...
1. **[dify](https://github.com/langgenius/dify)** - ⭐ 127,031
   Production-ready platform for agentic workflow development.

2. **[open-webui](https://github.com/open-webui/open-webui)** - ⭐ 121,668
   User-friendly AI Interface (Supports Ollama, OpenAI API, ...)

3. **[gemini-cli](https://github.com/google-gemini/gemini-cli)** - ⭐ 92,305
   An open-source AI agent that brings the power of Gemini directly into your terminal.

4. **[awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)** - ⭐ 79,570
   A collection of MCP servers.

5. **[netdata](https://github.com/netdata/netdata)** - ⭐ 77,489
   The fastest path to AI-powered full stack observability, even for lean teams.

6. **[servers](https://github.com/modelcontextprotocol/servers)** - ⭐ 77,011
   Model Context Protocol Servers

7. **[ragflow](https://github.com/infiniflow/ragflow)** - ⭐ 72,046
   RAGFlow is a leading open-source Retrieval-Augmented Generation (RAG) engine that fuses cutting-edge RAG with Agent capabilities to create a superior context layer for LLMs

8. **[lobe-chat](https://github.com/lobehub/lobe-chat)** - ⭐ 70,453
...
9. **[anything-llm](https://github.com/Mintplex-Labs/anything-llm)** - ⭐ 53,746
   The all-in-one Desktop & Docker AI application with built-in RAG, AI agents, No-code agent builder, MCP compatibility,  and more.

10. **[JeecgBoot](https://github.com/jeecgboot/JeecgBoot)** - ⭐ 45,073
...
11. **[TrendRadar](https://github.com/sansan0/TrendRadar)** - ⭐ 44,318
...
12. **[context7](https://github.com/upstash/context7)** - ⭐ 43,234
   Context7 MCP Server -- Up-to-date code documentation for LLMs and AI code editors

13. **[mindsdb](https://github.com/mindsdb/mindsdb)** - ⭐ 38,307
...
15. **[LibreChat](https://github.com/danny-avila/LibreChat)** - ⭐ 33,307
   Enhanced ChatGPT Clone: Features Agents, MCP, DeepSeek, Anthropic, AWS, OpenAI, Responses API, Azure, Groq, o1, GPT-5, Mistral, OpenRouter, Vertex AI, Gemini, Artifacts, AI model switching, message search, Code Interpreter, langchain, DALL-E-3, OpenAPI Actions, Functions, Secure Multi-User Auth, Presets, open-source for self-hosting. Active.

16. **[1Panel](https://github.com/1Panel-dev/1Panel)** - ⭐ 32,986
   🔥 1Panel provides an intuitive web interface and MCP Server to manage websites, files, containers, databases, and LLMs on a Linux server.

17. **[nacos](https://github.com/alibaba/nacos)** - ⭐ 32,573
   an easy-to-use dynamic service discovery, configuration and service management platform for building AI cloud native applications.

18. **[PDFMathTranslate](https://github.com/PDFMathTranslate/PDFMathTranslate)** - ⭐ 31,457
   [EMNLP 2025 Demo] PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/MCP/Docker/Zotero

19. **[goose](https://github.com/block/goose)** - ⭐ 27,653
   an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM

20. **[ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub)** - ⭐ 27,103
   In-depth tutorials on LLMs, RAGs and real-world AI agent applications.

21. **[composio](https://github.com/ComposioHQ/composio)** - ⭐ 26,428
   Composio equips your AI agents & LLMs with 100+ high-quality integrations via function calling

22. **[github-mcp-server](https://github.com/github/github-mcp-server)** - ⭐ 26,238
   GitHub's official MCP Server

23. **[playwright-mcp](https://github.com/microsoft/playwright-mcp)** - ⭐ 26,106
   Playwright MCP server

24. **[gpt-researcher](https://github.com/assafelovic/gpt-researcher)** - ⭐ 24,993
   An LLM agent that conducts deep research (local and web) on any given topic and generates a long report with citations.

25. **[UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)** - ⭐ 24,691
   The Open-Source Multimodal AI Agent Stack: Connecting Cutting-Edge AI Models and Agent Infra

26. **[xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)** - ⭐ 23,457
   An MCP-based chatbot | 一个基于MCP的聊天机器人

27. **[everything-claude-code](https://github.com/affaan-m/everything-claude-code)** - ⭐ 22,959
   Complete Claude Code configuration collection - agents, skills, hooks, commands, rules, MCPs. Battle-tested configs from an Anthropic hackathon winner.

28. **[fastmcp](https://github.com/jlowin/fastmcp)** - ⭐ 22,278
   🚀 The fast, Pythonic way to build MCP servers and clients

29. **[chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp)** - ⭐ 22,065
   Chrome DevTools for coding agents

30. **[repomix](https://github.com/yamadashy/repomix)** - ⭐ 21,416
   📦 Repomix is a powerful tool that packs your entire repository into a single, AI-friendly file. Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools like Claude, ChatGPT, DeepSeek, Perplexity, Gemini, Gemma, Llama, Grok, and more.

31. **[python-sdk](https://github.com/modelcontextprotocol/python-sdk)** - ⭐ 21,297
   The official Python SDK for Model Context Protocol servers and clients

32. **[activepieces](https://github.com/activepieces/activepieces)** - ⭐ 20,479
   AI Agents & MCPs & AI Workflow Automation • (~400 MCP servers for AI agents) • AI Automation / AI Agent with MCPs • AI Workflows & AI Agents • MCPs for AI Agents

33. **[mastra](https://github.com/mastra-ai/mastra)** - ⭐ 20,359
   From the team behind Gatsby, Mastra is a framework for building AI-powered applications and agents with a modern TypeScript stack.

34. **[MaxKB](https://github.com/1Panel-dev/MaxKB)** - ⭐ 19,929
   🔥 MaxKB is an open-source platform for building enterprise-grade agents.  强大易用的开源企业级智能体平台。

35. **[serena](https://github.com/oraios/serena)** - ⭐ 19,112
   A powerful coding agent toolkit providing semantic retrieval and editing capabilities (MCP server & other integrations)

36. **[agentic](https://github.com/transitive-bullshit/agentic)** - ⭐ 18,114
   Your API ⇒ Paid MCP. Instantly.

37. **[blender-mcp](https://github.com/ahujasid/blender-mcp)** - ⭐ 16,348

38. **[agentscope](https://github.com/agentscope-ai/agentscope)** - ⭐ 15,849
   AgentScope: Agent-Oriented Programming for Building LLM Applications

39. **[mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners)** - ⭐ 14,139
...
41. **[trigger.dev](https://github.com/triggerdotdev/trigger.dev)** - ⭐ 13,390
   Trigger.dev – build and deploy fully‑managed AI agents and workflows

42. **[cc-switch](https://github.com/farion1231/cc-switch)** - ⭐ 13,314
   A cross-platform desktop All-in-One assistant tool for Claude Code, Codex, OpenCode & Gemini CLI.

43. **[Qwen-Agent](https://github.com/QwenLM/Qwen-Agent)** - ⭐ 13,021
   Agent framework and applications built upon Qwen>=3.0, featuring Function Calling, MCP, Code Interpreter, RAG, Chrome extension, etc.

44. **[claude-flow](https://github.com/ruvnet/claude-flow)** - ⭐ 12,774
...
45. **[Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP)** - ⭐ 12,687
   MCP server to provide Figma layout information to AI coding agents like Cursor

46. **[n8n-mcp](https://github.com/czlonkowski/n8n-mcp)** - ⭐ 12,645
   A MCP for Claude Desktop / Claude Code / Windsurf / Cursor to build n8n workflows for you 

47. **[genai-toolbox](https://github.com/googleapis/genai-toolbox)** - ⭐ 12,598
   MCP Toolbox for Databases is an open source MCP server for databases.

48. **[typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk)** - ⭐ 11,403
   The official TypeScript SDK for Model Context Protocol servers and clients

49. **[fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)** - ⭐ 11,388
   Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!

50. **[pal-mcp-server](https://github.com/BeehiveInnovations/pal-mcp-server)** - ⭐ 10,931
   The power of Claude Code / GeminiCLI / CodexCLI + [Gemini / OpenAI / OpenRouter / Azure / Grok / Ollama / Custom Model / All Of The Above] working as one.

51. **[nginx-ui](https://github.com/0xJacky/nginx-ui)** - ⭐ 10,458
   Yet another WebUI for Nginx

52. **[gateway](https://github.com/Portkey-AI/gateway)** - ⭐ 10,362
   A blazing fast AI Gateway with integrated guardrails. Route to 200+ LLMs, 50+ AI Guardrails with 1 fast & friendly API.

53. **[mcp-chrome](https://github.com/hangwin/mcp-chrome)** - ⭐ 10,078
   Chrome MCP Server is a Chrome extension-based Model Context Protocol (MCP) server that exposes your Chrome browser functionality to AI assistants like Claude, enabling complex browser automation, content analysis, and semantic search.

54. **[zen-mcp-server](https://github.com/BeehiveInnovations/zen-mcp-server)** - ⭐ 9,890
   The power of Claude Code / GeminiCLI / CodexCLI + [Gemini / OpenAI / OpenRouter / Azure / Grok / Ollama / Custom Model / All Of The Above] working as one.

55. **[XHS-Downloader](https://github.com/JoeanAmier/XHS-Downloader)** - ⭐ 9,860
   小红书（XiaoHongShu、RedNote）链接提取/作品采集工具：提取账号发布、收藏、点赞、专辑作品链接；提取搜索结果作品、用户链接；采集小红书作品信息；提取小红书作品下载地址；下载小红书无水印作品文件

56. **[mcp-use](https://github.com/mcp-use/mcp-use)** - ⭐ 8,990
   mcp-use is the easiest way to interact with mcp servers with custom agents

57. **[Scrapling](https://github.com/D4Vinci/Scrapling)** - ⭐ 8,844
   🕷️ An undetectable, powerful, flexible, high-performance Python library to make Web Scraping Easy and Effortless as it should be!

58. **[awesome-ai-apps](https://github.com/Arindam200/awesome-ai-apps)** - ⭐ 8,622
   A collection of projects showcasing RAG, agents, workflows, and other AI use cases

59. **[inspector](https://github.com/modelcontextprotocol/inspector)** - ⭐ 8,408
   Visual testing tool for MCP servers

60. **[xiaozhi-esp32-server](https://github.com/xinnan-tech/xiaozhi-esp32-server)** - ⭐ 8,394
   本项目为xiaozhi-esp32提供后端服务，帮助您快速搭建ESP32设备控制服务器。Backend service for xiaozhi-esp32, helps you quickly build an ESP32 device control server.

61. **[xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp)** - ⭐ 8,261
   MCP for xiaohongshu.com

62. **[mcp-go](https://github.com/mark3labs/mcp-go)** - ⭐ 8,028
   A Go implementation of the Model Context Protocol (MCP), enabling seamless integration between LLM applications and external data sources and tools.

63. **[mcp-agent](https://github.com/lastmile-ai/mcp-agent)** - ⭐ 7,970
   Build effective agents using Model Context Protocol and simple workflow patterns

64. **[mcp](https://github.com/awslabs/mcp)** - ⭐ 7,943
   Official AWS MCP Servers

65. **[Skill_Seekers](https://github.com/yusufkaraaslan/Skill_Seekers)** - ⭐ 7,883
   Convert documentation websites, GitHub repositories, and PDFs into Claude AI skills with automatic conflict detection

66. **[git-mcp](https://github.com/idosal/git-mcp)** - ⭐ 7,448
   Put an end to code hallucinations! GitMCP is a free, open-source, remote MCP server for any GitHub project

67. **[awesome-LLM-resources](https://github.com/WangRongsheng/awesome-LLM-resources)** - ⭐ 7,378
...
69. **[GhidraMCP](https://github.com/LaurieWired/GhidraMCP)** - ⭐ 7,135
   MCP Server for Ghidra

70. **[browser-tools-mcp](https://github.com/AgentDeskAI/browser-tools-mcp)** - ⭐ 7,012
   Monitor browser logs directly from Cursor and other MCP compatible IDEs.

71. **[registry](https://github.com/modelcontextprotocol/registry)** - ⭐ 6,313
   A community driven registry service for Model Context Protocol (MCP) servers.

72. **[hexstrike-ai](https://github.com/0x4m4/hexstrike-ai)** - ⭐ 6,240
   HexStrike AI MCP Agents is an advanced MCP server that lets AI agents (Claude, GPT, Copilot, etc.) autonomously run 150+ cybersecurity tools for automated pentesting, vulnerability discovery, bug bounty automation, and security research. Seamlessly bridge LLMs with real-world offensive security capabilities.

73. **[awesome-mcp-clients](https://github.com/punkpeye/awesome-mcp-clients)** - ⭐ 6,238
   A collection of MCP clients.

74. **[cursor-talk-to-figma-mcp](https://github.com/grab/cursor-talk-to-figma-mcp)** - ⭐ 6,175
...
75. **[Awesome-MCP-ZH](https://github.com/yzfly/Awesome-MCP-ZH)** - ⭐ 5,903
   MCP 资源精选， MCP指南，Claude MCP，MCP Servers, MCP Clients

76. **[astron-rpa](https://github.com/iflytek/astron-rpa)** - ⭐ 5,899
   Agent-ready RPA suite with out-of-the-box automation tools. Built for individuals and enterprises.

77. **[klavis](https://github.com/Klavis-AI/klavis)** - ⭐ 5,608
   Klavis AI (YC X25):  MCP integration platforms that let AI agents use tools reliably at any scale

78. **[mcp](https://github.com/BrowserMCP/mcp)** - ⭐ 5,565
   Browser MCP is a Model Context Provider (MCP) server that allows AI applications to control your browser

79. **[kreuzberg](https://github.com/kreuzberg-dev/kreuzberg)** - ⭐ 5,528
...
80. **[firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server)** - ⭐ 5,316
   🔥 Official Firecrawl MCP Server - Adds powerful web scraping and search to Cursor, Claude and any other LLM clients.

81. **[DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP)** - ⭐ 5,308
   This is MCP server for Claude that gives it terminal control, file system search and diff file editing capabilities

82. **[unity-mcp](https://github.com/CoplayDev/unity-mcp)** - ⭐ 5,297
   Unity MCP acts as a bridge, allowing AI assistants (like Claude, Cursor) to interact directly with your Unity Editor via a local MCP (Model Context Protocol) Client. Give your LLM tools to manage assets, control scenes, edit scripts, and automate tasks within Unity.

83. **[whatsapp-mcp](https://github.com/lharries/whatsapp-mcp)** - ⭐ 5,249
   WhatsApp MCP server

84. **[Everywhere](https://github.com/DearVa/Everywhere)** - ⭐ 5,224
   Context-aware AI assistant for your desktop. Ready to respond intelligently, seamlessly integrating multiple LLMs and MCP tools.

85. **[ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp)** - ⭐ 5,173
   AI-powered reverse engineering assistant that bridges IDA Pro with language models through MCP.

86. **[mcp-playwright](https://github.com/executeautomation/mcp-playwright)** - ⭐ 5,172
   Playwright Model Context Protocol Server - Tool to automate Browsers and APIs in Claude Desktop, Cline, Cursor IDE and More 🔌

87. **[claude-context](https://github.com/zilliztech/claude-context)** - ⭐ 5,149
   Code search MCP for Claude Code. Make entire codebase the context for any coding agent.

88. **[awesome-mcp-servers](https://github.com/appcypher/awesome-mcp-servers)** - ⭐ 5,087
   Awesome MCP Servers - A curated list of Model Context Protocol servers

89. **[voltagent](https://github.com/VoltAgent/voltagent)** - ⭐ 5,014
   AI Agent Engineering Platform built on an Open Source TypeScript AI Agent Framework

90. **[gaianet-node](https://github.com/GaiaNet-AI/gaianet-node)** - ⭐ 5,009
   Install, run and deploy your own decentralized AI agent service

91. **[5ire](https://github.com/nanbingxyz/5ire)** - ⭐ 4,975
   5ire is a cross-platform desktop AI assistant, MCP client. It compatible with major service providers,  supports local knowledge base and  tools via model context protocol servers .

92. **[sdk-python](https://github.com/strands-agents/sdk-python)** - ⭐ 4,940
   A model-driven approach to building AI agents in just a few lines of code.

93. **[memU](https://github.com/NevaMind-AI/memU)** - ⭐ 4,907
   Memory infrastructure for LLMs and AI agents

94. **[claude-plugins-official](https://github.com/anthropics/claude-plugins-official)** - ⭐ 4,784
   Official, Anthropic-managed directory of high quality Claude Code Plugins.

95. **[aci](https://github.com/aipotheosis-labs/aci)** - ⭐ 4,701
   ACI.dev is the open source tool-calling platform that hooks up 600+ tools into any agentic IDE or custom AI agent through direct function calling or a unified MCP server. The birthplace of VibeOps.

96. **[Kiln](https://github.com/Kiln-AI/Kiln)** - ⭐ 4,593
   Build, Evaluate, and Optimize AI Systems. Includes evals, RAG, agents, fine-tuning, synthetic data generation, dataset management, MCP, and more.

97. **[microsandbox](https://github.com/zerocore-ai/microsandbox)** - ⭐ 4,469
   opensource self-hosted sandboxes for ai agents

98. **[casibase](https://github.com/casibase/casibase)** - ⭐ 4,404
   ⚡️AI Cloud OS: Open-source enterprise-level AI knowledge base and MCP (model-context-protocol)/A2A (agent-to-agent) management platform with admin UI, user management and Single-Sign-On⚡️, supports ChatGPT, Claude, Llama, Ollama, HuggingFace, etc., chat bot demo: https://ai.casibase.com, admin UI demo: https://ai-admin.casibase.com

99. **[deep-research](https://github.com/u14app/deep-research)** - ⭐ 4,341
   Use any LLMs (Large Language Models) for Deep Research. Support SSE API and MCP server.

100. **[httprunner](https://github.com/httprunner/httprunner)** - ⭐ 4,248
   HttpRunner 是一款开源的 API/UI 测试框架，简单易用，功能强大，具有丰富的插件化机制和高度的可扩展能力。

101. **[magic-mcp](https://github.com/21st-dev/magic-mcp)** - ⭐ 4,167
   It's like v0 but in your Cursor/WindSurf/Cline. 21st dev Magic MCP server for working with your frontend like Magic

102. **[mcp-ui](https://github.com/MCP-UI-Org/mcp-ui)** - ⭐ 4,084
   UI over MCP. Create next-gen UI experiences with the protocol and SDK!

103. **[wanwu](https://github.com/UnicomAI/wanwu)** - ⭐ 4,071
   China Unicom's Yuanjing Wanwu Agent Platform is an enterprise-grade, multi-tenant AI agent development platform. It helps users build applications such as intelligent agents, workflows, and rag, and also supports model management. The platform features a developer-friendly license, and we welcome all developers to build upon the platform.

104. **[mcp-atlassian](https://github.com/sooperset/mcp-atlassian)** - ⭐ 4,068
   MCP server for Atlassian tools (Confluence, Jira)

105. **[Windows-MCP](https://github.com/CursorTouch/Windows-MCP)** - ⭐ 4,011
   MCP Server for Computer Use in Windows

106. **[Olares](https://github.com/beclab/Olares)** - ⭐ 3,953
   Olares: An Open-Source Personal Cloud to Reclaim Your Data

107. **[mcpo](https://github.com/open-webui/mcpo)** - ⭐ 3,899
   A simple, secure MCP-to-OpenAPI proxy server

108. **[directories](https://github.com/pontusab/directories)** - ⭐ 3,884
   The Cursor & Windsurf community, find rules and MCPs

109. **[learn-agentic-ai](https://github.com/panaversity/learn-agentic-ai)** - ⭐ 3,871
   Learn Agentic AI using Dapr Agentic Cloud Ascent (DACA) Design Pattern and Agent-Native Cloud Technologies: OpenAI Agents SDK, Memory, MCP, A2A, Knowledge Graphs, Dapr, Rancher Desktop, and Kubernetes.

110. **[XcodeBuildMCP](https://github.com/cameroncooke/XcodeBuildMCP)** - ⭐ 3,824
   A Model Context Protocol (MCP) server that provides Xcode-related tools for integration with AI assistants and other MCP clients.

111. **[csharp-sdk](https://github.com/modelcontextprotocol/csharp-sdk)** - ⭐ 3,806
   The official C# SDK for Model Context Protocol servers and clients. Maintained in collaboration with Microsoft.

112. **[notion-mcp-server](https://github.com/makenotion/notion-mcp-server)** - ⭐ 3,778
   Official Notion MCP Server

113. **[spec-workflow-mcp](https://github.com/Pimzino/spec-workflow-mcp)** - ⭐ 3,748
...
115. **[telegram-search](https://github.com/groupultra/telegram-search)** - ⭐ 3,704
   🔍 导出并模糊搜索 Telegram 聊天记录 | Export and fuzzy search your Telegram chat history

116. **[go-sdk](https://github.com/modelcontextprotocol/go-sdk)** - ⭐ 3,684
   The official Go SDK for Model Context Protocol servers and clients. Maintained in collaboration with Google.

117. **[fast-agent](https://github.com/evalstate/fast-agent)** - ⭐ 3,629
   Define, Prompt and Test MCP enabled Agents and Workflows

118. **[exa-mcp-server](https://github.com/exa-labs/exa-mcp-server)** - ⭐ 3,623
   Exa MCP for web search and web crawling!

119. **[core](https://github.com/opensumi/core)** - ⭐ 3,594
   A framework helps you quickly build AI Native IDE products. MCP Client, supports Model Context Protocol (MCP) tools via MCP server.

120. **[mcp-server-chart](https://github.com/antvis/mcp-server-chart)** - ⭐ 3,562
   🤖 A visualization mcp & skills contains 25+ visual charts using @antvis. Using for chart generation and data analysis.

121. **[mcp-feedback-enhanced](https://github.com/Minidoracat/mcp-feedback-enhanced)** - ⭐ 3,550
   Enhanced MCP server for interactive user feedback and command execution in AI-assisted development, featuring dual interface support (Web UI and Desktop Application) with intelligent environment detection and cross-platform compatibility.

122. **[ciso-assistant-community](https://github.com/intuitem/ciso-assistant-community)** - ⭐ 3,534
...
123. **[cipher](https://github.com/campfirein/cipher)** - ⭐ 3,458
...
125. **[awesome-mcp-servers](https://github.com/wong2/awesome-mcp-servers)** - ⭐ 3,423
   A curated list of Model Context Protocol (MCP) servers

126. **[go-whatsapp-web-multidevice](https://github.com/aldinokemal/go-whatsapp-web-multidevice)** - ⭐ 3,399
   GOWA - WhatsApp REST API with support for UI, Multi Account, Webhooks, and MCP. Built with Golang for efficient memory use. 

127. **[Continuous-Claude-v3](https://github.com/parcadei/Continuous-Claude-v3)** - ⭐ 3,382
   Context management for Claude Code. Hooks maintain state via ledgers and handoffs. MCP execution without context pollution. Agent orchestration with isolated context windows.

128. **[mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare)** - ⭐ 3,326

129. **[PeopleInSpace](https://github.com/joreilly/PeopleInSpace)** - ⭐ 3,297
   Kotlin Multiplatform sample with SwiftUI, Jetpack Compose, Compose for Wear, Compose for Desktop, and Compose for Web clients along with Ktor backend.

130. **[MCP-Chinese-Getting-Started-Guide](https://github.com/liaokongVFX/MCP-Chinese-Getting-Started-Guide)** - ⭐ 3,289
   Model Context Protocol(MCP) 编程极速入门

131. **[langchain-mcp-adapters](https://github.com/langchain-ai/langchain-mcp-adapters)** - ⭐ 3,285
   LangChain 🔌 MCP

132. **[PPTAgent](https://github.com/icip-cas/PPTAgent)** - ⭐ 3,240
   An Agentic Framework for Reflective PowerPoint Generation

133. **[metorial](https://github.com/metorial/metorial)** - ⭐ 3,207
   Connect any AI model to 600+ integrations; powered by MCP 📡 🚀

134. **[excel-mcp-server](https://github.com/haris-musa/excel-mcp-server)** - ⭐ 3,188
   A Model Context Protocol server for Excel file manipulation

135. **[mobile-mcp](https://github.com/mobile-next/mobile-mcp)** - ⭐ 3,177
   Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators, Simulators and Real Devices)

136. **[claude-code-guide](https://github.com/zebbern/claude-code-guide)** - ⭐ 3,144
...
137. **[mcp-context-forge](https://github.com/IBM/mcp-context-forge)** - ⭐ 3,133
   A Model Context Protocol (MCP) Gateway & Registry. Serves as a central management point for tools, resources, and prompts that can be accessed by MCP-compatible LLM applications. Converts REST API endpoints to MCP, composes virtual MCP servers with added security and observability, and converts between protocols (stdio, SSE, Streamable HTTP).

138. **[py-xiaozhi](https://github.com/huangjunsen0406/py-xiaozhi)** - ⭐ 3,127
   A Python-based Xiaozhi AI for users who want the full Xiaozhi experience without owning specialized hardware.

139. **[learn-ai-engineering](https://github.com/ashishps1/learn-ai-engineering)** - ⭐ 3,116
   Learn AI and LLMs from scratch using free resources

140. **[boost](https://github.com/laravel/boost)** - ⭐ 3,099
   Laravel-focused MCP server for augmenting your AI powered local development experience.

141. **[java-sdk](https://github.com/modelcontextprotocol/java-sdk)** - ⭐ 3,092
   The official Java SDK for Model Context Protocol servers and clients. Maintained in collaboration with Spring AI

142. **[mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase)** - ⭐ 3,083
   Allow LLMs to control a browser with Browserbase and Stagehand

143. **[osaurus](https://github.com/dinoki-ai/osaurus)** - ⭐ 3,081
...
144. **[octelium](https://github.com/octelium/octelium)** - ⭐ 3,078
   A next-gen FOSS self-hosted unified zero trust secure access platform that can operate as a remote access VPN, a ZTNA platform, API/AI/MCP gateway, a PaaS, an ngrok-alternative and a homelab infrastructure.

145. **[UltraRAG](https://github.com/OpenBMB/UltraRAG)** - ⭐ 3,051
   UltraRAG v3: A Low-Code MCP Framework for Building Complex and Innovative RAG Pipelines

146. **[mcp](https://github.com/google/mcp)** - ⭐ 3,001
   Google 💚 MCP

147. **[rikkahub](https://github.com/rikkahub/rikkahub)** - ⭐ 2,964
   RikkaHub is an Android APP that supports for multiple LLM providers.

148. **[n8n-nodes-mcp](https://github.com/nerding-io/n8n-nodes-mcp)** - ⭐ 2,961
   n8n custom node for MCP

149. **[core](https://github.com/cheshire-cat-ai/core)** - ⭐ 2,951
   AI agent microservice

150. **[fastmcp](https://github.com/punkpeye/fastmcp)** - ⭐ 2,890
   A TypeScript framework for building MCP servers.

151. **[rust-sdk](https://github.com/modelcontextprotocol/rust-sdk)** - ⭐ 2,866
   The official Rust SDK for the Model Context Protocol

152. **[AI-Infra-Guard](https://github.com/Tencent/AI-Infra-Guard)** - ⭐ 2,832
...
153. **[mcp-obsidian](https://github.com/MarkusPfundstein/mcp-obsidian)** - ⭐ 2,743
   MCP server that interacts with Obsidian via the Obsidian rest API community plugin

154. **[shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server)** - ⭐ 2,623
...
157. **[playwriter](https://github.com/remorses/playwriter)** - ⭐ 2,535
   MCP to control your Chrome window via extension. Runs Playwright code in a stateful sandbox. 

158. **[mcp](https://github.com/microsoft/mcp)** - ⭐ 2,471
   Catalog of official Microsoft MCP (Model Context Protocol) server implementations for AI-powered data access and tool integration

159. **[supabase-mcp](https://github.com/supabase-community/supabase-mcp)** - ⭐ 2,417
   Connect Supabase to your AI assistants

160. **[basic-memory](https://github.com/basicmachines-co/basic-memory)** - ⭐ 2,401
   AI conversations that actually remember. Never re-explain your project to your AI again. Join our Discord: https://discord.gg/tyvKNccgqN

161. **[supergateway](https://github.com/supercorp-ai/supergateway)** - ⭐ 2,385
   Run MCP stdio servers over SSE and SSE over stdio. AI gateway.

162. **[markdownify-mcp](https://github.com/zcaceres/markdownify-mcp)** - ⭐ 2,371
   A Model Context Protocol server for converting almost anything to Markdown

163. **[buildwithclaude](https://github.com/davepoon/buildwithclaude)** - ⭐ 2,297
   A single hub to find Claude Skills, Agents, Commands, Hooks, Plugins, and Marketplace collections to extend Claude Code

164. **[MCP-SuperAssistant](https://github.com/srbhptl39/MCP-SuperAssistant)** - ⭐ 2,233
   Brings MCP to ChatGPT, DeepSeek, Perplexity, Grok, Gemini, Google AI Studio, OpenRouter, DeepSeek, T3 Chat and more...

165. **[sandbox](https://github.com/agent-infra/sandbox)** - ⭐ 2,205
   All-in-One Sandbox for AI Agents that combines Browser, Shell, File, MCP and VSCode Server in a single Docker container.

166. **[mcp-proxy](https://github.com/sparfenyuk/mcp-proxy)** - ⭐ 2,194
   A bridge between Streamable HTTP and stdio MCP transports

167. **[mcp-grafana](https://github.com/grafana/mcp-grafana)** - ⭐ 2,170
   MCP server for Grafana

168. **[ableton-mcp](https://github.com/ahujasid/ableton-mcp)** - ⭐ 2,169

169. **[chatmcp](https://github.com/daodao97/chatmcp)** - ⭐ 2,161
   ChatMCP is an AI chat client implementing the Model Context Protocol (MCP).

170. **[ddgs](https://github.com/deedy5/ddgs)** - ⭐ 2,099
   DDGS | Dux Distributed Global Search. A metasearch library that aggregates results from diverse web search services

171. **[claude-code-subagents-collection](https://github.com/davepoon/claude-code-subagents-collection)** - ⭐ 2,098
   Claude Code Subagents & Commands Collection + CLI Tool

172. **[kagent](https://github.com/kagent-dev/kagent)** - ⭐ 2,084
   Cloud Native Agentic AI | Discord: https://bit.ly/kagentdiscord

173. **[comfyui_LLM_party](https://github.com/heshengtao/comfyui_LLM_party)** - ⭐ 2,080
   LLM Agent Framework in ComfyUI includes MCP sever, Omost,GPT-sovits, ChatTTS,GOT-OCR2.0, and FLUX prompt nodes,access to Feishu,discord,and adapts to all llms with similar openai / aisuite interfaces, such as o1,ollama, gemini, grok, qwen, GLM, deepseek, kimi,doubao. Adapted to local llms, vlm, gguf such as llama-3.3 Janus-Pro, Linkage graphRAG

174. **[arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server)** - ⭐ 2,068
   A Model Context Protocol server for searching and analyzing arXiv papers

175. **[papersgpt-for-zotero](https://github.com/papersgpt/papersgpt-for-zotero)** - ⭐ 2,061
...
176. **[lemonade](https://github.com/lemonade-sdk/lemonade)** - ⭐ 2,042
   Lemonade helps users discover and run local AI apps by serving optimized LLMs right from their own GPUs and NPUs. Join our discord: https://discord.gg/5xXzkMu8Zk

177. **[DevDocs](https://github.com/cyberagiinc/DevDocs)** - ⭐ 2,014
   Completely free, private, UI based Tech Documentation MCP server. Designed for coders and software developers in mind. Easily integrate into Cursor, Windsurf, Cline, Roo Code, Claude Desktop App 

178. **[Unla](https://github.com/AmoyLab/Unla)** - ⭐ 2,012
   🧩 MCP Gateway - A lightweight gateway service that instantly transforms existing MCP Servers and APIs into MCP servers with zero code changes. Features Docker deployment and management UI, requiring no infrastructure modifications.

179. **[antigravity-awesome-skills](https://github.com/sickn33/antigravity-awesome-skills)** - ⭐ 2,003
...
180. **[mcp-shrimp-task-manager](https://github.com/cjo4m06/mcp-shrimp-task-manager)** - ⭐ 1,995
   Shrimp Task Manager is a task tool built for AI Agents, emphasizing chain-of-thought, reflection, and style consistency. It converts natural language into structured dev tasks with dependency tracking and iterative refinement, enabling agent-like developer behavior in reasoning AI systems.

181. **[superglue](https://github.com/superglue-ai/superglue)** - ⭐ 1,975
   superglue (YC W25) builds integrations and tools from natural language. Get production-grade tools for long tail and enterprise systems.

182. **[mcp-crawl4ai-rag](https://github.com/coleam00/mcp-crawl4ai-rag)** - ⭐ 1,972
   Web Crawling and RAG Capabilities for AI Agents and AI Coding Assistants

183. **[dbhub](https://github.com/bytebase/dbhub)** - ⭐ 1,964
   Zero-dependency, token-efficient database MCP server for Postgres, MySQL, SQL Server, MariaDB, SQLite.

184. **[mcpso](https://github.com/chatmcp/mcpso)** - ⭐ 1,959
   directory for Awesome MCP Servers

185. **[brightdata-mcp](https://github.com/brightdata/brightdata-mcp)** - ⭐ 1,943
   A powerful Model Context Protocol (MCP) server that provides an all-in-one solution for public web access.

186. **[metamcp](https://github.com/metatool-ai/metamcp)** - ⭐ 1,940
   MCP Aggregator, Orchestrator, Middleware, Gateway in one docker

187. **[modelcontextprotocol](https://github.com/perplexityai/modelcontextprotocol)** - ⭐ 1,892
   The official MCP server implementation for the Perplexity API Platform

188. **[postgres-mcp](https://github.com/crystaldba/postgres-mcp)** - ⭐ 1,886
   Postgres MCP Pro provides configurable read/write access and performance analysis for you and your AI agents.

189. **[yomo](https://github.com/yomorun/yomo)** - ⭐ 1,883
   🦖 Serverless AI Agent Framework with Geo-distributed Edge AI Infra.

190. **[gemini-mcp-tool](https://github.com/jamubc/gemini-mcp-tool)** - ⭐ 1,861
   MCP server that enables AI assistants to interact with Google Gemini CLI, leveraging Gemini's massive token window for large file analysis and codebase understanding

191. **[mcp-cli](https://github.com/chrishayuk/mcp-cli)** - ⭐ 1,843

192. **[witsy](https://github.com/nbonamy/witsy)** - ⭐ 1,839
   Witsy: desktop AI assistant / universal MCP client

193. **[Aix-DB](https://github.com/apconw/Aix-DB)** - ⭐ 1,837
   Aix-DB 基于 LangChain/LangGraph 框架，结合 MCP Skills 多智能体协作架构，实现自然语言到数据洞察的端到端转换。

194. **[bifrost](https://github.com/maximhq/bifrost)** - ⭐ 1,829
   Fastest LLM gateway (50x faster than LiteLLM) with adaptive load balancer, cluster mode, guardrails, 1000+ models support & <100 µs overhead at 5k RPS.

195. **[beelzebub](https://github.com/mariocandela/beelzebub)** - ⭐ 1,818
   A secure low code honeypot framework, leveraging AI for System Virtualization.

196. **[sanic-web](https://github.com/apconw/sanic-web)** - ⭐ 1,817
...
197. **[agentset](https://github.com/agentset-ai/agentset)** - ⭐ 1,814
   The open-source RAG platform: built-in citations, deep research, 22+ file formats, partitions, MCP server, and more.

198. **[opendia](https://github.com/aaronjmars/opendia)** - ⭐ 1,764
   Connect your browser to AI models. Just use Dia on Chrome, Arc or Firefox.

199. **[mcphub](https://github.com/samanhappy/mcphub)** - ⭐ 1,743
   A unified hub for centrally managing and dynamically orchestrating multiple MCP servers/APIs into separate endpoints with flexible routing strategies

200. **[Dive](https://github.com/OpenAgentPlatform/Dive)** - ⭐ 1,718
   Dive is an open-source MCP Host Desktop Application that seamlessly integrates with any LLMs supporting function calling capabilities. ✨

201. **[mcphub.nvim](https://github.com/ravitemer/mcphub.nvim)** - ⭐ 1,694
   An MCP client for Neovim that seamlessly integrates MCP servers into your editing workflow with an intuitive interface for managing, testing, and using MCP servers with your favorite chat plugins.

202. **[AIaW](https://github.com/NitroRCr/AIaW)** - ⭐ 1,694
...
203. **[mcpb](https://github.com/modelcontextprotocol/mcpb)** - ⭐ 1,666
   Desktop Extensions: One-click local MCP server installation in desktop apps

204. **[interactive-feedback-mcp](https://github.com/noopstudios/interactive-feedback-mcp)** - ⭐ 1,661
   Interactive User Feedback MCP

205. **[mcp-router](https://github.com/mcp-router/mcp-router)** - ⭐ 1,631
   A Unified MCP Server Management App (MCP Manager).

206. **[zenfeed](https://github.com/glidea/zenfeed)** - ⭐ 1,630
   Make RSS 📰 great again with AI 🧠✨!!

207. **[super-agent-party](https://github.com/heshengtao/super-agent-party)** - ⭐ 1,624
...
208. **[agentgateway](https://github.com/agentgateway/agentgateway)** - ⭐ 1,617
   Next Generation Agentic Proxy for AI Agents and MCP servers

209. **[awesome-agent-skills](https://github.com/heilcheng/awesome-agent-skills)** - ⭐ 1,613
   A curated list of skills, tools, tutorials, and capabilities for AI coding agents (Claude, Codex, Copilot, VS Code)

210. **[codemcp](https://github.com/ezyang/codemcp)** - ⭐ 1,603
   Coding assistant MCP for Claude Desktop

211. **[anyquery](https://github.com/julien040/anyquery)** - ⭐ 1,601
   Query anything (GitHub, Notion, +40 more) with SQL and let LLMs (ChatGPT, Claude) connect to using MCP

212. **[inspector](https://github.com/MCPJam/inspector)** - ⭐ 1,594
   Local inspector for ChatGPT apps & MCP apps (ext-apps)

213. **[Continuous-Claude-v2](https://github.com/parcadei/Continuous-Claude-v2)** - ⭐ 1,575
   Context management for Claude Code. Hooks maintain state via ledgers and handoffs. MCP execution without context pollution. Agent orchestration with isolated context windows.

214. **[py-gpt](https://github.com/szczyglis-dev/py-gpt)** - ⭐ 1,559
   Desktop AI Assistant powered by GPT-5, GPT-4, o1, o3, Gemini, Claude, Ollama, DeepSeek, Perplexity, Grok, Bielik, chat, vision, voice, RAG, image and video generation, agents, tools, MCP, plugins, speech synthesis and recognition, web search, memory, presets, assistants,and more. Linux, Windows, Mac

215. **[kubb](https://github.com/kubb-labs/kubb)** - ⭐ 1,552
   🧩 The Ultimate Toolkit for Generating Type-Safe API Clients, Hooks, and Validators.

216. **[MAI-UI](https://github.com/Tongyi-MAI/MAI-UI)** - ⭐ 1,551
   MAI-UI: Real-World Centric Foundation GUI Agents ranging from 2B to 235B

217. **[n8n-mcp-server](https://github.com/leonardsellem/n8n-mcp-server)** - ⭐ 1,550
   MCP server that provides tools and resources for interacting with n8n API

218. **[toolhive](https://github.com/stacklok/toolhive)** - ⭐ 1,547
   ToolHive makes deploying MCP servers easy, secure and fun

219. **[mcp_agent_mail](https://github.com/Dicklesworthstone/mcp_agent_mail)** - ⭐ 1,543
   Like gmail for your coding agents. Lets various different agents communicate and coordinate with each other.

220. **[mcphost](https://github.com/mark3labs/mcphost)** - ⭐ 1,527
   A CLI host application that enables Large Language Models (LLMs) to interact with external tools through the Model Context Protocol (MCP).

221. **[ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp)** - ⭐ 1,515
   MCP server for interacting with the iOS simulator

222. **[mcp-installer](https://github.com/anaisbetts/mcp-installer)** - ⭐ 1,503
   An MCP server that installs other MCP servers for you

223. **[godot-mcp](https://github.com/Coding-Solo/godot-mcp)** - ⭐ 1,501
   MCP server for interfacing with Godot game engine. Provides tools for launching the editor, running projects, and capturing debug output.

224. **[Office-Word-MCP-Server](https://github.com/GongRzhe/Office-Word-MCP-Server)** - ⭐ 1,482
   A Model Context Protocol (MCP) server for creating, reading, and manipulating Microsoft Word documents. This server enables AI assistants to work with Word documents through a standardized interface, providing rich document editing capabilities.

225. **[yu-ai-agent](https://github.com/liyupi/yu-ai-agent)** - ⭐ 1,475
...
226. **[better-agents](https://github.com/langwatch/better-agents)** - ⭐ 1,452
   Standards for building agents, better

227. **[mcptools](https://github.com/f/mcptools)** - ⭐ 1,451
   A command-line interface for interacting with MCP (Model Context Protocol) servers using both stdio and HTTP transport.

228. **[MCP-Reborn](https://github.com/Hexeption/MCP-Reborn)** - ⭐ 1,441
   MCP-Reborn is an MCP (Mod Coder Pack) for Minecraft for making modded clients and researching its code. (1.13-1.21.4)

229. **[Office-PowerPoint-MCP-Server](https://github.com/GongRzhe/Office-PowerPoint-MCP-Server)** - ⭐ 1,439
   A MCP (Model Context Protocol) server for PowerPoint manipulation using python-pptx. This server provides tools for creating, editing, and manipulating PowerPoint presentations through the MCP protocol.

230. **[pg-aiguide](https://github.com/timescale/pg-aiguide)** - ⭐ 1,437
   MCP server and Claude plugin for Postgres skills and documentation. Helps AI coding tools generate better PostgreSQL code.

231. **[claudian](https://github.com/YishenTu/claudian)** - ⭐ 1,433
   An Obsidian plugin that embeds Claude Code as an AI collaborator in your vault

232. **[rulego](https://github.com/rulego/rulego)** - ⭐ 1,409
   ⛓️RuleGo is a lightweight, high-performance, embedded, next-generation component orchestration rule engine framework for Go.

233. **[mcp-scan](https://github.com/invariantlabs-ai/mcp-scan)** - ⭐ 1,409
   Constrain, log and scan your MCP connections for security vulnerabilities.

234. **[mcp-language-server](https://github.com/isaacphi/mcp-language-server)** - ⭐ 1,407
   mcp-language-server gives MCP enabled clients access semantic tools like get definition, references, rename, and diagnostics.

235. **[php-sdk](https://github.com/modelcontextprotocol/php-sdk)** - ⭐ 1,320
   The official PHP SDK for Model Context Protocol servers and clients. Maintained in collaboration with The PHP Foundation.

236. **[unreal-mcp](https://github.com/chongdashu/unreal-mcp)** - ⭐ 1,318
   Enable AI assistant clients like Cursor, Windsurf and Claude Desktop to control Unreal Engine through natural language using the Model Context Protocol (MCP).

237. **[nerve](https://github.com/evilsocket/nerve)** - ⭐ 1,317
   The Simple Agent Development Kit.

238. **[mcp](https://github.com/MicrosoftDocs/mcp)** - ⭐ 1,305
   Official Microsoft Learn MCP Server – powering LLMs and AI agents with real-time, trusted Microsoft docs & code samples.

239. **[docker-mcp-tutorial](https://github.com/theNetworkChuck/docker-mcp-tutorial)** - ⭐ 1,297
   Complete tutorial materials for building MCP servers with Docker - from NetworkChuck's video

240. **[solace-agent-mesh](https://github.com/SolaceLabs/solace-agent-mesh)** - ⭐ 1,297
   An event-driven framework designed to build and orchestrate multi-agent AI systems. It enables seamless integration of AI agents with real-world data sources and systems, facilitating complex, multi-step workflows.

241. **[Risuai](https://github.com/kwaroran/Risuai)** - ⭐ 1,292
   Make your own story. User-friendly software for LLM roleplaying

242. **[LitterBox](https://github.com/BlackSnufkin/LitterBox)** - ⭐ 1,291
   A secure sandbox environment for malware developers and red teamers to test payloads against detection mechanisms before deployment. Integrates with LLM agents via MCP for enhanced analysis capabilities.

243. **[Claude-Code-Development-Kit](https://github.com/peterkrueck/Claude-Code-Development-Kit)** - ⭐ 1,290
   Handle context at scale - my custom Claude Code workflow including hooks, mcp and sub agents

244. **[mcp-obsidian](https://github.com/smithery-ai/mcp-obsidian)** - ⭐ 1,286
   A connector for Claude Desktop to read and search an Obsidian vault.

245. **[code-mode](https://github.com/universal-tool-calling-protocol/code-mode)** - ⭐ 1,281
   🔌 Plug-and-play library to enable agents to call MCP and UTCP tools via code execution. 

246. **[mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes)** - ⭐ 1,274
   MCP Server for kubernetes management commands

247. **[mcp-unity](https://github.com/CoderGamester/mcp-unity)** - ⭐ 1,258
   Model Context Protocol (MCP) plugin to connect with Unity Editor — designed for Cursor, Claude Code, Codex, Windsurf and other IDEs

248. **[damn-vulnerable-MCP-server](https://github.com/harishsg993010/damn-vulnerable-MCP-server)** - ⭐ 1,248
   Damn Vulnerable MCP Server

249. **[web-eval-agent](https://github.com/refreshdotdev/web-eval-agent)** - ⭐ 1,235
   An MCP server that autonomously evaluates web applications. 

250. **[kotlin-sdk](https://github.com/modelcontextprotocol/kotlin-sdk)** - ⭐ 1,228
   The official Kotlin SDK for Model Context Protocol servers and clients. Maintained in collaboration with JetBrains

251. **[web-eval-agent](https://github.com/withRefresh/web-eval-agent)** - ⭐ 1,226
   An MCP server that autonomously evaluates web applications. 

252. **[RisuAI](https://github.com/kwaroran/RisuAI)** - ⭐ 1,222
   Make your own story. User-friendly software for LLM roleplaying

253. **[ai](https://github.com/stripe/ai)** - ⭐ 1,222
   One-stop shop for building AI-powered products and businesses with Stripe.

254. **[deepwiki-mcp](https://github.com/regenrek/deepwiki-mcp)** - ⭐ 1,221
   📖 MCP server for fetch deepwiki.com and get latest knowledge in Cursor and other Code Editors

255. **[mcp-remote](https://github.com/geelen/mcp-remote)** - ⭐ 1,220

256. **[sre](https://github.com/SmythOS/sre)** - ⭐ 1,216
   The SmythOS Runtime Environment (SRE) is an open-source, cloud-native runtime for agentic AI. Secure, modular, and production-ready, it lets developers build, run, and manage intelligent agents across local, cloud, and edge environments.

257. **[MiniMax-MCP](https://github.com/MiniMax-AI/MiniMax-MCP)** - ⭐ 1,208
   Official MiniMax Model Context Protocol (MCP) server that enables interaction with powerful Text to Speech, image generation and video generation APIs.

258. **[grafbase](https://github.com/grafbase/grafbase)** - ⭐ 1,203
   The Grafbase GraphQL Federation Gateway

259. **[A2V](https://github.com/Devin-AXIS/A2V)** - ⭐ 1,199
   A2V: Next-Gen AI Value Compute Protocol.                                                                                 

260. **[mcp-memory-service](https://github.com/doobidoo/mcp-memory-service)** - ⭐ 1,199
   Stop re-explaining your project to AI every session. Automatic context memory for Claude, VS Code, Cursor, and 13+ AI tools.

261. **[swift-sdk](https://github.com/modelcontextprotocol/swift-sdk)** - ⭐ 1,194
   The official Swift SDK for Model Context Protocol servers and clients.

262. **[mcp-gateway](https://github.com/docker/mcp-gateway)** - ⭐ 1,190
   docker mcp CLI plugin / MCP Gateway

263. **[Peekaboo](https://github.com/steipete/Peekaboo)** - ⭐ 1,187
   Peekaboo is a macOS CLI & optional MCP server that enables AI agents to capture screenshots of applications, or the entire system, with optional visual question answering through local or remote AI models.

264. **[xmcp](https://github.com/basementstudio/xmcp)** - ⭐ 1,185
   The TypeScript MCP framework

265. **[google_workspace_mcp](https://github.com/taylorwilsdon/google_workspace_mcp)** - ⭐ 1,185
...
266. **[cunzhi](https://github.com/imhuso/cunzhi)** - ⭐ 1,184
   告别AI提前终止烦恼，助力AI更加持久

267. **[mcp-server-qdrant](https://github.com/qdrant/mcp-server-qdrant)** - ⭐ 1,182
   An official Qdrant Model Context Protocol (MCP) server implementation

268. **[slack-mcp-server](https://github.com/korotovsky/slack-mcp-server)** - ⭐ 1,181
...
269. **[mcp-golang](https://github.com/metoro-io/mcp-golang)** - ⭐ 1,180
   Write Model Context Protocol servers in few lines of go code. Docs at https://mcpgolang.com . Created by https://metoro.io

270. **[azure-devops-mcp](https://github.com/microsoft/azure-devops-mcp)** - ⭐ 1,180
   The MCP server for Azure DevOps, bringing the power of Azure DevOps directly to your agents.

271. **[npcpy](https://github.com/NPC-Worldwide/npcpy)** - ⭐ 1,177
   AI research and development

272. **[elevenlabs-mcp](https://github.com/elevenlabs/elevenlabs-mcp)** - ⭐ 1,165
   The official ElevenLabs MCP server

273. **[terraform-mcp-server](https://github.com/hashicorp/terraform-mcp-server)** - ⭐ 1,163
   The Terraform MCP Server provides seamless integration with Terraform ecosystem, enabling advanced automation and interaction capabilities for Infrastructure as Code (IaC) development.

274. **[google-analytics-mcp](https://github.com/googleanalytics/google-analytics-mcp)** - ⭐ 1,146

275. **[Agent-MCP](https://github.com/rinadelph/Agent-MCP)** - ⭐ 1,139
   Agent-MCP is a framework for creating multi-agent systems that enables coordinated, efficient AI collaboration through the Model Context Protocol (MCP). The system is designed for developers building AI applications that benefit from multiple specialized agents working in parallel on different aspects of a project.

276. **[jadx-ai-mcp](https://github.com/zinja-coder/jadx-ai-mcp)** - ⭐ 1,129
   Plugin for JADX to integrate MCP server

277. **[tuui](https://github.com/AI-QL/tuui)** - ⭐ 1,121
   A desktop MCP client designed as a tool unitary utility integration, accelerating AI adoption through the Model Context Protocol (MCP) and enabling cross-vendor LLM API orchestration.

278. **[fast-mcp](https://github.com/yjacquin/fast-mcp)** - ⭐ 1,120
   A Ruby Implementation of the Model Context Protocol

279. **[tavily-mcp](https://github.com/tavily-ai/tavily-mcp)** - ⭐ 1,114
   Production ready MCP server with real-time search, extract, map & crawl.

280. **[mcp-server-mysql](https://github.com/benborla/mcp-server-mysql)** - ⭐ 1,105
   A Model Context Protocol server that provides read-only access to MySQL databases. This server enables LLMs to inspect database schemas and execute read-only queries.

281. **[AWorld](https://github.com/inclusionAI/AWorld)** - ⭐ 1,104
   Build, evaluate and train General Multi-Agent Assistance with ease

282. **[xiaozhi-esp32-server-java](https://github.com/joey-zhou/xiaozhi-esp32-server-java)** - ⭐ 1,102
   小智ESP32的Java企业级管理平台，提供设备监控、音色定制、角色切换和对话记录管理的前后端及服务端一体化解决方案

283. **[cui](https://github.com/wbopan/cui)** - ⭐ 1,095
   A web UI for Claude Code agents

284. **[mysql_mcp_server](https://github.com/designcomputer/mysql_mcp_server)** - ⭐ 1,091
   A Model Context Protocol (MCP) server that enables secure interaction with MySQL databases

285. **[iMCP](https://github.com/mattt/iMCP)** - ⭐ 1,085
   A macOS app that provides an MCP server to your Messages, Contacts, Reminders and more

286. **[xhs-toolkit](https://github.com/aki66938/xhs-toolkit)** - ⭐ 1,082
   📕 小红书创作者MCP工具包 - 支持与AI客户端集成的内容创作和发布工具

287. **[trustgraph](https://github.com/trustgraph-ai/trustgraph)** - ⭐ 1,070
   The Context Graph Factory for AI. Build, manage, and deploy AI-optimized Context Graphs.

288. **[zotero-mcp](https://github.com/54yyyu/zotero-mcp)** - ⭐ 1,070
   Zotero MCP: Connects your Zotero research library with Claude and other AI assistants via the Model Context Protocol to discuss papers, get summaries, analyze citations, and more.

289. **[flock](https://github.com/Onelevenvy/flock)** - ⭐ 1,065
   Flock is a workflow-based low-code platform for rapidly building chatbots, RAG, and coordinating multi-agent teams, powered by LangGraph, Langchain, FastAPI, and NextJS.（Flock 是一个基于workflow工作流的低代码平台，用于快速构建聊天机器人、RAG、Agent和Muti-Agent应用，采用 LangGraph、Langchain、FastAPI 和 NextJS 构建。）

290. **[claude-code-plugins-plus-skills](https://github.com/jeremylongshore/claude-code-plugins-plus-skills)** - ⭐ 1,056
   Hundreds of Claude Code plugins with embedded AI skills. Learn via interactive Jupyter tutorials.

291. **[SearChat](https://github.com/sear-chat/SearChat)** - ⭐ 1,038
   Search + Chat = SearChat(AI Chat with Search), Support OpenAI/Anthropic/VertexAI/Gemini, DeepResearch, SearXNG, Docker.  AI对话式搜索引擎，支持DeepResearch, 支持OpenAI/Anthropic/VertexAI/Gemini接口、聚合搜索引擎SearXNG，支持Docker一键部署。

292. **[mcp-server-chatsum](https://github.com/chatmcp/mcp-server-chatsum)** - ⭐ 1,030
   Query and Summarize your chat messages.

293. **[kubernetes-mcp-server](https://github.com/containers/kubernetes-mcp-server)** - ⭐ 1,029
   Model Context Protocol (MCP) server for Kubernetes and OpenShift

294. **[minima](https://github.com/dmayboroda/minima)** - ⭐ 1,027
   On-premises conversational RAG with configurable containers

295. **[search_with_ai](https://github.com/yokingma/search_with_ai)** - ⭐ 1,025
...
296. **[use-mcp](https://github.com/modelcontextprotocol/use-mcp)** - ⭐ 1,023

297. **[ApeRAG](https://github.com/apecloud/ApeRAG)** - ⭐ 1,023
   ApeRAG: Production-ready GraphRAG with multi-modal indexing, AI agents, MCP support, and scalable K8s deployment

298. **[lets-learn-mcp-python](https://github.com/microsoft/lets-learn-mcp-python)** - ⭐ 1,021
   MCP Python Tutorial 

299. **[Awesome-MCP-Servers](https://github.com/YuzeHao2023/Awesome-MCP-Servers)** - ⭐ 1,017
   A curated list of Model Context Protocol (MCP) servers 

300. **[claude-code-mcp](https://github.com/steipete/claude-code-mcp)** - ⭐ 1,014
   Claude Code as one-shot MCP server to have an agent in your agent.

301. **[mcp-boilerplate](https://github.com/iannuttall/mcp-boilerplate)** - ⭐ 997
   A remote Cloudflare MCP server boilerplate with user authentication and Stripe for paid tools.

302. **[wenyan-mcp](https://github.com/caol64/wenyan-mcp)** - ⭐ 994
   文颜 MCP Server 可以让 AI 自动将 Markdown 文章排版后发布至微信公众号。

303. **[better-chatbot](https://github.com/cgoinglove/better-chatbot)** - ⭐ 989
   Just a Better Chatbot. Powered by Agent & MCP & Workflows.

304. **[awesome-remote-mcp-servers](https://github.com/jaw9c/awesome-remote-mcp-servers)** - ⭐ 982
   Remote MCP Servers

305. **[claude-init](https://github.com/cfrs2005/claude-init)** - ⭐ 978
   Claude Code 中文开发套件 - 为中国开发者定制的零门槛 AI 编程环境。一键安装完整中文化体验，集成 MCP 服务器、智能上下文管理、安全扫描，支持免翻墙访问。让 AI 编程更简单。

306. **[quickstart-resources](https://github.com/modelcontextprotocol/quickstart-resources)** - ⭐ 969
   A repository of servers and clients from the Model Context Protocol tutorials

307. **[fetcher-mcp](https://github.com/jae-jae/fetcher-mcp)** - ⭐ 968
   MCP server for fetch web page content using Playwright headless browser.

308. **[ollama-mcp-bridge](https://github.com/patruff/ollama-mcp-bridge)** - ⭐ 961
   Bridge between Ollama and MCP servers, enabling local LLMs to use Model Context Protocol tools

309. **[WebMCP](https://github.com/MiguelsPizza/WebMCP)** - ⭐ 955
   Bringing the power of MCP to the web

310. **[docs-mcp-server](https://github.com/arabold/docs-mcp-server)** - ⭐ 950
   Grounded Docs MCP Server: Open-Source Alternative to Context7, Nia, and Ref.Tools

311. **[ros-mcp-server](https://github.com/robotmcp/ros-mcp-server)** - ⭐ 949
   Connect AI models like Claude & GPT with robots using MCP and ROS.

312. **[Gmail-MCP-Server](https://github.com/GongRzhe/Gmail-MCP-Server)** - ⭐ 948
   A Model Context Protocol (MCP) server for Gmail integration in Claude Desktop with auto authentication support. This server enables AI assistants to manage Gmail through natural language interactions.

313. **[RedNote-MCP](https://github.com/iFurySt/RedNote-MCP)** - ⭐ 946
   🚀MCP server for accessing RedNote(XiaoHongShu, xhs).

314. **[gitlab-mcp](https://github.com/zereight/gitlab-mcp)** - ⭐ 944
   First gitlab mcp for you

315. **[mcp-jetbrains](https://github.com/JetBrains/mcp-jetbrains)** - ⭐ 940
   A model context protocol server to work with JetBrains IDEs: IntelliJ, PyCharm, WebStorm, etc. Also, works with Android Studio

316. **[CloudBase-MCP](https://github.com/TencentCloudBase/CloudBase-MCP)** - ⭐ 938
      CloudBase MCP - Connect CloudBase to your AI Agent.     Go from AI prompt to live app. 

317. **[ref-tools-mcp](https://github.com/ref-tools/ref-tools-mcp)** - ⭐ 937
   Helping coding agents never make mistakes working with public or private libraries without wasting the context window.

318. **[ai-dev-tools-zoomcamp](https://github.com/DataTalksClub/ai-dev-tools-zoomcamp)** - ⭐ 937
...
319. **[short-video-maker](https://github.com/gyoridavid/short-video-maker)** - ⭐ 932
   Creates short videos for TikTok, Instagram Reels, and YouTube Shorts using the Model Context Protocol (MCP) and a REST API.

320. **[mcporter](https://github.com/steipete/mcporter)** - ⭐ 930
   Call MCPs via TypeScript, masquerading as simple TypeScript API. Or package them as cli.

321. **[awesome-devops-mcp-servers](https://github.com/rohitg00/awesome-devops-mcp-servers)** - ⭐ 927
   A curated list of awesome MCP servers focused on DevOps tools and capabilities.

322. **[mcp-windbg](https://github.com/svnscha/mcp-windbg)** - ⭐ 926
   Model Context Protocol for WinDBG

323. **[google-calendar-mcp](https://github.com/nspady/google-calendar-mcp)** - ⭐ 916
   MCP integration for Google Calendar to manage events.

324. **[gemini-nexus](https://github.com/yeahhe365/gemini-nexus)** - ⭐ 913
...
325. **[mcpdoc](https://github.com/langchain-ai/mcpdoc)** - ⭐ 912
   Expose llms-txt to IDEs for development

326. **[CloudBase-AI-ToolKit](https://github.com/TencentCloudBase/CloudBase-AI-ToolKit)** - ⭐ 909
      CloudBase MCP - Connect CloudBase to your AI Agent.     Go from AI prompt to live app in one click.

327. **[tools](https://github.com/strands-agents/tools)** - ⭐ 909
   A set of tools that gives agents powerful capabilities.

328. **[todo-for-ai](https://github.com/todo-for-ai/todo-for-ai)** - ⭐ 909
...
329. **[Pixelle-MCP](https://github.com/AIDC-AI/Pixelle-MCP)** - ⭐ 903
   An Open-Source Multimodal AIGC Solution based on ComfyUI + MCP + LLM  https://pixelle.ai

330. **[mongodb-mcp-server](https://github.com/mongodb-js/mongodb-mcp-server)** - ⭐ 896
   A Model Context Protocol server to connect to MongoDB databases and MongoDB Atlas Clusters.

331. **[MCP-Bridge](https://github.com/SecretiveShell/MCP-Bridge)** - ⭐ 895
   A middleware to provide an openAI compatible endpoint that can call MCP tools

332. **[mcp-framework](https://github.com/QuantGeekDev/mcp-framework)** - ⭐ 895
   A framework for writing MCP (Model Context Protocol) servers in Typescript

333. **[nuxt-mcp-dev](https://github.com/antfu/nuxt-mcp-dev)** - ⭐ 891
   MCP server helping models to understand your Vite/Nuxt app better.

334. **[agentic-radar](https://github.com/splx-ai/agentic-radar)** - ⭐ 882
   A security scanner for your LLM agentic workflows

335. **[mcp-neo4j](https://github.com/neo4j-contrib/mcp-neo4j)** - ⭐ 881
   Neo4j Labs Model Context Protocol servers

336. **[mix.core](https://github.com/mixcore/mix.core)** - ⭐ 880
   🚀 A future-proof enterprise web CMS supporting both headless and decoupled approaches. Build any type of app with customizable APIs on ASP.NET Core/.NET Core. Completely open-source and designed for flexibility.

337. **[chatgpt-cli](https://github.com/kardolus/chatgpt-cli)** - ⭐ 880
...
338. **[agents](https://github.com/inkeep/agents)** - ⭐ 876
   Create AI Agents in a No-Code Visual Builder or TypeScript SDK with full 2-way sync. For shipping AI assistants and multi-agent AI workflows.

339. **[mcp-browser-use](https://github.com/Saik0s/mcp-browser-use)** - ⭐ 875

340. **[MCProtocolLib](https://github.com/GeyserMC/MCProtocolLib)** - ⭐ 871
   A library for communication with a Minecraft client/server.

341. **[openapi-mcp-server](https://github.com/janwilmake/openapi-mcp-server)** - ⭐ 870
   Allow AI to wade through complex OpenAPIs using Simple Language

342. **[mcp-course](https://github.com/huggingface/mcp-course)** - ⭐ 868

343. **[jupyter-mcp-server](https://github.com/datalayer/jupyter-mcp-server)** - ⭐ 864
   🪐 🔧 Model Context Protocol (MCP) Server for Jupyter.

344. **[mcpm.sh](https://github.com/pathintegral-institute/mcpm.sh)** - ⭐ 863
   CLI MCP package manager & registry for all platforms and all clients. Search & configure MCP servers. Advanced Router & Profile features.

345. **[awesome-mcp-list](https://github.com/MobinX/awesome-mcp-list)** - ⭐ 860
   A concise list for mcp servers

346. **[memory-bank-mcp](https://github.com/alioshr/memory-bank-mcp)** - ⭐ 848
   A Model Context Protocol (MCP) server implementation for remote memory bank management, inspired by Cline Memory Bank.

347. **[mcp-notion-server](https://github.com/suekou/mcp-notion-server)** - ⭐ 846

348. **[AI-Gateway](https://github.com/Azure-Samples/AI-Gateway)** - ⭐ 842
...
349. **[hyper-mcp](https://github.com/hyper-mcp-rs/hyper-mcp)** - ⭐ 840
   📦️ A fast, secure MCP server that extends its capabilities through WebAssembly plugins.

350. **[trpc-agent-go](https://github.com/trpc-group/trpc-agent-go)** - ⭐ 836
   trpc-agent-go is a powerful Go framework for building intelligent agent systems using large language models (LLMs) and tools.

351. **[hyper-mcp](https://github.com/tuananh/hyper-mcp)** - ⭐ 835
   📦️ A fast, secure MCP server that extends its capabilities through WebAssembly plugins.

352. **[hyper-mcp](https://github.com/joseph-wortmann/hyper-mcp)** - ⭐ 834
   📦️ A fast, secure MCP server that extends its capabilities through WebAssembly plugins.

353. **[scira-mcp-chat](https://github.com/zaidmukaddam/scira-mcp-chat)** - ⭐ 828
   A minimalistic MCP client with a good feature set.

354. **[OpenDerisk](https://github.com/derisk-ai/OpenDerisk)** - ⭐ 827
...
355. **[mcp-sequential-thinking](https://github.com/arben-adm/mcp-sequential-thinking)** - ⭐ 827

356. **[MCPJungle](https://github.com/mcpjungle/MCPJungle)** - ⭐ 824
   Self-hosted MCP Gateway for AI agents

357. **[yokai](https://github.com/ankorstore/yokai)** - ⭐ 818
   Simple, modular, and observable Go framework for backend applications.

358. **[supabase-mcp-server](https://github.com/alexander-zuev/supabase-mcp-server)** - ⭐ 816
   Query MCP enables end-to-end management of Supabase via chat interface: read & write query executions, management API support, automatic migration versioning, access to logs and much more.

359. **[wassette](https://github.com/microsoft/wassette)** - ⭐ 815
   Wassette: A security-oriented runtime that runs WebAssembly Components via MCP

360. **[Unity-MCP](https://github.com/IvanMurzak/Unity-MCP)** - ⭐ 815
   AI-powered bridge connecting LLMs and advanced AI agents to the Unity Editor via the Model Context Protocol (MCP). Chat with AI to generate code, debug errors, and automate game development tasks directly within your project.

361. **[statespace](https://github.com/statespace-tech/statespace)** - ⭐ 814
   Turn your data into shareable RAG apps in minutes. All in pure Markdown. Zero boilerplate.

362. **[openapi-servers](https://github.com/open-webui/openapi-servers)** - ⭐ 814
   OpenAPI Tool Servers

363. **[toolfront](https://github.com/statespace-tech/toolfront)** - ⭐ 809
   Turn your data into shareable RAG apps in minutes. All in pure Markdown. Zero boilerplate.

364. **[golf](https://github.com/golf-mcp/golf)** - ⭐ 807
   Production-Ready MCP Server Framework • Build, deploy & scale secure AI agent infrastructure • Includes Auth, Observability, Debugger, Telemetry & Runtime • Run real-world MCPs powering AI Agents 

365. **[DeepMCPAgent](https://github.com/cryxnet/DeepMCPAgent)** - ⭐ 804
   Model-agnostic plug-n-play LangChain/LangGraph agents powered entirely by MCP tools over HTTP/SSE.

366. **[server](https://github.com/php-mcp/server)** - ⭐ 803
   Core PHP implementation for the Model Context Protocol (MCP) server

367. **[browser-use-mcp-server](https://github.com/kontext-dev/browser-use-mcp-server)** - ⭐ 798
   Browse the web, directly from Cursor etc.

368. **[context-space](https://github.com/context-space/context-space)** - ⭐ 797
   Ultimate Context Engineering Infrastructure, starting from MCPs and Integrations

369. **[excel-mcp-server](https://github.com/negokaz/excel-mcp-server)** - ⭐ 796
   A Model Context Protocol (MCP) server that reads and writes MS Excel data

370. **[MCP-Security-Checklist](https://github.com/slowmist/MCP-Security-Checklist)** - ⭐ 794
   A comprehensive security checklist for MCP-based AI tools. Built by SlowMist to safeguard LLM plugin ecosystems.

371. **[arcade-mcp](https://github.com/ArcadeAI/arcade-mcp)** - ⭐ 791
   The best way to create, deploy, and share MCP Servers

372. **[bank-api](https://github.com/erwinkramer/bank-api)** - ⭐ 781
   The Bank API is a design reference project suitable to bootstrap development for a compliant and modern API.

373. **[himarket](https://github.com/higress-group/himarket)** - ⭐ 779
...
374. **[acemcp](https://github.com/qy527145/acemcp)** - ⭐ 777
   一个将ACE(Augment Context Engine) 做成MCP的项目

375. **[mcp-knowledge-graph](https://github.com/shaneholloman/mcp-knowledge-graph)** - ⭐ 775
   MCP server enabling persistent memory for Claude through a local knowledge graph - fork focused on local development

376. **[agent-kit](https://github.com/inngest/agent-kit)** - ⭐ 773
   AgentKit: Build multi-agent networks in TypeScript with deterministic routing and rich tooling via MCP.

377. **[qgis_mcp](https://github.com/jjsantos01/qgis_mcp)** - ⭐ 770
   Model Context Protocol (MCP) that allows LLMs to use QGIS Desktop

378. **[Context](https://github.com/indragiek/Context)** - ⭐ 767
   Native macOS client for Model Context Protocol (MCP)

379. **[k8m](https://github.com/weibaohui/k8m)** - ⭐ 763
   一款轻量级、跨平台的 Mini Kubernetes AI Dashboard，支持大模型+智能体+MCP(支持设置操作权限)，集成多集群管理、智能分析、实时异常检测等功能，支持多架构并可单文件部署，助力高效集群管理与运维优化。

380. **[vibetest-use](https://github.com/browser-use/vibetest-use)** - ⭐ 762
   Vibetest MCP - automated QA testing using Browser-Use agents

381. **[kubectl-mcp-server](https://github.com/rohitg00/kubectl-mcp-server)** - ⭐ 762
   A Model Context Protocol (MCP) server for Kubernetes. Install: npx kubectl-mcp-server or pip install kubectl-mcp-server

382. **[vllora](https://github.com/vllora/vllora)** - ⭐ 758
   Debug your AI agents

383. **[runno](https://github.com/taybenlor/runno)** - ⭐ 757
   Sandboxed runtime for programming languages and WASI binaries. Works in the browser, on your server, or via MCP.

384. **[mcp-marketplace](https://github.com/cline/mcp-marketplace)** - ⭐ 752
...
385. **[Claude-Code-Everything-You-Need-to-Know](https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know)** - ⭐ 748
   The ultimate all-in-one guide to mastering Claude Code. From setup, prompt engineering, commands, hooks, workflows, automation, and integrations, to MCP servers, tools, and the BMAD method—packed with step-by-step tutorials, real-world examples, and expert strategies to make this the global go-to repo for Claude mastery.

386. **[mcp-scanner](https://github.com/cisco-ai-defense/mcp-scanner)** - ⭐ 747
   Scan MCP servers for potential threats & security findings.

387. **[claude-delegator](https://github.com/jarrodwatts/claude-delegator)** - ⭐ 747
   Delegate tasks to Codex GPT 5.2 directly from within Claude Code.

388. **[apple-docs-mcp](https://github.com/kimsungwhee/apple-docs-mcp)** - ⭐ 743
   MCP server for Apple Developer Documentation - Search iOS/macOS/SwiftUI/UIKit docs, WWDC videos, Swift/Objective-C APIs & code examples in Claude, Cursor & AI assistants

389. **[duckduckgo-mcp-server](https://github.com/nickclyde/duckduckgo-mcp-server)** - ⭐ 743
   A Model Context Protocol (MCP) server that provides web search capabilities through DuckDuckGo, with additional features for content fetching and parsing.

390. **[heurist-agent-framework](https://github.com/heurist-network/heurist-agent-framework)** - ⭐ 742
   A flexible multi-interface AI agent framework for building agents with reasoning, tool use, memory, deep research, blockchain interaction, MCP, and agents-as-a-service.

391. **[linkedin-mcp-server](https://github.com/stickerdaniel/linkedin-mcp-server)** - ⭐ 742
...
392. **[mcp-server](https://github.com/financial-datasets/mcp-server)** - ⭐ 741
   An MCP server for interacting with the Financial Datasets stock market API.

393. **[lisa.py](https://github.com/ant4g0nist/lisa.py)** - ⭐ 739
   LLDB MCP Integration + other helpful commands

394. **[AITreasureBox](https://github.com/superiorlu/AITreasureBox)** - ⭐ 739
   🤖 Collect practical AI repos, tools, websites, papers and tutorials on AI. 实用的AI百宝箱 💎 

395. **[mcp-cli](https://github.com/philschmid/mcp-cli)** - ⭐ 738
   Lighweight CLI to interact with MCP servers

396. **[context-portal](https://github.com/GreatScottyMac/context-portal)** - ⭐ 730
...
397. **[coderunner](https://github.com/instavm/coderunner)** - ⭐ 723
   A secure local sandbox to run LLM-generated code using Apple containers

398. **[openmcp-client](https://github.com/LSTM-Kirigaya/openmcp-client)** - ⭐ 721
   All in one vscode plugin for mcp developer

399. **[apify-mcp-server](https://github.com/apify/apify-mcp-server)** - ⭐ 715
   The Apify MCP server enables your AI agents to extract data from social media, search engines, maps, e-commerce sites, or any other website using thousands of ready-made scrapers, crawlers, and automation tools available on the Apify Store.

400. **[mcp](https://github.com/hyperbrowserai/mcp)** - ⭐ 713
   A MCP server implementation for hyperbrowser

401. **[passage-of-time-mcp](https://github.com/jlumbroso/passage-of-time-mcp)** - ⭐ 711
...
402. **[nanobot](https://github.com/nanobot-ai/nanobot)** - ⭐ 709
   Build MCP Agents

403. **[MassGen](https://github.com/massgen/MassGen)** - ⭐ 706
...
404. **[llm-functions](https://github.com/sigoden/llm-functions)** - ⭐ 701
   Easily create LLM tools and agents using plain Bash/JavaScript/Python functions.

405. **[annas-mcp](https://github.com/iosifache/annas-mcp)** - ⭐ 701
   MCP server and CLI tool for searching and downloading documents from Anna's Archive

406. **[just-prompt](https://github.com/disler/just-prompt)** - ⭐ 700
...
407. **[code-index-mcp](https://github.com/johnhuang316/code-index-mcp)** - ⭐ 700
   A Model Context Protocol (MCP) server that helps large language models index, search, and analyze code repositories with minimal setup

408. **[12306-mcp](https://github.com/Joooook/12306-mcp)** - ⭐ 691
   This is a 12306 ticket search server based on the Model Context Protocol (MCP).

409. **[ruby-sdk](https://github.com/modelcontextprotocol/ruby-sdk)** - ⭐ 689
   The official Ruby SDK for the Model Context Protocol. Maintained in collaboration with Shopify.

410. **[octocode-mcp](https://github.com/bgauryy/octocode-mcp)** - ⭐ 687
   MCP server for semantic code research and context generation on real-time using LLM patterns | Search naturally across public & private repos based on your permissions | Transform any accessible codebase/s into AI-optimized knowledge on simple and complex flows | Find real implementations and live docs from anywhere

411. **[langgraph-mcp-agents](https://github.com/teddynote-lab/langgraph-mcp-agents)** - ⭐ 682
...
412. **[HowToCook-mcp](https://github.com/worryzyy/HowToCook-mcp)** - ⭐ 679
   基于Anduin2017 / HowToCook （程序员在家做饭指南）的mcp server

413. **[fetch-mcp](https://github.com/zcaceres/fetch-mcp)** - ⭐ 673
   A flexible HTTP fetching Model Context Protocol server.

414. **[clojure-mcp](https://github.com/bhauman/clojure-mcp)** - ⭐ 670
   Clojure MCP

415. **[mcp-server-docker](https://github.com/ckreiling/mcp-server-docker)** - ⭐ 669
   MCP server for Docker

416. **[llm-server-docs](https://github.com/varunvasudeva1/llm-server-docs)** - ⭐ 666
   End-to-end documentation to set up your own local & fully private LLM server on Debian. Equipped with chat, web search, RAG, model management, MCP servers, image generation, and TTS.

417. **[go-mcp](https://github.com/ThinkInAIXYZ/go-mcp)** - ⭐ 663
...
418. **[mcp-clickhouse](https://github.com/ClickHouse/mcp-clickhouse)** - ⭐ 661
   Connect ClickHouse to your AI assistants.

419. **[mcp-client-cli](https://github.com/adhikasp/mcp-client-cli)** - ⭐ 660
   A simple CLI to run LLM prompt and implement MCP client.

420. **[yacy_grid_mcp](https://github.com/yacy/yacy_grid_mcp)** - ⭐ 654
   The YaCy Grid Master Connect Program

421. **[android-mcp-server](https://github.com/minhalvp/android-mcp-server)** - ⭐ 647
   An MCP server that provides control over Android devices via adb

422. **[mcp](https://github.com/laravel/mcp)** - ⭐ 646
   Rapidly build MCP servers for your Laravel applications.

423. **[cuga-agent](https://github.com/cuga-project/cuga-agent)** - ⭐ 646
...
424. **[laravel-restify](https://github.com/BinarCode/laravel-restify)** - ⭐ 645
   Laravel API for Ai Agents and humans.

425. **[claude-code-plugins-plus](https://github.com/jeremylongshore/claude-code-plugins-plus)** - ⭐ 641
...
426. **[open-ptc-agent](https://github.com/Chen-zexi/open-ptc-agent)** - ⭐ 641
   An open source implementation of code execution with MCP (Programatic Tool Calling) 

427. **[llm-search](https://github.com/snexus/llm-search)** - ⭐ 641
   Querying local documents, powered by LLM

428. **[enrichmcp](https://github.com/featureform/enrichmcp)** - ⭐ 641
   EnrichMCP is a python framework for building data driven MCP servers

429. **[mcp_excalidraw](https://github.com/yctimlin/mcp_excalidraw)** - ⭐ 639

430. **[mcp-mem0](https://github.com/coleam00/mcp-mem0)** - ⭐ 637
   MCP server for long term agent memory with Mem0. Also useful as a template to get you started building your own MCP server with Python!

431. **[awesome-mcp-security](https://github.com/Puliczek/awesome-mcp-security)** - ⭐ 637
   🔥🔒 Awesome MCP (Model Context Protocol) Security 🖥️

432. **[RAGLight](https://github.com/Bessouat40/RAGLight)** - ⭐ 635
   RAGLight is a modular framework for Retrieval-Augmented Generation (RAG). It makes it easy to plug in different LLMs, embeddings, and vector stores, and now includes seamless MCP integration to connect external tools and data sources.

433. **[python-utcp](https://github.com/universal-tool-calling-protocol/python-utcp)** - ⭐ 634
   Official python implementation of UTCP. UTCP is an open standard that lets AI agents call any API directly, without extra middleware.

434. **[wcgw](https://github.com/rusiaaman/wcgw)** - ⭐ 633
   Shell and coding agent on mcp clients

435. **[obsidian-mcp](https://github.com/StevenStavrakis/obsidian-mcp)** - ⭐ 627
   A simple MCP server for Obsidian

436. **[gcloud-mcp](https://github.com/googleapis/gcloud-mcp)** - ⭐ 627
   gcloud MCP server

437. **[voicemode](https://github.com/mbailey/voicemode)** - ⭐ 624
   Natural voice conversations with Claude

438. **[mcp-proxy](https://github.com/TBXark/mcp-proxy)** - ⭐ 623
   An MCP proxy server that aggregates and serves multiple MCP resource servers through a single HTTP server.

439. **[samples](https://github.com/strands-agents/samples)** - ⭐ 619
   Agent samples built using the Strands Agents SDK.

440. **[workers-mcp](https://github.com/cloudflare/workers-mcp)** - ⭐ 617
   Talk to a Cloudflare Worker from Claude Desktop!

441. **[mcp-google-sheets](https://github.com/xing5/mcp-google-sheets)** - ⭐ 615
   This MCP server integrates with your Google Drive and Google Sheets, to enable creating and modifying spreadsheets.

442. **[phpMyFAQ](https://github.com/thorsten/phpMyFAQ)** - ⭐ 611
   phpMyFAQ - Open Source FAQ web application for PHP 8.3+ and MySQL, PostgreSQL and other databases

443. **[telegram-mcp](https://github.com/chigwell/telegram-mcp)** - ⭐ 608
   Telegram MCP server powered by Telethon to let MCP clients read chats, manage groups, and send/modify messages, media, contacts, and settings.

444. **[mem-agent-mcp](https://github.com/firstbatchxyz/mem-agent-mcp)** - ⭐ 603
   mem-agent mcp server

445. **[mcp-server-elasticsearch](https://github.com/elastic/mcp-server-elasticsearch)** - ⭐ 602

446. **[zypher-agent](https://github.com/corespeed-io/zypher-agent)** - ⭐ 594
   A minimal yet powerful framework for creating AI agents with full control over tools, providers, and execution flow.

447. **[vibe](https://github.com/mondaycom/vibe)** - ⭐ 594
   🎨 Vibe Design System - Official monday.com UI resources for application development in React.js

448. **[awesome-web3-mcp-servers](https://github.com/demcp/awesome-web3-mcp-servers)** - ⭐ 594
...
449. **[mcp-link](https://github.com/automation-ai-labs/mcp-link)** - ⭐ 594
   Convert Any OpenAPI V3 API to MCP Server

450. **[FantasyPremierLeague](https://github.com/joreilly/FantasyPremierLeague)** - ⭐ 593
   Fantasy Premier League Kotlin/Compose Multiplatform sample 

451. **[yargi-mcp](https://github.com/saidsurucu/yargi-mcp)** - ⭐ 593
   MCP Server For Turkish Legal Databases

452. **[a-share-mcp-is-just-i-need](https://github.com/24mlight/a-share-mcp-is-just-i-need)** - ⭐ 592

453. **[mcp-filesystem-server](https://github.com/mark3labs/mcp-filesystem-server)** - ⭐ 586
   Go server implementing Model Context Protocol (MCP) for filesystem operations.

454. **[FLUJO](https://github.com/mario-andreschak/FLUJO)** - ⭐ 586
   MCP-Hub and -Inspector, Multi-Model Workflow and Chat Interface 

455. **[daydreams](https://github.com/daydreamsai/daydreams)** - ⭐ 583
   Daydreams is a set of tools for building agents for commerce

456. **[tome](https://github.com/runebookai/tome)** - ⭐ 583
   a magical LLM desktop client that makes it easy for *anyone* to use LLMs and MCP

457. **[FofaMap](https://github.com/asaotomo/FofaMap)** - ⭐ 581
...
458. **[drawio-mcp-server](https://github.com/lgazo/drawio-mcp-server)** - ⭐ 581
   Draw.io Model Context Protocol (MCP) Server

459. **[CyberStrikeAI](https://github.com/Ed1s0nZ/CyberStrikeAI)** - ⭐ 580
   CyberStrikeAI is an AI-native security testing platform built in Go. It integrates 100+ security tools, an intelligent orchestration engine, role-based testing with predefined security roles, a skills system with specialized testing skills, and comprehensive lifecycle management capabilities.

460. **[mcpcan](https://github.com/Kymo-MCP/mcpcan)** - ⭐ 577
...
461. **[dexto](https://github.com/truffle-ai/dexto)** - ⭐ 575
   A coding agent and general agent harness for building and orchestrating agentic applications.

462. **[blueprint-mcp](https://github.com/ArcadeAI/blueprint-mcp)** - ⭐ 575
   Diagram generation for understanding codebases and system architecture using Nano Banana Pro.

463. **[obot](https://github.com/obot-platform/obot)** - ⭐ 572
   Complete MCP Platform -- Hosting, Registry, Gateway, and Chat Client

464. **[langgraph-mcp](https://github.com/esxr/langgraph-mcp)** - ⭐ 571
   LangGraph solution template for MCP

465. **[mem0-mcp](https://github.com/mem0ai/mem0-mcp)** - ⭐ 568

466. **[macos-automator-mcp](https://github.com/steipete/macos-automator-mcp)** - ⭐ 563
   An MCP server to run AppleScript and JXA (JavaScript for Automation) to macOS.

467. **[MCP-Nest](https://github.com/rekog-labs/MCP-Nest)** - ⭐ 560
   A NestJS module to effortlessly create Model Context Protocol (MCP) servers for exposing AI tools, resources, and prompts.

468. **[spotify-mcp](https://github.com/varunneal/spotify-mcp)** - ⭐ 559
   MCP to connect your LLM with Spotify.

469. **[mcp-pointer](https://github.com/etsd-tech/mcp-pointer)** - ⭐ 555
   MCP tool: let you point at DOM elements for your favorite agentic coding tool. Let AI see what you see.

470. **[mcp-sequentialthinking-tools](https://github.com/spences10/mcp-sequentialthinking-tools)** - ⭐ 554
   🧠 An adaptation of the MCP Sequential Thinking Server to guide tool usage. This server provides recommendations for which MCP tools would be most effective at each stage.

471. **[paper-search-mcp](https://github.com/openags/paper-search-mcp)** - ⭐ 554
   A MCP for searching and downloading academic papers from multiple sources like arXiv, PubMed, bioRxiv, etc.

472. **[MCP-Universe](https://github.com/SalesforceAIResearch/MCP-Universe)** - ⭐ 548
   MCP-Universe is a comprehensive framework designed for developing, testing, and benchmarking AI agents

473. **[mcp-handler](https://github.com/vercel/mcp-handler)** - ⭐ 547
   Easily spin up an MCP Server on Next.js, Nuxt, Svelte, and more

474. **[obsidian-mcp-tools](https://github.com/jacksteamdev/obsidian-mcp-tools)** - ⭐ 546
   Add Obsidian integrations like semantic search and custom Templater prompts to Claude or any MCP client.

475. **[douyin-mcp-server](https://github.com/yzfly/douyin-mcp-server)** - ⭐ 546
   提取抖音无水印视频链接，视频文案，douyin-mcp-server

476. **[mcp-shield](https://github.com/riseandignite/mcp-shield)** - ⭐ 544
   Security scanner for MCP servers

477. **[brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server)** - ⭐ 544

478. **[manim-mcp-server](https://github.com/abhiemj/manim-mcp-server)** - ⭐ 542

479. **[LLMTornado](https://github.com/lofcz/LLMTornado)** - ⭐ 541
   The .NET library to build AI agents with 25+ built-in connectors.

480. **[next-devtools-mcp](https://github.com/vercel/next-devtools-mcp)** - ⭐ 541
   Next.js Development for Coding Agent

481. **[vite-plugin-vue-mcp](https://github.com/webfansplz/vite-plugin-vue-mcp)** - ⭐ 539
   Vite plugin that enables a MCP server helping models to understand your Vue app better.

482. **[mcp-server-neon](https://github.com/neondatabase/mcp-server-neon)** - ⭐ 539
   MCP server for interacting with Neon Management API and databases

483. **[evo-ai](https://github.com/EvolutionAPI/evo-ai)** - ⭐ 538
   Evo AI is an open-source platform for creating and managing AI agents, enabling integration with different AI models and services.

484. **[mcp-for-security](https://github.com/cyproxio/mcp-for-security)** - ⭐ 537
   MCP for Security: A collection of Model Context Protocol servers for popular security tools like SQLMap, FFUF, NMAP, Masscan and more. Integrate security testing and penetration testing into AI workflows.

485. **[google-search](https://github.com/web-agent-master/google-search)** - ⭐ 533
   A Playwright-based Node.js tool that bypasses search engine anti-scraping mechanisms to execute Google searches. Local alternative to SERP APIs with MCP server integration.

486. **[dolphin-mcp](https://github.com/QuixiAI/dolphin-mcp)** - ⭐ 532

487. **[pg-mcp-server](https://github.com/stuzero/pg-mcp-server)** - ⭐ 532

488. **[wren-engine](https://github.com/Canner/wren-engine)** - ⭐ 532
   🤖 The Semantic Engine for Model Context Protocol(MCP) Clients and AI Agents 🔥 

489. **[fastapi-mcp-langgraph-template](https://github.com/NicholasGoh/fastapi-mcp-langgraph-template)** - ⭐ 531
   A modern template for agentic orchestration — built for rapid iteration and scalable deployment using highly customizable, community-supported tools like MCP, LangGraph, and more.

490. **[tda](https://github.com/irockel/tda)** - ⭐ 530
   TDA - Thread Dump Analyzer

491. **[cclsp](https://github.com/ktnyt/cclsp)** - ⭐ 528
   Claude Code LSP: enhance your Claude Code experience with non-IDE dependent LSP integration.

492. **[multimodal-agents-course](https://github.com/the-ai-merge/multimodal-agents-course)** - ⭐ 527
   An MCP Multimodal AI Agent with eyes and ears!

493. **[awesome-mcp-servers](https://github.com/TensorBlock/awesome-mcp-servers)** - ⭐ 527
   A comprehensive collection of Model Context Protocol (MCP) servers

494. **[mcp-server-data-exploration](https://github.com/reading-plus-ai/mcp-server-data-exploration)** - ⭐ 522

495. **[echokit_server](https://github.com/second-state/echokit_server)** - ⭐ 522
   Open Source Voice Agent Platform

496. **[homeassistant-mcp](https://github.com/tevonsb/homeassistant-mcp)** - ⭐ 522
   A MCP server for Home Assistant

497. **[mcp.el](https://github.com/lizqwerscott/mcp.el)** - ⭐ 521
   An Mcp client inside Emacs

498. **[cloud-run-mcp](https://github.com/GoogleCloudPlatform/cloud-run-mcp)** - ⭐ 521
   MCP server to deploy apps to Cloud Run

499. **[sentry-mcp](https://github.com/getsentry/sentry-mcp)** - ⭐ 519
   An MCP server for interacting with Sentry via LLMs.

500. **[ethora](https://github.com/dappros/ethora)** - ⭐ 518
...
501. **[pgmcp](https://github.com/subnetmarco/pgmcp)** - ⭐ 518
   An MCP server to query any Postgres database in natural language.

502. **[nuwax](https://github.com/nuwax-ai/nuwax)** - ⭐ 517
...
503. **[ghostcrew](https://github.com/GH05TCREW/ghostcrew)** - ⭐ 515
...
504. **[apple-doc-mcp](https://github.com/MightyDillah/apple-doc-mcp)** - ⭐ 515
   MCP server providing seamless access to Apple Developer Documentation with smart search and wildcard support

505. **[gateway](https://github.com/centralmind/gateway)** - ⭐ 514
   Universal MCP-Server for your Databases optimized for LLMs and AI-Agents.

506. **[Mantic.sh](https://github.com/marcoaapfortes/Mantic.sh)** - ⭐ 514
   A structural code search engine for Al agents.

507. **[line-bot-mcp-server](https://github.com/line/line-bot-mcp-server)** - ⭐ 513
   MCP server that integrates the LINE Messaging API to connect an AI Agent to the LINE Official Account.

508. **[ida-mcp-server](https://github.com/MxIris-Reverse-Engineering/ida-mcp-server)** - ⭐ 513
   A Model Context Protocol server for IDA

509. **[iterm-mcp](https://github.com/ferrislucas/iterm-mcp)** - ⭐ 512
   A Model Context Protocol server that executes commands in the current iTerm session - useful for REPL and CLI assistance

510. **[apple-health-mcp](https://github.com/neiltron/apple-health-mcp)** - ⭐ 511
   MCP server for querying Apple Health data with natural language and SQL

511. **[notebooklm-mcp](https://github.com/PleasePrompto/notebooklm-mcp)** - ⭐ 511
   MCP server for NotebookLM - Let your AI agents (Claude Code, Codex) research documentation directly with grounded, citation-backed answers from Gemini. Persistent auth, library management, cross-client sharing. Zero hallucinations, just your knowledge base.

512. **[mcp-server-weread](https://github.com/freestylefly/mcp-server-weread)** - ⭐ 508
   微信读书MCP

513. **[browserwing](https://github.com/browserwing/browserwing)** - ⭐ 508
...
514. **[multimodal-agents-course](https://github.com/multi-modal-ai/multimodal-agents-course)** - ⭐ 507
   An MCP Multimodal AI Agent with eyes and ears!

515. **[openapi-mcp-generator](https://github.com/harsha-iiiv/openapi-mcp-generator)** - ⭐ 506
   A tool that converts OpenAPI specifications to MCP server

516. **[reverse-engineering-assistant](https://github.com/cyberkaida/reverse-engineering-assistant)** - ⭐ 506
   MCP server for reverse engineering tasks in Ghidra 👩‍💻

517. **[mcp-get](https://github.com/michaellatman/mcp-get)** - ⭐ 503

518. **[mcp-client-for-ollama](https://github.com/jonigl/mcp-client-for-ollama)** - ⭐ 502
   A text-based user interface (TUI) client for interacting with MCP servers using Ollama. Features include agent mode, multi-server, model switching, streaming responses, tool management, human-in-the-loop, thinking mode, model params config, MCP prompts, custom system prompt and saved preferences. Built for developers working with local LLMs.

519. **[mcp-server-bash-sdk](https://github.com/muthuishere/mcp-server-bash-sdk)** - ⭐ 501
   Yes Mcp server in bash

520. **[awesome-a2a](https://github.com/ai-boost/awesome-a2a)** - ⭐ 498
   Agent2Agent (A2A) – awesome A2A agents, tools, servers & clients, all in one place.

521. **[UnityMCP](https://github.com/jackwrichards/UnityMCP)** - ⭐ 497

522. **[TuriX-CUA](https://github.com/TurixAI/TuriX-CUA)** - ⭐ 495
   This is the official website for TuriX Computer-use-Agent

523. **[PentestAgent](https://github.com/GH05TCREW/PentestAgent)** - ⭐ 493
...
524. **[MCPSpy](https://github.com/alex-ilgayev/MCPSpy)** - ⭐ 492
   MCP Monitoring with eBPF

525. **[UnityMCP](https://github.com/Arodoid/UnityMCP)** - ⭐ 491

526. **[davinci-resolve-mcp](https://github.com/samuelgursky/davinci-resolve-mcp)** - ⭐ 491
   MCP server integration for DaVinci Resolve

527. **[web-agent-protocol](https://github.com/OTA-Tech-AI/web-agent-protocol)** - ⭐ 490
   🌐Web Agent Protocol (WAP) - Record and replay user interactions in the browser with MCP support

528. **[mcp-youtube](https://github.com/anaisbetts/mcp-youtube)** - ⭐ 490
   A Model-Context Protocol Server for YouTube

529. **[archestra](https://github.com/archestra-ai/archestra)** - ⭐ 488
   Enterprise-ready MCP gateway, MCP registry & orchestrator

530. **[UnrealMCP](https://github.com/kvick-games/UnrealMCP)** - ⭐ 483
   MCP to allow AI agents to control Unreal

531. **[rails-mcp-server](https://github.com/maquina-app/rails-mcp-server)** - ⭐ 483
   A Ruby gem implementation of a Model Context Protocol (MCP) server for Rails projects. This server allows LLMs (Large Language Models) to interact with Rails projects through the Model Context Protocol.

532. **[claude-debugs-for-you](https://github.com/jasonjmcghee/claude-debugs-for-you)** - ⭐ 482
   Enable any LLM (e.g. Claude) to interactively debug any language for you via MCP and a VS Code Extension

533. **[mcp-pandoc](https://github.com/vivekVells/mcp-pandoc)** - ⭐ 482
   MCP server for document format conversion using pandoc.

534. **[haiku.rag](https://github.com/ggozad/haiku.rag)** - ⭐ 479
   Opinionated agentic RAG powered by LanceDB, Pydantic AI, and Docling

535. **[talk-to-girlfriend-ai](https://github.com/arlanrakh/talk-to-girlfriend-ai)** - ⭐ 476
   im busy building ai agents so why not let an ai talk to my girlfriend? 

536. **[llm-mcp-rag](https://github.com/KelvinQiu802/llm-mcp-rag)** - ⭐ 475
   LLM + MCP + RAG = Magic

537. **[AnyTool](https://github.com/HKUDS/AnyTool)** - ⭐ 474
   "AnyTool: Universal Tool-Use Layer for AI Agents"

538. **[web-search-mcp](https://github.com/mrkrsl/web-search-mcp)** - ⭐ 474
   A simple, locally hosted Web Search MCP server for use with Local LLMs

539. **[mcp-gsuite](https://github.com/MarkusPfundstein/mcp-gsuite)** - ⭐ 473
   MCP Server to interact with Google Gsuite prodcuts

540. **[cli](https://github.com/smithery-ai/cli)** - ⭐ 472
   Install, manage and develop MCP servers

541. **[chroma-mcp](https://github.com/chroma-core/chroma-mcp)** - ⭐ 472
   A Model Context Protocol (MCP) server implementation that provides database capabilities for Chroma

542. **[n8n-workflow-builder](https://github.com/makafeli/n8n-workflow-builder)** - ⭐ 472
   AI assistant integration for n8n workflow automation through Model Context Protocol (MCP). Connect Claude Desktop, ChatGPT, and other AI assistants to n8n for natural language workflow management.

543. **[freecad-mcp](https://github.com/neka-nat/freecad-mcp)** - ⭐ 471
   FreeCAD MCP(Model Context Protocol) server

544. **[open-multi-agent-canvas](https://github.com/CopilotKit/open-multi-agent-canvas)** - ⭐ 470
   The open-source multi-agent chat interface that lets you manage multiple agents in one dynamic conversation and add MCP servers for deep research

545. **[aser](https://github.com/AmeNetwork/aser)** - ⭐ 470
   Aser is a lightweight, self-assembling AI Agent frame.

546. **[borsa-mcp](https://github.com/saidsurucu/borsa-mcp)** - ⭐ 468
   MCP Server for Turkish & American Stock Exchange and Fund Data

547. **[laravel](https://github.com/php-mcp/laravel)** - ⭐ 467
   An SDK building Laravel MCP servers

548. **[dbt-mcp](https://github.com/dbt-labs/dbt-mcp)** - ⭐ 467
   A MCP (Model Context Protocol) server for interacting with dbt.

549. **[clickup-mcp-server](https://github.com/taazkareem/clickup-mcp-server)** - ⭐ 462
   ClickUp MCP Server - Integrate ClickUp project management with AI through Model Context Protocol

550. **[copilot-mcp](https://github.com/VikashLoomba/copilot-mcp)** - ⭐ 462
...
551. **[argo](https://github.com/xark-argo/argo)** - ⭐ 462
   ARGO is an open-source AI Agent platform that brings Local Manus to your desktop. With one-click model downloads, seamless closed LLM integration, and offline-first RAG knowledge bases, ARGO becomes a DeepResearch powerhouse for autonomous thinking, task planning, and 100% of your data stays locally. Support Win/Mac/Docker.

552. **[doctor](https://github.com/sisig-ai/doctor)** - ⭐ 461
   Doctor is a tool for discovering, crawl, and indexing web sites to be exposed as an MCP server for LLM agents.

553. **[atlas-mcp-server](https://github.com/cyanheads/atlas-mcp-server)** - ⭐ 461
   A Model Context Protocol (MCP) server for ATLAS, a Neo4j-powered task management system for LLM Agents - implementing a three-tier architecture (Projects, Tasks, Knowledge) to manage complex workflows. Now with Deep Research.

554. **[deeppowers](https://github.com/deeppowers/deeppowers)** - ⭐ 460
...
555. **[alpaca-mcp-server](https://github.com/alpacahq/alpaca-mcp-server)** - ⭐ 459
   Alpaca’s official MCP Server lets you trade stocks, ETFs, crypto, and options, run data analysis, and build strategies in plain English directly from your favorite LLM tools and IDEs

556. **[MCP-Kali-Server](https://github.com/Wh0am123/MCP-Kali-Server)** - ⭐ 458
   MCP configuration to connect AI agent to a Linux machine.

557. **[bm.md](https://github.com/miantiao-me/bm.md)** - ⭐ 457
   更好用的 Markdown 排版助手｜一键适配微信公众号、网页与图片。

558. **[director](https://github.com/director-run/director)** - ⭐ 456
   MCP Playbooks for AI agents

559. **[vibe-check-mcp-server](https://github.com/PV-Bhat/vibe-check-mcp-server)** - ⭐ 454
   Vibe Check is a tool that provides mentor-like feedback to AI Agents, preventing tunnel-vision, over-engineering and reasoning lock-in for complex and long-horizon agent workflows. KISS your over-eager AI Agents goodbye! Effective for: Coding, Ambiguous Tasks, High-Risk tasks

560. **[flux-operator](https://github.com/controlplaneio-fluxcd/flux-operator)** - ⭐ 454
   GitOps on Autopilot Mode

561. **[mcp-adapter](https://github.com/WordPress/mcp-adapter)** - ⭐ 454
   An MCP adapter that bridges the Abilities API to the Model Context Protocol, enabling MCP clients to discover and invoke WordPress plugin, theme, and core abilities programmatically.

562. **[nexus](https://github.com/Nexus-Router/nexus)** - ⭐ 452
   Govern & Secure your AI

563. **[mcp-remote-macos-use](https://github.com/baryhuang/mcp-remote-macos-use)** - ⭐ 450
   The only general AI agent that does NOT requires extra API key, giving you full control on your local and remote MacOs from Claude Desktop App

564. **[adb-mcp](https://github.com/mikechambers/adb-mcp)** - ⭐ 448

565. **[nexus](https://github.com/grafbase/nexus)** - ⭐ 446
   Govern & Secure your AI

566. **[nexus](https://github.com/nexus-ai-labs/nexus)** - ⭐ 446
   Govern & Secure your AI

567. **[minecraft-mcp-server](https://github.com/yuniko-software/minecraft-mcp-server)** - ⭐ 446
   A Minecraft MCP Server powered by Mineflayer API. It allows to control a Minecraft character in real-time, allowing AI assistants to build structures, explore the world, and interact with the game environment through natural language instruction

568. **[docker-mcp](https://github.com/QuantGeekDev/docker-mcp)** - ⭐ 446
   A docker MCP Server (modelcontextprotocol)

569. **[mcp-server-youtube-transcript](https://github.com/kimtaeyoon83/mcp-server-youtube-transcript)** - ⭐ 446
   This is an MCP server that allows you to directly download transcripts of YouTube videos.

570. **[pdf-reader-mcp](https://github.com/SylphxAI/pdf-reader-mcp)** - ⭐ 445
   📄 Production-ready MCP server for PDF processing - 5-10x faster with parallel processing and 94%+ test coverage

571. **[mcpe](https://github.com/ReMinecraftPE/mcpe)** - ⭐ 444
   ReMinecraftPE - A custom experience based on Minecraft PE as of 2011.

572. **[MCP-Zero](https://github.com/xfey/MCP-Zero)** - ⭐ 439
   MCP-Zero: Active Tool Discovery for Autonomous LLM Agents

573. **[mcp-server](https://github.com/PortSwigger/mcp-server)** - ⭐ 439
   MCP Server for Burp

574. **[ai-trader](https://github.com/whchien/ai-trader)** - ⭐ 439
   Backtrader-powered backtesting framework for algorithmic trading, featuring 20+ strategies, multi-market support, CLI tools, and an integrated MCP server for professional traders.

575. **[notebooklm-mcp](https://github.com/jacob-bd/notebooklm-mcp)** - ⭐ 434

576. **[mcp-send-email](https://github.com/resend/mcp-send-email)** - ⭐ 433
   Send emails directly from Cursor with this email sending MCP server

577. **[mcp-bench](https://github.com/Accenture/mcp-bench)** - ⭐ 433
   MCP-Bench: Benchmarking Tool-Using LLM Agents with Complex Real-World Tasks via MCP Servers

578. **[tsidp](https://github.com/tailscale/tsidp)** - ⭐ 432
   A simple OIDC / OAuth Identity Provider (IdP) server for your tailnet.

579. **[mcp-gateway](https://github.com/microsoft/mcp-gateway)** - ⭐ 432
   MCP Gateway is a reverse proxy and management layer for MCP servers, enabling scalable, session-aware stateful routing and lifecycle management of MCP servers in Kubernetes environments.

580. **[youtube-mcp-server](https://github.com/ZubeidHendricks/youtube-mcp-server)** - ⭐ 431
   MCP Server for YouTube API, enabling video management, Shorts creation, and advanced analytics

581. **[mcp-security](https://github.com/google/mcp-security)** - ⭐ 430

582. **[MetasploitMCP](https://github.com/GH05TCREW/MetasploitMCP)** - ⭐ 430
   MCP Server for Metasploit

583. **[meta-ads-mcp](https://github.com/pipeboard-co/meta-ads-mcp)** - ⭐ 428
   MCP server to manage Facebook and Instagram Ads (Meta Ads)

584. **[MCP](https://github.com/jina-ai/MCP)** - ⭐ 428
   Official Jina AI Remote MCP Server

585. **[Godot-MCP](https://github.com/ee0pdt/Godot-MCP)** - ⭐ 427
   An MCP for Godot that lets you create and edit games in the Godot game engine with tools like Claude

586. **[mcp-hub](https://github.com/ravitemer/mcp-hub)** - ⭐ 423
   A centralized manager for Model Context Protocol (MCP) servers with dynamic server management and monitoring

587. **[xhs-mcp](https://github.com/jobsonlook/xhs-mcp)** - ⭐ 422
   小红书MCP服务 x-s x-t js逆向

588. **[joinly](https://github.com/joinly-ai/joinly)** - ⭐ 421
   Make your meetings accessible to AI Agents

589. **[mcpstore](https://github.com/whillhill/mcpstore)** - ⭐ 421
   开盒即用的优雅管理mcp服务 | 结合Agent框架 | 作者听劝 | 已发布pypi | Vue页面demo 

590. **[kratos-transport](https://github.com/tx7do/kratos-transport)** - ⭐ 420
   kratos transport layer extension, support: rabbitmq,kafka,rocketmq,activemq,apollo,mcp,tcp,websocket...

591. **[mcp-server-spec-driven-development](https://github.com/formulahendry/mcp-server-spec-driven-development)** - ⭐ 419
   Spec-Driven Development MCP Server, not just Vibe Coding

592. **[AgentX](https://github.com/lucky-aeon/AgentX)** - ⭐ 419
   AgentX 致力于让小白也能无门槛通过自然语言打造属于自己的 Agent。AgentX 采用了自研 MCP 网关，模型高可用组件打造高可用

593. **[sdk-typescript](https://github.com/strands-agents/sdk-typescript)** - ⭐ 418
   A model-driven approach to building AI agents in just a few lines of code. 

594. **[skybridge](https://github.com/alpic-ai/skybridge)** - ⭐ 417
   Skybridge is a framework for building ChatGPT & MCP Apps

595. **[learn-low-code-agentic-ai](https://github.com/panaversity/learn-low-code-agentic-ai)** - ⭐ 415
...
596. **[mcpadapt](https://github.com/grll/mcpadapt)** - ⭐ 415
   Unlock 650+ MCP servers tools in your favorite agentic framework.

597. **[ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server)** - ⭐ 413
   A Model Context Protocol (MCP) server for interacting with Microsoft 365 and Office services through the Graph API

598. **[shinkai-local-ai-agents](https://github.com/dcSpark/shinkai-local-ai-agents)** - ⭐ 411
...
599. **[kmcp](https://github.com/kagent-dev/kmcp)** - ⭐ 410
   CLI tool and Kubernetes Controller for building, testing and deploying MCP servers

600. **[applescript-mcp](https://github.com/peakmojo/applescript-mcp)** - ⭐ 410
   MCP server that execute applescript giving you full control of your Mac

601. **[mcp-cli](https://github.com/wong2/mcp-cli)** - ⭐ 409
   A CLI inspector for the Model Context Protocol

602. **[mcp-nixos](https://github.com/utensils/mcp-nixos)** - ⭐ 409
   MCP-NixOS - Model Context Protocol Server for NixOS resources

603. **[azure-ai-travel-agents](https://github.com/Azure-Samples/azure-ai-travel-agents)** - ⭐ 408
...
604. **[NetCoreKevin](https://github.com/junkai-li/NetCoreKevin)** - ⭐ 407
...
605. **[mcp-registry](https://github.com/docker/mcp-registry)** - ⭐ 407
   Official Docker MCP registry 

606. **[cocos-mcp-server](https://github.com/DaxianLee/cocos-mcp-server)** - ⭐ 407
...
607. **[awesome-mcp-devtools](https://github.com/punkpeye/awesome-mcp-devtools)** - ⭐ 406
   A curated list of developer tools, SDKs, libraries, and testing utilities for Model Context Protocol (MCP) server development.

608. **[CoexistAI](https://github.com/SPThole/CoexistAI)** - ⭐ 405
   CoexistAI is a modular, developer-friendly research assistant framework . It enables you to build, search, summarize, and automate research workflows using LLMs, web search, Reddit, YouTube, and mapping tools—all with simple MCP tool calls or API calls or Python functions. 

609. **[mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry)** - ⭐ 405
...
610. **[RestClient.Net](https://github.com/MelbourneDeveloper/RestClient.Net)** - ⭐ 402
   The safest way to make REST calls in C# with an MCP Generator

611. **[GhidrAssistMCP](https://github.com/jtang613/GhidrAssistMCP)** - ⭐ 402
   An MCP extension for Ghidra

612. **[mcp-server-motherduck](https://github.com/motherduckdb/mcp-server-motherduck)** - ⭐ 402
   MCP server for DuckDB and MotherDuck

613. **[mcp-searxng](https://github.com/ihor-sokoliuk/mcp-searxng)** - ⭐ 401
   MCP Server for SearXNG

614. **[mcp-redis](https://github.com/redis/mcp-redis)** - ⭐ 401
   The official Redis MCP Server is a natural language interface designed for agentic applications to manage and search data in Redis efficiently

615. **[biomcp](https://github.com/genomoncology/biomcp)** - ⭐ 395
   BioMCP: Biomedical Model Context Protocol

616. **[Software-planning-mcp](https://github.com/NightTrek/Software-planning-mcp)** - ⭐ 394
   An experiment in software planning using MCP

617. **[airtable-mcp-server](https://github.com/domdomegg/airtable-mcp-server)** - ⭐ 394
   🗂️🤖 Airtable Model Context Protocol Server, for allowing AI systems to interact with your Airtable bases

618. **[FinanceMCP](https://github.com/guangxiangdebizi/FinanceMCP)** - ⭐ 393
...
619. **[mcp](https://github.com/baidu-maps/mcp)** - ⭐ 391
   Baidu Map MCP Server

620. **[cupertino](https://github.com/mihaelamj/cupertino)** - ⭐ 391
   A local Apple Documentation crawler and MCP server. Written in Swift.

621. **[mineru-tianshu](https://github.com/magicyuan876/mineru-tianshu)** - ⭐ 389
   天枢 - 企业级 AI 一站式数据预处理平台 | PDF/Office转Markdown | 支持MCP协议AI助手集成 | Vue3+FastAPI全栈方案 | 文档解析 | 多模态信息提取

622. **[lunar](https://github.com/TheLunarCompany/lunar)** - ⭐ 389
   lunar.dev: Agent native MCP Gateway for governance and security

623. **[memento-mcp](https://github.com/gannonh/memento-mcp)** - ⭐ 388
   Memento MCP: A Knowledge Graph Memory System for LLMs

624. **[chatluna](https://github.com/ChatLunaLab/chatluna)** - ⭐ 388
...
625. **[docfork](https://github.com/docfork/docfork)** - ⭐ 388
   Docfork - Up-to-date Docs for AI Agents.

626. **[mcp-alchemy](https://github.com/runekaagaard/mcp-alchemy)** - ⭐ 386
   A MCP (model context protocol) server that gives the LLM access to and knowledge about relational databases like SQLite, Postgresql, MySQL & MariaDB, Oracle, and MS-SQL.

627. **[codexia](https://github.com/milisp/codexia)** - ⭐ 385
   A powerfull GUI and Toolkit for Codex CLI + Claude Code. FileTree + prompt notepad + git worktree and more

628. **[lark-openapi-mcp](https://github.com/larksuite/lark-openapi-mcp)** - ⭐ 384
   飞书/Lark官方 OpenAPI MCP

629. **[groq-desktop-beta](https://github.com/groq/groq-desktop-beta)** - ⭐ 381
   Local Groq Desktop chat app with MCP support

630. **[ai4j](https://github.com/LnYo-Cly/ai4j)** - ⭐ 381
...
631. **[MCP-SecurityTools](https://github.com/Ta0ing/MCP-SecurityTools)** - ⭐ 381
   MCP-SecurityTools 是一个专注于收录和更新网络安全领域 MCP 的开源项目，旨在汇总、整理和优化各类与 MCP 相关的安全工具、技术及实战经验。

632. **[unreal-engine-mcp](https://github.com/flopperam/unreal-engine-mcp)** - ⭐ 381
...
633. **[lanhu-mcp](https://github.com/dsphper/lanhu-mcp)** - ⭐ 381
   ⚡ 需求分析效率提升 200%！全球首个为 AI 编程时代设计的团队协作 MCP 服务器，自动分析需求自动编写前后端代码，下载切图

634. **[mcp-hfspace](https://github.com/evalstate/mcp-hfspace)** - ⭐ 378
   MCP Server to Use HuggingFace spaces, easy configuration and Claude Desktop mode. 

635. **[station](https://github.com/cloudshipai/station)** - ⭐ 378
   Station is our open-source runtime that lets teams deploy agents on their own infrastructure with full control.

636. **[minion-agent](https://github.com/femto/minion-agent)** - ⭐ 378
   A simple agent framework that's capable of browser use + mcp + auto instrument + plan + deep  research + more

637. **[docling-mcp](https://github.com/docling-project/docling-mcp)** - ⭐ 377
   Making docling agentic through MCP

638. **[mcp-mermaid](https://github.com/hustcc/mcp-mermaid)** - ⭐ 377
   ❤️ Generate mermaid diagram and chart with AI MCP dynamically.

639. **[labs-ai-tools-for-devs](https://github.com/docker/labs-ai-tools-for-devs)** - ⭐ 376
   Your trusted home for discovering MCP tools – seamlessly integrated into Docker

640. **[agent-builder](https://github.com/strands-agents/agent-builder)** - ⭐ 376
   An example agent demonstrating streaming, tool use, and interactivity from your terminal. This agent builder can help you to build your own agents and tools.

641. **[agentscope-runtime](https://github.com/agentscope-ai/agentscope-runtime)** - ⭐ 375
...
642. **[mcp-code-graph](https://github.com/JudiniLabs/mcp-code-graph)** - ⭐ 374
   MCP Server for code graph analysis and visualization by CodeGPT

643. **[Anemoi](https://github.com/Coral-Protocol/Anemoi)** - ⭐ 373
   Anemoi: A Semi-Centralized Multi-agent Systems Based on Agent-to-Agent Communication MCP server from Coral Protocol

644. **[Agentfy](https://github.com/Agentfy-io/Agentfy)** - ⭐ 373
...
645. **[claude-codex-settings](https://github.com/fcakyon/claude-codex-settings)** - ⭐ 373
   My personal Claude Code and OpenAI Codex setup with battle-tested skills, commands, hooks, agents and MCP servers that I use daily.

646. **[docfork-mcp](https://github.com/docfork/docfork-mcp)** - ⭐ 372
   Docfork MCP - Up-to-date Docs for AI Agents.

647. **[mcp-server](https://github.com/e2b-dev/mcp-server)** - ⭐ 372
   Giving Claude ability to run code with E2B via MCP (Model Context Protocol)

648. **[mcpmark](https://github.com/eval-sys/mcpmark)** - ⭐ 372
   MCPMark is a comprehensive, stress-testing MCP benchmark designed to evaluate model and agent capabilities in real-world MCP use.

649. **[bagel](https://github.com/Extelligence-ai/bagel)** - ⭐ 371
   Chat with your robotics, drone, and IoT data — ChatGPT for the physical world.

650. **[kicad-mcp](https://github.com/lamaalrajih/kicad-mcp)** - ⭐ 370
   Model Context Protocol server for KiCad on Mac, Windows, and Linux

651. **[graphlit-mcp-server](https://github.com/graphlit/graphlit-mcp-server)** - ⭐ 370
   Model Context Protocol (MCP) Server for Graphlit Platform

652. **[mcp-google-ads](https://github.com/cohnen/mcp-google-ads)** - ⭐ 370
   An MCP tool that connects Google Ads with Claude AI/Cursor and others, allowing you to analyze your advertising data through natural language conversations. This integration gives you access to campaign information, performance metrics, keyword analytics, and ad management—all through simple chat with Claude, Cursor or Windsurf.

653. **[home-assistant-vibecode-agent](https://github.com/Coolver/home-assistant-vibecode-agent)** - ⭐ 370
...
654. **[mcp-k8s-go](https://github.com/strowk/mcp-k8s-go)** - ⭐ 369
   MCP server connecting to Kubernetes

655. **[UnrealGenAISupport](https://github.com/prajwalshettydev/UnrealGenAISupport)** - ⭐ 368
...
656. **[yutu](https://github.com/eat-pray-ai/yutu)** - ⭐ 367
   A fully functional MCP server and CLI for YouTube

657. **[Redbook-Search-Comment-MCP2.0](https://github.com/chenningling/Redbook-Search-Comment-MCP2.0)** - ⭐ 366
...
658. **[puppeteer-mcp-server](https://github.com/merajmehrabi/puppeteer-mcp-server)** - ⭐ 366
   This MCP server provides browser automation capabilities through Puppeteer, allowing interaction with both new browser instances and existing Chrome windows.

659. **[mnemo](https://github.com/MnemoAI/mnemo)** - ⭐ 365
   A MCP-Ready Intelligence Engine for Data & Agent-as-a-Service.

660. **[mcp-server-airbnb](https://github.com/openbnb-org/mcp-server-airbnb)** - ⭐ 365
   Search Airbnb using your AI Agent

661. **[mcp-obsidian](https://github.com/bitbonsai/mcp-obsidian)** - ⭐ 365
   A lightweight Model Context Protocol (MCP) server for safe Obsidian vault access

662. **[Feishu-MCP](https://github.com/cso1z/Feishu-MCP)** - ⭐ 364
   为 Cursor、Windsurf、Cline 和其他 AI 驱动的编码工具提供访问、编辑和结构化处理飞书文档的能力，基于 Model Context Protocol 服务器实现。

663. **[mcp](https://github.com/mondaycom/mcp)** - ⭐ 364
   Enable AI agents to work reliably - giving them secure access to structured data, tools to take action, and the context needed to make smart decisions.

664. **[mcp-sdk-php](https://github.com/logiscape/mcp-sdk-php)** - ⭐ 361
   Model Context Protocol SDK for PHP

665. **[pokemon-chat](https://github.com/skygazer42/pokemon-chat)** - ⭐ 360
   基于 LightRAG、LangGraph、MCP、RagFlow、微调LLMs宝可梦主题的专有领域智能聊天助手

666. **[awesome-claude-code-plugins](https://github.com/ccplugins/awesome-claude-code-plugins)** - ⭐ 360
   Awesome Claude Code plugins — a curated list of slash commands, subagents, MCP servers, and hooks for Claude Code

667. **[MCPSharp](https://github.com/afrise/MCPSharp)** - ⭐ 359
   MCPSharp is a .NET library that helps you build Model Context Protocol (MCP) servers and clients - the standardized API protocol used by AI assistants and models.

668. **[sonarqube-mcp-server](https://github.com/SonarSource/sonarqube-mcp-server)** - ⭐ 359
   SonarQube MCP Server

669. **[automation-mcp](https://github.com/ashwwwin/automation-mcp)** - ⭐ 357
   Control your Mac with detailed mouse, keyboard, screen, and window management capabilities.

670. **[evm-mcp-server](https://github.com/mcpdotdirect/evm-mcp-server)** - ⭐ 356
   MCP server that provides LLMs with tools for interacting with EVM networks

671. **[mcp2mqtt](https://github.com/mcp2everything/mcp2mqtt)** - ⭐ 356
   本项目通过将 MCP 协议转换为 MQTT 协议，我们能够利用强大的大型语言模型（LLMs），就能轻松操控您的智能家居、机器人或其他硬件设备。

672. **[prism-insight](https://github.com/dragon1086/prism-insight)** - ⭐ 355
   AI-based stock analysis and trading system

673. **[agent](https://github.com/1mcp-app/agent)** - ⭐ 355
   A unified Model Context Protocol server implementation that aggregates multiple MCP servers into one.

674. **[gemini-flow](https://github.com/clduab11/gemini-flow)** - ⭐ 355
   rUv's Claude-Flow, translated to the new Gemini CLI; transforming it into an autonomous AI development team.

675. **[edgeone-pages-mcp](https://github.com/TencentEdgeOne/edgeone-pages-mcp)** - ⭐ 353
   An MCP service designed for deploying HTML content to EdgeOne Pages and obtaining an accessible public URL.

676. **[tfmcp](https://github.com/nwiizo/tfmcp)** - ⭐ 353
   🌍 Terraform Model Context Protocol (MCP) Tool - An experimental CLI tool that enables AI assistants to manage and operate Terraform environments. Supports reading Terraform configurations, analyzing plans, applying configurations, and managing state with Claude Desktop integration. ⚡️

677. **[reddit-mcp-buddy](https://github.com/karanb192/reddit-mcp-buddy)** - ⭐ 353
   Clean, LLM-optimized Reddit MCP server. Browse posts, search content, analyze users. No fluff, just Reddit data.

678. **[applescript-mcp](https://github.com/joshrutkowski/applescript-mcp)** - ⭐ 352
   A macOS AppleScript MCP server

679. **[ableton-live-mcp-server](https://github.com/Simon-Kansara/ableton-live-mcp-server)** - ⭐ 352
   MCP Server implementation for Ableton Live OSC control

680. **[todoist-mcp-server](https://github.com/abhiz123/todoist-mcp-server)** - ⭐ 351
   MCP server for Todoist integration enabling natural language task management with Claude

681. **[mcpr](https://github.com/conikeec/mcpr)** - ⭐ 351
   Model Context Protocol (MCP) implementation in Rust

682. **[OpenContext](https://github.com/0xranx/OpenContext)** - ⭐ 351
...
683. **[CodeGraphContext](https://github.com/CodeGraphContext/CodeGraphContext)** - ⭐ 351
   An MCP server plus a CLI tool that indexes local code into a graph database to provide context to AI assistants.

684. **[mcp-graphql](https://github.com/blurrah/mcp-graphql)** - ⭐ 350
   Model Context Protocol server for GraphQL

685. **[f2c-mcp](https://github.com/f2c-ai/f2c-mcp)** - ⭐ 347
   F2C MCP Server

686. **[xcode-mcp-server](https://github.com/r-huijts/xcode-mcp-server)** - ⭐ 347
   MCP Server implementation for Xcode integration

687. **[mcp-teams-server](https://github.com/InditexTech/mcp-teams-server)** - ⭐ 347
   An MCP (Model Context Protocol) server implementation for Microsoft Teams integration, providing capabilities to read messages, create messages, reply to messages, mention members.

688. **[prometheus-mcp-server](https://github.com/pab1it0/prometheus-mcp-server)** - ⭐ 346
   A Model Context Protocol (MCP) server that enables AI agents and LLMs to query and analyze Prometheus metrics through standardized interfaces.

689. **[twitter-mcp](https://github.com/EnesCinr/twitter-mcp)** - ⭐ 346
   A Model Context Protocol server allows to interact with Twitter, enabling posting tweets and searching Twitter.

690. **[Construction-Hazard-Detection](https://github.com/yihong1120/Construction-Hazard-Detection)** - ⭐ 346
   Enhances construction site safety using YOLO for object detection, identifying hazards like workers without helmets or safety vests, and proximity to machinery or vehicles. HDBSCAN clusters safety cone coordinates to create monitored zones. Post-processing algorithms improve detection accuracy.

691. **[run-model-context-protocol-servers-with-aws-lambda](https://github.com/awslabs/run-model-context-protocol-servers-with-aws-lambda)** - ⭐ 343
   Run existing Model Context Protocol (MCP) stdio-based servers in AWS Lambda functions

692. **[linear-mcp-server](https://github.com/jerhadf/linear-mcp-server)** - ⭐ 342
   A server that integrates Linear's project management system with the Model Context Protocol (MCP) to allow LLMs to interact with Linear.

693. **[RetroMCP-Java](https://github.com/MCPHackers/RetroMCP-Java)** - ⭐ 342
   A rewrite of MCP to provide support for many versions of Minecraft which were never supported by original MCP

694. **[a2a-directory](https://github.com/sing1ee/a2a-directory)** - ⭐ 340
   Agent2Agent (A2A) – AgentCards, Servers, Clients, Docs

695. **[daan](https://github.com/pluveto/daan)** - ⭐ 339
   ✨Lightweight LLM Client with MCP 🔌 & Characters 👤

696. **[awesome-cursor-mpc-server](https://github.com/kleneway/awesome-cursor-mpc-server)** - ⭐ 338
   Example of an MCP server with custom tools that can be called directly from cursor

697. **[base-mcp](https://github.com/base/base-mcp)** - ⭐ 338
   A Model Context Protocol (MCP) server that provides onchain tools for LLMs, allowing them to interact with the Base network and Coinbase API.

698. **[mcp-reddit](https://github.com/adhikasp/mcp-reddit)** - ⭐ 338
   A Model Context Protocol (MCP) server that provides tools for fetching and analyzing Reddit content.

699. **[db-mcp-server](https://github.com/FreePeak/db-mcp-server)** - ⭐ 337
   A powerful multi-database server implementing the Model Context Protocol (MCP) to provide AI assistants with structured access to databases.

700. **[devopness](https://github.com/devopness/devopness)** - ⭐ 337
   DevOps Happiness: 1-click or 1-prompt MCP. Deploy apps + infra + CI/CD on your cloud. Happy humans + reliable agents. 🚀

701. **[obsidian-mcp-server](https://github.com/cyanheads/obsidian-mcp-server)** - ⭐ 337
   Obsidian Knowledge-Management MCP (Model Context Protocol) server that enables AI agents and development tools to interact with an Obsidian vault. It provides a comprehensive suite of tools for reading, writing, searching, and managing notes, tags, and frontmatter, acting as a bridge to the Obsidian Local REST API plugin.

702. **[devtools-debugger-mcp](https://github.com/ScriptedAlchemy/devtools-debugger-mcp)** - ⭐ 336
   An MCP server exposing full Chrome DevTools Protocol debugging: breakpoints, step/run, call stacks, eval, and source maps.

703. **[mcp-gateway](https://github.com/lasso-security/mcp-gateway)** - ⭐ 336
   A plugin-based gateway that orchestrates other MCPs and allows developers to build upon it enterprise-grade agents.

704. **[droidmind](https://github.com/hyperb1iss/droidmind)** - ⭐ 336
   Control your Android devices with AI using Model Context Protocol

705. **[mcp-apple-notes](https://github.com/RafalWilinski/mcp-apple-notes)** - ⭐ 336
   Talk with your notes in Claude. RAG over your Apple Notes using Model Context Protocol.

706. **[mcp-for-next.js](https://github.com/vercel-labs/mcp-for-next.js)** - ⭐ 335

707. **[WebMCP](https://github.com/jasonjmcghee/WebMCP)** - ⭐ 335
...
708. **[revit-mcp](https://github.com/revit-mcp/revit-mcp)** - ⭐ 334
   AI-Powered Revit Modeling

709. **[paws-on-mcp](https://github.com/hemanth/paws-on-mcp)** - ⭐ 332
   A comprehensive Model Context Protocol (MCP) server implementing the latest specification.

710. **[tradingview-mcp](https://github.com/atilaahmettaner/tradingview-mcp)** - ⭐ 332
...
711. **[CodeGraphContext](https://github.com/Shashankss1205/CodeGraphContext)** - ⭐ 331
   An MCP server plus a CLI tool that indexes local code into a graph database to provide context to AI assistants.

712. **[mcp-selenium](https://github.com/angiejones/mcp-selenium)** - ⭐ 331
   An MCP implementation for Selenium WebDriver

713. **[interactive-mcp](https://github.com/ttommyth/interactive-mcp)** - ⭐ 331
   Vibe coding should have human in the loop! interactive-mcp: Local, cross-platform MCP server for interact with your AI Agent

714. **[skillz](https://github.com/intellectronica/skillz)** - ⭐ 331
   An MCP server for loading skills (shim for non-claude clients).

715. **[BloodHound-MCP-AI](https://github.com/MorDavid/BloodHound-MCP-AI)** - ⭐ 331
   BloodHound-MCP-AI is integration that connects BloodHound with AI through Model Context Protocol, allowing security professionals to analyze Active Directory attack paths using natural language instead of complex Cypher queries.

716. **[MemoryMesh](https://github.com/CheMiguel23/MemoryMesh)** - ⭐ 331
   A knowledge graph server that uses the Model Context Protocol (MCP) to provide structured memory persistence for AI models.

717. **[WireMCP](https://github.com/0xKoda/WireMCP)** - ⭐ 331
   An MCP for WireShark (tshark). Empower LLM's with realtime network traffic analysis capability

718. **[hermes-mcp](https://github.com/cloudwalk/hermes-mcp)** - ⭐ 330
   Elixir Model Context Protocol (MCP) SDK

719. **[mcp-calculator](https://github.com/78/mcp-calculator)** - ⭐ 330
   Xiaozhi MCP sample program

720. **[laravel-mcp-server](https://github.com/opgginc/laravel-mcp-server)** - ⭐ 329
   A Laravel package for implementing secure Model Context Protocol servers using Streamable HTTP and SSE transport, providing real-time communication and a scalable tool system for enterprise environments.

721. **[Ace-Mcp-Node](https://github.com/yeuxuan/Ace-Mcp-Node)** - ⭐ 328
...
722. **[open-mcp](https://github.com/wegotdocs/open-mcp)** - ⭐ 327

723. **[mcsmcp](https://github.com/microsoft/mcsmcp)** - ⭐ 326
   Lab for creating an MCP Server and using it in Microsoft Copilot Studio.

724. **[open-skills](https://github.com/instavm/open-skills)** - ⭐ 326
   OpenSkills: Run Claude Skills Locally using any LLM

725. **[css-mcp](https://github.com/stolinski/css-mcp)** - ⭐ 324

726. **[moling](https://github.com/gojue/moling)** - ⭐ 323
   MoLing is a computer-use and browser-use based MCP server. It is a locally deployed, dependency-free office AI assistant.

727. **[Android-MCP](https://github.com/CursorTouch/Android-MCP)** - ⭐ 323
   Lightweight MCP Server for interacting with Android Operating System.

728. **[powerbi-modeling-mcp](https://github.com/microsoft/powerbi-modeling-mcp)** - ⭐ 323
   The Power BI Modeling MCP Server, brings Power BI semantic modeling capabilities to your AI agents.

729. **[Rube](https://github.com/ComposioHQ/Rube)** - ⭐ 322
...
730. **[ha-mcp](https://github.com/homeassistant-ai/ha-mcp)** - ⭐ 322
   The Unofficial and Awesome Home Assistant MCP Server

731. **[vscode-mcp-server](https://github.com/juehang/vscode-mcp-server)** - ⭐ 321
   MCP server to expose VS Code editing features to an LLM for AI coding

732. **[mcp](https://github.com/IBM/mcp)** - ⭐ 320
   A collection of Model Context Protocol (MCP) servers, clients and developer tools by IBM.

733. **[mcp-server-azure-devops](https://github.com/Tiberriver256/mcp-server-azure-devops)** - ⭐ 319
   An MCP server for Azure DevOps

734. **[Minecraft-Hack-BaseClient](https://github.com/OxideWaveLength/Minecraft-Hack-BaseClient)** - ⭐ 318
   This is a Minecraft Base Client

735. **[abcoder](https://github.com/cloudwego/abcoder)** - ⭐ 318
   deep, reliable and confidential coding-context

736. **[mesh](https://github.com/decocms/mesh)** - ⭐ 318
   One secure endpoint for every MCP server. Deploy anywhere.

737. **[langconnect-client](https://github.com/teddynote-lab/langconnect-client)** - ⭐ 317
   A Modern GUI Interface for Vector Database Management(Supports MCP integration)

738. **[agentcontrolplane](https://github.com/humanlayer/agentcontrolplane)** - ⭐ 317
...
739. **[ClimateTraceKMP](https://github.com/joreilly/ClimateTraceKMP)** - ⭐ 316
   Kotlin/Compose Multiplatform project to show climate related emission data from https://climatetrace.org/data.

740. **[maverick-mcp](https://github.com/wshobson/maverick-mcp)** - ⭐ 316
   MaverickMCP - Personal Stock Analysis MCP Server

741. **[emcee](https://github.com/mattt/emcee)** - ⭐ 314
   MCP generator for OpenAPIs 🫳🎤💥

742. **[autogenstudio-skills](https://github.com/madtank/autogenstudio-skills)** - ⭐ 312
   Repo of skills for autogen studio using model context protocol (mcp)

743. **[mcp-servers-hub](https://github.com/apappascs/mcp-servers-hub)** - ⭐ 311
   Discover the most comprehensive and up-to-date collection of MCP servers in the market. This repository serves as a centralized hub, offering an extensive catalog of open-source and proprietary MCP servers, complete with features, documentation links, and contributors.

744. **[mcp-aktools](https://github.com/aahl/mcp-aktools)** - ⭐ 311
   📈 提供股票、加密货币的数据查询和分析功能MCP服务器

745. **[gptr-mcp](https://github.com/assafelovic/gptr-mcp)** - ⭐ 309
   MCP server for enabling LLM applications to perform deep research via the MCP protocol

746. **[ast-grep-mcp](https://github.com/ast-grep/ast-grep-mcp)** - ⭐ 309

747. **[redd-archiver](https://github.com/19-84/redd-archiver)** - ⭐ 309
...
748. **[code-sandbox-mcp](https://github.com/Automata-Labs-team/code-sandbox-mcp)** - ⭐ 308
   An MCP server to create secure code sandbox environment for executing code within Docker containers. This MCP server provides AI applications with a safe and isolated environment for running code while maintaining security through containerization.

749. **[mcp-for-argocd](https://github.com/argoproj-labs/mcp-for-argocd)** - ⭐ 306
   An implementation of Model Context Protocol (MCP) server for Argo CD.

750. **[claude-talk-to-figma-mcp](https://github.com/arinspunk/claude-talk-to-figma-mcp)** - ⭐ 305
...
751. **[AgentChat](https://github.com/Shy2593666979/AgentChat)** - ⭐ 305
...
752. **[claude-code-statusline](https://github.com/rz1989s/claude-code-statusline)** - ⭐ 305
...
753. **[tinystruct](https://github.com/tinystruct/tinystruct)** - ⭐ 304
...
754. **[mcp-server](https://github.com/mapbox/mcp-server)** - ⭐ 304
   Mapbox Model Context Protocol (MCP) server

755. **[one-mcp](https://github.com/burugo/one-mcp)** - ⭐ 304
...
756. **[stealth-browser-mcp](https://github.com/vibheksoni/stealth-browser-mcp)** - ⭐ 304
   The only browser automation that bypasses anti-bot systems. AI writes network hooks, clones UIs pixel-perfect via simple chat.

757. **[mcp-sse](https://github.com/sidharthrajaram/mcp-sse)** - ⭐ 303
   A working pattern for SSE-based MCP clients and servers

758. **[mcprouter](https://github.com/chatmcp/mcprouter)** - ⭐ 303
   api router for MCP Servers

759. **[openmcp](https://github.com/getdatanaut/openmcp)** - ⭐ 302
   Turn any openapi file into an mcp server, with just the tools you need.

760. **[automcp](https://github.com/NapthaAI/automcp)** - ⭐ 302
   Easily convert tool, agents and orchestrators from existing agent frameworks to MCP servers

761. **[ebook-mcp](https://github.com/onebirdrocks/ebook-mcp)** - ⭐ 302
...
762. **[investor-agent](https://github.com/ferdousbhai/investor-agent)** - ⭐ 301
   A Model Context Protocol server for building an investor agent

763. **[deep-research-mcp](https://github.com/Ozamatash/deep-research-mcp)** - ⭐ 301

764. **[mcp-server-code-execution-mode](https://github.com/elusznik/mcp-server-code-execution-mode)** - ⭐ 301
   An MCP server that executes Python code in isolated rootless containers with optional MCP server proxying. Implementation of Anthropic's and Cloudflare's ideas for reducing MCP tool definitions context bloat.

765. **[deepseek-mcp-server](https://github.com/DMontgomery40/deepseek-mcp-server)** - ⭐ 299
   Model Context Protocol server for DeepSeek's advanced language models

766. **[mcp-claude-code](https://github.com/SDGLBL/mcp-claude-code)** - ⭐ 298
   MCP implementation of Claude Code capabilities and more

767. **[mcp-git-ingest](https://github.com/adhikasp/mcp-git-ingest)** - ⭐ 297
   A Model Context Protocol (MCP) server that helps read GitHub repository structure and important files.

768. **[mcp-database-server](https://github.com/executeautomation/mcp-database-server)** - ⭐ 295
   MCP Database Server is a new MCP Server which helps connect with Sqlite, SqlServer and Posgresql Databases

769. **[DeepWideResearch](https://github.com/puppyone-ai/DeepWideResearch)** - ⭐ 294
   Agentic RAG for any scenario. Customize sources, depth, and width

770. **[mssql_mcp_server](https://github.com/RichardHan/mssql_mcp_server)** - ⭐ 294
...
771. **[mcp-server-apple-shortcuts](https://github.com/recursechat/mcp-server-apple-shortcuts)** - ⭐ 292

772. **[mysql_mcp_server_pro](https://github.com/wenb1n-dev/mysql_mcp_server_pro)** - ⭐ 290
...
773. **[aider-mcp-server](https://github.com/disler/aider-mcp-server)** - ⭐ 290
   Minimal MCP Server for Aider

774. **[generator](https://github.com/context-hub/generator)** - ⭐ 290
   CTX: a tool that solves the context management gap when working with LLMs like ChatGPT or Claude. It helps developers organize and automatically collect information from their codebase into structured documents that can be easily shared with AI assistants.

775. **[mcp-server-simulator-ios-idb](https://github.com/InditexTech/mcp-server-simulator-ios-idb)** - ⭐ 290
   A Model Context Protocol (MCP) server that enables LLMs to interact with iOS simulators through natural language commands.

776. **[aws-mcp](https://github.com/RafalWilinski/aws-mcp)** - ⭐ 289
   Talk with your AWS using Claude. Model Context Protocol (MCP) server for AWS. Better Amazon Q alternative.

777. **[llm-context.py](https://github.com/cyberchitta/llm-context.py)** - ⭐ 289
   Share code with LLMs via Model Context Protocol or clipboard. Rule-based customization enables easy switching between different tasks (like code review and documentation). Includes smart code outlining.

778. **[mcp-everything-search](https://github.com/mamertofabian/mcp-everything-search)** - ⭐ 289

779. **[AI-Kline](https://github.com/QuantML-C/AI-Kline)** - ⭐ 289
...
780. **[blender-mcp-vxai](https://github.com/VxASI/blender-mcp-vxai)** - ⭐ 287

781. **[mcp-server-mas-sequential-thinking](https://github.com/FradSer/mcp-server-mas-sequential-thinking)** - ⭐ 287
   An advanced sequential thinking process using a Multi-Agent System (MAS) built with the Agno framework and served via MCP.

782. **[MaaMCP](https://github.com/MAA-AI/MaaMCP)** - ⭐ 287
   基于 MaaFramework 的 MCP 服务器 为 AI 助手提供 Android 设备和 Windows 桌面自动化能力

783. **[o3-search-mcp](https://github.com/yoshiko-pg/o3-search-mcp)** - ⭐ 286
   MCP server for OpenAI o3 web search

784. **[x64DbgMCPServer](https://github.com/AgentSmithers/x64DbgMCPServer)** - ⭐ 285
   x64DbgMCPServer made from c# with Claude, Windsurf and Cursor support

785. **[hydra-mcp-solana](https://github.com/hydra-mcp/hydra-mcp-solana)** - ⭐ 284
   hydra-ai

786. **[consult7](https://github.com/szeider/consult7)** - ⭐ 284
   MCP server to consult a language model with large context size

787. **[lets-learn-mcp-csharp](https://github.com/microsoft/lets-learn-mcp-csharp)** - ⭐ 284

788. **[mcp-youtube-transcript](https://github.com/jkawamoto/mcp-youtube-transcript)** - ⭐ 284
   MCP server retrieving transcripts of YouTube videos

789. **[claude-skills-mcp](https://github.com/K-Dense-AI/claude-skills-mcp)** - ⭐ 284
   MCP server for searching and retrieving Claude Agent Skills using vector search

790. **[zotero-mcp](https://github.com/cookjohn/zotero-mcp)** - ⭐ 284
...
791. **[meGPT](https://github.com/adrianco/meGPT)** - ⭐ 283
   Code to process many kinds of content by an author into an MCP server

792. **[mcpsvr](https://github.com/nanbingxyz/mcpsvr)** - ⭐ 283
   Discover Exceptional MCP Servers

793. **[solon-ai](https://github.com/opensolon/solon-ai)** - ⭐ 283
...
794. **[obsidian-mcp](https://github.com/newtype-01/obsidian-mcp)** - ⭐ 283
   Obsidian MCP (Model Context Protocol) Server

795. **[minthcm](https://github.com/minthcm/minthcm)** - ⭐ 282
   First AI‑enabled open-source Human Capital Management system that you can start using today.

796. **[mq](https://github.com/harehare/mq)** - ⭐ 282
   jq-like command-line tool for markdown processing

797. **[perplexity-mcp](https://github.com/DaInfernalCoder/perplexity-mcp)** - ⭐ 281
...
798. **[DeepWideResearch](https://github.com/PuppyAgent/DeepWideResearch)** - ⭐ 281
   Agentic RAG for any scenario. Customize sources, depth, and width

799. **[remote-mcp-server-with-auth](https://github.com/coleam00/remote-mcp-server-with-auth)** - ⭐ 281
...
800. **[mcp-neovim-server](https://github.com/bigcodegen/mcp-neovim-server)** - ⭐ 281
   Control Neovim using Model Context Protocol (MCP) and the official neovim/node-client JavaScript library

801. **[mcp-linker](https://github.com/milisp/mcp-linker)** - ⭐ 281
...
802. **[rhinomcp](https://github.com/jingcheng-chen/rhinomcp)** - ⭐ 281
   RhinoMCP connects Rhino 3D to AI Agent through the Model Context Protocol (MCP)

803. **[Context-Engine](https://github.com/Context-Engine-AI/Context-Engine)** - ⭐ 281
   Context-Engine MCP - Agentic Context Compression Suite

804. **[utcp-specification](https://github.com/universal-tool-calling-protocol/utcp-specification)** - ⭐ 280
   The specification for the Universal Tool Calling Protocol

805. **[better-icons](https://github.com/better-auth/better-icons)** - ⭐ 280
   Skill and MCP server for searching and retrieving icons

806. **[apktool-mcp-server](https://github.com/zinja-coder/apktool-mcp-server)** - ⭐ 279
   A MCP Server for APK Tool (Part of Android Reverse Engineering MCP Suites)

807. **[mcp-manager](https://github.com/zueai/mcp-manager)** - ⭐ 279
   simple web ui to manage mcp (model context protocol) servers in the claude app

808. **[MCP-handle](https://github.com/WeatherPal-AI/MCP-handle)** - ⭐ 278
   MCP integration platforms making AI-Agents developers focusing on their own tasks

809. **[perplexity-mcp](https://github.com/jsonallen/perplexity-mcp)** - ⭐ 278
   A Model Context Protocol (MCP) server that provides web search functionality using Perplexity AI's API.

810. **[chrome-devtools-mcp](https://github.com/benjaminr/chrome-devtools-mcp)** - ⭐ 277
   An MCP Server for Chrome DevTools, following the Chrome DevTools Protocol. Integrates with Claude Desktop and Claude Code.

811. **[ddddocr](https://github.com/86maid/ddddocr)** - ⭐ 276
...
812. **[Context-Engine](https://github.com/m1rl0k/Context-Engine)** - ⭐ 276
   Context-Engine MCP - Agentic Context Compression Suite

813. **[FileScopeMCP](https://github.com/admica/FileScopeMCP)** - ⭐ 275
   Analyzes your codebase identifying important files based on dependency relationships. Generates diagrams and importance scores per file, helping AI assistants understand the codebase. Automatically parses popular programming languages such as Python, C, C++, Rust, Zig, Lua.

814. **[mcp-mongo-server](https://github.com/kiliczsh/mcp-mongo-server)** - ⭐ 275
   A Model Context Protocol Server for MongoDB

815. **[laravel-claude-code-setup](https://github.com/laraben/laravel-claude-code-setup)** - ⭐ 275
   One-command setup for AI-powered Laravel development with Claude Code and MCP servers

816. **[MCP-Server-Playwright](https://github.com/VikashLoomba/MCP-Server-Playwright)** - ⭐ 275
   MCP server for browser automation using Playwright

817. **[KiCAD-MCP-Server](https://github.com/mixelpixx/KiCAD-MCP-Server)** - ⭐ 275
   KiCAD MCP is a Model Context Protocol (MCP) implementation that enables Large Language Models (LLMs) like Claude to directly interact with KiCAD for printed circuit board design.

818. **[dify-mcp-server](https://github.com/YanxingLiu/dify-mcp-server)** - ⭐ 274
   Model Context Protocol (MCP) Server for dify workflows

819. **[app-store-connect-mcp-server](https://github.com/JoshuaRileyDev/app-store-connect-mcp-server)** - ⭐ 274

820. **[MCPControl](https://github.com/claude-did-this/MCPControl)** - ⭐ 274
   MCP server for Windows OS automation

821. **[mcp](https://github.com/oracle/mcp)** - ⭐ 274
...
822. **[mcp-reasoner](https://github.com/Jacck/mcp-reasoner)** - ⭐ 273
   A systematic reasoning MCP server implementation for Claude Desktop with beam search and thought evaluation.

823. **[safe-mcp](https://github.com/SAFE-MCP/safe-mcp)** - ⭐ 273
   SAFE-MCP is a comprehensive security framework for documenting and mitigating threats in the AI Agent ecosystem.

824. **[mcp-documentation-server](https://github.com/andrea9293/mcp-documentation-server)** - ⭐ 273
...
825. **[jadx-mcp-server](https://github.com/zinja-coder/jadx-mcp-server)** - ⭐ 272
   MCP server for JADX-AI Plugin

826. **[metorial-index](https://github.com/metorial/metorial-index)** - ⭐ 271
   Metorial MCP Index - An ever growing list of open source MCP servers 📁 🎉

827. **[mcp940](https://github.com/WangTingZheng/mcp940)** - ⭐ 271
   Source code of minecraft 1.12

828. **[imagesorcery-mcp](https://github.com/sunriseapps/imagesorcery-mcp)** - ⭐ 271
   An MCP server providing tools for image processing operations

829. **[telegram-mcp](https://github.com/chaindead/telegram-mcp)** - ⭐ 271
   Telegram MCP for managing dialogs, messages, drafts, read statuses, and more.

830. **[jinni](https://github.com/smat-dev/jinni)** - ⭐ 270
   Bring your project into LLM context - tool and MCP server

831. **[proximity](https://github.com/fr0gger/proximity)** - ⭐ 269
   Proximity is a MCP security scanner powered with NOVA

832. **[kagimcp](https://github.com/kagisearch/kagimcp)** - ⭐ 269
   The Official Model Context Protocol (MCP) server for Kagi search & other tools.

833. **[claude-modular](https://github.com/oxygen-fragment/claude-modular)** - ⭐ 268
   Production-ready modular Claude Code framework with 30+ commands, token optimization, and MCP server integration. Achieves 2-10x productivity gains through   systematic command organization and hierarchical configuration.

834. **[AetherLink](https://github.com/1600822305/AetherLink)** - ⭐ 267
...
835. **[ultra-mcp](https://github.com/RealMikeChong/ultra-mcp)** - ⭐ 265
   100x Your Claude Code, Gemini CLI, Cursor and/or any coding tools with MCP client support

836. **[model-context-protocol-resources](https://github.com/cyanheads/model-context-protocol-resources)** - ⭐ 265
   Exploring the Model Context Protocol (MCP) through practical guides, clients, and servers I've built while learning about this new protocol.

837. **[hass-mcp](https://github.com/voska/hass-mcp)** - ⭐ 265
   Home Assistant MCP Server

838. **[todoist-ai](https://github.com/Doist/todoist-ai)** - ⭐ 265
   A set of tools to connect to AI agents, to allow them to use Todoist on a user's behalf. Includes MCP support.

839. **[anytype-mcp](https://github.com/anyproto/anytype-mcp)** - ⭐ 264
   An MCP server enabling AI assistants to interact with Anytype - your encrypted, local and collaborative wiki - to organize objects, lists, and more through natural language.

840. **[mcp-omnisearch](https://github.com/spences10/mcp-omnisearch)** - ⭐ 262
   🔍 A Model Context Protocol (MCP) server providing unified access to multiple search engines (Tavily, Brave, Kagi), AI tools (Perplexity, FastGPT), and content processing services (Jina AI, Kagi). Combines search, AI responses, content processing, and enhancement features through a single interface.

841. **[mcp-odoo](https://github.com/tuanle96/mcp-odoo)** - ⭐ 261
   MCP Server for Odoo

842. **[osp_marketing_tools](https://github.com/open-strategy-partners/osp_marketing_tools)** - ⭐ 260
   A Model Context Protocol (MCP) server that empowers LLMs to use some of Open Srategy Partners' core writing and product marketing techniques.

843. **[mcp-server-12306](https://github.com/drfccv/mcp-server-12306)** - ⭐ 260
   12306 MCP Server​​ 是一个基于 ​​Model Context Protocol (MCP)​​ 的高性能火车票查询后端系统。它通过标准化接口提供官方 12306 的实时数据服务，包括余票查询、车站信息、列车经停站、中转换乘方案等核心功能。

844. **[iam-policy-autopilot](https://github.com/awslabs/iam-policy-autopilot)** - ⭐ 259
   IAM Policy Autopilot is an open source static code analysis tool that helps you quickly create baseline AWS IAM policies that you can refine as your application evolves. This tool is available as a command-line utility and MCP server for use within AI coding assistants for quickly building IAM policies.

845. **[google-docs-mcp](https://github.com/a-bonus/google-docs-mcp)** - ⭐ 258
...
846. **[geminimcp](https://github.com/GuDaStudio/geminimcp)** - ⭐ 258
...
847. **[reddit-mcp](https://github.com/Arindam200/reddit-mcp)** - ⭐ 257
   Model Context Protocol server implementation for Reddit

848. **[mcp](https://github.com/salesforcecli/mcp)** - ⭐ 257
   MCP Server for interacting with Salesforce instances

849. **[project-nova](https://github.com/dujonwalker/project-nova)** - ⭐ 256
...
850. **[django-mcp-server](https://github.com/gts360/django-mcp-server)** - ⭐ 256
   Django MCP Server is a Django extensions to easily enable AI Agents to interact with Django Apps through the Model Context Protocol it works equally well on WSGI and ASGI

851. **[deepcontext-mcp](https://github.com/Wildcard-Official/deepcontext-mcp)** - ⭐ 255
   DeepContext is an MCP server that adds symbol-aware semantic search to Claude Code, Codex CLI, and other agents for faster, smarter context on large codebases.

852. **[mcp-gdrive](https://github.com/isaacphi/mcp-gdrive)** - ⭐ 254
   Model Context Protocol (MCP) Server for reading from Google Drive and editing Google Sheets

853. **[mcp-server](https://github.com/strands-agents/mcp-server)** - ⭐ 254
   This MCP server provides documentation about Strands Agents to your GenAI tools, so you can use your favorite AI coding assistant to vibe-code Strands Agents.

854. **[admin](https://github.com/decocms/admin)** - ⭐ 253
   Define and compose secure MCPs in TypeScript. Generate AI workflows and agents with React + Tailwind UI. Deploy anywhere.

855. **[apollo-mcp-server](https://github.com/apollographql/apollo-mcp-server)** - ⭐ 253
   Apollo MCP Server

856. **[ai-agent-team](https://github.com/peterfei/ai-agent-team)** - ⭐ 252
   AI Agent Team-拥有24/7专业AI开发团队：产品经理、前端开发、后端开发、测试工程师、DevOps工程师、技术负责人。一键安装，支持中英文命令，大幅提升开发效率！

857. **[things-mcp](https://github.com/hald/things-mcp)** - ⭐ 252
   Things.app MCP Server

858. **[code-reasoning](https://github.com/mettamatt/code-reasoning)** - ⭐ 251
   A code reasoning MCP server, a fork of sequential-thinking

859. **[mcp-ical](https://github.com/Omar-V2/mcp-ical)** - ⭐ 251
   A Model Context Protocol Server that allows you to interact with your MacOS Calendar through natural language.

860. **[aci-mcp](https://github.com/aipotheosis-labs/aci-mcp)** - ⭐ 250
   MCP server(s) for Aipolabs ACI.dev

861. **[doris-mcp-server](https://github.com/apache/doris-mcp-server)** - ⭐ 250
   Apache Doris MCP Server

862. **[AEnvironment](https://github.com/inclusionAI/AEnvironment)** - ⭐ 249
   Standardized environment infrastructure for Agentic AI development.

863. **[api200](https://github.com/API-200/api200)** - ⭐ 248
   API 200 is an open source API gateway to simplify 3rd-party integrations. Import endpoints, set up caching, retries, and mocks. Access all services via one URL. Monitor logs, track errors, and get alerts on API incidents.

864. **[mcp_massive](https://github.com/massive-com/mcp_massive)** - ⭐ 248
   An MCP server for Massive.com Financial Market Data

865. **[enterprise-mcp-course](https://github.com/decodingai-magazine/enterprise-mcp-course)** - ⭐ 248
...
866. **[MARM-Systems](https://github.com/Lyellr88/MARM-Systems)** - ⭐ 248
...
867. **[skillport](https://github.com/gotalab/skillport)** - ⭐ 248
   Bring Agent Skills to Any AI Agent and Coding Agent — via CLI or MCP. Manage once, serve anywhere.

868. **[mcp-server-tree-sitter](https://github.com/wrale/mcp-server-tree-sitter)** - ⭐ 247
   MCP Server for Tree-sitter

869. **[xiaozhi-client](https://github.com/shenjingnan/xiaozhi-client)** - ⭐ 247
   小智AI客户端，目前主要用于MCP的对接

870. **[suppr-mcp](https://github.com/WildDataX/suppr-mcp)** - ⭐ 246
    超能文献|AI驱动的文档翻译与学术搜索服务。支持PDF、DOCX、PPTX等多格式文档的高质量翻译（支持11种语言），特别优化了数学公式翻译。同时提供PubMed学术文献智能搜索功能。更多访问：https://suppr.wilddata.cn

871. **[g-search-mcp](https://github.com/jae-jae/g-search-mcp)** - ⭐ 245
   A powerful MCP server for Google search that enables parallel searching with multiple keywords simultaneously.

872. **[rust-docs-mcp-server](https://github.com/Govcraft/rust-docs-mcp-server)** - ⭐ 245
   🦀 Prevents outdated Rust code suggestions from AI assistants. This MCP server fetches current crate docs, uses embeddings/LLMs, and provides accurate context via a tool call.

873. **[mcp-server-gemini](https://github.com/aliargun/mcp-server-gemini)** - ⭐ 244
   MCP server implementation for Google's Gemini API

874. **[CAAL](https://github.com/CoreWorxLab/CAAL)** - ⭐ 243
   Local voice assistant that learns new abilities via auto-discovered n8n workflows exposed as tools via MCP

875. **[studio-rust-mcp-server](https://github.com/Roblox/studio-rust-mcp-server)** - ⭐ 243
   Standalone Roblox Studio MCP Server

876. **[mcp-chatbot](https://github.com/3choff/mcp-chatbot)** - ⭐ 242
   A simple CLI chatbot that demonstrates the integration of the Model Context Protocol (MCP).

877. **[Windows-MCP.Net](https://github.com/AIDotNet/Windows-MCP.Net)** - ⭐ 242
   A .NET-based Windows desktop automation MCP (Model Context Protocol) server that provides AI assistants with the ability to interact with the Windows desktop environment.

878. **[bazi-mcp](https://github.com/cantian-ai/bazi-mcp)** - ⭐ 242
   MCP server for Bazi (八字) information

879. **[spring-ai-summary](https://github.com/java-ai-tech/spring-ai-summary)** - ⭐ 242
   SpringAI，LLM，MCP，Embedding

880. **[1c_mcp](https://github.com/vladimir-kharin/1c_mcp)** - ⭐ 242
...
881. **[chat-mcp](https://github.com/AI-QL/chat-mcp)** - ⭐ 241
   A Desktop Chat App that leverages MCP(Model Context Protocol) to interface with other LLMs.

882. **[next-lens](https://github.com/1weiho/next-lens)** - ⭐ 241
   A CLI that scans Next.js routes and provides quick insights from your terminal, web UI, and MCP.

883. **[mcp-prompt-server](https://github.com/gdli6177/mcp-prompt-server)** - ⭐ 240
   这是一个基于Model Context Protocol (MCP)的服务器，用于根据用户任务需求提供预设的prompt模板，帮助Cline/Cursor/Windsurf...更高效地执行各种任务。服务器将预设的prompt作为工具(tools)返回，以便在Cursor和Windsurf等编辑器中更好地使用。

884. **[mcp-feedback-collector](https://github.com/sanshao85/mcp-feedback-collector)** - ⭐ 240
   一个现代化的 Model Context Protocol (MCP) 服务器，为AI助手提供交互式用户反馈收集功能。

885. **[elasticsearch-mcp-server](https://github.com/cr7258/elasticsearch-mcp-server)** - ⭐ 240
   A Model Context Protocol (MCP) server implementation that provides Elasticsearch and OpenSearch interaction.

886. **[ssh-mcp](https://github.com/tufantunc/ssh-mcp)** - ⭐ 240
   MCP server exposing SSH control for Linux servers via Model Context Protocol.

887. **[PIXRA](https://github.com/dodufish/PIXRA)** - ⭐ 239
   Pixelize the real world on-chain

888. **[video-editing-mcp](https://github.com/burningion/video-editing-mcp)** - ⭐ 239
   MCP Interface for Video Jungle

889. **[claude_code-gemini-mcp](https://github.com/RaiAnsar/claude_code-gemini-mcp)** - ⭐ 239
   Simplified Gemini for Claude Code. 

890. **[claude-code-mcpinstall](https://github.com/undeadpickle/claude-code-mcpinstall)** - ⭐ 239
   Easy guide to installing Claude Code MCPs globally on your machine.

891. **[human-mcp](https://github.com/mrgoonie/human-mcp)** - ⭐ 239

892. **[Lynkr](https://github.com/Fast-Editor/Lynkr)** - ⭐ 239
   Streamline your workflow with Lynkr, a CLI tool that acts as an HTTP proxy for efficient code interactions using Claude Code CLI.

893. **[lean-lsp-mcp](https://github.com/oOo0oOo/lean-lsp-mcp)** - ⭐ 239
   Lean Theorem Prover MCP

894. **[private-journal-mcp](https://github.com/obra/private-journal-mcp)** - ⭐ 239
   A lightweight MCP server that provides Claude with a private journaling capability to process feelings and thoughts

895. **[mcp-server-code-runner](https://github.com/formulahendry/mcp-server-code-runner)** - ⭐ 238
   Code Runner MCP Server

896. **[mcp_flutter](https://github.com/Arenukvern/mcp_flutter)** - ⭐ 238
   MCP server and MCP Toolkit  for Flutter and Dart VM - supports dynamic tooling

897. **[weather-mcp-server](https://github.com/ezh0v/weather-mcp-server)** - ⭐ 237
   A lightweight Model Context Protocol (MCP) server that enables AI assistants like Claude to retrieve and interpret real-time weather data. Discuss on Hacker News:

898. **[foundry-mcp-server](https://github.com/PraneshASP/foundry-mcp-server)** - ⭐ 236
   An experimental MCP Server for foundry built for Solidity devs

899. **[MCPBench](https://github.com/modelscope/MCPBench)** - ⭐ 236
   The evaluation benchmark on MCP servers

900. **[aitour26-WRK540-unlock-your-agents-potential-with-model-context-protocol](https://github.com/microsoft/aitour26-WRK540-unlock-your-agents-potential-with-model-context-protocol)** - ⭐ 236

901. **[mcp-on-vercel](https://github.com/vercel-labs/mcp-on-vercel)** - ⭐ 236

902. **[NFTIAI](https://github.com/Axarb/NFTIAI)** - ⭐ 235
...
903. **[mcp2py](https://github.com/MaximeRivest/mcp2py)** - ⭐ 235
   Turn any MCP server into a Python module

904. **[firebase-mcp](https://github.com/gannonh/firebase-mcp)** - ⭐ 235
   🔥 Model Context Protocol (MCP) server for Firebase.

905. **[dat](https://github.com/hexinfo/dat)** - ⭐ 233
   Asking yours data in a natural language way through pre-modeling (data models and semantic models).

906. **[mcp-server](https://github.com/volcengine/mcp-server)** - ⭐ 233
   Volcengine MCP Servers

907. **[browser-control-mcp](https://github.com/eyalzh/browser-control-mcp)** - ⭐ 233
   MCP server paired with a browser extension that enables AI agents to control the user's browser.

908. **[mcp-proxy-for-aws](https://github.com/aws/mcp-proxy-for-aws)** - ⭐ 233
   AWS MCP Proxy Server

909. **[mcp-proxy](https://github.com/punkpeye/mcp-proxy)** - ⭐ 233
   A TypeScript streamable HTTP and SSE proxy for MCP servers that use stdio transport.

910. **[atlassian-mcp-server](https://github.com/atlassian/atlassian-mcp-server)** - ⭐ 233
   Remote MCP Server that securely connects Jira and Confluence with your LLM, IDE, or agent platform of choice.

911. **[claude-code-mastery](https://github.com/TheDecipherist/claude-code-mastery)** - ⭐ 233
   The complete guide to Claude Code: CLAUDE.md, hooks, skills, MCP servers, and commands

912. **[Lambda-MCP-Server](https://github.com/mikegc-aws/Lambda-MCP-Server)** - ⭐ 232
   Creates a simple MCP tool server with "streaming" HTTP.

913. **[mcp-foundry](https://github.com/microsoft-foundry/mcp-foundry)** - ⭐ 230
   A MCP Server for Azure AI Foundry: it's now moved to cloud, check the new Foundry MCP Server

914. **[mcp_chatbot](https://github.com/keli-wen/mcp_chatbot)** - ⭐ 230
   A chatbot implementation compatible with MCP (terminal / streamlit supported)

915. **[mcp-telegram](https://github.com/dryeab/mcp-telegram)** - ⭐ 229
   MCP Server for Telegram

916. **[MCP-connect](https://github.com/EvalsOne/MCP-connect)** - ⭐ 229
   Enables cloud-based AI services to access local Stdio based MCP servers via HTTP requests

917. **[mac_messages_mcp](https://github.com/carterlasalle/mac_messages_mcp)** - ⭐ 229
   An MCP server that securely interfaces with your iMessage database via the Model Context Protocol (MCP), allowing LLMs to query and analyze iMessage conversations. It includes robust phone number validation, attachment processing, contact management, group chat handling, and full support for sending and receiving messages.

918. **[xiyan_mcp_server](https://github.com/XGenerationLab/xiyan_mcp_server)** - ⭐ 228
   A Model Context Protocol (MCP) server that enables natural language queries to databases

919. **[outlook-mcp](https://github.com/ryaker/outlook-mcp)** - ⭐ 228
   MCP server for Claude to access Outlook data via Microsoft Graph API

920. **[sample-serverless-mcp-servers](https://github.com/aws-samples/sample-serverless-mcp-servers)** - ⭐ 227
   Sample implementations of AI Agents and MCP Servers running on AWS Serverless compute

921. **[mcp-foundry](https://github.com/azure-ai-foundry/mcp-foundry)** - ⭐ 227
   A MCP Server for Azure AI Foundry: it's now moved to cloud, check the new Foundry MCP Server

922. **[awesome-mcp-servers](https://github.com/PipedreamHQ/awesome-mcp-servers)** - ⭐ 226
   A collection of MCP servers

923. **[cobolt](https://github.com/platinum-hill/cobolt)** - ⭐ 226
...
924. **[octocode](https://github.com/Muvon/octocode)** - ⭐ 226
   Semantic code searcher and codebase utility with AI memory onboard

925. **[strava-mcp](https://github.com/r-huijts/strava-mcp)** - ⭐ 226
   A Model Context Protocol (MCP) server that connects to Strava API, providing tools to access Strava data through LLMs

926. **[MiroRL](https://github.com/MiroMindAI/MiroRL)** - ⭐ 225
   MiroRL is  an MCP-first reinforcement learning framework for deep research agent.

927. **[lyraios](https://github.com/GalaxyLLMCI/lyraios)** - ⭐ 224
...
928. **[openapi-to-mcpserver](https://github.com/higress-group/openapi-to-mcpserver)** - ⭐ 224
   A tool&lib that can automatically convert OpenAPI documents into Higress remote MCP server configurations.

929. **[CAD-MCP](https://github.com/daobataotie/CAD-MCP)** - ⭐ 223
   CAD MCP Server

930. **[remote-swe-agents](https://github.com/aws-samples/remote-swe-agents)** - ⭐ 223
   Autonomous SWE agent working in the cloud! (a.k.a. Vibe coding with Bedrock)

931. **[omnicoreagent](https://github.com/omnirexflora-labs/omnicoreagent)** - ⭐ 223
...
932. **[Unreal_mcp](https://github.com/ChiR24/Unreal_mcp)** - ⭐ 223
...
933. **[mcp-server-commands](https://github.com/g0t4/mcp-server-commands)** - ⭐ 222
   Model Context Protocol server to run commands

934. **[Mimir](https://github.com/orneryd/Mimir)** - ⭐ 222
...
935. **[Alice](https://github.com/pmbstyle/Alice)** - ⭐ 222
...
936. **[cheatengine-mcp-bridge](https://github.com/miscusi-peek/cheatengine-mcp-bridge)** - ⭐ 222
...
937. **[llamacloud-mcp](https://github.com/run-llama/llamacloud-mcp)** - ⭐ 221

938. **[agent-mcp-lab](https://github.com/WaveSpeedAI/agent-mcp-lab)** - ⭐ 221

939. **[langgraph-whatsapp-agent](https://github.com/lgesuellip/langgraph-whatsapp-agent)** - ⭐ 220
...
940. **[spotify-mcp-server](https://github.com/marcelmarais/spotify-mcp-server)** - ⭐ 220
   Lightweight MCP server for Spotify

941. **[home-assistant-cursor-agent](https://github.com/Coolver/home-assistant-cursor-agent)** - ⭐ 219
...
942. **[mcp-twikit](https://github.com/adhikasp/mcp-twikit)** - ⭐ 219
   A Model Context Protocol (MCP) server for interacting with Twitter.

943. **[mcp-maigret](https://github.com/BurtTheCoder/mcp-maigret)** - ⭐ 219
   MCP server for maigret, a powerful OSINT tool that collects user account information from various public sources. 

944. **[mcp-compass](https://github.com/liuyoshio/mcp-compass)** - ⭐ 219
   MCP Discovery & Recommendation Service - Find the right MCP server for your needs

945. **[mcp-cli](https://github.com/apify/mcp-cli)** - ⭐ 219
...
946. **[effect-mcp](https://github.com/tim-smart/effect-mcp)** - ⭐ 218

947. **[smart-tree](https://github.com/8b-is/smart-tree)** - ⭐ 218
...
948. **[image-gen-server](https://github.com/fengin/image-gen-server)** - ⭐ 217
   一个能与Cursor集成的图片生成mcp server工具，实现调用即梦逆向接口

949. **[tentix](https://github.com/labring/tentix)** - ⭐ 216
...
950. **[playwright-mcp](https://github.com/cloudflare/playwright-mcp)** - ⭐ 215
   Playwright MCP fork that works with Cloudflare Browser Rendering

951. **[obsidian-mcp-plugin](https://github.com/aaronsb/obsidian-mcp-plugin)** - ⭐ 215
   High-performance Model Context Protocol (MCP) server for Obsidian that provides AI tools with direct vault access through semantic operations and HTTP transport.

952. **[human-in-the-loop](https://github.com/KOBA789/human-in-the-loop)** - ⭐ 215
   An MCP (Model Context Protocol) server that allows AI assistants to ask questions to humans via Discord.

953. **[learn-agentic-ai-from-low-code-to-code](https://github.com/panaversity/learn-agentic-ai-from-low-code-to-code)** - ⭐ 214
   Build production-grade agents with OpenAI AgentKit, a no-code platfrom.

954. **[vibevideo-mcp](https://github.com/hyepartners-gmail/vibevideo-mcp)** - ⭐ 214
   Agent MCP for ffmpeg

955. **[mcp-server-milvus](https://github.com/zilliztech/mcp-server-milvus)** - ⭐ 214
   Model Context Protocol Servers for Milvus

956. **[facebook-ads-mcp-server](https://github.com/gomarble-ai/facebook-ads-mcp-server)** - ⭐ 214

957. **[lokka](https://github.com/merill/lokka)** - ⭐ 214
   MCP (Model Context Protocol) for Microsoft 365. Includes support for Microsoft Graph and other services

958. **[antd-components-mcp](https://github.com/zhixiaoqiang/antd-components-mcp)** - ⭐ 214
   An MCP service for Ant Design components query | 一个减少 Ant Design 组件代码生成幻觉的 MCP 服务，包含系统提示词、组件文档、API 文档、代码示例和更新日志查询

959. **[penpot-mcp](https://github.com/montevive/penpot-mcp)** - ⭐ 214
   Penpot MCP server

960. **[mermaid-mcp-server](https://github.com/peng-shawn/mermaid-mcp-server)** - ⭐ 214
   A Model Context Protocol (MCP) server that converts Mermaid diagrams to PNG images

961. **[lihil](https://github.com/raceychan/lihil)** - ⭐ 213
   2X faster ASGI web framework for python, offering high-level development, low-level performance.

962. **[mcp_code_executor](https://github.com/bazinga012/mcp_code_executor)** - ⭐ 213
   The MCP Code Executor is an MCP server that allows LLMs to execute Python code within a specified Conda environment.

963. **[mcp-openapi-server](https://github.com/ivo-toby/mcp-openapi-server)** - ⭐ 213
   MCP Server (Model Context Protocol) for turning OpenAPI specifications into a MCP Resource

964. **[ticktick-mcp](https://github.com/jacepark12/ticktick-mcp)** - ⭐ 213
   MCP server that interacts with TickTick (Dida 365) via the TickTick Open API

965. **[mcp](https://github.com/Snowflake-Labs/mcp)** - ⭐ 213
   MCP Server for Snowflake including Cortex AI, object management, SQL orchestration, semantic view consumption, and more

966. **[razorpay-mcp-server](https://github.com/razorpay/razorpay-mcp-server)** - ⭐ 212
   Razorpay's Official MCP Server

967. **[plate-playground-template](https://github.com/udecode/plate-playground-template)** - ⭐ 211
   Plate AI template with React 19, Next 16, Tailwind 4, MCP.

968. **[domainstack.io](https://github.com/jakejarvis/domainstack.io)** - ⭐ 211
   🧰 All-in-one domain name intelligence as a service

969. **[uber-eats-mcp-server](https://github.com/ericzakariasson/uber-eats-mcp-server)** - ⭐ 211

970. **[cpp-mcp](https://github.com/hkr04/cpp-mcp)** - ⭐ 211
   Lightweight C++ MCP (Model Context Protocol) SDK

971. **[mindmap-mcp-server](https://github.com/YuChenSSR/mindmap-mcp-server)** - ⭐ 211
   mindmap, mcp server, artifact

972. **[ruby_llm-mcp](https://github.com/patvice/ruby_llm-mcp)** - ⭐ 211
   Full-featured MCP support for Ruby and RubyLLM—making it easy to build structured, composable LLM workflows in pure Ruby.

973. **[c2sagent](https://github.com/C2SAgent/c2sagent)** - ⭐ 211
...
974. **[Autono](https://github.com/vortezwohl/Autono)** - ⭐ 210
   A ReAct-Based Highly Robust Autonomous Agent Framework.

975. **[gibber-mcp](https://github.com/antonpk1/gibber-mcp)** - ⭐ 210
   Tiny MCP server with cryptography tools, sufficient to establish end-to-end encryption between LLM agents

976. **[mcp-taskmanager](https://github.com/kazuph/mcp-taskmanager)** - ⭐ 210

977. **[composer-trade-mcp](https://github.com/invest-composer/composer-trade-mcp)** - ⭐ 210
   Composer's MCP server lets MCP-enabled LLMs like Claude backtest trading ideas and automatically invest in them for you

978. **[multimodal-mcp-client](https://github.com/Ejb503/multimodal-mcp-client)** - ⭐ 210
   A Multi-modal MCP client for voice powered agentic workflows

979. **[anki-mcp-server](https://github.com/nailuoGG/anki-mcp-server)** - ⭐ 210
   MCP server for Anki via AnkiConnect

980. **[mcp-server-trello](https://github.com/delorenj/mcp-server-trello)** - ⭐ 210
   A Model Context Protocol (MCP) server that provides tools for interacting with Trello boards.

981. **[figma-mcp](https://github.com/MatthewDailey/figma-mcp)** - ⭐ 209
   ModelContextProtocol for Figma's REST API

982. **[claude-historian-mcp](https://github.com/Vvkmnn/claude-historian-mcp)** - ⭐ 209
   🤖 An MCP server for surfacing useful Claude Code conversation history

983. **[yt-dlp-mcp](https://github.com/kevinwatt/yt-dlp-mcp)** - ⭐ 209
   A Model Context Protocol (MCP) server that bridges Video & Audio content with Large Language Models using yt-dlp.

984. **[kite-mcp-server](https://github.com/zerodha/kite-mcp-server)** - ⭐ 208
   Zerodha Kite MCP server

985. **[vulnerable-mcp-servers-lab](https://github.com/appsecco/vulnerable-mcp-servers-lab)** - ⭐ 208
   A collection of servers which are deliberately vulnerable to learn Pentesting MCP Servers.

986. **[Google-Search-MCP-Server](https://github.com/mixelpixx/Google-Search-MCP-Server)** - ⭐ 207
...
987. **[mcp-context-protector](https://github.com/trailofbits/mcp-context-protector)** - ⭐ 206
   MCP security wrapper

988. **[mcp-rb](https://github.com/funwarioisii/mcp-rb)** - ⭐ 206
   A lightweight Ruby framework for building MCP servers with a Sinatra-like DSL

989. **[automagik-genie](https://github.com/namastexlabs/automagik-genie)** - ⭐ 206
   🧞 Automagik Genie – bootstrap, update, and roll back AI agent workspaces with a single CLI + MCP toolkit.

990. **[Remote-MCP](https://github.com/ssut/Remote-MCP)** - ⭐ 206
   A type-safe solution to remote MCP communication, enabling effortless integration for centralized management of Model Context.

991. **[jebmcp](https://github.com/dawnslab/jebmcp)** - ⭐ 206

992. **[OSWorld-MCP](https://github.com/X-PLUG/OSWorld-MCP)** - ⭐ 205

993. **[notion_mcp](https://github.com/danhilse/notion_mcp)** - ⭐ 205
   A simple MCP integration that allows Claude to read and manage a personal Notion todo list

994. **[melrose](https://github.com/emicklei/melrose)** - ⭐ 205
   interactive programming of melodies, producing MIDI 

995. **[TradingAgents-MCPmode](https://github.com/guangxiangdebizi/TradingAgents-MCPmode)** - ⭐ 205
   TradingAgents-MCPmode 是一个创新的多智能体交易分析系统，集成了 Model Context Protocol (MCP) 工具，实现了智能化的股票分析和交易决策流程。系统通过多个专业化智能体的协作，提供全面的市场分析、投资建议和风险管理。

996. **[mcp-trends-hub](https://github.com/baranwang/mcp-trends-hub)** - ⭐ 204
   基于 Model Context Protocol (MCP) 协议的全网热点趋势一站式聚合服务

997. **[AutomatedEmulation](https://github.com/iknowjason/AutomatedEmulation)** - ⭐ 204
...
998. **[sqrl](https://github.com/DataSQRL/sqrl)** - ⭐ 204
   Data Pipeline Automation Framework to build MCP servers, data APIs, and data lakes with SQL.

999. **[gemini-cli-desktop](https://github.com/Piebald-AI/gemini-cli-desktop)** - ⭐ 204
   Web/desktop UI for Gemini CLI/Qwen Code.  Manage projects, switch between tools, search across past conversations, and manage MCP servers, all from one multilingual interface, locally or remotely.

1000. **[sora-mcp](https://github.com/Doriandarko/sora-mcp)** - ⭐ 203
   An MCP server to use Sora video generation APIs

1001. **[langchain-mcp](https://github.com/rectalogic/langchain-mcp)** - ⭐ 203
   Model Context Protocol tool support for LangChain

1002. **[jetski](https://github.com/hyprmcp/jetski)** - ⭐ 203
...
1003. **[tmux-mcp](https://github.com/nickgnd/tmux-mcp)** - ⭐ 203
   A MCP server for our beloved terminal multiplexer tmux.

1004. **[y-cli](https://github.com/luohy15/y-cli)** - ⭐ 202
   A Tiny Terminal Chat App for AI Models with MCP Client Support

1005. **[Google-Scholar-MCP-Server](https://github.com/JackKuo666/Google-Scholar-MCP-Server)** - ⭐ 202
...
1006. **[mastergo-magic-mcp](https://github.com/mastergo-design/mastergo-magic-mcp)** - ⭐ 202
...
1007. **[mcp-n8n-workflow-builder](https://github.com/salacoste/mcp-n8n-workflow-builder)** - ⭐ 202
   AI-powered n8n workflow automation through natural language. MCP server enabling Claude AI & Cursor IDE to create, manage, and monitor workflows via Model Context Protocol. Multi-instance support, 17 tools, comprehensive docs. Build workflows conversationally without manual JSON editing.

1008. **[unsplash-mcp-server](https://github.com/hellokaton/unsplash-mcp-server)** - ⭐ 201
   🔎 A MCP server for Unsplash image search.

1009. **[mcp](https://github.com/hopx-ai/mcp)** - ⭐ 200

1010. **[ht-mcp](https://github.com/memextech/ht-mcp)** - ⭐ 200
   Pure Rust implementation of MCP server for headless terminal 

1011. **[mcp-server-deep-research](https://github.com/reading-plus-ai/mcp-server-deep-research)** - ⭐ 200

1012. **[mathom](https://github.com/stephenlacy/mathom)** - ⭐ 199
   Run and monitor MCP servers locally

1013. **[ha-mcp-for-xiaozhi](https://github.com/c1pher-cn/ha-mcp-for-xiaozhi)** - ⭐ 199
   Homeassistant MCP server for 小智AI

1014. **[BifrostMCP](https://github.com/biegehydra/BifrostMCP)** - ⭐ 199
...
1018. **[mcp-gsc](https://github.com/AminForou/mcp-gsc)** - ⭐ 197
   Google Search Console Insights with Claude AI for SEOs

1019. **[vllm-mlx](https://github.com/waybarrios/vllm-mlx)** - ⭐ 197
...
1020. **[ProxmoxMCP](https://github.com/canvrno/ProxmoxMCP)** - ⭐ 196
   MCP for Proxmox integration in Cline

1021. **[cognition-wheel](https://github.com/Hormold/cognition-wheel)** - ⭐ 196
   A Model Context Protocol (MCP) server that implements a "wisdom of crowds" approach to AI reasoning by consulting multiple state-of-the-art language models in parallel and synthesizing their responses.

1022. **[mongodb-lens](https://github.com/furey/mongodb-lens)** - ⭐ 196
   🍃🔎 MongoDB Lens: Full Featured MCP Server for MongoDB Databases

1023. **[opik-mcp](https://github.com/comet-ml/opik-mcp)** - ⭐ 196
   Model Context Protocol (MCP) implementation for Opik enabling seamless IDE integration and unified access to prompts, projects, traces, and metrics. 

1024. **[mcp-echarts](https://github.com/hustcc/mcp-echarts)** - ⭐ 196
   🧬 Generate visual charts using ECharts with AI MCP dynamically, used for chart generation and data analysis.

1025. **[mcp-portal-transparencia](https://github.com/dutradotdev/mcp-portal-transparencia)** - ⭐ 195
   MCP para orquestração automatizada de chamadas à API do Portal da Transparência do Governo Federal brasileiro

1026. **[phone-mcp](https://github.com/hao-cyber/phone-mcp)** - ⭐ 195
   A phone control plugin for MCP that allows you to control your Android phone through ADB commands to connect any human

1027. **[sec-edgar-mcp](https://github.com/stefanoamorelli/sec-edgar-mcp)** - ⭐ 195
   A SEC EDGAR MCP (Model Context Protocol) Server

1028. **[gram](https://github.com/speakeasy-api/gram)** - ⭐ 195
   Platform to create, curate and host MCP servers ⚒️ Build production quality tools for your agents.

1029. **[metorial-platform](https://github.com/metorial/metorial-platform)** - ⭐ 194
   The engine powering hundreds of thousands of MCP connections 🤖 🔥

1030. **[nano-agent](https://github.com/disler/nano-agent)** - ⭐ 194
   A MCP Server for a small scale engineering agents with multi-provider LLM support.

1031. **[mcp-proxy-server](https://github.com/adamwattis/mcp-proxy-server)** - ⭐ 193
   An MCP proxy server that aggregates and serves multiple MCP resource servers through a single interface

1032. **[claude-self-reflect](https://github.com/ramakay/claude-self-reflect)** - ⭐ 193
   Claude forgets everything. This fixes that. 🔗 www.npmjs.com/package/claude-self-reflect

1033. **[dynatrace-mcp](https://github.com/dynatrace-oss/dynatrace-mcp)** - ⭐ 193
   MCP server for Dynatrace Observability

1034. **[waldzell-mcp](https://github.com/waldzellai/waldzell-mcp)** - ⭐ 192
   Waldzell AI's monorepo of MCP servers. Use in Claude Desktop, Cline, Roo Code, and more!

1035. **[gcp-mcp](https://github.com/eniayomi/gcp-mcp)** - ⭐ 192
   A Model Context Protocol (MCP) server that enables AI assistants like Claude to interact with your Google Cloud Platform environment. This allows for natural language querying and management of your GCP resources during conversations.

1036. **[wavefront](https://github.com/rootflo/wavefront)** - ⭐ 192
   🔥🔥🔥 Enterprise AI middleware, alternative to unifyapps, n8n, lyzr

1037. **[nosia](https://github.com/dilolabs/nosia)** - ⭐ 192
   Self-hosted AI RAG + MCP Platform

1038. **[mcp-guardian](https://github.com/eqtylab/mcp-guardian)** - ⭐ 192
   Manage / Proxy / Secure your MCP Servers

1039. **[easy-mcp](https://github.com/zcaceres/easy-mcp)** - ⭐ 191
   Absurdly easy Model Context Protocol Servers in Typescript

1040. **[mcp_forge](https://github.com/mlzoo/mcp_forge)** - ⭐ 191
   这是一个专为开发企业级MCP server而设计的通用开发框架

1041. **[figma-flutter-mcp](https://github.com/mhmzdev/figma-flutter-mcp)** - ⭐ 191
   An MCP server that provides the coding agents Figma's design token to write Flutter code.

1042. **[binary_ninja_mcp](https://github.com/fosdickio/binary_ninja_mcp)** - ⭐ 191
   A Binary Ninja plugin containing an MCP server that enables seamless integration with your favorite LLM/MCP client.

1043. **[seo-mcp](https://github.com/cnych/seo-mcp)** - ⭐ 190
...
1044. **[MCP-server-client-computer-use-ai-sdk](https://github.com/mediar-ai/MCP-server-client-computer-use-ai-sdk)** - ⭐ 190

1045. **[RelaMind](https://github.com/El-12stu/RelaMind)** - ⭐ 190
   基于 AI 的个人成长轨迹分析系统，通过记录生活、回顾历史、分析模式帮助用户更好地理解自己，实现持续成长。包含智能路由、RAG 检索、自主任务智能体等功能。

1046. **[yahoo-finance-mcp](https://github.com/Alex2Yang97/yahoo-finance-mcp)** - ⭐ 190
   This is a Model Context Protocol (MCP) server that provides comprehensive financial data from Yahoo Finance. It allows you to retrieve detailed information about stocks, including historical prices, company information, financial statements, options data, and market news.

1047. **[armor-crypto-mcp](https://github.com/armorwallet/armor-crypto-mcp)** - ⭐ 189
   The MCP server for interacting with Blockchain, Swaps, Strategic Planning and more.

1048. **[AutoDocs](https://github.com/TrySita/AutoDocs)** - ⭐ 187
...
1049. **[code-sandbox-mcp](https://github.com/philschmid/code-sandbox-mcp)** - ⭐ 187

1050. **[mcp-usecase](https://github.com/teddynote-lab/mcp-usecase)** - ⭐ 187

1051. **[mcp-injection-experiments](https://github.com/invariantlabs-ai/mcp-injection-experiments)** - ⭐ 187
   Code snippets to reproduce MCP tool poisoning attacks.

1052. **[utcp-mcp](https://github.com/universal-tool-calling-protocol/utcp-mcp)** - ⭐ 187
   All-in-one MCP server that can connect your AI agents to any native endpoint, powered by UTCP

1053. **[supabase-mcp](https://github.com/coleam00/supabase-mcp)** - ⭐ 187
   Supabase MCP server created in Python.

1054. **[persistent-ai-memory](https://github.com/savantskie/persistent-ai-memory)** - ⭐ 187
   A persistent local memory for AI, LLMs, or Copilot in VS Code.

1055. **[pbi-desktop-mcp-public](https://github.com/maxanatsko/pbi-desktop-mcp-public)** - ⭐ 187
...
1056. **[mcp-launchpad](https://github.com/kenneth-liao/mcp-launchpad)** - ⭐ 187
...
1057. **[Omni-Adapter](https://github.com/HuChundong/Omni-Adapter)** - ⭐ 186
   多平台 文生图/图生图 等能力接入MCP

1058. **[mcp-linkedin](https://github.com/adhikasp/mcp-linkedin)** - ⭐ 186
   A Model Context Protocol (MCP) server that provides tools to interact with LinkedIn's Feeds and Job API.

1059. **[servicenow-mcp](https://github.com/echelon-ai-labs/servicenow-mcp)** - ⭐ 186
   MCP Server for ServiceNow

1060. **[auto-mcp](https://github.com/brizzai/auto-mcp)** - ⭐ 185
   Transform any OpenAPI/Swagger definition into a fully-featured Model Context Protocol (MCP) server

1061. **[hf-mcp-server](https://github.com/huggingface/hf-mcp-server)** - ⭐ 185
   Hugging Face MCP Server

1062. **[a2a_mcp-example](https://github.com/ishanExtreme/a2a_mcp-example)** - ⭐ 184
   An example showing how A2A and MCP can be used together

1063. **[EdgeBox](https://github.com/BIGPPWONG/EdgeBox)** - ⭐ 184
...
1064. **[litemcp](https://github.com/wong2/litemcp)** - ⭐ 183
   A TypeScript framework for building MCP servers elegantly

1065. **[gistpad-mcp](https://github.com/lostintangent/gistpad-mcp)** - ⭐ 183
   📓 An MCP server for managing your personal knowledge, daily notes, and re-usable prompts via GitHub Gists

1066. **[mcp-servers-nix](https://github.com/natsukium/mcp-servers-nix)** - ⭐ 183
...
1071. **[mcp-agent-graph](https://github.com/keta1930/mcp-agent-graph)** - ⭐ 182
   MCP Agent Graph is a Multi-Agent System built on the principles of Context Engineering

1072. **[touchdesigner-mcp](https://github.com/8beeeaaat/touchdesigner-mcp)** - ⭐ 182
   MCP server for TouchDesigner

1073. **[dify-plugin-tools-mcp_sse](https://github.com/junjiem/dify-plugin-tools-mcp_sse)** - ⭐ 181
   Dify 1.0 Plugin MCP HTTP with SSE or Streamable HTTP transport Tools

1074. **[MCP-Checklists](https://github.com/MCP-Manager/MCP-Checklists)** - ⭐ 181

1075. **[mcp-run-python](https://github.com/pydantic/mcp-run-python)** - ⭐ 181
   MCP server to run Python code in a sandbox.

1076. **[claudex](https://github.com/Mng-dev-ai/claudex)** - ⭐ 181
...
1077. **[protoc-gen-go-mcp](https://github.com/redpanda-data/protoc-gen-go-mcp)** - ⭐ 181
   Go protobuf compiler extension to turn any gRPC service into an MCP server

1078. **[frida-mcp](https://github.com/dnakov/frida-mcp)** - ⭐ 180
   MCP stdio server for frida

1079. **[quarkus-mcp-servers](https://github.com/quarkiverse/quarkus-mcp-servers)** - ⭐ 179
   Model Context Protocol Servers in Quarkus

1080. **[k8s-mcp-server](https://github.com/alexei-led/k8s-mcp-server)** - ⭐ 179
   K8s-mcp-server is a Model Context Protocol (MCP) server that enables AI assistants like Claude to securely execute Kubernetes commands. It provides a bridge between language models and essential Kubernetes CLI tools including kubectl, helm, istioctl, and argocd, allowing AI systems to assist with cluster management, troubleshooting, and deployments

1081. **[Geargrafx](https://github.com/drhelius/Geargrafx)** - ⭐ 179
...
1082. **[wikipedia-mcp](https://github.com/Rudra-ravi/wikipedia-mcp)** - ⭐ 179
   A Model Context Protocol (MCP) server that retrieves information from Wikipedia to provide context to LLMs.

1083. **[mcp-text-editor](https://github.com/tumf/mcp-text-editor)** - ⭐ 178

1084. **[claude-code-mcp](https://github.com/auchenberg/claude-code-mcp)** - ⭐ 178
   claude-code-mcp

1085. **[MakeMoneyWithAI](https://github.com/garylab/MakeMoneyWithAI)** - ⭐ 178
...
1088. **[mcp-server-siri-shortcuts](https://github.com/dvcrn/mcp-server-siri-shortcuts)** - ⭐ 177
   MCP for calling Siri Shorcuts from LLMs

1089. **[claude-context-local](https://github.com/FarhanAliRaza/claude-context-local)** - ⭐ 176
...
1090. **[stitch](https://github.com/gemini-cli-extensions/stitch)** - ⭐ 176
   The Stitch extension for Gemini CLI enables you to interact with the Stitch MCP server using natural language commands. 

1091. **[ida-mcp-server-plugin](https://github.com/taida957789/ida-mcp-server-plugin)** - ⭐ 175
   IDA Pro Plugin for serving MCP SSE server for cursor / claude

1092. **[ai-counsel](https://github.com/blueman82/ai-counsel)** - ⭐ 175
   True deliberative consensus MCP server where AI models debate and refine positions across multiple rounds

1093. **[quarkus-mcp-server](https://github.com/quarkiverse/quarkus-mcp-server)** - ⭐ 175
   This extension enables developers to implement the MCP server features easily.

1094. **[git-mcp-server](https://github.com/cyanheads/git-mcp-server)** - ⭐ 175
   An MCP (Model Context Protocol) server enabling LLMs and AI agents to interact with Git repositories. Provides tools for comprehensive Git operations including clone, commit, branch, diff, log, status, push, pull, merge, rebase, worktree, tag management, and more, via the MCP standard. STDIO & HTTP.

1095. **[mongo-mcp](https://github.com/QuantGeekDev/mongo-mcp)** - ⭐ 174
   A mongo db server for the model context protocol (MCP)

1096. **[bilibili-mcp-server](https://github.com/huccihuang/bilibili-mcp-server)** - ⭐ 174
   MCP Server for the Bilibili API, supporting various operations.

1097. **[pctx](https://github.com/portofcontext/pctx)** - ⭐ 173
...
1098. **[Revornix](https://github.com/Qingyon-AI/Revornix)** - ⭐ 173
...
1099. **[mcp-snowflake-server](https://github.com/isaacwasserman/mcp-snowflake-server)** - ⭐ 173

1100. **[smart-coding-mcp](https://github.com/omar-haris/smart-coding-mcp)** - ⭐ 173
...
1101. **[spring-ai-playground](https://github.com/JM-Lab/spring-ai-playground)** - ⭐ 172
...
1102. **[mcp-chat](https://github.com/PipedreamHQ/mcp-chat)** - ⭐ 172
   Examples of using Pipedream's MCP server in your app or AI agent.

1103. **[aws-finops-mcp-server](https://github.com/ravikiranvm/aws-finops-mcp-server)** - ⭐ 171
   An MCP (Model Context Protocol) server that brings powerful AWS FinOps capabilities directly into your AI assistant. Analyze cloud costs, audit for waste, and get budget insights using natural language, all while keeping your credentials secure on your local machine.

1104. **[skunit](https://github.com/mehrandvd/skunit)** - ⭐ 171
   skUnit is a testing tool for AI units, such as IChatClient, MCP Servers and agents.

1105. **[mcp-server-duckdb](https://github.com/ktanaka101/mcp-server-duckdb)** - ⭐ 171
   A Model Context Protocol (MCP) server implementation for DuckDB, providing database interaction capabilities

1106. **[aws-mcp-server](https://github.com/alexei-led/aws-mcp-server)** - ⭐ 171
   A lightweight service that enables AI assistants to execute AWS CLI commands (in safe containerized environment) through the Model Context Protocol (MCP). Bridges Claude, Cursor, and other MCP-aware AI tools with AWS CLI for enhanced cloud infrastructure management.

1107. **[comfyui-mcp-server](https://github.com/joenorton/comfyui-mcp-server)** - ⭐ 171
   lightweight Python-based MCP (Model Context Protocol) server for local ComfyUI

1108. **[tomcp](https://github.com/Ami3466/tomcp)** - ⭐ 170
   Turn any website or doc into an MCP server

1109. **[Text2Sql.Net](https://github.com/AIDotNet/Text2Sql.Net)** - ⭐ 170
   Text2Sql.Net 是一个使用DotNet和Semantic Kernel开发的Text2Sql工具

1110. **[command](https://github.com/scopecraft/command)** - ⭐ 170
   Scopecraft Command - A CLI and MCP server for Markdown-Driven Task Management (MDTM)

1111. **[discordmcp](https://github.com/v-3/discordmcp)** - ⭐ 170
   Discord MCP Server for Claude Integration

1112. **[mcp-logseq](https://github.com/ergut/mcp-logseq)** - ⭐ 170
   MCP server to interact with LogSeq via its Local HTTP API - enabling AI assistants like Claude to seamlessly read, write, and manage your LogSeq graph.

1113. **[mcp-servers](https://github.com/cursor/mcp-servers)** - ⭐ 170
   A list of MCP (Model Context Protocol) servers for developer tools and services

1114. **[mcp-scholarly](https://github.com/adityak74/mcp-scholarly)** - ⭐ 169
   A MCP server to search for accurate academic articles.

1115. **[facebook-ads-library-mcp](https://github.com/talknerdytome-labs/facebook-ads-library-mcp)** - ⭐ 169
   MCP Server for Facebook ADs Library - Get instant answers from FB's ad library

1116. **[after-effects-mcp](https://github.com/Dakkshin/after-effects-mcp)** - ⭐ 169
   MCP Server for Adobe After Effects. Enables remote control (compositions, text, shapes, solids, properties) via the Model Context Protocol using ExtendScript.

1117. **[openapi-mcp](https://github.com/ckanthony/openapi-mcp)** - ⭐ 168
   Dockerized MCP Server to allow your AI agent to access any API with existing api docs

1118. **[google-analytics-mcp](https://github.com/surendranb/google-analytics-mcp)** - ⭐ 168
...
1119. **[tableau-mcp](https://github.com/tableau/tableau-mcp)** - ⭐ 168
...
1120. **[y-gui](https://github.com/luohy15/y-gui)** - ⭐ 167
   A Tiny Web Chat App for AI Models with MCP Client Support

1121. **[mcp-google-map](https://github.com/cablate/mcp-google-map)** - ⭐ 167
   A powerful Model Context Protocol (MCP) server providing comprehensive Google Maps API integration with LLM processing capabilities.

1122. **[xero-mcp-server](https://github.com/XeroAPI/xero-mcp-server)** - ⭐ 167
   An MCP server that integrates with the MCP protocol. https://modelcontextprotocol.io/introduction

1123. **[claudepro-directory](https://github.com/JSONbored/claudepro-directory)** - ⭐ 166
...
1124. **[Chanakya-Local-Friend](https://github.com/Rishabh-Bajpai/Chanakya-Local-Friend)** - ⭐ 166
...
1125. **[markmap-mcp-server](https://github.com/jinzcdev/markmap-mcp-server)** - ⭐ 166
   An MCP server for converting Markdown to interactive mind maps with export support (PNG/JPG/SVG).

1126. **[toolbase](https://github.com/Toolbase-AI/toolbase)** - ⭐ 166
   A desktop application that adds powerful tools to Claude and AI platforms

1127. **[life-sciences](https://github.com/anthropics/life-sciences)** - ⭐ 166
...
1128. **[mcp-use-ts](https://github.com/mcp-use/mcp-use-ts)** - ⭐ 165
   mcp-use is the framework for MCP with the best DX - Build AI agents, create MCP   servers with UI widgets, and debug with built-in inspector. Includes client SDK, server SDK, React hooks, and powerful dev tools.

1129. **[mcp-server-wazuh](https://github.com/gbrigandi/mcp-server-wazuh)** - ⭐ 165
   MCP Server for Wazuh SIEM

1130. **[keyboard-local](https://github.com/keyboard-dev/keyboard-local)** - ⭐ 164
   One MCP Server, All Your Apps, Privacy First

1131. **[mcp-agent-langchainjs](https://github.com/Azure-Samples/mcp-agent-langchainjs)** - ⭐ 164
...
1132. **[install-mcp](https://github.com/supermemoryai/install-mcp)** - ⭐ 164
   A simple CLI to install MCP servers into any client - auth included!

1133. **[burp-mcp-agents](https://github.com/six2dez/burp-mcp-agents)** - ⭐ 164
   Practical setup guides and helpers to connect Burp Suite MCP Server to multiple AI backends (Codex, Gemini, Ollama, ...).

1134. **[meilisearch-mcp](https://github.com/meilisearch/meilisearch-mcp)** - ⭐ 163
   A Model Context Protocol (MCP) server for interacting with Meilisearch through LLM interfaces.

1135. **[dify-mcp-client](https://github.com/3dify-project/dify-mcp-client)** - ⭐ 163
   MCP Client as an Agent Strategy Plugin. Support GUI operation via UI-TARS-SDK.

1136. **[mcp-telegram](https://github.com/sparfenyuk/mcp-telegram)** - ⭐ 163
   MCP server to work with Telegram through MTProto

1137. **[mcp](https://github.com/magicuidesign/mcp)** - ⭐ 163
   Official Magic UI MCP server.

1138. **[appium-mcp](https://github.com/appium/appium-mcp)** - ⭐ 163
   Appium MCP on Steroids!

1139. **[mcp-server-weaviate](https://github.com/weaviate/mcp-server-weaviate)** - ⭐ 162
   MCP (Model Context Protocol) server for Weaviate

1140. **[lsp-mcp](https://github.com/jonrad/lsp-mcp)** - ⭐ 162
   An Model Context Protocol (MCP) server that provides LLMs/AI Agents with the capabilities of a language server protocol (LSP) server. This gives the AI the ability to get language aware context from the codebase.

1141. **[c4-genai-suite](https://github.com/codecentric/c4-genai-suite)** - ⭐ 162
   c4 GenAI Suite

1142. **[mcp-access-point](https://github.com/sxhxliang/mcp-access-point)** - ⭐ 162
   Turn a web server into an MCP server in one click without making any code changes.

1143. **[sketchup-mcp](https://github.com/mhyrr/sketchup-mcp)** - ⭐ 162
   Sketchup Model Context Protocol

1144. **[agentregistry](https://github.com/agentregistry-dev/agentregistry)** - ⭐ 161
   Fast-track AI innovation with a centralized, trusted, curated registry

1145. **[sudocode](https://github.com/sudocode-ai/sudocode)** - ⭐ 161
   Lightweight agent orchestration dev tool that lives in your repo

1146. **[dbt-llm-agent](https://github.com/pragunbhutani/dbt-llm-agent)** - ⭐ 160
   LLM based AI Agent to automate Data Analysis for dbt projects with remote MCP server

1147. **[jmap-mcp](https://github.com/wyattjoh/jmap-mcp)** - ⭐ 160
   A Model Context Protocol (MCP) server that provides tools for interacting with JMAP (JSON Meta Application Protocol) email servers. Built with Deno and using the jmap-jam client library.

1148. **[cli-mcp-server](https://github.com/MladenSU/cli-mcp-server)** - ⭐ 160
   Command line interface for MCP clients with secure execution and customizable security policies

1149. **[gbox](https://github.com/babelcloud/gbox)** - ⭐ 160
   Cli and MCP for gbox. Enable AI agents to operate Android/Browser/Desktop like human.

1150. **[mcp-server-guide](https://github.com/figma/mcp-server-guide)** - ⭐ 160
   A guide on how to use the Figma MCP server

1151. **[Quickchart-MCP-Server](https://github.com/GongRzhe/Quickchart-MCP-Server)** - ⭐ 159
...
1152. **[mcp-shell-server](https://github.com/tumf/mcp-shell-server)** - ⭐ 159

1153. **[Companion](https://github.com/mattt/Companion)** - ⭐ 159
   Your neighborhood friendly MCP utility for macOS, iOS, and visionOS

1154. **[discord-mcp](https://github.com/SaseQ/discord-mcp)** - ⭐ 159
   A MCP server for the Discord integration. Enable your AI assistants to seamlessly interact with Discord. Enhance your Discord experience with powerful automation capabilities.

1155. **[remote-mcp-server](https://github.com/gleanwork/remote-mcp-server)** - ⭐ 158
   Remote MCP Server that securely connects Enterprise context with your LLM, IDE, or agent platform of choice.

1156. **[slack-mcp-client](https://github.com/tuannvm/slack-mcp-client)** - ⭐ 158
...
1157. **[UnityNaturalMCP](https://github.com/notargs/UnityNaturalMCP)** - ⭐ 158
   UnityNaturalMCP is an MCP server implementation for Unity that aims for a "natural" user experience.

1158. **[open-streetmap-mcp](https://github.com/jagan-shanmugam/open-streetmap-mcp)** - ⭐ 158
   An OpenStreetMap MCP server implementation that enhances LLM capabilities with location-based services and geospatial data.

1159. **[photoshop-python-api-mcp-server](https://github.com/loonghao/photoshop-python-api-mcp-server)** - ⭐ 158
   A Model Context Protocol (MCP) server that interfaces with Adobe Photoshop's Python API. Enables LLMs to execute image editing operations, automate workflows, and manage Photoshop tasks through structured commands and context-aware interactions.

1160. **[fetch-mcp](https://github.com/egoist/fetch-mcp)** - ⭐ 157
   An MCP server for fetching URLs / Youtube video transcript.

1161. **[spotinfo](https://github.com/alexei-led/spotinfo)** - ⭐ 157
   CLI for exploring AWS EC2 Spot inventory. Inspect AWS Spot instance types, saving, price, and interruption frequency.

1162. **[compliant-llm](https://github.com/fiddlecube/compliant-llm)** - ⭐ 157
   Build Secure and Compliant AI agents and MCP Servers. YC W23

1163. **[docs](https://github.com/strands-agents/docs)** - ⭐ 157
   Documentation for the Strands Agents SDK. A model-driven approach to building AI agents in just a few lines of code. 

1164. **[mcp](https://github.com/neo4j/mcp)** - ⭐ 157
   Neo4j official MCP Server

1165. **[opentelemetry-mcp-server](https://github.com/traceloop/opentelemetry-mcp-server)** - ⭐ 157
   Unified MCP server for querying OpenTelemetry traces across multiple backends (Jaeger, Tempo, Traceloop, etc.), enabling AI agents to analyze distributed traces for automated debugging and observability.

1166. **[DrissionPageMCP](https://github.com/wxhzhwxhzh/DrissionPageMCP)** - ⭐ 157
   基于DrissionPage和FastMCP的浏览器自动化MCP服务器，提供丰富的浏览器操作API供AI调用

1167. **[pg-mcp-server](https://github.com/ericzakariasson/pg-mcp-server)** - ⭐ 157
   MCP Server for Postgres

1168. **[toolsdk-mcp-registry](https://github.com/toolsdk-ai/toolsdk-mcp-registry)** - ⭐ 156
...
1169. **[claude-config-editor](https://github.com/gagarinyury/claude-config-editor)** - ⭐ 156
...
1170. **[integrate-mcp-with-copilot](https://github.com/skills/integrate-mcp-with-copilot)** - ⭐ 156
   Learn how to use MCP Servers with GitHub Copilot

1171. **[recall](https://github.com/joseairosa/recall)** - ⭐ 155
   Give Claude perfect recall - Redis-powered persistent memory for LLMs

1172. **[mcp-client-slackbot](https://github.com/sooperset/mcp-client-slackbot)** - ⭐ 155
   Simple Slackbot MCP Client

1173. **[gate22](https://github.com/aipotheosis-labs/gate22)** - ⭐ 155
...
1174. **[XPack-MCP-Marketplace](https://github.com/xpack-ai/XPack-MCP-Marketplace)** - ⭐ 154
...
1175. **[awesome-a2a](https://github.com/pab1it0/awesome-a2a)** - ⭐ 154
   Agent2Agent (A2A) – awesome A2A agents, tools, servers & clients, all in one place. 

1176. **[alibabacloud-tablestore-mcp-server](https://github.com/aliyun/alibabacloud-tablestore-mcp-server)** - ⭐ 154

1177. **[mcp-opennutrition](https://github.com/deadletterq/mcp-opennutrition)** - ⭐ 154
...
1178. **[flights-mcp](https://github.com/ravinahp/flights-mcp)** - ⭐ 153
   An MCP server to search for flights.

1179. **[mcp-server-langfuse](https://github.com/langfuse/mcp-server-langfuse)** - ⭐ 153
   Model Context Protocol (MCP) Server for Langfuse Prompt Management. This server allows you to access and manage your Langfuse prompts through the Model Context Protocol.

1180. **[MCP-Salesforce](https://github.com/smn2gnt/MCP-Salesforce)** - ⭐ 153
   MCP Salesforce connector

1181. **[superset-mcp](https://github.com/aptro/superset-mcp)** - ⭐ 153
   connect to 50+ data stores via superset mcp server. Can use with open ai agent sdk, Claude app, cursor, windsurf

1182. **[python-mcp-server-client](https://github.com/GobinFan/python-mcp-server-client)** - ⭐ 152
   支持查询主流agent框架技术文档的MCP server（支持stdio和sse两种传输协议）, 支持 langchain、llama-index、autogen、agno、openai-agents-sdk、mcp-doc、camel-ai 和 crew-ai

1183. **[mcp-summarizer](https://github.com/0xshellming/mcp-summarizer)** - ⭐ 152
   MCP Server for AI Summarization

1184. **[web3-research-mcp](https://github.com/aaronjmars/web3-research-mcp)** - ⭐ 152
   Deep Research for crypto - free & fully local

1185. **[mcp-simple-pubmed](https://github.com/andybrandt/mcp-simple-pubmed)** - ⭐ 152
   MCP server for searching and querying PubMed medical papers/research database

1186. **[mcptools](https://github.com/posit-dev/mcptools)** - ⭐ 152
   Model Context Protocol For R

1187. **[penpot-mcp](https://github.com/penpot/penpot-mcp)** - ⭐ 152
   Penpot's official MCP Server

1188. **[tmcp](https://github.com/paoloricciuti/tmcp)** - ⭐ 151
   Typescript SDK to build MCP servers in an agnostic way

1189. **[awesome-claude-dxt](https://github.com/milisp/awesome-claude-dxt)** - ⭐ 150
   Awesome Claude Desktop Extensions (dxt) (not only Claude) mcpb

1190. **[mcp-server-metamcp](https://github.com/metatool-ai/mcp-server-metamcp)** - ⭐ 150
   MCP Server MetaMCP manages all your other MCPs in one MCP.

1191. **[instagram_dm_mcp](https://github.com/trypeggy/instagram_dm_mcp)** - ⭐ 150
   Instagram Direct messages MCP

1192. **[mcp-gateway](https://github.com/lightconetech/mcp-gateway)** - ⭐ 150
   A gateway demo for MCP SSE Server

1193. **[metatrader-mcp-server](https://github.com/ariadng/metatrader-mcp-server)** - ⭐ 150
   Model Context Protocol (MCP) to enable AI LLMs to trade using MetaTrader platform

1194. **[eShopLite](https://github.com/Azure-Samples/eShopLite)** - ⭐ 150
   eShopLite is a set of reference .NET applications implementing an eCommerce site with features like Semantic Search, MCP, Reasoning models and more.

1195. **[scrapeless-mcp-server](https://github.com/scrapeless-ai/scrapeless-mcp-server)** - ⭐ 150
   Scrapeless Mcp Server

1196. **[SharpToolsMCP](https://github.com/kooshi/SharpToolsMCP)** - ⭐ 150
   A suite of MCP tools for AIs to analyze and modify C# solutions with high signal, Roslyn powered context.

1197. **[postman-mcp-server](https://github.com/postmanlabs/postman-mcp-server)** - ⭐ 150
   Connect your AI to your APIs on Postman

1198. **[mcp-server-example](https://github.com/alejandro-ao/mcp-server-example)** - ⭐ 149
   A simple MCP server to search for documentation (tutorial)

1199. **[garmin_mcp](https://github.com/Taxuspt/garmin_mcp)** - ⭐ 149
   MCP server to access Garmin data

1200. **[mcp-shark](https://github.com/mcp-shark/mcp-shark)** - ⭐ 149
...
1201. **[tinymcp](https://github.com/golioth/tinymcp)** - ⭐ 148
   Let LLMs control embedded devices via the Model Context Protocol.

1202. **[MCPHub-Desktop](https://github.com/Jeamee/MCPHub-Desktop)** - ⭐ 148
   Desktop APP for Discover and Install MCP Servers

1203. **[mcp-client-go](https://github.com/yincongcyincong/mcp-client-go)** - ⭐ 148
   mcp client for Go (Golang). Integrate multiple  Model Context Protocol (MCP) servers

1204. **[make-mcp-server](https://github.com/integromat/make-mcp-server)** - ⭐ 148
   Make MCP Server

1205. **[GEmojiSharp](https://github.com/hlaueriksson/GEmojiSharp)** - ⭐ 148
   :octocat: GitHub Emoji for C#, dotnet and beyond

1206. **[mcp-solver](https://github.com/szeider/mcp-solver)** - ⭐ 148
   Model Context Protocol (MCP) server for constraint optimization and solving"

1207. **[mcp-3D-printer-server](https://github.com/DMontgomery40/mcp-3D-printer-server)** - ⭐ 148
   Connects MCP to major 3D printer APIs (Orca, Bambu, OctoPrint, Klipper, Duet, Repetier, Prusa, Creality). Control prints, monitor status, and perform advanced STL operations like scaling, rotation, sectional editing, and base extension. Includes slicing and visualization.

1208. **[task-orchestrator](https://github.com/jpicklyk/task-orchestrator)** - ⭐ 147
...
1209. **[lucid-agents](https://github.com/daydreamsai/lucid-agents)** - ⭐ 147
...
1210. **[cursor-notebook-mcp](https://github.com/jbeno/cursor-notebook-mcp)** - ⭐ 147
   Model Context Protocol (MCP) server designed to allow AI agents within Cursor to interact with Jupyter Notebook (.ipynb) files

1211. **[sunpeak](https://github.com/Sunpeak-AI/sunpeak)** - ⭐ 147
   Local-first ChatGPT App framework.

1212. **[relay](https://github.com/prism-php/relay)** - ⭐ 147
   An MCP client tool for Prism

1213. **[chatgpt-copilot](https://github.com/feiskyer/chatgpt-copilot)** - ⭐ 147
   ChatGPT Copilot Extension for Visual Studio Code

1214. **[codex-mcp-server](https://github.com/tuannvm/codex-mcp-server)** - ⭐ 147
   MCP server wrapper for OpenAI Codex CLI that enables Claude Code to leverage Codex's AI capabilities directly.

1215. **[Gemini-mcp](https://github.com/LKbaba/Gemini-mcp)** - ⭐ 146
   MCP server implementation for Google's Gemini API

1216. **[any-chat-completions-mcp](https://github.com/pyroprompts/any-chat-completions-mcp)** - ⭐ 146
   MCP Server for using any LLM as a Tool

1217. **[Log-Analyzer-with-MCP](https://github.com/awslabs/Log-Analyzer-with-MCP)** - ⭐ 146
   A Model Context Protocol (MCP) server that provides AI assistants access to AWS CloudWatch Logs for analysis, searching, and correlation

1218. **[decipher-research-agent](https://github.com/mtwn105/decipher-research-agent)** - ⭐ 146
   Turn topics, links, and files into AI-generated research notebooks — summarize, explore, and ask anything.

1219. **[mcp-dotnet-samples](https://github.com/microsoft/mcp-dotnet-samples)** - ⭐ 146
   A comprehensive set of samples of creating and using MCP servers and clients with .NET

1220. **[CreatorBox](https://github.com/xiesx123/CreatorBox)** - ⭐ 146
   🚀🎬灵活、高效、可扩展，专属剪辑配音工具箱，释放创作潜力 . Flexible, efficient, and scalable toolbox for editing and dubbing, unleashing creative potential

1221. **[mcp-server-weread](https://github.com/ChenyqThu/mcp-server-weread)** - ⭐ 145

1222. **[figma-mcp-server](https://github.com/TimHolden/figma-mcp-server)** - ⭐ 145
   Model Context Protocol server implementation for Figma API

1223. **[open-responses-server](https://github.com/teabranch/open-responses-server)** - ⭐ 145
   Wraps any OpenAI API interface as Responses with MCPs support so it supports Codex. Adding any missing stateful features. Ollama and Vllm compliant.

1224. **[ultimate_mcp_client](https://github.com/Dicklesworthstone/ultimate_mcp_client)** - ⭐ 145

1225. **[postman-mcp-server](https://github.com/delano/postman-mcp-server)** - ⭐ 145
   An MCP server that provides access to Postman.

1226. **[mcp-mysql-server](https://github.com/f4ww4z/mcp-mysql-server)** - ⭐ 145
   A Model Context Protocol server for MySQL database operations

1227. **[polymarket-mcp-server](https://github.com/caiovicentino/polymarket-mcp-server)** - ⭐ 145
   🤖 AI-Powered MCP Server for Polymarket - Enable Claude to trade prediction markets with 45 tools, real-time monitoring, and enterprise-grade safety features

1228. **[goku](https://github.com/jcaromiq/goku)** - ⭐ 144
   Goku is an HTTP load testing application written in Rust 

1229. **[agentor](https://github.com/CelestoAI/agentor)** - ⭐ 144
...
1230. **[hypertool-mcp](https://github.com/toolprint/hypertool-mcp)** - ⭐ 144
   Dynamically expose tools from proxied servers based on an Agent Persona

1231. **[uaip](https://github.com/concierge-hq/uaip)** - ⭐ 144
...
1232. **[plane-mcp-server](https://github.com/makeplane/plane-mcp-server)** - ⭐ 144
...
1235. **[concierge](https://github.com/concierge-hq/concierge)** - ⭐ 144
   Open Source AI platform to build Agentic services, ChatGPT Apps and MCP Servers

1236. **[website-downloader](https://github.com/pskill9/website-downloader)** - ⭐ 143
   MCP server to download entire websites

1237. **[OpenDataMCP](https://github.com/OpenDataMCP/OpenDataMCP)** - ⭐ 143
   Connect any Open Data to any LLM with Model Context Protocol.

1238. **[mcp-servers](https://github.com/charIesding/mcp-servers)** - ⭐ 143
   mcp server implementations

1239. **[pubmearch](https://github.com/Darkroaster/pubmearch)** - ⭐ 143
   A PubMed MCP server.

1240. **[obsidian-claude-code-mcp](https://github.com/iansinnott/obsidian-claude-code-mcp)** - ⭐ 143
   Connect Claude Code and other AI tools to your Obsidian notes using Model Context Protocol (MCP)

1241. **[notion-mcp-server](https://github.com/awkoy/notion-mcp-server)** - ⭐ 143
   **Notion MCP Server** is a Model Context Protocol (MCP) server implementation that enables AI assistants to interact with Notion's API. This production-ready server provides a complete set of tools.

1242. **[mcp-1panel](https://github.com/1Panel-dev/mcp-1panel)** - ⭐ 142
   mcp-1panel is an implementation of the Model Context Protocol (MCP) server for 1Panel.

1243. **[quick-data-mcp](https://github.com/disler/quick-data-mcp)** - ⭐ 142
   Prompt focused MCP Server for .json and .csv agentic data analytics for Claude Code

1244. **[osint-tools-mcp-server](https://github.com/frishtik/osint-tools-mcp-server)** - ⭐ 142
   MCP server exposing multiple OSINT tools for AI assistants like Claude

1245. **[mcp-server-starrocks](https://github.com/StarRocks/mcp-server-starrocks)** - ⭐ 142
   StarRocks MCP (Model Context Protocol) Server

1246. **[kom](https://github.com/weibaohui/kom)** - ⭐ 142
   kom 是一个用于 Kubernetes 操作的工具，SDK级的kubectl、client-go的使用封装。并且支持作为管理k8s 的 MCP server。 它提供了一系列功能来管理 Kubernetes 资源，包括创建、更新、删除和获取资源，甚至使用SQL查询k8s资源。这个项目支持多种 Kubernetes 资源类型的操作，并能够处理自定义资源定义（CRD）。 通过使用 kom，你可以轻松地进行资源的增删改查和日志获取以及操作POD内文件等动作。

1247. **[ReActMCP](https://github.com/mshojaei77/ReActMCP)** - ⭐ 141
   ReActMCP is a reactive MCP client that empowers AI assistants to instantly respond with real-time, Markdown-formatted web search insights powered by the Exa API.

1248. **[mcp-discord](https://github.com/hanweg/mcp-discord)** - ⭐ 141
   MCP server for discord bot

1249. **[mcp-server-calculator](https://github.com/githejie/mcp-server-calculator)** - ⭐ 141
   A Model Context Protocol server for calculating.

1250. **[code-assistant](https://github.com/stippi/code-assistant)** - ⭐ 141
   An LLM-powered, autonomous coding assistant. Also offers an MCP and ACP mode.

1251. **[mcp-server-odoo](https://github.com/ivnvxd/mcp-server-odoo)** - ⭐ 141
   A Model Context Protocol (MCP) server that enables AI assistants to securely interact with Odoo ERP systems through standardized resources and tools for data retrieval and manipulation.

1252. **[node-code-sandbox-mcp](https://github.com/alfonsograziano/node-code-sandbox-mcp)** - ⭐ 140
   A Node.js–based Model Context Protocol server that spins up disposable Docker containers to execute arbitrary JavaScript.

1253. **[powerpoint](https://github.com/supercurses/powerpoint)** - ⭐ 140
   A MCP Server for creating Powerpoint Presentations

1254. **[logfire-mcp](https://github.com/pydantic/logfire-mcp)** - ⭐ 140
   The Logfire MCP Server is here! :tada:

1255. **[mcp-interviewer](https://github.com/microsoft/mcp-interviewer)** - ⭐ 140
   Catch MCP server issues before your agents do.

1256. **[strudel-mcp-server](https://github.com/williamzujkowski/strudel-mcp-server)** - ⭐ 140
   A Model Context Protocol (MCP) server that gives Claude direct control over Strudel.cc for AI-assisted music generation and live coding.

1257. **[seo-research-mcp](https://github.com/egebese/seo-research-mcp)** - ⭐ 140
...
1258. **[mcp-montano-server](https://github.com/lucasmontano/mcp-montano-server)** - ⭐ 139
   Simple MCP Server Implementation

1259. **[MCP-X](https://github.com/TimeCyber/MCP-X)** - ⭐ 139
...
1260. **[agentql-mcp](https://github.com/tinyfish-io/agentql-mcp)** - ⭐ 139
   Model Context Protocol server that integrates AgentQL's data extraction capabilities.

1261. **[google-slides-mcp](https://github.com/matteoantoci/google-slides-mcp)** - ⭐ 139
   MCP Server for Google Slides

1262. **[rust-mcp-sdk](https://github.com/rust-mcp-stack/rust-mcp-sdk)** - ⭐ 139
   A high-performance, asynchronous toolkit for building MCP servers and clients in Rust.

1263. **[MaxMSP-MCP-Server](https://github.com/tiianhk/MaxMSP-MCP-Server)** - ⭐ 139
   MCP (Model Context Protocol) Server for Max (Max/MSP/Jitter)

1264. **[mcp-email-server](https://github.com/ai-zerolab/mcp-email-server)** - ⭐ 139
   IMAP and SMTP via MCP Server

1265. **[datagov-mcp](https://github.com/aviveldan/datagov-mcp)** - ⭐ 138
   MCP server for Israel Government Data

1266. **[eion](https://github.com/eiondb/eion)** - ⭐ 138
   Shared Memory Storage for Multi-Agent Systems

1267. **[systemprompt-code-orchestrator](https://github.com/systempromptio/systemprompt-code-orchestrator)** - ⭐ 138
     MCP server for orchestrating AI coding agents (Claude Code CLI & Gemini CLI). Features task management, process execution, Git integration, and dynamic resource discovery. Full TypeScript implementation with Docker support and Cloudflare Tunnel integration. 

1268. **[autocad-mcp](https://github.com/puran-water/autocad-mcp)** - ⭐ 138
...
1269. **[frontmcp](https://github.com/agentfront/frontmcp)** - ⭐ 138
   TypeScript-first framework for the Model Context Protocol (MCP). You write clean, typed code; FrontMCP handles the protocol, transport, DI, session/auth, and execution flow.

1270. **[refref](https://github.com/refrefhq/refref)** - ⭐ 138
   🌟 Open Source Referral and Affiliate Marketing Platform - Launch your referral program in minutes!

1271. **[wa_llm](https://github.com/ilanbenb/wa_llm)** - ⭐ 138
   A WhatsApp bot that can participate in group conversations, powered by AI. The bot monitors group messages and responds when mentioned.

1272. **[graphiti-mcp-server](https://github.com/gifflet/graphiti-mcp-server)** - ⭐ 137
   Graphiti MCP Server

1273. **[SecureMCP](https://github.com/makalin/SecureMCP)** - ⭐ 137
...
1274. **[memory-graph](https://github.com/memory-graph/memory-graph)** - ⭐ 137
   A graph DB-based MCP memory server for coding agents with intelligent relationship tracking

1275. **[mssql-mcp](https://github.com/Aaronontheweb/mssql-mcp)** - ⭐ 137
   MSSQL Server MCP implementation written in C#

1276. **[guidance-for-deploying-model-context-protocol-servers-on-aws](https://github.com/aws-solutions-library-samples/guidance-for-deploying-model-context-protocol-servers-on-aws)** - ⭐ 137
...
1277. **[mcp-k8s](https://github.com/silenceper/mcp-k8s)** - ⭐ 137
   A Kubernetes MCP (Model Control Protocol) server that enables interaction with Kubernetes clusters through MCP tools.

1278. **[bilibili-mcp-js](https://github.com/34892002/bilibili-mcp-js)** - ⭐ 137
   Bilibili video search MCP (Model Context Protocol) service - 哔哩哔哩视频搜索MCP服务

1279. **[doc-ops-mcp](https://github.com/Tele-AI/doc-ops-mcp)** - ⭐ 136
   MCP server for seamless document format conversion and processing

1280. **[backlog-mcp-server](https://github.com/nulab/backlog-mcp-server)** - ⭐ 136

1281. **[linux-mcp-server](https://github.com/rhel-lightspeed/linux-mcp-server)** - ⭐ 136
   Tools to allow LLM clients to interact with Linux systems remotely

1282. **[agent-toolkit](https://github.com/datacommonsorg/agent-toolkit)** - ⭐ 135
   Tools and agents for interacting with the Data Commons Knowledge Graph using the Model Context Protocol (MCP).

1283. **[mcp-server-serper](https://github.com/marcopesani/mcp-server-serper)** - ⭐ 135
   Serper MCP Server supporting search and webpage scraping

1284. **[k8s-mcp-server](https://github.com/reza-gholizade/k8s-mcp-server)** - ⭐ 135
   Manage Your Kubernetes Cluster with k8s mcp-server

1285. **[zabbix-mcp-server](https://github.com/mpeirone/zabbix-mcp-server)** - ⭐ 135
...
1286. **[Context-Engineering-for-Multi-Agent-Systems](https://github.com/Denis2054/Context-Engineering-for-Multi-Agent-Systems)** - ⭐ 135
...
1287. **[ultimate_mcp_server](https://github.com/Dicklesworthstone/ultimate_mcp_server)** - ⭐ 135
   The Ultimate Model Context Protocol (MCP) Server, providing unified access to a wide variety of useful and powerful tools.

1288. **[mkinf](https://github.com/mkinf-io/mkinf)** - ⭐ 134
   mkinf SDK to interact with mkinf hub MCP servers

1289. **[hayhooks](https://github.com/deepset-ai/hayhooks)** - ⭐ 134
   Easily deploy Haystack pipelines as REST APIs and MCP Tools.

1290. **[mcp-server-typescript](https://github.com/dataforseo/mcp-server-typescript)** - ⭐ 134
   DataForSEO API modelcontextprotocol server 

1291. **[zettelkasten-mcp](https://github.com/entanglr/zettelkasten-mcp)** - ⭐ 134
   A Model Context Protocol (MCP) server that implements the Zettelkasten knowledge management methodology, allowing you to create, link, explore and synthesize atomic notes through Claude and other MCP-compatible clients.

1292. **[mcp-server-reddit](https://github.com/Hawstein/mcp-server-reddit)** - ⭐ 134
   A Model Context Protocol (MCP) server that provides tools for fetching Reddit content, including frontpage posts, subreddit information and hot posts, post details, and comments.

1293. **[ghost-mcp](https://github.com/MFYDev/ghost-mcp)** - ⭐ 134
   A Model Context Protocol (MCP) server for interacting with Ghost CMS through LLM interfaces like Claude. Allow you to control your Ghost blog by simply asking Claude etc.

1294. **[ssh-mcp-server](https://github.com/classfang/ssh-mcp-server)** - ⭐ 134
   基于 SSH 的 MCP 服务器 🧙‍♀️。已被MCP官方收录 🎉。 SSH MCP Server 🧙‍♀️. It has been included in the community MCP repository 🎉.

1295. **[intervals-mcp-server](https://github.com/mvilanova/intervals-mcp-server)** - ⭐ 134
   Model Context Protocol (MCP) server for connecting Claude and ChatGPT with the Intervals.icu API.

1296. **[Multi-Source-Media-MCP-Server](https://github.com/Decade-qiu/Multi-Source-Media-MCP-Server)** - ⭐ 133
   An MCP Tool Implementation for Multi-Source Image Access & Generation

1297. **[LMStudio-MCP](https://github.com/infinitimeless/LMStudio-MCP)** - ⭐ 133
   A Model Control Protocol (MCP) server that allows Claude to communicate with locally running LLM models via LM Studio.

1298. **[Awesome-MCP](https://github.com/AlexMili/Awesome-MCP)** - ⭐ 133
   Awesome ModelContextProtocol resources - A curated list of MCP resources

1299. **[mcp-think-tool](https://github.com/DannyMac180/mcp-think-tool)** - ⭐ 133
   An MCP server implementing the think tool for Claude

1300. **[Frappe_Assistant_Core](https://github.com/buildswithpaul/Frappe_Assistant_Core)** - ⭐ 133
   Infrastructure that connects LLMs to ERPNext. Frappe Assistant Core works with the Model Context Protocol (MCP) to expose ERPNext functionality to any compatible Language Model

1301. **[MCP-PostgreSQL-Ops](https://github.com/call518/MCP-PostgreSQL-Ops)** - ⭐ 133
...
1302. **[matlab-mcp-core-server](https://github.com/matlab/matlab-mcp-core-server)** - ⭐ 133
   Run MATLAB® using AI applications with the official MATLAB MCP Server from MathWorks®. This MCP server for MATLAB supports a wide range of coding agents like Claude Code® and Visual Studio® Code.

1303. **[Gitingest-MCP](https://github.com/puravparab/Gitingest-MCP)** - ⭐ 132
   mcp server for gitingest

1304. **[mcp-bigquery-server](https://github.com/ergut/mcp-bigquery-server)** - ⭐ 131
   A Model Context Protocol (MCP) server that provides secure, read-only access to BigQuery datasets. Enables Large Language Models (LLMs) to safely query and analyze data through a standardized interface.

1305. **[ragrabbit](https://github.com/madarco/ragrabbit)** - ⭐ 131
   Open Source, Self-Hosted, AI Search and LLM.txt for your website

1306. **[AgentCrew](https://github.com/saigontechnology/AgentCrew)** - ⭐ 131
   Chat application with multi-agents system supports multi-models and MCP

1307. **[mcp-chat](https://github.com/Flux159/mcp-chat)** - ⭐ 131
   Open Source Generic MCP Client for testing & evaluating mcp servers and agents

1308. **[jupyter-ai-agents](https://github.com/datalayer/jupyter-ai-agents)** - ⭐ 131
   🪐 🤖 AI Agents for JupyterLab with 🔧 MCP tools - Chat interface for optimized notebook interaction and code execution.

1309. **[OmniFocus-MCP](https://github.com/themotionmachine/OmniFocus-MCP)** - ⭐ 131
   Let LLMs interface with your tasks and projects through the Model Context Protocol. Add, organize, and query your OmniFocus database with natural language commands.

1310. **[mcp-server-macos-use](https://github.com/mediar-ai/mcp-server-macos-use)** - ⭐ 131
   AI agent that controls computer with OS-level tools, MCP compatible, works with any model

1311. **[mcp-server-apache-airflow](https://github.com/yangkyeongmo/mcp-server-apache-airflow)** - ⭐ 131

1312. **[mcp-server-manifest](https://github.com/Zomato/mcp-server-manifest)** - ⭐ 131

1313. **[mcp-gateway](https://github.com/acehoss/mcp-gateway)** - ⭐ 130
...
1314. **[freecad_mcp](https://github.com/bonninr/freecad_mcp)** - ⭐ 130
...
1315. **[drawio2go](https://github.com/Menghuan1918/drawio2go)** - ⭐ 130
   A modern DrawIO editor application.  AI-Powered, Human-AI Collaboration | AI 加持，人机共绘drawio

1316. **[awesome-crypto-mcp-servers](https://github.com/badkk/awesome-crypto-mcp-servers)** - ⭐ 129
   A collection of crypto MCP servers.

1317. **[N8N2MCP](https://github.com/Super-Chain/N8N2MCP)** - ⭐ 129
   Convert N8N agent / workflow into MCP servers, you can use it in Claude / Cursor / Super Chain 

1318. **[play-store-mcp](https://github.com/antoniolg/play-store-mcp)** - ⭐ 129
   An MCP server that connects to Play Store Console and release new App versions from an MCP Client

1319. **[A2A-MCP-Server](https://github.com/GongRzhe/A2A-MCP-Server)** - ⭐ 129
...
1320. **[claude-prompts](https://github.com/minipuft/claude-prompts)** - ⭐ 129
   MCP prompt template server: hot-reload, thinking frameworks, quality gates

1321. **[Human-In-the-Loop-MCP-Server](https://github.com/GongRzhe/Human-In-the-Loop-MCP-Server)** - ⭐ 129
...
1322. **[unifi-network-mcp](https://github.com/sirkirby/unifi-network-mcp)** - ⭐ 129
   MCP server implementation for the UniFi network application

1323. **[xhs-mcp-server](https://github.com/aicu-icu/xhs-mcp-server)** - ⭐ 128
   小红书MCP服务器 | 基于Electron+小红书Web API。一键安装运行、极速抓取笔记、评论、用户等数据并让AI智能分析、整理与导出

1324. **[aws-cost-explorer-mcp-server](https://github.com/aarora79/aws-cost-explorer-mcp-server)** - ⭐ 128
   MCP server for understanding AWS spend

1325. **[mcp-server-aws](https://github.com/rishikavikondala/mcp-server-aws)** - ⭐ 128
   A Model Context Protocol server implementation for operations on AWS resources

1326. **[esp-mcp](https://github.com/horw/esp-mcp)** - ⭐ 128
   Centralize ESP32 related commands and simplify getting started with seamless, LLM-driven interaction and help.

1327. **[mcp-rubber-duck](https://github.com/nesquikm/mcp-rubber-duck)** - ⭐ 128
   An MCP server that acts as a bridge to query multiple OpenAI-compatible LLMs with MCP tool access. Just like rubber duck debugging, explain your problems to various AI "ducks" who can actually research and get different perspectives!

1328. **[zotero-mcp](https://github.com/kujenga/zotero-mcp)** - ⭐ 127
   Model Context Protocol (MCP) server for the Zotero API, in Python

1329. **[mcp-server-plugin](https://github.com/JetBrains/mcp-server-plugin)** - ⭐ 127
   JetBrains MCP Server Plugin

1330. **[magg](https://github.com/sitbon/magg)** - ⭐ 127
   Magg: The MCP Aggregator

1331. **[mcp-read-website-fast](https://github.com/just-every/mcp-read-website-fast)** - ⭐ 127
   Quickly reads webpages and converts to markdown for fast, token efficient web scraping

1332. **[ollama-mcp](https://github.com/rawveg/ollama-mcp)** - ⭐ 127
...
1335. **[crawl4ai-mcp-server](https://github.com/weidwonder/crawl4ai-mcp-server)** - ⭐ 127
   用于提供给本地开发者的 LLM的高效互联网搜索&内容获取的MCP Server， 节省你的token

1336. **[think-mcp-server](https://github.com/PhillipRt/think-mcp-server)** - ⭐ 126
...
1346. **[beyond-mcp](https://github.com/disler/beyond-mcp)** - ⭐ 126
   It's time to push beyond MCP Servers... Right?

1347. **[play-store-mcp](https://github.com/devexpert-io/play-store-mcp)** - ⭐ 125
   An MCP server that connects to Play Store Console and release new App versions from an MCP Client
...
1353. **[opencode-studio](https://github.com/Microck/opencode-studio)** - ⭐ 124
   web GUI for securely managing local OpenCode configuration

1354. **[buttplug-mcp](https://github.com/ConAcademy/buttplug-mcp)** - ⭐ 123
   Buttplug.io Model Context Protocol (MCP) Server

1355. **[ZotLink](https://github.com/TonybotNi/ZotLink)** - ⭐ 123
...
1356. **[mcp](https://github.com/pronskiy/mcp)** - ⭐ 123
   🐉 The fast, PHP way to build MCP servers

1357. **[mcp-svelte-docs](https://github.com/spences10/mcp-svelte-docs)** - ⭐ 123
   🔍 MCP server that lets you search and access Svelte documentation with built-in caching

1358. **[unreal-analyzer-mcp](https://github.com/ayeletstudioindia/unreal-analyzer-mcp)** - ⭐ 123
   MCP server for Unreal Engine 5

1359. **[linear-mcp](https://github.com/cline/linear-mcp)** - ⭐ 122
   a private MCP server for accessing Linear

1360. **[tiktok-mcp](https://github.com/Seym0n/tiktok-mcp)** - ⭐ 122
   Model Context Protocol (MCP) with TikTok integration

1361. **[4D-ARE](https://github.com/ybeven/4D-ARE)** - ⭐ 122
...
1362. **[mcp-streamable-http](https://github.com/invariantlabs-ai/mcp-streamable-http)** - ⭐ 122
   Example implementation of MCP Streamable HTTP client/server in Python and TypeScript.

1363. **[aws-lambda-mcp-cookbook](https://github.com/ran-isenberg/aws-lambda-mcp-cookbook)** - ⭐ 122
...
1372. **[mcp-apache-spark-history-server](https://github.com/kubeflow/mcp-apache-spark-history-server)** - ⭐ 121
   MCP Server for Apache Spark History Server. The bridge between Agentic AI and Apache Spark.

1373. **[mcp-watch](https://github.com/kapilduraphe/mcp-watch)** - ⭐ 120
   A comprehensive security scanner for Model Context Protocol (MCP) servers that detects vulnerabilities and security issues in your MCP server implementations.

1374. **[mcp](https://github.com/MariaDB/mcp)** - ⭐ 120
   MariaDB MCP (Model Context Protocol) server implementation

1375. **[rust-mcp-filesystem](https://github.com/rust-mcp-stack/rust-mcp-filesystem)** - ⭐ 120
...
1377. **[pageindex-mcp](https://github.com/VectifyAI/pageindex-mcp)** - ⭐ 120
...
1378. **[figma-console-mcp](https://github.com/southleft/figma-console-mcp)** - ⭐ 120
   Your design system as an API. Connect AI to Figma for extraction, creation, and debugging.

1379. **[UnityMCP](https://github.com/isuzu-shiranui/UnityMCP)** - ⭐ 119
   Unity Editor integration with Model Context Protocol (MCP) enabling AI assistants like Claude to interact with Unity projects. Features a TypeScript MCP server and C# Unity plugin with extensible command handler architecture, TCP/IP communication, and dynamic plugin discovery.

1380. **[ffmpeg-mcp](https://github.com/egoist/ffmpeg-mcp)** - ⭐ 119
   An MCP server for FFmpeg

1381. **[mcp-package-version](https://github.com/sammcj/mcp-package-version)** - ⭐ 119
   An MCP server that provides LLMs with the latest stable package versions when coding

1382. **[n8n-mcp-server](https://github.com/illuminaresolutions/n8n-mcp-server)** - ⭐ 119
   MCP server implementation for n8n workflow automation

1383. **[MakerAi](https://github.com/gustavoeenriquez/MakerAi)** - ⭐ 118
...
1384. **[mcp-server](https://github.com/browserstack/mcp-server)** - ⭐ 118
   BrowserStack's Official MCP Server

1385. **[computer-use-mcp](https://github.com/domdomegg/computer-use-mcp)** - ⭐ 118
   💻 Give AI models complete control of your computer (probably a bad idea)

1386. **[shopify-mcp](https://github.com/GeLi2001/shopify-mcp)** - ⭐ 118
   MCP server for Shopify api, usable on mcp hosts such as Claude and Cursor

1387. **[mcp-devtools](https://github.com/sammcj/mcp-devtools)** - ⭐ 117
   A modular MCP server that provides commonly used developer tools for AI coding agents

1388. **[remote-mcp-functions-dotnet](https://github.com/Azure-Samples/remote-mcp-functions-dotnet)** - ⭐ 117
...
1389. **[jupyter-notebook-mcp](https://github.com/jjsantos01/jupyter-notebook-mcp)** - ⭐ 117
   A Model Context Protocol (MCP) for Jupyter Notebook

1390. **[memorizer-v1](https://github.com/petabridge/memorizer-v1)** - ⭐ 117
   Vector-search powered agent memory MCP server

1391. **[mcp-server-salesforce](https://github.com/tsmztech/mcp-server-salesforce)** - ⭐ 117
   Salesforce MCP Server

1392. **[uLoopMCP](https://github.com/hatayama/uLoopMCP)** - ⭐ 117
   Your Unity project's AI autopilot. Compile, test, debug, repeat—until it just works.

1393. **[SmartDB_MCP](https://github.com/wenb1n-dev/SmartDB_MCP)** - ⭐ 117
...
1394. **[laravel-toon](https://github.com/mischasigtermans/laravel-toon)** - ⭐ 117
   TOON encoding for Laravel. Encode data for AI/LLMs with ~50% fewer tokens than JSON.

1395. **[aleph](https://github.com/Hmbown/aleph)** - ⭐ 117
   Skill + MCP server for recursive LLM reasoning. Load context, iterate with search/code/think tools, converge on answers.

1396. **[elevenlabs-mcp-server](https://github.com/mamertofabian/elevenlabs-mcp-server)** - ⭐ 116

1397. **[VisionCraft-MCP-Server](https://github.com/augmentedstartups/VisionCraft-MCP-Server)** - ⭐ 116
...
1398. **[Security-Detections-MCP](https://github.com/MHaggis/Security-Detections-MCP)** - ⭐ 116
   MCP to help Defenders Detection Engineer Harder and Smarter

1399. **[paperless-mcp](https://github.com/nloui/paperless-mcp)** - ⭐ 115
   An MCP (Model Context Protocol) server for interacting with a Paperless-NGX API server. This server provides tools for managing documents, tags, correspondents, and document types in your Paperless-NGX instance.

1400. **[mcp-mianshiya-server](https://github.com/yuyuanweb/mcp-mianshiya-server)** - ⭐ 115
   基于 Spring AI 的面试鸭搜索题目的 MCP Server 服务，快速让 AI 搜索企业面试真题和答案

1401. **[MCP-Workspace-Server](https://github.com/answerlink/MCP-Workspace-Server)** - ⭐ 115
...
1402. **[kodit](https://github.com/helixml/kodit)** - ⭐ 115
   👩‍💻 MCP server to index external repositories

1403. **[mcp_proxy_rust](https://github.com/tidewave-ai/mcp_proxy_rust)** - ⭐ 115
   A proxy to use HTTP/SSE MCPs from STDIO clients

1404. **[mcp-server-asana](https://github.com/roychri/mcp-server-asana)** - ⭐ 114

1405. **[hub-mcp](https://github.com/docker/hub-mcp)** - ⭐ 114
   Docker Hub MCP Server

1406. **[turbo-flow-claude](https://github.com/marcuspat/turbo-flow-claude)** - ⭐ 114
...
1407. **[MCppServer](https://github.com/Noeli14/MCppServer)** - ⭐ 114
   Fast and super efficient Minecraft Server written in C++

1408. **[mcpproxy-go](https://github.com/smart-mcp-proxy/mcpproxy-go)** - ⭐ 114
   Supercharge AI Agents, Safely

1409. **[mcp-server](https://github.com/InterviewReady/mcp-server)** - ⭐ 114
   An MCP server for InterviewReady

1410. **[NornicDB](https://github.com/orneryd/NornicDB)** - ⭐ 114
...
1411. **[cli](https://github.com/mcpgod/cli)** - ⭐ 113
   Fine-grained control over model context protocol (MCP) clients, servers, and tools. Context is God.

1412. **[google-workspace-mcp](https://github.com/aaronsb/google-workspace-mcp)** - ⭐ 113
   A Model Context Protocol (MCP) server that provides authenticated access to Google Workspace APIs, offering integrated Authentication, Gmail, Calendar, and Drive functionality

1413. **[mcp-ts-template](https://github.com/cyanheads/mcp-ts-template)** - ⭐ 113
...
1414. **[teslamate-mcp](https://github.com/cobanov/teslamate-mcp)** - ⭐ 113
   A Model Context Protocol (MCP) server that provides access to your TeslaMate database, allowing AI assistants to query Tesla vehicle data and analytics.

1415. **[OpenSCAD-MCP-Server](https://github.com/jhacksman/OpenSCAD-MCP-Server)** - ⭐ 113
   Devin's attempt at creating an OpenSCAD MCP Server that takes a user prompt and generates a preview image and 3d file.

1416. **[SwiftMCP](https://github.com/Cocoanetics/SwiftMCP)** - ⭐ 113
   Model Context Protocol Server for Swift

1417. **[remote-mcp-apim-functions-python](https://github.com/Azure-Samples/remote-mcp-apim-functions-python)** - ⭐ 113
   Azure API Management as AI Gateway to Remote MCP servers.

1418. **[MCP-oura](https://github.com/YuzeHao2023/MCP-oura)** - ⭐ 113
   MCP server for Oura API integration

1419. **[mcp-memory](https://github.com/Puliczek/mcp-memory)** - ⭐ 113
...
1420. **[mcp-server](https://github.com/bitwarden/mcp-server)** - ⭐ 113
   MCP server for interaction with Bitwarden.

1421. **[isaac-sim-mcp](https://github.com/omni-mcp/isaac-sim-mcp)** - ⭐ 113
   Isaac Simulation MCP Extension and Server

1422. **[iphone-mcp](https://github.com/Lakr233/iphone-mcp)** - ⭐ 113
...
1423. **[mcp-victoriametrics](https://github.com/VictoriaMetrics-Community/mcp-victoriametrics)** - ⭐ 113
   The implementation of Model Context Protocol (MCP) server for VictoriaMetrics

1424. **[mcp-hubspot](https://github.com/peakmojo/mcp-hubspot)** - ⭐ 112
   A Model Context Protocol (MCP) server that enables AI assistants to interact with HubSpot CRM data, providing built-in vector storage and caching mechanisms help overcome HubSpot API limitations while improving response times.

1425. **[swagger-mcp](https://github.com/dcolley/swagger-mcp)** - ⭐ 112
   Swagger to MCP server

1426. **[aseprite-mcp](https://github.com/diivi/aseprite-mcp)** - ⭐ 112
   MCP server for interacting with the Aseprite API

1427. **[ffmpeg-mcp](https://github.com/video-creator/ffmpeg-mcp)** - ⭐ 112
...
1428. **[mcp-redmine](https://github.com/runekaagaard/mcp-redmine)** - ⭐ 112
   A redmine MCP server covering close to 100% of redmines API

1429. **[MCP2Lambda](https://github.com/danilop/MCP2Lambda)** - ⭐ 111
   Run any AWS Lambda function as a Large Language Model (LLM) tool without code changes using Anthropic's Model Context Protocol (MCP).

1430. **[notion-mcp](https://github.com/ccabanillas/notion-mcp)** - ⭐ 111
   A Model Context Protocol (MCP) server implementation for Notion integration, providing a standardized interface for interacting with Notion's API.

1431. **[punkpeye_awesome-mcp-servers](https://github.com/MCP-Mirror/punkpeye_awesome-mcp-servers)** - ⭐ 111
   Mirror of https://github.com/punkpeye/awesome-mcp-servers

1432. **[Deepseek-Thinking-Claude-3.5-Sonnet-CLINE-MCP](https://github.com/newideas99/Deepseek-Thinking-Claude-3.5-Sonnet-CLINE-MCP)** - ⭐ 111
...
1433. **[mcpauth](https://github.com/mcpauth/mcpauth)** - ⭐ 111
   Authentication for MCP Servers

1434. **[xcodeproj-mcp-server](https://github.com/giginet/xcodeproj-mcp-server)** - ⭐ 111
   A Model Context Protocol Server to manipulate *.xcodeproj

1435. **[foxy-contexts](https://github.com/strowk/foxy-contexts)** - ⭐ 111
   Foxy contexts is a library for building context servers supporting Model Context Protocol

1436. **[mcp-checkpoint](https://github.com/aira-security/mcp-checkpoint)** - ⭐ 111
...
1438. **[exstruct](https://github.com/harumiWeb/exstruct)** - ⭐ 111
   Excel to structured JSON (tables, shapes, charts) for LLM/RAG pipelines

1439. **[mcp-jfrog](https://github.com/jfrog/mcp-jfrog)** - ⭐ 110
   Model Context Protocol (MCP) Server for the JFrog Platform API, enabling repository management, build tracking, release lifecycle management, and more.

1440. **[google-sheets-mcp](https://github.com/mkummer225/google-sheets-mcp)** - ⭐ 110
   Google Sheets MCP Server 📊🤖

1441. **[server-wp-mcp](https://github.com/emzimmer/server-wp-mcp)** - ⭐ 110

1442. **[MCP-searxng](https://github.com/SecretiveShell/MCP-searxng)** - ⭐ 110
   MCP server for connecting agentic systems to search systems via searXNG

1443. **[netbox-mcp-server](https://github.com/netboxlabs/netbox-mcp-server)** - ⭐ 110
   Model Context Protocol (MCP) server for read-only interaction with NetBox data in LLMs

1444. **[mcp-bsl-platform-context](https://github.com/alkoleft/mcp-bsl-platform-context)** - ⭐ 110
   MCP сервер для AI-ассистентов (справка по синтаксису и объектной модели 1С:Предприятие)

1445. **[swiftlens](https://github.com/swiftlens/swiftlens)** - ⭐ 110
...
1446. **[spring-documentation-mcp-server](https://github.com/andrlange/spring-documentation-mcp-server)** - ⭐ 110
   Spring Boot based MCP Server provide full Spring Ecosystem Documentation for LLMs

1447. **[livebook_tools](https://github.com/thmsmlr/livebook_tools)** - ⭐ 109
   Powertools for livebook.dev — AI Code Editing, MCP Servers, and Running Livebooks from the CLI

1448. **[vscode-as-mcp-server](https://github.com/acomagu/vscode-as-mcp-server)** - ⭐ 109
...
1449. **[pentest-mcp](https://github.com/DMontgomery40/pentest-mcp)** - ⭐ 109
   NOT for educational purposes: An MCP server for professional penetration testers including STDIO/HTTP/SSE support, nmap, go/dirbuster, nikto, JtR, hashcat, wordlist building, and more.

1450. **[crypto-indicators-mcp](https://github.com/kukapay/crypto-indicators-mcp)** - ⭐ 109
   An MCP server providing a range of cryptocurrency technical analysis indicators and strategies.

1451. **[Wazuh-MCP-Server](https://github.com/gensecaihq/Wazuh-MCP-Server)** - ⭐ 109
...
1452. **[raindrop-mcp](https://github.com/adeze/raindrop-mcp)** - ⭐ 109
   Raindrop MCP Server

1453. **[-mcp-to-skill-converter](https://github.com/GBSOSS/-mcp-to-skill-converter)** - ⭐ 109
      Convert any MCP server into a Claude Skill with 90% context savings

1454. **[modex](https://github.com/theronic/modex)** - ⭐ 108
   Modex is a Clojure MCP Library to augment your AI models with Tools, Resources & Prompts using Clojure (Model Context Protocol). Implements MCP Server & Client.

1455. **[share-best-mcp](https://github.com/shareAI-lab/share-best-mcp)** - ⭐ 108
   世界上最好的MCP Servers的列表,The best mcp servers in the world.

1456. **[minesweeper-mcp-server](https://github.com/tonypan2/minesweeper-mcp-server)** - ⭐ 108
   An MCP server for playing Minesweeper

1457. **[DINO-X-MCP](https://github.com/IDEA-Research/DINO-X-MCP)** - ⭐ 108
   Official DINO-X Model Context Protocol (MCP) server that empowers LLMs with real-world visual perception through image object detection, localization, and captioning APIs.

1458. **[Easy-MCP-AutoCad](https://github.com/zh19980811/Easy-MCP-AutoCad)** - ⭐ 108
   这个项目是一个基于Model Context Protocol (MCP)的AutoCAD集成服务器，它允许通过自然语言与AutoCAD进行交互。通过这个服务器，用户可以使用Claude等大型语言模型来创建、修改和分析AutoCAD图纸，同时还可以存储和查询CAD元素的相关数据。目前制作参考学习，仅实现端到端之间的通信，具体工具函数尚未晚上

1459. **[asyncmcp](https://github.com/bh-rat/asyncmcp)** - ⭐ 108
   Async transport layers for MCP

1460. **[gRPC-zig](https://github.com/ziglana/gRPC-zig)** - ⭐ 108
   blazigly fast gRPC/MCP client & server implementation in zig

1461. **[ai-command](https://github.com/mcp-wp/ai-command)** - ⭐ 108
   Control WordPress using WP-CLI, AI, and MCP.

1462. **[dash-mcp-server](https://github.com/Kapeli/dash-mcp-server)** - ⭐ 108
   MCP server for Dash, the macOS documentation browser

1463. **[apple-rag-mcp](https://github.com/BingoWon/apple-rag-mcp)** - ⭐ 107
...
1472. **[aks-mcp](https://github.com/Azure/aks-mcp)** - ⭐ 107
   A Model Context Protocol (MCP) server that enables AI assistants to interact with AKS clusters. It serves as a bridge between AI tools (like Claude, Cursor, and GitHub Copilot) and AKS.

1473. **[mcp-probe](https://github.com/conikeec/mcp-probe)** - ⭐ 106
   A Model Context Protocol (MCP) client library and debugging toolkit in Rust. This foundation provides both a production-ready SDK for building MCP integrations and the core architecture for an interactive debugger.

1474. **[oracle-mcp-server](https://github.com/danielmeppiel/oracle-mcp-server)** - ⭐ 106
   MCP Server for working with large Oracle databases

1475. **[mcp-client](https://github.com/punkpeye/mcp-client)** - ⭐ 106
   An MCP client for Node.js.

1476. **[mcp-tool-kit](https://github.com/getfounded/mcp-tool-kit)** - ⭐ 106
   Agentic abstraction layer for building high precision vertical AI agents written in python for Model Context Protocol.

1477. **[payloadcmsmcp](https://github.com/disruption-hub/payloadcmsmcp)** - ⭐ 106
   Payload CMS MCP Server

1478. **[gemini-cli-mcp-server](https://github.com/centminmod/gemini-cli-mcp-server)** - ⭐ 106

1479. **[UnityMCPIntegration](https://github.com/quazaai/UnityMCPIntegration)** - ⭐ 106
   Enable AI Agents to Control Unity

1480. **[hevy-mcp](https://github.com/chrisdoc/hevy-mcp)** - ⭐ 106
   Manage your Hevy workouts, routines, folders, and exercise templates. Create and update sessions faster, organize plans, and search exercises to build workouts quickly. Stay synced with changes so your training log is always up to date.

1481. **[Fabric-Analytics-MCP](https://github.com/santhoshravindran7/Fabric-Analytics-MCP)** - ⭐ 105
...
1482. **[ZipAgent](https://github.com/JiayuXu0/ZipAgent)** - ⭐ 105
   轻量级AI Agent框架，让你5分钟构建专属智能助手。Lightweight AI Agent framework. Build your AI assistant in 5 minutes.

1483. **[server-google-news](https://github.com/ChanMeng666/server-google-news)** - ⭐ 105
   【Star-crossed coders unite!⭐️】Model Context Protocol (MCP) server implementation providing Google News search capabilities via SerpAPI, with automatic news categorization and multi-language support.

1484. **[railway-mcp-server](https://github.com/railwayapp/railway-mcp-server)** - ⭐ 105
   Official Railway MCP Server for interacting with your Railway account

1485. **[Taiwan-Health-MCP](https://github.com/healthymind-tech/Taiwan-Health-MCP)** - ⭐ 105

1486. **[gemini-desktop](https://github.com/kkrishnan90/gemini-desktop)** - ⭐ 104
...
1487. **[mcp.science](https://github.com/pathintegral-institute/mcp.science)** - ⭐ 104
   Open Source MCP Servers for Scientific Research

1488. **[sourcerer-mcp](https://github.com/st3v3nmw/sourcerer-mcp)** - ⭐ 104
   MCP for semantic code search & navigation that reduces token waste

1489. **[mcp](https://github.com/frappe/mcp)** - ⭐ 104
   Frappe MCP allows Frappe apps to function as MCP servers

1490. **[agentcare-mcp](https://github.com/Kartha-AI/agentcare-mcp)** - ⭐ 104
   MCP Server for EMRs with FHIR

1491. **[csharp-runner](https://github.com/sdcb/csharp-runner)** - ⭐ 104
   fast, secure c# runner

1492. **[freqtrade-mcp](https://github.com/kukapay/freqtrade-mcp)** - ⭐ 104
   An MCP server that integrates with the Freqtrade cryptocurrency trading bot.

1493. **[augments-mcp-server](https://github.com/augmnt/augments-mcp-server)** - ⭐ 104
   Comprehensive MCP server providing real-time framework documentation access for Claude Code with intelligent caching, multi-source integration, and context-aware assistance.

1494. **[flowlens-mcp-server](https://github.com/magentic/flowlens-mcp-server)** - ⭐ 104
...
1495. **[mcp-prompts](https://github.com/sparesparrow/mcp-prompts)** - ⭐ 104
   Model Context Protocol server for managing, storing, and providing prompts and prompt templates for LLM interactions. 

1496. **[ableton-mcp-extended](https://github.com/uisato/ableton-mcp-extended)** - ⭐ 104
   Ableton Live MCP (Model Context Protocol) server that allows control directly through AI assistants.

1497. **[smileyCoin](https://github.com/fefergrgrgrg/smileyCoin)** - ⭐ 103
   simple web ui to manage mcp (model context protocol) servers in the claude app

1498. **[memory-bank-MCP](https://github.com/tuncer-byte/memory-bank-MCP)** - ⭐ 103
...
1499. **[solana-mcp](https://github.com/solanamcp/solana-mcp)** - ⭐ 103
   Solana Agent Kit MCP Server 

1500. **[awesome-context-engineering](https://github.com/jihoo-kim/awesome-context-engineering)** - ⭐ 103
...
1501. **[GenesisCore](https://github.com/AIGODLIKE/GenesisCore)** - ⭐ 103
   One click installation! BlenderMCP tool that supports DeepSeek, Claude, and others, fully integrated into Blender!

1502. **[typescript-utcp](https://github.com/universal-tool-calling-protocol/typescript-utcp)** - ⭐ 103
...
1503. **[ARIES](https://github.com/Chieko-Seren/ARIES)** - ⭐ 103
...
1504. **[http-oauth-mcp-server](https://github.com/NapthaAI/http-oauth-mcp-server)** - ⭐ 103
...
1505. **[chronulus-mcp](https://github.com/ChronulusAI/chronulus-mcp)** - ⭐ 103
   MCP Server for Chronulus AI Forecasting and Prediction Agents

1506. **[portainer-mcp](https://github.com/portainer/portainer-mcp)** - ⭐ 103
   Portainer MCP server

1507. **[Polymcp](https://github.com/poly-mcp/Polymcp)** - ⭐ 103
   Polymcp provides a simple and efficient way to interact with MCP servers using custom agents

1508. **[comet-mcp](https://github.com/hanzili/comet-mcp)** - ⭐ 103
   MCP Server connecting to Perplexity Comet browser

1509. **[memory-mcp-server](https://github.com/okooo5km/memory-mcp-server)** - ⭐ 102
   A Model Context Protocol server that provides knowledge graph management capabilities. 

1510. **[erickwendel-contributions-mcp](https://github.com/ErickWendel/erickwendel-contributions-mcp)** - ⭐ 102
   A Model Context Protocol (MCP) server that provides tools to query Erick Wendel's contributions across different platforms

1511. **[mcpm](https://github.com/MCP-Club/mcpm)** - ⭐ 102
...
1512. **[vectorize-mcp-server](https://github.com/vectorize-io/vectorize-mcp-server)** - ⭐ 102
   Official Vectorize MCP Server

1513. **[a2a-mcp-tutorial](https://github.com/Tsadoq/a2a-mcp-tutorial)** - ⭐ 102
   A tutorial on how to use Model Context Protocol by Anthropic and Agent2Agent Protocol by Google

1514. **[remote-mcp-functions](https://github.com/Azure-Samples/remote-mcp-functions)** - ⭐ 102
   Landing page for Remote MCP Server efforts in Azure Functions with links to all language stack specific repos.

1515. **[deep-code-reasoning-mcp](https://github.com/haasonsaas/deep-code-reasoning-mcp)** - ⭐ 102
   A Model Context Protocol (MCP) server that provides advanced code analysis and reasoning capabilities powered by Google's Gemini AI

1516. **[gemini-mcp](https://github.com/RLabs-Inc/gemini-mcp)** - ⭐ 102
   MCP Server that enables Claude code to interact with Gemini

1517. **[awesome-x402](https://github.com/xpaysh/awesome-x402)** - ⭐ 102
   🚀 Curated list of x402 resources: HTTP 402 Payment Required protocol for blockchain payments, crypto micropayments, AI agents, API monetization. Includes SDKs (TypeScript, Python, Rust), examples, facilitators (Coinbase, Cloudflare), MCP integration, tutorials. Accept USDC payments with one line of code. Perfect for AI agent economy.

1518. **[template-repo](https://github.com/AndrewAltimit/template-repo)** - ⭐ 102
...
1519. **[Financial-Modeling-Prep-MCP-Server](https://github.com/imbenrabi/Financial-Modeling-Prep-MCP-Server)** - ⭐ 102
   A Model Context Protocol (MCP) implementation for Financial Modeling Prep, enabling AI assistants to access and analyze financial data, stock information, company fundamentals, and market insights.

1520. **[nextcloud-mcp-server](https://github.com/cbcoutinho/nextcloud-mcp-server)** - ⭐ 102
   Nextcloud MCP Server

1521. **[btp-sap-odata-to-mcp-server](https://github.com/lemaiwo/btp-sap-odata-to-mcp-server)** - ⭐ 101
   BTP CloudFoundry Node.js MCP server for SAP OData services integration

1522. **[sqlite-explorer-fastmcp-mcp-server](https://github.com/hannesrudolph/sqlite-explorer-fastmcp-mcp-server)** - ⭐ 101
   An MCP server that provides safe, read-only access to SQLite databases through Model Context Protocol (MCP). This server is built with the FastMCP framework, which enables LLMs to explore and query SQLite databases with built-in safety features and query validation.

1523. **[mcp-server-atlassian-bitbucket](https://github.com/aashari/mcp-server-atlassian-bitbucket)** - ⭐ 101
   Node.js/TypeScript MCP server for Atlassian Bitbucket. Enables AI systems (LLMs) to interact with workspaces, repositories, and pull requests via tools (list, get, comment, search). Connects AI directly to version control workflows through the standard MCP interface.

1524. **[mcp-virustotal](https://github.com/BurtTheCoder/mcp-virustotal)** - ⭐ 101
   A Model Context Protocol (MCP) server for querying the VirusTotal API.

1525. **[claude-code-mcp-enhanced](https://github.com/grahama1970/claude-code-mcp-enhanced)** - ⭐ 100
...
1526. **[mcp-hono-stateless](https://github.com/mhart/mcp-hono-stateless)** - ⭐ 100
   An example Hono MCP server using Streamable HTTP

1527. **[AgentBoard](https://github.com/igrigorik/AgentBoard)** - ⭐ 100
...
1528. **[autodev-codebase](https://github.com/anrgct/autodev-codebase)** - ⭐ 100
...
1529. **[complete-intro-to-mcp](https://github.com/btholt/complete-intro-to-mcp)** - ⭐ 100
   The Complete Intro to MCP Servers, as taught for Frontend Masters by Brian Holt

1530. **[linggen](https://github.com/linggen/linggen)** - ⭐ 100
   A local-first memory layer for AI (Cursor, Zed, Claude). Persistent architectural context via semantic search.

1531. **[neurolink](https://github.com/juspay/neurolink)** - ⭐ 100
   Universal AI Development Platform with MCP server integration, multi-provider support, and professional CLI. Build, test, and deploy AI applications with multiple ai providers.

1532. **[IntelliConnect](https://github.com/ruanrongman/IntelliConnect)** - ⭐ 100
   本项目为xiaozhi-esp32提供后端服务  |  A Powerful AI agent IoT platform core.

1533. **[mcp-shodan](https://github.com/BurtTheCoder/mcp-shodan)** - ⭐ 100
   MCP server for querying the Shodan API

1534. **[sample-agentic-ai-demos](https://github.com/aws-samples/sample-agentic-ai-demos)** - ⭐ 100
   Collection of examples of how to use Model Context Protocol with AWS.

1535. **[finance-trading-ai-agents-mcp](https://github.com/aitrados/finance-trading-ai-agents-mcp)** - ⭐ 100
...
1536. **[mcp-windows-desktop-automation](https://github.com/mario-andreschak/mcp-windows-desktop-automation)** - ⭐ 99
   A Model Context Protocol (MCP) server for Windows desktop automation using AutoIt.

1537. **[next-mcp-server](https://github.com/vertile-ai/next-mcp-server)** - ⭐ 99
   Help LLMs to understand your Next apps better

1538. **[turbular](https://github.com/raeudigerRaeffi/turbular)** - ⭐ 99
   A MCP server allowing LLM agents to easily connect and retrieve data from any database

1539. **[pywss](https://github.com/czasg/pywss)** - ⭐ 99
   一个轻量级的 Python Web 框架，一站式集成 MCP SSE、StreamHTTP 和 MCPO 协议，助你轻松构建MCP Server🔥

1540. **[mighty-security](https://github.com/NineSunsInc/mighty-security)** - ⭐ 99
   Don't Simply Trust MCP Server Code, Validate and Scan

1541. **[alibabacloud-ack-mcp-server](https://github.com/aliyun/alibabacloud-ack-mcp-server)** - ⭐ 99
...
1542. **[gtasks-mcp](https://github.com/zcaceres/gtasks-mcp)** - ⭐ 99
   A Google Tasks Model Context Protocol Server for Claude

1543. **[forgetful](https://github.com/ScottRBK/forgetful)** - ⭐ 99
   Opensource Memory for Agents

1544. **[JavaSinkTracer_MCP](https://github.com/Zacarx/JavaSinkTracer_MCP)** - ⭐ 99
   基于函数级污点分析的 Java 源代码漏洞审计工具JavaSinkTracer，通过 Model Context Protocol (MCP) 为 AI 助手提供安全分析能力。

1545. **[apple-health-mcp-server](https://github.com/the-momentum/apple-health-mcp-server)** - ⭐ 99
   MCP server for querying Apple Health data with natural language using DuckDB under the hood.

1546. **[seline](https://github.com/tercumantanumut/seline)** - ⭐ 99
   seline agent with a style

1547. **[pocketbase-mcp](https://github.com/mrwyndham/pocketbase-mcp)** - ⭐ 99
   MCP server for building PocketBase apps really quickly - Need a front end quick consider FastPocket

1548. **[mcp_on_ruby](https://github.com/rubyonai/mcp_on_ruby)** - ⭐ 98
   💎 A Ruby implementation of the Model Context Protocol

1549. **[atomic-red-team-mcp](https://github.com/cyberbuff/atomic-red-team-mcp)** - ⭐ 98
   MCP server for Atomic Red Team

1550. **[mcp-client-nodejs](https://github.com/ConardLi/mcp-client-nodejs)** - ⭐ 98
   Node.js Client Implementation for Model Context Protocol (MCP)

1551. **[mcp-toolkit](https://github.com/nuxt-modules/mcp-toolkit)** - ⭐ 98
   Create MCP servers directly in your Nuxt application. Define tools, resources, and prompts with a simple and intuitive API.

1552. **[mysql-mcp-server-sse](https://github.com/mangooer/mysql-mcp-server-sse)** - ⭐ 98
...
1553. **[academic-search-mcp-server](https://github.com/afrise/academic-search-mcp-server)** - ⭐ 98
...
1554. **[typst-mcp](https://github.com/johannesbrandenburger/typst-mcp)** - ⭐ 98
   Typst MCP Server is an MCP (Model Context Protocol) implementation that helps AI models interact with Typst, a markup-based typesetting system. The server provides tools for converting between LaTeX and Typst, validating Typst syntax, and generating images from Typst code.

1555. **[robloxstudio-mcp](https://github.com/boshyxd/robloxstudio-mcp)** - ⭐ 98
   Create agentic AI workflows in ROBLOX Studio

1556. **[mcp-sse-demo](https://github.com/cnych/mcp-sse-demo)** - ⭐ 97
   claude mcp sse demo with server and client(cli、web)

1557. **[mcp-typescript-sdk](https://github.com/emqx/mcp-typescript-sdk)** - ⭐ 97
   A TypeScript SDK for implementing Model Context Protocol (MCP) over MQTT, supporting both browser and Node.js environments.

1558. **[gemini-mcp-desktop-client](https://github.com/duke7able/gemini-mcp-desktop-client)** - ⭐ 97
   first gemini based desktop client for MCP

1559. **[searxng-mul-mcp](https://github.com/jae-jae/searxng-mul-mcp)** - ⭐ 97
   A Model Context Protocol (MCP) server for SearXNG search engine with multi-query parallel search support

1560. **[mcp-screenshot-website-fast](https://github.com/just-every/mcp-screenshot-website-fast)** - ⭐ 97
   Quickly screenshots webpages and converts to an LLM friendly size

1561. **[MiniMax-MCP-JS](https://github.com/MiniMax-AI/MiniMax-MCP-JS)** - ⭐ 97
   Official MiniMax Model Context Protocol (MCP) JavaScript implementation that provides seamless integration with MiniMax's powerful AI capabilities including image generation, video generation, text-to-speech, and voice cloning APIs.

1562. **[mcp](https://github.com/taskade/mcp)** - ⭐ 97
   🤖 Taskade MCP · Official MCP server and OpenAPI to MCP codegen. Build AI agent tools from any OpenAPI API and connect to Claude, Cursor, and more.

1563. **[all-in-one-model-context-protocol](https://github.com/nguyenvanduocit/all-in-one-model-context-protocol)** - ⭐ 96
   🚀 All-in-one MCP server with AI search, RAG, and multi-service integrations (GitLab/Jira/Confluence/YouTube) for AI-enhanced development workflows

1564. **[mcp-local-rag](https://github.com/nkapila6/mcp-local-rag)** - ⭐ 96
   "primitive" RAG-like web search model context protocol (MCP) server that runs locally. ✨ no APIs ✨

1565. **[powerbi-mcp](https://github.com/sulaiman013/powerbi-mcp)** - ⭐ 96
   MCP server for natural language interaction with Power BI datasets

1566. **[systemprompt-mcp-server](https://github.com/systempromptio/systemprompt-mcp-server)** - ⭐ 96
...
1567. **[godoc-mcp](https://github.com/mrjoshuak/godoc-mcp)** - ⭐ 96
   go doc mcp server

1568. **[lapras-mcp-server](https://github.com/lapras-inc/lapras-mcp-server)** - ⭐ 96
   lapras.com 公式MCP Server

1569. **[mcp-server](https://github.com/webflow/mcp-server)** - ⭐ 96
   Model Context Protocol (MCP) server for the Webflow Data API.

1570. **[terminal-controller-mcp](https://github.com/GongRzhe/terminal-controller-mcp)** - ⭐ 96
   A Model Context Protocol (MCP) server that enables secure terminal command execution, directory navigation, and file system operations through a standardized interface.

1571. **[mcp-kit](https://github.com/my-mcp-hub/mcp-kit)** - ⭐ 96
   A CLI tool to create MCP (Model Context Protocol) applications with ease.

1572. **[langgraph-ai](https://github.com/piyushagni5/langgraph-ai)** - ⭐ 96
   LangGraph AI Repository

1573. **[heimdall-mcp-server](https://github.com/lcbcFoo/heimdall-mcp-server)** - ⭐ 96
   Your AI Coding Assistant's Long-Term Memory

1574. **[github-stars](https://github.com/miantiao-me/github-stars)** - ⭐ 96
   A Cloudflare-powered MCP (Model Context Protocol) Server that allows you to search and query your GitHub starred repositories using natural language.

1575. **[go-utcp](https://github.com/universal-tool-calling-protocol/go-utcp)** - ⭐ 96
    Official Go implementation of the UTCP 

1576. **[akshare-one-mcp](https://github.com/zwldarren/akshare-one-mcp)** - ⭐ 96
   MCP server that provides access to Chinese stock market data using akshare-one

1577. **[mcp-server-gsc](https://github.com/ahonn/mcp-server-gsc)** - ⭐ 96
   A Model Context Protocol (MCP) server providing access to Google Search Console

1578. **[awesome-mcp-enterprise](https://github.com/bh-rat/awesome-mcp-enterprise)** - ⭐ 95
   A curated list of awesome MCP (Model Context Protocol) tools, platforms, and services for enterprises.

1579. **[api2mcp4j](https://github.com/TheEterna/api2mcp4j)** - ⭐ 95
...
1580. **[gossiphs](https://github.com/williamfzc/gossiphs)** - ⭐ 95
...
1581. **[Vibe-Coder-MCP](https://github.com/freshtechbro/Vibe-Coder-MCP)** - ⭐ 95
    Vibe-Coder-MCP server extends AI assistants with specialized software development tools.

1582. **[sandbox-mcp](https://github.com/pottekkat/sandbox-mcp)** - ⭐ 95
   A Model Context Protocol (MCP) server that enables LLMs to run ANY code safely in isolated Docker containers.

1583. **[mcp-graphiti](https://github.com/rawr-ai/mcp-graphiti)** - ⭐ 95
   Graphiti Model Context Protocol (MCP) Server - An MCP server for knowledge graph management via Graphiti

1584. **[wanaku](https://github.com/wanaku-ai/wanaku)** - ⭐ 95
   Wanaku MCP Router

1585. **[ruby-mcp-client](https://github.com/simonx1/ruby-mcp-client)** - ⭐ 94
   This is a Ruby implementation of MCP (Model Context Protocol) client

1586. **[alibaba-cloud-ops-mcp-server](https://github.com/aliyun/alibaba-cloud-ops-mcp-server)** - ⭐ 94
   AlibabaCloud CloudOps MCP Server

1587. **[opencv-mcp-server](https://github.com/GongRzhe/opencv-mcp-server)** - ⭐ 94
...
1588. **[infobus-mcp](https://github.com/simovilab/infobus-mcp)** - ⭐ 93
   Model Context Protocol server enabling AI assistants to access transit information through standardized interfaces

1589. **[elektron-mcp](https://github.com/zerubeus/elektron-mcp)** - ⭐ 93
   MCP sever for controlling Elektron devices using LLMs

1590. **[MasterMCP](https://github.com/slowmist/MasterMCP)** - ⭐ 93
...
1591. **[mcp-replicate](https://github.com/deepfates/mcp-replicate)** - ⭐ 93
   Model Context Protocol server for Replicate's API

1592. **[gospy](https://github.com/monsterxx03/gospy)** - ⭐ 93
   Non-Invasive goroutine inspector

1593. **[gis-mcp](https://github.com/mahdin75/gis-mcp)** - ⭐ 93
   A Model Context Protocol (MCP) server implementation that connects Large Language Models (LLMs) to GIS operations using GIS libraries, enabling AI assistants to perform geospatial operations and transformations.

1594. **[mcp-server-idapro](https://github.com/fdrechsler/mcp-server-idapro)** - ⭐ 92
   A Model Context Protocol (MCP) server that enables AI assistants to interact with IDA Pro for reverse engineering and binary analysis tasks.

1595. **[mcp-server](https://github.com/OctopusDeploy/mcp-server)** - ⭐ 92
   Octopus Deploy Official MCP Server

1596. **[snippy](https://github.com/Azure-Samples/snippy)** - ⭐ 92
...
1597. **[a2ajava](https://github.com/vishalmysore/a2ajava)** - ⭐ 92
...
1598. **[rust-docs-mcp](https://github.com/snowmead/rust-docs-mcp)** - ⭐ 92
   MCP server for agents to explore rust docs, analyze source code, and build with confidence

1599. **[computer-control-mcp](https://github.com/AB498/computer-control-mcp)** - ⭐ 92
   MCP server that provides computer control capabilities, like mouse, keyboard, OCR, etc. using PyAutoGUI, RapidOCR, ONNXRuntime. Similar to 'computer-use' by Anthropic. With Zero External Dependencies.

1600. **[open-mcp-auth-proxy](https://github.com/wso2/open-mcp-auth-proxy)** - ⭐ 92
   Authentication and Authorization Proxy for MCP Servers

1601. **[brave-search-mcp](https://github.com/mikechao/brave-search-mcp)** - ⭐ 92
...
1602. **[kindly-web-search-mcp-server](https://github.com/Shelpuk-AI-Technology-Consulting/kindly-web-search-mcp-server)** - ⭐ 92
...
1603. **[editor-mcp-server](https://github.com/playcanvas/editor-mcp-server)** - ⭐ 92
   MCP Server for AI automation of the PlayCanvas Editor

1604. **[needle-mcp](https://github.com/needle-ai/needle-mcp)** - ⭐ 91
   Needle MCP Server for easy RAG.Long-term memory for LLMs.

1605. **[square-mcp-server](https://github.com/square/square-mcp-server)** - ⭐ 91
   A Model Context Protocol (MCP) server for square

1606. **[AgentUp](https://github.com/always-further/AgentUp)** - ⭐ 91
   Portable , scalable , secure AI Agents

1607. **[sparql-llm](https://github.com/sib-swiss/sparql-llm)** - ⭐ 91
   🦜✨ Chat system, MCP server, and reusable components to improve LLMs capabilities when generating SPARQL queries

1608. **[google-tag-manager-mcp-server](https://github.com/stape-io/google-tag-manager-mcp-server)** - ⭐ 91
   MCP server for Google Tag Manager

1609. **[spring-ai-playground](https://github.com/spring-ai-community/spring-ai-playground)** - ⭐ 90
...
1610. **[mcpcat-typescript-sdk](https://github.com/MCPCat/mcpcat-typescript-sdk)** - ⭐ 90
   MCPcat is an analytics platform for MCP server owners 🐱.

1611. **[pluggedin-app](https://github.com/VeriTeknik/pluggedin-app)** - ⭐ 90
   The Crossroads for AI Data Exchanges. A unified, self-hostable web interface for discovering, configuring, and managing Model Context Protocol (MCP) servers—bringing together AI tools, workspaces, prompts, and logs from multiple MCP sources (Claude, Cursor, etc.) under one roof.

1612. **[yfinance-mcp](https://github.com/narumiruna/yfinance-mcp)** - ⭐ 90

1613. **[ToolsForMCPServer](https://github.com/tanaikech/ToolsForMCPServer)** - ⭐ 89
   The Gemini CLI confirmed that the MCP server built with Google Apps Script (GAS), a low-code platform, offers immense possibilities. If you've created snippets for GAS, these could be revitalized and/or leveraged in new ways by using them as the MCP server. The Gemini CLI and other MCP clients will be useful in achieving this.

1614. **[zed-mcp-server-context7](https://github.com/akbxr/zed-mcp-server-context7)** - ⭐ 89
   Context7 MCP Server for Zed

1615. **[octagon-mcp-server](https://github.com/OctagonAI/octagon-mcp-server)** - ⭐ 89
...
1616. **[falcon-mcp](https://github.com/CrowdStrike/falcon-mcp)** - ⭐ 89
   Connect AI agents to CrowdStrike Falcon for automated security analysis and threat hunting

1617. **[mcp-trino](https://github.com/tuannvm/mcp-trino)** - ⭐ 89
   A high-performance Model Context Protocol (MCP) server for Trino implemented in Go.

1618. **[litegraph](https://github.com/litegraphdb/litegraph)** - ⭐ 89
...
1619. **[mcp-agent](https://github.com/Haohao-end/mcp-agent)** - ⭐ 88
   A modular Python framework implementing the Model Context Protocol (MCP). It features a standardized client-server architecture over StdIO, integrating LLMs with external tools, real-time weather data fetching, and an advanced RAG (Retrieval-Augmented Generation) system.

1620. **[molecule-mcp](https://github.com/ChatMol/molecule-mcp)** - ⭐ 88
   A model-context-protocol server for molecules.

1621. **[openai-gpt-image-mcp](https://github.com/SureScaleAI/openai-gpt-image-mcp)** - ⭐ 88
   A Model Context Protocol (MCP) tool server for OpenAI's GPT-4o/gpt-image-1 image generation and editing APIs.

1622. **[anki-mcp-server](https://github.com/ankimcp/anki-mcp-server)** - ⭐ 88
   A Model Context Protocol (MCP) server that enables AI assistants to interact with Anki, the spaced repetition flashcard application.

1623. **[mcp-python-interpreter](https://github.com/yzfly/mcp-python-interpreter)** - ⭐ 87
   MCP Python Interpreter: run python code. Python-mcp-server, mcp-python-server, Code Executor

1624. **[mcp-server-and-gw](https://github.com/boilingdata/mcp-server-and-gw)** - ⭐ 87
   An MCP stdio to HTTP SSE transport gateway with example server and MCP client

1625. **[vibe](https://github.com/michiosw/vibe)** - ⭐ 87
   Open-Source AI-powered web browser. Browse the web with your own LLM API key. Alternative to Dia / Comet.

1626. **[mem0-mcp](https://github.com/pinkpixel-dev/mem0-mcp)** - ⭐ 87
   ✨ mem0 MCP Server: A memory system using mem0 for AI applications with model context protocl (MCP) integration. Enables long-term memory for AI agents as a drop-in MCP server.

1627. **[chat-ui](https://github.com/AI-QL/chat-ui)** - ⭐ 87
...
1628. **[achatbot](https://github.com/ai-bot-pro/achatbot)** - ⭐ 87
...
1629. **[outline-mcp-server](https://github.com/mmmeff/outline-mcp-server)** - ⭐ 87
   It's an MCP server... for Outline (the documentation platform!)

1630. **[mcpgen](https://github.com/lyeslabs/mcpgen)** - ⭐ 87
   Generate Go MCP server boilerplate from OpenAPI 3 specifications

1631. **[model-context-protocol-mcp-hands-on-with-agentic-ai-2034200](https://github.com/LinkedInLearning/model-context-protocol-mcp-hands-on-with-agentic-ai-2034200)** - ⭐ 87
...
1632. **[schedcp](https://github.com/eunomia-bpf/schedcp)** - ⭐ 87
   MCP Server for Linux Scheduler Management and Auto optimization

1633. **[pinescript-mcp-server](https://github.com/cklose2000/pinescript-mcp-server)** - ⭐ 86
   A Model Context Protocol (MCP) server for working with TradingView PineScript

1634. **[react-agent-hooks](https://github.com/chuanqisun/react-agent-hooks)** - ⭐ 86
   Turn React hooks into LLM tools

1635. **[mcp-server-llamacloud](https://github.com/run-llama/mcp-server-llamacloud)** - ⭐ 86
   A MCP server connecting to managed indexes on LlamaCloud

1636. **[vggt-mps](https://github.com/jmanhype/vggt-mps)** - ⭐ 86
   VGGT 3D Vision Agent optimized for Apple Silicon with Metal Performance Shaders

1637. **[slidev-mcp](https://github.com/LSTM-Kirigaya/slidev-mcp)** - ⭐ 86
   mcp server for slidev to make web ppt quickly and elegantly

1638. **[semantic-scholar-fastmcp-mcp-server](https://github.com/zongmin-yu/semantic-scholar-fastmcp-mcp-server)** - ⭐ 86
   A FastMCP server implementation for the Semantic Scholar API, providing comprehensive access to academic paper data, author information, and citation networks.

1639. **[awsome_kali_MCPServers](https://github.com/ccq1/awsome_kali_MCPServers)** - ⭐ 86
   awsome kali MCPServers is a set of MCP servers tailored for Kali Linux

1640. **[mcp-memory-keeper](https://github.com/mkreyman/mcp-memory-keeper)** - ⭐ 86
   MCP server for persistent context management in AI coding assistants

1641. **[memory-mcp-server-go](https://github.com/okooo5km/memory-mcp-server-go)** - ⭐ 86
   A Model Context Protocol server that provides knowledge graph management capabilities.

1642. **[flexible-graphrag](https://github.com/stevereiner/flexible-graphrag)** - ⭐ 86
...
1643. **[FrontAgent](https://github.com/ceilf6/FrontAgent)** - ⭐ 86
   AI agent platform for frontend engineering with SDD constraints & MCP-controlled automation. | 面向前端工程的企业级 AI Agent 平台

1644. **[mcp-ui](https://github.com/machaojin1917939763/mcp-ui)** - ⭐ 85
   基于MCP(Model Context Protocol)的智能聊天应用，支持Web和桌面环境。集成OpenAI/Anthropic API，提供MCP服务器的所有工具能力。简洁现代的UI设计，支持跨平台部署。

1645. **[github-stars](https://github.com/ccbikai/github-stars)** - ⭐ 85
   A Cloudflare-powered MCP (Model Context Protocol) Server that allows you to search and query your GitHub starred repositories using natural language.

1646. **[ragie-mcp-server](https://github.com/ragieai/ragie-mcp-server)** - ⭐ 85
   Ragie Model Context Protocol Server

1647. **[action_mcp](https://github.com/seuros/action_mcp)** - ⭐ 85
   Rails Engine with MCP compliant Spec.

1648. **[splunk-mcp](https://github.com/livehybrid/splunk-mcp)** - ⭐ 85
   A Model Context Protocol (MCP) implementation for Splunk Enterprise and Cloud integration with Cursor IDE or Claude

1649. **[IB_MCP](https://github.com/rcontesti/IB_MCP)** - ⭐ 85
   This project provides an Interactive Brokers (IB) API interface using the Model Context Protocol (MCP).

1650. **[mikrotik-mcp](https://github.com/jeff-nasseri/mikrotik-mcp)** - ⭐ 85
   MCP server for Mikrotik

1651. **[furi](https://github.com/ashwwwin/furi)** - ⭐ 85
   CLI & API for MCP management

1652. **[deepl-mcp-server](https://github.com/DeepLcom/deepl-mcp-server)** - ⭐ 85
   A Model Context Protocol (MCP) server that provides translation capabilities using the DeepL API.

1653. **[memov](https://github.com/memovai/memov)** - ⭐ 85
...
1654. **[mcp-rest-api](https://github.com/dkmaker/mcp-rest-api)** - ⭐ 84
   A TypeScript-based MCP server that enables testing of REST APIs through Cline. This tool allows you to test and interact with any REST API endpoints directly from your development environment.

1655. **[mcp-dockmaster](https://github.com/dcSpark/mcp-dockmaster)** - ⭐ 84
...
1656. **[awesome-openid-connect](https://github.com/cerberauth/awesome-openid-connect)** - ⭐ 84
...
1657. **[tiger-cli](https://github.com/timescale/tiger-cli)** - ⭐ 84
   Tiger CLI is the command-line interface for Tiger Cloud. It includes an MCP server for helping coding agents write production-level Postgres code.

1658. **[openagent](https://github.com/Th0rgal/openagent)** - ⭐ 84
   Self-hosted orchestrator for AI autonomous agents. Run Claude Code & Open Code in isolated linux workspaces. Manage your skills, configs and encrypted secrets with a git repo.

1659. **[spiceflow](https://github.com/remorses/spiceflow)** - ⭐ 83
   Super Simple API framework, type safe, automatic OpenAPI, MCP support, client RPC, streaming with SSE

1660. **[mcp-node](https://github.com/algolia/mcp-node)** - ⭐ 83
   MCP server for interacting with Algolia

1661. **[arxiv-latex-mcp](https://github.com/takashiishida/arxiv-latex-mcp)** - ⭐ 83
   MCP server that uses arxiv-to-prompt to fetch and process arXiv LaTeX sources for precise interpretation of mathematical expressions in scientific papers.

1662. **[mcp](https://github.com/twilio-labs/mcp)** - ⭐ 83
   Monorepo providing 1) OpenAPI to MCP Tool generator 2) Exposing all of Twilio's API as MCP Tools

1663. **[agent-tool-protocol](https://github.com/mondaycom/agent-tool-protocol)** - ⭐ 82
   Agent Tool Protocol

1664. **[browser-debugger-cli](https://github.com/szymdzum/browser-debugger-cli)** - ⭐ 82
   CLI tool for agents to quickly access browser telemetry (DOM, network, console) via Chrome DevTools Protocol.

1665. **[mcp-memory-libsql](https://github.com/spences10/mcp-memory-libsql)** - ⭐ 82
   🧠 High-performance persistent memory system for Model Context Protocol (MCP) powered by libSQL. Features vector search, semantic knowledge storage, and efficient relationship management - perfect for AI agents and knowledge graph applications.

1666. **[claude-swarm](https://github.com/cj-vana/claude-swarm)** - ⭐ 82
...
1667. **[mcp-github-project-manager](https://github.com/kunwarVivek/mcp-github-project-manager)** - ⭐ 82
   a mcp server to manage github project's functionality 

1668. **[amap-mcp-server](https://github.com/sugarforever/amap-mcp-server)** - ⭐ 81
   高德地图MCP Server，支持stdio, sse和streamable-http

1669. **[node-candidate-mcp-server](https://github.com/jhgaylor/node-candidate-mcp-server)** - ⭐ 81
   A Model Context Protocol (MCP) server library that gives LLMs access to information about a candidate.

1670. **[mcp-rs-template](https://github.com/linux-china/mcp-rs-template)** - ⭐ 81
   Model Context Protocol (MCP) CLI server template for Rust

1671. **[sh-disney-mcp](https://github.com/syyuan14/sh-disney-mcp)** - ⭐ 81
   sh-disney-mcp 是一个基于 Model Context Protocol (MCP) 的mcp server，旨在通过标准化的接口，帮助大模型快速获取上海迪士尼乐园的门票价格和售卖状态信息

1672. **[mcphub](https://github.com/Cognitive-Stack/mcphub)** - ⭐ 81
...
1673. **[viper](https://github.com/ozanunal0/viper)** - ⭐ 81
...
1674. **[mcp-excel-server](https://github.com/yzfly/mcp-excel-server)** - ⭐ 81
...
1675. **[apps-sdk-template](https://github.com/alpic-ai/apps-sdk-template)** - ⭐ 81
   A minimalist Typescript ChatGPT App based on the Skybridge framework

1676. **[Delphi-MCP-Server](https://github.com/GDKsoftware/Delphi-MCP-Server)** - ⭐ 81
   Native Delphi Server implementation of the Model Context Protocol (MCP)

1677. **[mcp-n8n-builder](https://github.com/spences10/mcp-n8n-builder)** - ⭐ 81
   🪄 MCP server for programmatic creation and management of n8n workflows. Enables AI assistants to build, modify, and manage workflows without direct user intervention through a comprehensive set of tools and resources for interacting with n8n's REST API.

1678. **[legion-mcp](https://github.com/TheRaLabs/legion-mcp)** - ⭐ 81
   A server that helps people access and query data in databases using the Legion Query Runner with Model Context Protocol (MCP) in Python.

1679. **[Awesome-Claude-MCP-Servers](https://github.com/win4r/Awesome-Claude-MCP-Servers)** - ⭐ 81
   A curated list of Model Context Protocol (MCP) servers optimized for Claude AI assistants.

1680. **[leetcode-mcp-server](https://github.com/jinzcdev/leetcode-mcp-server)** - ⭐ 81
   An MCP server enabling automated access to LeetCode's problems, solutions, and public data with optional authentication for user-specific features, supporting leetcode.com & leetcode.cn sites.

1681. **[mcp-sqlite](https://github.com/jparkerweb/mcp-sqlite)** - ⭐ 81
   🐇 Model Context Protocol (MCP) server that provides comprehensive SQLite database interaction capabilities

1682. **[toolhive-studio](https://github.com/stacklok/toolhive-studio)** - ⭐ 81
   ToolHive is an application that allows you to install, manage and run MCP servers and connect them to AI agents

1683. **[paper-search-mcp-nodejs](https://github.com/Dianel555/paper-search-mcp-nodejs)** - ⭐ 81
...
1684. **[office-editor-mcp](https://github.com/theWDY/office-editor-mcp)** - ⭐ 81
   基于MCP(Model Context Protocol)的Office文档处理助手，支持在MCP Client中创建和编辑Word、Excel、Powerpoint文档。

1685. **[xiaozhi-mcp-ha](https://github.com/mac8005/xiaozhi-mcp-ha)** - ⭐ 81
   A Home Assistant Custom Integration (HACS) that connects Xiaozhi ESP32 AI chatbot to Home Assistant via MCP

1686. **[narsil-mcp](https://github.com/postrv/narsil-mcp)** - ⭐ 81
   Rust MCP server for comprehensive code intelligence - 90 tools, 32 languages, security scanning, call graphs, and more

1687. **[fhir-mcp-server](https://github.com/wso2/fhir-mcp-server)** - ⭐ 81
   FHIR MCP Server – helping you expose any FHIR Server or API as a MCP Server.

1688. **[cve-search_mcp](https://github.com/roadwy/cve-search_mcp)** - ⭐ 81
   A Model Context Protocol (MCP) server for querying the CVE-Search API

1689. **[mcp-server](https://github.com/keboola/mcp-server)** - ⭐ 80
   Model Context Protocol (MCP) Server for the Keboola Platform

1690. **[ramparts](https://github.com/highflame-ai/ramparts)** - ⭐ 80
   mcp scan that scans any mcp server for indirect attack vectors and security or configuration vulnerabilities

1691. **[mcp-server-stability-ai](https://github.com/tadasant/mcp-server-stability-ai)** - ⭐ 80
...
1692. **[aws-security-mcp](https://github.com/groovyBugify/aws-security-mcp)** - ⭐ 80
   A Model Context Protocol server that connects AI assistants like Claude to AWS security services, allowing them to autonomously query, inspect, and analyze AWS infrastructure for security issues and misconfigurations.

1693. **[MCPay](https://github.com/microchipgnu/MCPay)** - ⭐ 80
   Open-source Infrastructure for MCP and x402

1694. **[cursor-rust-tools](https://github.com/terhechte/cursor-rust-tools)** - ⭐ 80
   A MCP server to allow the LLM in Cursor to access Rust Analyzer, Crate Docs and Cargo Commands.

1695. **[rohlik-mcp](https://github.com/tomaspavlin/rohlik-mcp)** - ⭐ 80
   MCP server that lets you shop groceries across the Rohlik Group platforms (Rohlik.cz, Knuspr.de, Gurkerl.at, Kifli.hu, Sezamo.ro)

1696. **[anki-mcp-server](https://github.com/CamdenClark/anki-mcp-server)** - ⭐ 80
   A model context protocol server that connects to Anki through AnkiConnect

1697. **[mcp-gateway](https://github.com/hyprmcp/mcp-gateway)** - ⭐ 80
...
1698. **[identity](https://github.com/agntcy/identity)** - ⭐ 80
...
1699. **[QMT-MCP](https://github.com/guangxiangdebizi/QMT-MCP)** - ⭐ 80
    QMT-MCP 模块化量化交易助手

1700. **[diagram-mcp-server](https://github.com/andrewmoshu/diagram-mcp-server)** - ⭐ 80
   An MCP server that seamlessly creates infrastructure diagrams for AWS, Azure, GCP, Kubernetes and more

1701. **[agentic-stock-research-system](https://github.com/rooneyrulz/agentic-stock-research-system)** - ⭐ 80
...
1702. **[google_ads_mcp](https://github.com/google-marketing-solutions/google_ads_mcp)** - ⭐ 80
   The Google Ads MCP Server is an implementation of the Model Context Protocol (MCP) that enables Large Language Models (LLMs), such as Gemini, to interact directly with the Google Ads API.

1703. **[fastmcp-boilerplate](https://github.com/punkpeye/fastmcp-boilerplate)** - ⭐ 79
   A simple MCP server built using FastMCP, TypeScript, ESLint, and Prettier.

1704. **[NASA-MCP-server](https://github.com/ProgramComputer/NASA-MCP-server)** - ⭐ 79
   A Model Context Protocol (MCP) server for NASA APIs, providing a standardized interface for AI models to interact with NASA's vast array of data sources.

1705. **[github-chat-mcp](https://github.com/AsyncFuncAI/github-chat-mcp)** - ⭐ 79
   A Model Context Protocol (MCP) for analyzing and querying GitHub repositories using the GitHub Chat API.

1706. **[codemirror-mcp](https://github.com/marimo-team/codemirror-mcp)** - ⭐ 79
   CodeMirror extension to hook up a Model Context Provider (MCP)

1707. **[jira-mcp](https://github.com/nguyenvanduocit/jira-mcp)** - ⭐ 79
...
1708. **[ls-mcp](https://github.com/lirantal/ls-mcp)** - ⭐ 79
   List MCP Server configurations in your system used by AI applications like Cursor, Claude Desktop, VS Code and others

1709. **[reddit-research-mcp](https://github.com/king-of-the-grackles/reddit-research-mcp)** - ⭐ 79
...
1710. **[loki-mcp](https://github.com/grafana/loki-mcp)** - ⭐ 79
   An MCP ( Model Context Protocol ) Server for Grafana Loki

1711. **[dicom-mcp](https://github.com/ChristianHinge/dicom-mcp)** - ⭐ 79
   Model Context Protocol (MCP) for interacting with dicom servers (PACS etc.)

1712. **[healthcare-mcp-public](https://github.com/Cicatriiz/healthcare-mcp-public)** - ⭐ 79
   A Model Context Protocol (MCP) server providing AI assistants with access to healthcare data and medical information tools, including FDA drug info, PubMed, medRxiv, NCBI Bookshelf, clinical trials, ICD-10, DICOM metadata, and a medical calculator.

1713. **[mcp-server-any-openapi](https://github.com/baryhuang/mcp-server-any-openapi)** - ⭐ 79
...
1714. **[z-image-studio](https://github.com/iconben/z-image-studio)** - ⭐ 79
...
1715. **[Matryoshka](https://github.com/yogthos/Matryoshka)** - ⭐ 79
   MCP server for token-efficient large document analysis via the use of REPL state

1716. **[web-scout-mcp](https://github.com/pinkpixel-dev/web-scout-mcp)** - ⭐ 79
   A powerful MCP server extension providing web search and content extraction capabilities. Integrates DuckDuckGo search functionality and URL content extraction into your MCP environment, enabling AI assistants to search the web and extract webpage content programmatically.

1717. **[mcp-azure-devops](https://github.com/Vortiago/mcp-azure-devops)** - ⭐ 78
   A Model Context Protocol (MCP) server enabling AI assistants to interact with Azure DevOps services via Python SDK.

1718. **[oxylabs-mcp](https://github.com/oxylabs/oxylabs-mcp)** - ⭐ 78
   Official Oxylabs MCP integration

1719. **[mcp-discovery](https://github.com/rust-mcp-stack/mcp-discovery)** - ⭐ 78
   A command-line tool written in Rust for discovering and documenting MCP Server capabilities.

1720. **[FNewsCrawler](https://github.com/noimank/FNewsCrawler)** - ⭐ 78
   一个专门为大模型设计的财经信息MCP（Model Context Protocol）服务，通过高效的爬虫技术从各大财经网站（同花顺、东方财富等）获取实时资讯，为AI模型提供准确、及时的财经数据支持。

1721. **[mcp-outline](https://github.com/Vortiago/mcp-outline)** - ⭐ 78
   A Model Context Protocol (MCP) server enabling AI assistants to interact with Outline documentation services.

1722. **[Nano-Banana-MCP](https://github.com/ConechoAI/Nano-Banana-MCP)** - ⭐ 78
   A Nano Banana MCP server, which you can integrate to cursor/claude code and any mcp client

1723. **[lucidity-mcp](https://github.com/hyperb1iss/lucidity-mcp)** - ⭐ 77
...
1724. **[advanced-unity-mcp](https://github.com/codemaestroai/advanced-unity-mcp)** - ⭐ 77
   Public repository for Advanced Unity MCP by Code Maestro (www.code-maestro.com).

1725. **[visual-ui-debug-agent-mcp](https://github.com/samihalawa/visual-ui-debug-agent-mcp)** - ⭐ 77
   VUDA is an autonomous debugging agent that empowers AI models to visually analyze, test, and debug web

1726. **[devex](https://github.com/ParthKapoor-dev/devex)** - ⭐ 77
   ⚡️ Devex — A Fast, Secure, and Scalable Repl-as-a-Service Platform built for Developers 🚀

1727. **[context-sync](https://github.com/Intina47/context-sync)** - ⭐ 77
...
1728. **[mcp-monitor](https://github.com/seekrays/mcp-monitor)** - ⭐ 77
   A system monitoring tool that exposes system metrics via the Model Context Protocol (MCP). This tool allows LLMs to retrieve real-time system information through an MCP-compatible interface.

1729. **[mcp-openapi](https://github.com/ReAPI-com/mcp-openapi)** - ⭐ 77
   OpenAPI specification MCP server.

1730. **[mcp-gemini-google-search](https://github.com/yukukotani/mcp-gemini-google-search)** - ⭐ 77
   MCP server for Google Search integration using Gemini's built-in search capabilities

1731. **[ols4](https://github.com/EBISPOT/ols4)** - ⭐ 77
   The EMBL-EBI Ontology Lookup Service (OLS)

1732. **[gitlab-mr-mcp](https://github.com/kopfrechner/gitlab-mr-mcp)** - ⭐ 77
   Interact seamlessly with GitLab repositories to manage merge requests and issues. Fetch details, add comments, and streamline your code review process with ease.

1733. **[tester-mcp-client](https://github.com/apify/tester-mcp-client)** - ⭐ 77
   Model Context Protocol (MCP) Client for Apify's Actors

1734. **[actual-mcp](https://github.com/s-stefanov/actual-mcp)** - ⭐ 76
   Model Context Protocol for Actual Budget API

1735. **[terminal_server](https://github.com/theailanguage/terminal_server)** - ⭐ 76
   MCP server that can execute terminal commands

1736. **[google-cloud-mcp](https://github.com/krzko/google-cloud-mcp)** - ⭐ 76
   🤖 A Model Context Protocol (MCP) server for Google Cloud (GCP)

1737. **[woocommerce-mcp-server](https://github.com/techspawn/woocommerce-mcp-server)** - ⭐ 76
   A WooCommerce (MCP) Model Context Protocol server

1738. **[youtrack-mcp](https://github.com/tonyzorin/youtrack-mcp)** - ⭐ 76
...
1739. **[anubis-mcp](https://github.com/zoedsoupe/anubis-mcp)** - ⭐ 76
   Elixir Model Context Protocol (MCP) SDK (hermes-mcp fork)

1740. **[codeglide-mcpgen](https://github.com/CodeGlide/codeglide-mcpgen)** - ⭐ 76
   Generation of Secure MCP (Model Context Protocol) Servers from API source code at Scale

1741. **[bitbucket-mcp](https://github.com/MatanYemini/bitbucket-mcp)** - ⭐ 76
   Bitbucket MCP - A Model Context Protocol (MCP) server for integrating with Bitbucket Cloud and Server APIs

1742. **[mcp-server-circleci](https://github.com/CircleCI-Public/mcp-server-circleci)** - ⭐ 76
   A specialized server implementation for the Model Context Protocol (MCP) designed to integrate with CircleCI's development workflow. This project serves as a bridge between CircleCI's infrastructure and the Model Context Protocol, enabling enhanced AI-powered development experiences.

1743. **[iron-manus-mcp](https://github.com/dnnyngyen/iron-manus-mcp)** - ⭐ 75
   Iron Manus MCP (+ J.A.R.V.I.S. Orchestration)

1744. **[sample-agents-with-nova-act-and-mcp](https://github.com/aws-samples/sample-agents-with-nova-act-and-mcp)** - ⭐ 75
...
1745. **[cursor10x-mcp](https://github.com/aiurda/cursor10x-mcp)** - ⭐ 75
   The Cursor10x MCP is a persistent multi-dimensional memory system for Cursor that enhances AI assistants with conversation context, project history, and code relationships across sessions.

1746. **[mcp-llms-txt-explorer](https://github.com/thedaviddias/mcp-llms-txt-explorer)** - ⭐ 75
   MCP to explore websites with llms.txt files

1747. **[agentic-coding](https://github.com/sammcj/agentic-coding)** - ⭐ 75
   Agentic Coding Rules, Templates etc...

1748. **[imessage-query-fastmcp-mcp-server](https://github.com/hannesrudolph/imessage-query-fastmcp-mcp-server)** - ⭐ 75
   An MCP server that provides safe access to your iMessage database through Model Context Protocol (MCP). This server is built with the FastMCP framework and the imessagedb library, enabling LLMs to query and analyze iMessage conversations with proper phone number validation and attachment handling.

1749. **[ExternalAttacker-MCP](https://github.com/MorDavid/ExternalAttacker-MCP)** - ⭐ 75
   A modular external attack surface mapping tool integrating tools for automated reconnaissance and bug bounty workflows.

1750. **[mcp-server](https://github.com/cap-js/mcp-server)** - ⭐ 75
   MCP server for AI-assisted development of CAP applications

1751. **[jvm-mcp-server](https://github.com/xzq-xu/jvm-mcp-server)** - ⭐ 74
   This is an implementation project of a JVM-based MCP (Model Context Protocol) server. The project aims to provide a standardized MCP server implementation for the JVM platform, enabling AI models to better interact with the Java ecosystem.

1752. **[mcp-kafka](https://github.com/kanapuli/mcp-kafka)** - ⭐ 74
   A Model Context Protocol Server to perform Kafka client operations

1753. **[ChEMBL-MCP-Server](https://github.com/Augmented-Nature/ChEMBL-MCP-Server)** - ⭐ 74
   A comprehensive Model Context Protocol (MCP) server providing advanced access to the ChEMBL chemical database.

1754. **[agentic-tools-mcp](https://github.com/Pimzino/agentic-tools-mcp)** - ⭐ 74
   A comprehensive Model Context Protocol (MCP) server providing AI assistants with powerful task management and agent memories capabilities with project-specific storage.

1755. **[perfetto-mcp](https://github.com/antarikshc/perfetto-mcp)** - ⭐ 74
...
1756. **[mcp-canvas-lms](https://github.com/DMontgomery40/mcp-canvas-lms)** - ⭐ 74
...
1757. **[zed-mcp-server-github](https://github.com/LoamStudios/zed-mcp-server-github)** - ⭐ 74
   A GitHub MCP Server extension for Zed

1758. **[mcp-forge](https://github.com/achetronic/mcp-forge)** - ⭐ 74
   A complete MCP server template that include vitamins (oauth authentication included)

1759. **[glif-mcp-server](https://github.com/glifxyz/glif-mcp-server)** - ⭐ 74
   Easily run glif.app AI workflows inside your LLM: image generators, memes, selfies, and more. Glif supports all major multimedia AI models inside one app

1760. **[code-to-tree](https://github.com/micl2e2/code-to-tree)** - ⭐ 74
   A runtime-free MCP server that converts source code into AST🌲, regardless of language.

1761. **[awesome-osint-mcp-servers](https://github.com/soxoj/awesome-osint-mcp-servers)** - ⭐ 74
   A curated list of OSINT MCP servers. Pull requests are welcomed!

1762. **[fabric-mcp](https://github.com/ksylvan/fabric-mcp)** - ⭐ 74
   Fabric MCP Server: Seamlessly integrate Fabric AI capabilities into MCP-enabled tools like IDEs and chat interfaces.

1763. **[arbor](https://github.com/Anandb71/arbor)** - ⭐ 74
   Graph-native code intelligence that replaces embedding-based RAG with deterministic program understanding.

1764. **[mcp-local-rag](https://github.com/shinpr/mcp-local-rag)** - ⭐ 74
...
1765. **[mcp-metatrader5-server](https://github.com/Qoyyuum/mcp-metatrader5-server)** - ⭐ 73
...
1766. **[stock-mcp](https://github.com/huweihua123/stock-mcp)** - ⭐ 73
   专业的金融市场数据 MCP 服务器 - 支持A股/美股/加密货币，原生 MCP 协议，AI Agent 友好

1767. **[mcp-llm](https://github.com/sammcj/mcp-llm)** - ⭐ 73
    An MCP server that provides LLMs access to other LLMs

1768. **[bridge4simulator](https://github.com/AppGram/bridge4simulator)** - ⭐ 73
...
1769. **[mcp-jenkins](https://github.com/lanbaoshen/mcp-jenkins)** - ⭐ 73
   The Model Context Protocol (MCP) is an open-source implementation that bridges Jenkins with AI language models following Anthropic's MCP specification. This project enables secure, contextual AI interactions with Jenkins tools while maintaining data privacy and security.

1770. **[rust-mcp-schema](https://github.com/rust-mcp-stack/rust-mcp-schema)** - ⭐ 72
   A type-safe implementation of the official Model Context Protocol (MCP) schema in Rust.

1771. **[masquerade](https://github.com/postralai/masquerade)** - ⭐ 72
   The Privacy Firewall for LLMs

1772. **[wecom-bot-mcp-server](https://github.com/loonghao/wecom-bot-mcp-server)** - ⭐ 72
...
1773. **[Mureka-mcp](https://github.com/SkyworkAI/Mureka-mcp)** - ⭐ 72
   generate lyrics, song and background music(instrumental). Model Context Protocol (MCP) server.

1774. **[conductor-tasks](https://github.com/hridaya423/conductor-tasks)** - ⭐ 72
   A task management system designed for AI development

1775. **[codebase-mcp](https://github.com/DeDeveloper23/codebase-mcp)** - ⭐ 72
   Model Context Protocol implementation for retrieving codebases using RepoMix

1776. **[chat.md](https://github.com/rusiaaman/chat.md)** - ⭐ 71
   An md file as a chat interface and editable history in one.

1777. **[choturobo](https://github.com/vishalmysore/choturobo)** - ⭐ 71
...
1778. **[fullstack-langgraph-nextjs-agent](https://github.com/agentailor/fullstack-langgraph-nextjs-agent)** - ⭐ 71
...
1779. **[ytt-mcp](https://github.com/cottongeeks/ytt-mcp)** - ⭐ 71
   MCP server to fetch YouTube transcripts

1780. **[MCP-wolfram-alpha](https://github.com/SecretiveShell/MCP-wolfram-alpha)** - ⭐ 71
   Connect your chat repl to wolfram alpha computational intelligence

1781. **[Custom-MCP-Server](https://github.com/Sharan-Kumar-R/Custom-MCP-Server)** - ⭐ 71
   MCP server for scraping LinkedIn, Facebook, Instagram profiles and Google search.

1782. **[SillyTavern-MCP-Client](https://github.com/bmen25124/SillyTavern-MCP-Client)** - ⭐ 71
   An extension of MCP for SillyTavern.

1783. **[ophis](https://github.com/njayp/ophis)** - ⭐ 71
   Transform any Cobra CLI into an MCP server

1784. **[spring-ai](https://github.com/eazybytes/spring-ai)** - ⭐ 71
   From Java Dev to AI Engineer: Spring AI Fast Track

1785. **[xclaude-plugin](https://github.com/conorluddy/xclaude-plugin)** - ⭐ 71
...
1786. **[airtable-mcp](https://github.com/felores/airtable-mcp)** - ⭐ 70
   Search, create and update Airtable bases, tables, fields, and records using Claude Desktop and MCP (Model Context Protocol) clients

1787. **[railway-mcp](https://github.com/jason-tan-swe/railway-mcp)** - ⭐ 70
   An unofficial and community-built MCP server for integrating with https://railway.app

1788. **[ccxt-mcp](https://github.com/lazy-dinosaur/ccxt-mcp)** - ⭐ 70
   CCXT MCP Server bridges the gap between AI models and cryptocurrency trading by providing a standardized interface through the Model Context Protocol. Created to empower automated trading strategies, this tool allows AI assistants like Claude and GPT to directly interact with over 100 cryptocurrency exchanges without requiring users to write comple

1789. **[MCP-server-Deepseek_R1](https://github.com/66julienmartin/MCP-server-Deepseek_R1)** - ⭐ 70
   A Model Context Protocol (MCP) server implementation connecting Claude Desktop with DeepSeek's language models (R1/V3)

1790. **[surrealmcp](https://github.com/surrealdb/surrealmcp)** - ⭐ 70
   The official MCP server for SurrealDB

1791. **[template-mcp-server](https://github.com/mcpdotdirect/template-mcp-server)** - ⭐ 70
   Template to quickly set up your own MCP server 

1792. **[mcp-fal](https://github.com/am0y/mcp-fal)** - ⭐ 70
   A Model Context Protocol (MCP) server for interacting with fal.ai models and services.

1793. **[mcp-client-capabilities](https://github.com/apify/mcp-client-capabilities)** - ⭐ 70
   Index of all Model Context Protocol (MCP) clients and their capabilities

1794. **[x64dbgMCP](https://github.com/Wasdubya/x64dbgMCP)** - ⭐ 70
   Model Context Protocol for x64dbg & x32dbg

1795. **[mcp-server-email](https://github.com/Shy2593666979/mcp-server-email)** - ⭐ 69
...
1796. **[HopperMCP](https://github.com/MxIris-Reverse-Engineering/HopperMCP)** - ⭐ 69
   A Model Context Protocol server for Hopper Disassembler

1797. **[OmniMCP](https://github.com/OpenAdaptAI/OmniMCP)** - ⭐ 69
   OmniMCP uses Microsoft OmniParser and Model Context Protocol (MCP) to provide AI models with rich UI context and powerful interaction capabilities.

1798. **[bing-search-mcp](https://github.com/leehanchung/bing-search-mcp)** - ⭐ 69
   MCP Server for Bing Search API

1799. **[mcp-velociraptor](https://github.com/mgreen27/mcp-velociraptor)** - ⭐ 69
   VelociraptorMCP is a Model Context Protocol bridge for exposing LLMs to MCP clients.

1800. **[BurpSuite-MCP-Server](https://github.com/X3r0K/BurpSuite-MCP-Server)** - ⭐ 69
   BurpSuite MCP Server:  A powerful Model Context Protocol (MCP) server implementation for BurpSuite, providing programmatic access to Burp's core functionalities.

1801. **[bitcoin-mcp](https://github.com/AbdelStark/bitcoin-mcp)** - ⭐ 69
   Bitcoin & Lightning Network MCP Server.

1802. **[blender-open-mcp](https://github.com/dhakalnirajan/blender-open-mcp)** - ⭐ 68
   Open Models MCP for Blender Using Ollama

1803. **[ncp](https://github.com/portel-dev/ncp)** - ⭐ 68
...
1804. **[ClueoMCP](https://github.com/ClueoFoundation/ClueoMCP)** - ⭐ 68
...
1805. **[mcp-client-python](https://github.com/alejandro-ao/mcp-client-python)** - ⭐ 68

1806. **[github-brain](https://github.com/wham/github-brain)** - ⭐ 68
   An experimental MCP server that summarizes GitHub discussions, issues, and pull requests using a fast local database.

1807. **[ollama-mcp-client](https://github.com/mihirrd/ollama-mcp-client)** - ⭐ 67
   MCP client for local ollama models

1808. **[agenite](https://github.com/subeshb1/agenite)** - ⭐ 67
...
1809. **[MCPhoenix](https://github.com/jmanhype/MCPhoenix)** - ⭐ 67
   A simplified implementation of the Model Context Protocol (MCP) server using Elixir's Phoenix Framework.

1810. **[mcp_gradio_client](https://github.com/justjoehere/mcp_gradio_client)** - ⭐ 67
   This is a proof of concept repo on how to create a gradio UI using the Model Context Protocol Client Python SDK.

1811. **[gmail-mcp-server](https://github.com/jasonsum/gmail-mcp-server)** - ⭐ 67
   Model Context Protocol (MCP) server for Gmail

1812. **[optuna-mcp](https://github.com/optuna/optuna-mcp)** - ⭐ 67
   The Optuna MCP Server is a Model Context Protocol (MCP) server to interact with Optuna APIs.

1813. **[anilist-mcp](https://github.com/yuna0x0/anilist-mcp)** - ⭐ 67
   AniList MCP server for accessing anime and manga data

1814. **[piapi-mcp-server](https://github.com/apinetwork/piapi-mcp-server)** - ⭐ 67
   A TypeScript implementation of a Model Context Protocol (MCP) server that integrates with PiAPI's API. PiAPI makes user able to generate media content with Midjourney/Flux/Kling/LumaLabs/Udio/Chrip/Trellis directly from Claude or any other MCP-compatible apps.

1815. **[deepseek-thinker-mcp](https://github.com/ruixingshi/deepseek-thinker-mcp)** - ⭐ 67
...
1816. **[deepview-mcp](https://github.com/ai-1st/deepview-mcp)** - ⭐ 67
   DeepView MCP is a Model Context Protocol server that enables IDEs like Cursor and Windsurf to analyze large codebases using Gemini 2.5 Pro's extensive context window.

1817. **[gdai-mcp-plugin-godot](https://github.com/3ddelano/gdai-mcp-plugin-godot)** - ⭐ 67
...
1818. **[unitree-go2-mcp-server](https://github.com/lpigeon/unitree-go2-mcp-server)** - ⭐ 67
   The Unitree Go2 MCP Server is a server built on the MCP that enables users to control the Unitree Go2 robot using natural language commands interpreted by a LLM.

1819. **[ig-mcp](https://github.com/jlbadano/ig-mcp)** - ⭐ 66
...
1820. **[math-mcp](https://github.com/EthanHenrickson/math-mcp)** - ⭐ 66
   A Model Context Protocol (MCP) server that provides basic mathematical and statistical functions to Large Language Models (LLMs). This server enables LLMs to perform accurate numerical calculations through a simple API.

1821. **[raindrop-io-mcp-server](https://github.com/hiromitsusasaki/raindrop-io-mcp-server)** - ⭐ 66
   An integration that allows LLMs to interact with Raindrop.io bookmarks using the Model Context Protocol (MCP).

1822. **[vibe-blocks-mcp](https://github.com/majidmanzarpour/vibe-blocks-mcp)** - ⭐ 66
...
1823. **[mcp-server-datahub](https://github.com/acryldata/mcp-server-datahub)** - ⭐ 66
   The official Model Context Protocol (MCP) server for DataHub (https://datahub.com)

1824. **[boilerplate-mcp-server](https://github.com/aashari/boilerplate-mcp-server)** - ⭐ 66
   TypeScript Model Context Protocol (MCP) server boilerplate providing IP lookup tools/resources. Includes CLI support and extensible structure for connecting AI systems (LLMs) to external data sources like ip-api.com. Ideal template for creating new MCP integrations via Node.js.

1825. **[m3](https://github.com/rafiattrach/m3)** - ⭐ 66
...
1834. **[monarch-mcp-server](https://github.com/robcerda/monarch-mcp-server)** - ⭐ 66
   MCP Server for use with Monarch Money

1835. **[tauri-plugin-mcp](https://github.com/P3GLEG/tauri-plugin-mcp)** - ⭐ 66
...
1836. **[perplexity-mcp-zerver](https://github.com/wysh3/perplexity-mcp-zerver)** - ⭐ 66
   MCP web search using perplexity without any API KEYS 

1837. **[markitdown_mcp_server](https://github.com/KorigamiK/markitdown_mcp_server)** - ⭐ 65
   A Model Context Protocol (MCP) server that converts various file formats to Markdown using the MarkItDown utility.

1838. **[ViaMCP](https://github.com/ViaVersionMCP/ViaMCP)** - ⭐ 65
   Client-side Implementation of the Via* projects for MCP

1839. **[mcp-tutorials](https://github.com/chenmingyong0423/mcp-tutorials)** - ⭐ 65
   Model Context Protocol(MCP) 中文教程讲解

1840. **[community-servers](https://github.com/mcp-get/community-servers)** - ⭐ 65
...
1841. **[flapi](https://github.com/DataZooDE/flapi)** - ⭐ 65
...
1842. **[openfoam-mcp-server](https://github.com/webworn/openfoam-mcp-server)** - ⭐ 65
   LLM-powered OpenFOAM MCP server for intelligent CFD education with Socratic questioning and expert error resolution

1843. **[shinzo-ts](https://github.com/shinzo-labs/shinzo-ts)** - ⭐ 65
...
1844. **[mcp-server-node](https://github.com/lucianoayres/mcp-server-node)** - ⭐ 65
...
1845. **[lsd-mcp](https://github.com/lsd-so/lsd-mcp)** - ⭐ 64
   LSD Model Context Protocol

1846. **[svelte5-mcp](https://github.com/StudentOfJS/svelte5-mcp)** - ⭐ 64
   A specialized Model Context Protocol (MCP) server for Svelte 5 frontend development

1847. **[ollama-mcp-client](https://github.com/anjor/ollama-mcp-client)** - ⭐ 64

1848. **[mcp-config](https://github.com/marcusschiesser/mcp-config)** - ⭐ 64
   A CLI tool for easy installation of MCP servers and managing their configuration

1849. **[crash-mcp](https://github.com/nikkoxgonzales/crash-mcp)** - ⭐ 64
   MCP server for structured and efficient reasoning with step validation, branching, and revisions.

1850. **[CanvasMCPClient](https://github.com/n00bvn/CanvasMCPClient)** - ⭐ 64
   Canvas MCP Client is an open-source, self-hostable dashboard application built around an infinite, zoomable, and pannable canvas. It provides a unified interface for interacting with multiple MCP (Model Context Protocol) servers through a flexible, widget-based system.

1851. **[VibeShift](https://github.com/GroundNG/VibeShift)** - ⭐ 64
   [MCP Server] The Security Agent for AI assisted coding

1852. **[amazon-mcp](https://github.com/Fewsats/amazon-mcp)** - ⭐ 64
   Amazon MCP server to search & buy products using the L402

1853. **[nav2_mcp_server](https://github.com/ajtudela/nav2_mcp_server)** - ⭐ 64
   MCP server that provides tools and resources to control and monitor robots using Nav2.

1854. **[ros2_mcp](https://github.com/wise-vision/ros2_mcp)** - ⭐ 64
   Advanced MCP Server ROS 2 bridging AI agents straight into robotics

1855. **[rtfmbro-mcp](https://github.com/marckrenn/rtfmbro-mcp)** - ⭐ 64
   rtfmbro provides always-up-to-date, version-specific package documentation as context for coding agents. An alternative to context7

1856. **[airtable-mcp](https://github.com/rashidazarang/airtable-mcp)** - ⭐ 64
   Airtable integration for AI-powered applications via Anthropic's Model Context Protocol (MCP)

1857. **[claude-desktop-extension-bear-notes](https://github.com/vasylenko/claude-desktop-extension-bear-notes)** - ⭐ 64
   Claude Desktop extension with bundled MCP Server for Bear note taking app

1858. **[mcp-fhir](https://github.com/flexpa/mcp-fhir)** - ⭐ 63
   A Model Context Protocol implementation for FHIR

1859. **[mcp-sdk](https://github.com/AntigmaLabs/mcp-sdk)** - ⭐ 63
   Minimalistic Rust Implementation Of Model Context Protocol from Anthropic

1860. **[turbomcp](https://github.com/Epistates/turbomcp)** - ⭐ 63
   A full featured, enterprise grade rust MCP SDK

1861. **[mcp-discord](https://github.com/barryyip0625/mcp-discord)** - ⭐ 63
   Implement Discord MCP server enabling AI assistants to interact with the Discord platform.

1862. **[deep-research-mcp-server](https://github.com/ssdeanx/deep-research-mcp-server)** - ⭐ 63
   MCP Deep Research Server using Gemini creating a Research AI Agent

1863. **[lazy-mcp](https://github.com/voicetreelab/lazy-mcp)** - ⭐ 63
     MCP proxy server with lazy loading support - reduces context usage through on-demand tool activation

1864. **[mcp-bear](https://github.com/jkawamoto/mcp-bear)** - ⭐ 63
   A MCP server for interacting with Bear note-taking software.

1865. **[mcp-openapi-schema-explorer](https://github.com/kadykov/mcp-openapi-schema-explorer)** - ⭐ 62
   MCP server providing token-efficient access to OpenAPI/Swagger specs via MCP Resource Templates for client-side exploration.

1866. **[usolver](https://github.com/sdiehl/usolver)** - ⭐ 62
   A model context protocol server for solving combinatorial optimization problems with logical and numerical constraints.

1867. **[nutrient-dws-mcp-server](https://github.com/PSPDFKit/nutrient-dws-mcp-server)** - ⭐ 62
   A Model Context Protocol (MCP) server implementation that integrates with the Nutrient Document Web Service (DWS) Processor API, providing powerful PDF processing capabilities for AI assistants.

1868. **[mcp-durable-object-client](https://github.com/Dhravya/mcp-durable-object-client)** - ⭐ 62
   testing mcps

1869. **[mcp-wolframalpha](https://github.com/akalaric/mcp-wolframalpha)** - ⭐ 62
   A Python-powered Model Context Protocol MCP server and client that uses Wolfram Alpha via API.

1870. **[tiny-mcp](https://github.com/wdndev/tiny-mcp)** - ⭐ 62
   Python 实现 MCP client / service

1871. **[voice-mcp-agent](https://github.com/den-vasyliev/voice-mcp-agent)** - ⭐ 62
...
1872. **[mcp_newsnow](https://github.com/sligter/mcp_newsnow)** - ⭐ 62
   一个基于 Model Context Protocol (MCP) 的新闻聚合服务器，通过 Newsnow API 提供多平台热点新闻和趋势话题。

1873. **[gopher-mcp](https://github.com/GopherSecurity/gopher-mcp)** - ⭐ 62
   MCP C++ SDK - Model Context Protocol implementation in CPP with enterprise-grade security, visibility and connectivity.

1874. **[MySQL_MCP](https://github.com/guangxiangdebizi/MySQL_MCP)** - ⭐ 62
   这是一个功能强大且易用的MySQL数据库MCP（Model Context Protocol）服务器，让你的AI助手可以安全地进行完整的数据库操作，支持多数据库连接管理、增删改查、事务管理和智能回滚功能。

1875. **[robot_MCP](https://github.com/IliaLarchenko/robot_MCP)** - ⭐ 62
   A simple MCP server for the SO-ARM100 control

1876. **[mcp-server-ccxt](https://github.com/Nayshins/mcp-server-ccxt)** - ⭐ 62
   Cryptocurrency Market Data MCP Server

1877. **[django-ai-boost](https://github.com/vintasoftware/django-ai-boost)** - ⭐ 62
   A MCP server for Django applications, inspired by Laravel Boost.

1878. **[mcp-gopls](https://github.com/hloiseau/mcp-gopls)** - ⭐ 62
   Model Context Protocol (MCP) server for Go using gopls – LSP-powered analysis, tests, coverage, and tooling.

1879. **[sub-agents-mcp](https://github.com/shinpr/sub-agents-mcp)** - ⭐ 62
   Define task-specific AI sub-agents in Markdown for any MCP-compatible tool.

1880. **[contentful-mcp](https://github.com/ivo-toby/contentful-mcp)** - ⭐ 61
   MCP (Model Context Protocol) server for the Contentful Management API

1881. **[mcpr](https://github.com/devOpifex/mcpr)** - ⭐ 61
   Model Context Protocol server and client for R

1882. **[mcp-server-okppt](https://github.com/NeekChaw/mcp-server-okppt)** - ⭐ 61
...
1883. **[kollektiv-mcp](https://github.com/alexander-zuev/kollektiv-mcp)** - ⭐ 61
...
1884. **[ollama-mcp-db](https://github.com/robdodson/ollama-mcp-db)** - ⭐ 61
...
1885. **[mcp-cn](https://github.com/mengjian-github/mcp-cn)** - ⭐ 61
...
1886. **[ipybox](https://github.com/gradion-ai/ipybox)** - ⭐ 61
   Python code execution sandbox with programmatic MCP tool calling (PTC)

1887. **[mcp-miro](https://github.com/k-jarzyna/mcp-miro)** - ⭐ 61
   Miro integration for Model Context Protocol

1888. **[yamcp](https://github.com/hamidra/yamcp)** - ⭐ 61
   Organize your MCP servers in local workspaces, share them as Yet-Another-MCP through a single command

1889. **[mcp_zoomeye](https://github.com/zoomeye-ai/mcp_zoomeye)** - ⭐ 61
   A Model Context Protocol server that provides network asset information based on query conditions. This server allows LLMs to obtain network asset information and supports querying network asset information by zoomeye dork etc.

1890. **[mcp-arr](https://github.com/aplaceforallmystuff/mcp-arr)** - ⭐ 61
   MCP server for *arr media management suite

1891. **[slither-mcp](https://github.com/trailofbits/slither-mcp)** - ⭐ 61
   MCP server for Slither static analysis of Solidity smart contracts

1892. **[one-search-mcp](https://github.com/yokingma/one-search-mcp)** - ⭐ 61
   🚀 OneSearch MCP Server: Web Search & Scraper & Extract,  Support Firecrawl, SearXNG, Tavily, DuckDuckGo, Bing, etc.

1893. **[data-gov-il-mcp](https://github.com/DavidOsherdiagnostica/data-gov-il-mcp)** - ⭐ 61
   Advanced MCP server for seamless access to Israeli Government Open Data

1894. **[identity-service](https://github.com/agntcy/identity-service)** - ⭐ 61
...
1895. **[rember-mcp](https://github.com/rember/rember-mcp)** - ⭐ 60
   A Model Context Protocol (MCP) server for Rember.

1896. **[chess-mcp](https://github.com/pab1it0/chess-mcp)** - ⭐ 60
   A Model Context Protocol server for Chess.com's Published Data API.  This provides access to Chess.com player data, game records, and other public information through standardized MCP interfaces, allowing AI assistants to search and analyze chess information.

1897. **[junos-mcp-server](https://github.com/Juniper/junos-mcp-server)** - ⭐ 60
...
1898. **[devto-mcp](https://github.com/Arindam200/devto-mcp)** - ⭐ 60
   MCP Server of DevTo

1899. **[mcp-difyworkflow-server](https://github.com/gotoolkits/mcp-difyworkflow-server)** - ⭐ 60
   mcp-difyworkflow-server is an mcp server Tools application that implements the query and invocation of Dify workflows, supporting the on-demand operation of multiple custom Dify workflows.

1900. **[mcpc](https://github.com/mcpc-tech/mcpc)** - ⭐ 60
   Build agentic-MCP servers by composing existing MCP tools.

1901. **[ocaml-mcp-sdk](https://github.com/bmorphism/ocaml-mcp-sdk)** - ⭐ 59
   OCaml SDK for Model Context Protocol using Jane Street's oxcaml_effect library

1902. **[daipendency-mcp](https://github.com/daipendency/daipendency-mcp)** - ⭐ 59
   Model Context Protocol server for Daipendency

1903. **[smart-pet-with-mcp](https://github.com/shijianzhong/smart-pet-with-mcp)** - ⭐ 59
   一个桌宠形式的mcp client，可以对接任意mcp server,配合测试的mcp server 开源地址：https://github.com/shijianzhong/mcp-server-for-pc

1904. **[mcp-clojure-sdk](https://github.com/unravel-team/mcp-clojure-sdk)** - ⭐ 59
   A Clojure SDK to create MCP servers (and eventually clients)

1905. **[fred-mcp-server](https://github.com/stefanoamorelli/fred-mcp-server)** - ⭐ 59
   Open-source FRED MCP Server (Federal Reserve Economic Data)

1906. **[cline-mcp-memory-bank](https://github.com/dazeb/cline-mcp-memory-bank)** - ⭐ 59
   A memory system for Cline that tracks progress between conversations.

1907. **[shadcn-ui-mcp-server](https://github.com/ymadd/shadcn-ui-mcp-server)** - ⭐ 59
   MCP server for shadcn/ui component references

1908. **[pydantic-rpc](https://github.com/i2y/pydantic-rpc)** - ⭐ 59
...
1909. **[meta-mcp](https://github.com/brijr/meta-mcp)** - ⭐ 59
   MCP Server for connecting to the Meta Marketing API

1910. **[ableton-copilot-mcp](https://github.com/xiaolaa2/ableton-copilot-mcp)** - ⭐ 59
...
1911. **[autosteer](https://github.com/notch-ai/autosteer)** - ⭐ 59
   Desktop app for multi-workspace Claude Code management

1912. **[mcp-server-echart](https://github.com/cnkanwei/mcp-server-echart)** - ⭐ 59
   基于 mcp-go 框架构建的 mcp 服务，它提供了一个能动态生成 ECharts 图表页面的工具。

1913. **[mcp-hub](https://github.com/lobstercare/mcp-hub)** - ⭐ 58
   A curated list of awesome Model Context Protocol (MCP) servers.

1914. **[baml-agents](https://github.com/Elijas/baml-agents)** - ⭐ 58
   Building Agents with LLM structured generation (BAML), MCP Tools, and 12-Factor Agents principles

1915. **[MCP-Dandan](https://github.com/82ch/MCP-Dandan)** - ⭐ 58
   MCP Security Solution for Agentic AI — real-time proxying, behavior analysis, and malicious tool detection

1916. **[mcp-servers](https://github.com/pulsemcp/mcp-servers)** - ⭐ 58
   MCP (Model Context Protocol) Servers authored and maintained by the PulseMCP team. We build reliable servers thoughtfully designed specifically for MCP Client-powered workflows.

1917. **[ashra-mcp](https://github.com/getrupt/ashra-mcp)** - ⭐ 58
   A Model Context Protocol server for Ashra

1918. **[windbg-ext-mcp](https://github.com/NadavLor/windbg-ext-mcp)** - ⭐ 58
...
1919. **[create-mcp-app](https://github.com/boguan/create-mcp-app)** - ⭐ 58
   A CLI tool for quickly scaffolding Model Context Protocol (MCP) server applications with TypeScript support and modern development tooling

1920. **[nocodb-mcp-server](https://github.com/edwinbernadus/nocodb-mcp-server)** - ⭐ 58
   nocodb mcp server

1921. **[roundtable](https://github.com/askbudi/roundtable)** - ⭐ 58
...
1922. **[mcp-server-axiom](https://github.com/axiomhq/mcp-server-axiom)** - ⭐ 57
   Axiom Model Context Protocol Server

1923. **[mobile-mcp](https://github.com/runablehq/mobile-mcp)** - ⭐ 57
   A Model Context Protocol (MCP) server that provides mobile automation capabilities.

1924. **[mcp-gemini-search](https://github.com/arjunprabhulal/mcp-gemini-search)** - ⭐ 57
   Model Context Protocol (MCP) with Gemini 2.5 Pro. Convert conversational queries into flight searches using Gemini's function calling capabilities and MCP's flight search tools

1925. **[quick-mcp-example](https://github.com/ALucek/quick-mcp-example)** - ⭐ 57
   Short and sweet example MCP server / client implementation for Tools, Resources and Prompts.

1926. **[clarity-mcp-server](https://github.com/microsoft/clarity-mcp-server)** - ⭐ 57
   A Model Context Protocol (MCP) server for Microsoft Clarity

1927. **[EnergyPlus-MCP](https://github.com/LBNL-ETA/EnergyPlus-MCP)** - ⭐ 57
...
1928. **[metis-router](https://github.com/metis-mantis/metis-router)** - ⭐ 57
   MCP router and Web Based MCP client

1929. **[xiaozhi-mcp-client](https://github.com/shadowcz007/xiaozhi-mcp-client)** - ⭐ 57
   可视化的配置和管理，给xiaozhi接入mcp

1930. **[XActions](https://github.com/nirholas/XActions)** - ⭐ 57
...
1931. **[purple-mcp](https://github.com/Sentinel-One/purple-mcp)** - ⭐ 57
...
1932. **[Archive-Agent](https://github.com/shredEngineer/Archive-Agent)** - ⭐ 57
   Find your files with natural language and ask questions.

1933. **[mcpserver](https://github.com/2234839/mcpserver)** - ⭐ 57
   为claude code+glm 添加上眼睛

1934. **[mcp-think-tank](https://github.com/flight505/mcp-think-tank)** - ⭐ 56
...
1935. **[nutrient-document-engine-mcp-server](https://github.com/PSPDFKit/nutrient-document-engine-mcp-server)** - ⭐ 56
   A Model Context Protocol (MCP) server implementation exposes document processing capabilities through natural language, supporting both direct human interaction and AI agent tool calling.

1936. **[Intelli](https://github.com/intelligentnode/Intelli)** - ⭐ 56
   Build multi-model chatbots and agents from intent.

1937. **[mcp-manager](https://github.com/MediaPublishing/mcp-manager)** - ⭐ 56
   A web-based GUI tool for managing Model Context Protocol (MCP) servers in Claude and Cursor

1938. **[mcp-thinking](https://github.com/mattzcarey/mcp-thinking)** - ⭐ 56
   thinking tool for claude desktop/mcp clients using Deepseek reasoner

1939. **[sublinear-time-solver](https://github.com/ruvnet/sublinear-time-solver)** - ⭐ 56
...
1942. **[google-ai-mode-mcp](https://github.com/PleasePrompto/google-ai-mode-mcp)** - ⭐ 56
...
1943. **[AllVoiceLab-MCP](https://github.com/allvoicelab/AllVoiceLab-MCP)** - ⭐ 56
...
1944. **[erpnext-mcp-server](https://github.com/rakeshgangwar/erpnext-mcp-server)** - ⭐ 56
   Connect AI assistants to your ERPNext instance via the Model Context Protocol (MCP) using the official Frappe API.

1945. **[interactive-brokers-mcp](https://github.com/code-rabi/interactive-brokers-mcp)** - ⭐ 56
   Interactive Brokers MCP Server

1946. **[job-searchoor](https://github.com/0xDAEF0F/job-searchoor)** - ⭐ 56
   A simple MCP server that delivers you jobs based on your needs

1947. **[solana-mcp-server](https://github.com/openSVM/solana-mcp-server)** - ⭐ 56
   solana mcp sever to enable solana rpc methods

1948. **[mcp-server](https://github.com/UI5/mcp-server)** - ⭐ 56
   The UI5 MCP server improves the developer experience when working with agentic AI and the UI5 framework.

1949. **[adbfriend](https://github.com/mikepenz/adbfriend)** - ⭐ 56
   Android ADB CLI tool including integrated MCP Server with common adb actions used during development

1950. **[umbraco-mcp](https://github.com/Matthew-Wise/umbraco-mcp)** - ⭐ 55
   A model context protocol  (MCP) server for Umbraco 

1951. **[mkp](https://github.com/StacklokLabs/mkp)** - ⭐ 55
   MKP is a Model Context Protocol (MCP) server for Kubernetes

1952. **[mcp-bridge-api](https://github.com/INQUIRELAB/mcp-bridge-api)** - ⭐ 55
...
1953. **[Alph](https://github.com/Aqualia/Alph)** - ⭐ 55
   Universal MCP Server Configuration Manager

1954. **[MCP4EDA](https://github.com/NellyW8/MCP4EDA)** - ⭐ 55
...
1955. **[time-mcp](https://github.com/yokingma/time-mcp)** - ⭐ 55
   ⏰ Time MCP Server: Giving LLMs Time Awareness Capabilities

1956. **[mcd-mcp-server](https://github.com/M-China/mcd-mcp-server)** - ⭐ 55
   McDonald's China MCP Server Integration Guide

1957. **[mcp_server_gdb](https://github.com/pansila/mcp_server_gdb)** - ⭐ 55
   MCP Server to expose the GDB debugging capabilities

1958. **[mcp-server-flomo](https://github.com/chatmcp/mcp-server-flomo)** - ⭐ 55
   Write notes to Flomo

1959. **[openai-mcp-client](https://github.com/ResoluteError/openai-mcp-client)** - ⭐ 54
   A rudimentary implementation of Anthropic's Model Context Protocol with OpenAIs Model

1960. **[mcp-headless-gmail](https://github.com/baryhuang/mcp-headless-gmail)** - ⭐ 54
   A MCP (Model Context Protocol) server that provides get, send Gmails without local credential or token setup.

1961. **[geoserver-mcp](https://github.com/mahdin75/geoserver-mcp)** - ⭐ 54
   A Model Context Protocol (MCP) server implementation that connects LLMs to the GeoServer REST API

1962. **[fastmail-mcp](https://github.com/MadLlama25/fastmail-mcp)** - ⭐ 54
...
1963. **[podman-mcp-server](https://github.com/manusa/podman-mcp-server)** - ⭐ 54
   Model Context Protocol (MCP) server for container runtimes (Podman and Docker)

1964. **[bc-code-intelligence-mcp](https://github.com/JeremyVyska/bc-code-intelligence-mcp)** - ⭐ 54
...
1965. **[mcp-reticle](https://github.com/LabTerminal/mcp-reticle)** - ⭐ 54
   Reticle intercepts, visualizes, and profiles JSON-RPC traffic between your LLM and MCP servers in real-time, with zero latency overhead. Stop debugging blind. Start seeing everything.

1966. **[mcp-open-library](https://github.com/8enSmith/mcp-open-library)** - ⭐ 54
   A Model Context Protocol (MCP) server for the Internet Archive's Open Library API that enables AI assistants to search for book and author information.

1967. **[stackoverflow-mcp](https://github.com/gscalzo/stackoverflow-mcp)** - ⭐ 54
   A Model Context Protocol server for querying Stack Overflow to help AI models find programming solutions

1968. **[agent-toolkit](https://github.com/sanity-io/agent-toolkit)** - ⭐ 54
   Collection of resources to help AI agents build better with Sanity.

1969. **[fli](https://github.com/punitarani/fli)** - ⭐ 54
   Google Flights MCP and Python Library

1970. **[scrapegraph-mcp](https://github.com/ScrapeGraphAI/scrapegraph-mcp)** - ⭐ 54
   ScapeGraph MCP Server

1971. **[fhir-mcp-server](https://github.com/the-momentum/fhir-mcp-server)** - ⭐ 54
   FHIR MCP Server for handling medical data standard.

1972. **[minibridge](https://github.com/acuvity/minibridge)** - ⭐ 54
   Make your MCP servers secure and production ready

1973. **[web2mcp](https://github.com/neelsomani/web2mcp)** - ⭐ 54
   Generate an MCP for any web app

1974. **[MCP_Atom_of_Thoughts](https://github.com/kbsooo/MCP_Atom_of_Thoughts)** - ⭐ 54
...
1975. **[appium-mcp](https://github.com/Rahulec08/appium-mcp)** - ⭐ 53
...
1976. **[mcp-openai](https://github.com/S1M0N38/mcp-openai)** - ⭐ 53
   🔗 MCP Client with OpenAI compatible API

1977. **[qu3-app](https://github.com/qu3ai/qu3-app)** - ⭐ 53
   Quantum-proof MCP Server and Client Interactions

1978. **[NoLLMChat](https://github.com/zrg-team/NoLLMChat)** - ⭐ 53
...
1979. **[mssql_mcp_server](https://github.com/JexinSam/mssql_mcp_server)** - ⭐ 53
   A Model Context Protocol (MCP) server facilitating secure interactions with MSSQL databases.

1980. **[nasdaq-data-link-mcp](https://github.com/stefanoamorelli/nasdaq-data-link-mcp)** - ⭐ 53
   A Nasdaq Data Link MCP (Model Context Protocol) Server

1981. **[mcp-shell](https://github.com/sonirico/mcp-shell)** - ⭐ 53
   Give hands to AI. MCP server to run shell commands securely, auditably, and on demand.

1982. **[ticktick-mcp-server](https://github.com/alexarevalo9/ticktick-mcp-server)** - ⭐ 53
   A Model Context Protocol (MCP) server designed to integrate with the TickTick task management platform, enabling intelligent context-aware task operations and automation.

1983. **[gomcp](https://github.com/llmcontext/gomcp)** - ⭐ 53
   Unofficial Golang SDK for Anthropic Model Context Protocol

1984. **[mxcp](https://github.com/raw-labs/mxcp)** - ⭐ 53
   Model eXecution + Context Protocol: Enterprise-Grade Data-to-AI Infrastructure

1985. **[mcp-server-azure-ai-agents](https://github.com/farzad528/mcp-server-azure-ai-agents)** - ⭐ 53
   Model Context Protocol Servers for Azure AI Search

1986. **[awesome-remote-mcp-servers](https://github.com/sylviangth/awesome-remote-mcp-servers)** - ⭐ 53
   A curated list of Hosted & Managed Model Context Protocol (MCP) Servers accessible via a simple URL endpoint.

1987. **[mcp](https://github.com/abap-ai/mcp)** - ⭐ 53
   ABAP MCP - Model Context Protocol - Server SDK

1988. **[joplin-mcp-server](https://github.com/dweigend/joplin-mcp-server)** - ⭐ 53
   A Model Context Protocol (MCP) Server for https://joplinapp.org/ that enables note access through the https://modelcontextprotocol.io. Perfect for integration with AI assistants like Claude.

1989. **[MediaWiki-MCP-Server](https://github.com/ProfessionalWiki/MediaWiki-MCP-Server)** - ⭐ 53
   Model Context Protocol (MCP) Server to connect your AI with any MediaWiki

1990. **[mcp-docs-service](https://github.com/alekspetrov/mcp-docs-service)** - ⭐ 53
   MCP Documentation Management Service - A Model Context Protocol implementation for documentation management

1991. **[ollama-mcp-bridge](https://github.com/jonigl/ollama-mcp-bridge)** - ⭐ 53
   Extend the Ollama API with dynamic AI tool integration from multiple MCP (Model Context Protocol) servers. Fully compatible, transparent, and developer-friendly, ideal for building powerful local LLM applications, AI agents, and custom chatbots

1992. **[mcp-auth-proxy](https://github.com/sigbit/mcp-auth-proxy)** - ⭐ 53
   MCP Auth Proxy is a secure OAuth 2.1 authentication proxy for Model Context Protocol (MCP) servers

1993. **[client](https://github.com/php-mcp/client)** - ⭐ 52
   Core PHP implementation for the Model Context Protocol (MCP) Client

1994. **[cap-mcp-plugin](https://github.com/gavdilabs/cap-mcp-plugin)** - ⭐ 52
   MCP (Model Context Protocol) server plugin for CAP NodeJS

1995. **[mcp-cpp](https://github.com/Neumann-Labs/mcp-cpp)** - ⭐ 52
   A C++ SDK for the Model Context Protocol (MCP). The SDK will provide a framework for creating MCP servers and clients in C++.

1996. **[ocaml-mcp](https://github.com/tmattio/ocaml-mcp)** - ⭐ 52
   OCaml implementation of the Model Context Protocol (MCP)

1997. **[mcp-app-demo](https://github.com/pomerium/mcp-app-demo)** - ⭐ 52
...
1998. **[mcp](https://github.com/twelvedata/mcp)** - ⭐ 52
...
1999. **[mcp-duckdb-memory-server](https://github.com/IzumiSy/mcp-duckdb-memory-server)** - ⭐ 52
   MCP Memory Server with DuckDB backend

2000. **[mcp-batchit](https://github.com/ryanjoachim/mcp-batchit)** - ⭐ 52
...
2001. **[trpc-mcp-go](https://github.com/trpc-group/trpc-mcp-go)** - ⭐ 52
   Go implementation of the Model Context Protocol (MCP) with comprehensive Streamable HTTP, STDIO, and SSE support. 

2002. **[freecad-mcp](https://github.com/contextform/freecad-mcp)** - ⭐ 52
   FreeCAD MCP - Open-source Model Context Protocol server for FreeCAD automation

2003. **[vrchat-mcp](https://github.com/sawa-zen/vrchat-mcp)** - ⭐ 52
   This project is a Model Context Protocol (MCP) server for interacting with the VRChat API.

2004. **[bloodhound_mcp](https://github.com/mwnickerson/bloodhound_mcp)** - ⭐ 52
   A Model Context Protocol (MCP) server to converse with data in Bloodhound

2005. **[adx-mcp-server](https://github.com/pab1it0/adx-mcp-server)** - ⭐ 52
   A Model Context Protocol (MCP) server that enables AI assistants to query and analyze Azure Data Explorer databases through standardized interfaces.

2006. **[xiaohongshu-mcp-python](https://github.com/luyike221/xiaohongshu-mcp-python)** - ⭐ 52
...
2007. **[dramacraft](https://github.com/whatyun/dramacraft)** - ⭐ 52
   DramaCraft 是一个专业的短剧视频编辑 MCP (Model Context Protocol) 服务，集成国产中文大模型 API，实现剪映的智能自动化编辑功能。项目已完成从视频分析到草稿生成的完整解决方案

2008. **[DecompilerServer](https://github.com/pardeike/DecompilerServer)** - ⭐ 52
...
2009. **[FreeCAD-MCP](https://github.com/ATOI-Ming/FreeCAD-MCP)** - ⭐ 52
...
2010. **[mcp-client](https://github.com/rakesh-eltropy/mcp-client)** - ⭐ 51

2011. **[Memory-Plus](https://github.com/Yuchen20/Memory-Plus)** - ⭐ 51
...
2012. **[ibkr-mcp-server](https://github.com/seriallazer/ibkr-mcp-server)** - ⭐ 51
   MCP Server for IBKR Client

2013. **[mcp-ssh](https://github.com/shuakami/mcp-ssh)** - ⭐ 51
   🔐 SSH MCP Tool - AI-powered SSH management through MCP protocol | 基于MCP协议的SSH工具，为AI提供SSH远程操作能力

2014. **[context-optimizer-mcp-server](https://github.com/malaksedarous/context-optimizer-mcp-server)** - ⭐ 51
   A Model Context Protocol (MCP) server that provides context optimization tools for AI coding assistants including GitHub Copilot, Cursor AI, Claude Desktop, and other MCP-compatible assistants enabling them to extract targeted information rather than processing large terminal outputs and files wasting their context.

2015. **[quickbooks-online-mcp-server](https://github.com/intuit/quickbooks-online-mcp-server)** - ⭐ 51
...
2016. **[go-mcp-mysql](https://github.com/Zhwt/go-mcp-mysql)** - ⭐ 51
   Zero burden, ready-to-use Model Context Protocol (MCP) server for interacting with MySQL and automation. No Node.js or Python environment needed.

2017. **[adk-mcp-a2a-crash-course](https://github.com/chongdashu/adk-mcp-a2a-crash-course)** - ⭐ 51
...
2018. **[deploystack](https://github.com/deploystackio/deploystack)** - ⭐ 51
   MCP Management Platform - Centralized credential vault, governance, and token optimization for developers and enterprises.

2019. **[chucknorris](https://github.com/pollinations/chucknorris)** - ⭐ 50
...
2020. **[AgentDNS-Node](https://github.com/jsjfai/AgentDNS-Node)** - ⭐ 50
...
2021. **[mcp-guard](https://github.com/General-Analysis/mcp-guard)** - ⭐ 50
   MCP Guard secures your MCP client from prompt injection attacks and more.

2022. **[mcp-security-audit](https://github.com/qianniuspace/mcp-security-audit)** - ⭐ 50
   A powerful MCP (Model Context Protocol) Server that audits npm package dependencies for security vulnerabilities. Built with remote npm registry integration for real-time security checks.

2023. **[rag-app-on-aws](https://github.com/genieincodebottle/rag-app-on-aws)** - ⭐ 50
...
2024. **[gomcp](https://github.com/localrivet/gomcp)** - ⭐ 50
...
2025. **[mcp-server-atlassian-jira](https://github.com/aashari/mcp-server-atlassian-jira)** - ⭐ 50
...
2026. **[youtube-mcp-server](https://github.com/mourad-ghafiri/youtube-mcp-server)** - ⭐ 50
   A powerful Model Context Protocol (MCP) server for YouTube video transcription and metadata extraction.

2027. **[mcpo_docker_use](https://github.com/flyfox666/mcpo_docker_use)** - ⭐ 49
...
2028. **[create-mcp](https://github.com/zueai/create-mcp)** - ⭐ 49
...
2029. **[rulego-server](https://github.com/rulego/rulego-server)** - ⭐ 49
   A lightweight dependency-free workflow automation platform. Supports iPaaS, stream computing, MCP, and AI capabilities. 

2030. **[tripadvisor-mcp](https://github.com/pab1it0/tripadvisor-mcp)** - ⭐ 49
...
2031. **[oatpp-mcp](https://github.com/oatpp/oatpp-mcp)** - ⭐ 49
   Anthropic’s Model Context Protocol implementation for Oat++

2032. **[kroger-mcp](https://github.com/CupOfOwls/kroger-mcp)** - ⭐ 49
...
2033. **[mcp-server-synology](https://github.com/atom2ueki/mcp-server-synology)** - ⭐ 49
...
2034. **[AI-Cursor-Scraping-Assistant](https://github.com/TheWebScrapingClub/AI-Cursor-Scraping-Assistant)** - ⭐ 49
...
2035. **[mcp-swagger-server](https://github.com/zaizaizhao/mcp-swagger-server)** - ⭐ 49
   MCP Swagger Server 将任何符合 OpenAPI/Swagger 规范的 REST API 转换为 Model Context Protocol (MCP) 格式，让 AI 助手能够理解和调用您的 API。

2036. **[mcp-oauth-gateway](https://github.com/atrawog/mcp-oauth-gateway)** - ⭐ 49
...
2037. **[zendesk-mcp-server](https://github.com/reminia/zendesk-mcp-server)** - ⭐ 49
   A Model Context Protocol server for Zendesk

2038. **[mcp-server-kibana](https://github.com/TocharianOU/mcp-server-kibana)** - ⭐ 49
   MCP server for Kibana, Access search and manage Kibana in MCP Client.

2039. **[scheduler-mcp](https://github.com/PhialsBasement/scheduler-mcp)** - ⭐ 49
...
2040. **[anysite-mcp-server](https://github.com/anysiteio/anysite-mcp-server)** - ⭐ 48
   A Model Context Protocol (MCP) server that provides comprehensive access to LinkedIn data and functionalities using the Anysite API, enabling not only data retrieval but also robust management of user accounts.

2041. **[mcp](https://github.com/goplus/mcp)** - ⭐ 48
...
2042. **[mcp-mermaid-validator](https://github.com/rtuin/mcp-mermaid-validator)** - ⭐ 48
   A Model Context Protocol server that validates and renders Mermaid diagrams.

2043. **[auto-MCP-client](https://github.com/Chen-speculation/auto-MCP-client)** - ⭐ 48
...
2044. **[mcp-client-demo](https://github.com/KelvinQiu802/mcp-client-demo)** - ⭐ 48

2045. **[puremd-mcp](https://github.com/puremd/puremd-mcp)** - ⭐ 48
   Unblock, scrape, and search tools for MCP clients

2046. **[1xn-vmcp](https://github.com/1xn-labs/1xn-vmcp)** - ⭐ 48
   vMCP - Virtual Model Context Protocol

2047. **[rs-utcp](https://github.com/universal-tool-calling-protocol/rs-utcp)** - ⭐ 48
   Official Rust implementation of the UTCP

2048. **[mcp-kubernetes](https://github.com/Azure/mcp-kubernetes)** - ⭐ 48
   A Model Context Protocol (MCP) server that enables AI assistants to interact with Kubernetes clusters. It serves as a bridge between AI tools (like Claude, Cursor, and GitHub Copilot) and Kubernetes

2049. **[model-context-protocol-rb](https://github.com/dickdavis/model-context-protocol-rb)** - ⭐ 47
   An implementation of the Model Context Protocol in Ruby.

2050. **[kuon](https://github.com/lissettecarlr/kuon)** - ⭐ 47
...
2051. **[mcp_demo](https://github.com/Ming-jiayou/mcp_demo)** - ⭐ 47
   A simple example of building an MCP client using C#.

2052. **[vchart-mcp-server](https://github.com/VisActor/vchart-mcp-server)** - ⭐ 47
   A Model Context Protocol (MCP) server for the @visactor/vchart that enables AI assistants to generate interactive charts and visualizations.

2053. **[mcp-things3](https://github.com/drjforrest/mcp-things3)** - ⭐ 47
...
2054. **[claude-mcp-setup](https://github.com/patruff/claude-mcp-setup)** - ⭐ 47
   Easy setup script for Anthropic Claude Model Context Protocol (MCP) servers on Windows

2055. **[mcp-server](https://github.com/inkdropapp/mcp-server)** - ⭐ 47
   Inkdrop Model Context Protocol Server

2056. **[Koppla](https://github.com/ruudmens/Koppla)** - ⭐ 47
   A Model-Context-Protocol (MCP) Server for Active Directory

2057. **[pubmed-mcp-server](https://github.com/cyanheads/pubmed-mcp-server)** - ⭐ 47
...
2058. **[tuisic](https://github.com/Dark-Kernel/tuisic)** - ⭐ 47
...
2059. **[mcp-gitee](https://github.com/oschina/mcp-gitee)** - ⭐ 47
   mcp-gitee is a Model Context Protocol (MCP) server implementation for Gitee. It provides a set of tools that interact with Gitee's API, allowing AI assistants to manage repository, issues, pull requests, etc.

2060. **[supermcp](https://github.com/dhanababum/supermcp)** - ⭐ 47
...
2061. **[mcp-gearbox](https://github.com/rohitsoni007/mcp-gearbox)** - ⭐ 46
   A modern desktop application for managing Model Context Protocol (MCP) servers across multiple AI agents

2062. **[mcp-openapi-schema](https://github.com/hannesj/mcp-openapi-schema)** - ⭐ 46
   OpenAPI Schema Model Context Protocol Server

2063. **[langchain-mcp-client](https://github.com/guinacio/langchain-mcp-client)** - ⭐ 46
   This Streamlit application provides a user interface for connecting to MCP (Model Context Protocol) servers and interacting with them using different LLM providers (OpenAI, Anthropic, Google, Ollama).

2064. **[APIWeaver](https://github.com/GongRzhe/APIWeaver)** - ⭐ 46
...
2065. **[ns-mcp-server](https://github.com/r-huijts/ns-mcp-server)** - ⭐ 46
   A Model Context Protocol (MCP) server that provides access to NS (Dutch Railways) travel information through Claude AI. This server enables Claude to fetch real-time train travel information and disruptions using the official Dutch NS API.

2066. **[eliza-plugin-mcp](https://github.com/fleek-platform/eliza-plugin-mcp)** - ⭐ 46
   ElizaOS plugin allowing agents to connect to MCP servers

2067. **[Homeassistant-server-mcp](https://github.com/hekmon8/Homeassistant-server-mcp)** - ⭐ 46
   A Model Context Protocol (MCP) server for interacting with Home Assistant. This server provides tools to control and monitor your Home Assistant devices through MCP-enabled applications.

2068. **[Aspire.MCP.Sample](https://github.com/elbruno/Aspire.MCP.Sample)** - ⭐ 46
   Sample MCP Server and MCP client with Aspire

2069. **[mcp-lite-dev](https://github.com/datawhalechina/mcp-lite-dev)** - ⭐ 46
   共学《MCP极简开发》项目代码

2070. **[mcp-victorialogs](https://github.com/VictoriaMetrics-Community/mcp-victorialogs)** - ⭐ 46
   The implementation of Model Context Protocol (MCP) server for VictoriaLogs.

2071. **[shadowgit-mcp](https://github.com/blade47/shadowgit-mcp)** - ⭐ 46
...
2072. **[xc-mcp](https://github.com/conorluddy/xc-mcp)** - ⭐ 46
...
2073. **[mcp-auth-servers](https://github.com/Azure-Samples/mcp-auth-servers)** - ⭐ 46
   🔒 Reference MCP servers that demo how authentication works with the current Model Context Protocol spec.

2074. **[mcp-sdk](https://github.com/symfony/mcp-sdk)** - ⭐ 45
   Model Context Protocol SDK for Client and Server applications in PHP

2075. **[hackmd-mcp](https://github.com/yuna0x0/hackmd-mcp)** - ⭐ 45
   A Model Context Protocol server for integrating HackMD's note-taking platform with AI assistants.

2076. **[mcp-made-simple](https://github.com/chongdashu/mcp-made-simple)** - ⭐ 45
   Model Context Protocol (MCP) Made Simple - Code for the tutorial series - focusing on practical ways to understand and use MCP

2077. **[Serper-search-mcp](https://github.com/NightTrek/Serper-search-mcp)** - ⭐ 45
   Un-official Serper Google search server for Cline and other MCP clients

2078. **[mcpcat-python-sdk](https://github.com/MCPCat/mcpcat-python-sdk)** - ⭐ 45
   MCPcat is an analytics platform for MCP server owners 🐱.

2079. **[mcp-rdf-explorer](https://github.com/emekaokoye/mcp-rdf-explorer)** - ⭐ 45
...
2080. **[codex-mcp-go](https://github.com/w31r4/codex-mcp-go)** - ⭐ 45
...
2081. **[mcp-youtube](https://github.com/adhikasp/mcp-youtube)** - ⭐ 45
   Model Context Protocol to fetch youtube transcript

2082. **[sample-agentic-ai-web](https://github.com/aws-samples/sample-agentic-ai-web)** - ⭐ 45
...
2083. **[excalidraw-mcp](https://github.com/i-tozer/excalidraw-mcp)** - ⭐ 45
   Model Context Protocol (MCP) server for Excalidraw - Work in Progress

2084. **[calculator-mcp-server](https://github.com/huhabla/calculator-mcp-server)** - ⭐ 45
   A Model Context Protocol (MCP) server that provides Claude with advanced mathematical calculation capabilities

2085. **[marinade-finance-mcp-server](https://github.com/lorine93s/marinade-finance-mcp-server)** - ⭐ 45
   Marinade Finance MCP Server is an MCP server specifically designed for the Marinade Finance.

2086. **[mcp-server-atlassian-confluence](https://github.com/aashari/mcp-server-atlassian-confluence)** - ⭐ 45
   Node.js/TypeScript MCP server for Atlassian Confluence. Provides tools enabling AI systems (LLMs) to list/get spaces & pages (content formatted as Markdown) and search via CQL. Connects AI seamlessly to Confluence knowledge bases using the standard MCP interface.

2087. **[meme-mcp](https://github.com/haltakov/meme-mcp)** - ⭐ 45
   A simple Model Context Protocol (MCP) server for generating memes using the ImgFlip API

2088. **[modular-mcp](https://github.com/d-kimuson/modular-mcp)** - ⭐ 45
   A Model Context Protocol (MCP) proxy server that enables efficient management of large tool collections across multiple MCP servers by grouping them and loading tool schemas on-demand.

2089. **[vercel-ai-docs-mcp](https://github.com/IvanAmador/vercel-ai-docs-mcp)** - ⭐ 45
   A Model Context Protocol (MCP) server that provides AI-powered search and querying capabilities for the Vercel AI SDK documentation. This project enables developers to ask questions about the Vercel AI SDK and receive accurate, contextualized responses based on the official documentation.

2090. **[awesome-mcp-security](https://github.com/AIM-Intelligence/awesome-mcp-security)** - ⭐ 45
   Security Threats related with MCP (Model Context Protocol), MCP Servers and more

2091. **[semanticscholar-MCP-Server](https://github.com/JackKuo666/semanticscholar-MCP-Server)** - ⭐ 45
   🔍 This project implements a Model Context Protocol (MCP) server for interacting with the Semantic Scholar API. It provides tools for searching papers, retrieving paper and author details, and fetching citations and references.

2092. **[crawlbase-mcp](https://github.com/crawlbase/crawlbase-mcp)** - ⭐ 45
   Crawlbase MCP Server connects AI agents and LLMs with real-time web data. It powers Claude, Cursor, and Windsurf integrations with battle-tested web scraping, JavaScript rendering, and anti-bot protection enabling structured, live data inside your AI workflows.

2093. **[ai-humanizer-mcp-server](https://github.com/Text2Go/ai-humanizer-mcp-server)** - ⭐ 45
   A powerful Model Context Protocol (MCP) server that helps refine AI-generated content to sound more natural and human-like. Built with advanced AI detection and text enhancement capabilities.

2094. **[pprof-analyzer-mcp](https://github.com/ZephyrDeng/pprof-analyzer-mcp)** - ⭐ 44
   This is a Model Context Protocol (MCP) server implemented in Go, providing a tool to analyze Go pprof performance profiles.

2095. **[flightradar24-mcp-server](https://github.com/sunsetcoder/flightradar24-mcp-server)** - ⭐ 44
   Model Context Protocol server for Flight Tracking

2096. **[vue-mcp-next](https://github.com/tuskermanshu/vue-mcp-next)** - ⭐ 44
...
2097. **[mcp-starter-template](https://github.com/StevenStavrakis/mcp-starter-template)** - ⭐ 44
   An opinionated starter template for making Model Context Protocol (MCP) servers

2098. **[langchaingo-mcp-adapter](https://github.com/i2y/langchaingo-mcp-adapter)** - ⭐ 44
   A Go adapter that bridges LangChain Go tools with Model Context Protocol (MCP) servers.

2099. **[wechat-mcp](https://github.com/JettChenT/wechat-mcp)** - ⭐ 44
   Model Context Protocol for WeChat

2100. **[generic-mcp-client-chat](https://github.com/rom1504/generic-mcp-client-chat)** - ⭐ 44
   Generic MCP Client to use any MCP tool in a chat

2101. **[spring-ai-mcp-client](https://github.com/ogulcanarbc/spring-ai-mcp-client)** - ⭐ 44
...
2102. **[Claude-Project-Coordinator](https://github.com/M-Pineapple/Claude-Project-Coordinator)** - ⭐ 44
...
2103. **[thingspanel-mcp](https://github.com/ThingsPanel/thingspanel-mcp)** - ⭐ 44
...
2104. **[esa-mcp-server](https://github.com/esaio/esa-mcp-server)** - ⭐ 44
   esa.io の公式 MCP(Model Context Protocol)サーバー(STDIO Transport版)

2105. **[mcp-mail](https://github.com/shuakami/mcp-mail)** - ⭐ 44
   📧 MCP Mail Tool - AI-powered email management tool | 基于 MCP 的智能邮件管理工具

2106. **[dataproduct-mcp](https://github.com/entropy-data/dataproduct-mcp)** - ⭐ 44
...
2107. **[mealie-mcp-server](https://github.com/rldiao/mealie-mcp-server)** - ⭐ 44
   MCP server that exposes Mealie APIs to MCP clients such as Claude Desktop

2108. **[canvas-mcp](https://github.com/vishalsachdev/canvas-mcp)** - ⭐ 44
   A Model Context Protocol server to run locally and connect to a Canvas LMS 

2109. **[MCPP.Net](https://github.com/xuzeyu91/MCPP.Net)** - ⭐ 43
   Model Context Protocol Platform，统一管理你的MCP服务

2110. **[mcp-playground](https://github.com/Elkhn/mcp-playground)** - ⭐ 43
   A Streamlit-based chat app for LLMs with plug-and-play tool support via Model Context Protocol (MCP), powered by LangChain, LangGraph, and Docker.

2111. **[taskMaster-todoist-mcp](https://github.com/mingolladaniele/taskMaster-todoist-mcp)** - ⭐ 43
...
2112. **[LLaMa-MCP-Streamlit](https://github.com/Nikunj2003/LLaMa-MCP-Streamlit)** - ⭐ 43
   AI assistant built with Streamlit, NVIDIA NIM (LLaMa 3.3:70B) / Ollama, and Model Control Protocol (MCP).

2113. **[pdf-mcp](https://github.com/saury1120/pdf-mcp)** - ⭐ 43
   一个强大的 PDF 处理 MCP（Model Context Protocol）服务，提供全面的 PDF 文档分析功能

2114. **[mcp-agents-hub](https://github.com/mcp-agents-ai/mcp-agents-hub)** - ⭐ 43
   The open-source ecosystem for building, discovering, and deploying Model Context Protocol servers and clients.

2115. **[scaled-mcp](https://github.com/Traego/scaled-mcp)** - ⭐ 43
   ScaledMCP is a horizontally scalabled MCP and A2A Server. You know, for AI.

2116. **[mcp-servers-kagi](https://github.com/ac3xx/mcp-servers-kagi)** - ⭐ 43
   A Model Context Protocol server implementation for Kagi's API

2117. **[world_bank_mcp_server](https://github.com/anshumax/world_bank_mcp_server)** - ⭐ 43
   An implementation of the Model Context Protocol for the World Bank open data API

2118. **[bookstack-mcp-server](https://github.com/pnocera/bookstack-mcp-server)** - ⭐ 43
   A Model Context Protocol (MCP) server providing full access to BookStack's knowledge management capabilities

2119. **[mcp](https://github.com/getAlby/mcp)** - ⭐ 43
   Connect a bitcoin lightning wallet to your LLM using Nostr Wallet Connect and Model Context Protocol

2120. **[mcp-container-ts](https://github.com/Azure-Samples/mcp-container-ts)** - ⭐ 43
   This is a quick start guide that provides the basic building blocks to set up a remote Model Context Protocol (MCP) server using Azure Container Apps. The MCP server is built using Node.js and TypeScript, and it can be used to run various tools and services in a serverless environment.

2121. **[mcp-server-ledger](https://github.com/minhyeoky/mcp-server-ledger)** - ⭐ 43
   A Model Context Protocol server for interacting with Ledger CLI, a powerful double-entry accounting system. This server enables Large Language Models to query and analyze financial data through a standardized interface, making it easy for AI assistants to help with financial reporting, budget analysis, and accounting tasks.

2122. **[mcp-filter](https://github.com/pro-vi/mcp-filter)** - ⭐ 43
   A proxy MCP (Model Context Protocol) server that filters the upstream tool surface to just the tools you need.

2123. **[abaqus-mcp-server](https://github.com/jianzhichun/abaqus-mcp-server)** - ⭐ 43
...
2124. **[mcp](https://github.com/40ants/mcp)** - ⭐ 43
   40ANTS-MCP is a framework for building Model Context Protocol servers in Common Lisp

2125. **[attio-mcp-server](https://github.com/kesslerio/attio-mcp-server)** - ⭐ 43
   Attio Model Context Protocol (MCP) server implementation

2126. **[vikunja-mcp](https://github.com/democratize-technology/vikunja-mcp)** - ⭐ 43
   Model Context Protocol server for Vikunja task management. Enables AI assistants to interact with Vikunja instances via MCP.

2127. **[any2markdown](https://github.com/WW-AI-Lab/any2markdown)** - ⭐ 43
...
2128. **[mcp-graphql-schema](https://github.com/hannesj/mcp-graphql-schema)** - ⭐ 43
   GraphQL Schema Model Context Protocol Server

2129. **[openrpc-mcp-server](https://github.com/shanejonas/openrpc-mcp-server)** - ⭐ 43
   A Model Context Protocol (MCP) server that provides JSON-RPC functionality through OpenRPC.

2130. **[python-notebook-mcp](https://github.com/UsamaK98/python-notebook-mcp)** - ⭐ 43
   Lightweight Python Notebook MCP - Enable AI assistants to create, edit, and view Jupyter notebooks via Model Context Protocol

2131. **[beemcp](https://github.com/OkGoDoIt/beemcp)** - ⭐ 43
   BeeMCP: an unofficial Model Context Protocol (MCP) server that connects your Bee wearable lifelogger to AI via the Model Context Protocol

2132. **[godoctor](https://github.com/danicat/godoctor)** - ⭐ 43
   A Model Context Protocol server for Go developers

2133. **[godot-mcp](https://github.com/bradypp/godot-mcp)** - ⭐ 43
   A Model Context Protocol (MCP) server for interacting with the Godot game engine.

2134. **[rhinoMcpServer](https://github.com/always-tinkering/rhinoMcpServer)** - ⭐ 43
...
2135. **[solana-dev-mcp](https://github.com/solana-foundation/solana-dev-mcp)** - ⭐ 42
   Solana Model Context Protocol (MCP) Demo

2136. **[awesome-mcp-servers](https://github.com/mctrinh/awesome-mcp-servers)** - ⭐ 42
   A curated list of excellent Model Context Protocol (MCP) servers.

2137. **[mcp-openmsx](https://github.com/nataliapc/mcp-openmsx)** - ⭐ 42
...
2138. **[mcp-amadeus](https://github.com/donghyun-chae/mcp-amadeus)** - ⭐ 42
   Amadeus MCP(Model Context Protocol) Server

2139. **[MCPApp](https://github.com/tanaikech/MCPApp)** - ⭐ 42
   This text introduces the Model Context Protocol (MCP) for AI interaction, exploring Google Apps Script (GAS) as a server option. It shows feasibility with a sample but notes the lack of a GAS SDK, aiming to encourage understanding and development.

2140. **[mcp_server_filesystem](https://github.com/MarcusJellinghaus/mcp_server_filesystem)** - ⭐ 42
   MCP File System Server: A secure Model Context Protocol server that provides file operations for AI assistants. Enables Claude and other assistants to safely read, write, and list files in a designated project directory with robust path validation and security controls.

2141. **[devcontext](https://github.com/aiurda/devcontext)** - ⭐ 42
   DevContext is a cutting-edge Model Context Protocol (MCP) server designed to provide developers with continuous, project-centric context awareness. Unlike traditional context systems, DevContext continuously learns from and adapts to your development patterns and delivers highly relevant context providing a deeper understanding of your codebase.

2142. **[MCP-Airflow-API](https://github.com/call518/MCP-Airflow-API)** - ⭐ 42
...
2147. **[youtrack-mcp](https://github.com/devstroop/youtrack-mcp)** - ⭐ 42
   An MCP (Model Context Protocol) server that provides YouTrack REST API access to AI agents

2148. **[rust-analyzer-mcp](https://github.com/zeenix/rust-analyzer-mcp)** - ⭐ 42
   A Model Context Protocol (MCP) server that provides integration with rust-analyzer

2149. **[mcp-server](https://github.com/profullstack/mcp-server)** - ⭐ 41
   A generic, modular server for implementing the Model Context Protocol (MCP). 

2150. **[mcp-server-js](https://github.com/yepcode/mcp-server-js)** - ⭐ 41
...
2151. **[caldav-mcp](https://github.com/dominik1001/caldav-mcp)** - ⭐ 41
   A CalDAV client using Model Context Protocol (MCP) to expose calendar operations as tools for AI assistants.

2152. **[dynamic-shell-server](https://github.com/codelion/dynamic-shell-server)** - ⭐ 41
   Dynamic Shell Command MCP Server

2153. **[zig-mcp-server](https://github.com/openSVM/zig-mcp-server)** - ⭐ 41
   A Model Context Protocol (MCP) server that provides Zig language tooling, code analysis, and documentation access. This server enhances AI capabilities with Zig-specific functionality including code optimization, compute unit estimation, code generation, and best practices recommendations.

2154. **[kafka-mcp-server](https://github.com/tuannvm/kafka-mcp-server)** - ⭐ 41
   A Model Context Protocol (MCP) server for Apache Kafka implemented in Go, leveraging franz-go and mcp-go.

2155. **[prism-mcp-rs](https://github.com/prismworks-ai/prism-mcp-rs)** - ⭐ 41
   Enterprise-grade Rust implementation of Anthropic's MCP protocol

2156. **[mcp](https://github.com/Azure-Samples/mcp)** - ⭐ 41
...
2157. **[salesforce-mcp-server](https://github.com/kablewy/salesforce-mcp-server)** - ⭐ 41
   Model Context Protocol server for Salesforce REST API integration

2158. **[contentful-mcp-server](https://github.com/contentful/contentful-mcp-server)** - ⭐ 41
   MCP (Model Context Protocol) server for the Contentful Management API

2159. **[mcp-design-system-extractor](https://github.com/freema/mcp-design-system-extractor)** - ⭐ 41
   MCP (Model Context Protocol) server that enables AI assistants to interact with Storybook design systems. Extract component HTML, analyze styles, and help with design system adoption and refactoring.

2160. **[luma-mcp](https://github.com/JochenYang/luma-mcp)** - ⭐ 41
...
2161. **[repl-mcp](https://github.com/simm-is/repl-mcp)** - ⭐ 41
   Model Context Protocol Clojure support including REPL integration with development tools.

2162. **[mailgun-mcp-server](https://github.com/mailgun/mailgun-mcp-server)** - ⭐ 41
   Implementation of Model Context Protocol server for Mailgun APIs

2163. **[mcp-toolbox-sdk-go](https://github.com/googleapis/mcp-toolbox-sdk-go)** - ⭐ 41
   Go SDK for interacting with the MCP Toolbox for Databases.

2164. **[Claude-Deep-Research](https://github.com/mcherukara/Claude-Deep-Research)** - ⭐ 41
   An MCP (Model Context Protocol) server that enables comprehensive research capabilities for Claude

2165. **[mcp-logic](https://github.com/angrysky56/mcp-logic)** - ⭐ 41
...
2166. **[dify-mcp-server](https://github.com/AI-FE/dify-mcp-server)** - ⭐ 40
   A Model Context Protocol server for Dify

2167. **[mcp_rails_template](https://github.com/seuros/mcp_rails_template)** - ⭐ 40
   A minimal Rails API template for creating MCP (Model Context Protocol) servers with robust tool execution capabilities and examples.

2168. **[agentic-mcp-client](https://github.com/peakmojo/agentic-mcp-client)** - ⭐ 40
   A standalone agent runner that executes tasks using MCP (Model Context Protocol) tools via Anthropic Claude, AWS BedRock and OpenAI APIs. It enables AI agents to run autonomously in cloud environments and interact with various systems securely.

2169. **[nmap-mcp-server](https://github.com/PhialsBasement/nmap-mcp-server)** - ⭐ 40
   A Model Context Protocol (MCP) server that enables AI assistants to perform network scanning operations using NMAP

2170. **[pagerduty-mcp-server](https://github.com/PagerDuty/pagerduty-mcp-server)** - ⭐ 40
   PagerDuty's official local MCP (Model Context Protocol) server which provides tools to interact with your PagerDuty account directly from your MCP-enabled client.

2171. **[instagram-engagement-mcp](https://github.com/Bob-lance/instagram-engagement-mcp)** - ⭐ 40
...
2172. **[browser-use-mcp-client](https://github.com/Linzo99/browser-use-mcp-client)** - ⭐ 40
   A MCP client for browser-use

2173. **[mcp-zenml](https://github.com/zenml-io/mcp-zenml)** - ⭐ 40
   MCP server to connect an MCP client (Cursor, Claude Desktop etc) with your ZenML MLOps and LLMOps pipelines

2174. **[beanquery-mcp](https://github.com/vanto/beanquery-mcp)** - ⭐ 40
...
2175. **[mcp-shell](https://github.com/hdresearch/mcp-shell)** - ⭐ 40
   Execute a secure shell in Claude Desktop using the Model Context Protocol.

2176. **[shotgrid-mcp-server](https://github.com/loonghao/shotgrid-mcp-server)** - ⭐ 40
   A Model Context Protocol (MCP) server for Autodesk ShotGrid/Flow Production Tracking (FPT) with comprehensive CRUD operations and data management capabilities.

2177. **[mcp-ssh](https://github.com/AiondaDotCom/mcp-ssh)** - ⭐ 40
   A Model Context Protocol (MCP) server for managing and controlling SSH connections.

2178. **[osm-mcp](https://github.com/wiseman/osm-mcp)** - ⭐ 40
   Model Context Protocol server for OpenStreetMap data

2179. **[mcp-codestyle-server](https://github.com/itxaiohanglover/mcp-codestyle-server)** - ⭐ 40
...
2180. **[codebadger](https://github.com/Lekssays/codebadger)** - ⭐ 40
...
2181. **[mcp-server-tauri](https://github.com/hypothesi/mcp-server-tauri)** - ⭐ 40
   A Model Context Protocol (MCP) server and plugin for Tauri v2 development

2182. **[davinci-resolve-mcp](https://github.com/apvlv/davinci-resolve-mcp)** - ⭐ 40
   A Model Context Protocol (MCP) server for interacting with DaVinci Resolve and Fusion

2183. **[dotcom.chat](https://github.com/kamath/dotcom.chat)** - ⭐ 39
   A simple NextJS MCP client with sensible keybindings

2184. **[MCPollinations](https://github.com/pinkpixel-dev/MCPollinations)** - ⭐ 39
   A Model Context Protocol (MCP) server that enables AI assistants to generate images, text, and audio through the Pollinations APIs. Supports customizable parameters, image saving, and multiple model options.

2185. **[sharepoint-mcp](https://github.com/DEmodoriGatsuO/sharepoint-mcp)** - ⭐ 39
...
2186. **[mcp_code_analyzer](https://github.com/emiryasar/mcp_code_analyzer)** - ⭐ 39
   A Model Context Protocol (MCP) server implementation for comprehensive code analysis. This tool integrates with Claude Desktop to provide code analysis capabilities through natural language interactions.

2187. **[mcp-crypto-price](https://github.com/truss44/mcp-crypto-price)** - ⭐ 39
   A Model Context Protocol (MCP) server that provides real-time cryptocurrency analysis via CoinCap's API. Enables Claude and other MCP clients to fetch crypto prices, analyze market trends, and track historical data.

2188. **[mmcp](https://github.com/koki-develop/mmcp)** - ⭐ 39
   🛠️ Manage your MCP (Model Context Protocol) server definitions in one place and apply them to supported agents.

2189. **[mcp-desktop](https://github.com/http4k/mcp-desktop)** - ⭐ 39
   http4k MCP Desktop Client

2190. **[mcp-client-server-host-demo](https://github.com/danwritecode/mcp-client-server-host-demo)** - ⭐ 39
   A quick pokemon demo to showcase MCP server, client, and host

2191. **[mcp](https://github.com/kyopark2014/mcp)** - ⭐ 39
   It shows how to use model-context-protocol. 

2192. **[activitywatch-mcp-server](https://github.com/8bitgentleman/activitywatch-mcp-server)** - ⭐ 39
   Model Context Protocol server for ActivityWatch time tracking data

2193. **[openrouter-deep-research-mcp](https://github.com/wheattoast11/openrouter-deep-research-mcp)** - ⭐ 39
...
2194. **[mssql-mcp](https://github.com/daobataotie/mssql-mcp)** - ⭐ 39
   mssql mcp server

2195. **[mcp_ctl](https://github.com/runablehq/mcp_ctl)** - ⭐ 39
   A package manager to manage all your mcp servers across platforms

2196. **[algorand-mcp](https://github.com/GoPlausible/algorand-mcp)** - ⭐ 39
   Algorand Model Context Protocol (Server & Client)

2197. **[bsky-mcp-server](https://github.com/brianellin/bsky-mcp-server)** - ⭐ 39
   Bluesky MCP (Model Context Protocol) Server

2198. **[How-To-Create-MCP-Server](https://github.com/nisalgunawardhana/How-To-Create-MCP-Server)** - ⭐ 39
   This guide will help you set up a basic MCP (Model Context Protocol) server in .NET, configure it in VS Code, and interact with it using Copilot Chat.

2199. **[imap-mcp](https://github.com/non-dirty/imap-mcp)** - ⭐ 39
   IMAP Model Context Protocol server for interactive email processing

2200. **[langfuse-mcp](https://github.com/avivsinai/langfuse-mcp)** - ⭐ 39
   A Model Context Protocol (MCP) server for Langfuse, enabling AI agents to query Langfuse trace data for enhanced debugging and observability

2201. **[autoteam](https://github.com/diazoxide/autoteam)** - ⭐ 38
   Orchestrate AI agents with YAML-driven workflows via universal Model Context Protocol (MCP)

2202. **[middy-mcp](https://github.com/fredericbarthelet/middy-mcp)** - ⭐ 38
   Middy middleware for Model Context Protocol server hosting on AWS Lambda

2203. **[dev-to-mcp](https://github.com/nickytonline/dev-to-mcp)** - ⭐ 38
   A remote Model Context Protocol (MCP) server for interacting with the dev.to public API without requiring authentication.

2204. **[mcp-center](https://github.com/nautilus-ops/mcp-center)** - ⭐ 38
   A centralized platform for managing and connecting MCP servers. MCP Center provides a high-performance proxy service that enables seamless communication between MCP clients and multiple MCP servers.

2205. **[anki-mcp](https://github.com/nietus/anki-mcp)** - ⭐ 38
   MCP server for anki

2206. **[McpDotNet.Extensions.SemanticKernel](https://github.com/StefH/McpDotNet.Extensions.SemanticKernel)** - ⭐ 38
   Microsoft SemanticKernel integration for the Model Context Protocol (MCP). Enables seamless use of MCP tools as AI functions.

2207. **[okta-mcp-server](https://github.com/fctr-id/okta-mcp-server)** - ⭐ 38
   The Okta MCP Server is a groundbreaking tool built by the team at Fctr that enables AI models to interact directly with your Okta environment using the Model Context Protocol (MCP). Built specifically for IAM engineers, security teams, and Okta administrators, it implements the MCP specification to help work with Okta enitities

2208. **[grafana-mcp-analyzer](https://github.com/SailingCoder/grafana-mcp-analyzer)** - ⭐ 38
   让AI助手直接分析你的Grafana监控数据 - A Model Context Protocol server for Grafana data analysis

2209. **[mcp_weather_server](https://github.com/isdaniel/mcp_weather_server)** - ⭐ 38
   A Model Context Protocol (MCP) server that provides weather information using the Open-Meteo API.

2210. **[open-ghl-mcp](https://github.com/basicmachines-co/open-ghl-mcp)** - ⭐ 38
   An open source Model Context Protocol server for GoHighLevel API v2 with OAuth

2211. **[dynamic-fastmcp](https://github.com/ragieai/dynamic-fastmcp)** - ⭐ 38
...
2212. **[MCPToolBenchPP](https://github.com/mcp-tool-bench/MCPToolBenchPP)** - ⭐ 38
   MCPToolBench++ MCP Model Context Protocol Tool Use Benchmark on AI Agent and Model Tool Use Ability

2213. **[shodan-mcp-server](https://github.com/Cyreslab-AI/shodan-mcp-server)** - ⭐ 38
   A Model Context Protocol server that provides access to Shodan API functionality

2214. **[mcp-android-server-python](https://github.com/nim444/mcp-android-server-python)** - ⭐ 38
   MCP Android agent - This project provides an *MCP (Model Context Protocol)* server for automating Android devices using uiautomator2. It's designed to be easily plugged into AI agents like GitHub Copilot Chat, Claude, or Open Interpreter to control Android devices through natural language.

2215. **[discourse-mcp](https://github.com/discourse/discourse-mcp)** - ⭐ 38
   MCP client for Discourse sites

2216. **[binance-mcp-server](https://github.com/AnalyticAce/binance-mcp-server)** - ⭐ 38
...
2217. **[illustrator-mcp-server](https://github.com/spencerhhubert/illustrator-mcp-server)** - ⭐ 38
   mcp server to run scripts on adobe illustrator

2218. **[mcp-konnect](https://github.com/Kong/mcp-konnect)** - ⭐ 37
   A Model Context Protocol (MCP) server for interacting with Kong Konnect APIs, allowing AI assistants to query and analyze Kong Gateway configurations, traffic, and analytics.

2219. **[mcp-client-example](https://github.com/artemnovichkov/mcp-client-example)** - ⭐ 37
   Learn how to implement MCP client with SwiftUI and Anthropic API

2220. **[offeryn](https://github.com/avahowell/offeryn)** - ⭐ 37
   Build tools for LLMs in Rust using Model Context Protocol

2221. **[youtrack-mcp](https://github.com/itsalfredakku/youtrack-mcp)** - ⭐ 37
   An MCP (Model Context Protocol) server that provides YouTrack REST API access to AI agents

2222. **[ContextPods](https://github.com/conorluddy/ContextPods)** - ⭐ 37
   Model Context Protocol management suite/factory. An MCP that can generate and manage other local MCPs in multiple languages. Uses the official SDKs for code gen.

2223. **[mcp-sitecore-server](https://github.com/Antonytm/mcp-sitecore-server)** - ⭐ 37
   Model Context Protocol server for Sitecore

2224. **[solscan-mcp](https://github.com/wowinter13/solscan-mcp)** - ⭐ 37
   An MCP server for querying Solana transactions using natural language with Solscan API

2225. **[RedBook-Search-Comment-MCP](https://github.com/chenningling/RedBook-Search-Comment-MCP)** - ⭐ 37
   这是一款基于 Playwright 开发的小红书自动搜索和评论工具，作为 MCP Server，可通过特定配置接入 MCP Client，帮助用户自动完成登录小红书、搜索关键词、获取笔记内容及发布智能评论等操作。

2226. **[DeepCo](https://github.com/succlz123/DeepCo)** - ⭐ 37
   A Chat Client for LLMs, written in Compose Multiplatform.

2227. **[matlab-mcp](https://github.com/Tsuchijo/matlab-mcp)** - ⭐ 37
   Model Context Protocol server to let LLMs write and execute matlab scripts 

2228. **[nuclei-mcp](https://github.com/addcontent/nuclei-mcp)** - ⭐ 37
...
2229. **[mcp-summarization-functions](https://github.com/Braffolk/mcp-summarization-functions)** - ⭐ 37
   Provides summarised output from various actions that could otherwise eat up tokens and cause crashes for AI agents 

2230. **[HAL](https://github.com/DeanWard/HAL)** - ⭐ 37
   HAL (HTTP API Layer) is a Model Context Protocol (MCP) server that provides HTTP API capabilities to Large Language Models.

2231. **[mcp-server-ios-simulator](https://github.com/atom2ueki/mcp-server-ios-simulator)** - ⭐ 37
   Model Context Protocol (MCP) implementation for iOS simulators

2232. **[altium-mcp](https://github.com/coffeenmusic/altium-mcp)** - ⭐ 37
   Altium Model Context Protocol server and Altium API script

2233. **[mcp-pyautogui-server](https://github.com/hetaoBackend/mcp-pyautogui-server)** - ⭐ 37
   A MCP (Model Context Protocol) server that provides automated GUI testing and control capabilities through PyAutoGUI.

2234. **[mcp-tasks](https://github.com/flesler/mcp-tasks)** - ⭐ 37
   A comprehensive and efficient MCP server for task management with multi-format support (Markdown, JSON, YAML)

2235. **[webscraping-ai-mcp-server](https://github.com/webscraping-ai/webscraping-ai-mcp-server)** - ⭐ 37
    A Model Context Protocol (MCP) server implementation that integrates with WebScraping.AI for web data extraction capabilities.

2236. **[smythos-studio](https://github.com/SmythOS/smythos-studio)** - ⭐ 37
...
2237. **[openai-mcp](https://github.com/arthurcolle/openai-mcp)** - ⭐ 37
   OpenAI Code Assistant Model Context Protocol (MCP) Server

2238. **[dexpaprika-mcp](https://github.com/coinpaprika/dexpaprika-mcp)** - ⭐ 37
...
2239. **[p4mcp-server](https://github.com/perforce/p4mcp-server)** - ⭐ 37
...
2240. **[mcp-server-leetcode](https://github.com/doggybee/mcp-server-leetcode)** - ⭐ 36
...
2241. **[mcp-flight-search](https://github.com/arjunprabhulal/mcp-flight-search)** - ⭐ 36
   MCP Server implementation for the Model Context Protocol (MCP) enabling AI tool usage - Realtime Flight Search 

2242. **[mcp-go](https://github.com/riza-io/mcp-go)** - ⭐ 36
   Build Model Context Protocol (MCP) servers in Go

2243. **[Mcp.Net](https://github.com/SamFold/Mcp.Net)** - ⭐ 36
   A fully featured C# implementation of Anthropic's Model Context Protocol (MCP)

2244. **[baseline-mcp-server](https://github.com/yamanoku/baseline-mcp-server)** - ⭐ 36
   特定のWeb APIに関するBaselineの状況を提供するModel Context Protocolサーバー

2245. **[example-mcp-server](https://github.com/kirill-markin/example-mcp-server)** - ⭐ 36
   A ready-to-use MCP (Model Context Protocol) server template for extending Cursor IDE with custom tools. Deploy your own server to Heroku with one click, create custom commands, and enhance your Cursor IDE experience. Perfect for developers who want to add their own tools and commands to Cursor IDE without complex setup.

2246. **[mcp-governance-sdk](https://github.com/ithena-one/mcp-governance-sdk)** - ⭐ 36
   Enterprise Governance Layer (Identity, RBAC, Credentials, Auditing, Logging, Tracing) for the Model Context Protocol SDK

2247. **[mcpmc](https://github.com/gerred/mcpmc)** - ⭐ 36
   Model Context Protocol Minecraft Server

2248. **[OmniMind](https://github.com/Techiral/OmniMind)** - ⭐ 36
...
2249. **[fast-filesystem-mcp](https://github.com/efforthye/fast-filesystem-mcp)** - ⭐ 36
   A high-performance Model Context Protocol (MCP) server that provides secure filesystem access for Claude and other AI assistants.

2250. **[flutter-mcp-ai-chat](https://github.com/leehack/flutter-mcp-ai-chat)** - ⭐ 36
   Demonstrate how to implement MCP Client in Flutter application with AI.

2251. **[FastDomainCheck-MCP-Server](https://github.com/bingal/FastDomainCheck-MCP-Server)** - ⭐ 36
   A Model Context Protocol for checking domain name registration status in bulk.

2252. **[mcp-debug](https://github.com/giantswarm/mcp-debug)** - ⭐ 36

2253. **[mlb-api-mcp](https://github.com/guillochon/mlb-api-mcp)** - ⭐ 36
...
2254. **[code-mcp](https://github.com/54yyyu/code-mcp)** - ⭐ 36
...
2255. **[mcp-anywhere](https://github.com/locomotive-agency/mcp-anywhere)** - ⭐ 36
...
2256. **[mcp-gemini-server](https://github.com/bsmi021/mcp-gemini-server)** - ⭐ 36
   This project provides a dedicated MCP (Model Context Protocol) server that wraps the @google/genai SDK. It exposes Google's Gemini model capabilities as standard MCP tools, allowing other LLMs (like Cline) or MCP-compatible systems to leverage Gemini's features as a backend workhorse.

2257. **[keycloak-model-context-protocol](https://github.com/ChristophEnglisch/keycloak-model-context-protocol)** - ⭐ 36
...
2258. **[MCPNotes](https://github.com/9Ninety/MCPNotes)** - ⭐ 36
   A simple note-taking MCP server for recording and managing notes with AI models.

2259. **[ai-vision-mcp](https://github.com/tan-yong-sheng/ai-vision-mcp)** - ⭐ 36
   A Model Context Protocol (MCP) server that provides vision capabilities to analyze image and video

2260. **[MCP-Server-Creator](https://github.com/GongRzhe/MCP-Server-Creator)** - ⭐ 36
...
2261. **[MayaMCP](https://github.com/PatrickPalmer/MayaMCP)** - ⭐ 36
   Model Context Protocol (MCP) server implementation for Autodesk Maya

2262. **[esa-mcp-server](https://github.com/d-kimuson/esa-mcp-server)** - ⭐ 35
   esa の Model Context Protocol サーバー実装

2263. **[mcp-langchain-ts-client](https://github.com/isaacwasserman/mcp-langchain-ts-client)** - ⭐ 35
   LangChain.js client for Model Context Protocol.

2264. **[linkedin-mcp-server](https://github.com/Dishant27/linkedin-mcp-server)** - ⭐ 35
   Model Context Protocol (MCP) server for LinkedIn API integration

2265. **[mcp-gateway](https://github.com/theognis1002/mcp-gateway)** - ⭐ 35
...
2266. **[mcp-toolkit](https://github.com/metosin/mcp-toolkit)** - ⭐ 35
   a lib to build MCP clients and MCP servers in Clojure(script)

2267. **[tomtom-mcp](https://github.com/tomtom-international/tomtom-mcp)** - ⭐ 35
   A Model Context Protocol (MCP) server providing TomTom's location services, search, routing, and traffic data to AI agents.

2268. **[lunchmoney-mcp](https://github.com/akutishevsky/lunchmoney-mcp)** - ⭐ 35
...
2269. **[mcp-mistral-ocr](https://github.com/everaldo/mcp-mistral-ocr)** - ⭐ 35
   Model Context Protocol (MCP) Server for Mistral OCR API

2270. **[codebase-mcp](https://github.com/danyQe/codebase-mcp)** - ⭐ 35
...
2271. **[agent-mcp-gateway](https://github.com/roddutra/agent-mcp-gateway)** - ⭐ 35
...
2272. **[mcp-bundle](https://github.com/symfony/mcp-bundle)** - ⭐ 35
   Symfony integration bundle for Model Context Protocol (via official mcp/sdk)

2273. **[FastAPI-BitNet](https://github.com/grctest/FastAPI-BitNet)** - ⭐ 35
   Running Microsoft's BitNet inference framework via FastAPI, Uvicorn and Docker.

2274. **[teams-mcp](https://github.com/floriscornel/teams-mcp)** - ⭐ 35
...
2275. **[mcp-databricks-server](https://github.com/RafaelCartenet/mcp-databricks-server)** - ⭐ 35
...
2276. **[mcp-wikidata](https://github.com/zzaebok/mcp-wikidata)** - ⭐ 35
   A server implementation for Wikidata API using the Model Context Protocol (MCP).

2277. **[Readwise-Reader-MCP](https://github.com/edricgsh/Readwise-Reader-MCP)** - ⭐ 35
   A Model Context Protocol (MCP) server for the Readwise Reader API, built with TypeScript and the official Claude SDK.

2278. **[mcp-front](https://github.com/stainless-api/mcp-front)** - ⭐ 35
   Auth proxy for Model Context Protocol servers - adds authentication to MCP tools for Claude.ai, Claude Code, Cursor, Gemini

2279. **[Scientific-Papers-MCP](https://github.com/benedict2310/Scientific-Papers-MCP)** - ⭐ 35
...
2280. **[mcp-file-context-server](https://github.com/bsmi021/mcp-file-context-server)** - ⭐ 34
   A Model Context Protocol (MCP) server that provides file system context to Large Language Models (LLMs). This server enables LLMs to read, search, and analyze code files with advanced caching and real-time file watching capabilities.

2281. **[mcp-security-inspector](https://github.com/purpleroc/mcp-security-inspector)** - ⭐ 34
   一个用于检测Model Context Protocol (MCP)安全性的Chrome扩展工具。

2282. **[mcp-client-auth](https://github.com/dzhng/mcp-client-auth)** - ⭐ 34
...
2283. **[salesforce-mcp-server](https://github.com/jaworjar95/salesforce-mcp-server)** - ⭐ 34
   A comprehensive Model Context Protocol (MCP) server that provides seamless Salesforce integration for AI development tools like Claude Desktop, Cline, and other MCP-compatible clients.

2284. **[coin_api_mcp](https://github.com/longmans/coin_api_mcp)** - ⭐ 34
   A Model Context Protocol server that provides access to CoinMarketCap's cryptocurrency data. This server enables AI-powered applications to retrieve cryptocurrency listings, quotes, and detailed information about various coins.

2285. **[mcp-accessibility-scanner](https://github.com/JustasMonkev/mcp-accessibility-scanner)** - ⭐ 34
   An MCP (Model Context Protocol) server for performing accessibility audits on webpages using axe-core.

2286. **[MCPSwiftWrapper](https://github.com/jamesrochabrun/MCPSwiftWrapper)** - ⭐ 34
   A light wrapper around mcp-swift-sdk for easy usage of MCP clients in Swift

2287. **[metabase-mcp](https://github.com/jerichosequitin/metabase-mcp)** - ⭐ 34
...
2288. **[chat-nextjs-mcp-client](https://github.com/shricodev/chat-nextjs-mcp-client)** - ⭐ 34
   ⚡ Chat MCP Client for Remote hosted MCP Servers (with Composio) and locally hosted MCP servers. 📡

2289. **[RiMCP_hybrid](https://github.com/h7lu/RiMCP_hybrid)** - ⭐ 34
   Rimworld Coding RAG MCP server

2290. **[mcp-starter](https://github.com/instructa/mcp-starter)** - ⭐ 34
   A super simple Starter to build your own MCP Server

2291. **[mcp-server-opendal](https://github.com/Xuanwo/mcp-server-opendal)** - ⭐ 34
   Model Context Protocol Server for Apache OpenDAL™

2292. **[meta-prompt-mcp-server](https://github.com/tisu19021997/meta-prompt-mcp-server)** - ⭐ 34
   Turn any MCP Client into a "multi-agent" system (via prompting)

2293. **[aio-mcp](https://github.com/athapong/aio-mcp)** - ⭐ 34
...
2294. **[tinyagent](https://github.com/askbudi/tinyagent)** - ⭐ 34
   Tiny Agent: Production-Ready LLM Agent SDK for Every Developer

2295. **[llm-tools-mcp](https://github.com/VirtusLab/llm-tools-mcp)** - ⭐ 34
   Connect to MCP servers right from your shell. Plugin for simonw/llm.

2296. **[pentestMCP](https://github.com/ramkansal/pentestMCP)** - ⭐ 34
   pentestMCP: AI-Powered Penetration Testing via MCP, an MCP designed for penetration testers.

2297. **[thoughtbox](https://github.com/Kastalien-Research/thoughtbox)** - ⭐ 34
...
2298. **[macOS-Notification-MCP](https://github.com/devizor/macOS-Notification-MCP)** - ⭐ 34
...
2299. **[linkedin-mcpserver](https://github.com/felipfr/linkedin-mcpserver)** - ⭐ 33
   A powerful Model Context Protocol server for LinkedIn API integration

2300. **[adk-python-mcp-client](https://github.com/arjunprabhulal/adk-python-mcp-client)** - ⭐ 33
   Demo of ADK (Agent Development Kit) as an MCP (Model Context Protocol) client for flight search capabilities.

2301. **[mcp-scala](https://github.com/windymelt/mcp-scala)** - ⭐ 33
   Model Context Protocol server written in Scala

2302. **[prometheus_mcp_server](https://github.com/CaesarYangs/prometheus_mcp_server)** - ⭐ 33
...
2303. **[mcp-google-calendar](https://github.com/markelaugust74/mcp-google-calendar)** - ⭐ 33
...
2304. **[mcp-prompt-server-go](https://github.com/smallnest/mcp-prompt-server-go)** - ⭐ 33
...
2305. **[jina-mcp-tools](https://github.com/PsychArch/jina-mcp-tools)** - ⭐ 33
   A Model Context Protocol (MCP) server that integrates with Jina AI Search Foundation APIs.

2306. **[a11y-mcp](https://github.com/priyankark/a11y-mcp)** - ⭐ 33
   An MCP (Model Context Protocol) server for performing accessibility audits on webpages using axe-core. Use the results in an agentic loop with your favorite AI assistants (Amp/Cline/Cursor/GH Copilot) and let them fix a11y issues for you!

2307. **[mcp-registry](https://github.com/ARadRareness/mcp-registry)** - ⭐ 33
   A central registry and HTTP interface for coordinating Model Context Protocol (MCP) servers.

2308. **[Outlook_Calendar_MCP](https://github.com/merajmehrabi/Outlook_Calendar_MCP)** - ⭐ 33
   A Model Context Protocol (MCP) server that allows Claude to access and manage your local Microsfot Outlook calendar (Windows only).

2309. **[mcp-server-text-editor](https://github.com/bhouston/mcp-server-text-editor)** - ⭐ 33
   An open source implementation of the Claude built-in text editor tool

2310. **[claude-code-mcp](https://github.com/KunihiroS/claude-code-mcp)** - ⭐ 33
   MCP Server connects with claude code local command.

2311. **[postman-mcp](https://github.com/SalehKhatri/postman-mcp)** - ⭐ 33
...
2312. **[McpToolkit](https://github.com/nuskey8/McpToolkit)** - ⭐ 33
   Lightweight, fast, NativeAOT compatible MCP (Model Context Protocol) framework for .NET

2313. **[mcp-api-gateway](https://github.com/rflpazini/mcp-api-gateway)** - ⭐ 33
   A universal MCP (Model Context Protocol) server to integrate any API with Claude Desktop using only Docker configurations.

2314. **[mcp-ssh-manager](https://github.com/bvisible/mcp-ssh-manager)** - ⭐ 33
...
2315. **[firefox-devtools-mcp](https://github.com/freema/firefox-devtools-mcp)** - ⭐ 33
   Model Context Protocol server for Firefox DevTools - enables AI assistants to inspect and control Firefox browser through the Remote Debugging Protocol

2316. **[reaper-reapy-mcp](https://github.com/wegitor/reaper-reapy-mcp)** - ⭐ 33
...
2317. **[wezterm-mcp](https://github.com/hiraishikentaro/wezterm-mcp)** - ⭐ 32
   About A Model Context Protocol server that executes commands in the current WezTerm session

2318. **[mcp-nats](https://github.com/sinadarbouy/mcp-nats)** - ⭐ 32
   A Model Context Protocol (MCP) server for NATS messaging system integration

2319. **[zilliz-mcp-server](https://github.com/zilliztech/zilliz-mcp-server)** - ⭐ 32
...
2320. **[azure-functions-mcp-extension](https://github.com/Azure/azure-functions-mcp-extension)** - ⭐ 32
   Model Context Protocol extension for Azure Functions.

2321. **[mentor-mcp-server](https://github.com/cyanheads/mentor-mcp-server)** - ⭐ 32
...
2322. **[laravel-mcp-client](https://github.com/scriptoshi/laravel-mcp-client)** - ⭐ 32

2323. **[crawl-mcp](https://github.com/wutongci/crawl-mcp)** - ⭐ 32
   完整的微信文章抓取MCP服务器 - 基于Model Context Protocol (MCP)的智能网页抓取工具，专为Cursor IDE和AI工具设计。

2324. **[mcp-domain-availability](https://github.com/imprvhub/mcp-domain-availability)** - ⭐ 32
   A Model Context Protocol (MCP) server that enables Claude Desktop to check domain availability across 50+ TLDs. Features DNS/WHOIS verification, bulk checking, and smart suggestions. Zero-clone installation via uvx.

2325. **[claude-mcp](https://github.com/cnych/claude-mcp)** - ⭐ 32
   Claude Unified Model Context Interaction Protocol

2326. **[fantasy-football-mcp-public](https://github.com/derekrbreese/fantasy-football-mcp-public)** - ⭐ 32
...
2327. **[evernote-mcp-server](https://github.com/brentmid/evernote-mcp-server)** - ⭐ 32
   Evernote MCP server - allows LLMs that support MCP (like Claude Desktop) to query your notes in Evernote

2328. **[twenty-crm-mcp-server](https://github.com/mhenry3164/twenty-crm-mcp-server)** - ⭐ 32
...
2329. **[sunnysideFigma-Context-MCP](https://github.com/tercumantanumut/sunnysideFigma-Context-MCP)** - ⭐ 32
...
2330. **[openbim-mcp](https://github.com/helenkwok/openbim-mcp)** - ⭐ 32
   Model Context Protocol (MCP) server for openBIM

2331. **[openscad-mcp](https://github.com/quellant/openscad-mcp)** - ⭐ 32
   A Model Context Protocol (MCP) server for OpenSCAD 3D modeling and rendering

2332. **[mcp-browser-agent](https://github.com/imprvhub/mcp-browser-agent)** - ⭐ 32
   A Model Context Protocol (MCP) integration that provides Claude Desktop with autonomous browser automation capabilities. This agent enables Claude to interact with web content, manipulate DOM elements, execute JavaScript, and perform API requests.

2333. **[filesystem-mcp-server](https://github.com/cyanheads/filesystem-mcp-server)** - ⭐ 32
   A Model Context Protocol (MCP) server for platform-agnostic file capabilities, including advanced search/replace and directory tree traversal

2334. **[mcp-sync](https://github.com/ztripez/mcp-sync)** - ⭐ 32
   Sync MCP (Model Context Protocol) configurations across AI tools

2335. **[PixVerse-MCP](https://github.com/PixVerseAI/PixVerse-MCP)** - ⭐ 31
   Official PixVerse Model Context Protocol (MCP) server that enables interaction with powerful AI video generation APIs.

2336. **[mcp-server-weibo](https://github.com/Selenium39/mcp-server-weibo)** - ⭐ 31
   Model Context Protocol服务器，用于抓取微博用户信息、动态和搜索功能

2337. **[MCPDocSearch](https://github.com/alizdavoodi/MCPDocSearch)** - ⭐ 31
...
2338. **[simple-psql-mcp](https://github.com/NetanelBollag/simple-psql-mcp)** - ⭐ 31
...
2339. **[storyblok-mcp-server](https://github.com/Kiran1689/storyblok-mcp-server)** - ⭐ 31
...
2340. **[MCPCorpus](https://github.com/Snakinya/MCPCorpus)** - ⭐ 31
...
2341. **[seatunnel-mcp](https://github.com/ocean-zhc/seatunnel-mcp)** - ⭐ 31
...
2342. **[lets-learn-mcp-java](https://github.com/microsoft/lets-learn-mcp-java)** - ⭐ 31
   Learn how to build Java-based MCP Servers and Clients with LangChain4J and Quarkus

2343. **[mcp-server-lib.el](https://github.com/laurynas-biveinis/mcp-server-lib.el)** - ⭐ 31
   Emacs Lisp implementation of the Model Context Protocol

2344. **[azure-container-apps-ai-mcp](https://github.com/Azure-Samples/azure-container-apps-ai-mcp)** - ⭐ 31
...
2345. **[mcp-weather](https://github.com/TimLukaHorstmann/mcp-weather)** - ⭐ 31
   A Model Context Protocol (MCP) server that provides hourly and daily weather forecasts using the AccuWeather API.

2346. **[mcp_server](https://github.com/peppemas/mcp_server)** - ⭐ 31
   A C++ implementation of a Model Context Protocol Server with a pluggable module architecture.

2347. **[mcp-google-cse](https://github.com/Richard-Weiss/mcp-google-cse)** - ⭐ 31
   A Model Context Protocol server that provides search capabilities using a Google CSE (custom search engine).

2348. **[org-mcp](https://github.com/laurynas-biveinis/org-mcp)** - ⭐ 31
   Emacs Org-mode integration with Model Context Protocol (MCP) for AI-assisted task management

2349. **[PubChem-MCP-Server](https://github.com/Augmented-Nature/PubChem-MCP-Server)** - ⭐ 31
   A comprehensive Model Context Protocol (MCP) server for accessing the PubChem chemical database. This server provides access to over 110 million chemical compounds with extensive molecular properties, bioassay data, and chemical informatics tools.

2350. **[mcpc](https://github.com/OlaHulleberg/mcpc)** - ⭐ 31
...
2351. **[nostr-mcp-server](https://github.com/AustinKelsay/nostr-mcp-server)** - ⭐ 31
   A Model Context Protocol (MCP) server that provides Nostr capabilities to AI agents

2352. **[mcp-wasm](https://github.com/beekmarks/mcp-wasm)** - ⭐ 31
   A proof-of-concept implementation of a Model Context Protocol (MCP) server that runs in WebAssembly (WASM) within a web browser. This project demonstrates the integration of MCP tools and resources in a browser environment.

2353. **[React-Native-MCP](https://github.com/MrNitro360/React-Native-MCP)** - ⭐ 31
...
2354. **[authenticator_mcp](https://github.com/firstorderai/authenticator_mcp)** - ⭐ 31
   A secure MCP (Model Context Protocol) server that enables AI agents to interact with the Authenticator App.

2355. **[Smart-Thinking](https://github.com/Leghis/Smart-Thinking)** - ⭐ 31
   Smart-Thinking is a Model Context Protocol (MCP) server that delivers graph-based, multi-step reasoning without relying on external AI APIs. Everything happens locally: similarity search, heuristic-based scoring, verification tracking, memory, and visualization all run in a deterministic pipeline designed for transparency and reproducibility.

2356. **[AlphaFold-MCP-Server](https://github.com/Augmented-Nature/AlphaFold-MCP-Server)** - ⭐ 31
   A comprehensive Model Context Protocol (MCP) server that provides access to the AlphaFold Protein Structure Database through a rich set of tools and resources for protein structure prediction analysis.

2357. **[mcp-googletasks](https://github.com/arpitbatra123/mcp-googletasks)** - ⭐ 31
...
2358. **[PRD-MCP-Server](https://github.com/Saml1211/PRD-MCP-Server)** - ⭐ 31
   Flagship Model Context Protocol server for generating Product Requirement Documents (PRDs) from codebase context.

2359. **[keynote-mcp](https://github.com/easychen/keynote-mcp)** - ⭐ 31
   A Model Context Protocol (MCP) server that enables AI assistants to control Keynote presentations through AppleScript automation.

2360. **[awesome-blockchain-mcps](https://github.com/royyannick/awesome-blockchain-mcps)** - ⭐ 31
...
2361. **[mcp-zap-server](https://github.com/dtkmn/mcp-zap-server)** - ⭐ 31
   A Spring Boot application exposing OWASP ZAP as an MCP (Model Context Protocol) server. It lets any MCP‑compatible AI agent (e.g., Claude Desktop, Cursor) orchestrate ZAP actions—spider, active scan, import OpenAPI specs, and generate reports.

2362. **[keycloak-mcp-server](https://github.com/sshaaf/keycloak-mcp-server)** - ⭐ 31
...
2363. **[awesome-devops-mcp](https://github.com/agenticdevops/awesome-devops-mcp)** - ⭐ 31
   List of Awesome MCP Servers and Clients for building Agentic Devops 

2364. **[mcp-tool-filter](https://github.com/Portkey-AI/mcp-tool-filter)** - ⭐ 31
...
2365. **[mermaid-mcp](https://github.com/Narasimhaponnada/mermaid-mcp)** - ⭐ 31

2366. **[mcp-aoai-web-browsing](https://github.com/kimtth/mcp-aoai-web-browsing)** - ⭐ 30
   A minimal Model Context Protocol 🖥️ server/client🧑‍💻with Azure OpenAI and 🌐 web browser control via Playwright.

2367. **[pan-mcp-relay](https://github.com/PaloAltoNetworks/pan-mcp-relay)** - ⭐ 30
   Palo Alto Networks AI Runtime Security Model Context Protocol (MCP) Relay Server

2368. **[chatwork-mcp-server](https://github.com/chatwork/chatwork-mcp-server)** - ⭐ 30
   ChatworkをAIから操作するためのMCP(Model Context Protocol)サーバー

2369. **[dev-kit](https://github.com/nguyenvanduocit/dev-kit)** - ⭐ 30
   [Model Context Protocol] Dev Kit - anything a developer need for him day to day works

2370. **[midi-mcp-server](https://github.com/tubone24/midi-mcp-server)** - ⭐ 30
...
2371. **[EU_AI_ACT_MCP](https://github.com/SonnyLabs/EU_AI_ACT_MCP)** - ⭐ 30
   EU AI Act MCP (Model Context Protocol) that connects to your AI agents, helping you to comply with the EU AI Act.

2372. **[hana-mcp-server](https://github.com/HatriGt/hana-mcp-server)** - ⭐ 30
   Model Context Server Protocol for your HANA DB

2373. **[clap-mcp](https://github.com/gakonst/clap-mcp)** - ⭐ 30
   A Rust framework that bridges clap command-line applications with the Model Context Protocol (MCP)

2374. **[demo-mcp-server-client-implementation](https://github.com/mschwarzmueller/demo-mcp-server-client-implementation)** - ⭐ 30
   A demo implementation of a MCP server (consuming a dummy API) and basic client.

2375. **[zerodha-mcp](https://github.com/mtwn105/zerodha-mcp)** - ⭐ 30
   Zerodha MCP Server & Client - AI Agent (w/Agno & w/Google ADK)

2376. **[mcp-ollama](https://github.com/emgeee/mcp-ollama)** - ⭐ 30
   Query model running with Ollama from within Claude Desktop or other MCP clients

2377. **[mcp-client](https://github.com/edanyal/mcp-client)** - ⭐ 30
   Typescript mcp client library.

2378. **[postmancer](https://github.com/hijaz/postmancer)** - ⭐ 30
   An experimental MCP server Rest Client intended to be a replacement of tools postman & insomnia

2379. **[apisix-mcp](https://github.com/api7/apisix-mcp)** - ⭐ 30
   APISIX Model Context Protocol (MCP) server is used to bridge large language models (LLMs) with the APISIX Admin API.

2380. **[polymarket-mcp](https://github.com/ozgureyilmaz/polymarket-mcp)** - ⭐ 30
...
2381. **[mcp-inception](https://github.com/tanevanwifferen/mcp-inception)** - ⭐ 30
   Call another MCP client from your MCP client. Offload context windows, delegate tasks, split between models

2382. **[n8n-mcp](https://github.com/vredrick/n8n-mcp)** - ⭐ 30
   n8n MCP Server - Documentation and tools for n8n nodes via Model Context Protocol with SSE support

2383. **[mcp-java-sdk-examples](https://github.com/thought2code/mcp-java-sdk-examples)** - ⭐ 30
   A collection of MCP server examples developed by various Java SDKs

2384. **[mcp-cyclops](https://github.com/cyclops-ui/mcp-cyclops)** - ⭐ 30
   Model Context Protocol server for Cyclops

2385. **[SUMO-MCP-Server](https://github.com/XRDS76354/SUMO-MCP-Server)** - ⭐ 30
...
2386. **[dap_mcp](https://github.com/KashunCheng/dap_mcp)** - ⭐ 30
   Model Context Protocol (MCP) server that interacts with a Debugger

2387. **[reaper-mcp](https://github.com/itsuzef/reaper-mcp)** - ⭐ 30
   A comprehensive Model Context Protocol (MCP) server that enables AI agents to create fully mixed and mastered tracks in REAPER with both MIDI and audio capabilities.

2388. **[univer-mcp](https://github.com/dream-num/univer-mcp)** - ⭐ 30
   AI-powered spreadsheet automation through Model Context Protocol (MCP) server for Univer

2389. **[memcord](https://github.com/ukkit/memcord)** - ⭐ 30
   🧠 Privacy-first MCP server for AI memory management. Save, search & organize chat history with intelligent  summarization.

2390. **[adb-mcp](https://github.com/srmorete/adb-mcp)** - ⭐ 30
   An MCP (Model Context Protocol) server for interacting with Android devices through ADB in TypeScript.

2391. **[mcp-hacker-news](https://github.com/paabloLC/mcp-hacker-news)** - ⭐ 30
...
2392. **[nvim-mcp](https://github.com/linw1995/nvim-mcp)** - ⭐ 30
...
2393. **[mcp-appium-gestures](https://github.com/AppiumTestDistribution/mcp-appium-gestures)** - ⭐ 30
   This is a Model Context Protocol (MCP) server providing resources and tools for Appium mobile gestures using Actions API..

2394. **[mcp-for-security-python](https://github.com/f1tz/mcp-for-security-python)** - ⭐ 30
...
2395. **[searxng-mcp](https://github.com/tisDDM/searxng-mcp)** - ⭐ 30
...
2396. **[metabase-mcp](https://github.com/hluaguo/metabase-mcp)** - ⭐ 30
...
2397. **[MCP-Server-Starter](https://github.com/TheSethRose/MCP-Server-Starter)** - ⭐ 29
   A Model Context Protocol server starter template

2398. **[mcp-server-dumplingai](https://github.com/DumplingAI/mcp-server-dumplingai)** - ⭐ 29
   MCP (Model Context Protocol) server for Dumpling AI

2399. **[mcp-badges](https://github.com/mcpx-dev/mcp-badges)** - ⭐ 29
   Get your projects MCP (Model Context Protocol)  badges

2400. **[mcp-attr](https://github.com/frozenlib/mcp-attr)** - ⭐ 29
   A library for declaratively building Model Context Protocol servers.

2401. **[rails-pg-extras-mcp](https://github.com/pawurb/rails-pg-extras-mcp)** - ⭐ 29
   MCP (Model Context Protocol) LLM interface for rails-pg-extras gem

2402. **[maven-mcp-server](https://github.com/Bigsy/maven-mcp-server)** - ⭐ 29
   An MCP (Model Context Protocol) server that provides tools for checking Maven dependency versions.

2403. **[browserai-mcp](https://github.com/brightdata/browserai-mcp)** - ⭐ 29
   A powerful Model Context Protocol (MCP) server that provides an access to serverless browser for AI agents and apps

2404. **[luke-desktop](https://github.com/DrJonBrock/luke-desktop)** - ⭐ 29
   A modern desktop client for Claude AI with MCP server support, built with Tauri, React, and TypeScript.

2405. **[xmind-generator-mcp](https://github.com/BangyiZhang/xmind-generator-mcp)** - ⭐ 29
   An MCP (Model Context Protocol) server for generating Xmind mind maps. This server allows LLMs to create structured mind maps through the MCP protocol.

2406. **[phonepi-mcp](https://github.com/priyankark/phonepi-mcp)** - ⭐ 29
...
2407. **[actor-critic-thinking-mcp](https://github.com/aquarius-wing/actor-critic-thinking-mcp)** - ⭐ 29
   A dual-perspective thinking analysis server based on Model Context Protocol (MCP), providing comprehensive performance evaluation through Actor-Critic methodology.

2408. **[cca-mcp-configurator](https://github.com/doggy8088/cca-mcp-configurator)** - ⭐ 29
   一個簡單易用的網頁工具，用於管理 GitHub Copilot 的 MCP (Model Context Protocol) 設定

2409. **[rod-mcp](https://github.com/go-rod/rod-mcp)** - ⭐ 29
   Model Context Protocol Server of Rod

2410. **[NetContextServer](https://github.com/willibrandon/NetContextServer)** - ⭐ 29
   A .NET implementation of the Model Context Protocol enabling AI assistants to explore and understand .NET codebases.

2411. **[openai-mcp-agent-dotnet](https://github.com/Azure-Samples/openai-mcp-agent-dotnet)** - ⭐ 29
   Sample to create an AI Agent using OpenAI models with any MCP server running on Azure Container Apps

2412. **[modao-proto-mcp](https://github.com/modao-dev/modao-proto-mcp)** - ⭐ 29
...
2413. **[mcp-server-weibo](https://github.com/qinyuanpei/mcp-server-weibo)** - ⭐ 29
   基于 Model Context Protocol 的微博数据接口服务器 - 实时获取微博用户信息、动态内容、热搜榜单、粉丝关注数据。支持用户搜索、内容搜索、话题分析，为 AI 应用提供完整的微博数据接入方案。

2414. **[dockashell](https://github.com/anzax/dockashell)** - ⭐ 29
...
2415. **[MCP-Scanner](https://github.com/knostic/MCP-Scanner)** - ⭐ 29
...
2420. **[Volatility-MCP-Server](https://github.com/bornpresident/Volatility-MCP-Server)** - ⭐ 28
   A Model Context Protocol (MCP) server that integrates Volatility 3 memory forensics framework with Claude

2421. **[sketchfab-mcp-server](https://github.com/gregkop/sketchfab-mcp-server)** - ⭐ 28
   This is an MCP (Model Context Protocol) Server for discovering and downloading 3D models 

2422. **[mcp-testing-framework](https://github.com/L-Qun/mcp-testing-framework)** - ⭐ 28
   Testing framework for Model Context Protocol (MCP)

2423. **[laravel-mcp-sdk](https://github.com/mohamedahmed01/laravel-mcp-sdk)** - ⭐ 28
   Laravel Based Implementation for Model Context Protocol

2424. **[mcp-websocket](https://github.com/virajsharma2000/mcp-websocket)** - ⭐ 28
   This server implements an MCP (Model Context Protocol) server with WebSocket enhancements for real-time data updates.

2425. **[mcp_autogen_sse_stdio](https://github.com/SaM-92/mcp_autogen_sse_stdio)** - ⭐ 28
   This repository demonstrates how to use AutoGen to integrate local and remote MCP (Model Context Protocol) servers. It showcases a local math tool (math_server.py) using Stdio and a remote Apify tool (RAG Web Browser Actor) via SSE for tasks like arithmetic and web browsing.

2426. **[mattermost-mcp-host](https://github.com/jagan-shanmugam/mattermost-mcp-host)** - ⭐ 28
   A Mattermost integration that connects to Model Context Protocol (MCP) servers, leveraging a LangGraph-based Agent.

2427. **[nchan-mcp-transport](https://github.com/ConechoAI/nchan-mcp-transport)** - ⭐ 28
...
2428. **[TAM-MCP-Server](https://github.com/gvaibhav/TAM-MCP-Server)** - ⭐ 28
...
2429. **[mcp-etherscan-server](https://github.com/crazyrabbitLTC/mcp-etherscan-server)** - ⭐ 28
   An MCP (Model Context Protocol) server that provides Ethereum blockchain data tools via Etherscan's API. Features include checking ETH balances, viewing transaction history, tracking ERC20 transfers, fetching contract ABIs, monitoring gas prices, and resolving ENS names.

2430. **[vsc-mcp](https://github.com/thomasgazzoni/vsc-mcp)** - ⭐ 28
   This project provides tools that expose Language Server Protocol (LSP) functionality as MCP (Model Context Protocol) tools

2431. **[asterisk-mcp-server](https://github.com/winfunc/asterisk-mcp-server)** - ⭐ 28
   Asterisk Model Context Protocol (MCP) server.

2432. **[biothings-mcp](https://github.com/longevity-genie/biothings-mcp)** - ⭐ 28
   MCP (Model Context Protocol) server for biothings

2433. **[notion-mcp](https://github.com/Badhansen/notion-mcp)** - ⭐ 28
   A simple Model Context Protocol (MCP) server that integrates with Notion's API to manage my personal todo list.

2434. **[matrix-mcp-server](https://github.com/mjknowles/matrix-mcp-server)** - ⭐ 28
   MCP Server for a Matrix home server integration; chat, manage rooms, etc.

2435. **[YFinance-Trader-MCP-ClaudeDesktop](https://github.com/SaintDoresh/YFinance-Trader-MCP-ClaudeDesktop)** - ⭐ 28
   An MCP (Model Context Protocol) tool that provides stock market data and trading capabilities using the yfinance library, specifically adapted for Claude Desktop.

2436. **[UnrealMCPBridge](https://github.com/appleweed/UnrealMCPBridge)** - ⭐ 28
   An Unreal Engine plugin that implements an MCP server allowing MCP clients to access the UE Editor Python API.

2437. **[xhs-mcp](https://github.com/Algovate/xhs-mcp)** - ⭐ 28
   用于小红书（xiaohongshu.com）的 Model Context Protocol（MCP）服务器与 CLI 工具，支持登录、发布、搜索、推荐等自动化能力

2438. **[AI-Tracker](https://github.com/twwch/AI-Tracker)** - ⭐ 28
   本仓库旨在整理关于大语言模型（LLM）底层逻辑、**上下文工程 (Context Engineering)** 以及 **Model Context Protocol (MCP)** 协议的核心学习资源与实战路径。

2439. **[mcp-server-fuzzer](https://github.com/Agent-Hellboy/mcp-server-fuzzer)** - ⭐ 28
   A generic mcp server fuzzer

2440. **[openapi-mcp-generator](https://github.com/abutbul/openapi-mcp-generator)** - ⭐ 28
...
2441. **[mcp-ollama-agent](https://github.com/ausboss/mcp-ollama-agent)** - ⭐ 28
...
2442. **[mcp-bash](https://github.com/patrickomatik/mcp-bash)** - ⭐ 28
...
2443. **[workflows-mcp-server](https://github.com/cyanheads/workflows-mcp-server)** - ⭐ 28
...
2444. **[mcp-proxy](https://github.com/stephenlacy/mcp-proxy)** - ⭐ 28
   Fast rust MCP proxy between stdio and SSE

2445. **[mcp-zero](https://github.com/zeromicro/mcp-zero)** - ⭐ 28
   Model Context Protocol (MCP) server for go-zero framework - Generate APIs, RPC services, and models with AI assistance.

2446. **[claude-code-mcp](https://github.com/zebbern/claude-code-mcp)** - ⭐ 28
...
2447. **[Learn-Model-Context-Protocol-with-Python](https://github.com/PacktPublishing/Learn-Model-Context-Protocol-with-Python)** - ⭐ 28
   Learn Model Context Protocol with Python, published by Packt

2448. **[embedded-debugger-mcp](https://github.com/Adancurusul/embedded-debugger-mcp)** - ⭐ 28
   A Model Context Protocol server for embedded debugging with probe-rs - supports ARM Cortex-M, RISC-V debugging via J-Link, ST-Link, and more

2449. **[datagouv-mcp](https://github.com/datagouv/datagouv-mcp)** - ⭐ 28
...
2450. **[taskflow-mcp](https://github.com/pinkpixel-dev/taskflow-mcp)** - ⭐ 28
   A task management Model Context Protocol (MCP) server that helps AI assistants break down user requests into manageable tasks with subtasks, dependencies, and notes. Enforces a structured workflow with user approval steps.

2451. **[yahoo-finance-server](https://github.com/AgentX-ai/yahoo-finance-server)** - ⭐ 28
...
2452. **[Memgpt-MCP-Server](https://github.com/Vic563/Memgpt-MCP-Server)** - ⭐ 27
   A Model Context Protocol (MCP) server that provides persistent memory and multi-model LLM support.

2453. **[excel-reader-mcp](https://github.com/ArchimedesCrypto/excel-reader-mcp)** - ⭐ 27
...
2454. **[aws-mcp](https://github.com/lokeswaran-aj/aws-mcp)** - ⭐ 27
   An MCP(Model Context Protocol) Server for AWS services

2455. **[mcpc](https://github.com/apify/mcpc)** - ⭐ 27
   Universal command-line client for the Model Context Protocol (MCP)

2456. **[gaia-x](https://github.com/YFGaia/gaia-x)** - ⭐ 27
...
2457. **[VercelGenUI_MCP](https://github.com/JamesSloan/VercelGenUI_MCP)** - ⭐ 27
   Proof of concept chat AI combining the Model Context Protocol (MCP) with Vercel's AI SDK UI

2458. **[postgres-mcp-server](https://github.com/ahmedmustahid/postgres-mcp-server)** - ⭐ 27
   MCP (Model Context Protocol) Server for postgres Database

2459. **[mcp](https://github.com/supadata-ai/mcp)** - ⭐ 27
   Official Supadata MCP Server - Adds powerful video & web scraping to Cursor, Claude and any other LLM clients.

2460. **[google-workspace-mcp-server](https://github.com/epaproditus/google-workspace-mcp-server)** - ⭐ 27
   A Model Context Protocol server for Google Workspace integration (Gmail and Calendar)

2461. **[nettune](https://github.com/jtsang4/nettune)** - ⭐ 27
...
2462. **[mcp-structured-thinking](https://github.com/Promptly-Technologies-LLC/mcp-structured-thinking)** - ⭐ 27
...
2463. **[framer-plugin-mcp](https://github.com/Sheshiyer/framer-plugin-mcp)** - ⭐ 27
   A Model Context Protocol (MCP) server for creating and managing Framer plugins with web3 capabilities

2464. **[mcp-web-browser](https://github.com/random-robbie/mcp-web-browser)** - ⭐ 27
   An advanced web browsing server for the Model Context Protocol (MCP) powered by Playwright, enabling headless browser interactions through a flexible, secure API.

2465. **[directus-mcp-server](https://github.com/rijkvanzanten/directus-mcp-server)** - ⭐ 27
   Model Context Protocol server for Directus

2466. **[Python-Runtime-Interpreter-MCP-Server](https://github.com/hileamlakB/Python-Runtime-Interpreter-MCP-Server)** - ⭐ 27
   PRIMS is a lightweight, open-source Model Context Protocol (MCP) server that lets LLM agents safely execute arbitrary Python code in a secure, throw-away sandbox.

2467. **[seo-insights-mcp-server](https://github.com/mrgoonie/seo-insights-mcp-server)** - ⭐ 27
...
2468. **[mcp_espn_ff](https://github.com/KBThree13/mcp_espn_ff)** - ⭐ 27
   ESPN Fantasy API with LLMs!

2469. **[octave-mcp](https://github.com/elevanaltd/octave-mcp)** - ⭐ 27
...
2470. **[nimbletools-core](https://github.com/NimbleBrainInc/nimbletools-core)** - ⭐ 27
   NimbleTools is an open-source MCP runtime. Infrastructure for the agentic web.

2471. **[deno-mcp-template](https://github.com/phughesmcr/deno-mcp-template)** - ⭐ 27
   A template repo for writing and publishing local, remote, DXT, and binary MCP servers using Deno.

2472. **[gemsuite-mcp](https://github.com/PV-Bhat/gemsuite-mcp)** - ⭐ 27
...
2473. **[mcp-stytch-consumer-todo-list](https://github.com/stytchauth/mcp-stytch-consumer-todo-list)** - ⭐ 27
   Workers + Stytch TODO App MCP Server

2474. **[mindbridge-mcp](https://github.com/pinkpixel-dev/mindbridge-mcp)** - ⭐ 27
...
2475. **[php-mcp](https://github.com/dtyq/php-mcp)** - ⭐ 27
...
2476. **[WebSearch-MCP](https://github.com/mnhlt/WebSearch-MCP)** - ⭐ 27
...
2477. **[src-to-kb](https://github.com/vezlo/src-to-kb)** - ⭐ 27
   Convert source code to LLM ready knowledge base

2478. **[Healthcare-MCP](https://github.com/innovaccer/Healthcare-MCP)** - ⭐ 27
...
2479. **[AskUserQuestionPlus](https://github.com/JoJoJotarou/AskUserQuestionPlus)** - ⭐ 27
...
2480. **[svgmaker-mcp](https://github.com/GenWaveLLC/svgmaker-mcp)** - ⭐ 27
...
2481. **[adeu](https://github.com/dealfluence/adeu)** - ⭐ 27
...
2482. **[GenomeMCP](https://github.com/Eldergenix/GenomeMCP)** - ⭐ 26
...
2483. **[ddg_search](https://github.com/OEvortex/ddg_search)** - ⭐ 26
   A powerful Model Context Protocol (MCP) server for web search and URL content extraction using DuckDuckGo.

2484. **[do-remote-mcp-server-template](https://github.com/do-community/do-remote-mcp-server-template)** - ⭐ 26
   A Model Context Protocol (MCP) server that checks domain name availability using WHOIS lookups and DNS resolution

2485. **[mcp-frontend-testing](https://github.com/StudentOfJS/mcp-frontend-testing)** - ⭐ 26
   Frontend testing tools for Model Context Protocol

2486. **[pptx-xlsx-mcp](https://github.com/jenstangen1/pptx-xlsx-mcp)** - ⭐ 26
   Antrophics Model context protocol to edit powerpoint files

2487. **[minds-mcp](https://github.com/mindsdb/minds-mcp)** - ⭐ 26
...
2488. **[mcp-advisor](https://github.com/olaservo/mcp-advisor)** - ⭐ 26
   MCP Server to assist LLMs and humans on Model Context Protocol spec compliance and understanding

2489. **[mcp-client-x](https://github.com/RGGH/mcp-client-x)** - ⭐ 26
   Python MCP client + server example

2490. **[mcp-gateway](https://github.com/lucky-aeon/mcp-gateway)** - ⭐ 26
...
2491. **[mcp-log-proxy](https://github.com/emicklei/mcp-log-proxy)** - ⭐ 26
   a web logging proxy for MCP client-server communication

2492. **[langchain-mcp-tools-py](https://github.com/hideya/langchain-mcp-tools-py)** - ⭐ 26
   MCP to LangChain Tools Conversion Utility / Python

2493. **[mcp-server-giphy](https://github.com/magarcia/mcp-server-giphy)** - ⭐ 26
   An implementation of Giphy integration with Model Context Protocol

2494. **[MalwareBazaar_MCP](https://github.com/mytechnotalent/MalwareBazaar_MCP)** - ⭐ 26
   An AI-driven MCP server that autonomously interfaces with Malware Bazaar, delivering real-time threat intel and sample metadata for authorized cybersecurity research workflows.

2495. **[omop_mcp](https://github.com/OHNLP/omop_mcp)** - ⭐ 26
...
2496. **[mcp-chain-of-draft-server](https://github.com/bsmi021/mcp-chain-of-draft-server)** - ⭐ 26
   Chain of Draft Server is a powerful AI-driven tool that helps developers make better decisions through systematic, iterative refinement of thoughts and designs. It integrates seamlessly with popular AI agents and provides a structured approach to reasoning, API design, architecture decisions, code reviews, and implementation planning.

2497. **[alibabacloud-dataworks-mcp-server](https://github.com/aliyun/alibabacloud-dataworks-mcp-server)** - ⭐ 26
   A Model Context Protocol (MCP) server that provides tools for AI, allowing it to interact with the DataWorks Open API through a standardized interface. This implementation is based on the Aliyun Open API and enables AI agents to perform cloud resources operations seamlessly.

2498. **[levante](https://github.com/levante-hub/levante)** - ⭐ 26
   Levante - Personal, Secure, Free, Local AI, MCP Client

2499. **[mcp-client-cli](https://github.com/thedotmack/mcp-client-cli)** - ⭐ 26
   Command-line interface for any Model Context Protocol (MCP) server.

2500. **[ton-blockchain-mcp](https://github.com/devonmojito/ton-blockchain-mcp)** - ⭐ 26
   A Model Context Protocol (MCP) server written in Python for natural language interaction with the TON blockchain 💎

2501. **[MCP-BOE](https://github.com/ComputingVictor/MCP-BOE)** - ⭐ 26
...
2502. **[kaggle-mcp](https://github.com/54yyyu/kaggle-mcp)** - ⭐ 26
...
2503. **[MCPSecBench](https://github.com/AIS2Lab/MCPSecBench)** - ⭐ 26
   MCPSecBench: A Systematic Security Benchmark and Playground for Testing Model Context Protocols

2504. **[mcp-writer-substack](https://github.com/jonathan-politzki/mcp-writer-substack)** - ⭐ 26
   Model Context Protocol to bridge in Substack writings to Claude.

2505. **[ida-headless-mcp](https://github.com/zboralski/ida-headless-mcp)** - ⭐ 26
   Headless IDA Pro binary analysis via Model Context Protocol

2506. **[ai-foundry-agents-samples](https://github.com/Azure-Samples/ai-foundry-agents-samples)** - ⭐ 26
   Azure AI Foundry - Agents related sample code

2507. **[freepik-mcp](https://github.com/freepik-company/freepik-mcp)** - ⭐ 26
   The Freepik enables popular agent Model Context Protocol (MCP) to integrate with Freepik APIs through function calling.

2508. **[gatekit](https://github.com/gatekit-ai/gatekit)** - ⭐ 26
   A hackable Model Context Protocol (MCP) gateway

2509. **[alpaca-mcp-server](https://github.com/tedlikeskix/alpaca-mcp-server)** - ⭐ 25
   Model Context Protocol (MCP) server for Alpaca trading API

2510. **[gyazo-mcp-server](https://github.com/nota/gyazo-mcp-server)** - ⭐ 25
   Official Model Context Protocol server for Gyazo

2511. **[mcp-php](https://github.com/garyblankenship/mcp-php)** - ⭐ 25
   model context protocol or mcp for php laravel

2512. **[mcp-media-processor](https://github.com/maoxiaoke/mcp-media-processor)** - ⭐ 25
   A Node.js server implementing Model Context Protocol (MCP) for media processing operations, providing powerful video and image manipulation capabilities.

2513. **[mcp-webdriveragent](https://github.com/AppiumTestDistribution/mcp-webdriveragent)** - ⭐ 25
   This is a Model Context Protocol (MCP) server that provides tools for building and signing WebDriverAgent for iOS.

2514. **[turn-based-game-mcp](https://github.com/github-samples/turn-based-game-mcp)** - ⭐ 25
...
2515. **[taiwan-holiday-mcp](https://github.com/lis186/taiwan-holiday-mcp)** - ⭐ 25
   一個基於 Model Context Protocol (MCP) 的台灣假期查詢伺服器，為 AI 工具提供準確的台灣國定假日資訊。

2516. **[mcp-manager](https://github.com/nstebbins/mcp-manager)** - ⭐ 25
   CLI tool for managing Model Context Protocol (MCP) servers in one place & using them across them different clients

2517. **[php-mcp-sdk](https://github.com/dalehurley/php-mcp-sdk)** - ⭐ 25
...
2518. **[symfony-mcp-server](https://github.com/klapaudius/symfony-mcp-server)** - ⭐ 25
   A Symfony package designed for building secure servers based on the Model Context Protocol, utilizing Server-Sent Events (SSE) and/or StreamableHTTP for real-time communication. It offers a scalable tool system tailored for enterprise-grade applications.

2519. **[FalkorDB-MCPServer](https://github.com/FalkorDB/FalkorDB-MCPServer)** - ⭐ 25
   FalkorDB-MCPServer is an MCP (Model Context Protocol) server that connects LLMs to FalkorDB

2520. **[elysia-mcp](https://github.com/kerlos/elysia-mcp)** - ⭐ 25
   ElysiaJS plugin for Model Context Protocol with HTTP transport

2521. **[mcp-server-semgrep](https://github.com/VetCoders/mcp-server-semgrep)** - ⭐ 25
   MCP Server Semgrep is a [Model Context Protocol](https://modelcontextprotocol.io) compliant server that integrates the powerful Semgrep static analysis tool with AI assistants like Anthropic Claude. It enables advanced code analysis, security vulnerability detection, and code quality improvements directly through a conversational interface.

2522. **[deep-research-mcp](https://github.com/pinkpixel-dev/deep-research-mcp)** - ⭐ 25
   A Model Context Protocol (MCP) compliant server designed for comprehensive web research. It uses Tavily's Search and Crawl APIs to gather detailed information on a given topic, then structures this data in a format perfect for LLMs to create high-quality markdown documents.

2523. **[mcpmcp-server](https://github.com/glenngillen/mcpmcp-server)** - ⭐ 25
   Discover, setup, and integrate MCP servers with your favorite clients. Unlock the full potential of AI in your daily workflow.

2524. **[puzzlebox](https://github.com/cliffhall/puzzlebox)** - ⭐ 25
...
2525. **[Tiny-OAI-MCP-Agent](https://github.com/jalr4ever/Tiny-OAI-MCP-Agent)** - ⭐ 25
   A MCP protocol agent that operates a SQLite using natural language by OpenAI-Compatible LLM.

2526. **[slack-mcp-server](https://github.com/AVIMBU/slack-mcp-server)** - ⭐ 25
   A Model Context Protocol Server for Interacting with Slack

2527. **[vision-one-mcp-server](https://github.com/trendmicro/vision-one-mcp-server)** - ⭐ 25
...
2528. **[whistle-mcp](https://github.com/7gugu/whistle-mcp)** - ⭐ 25
...
2529. **[MCP-Developer-SubAgent](https://github.com/gensecaihq/MCP-Developer-SubAgent)** - ⭐ 25
...
2530. **[powerplatform-mcp](https://github.com/michsob/powerplatform-mcp)** - ⭐ 25
   PowerPlatform Model Context Protocol server

2531. **[zillow-mcp-server](https://github.com/sap156/zillow-mcp-server)** - ⭐ 25
   Zillow MCP Server for real estate data access via the Model Context Protocol

2532. **[systemprompt-mcp-notion](https://github.com/Ejb503/systemprompt-mcp-notion)** - ⭐ 25
...
2533. **[mcp-config-manager](https://github.com/holstein13/mcp-config-manager)** - ⭐ 25
...
2534. **[mcp-simple-timeserver](https://github.com/andybrandt/mcp-simple-timeserver)** - ⭐ 25
   Simple solution to give Claude ability to check current time via MCP

2535. **[kernel-mcp-server](https://github.com/kernel/kernel-mcp-server)** - ⭐ 25
   Open-source MCP server for secure, low-latency cloud-browser automation on Kernel.

2536. **[Amazing-Marvin-MCP](https://github.com/bgheneti/Amazing-Marvin-MCP)** - ⭐ 25
   Model Context Provider for Amazing Marvin productivity app - Access your tasks, projects, and categories in AI assistants

2537. **[FerrumMCP](https://github.com/Eth3rnit3/FerrumMCP)** - ⭐ 25
...
2538. **[chatbot_Shopify](https://github.com/Mobeen-Dev/chatbot_Shopify)** - ⭐ 25
   Agentic Shopify Chatbot with MCP integration, embedded directly into Shopify via a Theme Extension

2539. **[crawl4ai-mcp-server](https://github.com/sadiuysal/crawl4ai-mcp-server)** - ⭐ 25
...
2540. **[browser-use-rs](https://github.com/BB-fat/browser-use-rs)** - ⭐ 25
...
2541. **[mcp_rss](https://github.com/buhe/mcp_rss)** - ⭐ 25
   MCP RSS is a Model Context Protocol (MCP) server for interacting with RSS feeds.

2542. **[touchdesigner-mcp-server](https://github.com/bottobot/touchdesigner-mcp-server)** - ⭐ 25
...
2543. **[puppeteer-mcp-claude](https://github.com/jaenster/puppeteer-mcp-claude)** - ⭐ 25
...
2544. **[minimax_search](https://github.com/MiniMax-AI/minimax_search)** - ⭐ 25
   MiniMax Search is an MCP (Model Context Protocol) server that provides web search and browsing capabilities.

2545. **[fal-mcp-server](https://github.com/raveenb/fal-mcp-server)** - ⭐ 25
   MCP server for Fal.ai - Generate images, videos, music and audio with Claude

2546. **[google-search-console-mcp-server](https://github.com/Shin-sibainu/google-search-console-mcp-server)** - ⭐ 25
   Model Context Protocol server for Google Search Console API - integrate with Claude Code and Claude Desktop

2547. **[mcp-server](https://github.com/blockscout/mcp-server)** - ⭐ 25
   Wraps Blockscout APIs and exposes blockchain data by Model Context Protocol

2548. **[enhanced-mcp-memory](https://github.com/cbunting99/enhanced-mcp-memory)** - ⭐ 25
   An enhanced MCP (Model Context Protocol) server for intelligent memory and task management, designed for AI assistants and development workflows. Features semantic search, automatic task extraction, knowledge graphs, and comprehensive project management.

2549. **[desktop](https://github.com/agentify-sh/desktop)** - ⭐ 25
...
2550. **[agent-hub-mcp](https://github.com/gilbarbara/agent-hub-mcp)** - ⭐ 25
   A Model Context Protocol (MCP) server that enables communication and coordination between multiple AI agents

2551. **[nebulagraph-mcp-server](https://github.com/nebula-contrib/nebulagraph-mcp-server)** - ⭐ 25
   Model Context Protocol Server for NebulaGraph 3.x

2552. **[clay-mcp](https://github.com/clay-inc/clay-mcp)** - ⭐ 25
   A simple Model Context Protocol (MCP) server for Clay.

2553. **[semrush-mcp](https://github.com/mrkooblu/semrush-mcp)** - ⭐ 24
   A Model Context Protocol (MCP) server implementation that provides tools for accessing Semrush API data.

2554. **[Unlock-your-agents-potential-with-Model-Context-Protocol-PostgreSQL-Workshop](https://github.com/gloveboxes/Unlock-your-agents-potential-with-Model-Context-Protocol-PostgreSQL-Workshop)** - ⭐ 24

2555. **[ccmcp](https://github.com/gsong/ccmcp)** - ⭐ 24
   A CLI tool that intelligently discovers, validates, and selects MCP (Model Context Protocol) server configurations for Claude Code.

2556. **[opnsense-mcp-server](https://github.com/floriangrousset/opnsense-mcp-server)** - ⭐ 24
...
2557. **[n8n-AI-agent-DVM-MCP-client](https://github.com/r0d8lsh0p/n8n-AI-agent-DVM-MCP-client)** - ⭐ 24
...
2558. **[mcp-server-semgrep](https://github.com/Szowesgad/mcp-server-semgrep)** - ⭐ 24
   MCP Server Semgrep is a [Model Context Protocol](https://modelcontextprotocol.io) compliant server that integrates the powerful Semgrep static analysis tool with AI assistants like Anthropic Claude. It enables advanced code analysis, security vulnerability detection, and code quality improvements directly through a conversational interface.

2559. **[python-sequential-thinking-mcp](https://github.com/XD3an/python-sequential-thinking-mcp)** - ⭐ 24
...
2560. **[MCP](https://github.com/EduBase/MCP)** - ⭐ 24
   The EduBase MCP server enables Claude and other LLMs to interact with EduBase's comprehensive e-learning platform through the Model Context Protocol (MCP).

2561. **[mcp-task-manager-server](https://github.com/bsmi021/mcp-task-manager-server)** - ⭐ 24
   A local Model Context Protocol (MCP) server providing backend tools for client-driven project and task management using a SQLite database.

2562. **[brlaw_mcp_server](https://github.com/pdmtt/brlaw_mcp_server)** - ⭐ 24
   A MCP (Model Context Protocol) server for agent-driven research on Brazilian law using official sources

2563. **[DeepResearchMCP](https://github.com/ameeralns/DeepResearchMCP)** - ⭐ 24
...
2564. **[aistudio-mcp-server](https://github.com/eternnoir/aistudio-mcp-server)** - ⭐ 24
...
2565. **[mcp-template-dotnet](https://github.com/NikiforovAll/mcp-template-dotnet)** - ⭐ 24
   This repository contains a template for creating a Model Context Protocol (MCP) applications in .NET.

2566. **[mcp-playground](https://github.com/zanetworker/mcp-playground)** - ⭐ 24
   Simple MCP Client for remote MCP Servers 🌐

2567. **[awesome-mcp-lists](https://github.com/collabnix/awesome-mcp-lists)** - ⭐ 24
   A Curated List of MCP Servers, Clients and Toolkits

2568. **[mcp_streamable_http](https://github.com/theailanguage/mcp_streamable_http)** - ⭐ 24
   Educational repo for MCP streamable HTTP servers and clients

2569. **[Awesome-MCP](https://github.com/Albertchamberlain/Awesome-MCP)** - ⭐ 24
   Awesome-MCP Servers & Clients & Funny things

2570. **[openai-copilot](https://github.com/feiskyer/openai-copilot)** - ⭐ 24
   Your life Copilot powered by LLM models (CLI interface for LLM models with MCP tools).

2571. **[bgg-mcp](https://github.com/kkjdaniel/bgg-mcp)** - ⭐ 24
   BGG MCP provides access to BoardGameGeek and a variety of board game related data through the Model Context Protocol. Enabling retrieval and filtering of board game data, user collections, and profiles.

2572. **[meeting-mcp](https://github.com/Meeting-BaaS/meeting-mcp)** - ⭐ 24
   Model Context Protocol server for AI assistants to create meeting bots, search transcripts, and manage meeting recordings.

2573. **[calendar-mcp](https://github.com/deciduus/calendar-mcp)** - ⭐ 24
...
2574. **[readwise-vector-db](https://github.com/leonardsellem/readwise-vector-db)** - ⭐ 24
...
2575. **[nestjs-mcp](https://github.com/bamada/nestjs-mcp)** - ⭐ 24
   NestJS module for seamless Model Context Protocol (MCP) server integration using decorators.

2576. **[forgejo-mcp](https://github.com/goern/forgejo-mcp)** - ⭐ 24
...
2577. **[cfbd-mcp-server](https://github.com/lenwood/cfbd-mcp-server)** - ⭐ 24
   An MCP server enabling CFBD API queries within Claude Desktop.

2578. **[mcp-server-amazon-bedrock](https://github.com/zxkane/mcp-server-amazon-bedrock)** - ⭐ 24
   Model Context Procotol(MCP) server for using Amazon Bedrock Nova Canvas to generate images

2579. **[MiAO-MCP-for-Unity](https://github.com/MiAO-AI-Lab/MiAO-MCP-for-Unity)** - ⭐ 24
...
2580. **[github-repo-mcp](https://github.com/Ryan0204/github-repo-mcp)** - ⭐ 24
   Model Context Protocol server for Github Repo // Reading Github Repo

2581. **[k6-mcp-server](https://github.com/QAInsights/k6-mcp-server)** - ⭐ 24
   k6 MCP server

2582. **[Fusion-360-MCP-Server](https://github.com/AuraFriday/Fusion-360-MCP-Server)** - ⭐ 24
   Control Fusion 360 with any AI through Model Context Protocol (MCP)

2583. **[prometheus-mcp](https://github.com/idanfishman/prometheus-mcp)** - ⭐ 24
   A Model Context Protocol (MCP) server implementation that provides AI agents with programmatic access to Prometheus metrics via a unified interface.

2584. **[bzm-mcp](https://github.com/Blazemeter/bzm-mcp)** - ⭐ 24
   Official BlazeMeter MCP Server for AI-driven performance testing

2585. **[metals-standalone-client](https://github.com/jpablo/metals-standalone-client)** - ⭐ 24
   Minimal Metals stand alone client that allows running the metals mcp server

2586. **[mcp-caiyun-weather](https://github.com/caiyunapp/mcp-caiyun-weather)** - ⭐ 24
   A Model Context Protocol (MCP) server for Caiyun (ColorfulClouds) Weather.

2587. **[MCPServer](https://github.com/rhennigan/MCPServer)** - ⭐ 24
   Implements a model context protocol server using Wolfram Language

2588. **[mcp-desktop-automation](https://github.com/tanob/mcp-desktop-automation)** - ⭐ 24
   A Model Context Protocol server that provides desktop automation capabilities using RobotJS and screenshot capabilities

2589. **[pulse-editor](https://github.com/ClayPulse/pulse-editor)** - ⭐ 24
...
2590. **[Model-Context-Protocol](https://github.com/Coding-Crashkurse/Model-Context-Protocol)** - ⭐ 23

2591. **[greptimedb-mcp-server](https://github.com/GreptimeTeam/greptimedb-mcp-server)** - ⭐ 23
   A Model Context Protocol (MCP) server for GreptimeDB

2592. **[jigsawstack-mcp-server](https://github.com/JigsawStack/jigsawstack-mcp-server)** - ⭐ 23
   Model Context Protocol Server that allows AI models to interact with JigsawStack models!

2593. **[metabase-mcp-server](https://github.com/hyeongjun-dev/metabase-mcp-server)** - ⭐ 23
   A Model Context Protocol server that integrates AI assistants with Metabase analytics platform

2594. **[cortex](https://github.com/FreePeak/cortex)** - ⭐ 23
...
2595. **[paraview_mcp](https://github.com/LLNL/paraview_mcp)** - ⭐ 23
   ParaView-MCP integrates multimodal LLMs with ParaView via Model Context Protocol, enabling natural language control of scientific visualizations. The agent observes the viewport for visual feedback, making complex visualization tool accessible to all users while providing intelligent automation for experts.

2596. **[lineshopping-api-mcp](https://github.com/woraphol-j/lineshopping-api-mcp)** - ⭐ 23
...
2597. **[home-assistant-mcp](https://github.com/hpohlmann/home-assistant-mcp)** - ⭐ 23
...
2598. **[mcp-twitter-server](https://github.com/crazyrabbitLTC/mcp-twitter-server)** - ⭐ 23
   Model Context Protocol Server for Accessing twitter

2599. **[fastify-mcp](https://github.com/haroldadmin/fastify-mcp)** - ⭐ 23
   A Fastify plugin to run Model Context Protocol (MCP) servers

2600. **[batchdata-mcp-real-estate](https://github.com/zellerhaus/batchdata-mcp-real-estate)** - ⭐ 23
...
2601. **[lua-resty-mcp](https://github.com/ufownl/lua-resty-mcp)** - ⭐ 23
   Model Context Protocol SDK implemented in Lua for OpenResty

2602. **[mcp-server-starter-ts](https://github.com/alexanderop/mcp-server-starter-ts)** - ⭐ 23
   A minimal TypeScript starter template for building Model Context Protocol (MCP) servers.

2603. **[strava-mcp](https://github.com/kw510/strava-mcp)** - ⭐ 23
...
2604. **[mcp-slicer](https://github.com/zhaoyouj/mcp-slicer)** - ⭐ 23
   A Model Context Protocol server for 3D Slicer integration

2605. **[identity-spec](https://github.com/agntcy/identity-spec)** - ⭐ 23
   AGNTCY Identity allows to onboard, create and verify identities for Agents, Model Context Protocol (MCP) Servers and Multi-Agent Systems (MASs).

2606. **[mcp-ffmpeg-helper](https://github.com/sworddut/mcp-ffmpeg-helper)** - ⭐ 23
   一个基于 Model Context Protocol (MCP) 的 FFmpeg 辅助工具，提供视频处理功能。

2607. **[mcp-client-agent](https://github.com/shane-kercheval/mcp-client-agent)** - ⭐ 23
   CLI that uses DSPy to interact with MCP servers.

2608. **[mcp-community](https://github.com/Mirascope/mcp-community)** - ⭐ 23
   Easily run, deploy, and connect to MCP servers

2609. **[jsonv-ts](https://github.com/dswbx/jsonv-ts)** - ⭐ 23
   JSON Schema builder and validator for TypeScript with static type inference, Hono middleware for OpenAPI generation and validation, and MCP server/client implementation. Lightweight, dependency-free, and built on Web Standards.

2610. **[solana-mcp](https://github.com/tony-42069/solana-mcp)** - ⭐ 23
...
2611. **[aisdk-mcp-bridge](https://github.com/vrknetha/aisdk-mcp-bridge)** - ⭐ 23
...
2612. **[RevitMCP](https://github.com/oakplank/RevitMCP)** - ⭐ 23
   model context protocol for Autodesk Revit

2613. **[nlweb-net](https://github.com/nlweb-ai/nlweb-net)** - ⭐ 23
...
2614. **[mcp-pa-ai-agent](https://github.com/zhangzhongnan928/mcp-pa-ai-agent)** - ⭐ 23
   A personal assistant AI agent built with the Model Context Protocol (MCP)

2615. **[openproject-mcp-server](https://github.com/AndyEverything/openproject-mcp-server)** - ⭐ 23
   A Model Context Protocol (MCP) server that provides seamless integration with OpenProject API v3.

2616. **[roo-logger](https://github.com/annenpolka/roo-logger)** - ⭐ 23
   An MCP server for logging activity in Roo Code/Cline.

2617. **[codemesh](https://github.com/kiliman/codemesh)** - ⭐ 23
   The Self-Improving MCP Server - Agents write code to orchestrate multiple MCP servers with intelligent TypeScript execution and auto-augmentation

2618. **[microsoft_fabric_mcp](https://github.com/Augustab/microsoft_fabric_mcp)** - ⭐ 23
   MCP server wrapping around the Fabric Rest API

2619. **[mcp-annotated-java-sdk](https://github.com/thought2code/mcp-annotated-java-sdk)** - ⭐ 23
   Annotation-driven MCP dev 🚀 No Spring, Zero Boilerplate, Pure Java

2620. **[skill-mcp](https://github.com/fkesheh/skill-mcp)** - ⭐ 23
...
2637. **[p5js-ai-editor](https://github.com/adilmoujahid/p5js-ai-editor)** - ⭐ 22
...
2638. **[cursor-db-mcp](https://github.com/jbdamask/cursor-db-mcp)** - ⭐ 22
   Model Context Protocol server for querying Cursor chat history

2639. **[printify-mcp](https://github.com/TSavo/printify-mcp)** - ⭐ 22
   A Model Context Protocol (MCP) server for integrating AI assistants with Printify's print-on-demand platform

2640. **[mcp-claude-spotify](https://github.com/imprvhub/mcp-claude-spotify)** - ⭐ 22
   An integration that allows Claude Desktop to interact with Spotify using the Model Context Protocol (MCP).

2641. **[cf-mcp-client](https://github.com/cpage-pivotal/cf-mcp-client)** - ⭐ 22
   Tanzu Platform Chat

2642. **[supabase-mcp-client](https://github.com/tambo-ai/supabase-mcp-client)** - ⭐ 22
   Supabase MCP client react app with Tambo

2643. **[biznagafest-mcp](https://github.com/0GiS0/biznagafest-mcp)** - ⭐ 22
   MCP Servers en Málaga con salero

2644. **[langchain-mcp-tools-ts](https://github.com/hideya/langchain-mcp-tools-ts)** - ⭐ 22
   MCP to LangChain Tools Conversion Utility / TypeScript

2645. **[codesys-mcp-toolkit](https://github.com/johannesPettersson80/codesys-mcp-toolkit)** - ⭐ 22
   Model Context Protocol server for CODESYS automation platform

2646. **[dbt-docs-mcp](https://github.com/mattijsdp/dbt-docs-mcp)** - ⭐ 22
   MCP (model context protocol) server for interacting with dbt Docs

2647. **[MCP_A2A](https://github.com/regismesquita/MCP_A2A)** - ⭐ 22
...
2648. **[grumpydev-mcp](https://github.com/sinedied/grumpydev-mcp)** - ⭐ 22
   Let the grumpy senior dev review your code with this MCP server

2649. **[Claude-Code-MCP-Manager](https://github.com/qdhenry/Claude-Code-MCP-Manager)** - ⭐ 22
    A comprehensive tool to manage Model Context Protocol (MCP) configurations for Claude code

2650. **[slack-mcp-client](https://github.com/csonigo/slack-mcp-client)** - ⭐ 22
   An MCP client for slack in Typescript

2651. **[bear-notes-mcp](https://github.com/bejaminjones/bear-notes-mcp)** - ⭐ 22
   MCP server for Bear app - Full Read + Write AI-powered note management with Claude Desktop

2652. **[Excel-MCP-Server-Master](https://github.com/guillehr2/Excel-MCP-Server-Master)** - ⭐ 22
...
2653. **[congressMCP](https://github.com/amurshak/congressMCP)** - ⭐ 22
   An MCP server allowing AI agents and MCP clients to interface with the Congress.gov API

2654. **[google-search-console-mcp](https://github.com/surendranb/google-search-console-mcp)** - ⭐ 22
   Google Search Console MCP Server for Claude, Cursor, Windsurf and other MCP Clients

2655. **[d365fo-client](https://github.com/mafzaal/d365fo-client)** - ⭐ 22
...
2659. **[lc2mcp](https://github.com/xiaotonng/lc2mcp)** - ⭐ 22
   Convert LangChain tools to FastMCP tools

2660. **[bridge-mcp](https://github.com/codingjam/bridge-mcp)** - ⭐ 21
...
2661. **[cml-mcp](https://github.com/xorrkaz/cml-mcp)** - ⭐ 21
   A Model Context Protocol (MCP) Server for Cisco Modeling Labs (CML)

2662. **[mcpsharepoint](https://github.com/BrianCusack/mcpsharepoint)** - ⭐ 21
   Model Context Protocol server that provides access to Organisational SharePoint.

2663. **[command-executor-mcp-server](https://github.com/Sunwood-ai-labs/command-executor-mcp-server)** - ⭐ 21
   Model Context Protocol Server for Safely Executing Pre-approved Commands

2664. **[emqx-mcp-server](https://github.com/Benniu/emqx-mcp-server)** - ⭐ 21
   A Model Context Protocol (MCP) server implementation that provides EMQX MQTT broker interaction.

2665. **[mcp-sentry](https://github.com/MCP-100/mcp-sentry)** - ⭐ 21
   A Model Context Protocol server for retrieving and analyzing issues from Sentry.io

2666. **[fastify-mcp-server](https://github.com/flaviodelgrosso/fastify-mcp-server)** - ⭐ 21
   Fastify plugin to easily spin up Model Context Protocol (MCP) HTTP servers

2667. **[mcp-korean-spell](https://github.com/winterjung/mcp-korean-spell)** - ⭐ 21
   MCP(Model Context Protocol) server designed for Korean spell checking

2668. **[DocsRay](https://github.com/MIMICLab/DocsRay)** - ⭐ 21
   Lightweight PDF Q&A tool powered by RAG (Retrieval-Augmented Generation) with MCP (Model Context Protocol) Support.

2669. **[MCPRules](https://github.com/bartwisch/MCPRules)** - ⭐ 21
...
2670. **[code-context-mcp](https://github.com/fkesheh/code-context-mcp)** - ⭐ 21
   A Model Context Protocol (MCP) server for providing code context from git repositories

2671. **[mcp-knowledge-base](https://github.com/hjlee94/mcp-knowledge-base)** - ⭐ 21
   MCP agent/client/server implementation for private knowledge base

2672. **[awesome-mcp](https://github.com/MCPHubCloud/awesome-mcp)** - ⭐ 21
   A collection of mcp servers/client/sdks

2673. **[aj-mcp](https://github.com/lightweight-component/aj-mcp)** - ⭐ 21
   Simple MCP SDK in Java

2674. **[mcp-cmd](https://github.com/developit/mcp-cmd)** - ⭐ 21
   CLI for calling successive MCP Server tools

2675. **[server-sharepoint](https://github.com/Zerg00s/server-sharepoint)** - ⭐ 21
...
2688. **[peta-core](https://github.com/dunialabs/peta-core)** - ⭐ 21
   Peta core: The Control Plane for MCP — secure vault, managed runtime, audit trail, and policy-based approvals.

2689. **[ib-mcp-cache-server](https://github.com/ibproduct/ib-mcp-cache-server)** - ⭐ 20
   Memory Cache Server for use with supported MCP API Clients.

2690. **[hs-mcp](https://github.com/buecking/hs-mcp)** - ⭐ 20
   Haskell server/client for MCP (Model Context Protocol)

2691. **[zotero-mcp-server](https://github.com/swairshah/zotero-mcp-server)** - ⭐ 20
   MCP server to expose local zotero repository to MCP clients 

2692. **[mcp-server-runner](https://github.com/yonaka15/mcp-server-runner)** - ⭐ 20
...
2693. **[mcp-ai-agent](https://github.com/fkesheh/mcp-ai-agent)** - ⭐ 20
...
2694. **[easymcp](https://github.com/promptmesh/easymcp)** - ⭐ 20
   A high performance MCP client sdk for python

2695. **[mcp-framework](https://github.com/koki7o/mcp-framework)** - ⭐ 20
   Rust MCP framework for building AI agents

2696. **[mcp-server-memos-py](https://github.com/RyoJerryYu/mcp-server-memos-py)** - ⭐ 20
   A Python package enabling LLM models to interact with the Memos server via the MCP interface for searching, creating, retrieving, and managing memos.

2697. **[PDB-MCP-Server](https://github.com/Augmented-Nature/PDB-MCP-Server)** - ⭐ 20
...
2698. **[mcp-prompt-optimizer](https://github.com/Bubobot-Team/mcp-prompt-optimizer)** - ⭐ 20
   Advanced MCP server providing cutting-edge prompt optimization tools with research-backed strategies

2699. **[lotus-wisdom-mcp](https://github.com/linxule/lotus-wisdom-mcp)** - ⭐ 20
...
2700. **[kirby-mcp](https://github.com/bnomei/kirby-mcp)** - ⭐ 20
...
2701. **[holoviz-mcp](https://github.com/MarcSkovMadsen/holoviz-mcp)** - ⭐ 20
   ✨A MCP server that provides intelligent access to the HoloViz ecosystem for humans and AIs.

2702. **[help-scout-mcp-server](https://github.com/drewburchfield/help-scout-mcp-server)** - ⭐ 20
   MCP server for Help Scout - search conversations, threads, and inboxes with AI agents

2703. **[mcpc](https://github.com/micl2e2/mcpc)** - ⭐ 20
   Cross-platform C SDK for Model Context Protocol (MCP), in modern🚀 C23.

2704. **[NiFiMCP](https://github.com/ms82119/NiFiMCP)** - ⭐ 19
   An MCP Server and client for communicating with Nifi (v1.28)

2705. **[gemini-mcp-client](https://github.com/angrysky56/gemini-mcp-client)** - ⭐ 19
...
2706. **[starbase](https://github.com/metorial/starbase)** - ⭐ 19
   Connect, explore, and test any MCP server with AI models 🤖 ⚡

2707. **[guidance-for-scalable-model-inference-and-agentic-ai-on-amazon-eks](https://github.com/aws-solutions-library-samples/guidance-for-scalable-model-inference-and-agentic-ai-on-amazon-eks)** - ⭐ 19
...
2708. **[flutter-ai-labs](https://github.com/theshivamlko/flutter-ai-labs)** - ⭐ 19
   A curated collection of LLM-powered Flutter apps built using RAG, AI Agents, Multi-Agent Systems, MCP, and Voice Agents.

2709. **[deep-research](https://github.com/ssdeanx/deep-research)** - ⭐ 19
...
2710. **[mcp-diagnostics-extension](https://github.com/newbpydev/mcp-diagnostics-extension)** - ⭐ 19
   VS Code extension that exposes diagnostic problems via Model Context Protocol (MCP) for AI agents and tools

2711. **[knowledgebase-mcp](https://github.com/biocontext-ai/knowledgebase-mcp)** - ⭐ 19
   BioContextAI Knowledgebase MCP server for biomedical agentic AI 

2712. **[mcp](https://github.com/EmilLindfors/mcp)** - ⭐ 19
    A crate for making MCP (Model Context Protocol) compatible programs with rust

2713. **[perplexity-mcp-server](https://github.com/cyanheads/perplexity-mcp-server)** - ⭐ 19
...
2714. **[mcp-frontend](https://github.com/shaharia-lab/mcp-frontend)** - ⭐ 19
   Frontend for MCP (Model Context Protocol) Kit for Go - A Complete MCP solutions for ready to use

2715. **[minime-mcp](https://github.com/manujbawa/minime-mcp)** - ⭐ 19
...
2716. **[registry](https://github.com/biocontext-ai/registry)** - ⭐ 19
   The BioContextAI Registry for biomedical MCP servers

2717. **[mcp-server-mariadb](https://github.com/abel9851/mcp-server-mariadb)** - ⭐ 19
   An mcp server that provides read-only access to MariaDB.

2718. **[mcp-server](https://github.com/paperinvest/mcp-server)** - ⭐ 19
   Official MCP server for Paper's trading platform - enables AI assistants to interact with Paper's API

2719. **[agent-mcp](https://github.com/grupa-ai/agent-mcp)** - ⭐ 19
   MCPAgent for Grupa.AI Multi-agent Collaboration Network (MACNET) with Model Context Protocol (MCP) capabilities baked in

2720. **[html-to-markdown-mcp](https://github.com/levz0r/html-to-markdown-mcp)** - ⭐ 19
...
2721. **[Wwise-MCP](https://github.com/BilkentAudio/Wwise-MCP)** - ⭐ 19
...
2722. **[fast-mcp-telegram](https://github.com/leshchenko1979/fast-mcp-telegram)** - ⭐ 19
   Telegram MCP Server and HTTP-MTProto bridge | Multi-user auth, intelligent search, file sending, web setup | Docker & PyPI ready

2723. **[mssqlclient-mcp-server](https://github.com/aadversteeg/mssqlclient-mcp-server)** - ⭐ 19
...
2724. **[linux-command-mcp](https://github.com/xkiranj/linux-command-mcp)** - ⭐ 19
   MCP server and client for running Linux commands

2725. **[MCPbundler](https://github.com/eugenepyvovarov/MCPbundler)** - ⭐ 19

2726. **[agent-twitter-client-mcp](https://github.com/ryanmac/agent-twitter-client-mcp)** - ⭐ 18
...
2727. **[mcp-server-client-demo](https://github.com/S1LV3RJ1NX/mcp-server-client-demo)** - ⭐ 18
   Streamable HTTP based MCP server and Client demo with auto registry, Dockerfile setup and env. 

2728. **[eleven.shopping](https://github.com/elevenlabs/eleven.shopping)** - ⭐ 18
   ElevenLabs Agent with Storefront MCP UI Server & MCP UI client

2729. **[typescript-mcp-client](https://github.com/CodelyTV/typescript-mcp-client)** - ⭐ 18

2730. **[openpyxl-mcp-server](https://github.com/jonemo/openpyxl-mcp-server)** - ⭐ 18
...
2739. **[mcp-link](https://github.com/AuraFriday/mcp-link)** - ⭐ 18
...
2740. **[gpt2099.nu](https://github.com/cablehead/gpt2099.nu)** - ⭐ 18
   a Nushell cross.stream extension to interact with LLMs and MCP servers

2741. **[Devmind-MCP](https://github.com/JochenYang/Devmind-MCP)** - ⭐ 18
...
2742. **[seedream-image-mcp](https://github.com/wearzdk/seedream-image-mcp)** - ⭐ 18
   🚀 PixelMCP | 为你的 Cursor、Claude Code 等集成AI绘画能力，让AI生成的页面不再单调！

2743. **[mcp-chat-studio](https://github.com/JoeCastrom/mcp-chat-studio)** - ⭐ 18
...
2744. **[mcp-agent](https://github.com/joshuaalpuerto/mcp-agent)** - ⭐ 18
...
2745. **[Zammad-MCP](https://github.com/basher83/Zammad-MCP)** - ⭐ 18
...
2746. **[kratos-mcp](https://github.com/ceorkm/kratos-mcp)** - ⭐ 18
...
2747. **[mcpx](https://github.com/AIGC-Hackers/mcpx)** - ⭐ 18
...
2748. **[ai-cli](https://github.com/manusa/ai-cli)** - ⭐ 18
   ai-cli lets you go from zero to AI-powered in seconds in a safe, automated and tailored way.

2749. **[mcp-server-microsoft-paint](https://github.com/ghuntley/mcp-server-microsoft-paint)** - ⭐ 18

2750. **[GUI-MCP](https://github.com/PhialsBasement/GUI-MCP)** - ⭐ 18
...
2751. **[smartlead-mcp-server](https://github.com/jonathan-politzki/smartlead-mcp-server)** - ⭐ 17
   Local version of Smartlead MCP for quick download and deployment to MCP compatible clients or n8n.

2752. **[mcp-http-client-example](https://github.com/slavashvets/mcp-http-client-example)** - ⭐ 17
   Simple example client demonstrating how to connect to MCP servers over HTTP (SSE)

2753. **[rollbar-mcp-server](https://github.com/rollbar/rollbar-mcp-server)** - ⭐ 17
   Pre-release - Model Context Protocol server for Rollbar

2754. **[jiki](https://github.com/teilomillet/jiki)** - ⭐ 17

2755. **[MCP-Development-with-Rust](https://github.com/RustSandbox/MCP-Development-with-Rust)** - ⭐ 17
...
2756. **[askit](https://github.com/johnrobinsn/askit)** - ⭐ 17
   LLM Function Calling Library and CLI with Support for MCP Servers

2757. **[toolkit-mcp-server](https://github.com/cyanheads/toolkit-mcp-server)** - ⭐ 17
   A Model Context Protocol server providing LLM Agents with system utilities and tools, including IP geolocation, network diagnostics, system monitoring, cryptographic operations, and QR code generation.

2758. **[youtube-mcp-server](https://github.com/0GiS0/youtube-mcp-server)** - ⭐ 17
   Cómo crear MCP Servers y usarlos con GitHub Copilot Chat 🚀💻🤖

2759. **[local_faiss_mcp](https://github.com/nonatofabio/local_faiss_mcp)** - ⭐ 17
   Local FAISS vector store as an MCP server – drop-in local RAG for Claude / Copilot / Agents.

2760. **[cmcp](https://github.com/RussellLuo/cmcp)** - ⭐ 17
   A command-line utility for interacting with MCP servers.

2761. **[short-url](https://github.com/fengzhongsen/short-url)** - ⭐ 17
   简单易用的短链接生成工具，完全开源、免费、无需登录，可私有化部署，链接永久有效！

2762. **[datawrapper-mcp](https://github.com/palewire/datawrapper-mcp)** - ⭐ 17
   A Model Context Protocol (MCP) server for creating Datawrapper charts using AI assistants.

2763. **[it-tools-mcp](https://github.com/wrenchpilot/it-tools-mcp)** - ⭐ 17
...
2764. **[context-lens](https://github.com/cornelcroi/context-lens)** - ⭐ 17
...
2765. **[eraser-io-mcp-server](https://github.com/buck-0x/eraser-io-mcp-server)** - ⭐ 17
   A Python MCP (Model Context Protocol) server and CLI tool to render diagrams using the Eraser API.

2766. **[mcp-chain-of-draft-prompt-tool](https://github.com/brendancopley/mcp-chain-of-draft-prompt-tool)** - ⭐ 17
   MCP prompt tool applying Chain-of-Draft (CoD) reasoning - BYOLLM

2767. **[GUARDRAIL](https://github.com/nshkrdotcom/GUARDRAIL)** - ⭐ 17
   GUARDRAIL - MCP Security - Gateway for Unified Access, Resource Delegation, and Risk-Attenuating Information Limits

2768. **[mcp-oauth-proxy](https://github.com/obot-platform/mcp-oauth-proxy)** - ⭐ 17
   Oauth 2.1 proxy server that can autheticate client and proxy requests to mcp server

2769. **[Augmented-Nature-UniProt-MCP-Server](https://github.com/Augmented-Nature/Augmented-Nature-UniProt-MCP-Server)** - ⭐ 17
   A comprehensive Model Context Protocol (MCP) server providing advanced access to the UniProt protein database. 

2770. **[pi-mcp-adapter](https://github.com/nicobailon/pi-mcp-adapter)** - ⭐ 17
   Token-efficient MCP adapter for Pi coding agent

2771. **[muxi](https://github.com/ranaroussi/muxi)** - ⭐ 16
   An extensible AI agents framework

2772. **[mcp-email-client](https://github.com/gamalan/mcp-email-client)** - ⭐ 16
   Email Client as MCP Server. Feature: multiple configuration, more than just gmail

2773. **[oneshot](https://github.com/Destiner/oneshot)** - ⭐ 16
   Anthropic MCP client for macOS

2774. **[unity-mcp](https://github.com/wondeks/unity-mcp)** - ⭐ 16
   A Unity MCP server that allows MCP clients like Claude Desktop or Cursor to perform Unity Editor actions.

2775. **[CereBro](https://github.com/rob1997/CereBro)** - ⭐ 16
   A model-agnostic MCP Client-Server for .Net and Unity

2776. **[lite-mcp-client](https://github.com/sligter/lite-mcp-client)** - ⭐ 16
   Lite-MCP-Client是一个基于命令行的轻量级MCP客户端工具

2777. **[EasyMCP](https://github.com/mshojaei77/EasyMCP)** - ⭐ 16
...
2778. **[google-scholar-mcp](https://github.com/mochow13/google-scholar-mcp)** - ⭐ 16
   An MCP server for Google Scholar written in TypeScript with Streamable HTTP

2779. **[mcp-installer](https://github.com/joobisb/mcp-installer)** - ⭐ 16
   Simplifies the installation and management of MCP (Model Context Protocol) servers across different AI clients.

2780. **[appvector-mcp](https://github.com/Multivariate-AI-Inc/appvector-mcp)** - ⭐ 16
...
2781. **[daiv](https://github.com/srtab/daiv)** - ⭐ 16
...
2782. **[ACP-MCP-Server](https://github.com/GongRzhe/ACP-MCP-Server)** - ⭐ 16
...
2783. **[protocols-io-mcp-server](https://github.com/hqn21/protocols-io-mcp-server)** - ⭐ 16
   An MCP server that enables MCP clients like Claude Desktop to interact with data from protocols.io.

2784. **[mcp-progressive-agentskill](https://github.com/cablate/mcp-progressive-agentskill)** - ⭐ 16
...
2785. **[Agentic-MCP-Skill](https://github.com/cablate/Agentic-MCP-Skill)** - ⭐ 16
   Agentic-MCP, Progressive MCP client with three-layer lazy loading. Validates AgentSkills.io pattern for efficient token usage. Use MCP without pre-install & wasting full-loading

2786. **[mcp-chatbot](https://github.com/mctrinh/mcp-chatbot)** - ⭐ 16
...
2787. **[codeprism](https://github.com/rustic-ai/codeprism)** - ⭐ 16
...
2788. **[create-mcp](https://github.com/fefergrgrgrg/create-mcp)** - ⭐ 16
   CLI to set up and deploy MCP Servers to Cloudflare Workers in seconds. Just write TypeScript functions to make Cursor MCP tools.

2789. **[pophive-mcp-server](https://github.com/Cicatriiz/pophive-mcp-server)** - ⭐ 16
...
2790. **[MCP-Agent](https://github.com/CursorTouch/MCP-Agent)** - ⭐ 16
   Connect to any MCP servers using agents

2791. **[github-repos-manager-mcp](https://github.com/kurdin/github-repos-manager-mcp)** - ⭐ 16
...
2792. **[Unity-AI-Animation](https://github.com/IvanMurzak/Unity-AI-Animation)** - ⭐ 16
...
2793. **[mcpls](https://github.com/bug-ops/mcpls)** - ⭐ 16
   Universal MCP to LSP bridge - expose Language Server Protocol capabilities as MCP tools for AI agents

2794. **[fusion-mcp-server](https://github.com/Joe-Spencer/fusion-mcp-server)** - ⭐ 16
...
2795. **[Air-Quality-Trends-Analysis-Project](https://github.com/dyneth02/Air-Quality-Trends-Analysis-Project)** - ⭐ 16
...
2796. **[autotask-mcp](https://github.com/asachs01/autotask-mcp)** - ⭐ 16
   MCP server for Kaseya Autotask PSA — 39 tools for companies, tickets, projects, time entries, and more

2797. **[mcp_client](https://github.com/app-appplayer/mcp_client)** - ⭐ 15

2798. **[MCP-Analyzer](https://github.com/klara-research/MCP-Analyzer)** - ⭐ 15
   An MCP server to read MCP logs to debug directly inside the client

2799. **[mistr-agent](https://github.com/itisaevalex/mistr-agent)** - ⭐ 15
...
2800. **[mcp-server](https://github.com/HarperFast/mcp-server)** - ⭐ 15
   An MCP server providing an interface for MCP clients to access data within Harper.

2801. **[sveltekit-mcp-starter](https://github.com/axel-rock/sveltekit-mcp-starter)** - ⭐ 15

2802. **[mcp-this](https://github.com/shane-kercheval/mcp-this)** - ⭐ 15
...
2803. **[substack-mcp](https://github.com/marcomoauro/substack-mcp)** - ⭐ 15
...
2804. **[QCX](https://github.com/QueueLab/QCX)** - ⭐ 15
   Language to Maps

2805. **[django-firebase-mcp](https://github.com/raghavdasila/django-firebase-mcp)** - ⭐ 15
...
2806. **[jenkins-mcp-enterprise](https://github.com/Jordan-Jarvis/jenkins-mcp-enterprise)** - ⭐ 15
...
2807. **[claude-server](https://github.com/davidteren/claude-server)** - ⭐ 15
...
2808. **[pinmeto-location-mcp](https://github.com/PinMeTo/pinmeto-location-mcp)** - ⭐ 15
   PinMeTo MCP server that enables users with authorized credentials to unlock their data 

2809. **[grok-faf-mcp](https://github.com/Wolfe-Jam/grok-faf-mcp)** - ⭐ 15
   First MCP server for Grok | FAST⚡️AF • URL-based AI context • Vercel-deployed

2810. **[mcp-server-amazon](https://github.com/rigwild/mcp-server-amazon)** - ⭐ 15
   🛍📦 Unofficial Amazon Model Context Protocol Server (MCP) - Search products and purchase directly from Claude AI! ✨

2811. **[awesome-dxt-mcp](https://github.com/MCPStar/awesome-dxt-mcp)** - ⭐ 15
...
2812. **[npm-search-mcp-server](https://github.com/btwiuse/npm-search-mcp-server)** - ⭐ 15
   MCP server for searching npm packages

2813. **[mcp-client-and-proxy](https://github.com/appsecco/mcp-client-and-proxy)** - ⭐ 15
   A universal MCP client with proxying feature to interact with MCP Servers which support STDIO transport.

2814. **[mcp-server-python-template](https://github.com/sontallive/mcp-server-python-template)** - ⭐ 15
   This template provides a streamlined foundation for building Model Context Protocol (MCP) servers in Python. It's designed to make AI-assisted development of MCP tools easier and more efficient.

2815. **[autowpmcp](https://github.com/Njengah/autowpmcp)** - ⭐ 15
...
2816. **[mcp-koii](https://github.com/benjaminr/mcp-koii)** - ⭐ 15
   MCP Server for Teenage Engineering EP-133 KO-II

2817. **[mcp-graphql-forge](https://github.com/toolprint/mcp-graphql-forge)** - ⭐ 15
   MCP that can proxy any GraphQL API and expose graphql operations as mcp tools.

2818. **[arxiv-mcp-server](https://github.com/anuj0456/arxiv-mcp-server)** - ⭐ 15
...
2819. **[qdrant-mcp-server](https://github.com/mhalder/qdrant-mcp-server)** - ⭐ 15
   MCP server for semantic search using local Qdrant vector database and OpenAI embeddings

2820. **[unity-editor-mcp](https://github.com/ozankasikci/unity-editor-mcp)** - ⭐ 15
   An MCP server and client for LLMs to interact with Unity Projects

2821. **[systemprompt-mcp-core](https://github.com/Ejb503/systemprompt-mcp-core)** - ⭐ 14
   The core MCP extension for Systemprompt MCP multimodal client

2822. **[Open-MCP-Client](https://github.com/GongRzhe/Open-MCP-Client)** - ⭐ 14
...
2823. **[signal-mcp-client](https://github.com/piebro/signal-mcp-client)** - ⭐ 14
   An MCP client that uses signal for sending and receiving messages.

2824. **[vite-plugin-mcp-client-tools](https://github.com/atesgoral/vite-plugin-mcp-client-tools)** - ⭐ 14
   Pluggable Vite MCP plugin that brings client-side tools to your existing Vite setup

2825. **[llm-sse-mcp-demo-2025](https://github.com/nlinhvu/llm-sse-mcp-demo-2025)** - ⭐ 14
...
2826. **[mcp-bundler](https://github.com/wrtnlabs/mcp-bundler)** - ⭐ 14
   Is the MCP configuration too complicated? You can easily share your own simplified setup!

2827. **[mcp-tui](https://github.com/msabramo/mcp-tui)** - ⭐ 14
   MCP host app w/ textual user interface, in Python

2828. **[mcp-turso-cloud](https://github.com/spences10/mcp-turso-cloud)** - ⭐ 14
...
2829. **[ntfy-mcp-server](https://github.com/cyanheads/ntfy-mcp-server)** - ⭐ 14
   An MCP (Model Context Protocol) server designed to interact with the ntfy push notification service. It enables LLMs and AI agents to send notifications to your devices with extensive customization options.

2830. **[hasmcp-ce](https://github.com/hasmcp/hasmcp-ce)** - ⭐ 14
   HasMCP Community Edition

2831. **[gh-mcp](https://github.com/shuymn/gh-mcp)** - ⭐ 14
...
2832. **[the-academy](https://github.com/im-knots/the-academy)** - ⭐ 14
   A Socratic dialogue engine for AI agents. 

2833. **[mcpterm](https://github.com/dwrtz/mcpterm)** - ⭐ 14
   An MCP tool server that provides stateful, TUI-compatible terminal sessions.

2834. **[work-memory-mcp](https://github.com/moontmsai/work-memory-mcp)** - ⭐ 14
   Never lose context again - persistent memory management system for AI-powered workflows across multiple tools

2835. **[emceepee](https://github.com/eastlondoner/emceepee)** - ⭐ 14
...
2836. **[hoot](https://github.com/Portkey-AI/hoot)** - ⭐ 14
   MCP Testing Tool — Like Postman, but for the Model Context Protocol.

2837. **[notebooklm-mcp-secure](https://github.com/Pantheon-Security/notebooklm-mcp-secure)** - ⭐ 14
   Secure NotebookLM MCP Server - Query Google NotebookLM from Claude/AI agents with 14 security hardening layers

2838. **[Blender-MCP-Server](https://github.com/poly-mcp/Blender-MCP-Server)** - ⭐ 14
...
2839. **[docmole](https://github.com/Vigtu/docmole)** - ⭐ 14
   Dig through any documentation with AI - MCP server for Claude, Cursor, and other AI assistants

2840. **[spring-ai-mcp-deepseek](https://github.com/firefly0512/spring-ai-mcp-deepseek)** - ⭐ 13
   使用 Spring AI 整合 MCP 服务，包括 MCP server 和 deepseek client

2841. **[llamacppMCPClientDemo](https://github.com/brucepro/llamacppMCPClientDemo)** - ⭐ 13
   standalone react MCP client using SSE

2842. **[sample-multi-tenant-saas-mcp-server](https://github.com/aws-samples/sample-multi-tenant-saas-mcp-server)** - ⭐ 13
   Multi-Tenant remote MCP server with Amazon Cognito and remote client with Amazon Bedrock hosted on AWS

2843. **[mcp-chat-client](https://github.com/Ceeon/mcp-chat-client)** - ⭐ 13
   基于高德地图MCP服务的聊天客户端

2844. **[mcp-client-compatibility](https://github.com/tadata-org/mcp-client-compatibility)** - ⭐ 13

2845. **[mcp-client-laravel](https://github.com/RedberryProducts/mcp-client-laravel)** - ⭐ 13
...
2846. **[mcp-web-client](https://github.com/hemanth/mcp-web-client)** - ⭐ 13
   A web-based client for connecting to MCP servers with OAuth support

2847. **[mcp-client-for-weather-example](https://github.com/a-persimmons/mcp-client-for-weather-example)** - ⭐ 13
   一个MCP客户端实践：实现LLM调用天气MCP服务端查询天气的快速示例

2848. **[mcp-perplexity-server](https://github.com/PoliTwit1984/mcp-perplexity-server)** - ⭐ 13
...
2849. **[mcp-more](https://github.com/toosean/mcp-more)** - ⭐ 13
   A modern desktop application for managing Model Context Protocol (MCP) servers.

2850. **[MCP-Manager-GUI](https://github.com/gabrielbacha/MCP-Manager-GUI)** - ⭐ 13
   MCP Toggle is a simple GUI tool to help you manage MCP servers across clients seamlessly.

2851. **[easy-mcp-use](https://github.com/dforel/easy-mcp-use)** - ⭐ 13
...
2852. **[mcphawk](https://github.com/tech4242/mcphawk)** - ⭐ 13
...
2853. **[mcp-server-templates](https://github.com/Data-Everything/mcp-server-templates)** - ⭐ 13
   A flexible platform that provides Docker & Kubernetes backends, a lightweight CLI (mcpt), and client utilities for seamless MCP integration. Spin up servers from templates, route requests through a single endpoint with load balancing, and support both deployed (HTTP) and local (stdio) transports — all with sensible defaults and YAML-based configs.

2854. **[mcp-test-client](https://github.com/crazyrabbitLTC/mcp-test-client)** - ⭐ 13
   MCP Test Client is a TypeScript testing utility for Model Context Protocol (MCP) servers.

2855. **[deep-research](https://github.com/troyhantech/deep-research)** - ⭐ 13
   A minimalist deep research framework for any OpenAI API compatible LLMs. 

2856. **[Frontapp-MCP](https://github.com/zqushair/Frontapp-MCP)** - ⭐ 13
   MCP server and client for Frontapp

2857. **[mcp-config-editor](https://github.com/kaichen/mcp-config-editor)** - ⭐ 13
   A simple GUI for managing MCP servers, for easy toggle mcp servers.

2858. **[deep-directory-tree-mcp](https://github.com/andredezzy/deep-directory-tree-mcp)** - ⭐ 13
...
2859. **[mcp-ipfs](https://github.com/alexbakers/mcp-ipfs)** - ⭐ 13
   🪐 MCP IPFS Server 

2860. **[uk-case-law-mcp-server](https://github.com/georgejeffers/uk-case-law-mcp-server)** - ⭐ 13
   MCP server for UK case law using The National Archives API. Enables LLMs to search, retrieve, and cite UK legal judgments.

2861. **[mongo-mcp](https://github.com/1RB/mongo-mcp)** - ⭐ 13
   MCP server that provide tools to LLMs such as claude in cursor to interact with MongoDB

2862. **[mcp-server-subagent](https://github.com/dvcrn/mcp-server-subagent)** - ⭐ 13
   MCP for letting agents delegate tasks to sub-agents (Claude Code, Aider, Q)

2863. **[django-mcp](https://github.com/hyperb1iss/django-mcp)** - ⭐ 13
...
2864. **[memory-mcp-server](https://github.com/hpkv-io/memory-mcp-server)** - ⭐ 13
   A MCP (Model Context Protocol) server providing long-term memory for LLMs

2865. **[mcp-web-search-tool](https://github.com/gabrimatic/mcp-web-search-tool)** - ⭐ 13
   A MCP server providing real-time web search capabilities to any AI model.

2866. **[jadx-mcp-server](https://github.com/Qtty/jadx-mcp-server)** - ⭐ 13
   A Pure-Java MCP Server for JaDX Android Reverse Engineering Tool

2867. **[hive-crypto-mcp](https://github.com/hive-intel/hive-crypto-mcp)** - ⭐ 13
...
2868. **[IoT-Edge-MCP-Server](https://github.com/poly-mcp/IoT-Edge-MCP-Server)** - ⭐ 13
...
2869. **[mcp-jest](https://github.com/josharsh/mcp-jest)** - ⭐ 13
   Automated testing for Model Context Protocol servers. Ship MCP Servers with confidence.

2870. **[mcpdog](https://github.com/kinhunt/mcpdog)** - ⭐ 13
...
2871. **[MCP-Platform](https://github.com/Data-Everything/MCP-Platform)** - ⭐ 13
   A flexible platform that provides Docker & Kubernetes backends, a lightweight CLI (mcpt), and client utilities for seamless MCP integration. Spin up servers from templates, route requests through a single endpoint with load balancing, and support both deployed (HTTP) and local (stdio) transports — all with sensible defaults and YAML-based configs

2872. **[mcp-client-langchain-ts](https://github.com/hideya/mcp-client-langchain-ts)** - ⭐ 13
   Simple MCP Client CLI Implementation Using LangChain ReAct Agent / TypeScript

2873. **[chatgpt-app-typescript-template](https://github.com/pomerium/chatgpt-app-typescript-template)** - ⭐ 13
...
2874. **[llama-nexus](https://github.com/LlamaEdge/llama-nexus)** - ⭐ 12
   A gateway service designed to manage and orchestrate OpenAI-compatible API servers with MCP support.

2875. **[st_rag_mcp](https://github.com/digital-duck/st_rag_mcp)** - ⭐ 12
   MCP streamlit client with RAG support for tool search

2876. **[n8n-coolify-mcp-tools](https://github.com/wrediam/n8n-coolify-mcp-tools)** - ⭐ 12
...
2877. **[mcp-server-manager](https://github.com/infinitimeless/mcp-server-manager)** - ⭐ 12
   A tool to create, build, and manage MCP servers for use with Claude and other MCP clients

2878. **[MCP-Client-Server-for-agents](https://github.com/qmatteoq/MCP-Client-Server-for-agents)** - ⭐ 12
   This project demonstrates a Model Context Protocol (MCP) server and client implementation in .NET

2879. **[capture-mcp-server](https://github.com/blencorp/capture-mcp-server)** - ⭐ 12
...
2880. **[mcp-safe-run](https://github.com/ithena-one/mcp-safe-run)** - ⭐ 12
...
2881. **[xcf](https://github.com/CodeFreezeAI/xcf)** - ⭐ 12
   Xcode MCP Server xcf is a 100% Swift based allowing you to integrate Xcode with your favorite AI IDE or MCP Client

2882. **[CursorMCPMonitor](https://github.com/willibrandon/CursorMCPMonitor)** - ⭐ 12
...
2883. **[SchemaPin](https://github.com/ThirdKeyAI/SchemaPin)** - ⭐ 12
   The SchemaPin protocol for cryptographically signing and verifying AI agent tool schemas to prevent supply-chain attacks.

2884. **[Tinvo](https://github.com/imxcstar/Tinvo)** - ⭐ 12
   LLM AI Client based on Blazor. (openai, chatgpt, llama, ollama, onnx, deepseekr1...)

2885. **[signoz-mcp-server](https://github.com/DrDroidLab/signoz-mcp-server)** - ⭐ 12
   Connect your Signoz Instance with Cursor, Claude Desktop or any other MCP Compatible Client

2886. **[gemma-mcp](https://github.com/monatis/gemma-mcp)** - ⭐ 12
   MCP Client for Gemma-3

2887. **[context-kit](https://github.com/eyalzh/context-kit)** - ⭐ 12
   A CLI tool and MCP client, used to create spec files for AI coding agents with context baked in

2888. **[codepilot](https://github.com/rohittcodes/codepilot)** - ⭐ 12
   A multi-agent CLI tool powered by Swarms-rs and Composio

2889. **[mlb-mcp](https://github.com/etweisberg/mlb-mcp)** - ⭐ 12
   MCP server for advanced baseball analytics (statcast, fangraphs, baseball reference, mlb stats API) with client demo 

2890. **[muster](https://github.com/giantswarm/muster)** - ⭐ 12
   MCP tool management and workflow proxy

2891. **[Convert-Markdown-PDF-MCP](https://github.com/seanivore/Convert-Markdown-PDF-MCP)** - ⭐ 12
   Markdown To PDF Conversion MCP

2892. **[vmware-esxi-mcp](https://github.com/uldyssian-sh/vmware-esxi-mcp)** - ⭐ 12
...
2893. **[owl-mcp](https://github.com/ai4curation/owl-mcp)** - ⭐ 12
   MCP server for OWL applications

2894. **[openwebui-mcp-setup](https://github.com/sonzentherevolution/openwebui-mcp-setup)** - ⭐ 12
...
2895. **[skill-to-mcp](https://github.com/biocontext-ai/skill-to-mcp)** - ⭐ 12
   Convert AI Skills (Claude Skills format) to MCP server resources - Part of BioContextAI

2896. **[porkbun-mcp-server](https://github.com/miraclebakelaser/porkbun-mcp-server)** - ⭐ 12
   MCP server implementation for managing domains, DNS, and SSL via the Porkbun API.

2897. **[mcp-meme-sticky](https://github.com/nkapila6/mcp-meme-sticky)** - ⭐ 12
...
2898. **[proxy-base-agent](https://github.com/TheProxyCompany/proxy-base-agent)** - ⭐ 12
   A stateful agent with 100% reliable tool use. Build custom agents on any LLM with guaranteed state consistency.

2899. **[automagik-tools](https://github.com/namastexlabs/automagik-tools)** - ⭐ 12
   From API to AI in 30 Seconds - Transform any API into an intelligent MCP agent that learns, adapts, and speaks human

2900. **[prompt-engineer-mcp-server](https://github.com/hireshBrem/prompt-engineer-mcp-server)** - ⭐ 12
   Write 10x better prompts using Prompt Engineer MCP server.

2901. **[create-mcp-server-kit](https://github.com/Epi-1120/create-mcp-server-kit)** - ⭐ 12
   Scaffold a production-ready Model Context Protocol (MCP) server in seconds.

2902. **[memory-visualizer](https://github.com/mjherich/memory-visualizer)** - ⭐ 12
...
2903. **[MIST](https://github.com/CLoaKY233/MIST)** - ⭐ 12
...
2904. **[mcp-salesforce](https://github.com/AiondaDotCom/mcp-salesforce)** - ⭐ 12
...
2905. **[llms-txt-generator](https://github.com/aircodelabs/llms-txt-generator)** - ⭐ 12
   The ultimate AI-powered generator for llms.txt and llms-full.txt files. 

2906. **[ebay-mcp](https://github.com/YosefHayim/ebay-mcp)** - ⭐ 12
...
2907. **[Unity-AI-ProBuilder](https://github.com/IvanMurzak/Unity-AI-ProBuilder)** - ⭐ 12
...
2908. **[mcp-windows-automation](https://github.com/mukul975/mcp-windows-automation)** - ⭐ 12
...
2909. **[ckan-mcp-server](https://github.com/ondics/ckan-mcp-server)** - ⭐ 12
...
2910. **[claude_autoapprove](https://github.com/PyneSys/claude_autoapprove)** - ⭐ 12
   Autoapprove support for claude

2911. **[UCAI](https://github.com/nirholas/UCAI)** - ⭐ 12
...
2912. **[mcp-server-gemini-pro](https://github.com/gurveeer/mcp-server-gemini-pro)** - ⭐ 12
...
2913. **[mcp-obsidian](https://github.com/Piotr1215/mcp-obsidian)** - ⭐ 12
   simple mcp server for interacting with local obsidian notes

2914. **[ia-na-pratica](https://github.com/Code4Delphi/ia-na-pratica)** - ⭐ 11
   IA na Prática: LLM, RAG, MCP, Agents, Function Calling, Multimodal, TTS/STT e mais

2915. **[mcp_client_rust](https://github.com/darinkishore/mcp_client_rust)** - ⭐ 11

2916. **[mcp-client](https://github.com/EuclideanAI/mcp-client)** - ⭐ 11
...
2917. **[MCP_Client](https://github.com/andrewdeng318/MCP_Client)** - ⭐ 11

2918. **[mcp-spotify-player](https://github.com/vsaez/mcp-spotify-player)** - ⭐ 11
   MCP server to manage Spotify from MCP clients

2919. **[trebuchet](https://github.com/fuzzball-muck/trebuchet)** - ⭐ 11
   A MUD/MUCK/MUSH chat client with MCP/GUI support.

2920. **[mcp-wikipedia](https://github.com/algonacci/mcp-wikipedia)** - ⭐ 11
   MCP server to give client the ability to access Wikipedia pages

2921. **[systemprompt-mcp-gmail](https://github.com/Ejb503/systemprompt-mcp-gmail)** - ⭐ 11
...
2922. **[mcp-client-app](https://github.com/RegiByte/mcp-client-app)** - ⭐ 11
   A mcp client chat application built for learning purposes

2923. **[mcp-browser-automation](https://github.com/hrmeetsingh/mcp-browser-automation)** - ⭐ 11
   Model Context Protocol based AI Agent that runs a browser from Claude desktop

2924. **[simple-nodejs-mcp-client](https://github.com/sawa-zen/simple-nodejs-mcp-client)** - ⭐ 11
...
2925. **[ggMCP4VSCode](https://github.com/n2ns/ggMCP4VSCode)** - ⭐ 11
   Google Gemini Model Context Protocol (MCP) Client for VS Code. Connect AI assistants to local context & tools.

2926. **[goldrush-mcp-server](https://github.com/covalenthq/goldrush-mcp-server)** - ⭐ 11
...
2927. **[langchain-mcp-tools-ts-usage](https://github.com/hideya/langchain-mcp-tools-ts-usage)** - ⭐ 11
   MCP Tools Usage From LangChain ReAct Agent / Example in TypeScript

2928. **[mcp-chat-widget](https://github.com/aimdoc-ai/mcp-chat-widget)** - ⭐ 11
...
2929. **[oauth-callback](https://github.com/kriasoft/oauth-callback)** - ⭐ 11
   Lightweight OAuth 2.0 authorization code capture for CLI tools & desktop   apps. Works with Node.js, Deno, Bun. MCP SDK ready.

2930. **[semantictool](https://github.com/promptmesh/semantictool)** - ⭐ 11
   tool management service for performing vector tool calling at scale.

2931. **[davinci-mcp-professional](https://github.com/Positronikal/davinci-mcp-professional)** - ⭐ 11
...
2932. **[mcpconnect](https://github.com/rocket-connect/mcpconnect)** - ⭐ 11
   Inspect and debug Model Context Protocol servers directly in your browser.

2933. **[smartlead-mcp-server](https://github.com/LeadMagic/smartlead-mcp-server)** - ⭐ 11
...
2934. **[osmmcp](https://github.com/NERVsystems/osmmcp)** - ⭐ 11
...
2935. **[locust-mcp-server](https://github.com/QAInsights/locust-mcp-server)** - ⭐ 11
   A Model Context Protocol (MCP) server implementation for running Locust load tests. This server enables seamless integration of Locust load testing capabilities with AI-powered development environments.

2936. **[ultrathink](https://github.com/husniadil/ultrathink)** - ⭐ 11
...
2937. **[scorable-mcp](https://github.com/root-signals/scorable-mcp)** - ⭐ 11
   MCP for Scorable Evaluation Platform

2938. **[vector_mcp](https://github.com/sergiobayona/vector_mcp)** - ⭐ 11
   A server implementation for the Model Context Protocol (MCP) in Ruby.

2939. **[pentest-mcp-server](https://github.com/LayeSec006/pentest-mcp-server)** - ⭐ 11
   MCP server for penetration testing

2940. **[mcp-boilerplate](https://github.com/iamsrikanthnani/mcp-boilerplate)** - ⭐ 11
...
2941. **[emcp](https://github.com/joeymeere/emcp)** - ⭐ 11
   A framework for building simple MCP servers with custom middleware

2942. **[local-history-mcp](https://github.com/xxczaki/local-history-mcp)** - ⭐ 11
   MCP server for accessing VS Code/Cursor's Local History

2943. **[gsd-task-manager](https://github.com/vscarpenter/gsd-task-manager)** - ⭐ 11
...
2944. **[hass-mcp-server](https://github.com/ganhammar/hass-mcp-server)** - ⭐ 11
...
2945. **[predictive-maintenance-mcp](https://github.com/LGDiMaggio/predictive-maintenance-mcp)** - ⭐ 11
...
2946. **[RAG-MCP](https://github.com/cr21/RAG-MCP)** - ⭐ 11
   Simple RAG implementation from scratch using MCP, focusing on Perception, Memory, Decision and Action

2947. **[local-skills-mcp](https://github.com/kdpa-llc/local-skills-mcp)** - ⭐ 11
   Universal MCP server enabling any LLM or AI agent to utilize expert skills from your local filesystem. Reduces context consumption through lazy loading. Works with Claude, Cline, and any MCP-compatible client.

2948. **[mcp-delphi](https://github.com/flydev-fr/mcp-delphi)** - ⭐ 11
   Delphi and Lazarus/FPC MCP server: build/clean pascal projects via MCP tools.

2949. **[local-mcp-gateway](https://github.com/DXHeroes/local-mcp-gateway)** - ⭐ 11
   Aggregate multiple MCP servers into a single endpoint with web UI, OAuth 2.1, and profile-based tool management

2950. **[puppeteer-mcp-server](https://github.com/sultannaufal/puppeteer-mcp-server)** - ⭐ 11
...
2951. **[langchain-mcp-client](https://github.com/datalayer/langchain-mcp-client)** - ⭐ 10
   🦜🔗 LangChain Model Context Protocol (MCP) Client

2952. **[mcp-client-langchain-py](https://github.com/hideya/mcp-client-langchain-py)** - ⭐ 10
   Simple MCP Client CLI Implementation Using LangChain ReAct Agent / Python

2953. **[openalgo-mcp](https://github.com/marketcalls/openalgo-mcp)** - ⭐ 10
   Documentation

2954. **[mcp_client_openai](https://github.com/liangpn/mcp_client_openai)** - ⭐ 10
   适配Openai SDK构建MCP Client

2955. **[mcp-serverman](https://github.com/benhaotang/mcp-serverman)** - ⭐ 10
   a cli/mcp server tool for managing mcp server json config file with version control, profiles and multi-client support

2956. **[py-mcp-sse](https://github.com/jayliangdl/py-mcp-sse)** - ⭐ 10
   MCP Client 与 MCP Server基于SSE方式的样例实现（Python版本）

2957. **[mcpkit](https://github.com/cybertheory/mcpkit)** - ⭐ 10
   Easy to use Official MCP Registry Client UI. npx @cybertheory/mcpkit

2958. **[AIFoundry-MCPConnector-FabricGraphQL](https://github.com/LazaUK/AIFoundry-MCPConnector-FabricGraphQL)** - ⭐ 10
...
2959. **[server](https://github.com/mcpfinder/server)** - ⭐ 10
...
2960. **[kanboard-mcp](https://github.com/ChristianJStarr/kanboard-mcp)** - ⭐ 10
...
2961. **[emotion_ai](https://github.com/angrysky56/emotion_ai)** - ⭐ 10
...
2962. **[mcp-express-adapter](https://github.com/Moe03/mcp-express-adapter)** - ⭐ 10
   Run multiple MCP clients on a NodeJS Express server (adapter/middleware)

2963. **[mcp-trace](https://github.com/zabirauf/mcp-trace)** - ⭐ 10
   A TUI to probe the calls between MCP client and server

2964. **[mcp-server-blog](https://github.com/portal-labs-infrastructure/mcp-server-blog)** - ⭐ 10
   Example of a MCP implementation using TypeScript and OAuth.

2965. **[unity-mcp-template](https://github.com/dunward/unity-mcp-template)** - ⭐ 10
   Simple template project for controlling Unity via MCP

2966. **[awesome-mcp-hardware](https://github.com/beriberikix/awesome-mcp-hardware)** - ⭐ 10
   Awesome list of MCP servers for interacting with hardware and the physical world.

2967. **[polaris](https://github.com/octu0/polaris)** - ⭐ 10
   Distributed AI Agent Framework

2968. **[mcp-agent-proxy](https://github.com/mashh-lab/mcp-agent-proxy)** - ⭐ 10
   An MCP server that exposes local and remote agents across different servers as MCP tools.

2969. **[amazon-seller-mcp](https://github.com/enginterzi/amazon-seller-mcp)** - ⭐ 10
...
2970. **[auto-mcp-client](https://github.com/down-to-earth1994/auto-mcp-client)** - ⭐ 10
...
2971. **[programmatic-tool-calling-ai-sdk](https://github.com/cameronking4/programmatic-tool-calling-ai-sdk)** - ⭐ 10
...
2972. **[mcp-add](https://github.com/paoloricciuti/mcp-add)** - ⭐ 10
   Universal cli to add an MCP server to a variety of clients

2973. **[mcp-kit](https://github.com/shaharia-lab/mcp-kit)** - ⭐ 10
   MCP (Model Context Protocol) Kit for Go - A Complete MCP solutions for ready to use

2974. **[CodeCompass](https://github.com/alvinveroy/CodeCompass)** - ⭐ 10
...
2975. **[french-tax-mcp](https://github.com/cornelcroi/french-tax-mcp)** - ⭐ 10
   MCP server for French tax calculations and information - enables AI assistants to provide accurate French tax guidance

2976. **[claude-context-local](https://github.com/MikeO-AI/claude-context-local)** - ⭐ 10
...
2977. **[springboot-ai-mcp-example](https://github.com/duongminhhieu/springboot-ai-mcp-example)** - ⭐ 10
   Example Spring AI Model Context Protocol (MCP)

2978. **[mcp-space](https://github.com/tharuneshwar-s/mcp-space)** - ⭐ 10
...
2979. **[mode-manager-mcp](https://github.com/NiclasOlofsson/mode-manager-mcp)** - ⭐ 10
   MCP Memory Agent Server - A VS Code chatmode and instruction manager with library integration

2980. **[mcp-reporter](https://github.com/cyanheads/mcp-reporter)** - ⭐ 10
...
2981. **[mcp-starter-template-ts](https://github.com/onamfc/mcp-starter-template-ts)** - ⭐ 10
...
2982. **[prometheus-protocol](https://github.com/prometheus-protocol/prometheus-protocol)** - ⭐ 10
...
2983. **[rec-us-mcp-server](https://github.com/elizabethsiegle/rec-us-mcp-server)** - ⭐ 10
   Book a San Francisco tennis court via MCP server w/ auth

2984. **[mcp-demo](https://github.com/sshh12/mcp-demo)** - ⭐ 10
...
2985. **[AgentX-mcp-servers](https://github.com/AgentX-ai/AgentX-mcp-servers)** - ⭐ 10
   List of open sourced MCP servers. MIT license. Managed by AgentX with love.

2986. **[mcp-tradovate](https://github.com/0xjmp/mcp-tradovate)** - ⭐ 10
   MCP server for the Tradovate platform

2987. **[mcp-claude-hackernews](https://github.com/imprvhub/mcp-claude-hackernews)** - ⭐ 10
   An integration that allows Claude Desktop to interact with Hacker News using the Model Context Protocol (MCP).

2988. **[teamcity-mcp](https://github.com/Daghis/teamcity-mcp)** - ⭐ 10
...
2989. **[glasses-mcp](https://github.com/gourraguis/glasses-mcp)** - ⭐ 10
   Glasses MCP is a simple MCP server that lets your AI agent see and capture the web 👓

2990. **[ObsidianMCPServer](https://github.com/otaviocc/ObsidianMCPServer)** - ⭐ 10
   A Model Context Protocol (MCP) server that enables AI assistants to interact with your Obsidian vault 

2991. **[mcp-sys-bridge](https://github.com/leynier/mcp-sys-bridge)** - ⭐ 10
...
2992. **[sec-edgar-agentkit](https://github.com/stefanoamorelli/sec-edgar-agentkit)** - ⭐ 10
...
2993. **[druid-mcp-server](https://github.com/iunera/druid-mcp-server)** - ⭐ 10
...
2994. **[companies-house-mcp](https://github.com/stefanoamorelli/companies-house-mcp)** - ⭐ 10
...
2995. **[context-engineering-mcp](https://github.com/bralca/context-engineering-mcp)** - ⭐ 10
...
2996. **[universal-crypto-mcp](https://github.com/nirholas/universal-crypto-mcp)** - ⭐ 10
...
2997. **[temple-bridge](https://github.com/templetwo/temple-bridge)** - ⭐ 10
...
2998. **[nautobot_mcp](https://github.com/kvncampos/nautobot_mcp)** - ⭐ 10
...
1. **[chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat)** - ⭐ 40,762
   基于大模型搭建的聊天机器人，同时支持 微信公众号、企业微信应用、飞书、钉钉 等接入，可选择ChatGPT/Claude/DeepSeek/文心一言/讯飞星火/通义千问/ Gemini/GLM-4/Kimi/LinkAI，能处理文本、语音和图片，访问操作系统和互联网，支持基于自有知识库进行定制企业智能客服。

2. **[bytebot](https://github.com/bytebot-ai/bytebot)** - ⭐ 10,278
   Bytebot is a self-hosted AI desktop agent that automates computer tasks through natural language commands, operating within a containerized Linux desktop environment.

3. **[valuecell](https://github.com/ValueCell-ai/valuecell)** - ⭐ 8,444
   ValueCell is a community-driven, multi-agent platform for financial applications.

4. **[deepchat](https://github.com/ThinkInAIXYZ/deepchat)** - ⭐ 5,417
   🐬DeepChat - A smart assistant that connects powerful AI to your personal world

5. **[ruoyi-ai](https://github.com/ageerle/ruoyi-ai)** - ⭐ 4,711
   RuoYi AI 是一个全栈式 AI 开发平台，旨在帮助开发者快速构建和部署个性化的 AI 应用。

6. **[koog](https://github.com/JetBrains/koog)** - ⭐ 3,650
...
9. **[supermemory-mcp](https://github.com/supermemoryai/supermemory-mcp)** - ⭐ 1,590
...
14. **[flow-like](https://github.com/TM9657/flow-like)** - ⭐ 576
...
17. **[a2a-x402](https://github.com/google-agentic-commerce/a2a-x402)** - ⭐ 423
   The A2A x402 Extension brings cryptocurrency payments to the Agent-to-Agent (A2A) protocol, enabling agents to monetize their services through on-chain payments. This extension revives the spirit of HTTP 402 "Payment Required" for the decentralized agent ecosystem.

18. **[self-dify](https://github.com/datawhalechina/self-dify)** - ⭐ 305
...
23. **[airbyte-agent-connectors](https://github.com/airbytehq/airbyte-agent-connectors)** - ⭐ 100
...
1. **[n8n](https://github.com/n8n-io/n8n)** - ⭐ 170,920
   Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.

2. **[kong](https://github.com/Kong/kong)** - ⭐ 42,585
   🦍 The API and AI Gateway

3. **[LocalAI](https://github.com/mudler/LocalAI)** - ⭐ 42,307
   :robot: The free, Open Source alternative to OpenAI, Claude and others. Self-hosted and local-first. Drop-in replacement,  running on consumer-grade hardware. No GPU required. Runs gguf, transformers, diffusers and many more. Features: Generate Text, MCP, Audio, Video, Images, Voice Cloning, Distributed, P2P and decentralized inference

4. **[FastGPT](https://github.com/labring/FastGPT)** - ⭐ 26,978
   FastGPT is a knowledge-based platform built on the LLMs, offers a comprehensive suite of out-of-the-box capabilities such as data processing, RAG retrieval, and visual AI workflow orchestration, letting you easily develop and deploy complex question-answering systems without the need for extensive setup or configuration.

5. **[kratos](https://github.com/go-kratos/kratos)** - ⭐ 25,374
   Your ultimate Go microservices framework for the cloud-native era.

6. **[excelize](https://github.com/qax-os/excelize)** - ⭐ 20,221
   Go language library for reading and writing Microsoft Excel™ (XLAM / XLSM / XLSX / XLTM / XLTX) spreadsheets

7. **[plate](https://github.com/udecode/plate)** - ⭐ 15,827
   Rich-text editor with AI, MCP, and shadcn/ui

8. **[AstrBot](https://github.com/AstrBotDevs/AstrBot)** - ⭐ 15,159
...
12. **[note-gen](https://github.com/codexu/note-gen)** - ⭐ 10,590
   A cross-platform Markdown AI note-taking software.

13. **[langchain4j](https://github.com/langchain4j/langchain4j)** - ⭐ 10,494
   LangChain4j is an open-source Java library that simplifies the integration of LLMs into Java applications through a unified API, providing access to popular LLMs and vector databases. It makes implementing RAG, tool calling (including support for MCP), and agents easy. LangChain4j integrates seamlessly with various enterprise Java frameworks.

14. **[astron-agent](https://github.com/iflytek/astron-agent)** - ⭐ 8,845
   Enterprise-grade, commercial-friendly agentic workflow platform for building next-generation SuperAgents.

15. **[OpenMetadata](https://github.com/open-metadata/OpenMetadata)** - ⭐ 8,505
   OpenMetadata is a unified metadata platform for data discovery, data observability, and data governance powered by a central metadata repository, in-depth column level lineage, and seamless team collaboration.

16. **[Upsonic](https://github.com/Upsonic/Upsonic)** - ⭐ 7,750
   Agent Framework For Fintech and Banks

17. **[53AIHub](https://github.com/53AI/53AIHub)** - ⭐ 7,696
...
18. **[lamda](https://github.com/firerpa/lamda)** - ⭐ 7,567
    The most powerful Android RPA agent framework, next generation of mobile automation robots.

19. **[adk-go](https://github.com/google/adk-go)** - ⭐ 6,727
   An open-source, code-first Go toolkit for building, evaluating, and deploying sophisticated AI agents with flexibility and control.

20. **[Viper](https://github.com/FunnyWolf/Viper)** - ⭐ 4,885
   Adversary simulation and Red teaming platform with AI

21. **[magic](https://github.com/dtyq/magic)** - ⭐ 4,445
   Super Magic. The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)

22. **[ENScan_GO](https://github.com/wgpsec/ENScan_GO)** - ⭐ 4,177
...
24. **[ag2](https://github.com/ag2ai/ag2)** - ⭐ 4,082
   AG2 (formerly AutoGen): The Open-Source AgentOS. Join us at: https://discord.gg/sNGSwQME3x

25. **[kubefwd](https://github.com/txn2/kubefwd)** - ⭐ 4,027
   Bulk port forwarding Kubernetes services for local development.

26. **[Yuxi-Know](https://github.com/xerrors/Yuxi-Know)** - ⭐ 4,020
...
27. **[manifest](https://github.com/mnfst/manifest)** - ⭐ 3,283
   A shadcn/ui library for building ChatGPT Apps

28. **[semantic-router](https://github.com/vllm-project/semantic-router)** - ⭐ 2,904
...
30. **[ultracite](https://github.com/haydenbleasel/ultracite)** - ⭐ 2,586
   A highly opinionated, zero-configuration linter and formatter.

31. **[harbor](https://github.com/av/harbor)** - ⭐ 2,334
   Effortlessly run LLM backends, APIs, frontends, and services with one command.

32. **[easy-vibe](https://github.com/datawhalechina/easy-vibe)** - ⭐ 1,987
   Vibe coding from 0 to 1 ｜把想法做成真正能上线的产品｜首个交互式教程｜零基础也能学会的 AI 编程实战

33. **[amazon-q-developer-cli](https://github.com/aws/amazon-q-developer-cli)** - ⭐ 1,877
   ✨ Agentic chat experience in your terminal. Build applications using natural language.

34. **[generative-ai](https://github.com/genieincodebottle/generative-ai)** - ⭐ 1,750
   Comprehensive resources on Generative AI, including a detailed roadmap, projects, use cases, interview preparation, and coding preparation.

35. **[MinecraftDev](https://github.com/minecraft-dev/MinecraftDev)** - ⭐ 1,702
   Plugin for IntelliJ IDEA that gives special support for Minecraft modding projects.

36. **[MultiAgentPPT](https://github.com/johnson7788/MultiAgentPPT)** - ⭐ 1,468
...
37. **[mcpelauncher-manifest](https://github.com/minecraft-linux/mcpelauncher-manifest)** - ⭐ 1,426
   The main repository for the Linux and Mac OS Bedrock edition Minecraft launcher.

38. **[d2mcpp](https://github.com/mcpp-community/d2mcpp)** - ⭐ 1,418
...
40. **[NagaAgent](https://github.com/Xxiii8322766509/NagaAgent)** - ⭐ 1,318
   A simple yet powerful agent framework for personal assistants, designed to enable intelligent interaction, multi-agent collaboration, and seamless tool integration.

41. **[paperdebugger](https://github.com/PaperDebugger/paperdebugger)** - ⭐ 1,295
   A Plugin-Based Multi-Agent System for In-Editor Academic Writing, Review, and Editing

42. **[awesome-hacking-lists](https://github.com/taielab/awesome-hacking-lists)** - ⭐ 1,269
   A curated collection of top-tier penetration testing tools and productivity utilities across multiple domains. Join us to explore, contribute, and enhance your hacking toolkit!

43. **[BuildingAI](https://github.com/BidingCC/BuildingAI)** - ⭐ 1,219
...
44. **[langchain4j-aideepin](https://github.com/moyangzhan/langchain4j-aideepin)** - ⭐ 1,128
   基于AI的工作效率提升工具（聊天、绘画、知识库、工作流、 MCP服务市场、语音输入输出、长期记忆） | Ai-based productivity tools (Chat,Draw,RAG,Workflow,MCP marketplace, ASR,TTS, Long-term memory etc)

45. **[any-agent](https://github.com/mozilla-ai/any-agent)** - ⭐ 1,080
   A single interface to use and evaluate different agent frameworks 

46. **[Gearboy](https://github.com/drhelius/Gearboy)** - ⭐ 1,076
   Game Boy / Gameboy Color emulator and debugger for macOS, Windows, Linux, BSD and RetroArch.

47. **[AIPex](https://github.com/AIPexStudio/AIPex)** - ⭐ 1,029
...
48. **[zen](https://github.com/sheshbabu/zen)** - ⭐ 1,009
   Selfhosted notes app. Single golang binary, notes stored as markdown within SQLite, full-text search, very low resource usage

49. **[open-trading-api](https://github.com/koreainvestment/open-trading-api)** - ⭐ 984
...
51. **[arduino-mcp2515](https://github.com/autowp/arduino-mcp2515)** - ⭐ 959
   Arduino MCP2515 CAN interface library

52. **[chunkhound](https://github.com/chunkhound/chunkhound)** - ⭐ 907
   Local first codebase intelligence

53. **[claude-chatgpt-mcp](https://github.com/syedazharmbnr1/claude-chatgpt-mcp)** - ⭐ 769
   A Claude MCP tool to interact with the ChatGPT desktop app on macOS

54. **[MCPELauncher](https://github.com/zhuowei/MCPELauncher)** - ⭐ 726
   Source code for BlockLauncher, a launcher that patches Minecraft for Android

55. **[aderyn](https://github.com/Cyfrin/aderyn)** - ⭐ 707
   Solidity Static Analyzer that easily integrates into your editor

56. **[bytechef](https://github.com/bytechefhq/bytechef)** - ⭐ 703
...
63. **[marmot](https://github.com/marmotdata/marmot)** - ⭐ 496
...
64. **[IDA-NO-MCP](https://github.com/P4nda0s/IDA-NO-MCP)** - ⭐ 494
   Say goodbye to the complex, verbose, and laggy interaction mode of IDA Pro MCP

65. **[chatlog_alpha](https://github.com/teest114514/chatlog_alpha)** - ⭐ 467
...
67. **[LightAgent](https://github.com/wanxingai/LightAgent)** - ⭐ 463
...
68. **[ai-code-helper](https://github.com/liyupi/ai-code-helper)** - ⭐ 437
...
70. **[browser-operator-core](https://github.com/BrowserOperator/browser-operator-core)** - ⭐ 422
   Browser Operator - The AI browser with built in Multi-Agent platform! Open source alternative to ChatGPT Atlas, Perplexity Comet, Dia and Microsoft CoPilot Edge Browser

71. **[claude-codepro](https://github.com/maxritter/claude-codepro)** - ⭐ 402
   Production-grade Claude Code setup. Quality automated. Continuously improved. Ship with confidence. 🚀

72. **[mcp-cn-a-stock](https://github.com/elsejj/mcp-cn-a-stock)** - ⭐ 391
...
74. **[mcpi](https://github.com/martinohanlon/mcpi)** - ⭐ 385
   Minecraft: Pi Edition API Python Library

75. **[volcano-sdk](https://github.com/Kong/volcano-sdk)** - ⭐ 384
   🌋 Build AI agents that seamlessly combine LLM reasoning with real-world actions via MCP tools — in just a few lines of TypeScript.

76. **[azan-mcp](https://github.com/ahmedeltaher/azan-mcp)** - ⭐ 381
...
77. **[ios-simulator-skill](https://github.com/conorluddy/ios-simulator-skill)** - ⭐ 378
...
79. **[bridle](https://github.com/neiii/bridle)** - ⭐ 359
   TUI / CLI config manager for agentic harnesses (Amp, Claude Code, Opencode, Goose, Copilot CLI, Crush)

80. **[graphrag-toolkit](https://github.com/awslabs/graphrag-toolkit)** - ⭐ 350
...
83. **[UE5-MCP](https://github.com/VedantRGosavi/UE5-MCP)** - ⭐ 334
   MCP for Unreal Engine 5

84. **[eechat](https://github.com/Lucassssss/eechat)** - ⭐ 325
   🚀 Powerful Local AI Chat Application - Mcp, Secure, Efficient, Personalized 本地化部署的大模型客户端

85. **[Gearsystem](https://github.com/drhelius/Gearsystem)** - ⭐ 321
...
90. **[building-an-agentic-system](https://github.com/gerred/building-an-agentic-system)** - ⭐ 276
...
92. **[awesome-slash](https://github.com/avifenesh/awesome-slash)** - ⭐ 264
...
94. **[tool-ui](https://github.com/assistant-ui/tool-ui)** - ⭐ 248
   UI components for AI interfaces

95. **[ai4eh](https://github.com/ethiack/ai4eh)** - ⭐ 246
...
105. **[CookHero](https://github.com/Decade-qiu/CookHero)** - ⭐ 217
...
106. **[pydantic-deepagents](https://github.com/vstorm-co/pydantic-deepagents)** - ⭐ 216
...
116. **[cupcake](https://github.com/eqtylab/cupcake)** - ⭐ 169
   A native policy enforcement layer for AI coding agents. Built on OPA/Rego.

117. **[codecompanion-history.nvim](https://github.com/ravitemer/codecompanion-history.nvim)** - ⭐ 160
   A history management extension for codecompanion AI chat plugin that enables saving, browsing and restoring chat sessions.

118. **[agentic-ai-systems](https://github.com/ThibautMelen/agentic-ai-systems)** - ⭐ 147
...
120. **[ZenOps](https://github.com/opsre/ZenOps)** - ⭐ 139
...
125. **[claude-ipc-mcp](https://github.com/jdez427/claude-ipc-mcp)** - ⭐ 120
   AI-to-AI communication protocol for Claude, Gemini, and other AI assistants

126. **[mcp-glootie](https://github.com/AnEntrypoint/mcp-glootie)** - ⭐ 119
   wanna develop an app ❓

127. **[mcp-audit](https://github.com/apisec-inc/mcp-audit)** - ⭐ 119
   See what your AI agents can access. Scan MCP configs for exposed secrets, shadow APIs, and AI models. Generate AI-BOMs for compliance.

128. **[x-mcp](https://github.com/xpzouying/x-mcp)** - ⭐ 117
   小红书创作中心

129. **[AgentNexus](https://github.com/wozhenbang2004/AgentNexus)** - ⭐ 111
...
132. **[5-Day-AI-Agents-Intensive-Course-with-Google](https://github.com/sdivyanshu90/5-Day-AI-Agents-Intensive-Course-with-Google)** - ⭐ 108
...
135. **[AgentFly](https://github.com/Agent-One-Lab/AgentFly)** - ⭐ 103
   Scalable and extensible reinforcement learning for LM agents.

136. **[5-Day-AI-Agents-Intensive-Course-with-Google](https://github.com/anxiong2025/5-Day-AI-Agents-Intensive-Course-with-Google)** - ⭐ 96
   谷歌5天AI Agents强化课程
...
139. **[coplay-unity-plugin](https://github.com/CoplayDev/coplay-unity-plugin)** - ⭐ 78
...
155. **[Wireshark_mcp](https://github.com/jayimu/Wireshark_mcp)** - ⭐ 30
...
157. **[adk-mcp-gemma3](https://github.com/arjunprabhulal/adk-mcp-gemma3)** - ⭐ 26
   Build AI Agent using Google ADK , MCP and Gemma 3 model

158. **[codai](https://github.com/codai-agent/codai)** - ⭐ 24
...
159. **[hands-on-ai-building-ai-agents-with-model-context-protocol-mcp-and-agent2agent-a2a-6055298](https://github.com/LinkedInLearning/hands-on-ai-building-ai-agents-with-model-context-protocol-mcp-and-agent2agent-a2a-6055298)** - ⭐ 24
...
1. **[YC-Killer](https://github.com/sahibzada-allahyar/YC-Killer)** - ⭐ 2,611
...
1. **[modelcontextprotocol](https://github.com/modelcontextprotocol/modelcontextprotocol)** - ⭐ 6,990
   Specification and documentation for the Model Context Protocol

2. **[ai-guide](https://github.com/liyupi/ai-guide)** - ⭐ 4,605
...
3. **[jar-analyzer](https://github.com/jar-analyzer/jar-analyzer)** - ⭐ 1,890
