...
1. **[dify](https://github.com/langgenius/dify)** - ⭐ 130,377
   Production-ready platform for agentic workflow development.

2. **[open-webui](https://github.com/open-webui/open-webui)** - ⭐ 124,950
   User-friendly AI Interface (Supports Ollama, OpenAI API, ...)

3. **[gemini-cli](https://github.com/google-gemini/gemini-cli)** - ⭐ 95,720
   An open-source AI agent that brings the power of Gemini directly into your terminal.

4. **[awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)** - ⭐ 81,596
   A collection of MCP servers.

5. **[servers](https://github.com/modelcontextprotocol/servers)** - ⭐ 79,421
   Model Context Protocol Servers

6. **[netdata](https://github.com/netdata/netdata)** - ⭐ 77,886
   The fastest path to AI-powered full stack observability, even for lean teams.

7. **[ragflow](https://github.com/infiniflow/ragflow)** - ⭐ 73,733
   RAGFlow is a leading open-source Retrieval-Augmented Generation (RAG) engine that fuses cutting-edge RAG with Agent capabilities to create a superior context layer for LLMs

8. **[lobehub](https://github.com/lobehub/lobehub)** - ⭐ 72,664
...
10. **[anything-llm](https://github.com/Mintplex-Labs/anything-llm)** - ⭐ 55,039
   The all-in-one Desktop & Docker AI application with built-in RAG, AI agents, No-code agent builder, MCP compatibility,  and more.

11. **[everything-claude-code](https://github.com/affaan-m/everything-claude-code)** - ⭐ 52,588
   Complete Claude Code configuration collection - agents, skills, hooks, commands, rules, MCPs. Battle-tested configs from an Anthropic hackathon winner.

12. **[TrendRadar](https://github.com/sansan0/TrendRadar)** - ⭐ 47,303
...
13. **[context7](https://github.com/upstash/context7)** - ⭐ 46,951
   Context7 MCP Server -- Up-to-date code documentation for LLMs and AI code editors

14. **[JeecgBoot](https://github.com/jeecgboot/JeecgBoot)** - ⭐ 45,272
...
15. **[LocalAI](https://github.com/mudler/LocalAI)** - ⭐ 43,068
   :robot: The free, Open Source alternative to OpenAI, Claude and others. Self-hosted and local-first. Drop-in replacement,  running on consumer-grade hardware. No GPU required. Runs gguf, transformers, diffusers and many more. Features: Generate Text, MCP, Audio, Video, Images, Voice Cloning, Distributed, P2P and decentralized inference

16. **[mindsdb](https://github.com/mindsdb/mindsdb)** - ⭐ 38,585
   Federated Query Engine for AI - The only MCP Server you'll ever need

17. **[awesome-claude-skills](https://github.com/ComposioHQ/awesome-claude-skills)** - ⭐ 37,813
...
19. **[LibreChat](https://github.com/danny-avila/LibreChat)** - ⭐ 34,137
...
21. **[nacos](https://github.com/alibaba/nacos)** - ⭐ 32,656
   an easy-to-use dynamic service discovery, configuration and service management platform for building AI cloud native applications.

22. **[PDFMathTranslate](https://github.com/PDFMathTranslate/PDFMathTranslate)** - ⭐ 31,903
   [EMNLP 2025 Demo] PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/MCP/Docker/Zotero

23. **[goose](https://github.com/block/goose)** - ⭐ 31,228
   an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM

24. **[ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub)** - ⭐ 30,708
   In-depth tutorials on LLMs, RAGs and real-world AI agent applications.

25. **[UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)** - ⭐ 28,292
   The Open-Source Multimodal AI Agent Stack: Connecting Cutting-Edge AI Models and Agent Infra

26. **[playwright-mcp](https://github.com/microsoft/playwright-mcp)** - ⭐ 27,703
   Playwright MCP server

27. **[github-mcp-server](https://github.com/github/github-mcp-server)** - ⭐ 27,257
   GitHub's official MCP Server

28. **[composio](https://github.com/ComposioHQ/composio)** - ⭐ 27,190
   Composio powers 1000+ toolkits, tool search, context management, authentication, and a sandboxed workbench to help you build AI agents that turn intent into action.

29. **[chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp)** - ⭐ 26,729
   Chrome DevTools for coding agents

30. **[gpt-researcher](https://github.com/assafelovic/gpt-researcher)** - ⭐ 25,436
   An autonomous agent that conducts deep research on any data using any LLM providers.

31. **[gin-vue-admin](https://github.com/flipped-aurora/gin-vue-admin)** - ⭐ 24,342
...
32. **[xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)** - ⭐ 24,224
   An MCP-based chatbot | 一个基于MCP的聊天机器人

33. **[fastmcp](https://github.com/PrefectHQ/fastmcp)** - ⭐ 23,163
   🚀 The fast, Pythonic way to build MCP servers and clients.

34. **[fastmcp](https://github.com/jlowin/fastmcp)** - ⭐ 22,902
   🚀 The fast, Pythonic way to build MCP servers and clients

35. **[repomix](https://github.com/yamadashy/repomix)** - ⭐ 22,103
   📦 Repomix is a powerful tool that packs your entire repository into a single, AI-friendly file. Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools like Claude, ChatGPT, DeepSeek, Perplexity, Gemini, Gemma, Llama, Grok, and more.

36. **[python-sdk](https://github.com/modelcontextprotocol/python-sdk)** - ⭐ 21,838
   The official Python SDK for Model Context Protocol servers and clients

37. **[mastra](https://github.com/mastra-ai/mastra)** - ⭐ 21,411
   From the team behind Gatsby, Mastra is a framework for building AI-powered applications and agents with a modern TypeScript stack.

38. **[activepieces](https://github.com/activepieces/activepieces)** - ⭐ 20,964
   AI Agents & MCPs & AI Workflow Automation • (~400 MCP servers for AI agents) • AI Automation / AI Agent with MCPs • AI Workflows & AI Agents • MCPs for AI Agents

39. **[serena](https://github.com/oraios/serena)** - ⭐ 20,666
   A powerful coding agent toolkit providing semantic retrieval and editing capabilities (MCP server & other integrations)

40. **[cc-switch](https://github.com/farion1231/cc-switch)** - ⭐ 20,221
   A cross-platform desktop All-in-One assistant tool for Claude Code, Codex, OpenCode & Gemini CLI.

41. **[MaxKB](https://github.com/1Panel-dev/MaxKB)** - ⭐ 20,169
   🔥 MaxKB is an open-source platform for building enterprise-grade agents.  强大易用的开源企业级智能体平台。

42. **[blender-mcp](https://github.com/ahujasid/blender-mcp)** - ⭐ 17,336

43. **[agentscope](https://github.com/agentscope-ai/agentscope)** - ⭐ 16,490
   Build and run agents you can see, understand and trust.

44. **[Scrapling](https://github.com/D4Vinci/Scrapling)** - ⭐ 15,692
   🕷️ An adaptive Web Scraping framework that handles everything from a single request to a full-scale crawl!

45. **[antigravity-awesome-skills](https://github.com/sickn33/antigravity-awesome-skills)** - ⭐ 15,646
...
46. **[claude-flow](https://github.com/ruvnet/claude-flow)** - ⭐ 14,612
   🌊 The leading agent orchestration platform for Claude. Deploy intelligent multi-agent swarms, coordinate autonomous workflows, and build conversational AI systems. Features    enterprise-grade architecture, distributed swarm intelligence, RAG integration, and native Claude Code / Codex Integration

47. **[mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners)** - ⭐ 14,490
   This open-source curriculum introduces the fundamentals of Model Context Protocol (MCP) through real-world, cross-language examples in .NET, Java, TypeScript, JavaScript, Rust and Python. Designed for developers, it focuses on practical techniques for building modular, scalable, and secure AI workflows from session setup to service orchestration.

48. **[n8n-mcp](https://github.com/czlonkowski/n8n-mcp)** - ⭐ 13,996
   A MCP for Claude Desktop / Claude Code / Windsurf / Cursor to build n8n workflows for you 

49. **[trigger.dev](https://github.com/triggerdotdev/trigger.dev)** - ⭐ 13,862
   Trigger.dev – build and deploy fully‑managed AI agents and workflows

50. **[electerm](https://github.com/electerm/electerm)** - ⭐ 13,636
...
52. **[Qwen-Agent](https://github.com/QwenLM/Qwen-Agent)** - ⭐ 13,389
   Agent framework and applications built upon Qwen>=3.0, featuring Function Calling, MCP, Code Interpreter, RAG, Chrome extension, etc.

53. **[Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP)** - ⭐ 13,255
   MCP server to provide Figma layout information to AI coding agents like Cursor

54. **[genai-toolbox](https://github.com/googleapis/genai-toolbox)** - ⭐ 13,186
   MCP Toolbox for Databases is an open source MCP server for databases.

55. **[casdoor](https://github.com/casdoor/casdoor)** - ⭐ 13,072
...
56. **[typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk)** - ⭐ 11,677
   The official TypeScript SDK for Model Context Protocol servers and clients

57. **[fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)** - ⭐ 11,592
   Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!

58. **[pal-mcp-server](https://github.com/BeehiveInnovations/pal-mcp-server)** - ⭐ 11,124
   The power of Claude Code / GeminiCLI / CodexCLI + [Gemini / OpenAI / OpenRouter / Azure / Grok / Ollama / Custom Model / All Of The Above] working as one.

59. **[memU](https://github.com/NevaMind-AI/memU)** - ⭐ 10,912
   Memory for 24/7 proactive agents like openclaw (moltbot, clawdbot).

60. **[nginx-ui](https://github.com/0xJacky/nginx-ui)** - ⭐ 10,734
   Yet another WebUI for Nginx

61. **[gateway](https://github.com/Portkey-AI/gateway)** - ⭐ 10,712
   A blazing fast AI Gateway with integrated guardrails. Route to 200+ LLMs, 50+ AI Guardrails with 1 fast & friendly API.

62. **[mcp-chrome](https://github.com/hangwin/mcp-chrome)** - ⭐ 10,494
   Chrome MCP Server is a Chrome extension-based Model Context Protocol (MCP) server that exposes your Chrome browser functionality to AI assistants like Claude, enabling complex browser automation, content analysis, and semantic search.

63. **[XHS-Downloader](https://github.com/JoeanAmier/XHS-Downloader)** - ⭐ 10,169
   小红书（XiaoHongShu、RedNote）链接提取/作品采集工具：提取账号发布、收藏、点赞、专辑作品链接；提取搜索结果作品、用户链接；采集小红书作品信息；提取小红书作品下载地址；下载小红书作品文件

64. **[zen-mcp-server](https://github.com/BeehiveInnovations/zen-mcp-server)** - ⭐ 9,890
   The power of Claude Code / GeminiCLI / CodexCLI + [Gemini / OpenAI / OpenRouter / Azure / Grok / Ollama / Custom Model / All Of The Above] working as one.

65. **[Skill_Seekers](https://github.com/yusufkaraaslan/Skill_Seekers)** - ⭐ 9,868
   Convert documentation websites, GitHub repositories, and PDFs into Claude AI skills with automatic conflict detection

66. **[mcp-use](https://github.com/mcp-use/mcp-use)** - ⭐ 9,280
   The fullstack MCP framework to develop MCP Apps for ChatGPT / Claude & MCP Servers for AI Agents.

67. **[xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp)** - ⭐ 9,253
   MCP for xiaohongshu.com

68. **[awesome-ai-apps](https://github.com/Arindam200/awesome-ai-apps)** - ⭐ 9,027
   A collection of projects showcasing RAG, agents, workflows, and other AI use cases

69. **[inspector](https://github.com/modelcontextprotocol/inspector)** - ⭐ 8,801
   Visual testing tool for MCP servers

70. **[xiaozhi-esp32-server](https://github.com/xinnan-tech/xiaozhi-esp32-server)** - ⭐ 8,671
   本项目为xiaozhi-esp32提供后端服务，帮助您快速搭建ESP32设备控制服务器。Backend service for xiaozhi-esp32, helps you quickly build an ESP32 device control server.

71. **[claude-plugins-official](https://github.com/anthropics/claude-plugins-official)** - ⭐ 8,367
   Official, Anthropic-managed directory of high quality Claude Code Plugins.

72. **[mcp](https://github.com/awslabs/mcp)** - ⭐ 8,254
   Official MCP Servers for AWS

73. **[mcp-go](https://github.com/mark3labs/mcp-go)** - ⭐ 8,226
   A Go implementation of the Model Context Protocol (MCP), enabling seamless integration between LLM applications and external data sources and tools.

74. **[mcp-agent](https://github.com/lastmile-ai/mcp-agent)** - ⭐ 8,054
   Build effective agents using Model Context Protocol and simple workflow patterns

75. **[GhidraMCP](https://github.com/LaurieWired/GhidraMCP)** - ⭐ 7,714
   MCP Server for Ghidra

76. **[git-mcp](https://github.com/idosal/git-mcp)** - ⭐ 7,649
   Put an end to code hallucinations! GitMCP is a free, open-source, remote MCP server for any GitHub project

77. **[awesome-LLM-resources](https://github.com/WangRongsheng/awesome-LLM-resources)** - ⭐ 7,575
...
79. **[hexstrike-ai](https://github.com/0x4m4/hexstrike-ai)** - ⭐ 7,097
   HexStrike AI MCP Agents is an advanced MCP server that lets AI agents (Claude, GPT, Copilot, etc.) autonomously run 150+ cybersecurity tools for automated pentesting, vulnerability discovery, bug bounty automation, and security research. Seamlessly bridge LLMs with real-world offensive security capabilities.

80. **[browser-tools-mcp](https://github.com/AgentDeskAI/browser-tools-mcp)** - ⭐ 7,093
   Monitor browser logs directly from Cursor and other MCP compatible IDEs.

81. **[astron-rpa](https://github.com/iflytek/astron-rpa)** - ⭐ 6,897
   Agent-ready RPA suite with out-of-the-box automation tools. Built for individuals and enterprises.

82. **[registry](https://github.com/modelcontextprotocol/registry)** - ⭐ 6,475
   A community driven registry service for Model Context Protocol (MCP) servers.

83. **[cursor-talk-to-figma-mcp](https://github.com/grab/cursor-talk-to-figma-mcp)** - ⭐ 6,350
...
84. **[awesome-mcp-clients](https://github.com/punkpeye/awesome-mcp-clients)** - ⭐ 6,300
   A collection of MCP clients.

85. **[unity-mcp](https://github.com/CoplayDev/unity-mcp)** - ⭐ 6,278
   Unity MCP acts as a bridge, allowing AI assistants (like Claude, Cursor) to interact directly with your Unity Editor via a local MCP (Model Context Protocol) Client. Give your LLM tools to manage assets, control scenes, edit scripts, and automate tasks within Unity.

86. **[Awesome-MCP-ZH](https://github.com/yzfly/Awesome-MCP-ZH)** - ⭐ 6,245
   MCP 资源精选， MCP指南，Claude MCP，MCP Servers, MCP Clients

87. **[voltagent](https://github.com/VoltAgent/voltagent)** - ⭐ 6,171
   AI Agent Engineering Platform built on an Open Source TypeScript AI Agent Framework

88. **[kreuzberg](https://github.com/kreuzberg-dev/kreuzberg)** - ⭐ 6,167
...
90. **[mcp](https://github.com/BrowserMCP/mcp)** - ⭐ 5,872
   Browser MCP is a Model Context Provider (MCP) server that allows AI applications to control your browser

91. **[ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp)** - ⭐ 5,805
   AI-powered reverse engineering assistant that bridges IDA Pro with language models through MCP.

92. **[klavis](https://github.com/Klavis-AI/klavis)** - ⭐ 5,645
   Klavis AI (YC X25):  MCP integration platforms that let AI agents use tools reliably at any scale

93. **[firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server)** - ⭐ 5,598
   🔥 Official Firecrawl MCP Server - Adds powerful web scraping and search to Cursor, Claude and any other LLM clients.

94. **[Everywhere](https://github.com/DearVa/Everywhere)** - ⭐ 5,557
   Context-aware AI assistant for your desktop. Ready to respond intelligently, seamlessly integrating multiple LLMs and MCP tools.

95. **[DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP)** - ⭐ 5,537
   This is MCP server for Claude that gives it terminal control, file system search and diff file editing capabilities

96. **[claude-context](https://github.com/zilliztech/claude-context)** - ⭐ 5,449
   Code search MCP for Claude Code. Make entire codebase the context for any coding agent.

97. **[whatsapp-mcp](https://github.com/lharries/whatsapp-mcp)** - ⭐ 5,356
   WhatsApp MCP server

98. **[UltraRAG](https://github.com/OpenBMB/UltraRAG)** - ⭐ 5,326
   A Low-Code MCP Framework for Building Complex and Innovative RAG Pipelines

99. **[mcp-playwright](https://github.com/executeautomation/mcp-playwright)** - ⭐ 5,252
   Playwright Model Context Protocol Server - Tool to automate Browsers and APIs in Claude Desktop, Cline, Cursor IDE and More 🔌

100. **[sdk-python](https://github.com/strands-agents/sdk-python)** - ⭐ 5,200
   A model-driven approach to building AI agents in just a few lines of code.

101. **[awesome-mcp-servers](https://github.com/appcypher/awesome-mcp-servers)** - ⭐ 5,180
   Awesome MCP Servers - A curated list of Model Context Protocol servers

102. **[5ire](https://github.com/nanbingxyz/5ire)** - ⭐ 5,041
   5ire is a cross-platform desktop AI assistant, MCP client. It compatible with major service providers,  supports local knowledge base and  tools via model context protocol servers .

103. **[gaianet-node](https://github.com/GaiaNet-AI/gaianet-node)** - ⭐ 5,006
   Install, run and deploy your own decentralized AI agent service

104. **[microsandbox](https://github.com/zerocore-ai/microsandbox)** - ⭐ 4,853
...
106. **[Kiln](https://github.com/Kiln-AI/Kiln)** - ⭐ 4,675
   Build, Evaluate, and Optimize AI Systems. Includes evals, RAG, agents, fine-tuning, synthetic data generation, dataset management, MCP, and more.

107. **[mcp-ui](https://github.com/MCP-UI-Org/mcp-ui)** - ⭐ 4,457
   UI over MCP. Create next-gen UI experiences with the protocol and SDK!

108. **[XcodeBuildMCP](https://github.com/getsentry/XcodeBuildMCP)** - ⭐ 4,451
   A Model Context Protocol (MCP) server and CLI that provides tools for agent use when working on iOS and macOS projects.

109. **[casibase](https://github.com/casibase/casibase)** - ⭐ 4,447
   ⚡️AI Cloud OS: Open-source enterprise-level AI knowledge base and MCP (model-context-protocol)/A2A (agent-to-agent) management platform with admin UI, user management and Single-Sign-On⚡️, supports ChatGPT, Claude, Llama, Ollama, HuggingFace, etc., chat bot demo: https://ai.casibase.com, admin UI demo: https://ai-admin.casibase.com

110. **[deep-research](https://github.com/u14app/deep-research)** - ⭐ 4,445
   Use any LLMs (Large Language Models) for Deep Research. Support SSE API and MCP server.

111. **[Windows-MCP](https://github.com/CursorTouch/Windows-MCP)** - ⭐ 4,428
   MCP Server for Computer Use in Windows

112. **[mcp-atlassian](https://github.com/sooperset/mcp-atlassian)** - ⭐ 4,393
   MCP server for Atlassian tools (Confluence, Jira)

113. **[magic-mcp](https://github.com/21st-dev/magic-mcp)** - ⭐ 4,309
...
116. **[Olares](https://github.com/beclab/Olares)** - ⭐ 4,118
   Olares: An Open-Source Personal Cloud to Reclaim Your Data

117. **[wanwu](https://github.com/UnicomAI/wanwu)** - ⭐ 4,105
   China Unicom's Yuanjing Wanwu Agent Platform is an enterprise-grade, multi-tenant AI agent development platform. It helps users build applications such as intelligent agents, workflows, and rag, and also supports model management. The platform features a developer-friendly license, and we welcome all developers to build upon the platform.

118. **[mcpo](https://github.com/open-webui/mcpo)** - ⭐ 3,995
   A simple, secure MCP-to-OpenAPI proxy server

119. **[csharp-sdk](https://github.com/modelcontextprotocol/csharp-sdk)** - ⭐ 3,945
   The official C# SDK for Model Context Protocol servers and clients. Maintained in collaboration with Microsoft.

120. **[notion-mcp-server](https://github.com/makenotion/notion-mcp-server)** - ⭐ 3,940
   Official Notion MCP Server

121. **[go-sdk](https://github.com/modelcontextprotocol/go-sdk)** - ⭐ 3,934
   The official Go SDK for Model Context Protocol servers and clients. Maintained in collaboration with Google.

122. **[learn-agentic-ai](https://github.com/panaversity/learn-agentic-ai)** - ⭐ 3,924
   Learn Agentic AI using Dapr Agentic Cloud Ascent (DACA) Design Pattern and Agent-Native Cloud Technologies: OpenAI Agents SDK, Memory, MCP, A2A, Knowledge Graphs, Dapr, Rancher Desktop, and Kubernetes.

123. **[spec-workflow-mcp](https://github.com/Pimzino/spec-workflow-mcp)** - ⭐ 3,923
   A Model Context Protocol (MCP) server that provides structured spec-driven development workflow tools for AI-assisted software development, featuring a real-time web dashboard and VSCode extension for monitoring and managing your project's progress directly in your development environment.

124. **[directories](https://github.com/leerob/directories)** - ⭐ 3,908
   The Cursor & Windsurf community, find rules and MCPs

125. **[directories](https://github.com/pontusab/directories)** - ⭐ 3,896
   The Cursor & Windsurf community, find rules and MCPs

126. **[exa-mcp-server](https://github.com/exa-labs/exa-mcp-server)** - ⭐ 3,876
   Exa MCP for web search and web crawling!

127. **[learn-ai-engineering](https://github.com/ashishps1/learn-ai-engineering)** - ⭐ 3,837
   Learn AI and LLMs from scratch using free resources

128. **[telegram-search](https://github.com/groupultra/telegram-search)** - ⭐ 3,773
...
130. **[mcp-server-chart](https://github.com/antvis/mcp-server-chart)** - ⭐ 3,714
...
133. **[awesome-mcp-servers](https://github.com/wong2/awesome-mcp-servers)** - ⭐ 3,650
   A curated list of Model Context Protocol (MCP) servers

134. **[ciso-assistant-community](https://github.com/intuitem/ciso-assistant-community)** - ⭐ 3,608
...
136. **[go-whatsapp-web-multidevice](https://github.com/aldinokemal/go-whatsapp-web-multidevice)** - ⭐ 3,582
   GOWA - WhatsApp REST API with support for UI, Multi Account, Webhooks, and MCP, and Chatwoot. Built with Golang for efficient memory use. 

137. **[osaurus](https://github.com/osaurus-ai/osaurus)** - ⭐ 3,579
...
138. **[mcp-feedback-enhanced](https://github.com/Minidoracat/mcp-feedback-enhanced)** - ⭐ 3,577
   Enhanced MCP server for interactive user feedback and command execution in AI-assisted development, featuring dual interface support (Web UI and Desktop Application) with intelligent environment detection and cross-platform compatibility.

139. **[Continuous-Claude-v3](https://github.com/parcadei/Continuous-Claude-v3)** - ⭐ 3,564
   Context management for Claude Code. Hooks maintain state via ledgers and handoffs. MCP execution without context pollution. Agent orchestration with isolated context windows.

140. **[archestra](https://github.com/archestra-ai/archestra)** - ⭐ 3,560
   Secure cloud-native MCP registry, gateway & orchestrator

141. **[mobile-mcp](https://github.com/mobile-next/mobile-mcp)** - ⭐ 3,553
   Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators, Simulators and Real Devices)

142. **[osaurus](https://github.com/dinoki-ai/osaurus)** - ⭐ 3,548
   AI edge infrastructure for macOS. Run local or cloud models, share tools across apps via MCP, and power AI workflows with a native, always-on runtime.

143. **[cipher](https://github.com/campfirein/cipher)** - ⭐ 3,541
...
144. **[claude-code-guide](https://github.com/zebbern/claude-code-guide)** - ⭐ 3,465
   Claude Code Guide - Setup, Commands, workflows, agents, skills & tips-n-tricks 

145. **[mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare)** - ⭐ 3,458
...
147. **[octelium](https://github.com/octelium/octelium)** - ⭐ 3,405
   A next-gen FOSS self-hosted unified zero trust secure access platform that can operate as a remote access VPN, a ZTNA platform, API/AI/MCP gateway, a PaaS, an ngrok-alternative and a homelab infrastructure.

148. **[langchain-mcp-adapters](https://github.com/langchain-ai/langchain-mcp-adapters)** - ⭐ 3,381
   LangChain 🔌 MCP

149. **[PPTAgent](https://github.com/icip-cas/PPTAgent)** - ⭐ 3,380
   An Agentic Framework for Reflective PowerPoint Generation

150. **[excel-mcp-server](https://github.com/haris-musa/excel-mcp-server)** - ⭐ 3,374
   A Model Context Protocol server for Excel file manipulation

151. **[MCP-Chinese-Getting-Started-Guide](https://github.com/liaokongVFX/MCP-Chinese-Getting-Started-Guide)** - ⭐ 3,335
   Model Context Protocol(MCP) 编程极速入门

152. **[mcp-context-forge](https://github.com/IBM/mcp-context-forge)** - ⭐ 3,329
...
154. **[mcp](https://github.com/google/mcp)** - ⭐ 3,292
   Google 💚 MCP

155. **[boost](https://github.com/laravel/boost)** - ⭐ 3,291
   Laravel-focused MCP server for augmenting your AI powered local development experience.

156. **[rikkahub](https://github.com/rikkahub/rikkahub)** - ⭐ 3,288
   RikkaHub is an Android APP that supports for multiple LLM providers.

157. **[metorial](https://github.com/metorial/metorial)** - ⭐ 3,221
   Connect any AI model to 600+ integrations; powered by MCP 📡 🚀

158. **[java-sdk](https://github.com/modelcontextprotocol/java-sdk)** - ⭐ 3,197
   The official Java SDK for Model Context Protocol servers and clients. Maintained in collaboration with Spring AI

159. **[py-xiaozhi](https://github.com/huangjunsen0406/py-xiaozhi)** - ⭐ 3,188
   A Python-based Xiaozhi AI for users who want the full Xiaozhi experience without owning specialized hardware.

160. **[mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase)** - ⭐ 3,155
   Allow LLMs to control a browser with Browserbase and Stagehand

161. **[rust-sdk](https://github.com/modelcontextprotocol/rust-sdk)** - ⭐ 3,061
   The official Rust SDK for the Model Context Protocol

162. **[AI-Infra-Guard](https://github.com/Tencent/AI-Infra-Guard)** - ⭐ 2,986
...
163. **[n8n-nodes-mcp](https://github.com/nerding-io/n8n-nodes-mcp)** - ⭐ 2,985
   n8n custom node for MCP

164. **[core](https://github.com/cheshire-cat-ai/core)** - ⭐ 2,970
   AI agent microservice

165. **[fastmcp](https://github.com/punkpeye/fastmcp)** - ⭐ 2,964
   A TypeScript framework for building MCP servers.

166. **[playwriter](https://github.com/remorses/playwriter)** - ⭐ 2,934
...
167. **[mcp-obsidian](https://github.com/MarkusPfundstein/mcp-obsidian)** - ⭐ 2,899
   MCP server that interacts with Obsidian via the Obsidian rest API community plugin

168. **[easy-vibe](https://github.com/datawhalechina/easy-vibe)** - ⭐ 2,815
   vibe coding from 0 to 1 ｜深入浅出 AI 编程 ｜ vibecoding 零基础教程

169. **[excalidraw-mcp](https://github.com/excalidraw/excalidraw-mcp)** - ⭐ 2,739
   Fast and streamable Excalidraw MCP App

170. **[shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server)** - ⭐ 2,664
   A mcp server to allow LLMS gain context about shadcn ui component structure,usage and installation,compaitable with react,svelte 5,vue & React Native

171. **[mcp](https://github.com/microsoft/mcp)** - ⭐ 2,655
   Catalog of official Microsoft MCP (Model Context Protocol) server implementations for AI-powered data access and tool integration

172. **[sandbox](https://github.com/agent-infra/sandbox)** - ⭐ 2,636
   All-in-One Sandbox for AI Agents that combines Browser, Shell, File, MCP and VSCode Server in a single Docker container.

173. **[basic-memory](https://github.com/basicmachines-co/basic-memory)** - ⭐ 2,568
   AI conversations that actually remember. Never re-explain your project to your AI again. Join our Discord: https://discord.gg/tyvKNccgqN

174. **[kreuzberg](https://github.com/Goldziher/kreuzberg)** - ⭐ 2,561
...
175. **[bifrost](https://github.com/maximhq/bifrost)** - ⭐ 2,561
   Fastest enterprise AI gateway (50x faster than LiteLLM) with adaptive load balancer, cluster mode, guardrails, 1000+ models support & <100 µs overhead at 5k RPS.

176. **[nunu](https://github.com/go-nunu/nunu)** - ⭐ 2,546
   A CLI tool for building Go applications.

177. **[buildwithclaude](https://github.com/davepoon/buildwithclaude)** - ⭐ 2,495
   A single hub to find Claude Skills, Agents, Commands, Hooks, Plugins, and Marketplace collections to extend Claude Code, Claude Desktop, Agent SDK and OpenClaw

178. **[supabase-mcp](https://github.com/supabase-community/supabase-mcp)** - ⭐ 2,486
   Connect Supabase to your AI assistants

179. **[supergateway](https://github.com/supercorp-ai/supergateway)** - ⭐ 2,450
   Run MCP stdio servers over SSE and SSE over stdio. AI gateway.

180. **[awesome-agent-skills](https://github.com/heilcheng/awesome-agent-skills)** - ⭐ 2,433
   A curated list of skills, tools, tutorials, and capabilities for AI coding agents (Claude, Codex, Antigravity, Copilot, VS Code)

181. **[slackdump](https://github.com/rusq/slackdump)** - ⭐ 2,429
   Save or export your private and public Slack messages, threads, files, and users locally without admin privileges.

182. **[markdownify-mcp](https://github.com/zcaceres/markdownify-mcp)** - ⭐ 2,419
   A Model Context Protocol server for converting almost anything to Markdown

183. **[mcp-grafana](https://github.com/grafana/mcp-grafana)** - ⭐ 2,406
   MCP server for Grafana

184. **[Peekaboo](https://github.com/steipete/Peekaboo)** - ⭐ 2,390
   Peekaboo is a macOS CLI & optional MCP server that enables AI agents to capture screenshots of applications, or the entire system, with optional visual question answering through local or remote AI models.

185. **[MCP-SuperAssistant](https://github.com/srbhptl39/MCP-SuperAssistant)** - ⭐ 2,297
   Brings MCP to ChatGPT, DeepSeek, Perplexity, Grok, Gemini, Google AI Studio, OpenRouter, DeepSeek, T3 Chat and more...

186. **[mcp-proxy](https://github.com/sparfenyuk/mcp-proxy)** - ⭐ 2,289
   A bridge between Streamable HTTP and stdio MCP transports

187. **[ableton-mcp](https://github.com/ahujasid/ableton-mcp)** - ⭐ 2,257

188. **[kagent](https://github.com/kagent-dev/kagent)** - ⭐ 2,246
   Cloud Native Agentic AI | Discord: https://bit.ly/kagentdiscord

189. **[lemonade](https://github.com/lemonade-sdk/lemonade)** - ⭐ 2,245
   Lemonade helps users discover and run local AI apps by serving optimized LLMs right from their own GPUs and NPUs. Join our discord: https://discord.gg/5xXzkMu8Zk

190. **[EverMemOS](https://github.com/EverMind-AI/EverMemOS)** - ⭐ 2,239
   Long-term memory OS for your agents across LLMs and platforms.

191. **[ddgs](https://github.com/deedy5/ddgs)** - ⭐ 2,236
   A metasearch library that aggregates results from diverse web search services

192. **[arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server)** - ⭐ 2,222
   A Model Context Protocol server for searching and analyzing arXiv papers

193. **[postgres-mcp](https://github.com/crystaldba/postgres-mcp)** - ⭐ 2,189
   Postgres MCP Pro provides configurable read/write access and performance analysis for you and your AI agents.

194. **[dbhub](https://github.com/bytebase/dbhub)** - ⭐ 2,180
   Zero-dependency, token-efficient database MCP server for Postgres, MySQL, SQL Server, MariaDB, SQLite.

195. **[chatmcp](https://github.com/daodao97/chatmcp)** - ⭐ 2,175
   ChatMCP is an AI chat client implementing the Model Context Protocol (MCP).

196. **[mcporter](https://github.com/steipete/mcporter)** - ⭐ 2,152
   Call MCPs via TypeScript, masquerading as simple TypeScript API. Or package them as cli.

197. **[papersgpt-for-zotero](https://github.com/papersgpt/papersgpt-for-zotero)** - ⭐ 2,131
...
198. **[comfyui_LLM_party](https://github.com/heshengtao/comfyui_LLM_party)** - ⭐ 2,111
   LLM Agent Framework in ComfyUI includes MCP sever, Omost,GPT-sovits, ChatTTS,GOT-OCR2.0, and FLUX prompt nodes,access to Feishu,discord,and adapts to all llms with similar openai / aisuite interfaces, such as o1,ollama, gemini, grok, qwen, GLM, deepseek, kimi,doubao. Adapted to local llms, vlm, gguf such as llama-3.3 Janus-Pro, Linkage graphRAG

199. **[claude-code-subagents-collection](https://github.com/davepoon/claude-code-subagents-collection)** - ⭐ 2,098
   Claude Code Subagents & Commands Collection + CLI Tool

200. **[brightdata-mcp](https://github.com/brightdata/brightdata-mcp)** - ⭐ 2,061
   A powerful Model Context Protocol (MCP) server that provides an all-in-one solution for public web access.

201. **[solace-agent-mesh](https://github.com/SolaceLabs/solace-agent-mesh)** - ⭐ 2,054
   An event-driven framework designed to build and orchestrate multi-agent AI systems. It enables seamless integration of AI agents with real-world data sources and systems, facilitating complex, multi-step workflows.

202. **[metamcp](https://github.com/metatool-ai/metamcp)** - ⭐ 2,051
   MCP Aggregator, Orchestrator, Middleware, Gateway in one docker

203. **[Unla](https://github.com/AmoyLab/Unla)** - ⭐ 2,039
   🧩 MCP Gateway - A lightweight gateway service that instantly transforms existing MCP Servers and APIs into MCP servers with zero code changes. Features Docker deployment and management UI, requiring no infrastructure modifications.

204. **[DevDocs](https://github.com/cyberagiinc/DevDocs)** - ⭐ 2,035
   Completely free, private, UI based Tech Documentation MCP server. Designed for coders and software developers in mind. Easily integrate into Cursor, Windsurf, Cline, Roo Code, Claude Desktop App 

205. **[mcp-shrimp-task-manager](https://github.com/cjo4m06/mcp-shrimp-task-manager)** - ⭐ 2,027
   Shrimp Task Manager is a task tool built for AI Agents, emphasizing chain-of-thought, reflection, and style consistency. It converts natural language into structured dev tasks with dependency tracking and iterative refinement, enabling agent-like developer behavior in reasoning AI systems.

206. **[gemini-mcp-tool](https://github.com/jamubc/gemini-mcp-tool)** - ⭐ 2,008
   MCP server that enables AI assistants to interact with Google Gemini CLI, leveraging Gemini's massive token window for large file analysis and codebase understanding

207. **[mcp-crawl4ai-rag](https://github.com/coleam00/mcp-crawl4ai-rag)** - ⭐ 2,007
   Web Crawling and RAG Capabilities for AI Agents and AI Coding Assistants

208. **[superset](https://github.com/superset-sh/superset)** - ⭐ 1,990
   The command center to orchestrate coding agents - Run a team of Claude Code, OpenCode, Codex, or any other agents on your machine

209. **[superglue](https://github.com/superglue-ai/superglue)** - ⭐ 1,989
   superglue (YC W25) builds integrations and tools from natural language. Get production-grade tools for long tail and enterprise systems.

210. **[modelcontextprotocol](https://github.com/perplexityai/modelcontextprotocol)** - ⭐ 1,980
   The official MCP server implementation for the Perplexity API Platform

211. **[mcpso](https://github.com/chatmcp/mcpso)** - ⭐ 1,969
   directory for Awesome MCP Servers

212. **[Aix-DB](https://github.com/apconw/Aix-DB)** - ⭐ 1,964
   Aix-DB 基于 LangChain/LangGraph 框架，结合 MCP Skills 多智能体协作架构，实现自然语言到数据洞察的端到端转换。

213. **[godot-mcp](https://github.com/Coding-Solo/godot-mcp)** - ⭐ 1,959
   MCP server for interfacing with Godot game engine. Provides tools for launching the editor, running projects, and capturing debug output.

214. **[code-graph-rag](https://github.com/vitali87/code-graph-rag)** - ⭐ 1,955
   The ultimate RAG for your monorepo. Query, understand, and edit multi-language codebases with the power of AI and knowledge graphs

215. **[mcp-cli](https://github.com/IBM/mcp-cli)** - ⭐ 1,892

216. **[mcp-cli](https://github.com/chrishayuk/mcp-cli)** - ⭐ 1,891

217. **[yomo](https://github.com/yomorun/yomo)** - ⭐ 1,885
   🦖 Serverless AI Agent Framework with Geo-distributed Edge AI Infra.

218. **[agentset](https://github.com/agentset-ai/agentset)** - ⭐ 1,882
   The open-source RAG platform: built-in citations, deep research, 22+ file formats, partitions, MCP server, and more.

219. **[witsy](https://github.com/nbonamy/witsy)** - ⭐ 1,880
   Witsy: desktop AI assistant / universal MCP client

220. **[beelzebub](https://github.com/mariocandela/beelzebub)** - ⭐ 1,852
   A secure low code honeypot framework, leveraging AI for System Virtualization.

221. **[mcphub](https://github.com/samanhappy/mcphub)** - ⭐ 1,829
   A unified hub for centrally managing and dynamically orchestrating multiple MCP servers/APIs into separate endpoints with flexible routing strategies

222. **[sanic-web](https://github.com/apconw/sanic-web)** - ⭐ 1,817
...
223. **[agentgateway](https://github.com/agentgateway/agentgateway)** - ⭐ 1,804
   Next Generation Agentic Proxy for AI Agents and MCP servers

224. **[esp32_nat_router](https://github.com/martin-ger/esp32_nat_router)** - ⭐ 1,798
   An AI-enabled NAT Router/Firewall for the ESP32

225. **[opendia](https://github.com/aaronjmars/opendia)** - ⭐ 1,777
   Connect your browser to AI models. Just use Dia on Chrome, Arc or Firefox.

226. **[mcp-router](https://github.com/mcp-router/mcp-router)** - ⭐ 1,768
   A Unified MCP Server Management App (MCP Manager).

227. **[inspector](https://github.com/MCPJam/inspector)** - ⭐ 1,760
   Test & Debug MCP servers, ChatGPT apps, and MCP Apps (ext-apps)

228. **[super-agent-party](https://github.com/heshengtao/super-agent-party)** - ⭐ 1,757
...
229. **[AIaW](https://github.com/NitroRCr/AIaW)** - ⭐ 1,752
...
230. **[Dive](https://github.com/OpenAgentPlatform/Dive)** - ⭐ 1,734
   Dive is an open-source MCP Host Desktop Application that seamlessly integrates with any LLMs supporting function calling capabilities. ✨

231. **[mcp_agent_mail](https://github.com/Dicklesworthstone/mcp_agent_mail)** - ⭐ 1,733
   Asynchronous coordination layer for AI coding agents: identities, inboxes, searchable threads, and advisory file leases over FastMCP + Git + SQLite

232. **[mcphub.nvim](https://github.com/ravitemer/mcphub.nvim)** - ⭐ 1,730
   An MCP client for Neovim that seamlessly integrates MCP servers into your editing workflow with an intuitive interface for managing, testing, and using MCP servers with your favorite chat plugins.

233. **[mcpb](https://github.com/modelcontextprotocol/mcpb)** - ⭐ 1,729
   Desktop Extensions: One-click local MCP server installation in desktop apps

234. **[ext-apps](https://github.com/modelcontextprotocol/ext-apps)** - ⭐ 1,708
   Official repo for spec & SDK of MCP Apps protocol - standard for UIs embedded AI chatbots, served by MCP servers

235. **[plik](https://github.com/root-gg/plik)** - ⭐ 1,700
   Plik is a temporary file upload system (Wetransfer like) in Go.

236. **[yu-ai-agent](https://github.com/liyupi/yu-ai-agent)** - ⭐ 1,698
...
237. **[notebooklm-mcp-cli](https://github.com/jacob-bd/notebooklm-mcp-cli)** - ⭐ 1,696

238. **[vexa](https://github.com/Vexa-ai/vexa)** - ⭐ 1,694
   Open-source meeting transcription API for Google Meet, Microsoft Teams & Zoom. Auto-join bots, real-time WebSocket transcripts, MCP server for AI agents. Self-host or use hosted SaaS.

239. **[MAI-UI](https://github.com/Tongyi-MAI/MAI-UI)** - ⭐ 1,686
   MAI-UI: Real-World Centric Foundation GUI Agents ranging from 2B to 235B

240. **[interactive-feedback-mcp](https://github.com/noopstudios/interactive-feedback-mcp)** - ⭐ 1,674
   Interactive User Feedback MCP

241. **[ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp)** - ⭐ 1,668
   MCP server for interacting with the iOS simulator

242. **[zenfeed](https://github.com/glidea/zenfeed)** - ⭐ 1,651
   Make RSS 📰 great again with AI 🧠✨!! [网页监控工具-预定送会员：https://waitlist.dingding.glidea.app]

243. **[py-gpt](https://github.com/szczyglis-dev/py-gpt)** - ⭐ 1,639
   Desktop AI Assistant powered by GPT-5, GPT-4, o1, o3, Gemini, Claude, Ollama, DeepSeek, Perplexity, Grok, Bielik, chat, vision, voice, RAG, image and video generation, agents, tools, MCP, plugins, speech synthesis and recognition, web search, memory, presets, assistants,and more. Linux, Windows, Mac

244. **[Office-Word-MCP-Server](https://github.com/GongRzhe/Office-Word-MCP-Server)** - ⭐ 1,637
   A Model Context Protocol (MCP) server for creating, reading, and manipulating Microsoft Word documents. This server enables AI assistants to work with Word documents through a standardized interface, providing rich document editing capabilities.

245. **[kubb](https://github.com/kubb-labs/kubb)** - ⭐ 1,629
   🧩 The Ultimate Toolkit for Generating Type-Safe API Clients, Hooks, and Validators.

246. **[anyquery](https://github.com/julien040/anyquery)** - ⭐ 1,626
   Query anything (GitHub, Notion, +40 more) with SQL and let LLMs (ChatGPT, Claude) connect to using MCP

247. **[toolhive](https://github.com/stacklok/toolhive)** - ⭐ 1,619
   ToolHive makes deploying MCP servers easy, secure and fun

248. **[codemcp](https://github.com/ezyang/codemcp)** - ⭐ 1,607
   Coding assistant MCP for Claude Desktop

249. **[agent-scan](https://github.com/snyk/agent-scan)** - ⭐ 1,588
   Security scanner for AI agents, MCP servers and agent skills.

250. **[Continuous-Claude-v2](https://github.com/parcadei/Continuous-Claude-v2)** - ⭐ 1,575
   Context management for Claude Code. Hooks maintain state via ledgers and handoffs. MCP execution without context pollution. Agent orchestration with isolated context windows.

251. **[n8n-mcp-server](https://github.com/leonardsellem/n8n-mcp-server)** - ⭐ 1,567
   MCP server that provides tools and resources for interacting with n8n API

252. **[mcphost](https://github.com/mark3labs/mcphost)** - ⭐ 1,565
   A CLI host application that enables Large Language Models (LLMs) to interact with external tools through the Model Context Protocol (MCP).

253. **[pg-aiguide](https://github.com/timescale/pg-aiguide)** - ⭐ 1,564
   MCP server and Claude plugin for Postgres skills and documentation. Helps AI coding tools generate better PostgreSQL code.

254. **[Office-PowerPoint-MCP-Server](https://github.com/GongRzhe/Office-PowerPoint-MCP-Server)** - ⭐ 1,537
   A MCP (Model Context Protocol) server for PowerPoint manipulation using python-pptx. This server provides tools for creating, editing, and manipulating PowerPoint presentations through the MCP protocol.

255. **[google_workspace_mcp](https://github.com/taylorwilsdon/google_workspace_mcp)** - ⭐ 1,537
   Control Gmail, Google Calendar, Docs, Sheets, Slides, Chat, Forms, Tasks, Search & Drive with AI - Comprehensive Google Workspace / G Suite MCP Server & CLI Tool

256. **[moltis](https://github.com/moltis-org/moltis)** - ⭐ 1,515
...
257. **[zotero-mcp](https://github.com/54yyyu/zotero-mcp)** - ⭐ 1,512
   Zotero MCP: Connects your Zotero research library with Claude and other AI assistants via the Model Context Protocol to discuss papers, get summaries, analyze citations, and more.

258. **[mcp-installer](https://github.com/anaisbetts/mcp-installer)** - ⭐ 1,507
   An MCP server that installs other MCP servers for you

259. **[skills](https://github.com/microsoft/skills)** - ⭐ 1,496
   Skills, MCP servers, Custom Agents, Agents.md for SDKs to ground Coding Agents

260. **[claudian](https://github.com/YishenTu/claudian)** - ⭐ 1,493
   An Obsidian plugin that embeds Claude Code as an AI collaborator in your vault

261. **[mcptools](https://github.com/f/mcptools)** - ⭐ 1,493
   A command-line interface for interacting with MCP (Model Context Protocol) servers using both stdio and HTTP transport.

262. **[better-agents](https://github.com/langwatch/better-agents)** - ⭐ 1,474
   Standards for building agents, better

263. **[mcp-scan](https://github.com/invariantlabs-ai/mcp-scan)** - ⭐ 1,458
   Security scanner for AI agents, MCP servers and agent skills.

264. **[MCP-Reborn](https://github.com/Hexeption/MCP-Reborn)** - ⭐ 1,458
   MCP-Reborn is an MCP (Mod Coder Pack) for Minecraft for making modded clients and researching its code. (1.13-1.21.4)

265. **[mcp-language-server](https://github.com/isaacphi/mcp-language-server)** - ⭐ 1,454
   mcp-language-server gives MCP enabled clients access semantic tools like get definition, references, rename, and diagnostics.

266. **[unreal-mcp](https://github.com/chongdashu/unreal-mcp)** - ⭐ 1,444
   Enable AI assistant clients like Cursor, Windsurf and Claude Desktop to control Unreal Engine through natural language using the Model Context Protocol (MCP).

267. **[pilot-shell](https://github.com/maxritter/pilot-shell)** - ⭐ 1,443
...
268. **[claude-code-plugins-plus-skills](https://github.com/jeremylongshore/claude-code-plugins-plus-skills)** - ⭐ 1,440
...
269. **[rulego](https://github.com/rulego/rulego)** - ⭐ 1,432
   ⛓️RuleGo is a lightweight, high-performance, embedded, next-generation component orchestration rule engine framework for Go.

270. **[claude-pilot](https://github.com/maxritter/claude-pilot)** - ⭐ 1,418
...
271. **[NagaAgent](https://github.com/RTGS2017/NagaAgent)** - ⭐ 1,405
   A simple yet powerful agent framework for personal assistants, designed to enable intelligent interaction, multi-agent collaboration, and seamless tool integration.

272. **[oh-my-pi](https://github.com/can1357/oh-my-pi)** - ⭐ 1,404
   ⌥  AI Coding agent for the terminal — hash-anchored edits, optimized tool harness, LSP, Python, browser, subagents, and more

273. **[slack-mcp-server](https://github.com/korotovsky/slack-mcp-server)** - ⭐ 1,394
   The most powerful MCP Slack Server with no permission requirements, Apps support, GovSlack, DMs, Group DMs and smart history fetch logic.

274. **[mcp](https://github.com/MicrosoftDocs/mcp)** - ⭐ 1,392
   Official Microsoft Learn MCP Server – powering LLMs and AI agents with real-time, trusted Microsoft docs & code samples.

275. **[mcp-memory-service](https://github.com/doobidoo/mcp-memory-service)** - ⭐ 1,378
   Open-source persistent memory for AI agent pipelines (LangGraph, CrewAI, AutoGen) and Claude. REST API + knowledge graph + autonomous consolidation.

276. **[php-sdk](https://github.com/modelcontextprotocol/php-sdk)** - ⭐ 1,372
   The official PHP SDK for Model Context Protocol servers and clients. Maintained in collaboration with The PHP Foundation.

277. **[docker-mcp-tutorial](https://github.com/theNetworkChuck/docker-mcp-tutorial)** - ⭐ 1,361
   Complete tutorial materials for building MCP servers with Docker - from NetworkChuck's video

278. **[mcp-unity](https://github.com/CoderGamester/mcp-unity)** - ⭐ 1,357
   Model Context Protocol (MCP) plugin to connect with Unity Editor — designed for Cursor, Claude Code, Codex, Windsurf and other IDEs

279. **[google-analytics-mcp](https://github.com/googleanalytics/google-analytics-mcp)** - ⭐ 1,348

280. **[code-mode](https://github.com/universal-tool-calling-protocol/code-mode)** - ⭐ 1,336
   🔌 Plug-and-play library to enable agents to call MCP and UTCP tools via code execution. 

281. **[Risuai](https://github.com/kwaroran/Risuai)** - ⭐ 1,331
   Make your own story. User-friendly software for LLM roleplaying

282. **[hotpath-rs](https://github.com/pawurb/hotpath-rs)** - ⭐ 1,330
   Rust Performance Profiler & Channels Monitoring Toolkit (TUI, MCP)

283. **[grepai](https://github.com/yoanbernabeu/grepai)** - ⭐ 1,330
   Semantic Search & Call Graphs for AI Agents (100% Local)

284. **[mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes)** - ⭐ 1,324
   MCP Server for kubernetes management commands

285. **[azure-devops-mcp](https://github.com/microsoft/azure-devops-mcp)** - ⭐ 1,314
   The MCP server for Azure DevOps, bringing the power of Azure DevOps directly to your agents.

286. **[Claude-Code-Development-Kit](https://github.com/peterkrueck/Claude-Code-Development-Kit)** - ⭐ 1,313
   Handle context at scale - my custom Claude Code workflow including hooks, mcp and sub agents

287. **[LitterBox](https://github.com/BlackSnufkin/LitterBox)** - ⭐ 1,313
   A secure sandbox environment for malware developers and red teamers to test payloads against detection mechanisms before deployment. Integrates with LLM agents via MCP for enhanced analysis capabilities.

288. **[mcp-obsidian](https://github.com/smithery-ai/mcp-obsidian)** - ⭐ 1,310
   A connector for Claude Desktop to read and search an Obsidian vault.

289. **[ai](https://github.com/stripe/ai)** - ⭐ 1,307
   One-stop shop for building AI-powered products and businesses with Stripe.

290. **[jadx-ai-mcp](https://github.com/zinja-coder/jadx-ai-mcp)** - ⭐ 1,292
   Plugin for JADX to integrate MCP server

291. **[mcp-remote](https://github.com/geelen/mcp-remote)** - ⭐ 1,284

292. **[MiniMax-MCP](https://github.com/MiniMax-AI/MiniMax-MCP)** - ⭐ 1,274
   Official MiniMax Model Context Protocol (MCP) server that enables interaction with powerful Text to Speech, image generation and video generation APIs.

293. **[kotlin-sdk](https://github.com/modelcontextprotocol/kotlin-sdk)** - ⭐ 1,270
   The official Kotlin SDK for Model Context Protocol servers and clients. Maintained in collaboration with JetBrains

294. **[swift-sdk](https://github.com/modelcontextprotocol/swift-sdk)** - ⭐ 1,266
   The official Swift SDK for Model Context Protocol servers and clients.

295. **[deepwiki-mcp](https://github.com/regenrek/deepwiki-mcp)** - ⭐ 1,262
   📖 MCP server for fetch deepwiki.com and get latest knowledge in Cursor and other Code Editors

296. **[damn-vulnerable-MCP-server](https://github.com/harishsg993010/damn-vulnerable-MCP-server)** - ⭐ 1,258
   Damn Vulnerable MCP Server

297. **[mcp-gateway](https://github.com/docker/mcp-gateway)** - ⭐ 1,253
   docker mcp CLI plugin / MCP Gateway

298. **[terraform-mcp-server](https://github.com/hashicorp/terraform-mcp-server)** - ⭐ 1,246
   The Terraform MCP Server provides seamless integration with Terraform ecosystem, enabling advanced automation and interaction capabilities for Infrastructure as Code (IaC) development.

299. **[tavily-mcp](https://github.com/tavily-ai/tavily-mcp)** - ⭐ 1,243
   Production ready MCP server with real-time search, extract, map & crawl.

300. **[mcp-server-qdrant](https://github.com/qdrant/mcp-server-qdrant)** - ⭐ 1,241
   An official Qdrant Model Context Protocol (MCP) server implementation

301. **[web-eval-agent](https://github.com/refreshdotdev/web-eval-agent)** - ⭐ 1,235
   An MCP server that autonomously evaluates web applications. 

302. **[elevenlabs-mcp](https://github.com/elevenlabs/elevenlabs-mcp)** - ⭐ 1,235
   The official ElevenLabs MCP server

303. **[sre](https://github.com/SmythOS/sre)** - ⭐ 1,232
   The SmythOS Runtime Environment (SRE) is an open-source, cloud-native runtime for agentic AI. Secure, modular, and production-ready, it lets developers build, run, and manage intelligent agents across local, cloud, and edge environments.

304. **[mcp-server-mysql](https://github.com/benborla/mcp-server-mysql)** - ⭐ 1,231
   A Model Context Protocol server that provides read-only access to MySQL databases. This server enables LLMs to inspect database schemas and execute read-only queries.

305. **[web-eval-agent](https://github.com/withRefresh/web-eval-agent)** - ⭐ 1,226
   An MCP server that autonomously evaluates web applications. 

306. **[RisuAI](https://github.com/kwaroran/RisuAI)** - ⭐ 1,222
   Make your own story. User-friendly software for LLM roleplaying

307. **[OpenContracts](https://github.com/Open-Source-Legal/OpenContracts)** - ⭐ 1,222
...
308. **[grafbase](https://github.com/grafbase/grafbase)** - ⭐ 1,214
   The Grafbase GraphQL Federation Gateway

309. **[awesome-claude-plugins](https://github.com/ComposioHQ/awesome-claude-plugins)** - ⭐ 1,210
...
310. **[xmcp](https://github.com/basementstudio/xmcp)** - ⭐ 1,210
   The TypeScript MCP framework

311. **[npcpy](https://github.com/NPC-Worldwide/npcpy)** - ⭐ 1,210
   The python library for research and development in NLP, multimodal LLMs, Agents, ML, Knowledge Graphs, and more.

312. **[kubernetes-mcp-server](https://github.com/containers/kubernetes-mcp-server)** - ⭐ 1,202
   Model Context Protocol (MCP) server for Kubernetes and OpenShift

313. **[A2V](https://github.com/Devin-AXIS/A2V)** - ⭐ 1,201
   A2V: Next-Gen AI Value Compute Protocol.                                                                                 

314. **[cunzhi](https://github.com/imhuso/cunzhi)** - ⭐ 1,201
   告别AI提前终止烦恼，助力AI更加持久

315. **[mcp-golang](https://github.com/metoro-io/mcp-golang)** - ⭐ 1,196
   Write Model Context Protocol servers in few lines of go code. Docs at https://mcpgolang.com . Created by https://metoro.io

316. **[mcp_excalidraw](https://github.com/yctimlin/mcp_excalidraw)** - ⭐ 1,196

317. **[cli](https://github.com/TanStack/cli)** - ⭐ 1,186
   The official TanStack CLI - Project Scaffolding, MCP Server, Agent Skills Installation, etc

318. **[Agent-MCP](https://github.com/rinadelph/Agent-MCP)** - ⭐ 1,171
   Agent-MCP is a framework for creating multi-agent systems that enables coordinated, efficient AI collaboration through the Model Context Protocol (MCP). The system is designed for developers building AI applications that benefit from multiple specialized agents working in parallel on different aspects of a project.

319. **[iMCP](https://github.com/mattt/iMCP)** - ⭐ 1,170
   A macOS app that provides an MCP server to your Messages, Contacts, Reminders and more

320. **[xhs-toolkit](https://github.com/aki66938/xhs-toolkit)** - ⭐ 1,148
   📕 小红书创作者MCP工具包 - 支持与AI客户端集成的内容创作和发布工具

321. **[trustgraph](https://github.com/trustgraph-ai/trustgraph)** - ⭐ 1,147
   Programmable Context for the AI Stack. Build. Version. Deploy. The full lifecycle platform for Context Graphs.

322. **[xiaozhi-esp32-server-java](https://github.com/joey-zhou/xiaozhi-esp32-server-java)** - ⭐ 1,147
   小智ESP32的Java企业级管理平台，提供设备监控、音色定制、角色切换和对话记录管理的前后端及服务端一体化解决方案

323. **[fast-mcp](https://github.com/yjacquin/fast-mcp)** - ⭐ 1,142
   A Ruby Implementation of the Model Context Protocol

324. **[mysql_mcp_server](https://github.com/designcomputer/mysql_mcp_server)** - ⭐ 1,138
   A Model Context Protocol (MCP) server that enables secure interaction with MySQL databases

325. **[claude-code-mcp](https://github.com/steipete/claude-code-mcp)** - ⭐ 1,137
   Claude Code as one-shot MCP server to have an agent in your agent.

326. **[tuui](https://github.com/AI-QL/tuui)** - ⭐ 1,129
   A desktop MCP client designed as a tool unitary utility integration, accelerating AI adoption through the Model Context Protocol (MCP) and enabling cross-vendor LLM API orchestration.

327. **[cui](https://github.com/wbopan/cui)** - ⭐ 1,127
   A web UI for Claude Code agents

328. **[Agent-Reach](https://github.com/Panniantong/Agent-Reach)** - ⭐ 1,120
   Give your AI agent eyes to see the entire internet. Read & search Twitter, Reddit, YouTube, GitHub, Bilibili, XiaoHongShu — one CLI, zero API fees.

329. **[gitlab-mcp](https://github.com/zereight/gitlab-mcp)** - ⭐ 1,086
   First gitlab mcp for you

330. **[Unity-MCP](https://github.com/IvanMurzak/Unity-MCP)** - ⭐ 1,081
   AI-powered bridge connecting LLMs and advanced AI agents to the Unity Editor via the Model Context Protocol (MCP). Chat with AI to generate code, debug errors, and automate game development tasks directly within your project.

331. **[todo-for-ai](https://github.com/todo-for-ai/todo-for-ai)** - ⭐ 1,074
...
332. **[agent-deck](https://github.com/asheshgoplani/agent-deck)** - ⭐ 1,073
   Terminal session manager for AI coding agents. One TUI for Claude, Gemini, OpenCode, Codex, and more.

333. **[flock](https://github.com/Onelevenvy/flock)** - ⭐ 1,072
   Flock is a workflow-based low-code platform for rapidly building chatbots, RAG, and coordinating multi-agent teams, powered by LangGraph, Langchain, FastAPI, and NextJS.（Flock 是一个基于workflow工作流的低代码平台，用于快速构建聊天机器人、RAG、Agent和Muti-Agent应用，采用 LangGraph、Langchain、FastAPI 和 NextJS 构建。）

334. **[claude-init](https://github.com/cfrs2005/claude-init)** - ⭐ 1,072
   Claude Code 中文开发套件 - 为中国开发者定制的零门槛 AI 编程环境。一键安装完整中文化体验，集成 MCP 服务器、智能上下文管理、安全扫描，支持免翻墙访问。让 AI 编程更简单。

335. **[nanobot](https://github.com/nanobot-ai/nanobot)** - ⭐ 1,068
   Build MCP Agents

336. **[docs-mcp-server](https://github.com/arabold/docs-mcp-server)** - ⭐ 1,066
   Grounded Docs MCP Server: Open-Source Alternative to Context7, Nia, and Ref.Tools

337. **[ApeRAG](https://github.com/apecloud/ApeRAG)** - ⭐ 1,053
   ApeRAG: Production-ready GraphRAG with multi-modal indexing, AI agents, MCP support, and scalable K8s deployment

338. **[SearChat](https://github.com/sear-chat/SearChat)** - ⭐ 1,041
   Search + Chat = SearChat(AI Chat with Search), Support OpenAI/Anthropic/VertexAI/Gemini, DeepResearch, SearXNG, Docker.  AI对话式搜索引擎，支持DeepResearch, 支持OpenAI/Anthropic/VertexAI/Gemini接口、聚合搜索引擎SearXNG，支持Docker一键部署。

339. **[wenyan-mcp](https://github.com/caol64/wenyan-mcp)** - ⭐ 1,039
   文颜 MCP Server 可以让 AI 自动将 Markdown 文章排版后发布至微信公众号。

340. **[minima](https://github.com/dmayboroda/minima)** - ⭐ 1,038
   On-premises conversational RAG with configurable containers

341. **[lets-learn-mcp-python](https://github.com/microsoft/lets-learn-mcp-python)** - ⭐ 1,033
   MCP Python Tutorial 

342. **[mcp-server-chatsum](https://github.com/chatmcp/mcp-server-chatsum)** - ⭐ 1,032
   Query and Summarize your chat messages.

343. **[ros-mcp-server](https://github.com/robotmcp/ros-mcp-server)** - ⭐ 1,031
   Connect AI models like Claude & GPT with robots using MCP and ROS.

344. **[mcp-windbg](https://github.com/svnscha/mcp-windbg)** - ⭐ 1,031
   Model Context Protocol for WinDBG

345. **[Gmail-MCP-Server](https://github.com/GongRzhe/Gmail-MCP-Server)** - ⭐ 1,030
   A Model Context Protocol (MCP) server for Gmail integration in Claude Desktop with auto authentication support. This server enables AI assistants to manage Gmail through natural language interactions.

346. **[better-chatbot](https://github.com/cgoinglove/better-chatbot)** - ⭐ 1,028
   Just a Better Chatbot. Powered by Agent & MCP & Workflows.

347. **[Awesome-MCP-Servers](https://github.com/YuzeHao2023/Awesome-MCP-Servers)** - ⭐ 1,026
   A curated list of Model Context Protocol (MCP) servers 

348. **[search_with_ai](https://github.com/yokingma/search_with_ai)** - ⭐ 1,025
...
349. **[notebooklm-mcp](https://github.com/PleasePrompto/notebooklm-mcp)** - ⭐ 1,025
   MCP server for NotebookLM - Let your AI agents (Claude Code, Codex) research documentation directly with grounded, citation-backed answers from Gemini. Persistent auth, library management, cross-client sharing. Zero hallucinations, just your knowledge base.

350. **[WebMCP](https://github.com/MiguelsPizza/WebMCP)** - ⭐ 1,021
   Bringing the power of MCP to the web

351. **[google-calendar-mcp](https://github.com/nspady/google-calendar-mcp)** - ⭐ 1,015
   MCP integration for Google Calendar to manage events.

352. **[mcp-boilerplate](https://github.com/iannuttall/mcp-boilerplate)** - ⭐ 1,010
   A remote Cloudflare MCP server boilerplate with user authentication and Stripe for paid tools.

353. **[awesome-remote-mcp-servers](https://github.com/jaw9c/awesome-remote-mcp-servers)** - ⭐ 1,006
   Remote MCP Servers

354. **[quickstart-resources](https://github.com/modelcontextprotocol/quickstart-resources)** - ⭐ 1,000
   A repository of servers and clients from the Model Context Protocol tutorials

355. **[apple-docs-mcp](https://github.com/kimsungwhee/apple-docs-mcp)** - ⭐ 997
   MCP server for Apple Developer Documentation - Search iOS/macOS/SwiftUI/UIKit docs, WWDC videos, Swift/Objective-C APIs & code examples in Claude, Cursor & AI assistants

356. **[fetcher-mcp](https://github.com/jae-jae/fetcher-mcp)** - ⭐ 992
   MCP server for fetch web page content using Playwright headless browser.

357. **[Claude-Code-Everything-You-Need-to-Know](https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know)** - ⭐ 992
   The ultimate all-in-one guide to mastering Claude Code. From setup, prompt engineering, commands, hooks, workflows, automation, and integrations, to MCP servers, tools, and the BMAD method—packed with step-by-step tutorials, real-world examples, and expert strategies to make this the global go-to repo for Claude mastery.

358. **[short-video-maker](https://github.com/gyoridavid/short-video-maker)** - ⭐ 986
   Creates short videos for TikTok, Instagram Reels, and YouTube Shorts using the Model Context Protocol (MCP) and a REST API.

359. **[ref-tools-mcp](https://github.com/ref-tools/ref-tools-mcp)** - ⭐ 985
   Helping coding agents never make mistakes working with public or private libraries without wasting the context window.

360. **[ai-dev-tools-zoomcamp](https://github.com/DataTalksClub/ai-dev-tools-zoomcamp)** - ⭐ 985
...
361. **[RedNote-MCP](https://github.com/iFurySt/RedNote-MCP)** - ⭐ 978
   🚀MCP server for accessing RedNote(XiaoHongShu, xhs).

362. **[ollama-mcp-bridge](https://github.com/patruff/ollama-mcp-bridge)** - ⭐ 965
   Bridge between Ollama and MCP servers, enabling local LLMs to use Model Context Protocol tools

363. **[CloudBase-MCP](https://github.com/TencentCloudBase/CloudBase-MCP)** - ⭐ 961
      CloudBase MCP - Connect CloudBase to your AI Agent.     Go from AI prompt to live app. 

364. **[agents](https://github.com/inkeep/agents)** - ⭐ 960
   Create AI Agents in a No-Code Visual Builder or TypeScript SDK with full 2-way sync. For shipping AI assistants and multi-agent AI workflows.

365. **[paperbanana](https://github.com/llmsresearch/paperbanana)** - ⭐ 958
   Open source implementation and extension of Google Research’s PaperBanana for automated academic figures, diagrams, and research visuals, expanded to new domains like slide generation.

366. **[ha-mcp](https://github.com/homeassistant-ai/ha-mcp)** - ⭐ 956
   The Unofficial and Awesome Home Assistant MCP Server

367. **[gemini-nexus](https://github.com/yeahhe365/gemini-nexus)** - ⭐ 954
...
368. **[awesome-devops-mcp-servers](https://github.com/rohitg00/awesome-devops-mcp-servers)** - ⭐ 950
   A curated list of awesome MCP servers focused on DevOps tools and capabilities.

369. **[tools](https://github.com/strands-agents/tools)** - ⭐ 945
   A set of tools that gives agents powerful capabilities.

370. **[mcp-jetbrains](https://github.com/JetBrains/mcp-jetbrains)** - ⭐ 943
   A model context protocol server to work with JetBrains IDEs: IntelliJ, PyCharm, WebStorm, etc. Also, works with Android Studio

371. **[linkedin-mcp-server](https://github.com/stickerdaniel/linkedin-mcp-server)** - ⭐ 936
...
372. **[mcpdoc](https://github.com/langchain-ai/mcpdoc)** - ⭐ 931
   Expose llms-txt to IDEs for development

373. **[Pixelle-MCP](https://github.com/AIDC-AI/Pixelle-MCP)** - ⭐ 926
   An Open-Source Multimodal AIGC Solution based on ComfyUI + MCP + LLM  https://pixelle.ai

374. **[mongodb-mcp-server](https://github.com/mongodb-js/mongodb-mcp-server)** - ⭐ 925
   A Model Context Protocol server to connect to MongoDB databases and MongoDB Atlas Clusters.

375. **[MCP-Bridge](https://github.com/SecretiveShell/MCP-Bridge)** - ⭐ 916
   A middleware to provide an openAI compatible endpoint that can call MCP tools

376. **[agentic-radar](https://github.com/splx-ai/agentic-radar)** - ⭐ 915
   A security scanner for your LLM agentic workflows

377. **[amical](https://github.com/amicalhq/amical)** - ⭐ 911
   🎙️ AI Dictation App - Open Source and Local-first ⚡ Type 3x faster, no keyboard needed. 🆓 Powered by open source models, works offline, fast and accurate.

378. **[mcp-neo4j](https://github.com/neo4j-contrib/mcp-neo4j)** - ⭐ 910
   Neo4j Labs Model Context Protocol servers

379. **[CloudBase-AI-ToolKit](https://github.com/TencentCloudBase/CloudBase-AI-ToolKit)** - ⭐ 909
      CloudBase MCP - Connect CloudBase to your AI Agent.     Go from AI prompt to live app in one click.

380. **[jupyter-mcp-server](https://github.com/datalayer/jupyter-mcp-server)** - ⭐ 908
   🪐 🔧 Model Context Protocol (MCP) Server for Jupyter.

381. **[trpc-agent-go](https://github.com/trpc-group/trpc-agent-go)** - ⭐ 908
   trpc-agent-go is a powerful Go framework for building intelligent agent systems using large language models (LLMs) and tools.

382. **[mcp-framework](https://github.com/QuantGeekDev/mcp-framework)** - ⭐ 904
   A framework for writing MCP (Model Context Protocol) servers in Typescript

383. **[mcp-browser-use](https://github.com/Saik0s/mcp-browser-use)** - ⭐ 902

384. **[mcp-cli](https://github.com/philschmid/mcp-cli)** - ⭐ 900
   Lighweight CLI to interact with MCP servers

385. **[nuxt-mcp-dev](https://github.com/antfu/nuxt-mcp-dev)** - ⭐ 898
   MCP server helping models to understand your Vite/Nuxt app better.

386. **[mcpm.sh](https://github.com/pathintegral-institute/mcpm.sh)** - ⭐ 895
   CLI MCP package manager & registry for all platforms and all clients. Search & configure MCP servers. Advanced Router & Profile features.

387. **[chatgpt-cli](https://github.com/kardolus/chatgpt-cli)** - ⭐ 890
...
388. **[himarket](https://github.com/higress-group/himarket)** - ⭐ 882
...
389. **[MCProtocolLib](https://github.com/GeyserMC/MCProtocolLib)** - ⭐ 882
   A library for communication with a Minecraft client/server.

390. **[mix.core](https://github.com/mixcore/mix.core)** - ⭐ 881
   🚀 A future-proof enterprise web CMS supporting both headless and decoupled approaches. Build any type of app with customizable APIs on ASP.NET Core/.NET Core. Completely open-source and designed for flexibility.

391. **[openapi-mcp-server](https://github.com/janwilmake/openapi-mcp-server)** - ⭐ 878
   Allow AI to wade through complex OpenAPIs using Simple Language

392. **[excalidraw-mcp-app](https://github.com/antonpk1/excalidraw-mcp-app)** - ⭐ 876
   Excalidraw MCP App Server — hand-drawn diagrams for Claude

393. **[AI-Gateway](https://github.com/Azure-Samples/AI-Gateway)** - ⭐ 874
...
394. **[MCPJungle](https://github.com/mcpjungle/MCPJungle)** - ⭐ 873
   Self-hosted MCP Gateway for AI agents

395. **[mcp-course](https://github.com/huggingface/mcp-course)** - ⭐ 871

396. **[memory-bank-mcp](https://github.com/alioshr/memory-bank-mcp)** - ⭐ 867
   A Model Context Protocol (MCP) server implementation for remote memory bank management, inspired by Cline Memory Bank.

397. **[hyper-mcp](https://github.com/hyper-mcp-rs/hyper-mcp)** - ⭐ 865
   📦️ A fast, secure MCP server that extends its capabilities through WebAssembly plugins.

398. **[awesome-mcp-list](https://github.com/MobinX/awesome-mcp-list)** - ⭐ 864
   A concise list for mcp servers

399. **[OpenDerisk](https://github.com/derisk-ai/OpenDerisk)** - ⭐ 861
...
400. **[mcp-notion-server](https://github.com/suekou/mcp-notion-server)** - ⭐ 859

401. **[claude-delegator](https://github.com/jarrodwatts/claude-delegator)** - ⭐ 856
   Delegate tasks to Codex GPT 5.2 directly from within Claude Code.

402. **[excel-mcp-server](https://github.com/negokaz/excel-mcp-server)** - ⭐ 854
   A Model Context Protocol (MCP) server that reads and writes MS Excel data

403. **[browserwing](https://github.com/browserwing/browserwing)** - ⭐ 853
...
404. **[wassette](https://github.com/microsoft/wassette)** - ⭐ 846
   Wassette: A security-oriented runtime that runs WebAssembly Components via MCP

405. **[openapi-servers](https://github.com/open-webui/openapi-servers)** - ⭐ 846
   OpenAPI Tool Servers

406. **[mcp-sequential-thinking](https://github.com/arben-adm/mcp-sequential-thinking)** - ⭐ 844

407. **[kubectl-mcp-server](https://github.com/rohitg00/kubectl-mcp-server)** - ⭐ 837
   A Model Context Protocol (MCP) server for Kubernetes. Install: npx kubectl-mcp-server or pip install kubectl-mcp-server

408. **[CyberStrikeAI](https://github.com/Ed1s0nZ/CyberStrikeAI)** - ⭐ 836
   CyberStrikeAI is an AI-native security testing platform built in Go. It integrates 100+ security tools, an intelligent orchestration engine, role-based testing with predefined security roles, a skills system with specialized testing skills, and comprehensive lifecycle management capabilities.

409. **[hyper-mcp](https://github.com/tuananh/hyper-mcp)** - ⭐ 835
   📦️ A fast, secure MCP server that extends its capabilities through WebAssembly plugins.

410. **[hyper-mcp](https://github.com/joseph-wortmann/hyper-mcp)** - ⭐ 834
   📦️ A fast, secure MCP server that extends its capabilities through WebAssembly plugins.

411. **[scira-mcp-chat](https://github.com/zaidmukaddam/scira-mcp-chat)** - ⭐ 830
   A minimalistic MCP client with a good feature set.

412. **[yokai](https://github.com/ankorstore/yokai)** - ⭐ 822
   Simple, modular, and observable Go framework for backend applications.

413. **[statespace](https://github.com/statespace-tech/statespace)** - ⭐ 820
   Interactive web apps for AI agents

414. **[mcp-scanner](https://github.com/cisco-ai-defense/mcp-scanner)** - ⭐ 818
   Scan MCP servers for potential threats & security findings.

415. **[arcade-mcp](https://github.com/ArcadeAI/arcade-mcp)** - ⭐ 815
   The best way to create, deploy, and share MCP Servers

416. **[duckduckgo-mcp-server](https://github.com/nickclyde/duckduckgo-mcp-server)** - ⭐ 815
   A Model Context Protocol (MCP) server that provides web search capabilities through DuckDuckGo, with additional features for content fetching and parsing.

417. **[supabase-mcp-server](https://github.com/alexander-zuev/supabase-mcp-server)** - ⭐ 813
   Query MCP enables end-to-end management of Supabase via chat interface: read & write query executions, management API support, automatic migration versioning, access to logs and much more.

418. **[server](https://github.com/php-mcp/server)** - ⭐ 813
   Core PHP implementation for the Model Context Protocol (MCP) server

419. **[golf](https://github.com/golf-mcp/golf)** - ⭐ 811
   Production-Ready MCP Server Framework • Build, deploy & scale secure AI agent infrastructure • Includes Auth, Observability, Debugger, Telemetry & Runtime • Run real-world MCPs powering AI Agents 

420. **[apify-mcp-server](https://github.com/apify/apify-mcp-server)** - ⭐ 811
   The Apify MCP server enables your AI agents to extract data from social media, search engines, maps, e-commerce sites, or any other website using thousands of ready-made scrapers, crawlers, and automation tools available on the Apify Store.

421. **[toolfront](https://github.com/statespace-tech/toolfront)** - ⭐ 809
   Turn your data into shareable RAG apps in minutes. All in pure Markdown. Zero boilerplate.

422. **[claude-scholar](https://github.com/Galaxy-Dawn/claude-scholar)** - ⭐ 809
...
423. **[MassGen](https://github.com/massgen/MassGen)** - ⭐ 808
...
424. **[CodeGraphContext](https://github.com/CodeGraphContext/CodeGraphContext)** - ⭐ 808
   An MCP server plus a CLI tool that indexes local code into a graph database to provide context to AI assistants.

425. **[browser-use-mcp-server](https://github.com/kontext-dev/browser-use-mcp-server)** - ⭐ 806
   Browse the web, directly from Cursor etc.

426. **[DeepMCPAgent](https://github.com/cryxnet/DeepMCPAgent)** - ⭐ 805
   Model-agnostic plug-n-play LangChain/LangGraph agents powered entirely by MCP tools over HTTP/SSE.

427. **[MCP-Security-Checklist](https://github.com/slowmist/MCP-Security-Checklist)** - ⭐ 804
   A comprehensive security checklist for MCP-based AI tools. Built by SlowMist to safeguard LLM plugin ecosystems.

428. **[context-space](https://github.com/context-space/context-space)** - ⭐ 802
   Ultimate Context Engineering Infrastructure, starting from MCPs and Integrations

429. **[mcp-knowledge-graph](https://github.com/shaneholloman/mcp-knowledge-graph)** - ⭐ 800
   MCP server enabling persistent memory for Claude through a local knowledge graph - fork focused on local development

430. **[acemcp](https://github.com/qy527145/acemcp)** - ⭐ 798
   一个将ACE(Augment Context Engine) 做成MCP的项目

431. **[qgis_mcp](https://github.com/jjsantos01/qgis_mcp)** - ⭐ 797
   Model Context Protocol (MCP) that allows LLMs to use QGIS Desktop

432. **[bank-api](https://github.com/erwinkramer/bank-api)** - ⭐ 795
   The Bank API is a design reference project suitable to bootstrap development for a compliant and modern API.

433. **[code-index-mcp](https://github.com/johnhuang316/code-index-mcp)** - ⭐ 792
   A Model Context Protocol (MCP) server that helps large language models index, search, and analyze code repositories with minimal setup

434. **[agent-kit](https://github.com/inngest/agent-kit)** - ⭐ 791
   AgentKit: Build multi-agent networks in TypeScript with deterministic routing and rich tooling via MCP.

435. **[k8m](https://github.com/weibaohui/k8m)** - ⭐ 788
   一款轻量级、跨平台的 Mini Kubernetes AI Dashboard，支持大模型+智能体+MCP(支持设置操作权限)，集成多集群管理、智能分析、实时异常检测等功能，支持多架构并可单文件部署，助力高效集群管理与运维优化。

436. **[coderunner](https://github.com/instavm/coderunner)** - ⭐ 786
   A secure local sandbox to run LLM-generated code using Apple containers

437. **[vllora](https://github.com/vllora/vllora)** - ⭐ 779
   Debug your AI agents

438. **[heurist-agent-framework](https://github.com/heurist-network/heurist-agent-framework)** - ⭐ 779
   A flexible multi-interface AI agent framework for building agents with reasoning, tool use, memory, deep research, blockchain interaction, MCP, and agents-as-a-service.

439. **[Context](https://github.com/indragiek/Context)** - ⭐ 778
   Native macOS client for Model Context Protocol (MCP)

440. **[vibetest-use](https://github.com/browser-use/vibetest-use)** - ⭐ 768
   Vibetest MCP - automated QA testing using Browser-Use agents

441. **[glean](https://github.com/LeslieLeung/glean)** - ⭐ 768
   A self-hosted RSS reader and personal knowledge management tool.

442. **[runno](https://github.com/taybenlor/runno)** - ⭐ 760
   Sandboxed runtime for programming languages and WASI binaries. Works in the browser, on your server, or via MCP.

443. **[mcp-server](https://github.com/financial-datasets/mcp-server)** - ⭐ 758
   An MCP server for interacting with the Financial Datasets stock market API.

444. **[mcp-marketplace](https://github.com/cline/mcp-marketplace)** - ⭐ 753
...
445. **[context-portal](https://github.com/GreatScottyMac/context-portal)** - ⭐ 750
...
446. **[drift](https://github.com/dadbodgeoff/drift)** - ⭐ 750
   Codebase intelligence for AI. Detects patterns & conventions + remembers decisions across sessions. MCP server for any IDE. Offline CLI.

447. **[AITreasureBox](https://github.com/superiorlu/AITreasureBox)** - ⭐ 748
   🤖 Collect practical AI repos, tools, websites, papers and tutorials on AI. 实用的AI百宝箱 💎 

448. **[drawio-mcp](https://github.com/jgraph/drawio-mcp)** - ⭐ 747

449. **[lisa.py](https://github.com/ant4g0nist/lisa.py)** - ⭐ 740
   LLDB MCP Integration + other helpful commands

450. **[telegram-mcp](https://github.com/chigwell/telegram-mcp)** - ⭐ 739
   Telegram MCP server powered by Telethon to let MCP clients read chats, manage groups, and send/modify messages, media, contacts, and settings.

451. **[mcp](https://github.com/hyperbrowserai/mcp)** - ⭐ 738
   A MCP server implementation for hyperbrowser

452. **[annas-mcp](https://github.com/iosifache/annas-mcp)** - ⭐ 737
   MCP server and CLI tool for searching and downloading documents from Anna's Archive

453. **[octocode-mcp](https://github.com/bgauryy/octocode-mcp)** - ⭐ 734
   MCP server for semantic code research and context generation on real-time using LLM patterns | Search naturally across public & private repos based on your permissions | Transform any accessible codebase/s into AI-optimized knowledge on simple and complex flows | Find real implementations and live docs from anywhere

454. **[ruby-sdk](https://github.com/modelcontextprotocol/ruby-sdk)** - ⭐ 733
   The official Ruby SDK for the Model Context Protocol.

455. **[12306-mcp](https://github.com/Joooook/12306-mcp)** - ⭐ 729
   This is a 12306 ticket search server based on the Model Context Protocol (MCP).

456. **[openmcp-client](https://github.com/LSTM-Kirigaya/openmcp-client)** - ⭐ 728
   All in one vscode plugin for mcp developer

457. **[drawio-mcp-server](https://github.com/lgazo/drawio-mcp-server)** - ⭐ 723
   Draw.io Model Context Protocol (MCP) Server

458. **[just-prompt](https://github.com/disler/just-prompt)** - ⭐ 715
...
459. **[passage-of-time-mcp](https://github.com/jlumbroso/passage-of-time-mcp)** - ⭐ 713
...
460. **[llm-functions](https://github.com/sigoden/llm-functions)** - ⭐ 712
   Easily create LLM tools and agents using plain Bash/JavaScript/Python functions.

461. **[llm-server-docs](https://github.com/varunvasudeva1/llm-server-docs)** - ⭐ 702
   End-to-end documentation to set up your own local & fully private LLM server on Debian. Equipped with chat, web search, RAG, model management, MCP servers, image generation, and TTS.

462. **[mcpcan](https://github.com/Kymo-MCP/mcpcan)** - ⭐ 702
...
463. **[mcp-google-sheets](https://github.com/xing5/mcp-google-sheets)** - ⭐ 701
   This MCP server integrates with your Google Drive and Google Sheets, to enable creating and modifying spreadsheets.

464. **[paper-search-mcp](https://github.com/openags/paper-search-mcp)** - ⭐ 700
   A MCP for searching and downloading academic papers from multiple sources like arXiv, PubMed, bioRxiv, etc.

465. **[fetch-mcp](https://github.com/zcaceres/fetch-mcp)** - ⭐ 695
   A flexible HTTP fetching Model Context Protocol server.

466. **[mcp-clickhouse](https://github.com/ClickHouse/mcp-clickhouse)** - ⭐ 694
   Connect ClickHouse to your AI assistants.

467. **[HowToCook-mcp](https://github.com/worryzyy/HowToCook-mcp)** - ⭐ 693
   基于Anduin2017 / HowToCook （程序员在家做饭指南）的mcp server

468. **[clojure-mcp](https://github.com/bhauman/clojure-mcp)** - ⭐ 692
   Clojure MCP

469. **[brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server)** - ⭐ 689

470. **[langgraph-mcp-agents](https://github.com/teddynote-lab/langgraph-mcp-agents)** - ⭐ 686
...
471. **[macos-automator-mcp](https://github.com/steipete/macos-automator-mcp)** - ⭐ 686
   An MCP server to run AppleScript and JXA (JavaScript for Automation) to macOS.

472. **[gcloud-mcp](https://github.com/googleapis/gcloud-mcp)** - ⭐ 685
   gcloud MCP server

473. **[awesome-openclaw](https://github.com/SamurAIGPT/awesome-openclaw)** - ⭐ 684
   A curated list of OpenClaw resources, tools, skills, tutorials & articles. OpenClaw (formerly Moltbot / Clawdbot) — open-source self-hosted AI agent for WhatsApp, Telegram, Discord & 50+ integrations.

474. **[mcp](https://github.com/laravel/mcp)** - ⭐ 683
   Rapidly build MCP servers for your Laravel applications.

475. **[cuga-agent](https://github.com/cuga-project/cuga-agent)** - ⭐ 682
...
476. **[nuwax](https://github.com/nuwax-ai/nuwax)** - ⭐ 680
...
477. **[burp-ai-agent](https://github.com/six2dez/burp-ai-agent)** - ⭐ 679
   Burp Suite extension that adds built-in MCP tooling, AI-assisted analysis, privacy controls, passive and active scanning and more

478. **[mcp-server-docker](https://github.com/ckreiling/mcp-server-docker)** - ⭐ 677
   MCP server for Docker

479. **[open-ptc-agent](https://github.com/Chen-zexi/open-ptc-agent)** - ⭐ 672
   An open source implementation of code execution with MCP (Programatic Tool Calling) 

480. **[android-mcp-server](https://github.com/minhalvp/android-mcp-server)** - ⭐ 670
   An MCP server that provides control over Android devices via adb

481. **[mcp-client-cli](https://github.com/adhikasp/mcp-client-cli)** - ⭐ 667
   A simple CLI to run LLM prompt and implement MCP client.

482. **[go-mcp](https://github.com/ThinkInAIXYZ/go-mcp)** - ⭐ 666
...
483. **[awesome-mcp-security](https://github.com/Puliczek/awesome-mcp-security)** - ⭐ 657
   🔥🔒 Awesome MCP (Model Context Protocol) Security 🖥️

484. **[yacy_grid_mcp](https://github.com/yacy/yacy_grid_mcp)** - ⭐ 655
   The YaCy Grid Master Connect Program

485. **[mcp-mem0](https://github.com/coleam00/mcp-mem0)** - ⭐ 649
   MCP server for long term agent memory with Mem0. Also useful as a template to get you started building your own MCP server with Python!

486. **[laravel-restify](https://github.com/BinarCode/laravel-restify)** - ⭐ 649
   Laravel API for Ai Agents and humans.

487. **[next-devtools-mcp](https://github.com/vercel/next-devtools-mcp)** - ⭐ 649
   Next.js Development for Coding Agent

488. **[llm-search](https://github.com/snexus/llm-search)** - ⭐ 648
   Querying local documents, powered by LLM

489. **[mcp-proxy](https://github.com/tbxark/mcp-proxy)** - ⭐ 646
   An MCP proxy server that aggregates and serves multiple MCP resource servers through a single HTTP server.

490. **[wcgw](https://github.com/rusiaaman/wcgw)** - ⭐ 644
   Shell and coding agent on mcp clients

491. **[samples](https://github.com/strands-agents/samples)** - ⭐ 644
   Agent samples built using the Strands Agents SDK.

492. **[enrichmcp](https://github.com/featureform/enrichmcp)** - ⭐ 642
   EnrichMCP is a python framework for building data driven MCP servers

493. **[obsidian-mcp](https://github.com/StevenStavrakis/obsidian-mcp)** - ⭐ 642
   A simple MCP server for Obsidian

494. **[claude-code-plugins-plus](https://github.com/jeremylongshore/claude-code-plugins-plus)** - ⭐ 641
...
495. **[RAGLight](https://github.com/Bessouat40/RAGLight)** - ⭐ 638
   RAGLight is a modular framework for Retrieval-Augmented Generation (RAG). It makes it easy to plug in different LLMs, embeddings, and vector stores, and now includes seamless MCP integration to connect external tools and data sources.

496. **[skybridge](https://github.com/alpic-ai/skybridge)** - ⭐ 638
   Skybridge is a framework for building ChatGPT & MCP Apps

497. **[python-utcp](https://github.com/universal-tool-calling-protocol/python-utcp)** - ⭐ 637
   Official python implementation of UTCP. UTCP is an open standard that lets AI agents call any API directly, without extra middleware.

498. **[TuriX-CUA](https://github.com/TurixAI/TuriX-CUA)** - ⭐ 637
   This is the official website for TuriX Computer-use-Agent

499. **[figma-console-mcp](https://github.com/southleft/figma-console-mcp)** - ⭐ 633
   Your design system as an API. Connect AI to Figma for extraction, creation, and debugging.

500. **[workers-mcp](https://github.com/cloudflare/workers-mcp)** - ⭐ 628
   Talk to a Cloudflare Worker from Claude Desktop!

501. **[mcp-proxy](https://github.com/TBXark/mcp-proxy)** - ⭐ 624
   An MCP proxy server that aggregates and serves multiple MCP resource servers through a single HTTP server.

502. **[notebooklm-mcp](https://github.com/jacob-bd/notebooklm-mcp)** - ⭐ 624

503. **[obot](https://github.com/obot-platform/obot)** - ⭐ 621
   Complete MCP Platform -- Hosting, Registry, Gateway, and Chat Client

504. **[douyin-mcp-server](https://github.com/yzfly/douyin-mcp-server)** - ⭐ 618
   提取抖音无水印视频链接，视频文案，douyin-mcp-server，mcp，claude skill

505. **[a-share-mcp-is-just-i-need](https://github.com/24mlight/a-share-mcp-is-just-i-need)** - ⭐ 616

506. **[yargi-mcp](https://github.com/saidsurucu/yargi-mcp)** - ⭐ 615
   MCP Server For Turkish Legal Databases

507. **[vibe](https://github.com/mondaycom/vibe)** - ⭐ 614
   🎨 Vibe Design System - Official monday.com UI resources for application development in React.js

508. **[mcp-server-elasticsearch](https://github.com/elastic/mcp-server-elasticsearch)** - ⭐ 614

509. **[headroom](https://github.com/chopratejas/headroom)** - ⭐ 612
   The Context Optimization Layer for LLM Applications

510. **[phpMyFAQ](https://github.com/thorsten/phpMyFAQ)** - ⭐ 610
   phpMyFAQ - Open Source FAQ web application for PHP 8.3+ and MySQL, PostgreSQL and other databases

511. **[mem-agent-mcp](https://github.com/firstbatchxyz/mem-agent-mcp)** - ⭐ 610
   mem-agent mcp server

512. **[reverse-engineering-assistant](https://github.com/cyberkaida/reverse-engineering-assistant)** - ⭐ 606
   MCP server for reverse engineering tasks in Ghidra 👩‍💻

513. **[obsidian-mcp-tools](https://github.com/jacksteamdev/obsidian-mcp-tools)** - ⭐ 604
   Add Obsidian integrations like semantic search and custom Templater prompts to Claude or any MCP client.

514. **[mcp-filesystem-server](https://github.com/mark3labs/mcp-filesystem-server)** - ⭐ 603
   Go server implementing Model Context Protocol (MCP) for filesystem operations.

515. **[mem0-mcp](https://github.com/mem0ai/mem0-mcp)** - ⭐ 601

516. **[mcp-link](https://github.com/automation-ai-labs/mcp-link)** - ⭐ 600
   Convert Any OpenAPI V3 API to MCP Server

517. **[daydreams](https://github.com/daydreamsai/daydreams)** - ⭐ 599
   Daydreams is a set of tools for building agents for commerce

518. **[FofaMap](https://github.com/asaotomo/FofaMap)** - ⭐ 598
...
519. **[awesome-web3-mcp-servers](https://github.com/demcp/awesome-web3-mcp-servers)** - ⭐ 595
...
520. **[flow-like](https://github.com/TM9657/flow-like)** - ⭐ 594
   Flow-Like: Strongly Typed Enterprise Scale Workflows. Built for scalability, speed, seamless AI integration and rich customization.

521. **[FantasyPremierLeague](https://github.com/joreilly/FantasyPremierLeague)** - ⭐ 593
   Fantasy Premier League Kotlin/Compose Multiplatform sample 

522. **[tome](https://github.com/runebookai/tome)** - ⭐ 590
   a magical LLM desktop client that makes it easy for *anyone* to use LLMs and MCP

523. **[awesome-claude-code-toolkit](https://github.com/rohitg00/awesome-claude-code-toolkit)** - ⭐ 589
...
524. **[FLUJO](https://github.com/mario-andreschak/FLUJO)** - ⭐ 588
   MCP-Hub and -Inspector, Multi-Model Workflow and Chat Interface 

525. **[Wax](https://github.com/christopherkarani/Wax)** - ⭐ 587
   🍯 Memory layer for on-device AI Agents. Replace complex RAG pipelines with a serverless, single-file memory layer. 

526. **[MCP-Nest](https://github.com/rekog-labs/MCP-Nest)** - ⭐ 586
   A NestJS module to effortlessly create Model Context Protocol (MCP) servers for exposing AI tools, resources, and prompts.

527. **[dexto](https://github.com/truffle-ai/dexto)** - ⭐ 582
   A coding agent and general agent harness for building and orchestrating agentic applications.

528. **[mcp-adapter](https://github.com/WordPress/mcp-adapter)** - ⭐ 582
   An MCP adapter that bridges the Abilities API to the Model Context Protocol, enabling MCP clients to discover and invoke WordPress plugin, theme, and core abilities programmatically.

529. **[blueprint-mcp](https://github.com/ArcadeAI/blueprint-mcp)** - ⭐ 581
   Diagram generation for understanding codebases and system architecture using Nano Banana Pro.

530. **[spotify-mcp](https://github.com/varunneal/spotify-mcp)** - ⭐ 578
   MCP to connect your LLM with Spotify.

531. **[langgraph-mcp](https://github.com/esxr/langgraph-mcp)** - ⭐ 576
   LangGraph solution template for MCP

532. **[cclsp](https://github.com/ktnyt/cclsp)** - ⭐ 569
   Claude Code LSP: enhance your Claude Code experience with non-IDE dependent LSP integration.

533. **[sentry-mcp](https://github.com/getsentry/sentry-mcp)** - ⭐ 569
   An MCP server for interacting with Sentry via LLMs.

534. **[mcp-sequentialthinking-tools](https://github.com/spences10/mcp-sequentialthinking-tools)** - ⭐ 566
   🧠 An adaptation of the MCP Sequential Thinking Server to guide tool usage. This server provides recommendations for which MCP tools would be most effective at each stage.

535. **[mcp-handler](https://github.com/vercel/mcp-handler)** - ⭐ 566
   Easily spin up an MCP Server on Next.js, Nuxt, Svelte, and more

536. **[cupertino](https://github.com/mihaelamj/cupertino)** - ⭐ 565
   A local Apple Documentation crawler and MCP server. Written in Swift.

537. **[mcp-pointer](https://github.com/etsd-tech/mcp-pointer)** - ⭐ 564
   MCP tool: let you point at DOM elements for your favorite agentic coding tool. Let AI see what you see.

538. **[manim-mcp-server](https://github.com/abhiemj/manim-mcp-server)** - ⭐ 563

539. **[MCP-Universe](https://github.com/SalesforceAIResearch/MCP-Universe)** - ⭐ 561
   MCP-Universe is a comprehensive framework designed for developing, testing, and benchmarking AI agents

540. **[LLMTornado](https://github.com/lofcz/LLMTornado)** - ⭐ 560
   The .NET library to build AI agents with 30+ built-in connectors.

541. **[apple-doc-mcp](https://github.com/MightyDillah/apple-doc-mcp)** - ⭐ 560
   MCP server providing seamless access to Apple Developer Documentation with smart search and wildcard support

542. **[mcp-obsidian](https://github.com/bitbonsai/mcp-obsidian)** - ⭐ 560
   A lightweight Model Context Protocol (MCP) server for safe Obsidian vault access

543. **[wren-engine](https://github.com/Canner/wren-engine)** - ⭐ 557
   🤖 The Semantic Engine for Model Context Protocol(MCP) Clients and AI Agents 🔥 

544. **[mcp-for-security](https://github.com/cyproxio/mcp-for-security)** - ⭐ 557
   MCP for Security: A collection of Model Context Protocol servers for popular security tools like SQLMap, FFUF, NMAP, Masscan and more. Integrate security testing and penetration testing into AI workflows.

545. **[generative-ui](https://github.com/CopilotKit/generative-ui)** - ⭐ 557
   Generative UI examples for: AG-UI, A2UI/Open-JSON-UI, and MCP Apps.

546. **[davinci-resolve-mcp](https://github.com/samuelgursky/davinci-resolve-mcp)** - ⭐ 556
   MCP server integration for DaVinci Resolve

547. **[caswaf](https://github.com/casbin/caswaf)** - ⭐ 555
   Casbin AI & MCP security gateway for HTTP, online demo: https://door.caswaf.com

548. **[awesome-mcp-servers](https://github.com/TensorBlock/awesome-mcp-servers)** - ⭐ 555
   A comprehensive collection of Model Context Protocol (MCP) servers

549. **[web-search-mcp](https://github.com/mrkrsl/web-search-mcp)** - ⭐ 555
   A simple, locally hosted Web Search MCP server for use with Local LLMs

550. **[mcp-server-neon](https://github.com/neondatabase/mcp-server-neon)** - ⭐ 554
   MCP server for interacting with Neon Management API and databases

551. **[google-search](https://github.com/web-agent-master/google-search)** - ⭐ 553
   A Playwright-based Node.js tool that bypasses search engine anti-scraping mechanisms to execute Google searches. Local alternative to SERP APIs with MCP server integration.

552. **[evo-ai](https://github.com/EvolutionAPI/evo-ai)** - ⭐ 551
   Evo AI is an open-source platform for creating and managing AI agents, enabling integration with different AI models and services.

553. **[mcp-client-for-ollama](https://github.com/jonigl/mcp-client-for-ollama)** - ⭐ 550
   A text-based user interface (TUI) client for interacting with MCP servers using Ollama. Features include agent mode, multi-server, model switching, streaming responses, tool management, human-in-the-loop, thinking mode, model params config, MCP prompts, custom system prompt and saved preferences. Built for developers working with local LLMs.

554. **[freecad-mcp](https://github.com/neka-nat/freecad-mcp)** - ⭐ 549
   FreeCAD MCP(Model Context Protocol) server

555. **[mcp-shield](https://github.com/riseandignite/mcp-shield)** - ⭐ 545
   Security scanner for MCP servers

556. **[vite-plugin-vue-mcp](https://github.com/webfansplz/vite-plugin-vue-mcp)** - ⭐ 545
   Vite plugin that enables a MCP server helping models to understand your Vue app better.

557. **[mcp.el](https://github.com/lizqwerscott/mcp.el)** - ⭐ 545
   An Mcp client inside Emacs

558. **[homeassistant-mcp](https://github.com/tevonsb/homeassistant-mcp)** - ⭐ 544
   A MCP server for Home Assistant

559. **[multimodal-agents-course](https://github.com/the-ai-merge/multimodal-agents-course)** - ⭐ 543
   An MCP Multimodal AI Agent with eyes and ears!

560. **[echokit_server](https://github.com/second-state/echokit_server)** - ⭐ 542
   Open Source Voice Agent Platform

561. **[cloud-run-mcp](https://github.com/GoogleCloudPlatform/cloud-run-mcp)** - ⭐ 542
   MCP server to deploy apps to Cloud Run

562. **[Mantic.sh](https://github.com/marcoaapfortes/Mantic.sh)** - ⭐ 539
   A structural code search engine for Al agents.

563. **[tda](https://github.com/irockel/tda)** - ⭐ 536
   TDA - Thread Dump Analyzer (for Java). Analyze your Thread Dumps with a GUI or use it as MCP Server.

564. **[fastapi-mcp-langgraph-template](https://github.com/NicholasGoh/fastapi-mcp-langgraph-template)** - ⭐ 536
   A modern template for agentic orchestration — built for rapid iteration and scalable deployment using highly customizable, community-supported tools like MCP, LangGraph, and more.

565. **[pg-mcp-server](https://github.com/stuzero/pg-mcp-server)** - ⭐ 535

566. **[dolphin-mcp](https://github.com/QuixiAI/dolphin-mcp)** - ⭐ 532

567. **[AnyTool](https://github.com/HKUDS/AnyTool)** - ⭐ 532
   "AnyTool: Universal Tool-Use Layer for AI Agents"

568. **[Overture](https://github.com/SixHq/Overture)** - ⭐ 530
   Overture is an open-source, locally running web interface delivered as an MCP (Model Context Protocol) server that visually maps out the execution plan of any AI coding agent as an interactive flowchart/graph before the agent begins writing code. 

569. **[iterm-mcp](https://github.com/ferrislucas/iterm-mcp)** - ⭐ 529
   A Model Context Protocol server that executes commands in the current iTerm session - useful for REPL and CLI assistance

570. **[cli](https://github.com/smithery-ai/cli)** - ⭐ 527
   Install, manage and develop MCP servers and skills for agents

571. **[mcp-server-data-exploration](https://github.com/reading-plus-ai/mcp-server-data-exploration)** - ⭐ 524

572. **[line-bot-mcp-server](https://github.com/line/line-bot-mcp-server)** - ⭐ 524
   MCP server that integrates the LINE Messaging API to connect an AI Agent to the LINE Official Account.

573. **[alpaca-mcp-server](https://github.com/alpacahq/alpaca-mcp-server)** - ⭐ 524
   Alpaca’s official MCP Server lets you trade stocks, ETFs, crypto, and options, run data analysis, and build strategies in plain English directly from your favorite LLM tools and IDEs

574. **[pgmcp](https://github.com/subnetmarco/pgmcp)** - ⭐ 523
   An MCP server to query any Postgres database in natural language.

575. **[openapi-mcp-generator](https://github.com/harsha-iiiv/openapi-mcp-generator)** - ⭐ 523
   A tool that converts OpenAPI specifications to MCP server

576. **[awesome-a2a](https://github.com/ai-boost/awesome-a2a)** - ⭐ 522
   Agent2Agent (A2A) – awesome A2A agents, tools, servers & clients, all in one place.

577. **[ethora](https://github.com/dappros/ethora)** - ⭐ 521
...
578. **[meta-ads-mcp](https://github.com/pipeboard-co/meta-ads-mcp)** - ⭐ 521
   MCP server to manage Facebook and Instagram Ads (Meta Ads)

579. **[universal-db-mcp](https://github.com/Anarkh-Lee/universal-db-mcp)** - ⭐ 520
...
580. **[ida-mcp-server](https://github.com/MxIris-Reverse-Engineering/ida-mcp-server)** - ⭐ 519
   A Model Context Protocol server for IDA

581. **[pdf-reader-mcp](https://github.com/SylphxAI/pdf-reader-mcp)** - ⭐ 519
   📄 Production-ready MCP server for PDF processing - 5-10x faster with parallel processing and 94%+ test coverage

582. **[apple-health-mcp](https://github.com/neiltron/apple-health-mcp)** - ⭐ 518
   MCP server for querying Apple Health data with natural language and SQL

583. **[mcp-server-weread](https://github.com/freestylefly/mcp-server-weread)** - ⭐ 517
   微信读书MCP

584. **[gateway](https://github.com/centralmind/gateway)** - ⭐ 517
   Universal MCP-Server for your Databases optimized for LLMs and AI-Agents.

585. **[WebMCP](https://github.com/jasonjmcghee/WebMCP)** - ⭐ 517
...
586. **[ghostcrew](https://github.com/GH05TCREW/ghostcrew)** - ⭐ 515
...
587. **[flux-operator](https://github.com/controlplaneio-fluxcd/flux-operator)** - ⭐ 512
   GitOps on Autopilot Mode

588. **[UnrealMCP](https://github.com/kvick-games/UnrealMCP)** - ⭐ 511
   MCP to allow AI agents to control Unreal

589. **[bm.md](https://github.com/miantiao-me/bm.md)** - ⭐ 510
   更好用的 Markdown 排版助手｜一键适配微信公众号、网页与图片。

590. **[MetasploitMCP](https://github.com/GH05TCREW/MetasploitMCP)** - ⭐ 509
   MCP Server for Metasploit

591. **[talk-to-girlfriend-ai](https://github.com/arlanrakh/talk-to-girlfriend-ai)** - ⭐ 508
   im busy building ai agents so why not let an ai talk to my girlfriend? (i am single) 

592. **[mineru-tianshu](https://github.com/magicyuan876/mineru-tianshu)** - ⭐ 508
   天枢 - 企业级 AI 一站式数据预处理平台 | PDF/Office转Markdown | 支持MCP协议AI助手集成 | Vue3+FastAPI全栈方案 | 文档解析 | 多模态信息提取

593. **[multimodal-agents-course](https://github.com/multi-modal-ai/multimodal-agents-course)** - ⭐ 507
   An MCP Multimodal AI Agent with eyes and ears!

594. **[mcp-get](https://github.com/michaellatman/mcp-get)** - ⭐ 506

595. **[rails-mcp-server](https://github.com/maquina-app/rails-mcp-server)** - ⭐ 504
   A Ruby gem implementation of a Model Context Protocol (MCP) server for Rails projects. This server allows LLMs (Large Language Models) to interact with Rails projects through the Model Context Protocol.

596. **[UnityMCP](https://github.com/jackwrichards/UnityMCP)** - ⭐ 504

597. **[work-iq-mcp](https://github.com/microsoft/work-iq-mcp)** - ⭐ 504
   MCP Server and CLI for accessing Work IQ

598. **[awesome-claude-code-plugins](https://github.com/ccplugins/awesome-claude-code-plugins)** - ⭐ 504
   Awesome Claude Code plugins — a curated list of slash commands, subagents, MCP servers, and hooks for Claude Code

599. **[mcp-server-bash-sdk](https://github.com/muthuishere/mcp-server-bash-sdk)** - ⭐ 502
   Yes Mcp server in bash

600. **[mcp-pandoc](https://github.com/vivekVells/mcp-pandoc)** - ⭐ 500
   MCP server for document format conversion using pandoc.

601. **[borsa-mcp](https://github.com/saidsurucu/borsa-mcp)** - ⭐ 500
   MCP Server for Turkish & American Stock Exchange and Fund Data

602. **[MCPSpy](https://github.com/alex-ilgayev/MCPSpy)** - ⭐ 498
   MCP Monitoring with eBPF

603. **[chroma-mcp](https://github.com/chroma-core/chroma-mcp)** - ⭐ 498
   A Model Context Protocol (MCP) server implementation that provides database capabilities for Chroma

604. **[mcp-youtube](https://github.com/anaisbetts/mcp-youtube)** - ⭐ 495
   A Model-Context Protocol Server for YouTube

605. **[MCP-Kali-Server](https://github.com/Wh0am123/MCP-Kali-Server)** - ⭐ 495
   MCP configuration to connect AI agent to a Linux machine.

606. **[dbt-mcp](https://github.com/dbt-labs/dbt-mcp)** - ⭐ 494
   A MCP (Model Context Protocol) server for interacting with dbt.

607. **[mcp-server](https://github.com/PortSwigger/mcp-server)** - ⭐ 494
   MCP Server for Burp

608. **[PentestAgent](https://github.com/GH05TCREW/PentestAgent)** - ⭐ 493
...
609. **[web-agent-protocol](https://github.com/OTA-Tech-AI/web-agent-protocol)** - ⭐ 492
   🌐Web Agent Protocol (WAP) - Record and replay user interactions in the browser with MCP support

610. **[llm-mcp-rag](https://github.com/KelvinQiu802/llm-mcp-rag)** - ⭐ 492
   LLM + MCP + RAG = Magic

611. **[UnityMCP](https://github.com/Arodoid/UnityMCP)** - ⭐ 491

612. **[GhidrAssistMCP](https://github.com/jtang613/GhidrAssistMCP)** - ⭐ 491
   An MCP extension for Ghidra

613. **[unreal-engine-mcp](https://github.com/flopperam/unreal-engine-mcp)** - ⭐ 490
...
614. **[cocos-mcp-server](https://github.com/DaxianLee/cocos-mcp-server)** - ⭐ 490
...
615. **[n8n-workflow-builder](https://github.com/makafeli/n8n-workflow-builder)** - ⭐ 489
   AI assistant integration for n8n workflow automation through Model Context Protocol (MCP). Connect Claude Desktop, ChatGPT, and other AI assistants to n8n for natural language workflow management.

616. **[ai-trader](https://github.com/whchien/ai-trader)** - ⭐ 489
   Backtrader-powered backtesting framework for algorithmic trading, featuring 20+ strategies, multi-market support, CLI tools, and an integrated MCP server for professional traders.

617. **[minecraft-mcp-server](https://github.com/yuniko-software/minecraft-mcp-server)** - ⭐ 489
   A Minecraft MCP Server powered by Mineflayer API. It allows to control a Minecraft character in real-time, allowing AI assistants to build structures, explore the world, and interact with the game environment through natural language instruction

618. **[MCP](https://github.com/jina-ai/MCP)** - ⭐ 488
   Official Jina AI Remote MCP Server

619. **[sdk-typescript](https://github.com/strands-agents/sdk-typescript)** - ⭐ 488
   A model-driven approach to building AI agents in just a few lines of code. 

620. **[haiku.rag](https://github.com/ggozad/haiku.rag)** - ⭐ 487
   Opinionated agentic RAG powered by LanceDB, Pydantic AI, and Docling

621. **[mcp-gateway](https://github.com/microsoft/mcp-gateway)** - ⭐ 487
   MCP Gateway is a reverse proxy and management layer for MCP servers, enabling scalable, session-aware stateful routing and lifecycle management of MCP servers in Kubernetes environments.

622. **[claude-debugs-for-you](https://github.com/jasonjmcghee/claude-debugs-for-you)** - ⭐ 486
   Enable any LLM (e.g. Claude) to interactively debug any language for you via MCP and a VS Code Extension

623. **[mcp-searxng](https://github.com/ihor-sokoliuk/mcp-searxng)** - ⭐ 486
   MCP Server for SearXNG

624. **[mcpe](https://github.com/ReMinecraftPE/mcpe)** - ⭐ 485
   ReMinecraftPE - A custom experience based on Minecraft PE as of 2011.

625. **[engram](https://github.com/Gentleman-Programming/engram)** - ⭐ 485
   Persistent memory system for AI coding agents. Agent-agnostic Go binary with SQLite + FTS5, MCP server, HTTP API, CLI, and TUI.

626. **[ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server)** - ⭐ 483
   A Model Context Protocol (MCP) server for interacting with Microsoft 365 and Office services through the Graph API

627. **[tsidp](https://github.com/tailscale/tsidp)** - ⭐ 480
   A simple OIDC / OAuth Identity Provider (IdP) server for your tailnet.

628. **[adb-mcp](https://github.com/mikechambers/adb-mcp)** - ⭐ 480

629. **[argo](https://github.com/xark-argo/argo)** - ⭐ 478
   ARGO is an open-source AI Agent platform that brings Local Manus to your desktop. With one-click model downloads, seamless closed LLM integration, and offline-first RAG knowledge bases, ARGO becomes a DeepResearch powerhouse for autonomous thinking, task planning, and 100% of your data stays locally. Support Win/Mac/Docker.

630. **[concierge](https://github.com/concierge-hq/concierge)** - ⭐ 478
   🚀 Universal SDK for building next-gen MCP servers

631. **[mcp-server-youtube-transcript](https://github.com/kimtaeyoon83/mcp-server-youtube-transcript)** - ⭐ 478
   This is an MCP server that allows you to directly download transcripts of YouTube videos.

632. **[mcp-gsuite](https://github.com/MarkusPfundstein/mcp-gsuite)** - ⭐ 474
   MCP Server to interact with Google Gsuite prodcuts

633. **[open-multi-agent-canvas](https://github.com/CopilotKit/open-multi-agent-canvas)** - ⭐ 473
   The open-source multi-agent chat interface that lets you manage multiple agents in one dynamic conversation and add MCP servers for deep research

634. **[vibe-check-mcp-server](https://github.com/PV-Bhat/vibe-check-mcp-server)** - ⭐ 473
   Vibe Check is a tool that provides mentor-like feedback to AI Agents, preventing tunnel-vision, over-engineering and reasoning lock-in for complex and long-horizon agent workflows. KISS your over-eager AI Agents goodbye! Effective for: Coding, Ambiguous Tasks, High-Risk tasks

635. **[lanhu-mcp](https://github.com/dsphper/lanhu-mcp)** - ⭐ 473
   ⚡ 需求分析效率提升 200%！全球首个为 AI 编程时代设计的团队协作 MCP 服务器，自动分析需求自动编写前后端代码，下载切图

636. **[prism-insight](https://github.com/dragon1086/prism-insight)** - ⭐ 472
   AI-based stock analysis and trading system

637. **[laravel](https://github.com/php-mcp/laravel)** - ⭐ 470
   An SDK building Laravel MCP servers

638. **[aser](https://github.com/AmeNetwork/aser)** - ⭐ 469
   Aser is a lightweight, self-assembling AI Agent frame.

639. **[Godot-MCP](https://github.com/ee0pdt/Godot-MCP)** - ⭐ 469
   An MCP for Godot that lets you create and edit games in the Godot game engine with tools like Claude

640. **[agentscope-runtime](https://github.com/agentscope-ai/agentscope-runtime)** - ⭐ 469
...
641. **[atlas-mcp-server](https://github.com/cyanheads/atlas-mcp-server)** - ⭐ 468
   A Model Context Protocol (MCP) server for ATLAS, a Neo4j-powered task management system for LLM Agents - implementing a three-tier architecture (Projects, Tasks, Knowledge) to manage complex workflows. Now with Deep Research.

642. **[copilot-mcp](https://github.com/VikashLoomba/copilot-mcp)** - ⭐ 468
   A VSCode extension that lets you find and install Agent Skills and MCP Apps to use with GitHub Copilot, Claude Code, and Codex CLI.

643. **[nexus](https://github.com/Nexus-Router/nexus)** - ⭐ 467
   Govern & Secure your AI

644. **[lark-openapi-mcp](https://github.com/larksuite/lark-openapi-mcp)** - ⭐ 467
   飞书/Lark官方 OpenAPI MCP

645. **[director](https://github.com/director-run/director)** - ⭐ 464
   MCP Playbooks for AI agents

646. **[doctor](https://github.com/sisig-ai/doctor)** - ⭐ 462
   Doctor is a tool for discovering, crawl, and indexing web sites to be exposed as an MCP server for LLM agents.

647. **[probe](https://github.com/probelabs/probe)** - ⭐ 462
   AI-friendly semantic code search engine for large codebases. Combines ripgrep speed with tree-sitter AST parsing. Powers AI coding assistants with precise, context-aware code understanding.

648. **[mcp-remote-macos-use](https://github.com/baryhuang/mcp-remote-macos-use)** - ⭐ 462
   The only general AI agent that does NOT requires extra API key, giving you full control on your local and remote MacOs from Claude Desktop App

649. **[deeppowers](https://github.com/deeppowers/deeppowers)** - ⭐ 460
...
650. **[mcp-nixos](https://github.com/utensils/mcp-nixos)** - ⭐ 457
   MCP-NixOS - Model Context Protocol Server for NixOS resources

651. **[codexia](https://github.com/milisp/codexia)** - ⭐ 455
   A powerfull GUI and Toolkit for Codex CLI + Claude Code. FileTree + prompt notepad + git worktree and more

652. **[mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry)** - ⭐ 455
...
653. **[mcp-mermaid](https://github.com/hustcc/mcp-mermaid)** - ⭐ 454
   ❤️ Generate mermaid diagram and chart with AI MCP dynamically.

654. **[home-assistant-vibecode-agent](https://github.com/Coolver/home-assistant-vibecode-agent)** - ⭐ 453
...
655. **[Feishu-MCP](https://github.com/cso1z/Feishu-MCP)** - ⭐ 453
   为 Cursor、Windsurf、Cline 和其他 AI 驱动的编码工具提供访问、编辑和结构化处理飞书文档的能力，基于 Model Context Protocol 服务器实现。

656. **[MCP-Zero](https://github.com/xfey/MCP-Zero)** - ⭐ 452
   MCP-Zero: Active Tool Discovery for Autonomous LLM Agents

657. **[youtube-mcp-server](https://github.com/ZubeidHendricks/youtube-mcp-server)** - ⭐ 451
   MCP Server for YouTube API, enabling video management, Shorts creation, and advanced analytics

658. **[FinanceMCP](https://github.com/guangxiangdebizi/FinanceMCP)** - ⭐ 451
...
659. **[mcp-bench](https://github.com/Accenture/mcp-bench)** - ⭐ 450
   MCP-Bench: Benchmarking Tool-Using LLM Agents with Complex Real-World Tasks via MCP Servers

660. **[docker-mcp](https://github.com/QuantGeekDev/docker-mcp)** - ⭐ 450
   A docker MCP Server (modelcontextprotocol)

661. **[resend-mcp](https://github.com/resend/resend-mcp)** - ⭐ 450
   The official MCP server to send emails and interact with Resend

662. **[nexus](https://github.com/grafbase/nexus)** - ⭐ 446
   Govern & Secure your AI

663. **[nexus](https://github.com/nexus-ai-labs/nexus)** - ⭐ 446
   Govern & Secure your AI

664. **[mcp-security](https://github.com/google/mcp-security)** - ⭐ 446

665. **[AgentX](https://github.com/lucky-aeon/AgentX)** - ⭐ 445
   AgentX 致力于让小白也能无门槛通过自然语言打造属于自己的 Agent。AgentX 采用了自研 MCP 网关，模型高可用组件打造高可用

666. **[mcp-send-email](https://github.com/resend/mcp-send-email)** - ⭐ 444
   Send emails directly from Cursor with this email sending MCP server

667. **[mcp-hub](https://github.com/ravitemer/mcp-hub)** - ⭐ 444
   A centralized manager for Model Context Protocol (MCP) servers with dynamic server management and monitoring

668. **[xhs-mcp](https://github.com/jobsonlook/xhs-mcp)** - ⭐ 443
   小红书MCP服务 x-s x-t js逆向

669. **[claude-codex-settings](https://github.com/fcakyon/claude-codex-settings)** - ⭐ 439
   My personal Claude Code and OpenAI Codex setup with battle-tested skills, commands, hooks, agents and MCP servers that I use daily.

670. **[joinly](https://github.com/joinly-ai/joinly)** - ⭐ 435
   Make your meetings accessible to AI Agents

671. **[mcp-gsc](https://github.com/AminForou/mcp-gsc)** - ⭐ 435
   Google Search Console Insights with Claude AI for SEOs

672. **[CoexistAI](https://github.com/SPThole/CoexistAI)** - ⭐ 434
   CoexistAI is a modular, developer-friendly research assistant framework . It enables you to build, search, summarize, and automate research workflows using LLMs, web search, Reddit, YouTube, and mapping tools—all with simple MCP tool calls or API calls or Python functions. 

673. **[vllm-mlx](https://github.com/waybarrios/vllm-mlx)** - ⭐ 434
   OpenAI and Anthropic compatible server for Apple Silicon. Run LLMs and vision-language models (Llama, Qwen-VL, LLaVA) with continuous batching, MCP tool calling, and multimodal support. Native MLX backend, 400+ tok/s. Works with Claude Code.

674. **[biomcp](https://github.com/genomoncology/biomcp)** - ⭐ 433
   BioMCP: Biomedical Model Context Protocol

675. **[learn-low-code-agentic-ai](https://github.com/panaversity/learn-low-code-agentic-ai)** - ⭐ 433
...
676. **[mcp-redis](https://github.com/redis/mcp-redis)** - ⭐ 432
   The official Redis MCP Server is a natural language interface designed for agentic applications to manage and search data in Redis efficiently

677. **[kmcp](https://github.com/kagent-dev/kmcp)** - ⭐ 431
   CLI tool and Kubernetes Controller for building, testing and deploying MCP servers

678. **[mcp-server-motherduck](https://github.com/motherduckdb/mcp-server-motherduck)** - ⭐ 427
   Local MCP server for DuckDB and MotherDuck

679. **[powerbi-modeling-mcp](https://github.com/microsoft/powerbi-modeling-mcp)** - ⭐ 427
   The Power BI Modeling MCP Server, brings Power BI semantic modeling capabilities to your AI agents.

680. **[claude-talk-to-figma-mcp](https://github.com/arinspunk/claude-talk-to-figma-mcp)** - ⭐ 427
   A Model Context Protocol (MCP) that allows Claude Desktop and other AI tools (Claude Code, Cursor, Antigravity, etc.) to read, analyze, and modify Figma designs

681. **[docling-mcp](https://github.com/docling-project/docling-mcp)** - ⭐ 426
   Making docling agentic through MCP

682. **[mcp-security-hub](https://github.com/FuzzingLabs/mcp-security-hub)** - ⭐ 426
   A growing collection of MCP servers bringing offensive security tools to AI assistants. Nmap, Ghidra, Nuclei, SQLMap, Hashcat and more.

683. **[kratos-transport](https://github.com/tx7do/kratos-transport)** - ⭐ 425
   kratos transport layer extension, support: rabbitmq,kafka,rocketmq,activemq,apollo,mcp,tcp,websocket...

684. **[mcp-server-spec-driven-development](https://github.com/formulahendry/mcp-server-spec-driven-development)** - ⭐ 425
   Spec-Driven Development MCP Server, not just Vibe Coding

685. **[mcpstore](https://github.com/whillhill/mcpstore)** - ⭐ 424
   开盒即用的优雅管理mcp服务 | 结合Agent框架 | 作者听劝 | 已发布pypi | Vue页面demo 

686. **[mcp-registry](https://github.com/docker/mcp-registry)** - ⭐ 424
   Official Docker MCP registry 

687. **[docfork](https://github.com/docfork/docfork)** - ⭐ 424
   Docfork - Up-to-date Docs for AI Agents.

688. **[airtable-mcp-server](https://github.com/domdomegg/airtable-mcp-server)** - ⭐ 424
   🗂️🤖 Airtable Model Context Protocol Server, for allowing AI systems to interact with your Airtable bases

689. **[applescript-mcp](https://github.com/peakmojo/applescript-mcp)** - ⭐ 424
   MCP server that execute applescript giving you full control of your Mac

690. **[awesome-mcp-devtools](https://github.com/punkpeye/awesome-mcp-devtools)** - ⭐ 423
   A curated list of developer tools, SDKs, libraries, and testing utilities for Model Context Protocol (MCP) server development.

691. **[claude-codepro](https://github.com/maxritter/claude-codepro)** - ⭐ 422
...
692. **[NetCoreKevin](https://github.com/junkai-li/NetCoreKevin)** - ⭐ 422
...
697. **[mcpadapt](https://github.com/grll/mcpadapt)** - ⭐ 417
   Unlock 650+ MCP servers tools in your favorite agentic framework.

698. **[azure-ai-travel-agents](https://github.com/Azure-Samples/azure-ai-travel-agents)** - ⭐ 415
...
699. **[mcp-cli](https://github.com/wong2/mcp-cli)** - ⭐ 414
   A CLI inspector for the Model Context Protocol

700. **[Android-MCP](https://github.com/CursorTouch/Android-MCP)** - ⭐ 414
   MCP Server for interacting with Android Devices.

701. **[UnrealGenAISupport](https://github.com/prajwalshettydev/UnrealGenAISupport)** - ⭐ 413
...
702. **[mcp](https://github.com/baidu-maps/mcp)** - ⭐ 405
   Baidu Map MCP Server

703. **[RestClient.Net](https://github.com/MelbourneDeveloper/RestClient.Net)** - ⭐ 403
   The safest way to make REST calls in C# with an MCP Generator

704. **[aitour26-WRK540-unlock-your-agents-potential-with-model-context-protocol](https://github.com/microsoft/aitour26-WRK540-unlock-your-agents-potential-with-model-context-protocol)** - ⭐ 403

705. **[OpenContext](https://github.com/0xranx/OpenContext)** - ⭐ 402
   A personal context store for AI agents and assistants—reuse your existing coding agent CLI (Codex/Claude/OpenCode) with built‑in Skills/tools and a desktop GUI to capture, search, and reuse project knowledge across agents and repos.

706. **[chatluna](https://github.com/ChatLunaLab/chatluna)** - ⭐ 401
...
707. **[lunar](https://github.com/TheLunarCompany/lunar)** - ⭐ 401
   lunar.dev: Agent native MCP Gateway for governance and security

708. **[memento-mcp](https://github.com/gannonh/memento-mcp)** - ⭐ 401
   Memento MCP: A Knowledge Graph Memory System for LLMs

709. **[puppeteer-mcp-server](https://github.com/merajmehrabi/puppeteer-mcp-server)** - ⭐ 401
   This MCP server provides browser automation capabilities through Puppeteer, allowing interaction with both new browser instances and existing Chrome windows.

710. **[Software-planning-mcp](https://github.com/NightTrek/Software-planning-mcp)** - ⭐ 400
   An experiment in software planning using MCP

711. **[tradingview-mcp](https://github.com/atilaahmettaner/tradingview-mcp)** - ⭐ 398
...
712. **[edgeone-pages-mcp](https://github.com/TencentEdgeOne/edgeone-pages-mcp)** - ⭐ 396
   An MCP service designed for deploying HTML content to EdgeOne Pages and obtaining an accessible public URL.

713. **[sonarqube-mcp-server](https://github.com/SonarSource/sonarqube-mcp-server)** - ⭐ 394
   SonarQube MCP Server

714. **[mcp-alchemy](https://github.com/runekaagaard/mcp-alchemy)** - ⭐ 393
   A MCP (model context protocol) server that gives the LLM access to and knowledge about relational databases like SQLite, Postgresql, MySQL & MariaDB, Oracle, and MS-SQL.

715. **[better-icons](https://github.com/better-auth/better-icons)** - ⭐ 392
   Skill and MCP server for searching and retrieving icons

716. **[Redbook-Search-Comment-MCP2.0](https://github.com/chenningling/Redbook-Search-Comment-MCP2.0)** - ⭐ 390
...
717. **[kicad-mcp](https://github.com/lamaalrajih/kicad-mcp)** - ⭐ 389
   Model Context Protocol server for KiCad on Mac, Windows, and Linux

718. **[speakeasy](https://github.com/speakeasy-api/speakeasy)** - ⭐ 389
...
719. **[MCP-SecurityTools](https://github.com/Ta0ing/MCP-SecurityTools)** - ⭐ 388
   MCP-SecurityTools 是一个专注于收录和更新网络安全领域 MCP 的开源项目，旨在汇总、整理和优化各类与 MCP 相关的安全工具、技术及实战经验。

720. **[mcp-server-airbnb](https://github.com/openbnb-org/mcp-server-airbnb)** - ⭐ 388
   Search Airbnb using your AI Agent

721. **[ai4j](https://github.com/LnYo-Cly/ai4j)** - ⭐ 387
...
722. **[reddit-mcp-buddy](https://github.com/karanb192/reddit-mcp-buddy)** - ⭐ 387
   Clean, LLM-optimized Reddit MCP server. Browse posts, search content, analyze users. No fluff, just Reddit data.

723. **[mcpmark](https://github.com/eval-sys/mcpmark)** - ⭐ 386
   MCPMark is a comprehensive, stress-testing MCP benchmark designed to evaluate model and agent capabilities in real-world MCP use.

724. **[vestige](https://github.com/samvallad33/vestige)** - ⭐ 386
...
725. **[agent-builder](https://github.com/strands-agents/agent-builder)** - ⭐ 385
   An example agent demonstrating streaming, tool use, and interactivity from your terminal. This agent builder can help you to build your own agents and tools.

726. **[minion-agent](https://github.com/femto/minion-agent)** - ⭐ 385
   A simple agent framework that's capable of browser use + mcp + auto instrument + plan + deep  research + more

727. **[station](https://github.com/cloudshipai/station)** - ⭐ 384
   Station is our open-source runtime that lets teams deploy agents on their own infrastructure with full control.

728. **[agent](https://github.com/1mcp-app/agent)** - ⭐ 384
   A unified Model Context Protocol server implementation that aggregates multiple MCP servers into one.

729. **[mcp-hfspace](https://github.com/evalstate/mcp-hfspace)** - ⭐ 383
   MCP Server to Use HuggingFace spaces, easy configuration and Claude Desktop mode. 

730. **[yutu](https://github.com/eat-pray-ai/yutu)** - ⭐ 383
   A fully functional MCP server and CLI for YouTube

731. **[groq-desktop-beta](https://github.com/groq/groq-desktop-beta)** - ⭐ 382
   Local Groq Desktop chat app with MCP support

732. **[mcp-server](https://github.com/e2b-dev/mcp-server)** - ⭐ 381
   Giving Claude ability to run code with E2B via MCP (Model Context Protocol)

733. **[mcp-code-graph](https://github.com/JudiniLabs/mcp-code-graph)** - ⭐ 380
   MCP Server for code graph analysis and visualization by CodeGPT

734. **[obsidian-mcp-server](https://github.com/cyanheads/obsidian-mcp-server)** - ⭐ 380
   Obsidian Knowledge-Management MCP (Model Context Protocol) server that enables AI agents and development tools to interact with an Obsidian vault. It provides a comprehensive suite of tools for reading, writing, searching, and managing notes, tags, and frontmatter, acting as a bridge to the Obsidian Local REST API plugin.

735. **[Agentfy](https://github.com/Agentfy-io/Agentfy)** - ⭐ 379
...
736. **[labs-ai-tools-for-devs](https://github.com/docker/labs-ai-tools-for-devs)** - ⭐ 379
   Your trusted home for discovering MCP tools – seamlessly integrated into Docker

737. **[open-skills](https://github.com/instavm/open-skills)** - ⭐ 378
   OpenSkills: Run Claude Skills Locally using any LLM

738. **[prometheus-mcp-server](https://github.com/pab1it0/prometheus-mcp-server)** - ⭐ 376
   A Model Context Protocol (MCP) server that enables AI agents and LLMs to query and analyze Prometheus metrics through standardized interfaces.

739. **[mcp](https://github.com/mondaycom/mcp)** - ⭐ 375
   Enable AI agents to work reliably - giving them secure access to structured data, tools to take action, and the context needed to make smart decisions.

740. **[automation-mcp](https://github.com/ashwwwin/automation-mcp)** - ⭐ 375
   Control your Mac with detailed mouse, keyboard, screen, and window management capabilities.

741. **[mcp-k8s-go](https://github.com/strowk/mcp-k8s-go)** - ⭐ 374
   MCP server connecting to Kubernetes

742. **[zotero-mcp](https://github.com/cookjohn/zotero-mcp)** - ⭐ 374
...
743. **[graphlit-mcp-server](https://github.com/graphlit/graphlit-mcp-server)** - ⭐ 373
   Model Context Protocol (MCP) Server for Graphlit Platform

744. **[claude-code-mastery](https://github.com/TheDecipherist/claude-code-mastery)** - ⭐ 373
   The complete guide to Claude Code: CLAUDE.md, hooks, skills, MCP servers, and commands

745. **[Anemoi](https://github.com/Coral-Protocol/Anemoi)** - ⭐ 372
   Anemoi: A Semi-Centralized Multi-agent Systems Based on Agent-to-Agent Communication MCP server from Coral Protocol

746. **[docfork-mcp](https://github.com/docfork/docfork-mcp)** - ⭐ 372
   Docfork MCP - Up-to-date Docs for AI Agents.

747. **[bagel](https://github.com/Extelligence-ai/bagel)** - ⭐ 372
   Chat with your robotics, drone, and IoT data — ChatGPT for the physical world.

748. **[mnemo](https://github.com/MnemoAI/mnemo)** - ⭐ 370
   A MCP-Ready Intelligence Engine for Data & Agent-as-a-Service.

749. **[todoist-mcp-server](https://github.com/abhiz123/todoist-mcp-server)** - ⭐ 368
   MCP server for Todoist integration enabling natural language task management with Claude

750. **[pinion-os](https://github.com/chu2bard/pinion-os)** - ⭐ 367
   Client SDK, Claude plugin and skill framework for the Pinion protocol. x402 micropayments on Base.

751. **[skillz](https://github.com/intellectronica/skillz)** - ⭐ 367
   An MCP server for loading skills (shim for non-claude clients).

752. **[maverick-mcp](https://github.com/wshobson/maverick-mcp)** - ⭐ 367
   MaverickMCP - Personal Stock Analysis MCP Server

753. **[mcp-selenium](https://github.com/angiejones/mcp-selenium)** - ⭐ 366
   An MCP implementation for Selenium WebDriver

754. **[VTCode](https://github.com/vinhnx/VTCode)** - ⭐ 365
   VT Code - Semantic coding agent in the terminal

755. **[evm-mcp-server](https://github.com/mcpdotdirect/evm-mcp-server)** - ⭐ 364
   MCP server that provides LLMs with tools for interacting with EVM networks

756. **[mcp-graphql](https://github.com/blurrah/mcp-graphql)** - ⭐ 364
   Model Context Protocol server for GraphQL

757. **[AgentChat](https://github.com/Shy2593666979/AgentChat)** - ⭐ 364
...
758. **[KiCAD-MCP-Server](https://github.com/mixelpixx/KiCAD-MCP-Server)** - ⭐ 364
   KiCAD MCP is a Model Context Protocol (MCP) implementation that enables Large Language Models (LLMs) like Claude to directly interact with KiCAD for printed circuit board design.

759. **[mcp-sdk-php](https://github.com/logiscape/mcp-sdk-php)** - ⭐ 363
   Model Context Protocol SDK for PHP

760. **[ableton-live-mcp-server](https://github.com/Simon-Kansara/ableton-live-mcp-server)** - ⭐ 363
   MCP Server implementation for Ableton Live OSC control

761. **[anything-to-notebooklm](https://github.com/joeseesun/anything-to-notebooklm)** - ⭐ 363
   Claude Skill: Multi-source content processor for NotebookLM. Supports WeChat articles, web pages, YouTube, PDF, Markdown, search queries → Podcast/PPT/MindMap/Quiz etc.

762. **[daymon](https://github.com/daymonio/daymon)** - ⭐ 362
   Daymon puts your favorite AI to work 24/7. It schedules, remembers, and orchestrates your own virtual team. Free.

763. **[studio-rust-mcp-server](https://github.com/Roblox/studio-rust-mcp-server)** - ⭐ 362
   Standalone Roblox Studio MCP Server

764. **[f2c-mcp](https://github.com/f2c-ai/f2c-mcp)** - ⭐ 361
   F2C MCP Server

765. **[mcp2mqtt](https://github.com/mcp2everything/mcp2mqtt)** - ⭐ 360
   本项目通过将 MCP 协议转换为 MQTT 协议，我们能够利用强大的大型语言模型（LLMs），就能轻松操控您的智能家居、机器人或其他硬件设备。

766. **[mcp-apple-notes](https://github.com/RafalWilinski/mcp-apple-notes)** - ⭐ 360
   Talk with your notes in Claude. RAG over your Apple Notes using Model Context Protocol.

767. **[twitter-mcp](https://github.com/EnesCinr/twitter-mcp)** - ⭐ 359
   A Model Context Protocol server allows to interact with Twitter, enabling posting tweets and searching Twitter.

768. **[applescript-mcp](https://github.com/joshrutkowski/applescript-mcp)** - ⭐ 359
   A macOS AppleScript MCP server

769. **[WireMCP](https://github.com/0xKoda/WireMCP)** - ⭐ 359
   An MCP for WireShark (tshark). Empower LLM's with realtime network traffic analysis capability

770. **[MCPSharp](https://github.com/afrise/MCPSharp)** - ⭐ 358
   MCPSharp is a .NET library that helps you build Model Context Protocol (MCP) servers and clients - the standardized API protocol used by AI assistants and models.

771. **[devopness](https://github.com/devopness/devopness)** - ⭐ 358
   DevOps Happiness: 1-click or 1-prompt MCP. Deploy apps + infra + CI/CD on your cloud. Happy humans + reliable agents. 🚀

772. **[mcp-aktools](https://github.com/aahl/mcp-aktools)** - ⭐ 358
   📈 提供股票、加密货币的数据查询和分析功能MCP服务器

773. **[Lynkr](https://github.com/Fast-Editor/Lynkr)** - ⭐ 358
   Streamline your workflow with Lynkr, a CLI tool that acts as an HTTP proxy for efficient code interactions using Claude Code CLI.

774. **[claude-code-statusline](https://github.com/rz1989s/claude-code-statusline)** - ⭐ 357
...
775. **[MoltBrain](https://github.com/nhevers/MoltBrain)** - ⭐ 356
   Long-term memory layer for OpenClaw & MoltBook agents that learns and recalls your project context automatically.

776. **[xcode-mcp-server](https://github.com/r-huijts/xcode-mcp-server)** - ⭐ 356
   MCP Server implementation for Xcode integration

777. **[vtcode](https://github.com/vinhnx/vtcode)** - ⭐ 355
   VT Code - Semantic coding agent in the terminal

778. **[tfmcp](https://github.com/nwiizo/tfmcp)** - ⭐ 355
   🌍 Terraform Model Context Protocol (MCP) Tool - An experimental CLI tool that enables AI assistants to manage and operate Terraform environments. Supports reading Terraform configurations, analyzing plans, applying configurations, and managing state with Claude Desktop integration. ⚡️

779. **[mcp-teams-server](https://github.com/InditexTech/mcp-teams-server)** - ⭐ 354
   An MCP (Model Context Protocol) server implementation for Microsoft Teams integration, providing capabilities to read messages, create messages, reply to messages, mention members.

780. **[mcp-reddit](https://github.com/adhikasp/mcp-reddit)** - ⭐ 354
   A Model Context Protocol (MCP) server that provides tools for fetching and analyzing Reddit content.

781. **[RetroMCP-Java](https://github.com/MCPHackers/RetroMCP-Java)** - ⭐ 353
   A rewrite of MCP to provide support for many versions of Minecraft which were never supported by original MCP

782. **[droidmind](https://github.com/hyperb1iss/droidmind)** - ⭐ 351
   Control your Android devices with AI using Model Context Protocol

783. **[mcp-gateway](https://github.com/lasso-security/mcp-gateway)** - ⭐ 349
   A plugin-based gateway that orchestrates other MCPs and allows developers to build upon it enterprise-grade agents.

784. **[atlassian-mcp-server](https://github.com/atlassian/atlassian-mcp-server)** - ⭐ 349
   Remote MCP Server that securely connects Jira and Confluence with your LLM, IDE, or agent platform of choice.

785. **[run-model-context-protocol-servers-with-aws-lambda](https://github.com/awslabs/run-model-context-protocol-servers-with-aws-lambda)** - ⭐ 348
   Run existing Model Context Protocol (MCP) stdio-based servers in AWS Lambda functions

786. **[revit-mcp](https://github.com/revit-mcp/revit-mcp)** - ⭐ 347
   AI-Powered Revit Modeling

787. **[Construction-Hazard-Detection](https://github.com/yihong1120/Construction-Hazard-Detection)** - ⭐ 347
   Enhances construction site safety using YOLO for object detection, identifying hazards like workers without helmets or safety vests, and proximity to machinery or vehicles. HDBSCAN clusters safety cone coordinates to create monitored zones. Post-processing algorithms improve detection accuracy.

788. **[mcp-calculator](https://github.com/78/mcp-calculator)** - ⭐ 347
   Xiaozhi MCP sample program

789. **[one-mcp](https://github.com/burugo/one-mcp)** - ⭐ 345
   A centralized reverse-proxy platform for MCP servers — manage, group, and export as Skills from a single endpoint.

790. **[linear-mcp-server](https://github.com/jerhadf/linear-mcp-server)** - ⭐ 344
   A server that integrates Linear's project management system with the Model Context Protocol (MCP) to allow LLMs to interact with Linear.

791. **[db-mcp-server](https://github.com/FreePeak/db-mcp-server)** - ⭐ 344
   A powerful multi-database server implementing the Model Context Protocol (MCP) to provide AI assistants with structured access to databases.

792. **[mcp-for-next.js](https://github.com/vercel-labs/mcp-for-next.js)** - ⭐ 344

793. **[hermes-mcp](https://github.com/cloudwalk/hermes-mcp)** - ⭐ 344
   Elixir Model Context Protocol (MCP) SDK

794. **[ebook-mcp](https://github.com/onebirdrocks/ebook-mcp)** - ⭐ 344
...
795. **[ast-grep-mcp](https://github.com/ast-grep/ast-grep-mcp)** - ⭐ 343

796. **[stealth-browser-mcp](https://github.com/vibheksoni/stealth-browser-mcp)** - ⭐ 343
   The only browser automation that bypasses anti-bot systems. AI writes network hooks, clones UIs pixel-perfect via simple chat.

797. **[Context-Engine](https://github.com/Context-Engine-AI/Context-Engine)** - ⭐ 343
   Context-Engine MCP - Agentic Context Compression Suite

798. **[x64DbgMCPServer](https://github.com/AgentSmithers/x64DbgMCPServer)** - ⭐ 342
   x64DbgMCPServer made from c# with Claude, Windsurf and Cursor support

799. **[agentcontrolplane](https://github.com/humanlayer/agentcontrolplane)** - ⭐ 341
...
800. **[roam-code](https://github.com/Cranot/roam-code)** - ⭐ 341
...
801. **[a2a-directory](https://github.com/sing1ee/a2a-directory)** - ⭐ 340
   Agent2Agent (A2A) – AgentCards, Servers, Clients, Docs

802. **[agent-skills](https://github.com/microsoft/agent-skills)** - ⭐ 340
   Skills, MCP servers, Custom Coding Agents, Agents.md for SDKs to ground Coding Agents

803. **[daan](https://github.com/pluveto/daan)** - ⭐ 339
   ✨Lightweight LLM Client with MCP 🔌 & Characters 👤

804. **[mcsmcp](https://github.com/microsoft/mcsmcp)** - ⭐ 339
   Lab for creating an MCP Server and using it in Microsoft Copilot Studio.

805. **[base-mcp](https://github.com/base/base-mcp)** - ⭐ 339
   A Model Context Protocol (MCP) server that provides onchain tools for LLMs, allowing them to interact with the Base network and Coinbase API.

806. **[devtools-debugger-mcp](https://github.com/ScriptedAlchemy/devtools-debugger-mcp)** - ⭐ 339
   An MCP server exposing full Chrome DevTools Protocol debugging: breakpoints, step/run, call stacks, eval, and source maps.

807. **[CAAL](https://github.com/CoreWorxLab/CAAL)** - ⭐ 338
   Local voice assistant that learns new abilities via auto-discovered n8n workflows exposed as tools via MCP

808. **[PlanExe](https://github.com/PlanExeOrg/PlanExe)** - ⭐ 338
   Create a plan from a description in minutes

809. **[todoist-ai](https://github.com/Doist/todoist-ai)** - ⭐ 338
   A set of tools to connect to AI agents, to allow them to use Todoist on a user's behalf. Includes MCP support.

810. **[mcp](https://github.com/IBM/mcp)** - ⭐ 338
   A collection of Model Context Protocol (MCP) servers, clients and developer tools by IBM.

811. **[claude-emporium](https://github.com/Vvkmnn/claude-emporium)** - ⭐ 337
   🏛 [UNDER CONSTRUCTION] A (roman) claude plugin marketplace 

812. **[awesome-cursor-mpc-server](https://github.com/kleneway/awesome-cursor-mpc-server)** - ⭐ 337
   Example of an MCP server with custom tools that can be called directly from cursor

813. **[interactive-mcp](https://github.com/ttommyth/interactive-mcp)** - ⭐ 336
   Vibe coding should have human in the loop! interactive-mcp: Local, cross-platform MCP server for interact with your AI Agent

814. **[BloodHound-MCP-AI](https://github.com/MorDavid/BloodHound-MCP-AI)** - ⭐ 336
   BloodHound-MCP-AI is integration that connects BloodHound with AI through Model Context Protocol, allowing security professionals to analyze Active Directory attack paths using natural language instead of complex Cypher queries.

815. **[mcp-server-azure-devops](https://github.com/Tiberriver256/mcp-server-azure-devops)** - ⭐ 336
   An MCP server for Azure DevOps

816. **[mesh](https://github.com/decocms/mesh)** - ⭐ 335
   One secure endpoint for every MCP server. Deploy anywhere.

817. **[open-mcp](https://github.com/wegotdocs/open-mcp)** - ⭐ 333

818. **[vscode-mcp-server](https://github.com/juehang/vscode-mcp-server)** - ⭐ 333
   MCP server to expose VS Code editing features to an LLM for AI coding

819. **[paws-on-mcp](https://github.com/hemanth/paws-on-mcp)** - ⭐ 332
   A comprehensive Model Context Protocol (MCP) server implementing the latest specification.

820. **[MemoryMesh](https://github.com/CheMiguel23/MemoryMesh)** - ⭐ 332
   A knowledge graph server that uses the Model Context Protocol (MCP) to provide structured memory persistence for AI models.

821. **[CodeGraphContext](https://github.com/Shashankss1205/CodeGraphContext)** - ⭐ 331
   An MCP server plus a CLI tool that indexes local code into a graph database to provide context to AI assistants.

822. **[Ace-Mcp-Node](https://github.com/yeuxuan/Ace-Mcp-Node)** - ⭐ 331
...
823. **[mcp-for-argocd](https://github.com/argoproj-labs/mcp-for-argocd)** - ⭐ 331
   An implementation of Model Context Protocol (MCP) server for Argo CD.

824. **[laravel-mcp-server](https://github.com/opgginc/laravel-mcp-server)** - ⭐ 330
   A Laravel package for implementing secure Model Context Protocol servers using Streamable HTTP and SSE transport, providing real-time communication and a scalable tool system for enterprise environments.

825. **[css-mcp](https://github.com/stolinski/css-mcp)** - ⭐ 329

826. **[google-docs-mcp](https://github.com/a-bonus/google-docs-mcp)** - ⭐ 328
...
827. **[moling](https://github.com/gojue/moling)** - ⭐ 326
   MoLing is a computer-use and browser-use based MCP server. It is a locally deployed, dependency-free office AI assistant.

828. **[abcoder](https://github.com/cloudwego/abcoder)** - ⭐ 326
   deep, reliable and confidential coding-context

829. **[claude-skills-mcp](https://github.com/K-Dense-AI/claude-skills-mcp)** - ⭐ 325
   MCP server for searching and retrieving Claude Agent Skills using vector search

830. **[things-mcp](https://github.com/hald/things-mcp)** - ⭐ 325
   Things.app MCP Server

831. **[redd-archiver](https://github.com/19-84/redd-archiver)** - ⭐ 324
...
832. **[mcp-cli](https://github.com/apify/mcp-cli)** - ⭐ 324
...
837. **[ClimateTraceKMP](https://github.com/joreilly/ClimateTraceKMP)** - ⭐ 321
   Kotlin/Compose Multiplatform project to show climate related emission data from https://climatetrace.org/data.

838. **[tinystruct](https://github.com/tinystruct/tinystruct)** - ⭐ 321
...
839. **[skylos](https://github.com/duriantaco/skylos)** - ⭐ 321
...
840. **[langconnect-client](https://github.com/teddynote-lab/langconnect-client)** - ⭐ 320
   A Modern GUI Interface for Vector Database Management(Supports MCP integration)

841. **[Minecraft-Hack-BaseClient](https://github.com/OxideWaveLength/Minecraft-Hack-BaseClient)** - ⭐ 318
   This is a Minecraft Base Client

842. **[emcee](https://github.com/mattt/emcee)** - ⭐ 316
   MCP generator for OpenAPIs 🫳🎤💥

843. **[mcp-server](https://github.com/mapbox/mcp-server)** - ⭐ 315
   Mapbox Model Context Protocol (MCP) server

844. **[autogenstudio-skills](https://github.com/madtank/autogenstudio-skills)** - ⭐ 314
   Repo of skills for autogen studio using model context protocol (mcp)

845. **[code-sandbox-mcp](https://github.com/Automata-Labs-team/code-sandbox-mcp)** - ⭐ 314
   An MCP server to create secure code sandbox environment for executing code within Docker containers. This MCP server provides AI applications with a safe and isolated environment for running code while maintaining security through containerization.

846. **[mcp-servers-hub](https://github.com/apappascs/mcp-servers-hub)** - ⭐ 314
   Discover the most comprehensive and up-to-date collection of MCP servers in the market. This repository serves as a centralized hub, offering an extensive catalog of open-source and proprietary MCP servers, complete with features, documentation links, and contributors.

847. **[mssql_mcp_server](https://github.com/RichardHan/mssql_mcp_server)** - ⭐ 314
...
848. **[deep-research-mcp](https://github.com/teelaitila/deep-research-mcp)** - ⭐ 313

849. **[mcp-youtube-transcript](https://github.com/jkawamoto/mcp-youtube-transcript)** - ⭐ 313
   MCP server retrieving transcripts of YouTube videos

850. **[cheatengine-mcp-bridge](https://github.com/miscusi-peek/cheatengine-mcp-bridge)** - ⭐ 313
...
851. **[mq](https://github.com/harehare/mq)** - ⭐ 312
   jq-like command-line tool for markdown processing

852. **[investor-agent](https://github.com/ferdousbhai/investor-agent)** - ⭐ 312
   A Model Context Protocol server for building an investor agent

853. **[mcp-server-code-execution-mode](https://github.com/elusznik/mcp-server-code-execution-mode)** - ⭐ 310
   An MCP server that executes Python code in isolated rootless containers with optional MCP server proxying. Implementation of Anthropic's and Cloudflare's ideas for reducing MCP tool definitions context bloat.

854. **[kagimcp](https://github.com/kagisearch/kagimcp)** - ⭐ 310
   The Official Model Context Protocol (MCP) server for Kagi search & other tools.

855. **[ShipSwift](https://github.com/signerlabs/ShipSwift)** - ⭐ 310
   AI-native SwiftUI component library with full-stack recipes — connect via MCP for instant access.

856. **[deep-research-mcp](https://github.com/Ozamatash/deep-research-mcp)** - ⭐ 309

857. **[mcp-database-server](https://github.com/executeautomation/mcp-database-server)** - ⭐ 309
   MCP Database Server is a new MCP Server which helps connect with Sqlite, SqlServer and Posgresql Databases

858. **[MaaMCP](https://github.com/MAA-AI/MaaMCP)** - ⭐ 309
   基于 MaaFramework 的 MCP 服务器 为 AI 助手提供 Android 设备和 Windows 桌面自动化能力

859. **[anytype-mcp](https://github.com/anyproto/anytype-mcp)** - ⭐ 309
   An MCP server enabling AI assistants to interact with Anytype - your encrypted, local and collaborative wiki - to organize objects, lists, and more through natural language.

860. **[solon-ai](https://github.com/opensolon/solon-ai)** - ⭐ 306
...
861. **[mcp-sse](https://github.com/sidharthrajaram/mcp-sse)** - ⭐ 304
   A working pattern for SSE-based MCP clients and servers

862. **[sdk](https://github.com/smithery-ai/sdk)** - ⭐ 304
   Smithery helps AI agents access external services via a unified gateway.

863. **[ssh-mcp](https://github.com/tufantunc/ssh-mcp)** - ⭐ 304
   MCP server exposing SSH control for Linux servers via Model Context Protocol.

864. **[mcprouter](https://github.com/chatmcp/mcprouter)** - ⭐ 303
   api router for MCP Servers

865. **[openmcp](https://github.com/getdatanaut/openmcp)** - ⭐ 303
   Turn any openapi file into an mcp server, with just the tools you need.

866. **[Unreal_mcp](https://github.com/ChiR24/Unreal_mcp)** - ⭐ 303
...
867. **[automcp](https://github.com/NapthaAI/automcp)** - ⭐ 302
   Easily convert tool, agents and orchestrators from existing agent frameworks to MCP servers

868. **[mcp-everything-search](https://github.com/mamertofabian/mcp-everything-search)** - ⭐ 302

869. **[mcp-server-apple-shortcuts](https://github.com/recursechat/mcp-server-apple-shortcuts)** - ⭐ 302

870. **[rhinomcp](https://github.com/jingcheng-chen/rhinomcp)** - ⭐ 302
   RhinoMCP connects Rhino 3D to AI Agent through the Model Context Protocol (MCP)

871. **[AI-Kline](https://github.com/QuantML-C/AI-Kline)** - ⭐ 302
...
872. **[apktool-mcp-server](https://github.com/zinja-coder/apktool-mcp-server)** - ⭐ 301
   A MCP Server for APK Tool (Part of Android Reverse Engineering MCP Suites)

873. **[generator](https://github.com/context-hub/generator)** - ⭐ 301
   CTX: a tool that solves the context management gap when working with LLMs like ChatGPT or Claude. It helps developers organize and automatically collect information from their codebase into structured documents that can be easily shared with AI assistants.

874. **[app-store-connect-mcp-server](https://github.com/JoshuaRileyDev/app-store-connect-mcp-server)** - ⭐ 301

875. **[mcp-git-ingest](https://github.com/adhikasp/mcp-git-ingest)** - ⭐ 301
   A Model Context Protocol (MCP) server that helps read GitHub repository structure and important files.

876. **[deepseek-mcp-server](https://github.com/DMontgomery40/deepseek-mcp-server)** - ⭐ 299
   Model Context Protocol server for DeepSeek's advanced language models

877. **[jadx-mcp-server](https://github.com/zinja-coder/jadx-mcp-server)** - ⭐ 297
   MCP server for JADX-AI Plugin

878. **[mcp-claude-code](https://github.com/SDGLBL/mcp-claude-code)** - ⭐ 296
   MCP implementation of Claude Code capabilities and more

879. **[mcp-server-simulator-ios-idb](https://github.com/InditexTech/mcp-server-simulator-ios-idb)** - ⭐ 296
   A Model Context Protocol (MCP) server that enables LLMs to interact with iOS simulators through natural language commands.

880. **[DeepWideResearch](https://github.com/puppyone-ai/DeepWideResearch)** - ⭐ 295
   Agentic RAG for any scenario. Customize sources, depth, and width

881. **[llm-context.py](https://github.com/cyberchitta/llm-context.py)** - ⭐ 295
   Share code with LLMs via Model Context Protocol or clipboard. Rule-based customization enables easy switching between different tasks (like code review and documentation). Includes smart code outlining.

882. **[safe-mcp](https://github.com/safe-agentic-framework/safe-mcp)** - ⭐ 295
   SAFE-MCP is a comprehensive security framework for documenting and mitigating threats in the AI Agent ecosystem.

883. **[mcp-linker](https://github.com/milisp/mcp-linker)** - ⭐ 294
...
884. **[iam-policy-autopilot](https://github.com/awslabs/iam-policy-autopilot)** - ⭐ 294
   IAM Policy Autopilot is an open source static code analysis tool that helps you quickly create baseline AWS IAM policies that you can refine as your application evolves. This tool is available as a command-line utility and MCP server for use within AI coding assistants for quickly building IAM policies.

885. **[mcp](https://github.com/oracle/mcp)** - ⭐ 293
...
886. **[axon](https://github.com/harshkedia177/axon)** - ⭐ 293
...
887. **[mysql_mcp_server_pro](https://github.com/wenb1n-dev/mysql_mcp_server_pro)** - ⭐ 292
...
888. **[mcp-neovim-server](https://github.com/bigcodegen/mcp-neovim-server)** - ⭐ 292
   Control Neovim using Model Context Protocol (MCP) and the official neovim/node-client JavaScript library

889. **[mcpsvr](https://github.com/nanbingxyz/mcpsvr)** - ⭐ 292
   Discover Exceptional MCP Servers

890. **[obsidian-mcp](https://github.com/newtype-01/obsidian-mcp)** - ⭐ 291
   Obsidian MCP (Model Context Protocol) Server

891. **[aws-mcp](https://github.com/RafalWilinski/aws-mcp)** - ⭐ 291
   Talk with your AWS using Claude. Model Context Protocol (MCP) server for AWS. Better Amazon Q alternative.

892. **[minthcm](https://github.com/minthcm/minthcm)** - ⭐ 291
   First AI‑enabled open-source Human Capital Management system that you can start using today.

893. **[aider-mcp-server](https://github.com/disler/aider-mcp-server)** - ⭐ 291
   Minimal MCP Server for Aider

894. **[blender-mcp-vxai](https://github.com/VxASI/blender-mcp-vxai)** - ⭐ 290

895. **[consult7](https://github.com/szeider/consult7)** - ⭐ 290
   MCP server to consult a language model with large context size

896. **[imagesorcery-mcp](https://github.com/sunriseapps/imagesorcery-mcp)** - ⭐ 290
   An MCP server providing tools for image processing operations

897. **[MCPControl](https://github.com/claude-did-this/MCPControl)** - ⭐ 290
   MCP server for Windows OS automation

898. **[utcp-specification](https://github.com/universal-tool-calling-protocol/utcp-specification)** - ⭐ 289
   The specification for the Universal Tool Calling Protocol

899. **[lean-lsp-mcp](https://github.com/oOo0oOo/lean-lsp-mcp)** - ⭐ 289
   Lean Theorem Prover MCP

900. **[mcp](https://github.com/salesforcecli/mcp)** - ⭐ 289
   MCP Server for interacting with Salesforce instances

901. **[mcp-server-mas-sequential-thinking](https://github.com/FradSer/mcp-server-mas-sequential-thinking)** - ⭐ 288
   An advanced sequential thinking process using a Multi-Agent System (MAS) built with the Agno framework and served via MCP.

902. **[telegram-mcp](https://github.com/chaindead/telegram-mcp)** - ⭐ 288
   Telegram MCP for managing dialogs, messages, drafts, read statuses, and more.

903. **[mcp-documentation-server](https://github.com/andrea9293/mcp-documentation-server)** - ⭐ 288
...
904. **[lets-learn-mcp-csharp](https://github.com/microsoft/lets-learn-mcp-csharp)** - ⭐ 287

905. **[nova-proximity](https://github.com/Nova-Hunting/nova-proximity)** - ⭐ 287
   Nova-Proximity is a MCP and Agent Skills security scanner powered with NOVA

906. **[o3-search-mcp](https://github.com/yoshiko-pg/o3-search-mcp)** - ⭐ 286
   MCP server for OpenAI o3 web search

907. **[remote-mcp-server-with-auth](https://github.com/coleam00/remote-mcp-server-with-auth)** - ⭐ 286
...
908. **[ddddocr](https://github.com/86maid/ddddocr)** - ⭐ 286
...
909. **[safe-mcp](https://github.com/SAFE-MCP/safe-mcp)** - ⭐ 285
   SAFE-MCP is a comprehensive security framework for documenting and mitigating threats in the AI Agent ecosystem.

910. **[chrome-devtools-mcp](https://github.com/benjaminr/chrome-devtools-mcp)** - ⭐ 284
   An MCP Server for Chrome DevTools, following the Chrome DevTools Protocol. Integrates with Claude Desktop and Claude Code.

911. **[geminimcp](https://github.com/GuDaStudio/geminimcp)** - ⭐ 284
...
912. **[meGPT](https://github.com/adrianco/meGPT)** - ⭐ 283
   Code to process many kinds of content by an author into an MCP server

913. **[hydra-mcp-solana](https://github.com/hydra-mcp/hydra-mcp-solana)** - ⭐ 283
   hydra-ai

914. **[perplexity-mcp](https://github.com/DaInfernalCoder/perplexity-mcp)** - ⭐ 283
...
919. **[tabularis](https://github.com/debba/tabularis)** - ⭐ 283
   A lightweight, developer-focused database management tool

920. **[swiss-ai-call-agent](https://github.com/Chrissotino/swiss-ai-call-agent)** - ⭐ 283
...
921. **[mcp-manager](https://github.com/amxv/mcp-manager)** - ⭐ 282
   simple web ui to manage mcp (model context protocol) servers in the claude app

922. **[DeepWideResearch](https://github.com/PuppyAgent/DeepWideResearch)** - ⭐ 281
   Agentic RAG for any scenario. Customize sources, depth, and width

923. **[MCP-Server-Playwright](https://github.com/VikashLoomba/MCP-Server-Playwright)** - ⭐ 281
   MCP server for browser automation using Playwright

924. **[mcp-manager](https://github.com/zueai/mcp-manager)** - ⭐ 280
   simple web ui to manage mcp (model context protocol) servers in the claude app

925. **[MCP-handle](https://github.com/WeatherPal-AI/MCP-handle)** - ⭐ 280
   MCP integration platforms making AI-Agents developers focusing on their own tasks

926. **[FileScopeMCP](https://github.com/admica/FileScopeMCP)** - ⭐ 280
   Analyzes your codebase identifying important files based on dependency relationships. Generates diagrams and importance scores per file, helping AI assistants understand the codebase. Automatically parses popular programming languages such as Python, C, C++, Rust, Zig, Lua.

927. **[laravel-claude-code-setup](https://github.com/laraben/laravel-claude-code-setup)** - ⭐ 279
   One-command setup for AI-powered Laravel development with Claude Code and MCP servers

928. **[mcp940](https://github.com/WangTingZheng/mcp940)** - ⭐ 278
   Source code of minecraft 1.12

929. **[metorial-index](https://github.com/metorial/metorial-index)** - ⭐ 277
   Metorial MCP Index - An ever growing list of open source MCP servers 📁 🎉

930. **[hass-mcp](https://github.com/voska/hass-mcp)** - ⭐ 277
   Home Assistant MCP Server

931. **[django-mcp-server](https://github.com/gts360/django-mcp-server)** - ⭐ 277
   Django MCP Server is a Django extensions to easily enable AI Agents to interact with Django Apps through the Model Context Protocol it works equally well on WSGI and ASGI

932. **[mcp-mongo-server](https://github.com/kiliczsh/mcp-mongo-server)** - ⭐ 276
   A Model Context Protocol Server for MongoDB

933. **[Context-Engine](https://github.com/m1rl0k/Context-Engine)** - ⭐ 276
   Context-Engine MCP - Agentic Context Compression Suite

934. **[next-lens](https://github.com/1weiho/next-lens)** - ⭐ 276
   A CLI that scans Next.js routes and provides quick insights from your terminal, web UI, and MCP.

935. **[mcp-reasoner](https://github.com/Jacck/mcp-reasoner)** - ⭐ 276
   A systematic reasoning MCP server implementation for Claude Desktop with beam search and thought evaluation.

936. **[gemini-cli-desktop](https://github.com/Piebald-AI/gemini-cli-desktop)** - ⭐ 276
   Web/desktop UI for Gemini CLI/Qwen Code.  Manage projects, switch between tools, search across past conversations, and manage MCP servers, all from one multilingual interface, locally or remotely.

937. **[dify-mcp-server](https://github.com/YanxingLiu/dify-mcp-server)** - ⭐ 275
   Model Context Protocol (MCP) Server for dify workflows

938. **[mcp-server-guide](https://github.com/figma/mcp-server-guide)** - ⭐ 275
   A guide on how to use the Figma MCP server

939. **[AetherLink](https://github.com/1600822305/AetherLink)** - ⭐ 274
...
940. **[ai-agent-team](https://github.com/peterfei/ai-agent-team)** - ⭐ 274
   AI Agent Team-拥有24/7专业AI开发团队：产品经理、前端开发、后端开发、测试工程师、DevOps工程师、技术负责人。一键安装，支持中英文命令，大幅提升开发效率！

941. **[mcp-odoo](https://github.com/tuanle96/mcp-odoo)** - ⭐ 274
   MCP Server for Odoo

942. **[mcp-omnisearch](https://github.com/spences10/mcp-omnisearch)** - ⭐ 273
   🔍 A Model Context Protocol (MCP) server providing unified access to multiple search engines (Tavily, Brave, Kagi), AI tools (Perplexity, FastGPT), and content processing services (Jina AI, Kagi). Combines search, AI responses, content processing, and enhancement features through a single interface.

943. **[claude-modular](https://github.com/oxygen-fragment/claude-modular)** - ⭐ 272
   Production-ready modular Claude Code framework with 30+ commands, token optimization, and MCP server integration. Achieves 2-10x productivity gains through   systematic command organization and hierarchical configuration.

944. **[mcp-ical](https://github.com/Omar-V2/mcp-ical)** - ⭐ 272
   A Model Context Protocol Server that allows you to interact with your MacOS Calendar through natural language.

945. **[proximity](https://github.com/Nova-Hunting/proximity)** - ⭐ 271
   Proximity is a MCP security scanner powered with NOVA

946. **[jinni](https://github.com/smat-dev/jinni)** - ⭐ 270
   Bring your project into LLM context - tool and MCP server

947. **[mcp-gdrive](https://github.com/isaacphi/mcp-gdrive)** - ⭐ 270
   Model Context Protocol (MCP) Server for reading from Google Drive and editing Google Sheets

948. **[stitch](https://github.com/gemini-cli-extensions/stitch)** - ⭐ 269
   The Stitch extension for Gemini CLI enables you to interact with the Stitch MCP server using natural language commands. 

949. **[proximity](https://github.com/fr0gger/proximity)** - ⭐ 269
   Proximity is a MCP security scanner powered with NOVA

950. **[model-context-protocol-resources](https://github.com/cyanheads/model-context-protocol-resources)** - ⭐ 269
   Exploring the Model Context Protocol (MCP) through practical guides, clients, and servers I've built while learning about this new protocol.

951. **[ultra-mcp](https://github.com/RealMikeChong/ultra-mcp)** - ⭐ 269
   100x Your Claude Code, Gemini CLI, Cursor and/or any coding tools with MCP client support

952. **[reddit-mcp](https://github.com/Arindam200/reddit-mcp)** - ⭐ 267
   Model Context Protocol server implementation for Reddit

953. **[mcp-server-tree-sitter](https://github.com/wrale/mcp-server-tree-sitter)** - ⭐ 266
   MCP Server for Tree-sitter

954. **[deepcontext-mcp](https://github.com/Wildcard-Official/deepcontext-mcp)** - ⭐ 265
   DeepContext is an MCP server that adds symbol-aware semantic search to Claude Code, Codex CLI, and other agents for faster, smarter context on large codebases.

955. **[apollo-mcp-server](https://github.com/apollographql/apollo-mcp-server)** - ⭐ 264
   Apollo MCP Server

956. **[bazi-mcp](https://github.com/cantian-ai/bazi-mcp)** - ⭐ 264
   MCP server for Bazi (八字) information

957. **[wexin-read-mcp](https://github.com/Bwkyd/wexin-read-mcp)** - ⭐ 263
   能够让大模型阅读微信公众号文章，使用浏览器模拟绕过反爬虫。

958. **[xiaozhi-client](https://github.com/shenjingnan/xiaozhi-client)** - ⭐ 259
   小智AI客户端，目前主要用于MCP的对接

959. **[mcp-server](https://github.com/strands-agents/mcp-server)** - ⭐ 259
   This MCP server provides documentation about Strands Agents to your GenAI tools, so you can use your favorite AI coding assistant to vibe-code Strands Agents.

960. **[osp_marketing_tools](https://github.com/open-strategy-partners/osp_marketing_tools)** - ⭐ 258
   A Model Context Protocol (MCP) server that empowers LLMs to use some of Open Srategy Partners' core writing and product marketing techniques.

961. **[mcp_massive](https://github.com/massive-com/mcp_massive)** - ⭐ 258
   An MCP server for Massive.com Financial Market Data

962. **[api200](https://github.com/API-200/api200)** - ⭐ 257
   API 200 is an open source API gateway to simplify 3rd-party integrations. Import endpoints, set up caching, retries, and mocks. Access all services via one URL. Monitor logs, track errors, and get alerts on API incidents.

963. **[enterprise-mcp-course](https://github.com/decodingai-magazine/enterprise-mcp-course)** - ⭐ 257
...
964. **[doris-mcp-server](https://github.com/apache/doris-mcp-server)** - ⭐ 257
   Apache Doris MCP Server

965. **[rust-docs-mcp-server](https://github.com/Govcraft/rust-docs-mcp-server)** - ⭐ 256
   🦀 Prevents outdated Rust code suggestions from AI assistants. This MCP server fetches current crate docs, uses embeddings/LLMs, and provides accurate context via a tool call.

966. **[sandboxed.sh](https://github.com/Th0rgal/sandboxed.sh)** - ⭐ 255
   Self-hosted orchestrator for AI autonomous agents. Run Claude Code & Open Code in isolated linux workspaces. Manage your skills, configs and encrypted secrets with a git repo.

967. **[project-nova](https://github.com/dujonwalker/project-nova)** - ⭐ 254
...
968. **[spring-ai-summary](https://github.com/java-ai-tech/spring-ai-summary)** - ⭐ 254
   SpringAI，LLM，MCP，Embedding

969. **[code-reasoning](https://github.com/mettamatt/code-reasoning)** - ⭐ 254
   A code reasoning MCP server, a fork of sequential-thinking

970. **[admin](https://github.com/decocms/admin)** - ⭐ 253
   Define and compose secure MCPs in TypeScript. Generate AI workflows and agents with React + Tailwind UI. Deploy anywhere.

971. **[elasticsearch-mcp-server](https://github.com/cr7258/elasticsearch-mcp-server)** - ⭐ 253
   A Model Context Protocol (MCP) server implementation that provides Elasticsearch and OpenSearch interaction.

972. **[real-estate-mcp](https://github.com/tae0y/real-estate-mcp)** - ⭐ 253
   Ask Claude about Korean apartment prices — powered by MOLIT's open API

973. **[mcp_flutter](https://github.com/Arenukvern/mcp_flutter)** - ⭐ 252
   MCP server and MCP Toolkit  for Flutter and Dart VM - supports dynamic tooling

974. **[AEnvironment](https://github.com/inclusionAI/AEnvironment)** - ⭐ 252
   Standardized environment infrastructure for Agentic AI development.

975. **[Windows-MCP.Net](https://github.com/shuyu-labs/Windows-MCP.Net)** - ⭐ 252
   A .NET-based Windows desktop automation MCP (Model Context Protocol) server that provides AI assistants with the ability to interact with the Windows desktop environment.

976. **[Security-Detections-MCP](https://github.com/MHaggis/Security-Detections-MCP)** - ⭐ 252
   MCP to help Defenders Detection Engineer Harder and Smarter

977. **[g-search-mcp](https://github.com/jae-jae/g-search-mcp)** - ⭐ 251
   A powerful MCP server for Google search that enables parallel searching with multiple keywords simultaneously.

978. **[outlook-mcp](https://github.com/ryaker/outlook-mcp)** - ⭐ 251
   MCP server for Claude to access Outlook data via Microsoft Graph API

979. **[codex-mcp-server](https://github.com/tuannvm/codex-mcp-server)** - ⭐ 251
   MCP server wrapper for OpenAI Codex CLI that enables Claude Code to leverage Codex's AI capabilities directly.

980. **[aci-mcp](https://github.com/aipotheosis-labs/aci-mcp)** - ⭐ 250
   MCP server(s) for Aipolabs ACI.dev

981. **[MARM-Systems](https://github.com/Lyellr88/MARM-Systems)** - ⭐ 250
...
982. **[strava-mcp](https://github.com/r-huijts/strava-mcp)** - ⭐ 249
   A Model Context Protocol (MCP) server that connects to Strava API, providing tools to access Strava data through LLMs

983. **[mcp-server-gemini](https://github.com/aliargun/mcp-server-gemini)** - ⭐ 248
   MCP server implementation for Google's Gemini API

984. **[video-editing-mcp](https://github.com/burningion/video-editing-mcp)** - ⭐ 248
   MCP Interface for Video Jungle

985. **[CAD-MCP](https://github.com/daobataotie/CAD-MCP)** - ⭐ 248
   CAD MCP Server

986. **[claude-recall](https://github.com/nhevers/claude-recall)** - ⭐ 247
   Long-term memory layer for MoltBot & Claude Code that learns and recalls your project context automatically

987. **[suppr-mcp](https://github.com/WildDataX/suppr-mcp)** - ⭐ 247
    超能文献|AI驱动的文档翻译与学术搜索服务。支持PDF、DOCX、PPTX等多格式文档的高质量翻译（支持11种语言），特别优化了数学公式翻译。同时提供PubMed学术文献智能搜索功能。更多访问：https://suppr.wilddata.cn

988. **[browser-control-mcp](https://github.com/eyalzh/browser-control-mcp)** - ⭐ 247
   MCP server paired with a browser extension that enables AI agents to control the user's browser.

989. **[agents](https://github.com/astronomer/agents)** - ⭐ 246
   AI agent tooling for data engineering workflows.

990. **[gemini-kit](https://github.com/nth5693/gemini-kit)** - ⭐ 245
   🚀 19 AI Agents + 44 Commands for Gemini CLI - Code 10x faster with auto planning, testing, review & security

991. **[Windows-MCP.Net](https://github.com/AIDotNet/Windows-MCP.Net)** - ⭐ 244
   A .NET-based Windows desktop automation MCP (Model Context Protocol) server that provides AI assistants with the ability to interact with the Windows desktop environment.

992. **[mcp-chatbot](https://github.com/3choff/mcp-chatbot)** - ⭐ 244
   A simple CLI chatbot that demonstrates the integration of the Model Context Protocol (MCP).

993. **[ticktick-mcp](https://github.com/jacepark12/ticktick-mcp)** - ⭐ 244
   MCP server that interacts with TickTick (Dida 365) via the TickTick Open API

994. **[mcp-server](https://github.com/volcengine/mcp-server)** - ⭐ 244
   Volcengine MCP Servers

995. **[chat-mcp](https://github.com/AI-QL/chat-mcp)** - ⭐ 243
   A Desktop Chat App that leverages MCP(Model Context Protocol) to interface with other LLMs.

996. **[human-mcp](https://github.com/mrgoonie/human-mcp)** - ⭐ 243

997. **[embodied-claude](https://github.com/lifemate-ai/embodied-claude)** - ⭐ 243
   Claudeに身体性を与えるMCP群

998. **[obsidian-mcp-plugin](https://github.com/aaronsb/obsidian-mcp-plugin)** - ⭐ 243
   High-performance Model Context Protocol (MCP) server for Obsidian that provides AI tools with direct vault access through semantic operations and HTTP transport.

999. **[binary_ninja_mcp](https://github.com/fosdickio/binary_ninja_mcp)** - ⭐ 243
   A Binary Ninja plugin containing an MCP server that enables seamless integration with your favorite LLM/MCP client.

1000. **[mcp-feedback-collector](https://github.com/sanshao85/mcp-feedback-collector)** - ⭐ 242
   一个现代化的 Model Context Protocol (MCP) 服务器，为AI助手提供交互式用户反馈收集功能。

1001. **[awesome-mcp-servers](https://github.com/PipedreamHQ/awesome-mcp-servers)** - ⭐ 242
   A collection of MCP servers

1002. **[mcp2py](https://github.com/MaximeRivest/mcp2py)** - ⭐ 241
   Turn any MCP server into a Python module

1003. **[mcp-prompt-server](https://github.com/gdli6177/mcp-prompt-server)** - ⭐ 241
   这是一个基于Model Context Protocol (MCP)的服务器，用于根据用户任务需求提供预设的prompt模板，帮助Cline/Cursor/Windsurf...更高效地执行各种任务。服务器将预设的prompt作为工具(tools)返回，以便在Cursor和Windsurf等编辑器中更好地使用。

1004. **[mcp](https://github.com/Snowflake-Labs/mcp)** - ⭐ 241
   MCP Server for Snowflake including Cortex AI, object management, SQL orchestration, semantic view consumption, and more

1005. **[MCPBench](https://github.com/modelscope/MCPBench)** - ⭐ 241
   The evaluation benchmark on MCP servers

1006. **[claude-code-mcpinstall](https://github.com/undeadpickle/claude-code-mcpinstall)** - ⭐ 240
   Easy guide to installing Claude Code MCPs globally on your machine.

1007. **[foundry-mcp-server](https://github.com/PraneshASP/foundry-mcp-server)** - ⭐ 240
   An experimental MCP Server for foundry built for Solidity devs

1008. **[claude_code-gemini-mcp](https://github.com/RaiAnsar/claude_code-gemini-mcp)** - ⭐ 239
   Simplified Gemini for Claude Code. 

1009. **[weather-mcp-server](https://github.com/ezh0v/weather-mcp-server)** - ⭐ 239
   A lightweight Model Context Protocol (MCP) server that enables AI assistants like Claude to retrieve and interpret real-time weather data. Discuss on Hacker News:

1010. **[PIXRA](https://github.com/dodufish/PIXRA)** - ⭐ 239
   Pixelize the real world on-chain

1011. **[mcp-proxy-for-aws](https://github.com/aws/mcp-proxy-for-aws)** - ⭐ 239
   AWS MCP Proxy Server

1012. **[mcp-server-trello](https://github.com/delorenj/mcp-server-trello)** - ⭐ 239
   A Model Context Protocol (MCP) server that provides tools for interacting with Trello boards.

1013. **[dat](https://github.com/hexinfo/dat)** - ⭐ 239
   Asking yours data in a natural language way through pre-modeling (data models and semantic models).

1014. **[firebase-mcp](https://github.com/gannonh/firebase-mcp)** - ⭐ 239
   🔥 Model Context Protocol (MCP) server for Firebase.

1015. **[Mimir](https://github.com/orneryd/Mimir)** - ⭐ 239
...
1016. **[spotify-mcp-server](https://github.com/marcelmarais/spotify-mcp-server)** - ⭐ 239
   Lightweight MCP server for Spotify

1017. **[mcp-server-code-runner](https://github.com/formulahendry/mcp-server-code-runner)** - ⭐ 238
   Code Runner MCP Server

1018. **[mcp-on-vercel](https://github.com/vercel-labs/mcp-on-vercel)** - ⭐ 238

1019. **[mac_messages_mcp](https://github.com/carterlasalle/mac_messages_mcp)** - ⭐ 238
   An MCP server that securely interfaces with your iMessage database via the Model Context Protocol (MCP), allowing LLMs to query and analyze iMessage conversations. It includes robust phone number validation, attachment processing, contact management, group chat handling, and full support for sending and receiving messages.

1020. **[mcp-proxy](https://github.com/punkpeye/mcp-proxy)** - ⭐ 237
   A TypeScript streamable HTTP and SSE proxy for MCP servers that use stdio transport.

1021. **[mcp_chatbot](https://github.com/keli-wen/mcp_chatbot)** - ⭐ 236
   A chatbot implementation compatible with MCP (terminal / streamlit supported)

1022. **[octocode](https://github.com/Muvon/octocode)** - ⭐ 236
   Semantic code searcher and codebase utility

1023. **[facebook-ads-mcp-server](https://github.com/gomarble-ai/facebook-ads-mcp-server)** - ⭐ 236

1024. **[NFTIAI](https://github.com/Axarb/NFTIAI)** - ⭐ 235
...
1025. **[mcp-foundry](https://github.com/microsoft-foundry/mcp-foundry)** - ⭐ 235
   A MCP Server for Azure AI Foundry: it's now moved to cloud, check the new Foundry MCP Server

1026. **[openapi-to-mcpserver](https://github.com/higress-group/openapi-to-mcpserver)** - ⭐ 235
   A tool&lib that can automatically convert OpenAPI documents into Higress remote MCP server configurations.

1027. **[c2sagent](https://github.com/C2SAgent/c2sagent)** - ⭐ 233
...
1028. **[MCP-connect](https://github.com/EvalsOne/MCP-connect)** - ⭐ 232
   Enables cloud-based AI services to access local Stdio based MCP servers via HTTP requests

1029. **[omnicoreagent](https://github.com/omnirexflora-labs/omnicoreagent)** - ⭐ 232
...
1030. **[mcp-telegram](https://github.com/dryeab/mcp-telegram)** - ⭐ 232
   MCP Server for Telegram

1031. **[TradingAgents-MCPmode](https://github.com/guangxiangdebizi/TradingAgents-MCPmode)** - ⭐ 232
   TradingAgents-MCPmode 是一个创新的多智能体交易分析系统，集成了 Model Context Protocol (MCP) 工具，实现了智能化的股票分析和交易决策流程。系统通过多个专业化智能体的协作，提供全面的市场分析、投资建议和风险管理。

1032. **[Lambda-MCP-Server](https://github.com/mikegc-aws/Lambda-MCP-Server)** - ⭐ 231
   Creates a simple MCP tool server with "streaming" HTTP.

1033. **[xiyan_mcp_server](https://github.com/XGenerationLab/xiyan_mcp_server)** - ⭐ 231
   A Model Context Protocol (MCP) server that enables natural language queries to databases

1034. **[Google-Scholar-MCP-Server](https://github.com/JackKuo666/Google-Scholar-MCP-Server)** - ⭐ 231
...
1035. **[sample-serverless-mcp-servers](https://github.com/aws-samples/sample-serverless-mcp-servers)** - ⭐ 230
   Sample implementations of AI Agents and MCP Servers running on AWS Serverless compute

1036. **[playwright-mcp](https://github.com/cloudflare/playwright-mcp)** - ⭐ 230
   Playwright MCP fork that works with Cloudflare Browser Rendering

1037. **[nocturne_memory](https://github.com/Dataojitori/nocturne_memory)** - ⭐ 230
   一个基于uri而不是RAG的轻量级、可回滚、可视化的 **AI 外挂MCP记忆库**。让你的 AI 拥有跨模型，跨会话，跨工具的持久的结构化记忆。

1038. **[MiroRL](https://github.com/MiroMindAI/MiroRL)** - ⭐ 229
   MiroRL is  an MCP-first reinforcement learning framework for deep research agent.

1039. **[pageindex-mcp](https://github.com/VectifyAI/pageindex-mcp)** - ⭐ 229
...
1040. **[api-agent](https://github.com/agoda-com/api-agent)** - ⭐ 229
   Universal MCP server for GraphQL/REST APIs

1041. **[tmux-mcp](https://github.com/nickgnd/tmux-mcp)** - ⭐ 228
   A MCP server for our beloved terminal multiplexer tmux.

1042. **[remote-swe-agents](https://github.com/aws-samples/remote-swe-agents)** - ⭐ 228
   Autonomous SWE agent working in the cloud! (a.k.a. Vibe coding with Bedrock)

1043. **[mcp-foundry](https://github.com/azure-ai-foundry/mcp-foundry)** - ⭐ 227
   A MCP Server for Azure AI Foundry: it's now moved to cloud, check the new Foundry MCP Server

1044. **[cobolt](https://github.com/platinum-hill/cobolt)** - ⭐ 227
...
1045. **[vulnerable-mcp-servers-lab](https://github.com/appsecco/vulnerable-mcp-servers-lab)** - ⭐ 227
   A collection of servers which are deliberately vulnerable to learn Pentesting MCP Servers.

1046. **[mcp-maigret](https://github.com/BurtTheCoder/mcp-maigret)** - ⭐ 227
   MCP server for maigret, a powerful OSINT tool that collects user account information from various public sources. 

1047. **[mcp-openapi-server](https://github.com/ivo-toby/mcp-openapi-server)** - ⭐ 227
   MCP Server (Model Context Protocol) for turning OpenAPI specifications into a MCP Resource

1048. **[Alice](https://github.com/pmbstyle/Alice)** - ⭐ 226
...
1049. **[mcp-compass](https://github.com/liuyoshio/mcp-compass)** - ⭐ 226
   MCP Discovery & Recommendation Service - Find the right MCP server for your needs

1050. **[lyraios](https://github.com/GalaxyLLMCI/lyraios)** - ⭐ 225
...
1051. **[mcp-server-commands](https://github.com/g0t4/mcp-server-commands)** - ⭐ 225
   Model Context Protocol server to run commands (tool: `runProcess`)

1052. **[data-go-mcp-servers](https://github.com/Koomook/data-go-mcp-servers)** - ⭐ 224
   Korea public data portal (data.go.kr) API MCP servers

1053. **[antd-components-mcp](https://github.com/zhixiaoqiang/antd-components-mcp)** - ⭐ 224
   An MCP service for Ant Design components query | 一个减少 Ant Design 组件代码生成幻觉的 MCP 服务，包含系统提示词、组件文档、API 文档、代码示例和更新日志查询

1054. **[kite-mcp-server](https://github.com/zerodha/kite-mcp-server)** - ⭐ 224
   Zerodha Kite MCP server

1055. **[yahoo-finance-mcp](https://github.com/Alex2Yang97/yahoo-finance-mcp)** - ⭐ 224
   This is a Model Context Protocol (MCP) server that provides comprehensive financial data from Yahoo Finance. It allows you to retrieve detailed information about stocks, including historical prices, company information, financial statements, options data, and market news.

1056. **[ruby_llm-mcp](https://github.com/patvice/ruby_llm-mcp)** - ⭐ 224
   Full-featured MCP support for Ruby and RubyLLM—making it easy to build structured, composable LLM workflows in pure Ruby.

1057. **[lingti-bot](https://github.com/ruilisi/lingti-bot)** - ⭐ 224
   🐕⚡ 「极简至上 效率为王 一次编译 到处执行 极速接入」的 AI Bot

1058. **[claude-historian-mcp](https://github.com/Vvkmnn/claude-historian-mcp)** - ⭐ 223
   📜 An MCP server for conversation history search and retrieval in Claude Code

1059. **[llamacloud-mcp](https://github.com/run-llama/llamacloud-mcp)** - ⭐ 222

1060. **[langgraph-whatsapp-agent](https://github.com/lgesuellip/langgraph-whatsapp-agent)** - ⭐ 222
...
1061. **[effect-mcp](https://github.com/tim-smart/effect-mcp)** - ⭐ 222

1062. **[anki-mcp-server](https://github.com/nailuoGG/anki-mcp-server)** - ⭐ 222
   MCP server for Anki via AnkiConnect

1063. **[mermaid-mcp-server](https://github.com/peng-shawn/mermaid-mcp-server)** - ⭐ 222
   A Model Context Protocol (MCP) server that converts Mermaid diagrams to PNG images

1064. **[mcp-twikit](https://github.com/adhikasp/mcp-twikit)** - ⭐ 222
   A Model Context Protocol (MCP) server for interacting with Twitter.

1065. **[life-sciences](https://github.com/anthropics/life-sciences)** - ⭐ 222
...
1066. **[agent-mcp-lab](https://github.com/WaveSpeedAI/agent-mcp-lab)** - ⭐ 221

1067. **[smart-tree](https://github.com/8b-is/smart-tree)** - ⭐ 221
...
1068. **[penpot-mcp](https://github.com/montevive/penpot-mcp)** - ⭐ 221
   Penpot MCP server

1069. **[learn-agentic-ai-from-low-code-to-code](https://github.com/panaversity/learn-agentic-ai-from-low-code-to-code)** - ⭐ 221
   Build production-grade agents with OpenAI AgentKit, a no-code platfrom.

1070. **[lokka](https://github.com/merill/lokka)** - ⭐ 220
   MCP (Model Context Protocol) for Microsoft 365. Includes support for Microsoft Graph and other services

1071. **[Google-Search-MCP-Server](https://github.com/mixelpixx/Google-Search-MCP-Server)** - ⭐ 220
...
1072. **[plate-playground-template](https://github.com/udecode/plate-playground-template)** - ⭐ 220
   Plate AI template with React 19, Next 16, Tailwind 4, MCP.

1073. **[composer-trade-mcp](https://github.com/invest-composer/composer-trade-mcp)** - ⭐ 220
   Composer's MCP server lets MCP-enabled LLMs like Claude backtest trading ideas and automatically invest in them for you

1074. **[garmin_mcp](https://github.com/Taxuspt/garmin_mcp)** - ⭐ 220
   MCP server to access Garmin data

1075. **[home-assistant-cursor-agent](https://github.com/Coolver/home-assistant-cursor-agent)** - ⭐ 219
...
1076. **[claude-config-editor](https://github.com/gagarinyury/claude-config-editor)** - ⭐ 219
...
1077. **[mcp-trends-hub](https://github.com/baranwang/mcp-trends-hub)** - ⭐ 219
   基于 Model Context Protocol (MCP) 协议的全网热点趋势一站式聚合服务

1078. **[cpp-mcp](https://github.com/hkr04/cpp-mcp)** - ⭐ 219
   Lightweight C++ MCP (Model Context Protocol) SDK

1079. **[human-in-the-loop](https://github.com/KOBA789/human-in-the-loop)** - ⭐ 218
   An MCP (Model Context Protocol) server that allows AI assistants to ask questions to humans via Discord.

1080. **[robloxstudio-mcp](https://github.com/boshyxd/robloxstudio-mcp)** - ⭐ 218
   Create agentic AI workflows in ROBLOX Studio

1081. **[domainstack.io](https://github.com/jakejarvis/domainstack.io)** - ⭐ 217
   🧰 All-in-one domain name intelligence as a service

1082. **[yt-dlp-mcp](https://github.com/kevinwatt/yt-dlp-mcp)** - ⭐ 217
   A Model Context Protocol (MCP) server that bridges Video & Audio content with Large Language Models using yt-dlp.

1083. **[image-gen-server](https://github.com/fengin/image-gen-server)** - ⭐ 217
   一个能与Cursor集成的图片生成mcp server工具，实现调用即梦逆向接口

1084. **[tentix](https://github.com/labring/tentix)** - ⭐ 216
...
1085. **[mindmap-mcp-server](https://github.com/YuChenSSR/mindmap-mcp-server)** - ⭐ 216
   mindmap, mcp server, artifact

1086. **[overseer](https://github.com/dmmulroy/overseer)** - ⭐ 216
   CLI & Codemode MCP server for agent task management

1087. **[mcp-server-milvus](https://github.com/zilliztech/mcp-server-milvus)** - ⭐ 215
   Model Context Protocol Servers for Milvus

1088. **[mcp_code_executor](https://github.com/bazinga012/mcp_code_executor)** - ⭐ 215
   The MCP Code Executor is an MCP server that allows LLMs to execute Python code within a specified Conda environment.

1089. **[uber-eats-mcp-server](https://github.com/ericzakariasson/uber-eats-mcp-server)** - ⭐ 215

1090. **[MakeMoneyWithAI](https://github.com/garylab/MakeMoneyWithAI)** - ⭐ 215
   A list of open-source AI projects you can use to generate income easily.

1091. **[after-effects-mcp](https://github.com/Dakkshin/after-effects-mcp)** - ⭐ 215
   MCP Server for Adobe After Effects. Enables remote control (compositions, text, shapes, solids, properties) via the Model Context Protocol using ExtendScript.

1092. **[vibevideo-mcp](https://github.com/hyepartners-gmail/vibevideo-mcp)** - ⭐ 214
   Agent MCP for ffmpeg

1093. **[razorpay-mcp-server](https://github.com/razorpay/razorpay-mcp-server)** - ⭐ 214
   Razorpay's Official MCP Server

1094. **[frida-mcp](https://github.com/dnakov/frida-mcp)** - ⭐ 214
   MCP stdio server for frida

1095. **[lihil](https://github.com/raceychan/lihil)** - ⭐ 213
   2X faster ASGI web framework for python, offering high-level development, low-level performance.

1096. **[claude-context-mode](https://github.com/mksglu/claude-context-mode)** - ⭐ 213
   Stop losing context to large outputs.

1097. **[gibber-mcp](https://github.com/antonpk1/gibber-mcp)** - ⭐ 212
   Tiny MCP server with cryptography tools, sufficient to establish end-to-end encryption between LLM agents

1098. **[gram](https://github.com/speakeasy-api/gram)** - ⭐ 212
   Context layer for your product. Connect your agents and chat to 1st and 3rd party MCP servers!

1099. **[claudex](https://github.com/Mng-dev-ai/claudex)** - ⭐ 212
...
1100. **[mastergo-magic-mcp](https://github.com/mastergo-design/mastergo-magic-mcp)** - ⭐ 211
...
1101. **[jebmcp](https://github.com/dawnslab/jebmcp)** - ⭐ 211

1102. **[mathom](https://github.com/stephenlacy/mathom)** - ⭐ 211
   Run and monitor MCP servers locally

1103. **[sec-edgar-mcp](https://github.com/stefanoamorelli/sec-edgar-mcp)** - ⭐ 211
   A SEC EDGAR MCP (Model Context Protocol) Server

1104. **[mcp-taskmanager](https://github.com/kazuph/mcp-taskmanager)** - ⭐ 210

1105. **[multimodal-mcp-client](https://github.com/Ejb503/multimodal-mcp-client)** - ⭐ 210
   A Multi-modal MCP client for voice powered agentic workflows

1106. **[mcp-n8n-workflow-builder](https://github.com/salacoste/mcp-n8n-workflow-builder)** - ⭐ 210
   AI-powered n8n workflow automation through natural language. MCP server enabling Claude AI & Cursor IDE to create, manage, and monitor workflows via Model Context Protocol. Multi-instance support, 17 tools, comprehensive docs. Build workflows conversationally without manual JSON editing.

1107. **[Autono](https://github.com/vortezwohl/Autono)** - ⭐ 209
   A ReAct-Based Highly Robust Autonomous Agent Framework.

1108. **[figma-mcp](https://github.com/MatthewDailey/figma-mcp)** - ⭐ 209
   ModelContextProtocol for Figma's REST API

1109. **[ha-mcp-for-xiaozhi](https://github.com/c1pher-cn/ha-mcp-for-xiaozhi)** - ⭐ 209
   Homeassistant MCP server for 小智AI

1110. **[mcp-echarts](https://github.com/hustcc/mcp-echarts)** - ⭐ 209
   🧬 Generate visual charts using ECharts with AI MCP dynamically, used for chart generation and data analysis.

1111. **[mcp-server-deep-research](https://github.com/reading-plus-ai/mcp-server-deep-research)** - ⭐ 208

1112. **[jetski](https://github.com/hyprmcp/jetski)** - ⭐ 208
...
1113. **[automagik-genie](https://github.com/namastexlabs/automagik-genie)** - ⭐ 208
   🧞 Automagik Genie – bootstrap, update, and roll back AI agent workspaces with a single CLI + MCP toolkit.

1114. **[servicenow-mcp](https://github.com/echelon-ai-labs/servicenow-mcp)** - ⭐ 208
   MCP Server for ServiceNow

1115. **[ht-mcp](https://github.com/memextech/ht-mcp)** - ⭐ 207
   Pure Rust implementation of MCP server for headless terminal 

1116. **[MimikaStudio](https://github.com/BoltzmannEntropy/MimikaStudio)** - ⭐ 207
   MimikaStudio - A local-first application for macOS (Apple Silicon)

1117. **[mcp-context-protector](https://github.com/trailofbits/mcp-context-protector)** - ⭐ 206
   MCP security wrapper

1118. **[Remote-MCP](https://github.com/ssut/Remote-MCP)** - ⭐ 206
   A type-safe solution to remote MCP communication, enabling effortless integration for centralized management of Model Context.

1119. **[melrose](https://github.com/emicklei/melrose)** - ⭐ 206
   interactive programming of melodies, producing MIDI 

1120. **[mcp-rb](https://github.com/funwarioisii/mcp-rb)** - ⭐ 205
   A lightweight Ruby framework for building MCP servers with a Sinatra-like DSL

1121. **[OSWorld-MCP](https://github.com/X-PLUG/OSWorld-MCP)** - ⭐ 205

1122. **[notion_mcp](https://github.com/danhilse/notion_mcp)** - ⭐ 205
   A simple MCP integration that allows Claude to read and manage a personal Notion todo list

1123. **[AutomatedEmulation](https://github.com/iknowjason/AutomatedEmulation)** - ⭐ 205
...
1124. **[phone-mcp](https://github.com/hao-cyber/phone-mcp)** - ⭐ 205
   A phone control plugin for MCP that allows you to control your Android phone through ADB commands to connect any human

1125. **[BifrostMCP](https://github.com/biegehydra/BifrostMCP)** - ⭐ 205
   VSCode Extension with an MCP server that exposes semantic tools like Find Usages and Rename to LLMs

1126. **[langchain-mcp](https://github.com/rectalogic/langchain-mcp)** - ⭐ 205
   Model Context Protocol tool support for LangChain

1127. **[unsplash-mcp-server](https://github.com/hellokaton/unsplash-mcp-server)** - ⭐ 205
   🔎 A MCP server for Unsplash image search.

1128. **[mcp-servers-nix](https://github.com/natsukium/mcp-servers-nix)** - ⭐ 205
   A Nix-based configuration framework for Model Control Protocol (MCP) servers with ready-to-use packages.

1129. **[penpot-mcp](https://github.com/penpot/penpot-mcp)** - ⭐ 205
   Penpot's official MCP Server

1130. **[sqrl](https://github.com/DataSQRL/sqrl)** - ⭐ 204
   Data Pipeline Automation Framework to build MCP servers, data APIs, and data lakes with SQL.

1131. **[dynatrace-mcp](https://github.com/dynatrace-oss/dynatrace-mcp)** - ⭐ 204
   MCP server for Dynatrace Observability

1132. **[sora-mcp](https://github.com/Doriandarko/sora-mcp)** - ⭐ 204
   An MCP server to use Sora video generation APIs

1133. **[claude-self-reflect](https://github.com/ramakay/claude-self-reflect)** - ⭐ 204
   Claude forgets everything. This fixes that. 🔗 www.npmjs.com/package/claude-self-reflect

1134. **[touchdesigner-mcp](https://github.com/8beeeaaat/touchdesigner-mcp)** - ⭐ 203
   MCP server for TouchDesigner

1135. **[appium-mcp](https://github.com/appium/appium-mcp)** - ⭐ 203
   Appium MCP on Steroids!

1136. **[y-cli](https://github.com/luohy15/y-cli)** - ⭐ 202
   A Tiny Terminal Chat App for AI Models with MCP Client Support

1137. **[ai-infrastructure-agent](https://github.com/VersusControl/ai-infrastructure-agent)** - ⭐ 202
...
1138. **[pctx](https://github.com/portofcontext/pctx)** - ⭐ 202
...
1139. **[mcp-servers](https://github.com/cursor/mcp-servers)** - ⭐ 202
   A list of MCP (Model Context Protocol) servers for developer tools and services

1140. **[comfyui-mcp-server](https://github.com/joenorton/comfyui-mcp-server)** - ⭐ 202
   lightweight Python-based MCP (Model Context Protocol) server for local ComfyUI

1141. **[figma-flutter-mcp](https://github.com/mhmzdev/figma-flutter-mcp)** - ⭐ 202
   An MCP server that provides the coding agents Figma's design token to write Flutter code.

1142. **[nosia](https://github.com/dilolabs/nosia)** - ⭐ 201
   Self-hosted AI RAG + MCP Platform

1143. **[airbroke](https://github.com/icoretech/airbroke)** - ⭐ 201
   🔥 Lightweight, Airbrake/Sentry-compatible, PostgreSQL-based Open Source Error Catcher

1144. **[metorial-platform](https://github.com/metorial/metorial-platform)** - ⭐ 201
   The engine powering hundreds of thousands of MCP connections 🤖 🔥

1145. **[pbi-desktop-mcp-public](https://github.com/maxanatsko/pbi-desktop-mcp-public)** - ⭐ 201
...
1146. **[mcp](https://github.com/hopx-ai/mcp)** - ⭐ 200

1147. **[mcp-launchpad](https://github.com/kenneth-liao/mcp-launchpad)** - ⭐ 200
...
1148. **[k8s-mcp-server](https://github.com/alexei-led/k8s-mcp-server)** - ⭐ 200
   K8s-mcp-server is a Model Context Protocol (MCP) server that enables AI assistants like Claude to securely execute Kubernetes commands. It provides a bridge between language models and essential Kubernetes CLI tools including kubectl, helm, istioctl, and argocd, allowing AI systems to assist with cluster management, troubleshooting, and deployments

1149. **[mcp-server-rag-web-browser](https://github.com/apify/mcp-server-rag-web-browser)** - ⭐ 199
   A MCP Server for the RAG Web Browser Actor

1150. **[mongodb-lens](https://github.com/furey/mongodb-lens)** - ⭐ 199
   🍃🔎 MongoDB Lens: Full Featured MCP Server for MongoDB Databases

1151. **[persistent-ai-memory](https://github.com/savantskie/persistent-ai-memory)** - ⭐ 199
   A persistent local memory for AI, LLMs, or Copilot in VS Code.

1152. **[rmcp](https://github.com/finite-sample/rmcp)** - ⭐ 198
   R MCP Server

1153. **[opik-mcp](https://github.com/comet-ml/opik-mcp)** - ⭐ 198
   Model Context Protocol (MCP) implementation for Opik enabling seamless IDE integration and unified access to prompts, projects, traces, and metrics. 

1154. **[flyto-core](https://github.com/flytohub/flyto-core)** - ⭐ 198
   The open-source execution engine for AI agents. 412 modules, MCP-native, triggers, queue, versioning, metering.

1155. **[wavefront](https://github.com/rootflo/wavefront)** - ⭐ 197
   🔥🔥🔥 Enterprise AI middleware, alternative to unifyapps, n8n, lyzr

1156. **[mcp-proxy-server](https://github.com/adamwattis/mcp-proxy-server)** - ⭐ 197
   An MCP proxy server that aggregates and serves multiple MCP resource servers through a single interface

1157. **[skyll](https://github.com/assafelovic/skyll)** - ⭐ 197
   A tool for AI agents to discover and learn skills autonomously

1158. **[sudocode](https://github.com/sudocode-ai/sudocode)** - ⭐ 197
   Lightweight agent orchestration dev tool that lives in your repo

1159. **[ProxmoxMCP](https://github.com/canvrno/ProxmoxMCP)** - ⭐ 196
   MCP for Proxmox integration in Cline

1160. **[waldzell-mcp](https://github.com/waldzellai/waldzell-mcp)** - ⭐ 196
   Waldzell AI's monorepo of MCP servers. Use in Claude Desktop, Cline, Roo Code, and more!

1161. **[mcp_forge](https://github.com/mlzoo/mcp_forge)** - ⭐ 196
   这是一个专为开发企业级MCP server而设计的通用开发框架

1162. **[cognition-wheel](https://github.com/Hormold/cognition-wheel)** - ⭐ 196
   A Model Context Protocol (MCP) server that implements a "wisdom of crowds" approach to AI reasoning by consulting multiple state-of-the-art language models in parallel and synthesizing their responses.

1163. **[hf-mcp-server](https://github.com/huggingface/hf-mcp-server)** - ⭐ 196
   Hugging Face MCP Server

1164. **[mcp-portal-transparencia](https://github.com/dutradotdev/mcp-portal-transparencia)** - ⭐ 195
   MCP para orquestração automatizada de chamadas à API do Portal da Transparência do Governo Federal brasileiro

1165. **[EdgeBox](https://github.com/BIGPPWONG/EdgeBox)** - ⭐ 195
...
1166. **[nano-agent](https://github.com/disler/nano-agent)** - ⭐ 195
   A MCP Server for a small scale engineering agents with multi-provider LLM support.

1167. **[mcp-logseq](https://github.com/ergut/mcp-logseq)** - ⭐ 195
   MCP server to interact with LogSeq via its Local HTTP API - enabling AI assistants like Claude to seamlessly read, write, and manage your LogSeq graph.

1168. **[gcp-mcp](https://github.com/eniayomi/gcp-mcp)** - ⭐ 193
   A Model Context Protocol (MCP) server that enables AI assistants like Claude to interact with your Google Cloud Platform environment. This allows for natural language querying and management of your GCP resources during conversations.

1169. **[burp-mcp-agents](https://github.com/six2dez/burp-mcp-agents)** - ⭐ 193
   Practical setup guides and helpers to connect Burp Suite MCP Server to multiple AI backends (Codex, Gemini, Ollama, ...).

1170. **[mcp-guardian](https://github.com/eqtylab/mcp-guardian)** - ⭐ 192
   Manage / Proxy / Secure your MCP Servers

1171. **[easy-mcp](https://github.com/zcaceres/easy-mcp)** - ⭐ 192
   Absurdly easy Model Context Protocol Servers in Typescript

1172. **[MCP-server-client-computer-use-ai-sdk](https://github.com/mediar-ai/MCP-server-client-computer-use-ai-sdk)** - ⭐ 192

1173. **[RelaMind](https://github.com/El-12stu/RelaMind)** - ⭐ 192
   基于 AI 的个人成长轨迹分析系统，通过记录生活、回顾历史、分析模式帮助用户更好地理解自己，实现持续成长。包含智能路由、RAG 检索、自主任务智能体等功能。

1174. **[AutoDocs](https://github.com/TrySita/AutoDocs)** - ⭐ 192
...
1175. **[utcp-mcp](https://github.com/universal-tool-calling-protocol/utcp-mcp)** - ⭐ 192
   All-in-one MCP server that can connect your AI agents to any native endpoint, powered by UTCP

1176. **[claude-context-local](https://github.com/FarhanAliRaza/claude-context-local)** - ⭐ 192
...
1180. **[mcp-linkedin](https://github.com/adhikasp/mcp-linkedin)** - ⭐ 190
   A Model Context Protocol (MCP) server that provides tools to interact with LinkedIn's Feeds and Job API.

1181. **[xero-mcp-server](https://github.com/XeroAPI/xero-mcp-server)** - ⭐ 190
   An MCP server that integrates with the MCP protocol. https://modelcontextprotocol.io/introduction

1182. **[armor-crypto-mcp](https://github.com/armorwallet/armor-crypto-mcp)** - ⭐ 190
   The MCP server for interacting with Blockchain, Swaps, Strategic Planning and more.

1183. **[Geargrafx](https://github.com/drhelius/Geargrafx)** - ⭐ 189
...
1184. **[supabase-mcp](https://github.com/coleam00/supabase-mcp)** - ⭐ 189
   Supabase MCP server created in Python.

1185. **[wikipedia-mcp](https://github.com/Rudra-ravi/wikipedia-mcp)** - ⭐ 189
   A Model Context Protocol (MCP) server that retrieves information from Wikipedia to provide context to LLMs.

1186. **[auto-mcp](https://github.com/brizzai/auto-mcp)** - ⭐ 189
   Transform any OpenAPI/Swagger definition into a fully-featured Model Context Protocol (MCP) server

1187. **[ai-counsel](https://github.com/blueman82/ai-counsel)** - ⭐ 189
   True deliberative consensus MCP server where AI models debate and refine positions across multiple rounds

1188. **[smart-coding-mcp](https://github.com/omar-haris/smart-coding-mcp)** - ⭐ 188
...
1189. **[claudepro-directory](https://github.com/JSONbored/claudepro-directory)** - ⭐ 188
...
1190. **[discord-mcp](https://github.com/SaseQ/discord-mcp)** - ⭐ 188
   A MCP server for the Discord integration. Enable your AI assistants to seamlessly interact with Discord. Enhance your Discord experience with powerful automation capabilities.

1191. **[PerformanceMonitor](https://github.com/erikdarlingdata/PerformanceMonitor)** - ⭐ 188
...
1192. **[code-sandbox-mcp](https://github.com/philschmid/code-sandbox-mcp)** - ⭐ 187

1193. **[mcp-usecase](https://github.com/teddynote-lab/mcp-usecase)** - ⭐ 187

1194. **[mcp-injection-experiments](https://github.com/invariantlabs-ai/mcp-injection-experiments)** - ⭐ 187
   Code snippets to reproduce MCP tool poisoning attacks.

1195. **[gistpad-mcp](https://github.com/lostintangent/gistpad-mcp)** - ⭐ 187
   📓 An MCP server for managing your personal knowledge, daily notes, and re-usable prompts via GitHub Gists

1196. **[protoc-gen-go-mcp](https://github.com/redpanda-data/protoc-gen-go-mcp)** - ⭐ 187
   Go protobuf compiler extension to turn any gRPC service into an MCP server

1197. **[tableau-mcp](https://github.com/tableau/tableau-mcp)** - ⭐ 187
...
1198. **[mcp-proxy-server](https://github.com/ptbsare/mcp-proxy-server)** - ⭐ 187
   This server acts as a central hub for Model Context Protocol (MCP) resource servers.

1199. **[polymarket-mcp-server](https://github.com/caiovicentino/polymarket-mcp-server)** - ⭐ 187
   🤖 AI-Powered MCP Server for Polymarket - Enable Claude to trade prediction markets with 45 tools, real-time monitoring, and enterprise-grade safety features

1200. **[cocoindex-code](https://github.com/cocoindex-io/cocoindex-code)** - ⭐ 187
...
1201. **[Omni-Adapter](https://github.com/HuChundong/Omni-Adapter)** - ⭐ 186
   多平台 文生图/图生图 等能力接入MCP

1202. **[bluebox](https://github.com/VectorlyApp/bluebox)** - ⭐ 186
   Index the world's undocumented APIs

1203. **[mcp-google-map](https://github.com/cablate/mcp-google-map)** - ⭐ 186
   A powerful Model Context Protocol (MCP) server providing comprehensive Google Maps API integration with LLM processing capabilities.

1204. **[MCP-Checklists](https://github.com/MCP-Manager/MCP-Checklists)** - ⭐ 186

1205. **[ssh-mcp-server](https://github.com/classfang/ssh-mcp-server)** - ⭐ 186
   基于 SSH 的 MCP 服务器 🧙‍♀️。已被MCP官方收录 🎉。 SSH MCP Server 🧙‍♀️. It has been included in the community MCP repository 🎉.

1206. **[mcp-fusion](https://github.com/vinkius-labs/mcp-fusion)** - ⭐ 186
...
1207. **[litemcp](https://github.com/wong2/litemcp)** - ⭐ 185
   A TypeScript framework for building MCP servers elegantly

1208. **[git-mcp-server](https://github.com/cyanheads/git-mcp-server)** - ⭐ 185
   An MCP (Model Context Protocol) server enabling LLMs and AI agents to interact with Git repositories. Provides tools for comprehensive Git operations including clone, commit, branch, diff, log, status, push, pull, merge, rebase, worktree, tag management, and more, via the MCP standard. STDIO & HTTP.

1209. **[coolify-mcp](https://github.com/StuMason/coolify-mcp)** - ⭐ 185
   MCP server for Coolify — 38 optimized tools for managing self-hosted PaaS through AI assistants

1210. **[a2a_mcp-example](https://github.com/ishanExtreme/a2a_mcp-example)** - ⭐ 184
   An example showing how A2A and MCP can be used together

1211. **[quarkus-mcp-servers](https://github.com/quarkiverse/quarkus-mcp-servers)** - ⭐ 184
   Model Context Protocol Servers in Quarkus

1212. **[ida-mcp-server-plugin](https://github.com/taida957789/ida-mcp-server-plugin)** - ⭐ 184
   IDA Pro Plugin for serving MCP SSE server for cursor / claude

1213. **[agentregistry](https://github.com/agentregistry-dev/agentregistry)** - ⭐ 184
   Fast-track AI innovation with a centralized, trusted, curated registry

1214. **[dify-plugin-tools-mcp_sse](https://github.com/junjiem/dify-plugin-tools-mcp_sse)** - ⭐ 183
   Dify 1.0 Plugin MCP HTTP with SSE or Streamable HTTP transport Tools

1215. **[siconos](https://github.com/siconos/siconos)** - ⭐ 182
   Simulation framework for nonsmooth dynamical systems

1216. **[thinkchain](https://github.com/martinbowling/thinkchain)** - ⭐ 182
...
1217. **[mcp-openai-gemini-llama-example](https://github.com/philschmid/mcp-openai-gemini-llama-example)** - ⭐ 182

1218. **[facebook-ads-library-mcp](https://github.com/talknerdytome-labs/facebook-ads-library-mcp)** - ⭐ 182
   MCP Server for Facebook ADs Library - Get instant answers from FB's ad library

1219. **[mcp](https://github.com/neo4j/mcp)** - ⭐ 182
   Neo4j official MCP Server

1220. **[matlab-mcp-core-server](https://github.com/matlab/matlab-mcp-core-server)** - ⭐ 182
   Run MATLAB® using AI applications with the official MATLAB MCP Server from MathWorks®. This MCP server for MATLAB supports a wide range of coding agents like Claude Code® and Visual Studio® Code.

1221. **[google-analytics-mcp](https://github.com/surendranb/google-analytics-mcp)** - ⭐ 182
...
1222. **[4D-ARE](https://github.com/ybeven/4D-ARE)** - ⭐ 181
...
1223. **[mcp-server-siri-shortcuts](https://github.com/dvcrn/mcp-server-siri-shortcuts)** - ⭐ 181
   MCP for calling Siri Shorcuts from LLMs

1224. **[drawio2go](https://github.com/Menghuan1918/drawio2go)** - ⭐ 180
   A modern DrawIO editor application.  AI-Powered, Human-AI Collaboration | AI 加持，人机共绘drawio

1225. **[mcp-snowflake-server](https://github.com/isaacwasserman/mcp-snowflake-server)** - ⭐ 179

1226. **[quarkus-mcp-server](https://github.com/quarkiverse/quarkus-mcp-server)** - ⭐ 179
   This extension enables developers to implement the MCP server features easily.

1227. **[mcp-text-editor](https://github.com/tumf/mcp-text-editor)** - ⭐ 178

1228. **[claude-code-mcp](https://github.com/auchenberg/claude-code-mcp)** - ⭐ 178
   claude-code-mcp

1229. **[bilibili-mcp-server](https://github.com/huccihuang/bilibili-mcp-server)** - ⭐ 178
   MCP Server for the Bilibili API, supporting various operations.

1230. **[mcp-server-wazuh](https://github.com/gbrigandi/mcp-server-wazuh)** - ⭐ 178
   MCP Server for Wazuh SIEM

1231. **[sketchup-mcp](https://github.com/mhyrr/sketchup-mcp)** - ⭐ 178
   Sketchup Model Context Protocol

1232. **[aws-mcp-server](https://github.com/alexei-led/aws-mcp-server)** - ⭐ 178
   A lightweight service that enables AI assistants to execute AWS CLI commands (in safe containerized environment) through the Model Context Protocol (MCP). Bridges Claude, Cursor, and other MCP-aware AI tools with AWS CLI for enhanced cloud infrastructure management.

1233. **[tripo-mcp](https://github.com/VAST-AI-Research/tripo-mcp)** - ⭐ 177
   Official MCP server for Tripo

1234. **[spring-ai-playground](https://github.com/JM-Lab/spring-ai-playground)** - ⭐ 177
...
1235. **[linux-mcp-server](https://github.com/rhel-lightspeed/linux-mcp-server)** - ⭐ 177
   Tools to allow LLM clients to interact with Linux systems remotely

1236. **[postman-mcp-server](https://github.com/postmanlabs/postman-mcp-server)** - ⭐ 177
   Connect your AI to your APIs on Postman

1237. **[anki-mcp-server](https://github.com/scorzeth/anki-mcp-server)** - ⭐ 176
   An MCP server for Anki

1238. **[mcp](https://github.com/magicuidesign/mcp)** - ⭐ 176
   Official Magic UI MCP server.

1239. **[discordmcp](https://github.com/v-3/discordmcp)** - ⭐ 176
   Discord MCP Server for Claude Integration

1240. **[markmap-mcp-server](https://github.com/jinzcdev/markmap-mcp-server)** - ⭐ 176
   An MCP server for converting Markdown to interactive mind maps with export support (PNG/JPG/SVG).

1241. **[aws-finops-mcp-server](https://github.com/ravikiranvm/aws-finops-mcp-server)** - ⭐ 175
   An MCP (Model Context Protocol) server that brings powerful AWS FinOps capabilities directly into your AI assistant. Analyze cloud costs, audit for waste, and get budget insights using natural language, all while keeping your credentials secure on your local machine.

1242. **[mcp-chat](https://github.com/PipedreamHQ/mcp-chat)** - ⭐ 175
   Examples of using Pipedream's MCP server in your app or AI agent.

1243. **[tomcp](https://github.com/Ami3466/tomcp)** - ⭐ 175
   Turn any website or doc into an MCP server

1244. **[Context-Engineering-for-Multi-Agent-Systems](https://github.com/Denis2054/Context-Engineering-for-Multi-Agent-Systems)** - ⭐ 175
...
1245. **[mongo-mcp](https://github.com/QuantGeekDev/mongo-mcp)** - ⭐ 174
   A mongo db server for the model context protocol (MCP)

1246. **[Revornix](https://github.com/Qingyon-AI/Revornix)** - ⭐ 174
...
1247. **[forgetful](https://github.com/ScottRBK/forgetful)** - ⭐ 174
   Opensource Memory for Agents

1248. **[mcp-server-duckdb](https://github.com/ktanaka101/mcp-server-duckdb)** - ⭐ 173
   A Model Context Protocol (MCP) server implementation for DuckDB, providing database interaction capabilities

1249. **[mcp-email-server](https://github.com/ai-zerolab/mcp-email-server)** - ⭐ 173
   IMAP and SMTP via MCP Server

1250. **[integrate-mcp-with-copilot](https://github.com/skills/integrate-mcp-with-copilot)** - ⭐ 173
   Learn how to use MCP Servers with GitHub Copilot

1251. **[DrissionPageMCP](https://github.com/wxhzhwxhzh/DrissionPageMCP)** - ⭐ 173
   基于DrissionPage和FastMCP的浏览器自动化MCP服务器，提供丰富的浏览器操作API供AI调用

1252. **[openapi-mcp](https://github.com/ckanthony/openapi-mcp)** - ⭐ 172
   Dockerized MCP Server to allow your AI agent to access any API with existing api docs

1253. **[install-mcp](https://github.com/supermemoryai/install-mcp)** - ⭐ 172
   A simple CLI to install MCP servers into any client - auth included!

1254. **[Text2Sql.Net](https://github.com/shuyu-labs/Text2Sql.Net)** - ⭐ 172
   Text2Sql.Net 是一个使用DotNet和Semantic Kernel开发的Text2Sql工具

1255. **[command](https://github.com/scopecraft/command)** - ⭐ 172
   Scopecraft Command - A CLI and MCP server for Markdown-Driven Task Management (MDTM)

1256. **[unifi-network-mcp](https://github.com/sirkirby/unifi-network-mcp)** - ⭐ 172
   MCP server implementation for the UniFi network application

1257. **[skunit](https://github.com/mehrandvd/skunit)** - ⭐ 171
   skUnit is a testing tool for AI units, such as IChatClient, MCP Servers and agents.

1258. **[mcp-scholarly](https://github.com/adityak74/mcp-scholarly)** - ⭐ 171
   A MCP server to search for accurate academic articles.

1259. **[meilisearch-mcp](https://github.com/meilisearch/meilisearch-mcp)** - ⭐ 171
   A Model Context Protocol (MCP) server for interacting with Meilisearch through LLM interfaces.

1260. **[medusa](https://github.com/Pantheon-Security/medusa)** - ⭐ 171
...
1261. **[Text2Sql.Net](https://github.com/AIDotNet/Text2Sql.Net)** - ⭐ 170
   Text2Sql.Net 是一个使用DotNet和Semantic Kernel开发的Text2Sql工具

1262. **[docs](https://github.com/strands-agents/docs)** - ⭐ 170
   Documentation for the Strands Agents SDK. A model-driven approach to building AI agents in just a few lines of code. 

1263. **[photoshop-python-api-mcp-server](https://github.com/loonghao/photoshop-python-api-mcp-server)** - ⭐ 170
   A Model Context Protocol (MCP) server that interfaces with Adobe Photoshop's Python API. Enables LLMs to execute image editing operations, automate workflows, and manage Photoshop tasks through structured commands and context-aware interactions.

1264. **[y-gui](https://github.com/luohy15/y-gui)** - ⭐ 169
   A Tiny Web Chat App for AI Models with MCP Client Support

1265. **[keyboard-local](https://github.com/keyboard-dev/keyboard-local)** - ⭐ 169
   One MCP Server, All Your Apps, Privacy First

1266. **[mcp-use-ts](https://github.com/mcp-use/mcp-use-ts)** - ⭐ 169
   mcp-use is the framework for MCP with the best DX - Build AI agents, create MCP   servers with UI widgets, and debug with built-in inspector. Includes client SDK, server SDK, React hooks, and powerful dev tools.

1267. **[mcp-agent-langchainjs](https://github.com/Azure-Samples/mcp-agent-langchainjs)** - ⭐ 169
...
1268. **[lucid-agents](https://github.com/daydreamsai/lucid-agents)** - ⭐ 169
...
1269. **[Chanakya-Local-Friend](https://github.com/Rishabh-Bajpai/Chanakya-Local-Friend)** - ⭐ 169
...
1270. **[opentelemetry-mcp-server](https://github.com/traceloop/opentelemetry-mcp-server)** - ⭐ 169
   Unified MCP server for querying OpenTelemetry traces across multiple backends (Jaeger, Tempo, Traceloop, etc.), enabling AI agents to analyze distributed traces for automated debugging and observability.

1271. **[mcp-shell-server](https://github.com/tumf/mcp-shell-server)** - ⭐ 168

1272. **[mcp-access-point](https://github.com/sxhxliang/mcp-access-point)** - ⭐ 168
   Turn a web server into an MCP server in one click without making any code changes.

1273. **[aleph](https://github.com/Hmbown/aleph)** - ⭐ 168
   Skill + MCP server to turn your agent into an RLM. Load context, iterate with search/code/think tools, converge on answers.

1274. **[kindly-web-search-mcp-server](https://github.com/Shelpuk-AI-Technology-Consulting/kindly-web-search-mcp-server)** - ⭐ 168
...
1275. **[mcp-telegram](https://github.com/sparfenyuk/mcp-telegram)** - ⭐ 167
   MCP server to work with Telegram through MTProto

1276. **[lsp-mcp](https://github.com/jonrad/lsp-mcp)** - ⭐ 167
   An Model Context Protocol (MCP) server that provides LLMs/AI Agents with the capabilities of a language server protocol (LSP) server. This gives the AI the ability to get language aware context from the codebase.

1277. **[mcp-server-gsc](https://github.com/ahonn/mcp-server-gsc)** - ⭐ 167
   A Model Context Protocol (MCP) server providing access to Google Search Console

1278. **[toolbase](https://github.com/Toolbase-AI/toolbase)** - ⭐ 166
   A desktop application that adds powerful tools to Claude and AI platforms

1279. **[flights-mcp](https://github.com/ravinahp/flights-mcp)** - ⭐ 166
   An MCP server to search for flights.

1280. **[superset-mcp](https://github.com/aptro/superset-mcp)** - ⭐ 166
   connect to 50+ data stores via superset mcp server. Can use with open ai agent sdk, Claude app, cursor, windsurf

1281. **[c4-genai-suite](https://github.com/codecentric/c4-genai-suite)** - ⭐ 165
   c4 GenAI Suite

1282. **[pg-mcp-server](https://github.com/ericzakariasson/pg-mcp-server)** - ⭐ 165
   MCP Server for Postgres

1283. **[tmcp](https://github.com/paoloricciuti/tmcp)** - ⭐ 165
   Typescript SDK to build MCP servers in an agnostic way

1284. **[mcp-server-odoo](https://github.com/ivnvxd/mcp-server-odoo)** - ⭐ 165
   A Model Context Protocol (MCP) server that enables AI assistants to securely interact with Odoo ERP systems through standardized resources and tools for data retrieval and manipulation.

1285. **[obsidian-claude-code-mcp](https://github.com/iansinnott/obsidian-claude-code-mcp)** - ⭐ 164
   Connect Claude Code and other AI tools to your Obsidian notes using Model Context Protocol (MCP)

1286. **[gbox](https://github.com/babelcloud/gbox)** - ⭐ 164
   Cli and MCP for gbox. Enable AI agents to operate Android/Browser/Desktop like human.

1287. **[open-streetmap-mcp](https://github.com/jagan-shanmugam/open-streetmap-mcp)** - ⭐ 164
   An OpenStreetMap MCP server implementation that enhances LLM capabilities with location-based services and geospatial data.

1288. **[toolsdk-mcp-registry](https://github.com/toolsdk-ai/toolsdk-mcp-registry)** - ⭐ 164
...
1289. **[uLoopMCP](https://github.com/hatayama/uLoopMCP)** - ⭐ 164
   Your Unity project's AI autopilot. Compile, test, debug, repeat—until it just works.

1290. **[MaxMSP-MCP-Server](https://github.com/tiianhk/MaxMSP-MCP-Server)** - ⭐ 164
   MCP (Model Context Protocol) Server for Max (Max/MSP/Jitter)

1291. **[marionette_mcp](https://github.com/leancodepl/marionette_mcp)** - ⭐ 164
...
1292. **[dify-mcp-client](https://github.com/3dify-project/dify-mcp-client)** - ⭐ 163
   MCP Client as an Agent Strategy Plugin. Support GUI operation via UI-TARS-SDK.

1293. **[gate22](https://github.com/aipotheosis-labs/gate22)** - ⭐ 163
...
1294. **[cli-mcp-server](https://github.com/MladenSU/cli-mcp-server)** - ⭐ 163
   Command line interface for MCP clients with secure execution and customizable security policies

1295. **[UnityNaturalMCP](https://github.com/notargs/UnityNaturalMCP)** - ⭐ 163
   UnityNaturalMCP is an MCP server implementation for Unity that aims for a "natural" user experience.

1296. **[Companion](https://github.com/mattt/Companion)** - ⭐ 163
   Your neighborhood friendly MCP utility for macOS, iOS, and visionOS

1297. **[dbt-llm-agent](https://github.com/pragunbhutani/dbt-llm-agent)** - ⭐ 163
   LLM based AI Agent to automate Data Analysis for dbt projects with remote MCP server

1298. **[metatrader-mcp-server](https://github.com/ariadng/metatrader-mcp-server)** - ⭐ 163
   Model Context Protocol (MCP) to enable AI LLMs to trade using MetaTrader platform

1299. **[jmap-mcp](https://github.com/wyattjoh/jmap-mcp)** - ⭐ 163
   A Model Context Protocol (MCP) server that provides tools for interacting with JMAP (JSON Meta Application Protocol) email servers. Built with Deno and using the jmap-jam client library.

1300. **[AutoRedTeam-Orchestrator](https://github.com/Coff0xc/AutoRedTeam-Orchestrator)** - ⭐ 163
...
1301. **[SharpToolsMCP](https://github.com/kooshi/SharpToolsMCP)** - ⭐ 162
   A suite of MCP tools for AIs to analyze and modify C# solutions with high signal, Roslyn powered context.

1302. **[task-orchestrator](https://github.com/jpicklyk/task-orchestrator)** - ⭐ 162
...
1303. **[plane-mcp-server](https://github.com/makeplane/plane-mcp-server)** - ⭐ 161
   Plane's Official Model Context Protocol Server 🔌 ⌨️ 🔥

1304. **[slack-mcp-client](https://github.com/tuannvm/slack-mcp-client)** - ⭐ 161
...
1305. **[MCP-Salesforce](https://github.com/smn2gnt/MCP-Salesforce)** - ⭐ 161
   MCP Salesforce connector

1306. **[PolyMCP](https://github.com/poly-mcp/PolyMCP)** - ⭐ 160
   Polymcp provides a simple and efficient way to interact with MCP servers using custom agents

1307. **[mcp-server-weaviate](https://github.com/weaviate/mcp-server-weaviate)** - ⭐ 160
   MCP (Model Context Protocol) server for Weaviate

1308. **[zabbix-mcp-server](https://github.com/mpeirone/zabbix-mcp-server)** - ⭐ 160
...
1313. **[autocad-mcp](https://github.com/puran-water/autocad-mcp)** - ⭐ 159
...
1314. **[Quickchart-MCP-Server](https://github.com/GongRzhe/Quickchart-MCP-Server)** - ⭐ 158
...
1315. **[remote-mcp-server](https://github.com/gleanwork/remote-mcp-server)** - ⭐ 158
   Remote MCP Server that securely connects Enterprise context with your LLM, IDE, or agent platform of choice.

1316. **[compliant-llm](https://github.com/fiddlecube/compliant-llm)** - ⭐ 158
   Build Secure and Compliant AI agents and MCP Servers. YC W23

1317. **[mcp-simple-pubmed](https://github.com/andybrandt/mcp-simple-pubmed)** - ⭐ 158
   MCP server for searching and querying PubMed medical papers/research database

1318. **[strudel-mcp-server](https://github.com/williamzujkowski/strudel-mcp-server)** - ⭐ 158
   A Model Context Protocol (MCP) server that gives Claude direct control over Strudel.cc for AI-assisted music generation and live coding.

1319. **[spotinfo](https://github.com/alexei-led/spotinfo)** - ⭐ 158
   CLI for exploring AWS EC2 Spot inventory. Inspect AWS Spot instance types, saving, price, and interruption frequency.

1320. **[fetch-mcp](https://github.com/egoist/fetch-mcp)** - ⭐ 157
   An MCP server for fetching URLs / Youtube video transcript.

1321. **[mcp-client-slackbot](https://github.com/sooperset/mcp-client-slackbot)** - ⭐ 157
   Simple Slackbot MCP Client

1322. **[awesome-a2a](https://github.com/pab1it0/awesome-a2a)** - ⭐ 157
   Agent2Agent (A2A) – awesome A2A agents, tools, servers & clients, all in one place. 

1323. **[mcp-shark](https://github.com/mcp-shark/mcp-shark)** - ⭐ 157
...
1324. **[awesome-claude-dxt](https://github.com/milisp/awesome-claude-dxt)** - ⭐ 157
   Awesome Claude Desktop Extensions (dxt) (not only Claude) mcpb

1325. **[agentor](https://github.com/CelestoAI/agentor)** - ⭐ 157
...
1326. **[intervals-mcp-server](https://github.com/mvilanova/intervals-mcp-server)** - ⭐ 157
   Model Context Protocol (MCP) server for connecting Claude and ChatGPT with the Intervals.icu API.

1327. **[mcp-server-langfuse](https://github.com/langfuse/mcp-server-langfuse)** - ⭐ 156
   Model Context Protocol (MCP) Server for Langfuse Prompt Management. This server allows you to access and manage your Langfuse prompts through the Model Context Protocol.

1328. **[mcp-3D-printer-server](https://github.com/DMontgomery40/mcp-3D-printer-server)** - ⭐ 156
   Connects MCP to major 3D printer APIs (Orca, Bambu, OctoPrint, Klipper, Duet, Repetier, Prusa, Creality). Control prints, monitor status, and perform advanced STL operations like scaling, rotation, sectional editing, and base extension. Includes slicing and visualization.

1329. **[mcptools](https://github.com/posit-dev/mcptools)** - ⭐ 156
   Model Context Protocol For R

1330. **[scrapeless-mcp-server](https://github.com/scrapeless-ai/scrapeless-mcp-server)** - ⭐ 156
   Scrapeless Mcp Server

1331. **[rust-mcp-sdk](https://github.com/rust-mcp-stack/rust-mcp-sdk)** - ⭐ 156
   A high-performance, asynchronous toolkit for building MCP servers and clients in Rust.

1332. **[dedalus-mcp-python](https://github.com/dedalus-labs/dedalus-mcp-python)** - ⭐ 155
   A simple and performant Model Context Protocol framework for Python.

1333. **[alibabacloud-tablestore-mcp-server](https://github.com/aliyun/alibabacloud-tablestore-mcp-server)** - ⭐ 155

1334. **[XPack-MCP-Marketplace](https://github.com/xpack-ai/XPack-MCP-Marketplace)** - ⭐ 155
...
1335. **[mcp-summarizer](https://github.com/0xshellming/mcp-summarizer)** - ⭐ 155
   MCP Server for AI Summarization

1336. **[mcp-dotnet-samples](https://github.com/microsoft/mcp-dotnet-samples)** - ⭐ 155
   A comprehensive set of samples of creating and using MCP servers and clients with .NET

1337. **[Frappe_Assistant_Core](https://github.com/buildswithpaul/Frappe_Assistant_Core)** - ⭐ 155
   Infrastructure that connects LLMs to ERPNext. Frappe Assistant Core works with the Model Context Protocol (MCP) to expose ERPNext functionality to any compatible Language Model

1338. **[python-mcp-server-client](https://github.com/GobinFan/python-mcp-server-client)** - ⭐ 154
   支持查询主流agent框架技术文档的MCP server（支持stdio和sse两种传输协议）, 支持 langchain、llama-index、autogen、agno、openai-agents-sdk、mcp-doc、camel-ai 和 crew-ai

1339. **[code-assistant](https://github.com/stippi/code-assistant)** - ⭐ 154
   An LLM-powered, autonomous coding assistant. Also offers an MCP and ACP mode.

1340. **[osint-tools-mcp-server](https://github.com/frishtik/osint-tools-mcp-server)** - ⭐ 154
   MCP server exposing multiple OSINT tools for AI assistants like Claude

1341. **[mcp-solver](https://github.com/szeider/mcp-solver)** - ⭐ 154
   Model Context Protocol (MCP) server for constraint optimization and solving"

1342. **[web3-research-mcp](https://github.com/aaronjmars/web3-research-mcp)** - ⭐ 153
   Deep Research for crypto - free & fully local

1343. **[radare2-mcp](https://github.com/radareorg/radare2-mcp)** - ⭐ 153
   MCP stdio server for radare2

1344. **[AgentCrew](https://github.com/saigontechnology/AgentCrew)** - ⭐ 153
   Chat application with multi-agents system supports multi-models and MCP

1345. **[google-slides-mcp](https://github.com/matteoantoci/google-slides-mcp)** - ⭐ 153
   MCP Server for Google Slides

1346. **[mcp-server-example](https://github.com/alejandro-ao/mcp-server-example)** - ⭐ 152
   A simple MCP server to search for documentation (tutorial)

1347. **[eShopLite](https://github.com/Azure-Samples/eShopLite)** - ⭐ 152
   eShopLite is a set of reference .NET applications implementing an eCommerce site with features like Semantic Search, MCP, Reasoning models and more.

1348. **[cursor-notebook-mcp](https://github.com/jbeno/cursor-notebook-mcp)** - ⭐ 152
   Model Context Protocol (MCP) server designed to allow AI agents within Cursor to interact with Jupyter Notebook (.ipynb) files

1349. **[make-mcp-server](https://github.com/integromat/make-mcp-server)** - ⭐ 152
   Make MCP Server

1350. **[In-Memoria](https://github.com/pi22by7/In-Memoria)** - ⭐ 152
   Persistent Intelligence Infrastructure for AI Agents

1351. **[chatgpt-copilot](https://github.com/feiskyer/chatgpt-copilot)** - ⭐ 152
   ChatGPT Copilot Extension for Visual Studio Code

1352. **[sunpeak](https://github.com/Sunpeak-AI/sunpeak)** - ⭐ 151
   Local-first MCP App framework for ChatGPT Apps, Claude, and more.

1353. **[mcp-gateway](https://github.com/lightconetech/mcp-gateway)** - ⭐ 151
   A gateway demo for MCP SSE Server

1354. **[mcp-server-metamcp](https://github.com/metatool-ai/mcp-server-metamcp)** - ⭐ 151
   MCP Server MetaMCP manages all your other MCPs in one MCP.

1355. **[mcp-mysql-server](https://github.com/f4ww4z/mcp-mysql-server)** - ⭐ 151
   A Model Context Protocol server for MySQL database operations

1356. **[refref](https://github.com/refrefhq/refref)** - ⭐ 151
   🌟 Open Source Referral and Affiliate Marketing Platform - Launch your referral program in minutes!

1357. **[instagram_dm_mcp](https://github.com/trypeggy/instagram_dm_mcp)** - ⭐ 151
   Instagram Direct messages MCP

1358. **[mcp-client-go](https://github.com/yincongcyincong/mcp-client-go)** - ⭐ 150
   mcp client for Go (Golang). Integrate multiple  Model Context Protocol (MCP) servers

1359. **[GEmojiSharp](https://github.com/hlaueriksson/GEmojiSharp)** - ⭐ 150
   :octocat: GitHub Emoji for C#, dotnet and beyond

1360. **[Log-Analyzer-with-MCP](https://github.com/awslabs/Log-Analyzer-with-MCP)** - ⭐ 150
   A Model Context Protocol (MCP) server that provides AI assistants access to AWS CloudWatch Logs for analysis, searching, and correlation

1361. **[mcp-server-typescript](https://github.com/dataforseo/mcp-server-typescript)** - ⭐ 150
   DataForSEO API modelcontextprotocol server 

1362. **[open-responses-server](https://github.com/teabranch/open-responses-server)** - ⭐ 150
   Wraps any OpenAI API interface as Responses with MCPs support so it supports Codex. Adding any missing stateful features. Ollama and Vllm compliant.

1363. **[logfire-mcp](https://github.com/pydantic/logfire-mcp)** - ⭐ 150
   The Logfire MCP Server is here! :tada:

1364. **[anki-mcp-server](https://github.com/ankimcp/anki-mcp-server)** - ⭐ 150
   A Model Context Protocol (MCP) server that enables AI assistants to interact with Anki, the spaced repetition flashcard application.

1365. **[mcp-server-starrocks](https://github.com/StarRocks/mcp-server-starrocks)** - ⭐ 149
   StarRocks MCP (Model Context Protocol) Server

1366. **[relay](https://github.com/prism-php/relay)** - ⭐ 149
   An MCP client tool for Prism

1367. **[mcp-server-weread](https://github.com/ChenyqThu/mcp-server-weread)** - ⭐ 149

1368. **[Express-REST-API-and-MCP-Server-Framework](https://github.com/iolufemi/Express-REST-API-and-MCP-Server-Framework)** - ⭐ 149
...
1369. **[solana-mcp](https://github.com/sendaifun/solana-mcp)** - ⭐ 149
   A Model Context Protocol server for interacting with the Solana blockchain, powered by the Solana Agent Kit (https://github.com/sendaifun/solana-agent-kit)

1370. **[memov](https://github.com/memovai/memov)** - ⭐ 149
   Give git-like & traceable memory to any coding agents. By https://memov.ai/ aka Entire CLI for every coding agents by MCP.

1371. **[tinymcp](https://github.com/golioth/tinymcp)** - ⭐ 148
   Let LLMs control embedded devices via the Model Context Protocol.

1372. **[any-chat-completions-mcp](https://github.com/pyroprompts/any-chat-completions-mcp)** - ⭐ 148
   MCP Server for using any LLM as a Tool

1373. **[website-downloader](https://github.com/pskill9/website-downloader)** - ⭐ 148
   MCP server to download entire websites

1374. **[CreatorBox](https://github.com/xiesx123/CreatorBox)** - ⭐ 148
   🚀🎬灵活、高效、可扩展，专属剪辑配音工具箱，释放创作潜力 . Flexible, efficient, and scalable toolbox for editing and dubbing, unleashing creative potential

1375. **[agentql-mcp](https://github.com/tinyfish-io/agentql-mcp)** - ⭐ 148
   Model Context Protocol server that integrates AgentQL's data extraction capabilities.

1376. **[k8s-mcp-server](https://github.com/reza-gholizade/k8s-mcp-server)** - ⭐ 148
   Manage Your Kubernetes Cluster with k8s mcp-server

1377. **[seo-research-mcp](https://github.com/egebese/seo-research-mcp)** - ⭐ 148
...
1378. **[ida-mcp-rs](https://github.com/blacktop/ida-mcp-rs)** - ⭐ 148
   Headless IDA Pro MCP Server

1379. **[MCPHub-Desktop](https://github.com/Jeamee/MCPHub-Desktop)** - ⭐ 147
   Desktop APP for Discover and Install MCP Servers

1380. **[ultimate_mcp_client](https://github.com/Dicklesworthstone/ultimate_mcp_client)** - ⭐ 147
...
1381. **[backlog-mcp-server](https://github.com/nulab/backlog-mcp-server)** - ⭐ 147

1382. **[hypertool-mcp](https://github.com/toolprint/hypertool-mcp)** - ⭐ 147
   Dynamically expose tools from proxied servers based on an Agent Persona

1383. **[ghost-mcp](https://github.com/MFYDev/ghost-mcp)** - ⭐ 147
   A Model Context Protocol (MCP) server for interacting with Ghost CMS through LLM interfaces like Claude. Allow you to control your Ghost blog by simply asking Claude etc.

1384. **[decipher-research-agent](https://github.com/mtwn105/decipher-research-agent)** - ⭐ 146
   Turn topics, links, and files into AI-generated research notebooks — summarize, explore, and ask anything.

1385. **[figma-mcp-server](https://github.com/TimHolden/figma-mcp-server)** - ⭐ 146
   Model Context Protocol server implementation for Figma API

1386. **[freecad_mcp](https://github.com/bonninr/freecad_mcp)** - ⭐ 146
...
1387. **[mcp-discord](https://github.com/hanweg/mcp-discord)** - ⭐ 146
   MCP server for discord bot

1388. **[kom](https://github.com/weibaohui/kom)** - ⭐ 146
   kom 是一个用于 Kubernetes 操作的工具，SDK级的kubectl、client-go的使用封装。并且支持作为管理k8s 的 MCP server。 它提供了一系列功能来管理 Kubernetes 资源，包括创建、更新、删除和获取资源，甚至使用SQL查询k8s资源。这个项目支持多种 Kubernetes 资源类型的操作，并能够处理自定义资源定义（CRD）。 通过使用 kom，你可以轻松地进行资源的增删改查和日志获取以及操作POD内文件等动作。

1389. **[OmniFocus-MCP](https://github.com/themotionmachine/OmniFocus-MCP)** - ⭐ 146
   Let LLMs interface with your tasks and projects through the Model Context Protocol. Add, organize, and query your OmniFocus database with natural language commands.

1390. **[bocha-search-mcp](https://github.com/BochaAI/bocha-search-mcp)** - ⭐ 146
   Bocha Search MCP Server.

1391. **[Axon.MCP.Server](https://github.com/ali-kamali/Axon.MCP.Server)** - ⭐ 146
...
1392. **[goku](https://github.com/jcaromiq/goku)** - ⭐ 145
   Goku is an HTTP load testing application written in Rust 

1393. **[pubmearch](https://github.com/Darkroaster/pubmearch)** - ⭐ 145
   A PubMed MCP server.

1394. **[bilibili-mcp-js](https://github.com/34892002/bilibili-mcp-js)** - ⭐ 145
   Bilibili video search MCP (Model Context Protocol) service - 哔哩哔哩视频搜索MCP服务

1395. **[Human-In-the-Loop-MCP-Server](https://github.com/GongRzhe/Human-In-the-Loop-MCP-Server)** - ⭐ 145
...
1396. **[xiaoi](https://github.com/xvhuan/xiaoi)** - ⭐ 145
   小爱音箱语音通知工具：提供 CLI/TUI/MCP/Webhook 一键播报与控制音量，支持 PM2 常驻部署，支持docker部署。

1397. **[Gemini-mcp](https://github.com/LKbaba/Gemini-mcp)** - ⭐ 144
   MCP server implementation for Google's Gemini API

1398. **[postman-mcp-server](https://github.com/delano/postman-mcp-server)** - ⭐ 144
   An MCP server that provides access to Postman.

1399. **[uaip](https://github.com/concierge-hq/uaip)** - ⭐ 144
...
1400. **[notion-mcp-server](https://github.com/awkoy/notion-mcp-server)** - ⭐ 144
   **Notion MCP Server** is a Model Context Protocol (MCP) server implementation that enables AI assistants to interact with Notion's API. This production-ready server provides a complete set of tools.

1401. **[OpenDataMCP](https://github.com/OpenDataMCP/OpenDataMCP)** - ⭐ 144
   Connect any Open Data to any LLM with Model Context Protocol.

1402. **[railway-mcp-server](https://github.com/railwayapp/railway-mcp-server)** - ⭐ 144
   Official Railway MCP Server for interacting with your Railway account

1403. **[node-code-sandbox-mcp](https://github.com/alfonsograziano/node-code-sandbox-mcp)** - ⭐ 144
   A Node.js–based Model Context Protocol server that spins up disposable Docker containers to execute arbitrary JavaScript.

1404. **[memorizer](https://github.com/petabridge/memorizer)** - ⭐ 144
   Vector-search powered agent memory MCP server

1405. **[quick-data-mcp](https://github.com/disler/quick-data-mcp)** - ⭐ 144
   Prompt focused MCP Server for .json and .csv agentic data analytics for Claude Code

1406. **[aicode-toolkit](https://github.com/AgiFlow/aicode-toolkit)** - ⭐ 144
   Toolkit for Coding Agents to work reliably with repo of any size.

1407. **[mcp-servers](https://github.com/charIesding/mcp-servers)** - ⭐ 143
   mcp server implementations

1408. **[eion](https://github.com/eiondb/eion)** - ⭐ 143
   Shared Memory Storage for Multi-Agent Systems

1409. **[mcp-interviewer](https://github.com/microsoft/mcp-interviewer)** - ⭐ 143
   Catch MCP server issues before your agents do.

1410. **[frontmcp](https://github.com/agentfront/frontmcp)** - ⭐ 143
   TypeScript-first framework for the Model Context Protocol (MCP). You write clean, typed code; FrontMCP handles the protocol, transport, DI, session/auth, and execution flow.

1411. **[cachebro](https://github.com/glommer/cachebro)** - ⭐ 143
   File cache with diff tracking for AI coding agents. Drop-in MCP server that cuts token usage by 26%.

1412. **[mcp-1panel](https://github.com/1Panel-dev/mcp-1panel)** - ⭐ 142
   mcp-1panel is an implementation of the Model Context Protocol (MCP) server for 1Panel.

1413. **[openagent](https://github.com/Th0rgal/openagent)** - ⭐ 142
   Self-hosted orchestrator for AI autonomous agents. Run Claude Code & Open Code in isolated linux workspaces. Manage your skills, configs and encrypted secrets with a git repo.

1414. **[wa_llm](https://github.com/ilanbenb/wa_llm)** - ⭐ 142
   A WhatsApp bot that can participate in group conversations, powered by AI. The bot monitors group messages and responds when mentioned.

1415. **[mcp-server-calculator](https://github.com/githejie/mcp-server-calculator)** - ⭐ 142
   A Model Context Protocol server for calculating.

1416. **[powerpoint](https://github.com/supercurses/powerpoint)** - ⭐ 142
   A MCP Server for creating Powerpoint Presentations

1417. **[codex-mcp-server](https://github.com/cexll/codex-mcp-server)** - ⭐ 142
   Codex Mcp Server 

1418. **[ReActMCP](https://github.com/mshojaei77/ReActMCP)** - ⭐ 141
   ReActMCP is a reactive MCP client that empowers AI assistants to instantly respond with real-time, Markdown-formatted web search insights powered by the Exa API.

1419. **[Polymcp](https://github.com/poly-mcp/Polymcp)** - ⭐ 141
   Polymcp provides a simple and efficient way to interact with MCP servers using custom agents

1420. **[mcp-k8s](https://github.com/silenceper/mcp-k8s)** - ⭐ 141
   A Kubernetes MCP (Model Control Protocol) server that enables interaction with Kubernetes clusters through MCP tools.

1421. **[guidance-for-deploying-model-context-protocol-servers-on-aws](https://github.com/aws-solutions-library-samples/guidance-for-deploying-model-context-protocol-servers-on-aws)** - ⭐ 141
...
1422. **[ollama-mcp](https://github.com/rawveg/ollama-mcp)** - ⭐ 141
   An MCP Server for Ollama

1423. **[A2A-MCP-Server](https://github.com/GongRzhe/A2A-MCP-Server)** - ⭐ 141
...
1424. **[mcp-server-apache-airflow](https://github.com/yangkyeongmo/mcp-server-apache-airflow)** - ⭐ 140

1425. **[mssql-mcp](https://github.com/Aaronontheweb/mssql-mcp)** - ⭐ 140
   MSSQL Server MCP implementation written in C#

1426. **[graphiti-mcp-server](https://github.com/gifflet/graphiti-mcp-server)** - ⭐ 140
   Graphiti MCP Server

1427. **[mcp-rubber-duck](https://github.com/nesquikm/mcp-rubber-duck)** - ⭐ 140
   An MCP server that acts as a bridge to query multiple OpenAI-compatible LLMs with MCP tool access. Just like rubber duck debugging, explain your problems to various AI "ducks" who can actually research and get different perspectives!

1428. **[claude-prompts](https://github.com/minipuft/claude-prompts)** - ⭐ 140
   MCP prompt template server: hot-reload, thinking frameworks, quality gates

1429. **[ultimate_mcp_server](https://github.com/Dicklesworthstone/ultimate_mcp_server)** - ⭐ 140
...
1430. **[mcp-server-manifest](https://github.com/Zomato/mcp-server-manifest)** - ⭐ 139

1431. **[systemprompt-code-orchestrator](https://github.com/systempromptio/systemprompt-code-orchestrator)** - ⭐ 139
     MCP server for orchestrating AI coding agents (Claude Code CLI & Gemini CLI). Features task management, process execution, Git integration, and dynamic resource discovery. Full TypeScript implementation with Docker support and Cloudflare Tunnel integration. 

1432. **[MCP-X](https://github.com/TimeCyber/MCP-X)** - ⭐ 139
...
1433. **[agent-toolkit](https://github.com/datacommonsorg/agent-toolkit)** - ⭐ 139
   Tools and agents for interacting with the Data Commons Knowledge Graph using the Model Context Protocol (MCP).

1434. **[mcp-server-serper](https://github.com/marcopesani/mcp-server-serper)** - ⭐ 139
   Serper MCP Server supporting search and webpage scraping

1435. **[zettelkasten-mcp](https://github.com/entanglr/zettelkasten-mcp)** - ⭐ 139
   A Model Context Protocol (MCP) server that implements the Zettelkasten knowledge management methodology, allowing you to create, link, explore and synthesize atomic notes through Claude and other MCP-compatible clients.

1436. **[LMStudio-MCP](https://github.com/infinitimeless/LMStudio-MCP)** - ⭐ 139
   A Model Control Protocol (MCP) server that allows Claude to communicate with locally running LLM models via LM Studio.

1437. **[mcp-crash-course](https://github.com/emarco177/mcp-crash-course)** - ⭐ 139
...
1438. **[mcp-montano-server](https://github.com/lucasmontano/mcp-montano-server)** - ⭐ 138
   Simple MCP Server Implementation

1439. **[doc-ops-mcp](https://github.com/Tele-AI/doc-ops-mcp)** - ⭐ 138
   MCP server for seamless document format conversion and processing

1440. **[SecureMCP](https://github.com/makalin/SecureMCP)** - ⭐ 138
...
1441. **[datagov-mcp](https://github.com/aviveldan/datagov-mcp)** - ⭐ 137
   MCP server for Israel Government Data

1442. **[hayhooks](https://github.com/deepset-ai/hayhooks)** - ⭐ 137
   Easily deploy Haystack pipelines as REST APIs and MCP Tools.

1443. **[MCP-PostgreSQL-Ops](https://github.com/call518/MCP-PostgreSQL-Ops)** - ⭐ 137
...
1444. **[gemini-mcp](https://github.com/RLabs-Inc/gemini-mcp)** - ⭐ 137
   MCP Server that enables Claude code to interact with Gemini

1445. **[seline](https://github.com/tercumantanumut/seline)** - ⭐ 137
...
1446. **[NornicDB](https://github.com/orneryd/NornicDB)** - ⭐ 137
...
1447. **[ksail](https://github.com/devantler-tech/ksail)** - ⭐ 137
   Tool for creating, maintaining and operating Kubernetes clusters with ease.

1448. **[Gitingest-MCP](https://github.com/puravparab/Gitingest-MCP)** - ⭐ 136
   mcp server for gitingest

1449. **[mcp-server-macos-use](https://github.com/mediar-ai/mcp-server-macos-use)** - ⭐ 136
   AI agent that controls computer with OS-level tools, MCP compatible, works with any model

1450. **[mcpd](https://github.com/mozilla-ai/mcpd)** - ⭐ 136
...
1451. **[mcp-server-datadog](https://github.com/winor30/mcp-server-datadog)** - ⭐ 136

1452. **[codeql-mcp](https://github.com/JordyZomer/codeql-mcp)** - ⭐ 136
...
1453. **[mcp-local-rag](https://github.com/shinpr/mcp-local-rag)** - ⭐ 136
...
1454. **[mcp-server-reddit](https://github.com/Hawstein/mcp-server-reddit)** - ⭐ 135
   A Model Context Protocol (MCP) server that provides tools for fetching Reddit content, including frontpage posts, subreddit information and hot posts, post details, and comments.

1455. **[esp-mcp](https://github.com/horw/esp-mcp)** - ⭐ 135
   Centralize ESP32 related commands and simplify getting started with seamless, LLM-driven interaction and help.

1456. **[computer-use-mcp](https://github.com/domdomegg/computer-use-mcp)** - ⭐ 135
   💻 Give AI models complete control of your computer (probably a bad idea)

1457. **[mcp-think-tool](https://github.com/DannyMac180/mcp-think-tool)** - ⭐ 134
   An MCP server implementing the think tool for Claude

1458. **[jupyter-ai-agents](https://github.com/datalayer/jupyter-ai-agents)** - ⭐ 134
   🪐 🤖 AI Agents for JupyterLab with 🔧 MCP tools - Chat interface for optimized notebook interaction and code execution.

1459. **[mkinf](https://github.com/mkinf-io/mkinf)** - ⭐ 134
   mkinf SDK to interact with mkinf hub MCP servers

1460. **[xhs-mcp-server](https://github.com/aicu-icu/xhs-mcp-server)** - ⭐ 134
   小红书MCP服务器 | 基于Electron+小红书Web API。一键安装运行、极速抓取笔记、评论、用户等数据并让AI智能分析、整理与导出

1461. **[shopify-mcp](https://github.com/GeLi2001/shopify-mcp)** - ⭐ 134
   MCP server for Shopify api, usable on mcp hosts such as Claude and Cursor

1462. **[nextcloud-mcp-server](https://github.com/cbcoutinho/nextcloud-mcp-server)** - ⭐ 134
   Nextcloud MCP Server

1463. **[mcp-read-website-fast](https://github.com/just-every/mcp-read-website-fast)** - ⭐ 134
   Quickly reads webpages and converts to markdown for fast, token efficient web scraping

1464. **[Multi-Source-Media-MCP-Server](https://github.com/Decade-qiu/Multi-Source-Media-MCP-Server)** - ⭐ 133
   An MCP Tool Implementation for Multi-Source Image Access & Generation

1465. **[mcp-bigquery-server](https://github.com/ergut/mcp-bigquery-server)** - ⭐ 133
   A Model Context Protocol (MCP) server that provides secure, read-only access to BigQuery datasets. Enables Large Language Models (LLMs) to safely query and analyze data through a standardized interface.

1466. **[mcp-chat](https://github.com/Flux159/mcp-chat)** - ⭐ 133
   Open Source Generic MCP Client for testing & evaluating mcp servers and agents

1467. **[Awesome-MCP](https://github.com/AlexMili/Awesome-MCP)** - ⭐ 133
   Awesome ModelContextProtocol resources - A curated list of MCP resources

1468. **[play-store-mcp](https://github.com/antoniolg/play-store-mcp)** - ⭐ 133
   An MCP server that connects to Play Store Console and release new App versions from an MCP Client

1469. **[rust-mcp-filesystem](https://github.com/rust-mcp-stack/rust-mcp-filesystem)** - ⭐ 133
   Blazing-fast, asynchronous MCP server for seamless filesystem operations.

1470. **[claude-code-open](https://github.com/kill136/claude-code-open)** - ⭐ 133
   Open source AI coding platform with Web IDE, multi-agent system, 37+ tools, MCP protocol. MIT licensed.

1471. **[zotero-mcp](https://github.com/kujenga/zotero-mcp)** - ⭐ 132
   Model Context Protocol (MCP) server for the Zotero API, in Python

1472. **[mcp-gateway](https://github.com/acehoss/mcp-gateway)** - ⭐ 132
...
1473. **[mcp-apache-spark-history-server](https://github.com/kubeflow/mcp-apache-spark-history-server)** - ⭐ 132
   MCP Server for Apache Spark History Server. The bridge between Agentic AI and Apache Spark.

1474. **[N8N2MCP](https://github.com/Super-Chain/N8N2MCP)** - ⭐ 132
   Convert N8N agent / workflow into MCP servers, you can use it in Claude / Cursor / Super Chain 

1475. **[zig-mcp](https://github.com/zig-wasm/zig-mcp)** - ⭐ 132
   Model Context Protocol (MCP) server that provides up-to-date documentation for the Zig programming language standard library and builtin functions

1476. **[unreal-analyzer-mcp](https://github.com/ayeletstudioindia/unreal-analyzer-mcp)** - ⭐ 132
   MCP server for Unreal Engine 5

1477. **[mcp-redmine](https://github.com/runekaagaard/mcp-redmine)** - ⭐ 132
   A redmine MCP server covering close to 100% of redmines API

1478. **[paiml-mcp-agent-toolkit](https://github.com/paiml/paiml-mcp-agent-toolkit)** - ⭐ 132
   Pragmatic AI Labs MCP Agent Toolkit - An MCP Server designed to make code with agents more deterministic

1479. **[desktop](https://github.com/agentify-sh/desktop)** - ⭐ 132
...
1480. **[tiktok-mcp](https://github.com/Seym0n/tiktok-mcp)** - ⭐ 132
   Model Context Protocol (MCP) with TikTok integration

1481. **[ChatPPT-MCP](https://github.com/YOOTeam/ChatPPT-MCP)** - ⭐ 132
...
1482. **[mcpproxy-go](https://github.com/smart-mcp-proxy/mcpproxy-go)** - ⭐ 132
   Supercharge AI Agents, Safely

1483. **[pi-mcp-adapter](https://github.com/nicobailon/pi-mcp-adapter)** - ⭐ 132
   Token-efficient MCP adapter for Pi coding agent

1484. **[mcp_server_exe](https://github.com/shadowcz007/mcp_server_exe)** - ⭐ 131
   小智 & Cursor 的 MCP 启动器 - MCP For Cursor&xiaozhi。打包成可执行文件。Turn MCP server into an executable file

1485. **[ragrabbit](https://github.com/madarco/ragrabbit)** - ⭐ 131
   Open Source, Self-Hosted, AI Search and LLM.txt for your website

1486. **[mcp](https://github.com/MariaDB/mcp)** - ⭐ 131
   MariaDB MCP (Model Context Protocol) server implementation

1487. **[mcp-endpoint-server](https://github.com/xinnan-tech/mcp-endpoint-server)** - ⭐ 131
   xiaozhi mcp接入点服务器，用于自定义mcp服务注册，方便拓展小智服务端工具调用

1488. **[paperless-mcp](https://github.com/nloui/paperless-mcp)** - ⭐ 131
   An MCP (Model Context Protocol) server for interacting with a Paperless-NGX API server. This server provides tools for managing documents, tags, correspondents, and document types in your Paperless-NGX instance.

1489. **[crawl4ai-mcp-server](https://github.com/weidwonder/crawl4ai-mcp-server)** - ⭐ 130
   用于提供给本地开发者的 LLM的高效互联网搜索&内容获取的MCP Server， 节省你的token

1490. **[mcp-server](https://github.com/browserstack/mcp-server)** - ⭐ 130
   BrowserStack's Official MCP Server

1491. **[dify-plugin-agent-mcp_sse](https://github.com/junjiem/dify-plugin-agent-mcp_sse)** - ⭐ 130
   Dify 1.0 Plugin Support MCP Tools Agent strategies

1492. **[magg](https://github.com/sitbon/magg)** - ⭐ 130
   Magg: The MCP Aggregator

1493. **[mcp-linear](https://github.com/tacticlaunch/mcp-linear)** - ⭐ 130
...
1494. **[mcp-todoist](https://github.com/greirson/mcp-todoist)** - ⭐ 130
   MCP server that connects Claude to Todoist for natural language task and project   management with bulk operations

1495. **[vibing-steampunk](https://github.com/oisee/vibing-steampunk)** - ⭐ 130
   vs-punk: ADT to MCP bridge - Vibe code in ABAP / AMDP

1496. **[mcp-server-ccxt](https://github.com/doggybee/mcp-server-ccxt)** - ⭐ 129
   High-performance CCXT MCP server for cryptocurrency exchange integration

1497. **[hevy-mcp](https://github.com/chrisdoc/hevy-mcp)** - ⭐ 129
   Manage your Hevy workouts, routines, folders, and exercise templates. Create and update sessions faster, organize plans, and search exercises to build workouts quickly. Stay synced with changes so your training log is always up to date.

1498. **[Wazuh-MCP-Server](https://github.com/gensecaihq/Wazuh-MCP-Server)** - ⭐ 129
...
1499. **[beyond-mcp](https://github.com/disler/beyond-mcp)** - ⭐ 128
   It's time to push beyond MCP Servers... Right?

1500. **[mcp-server-aws](https://github.com/rishikavikondala/mcp-server-aws)** - ⭐ 128
   A Model Context Protocol server implementation for operations on AWS resources

1501. **[ZotLink](https://github.com/TonybotNi/ZotLink)** - ⭐ 128
...
1502. **[mcp-victoriametrics](https://github.com/VictoriaMetrics-Community/mcp-victoriametrics)** - ⭐ 128
   The implementation of Model Context Protocol (MCP) server for VictoriaMetrics

1503. **[mcp-server-salesforce](https://github.com/tsmztech/mcp-server-salesforce)** - ⭐ 128
   Salesforce MCP Server

1504. **[mevzuat-mcp](https://github.com/saidsurucu/mevzuat-mcp)** - ⭐ 128
   MCP Server for Searching Turkish Legislation

1505. **[ClaudeR](https://github.com/IMNMV/ClaudeR)** - ⭐ 128
...
1506. **[isaac-sim-mcp](https://github.com/omni-mcp/isaac-sim-mcp)** - ⭐ 128
   Isaac Simulation MCP Extension and Server

1507. **[CoWork-OS](https://github.com/CoWork-OS/CoWork-OS)** - ⭐ 128
...
1508. **[mcp-victoriametrics](https://github.com/VictoriaMetrics/mcp-victoriametrics)** - ⭐ 128
   The implementation of Model Context Protocol (MCP) server for VictoriaMetrics

1509. **[awesome-crypto-mcp-servers](https://github.com/badkk/awesome-crypto-mcp-servers)** - ⭐ 127
   A collection of crypto MCP servers.

1510. **[aws-cost-explorer-mcp-server](https://github.com/aarora79/aws-cost-explorer-mcp-server)** - ⭐ 127
   MCP server for understanding AWS spend

1511. **[mcp-server-plugin](https://github.com/JetBrains/mcp-server-plugin)** - ⭐ 127
   JetBrains MCP Server Plugin

1512. **[laravel-loop](https://github.com/kirschbaum-development/laravel-loop)** - ⭐ 127
   Laravel Loop is a powerful Model Context Protocol (MCP) server designed specifically for Laravel applications. It connects your Laravel application with AI assistants using the MCP protocol.

1513. **[specs-workflow-mcp](https://github.com/kingkongshot/specs-workflow-mcp)** - ⭐ 127
   Intelligent spec workflow management MCP server

1514. **[mcp-bsl-platform-context](https://github.com/alkoleft/mcp-bsl-platform-context)** - ⭐ 127
   MCP сервер для AI-ассистентов (справка по синтаксису и объектной модели 1С:Предприятие)

1515. **[dart-mcp-server](https://github.com/its-dart/dart-mcp-server)** - ⭐ 127
   Dart AI Model Context Protocol (MCP) server

1516. **[claude-prompts-mcp](https://github.com/minipuft/claude-prompts-mcp)** - ⭐ 126
   MCP prompt template server: hot-reload, thinking frameworks, quality gates

1517. **[mcp-devtools](https://github.com/sammcj/mcp-devtools)** - ⭐ 126
   A modular MCP server that provides commonly used developer tools for AI coding agents

1518. **[claude-code-tool-manager](https://github.com/tylergraydev/claude-code-tool-manager)** - ⭐ 126
   GUI app to manage MCP servers for Claude Code

1519. **[buttplug-mcp](https://github.com/ConAcademy/buttplug-mcp)** - ⭐ 126
   Buttplug.io Model Context Protocol (MCP) Server

1520. **[FirstData](https://github.com/MLT-OSS/FirstData)** - ⭐ 126
   The World's Most Comprehensive, Authoritative, and Structured Open Source Data Source Knowledge Base

1521. **[hub-mcp](https://github.com/docker/hub-mcp)** - ⭐ 126
   Docker Hub MCP Server

1522. **[OpenSCAD-MCP-Server](https://github.com/jhacksman/OpenSCAD-MCP-Server)** - ⭐ 126
   Devin's attempt at creating an OpenSCAD MCP Server that takes a user prompt and generates a preview image and 3d file.

1523. **[think-mcp-server](https://github.com/PhillipRt/think-mcp-server)** - ⭐ 125

1524. **[play-store-mcp](https://github.com/devexpert-io/play-store-mcp)** - ⭐ 125
   An MCP server that connects to Play Store Console and release new App versions from an MCP Client

1525. **[mcp-evals](https://github.com/mclenhard/mcp-evals)** - ⭐ 125
   A Node.js package and GitHub Action for evaluating MCP (Model Context Protocol) tool implementations using LLM-based scoring. This helps ensure your MCP server's tools are working correctly and performing well.

1526. **[mcp-streamable-http](https://github.com/invariantlabs-ai/mcp-streamable-http)** - ⭐ 125
   Example implementation of MCP Streamable HTTP client/server in Python and TypeScript.

1527. **[laravel-toon](https://github.com/mischasigtermans/laravel-toon)** - ⭐ 125
   TOON encoding for Laravel. Encode data for AI/LLMs with ~50% fewer tokens than JSON.

1528. **[raindrop-mcp](https://github.com/adeze/raindrop-mcp)** - ⭐ 125
   Raindrop MCP Server

1529. **[-mcp-to-skill-converter](https://github.com/GBSOSS/-mcp-to-skill-converter)** - ⭐ 125
      Convert any MCP server into a Claude Skill with 90% context savings

1530. **[awesome-x402](https://github.com/xpaysh/awesome-x402)** - ⭐ 125
   🚀 Curated list of x402 resources: HTTP 402 Payment Required protocol for blockchain payments, crypto micropayments, AI agents, API monetization. Includes SDKs (TypeScript, Python, Rust), examples, facilitators (Coinbase, Cloudflare), MCP integration, tutorials. Accept USDC payments with one line of code. Perfect for AI agent economy.

1531. **[meta_skill](https://github.com/Dicklesworthstone/meta_skill)** - ⭐ 125
...
1532. **[openfang](https://github.com/RightNow-AI/openfang)** - ⭐ 125
   Open-source Agent Operating System

1533. **[mcp-client-server](https://github.com/willccbb/mcp-client-server)** - ⭐ 124
   An MCP Server that's also an MCP Client. Useful for letting Claude develop and test MCPs without needing to reset the application.

1534. **[mcp](https://github.com/pronskiy/mcp)** - ⭐ 124
   🐉 The fast, PHP way to build MCP servers

1535. **[aws-lambda-mcp-cookbook](https://github.com/ran-isenberg/aws-lambda-mcp-cookbook)** - ⭐ 124
...
1536. **[turbo-flow-claude](https://github.com/marcuspat/turbo-flow-claude)** - ⭐ 124
...
1537. **[mcp-svelte-docs](https://github.com/spences10/mcp-svelte-docs)** - ⭐ 124
   🔍 MCP server that lets you search and access Svelte documentation with built-in caching

1538. **[MakerAi](https://github.com/gustavoeenriquez/MakerAi)** - ⭐ 124
...
1539. **[UnityMCP](https://github.com/isuzu-shiranui/UnityMCP)** - ⭐ 124
   Unity Editor integration with Model Context Protocol (MCP) enabling AI assistants like Claude to interact with Unity projects. Features a TypeScript MCP server and C# Unity plugin with extensible command handler architecture, TCP/IP communication, and dynamic plugin discovery.

1540. **[apple-health-mcp-server](https://github.com/the-momentum/apple-health-mcp-server)** - ⭐ 124
   MCP server for querying Apple Health data with natural language using DuckDB under the hood.

1541. **[mcp-server-bigquery](https://github.com/LucasHild/mcp-server-bigquery)** - ⭐ 123
   A Model Context Protocol server that provides access to BigQuery

1542. **[mcp-glootie](https://github.com/AnEntrypoint/mcp-glootie)** - ⭐ 123
   wanna develop an app ❓

1543. **[linear-mcp](https://github.com/cline/linear-mcp)** - ⭐ 123
   a private MCP server for accessing Linear

1544. **[cloudflare-mcp](https://github.com/mattzcarey/cloudflare-mcp)** - ⭐ 123
   unofficial mcp server for cloudflare api

1545. **[mcp-watch](https://github.com/kapilduraphe/mcp-watch)** - ⭐ 123
   A comprehensive security scanner for Model Context Protocol (MCP) servers that detects vulnerabilities and security issues in your MCP server implementations.

1546. **[openapi](https://github.com/samchon/openapi)** - ⭐ 123
   OpenAPI definitions, converters and LLM function calling schema composer.

1547. **[ableton-mcp-extended](https://github.com/uisato/ableton-mcp-extended)** - ⭐ 123
   Ableton Live MCP (Model Context Protocol) server that allows control directly through AI assistants.

1548. **[mcp-gm](https://github.com/AnEntrypoint/mcp-gm)** - ⭐ 123
   wanna develop an app ❓

1549. **[mcp-server](https://github.com/bitwarden/mcp-server)** - ⭐ 122
   MCP server for interaction with Bitwarden.

1550. **[mcp-server-asana](https://github.com/roychri/mcp-server-asana)** - ⭐ 122

1551. **[mcp-memory](https://github.com/Puliczek/mcp-memory)** - ⭐ 122
...
1552. **[aseprite-mcp](https://github.com/diivi/aseprite-mcp)** - ⭐ 122
   MCP server for interacting with the Aseprite API

1553. **[pentest-mcp](https://github.com/DMontgomery40/pentest-mcp)** - ⭐ 122
   NOT for educational purposes: An MCP server for professional penetration testers including STDIO/HTTP/SSE support, nmap, go/dirbuster, nikto, JtR, hashcat, wordlist building, and more.

1554. **[muppet](https://github.com/muppet-dev/muppet)** - ⭐ 121
   MCP Servers SDK for TypeScript

1555. **[easy-code-reader](https://github.com/FangYuan33/easy-code-reader)** - ⭐ 121
   A powerful MCP (Model Context Protocol) server for intelligently reading Java source code.

1556. **[MCP-Workspace-Server](https://github.com/answerlink/MCP-Workspace-Server)** - ⭐ 121
...
1557. **[ffmpeg-mcp](https://github.com/video-creator/ffmpeg-mcp)** - ⭐ 121
...
1558. **[n8n-mcp-server](https://github.com/illuminaresolutions/n8n-mcp-server)** - ⭐ 121
   MCP server implementation for n8n workflow automation

1559. **[google-workspace-mcp](https://github.com/aaronsb/google-workspace-mcp)** - ⭐ 120
   A Model Context Protocol (MCP) server that provides authenticated access to Google Workspace APIs, offering integrated Authentication, Gmail, Calendar, and Drive functionality

1560. **[mcp-package-version](https://github.com/sammcj/mcp-package-version)** - ⭐ 120
   An MCP server that provides LLMs with the latest stable package versions when coding

1561. **[ffmpeg-mcp](https://github.com/egoist/ffmpeg-mcp)** - ⭐ 120
   An MCP server for FFmpeg

1562. **[jupyter-notebook-mcp](https://github.com/jjsantos01/jupyter-notebook-mcp)** - ⭐ 120
   A Model Context Protocol (MCP) for Jupyter Notebook

1563. **[remote-mcp-functions-dotnet](https://github.com/Azure-Samples/remote-mcp-functions-dotnet)** - ⭐ 120
...
1564. **[google-sheets-mcp](https://github.com/mkummer225/google-sheets-mcp)** - ⭐ 120
   Google Sheets MCP Server 📊🤖

1565. **[SwiftMCP](https://github.com/Cocoanetics/SwiftMCP)** - ⭐ 120
   Model Context Protocol Server for Swift

1566. **[nanobanana-mcp-server](https://github.com/zhongweili/nanobanana-mcp-server)** - ⭐ 120

1567. **[akshare-one-mcp](https://github.com/zwldarren/akshare-one-mcp)** - ⭐ 120
   MCP server that provides access to Chinese stock market data using akshare-one

1568. **[netbox-mcp-server](https://github.com/netboxlabs/netbox-mcp-server)** - ⭐ 120
   Model Context Protocol (MCP) server for read-only interaction with NetBox data in LLMs

1569. **[teslamate-mcp](https://github.com/cobanov/teslamate-mcp)** - ⭐ 119
   A Model Context Protocol (MCP) server that provides access to your TeslaMate database, allowing AI assistants to query Tesla vehicle data and analytics.

1570. **[elevenlabs-mcp-server](https://github.com/mamertofabian/elevenlabs-mcp-server)** - ⭐ 119

1571. **[portainer-mcp](https://github.com/portainer/portainer-mcp)** - ⭐ 119
   Portainer MCP server

1572. **[comet-mcp](https://github.com/hanzili/comet-mcp)** - ⭐ 119
   MCP Server connecting to Perplexity Comet browser

1573. **[datagouv-mcp](https://github.com/datagouv/datagouv-mcp)** - ⭐ 119
   Official data.gouv.fr Model Context Protocol (MCP) server that allows AI chatbots to search, explore, and analyze datasets from the French national Open Data platform, directly through conversation.

1574. **[memorizer-v1](https://github.com/petabridge/memorizer-v1)** - ⭐ 118
   Vector-search powered agent memory MCP server

1575. **[mcp-mianshiya-server](https://github.com/yuyuanweb/mcp-mianshiya-server)** - ⭐ 118
   基于 Spring AI 的面试鸭搜索题目的 MCP Server 服务，快速让 AI 搜索企业面试真题和答案

1576. **[Easy-MCP-AutoCad](https://github.com/zh19980811/Easy-MCP-AutoCad)** - ⭐ 118
   这个项目是一个基于Model Context Protocol (MCP)的AutoCAD集成服务器，它允许通过自然语言与AutoCAD进行交互。通过这个服务器，用户可以使用Claude等大型语言模型来创建、修改和分析AutoCAD图纸，同时还可以存储和查询CAD元素的相关数据。目前制作参考学习，仅实现端到端之间的通信，具体工具函数尚未晚上

1577. **[SmartDB_MCP](https://github.com/wenb1n-dev/SmartDB_MCP)** - ⭐ 118
...
1578. **[exstruct](https://github.com/harumiWeb/exstruct)** - ⭐ 118
   Excel to structured JSON (tables, shapes, charts) for LLM/RAG pipelines

1579. **[polymarket-mcp](https://github.com/berlinbra/polymarket-mcp)** - ⭐ 118
   MCP Server for PolyMarket API

1580. **[typst-mcp](https://github.com/johannesbrandenburger/typst-mcp)** - ⭐ 118
   Typst MCP Server is an MCP (Model Context Protocol) implementation that helps AI models interact with Typst, a markup-based typesetting system. The server provides tools for converting between LaTeX and Typst, validating Typst syntax, and generating images from Typst code.

1581. **[swiftlens](https://github.com/swiftlens/swiftlens)** - ⭐ 118
...
1582. **[Financial-Modeling-Prep-MCP-Server](https://github.com/imbenrabi/Financial-Modeling-Prep-MCP-Server)** - ⭐ 118
   A Model Context Protocol (MCP) implementation for Financial Modeling Prep, enabling AI assistants to access and analyze financial data, stock information, company fundamentals, and market insights.

1583. **[VisionCraft-MCP-Server](https://github.com/augmentedstartups/VisionCraft-MCP-Server)** - ⭐ 117
...
1584. **[iphone-mcp](https://github.com/Lakr233/iphone-mcp)** - ⭐ 117
...
1585. **[mcp-ts-template](https://github.com/cyanheads/mcp-ts-template)** - ⭐ 117
   TypeScript template for building Model Context Protocol (MCP) servers. Ships with declarative tools/resources, pluggable auth, multi-backend storage, OpenTelemetry observability, and first-class support for both local and edge (Cloudflare Workers) runtimes.

1586. **[web-scout-mcp](https://github.com/pinkpixel-dev/web-scout-mcp)** - ⭐ 117
   A powerful MCP server extension providing web search and content extraction capabilities. Integrates DuckDuckGo search functionality and URL content extraction into your MCP environment, enabling AI assistants to search the web and extract webpage content programmatically.

1587. **[mcp-server](https://github.com/InterviewReady/mcp-server)** - ⭐ 117
   An MCP server for InterviewReady

1588. **[aks-mcp](https://github.com/Azure/aks-mcp)** - ⭐ 117
   A Model Context Protocol (MCP) server that enables AI assistants to interact with AKS clusters. It serves as a bridge between AI tools (like Claude, Cursor, and GitHub Copilot) and AKS.

1589. **[Hegelion](https://github.com/Hmbown/Hegelion)** - ⭐ 117
   Dialectical reasoning architecture for LLMs (Thesis → Antithesis → Synthesis)

1590. **[computer-control-mcp](https://github.com/AB498/computer-control-mcp)** - ⭐ 117
   MCP server that provides computer control capabilities, like mouse, keyboard, OCR, etc. using PyAutoGUI, RapidOCR, ONNXRuntime. Similar to 'computer-use' by Anthropic. With Zero External Dependencies.

1591. **[mcp-reticle](https://github.com/soth-ai/mcp-reticle)** - ⭐ 116
   Reticle intercepts, visualizes, and profiles JSON-RPC traffic between your LLM and MCP servers in real-time, with zero latency overhead. Stop debugging blind. Start seeing everything.

1592. **[mcp_proxy_rust](https://github.com/tidewave-ai/mcp_proxy_rust)** - ⭐ 116
   A proxy to use HTTP/SSE MCPs from STDIO clients

1593. **[mcp-hubspot](https://github.com/peakmojo/mcp-hubspot)** - ⭐ 116
   A Model Context Protocol (MCP) server that enables AI assistants to interact with HubSpot CRM data, providing built-in vector storage and caching mechanisms help overcome HubSpot API limitations while improving response times.

1594. **[mcp-server-atlassian-bitbucket](https://github.com/aashari/mcp-server-atlassian-bitbucket)** - ⭐ 116
   Node.js/TypeScript MCP server for Atlassian Bitbucket. Enables AI systems (LLMs) to interact with workspaces, repositories, and pull requests via tools (list, get, comment, search). Connects AI directly to version control workflows through the standard MCP interface.

1595. **[context-sync](https://github.com/Intina47/context-sync)** - ⭐ 116
...
1596. **[xcodeproj-mcp-server](https://github.com/giginet/xcodeproj-mcp-server)** - ⭐ 116
   A Model Context Protocol Server to manipulate *.xcodeproj

1597. **[ASI](https://github.com/vNeeL-code/ASI)** - ⭐ 116
   Android ✧ Gemma Integration into Android System Intelligence

1598. **[kodit](https://github.com/helixml/kodit)** - ⭐ 115
   👩‍💻 MCP server to index external repositories

1599. **[MCppServer](https://github.com/Noeli14/MCppServer)** - ⭐ 115
   Fast and super efficient Minecraft Server written in C++

1600. **[remote-mcp-apim-functions-python](https://github.com/Azure-Samples/remote-mcp-apim-functions-python)** - ⭐ 115
   Azure API Management as AI Gateway to Remote MCP servers.

1601. **[oracle-mcp-server](https://github.com/danielmeppiel/oracle-mcp-server)** - ⭐ 115
   MCP Server for working with large Oracle databases

1602. **[server-google-news](https://github.com/ChanMeng666/server-google-news)** - ⭐ 114
   【Star-crossed coders unite!⭐️】Model Context Protocol (MCP) server implementation providing Google News search capabilities via SerpAPI, with automatic news categorization and multi-language support.

1603. **[swagger-mcp](https://github.com/dcolley/swagger-mcp)** - ⭐ 114
   Swagger to MCP server

1604. **[env-doctor](https://github.com/mitulgarg/env-doctor)** - ⭐ 114
   Debug your GPU, CUDA, and AI stacks across local, Docker, and CI/CD (CLI and MCP server)

1605. **[remote-mcp-functions-python](https://github.com/Azure-Samples/remote-mcp-functions-python)** - ⭐ 114
   Getting Started with Remote MCP Servers using Azure Functions (Python)

1606. **[toolhive-studio](https://github.com/stacklok/toolhive-studio)** - ⭐ 114
   ToolHive is an application that allows you to install, manage and run MCP servers and connect them to AI agents

1607. **[mcp-probe](https://github.com/conikeec/mcp-probe)** - ⭐ 114
   A Model Context Protocol (MCP) client library and debugging toolkit in Rust. This foundation provides both a production-ready SDK for building MCP integrations and the core architecture for an interactive debugger.

1608. **[mcp-local-rag](https://github.com/nkapila6/mcp-local-rag)** - ⭐ 114
   "primitive" RAG-like web search model context protocol (MCP) server that runs locally. ✨ no APIs ✨

1609. **[mcp](https://github.com/frappe/mcp)** - ⭐ 114
   Frappe MCP allows Frappe apps to function as MCP servers

1610. **[cli](https://github.com/mcpgod/cli)** - ⭐ 113
   Fine-grained control over model context protocol (MCP) clients, servers, and tools. Context is God.

1611. **[MCP-oura](https://github.com/YuzeHao2023/MCP-oura)** - ⭐ 113
   MCP server for Oura API integration

1612. **[foxy-contexts](https://github.com/strowk/foxy-contexts)** - ⭐ 113
   Foxy contexts is a library for building context servers supporting Model Context Protocol

1613. **[UnityMCPIntegration](https://github.com/quazaai/UnityMCPIntegration)** - ⭐ 113
   Enable AI Agents to Control Unity

1614. **[mcp-toolkit](https://github.com/nuxt-modules/mcp-toolkit)** - ⭐ 113
   Create MCP servers directly in your Nuxt application. Define tools, resources, and prompts with a simple and intuitive API.

1615. **[notion-mcp](https://github.com/ccabanillas/notion-mcp)** - ⭐ 113
   A Model Context Protocol (MCP) server implementation for Notion integration, providing a standardized interface for interacting with Notion's API.

1616. **[falcon-mcp](https://github.com/CrowdStrike/falcon-mcp)** - ⭐ 113
   Connect AI agents to CrowdStrike Falcon for automated security analysis and threat hunting

1617. **[Dex](https://github.com/davekilleen/Dex)** - ⭐ 113
   Your AI Chief of Staff — a personal operating system starter kit that adapts to your role. No coding required.

1618. **[narsil-mcp](https://github.com/postrv/narsil-mcp)** - ⭐ 113
   Rust MCP server for comprehensive code intelligence - 90 tools, 32 languages, security scanning, call graphs, and more

1619. **[crypto-indicators-mcp](https://github.com/kukapay/crypto-indicators-mcp)** - ⭐ 112
   An MCP server providing a range of cryptocurrency technical analysis indicators and strategies.

1620. **[MCP2Lambda](https://github.com/danilop/MCP2Lambda)** - ⭐ 112
   Run any AWS Lambda function as a Large Language Model (LLM) tool without code changes using Anthropic's Model Context Protocol (MCP).

1621. **[punkpeye_awesome-mcp-servers](https://github.com/MCP-Mirror/punkpeye_awesome-mcp-servers)** - ⭐ 112
   Mirror of https://github.com/punkpeye/awesome-mcp-servers

1622. **[mikrotik-mcp](https://github.com/jeff-nasseri/mikrotik-mcp)** - ⭐ 112
   MCP server for Mikrotik

1623. **[gis-mcp](https://github.com/mahdin75/gis-mcp)** - ⭐ 112
   A Model Context Protocol (MCP) server implementation that connects Large Language Models (LLMs) to GIS operations using GIS libraries, enabling AI assistants to perform geospatial operations and transformations.

1624. **[Deepseek-Thinking-Claude-3.5-Sonnet-CLINE-MCP](https://github.com/newideas99/Deepseek-Thinking-Claude-3.5-Sonnet-CLINE-MCP)** - ⭐ 111
...
1625. **[MCP-searxng](https://github.com/SecretiveShell/MCP-searxng)** - ⭐ 111
   MCP server for connecting agentic systems to search systems via searXNG

1626. **[spring-documentation-mcp-server](https://github.com/andrlange/spring-documentation-mcp-server)** - ⭐ 111
   Spring Boot based MCP Server provide full Spring Ecosystem Documentation for LLMs

1627. **[vscode-as-mcp-server](https://github.com/acomagu/vscode-as-mcp-server)** - ⭐ 111
...
1628. **[mcp-checkpoint](https://github.com/aira-security/mcp-checkpoint)** - ⭐ 111
...
1629. **[mcpauth](https://github.com/mcpauth/mcpauth)** - ⭐ 111
   Authentication for MCP Servers

1630. **[gemini-cli-mcp-server](https://github.com/centminmod/gemini-cli-mcp-server)** - ⭐ 111

1631. **[gRPC-zig](https://github.com/ziglana/gRPC-zig)** - ⭐ 111
   blazigly fast gRPC/MCP client & server implementation in zig

1632. **[mcp.science](https://github.com/pathintegral-institute/mcp.science)** - ⭐ 111
   Open Source MCP Servers for Scientific Research

1633. **[mcp-jfrog](https://github.com/jfrog/mcp-jfrog)** - ⭐ 111
   Model Context Protocol (MCP) Server for the JFrog Platform API, enabling repository management, build tracking, release lifecycle management, and more.

1634. **[Taiwan-Health-MCP](https://github.com/healthymind-tech/Taiwan-Health-MCP)** - ⭐ 111

1635. **[pocketbase-mcp](https://github.com/mrwyndham/pocketbase-mcp)** - ⭐ 111
   MCP server for building PocketBase apps really quickly - Need a front end quick consider FastPocket

1636. **[pipelock](https://github.com/luckyPipewrench/pipelock)** - ⭐ 111
...
1637. **[x64dbgMCP](https://github.com/Wasdubya/x64dbgMCP)** - ⭐ 111
   Model Context Protocol for x64dbg & x32dbg

1638. **[livebook_tools](https://github.com/thmsmlr/livebook_tools)** - ⭐ 110
   Powertools for livebook.dev — AI Code Editing, MCP Servers, and Running Livebooks from the CLI

1639. **[dash-mcp-server](https://github.com/Kapeli/dash-mcp-server)** - ⭐ 110
   MCP server for Dash, the macOS documentation browser

1640. **[code-pathfinder](https://github.com/shivasurya/code-pathfinder)** - ⭐ 110
...
1641. **[augments-mcp-server](https://github.com/augmnt/augments-mcp-server)** - ⭐ 110
   Comprehensive MCP server providing real-time framework documentation access for Claude Code with intelligent caching, multi-source integration, and context-aware assistance.

1642. **[ai-command](https://github.com/mcp-wp/ai-command)** - ⭐ 110
   Control WordPress using WP-CLI, AI, and MCP.

1643. **[DINO-X-MCP](https://github.com/IDEA-Research/DINO-X-MCP)** - ⭐ 110
   Official DINO-X Model Context Protocol (MCP) server that empowers LLMs with real-world visual perception through image object detection, localization, and captioning APIs.

1644. **[modex](https://github.com/theronic/modex)** - ⭐ 110
   Modex is a Clojure MCP Library to augment your AI models with Tools, Resources & Prompts using Clojure (Model Context Protocol). Implements MCP Server & Client.

1645. **[template-repo](https://github.com/AndrewAltimit/template-repo)** - ⭐ 110
...
1646. **[diagram-mcp-server](https://github.com/andrewmoshu/diagram-mcp-server)** - ⭐ 110
   An MCP server that seamlessly creates infrastructure diagrams for AWS, Azure, GCP, Kubernetes and more

1647. **[design-systems-mcp](https://github.com/southleft/design-systems-mcp)** - ⭐ 110
   I'm your specialized design systems assistant. Ask me about components, tokens, patterns, and best practices.

1648. **[server-wp-mcp](https://github.com/emzimmer/server-wp-mcp)** - ⭐ 109

1649. **[game-asset-mcp](https://github.com/MubarakHAlketbi/game-asset-mcp)** - ⭐ 109
   An MCP server for creating 2D/3D game assets from text using Hugging Face AI models.

1650. **[apple-rag-mcp](https://github.com/BingoWon/apple-rag-mcp)** - ⭐ 109
    MCP server providing AI agents with instant access to Apple developer documentation via RAG technology

1651. **[mcp-virustotal](https://github.com/BurtTheCoder/mcp-virustotal)** - ⭐ 109
   A Model Context Protocol (MCP) server for querying the VirusTotal API.

1652. **[mcp-shodan](https://github.com/BurtTheCoder/mcp-shodan)** - ⭐ 109
   MCP server for querying the Shodan API

1653. **[mcp](https://github.com/taskade/mcp)** - ⭐ 109
   🤖 Taskade MCP · Official MCP server and OpenAPI to MCP codegen. Build AI agent tools from any OpenAPI API and connect to Claude, Cursor, and more.

1654. **[google_ads_mcp](https://github.com/google-marketing-solutions/google_ads_mcp)** - ⭐ 109
   The Google Ads MCP Server is an implementation of the Model Context Protocol (MCP) that enables Large Language Models (LLMs), such as Gemini, to interact directly with the Google Ads API.

1655. **[share-best-mcp](https://github.com/shareAI-lab/share-best-mcp)** - ⭐ 108
   世界上最好的MCP Servers的列表,The best mcp servers in the world.

1656. **[minesweeper-mcp-server](https://github.com/tonypan2/minesweeper-mcp-server)** - ⭐ 108
   An MCP server for playing Minesweeper

1657. **[mcp_client](https://github.com/theailanguage/mcp_client)** - ⭐ 108
   MCP Client Implementation using Python, LangGraph and Gemini

1658. **[asyncmcp](https://github.com/bh-rat/asyncmcp)** - ⭐ 108
   Async transport layers for MCP

1659. **[mcp-client](https://github.com/punkpeye/mcp-client)** - ⭐ 108
   An MCP client for Node.js.

1660. **[neurolink](https://github.com/juspay/neurolink)** - ⭐ 108
   Universal AI Development Platform with MCP server integration, multi-provider support, and professional CLI. Build, test, and deploy AI applications with multiple ai providers.

1661. **[outline-mcp-server](https://github.com/mmmeff/outline-mcp-server)** - ⭐ 108
   It's an MCP server... for Outline (the documentation platform!)

1662. **[google-tag-manager-mcp-server](https://github.com/stape-io/google-tag-manager-mcp-server)** - ⭐ 108
   MCP server for Google Tag Manager

1663. **[idun-agent-platform](https://github.com/Idun-Group/idun-agent-platform)** - ⭐ 108
...
1664. **[kibitz](https://github.com/nick1udwig/kibitz)** - ⭐ 107
   The coding agent for professionals

1665. **[slack-mcp-server](https://github.com/ubie-oss/slack-mcp-server)** - ⭐ 107
   A Slack MCP server

1666. **[selfhosted-supabase-mcp](https://github.com/HenkDz/selfhosted-supabase-mcp)** - ⭐ 107
   An MCP Server for your Self Hosted Supabase

1667. **[mcp-tool-kit](https://github.com/getfounded/mcp-tool-kit)** - ⭐ 107
   Agentic abstraction layer for building high precision vertical AI agents written in python for Model Context Protocol.

1668. **[payloadcmsmcp](https://github.com/disruption-hub/payloadcmsmcp)** - ⭐ 107
   Payload CMS MCP Server

1669. **[sourcerer-mcp](https://github.com/st3v3nmw/sourcerer-mcp)** - ⭐ 107
   MCP for semantic code search & navigation that reduces token waste

1670. **[browser-debugger-cli](https://github.com/szymdzum/browser-debugger-cli)** - ⭐ 107
   CLI tool for agents to quickly access browser telemetry (DOM, network, console) via Chrome DevTools Protocol.

1671. **[IntelliConnect](https://github.com/ruanrongman/IntelliConnect)** - ⭐ 106
   本项目为xiaozhi-esp32提供后端服务  |  A Powerful AI agent IoT platform core.

1672. **[csharp-runner](https://github.com/sdcb/csharp-runner)** - ⭐ 106
   fast, secure c# runner

1673. **[snippy](https://github.com/Azure-Samples/snippy)** - ⭐ 106
...
1674. **[mcpm](https://github.com/MCP-Club/mcpm)** - ⭐ 106
...
1675. **[arxiv-latex-mcp](https://github.com/takashiishida/arxiv-latex-mcp)** - ⭐ 106
   MCP server that uses arxiv-to-prompt to fetch and process arXiv LaTeX sources for precise interpretation of mathematical expressions in scientific papers.

1676. **[Fabric-Analytics-MCP](https://github.com/santhoshravindran7/Fabric-Analytics-MCP)** - ⭐ 105
...
1677. **[mcp-prompts](https://github.com/sparesparrow/mcp-prompts)** - ⭐ 105
   Model Context Protocol server for managing, storing, and providing prompts and prompt templates for LLM interactions. 

1678. **[flowlens-mcp-server](https://github.com/magentic/flowlens-mcp-server)** - ⭐ 105
...
1679. **[typescript-utcp](https://github.com/universal-tool-calling-protocol/typescript-utcp)** - ⭐ 105
...
1680. **[ZipAgent](https://github.com/JiayuXu0/ZipAgent)** - ⭐ 105
   轻量级AI Agent框架，让你5分钟构建专属智能助手。Lightweight AI Agent framework. Build your AI assistant in 5 minutes.

1681. **[GenesisCore](https://github.com/AIGODLIKE/GenesisCore)** - ⭐ 105
   One click installation! BlenderMCP tool that supports DeepSeek, Claude, and others, fully integrated into Blender!

1682. **[rust-docs-mcp](https://github.com/snowmead/rust-docs-mcp)** - ⭐ 105
   MCP server for agents to explore rust docs, analyze source code, and build with confidence

1683. **[yfinance-mcp](https://github.com/narumiruna/yfinance-mcp)** - ⭐ 105

1684. **[awesome-context-engineering](https://github.com/jihoo-kim/awesome-context-engineering)** - ⭐ 105
...
1685. **[linggen-memory](https://github.com/linggen/linggen-memory)** - ⭐ 105
   A local-first memory layer for AI (Cursor, Zed, Claude). Persistent architectural context via semantic search.

1686. **[agentcare-mcp](https://github.com/Kartha-AI/agentcare-mcp)** - ⭐ 104
   MCP Server for EMRs with FHIR

1687. **[freqtrade-mcp](https://github.com/kukapay/freqtrade-mcp)** - ⭐ 104
   An MCP server that integrates with the Freqtrade cryptocurrency trading bot.

1688. **[linggen](https://github.com/linggen/linggen)** - ⭐ 104
   A local-first memory layer for AI (Cursor, Zed, Claude). Persistent architectural context via semantic search.

1689. **[a2a-mcp-tutorial](https://github.com/Tsadoq/a2a-mcp-tutorial)** - ⭐ 104
   A tutorial on how to use Model Context Protocol by Anthropic and Agent2Agent Protocol by Google

1690. **[MiniMax-MCP-JS](https://github.com/MiniMax-AI/MiniMax-MCP-JS)** - ⭐ 104
   Official MiniMax Model Context Protocol (MCP) JavaScript implementation that provides seamless integration with MiniMax's powerful AI capabilities including image generation, video generation, text-to-speech, and voice cloning APIs.

1691. **[academic-search-mcp-server](https://github.com/afrise/academic-search-mcp-server)** - ⭐ 104
...
1692. **[gtasks-mcp](https://github.com/zcaceres/gtasks-mcp)** - ⭐ 104
   A Google Tasks Model Context Protocol Server for Claude

1693. **[chat.md](https://github.com/rusiaaman/chat.md)** - ⭐ 104
   An md file as a chat interface and editable history in one.

1694. **[finance-trading-ai-agents-mcp](https://github.com/aitrados/finance-trading-ai-agents-mcp)** - ⭐ 104
...
1695. **[JavaSinkTracer_MCP](https://github.com/Zacarx/JavaSinkTracer_MCP)** - ⭐ 104
   基于函数级污点分析的 Java 源代码漏洞审计工具JavaSinkTracer，通过 Model Context Protocol (MCP) 为 AI 助手提供安全分析能力。

1696. **[AgenticGoKit](https://github.com/AgenticGoKit/AgenticGoKit)** - ⭐ 104
...
1697. **[flexible-graphrag](https://github.com/stevereiner/flexible-graphrag)** - ⭐ 104
...
1698. **[esankhyiki-mcp](https://github.com/nso-india/esankhyiki-mcp)** - ⭐ 104
...
1699. **[smileyCoin](https://github.com/fefergrgrgrg/smileyCoin)** - ⭐ 103
   simple web ui to manage mcp (model context protocol) servers in the claude app

1700. **[memory-bank-MCP](https://github.com/tuncer-byte/memory-bank-MCP)** - ⭐ 103
...
1701. **[solana-mcp](https://github.com/solanamcp/solana-mcp)** - ⭐ 103
   Solana Agent Kit MCP Server 

1702. **[ARIES](https://github.com/Chieko-Seren/ARIES)** - ⭐ 103
...
1703. **[http-oauth-mcp-server](https://github.com/NapthaAI/http-oauth-mcp-server)** - ⭐ 103
...
1704. **[chronulus-mcp](https://github.com/ChronulusAI/chronulus-mcp)** - ⭐ 103
   MCP Server for Chronulus AI Forecasting and Prediction Agents

1705. **[memory-mcp-server](https://github.com/okooo5km/memory-mcp-server)** - ⭐ 103
   A Model Context Protocol server that provides knowledge graph management capabilities. 

1706. **[mcp-server](https://github.com/webflow/mcp-server)** - ⭐ 103
   Model Context Protocol (MCP) server for the Webflow Data API.

1707. **[sqlite-explorer-fastmcp-mcp-server](https://github.com/hannesrudolph/sqlite-explorer-fastmcp-mcp-server)** - ⭐ 103
   An MCP server that provides safe, read-only access to SQLite databases through Model Context Protocol (MCP). This server is built with the FastMCP framework, which enables LLMs to explore and query SQLite databases with built-in safety features and query validation.

1708. **[erickwendel-contributions-mcp](https://github.com/ErickWendel/erickwendel-contributions-mcp)** - ⭐ 103
   A Model Context Protocol (MCP) server that provides tools to query Erick Wendel's contributions across different platforms

1709. **[alibabacloud-ack-mcp-server](https://github.com/aliyun/alibabacloud-ack-mcp-server)** - ⭐ 103
...
1710. **[alibaba-cloud-ops-mcp-server](https://github.com/aliyun/alibaba-cloud-ops-mcp-server)** - ⭐ 103
   AlibabaCloud CloudOps MCP Server

1711. **[UnrealClaude](https://github.com/Natfii/UnrealClaude)** - ⭐ 103
   Claude Code CLI integration for Unreal Engine 5.7 - Get AI coding assistance with built-in UE5.7 documentation context directly in the editor.

1712. **[ATaC](https://github.com/ATaC-team/ATaC)** - ⭐ 103
   Recording and Replay AI Agent Trajectory.

1713. **[sap-skills](https://github.com/secondsky/sap-skills)** - ⭐ 103
...
1714. **[vectorize-mcp-server](https://github.com/vectorize-io/vectorize-mcp-server)** - ⭐ 102
   Official Vectorize MCP Server

1715. **[remote-mcp-functions](https://github.com/Azure-Samples/remote-mcp-functions)** - ⭐ 102
   Landing page for Remote MCP Server efforts in Azure Functions with links to all language stack specific repos.

1716. **[deep-code-reasoning-mcp](https://github.com/haasonsaas/deep-code-reasoning-mcp)** - ⭐ 102
   A Model Context Protocol (MCP) server that provides advanced code analysis and reasoning capabilities powered by Google's Gemini AI

1717. **[mcp-outline](https://github.com/Vortiago/mcp-outline)** - ⭐ 102
   A Model Context Protocol (MCP) server enabling AI assistants to interact with Outline documentation services.

1718. **[comfy-pilot](https://github.com/ConstantineB6/comfy-pilot)** - ⭐ 102
   MCP server + embedded terminal that lets Claude Code see and edit your ComfyUI workflows

1719. **[Nano-Banana-MCP](https://github.com/ConechoAI/Nano-Banana-MCP)** - ⭐ 102
   A Nano Banana MCP server, which you can integrate to cursor/claude code and any mcp client

1720. **[godoc-mcp](https://github.com/mrjoshuak/godoc-mcp)** - ⭐ 102
   go doc mcp server

1721. **[Matryoshka](https://github.com/yogthos/Matryoshka)** - ⭐ 102
   MCP server for token-efficient large document analysis via the use of REPL state

1722. **[gemini-desktop](https://github.com/kkrishnan90/gemini-desktop)** - ⭐ 101
...
1723. **[btp-sap-odata-to-mcp-server](https://github.com/lemaiwo/btp-sap-odata-to-mcp-server)** - ⭐ 101
   BTP CloudFoundry Node.js MCP server for SAP OData services integration

1724. **[powerbi-mcp](https://github.com/sulaiman013/powerbi-mcp)** - ⭐ 101
   MCP server for natural language interaction with Power BI datasets

1725. **[mcp-windows-desktop-automation](https://github.com/mario-andreschak/mcp-windows-desktop-automation)** - ⭐ 101
   A Model Context Protocol (MCP) server for Windows desktop automation using AutoIt.

1726. **[claude-code-mcp-enhanced](https://github.com/grahama1970/claude-code-mcp-enhanced)** - ⭐ 100
...
1727. **[mcp-hono-stateless](https://github.com/mhart/mcp-hono-stateless)** - ⭐ 100
   An example Hono MCP server using Streamable HTTP

1728. **[AgentBoard](https://github.com/igrigorik/AgentBoard)** - ⭐ 100
...
1729. **[autodev-codebase](https://github.com/anrgct/autodev-codebase)** - ⭐ 100
...
1730. **[complete-intro-to-mcp](https://github.com/btholt/complete-intro-to-mcp)** - ⭐ 100
   The Complete Intro to MCP Servers, as taught for Frontend Masters by Brian Holt

1731. **[sample-agentic-ai-demos](https://github.com/aws-samples/sample-agentic-ai-demos)** - ⭐ 100
   Collection of examples of how to use Model Context Protocol with AWS.

1732. **[mcp-screenshot-website-fast](https://github.com/just-every/mcp-screenshot-website-fast)** - ⭐ 100
   Quickly screenshots webpages and converts to an LLM friendly size

1733. **[mcp-client-nodejs](https://github.com/ConardLi/mcp-client-nodejs)** - ⭐ 100
   Node.js Client Implementation for Model Context Protocol (MCP)

1734. **[go-utcp](https://github.com/universal-tool-calling-protocol/go-utcp)** - ⭐ 100
    Official Go implementation of the UTCP 

1735. **[shodh-memory](https://github.com/varun29ankuS/shodh-memory)** - ⭐ 100
...
1736. **[github-stars](https://github.com/miantiao-me/github-stars)** - ⭐ 100
   A Cloudflare-powered MCP (Model Context Protocol) Server that allows you to search and query your GitHub starred repositories using natural language.

1737. **[EDT-MCP](https://github.com/DitriXNew/EDT-MCP)** - ⭐ 100
   MCP for 1C:EDT

1738. **[awesome-mcp-enterprise](https://github.com/bh-rat/awesome-mcp-enterprise)** - ⭐ 99
   A curated list of awesome MCP (Model Context Protocol) tools, platforms, and services for enterprises.

1739. **[next-mcp-server](https://github.com/vertile-ai/next-mcp-server)** - ⭐ 99
   Help LLMs to understand your Next apps better

1740. **[turbular](https://github.com/raeudigerRaeffi/turbular)** - ⭐ 99
   A MCP server allowing LLM agents to easily connect and retrieve data from any database

1741. **[pywss](https://github.com/czasg/pywss)** - ⭐ 99
   一个轻量级的 Python Web 框架，一站式集成 MCP SSE、StreamHTTP 和 MCPO 协议，助你轻松构建MCP Server🔥

1742. **[mighty-security](https://github.com/NineSunsInc/mighty-security)** - ⭐ 99
   Don't Simply Trust MCP Server Code, Validate and Scan

1743. **[terminal-controller-mcp](https://github.com/GongRzhe/terminal-controller-mcp)** - ⭐ 99
   A Model Context Protocol (MCP) server that enables secure terminal command execution, directory navigation, and file system operations through a standardized interface.

1744. **[lapras-mcp-server](https://github.com/lapras-inc/lapras-mcp-server)** - ⭐ 99
   lapras.com 公式MCP Server

1745. **[wanaku](https://github.com/wanaku-ai/wanaku)** - ⭐ 99
   Wanaku MCP Router

1746. **[brave-search-mcp](https://github.com/mikechao/brave-search-mcp)** - ⭐ 99
...
1747. **[heimdall-mcp-server](https://github.com/lcbcFoo/heimdall-mcp-server)** - ⭐ 99
   Your AI Coding Assistant's Long-Term Memory

1748. **[mysql-mcp-server-sse](https://github.com/mangooer/mysql-mcp-server-sse)** - ⭐ 99
...
1749. **[octagon-mcp-server](https://github.com/OctagonAI/octagon-mcp-server)** - ⭐ 99
...
1750. **[FNewsCrawler](https://github.com/noimank/FNewsCrawler)** - ⭐ 99
   一个专门为大模型设计的财经信息MCP（Model Context Protocol）服务，通过高效的爬虫技术从各大财经网站（同花顺、东方财富等）获取实时资讯，为AI模型提供准确、及时的财经数据支持。

1751. **[forge-orchestrator](https://github.com/nxtg-ai/forge-orchestrator)** - ⭐ 99
   Forge Orchestrator: Multi-AI task coordination. File locking, knowledge capture, drift detection. Rust.

1752. **[mpm-vibe-coding](https://github.com/halflifezyf2680/mpm-vibe-coding)** - ⭐ 99
...
1753. **[atomic-red-team-mcp](https://github.com/cyberbuff/atomic-red-team-mcp)** - ⭐ 98
   MCP server for Atomic Red Team

1754. **[mcp-typescript-sdk](https://github.com/emqx/mcp-typescript-sdk)** - ⭐ 98
   A TypeScript SDK for implementing Model Context Protocol (MCP) over MQTT, supporting both browser and Node.js environments.

1755. **[all-in-one-model-context-protocol](https://github.com/nguyenvanduocit/all-in-one-model-context-protocol)** - ⭐ 98
   🚀 All-in-one MCP server with AI search, RAG, and multi-service integrations (GitLab/Jira/Confluence/YouTube) for AI-enhanced development workflows

1756. **[langgraph-ai](https://github.com/piyushagni5/langgraph-ai)** - ⭐ 98
   LangGraph AI Repository

1757. **[mcp-graphiti](https://github.com/rawr-ai/mcp-graphiti)** - ⭐ 98
   Graphiti Model Context Protocol (MCP) Server - An MCP server for knowledge graph management via Graphiti

1758. **[paper-search-mcp-nodejs](https://github.com/Dianel555/paper-search-mcp-nodejs)** - ⭐ 98
...
1759. **[editor-mcp-server](https://github.com/playcanvas/editor-mcp-server)** - ⭐ 98
   MCP Server for AI automation of the PlayCanvas Editor

1760. **[systemprompt-mcp-server](https://github.com/systempromptio/systemprompt-mcp-server)** - ⭐ 98
...
1761. **[perfetto-mcp](https://github.com/antarikshc/perfetto-mcp)** - ⭐ 98
...
1762. **[memorix](https://github.com/AVIDS2/memorix)** - ⭐ 98
...
1763. **[mcp_on_ruby](https://github.com/rubyonai/mcp_on_ruby)** - ⭐ 97
   💎 A Ruby implementation of the Model Context Protocol

1764. **[mcp-sse-demo](https://github.com/cnych/mcp-sse-demo)** - ⭐ 97
   claude mcp sse demo with server and client(cli、web)

1765. **[sandbox-mcp](https://github.com/pottekkat/sandbox-mcp)** - ⭐ 97
   A Model Context Protocol (MCP) server that enables LLMs to run ANY code safely in isolated Docker containers.

1766. **[Vibe-Coder-MCP](https://github.com/freshtechbro/Vibe-Coder-MCP)** - ⭐ 97
    Vibe-Coder-MCP server extends AI assistants with specialized software development tools.

1767. **[openai-gpt-image-mcp](https://github.com/SureScaleAI/openai-gpt-image-mcp)** - ⭐ 97
   A Model Context Protocol (MCP) tool server for OpenAI's GPT-4o/gpt-image-1 image generation and editing APIs.

1768. **[xclaude-plugin](https://github.com/conorluddy/xclaude-plugin)** - ⭐ 97
...
1769. **[gemini-mcp-desktop-client](https://github.com/duke7able/gemini-mcp-desktop-client)** - ⭐ 96
   first gemini based desktop client for MCP

1770. **[searxng-mul-mcp](https://github.com/jae-jae/searxng-mul-mcp)** - ⭐ 96
   A Model Context Protocol (MCP) server for SearXNG search engine with multi-query parallel search support

1771. **[mcp-kit](https://github.com/my-mcp-hub/mcp-kit)** - ⭐ 96
   A CLI tool to create MCP (Model Context Protocol) applications with ease.

1772. **[api2mcp4j](https://github.com/TheEterna/api2mcp4j)** - ⭐ 96
...
1773. **[opencv-mcp-server](https://github.com/GongRzhe/opencv-mcp-server)** - ⭐ 96
...
1774. **[gossiphs](https://github.com/williamfzc/gossiphs)** - ⭐ 96
...
1775. **[ToolsForMCPServer](https://github.com/tanaikech/ToolsForMCPServer)** - ⭐ 96
   The Gemini CLI confirmed that the MCP server built with Google Apps Script (GAS), a low-code platform, offers immense possibilities. If you've created snippets for GAS, these could be revitalized and/or leveraged in new ways by using them as the MCP server. The Gemini CLI and other MCP clients will be useful in achieving this.

1776. **[IB_MCP](https://github.com/rcontesti/IB_MCP)** - ⭐ 96
   This project provides an Interactive Brokers (IB) API interface using the Model Context Protocol (MCP).

1777. **[sparql-llm](https://github.com/sib-swiss/sparql-llm)** - ⭐ 96
   🦜✨ Chat system, MCP server, and reusable components to improve LLMs capabilities when generating SPARQL queries

1778. **[zed-mcp-server-context7](https://github.com/akbxr/zed-mcp-server-context7)** - ⭐ 96
   Context7 MCP Server for Zed

1779. **[mcp-memory-keeper](https://github.com/mkreyman/mcp-memory-keeper)** - ⭐ 96
   MCP server for persistent context management in AI coding assistants

1780. **[needle-mcp](https://github.com/needle-ai/needle-mcp)** - ⭐ 95
   Needle MCP Server for easy RAG.Long-term memory for LLMs.

1781. **[a2ajava](https://github.com/vishalmysore/a2ajava)** - ⭐ 95
...
1782. **[z-image-studio](https://github.com/iconben/z-image-studio)** - ⭐ 95
...
1783. **[fhir-mcp-server](https://github.com/wso2/fhir-mcp-server)** - ⭐ 95
   FHIR MCP Server – helping you expose any FHIR Server or API as a MCP Server.

1784. **[claude-desktop-extension-bear-notes](https://github.com/vasylenko/claude-desktop-extension-bear-notes)** - ⭐ 95
   Claude Desktop extension with bundled MCP Server for Bear note taking app

1785. **[bitbucket-mcp](https://github.com/MatanYemini/bitbucket-mcp)** - ⭐ 95
   Bitbucket MCP - A Model Context Protocol (MCP) server for integrating with Bitbucket Cloud and Server APIs

1786. **[nowledge-mem](https://github.com/nowledge-co/nowledge-mem)** - ⭐ 95
   Memory and context manager just works.

1787. **[bouvet](https://github.com/vrn21/bouvet)** - ⭐ 94
   Sandbox for Agents 

1788. **[semantic-scholar-fastmcp-mcp-server](https://github.com/zongmin-yu/semantic-scholar-fastmcp-mcp-server)** - ⭐ 94
   A FastMCP server implementation for the Semantic Scholar API, providing comprehensive access to academic paper data, author information, and citation networks.

1789. **[ruby-mcp-client](https://github.com/simonx1/ruby-mcp-client)** - ⭐ 94
   This is a Ruby implementation of MCP (Model Context Protocol) client

1790. **[model-context-protocol-mcp-hands-on-with-agentic-ai-2034200](https://github.com/LinkedInLearning/model-context-protocol-mcp-hands-on-with-agentic-ai-2034200)** - ⭐ 94
...
1791. **[mcp-server-idapro](https://github.com/fdrechsler/mcp-server-idapro)** - ⭐ 94
   A Model Context Protocol (MCP) server that enables AI assistants to interact with IDA Pro for reverse engineering and binary analysis tasks.

1792. **[mcp](https://github.com/cloudflare/mcp)** - ⭐ 94
   MCP server for the Cloudflare API

1793. **[schedcp](https://github.com/eunomia-bpf/schedcp)** - ⭐ 93
   MCP Server for Linux Scheduler Management and Auto optimization

1794. **[infobus-mcp](https://github.com/simovilab/infobus-mcp)** - ⭐ 93
   Model Context Protocol server enabling AI assistants to access transit information through standardized interfaces

1795. **[elektron-mcp](https://github.com/zerubeus/elektron-mcp)** - ⭐ 93
   MCP sever for controlling Elektron devices using LLMs

1796. **[MasterMCP](https://github.com/slowmist/MasterMCP)** - ⭐ 93
...
1797. **[mcp-replicate](https://github.com/deepfates/mcp-replicate)** - ⭐ 93
   Model Context Protocol server for Replicate's API

1798. **[gospy](https://github.com/monsterxx03/gospy)** - ⭐ 93
   Non-Invasive goroutine inspector

1799. **[spring-ai-playground](https://github.com/spring-ai-community/spring-ai-playground)** - ⭐ 93
...
1800. **[pluggedin-app](https://github.com/VeriTeknik/pluggedin-app)** - ⭐ 93
   The Crossroads for AI Data Exchanges. A unified, self-hostable web interface for discovering, configuring, and managing Model Context Protocol (MCP) servers—bringing together AI tools, workspaces, prompts, and logs from multiple MCP sources (Claude, Cursor, etc.) under one roof.

1801. **[leetcode-mcp-server](https://github.com/jinzcdev/leetcode-mcp-server)** - ⭐ 93
   An MCP server enabling automated access to LeetCode's problems, solutions, and public data with optional authentication for user-specific features, supporting leetcode.com & leetcode.cn sites.

1802. **[mcp-trino](https://github.com/tuannvm/mcp-trino)** - ⭐ 93
   A high-performance Model Context Protocol (MCP) server for Trino implemented in Go.

1803. **[AgentUp](https://github.com/always-further/AgentUp)** - ⭐ 93
   Portable , scalable , secure AI Agents

1804. **[mcp-server](https://github.com/OctopusDeploy/mcp-server)** - ⭐ 92
   Octopus Deploy Official MCP Server

1805. **[open-mcp-auth-proxy](https://github.com/wso2/open-mcp-auth-proxy)** - ⭐ 92
   Authentication and Authorization Proxy for MCP Servers

1806. **[splunk-mcp](https://github.com/livehybrid/splunk-mcp)** - ⭐ 92
   A Model Context Protocol (MCP) implementation for Splunk Enterprise and Cloud integration with Cursor IDE or Claude

1807. **[mcpcat-typescript-sdk](https://github.com/MCPCat/mcpcat-typescript-sdk)** - ⭐ 92
   MCPcat is an analytics platform for MCP server owners 🐱.

1808. **[deepl-mcp-server](https://github.com/DeepLcom/deepl-mcp-server)** - ⭐ 92
   A Model Context Protocol (MCP) server that provides translation capabilities using the DeepL API.

1809. **[square-mcp-server](https://github.com/square/square-mcp-server)** - ⭐ 92
   A Model Context Protocol (MCP) server for square

1810. **[healthcare-mcp-public](https://github.com/Cicatriiz/healthcare-mcp-public)** - ⭐ 92
   A Model Context Protocol (MCP) server providing AI assistants with access to healthcare data and medical information tools, including FDA drug info, PubMed, medRxiv, NCBI Bookshelf, clinical trials, ICD-10, DICOM metadata, and a medical calculator.

1811. **[tiger-cli](https://github.com/timescale/tiger-cli)** - ⭐ 92
   Tiger CLI is the command-line interface for Tiger Cloud. It includes an MCP server for helping coding agents write production-level Postgres code.

1812. **[action_mcp](https://github.com/seuros/action_mcp)** - ⭐ 92
   Rails Engine with MCP compliant Spec.

1813. **[actual-mcp](https://github.com/s-stefanov/actual-mcp)** - ⭐ 92
   Model Context Protocol for Actual Budget API

1814. **[awesome-mcp-servers-devops](https://github.com/WagnerAgent/awesome-mcp-servers-devops)** - ⭐ 92
...
1815. **[loki-mcp](https://github.com/grafana/loki-mcp)** - ⭐ 92
   An MCP ( Model Context Protocol ) Server for Grafana Loki

1816. **[anubis-mcp](https://github.com/zoedsoupe/anubis-mcp)** - ⭐ 92
   Elixir Model Context Protocol (MCP) SDK (hermes-mcp fork)

1817. **[litegraph](https://github.com/litegraphdb/litegraph)** - ⭐ 91
...
1818. **[vibe](https://github.com/michiosw/vibe)** - ⭐ 91
   Open-Source AI-powered web browser. Browse the web with your own LLM API key. Alternative to Dia / Comet.

1819. **[awsome_kali_MCPServers](https://github.com/ccq1/awsome_kali_MCPServers)** - ⭐ 91
   awsome kali MCPServers is a set of MCP servers tailored for Kali Linux

1820. **[QMT-MCP](https://github.com/guangxiangdebizi/QMT-MCP)** - ⭐ 91
    QMT-MCP 模块化量化交易助手

1821. **[mcp-python-interpreter](https://github.com/yzfly/mcp-python-interpreter)** - ⭐ 90
   MCP Python Interpreter: run python code. Python-mcp-server, mcp-python-server, Code Executor

1822. **[pinescript-mcp-server](https://github.com/cklose2000/pinescript-mcp-server)** - ⭐ 90
   A Model Context Protocol (MCP) server for working with TradingView PineScript

1823. **[stock-mcp](https://github.com/huweihua123/stock-mcp)** - ⭐ 90
   专业的金融市场数据 MCP 服务器 - 支持A股/美股/加密货币，原生 MCP 协议，AI Agent 友好

1824. **[agent-toolkit](https://github.com/sanity-io/agent-toolkit)** - ⭐ 90
   Collection of resources to help AI agents build better with Sanity.

1825. **[generative-ui-playground](https://github.com/CopilotKit/generative-ui-playground)** - ⭐ 90
   Interact with all three types of generative UI, all in one interface

1826. **[molecule-mcp](https://github.com/ChatMol/molecule-mcp)** - ⭐ 89
   A model-context-protocol server for molecules.

1827. **[mcp-server-and-gw](https://github.com/boilingdata/mcp-server-and-gw)** - ⭐ 88
   An MCP stdio to HTTP SSE transport gateway with example server and MCP client

1828. **[mcp-rest-api](https://github.com/dkmaker/mcp-rest-api)** - ⭐ 88
   A TypeScript-based MCP server that enables testing of REST APIs through Cline. This tool allows you to test and interact with any REST API endpoints directly from your development environment.

1829. **[apps-sdk-template](https://github.com/alpic-ai/apps-sdk-template)** - ⭐ 88
   A minimalist Typescript ChatGPT App based on the Skybridge framework

1830. **[mcp-ui](https://github.com/machaojin1917939763/mcp-ui)** - ⭐ 88
   基于MCP(Model Context Protocol)的智能聊天应用，支持Web和桌面环境。集成OpenAI/Anthropic API，提供MCP服务器的所有工具能力。简洁现代的UI设计，支持跨平台部署。

1831. **[amap-mcp-server](https://github.com/sugarforever/amap-mcp-server)** - ⭐ 88
   高德地图MCP Server，支持stdio, sse和streamable-http

1832. **[mcp-agent](https://github.com/Haohao-end/mcp-agent)** - ⭐ 88
   A modular Python framework implementing the Model Context Protocol (MCP). It features a standardized client-server architecture over StdIO, integrating LLMs with external tools, real-time weather data fetching, and an advanced RAG (Retrieval-Augmented Generation) system.

1833. **[mcpgen](https://github.com/lyeslabs/mcpgen)** - ⭐ 88
   Generate Go MCP server boilerplate from OpenAPI 3 specifications

1834. **[chat-ui](https://github.com/AI-QL/chat-ui)** - ⭐ 88
...
1835. **[mcp-sqlite](https://github.com/jparkerweb/mcp-sqlite)** - ⭐ 88
   🐇 Model Context Protocol (MCP) server that provides comprehensive SQLite database interaction capabilities

1836. **[mcp-metatrader5-server](https://github.com/Qoyyuum/mcp-metatrader5-server)** - ⭐ 88
...
1837. **[mem0-mcp](https://github.com/pinkpixel-dev/mem0-mcp)** - ⭐ 87
   ✨ mem0 MCP Server: A memory system using mem0 for AI applications with model context protocl (MCP) integration. Enables long-term memory for AI agents as a drop-in MCP server.

1838. **[achatbot](https://github.com/ai-bot-pro/achatbot)** - ⭐ 87
...
1839. **[awesome-openid-connect](https://github.com/cerberauth/awesome-openid-connect)** - ⭐ 87
...
1840. **[slidev-mcp](https://github.com/LSTM-Kirigaya/slidev-mcp)** - ⭐ 87
   mcp server for slidev to make web ppt quickly and elegantly

1841. **[memory-mcp-server-go](https://github.com/okooo5km/memory-mcp-server-go)** - ⭐ 87
   A Model Context Protocol server that provides knowledge graph management capabilities.

1842. **[reddit-research-mcp](https://github.com/king-of-the-grackles/reddit-research-mcp)** - ⭐ 87
...
1843. **[cve-search_mcp](https://github.com/roadwy/cve-search_mcp)** - ⭐ 87
   A Model Context Protocol (MCP) server for querying the CVE-Search API

1844. **[spring-ai](https://github.com/eazybytes/spring-ai)** - ⭐ 87
   From Java Dev to AI Engineer: Spring AI Fast Track

1845. **[mcp-jenkins](https://github.com/lanbaoshen/mcp-jenkins)** - ⭐ 87
   The Model Context Protocol (MCP) is an open-source implementation that bridges Jenkins with AI language models following Anthropic's MCP specification. This project enables secure, contextual AI interactions with Jenkins tools while maintaining data privacy and security.

1846. **[react-agent-hooks](https://github.com/chuanqisun/react-agent-hooks)** - ⭐ 86
   Turn React hooks into LLM tools

1847. **[mcp-server-llamacloud](https://github.com/run-llama/mcp-server-llamacloud)** - ⭐ 86
   A MCP server connecting to managed indexes on LlamaCloud

1848. **[vggt-mps](https://github.com/jmanhype/vggt-mps)** - ⭐ 86
   VGGT 3D Vision Agent optimized for Apple Silicon with Metal Performance Shaders

1849. **[FrontAgent](https://github.com/ceilf6/FrontAgent)** - ⭐ 86
   AI agent platform for frontend engineering with SDD constraints & MCP-controlled automation. | 面向前端工程的企业级 AI Agent 平台

1850. **[mcp-dbutils](https://github.com/donghao1393/mcp-dbutils)** - ⭐ 86
...
1851. **[furi](https://github.com/ashwwwin/furi)** - ⭐ 86
   CLI & API for MCP management

1852. **[agent-tool-protocol](https://github.com/mondaycom/agent-tool-protocol)** - ⭐ 86
   Agent Tool Protocol

1853. **[ragie-mcp-server](https://github.com/ragieai/ragie-mcp-server)** - ⭐ 86
   Ragie Model Context Protocol Server

1854. **[legion-mcp](https://github.com/TheRaLabs/legion-mcp)** - ⭐ 86
   A server that helps people access and query data in databases using the Legion Query Runner with Model Context Protocol (MCP) in Python.

1855. **[identity](https://github.com/agntcy/identity)** - ⭐ 86
...
1856. **[oxylabs-mcp](https://github.com/oxylabs/oxylabs-mcp)** - ⭐ 86
   Official Oxylabs MCP integration

1857. **[awesome-osint-mcp-servers](https://github.com/soxoj/awesome-osint-mcp-servers)** - ⭐ 86
   A curated list of OSINT MCP servers. Pull requests are welcomed!

1858. **[monarch-mcp-server](https://github.com/robcerda/monarch-mcp-server)** - ⭐ 86
   MCP Server for use with Monarch Money

1859. **[github-stars](https://github.com/ccbikai/github-stars)** - ⭐ 85
   A Cloudflare-powered MCP (Model Context Protocol) Server that allows you to search and query your GitHub starred repositories using natural language.

1860. **[mcp](https://github.com/twilio-labs/mcp)** - ⭐ 85
   Monorepo providing 1) OpenAPI to MCP Tool generator 2) Exposing all of Twilio's API as MCP Tools

1861. **[arbor](https://github.com/Anandb71/arbor)** - ⭐ 85
   Graph-native code intelligence that replaces embedding-based RAG with deterministic program understanding.

1862. **[Delphi-MCP-Server](https://github.com/GDKsoftware/Delphi-MCP-Server)** - ⭐ 85
   Native Delphi Server implementation of the Model Context Protocol (MCP)

1863. **[mcp-dockmaster](https://github.com/dcSpark/mcp-dockmaster)** - ⭐ 84
...
1864. **[spiceflow](https://github.com/remorses/spiceflow)** - ⭐ 84
   Super Simple API framework, type safe, automatic OpenAPI, MCP support, client RPC, streaming with SSE

1865. **[spiceflow-framework](https://github.com/remorses/spiceflow-framework)** - ⭐ 84
   Super Simple API framework, type safe, automatic OpenAPI, MCP support, client RPC, streaming with SSE

1866. **[cursor-rust-tools](https://github.com/terhechte/cursor-rust-tools)** - ⭐ 84
   A MCP server to allow the LLM in Cursor to access Rust Analyzer, Crate Docs and Cargo Commands.

1867. **[mcp-server](https://github.com/cap-js/mcp-server)** - ⭐ 84
   MCP server for AI-assisted development of CAP applications

1868. **[mcp-github-project-manager](https://github.com/kunwarVivek/mcp-github-project-manager)** - ⭐ 83
   a mcp server to manage github project's functionality 

1869. **[mcp-node](https://github.com/algolia/mcp-node)** - ⭐ 83
   MCP server for interacting with Algolia

1870. **[claude-swarm](https://github.com/cj-vana/claude-swarm)** - ⭐ 83
...
1871. **[xiaozhi-mcp-ha](https://github.com/mac8005/xiaozhi-mcp-ha)** - ⭐ 83
   A Home Assistant Custom Integration (HACS) that connects Xiaozhi ESP32 AI chatbot to Home Assistant via MCP

1872. **[viper](https://github.com/ozanunal0/viper)** - ⭐ 83
...
1873. **[mcp-gateway](https://github.com/hyprmcp/mcp-gateway)** - ⭐ 83
...
1874. **[mcp-excel-server](https://github.com/yzfly/mcp-excel-server)** - ⭐ 83
...
1875. **[mcp-canvas-lms](https://github.com/DMontgomery40/mcp-canvas-lms)** - ⭐ 83
...
1876. **[math-mcp](https://github.com/EthanHenrickson/math-mcp)** - ⭐ 83
   A Model Context Protocol (MCP) server that provides basic mathematical and statistical functions to Large Language Models (LLMs). This server enables LLMs to perform accurate numerical calculations through a simple API.

1877. **[fabric-mcp](https://github.com/ksylvan/fabric-mcp)** - ⭐ 83
   Fabric MCP Server: Seamlessly integrate Fabric AI capabilities into MCP-enabled tools like IDEs and chat interfaces.

1878. **[deterministic-agent-control-protocol](https://github.com/elliot35/deterministic-agent-control-protocol)** - ⭐ 83
...
1879. **[fullstack-langgraph-nextjs-agent](https://github.com/agentailor/fullstack-langgraph-nextjs-agent)** - ⭐ 83
...
1880. **[github-chat-mcp](https://github.com/AsyncFuncAI/github-chat-mcp)** - ⭐ 83
   A Model Context Protocol (MCP) for analyzing and querying GitHub repositories using the GitHub Chat API.

1881. **[meta-mcp](https://github.com/brijr/meta-mcp)** - ⭐ 83
   MCP Server for connecting to the Meta Marketing API

1882. **[mcp-server-tauri](https://github.com/hypothesi/mcp-server-tauri)** - ⭐ 83
   A Model Context Protocol (MCP) server and plugin for Tauri v2 development

1883. **[Awesome-Claude-MCP-Servers](https://github.com/win4r/Awesome-Claude-MCP-Servers)** - ⭐ 82
   A curated list of Model Context Protocol (MCP) servers optimized for Claude AI assistants.

1884. **[mcp-n8n-builder](https://github.com/spences10/mcp-n8n-builder)** - ⭐ 82
   🪄 MCP server for programmatic creation and management of n8n workflows. Enables AI assistants to build, modify, and manage workflows without direct user intervention through a comprehensive set of tools and resources for interacting with n8n's REST API.

1885. **[agentic-stock-research-system](https://github.com/rooneyrulz/agentic-stock-research-system)** - ⭐ 82
...
1886. **[dicom-mcp](https://github.com/ChristianHinge/dicom-mcp)** - ⭐ 82
   Model Context Protocol (MCP) for interacting with dicom servers (PACS etc.)

1887. **[ramparts](https://github.com/highflame-ai/ramparts)** - ⭐ 82
   mcp scan that scans any mcp server for indirect attack vectors and security or configuration vulnerabilities

1888. **[mcp-rs-template](https://github.com/linux-china/mcp-rs-template)** - ⭐ 82
   Model Context Protocol (MCP) CLI server template for Rust

1889. **[rohlik-mcp](https://github.com/tomaspavlin/rohlik-mcp)** - ⭐ 82
   MCP server that lets you shop groceries across the Rohlik Group platforms (Rohlik.cz, Knuspr.de, Gurkerl.at, Kifli.hu, Sezamo.ro)

1890. **[gitlab-mr-mcp](https://github.com/kopfrechner/gitlab-mr-mcp)** - ⭐ 82
   Interact seamlessly with GitLab repositories to manage merge requests and issues. Fetch details, add comments, and streamline your code review process with ease.

1891. **[surrealmcp](https://github.com/surrealdb/surrealmcp)** - ⭐ 82
   The official MCP server for SurrealDB

1892. **[office-editor-mcp](https://github.com/theWDY/office-editor-mcp)** - ⭐ 81
   基于MCP(Model Context Protocol)的Office文档处理助手，支持在MCP Client中创建和编辑Word、Excel、Powerpoint文档。

1893. **[mcp-memory-libsql](https://github.com/spences10/mcp-memory-libsql)** - ⭐ 81
   🧠 High-performance persistent memory system for Model Context Protocol (MCP) powered by libSQL. Features vector search, semantic knowledge storage, and efficient relationship management - perfect for AI agents and knowledge graph applications.

1894. **[node-candidate-mcp-server](https://github.com/jhgaylor/node-candidate-mcp-server)** - ⭐ 81
   A Model Context Protocol (MCP) server library that gives LLMs access to information about a candidate.

1895. **[sh-disney-mcp](https://github.com/syyuan14/sh-disney-mcp)** - ⭐ 81
   sh-disney-mcp 是一个基于 Model Context Protocol (MCP) 的mcp server，旨在通过标准化的接口，帮助大模型快速获取上海迪士尼乐园的门票价格和售卖状态信息

1896. **[mcphub](https://github.com/Cognitive-Stack/mcphub)** - ⭐ 81
...
1897. **[anki-mcp-server](https://github.com/CamdenClark/anki-mcp-server)** - ⭐ 81
   A model context protocol server that connects to Anki through AnkiConnect

1898. **[mcp-server](https://github.com/keboola/mcp-server)** - ⭐ 81
   Model Context Protocol (MCP) Server for the Keboola Platform

1899. **[aws-security-mcp](https://github.com/groovyBugify/aws-security-mcp)** - ⭐ 81
   A Model Context Protocol server that connects AI assistants like Claude to AWS security services, allowing them to autonomously query, inspect, and analyze AWS infrastructure for security issues and misconfigurations.

1900. **[mcp-discovery](https://github.com/rust-mcp-stack/mcp-discovery)** - ⭐ 81
   A command-line tool written in Rust for discovering and documenting MCP Server capabilities.

1901. **[NASA-MCP-server](https://github.com/ProgramComputer/NASA-MCP-server)** - ⭐ 81
   A Model Context Protocol (MCP) server for NASA APIs, providing a standardized interface for AI models to interact with NASA's vast array of data sources.

1902. **[advanced-unity-mcp](https://github.com/codemaestroai/advanced-unity-mcp)** - ⭐ 81
   Public repository for Advanced Unity MCP by Code Maestro (www.code-maestro.com).

1903. **[mcp-openapi](https://github.com/ReAPI-com/mcp-openapi)** - ⭐ 81
   OpenAPI specification MCP server.

1904. **[ols4](https://github.com/EBISPOT/ols4)** - ⭐ 81
   The EMBL-EBI Ontology Lookup Service (OLS)

1905. **[mcp-hetzner](https://github.com/dkruyt/mcp-hetzner)** - ⭐ 81
   A Model Context Protocol (MCP) server for interacting with the Hetzner Cloud API. This server allows language models to manage Hetzner Cloud resources through structured functions.

1906. **[mcp-server-stability-ai](https://github.com/tadasant/mcp-server-stability-ai)** - ⭐ 80
...
1907. **[MCPay](https://github.com/microchipgnu/MCPay)** - ⭐ 80
   Open-source Infrastructure for MCP and x402

1908. **[woocommerce-mcp-server](https://github.com/techspawn/woocommerce-mcp-server)** - ⭐ 80
   A WooCommerce (MCP) Model Context Protocol server

1909. **[code-to-tree](https://github.com/micl2e2/code-to-tree)** - ⭐ 80
   A runtime-free MCP server that converts source code into AST🌲, regardless of language.

1910. **[mcp-server-any-openapi](https://github.com/baryhuang/mcp-server-any-openapi)** - ⭐ 80
...
1911. **[mcp-forge](https://github.com/achetronic/mcp-forge)** - ⭐ 80
   A complete MCP server template that include vitamins (oauth authentication included)

1912. **[zed-mcp-server-github](https://github.com/LoamStudios/zed-mcp-server-github)** - ⭐ 80
   A GitHub MCP Server extension for Zed

1913. **[fastmcp-boilerplate](https://github.com/punkpeye/fastmcp-boilerplate)** - ⭐ 79
   A simple MCP server built using FastMCP, TypeScript, ESLint, and Prettier.

1914. **[codemirror-mcp](https://github.com/marimo-team/codemirror-mcp)** - ⭐ 79
   CodeMirror extension to hook up a Model Context Provider (MCP)

1915. **[jira-mcp](https://github.com/nguyenvanduocit/jira-mcp)** - ⭐ 79
...
1916. **[ls-mcp](https://github.com/lirantal/ls-mcp)** - ⭐ 79
   List MCP Server configurations in your system used by AI applications like Cursor, Claude Desktop, VS Code and others

1917. **[mcp-monitor](https://github.com/seekrays/mcp-monitor)** - ⭐ 79
   A system monitoring tool that exposes system metrics via the Model Context Protocol (MCP). This tool allows LLMs to retrieve real-time system information through an MCP-compatible interface.

1918. **[agentic-tools-mcp](https://github.com/Pimzino/agentic-tools-mcp)** - ⭐ 79
   A comprehensive Model Context Protocol (MCP) server providing AI assistants with powerful task management and agent memories capabilities with project-specific storage.

1919. **[glif-mcp-server](https://github.com/glifxyz/glif-mcp-server)** - ⭐ 79
   Easily run glif.app AI workflows inside your LLM: image generators, memes, selfies, and more. Glif supports all major multimedia AI models inside one app

1920. **[mcp-azure-devops](https://github.com/Vortiago/mcp-azure-devops)** - ⭐ 79
   A Model Context Protocol (MCP) server enabling AI assistants to interact with Azure DevOps services via Python SDK.

1921. **[youtrack-mcp](https://github.com/tonyzorin/youtrack-mcp)** - ⭐ 79
...
1922. **[mcp-server-circleci](https://github.com/CircleCI-Public/mcp-server-circleci)** - ⭐ 79
   A specialized server implementation for the Model Context Protocol (MCP) designed to integrate with CircleCI's development workflow. This project serves as a bridge between CircleCI's infrastructure and the Model Context Protocol, enabling enhanced AI-powered development experiences.

1923. **[google-ai-mode-mcp](https://github.com/PleasePrompto/google-ai-mode-mcp)** - ⭐ 79
...
1924. **[XActions](https://github.com/nirholas/XActions)** - ⭐ 79
...
1925. **[Mureka-mcp](https://github.com/SkyworkAI/Mureka-mcp)** - ⭐ 78
   generate lyrics, song and background music(instrumental). Model Context Protocol (MCP) server.

1926. **[django-ai-boost](https://github.com/vintasoftware/django-ai-boost)** - ⭐ 78
   A MCP server for Django applications, inspired by Laravel Boost.

1927. **[rtfmbro-mcp](https://github.com/marckrenn/rtfmbro-mcp)** - ⭐ 78
   rtfmbro provides always-up-to-date, version-specific package documentation as context for coding agents. An alternative to context7

1928. **[one-search-mcp](https://github.com/yokingma/one-search-mcp)** - ⭐ 78
   🚀 OneSearch MCP Server: Web Search & Scraper & Extract,  Support agent-browser, SearXNG, Tavily, DuckDuckGo, Bing, etc.

1929. **[ig-mcp](https://github.com/jlbadano/ig-mcp)** - ⭐ 77
...
1930. **[lucidity-mcp](https://github.com/hyperb1iss/lucidity-mcp)** - ⭐ 77
...
1931. **[visual-ui-debug-agent-mcp](https://github.com/samihalawa/visual-ui-debug-agent-mcp)** - ⭐ 77
   VUDA is an autonomous debugging agent that empowers AI models to visually analyze, test, and debug web

1932. **[devex](https://github.com/ParthKapoor-dev/devex)** - ⭐ 77
   ⚡️ Devex — A Fast, Secure, and Scalable Repl-as-a-Service Platform built for Developers 🚀

1933. **[tester-mcp-client](https://github.com/apify/tester-mcp-client)** - ⭐ 77
   Model Context Protocol (MCP) Client for Apify's Actors

1934. **[terminal_server](https://github.com/theailanguage/terminal_server)** - ⭐ 77
   MCP server that can execute terminal commands

1935. **[mcp-reticle](https://github.com/LabTerminal/mcp-reticle)** - ⭐ 77
   Reticle intercepts, visualizes, and profiles JSON-RPC traffic between your LLM and MCP servers in real-time, with zero latency overhead. Stop debugging blind. Start seeing everything.

1936. **[mcp-llm](https://github.com/sammcj/mcp-llm)** - ⭐ 77
    An MCP server that provides LLMs access to other LLMs

1937. **[bridge4simulator](https://github.com/AppGram/bridge4simulator)** - ⭐ 77
...
1938. **[ExternalAttacker-MCP](https://github.com/MorDavid/ExternalAttacker-MCP)** - ⭐ 77
   A modular external attack surface mapping tool integrating tools for automated reconnaissance and bug bounty workflows.

1939. **[bing-search-mcp](https://github.com/leehanchung/bing-search-mcp)** - ⭐ 77
   MCP Server for Bing Search API

1940. **[sample-agents-with-nova-act-and-mcp](https://github.com/aws-samples/sample-agents-with-nova-act-and-mcp)** - ⭐ 77
...
1941. **[gopher-mcp](https://github.com/GopherSecurity/gopher-mcp)** - ⭐ 77
   MCP C++ SDK - Model Context Protocol implementation in CPP with enterprise-grade security, visibility and connectivity.

1942. **[mcp](https://github.com/vuetifyjs/mcp)** - ⭐ 77
   🤖 A Model Context Protocol (MCP) library for use with Agentic chat bots

1943. **[google-cloud-mcp](https://github.com/krzko/google-cloud-mcp)** - ⭐ 76
   🤖 A Model Context Protocol (MCP) server for Google Cloud (GCP)

1944. **[mcp-gemini-google-search](https://github.com/yukukotani/mcp-gemini-google-search)** - ⭐ 76
   MCP server for Google Search integration using Gemini's built-in search capabilities

1945. **[codeglide-mcpgen](https://github.com/CodeGlide/codeglide-mcpgen)** - ⭐ 76
   Generation of Secure MCP (Model Context Protocol) Servers from API source code at Scale

1946. **[imessage-query-fastmcp-mcp-server](https://github.com/hannesrudolph/imessage-query-fastmcp-mcp-server)** - ⭐ 76
   An MCP server that provides safe access to your iMessage database through Model Context Protocol (MCP). This server is built with the FastMCP framework and the imessagedb library, enabling LLMs to query and analyze iMessage conversations with proper phone number validation and attachment handling.

1947. **[ChEMBL-MCP-Server](https://github.com/Augmented-Nature/ChEMBL-MCP-Server)** - ⭐ 76
   A comprehensive Model Context Protocol (MCP) server providing advanced access to the ChEMBL chemical database.

1948. **[wecom-bot-mcp-server](https://github.com/loonghao/wecom-bot-mcp-server)** - ⭐ 76
...
1949. **[cursor10x-mcp](https://github.com/aiurda/cursor10x-mcp)** - ⭐ 76
   The Cursor10x MCP is a persistent multi-dimensional memory system for Cursor that enhances AI assistants with conversation context, project history, and code relationships across sessions.

1950. **[ophis](https://github.com/njayp/ophis)** - ⭐ 76
   Transform any Cobra CLI into an MCP server

1951. **[quickbooks-online-mcp-server](https://github.com/intuit/quickbooks-online-mcp-server)** - ⭐ 76
...
1952. **[HopperMCP](https://github.com/MxIris-Reverse-Engineering/HopperMCP)** - ⭐ 76
   A Model Context Protocol server for Hopper Disassembler

1953. **[mcp-kafka](https://github.com/kanapuli/mcp-kafka)** - ⭐ 76
   A Model Context Protocol Server to perform Kafka client operations

1954. **[mcpc](https://github.com/mcpc-tech/mcpc)** - ⭐ 76
   Build agentic-MCP servers by composing existing MCP tools.

1955. **[agentic-coding](https://github.com/sammcj/agentic-coding)** - ⭐ 75
   Agentic Coding Rules, Templates etc...

1956. **[jvm-mcp-server](https://github.com/xzq-xu/jvm-mcp-server)** - ⭐ 75
   This is an implementation project of a JVM-based MCP (Model Context Protocol) server. The project aims to provide a standardized MCP server implementation for the JVM platform, enabling AI models to better interact with the Java ecosystem.

1957. **[mcp-llms-txt-explorer](https://github.com/thedaviddias/mcp-llms-txt-explorer)** - ⭐ 75
   MCP to explore websites with llms.txt files

1958. **[rust-mcp-schema](https://github.com/rust-mcp-stack/rust-mcp-schema)** - ⭐ 75
   A type-safe implementation of the official Model Context Protocol (MCP) schema in Rust.

1959. **[choturobo](https://github.com/vishalmysore/choturobo)** - ⭐ 75
...
1960. **[slither-mcp](https://github.com/trailofbits/slither-mcp)** - ⭐ 75
   MCP server for Slither static analysis of Solidity smart contracts

1961. **[ynab-mcp-server](https://github.com/calebl/ynab-mcp-server)** - ⭐ 75
   Model Context Protocol for YNAB (you need a budget)

1962. **[lazy-mcp](https://github.com/voicetreelab/lazy-mcp)** - ⭐ 75
     MCP proxy server with lazy loading support - reduces context usage through on-demand tool activation

1963. **[NetworkOps_Platform](https://github.com/E-Conners-Lab/NetworkOps_Platform)** - ⭐ 75
...
1964. **[SillyTavern-MCP-Client](https://github.com/bmen25124/SillyTavern-MCP-Client)** - ⭐ 74
   An extension of MCP for SillyTavern.

1965. **[ccxt-mcp](https://github.com/lazy-dinosaur/ccxt-mcp)** - ⭐ 74
   CCXT MCP Server bridges the gap between AI models and cryptocurrency trading by providing a standardized interface through the Model Context Protocol. Created to empower automated trading strategies, this tool allows AI assistants like Claude and GPT to directly interact with over 100 cryptocurrency exchanges without requiring users to write comple

1966. **[mcp-fal](https://github.com/am0y/mcp-fal)** - ⭐ 74
   A Model Context Protocol (MCP) server for interacting with fal.ai models and services.

1967. **[windbg-ext-mcp](https://github.com/NadavLor/windbg-ext-mcp)** - ⭐ 74
...
1968. **[masquerade](https://github.com/postralai/masquerade)** - ⭐ 74
   The Privacy Firewall for LLMs

1969. **[perplexity-mcp-zerver](https://github.com/wysh3/perplexity-mcp-zerver)** - ⭐ 74
   MCP web search using perplexity without any API KEYS 

1970. **[bitcoin-mcp](https://github.com/AbdelStark/bitcoin-mcp)** - ⭐ 73
   Bitcoin & Lightning Network MCP Server.

1971. **[conductor-tasks](https://github.com/hridaya423/conductor-tasks)** - ⭐ 73
   A task management system designed for AI development

1972. **[mcp-client-capabilities](https://github.com/apify/mcp-client-capabilities)** - ⭐ 73
   Index of all Model Context Protocol (MCP) clients and their capabilities

1973. **[airtable-mcp](https://github.com/rashidazarang/airtable-mcp)** - ⭐ 73
   Airtable integration for AI-powered applications via Anthropic's Model Context Protocol (MCP)

1974. **[unitree-go2-mcp-server](https://github.com/lpigeon/unitree-go2-mcp-server)** - ⭐ 73
   The Unitree Go2 MCP Server is a server built on the MCP that enables users to control the Unitree Go2 robot using natural language commands interpreted by a LLM.

1975. **[openfoam-mcp-server](https://github.com/webworn/openfoam-mcp-server)** - ⭐ 73
   LLM-powered OpenFOAM MCP server for intelligent CFD education with Socratic questioning and expert error resolution

1976. **[claude-mermaid](https://github.com/veelenga/claude-mermaid)** - ⭐ 73
   MCP Server to previewing mermaid diagrams

1977. **[WeChat-MCP](https://github.com/BiboyQG/WeChat-MCP)** - ⭐ 73
   WeChat-MCP: let Claude/ChatGPT and other AI assistants read and reply to WeChat for you

1978. **[forgemax](https://github.com/postrv/forgemax)** - ⭐ 73
   Code Mode inspired local sandboxed MCP Gateway — collapses N servers x M tools into 2 tools (~1,000 tokens)

1979. **[codebase-mcp](https://github.com/DeDeveloper23/codebase-mcp)** - ⭐ 72
   Model Context Protocol implementation for retrieving codebases using RepoMix

1980. **[ytt-mcp](https://github.com/cottongeeks/ytt-mcp)** - ⭐ 72
   MCP server to fetch YouTube transcripts

1981. **[Custom-MCP-Server](https://github.com/Sharan-Kumar-R/Custom-MCP-Server)** - ⭐ 72
   MCP server for scraping LinkedIn, Facebook, Instagram profiles and Google search.

1982. **[sanity-mcp-server](https://github.com/sanity-io/sanity-mcp-server)** - ⭐ 72
   Deprecated: Use the remote MCP server at https://mcp.sanity.io instead.

1983. **[github-brain](https://github.com/wham/github-brain)** - ⭐ 72
   An experimental GitHub MCP server with local database.

1984. **[BurpSuite-MCP-Server](https://github.com/X3r0K/BurpSuite-MCP-Server)** - ⭐ 72
   BurpSuite MCP Server:  A powerful Model Context Protocol (MCP) server implementation for BurpSuite, providing programmatic access to Burp's core functionalities.

1985. **[tauri-plugin-mcp](https://github.com/P3GLEG/tauri-plugin-mcp)** - ⭐ 72
...
1986. **[junos-mcp-server](https://github.com/Juniper/junos-mcp-server)** - ⭐ 72
...
1987. **[raindrop-io-mcp-server](https://github.com/hiromitsusasaki/raindrop-io-mcp-server)** - ⭐ 72
   An integration that allows LLMs to interact with Raindrop.io bookmarks using the Model Context Protocol (MCP).

1988. **[ncp](https://github.com/portel-dev/ncp)** - ⭐ 71
...
1989. **[MCP-wolfram-alpha](https://github.com/SecretiveShell/MCP-wolfram-alpha)** - ⭐ 71
   Connect your chat repl to wolfram alpha computational intelligence

1990. **[template-mcp-server](https://github.com/mcpdotdirect/template-mcp-server)** - ⭐ 71
   Template to quickly set up your own MCP server 

1991. **[unreal-mcp](https://github.com/runreal/unreal-mcp)** - ⭐ 71
   MCP server for Unreal Engine that uses Unreal Python Remote Execution

1992. **[uml-mcp](https://github.com/antoinebou12/uml-mcp)** - ⭐ 71
...
1993. **[mcp-server-email](https://github.com/Shy2593666979/mcp-server-email)** - ⭐ 71
...
1994. **[mcp-arr](https://github.com/aplaceforallmystuff/mcp-arr)** - ⭐ 71
   MCP server for *arr media management suite

1995. **[trading-mcp](https://github.com/netanelavr/trading-mcp)** - ⭐ 70
   The MCP server that will help you trade smarter (or at least try)

1996. **[airtable-mcp](https://github.com/felores/airtable-mcp)** - ⭐ 70
   Search, create and update Airtable bases, tables, fields, and records using Claude Desktop and MCP (Model Context Protocol) clients

1997. **[railway-mcp](https://github.com/jason-tan-swe/railway-mcp)** - ⭐ 70
   An unofficial and community-built MCP server for integrating with https://railway.app

1998. **[gdai-mcp-plugin-godot](https://github.com/3ddelano/gdai-mcp-plugin-godot)** - ⭐ 70
...
1999. **[OmniMCP](https://github.com/OpenAdaptAI/OmniMCP)** - ⭐ 70
   OmniMCP uses Microsoft OmniParser and Model Context Protocol (MCP) to provide AI models with rich UI context and powerful interaction capabilities.

2000. **[blender-open-mcp](https://github.com/dhakalnirajan/blender-open-mcp)** - ⭐ 70
   Open Models MCP for Blender Using Ollama

2001. **[mcp-openmemory](https://github.com/baryhuang/mcp-openmemory)** - ⭐ 70
   Simple standalone MCP server giving Claude the ability to remember your conversations and learn from them over time.

2002. **[anilist-mcp](https://github.com/yuna0x0/anilist-mcp)** - ⭐ 70
   AniList MCP server for accessing anime and manga data

2003. **[mcp-velociraptor](https://github.com/mgreen27/mcp-velociraptor)** - ⭐ 70
   VelociraptorMCP is a Model Context Protocol bridge for exposing LLMs to MCP clients.

2004. **[MCP-server-Deepseek_R1](https://github.com/66julienmartin/MCP-server-Deepseek_R1)** - ⭐ 69
   A Model Context Protocol (MCP) server implementation connecting Claude Desktop with DeepSeek's language models (R1/V3)

2005. **[mcp-client-python](https://github.com/alejandro-ao/mcp-client-python)** - ⭐ 69

2006. **[markitdown_mcp_server](https://github.com/KorigamiK/markitdown_mcp_server)** - ⭐ 69
   A Model Context Protocol (MCP) server that converts various file formats to Markdown using the MarkItDown utility.

2007. **[ollama-mcp-client](https://github.com/mihirrd/ollama-mcp-client)** - ⭐ 69
   MCP client for local ollama models

2008. **[mcp-discord](https://github.com/barryyip0625/mcp-discord)** - ⭐ 69
   Implement Discord MCP server enabling AI assistants to interact with the Discord platform.

2009. **[tradingview-chart-mcp](https://github.com/ertugrul59/tradingview-chart-mcp)** - ⭐ 69
...
2010. **[joplin-mcp](https://github.com/alondmnt/joplin-mcp)** - ⭐ 69
   MCP server for the Joplin note taking app

2011. **[mcp-wolframalpha](https://github.com/akalaric/mcp-wolframalpha)** - ⭐ 69
   A Python-powered Model Context Protocol MCP server and client that uses Wolfram Alpha via API.

2012. **[turbomcp](https://github.com/Epistates/turbomcp)** - ⭐ 69
   A full featured, enterprise grade rust MCP SDK

2013. **[piapi-mcp-server](https://github.com/apinetwork/piapi-mcp-server)** - ⭐ 69
   A TypeScript implementation of a Model Context Protocol (MCP) server that integrates with PiAPI's API. PiAPI makes user able to generate media content with Midjourney/Flux/Kling/LumaLabs/Udio/Chrip/Trellis directly from Claude or any other MCP-compatible apps.

2014. **[ClueoMCP](https://github.com/ClueoFoundation/ClueoMCP)** - ⭐ 68
...
2015. **[vibe-blocks-mcp](https://github.com/majidmanzarpour/vibe-blocks-mcp)** - ⭐ 68
...
2016. **[agenite](https://github.com/subeshb1/agenite)** - ⭐ 68
...
2017. **[gmail-mcp-server](https://github.com/jasonsum/gmail-mcp-server)** - ⭐ 68
   Model Context Protocol (MCP) server for Gmail

2018. **[mcp-server-datahub](https://github.com/acryldata/mcp-server-datahub)** - ⭐ 68
   The official Model Context Protocol (MCP) server for DataHub (https://datahub.com)

2019. **[boilerplate-mcp-server](https://github.com/aashari/boilerplate-mcp-server)** - ⭐ 68
   TypeScript Model Context Protocol (MCP) server boilerplate providing IP lookup tools/resources. Includes CLI support and extensible structure for connecting AI systems (LLMs) to external data sources like ip-api.com. Ideal template for creating new MCP integrations via Node.js.

2020. **[wasmcp](https://github.com/wasmcp/wasmcp)** - ⭐ 68
   Build MCP servers with WebAssembly components

2021. **[ableton-copilot-mcp](https://github.com/xiaolaa2/ableton-copilot-mcp)** - ⭐ 68
...
2022. **[interactive-brokers-mcp](https://github.com/code-rabi/interactive-brokers-mcp)** - ⭐ 68
   Interactive Brokers MCP Server

2023. **[m3](https://github.com/rafiattrach/m3)** - ⭐ 68
...
2024. **[mcp-server-node](https://github.com/lucianoayres/mcp-server-node)** - ⭐ 68
...
2025. **[xiaohongshu-mcp-python](https://github.com/luyike221/xiaohongshu-mcp-python)** - ⭐ 68
...
2026. **[MCPhoenix](https://github.com/jmanhype/MCPhoenix)** - ⭐ 67
   A simplified implementation of the Model Context Protocol (MCP) server using Elixir's Phoenix Framework.

2027. **[mcp_gradio_client](https://github.com/justjoehere/mcp_gradio_client)** - ⭐ 67
   This is a proof of concept repo on how to create a gradio UI using the Model Context Protocol Client Python SDK.

2028. **[deepseek-thinker-mcp](https://github.com/ruixingshi/deepseek-thinker-mcp)** - ⭐ 67
...
2029. **[deepview-mcp](https://github.com/ai-1st/deepview-mcp)** - ⭐ 67
   DeepView MCP is a Model Context Protocol server that enables IDEs like Cursor and Windsurf to analyze large codebases using Gemini 2.5 Pro's extensive context window.

2030. **[roundtable](https://github.com/askbudi/roundtable)** - ⭐ 67
...
2031. **[MySQL_MCP](https://github.com/guangxiangdebizi/MySQL_MCP)** - ⭐ 67
   这是一个功能强大且易用的MySQL数据库MCP（Model Context Protocol）服务器，让你的AI助手可以安全地进行完整的数据库操作，支持多数据库连接管理、增删改查、事务管理和智能回滚功能。

2032. **[shinzo-ts](https://github.com/shinzo-labs/shinzo-ts)** - ⭐ 67
...
2039. **[lc2mcp](https://github.com/xiaotonng/lc2mcp)** - ⭐ 67
   Convert LangChain tools to FastMCP tools

2040. **[optuna-mcp](https://github.com/optuna/optuna-mcp)** - ⭐ 66
   The Optuna MCP Server is a Model Context Protocol (MCP) server to interact with Optuna APIs.

2041. **[awesome-mcp-best-practices](https://github.com/lirantal/awesome-mcp-best-practices)** - ⭐ 66
   Build Awesome MCPs with Awesome Best Practices for MCP Servers and MCP Clients

2042. **[nautex](https://github.com/hmldns/nautex)** - ⭐ 66
   MCP server for guiding Coding Agents via end-to-end requirements to implementation plan pipeline

2043. **[crash-mcp](https://github.com/nikkoxgonzales/crash-mcp)** - ⭐ 66
   MCP server for structured and efficient reasoning with step validation, branching, and revisions.

2044. **[mcp-gopls](https://github.com/hloiseau/mcp-gopls)** - ⭐ 66
   Model Context Protocol (MCP) server for Go using gopls – LSP-powered analysis, tests, coverage, and tooling.

2045. **[community-servers](https://github.com/mcp-get/community-servers)** - ⭐ 66
...
2046. **[tiny-mcp](https://github.com/wdndev/tiny-mcp)** - ⭐ 66
   Python 实现 MCP client / service

2047. **[flapi](https://github.com/DataZooDE/flapi)** - ⭐ 66
...
2048. **[deep-research-mcp-server](https://github.com/ssdeanx/deep-research-mcp-server)** - ⭐ 66
   MCP Deep Research Server using Gemini creating a Research AI Agent

2049. **[robot_MCP](https://github.com/IliaLarchenko/robot_MCP)** - ⭐ 66
   A simple MCP server for the SO-ARM100 control

2050. **[ros2_mcp](https://github.com/wise-vision/ros2_mcp)** - ⭐ 66
   Advanced MCP Server ROS 2 bridging AI agents straight into robotics

2051. **[VibeShift](https://github.com/GroundNG/VibeShift)** - ⭐ 66
   [MCP Server] The Security Agent for AI assisted coding

2052. **[mcp-bear](https://github.com/jkawamoto/mcp-bear)** - ⭐ 66
   A MCP server for interacting with Bear note-taking software.

2053. **[voice-mcp-agent](https://github.com/den-vasyliev/voice-mcp-agent)** - ⭐ 66
...
2054. **[ipybox](https://github.com/gradion-ai/ipybox)** - ⭐ 66
   Python code execution sandbox with programmatic MCP tool calling (PTC)

2055. **[CanvasMCPClient](https://github.com/n00bvn/CanvasMCPClient)** - ⭐ 65
   Canvas MCP Client is an open-source, self-hostable dashboard application built around an infinite, zoomable, and pannable canvas. It provides a unified interface for interacting with multiple MCP (Model Context Protocol) servers through a flexible, widget-based system.

2056. **[mcp-tutorials](https://github.com/chenmingyong0423/mcp-tutorials)** - ⭐ 65
   Model Context Protocol(MCP) 中文教程讲解

2057. **[mcp4k](https://github.com/ondrsh/mcp4k)** - ⭐ 65
   Compiler-driven MCP framework for Kotlin Multiplatform

2058. **[svelte5-mcp](https://github.com/StudentOfJS/svelte5-mcp)** - ⭐ 65
   A specialized Model Context Protocol (MCP) server for Svelte 5 frontend development

2059. **[fred-mcp-server](https://github.com/stefanoamorelli/fred-mcp-server)** - ⭐ 65
   Open-source FRED MCP Server (Federal Reserve Economic Data)

2060. **[sub-agents-mcp](https://github.com/shinpr/sub-agents-mcp)** - ⭐ 65
   Define task-specific AI sub-agents in Markdown for any MCP-compatible tool.

2061. **[medical-mcp](https://github.com/JamesANZ/medical-mcp)** - ⭐ 65
...
2062. **[mcp-openapi-schema-explorer](https://github.com/kadykov/mcp-openapi-schema-explorer)** - ⭐ 65
   MCP server providing token-efficient access to OpenAPI/Swagger specs via MCP Resource Templates for client-side exploration.

2063. **[mcp-fhir](https://github.com/flexpa/mcp-fhir)** - ⭐ 65
   A Model Context Protocol implementation for FHIR

2064. **[lsd-mcp](https://github.com/lsd-so/lsd-mcp)** - ⭐ 64
   LSD Model Context Protocol

2065. **[ollama-mcp-client](https://github.com/anjor/ollama-mcp-client)** - ⭐ 64

2066. **[mcp-config](https://github.com/marcusschiesser/mcp-config)** - ⭐ 64
   A CLI tool for easy installation of MCP servers and managing their configuration

2067. **[amazon-mcp](https://github.com/Fewsats/amazon-mcp)** - ⭐ 64
   Amazon MCP server to search & buy products using the L402

2068. **[mcp_zoomeye](https://github.com/zoomeye-ai/mcp_zoomeye)** - ⭐ 64
   A Model Context Protocol server that provides network asset information based on query conditions. This server allows LLMs to obtain network asset information and supports querying network asset information by zoomeye dork etc.

2069. **[mcp-all-in-one](https://github.com/vtxf/mcp-all-in-one)** - ⭐ 64
...
2070. **[pydantic-rpc](https://github.com/i2y/pydantic-rpc)** - ⭐ 64
...
2071. **[claude-code-buddy](https://github.com/PCIRCLE-AI/claude-code-buddy)** - ⭐ 64
...
2074. **[purple-mcp](https://github.com/Sentinel-One/purple-mcp)** - ⭐ 64
...
2077. **[Pare](https://github.com/Dave-London/Pare)** - ⭐ 64
   Dev tools, optimized for agents. Structured, token-efficient MCP servers for git, test runners, npm, Docker, and more.

2078. **[mcp-sdk](https://github.com/AntigmaLabs/mcp-sdk)** - ⭐ 63
   Minimalistic Rust Implementation Of Model Context Protocol from Anthropic

2079. **[nutrient-dws-mcp-server](https://github.com/PSPDFKit/nutrient-dws-mcp-server)** - ⭐ 63
   A Model Context Protocol (MCP) server implementation that integrates with the Nutrient Document Web Service (DWS) Processor API, providing powerful PDF processing capabilities for AI assistants.

2080. **[chess-mcp](https://github.com/pab1it0/chess-mcp)** - ⭐ 63
   A Model Context Protocol server for Chess.com's Published Data API.  This provides access to Chess.com player data, game records, and other public information through standardized MCP interfaces, allowing AI assistants to search and analyze chess information.

2081. **[mcp-server](https://github.com/UI5/mcp-server)** - ⭐ 63
   The UI5 MCP server improves the developer experience when working with agentic AI and the UI5 framework.

2082. **[mcp-bridge](https://github.com/firekula/mcp-bridge)** - ⭐ 63
   这是一个为 Cocos Creator 设计的 MCP (Model Context Protocol) 桥接插件，用于连接外部 AI 工具与 Cocos Creator 编辑器，实现对场景、节点等资源的自动化操作。

2083. **[mcp-miro](https://github.com/k-jarzyna/mcp-miro)** - ⭐ 62
   Miro integration for Model Context Protocol

2084. **[mcp-server-ccxt](https://github.com/Nayshins/mcp-server-ccxt)** - ⭐ 62
   Cryptocurrency Market Data MCP Server

2085. **[mcp-durable-object-client](https://github.com/Dhravya/mcp-durable-object-client)** - ⭐ 62
   testing mcps

2086. **[mcp-server-okppt](https://github.com/NeekChaw/mcp-server-okppt)** - ⭐ 62
...
2087. **[xiaozhi-mcp-client](https://github.com/shadowcz007/xiaozhi-mcp-client)** - ⭐ 62
   可视化的配置和管理，给xiaozhi接入mcp

2088. **[data-gov-il-mcp](https://github.com/DavidOsherdiagnostica/data-gov-il-mcp)** - ⭐ 62
   Advanced MCP server for seamless access to Israeli Government Open Data

2089. **[mcpr](https://github.com/devOpifex/mcpr)** - ⭐ 62
   Model Context Protocol server and client for R

2090. **[fli](https://github.com/punitarani/fli)** - ⭐ 62
   Google Flights MCP and Python Library

2091. **[vesta-mac-dist](https://github.com/scouzi1966/vesta-mac-dist)** - ⭐ 62
...
2092. **[UnrealMotionGraphicsMCP](https://github.com/winyunq/UnrealMotionGraphicsMCP)** - ⭐ 62
...
2093. **[mcd-mcp-server](https://github.com/M-China/mcd-mcp-server)** - ⭐ 62
   McDonald's China MCP Server Integration Guide

2094. **[clarity-mcp-server](https://github.com/microsoft/clarity-mcp-server)** - ⭐ 62
   A Model Context Protocol (MCP) server for Microsoft Clarity

2095. **[canvas-mcp](https://github.com/vishalsachdev/canvas-mcp)** - ⭐ 62
   A Model Context Protocol server to run locally and connect to a Canvas LMS 

2096. **[zendesk-mcp-server](https://github.com/reminia/zendesk-mcp-server)** - ⭐ 62
   A Model Context Protocol server for Zendesk

2097. **[ticktick-mcp-server](https://github.com/alexarevalo9/ticktick-mcp-server)** - ⭐ 62
   A Model Context Protocol (MCP) server designed to integrate with the TickTick task management platform, enabling intelligent context-aware task operations and automation.

2098. **[ollama-mcp-bridge](https://github.com/jonigl/ollama-mcp-bridge)** - ⭐ 62
   Extend the Ollama API with dynamic AI tool integration from multiple MCP (Model Context Protocol) servers. Fully compatible, transparent, and developer-friendly, ideal for building powerful local LLM applications, AI agents, and custom chatbots

2099. **[MeiGen-AI-Design-MCP](https://github.com/jau123/MeiGen-AI-Design-MCP)** - ⭐ 62
...
2100. **[xc-mcp](https://github.com/conorluddy/xc-mcp)** - ⭐ 62
...
2101. **[contentful-mcp](https://github.com/ivo-toby/contentful-mcp)** - ⭐ 61
   MCP (Model Context Protocol) server for the Contentful Management API

2102. **[kollektiv-mcp](https://github.com/alexander-zuev/kollektiv-mcp)** - ⭐ 61
...
2103. **[ollama-mcp-db](https://github.com/robdodson/ollama-mcp-db)** - ⭐ 61
...
2104. **[mcp-cn](https://github.com/mengjian-github/mcp-cn)** - ⭐ 61
...
2105. **[yamcp](https://github.com/hamidra/yamcp)** - ⭐ 61
   Organize your MCP servers in local workspaces, share them as Yet-Another-MCP through a single command

2106. **[identity-service](https://github.com/agntcy/identity-service)** - ⭐ 61
...
2107. **[rember-mcp](https://github.com/rember/rember-mcp)** - ⭐ 61
   A Model Context Protocol (MCP) server for Rember.

2108. **[nocodb-mcp-server](https://github.com/edwinbernadus/nocodb-mcp-server)** - ⭐ 61
   nocodb mcp server

2109. **[mcp-clojure-sdk](https://github.com/unravel-team/mcp-clojure-sdk)** - ⭐ 61
   A Clojure SDK to create MCP servers (and eventually clients)

2110. **[fhir-mcp-server](https://github.com/the-momentum/fhir-mcp-server)** - ⭐ 61
   FHIR MCP Server for handling medical data standard.

2111. **[devto-mcp](https://github.com/Arindam200/devto-mcp)** - ⭐ 60
   MCP Server of DevTo

2112. **[mcp-difyworkflow-server](https://github.com/gotoolkits/mcp-difyworkflow-server)** - ⭐ 60
   mcp-difyworkflow-server is an mcp server Tools application that implements the query and invocation of Dify workflows, supporting the on-demand operation of multiple custom Dify workflows.

2113. **[autosteer](https://github.com/notch-ai/autosteer)** - ⭐ 60
   Desktop app for multi-workspace Claude Code management

2114. **[FreeCAD-MCP](https://github.com/ATOI-Ming/FreeCAD-MCP)** - ⭐ 60
...
2115. **[MediaWiki-MCP-Server](https://github.com/ProfessionalWiki/MediaWiki-MCP-Server)** - ⭐ 60
   Model Context Protocol (MCP) Server to connect your AI with any MediaWiki

2116. **[mcp-servers](https://github.com/pulsemcp/mcp-servers)** - ⭐ 60
   MCP (Model Context Protocol) Servers authored and maintained by the PulseMCP team. We build reliable servers thoughtfully designed specifically for MCP Client-powered workflows.

2117. **[baml-agents](https://github.com/Elijas/baml-agents)** - ⭐ 60
   Building Agents with LLM structured generation (BAML), MCP Tools, and 12-Factor Agents principles

2118. **[joplin-mcp-server](https://github.com/dweigend/joplin-mcp-server)** - ⭐ 60
   A Model Context Protocol (MCP) Server for https://joplinapp.org/ that enables note access through the https://modelcontextprotocol.io. Perfect for integration with AI assistants like Claude.

2119. **[academia_mcp](https://github.com/IlyaGusev/academia_mcp)** - ⭐ 60
   Academia MCP server: Tools for automatic scientific research

2120. **[Alph](https://github.com/Aqualia/Alph)** - ⭐ 60
   Universal MCP Server Configuration Manager

2121. **[bc-code-intelligence-mcp](https://github.com/JeremyVyska/bc-code-intelligence-mcp)** - ⭐ 60
...
2122. **[mcp-hub](https://github.com/lobstercare/mcp-hub)** - ⭐ 60
   A curated list of awesome Model Context Protocol (MCP) servers.

2123. **[ocaml-mcp-sdk](https://github.com/bmorphism/ocaml-mcp-sdk)** - ⭐ 59
   OCaml SDK for Model Context Protocol using Jane Street's oxcaml_effect library

2124. **[daipendency-mcp](https://github.com/daipendency/daipendency-mcp)** - ⭐ 59
   Model Context Protocol server for Daipendency

2125. **[smart-pet-with-mcp](https://github.com/shijianzhong/smart-pet-with-mcp)** - ⭐ 59
   一个桌宠形式的mcp client，可以对接任意mcp server,配合测试的mcp server 开源地址：https://github.com/shijianzhong/mcp-server-for-pc

2126. **[cline-mcp-memory-bank](https://github.com/dazeb/cline-mcp-memory-bank)** - ⭐ 59
   A memory system for Cline that tracks progress between conversations.

2127. **[shadcn-ui-mcp-server](https://github.com/ymadd/shadcn-ui-mcp-server)** - ⭐ 59
   MCP server for shadcn/ui component references

2128. **[mcp-server-echart](https://github.com/cnkanwei/mcp-server-echart)** - ⭐ 59
   基于 mcp-go 框架构建的 mcp 服务，它提供了一个能动态生成 ECharts 图表页面的工具。

2129. **[nutrient-document-engine-mcp-server](https://github.com/PSPDFKit/nutrient-document-engine-mcp-server)** - ⭐ 59
   A Model Context Protocol (MCP) server implementation exposes document processing capabilities through natural language, supporting both direct human interaction and AI agent tool calling.

2130. **[mobile-mcp](https://github.com/runablehq/mobile-mcp)** - ⭐ 59
   A Model Context Protocol (MCP) server that provides mobile automation capabilities.

2131. **[mcp_server_gdb](https://github.com/pansila/mcp_server_gdb)** - ⭐ 59
   MCP Server to expose the GDB debugging capabilities

2132. **[time-mcp](https://github.com/yokingma/time-mcp)** - ⭐ 59
   ⏰ Time MCP Server: Giving LLMs Time Awareness Capabilities

2133. **[mcp](https://github.com/abap-ai/mcp)** - ⭐ 59
   ABAP MCP - Model Context Protocol - Server SDK

2134. **[quick-mcp-example](https://github.com/ALucek/quick-mcp-example)** - ⭐ 59
   Short and sweet example MCP server / client implementation for Tools, Resources and Prompts.

2135. **[mono-mcp](https://github.com/sin4ch/mono-mcp)** - ⭐ 59
   A comprehensive Model Context Protocol (MCP) server for Nigerian banking operations using the Mono Open Banking API.

2136. **[zeromcp](https://github.com/mrexodia/zeromcp)** - ⭐ 59
   Zero-dependency MCP server implementation.

2137. **[CodeMCP](https://github.com/SimplyLiz/CodeMCP)** - ⭐ 59
   Code intelligence for AI assistants - MCP server, CLI, and HTTP API with symbol navigation, impact analysis, and architecture mapping

2138. **[pubmed-mcp-server](https://github.com/cyanheads/pubmed-mcp-server)** - ⭐ 59
...
2139. **[bloodhound_mcp](https://github.com/mwnickerson/bloodhound_mcp)** - ⭐ 59
   A Model Context Protocol (MCP) server to converse with data in Bloodhound

2140. **[firefox-devtools-mcp](https://github.com/freema/firefox-devtools-mcp)** - ⭐ 59
   Model Context Protocol server for Firefox DevTools - enables AI assistants to inspect and control Firefox browser through the Remote Debugging Protocol

2141. **[ashra-mcp](https://github.com/getrupt/ashra-mcp)** - ⭐ 58
   A Model Context Protocol server for Ashra

2142. **[create-mcp-app](https://github.com/boguan/create-mcp-app)** - ⭐ 58
   A CLI tool for quickly scaffolding Model Context Protocol (MCP) server applications with TypeScript support and modern development tooling

2143. **[mcp-server-axiom](https://github.com/axiomhq/mcp-server-axiom)** - ⭐ 58
   Axiom Model Context Protocol Server

2144. **[mcpserver](https://github.com/2234839/mcpserver)** - ⭐ 58
   为claude code+glm 添加上眼睛

2145. **[MCP-Dandan](https://github.com/82ch/MCP-Dandan)** - ⭐ 58
   MCP Security Solution for Agentic AI — real-time proxying, behavior analysis, and malicious tool detection

2146. **[job-searchoor](https://github.com/0xDAEF0F/job-searchoor)** - ⭐ 58
   A simple MCP server that delivers you jobs based on your needs

2147. **[mcp-think-tank](https://github.com/flight505/mcp-think-tank)** - ⭐ 58
...
2148. **[scrapegraph-mcp](https://github.com/ScrapeGraphAI/scrapegraph-mcp)** - ⭐ 58
   ScapeGraph MCP Server

2149. **[freecad-mcp](https://github.com/contextform/freecad-mcp)** - ⭐ 58
   FreeCAD MCP - Open-source Model Context Protocol server for FreeCAD automation

2150. **[podman-mcp-server](https://github.com/manusa/podman-mcp-server)** - ⭐ 58
   Model Context Protocol (MCP) server for container runtimes (Podman and Docker)

2151. **[open-skills](https://github.com/besoeasy/open-skills)** - ⭐ 58
   Battle-tested skill library for AI agents. Save 98% of API costs with ready-to-use code for crypto, PDFs, search, web scraping & more. No trial-and-error, no expensive APIs.

2152. **[sublinear-time-solver](https://github.com/ruvnet/sublinear-time-solver)** - ⭐ 58
...
2153. **[stackoverflow-mcp](https://github.com/gscalzo/stackoverflow-mcp)** - ⭐ 58
   A Model Context Protocol server for querying Stack Overflow to help AI models find programming solutions

2154. **[mxcp](https://github.com/raw-labs/mxcp)** - ⭐ 58
   Model eXecution + Context Protocol: Enterprise-Grade Data-to-AI Infrastructure

2155. **[geoserver-mcp](https://github.com/mahdin75/geoserver-mcp)** - ⭐ 58
   A Model Context Protocol (MCP) server implementation that connects LLMs to the GeoServer REST API

2156. **[metis-router](https://github.com/metis-mantis/metis-router)** - ⭐ 57
   MCP router and Web Based MCP client

2157. **[Archive-Agent](https://github.com/shredEngineer/Archive-Agent)** - ⭐ 57
   Find your files with natural language and ask questions.

2158. **[adbfriend](https://github.com/mikepenz/adbfriend)** - ⭐ 57
   Android ADB CLI tool including integrated MCP Server with common adb actions used during development

2159. **[appium-mcp](https://github.com/Rahulec08/appium-mcp)** - ⭐ 57
...
2160. **[mcp-open-library](https://github.com/8enSmith/mcp-open-library)** - ⭐ 57
   A Model Context Protocol (MCP) server for the Internet Archive's Open Library API that enables AI assistants to search for book and author information.

2161. **[mcp-shell](https://github.com/sonirico/mcp-shell)** - ⭐ 57
   Give hands to AI. MCP server to run shell commands securely, auditably, and on demand.

2162. **[mcp-server-synology](https://github.com/atom2ueki/mcp-server-synology)** - ⭐ 57
...
2163. **[mkp](https://github.com/StacklokLabs/mkp)** - ⭐ 57
   MKP is a Model Context Protocol (MCP) server for Kubernetes

2164. **[vscode-mcp](https://github.com/tjx666/vscode-mcp)** - ⭐ 57
...
2165. **[mcp-manager](https://github.com/MediaPublishing/mcp-manager)** - ⭐ 57
   A web-based GUI tool for managing Model Context Protocol (MCP) servers in Claude and Cursor

2166. **[umbraco-mcp](https://github.com/Matthew-Wise/umbraco-mcp)** - ⭐ 57
   A model context protocol  (MCP) server for Umbraco 

2167. **[mcp](https://github.com/twelvedata/mcp)** - ⭐ 57
...
2168. **[naver-search-mcp](https://github.com/isnow890/naver-search-mcp)** - ⭐ 57
...
2169. **[mcp-server-security-standard](https://github.com/mcp-security-standard/mcp-server-security-standard)** - ⭐ 57
...
2170. **[ask-user-questions-mcp](https://github.com/paulp-o/ask-user-questions-mcp)** - ⭐ 57
...
2171. **[mcp-image](https://github.com/shinpr/mcp-image)** - ⭐ 57
...
2172. **[mcp-server-atlassian-jira](https://github.com/aashari/mcp-server-atlassian-jira)** - ⭐ 57
...
2173. **[trpc-mcp-go](https://github.com/trpc-group/trpc-mcp-go)** - ⭐ 57
   Go implementation of the Model Context Protocol (MCP) with comprehensive Streamable HTTP, STDIO, and SSE support. 

2174. **[mcp-gemini-search](https://github.com/arjunprabhulal/mcp-gemini-search)** - ⭐ 56
   Model Context Protocol (MCP) with Gemini 2.5 Pro. Convert conversational queries into flight searches using Gemini's function calling capabilities and MCP's flight search tools

2175. **[Intelli](https://github.com/intelligentnode/Intelli)** - ⭐ 56
   Build multi-model chatbots and agents from intent.

2176. **[mcp-thinking](https://github.com/mattzcarey/mcp-thinking)** - ⭐ 56
   thinking tool for claude desktop/mcp clients using Deepseek reasoner

2177. **[AllVoiceLab-MCP](https://github.com/allvoicelab/AllVoiceLab-MCP)** - ⭐ 56
...
2178. **[solana-mcp-server](https://github.com/openSVM/solana-mcp-server)** - ⭐ 56
   solana mcp sever to enable solana rpc methods

2179. **[mcp-batchit](https://github.com/ryanjoachim/mcp-batchit)** - ⭐ 56
...
2180. **[chucknorris](https://github.com/pollinations/chucknorris)** - ⭐ 56
...
2181. **[anysite-mcp-server](https://github.com/anysiteio/anysite-mcp-server)** - ⭐ 56
   A Model Context Protocol (MCP) server that provides comprehensive access to LinkedIn data and functionalities using the Anysite API, enabling not only data retrieval but also robust management of user accounts.

2182. **[blockbench-mcp-plugin](https://github.com/jasonjgardner/blockbench-mcp-plugin)** - ⭐ 56
   Adds MCP server to Blockbench

2183. **[DecompilerServer](https://github.com/pardeike/DecompilerServer)** - ⭐ 56
...
2184. **[mcp-bridge-api](https://github.com/INQUIRELAB/mcp-bridge-api)** - ⭐ 55
...
2185. **[astro-mcp](https://github.com/morinokami/astro-mcp)** - ⭐ 55
   MCP server to support Astro project development

2186. **[web2mcp](https://github.com/neelsomani/web2mcp)** - ⭐ 55
   Generate an MCP for any web app

2187. **[mcp-ssh](https://github.com/shuakami/mcp-ssh)** - ⭐ 55
   🔐 SSH MCP Tool - AI-powered SSH management through MCP protocol | 基于MCP协议的SSH工具，为AI提供SSH远程操作能力

2188. **[mcp-server-kibana](https://github.com/TocharianOU/mcp-server-kibana)** - ⭐ 55
   MCP server for Kibana, Access search and manage Kibana in MCP Client.

2189. **[attio-mcp-server](https://github.com/kesslerio/attio-mcp-server)** - ⭐ 55
   Attio Model Context Protocol (MCP) server implementation

2190. **[mcp-secrets-plugin](https://github.com/amirshk/mcp-secrets-plugin)** - ⭐ 55
...
2191. **[puremd-mcp](https://github.com/puremd/puremd-mcp)** - ⭐ 55
   Unblock, scrape, and search tools for MCP clients

2192. **[trellis_blender](https://github.com/FishWoWater/trellis_blender)** - ⭐ 55
   Blender plugin for TRELLIS and TRELLIS.2 (3D AIGC Model, Text-to-3D, Image-to-3D)

2193. **[cap-mcp-plugin](https://github.com/gavdilabs/cap-mcp-plugin)** - ⭐ 55
   MCP (Model Context Protocol) server plugin for CAP NodeJS

2194. **[powhttp-mcp](https://github.com/usestring/powhttp-mcp)** - ⭐ 55
   MCP server enabling agents to debug HTTP requests better (using powhttp)

2195. **[mcp-server-flomo](https://github.com/chatmcp/mcp-server-flomo)** - ⭐ 55
   Write notes to Flomo

2196. **[p4mcp-server](https://github.com/perforce/p4mcp-server)** - ⭐ 55
...
2197. **[hulunote](https://github.com/hulunote/hulunote)** - ⭐ 55
   An open-source outliner note-taking application with bidirectional linking.

2198. **[teams-mcp](https://github.com/floriscornel/teams-mcp)** - ⭐ 55
...
2199. **[idea-reality-mcp](https://github.com/mnemox-ai/idea-reality-mcp)** - ⭐ 55
...
2200. **[nasdaq-data-link-mcp](https://github.com/stefanoamorelli/nasdaq-data-link-mcp)** - ⭐ 54
   A Nasdaq Data Link MCP (Model Context Protocol) Server

2201. **[openai-mcp-client](https://github.com/ResoluteError/openai-mcp-client)** - ⭐ 54
   A rudimentary implementation of Anthropic's Model Context Protocol with OpenAIs Model

2202. **[mcp-headless-gmail](https://github.com/baryhuang/mcp-headless-gmail)** - ⭐ 54
   A MCP (Model Context Protocol) server that provides get, send Gmails without local credential or token setup.

2203. **[minibridge](https://github.com/acuvity/minibridge)** - ⭐ 54
   Make your MCP servers secure and production ready

2204. **[mssql_mcp_server](https://github.com/JexinSam/mssql_mcp_server)** - ⭐ 54
   A Model Context Protocol (MCP) server facilitating secure interactions with MSSQL databases.

2205. **[temporal-mcp](https://github.com/Mocksi/temporal-mcp)** - ⭐ 54
   Empowering AI with Workflow Orchestration

2206. **[mcp-server-azure-ai-agents](https://github.com/farzad528/mcp-server-azure-ai-agents)** - ⭐ 54
   Model Context Protocol Servers for Azure AI Search

2207. **[MCP_Atom_of_Thoughts](https://github.com/kbsooo/MCP_Atom_of_Thoughts)** - ⭐ 54
...
2208. **[python](https://github.com/mcp-auth/python)** - ⭐ 54
   🔐 Plug-and-play auth for Python MCP servers.

2209. **[ibkr-mcp-server](https://github.com/seriallazer/ibkr-mcp-server)** - ⭐ 54
   MCP Server for IBKR Client

2210. **[godoctor](https://github.com/danicat/godoctor)** - ⭐ 54
   A Model Context Protocol server for Go developers

2211. **[mcp-duckdb-memory-server](https://github.com/IzumiSy/mcp-duckdb-memory-server)** - ⭐ 54
   MCP Memory Server with DuckDB backend

2212. **[sympy-mcp](https://github.com/sdiehl/sympy-mcp)** - ⭐ 54
   A MCP server for symbolic manipulation of mathematical expressions

2213. **[vrchat-mcp](https://github.com/sawa-zen/vrchat-mcp)** - ⭐ 54
   This project is a Model Context Protocol (MCP) server for interacting with the VRChat API.

2214. **[swift-mcp-gui](https://github.com/NakaokaRei/swift-mcp-gui)** - ⭐ 54
   MCP server that can execute commands such as keyboard input and mouse movement on macOS

2215. **[mcp-docs-service](https://github.com/alekspetrov/mcp-docs-service)** - ⭐ 54
   MCP Documentation Management Service - A Model Context Protocol implementation for documentation management

2216. **[cosmotop](https://github.com/bjia56/cosmotop)** - ⭐ 54
   Multiplatform system monitoring tool using Cosmopolitan Libc

2217. **[mcp-gearbox](https://github.com/rohitsoni007/mcp-gearbox)** - ⭐ 54
   A modern desktop application for managing Model Context Protocol (MCP) servers across multiple AI agents

2218. **[talkito](https://github.com/robdmac/talkito)** - ⭐ 54
...
2219. **[ocaml-mcp](https://github.com/tmattio/ocaml-mcp)** - ⭐ 54
   OCaml implementation of the Model Context Protocol (MCP)

2220. **[tuisic](https://github.com/Dark-Kernel/tuisic)** - ⭐ 54
...
2221. **[rag-app-on-aws](https://github.com/genieincodebottle/rag-app-on-aws)** - ⭐ 54
...
2222. **[mcp-things3](https://github.com/drjforrest/mcp-things3)** - ⭐ 54
...
2223. **[mcp-ssh-manager](https://github.com/bvisible/mcp-ssh-manager)** - ⭐ 54
...
2224. **[mcp-openai](https://github.com/S1M0N38/mcp-openai)** - ⭐ 53
   🔗 MCP Client with OpenAI compatible API

2225. **[NoLLMChat](https://github.com/zrg-team/NoLLMChat)** - ⭐ 53
...
2226. **[gomcp](https://github.com/llmcontext/gomcp)** - ⭐ 53
   Unofficial Golang SDK for Anthropic Model Context Protocol

2227. **[awesome-remote-mcp-servers](https://github.com/sylviangth/awesome-remote-mcp-servers)** - ⭐ 53
   A curated list of Hosted & Managed Model Context Protocol (MCP) Servers accessible via a simple URL endpoint.

2228. **[client](https://github.com/php-mcp/client)** - ⭐ 53
   Core PHP implementation for the Model Context Protocol (MCP) Client

2229. **[user-feedback-mcp](https://github.com/mrexodia/user-feedback-mcp)** - ⭐ 53
   Simple MCP Server to enable a human-in-the-loop workflow in tools like Cline and Cursor.

2230. **[claude-code-emacs](https://github.com/yuya373/claude-code-emacs)** - ⭐ 53
...
2231. **[mcp-swagger-server](https://github.com/zaizaizhao/mcp-swagger-server)** - ⭐ 53
   MCP Swagger Server 将任何符合 OpenAPI/Swagger 规范的 REST API 转换为 Model Context Protocol (MCP) 格式，让 AI 助手能够理解和调用您的 API。

2232. **[Navidrome-MCP](https://github.com/Blakeem/Navidrome-MCP)** - ⭐ 53
...
2233. **[rust-analyzer-mcp](https://github.com/zeenix/rust-analyzer-mcp)** - ⭐ 53
   A Model Context Protocol (MCP) server that provides integration with rust-analyzer

2234. **[Multi-Agent-System-A2A-ADK-MCP](https://github.com/RubensZimbres/Multi-Agent-System-A2A-ADK-MCP)** - ⭐ 53
   Multi-Agent Systems with Google's Agent Development Kit + A2A + MCP

2235. **[agent-security-scanner-mcp](https://github.com/sinewaveai/agent-security-scanner-mcp)** - ⭐ 53
   Security scanner MCP server for AI coding agents. Prompt injection firewall, package hallucination detection (4.3M+ packages), 1000+ vulnerability rules with AST & taint analysis, auto-fix.

2236. **[godot-mcp](https://github.com/bradypp/godot-mcp)** - ⭐ 53
   A Model Context Protocol (MCP) server for interacting with the Godot game engine.

2237. **[agenticmail](https://github.com/agenticmail/agenticmail)** - ⭐ 53
   Email & SMS infrastructure for AI agents — send and receive real email and text messages programmatically

2238. **[cortex-scout](https://github.com/cortex-works/cortex-scout)** - ⭐ 53
...
2241. **[adx-mcp-server](https://github.com/pab1it0/adx-mcp-server)** - ⭐ 52
   A Model Context Protocol (MCP) server that enables AI assistants to query and analyze Azure Data Explorer databases through standardized interfaces.

2242. **[A2A_ADK_MCP](https://github.com/RubensZimbres/A2A_ADK_MCP)** - ⭐ 52
   Multi-Agent Systems with Google's Agent Development Kit + A2A + MCP

2243. **[context-optimizer-mcp-server](https://github.com/malaksedarous/context-optimizer-mcp-server)** - ⭐ 52
   A Model Context Protocol (MCP) server that provides context optimization tools for AI coding assistants including GitHub Copilot, Cursor AI, Claude Desktop, and other MCP-compatible assistants enabling them to extract targeted information rather than processing large terminal outputs and files wasting their context.

2244. **[adk-mcp-a2a-crash-course](https://github.com/chongdashu/adk-mcp-a2a-crash-course)** - ⭐ 52
...
2245. **[scheduler-mcp](https://github.com/PhialsBasement/scheduler-mcp)** - ⭐ 52
...
2246. **[Memory-Plus](https://github.com/Yuchen20/Memory-Plus)** - ⭐ 52
...
2247. **[deploystack](https://github.com/deploystackio/deploystack)** - ⭐ 52
   Open source MCP hosting - deploy MCP servers to HTTP endpoints for n8n, Dify, Voiceflow, and any MCP client.

2248. **[supermcp](https://github.com/dhanababum/supermcp)** - ⭐ 52
...
2249. **[skrills](https://github.com/athola/skrills)** - ⭐ 52
...
2250. **[gdal-mcp](https://github.com/JordanGunn/gdal-mcp)** - ⭐ 52
...
2251. **[mcp-victorialogs](https://github.com/VictoriaMetrics-Community/mcp-victorialogs)** - ⭐ 52
   The implementation of Model Context Protocol (MCP) server for VictoriaLogs.

2252. **[baba_is_eval](https://github.com/lennart-finke/baba_is_eval)** - ⭐ 52
   Claude  et al. play the brilliant puzzle title "Baba is You"

2253. **[ntfy-me-mcp](https://github.com/gitmotion/ntfy-me-mcp)** - ⭐ 52
...
2254. **[us-census-bureau-data-api-mcp](https://github.com/uscensusbureau/us-census-bureau-data-api-mcp)** - ⭐ 52
   The U.S. Census Bureau Data API MCP connects AI Assistants with official Census Bureau statistics.

2255. **[youtube-mcp-server](https://github.com/mourad-ghafiri/youtube-mcp-server)** - ⭐ 52
   A powerful Model Context Protocol (MCP) server for YouTube video transcription and metadata extraction.

2256. **[mcp-server-excel](https://github.com/sbroenne/mcp-server-excel)** - ⭐ 52
   Excel MCP Server & CLI - 23 tools, 214 operations for AI-powered Excel automation via COM API

2257. **[mcp-victorialogs](https://github.com/VictoriaMetrics/mcp-victorialogs)** - ⭐ 52
   The implementation of Model Context Protocol (MCP) server for VictoriaLogs.

2258. **[mcp-mermaid-validator](https://github.com/rtuin/mcp-mermaid-validator)** - ⭐ 51
   A Model Context Protocol server that validates and renders Mermaid diagrams.

2259. **[gomcp](https://github.com/localrivet/gomcp)** - ⭐ 51
...
2260. **[qu3-app](https://github.com/qu3ai/qu3-app)** - ⭐ 51
   Quantum-proof MCP Server and Client Interactions

2261. **[mcp-client](https://github.com/rakesh-eltropy/mcp-client)** - ⭐ 51

2262. **[go-mcp-mysql](https://github.com/Zhwt/go-mcp-mysql)** - ⭐ 51
   Zero burden, ready-to-use Model Context Protocol (MCP) server for interacting with MySQL and automation. No Node.js or Python environment needed.

2263. **[mcp-security-audit](https://github.com/qianniuspace/mcp-security-audit)** - ⭐ 51
   A powerful MCP (Model Context Protocol) Server that audits npm package dependencies for security vulnerabilities. Built with remote npm registry integration for real-time security checks.

2264. **[gdal-mcp](https://github.com/Wayfinder-Foundry/gdal-mcp)** - ⭐ 51
   Model Context Protocol server that packages GDAL-style geospatial workflows through Python-native libraries (Rasterio, GeoPandas, PyProj, etc.) to give AI agents catalog discovery, metadata intelligence, and raster/vector processing with built-in reasoning guidance and reference resources.

2265. **[whois-mcp](https://github.com/bharathvaj-ganesan/whois-mcp)** - ⭐ 51
   MCP Server for whois lookups.

2266. **[tripadvisor-mcp](https://github.com/pab1it0/tripadvisor-mcp)** - ⭐ 51
...
2267. **[pagerduty-mcp-server](https://github.com/PagerDuty/pagerduty-mcp-server)** - ⭐ 51
   PagerDuty's official local MCP (Model Context Protocol) server which provides tools to interact with your PagerDuty account directly from your MCP-enabled client.

2268. **[mcp-atlassian-server](https://github.com/phuc-nt/mcp-atlassian-server)** - ⭐ 51
   MCP server connecting AI assistants with Jira & Confluence for smart project management.

2269. **[kroger-mcp](https://github.com/CupOfOwls/kroger-mcp)** - ⭐ 51
...
2270. **[mcp-kubernetes](https://github.com/Azure/mcp-kubernetes)** - ⭐ 51
   A Model Context Protocol (MCP) server that enables AI assistants to interact with Kubernetes clusters. It serves as a bridge between AI tools (like Claude, Cursor, and GitHub Copilot) and Kubernetes

2271. **[ShadowCrawl](https://github.com/DevsHero/ShadowCrawl)** - ⭐ 51
...
2272. **[rs-utcp](https://github.com/universal-tool-calling-protocol/rs-utcp)** - ⭐ 51
   Official Rust implementation of the UTCP

2273. **[mcp-design-system-extractor](https://github.com/freema/mcp-design-system-extractor)** - ⭐ 51
   MCP (Model Context Protocol) server that enables AI assistants to interact with Storybook design systems. Extract component HTML, analyze styles, and help with design system adoption and refactoring.

2274. **[Skills-ContextManager](https://github.com/One-Man-Company/Skills-ContextManager)** - ⭐ 51
...
2275. **[langfuse-mcp](https://github.com/avivsinai/langfuse-mcp)** - ⭐ 51
   A Model Context Protocol (MCP) server for Langfuse, enabling AI agents to query Langfuse trace data for enhanced debugging and observability

2276. **[mcp-dock](https://github.com/OldJii/mcp-dock)** - ⭐ 51
...
2277. **[Perigon.CLI](https://github.com/AterDev/Perigon.CLI)** - ⭐ 50
...
2278. **[AgentDNS-Node](https://github.com/jsjfai/AgentDNS-Node)** - ⭐ 50
...
2283. **[mcpo_docker_use](https://github.com/flyfox666/mcpo_docker_use)** - ⭐ 50
...
2284. **[AI-Cursor-Scraping-Assistant](https://github.com/TheWebScrapingClub/AI-Cursor-Scraping-Assistant)** - ⭐ 50
...
2285. **[mcp-oauth-gateway](https://github.com/atrawog/mcp-oauth-gateway)** - ⭐ 50
...
2286. **[mcp-server](https://github.com/inkdropapp/mcp-server)** - ⭐ 50
   Inkdrop Model Context Protocol Server

2287. **[model-context-protocol-rb](https://github.com/dickdavis/model-context-protocol-rb)** - ⭐ 50
   An implementation of the Model Context Protocol in Ruby.

2288. **[hmr](https://github.com/promplate/hmr)** - ⭐ 50
   Real hot-module reload for Python—side effects handled reactively. https://py3.online/hmr

2289. **[hackmd-mcp](https://github.com/yuna0x0/hackmd-mcp)** - ⭐ 50
   A Model Context Protocol server for integrating HackMD's note-taking platform with AI assistants.

2290. **[gemini-cloud-assist-mcp](https://github.com/GoogleCloudPlatform/gemini-cloud-assist-mcp)** - ⭐ 50
   An MCP Server for Gemini Cloud Assist; provides tools to assist with your tasks on GCP

2291. **[semanticscholar-MCP-Server](https://github.com/JackKuo666/semanticscholar-MCP-Server)** - ⭐ 50
   🔍 This project implements a Model Context Protocol (MCP) server for interacting with the Semantic Scholar API. It provides tools for searching papers, retrieving paper and author details, and fetching citations and references.

2292. **[clinicaltrialsgov-mcp-server](https://github.com/cyanheads/clinicaltrialsgov-mcp-server)** - ⭐ 50
...
2307. **[crawlbase-mcp](https://github.com/crawlbase/crawlbase-mcp)** - ⭐ 49
   Crawlbase MCP Server connects AI agents and LLMs with real-time web data. It powers Claude, Cursor, and Windsurf integrations with battle-tested web scraping, JavaScript rendering, and anti-bot protection enabling structured, live data inside your AI workflows.

2308. **[mcp-amadeus](https://github.com/donghyun-chae/mcp-amadeus)** - ⭐ 49
   Amadeus MCP(Model Context Protocol) Server

2309. **[mcp-server-atlassian-confluence](https://github.com/aashari/mcp-server-atlassian-confluence)** - ⭐ 49
   Node.js/TypeScript MCP server for Atlassian Confluence. Provides tools enabling AI systems (LLMs) to list/get spaces & pages (content formatted as Markdown) and search via CQL. Connects AI seamlessly to Confluence knowledge bases using the standard MCP interface.

2310. **[activitywatch-mcp-server](https://github.com/8bitgentleman/activitywatch-mcp-server)** - ⭐ 49
   Model Context Protocol server for ActivityWatch time tracking data

2311. **[ai-humanizer-mcp-server](https://github.com/Text2Go/ai-humanizer-mcp-server)** - ⭐ 49
   A powerful Model Context Protocol (MCP) server that helps refine AI-generated content to sound more natural and human-like. Built with advanced AI detection and text enhancement capabilities.

2312. **[caldav-mcp](https://github.com/dominik1001/caldav-mcp)** - ⭐ 48
   A CalDAV client using Model Context Protocol (MCP) to expose calendar operations as tools for AI assistants.

2313. **[auto-MCP-client](https://github.com/Chen-speculation/auto-MCP-client)** - ⭐ 48
...
2314. **[mcp-client-demo](https://github.com/KelvinQiu802/mcp-client-demo)** - ⭐ 48

2315. **[vchart-mcp-server](https://github.com/VisActor/vchart-mcp-server)** - ⭐ 48
   A Model Context Protocol (MCP) server for the @visactor/vchart that enables AI assistants to generate interactive charts and visualizations.

2316. **[mcp-server-chart-minio](https://github.com/zaizaizhao/mcp-server-chart-minio)** - ⭐ 48
   mcp-server-chart私有化部署方案

2317. **[mcp-gitee](https://github.com/oschina/mcp-gitee)** - ⭐ 48
   mcp-gitee is a Model Context Protocol (MCP) server implementation for Gitee. It provides a set of tools that interact with Gitee's API, allowing AI assistants to manage repository, issues, pull requests, etc.

2318. **[lakevision](https://github.com/lakevision-project/lakevision)** - ⭐ 48
   Lakevision is a tool which provides insights into your Apache Iceberg based Data Lakehouse.

2319. **[mcp-rdf-explorer](https://github.com/emekaokoye/mcp-rdf-explorer)** - ⭐ 48
...
2320. **[calculator-mcp-server](https://github.com/huhabla/calculator-mcp-server)** - ⭐ 48
   A Model Context Protocol (MCP) server that provides Claude with advanced mathematical calculation capabilities

2321. **[mcp-dap-server](https://github.com/go-delve/mcp-dap-server)** - ⭐ 48
   MCP server to communicate with DAP servers allowing AI Agents the ability to debug live programs.

2322. **[gimp-mcp](https://github.com/maorcc/gimp-mcp)** - ⭐ 48
   GIMP MCP server

2323. **[mcp-auth-servers](https://github.com/Azure-Samples/mcp-auth-servers)** - ⭐ 48
   🔒 Reference MCP servers that demo how authentication works with the current Model Context Protocol spec.

2324. **[mcp-tts](https://github.com/blacktop/mcp-tts)** - ⭐ 48
   MCP Server for Text to Speech

2325. **[buildkite-mcp-server](https://github.com/buildkite/buildkite-mcp-server)** - ⭐ 48
   Official MCP Server for Buildkite.

2326. **[shotgrid-mcp-server](https://github.com/loonghao/shotgrid-mcp-server)** - ⭐ 48
   A Model Context Protocol (MCP) server for Autodesk ShotGrid/Flow Production Tracking (FPT) with comprehensive CRUD operations and data management capabilities.

2327. **[APIWeaver](https://github.com/GongRzhe/APIWeaver)** - ⭐ 48
...
2328. **[vikunja-mcp](https://github.com/democratize-technology/vikunja-mcp)** - ⭐ 48
   Model Context Protocol server for Vikunja task management. Enables AI assistants to interact with Vikunja instances via MCP.

2329. **[sample-agentic-ai-web](https://github.com/aws-samples/sample-agentic-ai-web)** - ⭐ 48
...
2330. **[crawl4ai-mcp-server](https://github.com/sadiuysal/crawl4ai-mcp-server)** - ⭐ 48
...
2331. **[mcp_demo](https://github.com/Ming-jiayou/mcp_demo)** - ⭐ 47
   A simple example of building an MCP client using C#.

2332. **[kuon](https://github.com/lissettecarlr/kuon)** - ⭐ 47
...
2333. **[claude-mcp-setup](https://github.com/patruff/claude-mcp-setup)** - ⭐ 47
   Easy setup script for Anthropic Claude Model Context Protocol (MCP) servers on Windows

2334. **[spec-coding-mcp](https://github.com/feiyun0112/spec-coding-mcp)** - ⭐ 47
...
2335. **[codex-mcp-go](https://github.com/w31r4/codex-mcp-go)** - ⭐ 47
...
2336. **[mcp](https://github.com/40ants/mcp)** - ⭐ 47
   40ANTS-MCP is a framework for building Model Context Protocol servers in Common Lisp

2337. **[mcp-youtube](https://github.com/adhikasp/mcp-youtube)** - ⭐ 47
   Model Context Protocol to fetch youtube transcript

2338. **[Aspire.MCP.Sample](https://github.com/elbruno/Aspire.MCP.Sample)** - ⭐ 47
   Sample MCP Server and MCP client with Aspire

2339. **[pprof-analyzer-mcp](https://github.com/ZephyrDeng/pprof-analyzer-mcp)** - ⭐ 47
   This is a Model Context Protocol (MCP) server implemented in Go, providing a tool to analyze Go pprof performance profiles.

2340. **[mcp_server_notify](https://github.com/Cactusinhand/mcp_server_notify)** - ⭐ 47
   Send system notification when Agent task is done.

2341. **[gnome-mcp-server](https://github.com/bilelmoussaoui/gnome-mcp-server)** - ⭐ 47
   Grant the AI octopus access to a portion of your desktop

2342. **[dremio-mcp](https://github.com/dremio/dremio-mcp)** - ⭐ 47
   Dremio MCP server

2343. **[advanced-homeassistant-mcp](https://github.com/jango-blockchained/advanced-homeassistant-mcp)** - ⭐ 47
   An advanced MCP server for Home Assistant. 🔋 Batteries included.

2344. **[Reversecore_MCP](https://github.com/sjkim1127/Reversecore_MCP)** - ⭐ 47
...
2345. **[bookstack-mcp-server](https://github.com/pnocera/bookstack-mcp-server)** - ⭐ 47
   A Model Context Protocol (MCP) server providing full access to BookStack's knowledge management capabilities

2346. **[MegaMemory](https://github.com/0xK3vin/MegaMemory)** - ⭐ 47
   Persistent project knowledge graph for coding agents. MCP server with semantic search, in-process embeddings, and web explorer.

2347. **[ns-mcp-server](https://github.com/r-huijts/ns-mcp-server)** - ⭐ 47
   A Model Context Protocol (MCP) server that provides access to NS (Dutch Railways) travel information through Claude AI. This server enables Claude to fetch real-time train travel information and disruptions using the official Dutch NS API.

2348. **[mcp-filter](https://github.com/pro-vi/mcp-filter)** - ⭐ 47
   A proxy MCP (Model Context Protocol) server that filters the upstream tool surface to just the tools you need.

2349. **[codex-specialized-subagents](https://github.com/leonardsellem/codex-specialized-subagents)** - ⭐ 47
   MCP server that lets Codex delegate to isolated codex exec sub-agents, selecting repo+global skills automatically

2350. **[meme-mcp](https://github.com/haltakov/meme-mcp)** - ⭐ 47
   A simple Model Context Protocol (MCP) server for generating memes using the ImgFlip API

2351. **[langchaingo-mcp-adapter](https://github.com/i2y/langchaingo-mcp-adapter)** - ⭐ 47
   A Go adapter that bridges LangChain Go tools with Model Context Protocol (MCP) servers.

2352. **[mcp-openapi-schema](https://github.com/hannesj/mcp-openapi-schema)** - ⭐ 47
   OpenAPI Schema Model Context Protocol Server

2353. **[MayaMCP](https://github.com/PatrickPalmer/MayaMCP)** - ⭐ 47
   Model Context Protocol (MCP) server implementation for Autodesk Maya

2354. **[awesome-openclaw](https://github.com/vincentkoc/awesome-openclaw)** - ⭐ 47
...
2355. **[mcp-ssh](https://github.com/AiondaDotCom/mcp-ssh)** - ⭐ 47
   A Model Context Protocol (MCP) server for managing and controlling SSH connections.

2356. **[langchain-mcp-client](https://github.com/guinacio/langchain-mcp-client)** - ⭐ 46
   This Streamlit application provides a user interface for connecting to MCP (Model Context Protocol) servers and interacting with them using different LLM providers (OpenAI, Anthropic, Google, Ollama).

2357. **[eliza-plugin-mcp](https://github.com/fleek-platform/eliza-plugin-mcp)** - ⭐ 46
   ElizaOS plugin allowing agents to connect to MCP servers

2358. **[Homeassistant-server-mcp](https://github.com/hekmon8/Homeassistant-server-mcp)** - ⭐ 46
   A Model Context Protocol (MCP) server for interacting with Home Assistant. This server provides tools to control and monitor your Home Assistant devices through MCP-enabled applications.

2359. **[mcp-lite-dev](https://github.com/datawhalechina/mcp-lite-dev)** - ⭐ 46
   共学《MCP极简开发》项目代码

2360. **[shadowgit-mcp](https://github.com/blade47/shadowgit-mcp)** - ⭐ 46
...
2361. **[steel-mcp-server](https://github.com/steel-dev/steel-mcp-server)** - ⭐ 46
   MCP Server for interacting with a Steel web browser

2362. **[tiger-slack](https://github.com/timescale/tiger-slack)** - ⭐ 46
   Real-time Slack ingest and MCP server to power your agentic Slack bots

2363. **[modular-mcp](https://github.com/d-kimuson/modular-mcp)** - ⭐ 46
   A Model Context Protocol (MCP) proxy server that enables efficient management of large tool collections across multiple MCP servers by grouping them and loading tool schemas on-demand.

2364. **[abaqus-mcp-server](https://github.com/jianzhichun/abaqus-mcp-server)** - ⭐ 46
...
2365. **[mcp-metabase-server](https://github.com/easecloudio/mcp-metabase-server)** - ⭐ 46
   A comprehensive MCP server for Metabase with 70+ tools.

2366. **[esa-mcp-server](https://github.com/esaio/esa-mcp-server)** - ⭐ 46
   esa.io の公式 MCP(Model Context Protocol)サーバー(STDIO Transport版)

2367. **[mcp-starter-template](https://github.com/StevenStavrakis/mcp-starter-template)** - ⭐ 46
   An opinionated starter template for making Model Context Protocol (MCP) servers

2368. **[flightradar24-mcp-server](https://github.com/sunsetcoder/flightradar24-mcp-server)** - ⭐ 46
   Model Context Protocol server for Flight Tracking

2369. **[Claude-Deep-Research](https://github.com/mcherukara/Claude-Deep-Research)** - ⭐ 46
   An MCP (Model Context Protocol) server that enables comprehensive research capabilities for Claude

2370. **[lunchmoney-mcp](https://github.com/akutishevsky/lunchmoney-mcp)** - ⭐ 46
...
2371. **[MDB-MCP](https://github.com/smadi0x86/MDB-MCP)** - ⭐ 46
   Multi Debugger MCP server that enables LLMs to interact with GDB and LLDB for binary debugging and analysis.

2372. **[globalping-mcp-server](https://github.com/jsdelivr/globalping-mcp-server)** - ⭐ 46
   Remote MCP server that gives LLMs access to run network commands

2373. **[davinci-resolve-mcp](https://github.com/apvlv/davinci-resolve-mcp)** - ⭐ 46
   A Model Context Protocol (MCP) server for interacting with DaVinci Resolve and Fusion

2374. **[mcp-toolbox-sdk-go](https://github.com/googleapis/mcp-toolbox-sdk-go)** - ⭐ 46
   Go SDK for interacting with the MCP Toolbox for Databases.

2375. **[mengram](https://github.com/alibaizhanov/mengram)** - ⭐ 46
...
2376. **[mcp-mail](https://github.com/shuakami/mcp-mail)** - ⭐ 46
   📧 MCP Mail Tool - AI-powered email management tool | 基于 MCP 的智能邮件管理工具

2377. **[mcpcat-python-sdk](https://github.com/MCPCat/mcpcat-python-sdk)** - ⭐ 46
   MCPcat is an analytics platform for MCP server owners 🐱.

2378. **[thoughtbox](https://github.com/Kastalien-Research/thoughtbox)** - ⭐ 46
   Thoughtbox is a Git-inspired workspace for Agent Teams.

2379. **[metabase-mcp](https://github.com/jerichosequitin/metabase-mcp)** - ⭐ 46
...
2380. **[mcp-sdk](https://github.com/symfony/mcp-sdk)** - ⭐ 45
   Model Context Protocol SDK for Client and Server applications in PHP

2381. **[mcp-made-simple](https://github.com/chongdashu/mcp-made-simple)** - ⭐ 45
   Model Context Protocol (MCP) Made Simple - Code for the tutorial series - focusing on practical ways to understand and use MCP

2382. **[Serper-search-mcp](https://github.com/NightTrek/Serper-search-mcp)** - ⭐ 45
   Un-official Serper Google search server for Cline and other MCP clients

2383. **[excalidraw-mcp](https://github.com/i-tozer/excalidraw-mcp)** - ⭐ 45
   Model Context Protocol (MCP) server for Excalidraw - Work in Progress

2384. **[marinade-finance-mcp-server](https://github.com/lorine93s/marinade-finance-mcp-server)** - ⭐ 45
   Marinade Finance MCP Server is an MCP server specifically designed for the Marinade Finance.

2385. **[vercel-ai-docs-mcp](https://github.com/IvanAmador/vercel-ai-docs-mcp)** - ⭐ 45
   A Model Context Protocol (MCP) server that provides AI-powered search and querying capabilities for the Vercel AI SDK documentation. This project enables developers to ask questions about the Vercel AI SDK and receive accurate, contextualized responses based on the official documentation.

2386. **[awesome-mcp-security](https://github.com/AIM-Intelligence/awesome-mcp-security)** - ⭐ 45
   Security Threats related with MCP (Model Context Protocol), MCP Servers and more

2387. **[dataproduct-mcp](https://github.com/entropy-data/dataproduct-mcp)** - ⭐ 45
...
2388. **[lisply-mcp](https://github.com/gornskew/lisply-mcp)** - ⭐ 45
   Model Context Protocol (MCP) server to manage and talk to compliant "Lisply" lisp-speaking backend services

2389. **[js](https://github.com/mcp-auth/js)** - ⭐ 45
   🔐 Plug-and-play auth for Node.js MCP servers.

2390. **[mcp-yfinance-server](https://github.com/Adity-star/mcp-yfinance-server)** - ⭐ 45
   Real-time stock API with Python, MCP server example, yfinance stock analysis dashboard

2391. **[luma-mcp](https://github.com/JochenYang/luma-mcp)** - ⭐ 45
...
2394. **[world_bank_mcp_server](https://github.com/anshumax/world_bank_mcp_server)** - ⭐ 45
   An implementation of the Model Context Protocol for the World Bank open data API

2395. **[mcp-zen](https://github.com/199-mcp/mcp-zen)** - ⭐ 45
   Enhanced Zen MCP Server with 'zen' default tool and improvements

2396. **[ai-software-architect](https://github.com/codenamev/ai-software-architect)** - ⭐ 45
...
2401. **[mailgun-mcp-server](https://github.com/mailgun/mailgun-mcp-server)** - ⭐ 45
   Implementation of Model Context Protocol server for Mailgun APIs

2402. **[altium-mcp](https://github.com/coffeenmusic/altium-mcp)** - ⭐ 45
   Altium Model Context Protocol server and Altium API script

2403. **[moondream-mcp](https://github.com/ColeMurray/moondream-mcp)** - ⭐ 44
   Moondream MCP Server in Python

2404. **[vue-mcp-next](https://github.com/tuskermanshu/vue-mcp-next)** - ⭐ 44
...
2405. **[spring-ai-mcp-client](https://github.com/ogulcanarbc/spring-ai-mcp-client)** - ⭐ 44
...
2406. **[Claude-Project-Coordinator](https://github.com/M-Pineapple/Claude-Project-Coordinator)** - ⭐ 44
...
2407. **[rhinoMcpServer](https://github.com/always-tinkering/rhinoMcpServer)** - ⭐ 44
...
2408. **[ainovelprompter](https://github.com/danielsobrado/ainovelprompter)** - ⭐ 44
   Create the prompts you need to write your Novel using AI

2409. **[mcp-typescribe](https://github.com/yWorks/mcp-typescribe)** - ⭐ 44
   An MCP server implementation enabling LLMs to work with new APIs and frameworks

2410. **[code-screenshot-mcp](https://github.com/MoussaabBadla/code-screenshot-mcp)** - ⭐ 44
   MCP server for generating beautiful code screenshots directly from Claude

2411. **[scaled-mcp](https://github.com/Traego/scaled-mcp)** - ⭐ 44
   ScaledMCP is a horizontally scalabled MCP and A2A Server. You know, for AI.

2412. **[contentful-mcp-server](https://github.com/contentful/contentful-mcp-server)** - ⭐ 44
   MCP (Model Context Protocol) server for the Contentful Management API

2413. **[mcp-container-ts](https://github.com/Azure-Samples/mcp-container-ts)** - ⭐ 44
   This is a quick start guide that provides the basic building blocks to set up a remote Model Context Protocol (MCP) server using Azure Container Apps. The MCP server is built using Node.js and TypeScript, and it can be used to run various tools and services in a serverless environment.

2414. **[python-notebook-mcp](https://github.com/UsamaK98/python-notebook-mcp)** - ⭐ 44
   Lightweight Python Notebook MCP - Enable AI assistants to create, edit, and view Jupyter notebooks via Model Context Protocol

2415. **[dynamic-fastmcp](https://github.com/ragieai/dynamic-fastmcp)** - ⭐ 44
...
2416. **[mcp-agents-hub](https://github.com/mcp-agents-ai/mcp-agents-hub)** - ⭐ 44
   The open-source ecosystem for building, discovering, and deploying Model Context Protocol servers and clients.

2417. **[MCP-Airflow-API](https://github.com/call518/MCP-Airflow-API)** - ⭐ 44
...
2418. **[wechat-mcp](https://github.com/JettChenT/wechat-mcp)** - ⭐ 44
   Model Context Protocol for WeChat

2419. **[devcontext](https://github.com/aiurda/devcontext)** - ⭐ 44
   DevContext is a cutting-edge Model Context Protocol (MCP) server designed to provide developers with continuous, project-centric context awareness. Unlike traditional context systems, DevContext continuously learns from and adapts to your development patterns and delivers highly relevant context providing a deeper understanding of your codebase.

2420. **[smythos-studio](https://github.com/SmythOS/smythos-studio)** - ⭐ 44
...
2421. **[discourse-mcp](https://github.com/discourse/discourse-mcp)** - ⭐ 44
   MCP client for Discourse sites

2422. **[chrome-debug-mcp](https://github.com/robertheadley/chrome-debug-mcp)** - ⭐ 44
   An MCP server to allow you to debug webpages using LLMs

2423. **[lighthouse-mcp-server](https://github.com/danielsogl/lighthouse-mcp-server)** - ⭐ 44
   MCP server that enables AI agents to perform comprehensive web audits using Google Lighthouse with 13+ tools for performance, accessibility, SEO, and security analysis.

2424. **[mcp-server-ledger](https://github.com/minhyeoky/mcp-server-ledger)** - ⭐ 44
   A Model Context Protocol server for interacting with Ledger CLI, a powerful double-entry accounting system. This server enables Large Language Models to query and analyze financial data through a standardized interface, making it easy for AI assistants to help with financial reporting, budget analysis, and accounting tasks.

2425. **[beemcp](https://github.com/OkGoDoIt/beemcp)** - ⭐ 44
   BeeMCP: an unofficial Model Context Protocol (MCP) server that connects your Bee wearable lifelogger to AI via the Model Context Protocol

2426. **[kafka-mcp-server](https://github.com/tuannvm/kafka-mcp-server)** - ⭐ 44
   A Model Context Protocol (MCP) server for Apache Kafka implemented in Go, leveraging franz-go and mcp-go.

2427. **[mcp-codestyle-server](https://github.com/itxaiohanglover/mcp-codestyle-server)** - ⭐ 44
...
2428. **[sharepoint-mcp](https://github.com/DEmodoriGatsuO/sharepoint-mcp)** - ⭐ 44
...
2429. **[osm-mcp](https://github.com/wiseman/osm-mcp)** - ⭐ 44
   Model Context Protocol server for OpenStreetMap data

2430. **[openscad-mcp](https://github.com/quellant/openscad-mcp)** - ⭐ 44
   A Model Context Protocol (MCP) server for OpenSCAD 3D modeling and rendering

2431. **[aivectormemory](https://github.com/Edlineas/aivectormemory)** - ⭐ 44
...
2432. **[generic-mcp-client-chat](https://github.com/rom1504/generic-mcp-client-chat)** - ⭐ 43
   Generic MCP Client to use any MCP tool in a chat

2433. **[thingspanel-mcp](https://github.com/ThingsPanel/thingspanel-mcp)** - ⭐ 43
...
2434. **[MCPP.Net](https://github.com/xuzeyu91/MCPP.Net)** - ⭐ 43
   Model Context Protocol Platform，统一管理你的MCP服务

2435. **[mcp-playground](https://github.com/Elkhn/mcp-playground)** - ⭐ 43
   A Streamlit-based chat app for LLMs with plug-and-play tool support via Model Context Protocol (MCP), powered by LangChain, LangGraph, and Docker.

2436. **[LLaMa-MCP-Streamlit](https://github.com/Nikunj2003/LLaMa-MCP-Streamlit)** - ⭐ 43
   AI assistant built with Streamlit, NVIDIA NIM (LLaMa 3.3:70B) / Ollama, and Model Control Protocol (MCP).

2437. **[pdf-mcp](https://github.com/saury1120/pdf-mcp)** - ⭐ 43
   一个强大的 PDF 处理 MCP（Model Context Protocol）服务，提供全面的 PDF 文档分析功能

2438. **[mcp-servers-kagi](https://github.com/ac3xx/mcp-servers-kagi)** - ⭐ 43
   A Model Context Protocol server implementation for Kagi's API

2439. **[any2markdown](https://github.com/WW-AI-Lab/any2markdown)** - ⭐ 43
...
2440. **[mcp-graphql-schema](https://github.com/hannesj/mcp-graphql-schema)** - ⭐ 43
   GraphQL Schema Model Context Protocol Server

2441. **[openrpc-mcp-server](https://github.com/shanejonas/openrpc-mcp-server)** - ⭐ 43
   A Model Context Protocol (MCP) server that provides JSON-RPC functionality through OpenRPC.

2442. **[mcp-openmsx](https://github.com/nataliapc/mcp-openmsx)** - ⭐ 43
...
2443. **[mcp-rquest](https://github.com/xxxbrian/mcp-rquest)** - ⭐ 43
...
2444. **[MCPApp](https://github.com/tanaikech/MCPApp)** - ⭐ 43
   This text introduces the Model Context Protocol (MCP) for AI interaction, exploring Google Apps Script (GAS) as a server option. It shows feasibility with a sample but notes the lack of a GAS SDK, aiming to encourage understanding and development.

2445. **[salesforce-mcp-server](https://github.com/kablewy/salesforce-mcp-server)** - ⭐ 43
   Model Context Protocol server for Salesforce REST API integration

2446. **[cli](https://github.com/syrin-labs/cli)** - ⭐ 43
   Runtime intelligence system that makes MCP servers debuggable, testable, and safe to run in production.

2447. **[agentic-developer-mcp](https://github.com/teabranch/agentic-developer-mcp)** - ⭐ 43
   An MCP server that scales development into controllable agentic, recursive flows, and build a feature from bottom-up

2448. **[prism-mcp-rs](https://github.com/prismworks-ai/prism-mcp-rs)** - ⭐ 43
   Enterprise-grade Rust implementation of Anthropic's MCP protocol

2449. **[imap-mcp](https://github.com/non-dirty/imap-mcp)** - ⭐ 43
   IMAP Model Context Protocol server for interactive email processing

2450. **[nmap-mcp-server](https://github.com/PhialsBasement/nmap-mcp-server)** - ⭐ 43
   A Model Context Protocol (MCP) server that enables AI assistants to perform network scanning operations using NMAP

2451. **[mcp-ai-memory](https://github.com/scanadi/mcp-ai-memory)** - ⭐ 43
   A production-ready Model Context Protocol (MCP) server for semantic memory management

2452. **[adeu](https://github.com/dealfluence/adeu)** - ⭐ 43
...
2453. **[mcp-server-arangodb](https://github.com/ravenwits/mcp-server-arangodb)** - ⭐ 43
   This is a TypeScript-based MCP server that provides database interaction capabilities through ArangoDB. It implements core database operations and allows seamless integration with ArangoDB through MCP tools. You can use it wih Claude app and also extension for VSCode that works with mcp like Cline!

2454. **[kanban-mcp](https://github.com/bradrisse/kanban-mcp)** - ⭐ 43
...
2455. **[fast-filesystem-mcp](https://github.com/efforthye/fast-filesystem-mcp)** - ⭐ 43
   A high-performance Model Context Protocol (MCP) server that provides secure filesystem access for Claude and other AI assistants.

2456. **[yandex-tracker-mcp](https://github.com/aikts/yandex-tracker-mcp)** - ⭐ 43
   Yandex Tracker MCP Server with OAuth2 support

2457. **[taskMaster-todoist-mcp](https://github.com/mingolladaniele/taskMaster-todoist-mcp)** - ⭐ 42
...
2458. **[solana-dev-mcp](https://github.com/solana-foundation/solana-dev-mcp)** - ⭐ 42
   Solana Model Context Protocol (MCP) Demo

2459. **[awesome-mcp-servers](https://github.com/mctrinh/awesome-mcp-servers)** - ⭐ 42
   A curated list of excellent Model Context Protocol (MCP) servers.

2460. **[mobile-dev-mcp-server](https://github.com/jsuarezruiz/mobile-dev-mcp-server)** - ⭐ 42
   This is a MCP designed to manage and interact with mobile devices and simulators.

2461. **[repl-mcp](https://github.com/simm-is/repl-mcp)** - ⭐ 42
   Model Context Protocol Clojure support including REPL integration with development tools.

2462. **[mcp-logic](https://github.com/angrysky56/mcp-logic)** - ⭐ 42
...
2463. **[zed-mcp-server-sequential-thinking](https://github.com/LoamStudios/zed-mcp-server-sequential-thinking)** - ⭐ 42
   A sequential thinking MCP server extension for Zed

2464. **[gradle-mcp-server](https://github.com/IlyaGulya/gradle-mcp-server)** - ⭐ 42
   A Model Context Protocol (MCP) server to enable AI tools to interact with Gradle projects programmatically.

2465. **[mcp-zenml](https://github.com/zenml-io/mcp-zenml)** - ⭐ 42
   MCP server to connect an MCP client (Cursor, Claude Desktop etc) with your ZenML MLOps and LLMOps pipelines

2466. **[pentestMCP](https://github.com/ramkansal/pentestMCP)** - ⭐ 42
   pentestMCP: AI-Powered Penetration Testing via MCP, an MCP designed for penetration testers.

2467. **[illustrator-mcp-server](https://github.com/spencerhhubert/illustrator-mcp-server)** - ⭐ 42
   mcp server to run scripts on adobe illustrator

2468. **[org-mcp](https://github.com/laurynas-biveinis/org-mcp)** - ⭐ 42
   Emacs Org-mode integration with Model Context Protocol (MCP) for AI-assisted task management

2469. **[reaper-reapy-mcp](https://github.com/wegitor/reaper-reapy-mcp)** - ⭐ 42
...
2470. **[mcp-accessibility-scanner](https://github.com/JustasMonkev/mcp-accessibility-scanner)** - ⭐ 42
   An MCP (Model Context Protocol) server for performing accessibility audits on webpages using axe-core.

2471. **[mcp-server-ios-simulator](https://github.com/atom2ueki/mcp-server-ios-simulator)** - ⭐ 42
   Model Context Protocol (MCP) implementation for iOS simulators

2472. **[mcp-server-js](https://github.com/yepcode/mcp-server-js)** - ⭐ 41
...
2473. **[dynamic-shell-server](https://github.com/codelion/dynamic-shell-server)** - ⭐ 41
   Dynamic Shell Command MCP Server

2474. **[zig-mcp-server](https://github.com/openSVM/zig-mcp-server)** - ⭐ 41
   A Model Context Protocol (MCP) server that provides Zig language tooling, code analysis, and documentation access. This server enhances AI capabilities with Zig-specific functionality including code optimization, compute unit estimation, code generation, and best practices recommendations.

2475. **[mcp](https://github.com/Azure-Samples/mcp)** - ⭐ 41
...
2476. **[dify-mcp-server](https://github.com/AI-FE/dify-mcp-server)** - ⭐ 41
   A Model Context Protocol server for Dify

2477. **[ZMCPTools](https://github.com/ZachHandley/ZMCPTools)** - ⭐ 41
   A custom TypeScript MCP Server intended to be used with Claude Code

2478. **[locallama-mcp](https://github.com/Heratiki/locallama-mcp)** - ⭐ 41
...
2479. **[seekcode](https://github.com/seekrays/seekcode)** - ⭐ 41
   A clean and efficient code snippet and clipboard management tool designed for developers

2480. **[binance-mcp-server](https://github.com/AnalyticAce/binance-mcp-server)** - ⭐ 41
...
2481. **[openrouter-deep-research-mcp](https://github.com/wheattoast11/openrouter-deep-research-mcp)** - ⭐ 41
...
2482. **[beanquery-mcp](https://github.com/vanto/beanquery-mcp)** - ⭐ 41
...
2483. **[embedded-debugger-mcp](https://github.com/Adancurusul/embedded-debugger-mcp)** - ⭐ 41
   A Model Context Protocol server for embedded debugging with probe-rs - supports ARM Cortex-M, RISC-V debugging via J-Link, ST-Link, and more

2484. **[nvim-mcp](https://github.com/linw1995/nvim-mcp)** - ⭐ 41
...
2485. **[platform-context-exporter](https://github.com/alkoleft/platform-context-exporter)** - ⭐ 41
   Инструмент для выгрузки синтаксис помощника в файлы

2486. **[ai-vision-mcp](https://github.com/tan-yong-sheng/ai-vision-mcp)** - ⭐ 41
   A Model Context Protocol (MCP) server that provides vision capabilities to analyze image and video

2487. **[polymarket-mcp](https://github.com/ozgureyilmaz/polymarket-mcp)** - ⭐ 41
   a mcp server for polymarket

2488. **[RivalSearchMCP](https://github.com/damionrashford/RivalSearchMCP)** - ⭐ 41
...
2489. **[instagram-engagement-mcp](https://github.com/Bob-lance/instagram-engagement-mcp)** - ⭐ 41
...
2490. **[MCPToolBenchPP](https://github.com/mcp-tool-bench/MCPToolBenchPP)** - ⭐ 41
   MCPToolBench++ MCP Model Context Protocol Tool Use Benchmark on AI Agent and Model Tool Use Ability

2491. **[Readwise-Reader-MCP](https://github.com/edricgsh/Readwise-Reader-MCP)** - ⭐ 41
   A Model Context Protocol (MCP) server for the Readwise Reader API, built with TypeScript and the official Claude SDK.

2492. **[Fusion-360-MCP-Server](https://github.com/AuraFriday/Fusion-360-MCP-Server)** - ⭐ 41
   Control Fusion 360 with any AI through Model Context Protocol (MCP)

2493. **[linkedin-mcpserver](https://github.com/felipfr/linkedin-mcpserver)** - ⭐ 41
   A powerful Model Context Protocol server for LinkedIn API integration

2494. **[svgmaker-mcp](https://github.com/GenWaveLLC/svgmaker-mcp)** - ⭐ 41
...
2495. **[mcp-server](https://github.com/profullstack/mcp-server)** - ⭐ 40
   A generic, modular server for implementing the Model Context Protocol (MCP). 

2496. **[mcp_rails_template](https://github.com/seuros/mcp_rails_template)** - ⭐ 40
   A minimal Rails API template for creating MCP (Model Context Protocol) servers with robust tool execution capabilities and examples.

2497. **[agentic-mcp-client](https://github.com/peakmojo/agentic-mcp-client)** - ⭐ 40
   A standalone agent runner that executes tasks using MCP (Model Context Protocol) tools via Anthropic Claude, AWS BedRock and OpenAI APIs. It enables AI agents to run autonomously in cloud environments and interact with various systems securely.

2498. **[browser-use-mcp-client](https://github.com/Linzo99/browser-use-mcp-client)** - ⭐ 40
   A MCP client for browser-use

2499. **[mcp-shell](https://github.com/hdresearch/mcp-shell)** - ⭐ 40
   Execute a secure shell in Claude Desktop using the Model Context Protocol.

2500. **[bsky-mcp-server](https://github.com/brianellin/bsky-mcp-server)** - ⭐ 40
   Bluesky MCP (Model Context Protocol) Server

2501. **[just-mcp](https://github.com/toolprint/just-mcp)** - ⭐ 40
   Share the same project justfile tasks with your AI Coding Agent.

2502. **[scraps](https://github.com/boykush/scraps)** - ⭐ 40
   Scraps is a portable CLI knowledge hub for managing interconnected Markdown documentation with Wiki-link notation.

2503. **[Scientific-Papers-MCP](https://github.com/benedict2310/Scientific-Papers-MCP)** - ⭐ 40
...
2504. **[algorand-mcp](https://github.com/GoPlausible/algorand-mcp)** - ⭐ 40
   Algorand Local Model Context Protocol (Server & Client)

2505. **[mcp-panther](https://github.com/panther-labs/mcp-panther)** - ⭐ 40
   Write detections, investigate alerts, and query logs from your favorite AI agents

2506. **[dev-to-mcp](https://github.com/nickytonline/dev-to-mcp)** - ⭐ 40
   A remote Model Context Protocol (MCP) server for interacting with the dev.to public API without requiring authentication.

2507. **[mcp-pyautogui-server](https://github.com/hetaoBackend/mcp-pyautogui-server)** - ⭐ 40
   A MCP (Model Context Protocol) server that provides automated GUI testing and control capabilities through PyAutoGUI.

2508. **[mcp_weather_server](https://github.com/isdaniel/mcp_weather_server)** - ⭐ 40
   A Model Context Protocol (MCP) server that provides weather information using the Open-Meteo API.

2509. **[linkedin-mcp-server](https://github.com/Dishant27/linkedin-mcp-server)** - ⭐ 40
   Model Context Protocol (MCP) server for LinkedIn API integration

2510. **[mcp-obsidian](https://github.com/fazer-ai/mcp-obsidian)** - ⭐ 40
   MCP server for Obsidian (TypeScript + Bun)

2511. **[TWSEMCPServer](https://github.com/twjackysu/TWSEMCPServer)** - ⭐ 40
   台灣證交所OpenAPI 的 MCP Server

2512. **[whatsapp-mcp](https://github.com/felipeadeildo/whatsapp-mcp)** - ⭐ 40
   WhatsApp Unofficial MCP Server

2513. **[shodan-mcp-server](https://github.com/Cyreslab-AI/shodan-mcp-server)** - ⭐ 40
   A Model Context Protocol server that provides access to Shodan API functionality

2514. **[xhs-mcp](https://github.com/Algovate/xhs-mcp)** - ⭐ 40
   用于小红书（xiaohongshu.com）的 Model Context Protocol（MCP）服务器与 CLI 工具，支持登录、发布、搜索、推荐等自动化能力

2515. **[flutter-skill](https://github.com/ai-dashboad/flutter-skill)** - ⭐ 40
...
2516. **[anki-mcp](https://github.com/nietus/anki-mcp)** - ⭐ 39
   MCP server for anki

2517. **[dotcom.chat](https://github.com/kamath/dotcom.chat)** - ⭐ 39
   A simple NextJS MCP client with sensible keybindings

2518. **[MCPollinations](https://github.com/pinkpixel-dev/MCPollinations)** - ⭐ 39
   A Model Context Protocol (MCP) server that enables AI assistants to generate images, text, and audio through the Pollinations APIs. Supports customizable parameters, image saving, and multiple model options.

2519. **[mcp_code_analyzer](https://github.com/emiryasar/mcp_code_analyzer)** - ⭐ 39
   A Model Context Protocol (MCP) server implementation for comprehensive code analysis. This tool integrates with Claude Desktop to provide code analysis capabilities through natural language interactions.

2520. **[mmcp](https://github.com/koki-develop/mmcp)** - ⭐ 39
   🛠️ Manage your MCP (Model Context Protocol) server definitions in one place and apply them to supported agents.

2521. **[mcp-desktop](https://github.com/http4k/mcp-desktop)** - ⭐ 39
   http4k MCP Desktop Client

2522. **[mcp-client-server-host-demo](https://github.com/danwritecode/mcp-client-server-host-demo)** - ⭐ 39
   A quick pokemon demo to showcase MCP server, client, and host

2523. **[mcp](https://github.com/kyopark2014/mcp)** - ⭐ 39
   It shows how to use model-context-protocol. 

2524. **[mssql-mcp](https://github.com/daobataotie/mssql-mcp)** - ⭐ 39
   mssql mcp server

2525. **[mcp_ctl](https://github.com/runablehq/mcp_ctl)** - ⭐ 39
   A package manager to manage all your mcp servers across platforms

2526. **[mcp-android-server-python](https://github.com/nim444/mcp-android-server-python)** - ⭐ 39
   MCP Android agent - This project provides an *MCP (Model Context Protocol)* server for automating Android devices using uiautomator2. It's designed to be easily plugged into AI agents like GitHub Copilot Chat, Claude, or Open Interpreter to control Android devices through natural language.

2527. **[nia](https://github.com/nozomio-labs/nia)** - ⭐ 39
...
2528. **[vscode-agent-todos](https://github.com/digitarald/vscode-agent-todos)** - ⭐ 39
   Gives VS Code agent mode planning superpowers with dynamic todo lists

2529. **[pbixray-mcp-server](https://github.com/jonaolden/pbixray-mcp-server)** - ⭐ 39
...
2530. **[ContextPods](https://github.com/conorluddy/ContextPods)** - ⭐ 39
   Model Context Protocol management suite/factory. An MCP that can generate and manage other local MCPs in multiple languages. Uses the official SDKs for code gen.

2531. **[neurondb](https://github.com/neurondb/neurondb)** - ⭐ 39
   PostgreSQL extension for vector search, embeddings, and ML, plus NeuronAgent runtime and NeuronMCP server.

2532. **[open-ghl-mcp](https://github.com/basicmachines-co/open-ghl-mcp)** - ⭐ 39
   An open source Model Context Protocol server for GoHighLevel API v2 with OAuth

2533. **[search-scrape](https://github.com/DevsHero/search-scrape)** - ⭐ 39
...
2534. **[agent-mcp-gateway](https://github.com/roddutra/agent-mcp-gateway)** - ⭐ 39
...
2535. **[RedBook-Search-Comment-MCP](https://github.com/chenningling/RedBook-Search-Comment-MCP)** - ⭐ 39
   这是一款基于 Playwright 开发的小红书自动搜索和评论工具，作为 MCP Server，可通过特定配置接入 MCP Client，帮助用户自动完成登录小红书、搜索关键词、获取笔记内容及发布智能评论等操作。

2536. **[steampipe-mcp](https://github.com/turbot/steampipe-mcp)** - ⭐ 39
   Enable AI assistants to explore and query your Steampipe data!

2537. **[storybook-mcp](https://github.com/mcpland/storybook-mcp)** - ⭐ 39
   A MCP server for Storybook.

2538. **[webscraping-ai-mcp-server](https://github.com/webscraping-ai/webscraping-ai-mcp-server)** - ⭐ 39
    A Model Context Protocol (MCP) server implementation that integrates with WebScraping.AI for web data extraction capabilities.

2539. **[gatekit](https://github.com/gatekit-ai/gatekit)** - ⭐ 39
   A hackable Model Context Protocol (MCP) gateway

2540. **[mlb-api-mcp](https://github.com/guillochon/mlb-api-mcp)** - ⭐ 39
...
2541. **[mermaid-mcp](https://github.com/Narasimhaponnada/mermaid-mcp)** - ⭐ 39

2542. **[linkedapi-mcp](https://github.com/Linked-API/linkedapi-mcp)** - ⭐ 39
   MCP server that lets AI assistants control LinkedIn accounts and retrieve real-time data.

2543. **[forgejo-mcp](https://github.com/raohwork/forgejo-mcp)** - ⭐ 39
   A MCP server that enables you to manage Gitea/Forgejo repositories through AI assistants

2544. **[How-To-Create-MCP-Server](https://github.com/nisalgunawardhana/How-To-Create-MCP-Server)** - ⭐ 39
   This guide will help you set up a basic MCP (Model Context Protocol) server in .NET, configure it in VS Code, and interact with it using Copilot Chat.

2545. **[mcp-server-leetcode](https://github.com/doggybee/mcp-server-leetcode)** - ⭐ 39
...
2546. **[RiMCP_hybrid](https://github.com/h7lu/RiMCP_hybrid)** - ⭐ 39
   Rimworld Coding RAG MCP server

2547. **[google-drive-mcp](https://github.com/piotr-agier/google-drive-mcp)** - ⭐ 39
...
2548. **[McpDotNet.Extensions.SemanticKernel](https://github.com/StefH/McpDotNet.Extensions.SemanticKernel)** - ⭐ 39
   Microsoft SemanticKernel integration for the Model Context Protocol (MCP). Enables seamless use of MCP tools as AI functions.

2549. **[claude-additional-models-mcp](https://github.com/Arkya-AI/claude-additional-models-mcp)** - ⭐ 39
...
2550. **[openzim-mcp](https://github.com/cameronrye/openzim-mcp)** - ⭐ 39
...
2551. **[mcp-crypto-price](https://github.com/truss44/mcp-crypto-price)** - ⭐ 38
   A Model Context Protocol (MCP) server that provides real-time cryptocurrency analysis via CoinCap's API. Enables Claude and other MCP clients to fetch crypto prices, analyze market trends, and track historical data.

2552. **[mcp-sitecore-server](https://github.com/Antonytm/mcp-sitecore-server)** - ⭐ 38
   Model Context Protocol server for Sitecore

2553. **[middy-mcp](https://github.com/fredericbarthelet/middy-mcp)** - ⭐ 38
   Middy middleware for Model Context Protocol server hosting on AWS Lambda

2554. **[mcp-center](https://github.com/nautilus-ops/mcp-center)** - ⭐ 38
   A centralized platform for managing and connecting MCP servers. MCP Center provides a high-performance proxy service that enables seamless communication between MCP clients and multiple MCP servers.

2555. **[okta-mcp-server](https://github.com/fctr-id/okta-mcp-server)** - ⭐ 38
   The Okta MCP Server is a groundbreaking tool built by the team at Fctr that enables AI models to interact directly with your Okta environment using the Model Context Protocol (MCP). Built specifically for IAM engineers, security teams, and Okta administrators, it implements the MCP specification to help work with Okta enitities

2556. **[grafana-mcp-analyzer](https://github.com/SailingCoder/grafana-mcp-analyzer)** - ⭐ 38
   让AI助手直接分析你的Grafana监控数据 - A Model Context Protocol server for Grafana data analysis

2557. **[prompt-decorators](https://github.com/synaptiai/prompt-decorators)** - ⭐ 38
...
2558. **[DeepCo](https://github.com/succlz123/DeepCo)** - ⭐ 38
   A Chat Client for LLMs, written in Compose Multiplatform.

2559. **[vancouver](https://github.com/jameslong/vancouver)** - ⭐ 38
   Simple MCP server library for Elixir.

2560. **[cdk_pywrapper](https://github.com/sebotic/cdk_pywrapper)** - ⭐ 38
   A Python wrapper for the Chemistry Development Kit (CDK)

2561. **[mocxykit](https://github.com/shunseven/mocxykit)** - ⭐ 38
...
2562. **[comfy-mcp-server](https://github.com/lalanikarim/comfy-mcp-server)** - ⭐ 38
   A server using FastMCP framework to generate images based on prompts via a remote Comfy server.

2563. **[mcpmc](https://github.com/gerred/mcpmc)** - ⭐ 38
   Model Context Protocol Minecraft Server

2564. **[autoteam](https://github.com/diazoxide/autoteam)** - ⭐ 38
   Orchestrate AI agents with YAML-driven workflows via universal Model Context Protocol (MCP)

2565. **[tomtom-mcp](https://github.com/tomtom-international/tomtom-mcp)** - ⭐ 38
   A Model Context Protocol (MCP) server providing TomTom's location services, search, routing, and traffic data to AI agents.

2566. **[mcp-konnect](https://github.com/Kong/mcp-konnect)** - ⭐ 38
   A Model Context Protocol (MCP) server for interacting with Kong Konnect APIs, allowing AI assistants to query and analyze Kong Gateway configurations, traffic, and analytics.

2567. **[nuclei-mcp](https://github.com/addcontent/nuclei-mcp)** - ⭐ 38
...
2568. **[apple-books-mcp](https://github.com/vgnshiyer/apple-books-mcp)** - ⭐ 38
   Apple Books MCP Server

2569. **[kitwork](https://github.com/kitwork/kitwork)** - ⭐ 38
...
2570. **[nostr-mcp](https://github.com/AbdelStark/nostr-mcp)** - ⭐ 38
   A Nostr MCP server that allows to interact with Nostr, enabling posting notes, and more.

2571. **[mcp-tasks](https://github.com/flesler/mcp-tasks)** - ⭐ 38
   A comprehensive and efficient MCP server for task management with multi-format support (Markdown, JSON, YAML)

2572. **[octomind](https://github.com/Muvon/octomind)** - ⭐ 38
   Highly configurable autonomous efficient-first agentic AI framework for CLI

2573. **[reactbits-mcp-server](https://github.com/ceorkm/reactbits-mcp-server)** - ⭐ 38
   MCP server providing access to 135+ animated React components from ReactBits.dev (9.2/10 test score)

2574. **[mcp-gitlab-server](https://github.com/yoda-digital/mcp-gitlab-server)** - ⭐ 38
   Enhanced MCP server for GitLab: group projects listing and activity tracking

2575. **[trivy-mcp](https://github.com/aquasecurity/trivy-mcp)** - ⭐ 38
   Trivy plugin for starting an MCP server

2576. **[context-awesome](https://github.com/bh-rat/context-awesome)** - ⭐ 38
   awesome-lists now available as MCP server for you agent.

2577. **[powerpoint-mcp](https://github.com/Ayushmaniar/powerpoint-mcp)** - ⭐ 38
   Open Source Model Context Protocol server for PowerPoint automation on Windows via pywin32

2578. **[mcp-flight-search](https://github.com/arjunprabhulal/mcp-flight-search)** - ⭐ 38
   MCP Server implementation for the Model Context Protocol (MCP) enabling AI tool usage - Realtime Flight Search 

2579. **[mcp-front](https://github.com/stainless-api/mcp-front)** - ⭐ 38
   Auth proxy for Model Context Protocol servers - adds authentication to MCP tools for Claude.ai, Claude Code, Cursor, Gemini

2580. **[evernote-mcp-server](https://github.com/brentmid/evernote-mcp-server)** - ⭐ 38
   Evernote MCP server - allows LLMs that support MCP (like Claude Desktop) to query your notes in Evernote

2581. **[MCP-Server-Creator](https://github.com/GongRzhe/MCP-Server-Creator)** - ⭐ 38
...
2582. **[codebase-mcp](https://github.com/danyQe/codebase-mcp)** - ⭐ 37
...
2583. **[mcp-summarization-functions](https://github.com/Braffolk/mcp-summarization-functions)** - ⭐ 37
   Provides summarised output from various actions that could otherwise eat up tokens and cause crashes for AI agents 

2584. **[mcp-server-webcrawl](https://github.com/pragmar/mcp-server-webcrawl)** - ⭐ 37
   MCP server tailored to connecting web crawler data and archives

2585. **[gemini-superclaude-mcp-server](https://github.com/Dianel555/gemini-superclaude-mcp-server)** - ⭐ 37
...
2586. **[HAL](https://github.com/DeanWard/HAL)** - ⭐ 37
   HAL (HTTP API Layer) is a Model Context Protocol (MCP) server that provides HTTP API capabilities to Large Language Models.

2587. **[mcp-client-example](https://github.com/artemnovichkov/mcp-client-example)** - ⭐ 37
   Learn how to implement MCP client with SwiftUI and Anthropic API

2588. **[offeryn](https://github.com/avahowell/offeryn)** - ⭐ 37
   Build tools for LLMs in Rust using Model Context Protocol

2589. **[youtrack-mcp](https://github.com/itsalfredakku/youtrack-mcp)** - ⭐ 37
   An MCP (Model Context Protocol) server that provides YouTrack REST API access to AI agents

2590. **[solscan-mcp](https://github.com/wowinter13/solscan-mcp)** - ⭐ 37
   An MCP server for querying Solana transactions using natural language with Solscan API

2591. **[matlab-mcp](https://github.com/Tsuchijo/matlab-mcp)** - ⭐ 37
   Model Context Protocol server to let LLMs write and execute matlab scripts 

2592. **[openai-mcp](https://github.com/arthurcolle/openai-mcp)** - ⭐ 37
   OpenAI Code Assistant Model Context Protocol (MCP) Server

2593. **[dexpaprika-mcp](https://github.com/coinpaprika/dexpaprika-mcp)** - ⭐ 37
...
2594. **[Mcp.Net](https://github.com/SamFold/Mcp.Net)** - ⭐ 37
   A fully featured C# implementation of Anthropic's Model Context Protocol (MCP)

2595. **[pdf-rag-mcp-server](https://github.com/hyson666/pdf-rag-mcp-server)** - ⭐ 37
   PDF RAG server for cursor.

2596. **[GDB-MCP](https://github.com/smadi0x86/GDB-MCP)** - ⭐ 37
   An MCP server that enables LLMs to interact with GDB and LLDB for binary debugging and analysis.

2597. **[mcp-mistral-ocr](https://github.com/everaldo/mcp-mistral-ocr)** - ⭐ 37
   Model Context Protocol (MCP) Server for Mistral OCR API

2598. **[Web-Algebra](https://github.com/AtomGraph/Web-Algebra)** - ⭐ 37
   Suite of generic Linked Data/SPARQL as well as LinkedDataHub-specific MCP tools

2599. **[mcp-anywhere](https://github.com/locomotive-agency/mcp-anywhere)** - ⭐ 37
...
2600. **[keycloak-model-context-protocol](https://github.com/ChristophEnglisch/keycloak-model-context-protocol)** - ⭐ 37
...
2601. **[unreal-mcp](https://github.com/runeape-sats/unreal-mcp)** - ⭐ 37
   Unreal Engine MCP server for Claude Desktop (early alpha preview)

2602. **[nestjs-starter](https://github.com/hmake98/nestjs-starter)** - ⭐ 37
...
2603. **[bonnard-cli](https://github.com/meal-inc/bonnard-cli)** - ⭐ 37
   Ultra-fast to deploy agentic-first mcp-ready semantic layer. Let your data be like water.

2604. **[mcp-wikidata](https://github.com/zzaebok/mcp-wikidata)** - ⭐ 37
   A server implementation for Wikidata API using the Model Context Protocol (MCP).

2605. **[claude-mcp](https://github.com/cnych/claude-mcp)** - ⭐ 37
   Claude Unified Model Context Interaction Protocol

2606. **[reaper-mcp](https://github.com/itsuzef/reaper-mcp)** - ⭐ 37
   A comprehensive Model Context Protocol (MCP) server that enables AI agents to create fully mixed and mastered tracks in REAPER with both MIDI and audio capabilities.

2607. **[metabase-mcp](https://github.com/hluaguo/metabase-mcp)** - ⭐ 37
...
2608. **[ida-headless-mcp](https://github.com/zboralski/ida-headless-mcp)** - ⭐ 37
   Headless IDA Pro binary analysis via Model Context Protocol

2609. **[twenty-crm-mcp-server](https://github.com/mhenry3164/twenty-crm-mcp-server)** - ⭐ 37
...
2610. **[memcord](https://github.com/ukkit/memcord)** - ⭐ 37
   🧠 Privacy-first MCP server for AI memory management. Save, search & organize chat history with intelligent  summarization.

2611. **[React-Native-MCP](https://github.com/MrNitro360/React-Native-MCP)** - ⭐ 37
...
2612. **[mcp-go](https://github.com/riza-io/mcp-go)** - ⭐ 36
   Build Model Context Protocol (MCP) servers in Go

2613. **[baseline-mcp-server](https://github.com/yamanoku/baseline-mcp-server)** - ⭐ 36
   特定のWeb APIに関するBaselineの状況を提供するModel Context Protocolサーバー

2614. **[example-mcp-server](https://github.com/kirill-markin/example-mcp-server)** - ⭐ 36
   A ready-to-use MCP (Model Context Protocol) server template for extending Cursor IDE with custom tools. Deploy your own server to Heroku with one click, create custom commands, and enhance your Cursor IDE experience. Perfect for developers who want to add their own tools and commands to Cursor IDE without complex setup.

2615. **[mcp-governance-sdk](https://github.com/ithena-one/mcp-governance-sdk)** - ⭐ 36
   Enterprise Governance Layer (Identity, RBAC, Credentials, Auditing, Logging, Tracing) for the Model Context Protocol SDK

2616. **[OmniMind](https://github.com/Techiral/OmniMind)** - ⭐ 36
...
2617. **[flutter-mcp-ai-chat](https://github.com/leehack/flutter-mcp-ai-chat)** - ⭐ 36
   Demonstrate how to implement MCP Client in Flutter application with AI.

2618. **[FastDomainCheck-MCP-Server](https://github.com/bingal/FastDomainCheck-MCP-Server)** - ⭐ 36
   A Model Context Protocol for checking domain name registration status in bulk.

2619. **[mcp-debug](https://github.com/giantswarm/mcp-debug)** - ⭐ 36

2620. **[code-mcp](https://github.com/54yyyu/code-mcp)** - ⭐ 36
...
2621. **[MCPNotes](https://github.com/9Ninety/MCPNotes)** - ⭐ 36
   A simple note-taking MCP server for recording and managing notes with AI models.

2622. **[mcp-gateway](https://github.com/theognis1002/mcp-gateway)** - ⭐ 36
...
2623. **[MCP-Microsoft-Office](https://github.com/Aanerud/MCP-Microsoft-Office)** - ⭐ 36
   an local MCP server you can run on your env, connecting you to Microsoft Graph, and the complete M365 eco system.

2624. **[mcp-server-antv](https://github.com/antvis/mcp-server-antv)** - ⭐ 36
...
2625. **[FastAPI-BitNet](https://github.com/grctest/FastAPI-BitNet)** - ⭐ 36
   Running Microsoft's BitNet inference framework via FastAPI, Uvicorn and Docker.

2626. **[a11y-mcp](https://github.com/priyankark/a11y-mcp)** - ⭐ 36
   An MCP (Model Context Protocol) server for performing accessibility audits on webpages using axe-core. Use the results in an agentic loop with your favorite AI assistants (Amp/Cline/Cursor/GH Copilot) and let them fix a11y issues for you!

2627. **[storyblok-mcp-server](https://github.com/Kiran1689/storyblok-mcp-server)** - ⭐ 36
...
2628. **[mcp-google-cse](https://github.com/Richard-Weiss/mcp-google-cse)** - ⭐ 36
   A Model Context Protocol server that provides search capabilities using a Google CSE (custom search engine).

2629. **[coin_api_mcp](https://github.com/longmans/coin_api_mcp)** - ⭐ 36
   A Model Context Protocol server that provides access to CoinMarketCap's cryptocurrency data. This server enables AI-powered applications to retrieve cryptocurrency listings, quotes, and detailed information about various coins.

2630. **[mcp-crew-ai](https://github.com/adam-paterson/mcp-crew-ai)** - ⭐ 36
   MCP Crew AI Server is a lightweight Python-based server designed to run, manage and create CrewAI workflows.

2631. **[Handler](https://github.com/alDuncanson/Handler)** - ⭐ 36
   A2A Protocol client and developer toolkit.

2632. **[mcp-security-inspector](https://github.com/purpleroc/mcp-security-inspector)** - ⭐ 36
   一个用于检测Model Context Protocol (MCP)安全性的Chrome扩展工具。

2633. **[mcp-bundle](https://github.com/symfony/mcp-bundle)** - ⭐ 36
   Symfony integration bundle for Model Context Protocol (via official mcp/sdk)

2634. **[mcp-zero](https://github.com/zeromicro/mcp-zero)** - ⭐ 36
   Model Context Protocol (MCP) server for go-zero framework - Generate APIs, RPC services, and models with AI assistance.

2635. **[mcp-databricks-server](https://github.com/RafaelCartenet/mcp-databricks-server)** - ⭐ 36
...
2636. **[kirby-mcp](https://github.com/bnomei/kirby-mcp)** - ⭐ 36
...
2637. **[ai-workshop](https://github.com/dotnet-presentations/ai-workshop)** - ⭐ 36
   Building GenAI Apps in C#: AI Templates, GitHub Models, Azure OpenAI & More

2638. **[agentic-commerce-protocol-demo](https://github.com/locus-technologies/agentic-commerce-protocol-demo)** - ⭐ 36
   Reference implementation of OpenAI's Agentic Commerce Protocol (ACP)

2639. **[salesforce-mcp-server](https://github.com/jaworjar95/salesforce-mcp-server)** - ⭐ 36
   A comprehensive Model Context Protocol (MCP) server that provides seamless Salesforce integration for AI development tools like Claude Desktop, Cline, and other MCP-compatible clients.

2640. **[mcp-appstore](https://github.com/appreply-co/mcp-appstore)** - ⭐ 36
...
2641. **[google-workspace-mcp](https://github.com/dguido/google-workspace-mcp)** - ⭐ 36
   MCP server for Google Drive, Docs, Sheets, Slides, Calendar, Gmail, and Contacts

2642. **[adal-cli](https://github.com/SylphAI-Inc/adal-cli)** - ⭐ 36
...
2643. **[keycloak-mcp-server](https://github.com/sshaaf/keycloak-mcp-server)** - ⭐ 36
...
2644. **[jina-mcp-tools](https://github.com/PsychArch/jina-mcp-tools)** - ⭐ 36
   A Model Context Protocol (MCP) server that integrates with Jina AI Search Foundation APIs.

2645. **[mcp-server](https://github.com/Aayush9029/mcp-server)** - ⭐ 36
   MCP SERVER

2646. **[MCPDocSearch](https://github.com/alizdavoodi/MCPDocSearch)** - ⭐ 36
...
2647. **[tasker-mcp](https://github.com/dceluis/tasker-mcp)** - ⭐ 35
   An MCP server for Android's Tasker automation app.

2648. **[mcp-file-context-server](https://github.com/bsmi021/mcp-file-context-server)** - ⭐ 35
   A Model Context Protocol (MCP) server that provides file system context to Large Language Models (LLMs). This server enables LLMs to read, search, and analyze code files with advanced caching and real-time file watching capabilities.

2649. **[mcp-gemini-server](https://github.com/bsmi021/mcp-gemini-server)** - ⭐ 35
   This project provides a dedicated MCP (Model Context Protocol) server that wraps the @google/genai SDK. It exposes Google's Gemini model capabilities as standard MCP tools, allowing other LLMs (like Cline) or MCP-compatible systems to leverage Gemini's features as a backend workhorse.

2650. **[esa-mcp-server](https://github.com/d-kimuson/esa-mcp-server)** - ⭐ 35
   esa の Model Context Protocol サーバー実装

2651. **[mcp-langchain-ts-client](https://github.com/isaacwasserman/mcp-langchain-ts-client)** - ⭐ 35
   LangChain.js client for Model Context Protocol.

2652. **[mcp-sandbox](https://github.com/JohanLi233/mcp-sandbox)** - ⭐ 35
   Python sandboxes for llms

2653. **[mcp-tung-shing](https://github.com/baranwang/mcp-tung-shing)** - ⭐ 35
   中国传统黄历 MCP 服务 | Chinese Traditional Almanac MCP Service

2654. **[mcp](https://github.com/screenshotone/mcp)** - ⭐ 35
   A simple implementation of an MCP server for the ScreenshotOne API

2655. **[atlas-docs-mcp](https://github.com/CartographAI/atlas-docs-mcp)** - ⭐ 35
   Provide LLMs hosted, clean markdown documentation of libraries and frameworks

2656. **[tinyagent](https://github.com/askbudi/tinyagent)** - ⭐ 35
   Tiny Agent: Production-Ready LLM Agent SDK for Every Developer

2657. **[MCPSwiftWrapper](https://github.com/jamesrochabrun/MCPSwiftWrapper)** - ⭐ 35
   A light wrapper around mcp-swift-sdk for easy usage of MCP clients in Swift

2658. **[yahoo-finance-server](https://github.com/AgentX-ai/yahoo-finance-server)** - ⭐ 35
...
2659. **[awesome-mcp-personas](https://github.com/toolprint/awesome-mcp-personas)** - ⭐ 35
   A curated collection of persona-based mcp server & tool groupings.

2660. **[nostr-mcp-server](https://github.com/AustinKelsay/nostr-mcp-server)** - ⭐ 35
   A Model Context Protocol (MCP) server that provides Nostr capabilities to AI agents

2661. **[mcp-zap-server](https://github.com/dtkmn/mcp-zap-server)** - ⭐ 35
   A Spring Boot application exposing OWASP ZAP as an MCP (Model Context Protocol) server. It lets any MCP‑compatible AI agent (e.g., Claude Desktop, Cursor) orchestrate ZAP actions—spider, active scan, import OpenAPI specs, and generate reports.

2662. **[mcp-server-text-editor](https://github.com/bhouston/mcp-server-text-editor)** - ⭐ 35
   An open source implementation of the Claude built-in text editor tool

2663. **[mcp-starter](https://github.com/instructa/mcp-starter)** - ⭐ 35
   A super simple Starter to build your own MCP Server

2664. **[mcp-client-cli](https://github.com/thedotmack/mcp-client-cli)** - ⭐ 35
   Command-line interface for any Model Context Protocol (MCP) server.

2665. **[mcp-toolkit](https://github.com/metosin/mcp-toolkit)** - ⭐ 35
   a lib to build MCP clients and MCP servers in Clojure(script)

2666. **[mcp-server](https://github.com/VapiAI/mcp-server)** - ⭐ 35
   Vapi MCP Server

2667. **[shadcn-svelte-mcp](https://github.com/Michael-Obele/shadcn-svelte-mcp)** - ⭐ 35
   Mastra MCP server and tooling for the shadcn-svelte component docs and developer utilities.

2668. **[gopls-mcp](https://github.com/xieyuschen/gopls-mcp)** - ⭐ 35
...
2669. **[workflowy](https://github.com/mholzen/workflowy)** - ⭐ 35
   Powerful CLI and MCP server for WorkFlowy: reports, search/replace, backup support, and AI integration (Claude, LLMs)

2670. **[pfsense-mcp-server](https://github.com/gensecaihq/pfsense-mcp-server)** - ⭐ 35
   pfSense MCP Server enables security administrators to manage their pfSense firewalls using natural language through AI assistants like Claude Desktop. Simply ask "Show me blocked IPs" or "Run a PCI compliance check" instead of navigating complex interfaces. Supports REST/XML-RPC/SSH connections, and includes built-in complian

2671. **[mcp-domain-availability](https://github.com/imprvhub/mcp-domain-availability)** - ⭐ 35
   A Model Context Protocol (MCP) server that enables Claude Desktop to check domain availability across 50+ TLDs. Features DNS/WHOIS verification, bulk checking, and smart suggestions. Zero-clone installation via uvx.

2672. **[mcp-browser-agent](https://github.com/imprvhub/mcp-browser-agent)** - ⭐ 35
   A Model Context Protocol (MCP) integration that provides Claude Desktop with autonomous browser automation capabilities. This agent enables Claude to interact with web content, manipulate DOM elements, execute JavaScript, and perform API requests.

2673. **[SUMO-MCP-Server](https://github.com/XRDS76354/SUMO-MCP-Server)** - ⭐ 35
...
2674. **[mcp-nats](https://github.com/sinadarbouy/mcp-nats)** - ⭐ 35
   A Model Context Protocol (MCP) server for NATS messaging system integration

2675. **[RoslynMCP](https://github.com/carquiza/RoslynMCP)** - ⭐ 35
   A Model Context Protocol (MCP) server that provides C# code analysis capabilities using Microsoft Roslyn

2676. **[authenticator_mcp](https://github.com/firstorderai/authenticator_mcp)** - ⭐ 35
   A secure MCP (Model Context Protocol) server that enables AI agents to interact with the Authenticator App.

2677. **[roampal-core](https://github.com/roampal-ai/roampal-core)** - ⭐ 35
   Outcome-based memory for Claude Code and OpenCode

2678. **[macOS-Notification-MCP](https://github.com/devizor/macOS-Notification-MCP)** - ⭐ 34
...
2679. **[mcp-client-auth](https://github.com/dzhng/mcp-client-auth)** - ⭐ 34
...
2680. **[chat-nextjs-mcp-client](https://github.com/shricodev/chat-nextjs-mcp-client)** - ⭐ 34
   ⚡ Chat MCP Client for Remote hosted MCP Servers (with Composio) and locally hosted MCP servers. 📡

2681. **[mcp-server-opendal](https://github.com/Xuanwo/mcp-server-opendal)** - ⭐ 34
   Model Context Protocol Server for Apache OpenDAL™

2682. **[meta-prompt-mcp-server](https://github.com/tisu19021997/meta-prompt-mcp-server)** - ⭐ 34
   Turn any MCP Client into a "multi-agent" system (via prompting)

2683. **[aio-mcp](https://github.com/athapong/aio-mcp)** - ⭐ 34
...
2684. **[llm-tools-mcp](https://github.com/VirtusLab/llm-tools-mcp)** - ⭐ 34
   Connect to MCP servers right from your shell. Plugin for simonw/llm.

2685. **[godoc-mcp-server](https://github.com/yikakia/godoc-mcp-server)** - ⭐ 34
   A mcp server provide infomation from pkg.go.dev. For all golang programmers

2686. **[DBJavaGenix](https://github.com/ZhaoXingPeng/DBJavaGenix)** - ⭐ 34
...
2687. **[mcp-prompt-server-go](https://github.com/smallnest/mcp-prompt-server-go)** - ⭐ 34
...
2688. **[chessagineweb](https://github.com/jalpp/chessagineweb)** - ⭐ 34
   The most underrated FOSS chess interface that combines AI agents and chess engines into one unified platform. 

2689. **[prometheus_mcp_server](https://github.com/CaesarYangs/prometheus_mcp_server)** - ⭐ 34
...
2690. **[codelogic-mcp-server](https://github.com/CodeLogicIncEngineering/codelogic-mcp-server)** - ⭐ 34
   An MCP Server to utilize Codelogic's rich software dependency data in your AI programming assistant.

2691. **[any-script-mcp](https://github.com/izumin5210/any-script-mcp)** - ⭐ 34
   An MCP server that exposes arbitrary CLI tools and shell scripts as MCP Tools

2692. **[modao-proto-mcp](https://github.com/modao-dev/modao-proto-mcp)** - ⭐ 34
...
2693. **[claude-code-mcp](https://github.com/KunihiroS/claude-code-mcp)** - ⭐ 34
   MCP Server connects with claude code local command.

2694. **[mcp-scala](https://github.com/windymelt/mcp-scala)** - ⭐ 34
   Model Context Protocol server written in Scala

2695. **[mcp-registry](https://github.com/ARadRareness/mcp-registry)** - ⭐ 34
   A central registry and HTTP interface for coordinating Model Context Protocol (MCP) servers.

2696. **[iotdb-mcp-server](https://github.com/apache/iotdb-mcp-server)** - ⭐ 34
   Apache IoTDB MCP Server

2697. **[1mcp](https://github.com/buremba/1mcp)** - ⭐ 34
   Let your agent write code and execute code directly in the browser with WASM

2698. **[kanban-mcp](https://github.com/eyalzh/kanban-mcp)** - ⭐ 34
   MCP server providing kanban-based task management memory for complex multi-session workflows with AI agents

2699. **[awesome-devops-mcp](https://github.com/agenticdevops/awesome-devops-mcp)** - ⭐ 34
   List of Awesome MCP Servers and Clients for building Agentic Devops 

2700. **[sunnysideFigma-Context-MCP](https://github.com/tercumantanumut/sunnysideFigma-Context-MCP)** - ⭐ 34
...
2701. **[filesystem-mcp-server](https://github.com/cyanheads/filesystem-mcp-server)** - ⭐ 34
   A Model Context Protocol (MCP) server for platform-agnostic file capabilities, including advanced search/replace and directory tree traversal

2702. **[vulnerablemcp](https://github.com/vineethsai/vulnerablemcp)** - ⭐ 34
   A comprehensive database of Model Context Protocol vulnerabilities, security research, and exploits

2703. **[adb-mcp](https://github.com/srmorete/adb-mcp)** - ⭐ 34
   An MCP (Model Context Protocol) server for interacting with Android devices through ADB in TypeScript.

2704. **[Learn-Model-Context-Protocol-with-Python](https://github.com/PacktPublishing/Learn-Model-Context-Protocol-with-Python)** - ⭐ 34
   Learn Model Context Protocol with Python, published by Packt

2705. **[elysia-mcp](https://github.com/kerlos/elysia-mcp)** - ⭐ 34
   ElysiaJS plugin for Model Context Protocol with HTTP transport

2706. **[diy-tools-mcp](https://github.com/hesreallyhim/diy-tools-mcp)** - ⭐ 34
   An MCP server that allows users to dynamically add custom tools/functions at runtime

2707. **[mcp-sync](https://github.com/ztripez/mcp-sync)** - ⭐ 34
   Sync MCP (Model Context Protocol) configurations across AI tools

2708. **[pushover-mcp](https://github.com/AshikNesin/pushover-mcp)** - ⭐ 34
   A MCP implementation for sending notifications via Pushover

2709. **[copilot-security-instructions](https://github.com/Robotti-io/copilot-security-instructions)** - ⭐ 34
...
2710. **[foundry-vtt-mcp](https://github.com/adambdooley/foundry-vtt-mcp)** - ⭐ 34
...
2711. **[apple-mail-mcp](https://github.com/patrickfreyer/apple-mail-mcp)** - ⭐ 34
   MCP server giving AI assistants full access to Apple Mail - read, search, compose, organize & analyze emails via natural language

2712. **[arifOS](https://github.com/ariffazil/arifOS)** - ⭐ 34
   ArifOS — AAA MCP-governed constitutional kernel for AI agents.

2713. **[Outlook_Calendar_MCP](https://github.com/merajmehrabi/Outlook_Calendar_MCP)** - ⭐ 34
   A Model Context Protocol (MCP) server that allows Claude to access and manage your local Microsfot Outlook calendar (Windows only).

2714. **[mcp_server](https://github.com/peppemas/mcp_server)** - ⭐ 34
   A C++ implementation of a Model Context Protocol Server with a pluggable module architecture.

2715. **[MCP-Scanner](https://github.com/knostic/MCP-Scanner)** - ⭐ 34
...
2716. **[octave-mcp](https://github.com/elevanaltd/octave-mcp)** - ⭐ 34
...
2717. **[fal-mcp-server](https://github.com/raveenb/fal-mcp-server)** - ⭐ 34
   MCP server for Fal.ai - Generate images, videos, music and audio with Claude

2718. **[awesome-blockchain-mcps](https://github.com/royyannick/awesome-blockchain-mcps)** - ⭐ 33
...
2719. **[adk-python-mcp-client](https://github.com/arjunprabhulal/adk-python-mcp-client)** - ⭐ 33
   Demo of ADK (Agent Development Kit) as an MCP (Model Context Protocol) client for flight search capabilities.

2720. **[mcp-google-calendar](https://github.com/markelaugust74/mcp-google-calendar)** - ⭐ 33
...
2721. **[McpToolkit](https://github.com/nuskey8/McpToolkit)** - ⭐ 33
   Lightweight, fast, NativeAOT compatible MCP (Model Context Protocol) framework for .NET

2722. **[mcp-api-gateway](https://github.com/rflpazini/mcp-api-gateway)** - ⭐ 33
   A universal MCP (Model Context Protocol) server to integrate any API with Claude Desktop using only Docker configurations.

2723. **[DMCPServer](https://github.com/Daniel09Fernandes/DMCPServer)** - ⭐ 33
   Dinos MCP Server, make your code, on MCP Action and execute by AI

2724. **[mcp-veo2](https://github.com/mario-andreschak/mcp-veo2)** - ⭐ 33
   MCP for Video- or Image-Generation with Google VEO2

2725. **[kaggle-mcp](https://github.com/arrismo/kaggle-mcp)** - ⭐ 33
   MCP server for Kaggle

2726. **[mcp-launcher](https://github.com/moeru-ai/mcp-launcher)** - ⭐ 33
   🐳🧩 Easy to use MCP builder & launcher for all possible MCP servers, just like Ollama for models!

2727. **[mentor-mcp-server](https://github.com/cyanheads/mentor-mcp-server)** - ⭐ 33
...
2728. **[wezterm-mcp](https://github.com/hiraishikentaro/wezterm-mcp)** - ⭐ 33
   About A Model Context Protocol server that executes commands in the current WezTerm session

2729. **[mcp-tool-filter](https://github.com/Portkey-AI/mcp-tool-filter)** - ⭐ 33
...
2730. **[PixVerse-MCP](https://github.com/PixVerseAI/PixVerse-MCP)** - ⭐ 33
   Official PixVerse Model Context Protocol (MCP) server that enables interaction with powerful AI video generation APIs.

2731. **[mcp-server-lib.el](https://github.com/laurynas-biveinis/mcp-server-lib.el)** - ⭐ 33
   Emacs Lisp implementation of the Model Context Protocol

2732. **[keynote-mcp](https://github.com/easychen/keynote-mcp)** - ⭐ 33
   A Model Context Protocol (MCP) server that enables AI assistants to control Keynote presentations through AppleScript automation.

2733. **[mcp-server](https://github.com/membranehq/mcp-server)** - ⭐ 33
   MCP Server for Membrane

2734. **[capacities-mcp](https://github.com/jem-computer/capacities-mcp)** - ⭐ 33
   Capacities×MCP

2735. **[devduck](https://github.com/cagataycali/devduck)** - ⭐ 33
   Minimalist AI agent that fixes itself when things break.

2736. **[fastmcp-threatintel](https://github.com/4R9UN/fastmcp-threatintel)** - ⭐ 33
   AI-Powered Threat Intelligence MCP tool

2737. **[mcp-wasm](https://github.com/beekmarks/mcp-wasm)** - ⭐ 33
   A proof-of-concept implementation of a Model Context Protocol (MCP) server that runs in WebAssembly (WASM) within a web browser. This project demonstrates the integration of MCP tools and resources in a browser environment.

2738. **[dap_mcp](https://github.com/KashunCheng/dap_mcp)** - ⭐ 33
   Model Context Protocol (MCP) server that interacts with a Debugger

2739. **[midi-mcp-server](https://github.com/tubone24/midi-mcp-server)** - ⭐ 33
...
2751. **[zilliz-mcp-server](https://github.com/zilliztech/zilliz-mcp-server)** - ⭐ 32
...
2752. **[azure-functions-mcp-extension](https://github.com/Azure/azure-functions-mcp-extension)** - ⭐ 32
   Model Context Protocol extension for Azure Functions.

2753. **[laravel-mcp-client](https://github.com/scriptoshi/laravel-mcp-client)** - ⭐ 32

2754. **[crawl-mcp](https://github.com/wutongci/crawl-mcp)** - ⭐ 32
   完整的微信文章抓取MCP服务器 - 基于Model Context Protocol (MCP)的智能网页抓取工具，专为Cursor IDE和AI工具设计。

2755. **[fantasy-football-mcp-public](https://github.com/derekrbreese/fantasy-football-mcp-public)** - ⭐ 32
...
2756. **[openbim-mcp](https://github.com/helenkwok/openbim-mcp)** - ⭐ 32
   Model Context Protocol (MCP) server for openBIM

2757. **[mcpc](https://github.com/OlaHulleberg/mcpc)** - ⭐ 32
...
2758. **[n8n-mcp](https://github.com/vredrick/n8n-mcp)** - ⭐ 32
   n8n MCP Server - Documentation and tools for n8n nodes via Model Context Protocol with SSE support

2759. **[mcp-googletasks](https://github.com/arpitbatra123/mcp-googletasks)** - ⭐ 32
...
2760. **[Direwolf](https://github.com/Framebuffers/Direwolf)** - ⭐ 32
   Distributed Data Processing Pipeline for MCP.

2761. **[imagegen-mcp](https://github.com/spartanz51/imagegen-mcp)** - ⭐ 32
   MCP server for OpenAI Image Generation & Editing — text-to-image, image-to-image (with mask), no extra plugins.

2762. **[PubChem-MCP-Server](https://github.com/Augmented-Nature/PubChem-MCP-Server)** - ⭐ 32
   A comprehensive Model Context Protocol (MCP) server for accessing the PubChem chemical database. This server provides access to over 110 million chemical compounds with extensive molecular properties, bioassay data, and chemical informatics tools.

2763. **[ptt_mcp_server](https://github.com/PyPtt/ptt_mcp_server)** - ⭐ 32
   The best PTT MCP server

2764. **[azure-container-apps-ai-mcp](https://github.com/Azure-Samples/azure-container-apps-ai-mcp)** - ⭐ 32
...
2765. **[hana-mcp-server](https://github.com/HatriGt/hana-mcp-server)** - ⭐ 32
   Model Context Server Protocol for your HANA DB

2766. **[MCPCorpus](https://github.com/Snakinya/MCPCorpus)** - ⭐ 32
...
2767. **[mcp-server-fuzzer](https://github.com/Agent-Hellboy/mcp-server-fuzzer)** - ⭐ 32
   A generic mcp server fuzzer

2768. **[mcp-server](https://github.com/HuaweiCloudDeveloper/mcp-server)** - ⭐ 32
   Provide different cloud products  MCP Server tools to  help developers  manage cloud resources  with AI-agent

2769. **[matrix-mcp-server](https://github.com/mjknowles/matrix-mcp-server)** - ⭐ 32
   MCP Server for a Matrix home server integration; chat, manage rooms, etc.

2770. **[univer-mcp](https://github.com/dream-num/univer-mcp)** - ⭐ 32
   AI-powered spreadsheet automation through Model Context Protocol (MCP) server for Univer

2771. **[MCP-Server-Starter](https://github.com/TheSethRose/MCP-Server-Starter)** - ⭐ 32
   A Model Context Protocol server starter template

2772. **[searxng-mcp](https://github.com/tisDDM/searxng-mcp)** - ⭐ 32
...
2773. **[native-devtools-mcp](https://github.com/sh3ll3x3c/native-devtools-mcp)** - ⭐ 32
...
2774. **[mcp-for-security-python](https://github.com/f1tz/mcp-for-security-python)** - ⭐ 32
...
2775. **[mcp-java-sdk-examples](https://github.com/thought2code/mcp-java-sdk-examples)** - ⭐ 32
   A collection of MCP server examples developed by various Java SDKs

2776. **[mcp](https://github.com/fastly/mcp)** - ⭐ 32
   Model Context Protocol (MCP) server for AI-powered Fastly CDN management.

2777. **[mcp-server-weibo](https://github.com/qinyuanpei/mcp-server-weibo)** - ⭐ 32
   基于 Model Context Protocol 的微博数据接口服务器 - 实时获取微博用户信息、动态内容、热搜榜单、粉丝关注数据。支持用户搜索、内容搜索、话题分析，为 AI 应用提供完整的微博数据接入方案。

2778. **[mcp-server](https://github.com/blockscout/mcp-server)** - ⭐ 32
   Wraps Blockscout APIs and exposes blockchain data by Model Context Protocol

2779. **[notebooklm-mcp-secure](https://github.com/Pantheon-Security/notebooklm-mcp-secure)** - ⭐ 32
   Secure NotebookLM MCP Server - Query Google NotebookLM from Claude/AI agents with 14 security hardening layers

2780. **[openproject-mcp-server](https://github.com/AndyEverything/openproject-mcp-server)** - ⭐ 32
   A Model Context Protocol (MCP) server that provides seamless integration with OpenProject API v3.

2781. **[omega-memory](https://github.com/omega-memory/omega-memory)** - ⭐ 32
   Persistent memory for AI coding agents

2782. **[simple-psql-mcp](https://github.com/NetanelBollag/simple-psql-mcp)** - ⭐ 31
...
2783. **[seatunnel-mcp](https://github.com/ocean-zhc/seatunnel-mcp)** - ⭐ 31
...
2784. **[mcp-weather](https://github.com/TimLukaHorstmann/mcp-weather)** - ⭐ 31
   A Model Context Protocol (MCP) server that provides hourly and daily weather forecasts using the AccuWeather API.

2785. **[Smart-Thinking](https://github.com/Leghis/Smart-Thinking)** - ⭐ 31
   Smart-Thinking is a Model Context Protocol (MCP) server that delivers graph-based, multi-step reasoning without relying on external AI APIs. Everything happens locally: similarity search, heuristic-based scoring, verification tracking, memory, and visualization all run in a deterministic pipeline designed for transparency and reproducibility.

2786. **[AlphaFold-MCP-Server](https://github.com/Augmented-Nature/AlphaFold-MCP-Server)** - ⭐ 31
   A comprehensive Model Context Protocol (MCP) server that provides access to the AlphaFold Protein Structure Database through a rich set of tools and resources for protein structure prediction analysis.

2787. **[PRD-MCP-Server](https://github.com/Saml1211/PRD-MCP-Server)** - ⭐ 31
   Flagship Model Context Protocol server for generating Product Requirement Documents (PRDs) from codebase context.

2788. **[dev-kit](https://github.com/nguyenvanduocit/dev-kit)** - ⭐ 31
   [Model Context Protocol] Dev Kit - anything a developer need for him day to day works

2789. **[postmancer](https://github.com/hijaz/postmancer)** - ⭐ 31
   An experimental MCP server Rest Client intended to be a replacement of tools postman & insomnia

2790. **[chatwork-mcp-server](https://github.com/chatwork/chatwork-mcp-server)** - ⭐ 31
   ChatworkをAIから操作するためのMCP(Model Context Protocol)サーバー

2791. **[zerodha-mcp](https://github.com/mtwn105/zerodha-mcp)** - ⭐ 31
   Zerodha MCP Server & Client - AI Agent (w/Agno & w/Google ADK)

2792. **[jlcpcb-parts-mcp](https://github.com/nvsofts/jlcpcb-parts-mcp)** - ⭐ 31
   JLCPCB PCBA向けの、部品探しを補助するためのMCPサーバー

2793. **[unplugin-mcp](https://github.com/situ2001/unplugin-mcp)** - ⭐ 31
...
2794. **[ez-mcp](https://github.com/intellectronica/ez-mcp)** - ⭐ 31
   The easiest path to getting an MCP server going

2795. **[ESP32MCPServer](https://github.com/navado/ESP32MCPServer)** - ⭐ 31
   Allow AI models connect to ESP32 exposed interfaces. AI generated MCP server for ESP32. 

2796. **[AskUserQuestionPlus](https://github.com/JoJoJotarou/AskUserQuestionPlus)** - ⭐ 31
...
2797. **[maven-mcp-server](https://github.com/Bigsy/maven-mcp-server)** - ⭐ 31
   An MCP (Model Context Protocol) server that provides tools for checking Maven dependency versions.

2798. **[mcp-aoai-web-browsing](https://github.com/kimtth/mcp-aoai-web-browsing)** - ⭐ 31
   A minimal Model Context Protocol 🖥️ server/client🧑‍💻with Azure OpenAI and 🌐 web browser control via Playwright.

2799. **[mcp-hacker-news](https://github.com/paabloLC/mcp-hacker-news)** - ⭐ 31
...
2800. **[pan-mcp-relay](https://github.com/PaloAltoNetworks/pan-mcp-relay)** - ⭐ 31
   Palo Alto Networks AI Runtime Security Model Context Protocol (MCP) Relay Server

2801. **[mcp-appium-gestures](https://github.com/AppiumTestDistribution/mcp-appium-gestures)** - ⭐ 31
   This is a Model Context Protocol (MCP) server providing resources and tools for Appium mobile gestures using Actions API..

2802. **[EU_AI_ACT_MCP](https://github.com/SonnyLabs/EU_AI_ACT_MCP)** - ⭐ 31
   EU AI Act MCP (Model Context Protocol) that connects to your AI agents, helping you to comply with the EU AI Act.

2803. **[paraview_mcp](https://github.com/llnl/paraview_mcp)** - ⭐ 31
...
2804. **[chabeau](https://github.com/permacommons/chabeau)** - ⭐ 31
   OpenAI-API compatible terminal chatbot and MCP client in Rust

2805. **[asterisk-mcp-server](https://github.com/winfunc/asterisk-mcp-server)** - ⭐ 31
   Asterisk Model Context Protocol (MCP) server.

2806. **[Amazing-Marvin-MCP](https://github.com/bgheneti/Amazing-Marvin-MCP)** - ⭐ 31
   Model Context Provider for Amazing Marvin productivity app - Access your tasks, projects, and categories in AI assistants

2807. **[phonepi-mcp](https://github.com/priyankark/phonepi-mcp)** - ⭐ 31
...
2808. **[mcp-bash](https://github.com/patrickomatik/mcp-bash)** - ⭐ 31
...
2812. **[cml-mcp](https://github.com/xorrkaz/cml-mcp)** - ⭐ 31
   A Model Context Protocol (MCP) Server for Cisco Modeling Labs (CML)

2813. **[WebSearch-MCP](https://github.com/mnhlt/WebSearch-MCP)** - ⭐ 31
...
2814. **[myBrAIn](https://github.com/lilium360/myBrAIn)** - ⭐ 31
...
2815. **[omop_mcp](https://github.com/OHNLP/omop_mcp)** - ⭐ 31
...
2816. **[sharedcontext](https://github.com/Eversmile12/sharedcontext)** - ⭐ 31
...
2827. **[airflow-mcp-server](https://github.com/abhishekbhakat/airflow-mcp-server)** - ⭐ 30
   MCP Server for Apache Airflow

2828. **[kafka-schema-reg-mcp](https://github.com/aywengo/kafka-schema-reg-mcp)** - ⭐ 30
   A comprehensive Message Control Protocol (MCP) server for Kafka Schema Registry.

2829. **[itential-mcp](https://github.com/itential/itential-mcp)** - ⭐ 30
   🔌 Itential Platform MCP Server

2830. **[ros-mcp](https://github.com/Yutarop/ros-mcp)** - ⭐ 30
   MCP server for ROS to control robots via topics, services, and actions.

2831. **[puppeteer-mcp-claude](https://github.com/jaenster/puppeteer-mcp-claude)** - ⭐ 30
...
2832. **[rod-mcp](https://github.com/go-rod/rod-mcp)** - ⭐ 30
   Model Context Protocol Server of Rod

2833. **[chrome-extension-bridge-mcp](https://github.com/Oanakiaja/chrome-extension-bridge-mcp)** - ⭐ 30
   A chrome extension bridge that allows you to connect to a mcp server to use global window object.

2834. **[protonmail-mcp](https://github.com/amotivv/protonmail-mcp)** - ⭐ 30
   This MCP server provides email sending functionality using Protonmail's SMTP service. It allows both Claude Desktop and Cline VSCode extension to send emails on your behalf using your Protonmail credentials.

2835. **[turbovault](https://github.com/Epistates/turbovault)** - ⭐ 30
   MCP server that transforms your Obsidian vault into an intelligent knowledge system

2836. **[postgres-mcp-server](https://github.com/ahmedmustahid/postgres-mcp-server)** - ⭐ 30
   MCP (Model Context Protocol) Server for postgres Database

2837. **[minimax_search](https://github.com/MiniMax-AI/minimax_search)** - ⭐ 30
   MiniMax Search is an MCP (Model Context Protocol) server that provides web search and browsing capabilities.

2838. **[browserai-mcp](https://github.com/brightdata/browserai-mcp)** - ⭐ 30
   A powerful Model Context Protocol (MCP) server that provides an access to serverless browser for AI agents and apps

2839. **[mattermost-mcp-host](https://github.com/jagan-shanmugam/mattermost-mcp-host)** - ⭐ 30
   A Mattermost integration that connects to Model Context Protocol (MCP) servers, leveraging a LangGraph-based Agent.

2840. **[xmind-generator-mcp](https://github.com/BangyiZhang/xmind-generator-mcp)** - ⭐ 30
   An MCP (Model Context Protocol) server for generating Xmind mind maps. This server allows LLMs to create structured mind maps through the MCP protocol.

2841. **[cca-mcp-configurator](https://github.com/doggy8088/cca-mcp-configurator)** - ⭐ 30
   一個簡單易用的網頁工具，用於管理 GitHub Copilot 的 MCP (Model Context Protocol) 設定

2842. **[actor-critic-thinking-mcp](https://github.com/aquarius-wing/actor-critic-thinking-mcp)** - ⭐ 30
   A dual-perspective thinking analysis server based on Model Context Protocol (MCP), providing comprehensive performance evaluation through Actor-Critic methodology.

2843. **[levante](https://github.com/levante-hub/levante)** - ⭐ 30
   Levante - Personal, Secure, Free, Local AI, MCP Client

2844. **[mcp-stata](https://github.com/tmonk/mcp-stata)** - ⭐ 30
...
2845. **[pubnub-mcp-server](https://github.com/pubnub/pubnub-mcp-server)** - ⭐ 30
   PubNub MCP Model Context Protocol Server for use in Cursor, Windsurf, Claude Desktop, Claude Code and OpenAI Codex and more!

2846. **[forgejo-mcp](https://github.com/goern/forgejo-mcp)** - ⭐ 30
...
2847. **[AI-Tracker](https://github.com/twwch/AI-Tracker)** - ⭐ 29
   本仓库旨在整理关于大语言模型（LLM）底层逻辑、**上下文工程 (Context Engineering)** 以及 **Model Context Protocol (MCP)** 协议的核心学习资源与实战路径。

2848. **[mcp-server-dumplingai](https://github.com/DumplingAI/mcp-server-dumplingai)** - ⭐ 29
   MCP (Model Context Protocol) server for Dumpling AI

2849. **[mcp-badges](https://github.com/mcpx-dev/mcp-badges)** - ⭐ 29
   Get your projects MCP (Model Context Protocol)  badges

2850. **[mcp-attr](https://github.com/frozenlib/mcp-attr)** - ⭐ 29
   A library for declaratively building Model Context Protocol servers.

2851. **[rails-pg-extras-mcp](https://github.com/pawurb/rails-pg-extras-mcp)** - ⭐ 29
   MCP (Model Context Protocol) LLM interface for rails-pg-extras gem

2852. **[luke-desktop](https://github.com/DrJonBrock/luke-desktop)** - ⭐ 29
   A modern desktop client for Claude AI with MCP server support, built with Tauri, React, and TypeScript.

2853. **[NetContextServer](https://github.com/willibrandon/NetContextServer)** - ⭐ 29
   A .NET implementation of the Model Context Protocol enabling AI assistants to explore and understand .NET codebases.

2854. **[openai-mcp-agent-dotnet](https://github.com/Azure-Samples/openai-mcp-agent-dotnet)** - ⭐ 29
   Sample to create an AI Agent using OpenAI models with any MCP server running on Azure Container Apps

2855. **[dockashell](https://github.com/anzax/dockashell)** - ⭐ 29
...
2856. **[biothings-mcp](https://github.com/longevity-genie/biothings-mcp)** - ⭐ 29
   MCP (Model Context Protocol) server for biothings

2857. **[telegram-mcp-server](https://github.com/kfastov/telegram-mcp-server)** - ⭐ 29
   MCP server implementation for Telegram

2858. **[agent-pm](https://github.com/gannonh/agent-pm)** - ⭐ 29
   MCP server for the planning and execution of AI-assisted development projects.

2859. **[mcp-notify](https://github.com/aahl/mcp-notify)** - ⭐ 29
   💬  MCP Server for notify to Weixin, Telegram, Bark, Lark, 飞书, 钉钉

2860. **[rdkit-mcp-server](https://github.com/tandemai-inc/rdkit-mcp-server)** - ⭐ 29
   MCP server that enables language models to interact with RDKit through natural language

2861. **[robinhood-mcp-server](https://github.com/rohitsingh-iitd/robinhood-mcp-server)** - ⭐ 29
...
2862. **[alibabacloud-dms-mcp-server](https://github.com/aliyun/alibabacloud-dms-mcp-server)** - ⭐ 29
...
2863. **[tgcli](https://github.com/kfastov/tgcli)** - ⭐ 29
   Telegram user console client and archiver

2864. **[framer-plugin-mcp](https://github.com/Sheshiyer/framer-plugin-mcp)** - ⭐ 29
   A Model Context Protocol (MCP) server for creating and managing Framer plugins with web3 capabilities

2865. **[workflows-mcp-server](https://github.com/cyanheads/workflows-mcp-server)** - ⭐ 29
...
2866. **[kaggle-mcp](https://github.com/54yyyu/kaggle-mcp)** - ⭐ 29
...
2867. **[excel-reader-mcp](https://github.com/ArchimedesCrypto/excel-reader-mcp)** - ⭐ 29
...
2868. **[ddg_search](https://github.com/OEvortex/ddg_search)** - ⭐ 29
   A powerful Model Context Protocol (MCP) server for web search and URL content extraction using DuckDuckGo.

2869. **[TAM-MCP-Server](https://github.com/gvaibhav/TAM-MCP-Server)** - ⭐ 29
...
2870. **[freepik-mcp](https://github.com/freepik-company/freepik-mcp)** - ⭐ 29
   The Freepik enables popular agent Model Context Protocol (MCP) to integrate with Freepik APIs through function calling.

2871. **[bear-notes-mcp](https://github.com/bejaminjones/bear-notes-mcp)** - ⭐ 29
   MCP server for Bear app - Full Read + Write AI-powered note management with Claude Desktop

2872. **[mcpmcp-server](https://github.com/glenngillen/mcpmcp-server)** - ⭐ 29
   Discover, setup, and integrate MCP servers with your favorite clients. Unlock the full potential of AI in your daily workflow.

2873. **[notion-mcp](https://github.com/Badhansen/notion-mcp)** - ⭐ 29
   A simple Model Context Protocol (MCP) server that integrates with Notion's API to manage my personal todo list.

2874. **[powerplatform-mcp](https://github.com/michsob/powerplatform-mcp)** - ⭐ 29
   PowerPlatform Model Context Protocol server

2875. **[deno-mcp-template](https://github.com/phughesmcr/deno-mcp-template)** - ⭐ 29
   A template repo for writing and publishing local, remote, DXT, and binary MCP servers using Deno.

2876. **[enhanced-mcp-memory](https://github.com/cbunting99/enhanced-mcp-memory)** - ⭐ 29
   An enhanced MCP (Model Context Protocol) server for intelligent memory and task management, designed for AI assistants and development workflows. Features semantic search, automatic task extraction, knowledge graphs, and comprehensive project management.

2877. **[codesys-mcp-toolkit](https://github.com/johannesPettersson80/codesys-mcp-toolkit)** - ⭐ 29
   Model Context Protocol server for CODESYS automation platform

2878. **[omnifocus-mcp-enhanced](https://github.com/jqlts1/omnifocus-mcp-enhanced)** - ⭐ 29
...
2879. **[Volatility-MCP-Server](https://github.com/bornpresident/Volatility-MCP-Server)** - ⭐ 29
   A Model Context Protocol (MCP) server that integrates Volatility 3 memory forensics framework with Claude

2880. **[mcp-etherscan-server](https://github.com/crazyrabbitLTC/mcp-etherscan-server)** - ⭐ 29
   An MCP (Model Context Protocol) server that provides Ethereum blockchain data tools via Etherscan's API. Features include checking ETH balances, viewing transaction history, tracking ERC20 transfers, fetching contract ABIs, monitoring gas prices, and resolving ENS names.

2881. **[mcp-ollama-agent](https://github.com/ausboss/mcp-ollama-agent)** - ⭐ 29
...
2882. **[mcp-klever-vm](https://github.com/klever-io/mcp-klever-vm)** - ⭐ 29
   MCP server for Klever blockchain smart contract development

2883. **[seo-insights-mcp-server](https://github.com/mrgoonie/seo-insights-mcp-server)** - ⭐ 29
...
2884. **[MCPSecBench](https://github.com/AIS2Lab/MCPSecBench)** - ⭐ 29
   MCPSecBench: A Systematic Security Benchmark and Playground for Testing Model Context Protocols

2885. **[FalkorDB-MCPServer](https://github.com/FalkorDB/FalkorDB-MCPServer)** - ⭐ 29
   FalkorDB-MCPServer is an MCP (Model Context Protocol) server that connects LLMs to FalkorDB

2886. **[mcp-codebase-index](https://github.com/MikeRecognex/mcp-codebase-index)** - ⭐ 29
...
2887. **[winremote-mcp](https://github.com/dddabtc/winremote-mcp)** - ⭐ 29
   Windows Remote MCP Server — 40+ tools for desktop automation, process management, file operations via FastMCP

2888. **[sketchfab-mcp-server](https://github.com/gregkop/sketchfab-mcp-server)** - ⭐ 28
   This is an MCP (Model Context Protocol) Server for discovering and downloading 3D models 

2889. **[mcp-testing-framework](https://github.com/L-Qun/mcp-testing-framework)** - ⭐ 28
   Testing framework for Model Context Protocol (MCP)

2890. **[laravel-mcp-sdk](https://github.com/mohamedahmed01/laravel-mcp-sdk)** - ⭐ 28
   Laravel Based Implementation for Model Context Protocol

2891. **[mcp-websocket](https://github.com/virajsharma2000/mcp-websocket)** - ⭐ 28
   This server implements an MCP (Model Context Protocol) server with WebSocket enhancements for real-time data updates.

2892. **[mcp_autogen_sse_stdio](https://github.com/SaM-92/mcp_autogen_sse_stdio)** - ⭐ 28
   This repository demonstrates how to use AutoGen to integrate local and remote MCP (Model Context Protocol) servers. It showcases a local math tool (math_server.py) using Stdio and a remote Apify tool (RAG Web Browser Actor) via SSE for tasks like arithmetic and web browsing.

2893. **[nchan-mcp-transport](https://github.com/ConechoAI/nchan-mcp-transport)** - ⭐ 28
...
2894. **[vsc-mcp](https://github.com/thomasgazzoni/vsc-mcp)** - ⭐ 28
   This project provides tools that expose Language Server Protocol (LSP) functionality as MCP (Model Context Protocol) tools

2895. **[YFinance-Trader-MCP-ClaudeDesktop](https://github.com/SaintDoresh/YFinance-Trader-MCP-ClaudeDesktop)** - ⭐ 28
   An MCP (Model Context Protocol) tool that provides stock market data and trading capabilities using the yfinance library, specifically adapted for Claude Desktop.

2896. **[openapi-mcp-generator](https://github.com/abutbul/openapi-mcp-generator)** - ⭐ 28
...
2897. **[claude-code-mcp](https://github.com/zebbern/claude-code-mcp)** - ⭐ 28
...
2898. **[taskflow-mcp](https://github.com/pinkpixel-dev/taskflow-mcp)** - ⭐ 28
   A task management Model Context Protocol (MCP) server that helps AI assistants break down user requests into manageable tasks with subtasks, dependencies, and notes. Enforces a structured workflow with user approval steps.

2899. **[gemsuite-mcp](https://github.com/PV-Bhat/gemsuite-mcp)** - ⭐ 28
...
2900. **[gaia-x](https://github.com/YFGaia/gaia-x)** - ⭐ 28
...
2901. **[tempo-mcp-server](https://github.com/ivelin-web/tempo-mcp-server)** - ⭐ 28
   MCP server for managing Tempo worklogs in Jira

2902. **[mcp_espn_ff](https://github.com/KBThree13/mcp_espn_ff)** - ⭐ 28
   ESPN Fantasy API with LLMs!

2903. **[Healthcare-MCP](https://github.com/innovaccer/Healthcare-MCP)** - ⭐ 28
...
2904. **[touchdesigner-mcp-server](https://github.com/bottobot/touchdesigner-mcp-server)** - ⭐ 28
...
2905. **[src-to-kb](https://github.com/vezlo/src-to-kb)** - ⭐ 28
   Convert source code to LLM ready knowledge base

2906. **[MCP-BOE](https://github.com/ComputingVictor/MCP-BOE)** - ⭐ 28
...
2907. **[whistle-mcp](https://github.com/7gugu/whistle-mcp)** - ⭐ 28
...
2908. **[mcp-caiyun-weather](https://github.com/caiyunapp/mcp-caiyun-weather)** - ⭐ 28
   A Model Context Protocol (MCP) server for Caiyun (ColorfulClouds) Weather.

2909. **[mcp-log-proxy](https://github.com/emicklei/mcp-log-proxy)** - ⭐ 28
   a web logging proxy for MCP client-server communication

2910. **[mcp-writer-substack](https://github.com/jonathan-politzki/mcp-writer-substack)** - ⭐ 28
   Model Context Protocol to bridge in Substack writings to Claude.

2911. **[zillow-mcp-server](https://github.com/sap156/zillow-mcp-server)** - ⭐ 28
   Zillow MCP Server for real estate data access via the Model Context Protocol

2912. **[ai-foundry-agents-samples](https://github.com/Azure-Samples/ai-foundry-agents-samples)** - ⭐ 28
   Azure AI Foundry - Agents related sample code

2913. **[mcp-proxy](https://github.com/stephenlacy/mcp-proxy)** - ⭐ 28
   Fast rust MCP proxy between stdio and SSE

2914. **[laravel-mcp-companion](https://github.com/brianirish/laravel-mcp-companion)** - ⭐ 28
...
2915. **[google-search-console-mcp-server](https://github.com/Shin-sibainu/google-search-console-mcp-server)** - ⭐ 28
   Model Context Protocol server for Google Search Console API - integrate with Claude Code and Claude Desktop

2916. **[MCPServer](https://github.com/rhennigan/MCPServer)** - ⭐ 28
   Implements a model context protocol server using Wolfram Language

2917. **[bgg-mcp](https://github.com/kkjdaniel/bgg-mcp)** - ⭐ 28
   BGG MCP provides access to BoardGameGeek and a variety of board game related data through the Model Context Protocol. Enabling retrieval and filtering of board game data, user collections, and profiles.

2918. **[nettune](https://github.com/jtsang4/nettune)** - ⭐ 28
...
2919. **[alibabacloud-dataworks-mcp-server](https://github.com/aliyun/alibabacloud-dataworks-mcp-server)** - ⭐ 28
   A Model Context Protocol (MCP) server that provides tools for AI, allowing it to interact with the DataWorks Open API through a standardized interface. This implementation is based on the Aliyun Open API and enables AI agents to perform cloud resources operations seamlessly.

2920. **[mcp-server-giphy](https://github.com/magarcia/mcp-server-giphy)** - ⭐ 28
   An implementation of Giphy integration with Model Context Protocol

2921. **[MiniMax-Coding-Plan-MCP](https://github.com/MiniMax-AI/MiniMax-Coding-Plan-MCP)** - ⭐ 28
...
2922. **[drawio-mcp-server](https://github.com/simonkurtz-MSFT/drawio-mcp-server)** - ⭐ 28
...
2923. **[Memgpt-MCP-Server](https://github.com/Vic563/Memgpt-MCP-Server)** - ⭐ 27
   A Model Context Protocol (MCP) server that provides persistent memory and multi-model LLM support.

2924. **[aws-mcp](https://github.com/lokeswaran-aj/aws-mcp)** - ⭐ 27
   An MCP(Model Context Protocol) Server for AWS services

2925. **[mcpc](https://github.com/apify/mcpc)** - ⭐ 27
   Universal command-line client for the Model Context Protocol (MCP)

2926. **[VercelGenUI_MCP](https://github.com/JamesSloan/VercelGenUI_MCP)** - ⭐ 27
   Proof of concept chat AI combining the Model Context Protocol (MCP) with Vercel's AI SDK UI

2927. **[mcp](https://github.com/supadata-ai/mcp)** - ⭐ 27
   Official Supadata MCP Server - Adds powerful video & web scraping to Cursor, Claude and any other LLM clients.

2928. **[google-workspace-mcp-server](https://github.com/epaproditus/google-workspace-mcp-server)** - ⭐ 27
   A Model Context Protocol server for Google Workspace integration (Gmail and Calendar)

2929. **[mcp-web-browser](https://github.com/random-robbie/mcp-web-browser)** - ⭐ 27
   An advanced web browsing server for the Model Context Protocol (MCP) powered by Playwright, enabling headless browser interactions through a flexible, secure API.

2930. **[directus-mcp-server](https://github.com/rijkvanzanten/directus-mcp-server)** - ⭐ 27
   Model Context Protocol server for Directus

2931. **[Python-Runtime-Interpreter-MCP-Server](https://github.com/hileamlakB/Python-Runtime-Interpreter-MCP-Server)** - ⭐ 27
   PRIMS is a lightweight, open-source Model Context Protocol (MCP) server that lets LLM agents safely execute arbitrary Python code in a secure, throw-away sandbox.

2932. **[nimbletools-core](https://github.com/NimbleBrainInc/nimbletools-core)** - ⭐ 27
   NimbleTools is an open-source MCP runtime. Infrastructure for the agentic web.

2933. **[mcp-stytch-consumer-todo-list](https://github.com/stytchauth/mcp-stytch-consumer-todo-list)** - ⭐ 27
   Workers + Stytch TODO App MCP Server

2934. **[mindbridge-mcp](https://github.com/pinkpixel-dev/mindbridge-mcp)** - ⭐ 27
...
2935. **[php-mcp](https://github.com/dtyq/php-mcp)** - ⭐ 27
...
2936. **[FerrumMCP](https://github.com/Eth3rnit3/FerrumMCP)** - ⭐ 27
...
2937. **[MCPbundler](https://github.com/eugenepyvovarov/MCPbundler)** - ⭐ 27

2938. **[vision-one-mcp-server](https://github.com/trendmicro/vision-one-mcp-server)** - ⭐ 27
...
2939. **[brlaw_mcp_server](https://github.com/pdmtt/brlaw_mcp_server)** - ⭐ 27
   A MCP (Model Context Protocol) server for agent-driven research on Brazilian law using official sources

2940. **[review-flow](https://github.com/DGouron/review-flow)** - ⭐ 27
...
2941. **[pulse-editor](https://github.com/ClayPulse/pulse-editor)** - ⭐ 27
...
2942. **[izan.io](https://github.com/ekingunoncu/izan.io)** - ⭐ 27
   Turn Any Browser Action & Data Extraction into an AI Tool in 60 Seconds

2943. **[mcp-config-manager](https://github.com/holstein13/mcp-config-manager)** - ⭐ 27
...
2944. **[Wwise-MCP](https://github.com/BilkentAudio/Wwise-MCP)** - ⭐ 27
...
2945. **[gtm-mcp-server](https://github.com/paolobietolini/gtm-mcp-server)** - ⭐ 27
   An MCP server for Google Tag Manager. Connect it to your LLM, authenticate once, and start managing GTM through natural language.

2946. **[jdwp-mcp](https://github.com/navicore/jdwp-mcp)** - ⭐ 27
   Java debugging for LLMs via JDWP and Model Context Protocol

2947. **[mcpshim](https://github.com/mcpshim/mcpshim)** - ⭐ 27
   Turn remote MCP servers into local command workflows.

2948. **[mcp-local-dev](https://github.com/txbm/mcp-local-dev)** - ⭐ 26
   Let LLMs manage your local dev environments

2949. **[mcp-structured-thinking](https://github.com/Promptly-Technologies-LLC/mcp-structured-thinking)** - ⭐ 26
...
2950. **[mcp-frontend-testing](https://github.com/StudentOfJS/mcp-frontend-testing)** - ⭐ 26
   Frontend testing tools for Model Context Protocol

2951. **[do-remote-mcp-server-template](https://github.com/do-community/do-remote-mcp-server-template)** - ⭐ 26
   A Model Context Protocol (MCP) server that checks domain name availability using WHOIS lookups and DNS resolution

2952. **[pptx-xlsx-mcp](https://github.com/jenstangen1/pptx-xlsx-mcp)** - ⭐ 26
   Antrophics Model context protocol to edit powerpoint files

2953. **[minds-mcp](https://github.com/mindsdb/minds-mcp)** - ⭐ 26
...
2954. **[mcp-client-x](https://github.com/RGGH/mcp-client-x)** - ⭐ 26
   Python MCP client + server example

2955. **[mcp-gateway](https://github.com/lucky-aeon/mcp-gateway)** - ⭐ 26
...
2956. **[langchain-mcp-tools-py](https://github.com/hideya/langchain-mcp-tools-py)** - ⭐ 26
   MCP to LangChain Tools Conversion Utility / Python

2957. **[MalwareBazaar_MCP](https://github.com/mytechnotalent/MalwareBazaar_MCP)** - ⭐ 26
   An AI-driven MCP server that autonomously interfaces with Malware Bazaar, delivering real-time threat intel and sample metadata for authorized cybersecurity research workflows.

2958. **[ton-blockchain-mcp](https://github.com/devonmojito/ton-blockchain-mcp)** - ⭐ 26
   A Model Context Protocol (MCP) server written in Python for natural language interaction with the TON blockchain 💎

2959. **[nebulagraph-mcp-server](https://github.com/nebula-contrib/nebulagraph-mcp-server)** - ⭐ 26
   Model Context Protocol Server for NebulaGraph 3.x

2960. **[taiwan-holiday-mcp](https://github.com/lis186/taiwan-holiday-mcp)** - ⭐ 26
   一個基於 Model Context Protocol (MCP) 的台灣假期查詢伺服器，為 AI 工具提供準確的台灣國定假日資訊。

2961. **[MCP-Developer-SubAgent](https://github.com/gensecaihq/MCP-Developer-SubAgent)** - ⭐ 26
...
2962. **[mcp-auth](https://github.com/famma-ai/mcp-auth)** - ⭐ 26
   MCP Auth via Reverse Proxy 

2963. **[mcp-simple-timeserver](https://github.com/andybrandt/mcp-simple-timeserver)** - ⭐ 26
...
2964. **[turn-based-game-mcp](https://github.com/github-samples/turn-based-game-mcp)** - ⭐ 26
...
2965. **[semrush-mcp](https://github.com/mrkooblu/semrush-mcp)** - ⭐ 26
   A Model Context Protocol (MCP) server implementation that provides tools for accessing Semrush API data.

2966. **[chatbot_Shopify](https://github.com/Mobeen-Dev/chatbot_Shopify)** - ⭐ 26
   Agentic Shopify Chatbot with MCP integration, embedded directly into Shopify via a Theme Extension

2967. **[symfony-mcp-server](https://github.com/klapaudius/symfony-mcp-server)** - ⭐ 26
   A Symfony package designed for building secure servers based on the Model Context Protocol, utilizing Server-Sent Events (SSE) and/or StreamableHTTP for real-time communication. It offers a scalable tool system tailored for enterprise-grade applications.

2968. **[greptimedb-mcp-server](https://github.com/GreptimeTeam/greptimedb-mcp-server)** - ⭐ 26
   A Model Context Protocol (MCP) server for GreptimeDB

2969. **[kernel-mcp-server](https://github.com/kernel/kernel-mcp-server)** - ⭐ 26
   Open-source MCP server for secure, low-latency cloud-browser automation on Kernel.

2970. **[clay-mcp](https://github.com/clay-inc/clay-mcp)** - ⭐ 26
   A simple Model Context Protocol (MCP) server for Clay.

2971. **[mcp-server-starter-ts](https://github.com/alexanderop/mcp-server-starter-ts)** - ⭐ 26
   A minimal TypeScript starter template for building Model Context Protocol (MCP) servers.

2972. **[cheat-engine-server-python](https://github.com/bethington/cheat-engine-server-python)** - ⭐ 26
...
2973. **[arch-mcp](https://github.com/nihalxkumar/arch-mcp)** - ⭐ 26
   Arch Linux MCP (Model Context Protocol)

2974. **[wiki-js-mcp](https://github.com/talosdeus/wiki-js-mcp)** - ⭐ 26
   Model Context Protocol (MCP) server for Wiki.js with hierarchical documentation & Docker setup

2975. **[relace-mcp](https://github.com/possible055/relace-mcp)** - ⭐ 26
   Unofficial Relace MCP client with AI features. Personal project; not affiliated with or endorsed by Relace

2976. **[Unity-AI-ProBuilder](https://github.com/IvanMurzak/Unity-AI-ProBuilder)** - ⭐ 26
...
2977. **[unplugin-devpilot](https://github.com/zcf0508/unplugin-devpilot)** - ⭐ 26
...
2978. **[php-mcp-sdk](https://github.com/dalehurley/php-mcp-sdk)** - ⭐ 26
...
2979. **[RevitMCP](https://github.com/oakplank/RevitMCP)** - ⭐ 26
   model context protocol for Autodesk Revit

2980. **[mcp-ffmpeg-helper](https://github.com/sworddut/mcp-ffmpeg-helper)** - ⭐ 26
   一个基于 Model Context Protocol (MCP) 的 FFmpeg 辅助工具，提供视频处理功能。

2981. **[Unity-AI-Animation](https://github.com/IvanMurzak/Unity-AI-Animation)** - ⭐ 26
...
2982. **[mcp-claude-spotify](https://github.com/imprvhub/mcp-claude-spotify)** - ⭐ 26
   An integration that allows Claude Desktop to interact with Spotify using the Model Context Protocol (MCP).

2983. **[fast-mcp-telegram](https://github.com/leshchenko1979/fast-mcp-telegram)** - ⭐ 26
   Telegram MCP Server and HTTP-MTProto bridge | Multi-user auth, intelligent search, file sending, web setup | Docker & PyPI ready

2984. **[batchdata-mcp-real-estate](https://github.com/zellerhaus/batchdata-mcp-real-estate)** - ⭐ 26
...
2985. **[congressMCP](https://github.com/amurshak/congressMCP)** - ⭐ 26
   An MCP server allowing AI agents and MCP clients to interface with the Congress.gov API

2986. **[metabase-mcp-server](https://github.com/hyeongjun-dev/metabase-mcp-server)** - ⭐ 26
   A Model Context Protocol server that integrates AI assistants with Metabase analytics platform

2987. **[mcp_xpp](https://github.com/ccampora/mcp_xpp)** - ⭐ 26
...
2988. **[mcp-chain-of-draft-server](https://github.com/bsmi021/mcp-chain-of-draft-server)** - ⭐ 25
   Chain of Draft Server is a powerful AI-driven tool that helps developers make better decisions through systematic, iterative refinement of thoughts and designs. It integrates seamlessly with popular AI agents and provides a structured approach to reasoning, API design, architecture decisions, code reviews, and implementation planning.

2989. **[alpaca-mcp-server](https://github.com/tedlikeskix/alpaca-mcp-server)** - ⭐ 25
   Model Context Protocol (MCP) server for Alpaca trading API

2990. **[gyazo-mcp-server](https://github.com/nota/gyazo-mcp-server)** - ⭐ 25
   Official Model Context Protocol server for Gyazo

2991. **[mcp-php](https://github.com/garyblankenship/mcp-php)** - ⭐ 25
   model context protocol or mcp for php laravel

2992. **[mcp-media-processor](https://github.com/maoxiaoke/mcp-media-processor)** - ⭐ 25
   A Node.js server implementing Model Context Protocol (MCP) for media processing operations, providing powerful video and image manipulation capabilities.

2993. **[mcp-webdriveragent](https://github.com/AppiumTestDistribution/mcp-webdriveragent)** - ⭐ 25
   This is a Model Context Protocol (MCP) server that provides tools for building and signing WebDriverAgent for iOS.

2994. **[mcp-manager](https://github.com/nstebbins/mcp-manager)** - ⭐ 25
   CLI tool for managing Model Context Protocol (MCP) servers in one place & using them across them different clients

2995. **[mcp-server-semgrep](https://github.com/VetCoders/mcp-server-semgrep)** - ⭐ 25
   MCP Server Semgrep is a [Model Context Protocol](https://modelcontextprotocol.io) compliant server that integrates the powerful Semgrep static analysis tool with AI assistants like Anthropic Claude. It enables advanced code analysis, security vulnerability detection, and code quality improvements directly through a conversational interface.

2996. **[deep-research-mcp](https://github.com/pinkpixel-dev/deep-research-mcp)** - ⭐ 25
   A Model Context Protocol (MCP) compliant server designed for comprehensive web research. It uses Tavily's Search and Crawl APIs to gather detailed information on a given topic, then structures this data in a format perfect for LLMs to create high-quality markdown documents.

2997. **[puzzlebox](https://github.com/cliffhall/puzzlebox)** - ⭐ 25
...
2998. **[Tiny-OAI-MCP-Agent](https://github.com/jalr4ever/Tiny-OAI-MCP-Agent)** - ⭐ 25
   A MCP protocol agent that operates a SQLite using natural language by OpenAI-Compatible LLM.

2999. **[slack-mcp-server](https://github.com/AVIMBU/slack-mcp-server)** - ⭐ 25
   A Model Context Protocol Server for Interacting with Slack

3000. **[systemprompt-mcp-notion](https://github.com/Ejb503/systemprompt-mcp-notion)** - ⭐ 25
...
3001. **[mcp_rss](https://github.com/buhe/mcp_rss)** - ⭐ 25
   MCP RSS is a Model Context Protocol (MCP) server for interacting with RSS feeds.

3002. **[agent-hub-mcp](https://github.com/gilbarbara/agent-hub-mcp)** - ⭐ 25
   A Model Context Protocol (MCP) server that enables communication and coordination between multiple AI agents

3003. **[meeting-mcp](https://github.com/Meeting-BaaS/meeting-mcp)** - ⭐ 25
   Model Context Protocol server for AI assistants to create meeting bots, search transcripts, and manage meeting recordings.

3004. **[mcp_streamable_http](https://github.com/theailanguage/mcp_streamable_http)** - ⭐ 25
   Educational repo for MCP streamable HTTP servers and clients

3005. **[ccmcp](https://github.com/gsong/ccmcp)** - ⭐ 25
   A CLI tool that intelligently discovers, validates, and selects MCP (Model Context Protocol) server configurations for Claude Code.

3006. **[awesome-mcp-lists](https://github.com/collabnix/awesome-mcp-lists)** - ⭐ 25
   A Curated List of MCP Servers, Clients and Toolkits

3007. **[mcp-slicer](https://github.com/zhaoyouj/mcp-slicer)** - ⭐ 25
   A Model Context Protocol server for 3D Slicer integration

3008. **[nestjs-mcp](https://github.com/bamada/nestjs-mcp)** - ⭐ 25
   NestJS module for seamless Model Context Protocol (MCP) server integration using decorators.

3009. **[prometheus-mcp](https://github.com/idanfishman/prometheus-mcp)** - ⭐ 25
   A Model Context Protocol (MCP) server implementation that provides AI agents with programmatic access to Prometheus metrics via a unified interface.

3010. **[apifox-mcp](https://github.com/iwen-conf/apifox-mcp)** - ⭐ 25
   Apifox MCP 服务器 - 让 Claude 等 AI 助手通过自然语言管理你的 Apifox 项目，轻松创建、更新和审计 API 接口

3011. **[lucide-icons-mcp](https://github.com/SeeYangZhi/lucide-icons-mcp)** - ⭐ 25
...
3012. **[github-repo-mcp](https://github.com/Ryan0204/github-repo-mcp)** - ⭐ 25
   Model Context Protocol server for Github Repo // Reading Github Repo

3013. **[aistudio-mcp-server](https://github.com/eternnoir/aistudio-mcp-server)** - ⭐ 25
...
3014. **[mcp-annotated-java-sdk](https://github.com/thought2code/mcp-annotated-java-sdk)** - ⭐ 25
   Annotation-driven MCP dev 🚀 No Spring, Zero Boilerplate, Pure Java

3015. **[PowerShell.MCP](https://github.com/yotsuda/PowerShell.MCP)** - ⭐ 25
...
3016. **[openai-copilot](https://github.com/feiskyer/openai-copilot)** - ⭐ 25
   Your life Copilot powered by LLM models (CLI interface for LLM models with MCP tools).

3017. **[MiAO-MCP-for-Unity](https://github.com/MiAO-AI-Lab/MiAO-MCP-for-Unity)** - ⭐ 25
...
3018. **[mcp-desktop-automation](https://github.com/tanob/mcp-desktop-automation)** - ⭐ 25
   A Model Context Protocol server that provides desktop automation capabilities using RobotJS and screenshot capabilities

3019. **[deep-research](https://github.com/ssdeanx/deep-research)** - ⭐ 25
...
3020. **[kratos-mcp](https://github.com/ceorkm/kratos-mcp)** - ⭐ 25
...
3021. **[json2video-mcp-server](https://github.com/omergocmen/json2video-mcp-server)** - ⭐ 25
   Message Communication Protocol server for json2video API integration

3022. **[camofox-mcp](https://github.com/redf0x1/camofox-mcp)** - ⭐ 25
   Anti-detection browser MCP server for AI agents — navigate, interact, and automate the web without getting blocked

3023. **[fusion-mcp-server](https://github.com/Joe-Spencer/fusion-mcp-server)** - ⭐ 25
...
3024. **[ebay-mcp](https://github.com/YosefHayim/ebay-mcp)** - ⭐ 25
...
3025. **[mssqlclient-mcp-server](https://github.com/aadversteeg/mssqlclient-mcp-server)** - ⭐ 25
...
3026. **[GenomeMCP](https://github.com/Eldergenix/GenomeMCP)** - ⭐ 24
...
3027. **[Unlock-your-agents-potential-with-Model-Context-Protocol-PostgreSQL-Workshop](https://github.com/gloveboxes/Unlock-your-agents-potential-with-Model-Context-Protocol-PostgreSQL-Workshop)** - ⭐ 24

3028. **[opnsense-mcp-server](https://github.com/floriangrousset/opnsense-mcp-server)** - ⭐ 24
...
3029. **[n8n-AI-agent-DVM-MCP-client](https://github.com/r0d8lsh0p/n8n-AI-agent-DVM-MCP-client)** - ⭐ 24
...
3030. **[mcp-server-semgrep](https://github.com/Szowesgad/mcp-server-semgrep)** - ⭐ 24
   MCP Server Semgrep is a [Model Context Protocol](https://modelcontextprotocol.io) compliant server that integrates the powerful Semgrep static analysis tool with AI assistants like Anthropic Claude. It enables advanced code analysis, security vulnerability detection, and code quality improvements directly through a conversational interface.

3031. **[python-sequential-thinking-mcp](https://github.com/XD3an/python-sequential-thinking-mcp)** - ⭐ 24
...
3032. **[MCP](https://github.com/EduBase/MCP)** - ⭐ 24
   The EduBase MCP server enables Claude and other LLMs to interact with EduBase's comprehensive e-learning platform through the Model Context Protocol (MCP).

3033. **[mcp-task-manager-server](https://github.com/bsmi021/mcp-task-manager-server)** - ⭐ 24
   A local Model Context Protocol (MCP) server providing backend tools for client-driven project and task management using a SQLite database.

3034. **[DeepResearchMCP](https://github.com/ameeralns/DeepResearchMCP)** - ⭐ 24
...
3035. **[mcp-template-dotnet](https://github.com/NikiforovAll/mcp-template-dotnet)** - ⭐ 24
   This repository contains a template for creating a Model Context Protocol (MCP) applications in .NET.

3036. **[mcp-playground](https://github.com/zanetworker/mcp-playground)** - ⭐ 24
   Simple MCP Client for remote MCP Servers 🌐

3037. **[Awesome-MCP](https://github.com/Albertchamberlain/Awesome-MCP)** - ⭐ 24
   Awesome-MCP Servers & Clients & Funny things

3038. **[calendar-mcp](https://github.com/deciduus/calendar-mcp)** - ⭐ 24
...
3039. **[readwise-vector-db](https://github.com/leonardsellem/readwise-vector-db)** - ⭐ 24
...
3040. **[cfbd-mcp-server](https://github.com/lenwood/cfbd-mcp-server)** - ⭐ 24
   An MCP server enabling CFBD API queries within Claude Desktop.

3041. **[mcp-server-amazon-bedrock](https://github.com/zxkane/mcp-server-amazon-bedrock)** - ⭐ 24
   Model Context Procotol(MCP) server for using Amazon Bedrock Nova Canvas to generate images

3042. **[k6-mcp-server](https://github.com/QAInsights/k6-mcp-server)** - ⭐ 24
   k6 MCP server

3043. **[bzm-mcp](https://github.com/Blazemeter/bzm-mcp)** - ⭐ 24
   Official BlazeMeter MCP Server for AI-driven performance testing

3044. **[mcp-client-agent](https://github.com/shane-kercheval/mcp-client-agent)** - ⭐ 24
   CLI that uses DSPy to interact with MCP servers.

3045. **[roo-logger](https://github.com/annenpolka/roo-logger)** - ⭐ 24
   An MCP server for logging activity in Roo Code/Cline.

3046. **[identity-spec](https://github.com/agntcy/identity-spec)** - ⭐ 24
   AGNTCY Identity allows to onboard, create and verify identities for Agents, Model Context Protocol (MCP) Servers and Multi-Agent Systems (MASs).

3047. **[cursor-db-mcp](https://github.com/jbdamask/cursor-db-mcp)** - ⭐ 24
   Model Context Protocol server for querying Cursor chat history

3048. **[d365fo-client](https://github.com/mafzaal/d365fo-client)** - ⭐ 24
...
3049. **[lua-resty-mcp](https://github.com/ufownl/lua-resty-mcp)** - ⭐ 24
   Model Context Protocol SDK implemented in Lua for OpenResty

3050. **[solana-mcp](https://github.com/tony-42069/solana-mcp)** - ⭐ 24
...
3051. **[silverbullet-mcp](https://github.com/Ahmad-A0/silverbullet-mcp)** - ⭐ 24
   A Model Context Protocol (MCP) server to interact with your SilverBullet notes and data.

3052. **[aj-mcp](https://github.com/lightweight-component/aj-mcp)** - ⭐ 24
   Simple MCP SDK in Java

3053. **[skill-mcp](https://github.com/fkesheh/skill-mcp)** - ⭐ 24
...
3054. **[codingbuddy](https://github.com/JeremyDev87/codingbuddy)** - ⭐ 24
...
3055. **[opnsense-mcp-server](https://github.com/Pixelworlds/opnsense-mcp-server)** - ⭐ 24
   Modular MCP server for OPNsense firewall management - 88 tools providing access to 2000+ methods through AI assistants

3056. **[jsonv-ts](https://github.com/dswbx/jsonv-ts)** - ⭐ 24
   JSON Schema builder and validator for TypeScript with static type inference, Hono middleware for OpenAPI generation and validation, and MCP server/client implementation. Lightweight, dependency-free, and built on Web Standards.

3057. **[help-scout-mcp-server](https://github.com/drewburchfield/help-scout-mcp-server)** - ⭐ 24
   MCP server for Help Scout - search conversations, threads, and inboxes with AI agents

3058. **[mcp-mesh](https://github.com/dhyansraj/mcp-mesh)** - ⭐ 24
...
3059. **[holoviz-mcp](https://github.com/MarcSkovMadsen/holoviz-mcp)** - ⭐ 24
   ✨A MCP server that provides intelligent access to the HoloViz ecosystem for humans and AIs.

3060. **[mcp-rss-aggregator](https://github.com/imprvhub/mcp-rss-aggregator)** - ⭐ 24
   Model Context Protocol Server for aggregating RSS feeds in Claude Desktop

3061. **[music-composer-webmcp](https://github.com/Leanmcp-Community/music-composer-webmcp)** - ⭐ 24
...
3062. **[agent-twitter-client-mcp](https://github.com/ryanmac/agent-twitter-client-mcp)** - ⭐ 24
...
3063. **[godot-mcp](https://github.com/HaD0Yun/godot-mcp)** - ⭐ 24
...
3064. **[Model-Context-Protocol](https://github.com/Coding-Crashkurse/Model-Context-Protocol)** - ⭐ 23

3065. **[jigsawstack-mcp-server](https://github.com/JigsawStack/jigsawstack-mcp-server)** - ⭐ 23
   Model Context Protocol Server that allows AI models to interact with JigsawStack models!

3066. **[cortex](https://github.com/FreePeak/cortex)** - ⭐ 23
...
3067. **[paraview_mcp](https://github.com/LLNL/paraview_mcp)** - ⭐ 23
   ParaView-MCP integrates multimodal LLMs with ParaView via Model Context Protocol, enabling natural language control of scientific visualizations. The agent observes the viewport for visual feedback, making complex visualization tool accessible to all users while providing intelligent automation for experts.

3068. **[lineshopping-api-mcp](https://github.com/woraphol-j/lineshopping-api-mcp)** - ⭐ 23
...
3069. **[home-assistant-mcp](https://github.com/hpohlmann/home-assistant-mcp)** - ⭐ 23
...
3070. **[mcp-twitter-server](https://github.com/crazyrabbitLTC/mcp-twitter-server)** - ⭐ 23
   Model Context Protocol Server for Accessing twitter

3071. **[strava-mcp](https://github.com/kw510/strava-mcp)** - ⭐ 23
...
3072. **[mcp-community](https://github.com/Mirascope/mcp-community)** - ⭐ 23
   Easily run, deploy, and connect to MCP servers

3073. **[aisdk-mcp-bridge](https://github.com/vrknetha/aisdk-mcp-bridge)** - ⭐ 23
...
3074. **[nlweb-net](https://github.com/nlweb-ai/nlweb-net)** - ⭐ 23
...
3075. **[mcp-pa-ai-agent](https://github.com/zhangzhongnan928/mcp-pa-ai-agent)** - ⭐ 23
   A personal assistant AI agent built with the Model Context Protocol (MCP)

3076. **[microsoft_fabric_mcp](https://github.com/Augustab/microsoft_fabric_mcp)** - ⭐ 23
   MCP server wrapping around the Fabric Rest API

3077. **[lightdash-mcp-server](https://github.com/syucream/lightdash-mcp-server)** - ⭐ 23
   A MCP(Model Context Protocol) server that accesses to Lightdash

3078. **[balldontlie-mcp](https://github.com/mikechao/balldontlie-mcp)** - ⭐ 23
   An MCP Server implementation that integrates the Balldontlie API, to provide information about players, teams and games for the NBA, NFL and MLB

3079. **[slack-mcp-client](https://github.com/csonigo/slack-mcp-client)** - ⭐ 23
   An MCP client for slack in Typescript

3080. **[fastify-mcp-server](https://github.com/flaviodelgrosso/fastify-mcp-server)** - ⭐ 23
   Fastify plugin to easily spin up Model Context Protocol (MCP) HTTP servers

3081. **[codemesh](https://github.com/kiliman/codemesh)** - ⭐ 23
   The Self-Improving MCP Server - Agents write code to orchestrate multiple MCP servers with intelligent TypeScript execution and auto-augmentation

3082. **[azure-diagram-mcp](https://github.com/dminkovski/azure-diagram-mcp)** - ⭐ 23
...
3083. **[MCP-123](https://github.com/Tylersuard/MCP-123)** - ⭐ 23
   The easiest possible implementation of an MCP server and client.  Set up a server or a client in 2 lines of code.

3084. **[cf-mcp-client](https://github.com/cpage-pivotal/cf-mcp-client)** - ⭐ 23
   Tanzu Platform Chat

3085. **[server-sharepoint](https://github.com/Zerg00s/server-sharepoint)** - ⭐ 23
...
3086. **[fastify-mcp](https://github.com/haroldadmin/fastify-mcp)** - ⭐ 23
   A Fastify plugin to run Model Context Protocol (MCP) servers

3087. **[Excel-MCP-Server-Master](https://github.com/guillehr2/Excel-MCP-Server-Master)** - ⭐ 23
...
3088. **[datawrapper-mcp](https://github.com/palewire/datawrapper-mcp)** - ⭐ 23
   A Model Context Protocol (MCP) server for creating Datawrapper charts using AI assistants.

3089. **[codebase-context](https://github.com/PatrickSys/codebase-context)** - ⭐ 23
...
3090. **[google-search-console-mcp](https://github.com/surendranb/google-search-console-mcp)** - ⭐ 23
   Google Search Console MCP Server for Claude, Cursor, Windsurf and other MCP Clients

3091. **[NiFiMCP](https://github.com/ms82119/NiFiMCP)** - ⭐ 23
   An MCP Server and client for communicating with Nifi (v1.28)

3092. **[autotask-mcp](https://github.com/asachs01/autotask-mcp)** - ⭐ 23
   MCP server for Kaseya Autotask PSA — 39 tools for companies, tickets, projects, time entries, and more

3093. **[Claude-Code-MCP-Manager](https://github.com/qdhenry/Claude-Code-MCP-Manager)** - ⭐ 23
    A comprehensive tool to manage Model Context Protocol (MCP) configurations for Claude code

3094. **[nobitex-mcp-server](https://github.com/xmannii/nobitex-mcp-server)** - ⭐ 22
   a Model Context Protocol (MCP) server that provides access to cryptocurrency market data from the Nobitex API.

3095. **[mcp-server-oracle](https://github.com/hdcola/mcp-server-oracle)** - ⭐ 22
   Model Context Protocol server to access oracle database

3096. **[higress-ops-mcp-server](https://github.com/higress-group/higress-ops-mcp-server)** - ⭐ 22
   A Model Context Protocol (MCP) server implementation that enables comprehensive configuration and management of Higress.

3097. **[Elysia-mcp](https://github.com/keithagroves/Elysia-mcp)** - ⭐ 22
   Model Context Protocol (MCP) Server for Bun and Elysia

3098. **[mcp-flux-studio](https://github.com/jmanhype/mcp-flux-studio)** - ⭐ 22
   A Model Context Protocol server for Flux image generation, providing tools for image generation, manipulation, and control

3099. **[DANP-Engine](https://github.com/DANP-LABS/DANP-Engine)** - ⭐ 22
   A trusted AI Model Context Protocol (MCP) runtime for secure, decentralized AI tools and services.

3100. **[mcp-sse-authenticated-cloud-run](https://github.com/the-freetech-company/mcp-sse-authenticated-cloud-run)** - ⭐ 22
   Host an Model Context Protocol SSE deployment on Cloud Run, Authenticating with IAM.

3101. **[MobSF-MCP](https://github.com/il-il1/MobSF-MCP)** - ⭐ 22
   a Node.js-based Model Context Protocol implementation for MobSF

3102. **[async-mcp](https://github.com/v3g42/async-mcp)** - ⭐ 22
   A minimalistic async Rust implementation of the Model Context Protocol (MCP).

3103. **[mcpagentai](https://github.com/mcpagents-ai/mcpagentai)** - ⭐ 22
...
3104. **[p5js-ai-editor](https://github.com/adilmoujahid/p5js-ai-editor)** - ⭐ 22
...
3105. **[printify-mcp](https://github.com/TSavo/printify-mcp)** - ⭐ 22
   A Model Context Protocol (MCP) server for integrating AI assistants with Printify's print-on-demand platform

3106. **[supabase-mcp-client](https://github.com/tambo-ai/supabase-mcp-client)** - ⭐ 22
   Supabase MCP client react app with Tambo

3107. **[biznagafest-mcp](https://github.com/0GiS0/biznagafest-mcp)** - ⭐ 22
   MCP Servers en Málaga con salero

3108. **[langchain-mcp-tools-ts](https://github.com/hideya/langchain-mcp-tools-ts)** - ⭐ 22
   MCP to LangChain Tools Conversion Utility / TypeScript

3109. **[dbt-docs-mcp](https://github.com/mattijsdp/dbt-docs-mcp)** - ⭐ 22
   MCP (model context protocol) server for interacting with dbt Docs

3110. **[metmuseum-mcp](https://github.com/mikechao/metmuseum-mcp)** - ⭐ 22
   Met Museum MCP integration to discover the art collection at The Metropolitan Museum of Art in New York

3111. **[nix-mcp-servers](https://github.com/ismail-kattakath/nix-mcp-servers)** - ⭐ 22
   A nix flake for configuring Model Context Protocol (MCP) servers across supported AI assistant clients

3112. **[ib-mcp-cache-server](https://github.com/ibproduct/ib-mcp-cache-server)** - ⭐ 22
   Memory Cache Server for use with supported MCP API Clients.

3113. **[your-money-left-the-chat](https://github.com/Rayato159/your-money-left-the-chat)** - ⭐ 22
   A Rust + MCP powered financial tracker that knows exactly where your money ghosted you.

3114. **[turbomcpstudio](https://github.com/Epistates/turbomcpstudio)** - ⭐ 22
   A native desktop application for developing, testing, and debugging Model Context Protocol servers.

3115. **[mcp-cmd](https://github.com/developit/mcp-cmd)** - ⭐ 22
   CLI for calling successive MCP Server tools

3116. **[mcp-framework](https://github.com/koki7o/mcp-framework)** - ⭐ 22
   Rust MCP framework for building AI agents

3117. **[GUI-MCP](https://github.com/PhialsBasement/GUI-MCP)** - ⭐ 22
...
3118. **[mcp-wireshark](https://github.com/khuynh22/mcp-wireshark)** - ⭐ 22
...
3124. **[ffmpeg-mcp-lite](https://github.com/kevinwatt/ffmpeg-mcp-lite)** - ⭐ 22
   MCP server for video/audio processing via FFmpeg - convert, compress, trim, extract audio, add subtitles

3125. **[awesome-mcp](https://github.com/MCPHubCloud/awesome-mcp)** - ⭐ 22
   A collection of mcp servers/client/sdks

3126. **[claude-vigil-mcp](https://github.com/Vvkmnn/claude-vigil-mcp)** - ⭐ 21
   🏺 An MCP server for checkpointing and file recovery in Claude Code

3127. **[MCP_A2A](https://github.com/regismesquita/MCP_A2A)** - ⭐ 21
...
3128. **[grumpydev-mcp](https://github.com/sinedied/grumpydev-mcp)** - ⭐ 21
   Let the grumpy senior dev review your code with this MCP server

3129. **[bridge-mcp](https://github.com/codingjam/bridge-mcp)** - ⭐ 21
...
3130. **[mcpsharepoint](https://github.com/BrianCusack/mcpsharepoint)** - ⭐ 21
   Model Context Protocol server that provides access to Organisational SharePoint.

3131. **[command-executor-mcp-server](https://github.com/Sunwood-ai-labs/command-executor-mcp-server)** - ⭐ 21
   Model Context Protocol Server for Safely Executing Pre-approved Commands

3132. **[emqx-mcp-server](https://github.com/Benniu/emqx-mcp-server)** - ⭐ 21
   A Model Context Protocol (MCP) server implementation that provides EMQX MQTT broker interaction.

3133. **[mcp-sentry](https://github.com/MCP-100/mcp-sentry)** - ⭐ 21
   A Model Context Protocol server for retrieving and analyzing issues from Sentry.io

3134. **[mcp-korean-spell](https://github.com/winterjung/mcp-korean-spell)** - ⭐ 21
   MCP(Model Context Protocol) server designed for Korean spell checking

3135. **[DocsRay](https://github.com/MIMICLab/DocsRay)** - ⭐ 21
   Lightweight PDF Q&A tool powered by RAG (Retrieval-Augmented Generation) with MCP (Model Context Protocol) Support.

3136. **[MCPRules](https://github.com/bartwisch/MCPRules)** - ⭐ 21
...
3145. **[mcp-ai-agent](https://github.com/fkesheh/mcp-ai-agent)** - ⭐ 21
...
3146. **[aws-s3-mcp](https://github.com/samuraikun/aws-s3-mcp)** - ⭐ 21
   MCP server to integrate AWS S3 and LLM

3147. **[mcp-server-memos-py](https://github.com/RyoJerryYu/mcp-server-memos-py)** - ⭐ 21
   A Python package enabling LLM models to interact with the Memos server via the MCP interface for searching, creating, retrieving, and managing memos.

3148. **[golemcore-bot](https://github.com/alexk-dev/golemcore-bot)** - ⭐ 21
...
3149. **[qdrant-mcp-server](https://github.com/mhalder/qdrant-mcp-server)** - ⭐ 21
   MCP server for semantic search using local Qdrant vector database and OpenAI embeddings

3150. **[raybridge](https://github.com/jlokos/raybridge)** - ⭐ 21
   MCP server that bridges Raycast extensions to any MCP-compatible client

3151. **[mcp-prompt-optimizer](https://github.com/Bubobot-Team/mcp-prompt-optimizer)** - ⭐ 21
   Advanced MCP server providing cutting-edge prompt optimization tools with research-backed strategies

3152. **[html-to-markdown-mcp](https://github.com/levz0r/html-to-markdown-mcp)** - ⭐ 21
...
3153. **[Air-Quality-Trends-Analysis-Project](https://github.com/dyneth02/Air-Quality-Trends-Analysis-Project)** - ⭐ 21
...
3154. **[guidance-for-scalable-model-inference-and-agentic-ai-on-amazon-eks](https://github.com/aws-solutions-library-samples/guidance-for-scalable-model-inference-and-agentic-ai-on-amazon-eks)** - ⭐ 21
...
3155. **[local_faiss_mcp](https://github.com/nonatofabio/local_faiss_mcp)** - ⭐ 21
   Local FAISS vector store as an MCP server – drop-in local RAG for Claude / Copilot / Agents.

3156. **[heuristic-mcp](https://github.com/softerist/heuristic-mcp)** - ⭐ 21
...
3157. **[mcp-diagnostics-extension](https://github.com/newbpydev/mcp-diagnostics-extension)** - ⭐ 20
   VS Code extension that exposes diagnostic problems via Model Context Protocol (MCP) for AI agents and tools

3158. **[mcp-server-runner](https://github.com/yonaka15/mcp-server-runner)** - ⭐ 20
...
3159. **[easymcp](https://github.com/promptmesh/easymcp)** - ⭐ 20
   A high performance MCP client sdk for python

3160. **[PDB-MCP-Server](https://github.com/Augmented-Nature/PDB-MCP-Server)** - ⭐ 20
...
3161. **[mcp-free-usdc-transfer](https://github.com/magnetai/mcp-free-usdc-transfer)** - ⭐ 20
   MCP (Model Context Protocol) server - free usdc transfer powered by Coinbase CDP

3162. **[mcp-file-operations-server](https://github.com/bsmi021/mcp-file-operations-server)** - ⭐ 20
   A Model Context Protocol (MCP) server that provides enhanced file operation capabilities with streaming, patching, and change tracking support.

3163. **[cucumberstudio-mcp](https://github.com/HeroSizy/cucumberstudio-mcp)** - ⭐ 20
   MCP Server for Cucumber Studio

3164. **[knowledgebase-mcp](https://github.com/biocontext-ai/knowledgebase-mcp)** - ⭐ 20
   BioContextAI Knowledgebase MCP server for biomedical agentic AI 

3165. **[registry](https://github.com/biocontext-ai/registry)** - ⭐ 20
   The BioContextAI Registry for biomedical MCP servers

3166. **[jenkins-mcp-enterprise](https://github.com/Jordan-Jarvis/jenkins-mcp-enterprise)** - ⭐ 20
...
3167. **[UCAI](https://github.com/nirholas/UCAI)** - ⭐ 20
...
3168. **[agent-mcp](https://github.com/grupa-ai/agent-mcp)** - ⭐ 20
   MCPAgent for Grupa.AI Multi-agent Collaboration Network (MACNET) with Model Context Protocol (MCP) capabilities baked in

3169. **[lotus-wisdom-mcp](https://github.com/linxule/lotus-wisdom-mcp)** - ⭐ 20
...
3170. **[flutter-ai-labs](https://github.com/theshivamlko/flutter-ai-labs)** - ⭐ 20
   A curated collection of LLM-powered Flutter apps built using RAG, AI Agents, Multi-Agent Systems, MCP, and Voice Agents.

3171. **[MCP-Mastery-with-Claude-and-Langchain](https://github.com/laxmimerit/MCP-Mastery-with-Claude-and-Langchain)** - ⭐ 20
   Build MCP servers & clients with Python, Streamlit, ChromaDB, LangChain, LangGraph agents, and Ollama integrations

3172. **[mcp-link](https://github.com/AuraFriday/mcp-link)** - ⭐ 20
...
3173. **[Zammad-MCP](https://github.com/basher83/Zammad-MCP)** - ⭐ 20
...
3174. **[janee](https://github.com/rsdouglas/janee)** - ⭐ 20
   Secrets management for AI agents via MCP • @janeesecure

3175. **[mcp-web-scraper](https://github.com/Decodo/mcp-web-scraper)** - ⭐ 20
   The Decodo MCP server which enables MCP clients to interface with services.

3176. **[rollbar-mcp-server](https://github.com/rollbar/rollbar-mcp-server)** - ⭐ 20
   Pre-release - Model Context Protocol server for Rollbar

3177. **[gemini-mcp-client](https://github.com/angrysky56/gemini-mcp-client)** - ⭐ 19
...
3178. **[starbase](https://github.com/metorial/starbase)** - ⭐ 19
   Connect, explore, and test any MCP server with AI models 🤖 ⚡

3179. **[mcp](https://github.com/EmilLindfors/mcp)** - ⭐ 19
    A crate for making MCP (Model Context Protocol) compatible programs with rust

3180. **[mcp-frontend](https://github.com/shaharia-lab/mcp-frontend)** - ⭐ 19
   Frontend for MCP (Model Context Protocol) Kit for Go - A Complete MCP solutions for ready to use

3181. **[mcp-server-mariadb](https://github.com/abel9851/mcp-server-mariadb)** - ⭐ 19
   An mcp server that provides read-only access to MariaDB.

3182. **[mcp-server](https://github.com/paperinvest/mcp-server)** - ⭐ 19
   Official MCP server for Paper's trading platform - enables AI assistants to interact with Paper's API

3183. **[linux-command-mcp](https://github.com/xkiranj/linux-command-mcp)** - ⭐ 19
   MCP server and client for running Linux commands

3184. **[mcp-server-client-demo](https://github.com/S1LV3RJ1NX/mcp-server-client-demo)** - ⭐ 19
   Streamable HTTP based MCP server and Client demo with auto registry, Dockerfile setup and env. 

3185. **[openapi2mcptools](https://github.com/2013xile/openapi2mcptools)** - ⭐ 19
   OpenAPI specifications => MCP (Model Context Protocol) tools

3186. **[ai-cli](https://github.com/manusa/ai-cli)** - ⭐ 19
   ai-cli lets you go from zero to AI-powered in seconds in a safe, automated and tailored way.

3187. **[typescript-mcp-client](https://github.com/CodelyTV/typescript-mcp-client)** - ⭐ 19

3188. **[eraser-io-mcp-server](https://github.com/buck-0x/eraser-io-mcp-server)** - ⭐ 19
   A Python MCP (Model Context Protocol) server and CLI tool to render diagrams using the Eraser API.

3189. **[context-lens](https://github.com/cornelcroi/context-lens)** - ⭐ 19
...
3190. **[termlink](https://github.com/chu2bard/termlink)** - ⭐ 19
   MCP server for shell and terminal operations

3191. **[Augmented-Nature-UniProt-MCP-Server](https://github.com/Augmented-Nature/Augmented-Nature-UniProt-MCP-Server)** - ⭐ 19
   A comprehensive Model Context Protocol (MCP) server providing advanced access to the UniProt protein database. 

3192. **[ACP-MCP-Server](https://github.com/GongRzhe/ACP-MCP-Server)** - ⭐ 19
...
3193. **[it-tools-mcp](https://github.com/wrenchpilot/it-tools-mcp)** - ⭐ 19
...
3194. **[Blender-MCP-Server](https://github.com/poly-mcp/Blender-MCP-Server)** - ⭐ 19
...
3195. **[codeprism](https://github.com/rustic-ai/codeprism)** - ⭐ 19
...
3196. **[google-scholar-mcp](https://github.com/mochow13/google-scholar-mcp)** - ⭐ 19
   An MCP server for Google Scholar written in TypeScript with Streamable HTTP

3197. **[mcpbi](https://github.com/jonaolden/mcpbi)** - ⭐ 19
   PowerBI MCP server to give LLM clients (Claude, GH Copilot,etc) context from locally running PowerBI Desktop instances.

3198. **[mcp](https://github.com/zuplo/mcp)** - ⭐ 18
   A fetch API based TypeScript SDK for MCP

3199. **[eleven.shopping](https://github.com/elevenlabs/eleven.shopping)** - ⭐ 18
   ElevenLabs Agent with Storefront MCP UI Server & MCP UI client

3200. **[openpyxl-mcp-server](https://github.com/jonemo/openpyxl-mcp-server)** - ⭐ 18
...
3201. **[sufetch](https://github.com/productdevbook/sufetch)** - ⭐ 18
   Type-safe OpenAPI clients with MCP server for AI-driven API exploration

3202. **[SimpleMcp.Demo](https://github.com/hassanhabib/SimpleMcp.Demo)** - ⭐ 18
   Simplest Possible Demo for Building MCP Server & Client

3203. **[mcp-copilot](https://github.com/tshu-w/mcp-copilot)** - ⭐ 18
   A meta MCP server that seamlessly scales LLMs to 1000+ MCP servers through automatic routing.

3204. **[mcp-libsql](https://github.com/Xexr/mcp-libsql)** - ⭐ 18
...
3205. **[gpt2099.nu](https://github.com/cablehead/gpt2099.nu)** - ⭐ 18
   a Nushell cross.stream extension to interact with LLMs and MCP servers

3206. **[Devmind-MCP](https://github.com/JochenYang/Devmind-MCP)** - ⭐ 18
...
3207. **[seedream-image-mcp](https://github.com/wearzdk/seedream-image-mcp)** - ⭐ 18
   🚀 PixelMCP | 为你的 Cursor、Claude Code 等集成AI绘画能力，让AI生成的页面不再单调！

3208. **[mcp-chat-studio](https://github.com/JoeCastrom/mcp-chat-studio)** - ⭐ 18
...
3209. **[mcp-agent](https://github.com/joshuaalpuerto/mcp-agent)** - ⭐ 18
...
3210. **[mcpx](https://github.com/AIGC-Hackers/mcpx)** - ⭐ 18
...
3211. **[mcp-server-microsoft-paint](https://github.com/ghuntley/mcp-server-microsoft-paint)** - ⭐ 18

3212. **[mcp-chain-of-draft-prompt-tool](https://github.com/brendancopley/mcp-chain-of-draft-prompt-tool)** - ⭐ 18
   MCP prompt tool applying Chain-of-Draft (CoD) reasoning - BYOLLM

3213. **[mcp-oauth-proxy](https://github.com/obot-platform/mcp-oauth-proxy)** - ⭐ 18
   Oauth 2.1 proxy server that can autheticate client and proxy requests to mcp server

3214. **[mcp-yfinance](https://github.com/9nate-drake/mcp-yfinance)** - ⭐ 18
   MCP Server for fething yfinance financial data into Claude Desktop

3215. **[gh-mcp](https://github.com/shuymn/gh-mcp)** - ⭐ 18
...
3216. **[toolkit-mcp-server](https://github.com/cyanheads/toolkit-mcp-server)** - ⭐ 18
   A Model Context Protocol server providing LLM Agents with system utilities and tools, including IP geolocation, network diagnostics, system monitoring, cryptographic operations, and QR code generation.

3217. **[hasmcp-ce](https://github.com/hasmcp/hasmcp-ce)** - ⭐ 18
   HasMCP Community Edition

3218. **[model-context-protocol-survey](https://github.com/asinghcsu/model-context-protocol-survey)** - ⭐ 18
   Model Context Protocol (MCP)

3219. **[MCP-Development-with-Rust](https://github.com/RustSandbox/MCP-Development-with-Rust)** - ⭐ 18
...
3220. **[mcp-server-amazon](https://github.com/rigwild/mcp-server-amazon)** - ⭐ 18
   🛍📦 Unofficial Amazon Model Context Protocol Server (MCP) - Search products and purchase directly from Claude AI! ✨

3221. **[unity-editor-mcp](https://github.com/ozankasikci/unity-editor-mcp)** - ⭐ 18
   An MCP server and client for LLMs to interact with Unity Projects

3222. **[emceepee](https://github.com/eastlondoner/emceepee)** - ⭐ 18
...
3223. **[short-url](https://github.com/fengzhongsen/short-url)** - ⭐ 18
   简单易用的短链接生成工具，完全开源、免费、无需登录，可私有化部署，链接永久有效！

3224. **[MCP-Agent](https://github.com/CursorTouch/MCP-Agent)** - ⭐ 18
   Connect to any MCP servers using agents

3225. **[github-repos-manager-mcp](https://github.com/kurdin/github-repos-manager-mcp)** - ⭐ 18
...
3226. **[substack-mcp](https://github.com/marcomoauro/substack-mcp)** - ⭐ 18
...
3227. **[universal-crypto-mcp](https://github.com/nirholas/universal-crypto-mcp)** - ⭐ 18
...
3228. **[smartlead-mcp-server](https://github.com/jonathan-politzki/smartlead-mcp-server)** - ⭐ 17
   Local version of Smartlead MCP for quick download and deployment to MCP compatible clients or n8n.

3229. **[mcp-http-client-example](https://github.com/slavashvets/mcp-http-client-example)** - ⭐ 17
   Simple example client demonstrating how to connect to MCP servers over HTTP (SSE)

3230. **[jiki](https://github.com/teilomillet/jiki)** - ⭐ 17

3231. **[askit](https://github.com/johnrobinsn/askit)** - ⭐ 17
   LLM Function Calling Library and CLI with Support for MCP Servers

3232. **[youtube-mcp-server](https://github.com/0GiS0/youtube-mcp-server)** - ⭐ 17
   Cómo crear MCP Servers y usarlos con GitHub Copilot Chat 🚀💻🤖

3233. **[cmcp](https://github.com/RussellLuo/cmcp)** - ⭐ 17
   A command-line utility for interacting with MCP servers.

3234. **[GUARDRAIL](https://github.com/nshkrdotcom/GUARDRAIL)** - ⭐ 17
   GUARDRAIL - MCP Security - Gateway for Unified Access, Resource Delegation, and Risk-Attenuating Information Limits

3235. **[mcp-server-prometheus](https://github.com/loglmhq/mcp-server-prometheus)** - ⭐ 17
   MCP server for interacting with Prometheus

3236. **[titanmind-whatsapp-mcp](https://github.com/TitanmindAGI/titanmind-whatsapp-mcp)** - ⭐ 17
...
3237. **[mcp-koii](https://github.com/benjaminr/mcp-koii)** - ⭐ 17
   MCP Server for Teenage Engineering EP-133 KO-II

3238. **[context-engineering](https://github.com/timothywarner-org/context-engineering)** - ⭐ 17
...
3239. **[daiv](https://github.com/srtab/daiv)** - ⭐ 17
...
3240. **[docmole](https://github.com/Vigtu/docmole)** - ⭐ 17
   Dig through any documentation with AI - MCP server for Claude, Cursor, and other AI assistants

3241. **[unity-mcp](https://github.com/wondeks/unity-mcp)** - ⭐ 17
   A Unity MCP server that allows MCP clients like Claude Desktop or Cursor to perform Unity Editor actions.

3242. **[Agentic-MCP-Skill](https://github.com/cablate/Agentic-MCP-Skill)** - ⭐ 17
   Agentic-MCP, Progressive MCP client with three-layer lazy loading. Validates AgentSkills.io pattern for efficient token usage. Use MCP without pre-install & wasting full-loading

3243. **[mcp-chatbot](https://github.com/mctrinh/mcp-chatbot)** - ⭐ 17
...
3244. **[autowpmcp](https://github.com/Njengah/autowpmcp)** - ⭐ 17
...
3245. **[arxiv-mcp-server](https://github.com/anuj0456/arxiv-mcp-server)** - ⭐ 17
...
3246. **[rpc-nodes-mcp](https://github.com/chainstacklabs/rpc-nodes-mcp)** - ⭐ 17
   Minimal, fast, and extensible MCP server for interactions with JSON-RPC blockchain nodes

3247. **[mcp](https://github.com/yandex-cloud/mcp)** - ⭐ 17
   Yandex Cloud MCP Servers

3248. **[teamcity-mcp](https://github.com/Daghis/teamcity-mcp)** - ⭐ 17
...
3249. **[local-skills-mcp](https://github.com/kdpa-llc/local-skills-mcp)** - ⭐ 17
   Universal MCP server enabling any LLM or AI agent to utilize expert skills from your local filesystem. Reduces context consumption through lazy loading. Works with Claude, Cline, and any MCP-compatible client.

3250. **[toolhive-catalog](https://github.com/stacklok/toolhive-catalog)** - ⭐ 17
   ToolHive's registry catalog of MCP servers

3251. **[mcp-server-codegraph](https://github.com/CartographAI/mcp-server-codegraph)** - ⭐ 17
   MCP server for graph representation of a codebase

3252. **[IoT-Edge-MCP-Server](https://github.com/poly-mcp/IoT-Edge-MCP-Server)** - ⭐ 17
...
3253. **[leanmcp-sdk](https://github.com/LeanMCP/leanmcp-sdk)** - ⭐ 17
   Production-ready TypeScript SDK for MCP servers: auth, multi-tenant, observability. Build enterprise AI agents fast.

3254. **[pophive-mcp-server](https://github.com/Cicatriiz/pophive-mcp-server)** - ⭐ 17
...
3255. **[ChatSpatial](https://github.com/cafferychen777/ChatSpatial)** - ⭐ 17
...
3256. **[skill-to-mcp](https://github.com/biocontext-ai/skill-to-mcp)** - ⭐ 17
   Convert AI Skills (Claude Skills format) to MCP server resources - Part of BioContextAI

3257. **[MCPHammer](https://github.com/praetorian-inc/MCPHammer)** - ⭐ 17
   MCP security testing framework for evaluating Model Context Protocol server vulnerabilities

3258. **[muxi](https://github.com/ranaroussi/muxi)** - ⭐ 16
   An extensible AI agents framework

3259. **[mcp-email-client](https://github.com/gamalan/mcp-email-client)** - ⭐ 16
   Email Client as MCP Server. Feature: multiple configuration, more than just gmail

3260. **[oneshot](https://github.com/Destiner/oneshot)** - ⭐ 16
   Anthropic MCP client for macOS

3261. **[CereBro](https://github.com/rob1997/CereBro)** - ⭐ 16
   A model-agnostic MCP Client-Server for .Net and Unity

3262. **[lite-mcp-client](https://github.com/sligter/lite-mcp-client)** - ⭐ 16
   Lite-MCP-Client是一个基于命令行的轻量级MCP客户端工具

3263. **[EasyMCP](https://github.com/mshojaei77/EasyMCP)** - ⭐ 16
...
3264. **[mcp-installer](https://github.com/joobisb/mcp-installer)** - ⭐ 16
   Simplifies the installation and management of MCP (Model Context Protocol) servers across different AI clients.

3265. **[appvector-mcp](https://github.com/Multivariate-AI-Inc/appvector-mcp)** - ⭐ 16
...
3266. **[protocols-io-mcp-server](https://github.com/hqn21/protocols-io-mcp-server)** - ⭐ 16
   An MCP server that enables MCP clients like Claude Desktop to interact with data from protocols.io.

3267. **[mcp-progressive-agentskill](https://github.com/cablate/mcp-progressive-agentskill)** - ⭐ 16
...
3268. **[create-mcp](https://github.com/fefergrgrgrg/create-mcp)** - ⭐ 16
   CLI to set up and deploy MCP Servers to Cloudflare Workers in seconds. Just write TypeScript functions to make Cursor MCP tools.

3269. **[videocapture-mcp](https://github.com/13rac1/videocapture-mcp)** - ⭐ 16
   Model Context Protocol (MCP) server to capture images from an OpenCV-compatible webcam or video source

3270. **[aica](https://github.com/dotneet/aica)** - ⭐ 16
   aica(AI Code Analyzer) reviews your code using AI. Supports CLI and GitHub Actions.

3271. **[gumroad-mcp](https://github.com/rmarescu/gumroad-mcp)** - ⭐ 16
   A Model Context Protocol (MCP) server implementation for Gumroad API

3272. **[go-mcp](https://github.com/dstotijn/go-mcp)** - ⭐ 16
   Go library for implementing the Model Context Protocol (MCP).

3273. **[sveltekit-mcp-starter](https://github.com/axel-rock/sveltekit-mcp-starter)** - ⭐ 16

3274. **[mcp-gateway](https://github.com/unrelated-ai/mcp-gateway)** - ⭐ 16
...
3275. **[qmt-mcp-server](https://github.com/jm12138/qmt-mcp-server)** - ⭐ 16
   基于 QMT 平台股票行情的 MCP 服务器，用于提供股票市场数据下载和查询的功能。

3276. **[mlb-mcp](https://github.com/etweisberg/mlb-mcp)** - ⭐ 16
   MCP server for advanced baseball analytics (statcast, fangraphs, baseball reference, mlb stats API) with client demo 

3277. **[grok-faf-mcp](https://github.com/Wolfe-Jam/grok-faf-mcp)** - ⭐ 16
   First MCP server for Grok | FAST⚡️AF • URL-based AI context • Vercel-deployed

3278. **[awesome-dxt-mcp](https://github.com/MCPStar/awesome-dxt-mcp)** - ⭐ 16
...
3279. **[hass-mcp-server](https://github.com/ganhammar/hass-mcp-server)** - ⭐ 16
...
3280. **[agentidentityprotocol](https://github.com/openagentidentityprotocol/agentidentityprotocol)** - ⭐ 16
...
3281. **[mcp-jest](https://github.com/josharsh/mcp-jest)** - ⭐ 16
   Automated testing for Model Context Protocol servers. Ship MCP Servers with confidence.

3282. **[rigour](https://github.com/rigour-labs/rigour)** - ⭐ 16
   Local-first quality gate + fix-loop controller for AI coding agents (CLI + MCP).

3283. **[archmcp](https://github.com/dejo1307/archmcp)** - ⭐ 16
   archmcp - MCP Architectural Snapshot Server and Knowledge Graph

3284. **[mie](https://github.com/kraklabs/mie)** - ⭐ 16
...
3285. **[mirroir-mcp](https://github.com/jfarcand/mirroir-mcp)** - ⭐ 16
...
3286. **[mcp-client-and-proxy](https://github.com/appsecco/mcp-client-and-proxy)** - ⭐ 15
   A universal MCP client with proxying feature to interact with MCP Servers which support STDIO transport.

3287. **[mcp_client](https://github.com/app-appplayer/mcp_client)** - ⭐ 15

3288. **[MCP-Analyzer](https://github.com/klara-research/MCP-Analyzer)** - ⭐ 15
   An MCP server to read MCP logs to debug directly inside the client

3289. **[mistr-agent](https://github.com/itisaevalex/mistr-agent)** - ⭐ 15
...
3290. **[mcp-server](https://github.com/HarperFast/mcp-server)** - ⭐ 15
   An MCP server providing an interface for MCP clients to access data within Harper.

3291. **[mcp-this](https://github.com/shane-kercheval/mcp-this)** - ⭐ 15
...
3292. **[django-firebase-mcp](https://github.com/raghavdasila/django-firebase-mcp)** - ⭐ 15
...
3293. **[claude-server](https://github.com/davidteren/claude-server)** - ⭐ 15
...
3294. **[pinmeto-location-mcp](https://github.com/PinMeTo/pinmeto-location-mcp)** - ⭐ 15
   PinMeTo MCP server that enables users with authorized credentials to unlock their data 

3295. **[npm-search-mcp-server](https://github.com/btwiuse/npm-search-mcp-server)** - ⭐ 15
   MCP server for searching npm packages

3296. **[mcp-server-python-template](https://github.com/sontallive/mcp-server-python-template)** - ⭐ 15
   This template provides a streamlined foundation for building Model Context Protocol (MCP) servers in Python. It's designed to make AI-assisted development of MCP tools easier and more efficient.

3297. **[mcp-graphql-forge](https://github.com/toolprint/mcp-graphql-forge)** - ⭐ 15
   MCP that can proxy any GraphQL API and expose graphql operations as mcp tools.

3298. **[mcp-tui](https://github.com/msabramo/mcp-tui)** - ⭐ 15
   MCP host app w/ textual user interface, in Python

3299. **[mcp-server-unitycatalog](https://github.com/ognis1205/mcp-server-unitycatalog)** - ⭐ 15
   Unity Catalog AI Model Context Protocol Server

3300. **[claude-mcp-scheduler](https://github.com/tonybentley/claude-mcp-scheduler)** - ⭐ 15
   Use Claude API to prompt remote agents on a cron interval but use local MCPs to handle tool calls for context

3301. **[Frontapp-MCP](https://github.com/zqushair/Frontapp-MCP)** - ⭐ 15
   MCP server and client for Frontapp

3302. **[vite-plugin-mcp-client-tools](https://github.com/atesgoral/vite-plugin-mcp-client-tools)** - ⭐ 15
   Pluggable Vite MCP plugin that brings client-side tools to your existing Vite setup

3303. **[mcp-server-templates](https://github.com/Data-Everything/mcp-server-templates)** - ⭐ 15
   A flexible platform that provides Docker & Kubernetes backends, a lightweight CLI (mcpt), and client utilities for seamless MCP integration. Spin up servers from templates, route requests through a single endpoint with load balancing, and support both deployed (HTTP) and local (stdio) transports — all with sensible defaults and YAML-based configs.

3304. **[mcp-client-for-weather-example](https://github.com/a-persimmons/mcp-client-for-weather-example)** - ⭐ 15
   一个MCP客户端实践：实现LLM调用天气MCP服务端查询天气的快速示例

3305. **[predictive-maintenance-mcp](https://github.com/LGDiMaggio/predictive-maintenance-mcp)** - ⭐ 15
...
3306. **[signal-mcp-client](https://github.com/piebro/signal-mcp-client)** - ⭐ 15
   An MCP client that uses signal for sending and receiving messages.

3307. **[mcp-turso-cloud](https://github.com/spences10/mcp-turso-cloud)** - ⭐ 15
...
3308. **[lyra-tool-discovery](https://github.com/nirholas/lyra-tool-discovery)** - ⭐ 15
...
3309. **[uk-case-law-mcp-server](https://github.com/georgejeffers/uk-case-law-mcp-server)** - ⭐ 15
   MCP server for UK case law using The National Archives API. Enables LLMs to search, retrieve, and cite UK legal judgments.

3310. **[mcp-web-client](https://github.com/hemanth/mcp-web-client)** - ⭐ 15
   A web-based client for connecting to MCP servers with OAuth support

3311. **[mcp_documents_reader](https://github.com/xt765/mcp_documents_reader)** - ⭐ 15
...
3312. **[hoot](https://github.com/Portkey-AI/hoot)** - ⭐ 15
   MCP Testing Tool — Like Postman, but for the Model Context Protocol.

3313. **[cursor-feedback-extension](https://github.com/jianger666/cursor-feedback-extension)** - ⭐ 15
   Save your Cursor monthly quota! Unlimited AI interactions in one conversation via MCP feedback loop.

3314. **[the-academy](https://github.com/im-knots/the-academy)** - ⭐ 15
   A Socratic dialogue engine for AI agents. 

3315. **[scopus-mcp](https://github.com/qwe4559999/scopus-mcp)** - ⭐ 15
...
3316. **[penpot-mcp-server](https://github.com/zcube/penpot-mcp-server)** - ⭐ 15
   MCP server for Penpot - Connect AI assistants to Penpot design platform via Model Context Protocol

3317. **[claude-praetorian-mcp](https://github.com/Vvkmnn/claude-praetorian-mcp)** - ⭐ 14
   ⚜️ An MCP server for context compaction and recycling in Claude Code

3318. **[chatgpt-app-typescript-template](https://github.com/pomerium/chatgpt-app-typescript-template)** - ⭐ 14
...
3319. **[systemprompt-mcp-core](https://github.com/Ejb503/systemprompt-mcp-core)** - ⭐ 14
   The core MCP extension for Systemprompt MCP multimodal client

3320. **[Open-MCP-Client](https://github.com/GongRzhe/Open-MCP-Client)** - ⭐ 14
...
3321. **[llm-sse-mcp-demo-2025](https://github.com/nlinhvu/llm-sse-mcp-demo-2025)** - ⭐ 14
...
3322. **[mcp-bundler](https://github.com/wrtnlabs/mcp-bundler)** - ⭐ 14
   Is the MCP configuration too complicated? You can easily share your own simplified setup!

3323. **[ntfy-mcp-server](https://github.com/cyanheads/ntfy-mcp-server)** - ⭐ 14
   An MCP (Model Context Protocol) server designed to interact with the ntfy push notification service. It enables LLMs and AI agents to send notifications to your devices with extensive customization options.

3324. **[mcpterm](https://github.com/dwrtz/mcpterm)** - ⭐ 14
   An MCP tool server that provides stateful, TUI-compatible terminal sessions.

3325. **[work-memory-mcp](https://github.com/moontmsai/work-memory-mcp)** - ⭐ 14
   Never lose context again - persistent memory management system for AI-powered workflows across multiple tools

3326. **[mcp-ipfs](https://github.com/alexbakers/mcp-ipfs)** - ⭐ 14
   🪐 MCP IPFS Server 

3327. **[deep-research](https://github.com/troyhantech/deep-research)** - ⭐ 14
   A minimalist deep research framework for any OpenAI API compatible LLMs. 

3328. **[hive-crypto-mcp](https://github.com/hive-intel/hive-crypto-mcp)** - ⭐ 14
...
3329. **[google-mcp](https://github.com/vakharwalad23/google-mcp)** - ⭐ 14
   Collection of Google-native tools (e.g., Gmail, Calendar) for the MCP

3330. **[ultrathink](https://github.com/husniadil/ultrathink)** - ⭐ 14
...
3331. **[mcp-server-subagent](https://github.com/dvcrn/mcp-server-subagent)** - ⭐ 14
   MCP for letting agents delegate tasks to sub-agents (Claude Code, Aider, Q)

3332. **[mcp-server-gemini-pro](https://github.com/gurveeer/mcp-server-gemini-pro)** - ⭐ 14
...
3333. **[opentargets-mcp](https://github.com/nickzren/opentargets-mcp)** - ⭐ 14
   MCP server for Open Targets Data

3334. **[MCP-Platform](https://github.com/Data-Everything/MCP-Platform)** - ⭐ 14
   A flexible platform that provides Docker & Kubernetes backends, a lightweight CLI (mcpt), and client utilities for seamless MCP integration. Spin up servers from templates, route requests through a single endpoint with load balancing, and support both deployed (HTTP) and local (stdio) transports — all with sensible defaults and YAML-based configs

3335. **[mcp-server](https://github.com/configcat/mcp-server)** - ⭐ 14
   Official ConfigCat Model Context Protocol (MCP) Server 

3336. **[mcp-config-editor](https://github.com/kaichen/mcp-config-editor)** - ⭐ 14
   A simple GUI for managing MCP servers, for easy toggle mcp servers.

3337. **[deep-directory-tree-mcp](https://github.com/andredezzy/deep-directory-tree-mcp)** - ⭐ 14
...
3338. **[mcpdog](https://github.com/kinhunt/mcpdog)** - ⭐ 14
...
3339. **[mcp-obsidian](https://github.com/Piotr1215/mcp-obsidian)** - ⭐ 14
   simple mcp server for interacting with local obsidian notes

3340. **[local-mcp-gateway](https://github.com/DXHeroes/local-mcp-gateway)** - ⭐ 14
   Aggregate multiple MCP servers into a single endpoint with web UI, OAuth 2.1, and profile-based tool management

3341. **[mcp-client-compatibility](https://github.com/tadata-org/mcp-client-compatibility)** - ⭐ 14

3342. **[django-mcp](https://github.com/hyperb1iss/django-mcp)** - ⭐ 14
...
3343. **[mcp.zig](https://github.com/muhammad-fiaz/mcp.zig)** - ⭐ 14
   A comprehensive Model Context Protocol (MCP) library for Zig — bringing MCP support to the Zig ecosystem.

3344. **[hop](https://github.com/danmartuszewski/hop)** - ⭐ 14
   Fast, elegant SSH connection manager with a TUI dashboard and MCP server

3345. **[davinci-mcp-professional](https://github.com/Positronikal/davinci-mcp-professional)** - ⭐ 14
...
3346. **[programmatic-tool-calling-ai-sdk](https://github.com/cameronking4/programmatic-tool-calling-ai-sdk)** - ⭐ 14
...
3347. **[mcp-kling](https://github.com/199-mcp/mcp-kling)** - ⭐ 14
   🎬 The FIRST MCP server for Kling AI video generation! Generate stunning AI videos directly from Claude.

3348. **[companies-house-mcp](https://github.com/stefanoamorelli/companies-house-mcp)** - ⭐ 14
...
3349. **[outlook-mcp](https://github.com/XenoXilus/outlook-mcp)** - ⭐ 13
...
3350. **[spring-ai-mcp-deepseek](https://github.com/firefly0512/spring-ai-mcp-deepseek)** - ⭐ 13
   使用 Spring AI 整合 MCP 服务，包括 MCP server 和 deepseek client

3351. **[llamacppMCPClientDemo](https://github.com/brucepro/llamacppMCPClientDemo)** - ⭐ 13
   standalone react MCP client using SSE

3352. **[sample-multi-tenant-saas-mcp-server](https://github.com/aws-samples/sample-multi-tenant-saas-mcp-server)** - ⭐ 13
   Multi-Tenant remote MCP server with Amazon Cognito and remote client with Amazon Bedrock hosted on AWS

3353. **[mcp-chat-client](https://github.com/Ceeon/mcp-chat-client)** - ⭐ 13
   基于高德地图MCP服务的聊天客户端

3354. **[mcp-client-laravel](https://github.com/RedberryProducts/mcp-client-laravel)** - ⭐ 13
...
3355. **[mcp-perplexity-server](https://github.com/PoliTwit1984/mcp-perplexity-server)** - ⭐ 13
...
3356. **[mcp-more](https://github.com/toosean/mcp-more)** - ⭐ 13
   A modern desktop application for managing Model Context Protocol (MCP) servers.

3357. **[MCP-Manager-GUI](https://github.com/gabrielbacha/MCP-Manager-GUI)** - ⭐ 13
   MCP Toggle is a simple GUI tool to help you manage MCP servers across clients seamlessly.

3358. **[easy-mcp-use](https://github.com/dforel/easy-mcp-use)** - ⭐ 13
...
3359. **[mcphawk](https://github.com/tech4242/mcphawk)** - ⭐ 13
...
3360. **[mcp-test-client](https://github.com/crazyrabbitLTC/mcp-test-client)** - ⭐ 13
   MCP Test Client is a TypeScript testing utility for Model Context Protocol (MCP) servers.

3361. **[mongo-mcp](https://github.com/1RB/mongo-mcp)** - ⭐ 13
   MCP server that provide tools to LLMs such as claude in cursor to interact with MongoDB

3362. **[memory-mcp-server](https://github.com/hpkv-io/memory-mcp-server)** - ⭐ 13
   A MCP (Model Context Protocol) server providing long-term memory for LLMs

3363. **[mcp-web-search-tool](https://github.com/gabrimatic/mcp-web-search-tool)** - ⭐ 13
   A MCP server providing real-time web search capabilities to any AI model.

3364. **[jadx-mcp-server](https://github.com/Qtty/jadx-mcp-server)** - ⭐ 13
   A Pure-Java MCP Server for JaDX Android Reverse Engineering Tool

3365. **[mcp-client-langchain-ts](https://github.com/hideya/mcp-client-langchain-ts)** - ⭐ 13
   Simple MCP Client CLI Implementation Using LangChain ReAct Agent / TypeScript

3366. **[prompt-engineer-mcp-server](https://github.com/hireshBrem/prompt-engineer-mcp-server)** - ⭐ 13
   Write 10x better prompts using Prompt Engineer MCP server.

3367. **[mcp-windows-automation](https://github.com/mukul975/mcp-windows-automation)** - ⭐ 13
...
3368. **[google-mcp-remote](https://github.com/vakharwalad23/google-mcp-remote)** - ⭐ 13
   Collection of Google-native tools (e.g., Gmail, Calendar) for the MCP

3369. **[mcp_review_code_tool](https://github.com/wenkil/mcp_review_code_tool)** - ⭐ 13
...
3370. **[mcp-time](https://github.com/TheoBrigitte/mcp-time)** - ⭐ 13
...
3371. **[sherpa](https://github.com/CartographAI/sherpa)** - ⭐ 13
   Chat with any codebase with MCP servers in a single command

3372. **[capture-mcp-server](https://github.com/blencorp/capture-mcp-server)** - ⭐ 13
...
3373. **[mcp-spotify-player](https://github.com/vsaez/mcp-spotify-player)** - ⭐ 13
   MCP server to manage Spotify from MCP clients

3374. **[codepilot](https://github.com/rohittcodes/codepilot)** - ⭐ 13
   A multi-agent CLI tool powered by Swarms-rs and Composio

3375. **[openwebui-mcp-setup](https://github.com/sonzentherevolution/openwebui-mcp-setup)** - ⭐ 13
...
3376. **[mcp-meme-sticky](https://github.com/nkapila6/mcp-meme-sticky)** - ⭐ 13
...
3377. **[mcp-safe-run](https://github.com/ithena-one/mcp-safe-run)** - ⭐ 13
...
3378. **[gsd-task-manager](https://github.com/vscarpenter/gsd-task-manager)** - ⭐ 13
...
3379. **[dx-toolkit](https://github.com/youdotcom-oss/dx-toolkit)** - ⭐ 13
   Open-source toolkit enabling developers to integrate You.com's AI capabilities into their workflows

3380. **[AgentStack](https://github.com/ssdeanx/AgentStack)** - ⭐ 13
...
3381. **[devtap](https://github.com/killme2008/devtap)** - ⭐ 13
   Bridge build/dev process output to AI coding sessions via MCP — supports Claude Code, Codex, OpenCode, Gemini CLI, and aider

3382. **[sarvam-mcp-server](https://github.com/Shobhit-Nagpal/sarvam-mcp-server)** - ⭐ 13
   talk to sarvam APIs directly, without code.

3383. **[temple-bridge](https://github.com/templetwo/temple-bridge)** - ⭐ 13
...
3384. **[signoz-mcp-server](https://github.com/DrDroidLab/signoz-mcp-server)** - ⭐ 13
   Connect your Signoz Instance with Cursor, Claude Desktop or any other MCP Compatible Client

3385. **[vmware-esxi-mcp](https://github.com/uldyssian-sh/vmware-esxi-mcp)** - ⭐ 13
...
3386. **[automagik-tools](https://github.com/namastexlabs/automagik-tools)** - ⭐ 13
   From API to AI in 30 Seconds - Transform any API into an intelligent MCP agent that learns, adapts, and speaks human

3387. **[vector_mcp](https://github.com/sergiobayona/vector_mcp)** - ⭐ 13
   A server implementation for the Model Context Protocol (MCP) in Ruby.

3388. **[RAG-MCP](https://github.com/cr21/RAG-MCP)** - ⭐ 13
   Simple RAG implementation from scratch using MCP, focusing on Perception, Memory, Decision and Action

3389. **[slack-mcp-server](https://github.com/jtalk22/slack-mcp-server)** - ⭐ 13
   Session-based Slack MCP server for local and hosted runtimes.

3390. **[Convert-Markdown-PDF-MCP](https://github.com/seanivore/Convert-Markdown-PDF-MCP)** - ⭐ 13
   Markdown To PDF Conversion MCP

3391. **[pentest-mcp-server](https://github.com/LayeSec006/pentest-mcp-server)** - ⭐ 13
   MCP server for penetration testing

3392. **[pentesting-cyber-mcp](https://github.com/hackersatyamrastogi/pentesting-cyber-mcp)** - ⭐ 13
...
3393. **[taiga-ui-mcp](https://github.com/taiga-family/taiga-ui-mcp)** - ⭐ 13
   Taiga UI MCP server providing documentation search and scaffolding tools.

3394. **[owl-mcp](https://github.com/ai4curation/owl-mcp)** - ⭐ 13
   MCP server for OWL applications

3395. **[XcodeMCPWrapper](https://github.com/SoundBlaster/XcodeMCPWrapper)** - ⭐ 13
   MCP that makes Xcode 26.3's MCP compatible with Cursor and other strict MCP-spec-compliant clients

3396. **[opencode-browser](https://github.com/michaljach/opencode-browser)** - ⭐ 13
...
3402. **[mcpskills-cli](https://github.com/dhanababum/mcpskills-cli)** - ⭐ 13
...
3403. **[gemini-webapi-mcp](https://github.com/AndyShaman/gemini-webapi-mcp)** - ⭐ 13
   MCP server for Google Gemini — free image generation, editing & chat via browser cookies. No API keys needed.

3404. **[llama-nexus](https://github.com/LlamaEdge/llama-nexus)** - ⭐ 12
   A gateway service designed to manage and orchestrate OpenAI-compatible API servers with MCP support.

3405. **[st_rag_mcp](https://github.com/digital-duck/st_rag_mcp)** - ⭐ 12
   MCP streamlit client with RAG support for tool search

3406. **[n8n-coolify-mcp-tools](https://github.com/wrediam/n8n-coolify-mcp-tools)** - ⭐ 12
...
3411. **[Tinvo](https://github.com/imxcstar/Tinvo)** - ⭐ 12
   LLM AI Client based on Blazor. (openai, chatgpt, llama, ollama, onnx, deepseekr1...)

3412. **[gemma-mcp](https://github.com/monatis/gemma-mcp)** - ⭐ 12
   MCP Client for Gemma-3

3413. **[muster](https://github.com/giantswarm/muster)** - ⭐ 12
   MCP tool management and workflow proxy

3414. **[porkbun-mcp-server](https://github.com/miraclebakelaser/porkbun-mcp-server)** - ⭐ 12
   MCP server implementation for managing domains, DNS, and SSL via the Porkbun API.

3415. **[proxy-base-agent](https://github.com/TheProxyCompany/proxy-base-agent)** - ⭐ 12
   A stateful agent with 100% reliable tool use. Build custom agents on any LLM with guaranteed state consistency.

3416. **[create-mcp-server-kit](https://github.com/Epi-1120/create-mcp-server-kit)** - ⭐ 12
   Scaffold a production-ready Model Context Protocol (MCP) server in seconds.

3417. **[memory-visualizer](https://github.com/mjherich/memory-visualizer)** - ⭐ 12
...
3418. **[MIST](https://github.com/CLoaKY233/MIST)** - ⭐ 12
...
3419. **[mcp-salesforce](https://github.com/AiondaDotCom/mcp-salesforce)** - ⭐ 12
...
3420. **[llms-txt-generator](https://github.com/aircodelabs/llms-txt-generator)** - ⭐ 12
   The ultimate AI-powered generator for llms.txt and llms-full.txt files. 

3421. **[ckan-mcp-server](https://github.com/ondics/ckan-mcp-server)** - ⭐ 12
...
3422. **[claude_autoapprove](https://github.com/PyneSys/claude_autoapprove)** - ⭐ 12
   Autoapprove support for claude

3423. **[ia-na-pratica](https://github.com/Code4Delphi/ia-na-pratica)** - ⭐ 12
   IA na Prática: LLM, RAG, MCP, Agents, Function Calling, Multimodal, TTS/STT e mais

3424. **[PackageFlow](https://github.com/runkids/PackageFlow)** - ⭐ 12
   A visual DevOps hub for npm scripts, Git, workflows, and deploy — controllable by AI via MCP.

3425. **[ggMCP4VSCode](https://github.com/n2ns/ggMCP4VSCode)** - ⭐ 12
   Google Gemini Model Context Protocol (MCP) Client for VS Code. Connect AI assistants to local context & tools.

3426. **[SQL_MCP_Server](https://github.com/pawankumar94/SQL_MCP_Server)** - ⭐ 12
...
3427. **[nestjs-mcp](https://github.com/orbit-codes/nestjs-mcp)** - ⭐ 12
   An opinionated MCP module for NestJS

3428. **[snowflake-mcp-server](https://github.com/dynamike/snowflake-mcp-server)** - ⭐ 12
   MCP Server for connecting to Snowflake with read-only questions

3429. **[mcp-server-kintone](https://github.com/macrat/mcp-server-kintone)** - ⭐ 12
   MCP server for kintone

3430. **[mcp-server-webscan](https://github.com/bsmi021/mcp-server-webscan)** - ⭐ 12
   A Model Context Protocol (MCP) server for web content scanning and analysis. This server provides tools for fetching, analyzing, and extracting information from web pages.

3431. **[swift-context-protocol](https://github.com/1amageek/swift-context-protocol)** - ⭐ 12
...
3432. **[mcp-server-weather-js](https://github.com/hideya/mcp-server-weather-js)** - ⭐ 12
   Simple Weather MCP Server Example

3433. **[agent-identity-protocol](https://github.com/ArangoGutierrez/agent-identity-protocol)** - ⭐ 12
   Agent Identity Protocol - Zero-trust security layer for AI agents. Policy enforcement proxy for MCP with Human-in-the-Loop approval, DLP scanning, and audit logging.

3434. **[md2confluence-mcp](https://github.com/Gyeom/md2confluence-mcp)** - ⭐ 12
   MCP server to upload Markdown to Confluence. Auto-converts Mermaid diagrams, code blocks, images, and tables.

3435. **[puppeteer-mcp-server](https://github.com/sultannaufal/puppeteer-mcp-server)** - ⭐ 12
...
3436. **[_b00t_](https://github.com/elasticdotventures/_b00t_)** - ⭐ 12
   🥾 _b00t_:  brians dotfiles aka state of the art agentic tooling & context initialization

3437. **[jenkins-mcp-server](https://github.com/AshwiniGhuge3012/jenkins-mcp-server)** - ⭐ 12
...
3438. **[openagentidentityprotocol](https://github.com/openagentidentityprotocol/openagentidentityprotocol)** - ⭐ 12
   Agent Identity Protocol - Zero-trust security layer for AI agents. Policy enforcement proxy for MCP with Human-in-the-Loop approval, DLP scanning, and audit logging.

3439. **[inspector](https://github.com/mcp-use/inspector)** - ⭐ 12
   Modern MCP Inspector for remote mcp servers with support for Apps SDK

3440. **[subcog](https://github.com/zircote/subcog)** - ⭐ 12
...
3441. **[osmmcp](https://github.com/NERVsystems/osmmcp)** - ⭐ 12
...
3442. **[garmin-connect-mcp](https://github.com/eddmann/garmin-connect-mcp)** - ⭐ 12
   MCP server enabling LLMs to interact with Garmin Connect - activities, health metrics, sleep data, and training analysis

3443. **[dav-mcp](https://github.com/PhilflowIO/dav-mcp)** - ⭐ 12
   Transform AI agents into orchestrating assistants managing calendars, contacts, and tasks

3444. **[mcp-add](https://github.com/paoloricciuti/mcp-add)** - ⭐ 12
   Universal cli to add an MCP server to a variety of clients

3445. **[mcp-client-gen](https://github.com/kriasoft/mcp-client-gen)** - ⭐ 12
   Turn any MCP server into a type-safe TypeScript SDK in seconds - with    OAuth 2.1 and multi-provider support

3446. **[clickup-mcp-server](https://github.com/taazkareem/clickup-mcp-server)** - ⭐ 12
   ClickUp MCP Server - Integrate ClickUp project management with AI through Model Context Protocol

3447. **[cv-resume-builder-mcp](https://github.com/eyaab/cv-resume-builder-mcp)** - ⭐ 12
...
3448. **[agent-board](https://github.com/quentintou/agent-board)** - ⭐ 12
...
3457. **[context-kit](https://github.com/eyalzh/context-kit)** - ⭐ 11
   A CLI tool and MCP client, used to create spec files for AI coding agents with context baked in

3458. **[mcp_client_rust](https://github.com/darinkishore/mcp_client_rust)** - ⭐ 11

3459. **[mcp-client](https://github.com/EuclideanAI/mcp-client)** - ⭐ 11
...
3460. **[MCP_Client](https://github.com/andrewdeng318/MCP_Client)** - ⭐ 11

3461. **[trebuchet](https://github.com/fuzzball-muck/trebuchet)** - ⭐ 11
   A MUD/MUCK/MUSH chat client with MCP/GUI support.

3462. **[systemprompt-mcp-gmail](https://github.com/Ejb503/systemprompt-mcp-gmail)** - ⭐ 11
...
3463. **[mcp-client-app](https://github.com/RegiByte/mcp-client-app)** - ⭐ 11
   A mcp client chat application built for learning purposes

3464. **[mcp-browser-automation](https://github.com/hrmeetsingh/mcp-browser-automation)** - ⭐ 11
   Model Context Protocol based AI Agent that runs a browser from Claude desktop

3465. **[simple-nodejs-mcp-client](https://github.com/sawa-zen/simple-nodejs-mcp-client)** - ⭐ 11
...
3466. **[langchain-mcp-tools-ts-usage](https://github.com/hideya/langchain-mcp-tools-ts-usage)** - ⭐ 11
   MCP Tools Usage From LangChain ReAct Agent / Example in TypeScript

3467. **[mcp-chat-widget](https://github.com/aimdoc-ai/mcp-chat-widget)** - ⭐ 11
...
3468. **[oauth-callback](https://github.com/kriasoft/oauth-callback)** - ⭐ 11
   Lightweight OAuth 2.0 authorization code capture for CLI tools & desktop   apps. Works with Node.js, Deno, Bun. MCP SDK ready.

3469. **[semantictool](https://github.com/promptmesh/semantictool)** - ⭐ 11
   tool management service for performing vector tool calling at scale.

3470. **[mcpconnect](https://github.com/rocket-connect/mcpconnect)** - ⭐ 11
   Inspect and debug Model Context Protocol servers directly in your browser.

3471. **[locust-mcp-server](https://github.com/QAInsights/locust-mcp-server)** - ⭐ 11
   A Model Context Protocol (MCP) server implementation for running Locust load tests. This server enables seamless integration of Locust load testing capabilities with AI-powered development environments.

3472. **[scorable-mcp](https://github.com/root-signals/scorable-mcp)** - ⭐ 11
   MCP for Scorable Evaluation Platform

3473. **[mcp-boilerplate](https://github.com/iamsrikanthnani/mcp-boilerplate)** - ⭐ 11
...
3474. **[emcp](https://github.com/joeymeere/emcp)** - ⭐ 11
   A framework for building simple MCP servers with custom middleware

3475. **[local-history-mcp](https://github.com/xxczaki/local-history-mcp)** - ⭐ 11
   MCP server for accessing VS Code/Cursor's Local History

3476. **[openalgo-mcp](https://github.com/marketcalls/openalgo-mcp)** - ⭐ 11
   Documentation

3477. **[polaris](https://github.com/octu0/polaris)** - ⭐ 11
   Distributed AI Agent Framework

3478. **[mcp-server-zotero-dev](https://github.com/introfini/mcp-server-zotero-dev)** - ⭐ 11
...
3479. **[glm5-mcp](https://github.com/Arkya-AI/glm5-mcp)** - ⭐ 11
...
3480. **[french-tax-mcp](https://github.com/cornelcroi/french-tax-mcp)** - ⭐ 11
   MCP server for French tax calculations and information - enables AI assistants to provide accurate French tax guidance

3481. **[springboot-ai-mcp-example](https://github.com/duongminhhieu/springboot-ai-mcp-example)** - ⭐ 11
   Example Spring AI Model Context Protocol (MCP)

3482. **[mcp-space](https://github.com/tharuneshwar-s/mcp-space)** - ⭐ 11
...
3483. **[druid-mcp-server](https://github.com/iunera/druid-mcp-server)** - ⭐ 11
...
3484. **[obsidian-mcp-server](https://github.com/smith-and-web/obsidian-mcp-server)** - ⭐ 11
   MCP server for Obsidian vault management - enables Claude and other AI assistants to read, write, search, and organize your notes

3485. **[trainingpeaks-mcp](https://github.com/JamsusMaximus/trainingpeaks-mcp)** - ⭐ 11
...
3486. **[mcp-client-langchain-py](https://github.com/hideya/mcp-client-langchain-py)** - ⭐ 11
   Simple MCP Client CLI Implementation Using LangChain ReAct Agent / Python

3487. **[Unity-AI-ParticleSystem](https://github.com/IvanMurzak/Unity-AI-ParticleSystem)** - ⭐ 11
   AI-powered tools for Unity Particle System. Create and modify Particle System directly through natural language commands.

3488. **[phabricator-mcp](https://github.com/freelancer/phabricator-mcp)** - ⭐ 11
   MCP server for Phabricator

3489. **[stata-workbench](https://github.com/tmonk/stata-workbench)** - ⭐ 11
...
3490. **[ProxmoxMCP-advance](https://github.com/Markermav/ProxmoxMCP-advance)** - ⭐ 11
   ProxmoxMCP (advance): MCP for Proxmox integration in Claude, Goose, Cline, any client.

3491. **[mcp-interactive-terminal](https://github.com/amol21p/mcp-interactive-terminal)** - ⭐ 11
...
3492. **[domain-search-mcp](https://github.com/dorukardahan/domain-search-mcp)** - ⭐ 11
...
3493. **[mcp-wikipedia](https://github.com/algonacci/mcp-wikipedia)** - ⭐ 10
   MCP server to give client the ability to access Wikipedia pages

3494. **[taskboard](https://github.com/tcarac/taskboard)** - ⭐ 10
...
3495. **[claude-context-local](https://github.com/MikeO-AI/claude-context-local)** - ⭐ 10
...
3496. **[langchain-mcp-client](https://github.com/datalayer/langchain-mcp-client)** - ⭐ 10
   🦜🔗 LangChain Model Context Protocol (MCP) Client

3497. **[mcp_client_openai](https://github.com/liangpn/mcp_client_openai)** - ⭐ 10
   适配Openai SDK构建MCP Client

3498. **[mcp-serverman](https://github.com/benhaotang/mcp-serverman)** - ⭐ 10
   a cli/mcp server tool for managing mcp server json config file with version control, profiles and multi-client support

3499. **[py-mcp-sse](https://github.com/jayliangdl/py-mcp-sse)** - ⭐ 10
   MCP Client 与 MCP Server基于SSE方式的样例实现（Python版本）

3500. **[mcpkit](https://github.com/cybertheory/mcpkit)** - ⭐ 10
   Easy to use Official MCP Registry Client UI. npx @cybertheory/mcpkit

3501. **[AIFoundry-MCPConnector-FabricGraphQL](https://github.com/LazaUK/AIFoundry-MCPConnector-FabricGraphQL)** - ⭐ 10
...
3502. **[server](https://github.com/mcpfinder/server)** - ⭐ 10
...
3503. **[kanboard-mcp](https://github.com/ChristianJStarr/kanboard-mcp)** - ⭐ 10
...
3504. **[emotion_ai](https://github.com/angrysky56/emotion_ai)** - ⭐ 10
...
3505. **[mcp-express-adapter](https://github.com/Moe03/mcp-express-adapter)** - ⭐ 10
   Run multiple MCP clients on a NodeJS Express server (adapter/middleware)

3506. **[mcp-trace](https://github.com/zabirauf/mcp-trace)** - ⭐ 10
   A TUI to probe the calls between MCP client and server

3507. **[mcp-server-blog](https://github.com/portal-labs-infrastructure/mcp-server-blog)** - ⭐ 10
   Example of a MCP implementation using TypeScript and OAuth.

3508. **[unity-mcp-template](https://github.com/dunward/unity-mcp-template)** - ⭐ 10
   Simple template project for controlling Unity via MCP

3509. **[mcp-agent-proxy](https://github.com/mashh-lab/mcp-agent-proxy)** - ⭐ 10
   An MCP server that exposes local and remote agents across different servers as MCP tools.

3510. **[amazon-seller-mcp](https://github.com/enginterzi/amazon-seller-mcp)** - ⭐ 10
...
3511. **[auto-mcp-client](https://github.com/down-to-earth1994/auto-mcp-client)** - ⭐ 10
...
3512. **[mcp-kit](https://github.com/shaharia-lab/mcp-kit)** - ⭐ 10
   MCP (Model Context Protocol) Kit for Go - A Complete MCP solutions for ready to use

3513. **[CodeCompass](https://github.com/alvinveroy/CodeCompass)** - ⭐ 10
...
3514. **[mode-manager-mcp](https://github.com/NiclasOlofsson/mode-manager-mcp)** - ⭐ 10
   MCP Memory Agent Server - A VS Code chatmode and instruction manager with library integration

3515. **[mcp-reporter](https://github.com/cyanheads/mcp-reporter)** - ⭐ 10
...
3516. **[mcp-starter-template-ts](https://github.com/onamfc/mcp-starter-template-ts)** - ⭐ 10
...
3517. **[prometheus-protocol](https://github.com/prometheus-protocol/prometheus-protocol)** - ⭐ 10
...
3518. **[rec-us-mcp-server](https://github.com/elizabethsiegle/rec-us-mcp-server)** - ⭐ 10
   Book a San Francisco tennis court via MCP server w/ auth

3519. **[mcp-demo](https://github.com/sshh12/mcp-demo)** - ⭐ 10
...
3520. **[AgentX-mcp-servers](https://github.com/AgentX-ai/AgentX-mcp-servers)** - ⭐ 10
   List of open sourced MCP servers. MIT license. Managed by AgentX with love.

3521. **[mcp-tradovate](https://github.com/0xjmp/mcp-tradovate)** - ⭐ 10
   MCP server for the Tradovate platform

3522. **[mcp-claude-hackernews](https://github.com/imprvhub/mcp-claude-hackernews)** - ⭐ 10
   An integration that allows Claude Desktop to interact with Hacker News using the Model Context Protocol (MCP).

3523. **[glasses-mcp](https://github.com/gourraguis/glasses-mcp)** - ⭐ 10
   Glasses MCP is a simple MCP server that lets your AI agent see and capture the web 👓

3524. **[ObsidianMCPServer](https://github.com/otaviocc/ObsidianMCPServer)** - ⭐ 10
   A Model Context Protocol (MCP) server that enables AI assistants to interact with your Obsidian vault 

3525. **[mcp-sys-bridge](https://github.com/leynier/mcp-sys-bridge)** - ⭐ 10
...
3526. **[sec-edgar-agentkit](https://github.com/stefanoamorelli/sec-edgar-agentkit)** - ⭐ 10
...
3527. **[context-engineering-mcp](https://github.com/bralca/context-engineering-mcp)** - ⭐ 10
...
3528. **[nautobot_mcp](https://github.com/kvncampos/nautobot_mcp)** - ⭐ 10
   Nautobot Model Context Protocol (MCP) Server - Contains STDIO and HTTP Deployments with Embedding Search and RAG.

3529. **[mcp-sqlite-server](https://github.com/prayanks/mcp-sqlite-server)** - ⭐ 10
...
3530. **[langgraph-mcp-dataanalysis](https://github.com/gongwon-nayeon/langgraph-mcp-dataanalysis)** - ⭐ 10
   DataAnalysis Agent using LangGraph & MCP server and client

3531. **[claude-faf-mcp](https://github.com/Wolfe-Jam/claude-faf-mcp)** - ⭐ 10
   Anthropic-approved MCP Server | Persistent AI Context | IANA-registered .faf format

3532. **[mcp-go](https://github.com/XiaoConstantine/mcp-go)** - ⭐ 10
   Golang impl of mcp protocol

3533. **[mcpet](https://github.com/shreyaskarnik/mcpet)** - ⭐ 10
...
3534. **[miniflux-mcp](https://github.com/tssujt/miniflux-mcp)** - ⭐ 10
   A Model Context Protocol (MCP) server for interacting with Miniflux RSS reader.

3535. **[mcp-spring-ai-mcp-client](https://github.com/chaozai0304/mcp-spring-ai-mcp-client)** - ⭐ 10
   使用java实现mcp client了解底层的调用机制，demo示例

3536. **[mcp-optimizer](https://github.com/StacklokLabs/mcp-optimizer)** - ⭐ 10
   MCP server that acts as an intelligent intermediary between AI clients and multiple MCP servers

3537. **[awesome-mcp](https://github.com/timunbasah3/awesome-mcp)** - ⭐ 10
...
3538. **[biomed-agent](https://github.com/nickzren/biomed-agent)** - ⭐ 10
   Connecting AI agent to biomedical data

3539. **[Simple_MCP_Client](https://github.com/Avento/Simple_MCP_Client)** - ⭐ 10
   Simple MCP Client for OpenAI/Deepseek R1/V3

3540. **[KunAvatar](https://github.com/KunLabAI/KunAvatar)** - ⭐ 10
...
3541. **[awesome-mcp](https://github.com/gauravfs-14/awesome-mcp)** - ⭐ 10
...
3542. **[mcp-for-woocommerce](https://github.com/iOSDevSK/mcp-for-woocommerce)** - ⭐ 10
...
3543. **[openapi-mcp-swagger](https://github.com/salacoste/openapi-mcp-swagger)** - ⭐ 10
...
3544. **[mcp-chaos-rig](https://github.com/Typewise/mcp-chaos-rig)** - ⭐ 10
...
3545. **[extract-llms-docs](https://github.com/nirholas/extract-llms-docs)** - ⭐ 10
...
3546. **[notification-mcp](https://github.com/pinkpixel-dev/notification-mcp)** - ⭐ 10
   A Model Context Protocol server that allows AI agents to play a notification sound via a tool when a task is completed.

3547. **[kroki-mcp](https://github.com/utain/kroki-mcp)** - ⭐ 10
...
3558. **[youtube-mcp-server](https://github.com/dannySubsense/youtube-mcp-server)** - ⭐ 10
...
3559. **[better-notion-mcp](https://github.com/n24q02m/better-notion-mcp)** - ⭐ 10
   Markdown-First MCP Server for Notion - Optimized for AI Agents

3560. **[gtm-mcp](https://github.com/pouyanafisi/gtm-mcp)** - ⭐ 10
   MCP server for Google Tag Manager: read tags/triggers/variables, publish containers, and audit changes via Claude/Gemini.

3561. **[kiro-powers](https://github.com/praveenc/kiro-powers)** - ⭐ 10
   Repository of custom kiro powers. https://kiro.dev/docs/powers/

3562. **[msty-admin-mcp](https://github.com/M-Pineapple/msty-admin-mcp)** - ⭐ 10
...
3563. **[MicrosoftGraph_Transcript_MCP](https://github.com/ITSpecialist111/MicrosoftGraph_Transcript_MCP)** - ⭐ 10
...
3564. **[FocusRelayMCP](https://github.com/deverman/FocusRelayMCP)** - ⭐ 10
...
3565. **[Azure-Foundry-Webinar](https://github.com/ShivamGoyal03/Azure-Foundry-Webinar)** - ⭐ 10
...
3566. **[Cognio](https://github.com/0xReLogic/Cognio)** - ⭐ 10
...
3567. **[robotmcp_client](https://github.com/robotmcp/robotmcp_client)** - ⭐ 10
   Connect AI models like Claude & GPT with robots using MCP and ROS.

3568. **[bookmark-manager-mcp](https://github.com/infinitepi-io/bookmark-manager-mcp)** - ⭐ 10
...
3569. **[bruno-mcp](https://github.com/macarthy/bruno-mcp)** - ⭐ 10
...
3570. **[systemprompt-template](https://github.com/systempromptio/systemprompt-template)** - ⭐ 10
   Production AI agent mesh in 3 commands. MCP servers, playbooks, and multi-agent orchestration built on systemprompt-core.

3571. **[fcpxml-mcp-server](https://github.com/DareDev256/fcpxml-mcp-server)** - ⭐ 10
   🎬 The first AI-powered MCP server for Final Cut Pro XML. Control your edits with natural language.

3572. **[chromadb-remote-mcp](https://github.com/meloncafe/chromadb-remote-mcp)** - ⭐ 10
   Remote MCP server for ChromaDB

3573. **[guildbridge](https://github.com/dend/guildbridge)** - ⭐ 10
   🏰 Remotely hosted MCP server for Discord

3574. **[cie](https://github.com/kraklabs/cie)** - ⭐ 10
...
3575. **[webfetch-mcp](https://github.com/manooll/webfetch-mcp)** - ⭐ 10
   Live Web Access for Your Local AI — Tunable Search & Clean Content Extraction

3576. **[LSP4J-MCP](https://github.com/stephanj/LSP4J-MCP)** - ⭐ 10
...
3577. **[cheatengine-mcp-bridge](https://github.com/beamstar/cheatengine-mcp-bridge)** - ⭐ 10
   🔗 Connect AI to Cheat Engine for fast memory analysis, enabling quick mods and audits without the tedious manual work.

3578. **[toolhive-cloud-ui](https://github.com/stacklok/toolhive-cloud-ui)** - ⭐ 10
...
1. **[chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat)** - ⭐ 41,489
...
2. **[bytebot](https://github.com/bytebot-ai/bytebot)** - ⭐ 10,455
   Bytebot is a self-hosted AI desktop agent that automates computer tasks through natural language commands, operating within a containerized Linux desktop environment.

3. **[valuecell](https://github.com/ValueCell-ai/valuecell)** - ⭐ 9,284
   ValueCell is a community-driven, multi-agent platform for financial applications.

4. **[deepchat](https://github.com/ThinkInAIXYZ/deepchat)** - ⭐ 5,524
   🐬DeepChat - A smart assistant that connects powerful AI to your personal world

5. **[ruoyi-ai](https://github.com/ageerle/ruoyi-ai)** - ⭐ 4,815
...
17. **[a2a-x402](https://github.com/google-agentic-commerce/a2a-x402)** - ⭐ 457
   The A2A x402 Extension brings cryptocurrency payments to the Agent-to-Agent (A2A) protocol, enabling agents to monetize their services through on-chain payments. This extension revives the spirit of HTTP 402 "Payment Required" for the decentralized agent ecosystem.

18. **[self-dify](https://github.com/datawhalechina/self-dify)** - ⭐ 340
...
1. **[n8n](https://github.com/n8n-io/n8n)** - ⭐ 176,423
   Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.

2. **[kong](https://github.com/Kong/kong)** - ⭐ 42,831
   🦍 The API and AI Gateway

3. **[FastGPT](https://github.com/labring/FastGPT)** - ⭐ 27,177
   FastGPT is a knowledge-based platform built on the LLMs, offers a comprehensive suite of out-of-the-box capabilities such as data processing, RAG retrieval, and visual AI workflow orchestration, letting you easily develop and deploy complex question-answering systems without the need for extensive setup or configuration.

4. **[kratos](https://github.com/go-kratos/kratos)** - ⭐ 25,472
   Your ultimate Go microservices framework for the cloud-native era.

5. **[excelize](https://github.com/qax-os/excelize)** - ⭐ 20,339
   Go language library for reading and writing Microsoft Excel™ (XLAM / XLSM / XLSX / XLTM / XLTX) spreadsheets

6. **[AstrBot](https://github.com/AstrBotDevs/AstrBot)** - ⭐ 17,985
   Agentic IM Chatbot infrastructure that integrates lots of IM platforms, LLMs, plugins and AI feature, and can be your openclaw alternative. ✨

7. **[plate](https://github.com/udecode/plate)** - ⭐ 15,962
...
10. **[ui](https://github.com/creativetimofficial/ui)** - ⭐ 11,717
   Open-source components, blocks, and AI agents designed to speed up your workflow. Import them seamlessly into your favorite tools through Registry and MCPs.

11. **[note-gen](https://github.com/codexu/note-gen)** - ⭐ 10,947
   A cross-platform Markdown AI note-taking software.

12. **[langchain4j](https://github.com/langchain4j/langchain4j)** - ⭐ 10,834
   LangChain4j is an open-source Java library that simplifies the integration of LLMs into Java applications through a unified API, providing access to popular LLMs and vector databases. It makes implementing RAG, tool calling (including support for MCP), and agents easy. LangChain4j integrates seamlessly with various enterprise Java frameworks.

13. **[astron-agent](https://github.com/iflytek/astron-agent)** - ⭐ 9,981
   Enterprise-grade, commercial-friendly agentic workflow platform for building next-generation SuperAgents.

14. **[53AIHub](https://github.com/53AI/53AIHub)** - ⭐ 9,350
...
15. **[OpenMetadata](https://github.com/open-metadata/OpenMetadata)** - ⭐ 8,766
   OpenMetadata is a unified metadata platform for data discovery, data observability, and data governance powered by a central metadata repository, in-depth column level lineage, and seamless team collaboration.

16. **[Upsonic](https://github.com/Upsonic/Upsonic)** - ⭐ 7,797
   Agent Framework For Fintech and Banks

17. **[lamda](https://github.com/firerpa/lamda)** - ⭐ 7,623
    The most powerful Android RPA agent framework, next generation of mobile automation robots.

18. **[adk-go](https://github.com/google/adk-go)** - ⭐ 7,008
...
21. **[Yuxi-Know](https://github.com/xerrors/Yuxi-Know)** - ⭐ 4,370
...
22. **[ENScan_GO](https://github.com/wgpsec/ENScan_GO)** - ⭐ 4,219
   一款基于各大企业信息API的工具，解决在遇到的各种针对国内企业信息收集难题。一键收集控股公司ICP备案、APP、小程序、微信公众号等信息聚合导出。支持MCP接入

23. **[ag2](https://github.com/ag2ai/ag2)** - ⭐ 4,186
   AG2 (formerly AutoGen): The Open-Source AgentOS. Join us at: https://discord.gg/sNGSwQME3x

24. **[nexent](https://github.com/ModelEngine-Group/nexent)** - ⭐ 4,122
...
25. **[kubefwd](https://github.com/txn2/kubefwd)** - ⭐ 4,049
   Bulk port forwarding Kubernetes services for local development.

26. **[manifest](https://github.com/mnfst/manifest)** - ⭐ 3,309
   A shadcn/ui library for building ChatGPT Apps and MCP Apps

27. **[semantic-router](https://github.com/vllm-project/semantic-router)** - ⭐ 3,237
   System Level Intelligent Router for Mixture-of-Models at Cloud, Data Center and Edge

28. **[Generative-Media-Skills](https://github.com/SamurAIGPT/Generative-Media-Skills)** - ⭐ 2,796
   Multi-modal Generative Media Skills for AI Agents (Claude Code, Cursor, Gemini CLI). High-quality image, video, and audio generation powered by muapi.ai.

29. **[ultracite](https://github.com/haydenbleasel/ultracite)** - ⭐ 2,706
   A highly opinionated, zero-configuration linter and formatter.

30. **[solon](https://github.com/opensolon/solon)** - ⭐ 2,705
...
31. **[harbor](https://github.com/av/harbor)** - ⭐ 2,465
   One command brings a complete pre-wired LLM stack with hundreds of services to explore.

32. **[amazon-q-developer-cli](https://github.com/aws/amazon-q-developer-cli)** - ⭐ 1,901
   ✨ Agentic chat experience in your terminal. Build applications using natural language.

33. **[generative-ai](https://github.com/genieincodebottle/generative-ai)** - ⭐ 1,791
   Comprehensive resources on Generative AI, including a detailed roadmap, projects, use cases, interview preparation, and coding preparation.

34. **[MinecraftDev](https://github.com/minecraft-dev/MinecraftDev)** - ⭐ 1,716
   Plugin for IntelliJ IDEA that gives special support for Minecraft modding projects.

35. **[d2mcpp](https://github.com/mcpp-community/d2mcpp)** - ⭐ 1,555
...
39. **[paperdebugger](https://github.com/PaperDebugger/paperdebugger)** - ⭐ 1,340
...
43. **[langchain4j-aideepin](https://github.com/moyangzhan/langchain4j-aideepin)** - ⭐ 1,170
   基于AI的工作效率提升工具（聊天、绘画、知识库、工作流、 MCP服务市场、语音输入输出、长期记忆） | Ai-based productivity tools (Chat,Draw,RAG,Workflow,MCP marketplace, ASR,TTS, Long-term memory etc)

44. **[AWorld](https://github.com/inclusionAI/AWorld)** - ⭐ 1,131
   Build, evaluate and train General Multi-Agent Assistance with ease

45. **[any-agent](https://github.com/mozilla-ai/any-agent)** - ⭐ 1,106
   A single interface to use and evaluate different agent frameworks 

46. **[Gearboy](https://github.com/drhelius/Gearboy)** - ⭐ 1,081
   Game Boy / Gameboy Color emulator and debugger for macOS, Windows, Linux, BSD and RetroArch.

47. **[AIPex](https://github.com/AIPexStudio/AIPex)** - ⭐ 1,074
...
48. **[chunkhound](https://github.com/chunkhound/chunkhound)** - ⭐ 1,061
   Local first codebase intelligence

49. **[open-trading-api](https://github.com/koreainvestment/open-trading-api)** - ⭐ 1,054
   Korea Investment & Securities Open API Github

50. **[zen](https://github.com/sheshbabu/zen)** - ⭐ 1,051
...
53. **[rulesync](https://github.com/dyoshikawa/rulesync)** - ⭐ 826
   A Utility CLI for AI Coding Agents

54. **[voicemode](https://github.com/mbailey/voicemode)** - ⭐ 792
...
62. **[WHartTest](https://github.com/MGdaasLab/WHartTest)** - ⭐ 638
...
63. **[chatlog_alpha](https://github.com/teest114514/chatlog_alpha)** - ⭐ 615
   原 [chatlog]项目（一个微信数据库读取及提供mcp服务开源软件）的二次开发，会尽可能同步最新开源解密源码

64. **[LightAgent](https://github.com/wanxingai/LightAgent)** - ⭐ 602
...
66. **[IDA-NO-MCP](https://github.com/P4nda0s/IDA-NO-MCP)** - ⭐ 596
   Say goodbye to the complex, verbose, and laggy interaction mode of IDA Pro MCP

67. **[tool-ui](https://github.com/assistant-ui/tool-ui)** - ⭐ 537
   UI components for AI interfaces

68. **[ios-simulator-skill](https://github.com/conorluddy/ios-simulator-skill)** - ⭐ 535
...
71. **[ai-code-helper](https://github.com/liyupi/ai-code-helper)** - ⭐ 481
...
75. **[mcp-cn-a-stock](https://github.com/elsejj/mcp-cn-a-stock)** - ⭐ 412
...
78. **[bridle](https://github.com/neiii/bridle)** - ⭐ 388
...
82. **[ChattyPlay-Agent](https://github.com/P1kaj1uu/ChattyPlay-Agent)** - ⭐ 380
...
84. **[pokemon-chat](https://github.com/skygazer42/pokemon-chat)** - ⭐ 367
...
86. **[pydantic-deepagents](https://github.com/vstorm-co/pydantic-deepagents)** - ⭐ 351
...
87. **[UE5-MCP](https://github.com/VedantRGosavi/UE5-MCP)** - ⭐ 349
...
91. **[eechat](https://github.com/Lucassssss/eechat)** - ⭐ 334
   🚀 Powerful Local AI Chat Application - Mcp, Secure, Efficient, Personalized 本地化部署的大模型客户端

92. **[CookHero](https://github.com/Decade-qiu/CookHero)** - ⭐ 334
...
100. **[edumcp](https://github.com/aieducations/edumcp)** - ⭐ 268
...
122. **[agentic-ai-systems](https://github.com/ThibautMelen/agentic-ai-systems)** - ⭐ 178
   🐔 Agentic systems explained with chickens. Workflows, agents & orchestration made simple. Mermaid diagrams included

123. **[Weave](https://github.com/liaotxcn/Weave)** - ⭐ 176
...
125. **[codecompanion-history.nvim](https://github.com/ravitemer/codecompanion-history.nvim)** - ⭐ 166
   A history management extension for codecompanion AI chat plugin that enables saving, browsing and restoring chat sessions.

126. **[x-mcp](https://github.com/xpzouying/x-mcp)** - ⭐ 166
   小红书创作中心
...
180. **[ai-agents](https://github.com/rjmurillo/ai-agents)** - ⭐ 14
   Multi-agent system for software development

181. **[ai-tools](https://github.com/elsejj/ai-tools)** - ⭐ 14
   ai-tools  call your llm based tools through shortcut (ctrl-q) in any application

182. **[feather_wand_agent](https://github.com/QAInsights/feather_wand_agent)** - ⭐ 13
...
1. **[ai-guide](https://github.com/liyupi/ai-guide)** - ⭐ 7,842
...
2. **[modelcontextprotocol](https://github.com/modelcontextprotocol/modelcontextprotocol)** - ⭐ 7,303
   Specification and documentation for the Model Context Protocol

3. **[jar-analyzer](https://github.com/jar-analyzer/jar-analyzer)** - ⭐ 1,930
...
4. **[LLM-Agents-Ecosystem-Handbook](https://github.com/oxbshw/LLM-Agents-Ecosystem-Handbook)** - ⭐ 493
