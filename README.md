...
1. **[dify](https://github.com/langgenius/dify)** - ⭐ 121,411
   Production-ready platform for agentic workflow development.

2. **[open-webui](https://github.com/open-webui/open-webui)** - ⭐ 117,654
   User-friendly AI Interface (Supports Ollama, OpenAI API, ...)

3. **[netdata](https://github.com/netdata/netdata)** - ⭐ 76,975
   The fastest path to AI-powered full stack observability, even for lean teams.

4. **[awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)** - ⭐ 76,554
   A collection of MCP servers.

5. **[servers](https://github.com/modelcontextprotocol/servers)** - ⭐ 74,336
   Model Context Protocol Servers

6. **[ragflow](https://github.com/infiniflow/ragflow)** - ⭐ 69,684
   RAGFlow is a leading open-source Retrieval-Augmented Generation (RAG) engine that fuses cutting-edge RAG with Agent capabilities to create a superior context layer for LLMs

7. **[lobe-chat](https://github.com/lobehub/lobe-chat)** - ⭐ 68,997
...
8. **[anything-llm](https://github.com/Mintplex-Labs/anything-llm)** - ⭐ 52,089
   The all-in-one Desktop & Docker AI application with built-in RAG, AI agents, No-code agent builder, MCP compatibility,  and more.

9. **[JeecgBoot](https://github.com/jeecgboot/JeecgBoot)** - ⭐ 44,682
...
10. **[context7](https://github.com/upstash/context7)** - ⭐ 39,197
   Context7 MCP Server -- Up-to-date code documentation for LLMs and AI code editors

11. **[TrendRadar](https://github.com/sansan0/TrendRadar)** - ⭐ 38,875
...
12. **[mindsdb](https://github.com/mindsdb/mindsdb)** - ⭐ 37,734
   Federated query engine for AI - The only MCP Server you'll ever need

13. **[1Panel](https://github.com/1Panel-dev/1Panel)** - ⭐ 32,429
   🔥 1Panel provides an intuitive web interface and MCP Server to manage websites, files, containers, databases, and LLMs on a Linux server.

14. **[nacos](https://github.com/alibaba/nacos)** - ⭐ 32,381
   an easy-to-use dynamic service discovery, configuration and service management platform for building AI cloud native applications.

15. **[LibreChat](https://github.com/danny-avila/LibreChat)** - ⭐ 32,361
   Enhanced ChatGPT Clone: Features Agents, MCP, DeepSeek, Anthropic, AWS, OpenAI, Responses API, Azure, Groq, o1, GPT-5, Mistral, OpenRouter, Vertex AI, Gemini, Artifacts, AI model switching, message search, Code Interpreter, langchain, DALL-E-3, OpenAPI Actions, Functions, Secure Multi-User Auth, Presets, open-source for self-hosting. Active.

16. **[PDFMathTranslate](https://github.com/PDFMathTranslate/PDFMathTranslate)** - ⭐ 30,484
   [EMNLP 2025 Demo] PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/MCP/Docker/Zotero

17. **[composio](https://github.com/ComposioHQ/composio)** - ⭐ 26,200
   Composio equips your AI agents & LLMs with 100+ high-quality integrations via function calling

18. **[github-mcp-server](https://github.com/github/github-mcp-server)** - ⭐ 25,130
   GitHub's official MCP Server

19. **[gpt-researcher](https://github.com/assafelovic/gpt-researcher)** - ⭐ 24,479
   An LLM agent that conducts deep research (local and web) on any given topic and generates a long report with citations.

20. **[playwright-mcp](https://github.com/microsoft/playwright-mcp)** - ⭐ 24,284
   Playwright MCP server

21. **[goose](https://github.com/block/goose)** - ⭐ 24,066
   an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM

22. **[ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub)** - ⭐ 23,119
   In-depth tutorials on LLMs, RAGs and real-world AI agent applications.

23. **[xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)** - ⭐ 22,320
   An MCP-based chatbot | 一个基于MCP的聊天机器人

24. **[fastmcp](https://github.com/jlowin/fastmcp)** - ⭐ 21,113
   🚀 The fast, Pythonic way to build MCP servers and clients

25. **[repomix](https://github.com/yamadashy/repomix)** - ⭐ 20,623
   📦 Repomix is a powerful tool that packs your entire repository into a single, AI-friendly file. Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools like Claude, ChatGPT, DeepSeek, Perplexity, Gemini, Gemma, Llama, Grok, and more.

26. **[python-sdk](https://github.com/modelcontextprotocol/python-sdk)** - ⭐ 20,582
   The official Python SDK for Model Context Protocol servers and clients

27. **[UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)** - ⭐ 19,863
   The Open-Source Multimodal AI Agent Stack: Connecting Cutting-Edge AI Models and Agent Infra

28. **[activepieces](https://github.com/activepieces/activepieces)** - ⭐ 19,751
   AI Agents & MCPs & AI Workflow Automation • (~400 MCP servers for AI agents) • AI Automation / AI Agent with MCPs • AI Workflows & AI Agents • MCPs for AI Agents

29. **[MaxKB](https://github.com/1Panel-dev/MaxKB)** - ⭐ 19,543
   🔥 MaxKB is an open-source platform for building enterprise-grade agents.  强大易用的开源企业级智能体平台。

30. **[mastra](https://github.com/mastra-ai/mastra)** - ⭐ 18,788
   The TypeScript AI agent framework. ⚡ Assistants, RAG, observability. Supports any LLM: GPT-4, Claude, Gemini, Llama.

31. **[agentic](https://github.com/transitive-bullshit/agentic)** - ⭐ 18,060
   Your API ⇒ Paid MCP. Instantly.

32. **[serena](https://github.com/oraios/serena)** - ⭐ 17,112
   A powerful coding agent toolkit providing semantic retrieval and editing capabilities (MCP server & other integrations)

33. **[chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp)** - ⭐ 16,442
   Chrome DevTools for coding agents

34. **[blender-mcp](https://github.com/ahujasid/blender-mcp)** - ⭐ 14,486

35. **[mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners)** - ⭐ 13,656
   This open-source curriculum introduces the fundamentals of Model Context Protocol (MCP) through real-world, cross-language examples in .NET, Java, TypeScript, JavaScript, Rust and Python. Designed for developers, it focuses on practical techniques for building modular, scalable, and secure AI workflows from session setup to service orchestration.

36. **[filestash](https://github.com/mickael-kerjean/filestash)** - ⭐ 13,173
   :file_folder: The Dropbox like web client for SFTP, S3, FTP, WebDAV, Git, Minio, LDAP, CalDAV, CardDAV, Mysql, Backblaze, ...

37. **[trigger.dev](https://github.com/triggerdotdev/trigger.dev)** - ⭐ 12,965
   Trigger.dev – build and deploy fully‑managed AI agents and workflows

38. **[Qwen-Agent](https://github.com/QwenLM/Qwen-Agent)** - ⭐ 12,644
   Agent framework and applications built upon Qwen>=3.0, featuring Function Calling, MCP, Code Interpreter, RAG, Chrome extension, etc.

39. **[Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP)** - ⭐ 12,185
   MCP server to provide Figma layout information to AI coding agents like Cursor

40. **[genai-toolbox](https://github.com/googleapis/genai-toolbox)** - ⭐ 11,763
   MCP Toolbox for Databases is an open source MCP server for databases.

41. **[fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)** - ⭐ 11,229
   Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!

42. **[typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk)** - ⭐ 10,999
   The official TypeScript SDK for Model Context Protocol servers and clients

43. **[n8n-mcp](https://github.com/czlonkowski/n8n-mcp)** - ⭐ 10,745
   A MCP for Claude Desktop / Claude Code / Windsurf / Cursor to build n8n workflows for you 

44. **[claude-flow](https://github.com/ruvnet/claude-flow)** - ⭐ 10,578
...
45. **[pal-mcp-server](https://github.com/BeehiveInnovations/pal-mcp-server)** - ⭐ 10,445
   The power of Claude Code / GeminiCLI / CodexCLI + [Gemini / OpenAI / OpenRouter / Azure / Grok / Ollama / Custom Model / All Of The Above] working as one.

46. **[nginx-ui](https://github.com/0xJacky/nginx-ui)** - ⭐ 10,142
   Yet another WebUI for Nginx

47. **[gateway](https://github.com/Portkey-AI/gateway)** - ⭐ 10,093
   A blazing fast AI Gateway with integrated guardrails. Route to 200+ LLMs, 50+ AI Guardrails with 1 fast & friendly API.

48. **[zen-mcp-server](https://github.com/BeehiveInnovations/zen-mcp-server)** - ⭐ 9,890
   The power of Claude Code / GeminiCLI / CodexCLI + [Gemini / OpenAI / OpenRouter / Azure / Grok / Ollama / Custom Model / All Of The Above] working as one.

49. **[mcp-chrome](https://github.com/hangwin/mcp-chrome)** - ⭐ 9,520
   Chrome MCP Server is a Chrome extension-based Model Context Protocol (MCP) server that exposes your Chrome browser functionality to AI assistants like Claude, enabling complex browser automation, content analysis, and semantic search.

50. **[XHS-Downloader](https://github.com/JoeanAmier/XHS-Downloader)** - ⭐ 9,389
   小红书（XiaoHongShu、RedNote）链接提取/作品采集工具：提取账号发布、收藏、点赞、专辑作品链接；提取搜索结果作品、用户链接；采集小红书作品信息；提取小红书作品下载地址；下载小红书无水印作品文件

51. **[mcp-use](https://github.com/mcp-use/mcp-use)** - ⭐ 8,551
   mcp-use is the easiest way to interact with mcp servers with custom agents

52. **[Scrapling](https://github.com/D4Vinci/Scrapling)** - ⭐ 8,300
   🕷️ An undetectable, powerful, flexible, high-performance Python library to make Web Scraping Easy and Effortless as it should be!

53. **[inspector](https://github.com/modelcontextprotocol/inspector)** - ⭐ 7,918
   Visual testing tool for MCP servers

54. **[xiaozhi-esp32-server](https://github.com/xinnan-tech/xiaozhi-esp32-server)** - ⭐ 7,888
   本项目为xiaozhi-esp32提供后端服务，帮助您快速搭建ESP32设备控制服务器。Backend service for xiaozhi-esp32, helps you quickly build an ESP32 device control server.

55. **[awesome-ai-apps](https://github.com/Arindam200/awesome-ai-apps)** - ⭐ 7,879
   A collection of projects showcasing RAG, agents, workflows, and other AI use cases

56. **[mcp-agent](https://github.com/lastmile-ai/mcp-agent)** - ⭐ 7,850
   Build effective agents using Model Context Protocol and simple workflow patterns

57. **[mcp-go](https://github.com/mark3labs/mcp-go)** - ⭐ 7,795
   A Go implementation of the Model Context Protocol (MCP), enabling seamless integration between LLM applications and external data sources and tools.

58. **[mcp](https://github.com/awslabs/mcp)** - ⭐ 7,637
   AWS MCP Servers — helping you get the most out of AWS, wherever you use MCP.

59. **[xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp)** - ⭐ 7,416
   MCP for xiaohongshu.com

60. **[git-mcp](https://github.com/idosal/git-mcp)** - ⭐ 7,154
   Put an end to code hallucinations! GitMCP is a free, open-source, remote MCP server for any GitHub project

61. **[awesome-LLM-resources](https://github.com/WangRongsheng/awesome-LLM-resources)** - ⭐ 6,939
   🧑‍🚀 全世界最好的LLM资料总结（语音视频生成、Agent、辅助编程、数据处理、模型训练、模型推理、o1 模型、MCP、小语言模型、视觉语言模型） | Summary of the world's best LLM resources. 

62. **[browser-tools-mcp](https://github.com/AgentDeskAI/browser-tools-mcp)** - ⭐ 6,899
   Monitor browser logs directly from Cursor and other MCP compatible IDEs.

63. **[GhidraMCP](https://github.com/LaurieWired/GhidraMCP)** - ⭐ 6,703
   MCP Server for Ghidra

64. **[cc-switch](https://github.com/farion1231/cc-switch)** - ⭐ 6,401
   A cross-platform desktop All-in-One assistant tool for Claude Code, Codex & Gemini CLI.

65. **[registry](https://github.com/modelcontextprotocol/registry)** - ⭐ 6,114
   A community driven registry service for Model Context Protocol (MCP) servers.

66. **[awesome-mcp-clients](https://github.com/punkpeye/awesome-mcp-clients)** - ⭐ 6,082
   A collection of MCP clients.

67. **[cursor-talk-to-figma-mcp](https://github.com/grab/cursor-talk-to-figma-mcp)** - ⭐ 5,786
...
68. **[klavis](https://github.com/Klavis-AI/klavis)** - ⭐ 5,507
   Klavis AI (YC X25):  MCP integration platforms that let AI agents use tools reliably at any scale

69. **[Awesome-MCP-ZH](https://github.com/yzfly/Awesome-MCP-ZH)** - ⭐ 5,270
   MCP 资源精选， MCP指南，Claude MCP，MCP Servers, MCP Clients

70. **[mcp](https://github.com/BrowserMCP/mcp)** - ⭐ 5,143
   Browser MCP is a Model Context Provider (MCP) server that allows AI applications to control your browser

71. **[whatsapp-mcp](https://github.com/lharries/whatsapp-mcp)** - ⭐ 5,132
   WhatsApp MCP server

72. **[DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP)** - ⭐ 5,062
   This is MCP server for Claude that gives it terminal control, file system search and diff file editing capabilities

73. **[mcp-playwright](https://github.com/executeautomation/mcp-playwright)** - ⭐ 5,057
   Playwright Model Context Protocol Server - Tool to automate Browsers and APIs in Claude Desktop, Cline, Cursor IDE and More 🔌

74. **[firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server)** - ⭐ 5,054
   🔥 Official Firecrawl MCP Server - Adds powerful web scraping and search to Cursor, Claude and any other LLM clients.

75. **[gaianet-node](https://github.com/GaiaNet-AI/gaianet-node)** - ⭐ 5,010
   Install, run and deploy your own decentralized AI agent service

76. **[hexstrike-ai](https://github.com/0x4m4/hexstrike-ai)** - ⭐ 5,005
   HexStrike AI MCP Agents is an advanced MCP server that lets AI agents (Claude, GPT, Copilot, etc.) autonomously run 150+ cybersecurity tools for automated pentesting, vulnerability discovery, bug bounty automation, and security research. Seamlessly bridge LLMs with real-world offensive security capabilities.

77. **[awesome-mcp-servers](https://github.com/appcypher/awesome-mcp-servers)** - ⭐ 4,968
   Awesome MCP Servers - A curated list of Model Context Protocol servers

78. **[Skill_Seekers](https://github.com/yusufkaraaslan/Skill_Seekers)** - ⭐ 4,952
   Convert documentation websites, GitHub repositories, and PDFs into Claude AI skills with automatic conflict detection

79. **[5ire](https://github.com/nanbingxyz/5ire)** - ⭐ 4,858
   5ire is a cross-platform desktop AI assistant, MCP client. It compatible with major service providers,  supports local knowledge base and  tools via model context protocol servers .

80. **[claude-context](https://github.com/zilliztech/claude-context)** - ⭐ 4,723
   Code search MCP for Claude Code. Make entire codebase the context for any coding agent.

81. **[astron-rpa](https://github.com/iflytek/astron-rpa)** - ⭐ 4,705
   Agent-ready RPA suite with out-of-the-box automation tools. Built for individuals and enterprises.

82. **[aci](https://github.com/aipotheosis-labs/aci)** - ⭐ 4,687
   ACI.dev is the open source tool-calling platform that hooks up 600+ tools into any agentic IDE or custom AI agent through direct function calling or a unified MCP server. The birthplace of VibeOps.

83. **[ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp)** - ⭐ 4,567
   AI-powered reverse engineering assistant that bridges IDA Pro with language models through MCP.

84. **[Kiln](https://github.com/Kiln-AI/Kiln)** - ⭐ 4,469
   Easily build AI systems with Evals, RAG, Agents, fine-tuning, synthetic data, and more.

85. **[sdk-python](https://github.com/strands-agents/sdk-python)** - ⭐ 4,433
   A model-driven approach to building AI agents in just a few lines of code.

86. **[casibase](https://github.com/casibase/casibase)** - ⭐ 4,328
   ⚡️AI Cloud OS: Open-source enterprise-level AI knowledge base and MCP (model-context-protocol)/A2A (agent-to-agent) management platform with admin UI, user management and Single-Sign-On⚡️, supports ChatGPT, Claude, Llama, Ollama, HuggingFace, etc., chat bot demo: https://ai.casibase.com, admin UI demo: https://ai-admin.casibase.com

87. **[deep-research](https://github.com/u14app/deep-research)** - ⭐ 4,254
   Use any LLMs (Large Language Models) for Deep Research. Support SSE API and MCP server.

88. **[unity-mcp](https://github.com/CoplayDev/unity-mcp)** - ⭐ 4,246
   An MCP server that allows MCP clients like Claude Desktop or Cursor to perform actions in the Unity Editor

89. **[httprunner](https://github.com/httprunner/httprunner)** - ⭐ 4,230
   HttpRunner 是一款开源的 API/UI 测试框架，简单易用，功能强大，具有丰富的插件化机制和高度的可扩展能力。

90. **[Everywhere](https://github.com/DearVa/Everywhere)** - ⭐ 4,195
...
91. **[voltagent](https://github.com/VoltAgent/voltagent)** - ⭐ 4,183
   Open Source TypeScript AI Agent Framework with built-in LLM Observability

92. **[microsandbox](https://github.com/zerocore-ai/microsandbox)** - ⭐ 4,153
   opensource self-hosted ai agent sandboxes

93. **[magic-mcp](https://github.com/21st-dev/magic-mcp)** - ⭐ 4,012
   It's like v0 but in your Cursor/WindSurf/Cline. 21st dev Magic MCP server for working with your frontend like Magic

94. **[directories](https://github.com/pontusab/directories)** - ⭐ 3,841
   The Cursor & Windsurf community, find rules and MCPs

95. **[mcp-ui](https://github.com/MCP-UI-Org/mcp-ui)** - ⭐ 3,791
   UI over MCP. Create next-gen UI experiences with the protocol and SDK!

96. **[mcp-atlassian](https://github.com/sooperset/mcp-atlassian)** - ⭐ 3,779
   MCP server for Atlassian tools (Confluence, Jira)

97. **[learn-agentic-ai](https://github.com/panaversity/learn-agentic-ai)** - ⭐ 3,770
   Learn Agentic AI using Dapr Agentic Cloud Ascent (DACA) Design Pattern and Agent-Native Cloud Technologies: OpenAI Agents SDK, Memory, MCP, A2A, Knowledge Graphs, Dapr, Rancher Desktop, and Kubernetes.

98. **[mcpo](https://github.com/open-webui/mcpo)** - ⭐ 3,748
   A simple, secure MCP-to-OpenAPI proxy server

99. **[csharp-sdk](https://github.com/modelcontextprotocol/csharp-sdk)** - ⭐ 3,680
   The official C# SDK for Model Context Protocol servers and clients. Maintained in collaboration with Microsoft.

100. **[Windows-MCP](https://github.com/CursorTouch/Windows-MCP)** - ⭐ 3,625
   MCP Server for Computer Use in Windows

101. **[notion-mcp-server](https://github.com/makenotion/notion-mcp-server)** - ⭐ 3,578
   Official Notion MCP Server

102. **[core](https://github.com/opensumi/core)** - ⭐ 3,573
   A framework helps you quickly build AI Native IDE products. MCP Client, supports Model Context Protocol (MCP) tools via MCP server.

103. **[fast-agent](https://github.com/evalstate/fast-agent)** - ⭐ 3,531
   Define, Prompt and Test MCP enabled Agents and Workflows

104. **[Olares](https://github.com/beclab/Olares)** - ⭐ 3,521
   Olares: An Open-Source Personal Cloud to Reclaim Your Data

105. **[MemOS](https://github.com/MemTensor/MemOS)** - ⭐ 3,439
...
106. **[mcp-feedback-enhanced](https://github.com/Minidoracat/mcp-feedback-enhanced)** - ⭐ 3,421
   Enhanced MCP server for interactive user feedback and command execution in AI-assisted development, featuring dual interface support (Web UI and Desktop Application) with intelligent environment detection and cross-platform compatibility.

107. **[ciso-assistant-community](https://github.com/intuitem/ciso-assistant-community)** - ⭐ 3,410
...
108. **[go-sdk](https://github.com/modelcontextprotocol/go-sdk)** - ⭐ 3,393
   The official Go SDK for Model Context Protocol servers and clients. Maintained in collaboration with Google.

109. **[exa-mcp-server](https://github.com/exa-labs/exa-mcp-server)** - ⭐ 3,383
   Exa MCP for web search and web crawling!

110. **[spec-workflow-mcp](https://github.com/Pimzino/spec-workflow-mcp)** - ⭐ 3,326
   A Model Context Protocol (MCP) server that provides structured spec-driven development workflow tools for AI-assisted software development, featuring a real-time web dashboard and VSCode extension for monitoring and managing your project's progress directly in your development environment.

111. **[cipher](https://github.com/campfirein/cipher)** - ⭐ 3,326
...
112. **[mcp-server-chart](https://github.com/antvis/mcp-server-chart)** - ⭐ 3,301
   🤖 A visualization mcp contains 25+ visual charts using @antvis. Using for chart generation and data analysis.

113. **[PeopleInSpace](https://github.com/joreilly/PeopleInSpace)** - ⭐ 3,267
   Kotlin Multiplatform sample with SwiftUI, Jetpack Compose, Compose for Wear, Compose for Desktop, and Compose for Web clients along with Ktor backend.

114. **[telegram-search](https://github.com/groupultra/telegram-search)** - ⭐ 3,253
   🔍  Semantic search your Telegram chat history | 语义化搜索您的 Telegram 聊天记录

115. **[go-whatsapp-web-multidevice](https://github.com/aldinokemal/go-whatsapp-web-multidevice)** - ⭐ 3,229
   GOWA - WhatsApp REST API with support for UI, Webhooks, and MCP. Built with Golang for efficient memory use. 

116. **[mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare)** - ⭐ 3,200

117. **[langchain-mcp-adapters](https://github.com/langchain-ai/langchain-mcp-adapters)** - ⭐ 3,196
   LangChain 🔌 MCP

118. **[metorial](https://github.com/metorial/metorial)** - ⭐ 3,178
   Connect any AI model to 600+ integrations; powered by MCP 📡 🚀

119. **[MCP-Chinese-Getting-Started-Guide](https://github.com/liaokongVFX/MCP-Chinese-Getting-Started-Guide)** - ⭐ 3,177
   Model Context Protocol(MCP) 编程极速入门

120. **[awesome-mcp-servers](https://github.com/wong2/awesome-mcp-servers)** - ⭐ 3,081
   A curated list of Model Context Protocol (MCP) servers

121. **[AionUi](https://github.com/iOfficeAI/AionUi)** - ⭐ 3,059
...
122. **[memU](https://github.com/NevaMind-AI/memU)** - ⭐ 3,026
   Memory infrastructure for LLMs and AI agents

123. **[py-xiaozhi](https://github.com/huangjunsen0406/py-xiaozhi)** - ⭐ 3,008
   A Python-based Xiaozhi AI for users who want the full Xiaozhi experience without owning specialized hardware.

124. **[wanwu](https://github.com/UnicomAI/wanwu)** - ⭐ 2,998
   China Unicom's Yuanjing Wanwu Agent Platform is an enterprise-grade, multi-tenant AI agent development platform. It helps users build applications such as intelligent agents, workflows, and rag, and also supports model management. The platform features a developer-friendly license, and we welcome all developers to build upon the platform.

125. **[XcodeBuildMCP](https://github.com/cameroncooke/XcodeBuildMCP)** - ⭐ 2,985
   A Model Context Protocol (MCP) server that provides Xcode-related tools for integration with AI assistants and other MCP clients.

126. **[java-sdk](https://github.com/modelcontextprotocol/java-sdk)** - ⭐ 2,970
   The official Java SDK for Model Context Protocol servers and clients. Maintained in collaboration with Spring AI

127. **[excel-mcp-server](https://github.com/haris-musa/excel-mcp-server)** - ⭐ 2,955
   A Model Context Protocol server for Excel file manipulation

128. **[mcp-context-forge](https://github.com/IBM/mcp-context-forge)** - ⭐ 2,949
...
130. **[boost](https://github.com/laravel/boost)** - ⭐ 2,928
   Laravel-focused MCP server for augmenting your AI powered local development experience.

131. **[n8n-nodes-mcp](https://github.com/nerding-io/n8n-nodes-mcp)** - ⭐ 2,918
   n8n custom node for MCP

132. **[mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase)** - ⭐ 2,917
   Allow LLMs to control a browser with Browserbase and Stagehand

133. **[learn-ai-engineering](https://github.com/ashishps1/learn-ai-engineering)** - ⭐ 2,914
   Learn AI and LLMs from scratch using free resources

134. **[apple-mcp](https://github.com/supermemoryai/apple-mcp)** - ⭐ 2,888
   Collection of apple-native tools for the model context protocol.

135. **[octelium](https://github.com/octelium/octelium)** - ⭐ 2,885
   A next-gen FOSS self-hosted unified zero trust secure access platform that can operate as a remote access VPN, a ZTNA platform, API/AI/MCP gateway, a PaaS, an ngrok-alternative and a homelab infrastructure.

136. **[fastmcp](https://github.com/punkpeye/fastmcp)** - ⭐ 2,816
   A TypeScript framework for building MCP servers.

137. **[PPTAgent](https://github.com/icip-cas/PPTAgent)** - ⭐ 2,808
   PPTAgent: Generating and Evaluating Presentations Beyond Text-to-Slides [EMNLP 2025]

138. **[claude-code-guide](https://github.com/zebbern/claude-code-guide)** - ⭐ 2,746
...
139. **[rust-sdk](https://github.com/modelcontextprotocol/rust-sdk)** - ⭐ 2,695
   The official Rust SDK for the Model Context Protocol

140. **[mobile-mcp](https://github.com/mobile-next/mobile-mcp)** - ⭐ 2,636
   Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators, Simulators and Real Devices)

141. **[rikkahub](https://github.com/rikkahub/rikkahub)** - ⭐ 2,608
   RikkaHub is an Android APP that supports for multiple LLM providers.

142. **[kreuzberg](https://github.com/kreuzberg-dev/kreuzberg)** - ⭐ 2,582
...
143. **[AI-Infra-Guard](https://github.com/Tencent/AI-Infra-Guard)** - ⭐ 2,565
...
145. **[shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server)** - ⭐ 2,524
...
146. **[mcp-obsidian](https://github.com/MarkusPfundstein/mcp-obsidian)** - ⭐ 2,524
   MCP server that interacts with Obsidian via the Obsidian rest API community plugin

147. **[nunu](https://github.com/go-nunu/nunu)** - ⭐ 2,509
   A CLI tool for building Go applications.

148. **[supabase-mcp](https://github.com/supabase-community/supabase-mcp)** - ⭐ 2,320
   Connect Supabase to your AI assistants

149. **[UltraRAG](https://github.com/OpenBMB/UltraRAG)** - ⭐ 2,312
   UltraRAG v2: A Low-Code MCP Framework for Building Complex and Innovative RAG Pipelines

150. **[markdownify-mcp](https://github.com/zcaceres/markdownify-mcp)** - ⭐ 2,298
   A Model Context Protocol server for converting almost anything to Markdown

151. **[mcp](https://github.com/microsoft/mcp)** - ⭐ 2,295
   Catalog of official Microsoft MCP (Model Context Protocol) server implementations for AI-powered data access and tool integration

152. **[supergateway](https://github.com/supercorp-ai/supergateway)** - ⭐ 2,292
   Run MCP stdio servers over SSE and SSE over stdio. AI gateway.

153. **[basic-memory](https://github.com/basicmachines-co/basic-memory)** - ⭐ 2,195
   AI conversations that actually remember. Never re-explain your project to your AI again. Join our Discord: https://discord.gg/tyvKNccgqN

154. **[chatmcp](https://github.com/daodao97/chatmcp)** - ⭐ 2,139
   ChatMCP is an AI chat client implementing the Model Context Protocol (MCP).

155. **[MCP-SuperAssistant](https://github.com/srbhptl39/MCP-SuperAssistant)** - ⭐ 2,137
   Brings MCP to ChatGPT, DeepSeek, Perplexity, Grok, Gemini, Google AI Studio, OpenRouter, DeepSeek, T3 Chat and more...

156. **[mcp-proxy](https://github.com/sparfenyuk/mcp-proxy)** - ⭐ 2,080
   A bridge between Streamable HTTP and stdio MCP transports

157. **[claude-code-subagents-collection](https://github.com/davepoon/claude-code-subagents-collection)** - ⭐ 2,058
   Claude Code Subagents & Commands Collection + CLI Tool

158. **[ableton-mcp](https://github.com/ahujasid/ableton-mcp)** - ⭐ 2,050
...
160. **[papersgpt-for-zotero](https://github.com/papersgpt/papersgpt-for-zotero)** - ⭐ 2,002
...
162. **[mcp-grafana](https://github.com/grafana/mcp-grafana)** - ⭐ 1,972
   MCP server for Grafana

163. **[superglue](https://github.com/superglue-ai/superglue)** - ⭐ 1,957
   superglue (YC W25) builds integrations and tools from natural language. Get production-grade tools for long tail and enterprise systems.

164. **[Unla](https://github.com/AmoyLab/Unla)** - ⭐ 1,953
   🧩 MCP Gateway - A lightweight gateway service that instantly transforms existing MCP Servers and APIs into MCP servers with zero code changes. Features Docker deployment and management UI, requiring no infrastructure modifications.

165. **[arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server)** - ⭐ 1,947
   A Model Context Protocol server for searching and analyzing arXiv papers

166. **[kagent](https://github.com/kagent-dev/kagent)** - ⭐ 1,934
   Cloud Native Agentic AI | Discord: https://bit.ly/kagentdiscord

167. **[mcpso](https://github.com/chatmcp/mcpso)** - ⭐ 1,932
   directory for Awesome MCP Servers

168. **[mcp-shrimp-task-manager](https://github.com/cjo4m06/mcp-shrimp-task-manager)** - ⭐ 1,916
   Shrimp Task Manager is a task tool built for AI Agents, emphasizing chain-of-thought, reflection, and style consistency. It converts natural language into structured dev tasks with dependency tracking and iterative refinement, enabling agent-like developer behavior in reasoning AI systems.

169. **[mcp-crawl4ai-rag](https://github.com/coleam00/mcp-crawl4ai-rag)** - ⭐ 1,907
   Web Crawling and RAG Capabilities for AI Agents and AI Coding Assistants

170. **[yomo](https://github.com/yomorun/yomo)** - ⭐ 1,873
   🦖 Serverless AI Agent Framework with Geo-distributed Edge AI Infra.

171. **[lemonade](https://github.com/lemonade-sdk/lemonade)** - ⭐ 1,853
...
172. **[modelcontextprotocol](https://github.com/perplexityai/modelcontextprotocol)** - ⭐ 1,819
   The official MCP server implementation for the Perplexity API Platform

173. **[mcp-cli](https://github.com/chrishayuk/mcp-cli)** - ⭐ 1,781

174. **[witsy](https://github.com/nbonamy/witsy)** - ⭐ 1,776
   Witsy: desktop AI assistant / universal MCP client

175. **[metamcp](https://github.com/metatool-ai/metamcp)** - ⭐ 1,771
   MCP Aggregator, Orchestrator, Middleware, Gateway in one docker

176. **[gemini-mcp-tool](https://github.com/jamubc/gemini-mcp-tool)** - ⭐ 1,746
   MCP server that enables AI assistants to interact with Google Gemini CLI, leveraging Gemini's massive token window for large file analysis and codebase understanding

177. **[opendia](https://github.com/aaronjmars/opendia)** - ⭐ 1,739
   Connect your browser to AI models. Just use Dia on Chrome, Arc or Firefox.

178. **[beelzebub](https://github.com/mariocandela/beelzebub)** - ⭐ 1,738
   A secure low code honeypot framework, leveraging AI for System Virtualization. 🇮🇹

179. **[sanic-web](https://github.com/apconw/sanic-web)** - ⭐ 1,731
...
180. **[brightdata-mcp](https://github.com/brightdata/brightdata-mcp)** - ⭐ 1,721
   A powerful Model Context Protocol (MCP) server that provides an all-in-one solution for public web access.

181. **[dbhub](https://github.com/bytebase/dbhub)** - ⭐ 1,707
   Universal database MCP server connecting to MySQL, PostgreSQL, SQL Server, MariaDB, SQLite.

182. **[sandbox](https://github.com/agent-infra/sandbox)** - ⭐ 1,666
   All-in-One Sandbox for AI Agents that combines Browser, Shell, File, MCP and VSCode Server in a single Docker container.

183. **[agentset](https://github.com/agentset-ai/agentset)** - ⭐ 1,663
   The open-source RAG platform: built-in citations, deep research, 22+ file formats, partitions, MCP server, and more.

184. **[mcphub.nvim](https://github.com/ravitemer/mcphub.nvim)** - ⭐ 1,661
   An MCP client for Neovim that seamlessly integrates MCP servers into your editing workflow with an intuitive interface for managing, testing, and using MCP servers with your favorite chat plugins.

185. **[Dive](https://github.com/OpenAgentPlatform/Dive)** - ⭐ 1,655
   Dive is an open-source MCP Host Desktop Application that seamlessly integrates with any LLMs supporting function calling capabilities. ✨

186. **[postgres-mcp](https://github.com/crystaldba/postgres-mcp)** - ⭐ 1,646
   Postgres MCP Pro provides configurable read/write access and performance analysis for you and your AI agents.

187. **[interactive-feedback-mcp](https://github.com/noopstudios/interactive-feedback-mcp)** - ⭐ 1,639
   Interactive User Feedback MCP

188. **[AIaW](https://github.com/NitroRCr/AIaW)** - ⭐ 1,631
...
189. **[mcphub](https://github.com/samanhappy/mcphub)** - ⭐ 1,629
   A unified hub for centrally managing and dynamically orchestrating multiple MCP servers/APIs into separate endpoints with flexible routing strategies

190. **[osaurus](https://github.com/dinoki-ai/osaurus)** - ⭐ 1,628
...
191. **[zenfeed](https://github.com/glidea/zenfeed)** - ⭐ 1,596
   Make RSS 📰 great again with AI 🧠✨!!

192. **[mcpb](https://github.com/modelcontextprotocol/mcpb)** - ⭐ 1,596
...
195. **[n8n-mcp-server](https://github.com/leonardsellem/n8n-mcp-server)** - ⭐ 1,498
   MCP server that provides tools and resources for interacting with n8n API

196. **[py-gpt](https://github.com/szczyglis-dev/py-gpt)** - ⭐ 1,497
   Desktop AI Assistant powered by GPT-5, GPT-4, o1, o3, Gemini, Claude, Ollama, DeepSeek, Perplexity, Grok, Bielik, chat, vision, voice, RAG, image and video generation, agents, tools, MCP, plugins, speech synthesis and recognition, web search, memory, presets, assistants,and more. Linux, Windows, Mac

197. **[mcphost](https://github.com/mark3labs/mcphost)** - ⭐ 1,489
   A CLI host application that enables Large Language Models (LLMs) to interact with external tools through the Model Context Protocol (MCP).

198. **[inspector](https://github.com/MCPJam/inspector)** - ⭐ 1,486
   Build ChatGPT Apps and MCP servers locally.

199. **[mcp-installer](https://github.com/anaisbetts/mcp-installer)** - ⭐ 1,477
   An MCP server that installs other MCP servers for you

200. **[kubb](https://github.com/kubb-labs/kubb)** - ⭐ 1,458
   🧩 The ultimate toolkit for working with APIs. 🎅🏼 HO. HO. HO.

201. **[agentgateway](https://github.com/agentgateway/agentgateway)** - ⭐ 1,428
   Next Generation Agentic Proxy for AI Agents and MCP servers

202. **[toolhive](https://github.com/stacklok/toolhive)** - ⭐ 1,424
   ToolHive makes deploying MCP servers easy, secure and fun

203. **[MCP-Reborn](https://github.com/Hexeption/MCP-Reborn)** - ⭐ 1,413
   MCP-Reborn is an MCP (Mod Coder Pack) for Minecraft for making modded clients and researching its code. (1.13-1.21.4)

204. **[mcptools](https://github.com/f/mcptools)** - ⭐ 1,394
   A command-line interface for interacting with MCP (Model Context Protocol) servers using both stdio and HTTP transport.

205. **[super-agent-party](https://github.com/heshengtao/super-agent-party)** - ⭐ 1,383
...
206. **[better-agents](https://github.com/langwatch/better-agents)** - ⭐ 1,373
   Standards for building agents, better

207. **[rulego](https://github.com/rulego/rulego)** - ⭐ 1,369
   ⛓️RuleGo is a lightweight, high-performance, embedded, next-generation component orchestration rule engine framework for Go.

208. **[mcp-router](https://github.com/mcp-router/mcp-router)** - ⭐ 1,357
   A Unified MCP Server Management App (MCP Manager).

209. **[mcp-scan](https://github.com/invariantlabs-ai/mcp-scan)** - ⭐ 1,335
   Constrain, log and scan your MCP connections for security vulnerabilities.

210. **[bifrost](https://github.com/maximhq/bifrost)** - ⭐ 1,323
   Fastest LLM gateway (50x faster than LiteLLM) with adaptive load balancer, cluster mode, guardrails, 1000+ models support & <100 µs overhead at 5k RPS.

211. **[mcp-language-server](https://github.com/isaacphi/mcp-language-server)** - ⭐ 1,309
   mcp-language-server gives MCP enabled clients access semantic tools like get definition, references, rename, and diagnostics.

212. **[Office-PowerPoint-MCP-Server](https://github.com/GongRzhe/Office-PowerPoint-MCP-Server)** - ⭐ 1,309
   A MCP (Model Context Protocol) server for PowerPoint manipulation using python-pptx. This server provides tools for creating, editing, and manipulating PowerPoint presentations through the MCP protocol.

213. **[nerve](https://github.com/evilsocket/nerve)** - ⭐ 1,307
   The Simple Agent Development Kit.

214. **[ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp)** - ⭐ 1,301
   MCP server for interacting with the iOS simulator

215. **[yu-ai-agent](https://github.com/liyupi/yu-ai-agent)** - ⭐ 1,261
...
216. **[Claude-Code-Development-Kit](https://github.com/peterkrueck/Claude-Code-Development-Kit)** - ⭐ 1,250
   Handle context at scale - my custom Claude Code workflow including hooks, mcp and sub agents

217. **[php-sdk](https://github.com/modelcontextprotocol/php-sdk)** - ⭐ 1,247
   The official PHP SDK for Model Context Protocol servers and clients. Maintained in collaboration with The PHP Foundation.

218. **[LitterBox](https://github.com/BlackSnufkin/LitterBox)** - ⭐ 1,237
   A secure sandbox environment for malware developers and red teamers to test payloads against detection mechanisms before deployment. Integrates with LLM agents via MCP for enhanced analysis capabilities.

219. **[damn-vulnerable-MCP-server](https://github.com/harishsg993010/damn-vulnerable-MCP-server)** - ⭐ 1,235
   Damn Vulnerable MCP Server

220. **[mcp-obsidian](https://github.com/smithery-ai/mcp-obsidian)** - ⭐ 1,235
   A connector for Claude Desktop to read and search an Obsidian vault.

221. **[web-eval-agent](https://github.com/withRefresh/web-eval-agent)** - ⭐ 1,226
   An MCP server that autonomously evaluates web applications. 

222. **[RisuAI](https://github.com/kwaroran/RisuAI)** - ⭐ 1,221
   Make your own story. User-friendly software for LLM roleplaying

223. **[mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes)** - ⭐ 1,210
   MCP Server for kubernetes management commands

224. **[godot-mcp](https://github.com/Coding-Solo/godot-mcp)** - ⭐ 1,208
   MCP server for interfacing with Godot game engine. Provides tools for launching the editor, running projects, and capturing debug output.

225. **[docker-mcp-tutorial](https://github.com/theNetworkChuck/docker-mcp-tutorial)** - ⭐ 1,200
   Complete tutorial materials for building MCP servers with Docker - from NetworkChuck's video

226. **[grafbase](https://github.com/grafbase/grafbase)** - ⭐ 1,192
   The Grafbase GraphQL Federation Gateway

227. **[sre](https://github.com/SmythOS/sre)** - ⭐ 1,189
   The SmythOS Runtime Environment (SRE) is an open-source, cloud-native runtime for agentic AI. Secure, modular, and production-ready, it lets developers build, run, and manage intelligent agents across local, cloud, and edge environments.

228. **[kotlin-sdk](https://github.com/modelcontextprotocol/kotlin-sdk)** - ⭐ 1,181
   The official Kotlin SDK for Model Context Protocol servers and clients. Maintained in collaboration with JetBrains

229. **[deepwiki-mcp](https://github.com/regenrek/deepwiki-mcp)** - ⭐ 1,175
   📖 MCP server for fetch deepwiki.com and get latest knowledge in Cursor and other Code Editors

230. **[code-mode](https://github.com/universal-tool-calling-protocol/code-mode)** - ⭐ 1,175
   🔌 Plug-and-play library to enable agents to call MCP and UTCP tools via code execution. 

231. **[mcp-remote](https://github.com/geelen/mcp-remote)** - ⭐ 1,169

232. **[mcp-golang](https://github.com/metoro-io/mcp-golang)** - ⭐ 1,168
   Write Model Context Protocol servers in few lines of go code. Docs at https://mcpgolang.com . Created by https://metoro.io

233. **[ai](https://github.com/stripe/ai)** - ⭐ 1,150
   One-stop shop for building AI-powered products and businesses with Stripe.

234. **[xmcp](https://github.com/basementstudio/xmcp)** - ⭐ 1,139
   The TypeScript MCP framework

235. **[mcp-unity](https://github.com/CoderGamester/mcp-unity)** - ⭐ 1,136
...
236. **[mcp](https://github.com/MicrosoftDocs/mcp)** - ⭐ 1,134
...
238. **[npcpy](https://github.com/NPC-Worldwide/npcpy)** - ⭐ 1,119
   The AI toolkit for the AI developer

239. **[mcp-server-qdrant](https://github.com/qdrant/mcp-server-qdrant)** - ⭐ 1,116
   An official Qdrant Model Context Protocol (MCP) server implementation

240. **[MiniMax-MCP](https://github.com/MiniMax-AI/MiniMax-MCP)** - ⭐ 1,115
   Official MiniMax Model Context Protocol (MCP) server that enables interaction with powerful Text to Speech, image generation and video generation APIs.

241. **[tuui](https://github.com/AI-QL/tuui)** - ⭐ 1,112
   A desktop MCP client designed as a tool unitary utility integration, accelerating AI adoption through the Model Context Protocol (MCP) and enabling cross-vendor LLM API orchestration.

242. **[fast-mcp](https://github.com/yjacquin/fast-mcp)** - ⭐ 1,096
   A Ruby Implementation of the Model Context Protocol

243. **[terraform-mcp-server](https://github.com/hashicorp/terraform-mcp-server)** - ⭐ 1,095
   The Terraform MCP Server provides seamless integration with Terraform ecosystem, enabling advanced automation and interaction capabilities for Infrastructure as Code (IaC) development.

244. **[A2V](https://github.com/Devin-AXIS/A2V)** - ⭐ 1,095
   A2V: Next-Gen AI Value Compute Protocol.                                                                                 

245. **[elevenlabs-mcp](https://github.com/elevenlabs/elevenlabs-mcp)** - ⭐ 1,093
   The official ElevenLabs MCP server

246. **[Office-Word-MCP-Server](https://github.com/GongRzhe/Office-Word-MCP-Server)** - ⭐ 1,087
   A Model Context Protocol (MCP) server for creating, reading, and manipulating Microsoft Word documents. This server enables AI assistants to work with Word documents through a standardized interface, providing rich document editing capabilities.

247. **[azure-devops-mcp](https://github.com/microsoft/azure-devops-mcp)** - ⭐ 1,084
   The MCP server for Azure DevOps, bringing the power of Azure DevOps directly to your agents.

248. **[unreal-mcp](https://github.com/chongdashu/unreal-mcp)** - ⭐ 1,078
   Enable AI assistant clients like Cursor, Windsurf and Claude Desktop to control Unreal Engine through natural language using the Model Context Protocol (MCP).

249. **[Agent-MCP](https://github.com/rinadelph/Agent-MCP)** - ⭐ 1,074
   Agent-MCP is a framework for creating multi-agent systems that enables coordinated, efficient AI collaboration through the Model Context Protocol (MCP). The system is designed for developers building AI applications that benefit from multiple specialized agents working in parallel on different aspects of a project.

250. **[mcp-gateway](https://github.com/docker/mcp-gateway)** - ⭐ 1,063
   docker mcp CLI plugin / MCP Gateway

251. **[paperdebugger](https://github.com/PaperDebugger/paperdebugger)** - ⭐ 1,060
   Paper Debugger is the best overleaf companion

252. **[AWorld](https://github.com/inclusionAI/AWorld)** - ⭐ 1,058
   Build, evaluate and train General Multi-Agent Assistance with ease

253. **[flock](https://github.com/Onelevenvy/flock)** - ⭐ 1,056
   Flock is a workflow-based low-code platform for rapidly building chatbots, RAG, and coordinating multi-agent teams, powered by LangGraph, Langchain, FastAPI, and NextJS.（Flock 是一个基于workflow工作流的低代码平台，用于快速构建聊天机器人、RAG、Agent和Muti-Agent应用，采用 LangGraph、Langchain、FastAPI 和 NextJS 构建。）

254. **[cunzhi](https://github.com/imhuso/cunzhi)** - ⭐ 1,033
   告别AI提前终止烦恼，助力AI更加持久

255. **[cui](https://github.com/wbopan/cui)** - ⭐ 1,029
   A web UI for Claude Code agents

256. **[SearChat](https://github.com/sear-chat/SearChat)** - ⭐ 1,027
...
259. **[xiaozhi-esp32-server-java](https://github.com/joey-zhou/xiaozhi-esp32-server-java)** - ⭐ 1,022
   小智ESP32的Java企业级管理平台，提供设备监控、音色定制、角色切换和对话记录管理的前后端及服务端一体化解决方案

260. **[minima](https://github.com/dmayboroda/minima)** - ⭐ 1,021
   On-premises conversational RAG with configurable containers

261. **[mysql_mcp_server](https://github.com/designcomputer/mysql_mcp_server)** - ⭐ 1,021
   A Model Context Protocol (MCP) server that enables secure interaction with MySQL databases

262. **[use-mcp](https://github.com/modelcontextprotocol/use-mcp)** - ⭐ 1,009

263. **[lets-learn-mcp-python](https://github.com/microsoft/lets-learn-mcp-python)** - ⭐ 1,005
   MCP Python Tutorial 

264. **[xhs-toolkit](https://github.com/aki66938/xhs-toolkit)** - ⭐ 992
   📕 小红书创作者MCP工具包 - 支持与AI客户端集成的内容创作和发布工具

265. **[tavily-mcp](https://github.com/tavily-ai/tavily-mcp)** - ⭐ 991
   Production ready MCP server with real-time search, extract, map & crawl.

266. **[slack-mcp-server](https://github.com/korotovsky/slack-mcp-server)** - ⭐ 991
...
267. **[google_workspace_mcp](https://github.com/taylorwilsdon/google_workspace_mcp)** - ⭐ 990
...
268. **[mcp-boilerplate](https://github.com/iannuttall/mcp-boilerplate)** - ⭐ 988
   A remote Cloudflare MCP server boilerplate with user authentication and Stripe for paid tools.

269. **[mcp_agent_mail](https://github.com/Dicklesworthstone/mcp_agent_mail)** - ⭐ 983
   Like gmail for your coding agents. Lets various different agents communicate and coordinate with each other.

270. **[mcp-server-mysql](https://github.com/benborla/mcp-server-mysql)** - ⭐ 978
   A Model Context Protocol server that provides read-only access to MySQL databases. This server enables LLMs to inspect database schemas and execute read-only queries.

271. **[ApeRAG](https://github.com/apecloud/ApeRAG)** - ⭐ 973
   ApeRAG: Production-ready GraphRAG with multi-modal indexing, AI agents, MCP support, and scalable K8s deployment

272. **[iMCP](https://github.com/mattt/iMCP)** - ⭐ 965
   A macOS app that provides an MCP server to your Messages, Contacts, Reminders and more

273. **[awesome-remote-mcp-servers](https://github.com/jaw9c/awesome-remote-mcp-servers)** - ⭐ 956
   Remote MCP Servers

274. **[google-analytics-mcp](https://github.com/googleanalytics/google-analytics-mcp)** - ⭐ 956

275. **[claude-code-mcp](https://github.com/steipete/claude-code-mcp)** - ⭐ 954
   Claude Code as one-shot MCP server to have an agent in your agent.

276. **[WebMCP](https://github.com/MiguelsPizza/WebMCP)** - ⭐ 949
   Bringing the power of MCP to the web

277. **[ollama-mcp-bridge](https://github.com/patruff/ollama-mcp-bridge)** - ⭐ 948
   Bridge between Ollama and MCP servers, enabling local LLMs to use Model Context Protocol tools

278. **[better-chatbot](https://github.com/cgoinglove/better-chatbot)** - ⭐ 941
   Just a Better Chatbot. Powered by Agent & MCP & Workflows.

279. **[mcp-jetbrains](https://github.com/JetBrains/mcp-jetbrains)** - ⭐ 938
   A model context protocol server to work with JetBrains IDEs: IntelliJ, PyCharm, WebStorm, etc. Also, works with Android Studio

280. **[mcp-memory-service](https://github.com/doobidoo/mcp-memory-service)** - ⭐ 935
...
281. **[wenyan-mcp](https://github.com/caol64/wenyan-mcp)** - ⭐ 933
   文颜 MCP Server 可以让 AI 自动将 Markdown 文章排版后发布至微信公众号。

282. **[fetcher-mcp](https://github.com/jae-jae/fetcher-mcp)** - ⭐ 932
   MCP server for fetch web page content using Playwright headless browser.

283. **[RedNote-MCP](https://github.com/iFurySt/RedNote-MCP)** - ⭐ 920
   🚀MCP server for accessing RedNote(XiaoHongShu, xhs).

284. **[claude-init](https://github.com/cfrs2005/claude-init)** - ⭐ 914
   Claude Code 中文开发套件 - 为中国开发者定制的零门槛 AI 编程环境。一键安装完整中文化体验，集成 MCP 服务器、智能上下文管理、安全扫描，支持免翻墙访问。让 AI 编程更简单。

285. **[awesome-devops-mcp-servers](https://github.com/rohitg00/awesome-devops-mcp-servers)** - ⭐ 906
   A curated list of awesome MCP servers focused on DevOps tools and capabilities.

286. **[quickstart-resources](https://github.com/modelcontextprotocol/quickstart-resources)** - ⭐ 900
   A repository of servers and clients from the Model Context Protocol tutorials

287. **[CloudBase-AI-ToolKit](https://github.com/TencentCloudBase/CloudBase-AI-ToolKit)** - ⭐ 886
      CloudBase MCP - Connect CloudBase to your AI Agent.     Go from AI prompt to live app in one click.

288. **[MCP-Bridge](https://github.com/SecretiveShell/MCP-Bridge)** - ⭐ 882
   A middleware to provide an openAI compatible endpoint that can call MCP tools

289. **[mcp-framework](https://github.com/QuantGeekDev/mcp-framework)** - ⭐ 880
   A framework for writing MCP (Model Context Protocol) servers in Typescript

290. **[nuxt-mcp-dev](https://github.com/antfu/nuxt-mcp-dev)** - ⭐ 879
   MCP server helping models to understand your Vite/Nuxt app better.

291. **[mix.core](https://github.com/mixcore/mix.core)** - ⭐ 878
   🚀 A future-proof enterprise web CMS supporting both headless and decoupled approaches. Build any type of app with customizable APIs on ASP.NET Core/.NET Core. Completely open-source and designed for flexibility.

292. **[ros-mcp-server](https://github.com/robotmcp/ros-mcp-server)** - ⭐ 878
   Connect AI models like Claude & GPT with robots using MCP and ROS.

293. **[mcpdoc](https://github.com/langchain-ai/mcpdoc)** - ⭐ 876
   Expose llms-txt to IDEs for development

294. **[kubernetes-mcp-server](https://github.com/containers/kubernetes-mcp-server)** - ⭐ 872
   Model Context Protocol (MCP) server for Kubernetes and OpenShift

295. **[solace-agent-mesh](https://github.com/SolaceLabs/solace-agent-mesh)** - ⭐ 871
...
299. **[Gmail-MCP-Server](https://github.com/GongRzhe/Gmail-MCP-Server)** - ⭐ 854
   A Model Context Protocol (MCP) server for Gmail integration in Claude Desktop with auto authentication support. This server enables AI assistants to manage Gmail through natural language interactions.

300. **[mcp-course](https://github.com/huggingface/mcp-course)** - ⭐ 853

301. **[mongodb-mcp-server](https://github.com/mongodb-js/mongodb-mcp-server)** - ⭐ 852
   A Model Context Protocol server to connect to MongoDB databases and MongoDB Atlas Clusters.

302. **[awesome-mcp-list](https://github.com/MobinX/awesome-mcp-list)** - ⭐ 851
   A concise list for mcp servers

303. **[mcp-browser-use](https://github.com/Saik0s/mcp-browser-use)** - ⭐ 851

304. **[ref-tools-mcp](https://github.com/ref-tools/ref-tools-mcp)** - ⭐ 851
   Helping coding agents never make mistakes working with public or private libraries without wasting the context window.

305. **[mcp-neo4j](https://github.com/neo4j-contrib/mcp-neo4j)** - ⭐ 846
   Model Context Protocol with Neo4j

306. **[mcp-notion-server](https://github.com/suekou/mcp-notion-server)** - ⭐ 840

307. **[docs-mcp-server](https://github.com/arabold/docs-mcp-server)** - ⭐ 840
   Grounded Docs MCP Server: Enhance Your AI Coding Assistant 

308. **[Peekaboo](https://github.com/steipete/Peekaboo)** - ⭐ 840
   Peekaboo is a macOS CLI & optional MCP server that enables AI agents to capture screenshots of applications, or the entire system, with optional visual question answering through local or remote AI models.

309. **[Pixelle-MCP](https://github.com/AIDC-AI/Pixelle-MCP)** - ⭐ 839
   An Open-Source Multimodal AIGC Solution based on ComfyUI + MCP + LLM  https://pixelle.ai

310. **[tools](https://github.com/strands-agents/tools)** - ⭐ 838
   A set of tools that gives agents powerful capabilities.

311. **[agentic-radar](https://github.com/splx-ai/agentic-radar)** - ⭐ 838
   A security scanner for your LLM agentic workflows

312. **[mcp-windbg](https://github.com/svnscha/mcp-windbg)** - ⭐ 837
   Model Context Protocol for WinDBG

313. **[mcpm.sh](https://github.com/pathintegral-institute/mcpm.sh)** - ⭐ 835
   CLI MCP package manager & registry for all platforms and all clients. Search & configure MCP servers. Advanced Router & Profile features.

314. **[hyper-mcp](https://github.com/tuananh/hyper-mcp)** - ⭐ 831
...
316. **[scira-mcp-chat](https://github.com/zaidmukaddam/scira-mcp-chat)** - ⭐ 818
   A minimalistic MCP client with a good feature set.

317. **[gitlab-mcp](https://github.com/zereight/gitlab-mcp)** - ⭐ 818
   First gitlab mcp for you

318. **[supabase-mcp-server](https://github.com/alexander-zuev/supabase-mcp-server)** - ⭐ 815
   Query MCP enables end-to-end management of Supabase via chat interface: read & write query executions, management API support, automatic migration versioning, access to logs and much more.

319. **[jupyter-mcp-server](https://github.com/datalayer/jupyter-mcp-server)** - ⭐ 814
   🪐 ✨ Model Context Protocol (MCP) Server for Jupyter.

320. **[trustgraph](https://github.com/trustgraph-ai/trustgraph)** - ⭐ 814
   Eliminate hallucinations from your AI agents.

321. **[memory-bank-mcp](https://github.com/alioshr/memory-bank-mcp)** - ⭐ 808
   A Model Context Protocol (MCP) server implementation for remote memory bank management, inspired by Cline Memory Bank.

322. **[google-calendar-mcp](https://github.com/nspady/google-calendar-mcp)** - ⭐ 806
   MCP integration for Google Calendar to manage events.

323. **[golf](https://github.com/golf-mcp/golf)** - ⭐ 803
   Production-Ready MCP Server Framework • Build, deploy & scale secure AI agent infrastructure • Includes Auth, Observability, Debugger, Telemetry & Runtime • Run real-world MCPs powering AI Agents 

324. **[OpenDerisk](https://github.com/derisk-ai/OpenDerisk)** - ⭐ 801
...
326. **[toolfront](https://github.com/statespace-tech/toolfront)** - ⭐ 799
   Turn your data into shareable RAG apps in minutes. All in pure Markdown. Zero boilerplate.

327. **[yokai](https://github.com/ankorstore/yokai)** - ⭐ 796
   Simple, modular, and observable Go framework for backend applications.

328. **[context-space](https://github.com/context-space/context-space)** - ⭐ 793
   Ultimate Context Engineering Infrastructure, starting from MCPs and Integrations

329. **[ai-dev-tools-zoomcamp](https://github.com/DataTalksClub/ai-dev-tools-zoomcamp)** - ⭐ 791
...
330. **[jadx-ai-mcp](https://github.com/zinja-coder/jadx-ai-mcp)** - ⭐ 789
   Plugin for JADX to integrate MCP server

331. **[wassette](https://github.com/microsoft/wassette)** - ⭐ 788
   Wassette: A security-oriented runtime that runs WebAssembly Components via MCP

332. **[agents](https://github.com/inkeep/agents)** - ⭐ 788
   Create AI Agents in a No-Code Visual Builder or TypeScript SDK with full 2-way sync. For shipping AI assistants and multi-agent AI workflows.

333. **[browser-use-mcp-server](https://github.com/kontext-dev/browser-use-mcp-server)** - ⭐ 784
   Browse the web, directly from Cursor etc.

334. **[MCP-Security-Checklist](https://github.com/slowmist/MCP-Security-Checklist)** - ⭐ 782
   A comprehensive security checklist for MCP-based AI tools. Built by SlowMist to safeguard LLM plugin ecosystems.

335. **[server](https://github.com/php-mcp/server)** - ⭐ 782
   Core PHP implementation for the Model Context Protocol (MCP) server

336. **[zotero-mcp](https://github.com/54yyyu/zotero-mcp)** - ⭐ 781
   Zotero MCP: Connects your Zotero research library with Claude and other AI assistants via the Model Context Protocol to discuss papers, get summaries, analyze citations, and more.

337. **[DeepMCPAgent](https://github.com/cryxnet/DeepMCPAgent)** - ⭐ 776
   Model-agnostic plug-n-play LangChain/LangGraph agents powered entirely by MCP tools over HTTP/SSE.

338. **[openapi-servers](https://github.com/open-webui/openapi-servers)** - ⭐ 775
...
341. **[trpc-agent-go](https://github.com/trpc-group/trpc-agent-go)** - ⭐ 751
...
343. **[vibetest-use](https://github.com/browser-use/vibetest-use)** - ⭐ 743
   Vibetest MCP - automated QA testing using Browser-Use agents

344. **[kubectl-mcp-server](https://github.com/rohitg00/kubectl-mcp-server)** - ⭐ 742
   Chat with your Kubernetes Cluster using AI tools and IDEs like Claude and Cursor!

345. **[mcp-knowledge-graph](https://github.com/shaneholloman/mcp-knowledge-graph)** - ⭐ 742
...
349. **[k8m](https://github.com/weibaohui/k8m)** - ⭐ 726
   一款轻量级、跨平台的 Mini Kubernetes AI Dashboard，支持大模型+智能体+MCP(支持设置操作权限)，集成多集群管理、智能分析、实时异常检测等功能，支持多架构并可单文件部署，助力高效集群管理与运维优化。

350. **[agent-kit](https://github.com/inngest/agent-kit)** - ⭐ 723
   AgentKit: Build multi-agent networks in TypeScript with deterministic routing and rich tooling via MCP.

351. **[qgis_mcp](https://github.com/jjsantos01/qgis_mcp)** - ⭐ 717
   Model Context Protocol (MCP) that allows LLMs to use QGIS Desktop

352. **[heurist-agent-framework](https://github.com/heurist-network/heurist-agent-framework)** - ⭐ 715
   A flexible multi-interface AI agent framework for building agents with reasoning, tool use, memory, deep research, blockchain interaction, MCP, and agents-as-a-service.

353. **[mcp-server](https://github.com/financial-datasets/mcp-server)** - ⭐ 715
   An MCP server for interacting with the Financial Datasets stock market API.

354. **[acemcp](https://github.com/qy527145/acemcp)** - ⭐ 713
   一个将ACE(Augment Context Engine) 做成MCP的项目

355. **[passage-of-time-mcp](https://github.com/jlumbroso/passage-of-time-mcp)** - ⭐ 708
...
356. **[excel-mcp-server](https://github.com/negokaz/excel-mcp-server)** - ⭐ 706
...
359. **[wordpress-mcp](https://github.com/Automattic/wordpress-mcp)** - ⭐ 694
...
360. **[just-prompt](https://github.com/disler/just-prompt)** - ⭐ 686
...
367. **[apple-docs-mcp](https://github.com/kimsungwhee/apple-docs-mcp)** - ⭐ 664
...
370. **[todo-for-ai](https://github.com/todo-for-ai/todo-for-ai)** - ⭐ 660
...
373. **[go-mcp](https://github.com/ThinkInAIXYZ/go-mcp)** - ⭐ 655
...
374. **[yacy_grid_mcp](https://github.com/yacy/yacy_grid_mcp)** - ⭐ 655
...
380. **[octocode-mcp](https://github.com/bgauryy/octocode-mcp)** - ⭐ 642
   MCP server for semantic code research and context generation on real-time using LLM patterns | Search naturally across public & private repos based on your permissions | Transform any accessible codebase/s into AI-optimized knowledge on simple and complex flows | Find real implementations and live docs from anywhere

381. **[linkedin-mcp-server](https://github.com/stickerdaniel/linkedin-mcp-server)** - ⭐ 638
...
382. **[laravel-restify](https://github.com/BinarCode/laravel-restify)** - ⭐ 637
   Laravel API for Ai Agents and humans.

383. **[claude-code-plugins-plus](https://github.com/jeremylongshore/claude-code-plugins-plus)** - ⭐ 636
...
384. **[llm-search](https://github.com/snexus/llm-search)** - ⭐ 635
   Querying local documents, powered by LLM

385. **[llm-server-docs](https://github.com/varunvasudeva1/llm-server-docs)** - ⭐ 634
   End-to-end documentation to set up your own local & fully private LLM server on Debian. Equipped with chat, web search, RAG, model management, MCP servers, image generation, and TTS.

386. **[python-utcp](https://github.com/universal-tool-calling-protocol/python-utcp)** - ⭐ 631
   Official python implementation of UTCP. UTCP is an open standard that lets AI agents call any API directly, without extra middleware.

387. **[enrichmcp](https://github.com/featureform/enrichmcp)** - ⭐ 630
   EnrichMCP is a python framework for building data driven MCP servers

388. **[apify-mcp-server](https://github.com/apify/apify-mcp-server)** - ⭐ 630
   The Apify MCP server enables your AI agents to extract data from social media, search engines, maps, e-commerce sites, or any other website using thousands of ready-made scrapers, crawlers, and automation tools available on the Apify Store.

389. **[wcgw](https://github.com/rusiaaman/wcgw)** - ⭐ 627
   Shell and coding agent on claude desktop app

390. **[mcp-mem0](https://github.com/coleam00/mcp-mem0)** - ⭐ 617
   MCP server for long term agent memory with Mem0. Also useful as a template to get you started building your own MCP server with Python!

391. **[android-mcp-server](https://github.com/minhalvp/android-mcp-server)** - ⭐ 615
...
394. **[workers-mcp](https://github.com/cloudflare/workers-mcp)** - ⭐ 609
...
397. **[awesome-mcp-security](https://github.com/Puliczek/awesome-mcp-security)** - ⭐ 604
   🔥🔒 Awesome MCP (Model Context Protocol) Security 🖥️

398. **[code-index-mcp](https://github.com/johnhuang316/code-index-mcp)** - ⭐ 600
   A Model Context Protocol (MCP) server that helps large language models index, search, and analyze code repositories with minimal setup

399. **[mcp](https://github.com/laravel/mcp)** - ⭐ 593
...
404. **[mem-agent-mcp](https://github.com/firstbatchxyz/mem-agent-mcp)** - ⭐ 582
   mem-agent mcp server

405. **[Claude-Code-Everything-You-Need-to-Know](https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know)** - ⭐ 582
   The ultimate all-in-one guide to mastering Claude Code. From setup, prompt engineering, commands, hooks, workflows, automation, and integrations, to MCP servers, tools, and the BMAD method—packed with step-by-step tutorials, real-world examples, and expert strategies to make this the global go-to repo for Claude mastery.

406. **[mcp-link](https://github.com/automation-ai-labs/mcp-link)** - ⭐ 581
   Convert Any OpenAPI V3 API to MCP Server

407. **[FLUJO](https://github.com/mario-andreschak/FLUJO)** - ⭐ 580
   MCP-Hub and -Inspector, Multi-Model Workflow and Chat Interface 

408. **[vibe](https://github.com/mondaycom/vibe)** - ⭐ 580
   🎨 Vibe Design System - Official monday.com UI resources for application development in React.js

409. **[Unity-MCP](https://github.com/IvanMurzak/Unity-MCP)** - ⭐ 578
   AI-powered bridge connecting LLMs and advanced AI agents to the Unity Editor via the Model Context Protocol (MCP). Chat with AI to generate code, debug errors, and automate game development tasks directly within your project.

410. **[daydreams](https://github.com/daydreamsai/daydreams)** - ⭐ 577
   Daydreams is a set of tools for building agents for commerce

411. **[open-ptc-agent](https://github.com/Chen-zexi/open-ptc-agent)** - ⭐ 576
   An open source implementation of code execution with MCP (Programatic Tool Calling) 

412. **[tome](https://github.com/runebookai/tome)** - ⭐ 574
   a magical LLM desktop client that makes it easy for *anyone* to use LLMs and MCP

413. **[langgraph-mcp](https://github.com/esxr/langgraph-mcp)** - ⭐ 567
   LangGraph solution template for MCP

414. **[dexto](https://github.com/truffle-ai/dexto)** - ⭐ 567
...
415. **[mcp-server-elasticsearch](https://github.com/elastic/mcp-server-elasticsearch)** - ⭐ 563

416. **[yargi-mcp](https://github.com/saidsurucu/yargi-mcp)** - ⭐ 562
   MCP Server For Turkish Legal Databases

417. **[mcp-filesystem-server](https://github.com/mark3labs/mcp-filesystem-server)** - ⭐ 560
   Go server implementing Model Context Protocol (MCP) for filesystem operations.

418. **[gcloud-mcp](https://github.com/googleapis/gcloud-mcp)** - ⭐ 557
   gcloud MCP server

419. **[mcp-google-sheets](https://github.com/xing5/mcp-google-sheets)** - ⭐ 554
   This MCP server integrates with your Google Drive and Google Sheets, to enable creating and modifying spreadsheets.

420. **[samples](https://github.com/strands-agents/samples)** - ⭐ 552
...
422. **[spotify-mcp](https://github.com/varunneal/spotify-mcp)** - ⭐ 543
   MCP to connect your LLM with Spotify.

423. **[mcp-shield](https://github.com/riseandignite/mcp-shield)** - ⭐ 537
   Security scanner for MCP servers

424. **[mcp-sequentialthinking-tools](https://github.com/spences10/mcp-sequentialthinking-tools)** - ⭐ 536
   🧠 An adaptation of the MCP Sequential Thinking Server to guide tool usage. This server provides recommendations for which MCP tools would be most effective at each stage.

425. **[MCP-Nest](https://github.com/rekog-labs/MCP-Nest)** - ⭐ 532
   A NestJS module to effortlessly create Model Context Protocol (MCP) servers for exposing AI tools, resources, and prompts.

426. **[vite-plugin-vue-mcp](https://github.com/webfansplz/vite-plugin-vue-mcp)** - ⭐ 530
   Vite plugin that enables a MCP server helping models to understand your Vue app better.

427. **[pg-mcp-server](https://github.com/stuzero/pg-mcp-server)** - ⭐ 529

428. **[mem0-mcp](https://github.com/mem0ai/mem0-mcp)** - ⭐ 529
...
431. **[evo-ai](https://github.com/EvolutionAPI/evo-ai)** - ⭐ 524
   Evo AI is an open-source platform for creating and managing AI agents, enabling integration with different AI models and services.

432. **[manim-mcp-server](https://github.com/abhiemj/manim-mcp-server)** - ⭐ 524

433. **[fastapi-mcp-langgraph-template](https://github.com/NicholasGoh/fastapi-mcp-langgraph-template)** - ⭐ 524
   A modern template for agentic orchestration — built for rapid iteration and scalable deployment using highly customizable, community-supported tools like MCP, LangGraph, and more.

434. **[MCP-Universe](https://github.com/SalesforceAIResearch/MCP-Universe)** - ⭐ 520
   MCP-Universe is a comprehensive framework designed for developing, testing, and benchmarking AI agents

435. **[mcp-handler](https://github.com/vercel/mcp-handler)** - ⭐ 512
   Easily spin up an MCP Server on Next.js, Nuxt, Svelte, and more

436. **[wren-engine](https://github.com/Canner/wren-engine)** - ⭐ 512
   🤖 The Semantic Engine for Model Context Protocol(MCP) Clients and AI Agents 🔥 

437. **[pgmcp](https://github.com/subnetmarco/pgmcp)** - ⭐ 512
   An MCP server to query any Postgres database in natural language.

438. **[mcp-server-data-exploration](https://github.com/reading-plus-ai/mcp-server-data-exploration)** - ⭐ 512

439. **[multimodal-agents-course](https://github.com/multi-modal-ai/multimodal-agents-course)** - ⭐ 508
   An MCP Multimodal AI Agent with eyes and ears!

440. **[google-search](https://github.com/web-agent-master/google-search)** - ⭐ 507
   A Playwright-based Node.js tool that bypasses search engine anti-scraping mechanisms to execute Google searches. Local alternative to SERP APIs with MCP server integration.

441. **[ethora](https://github.com/dappros/ethora)** - ⭐ 506
...
442. **[Awesome-MCP-Servers](https://github.com/YuzeHao2023/Awesome-MCP-Servers)** - ⭐ 505
   A curated list of Model Context Protocol (MCP) servers 

443. **[a-share-mcp-is-just-i-need](https://github.com/24mlight/a-share-mcp-is-just-i-need)** - ⭐ 504
...
446. **[mcp.el](https://github.com/lizqwerscott/mcp.el)** - ⭐ 503
   An Mcp client inside Emacs

447. **[macos-automator-mcp](https://github.com/steipete/macos-automator-mcp)** - ⭐ 502
   An MCP server to run AppleScript and JXA (JavaScript for Automation) to macOS.

448. **[mcp-for-security](https://github.com/cyproxio/mcp-for-security)** - ⭐ 502
   MCP for Security: A collection of Model Context Protocol servers for popular security tools like SQLMap, FFUF, NMAP, Masscan and more. Integrate security testing and penetration testing into AI workflows.

449. **[ghostcrew](https://github.com/GH05TCREW/ghostcrew)** - ⭐ 502
...
450. **[obot](https://github.com/obot-platform/obot)** - ⭐ 501
   Enterprise MCP Platform

451. **[iterm-mcp](https://github.com/ferrislucas/iterm-mcp)** - ⭐ 499
   A Model Context Protocol server that executes commands in the current iTerm session - useful for REPL and CLI assistance

452. **[mcporter](https://github.com/steipete/mcporter)** - ⭐ 499
   Call MCPs via TypeScript, masquerading as simple TypeScript API. Or package them as cli.

453. **[mcp-server-bash-sdk](https://github.com/muthuishere/mcp-server-bash-sdk)** - ⭐ 498
   Yes Mcp server in bash

454. **[mcp-get](https://github.com/michaellatman/mcp-get)** - ⭐ 497

455. **[ida-mcp-server](https://github.com/MxIris-Reverse-Engineering/ida-mcp-server)** - ⭐ 496
   A Model Context Protocol server for IDA

456. **[homeassistant-mcp](https://github.com/tevonsb/homeassistant-mcp)** - ⭐ 496
   A MCP server for Home Assistant

457. **[apple-health-mcp](https://github.com/neiltron/apple-health-mcp)** - ⭐ 494
...
459. **[mcp_excalidraw](https://github.com/yctimlin/mcp_excalidraw)** - ⭐ 492

460. **[mcp-server-weread](https://github.com/freestylefly/mcp-server-weread)** - ⭐ 491
   微信读书MCP

461. **[LLMTornado](https://github.com/lofcz/LLMTornado)** - ⭐ 490
...
463. **[web-agent-protocol](https://github.com/OTA-Tech-AI/web-agent-protocol)** - ⭐ 486
   🌐Web Agent Protocol (WAP) - Record and replay user interactions in the browser with MCP support

464. **[paper-search-mcp](https://github.com/openags/paper-search-mcp)** - ⭐ 485
   A MCP for searching and downloading academic papers from multiple sources like arXiv, PubMed, bioRxiv, etc.

465. **[cloud-run-mcp](https://github.com/GoogleCloudPlatform/cloud-run-mcp)** - ⭐ 483
   MCP server to deploy apps to Cloud Run

466. **[awesome-a2a](https://github.com/ai-boost/awesome-a2a)** - ⭐ 482
   Agent2Agent (A2A) – awesome A2A agents, tools, servers & clients, all in one place.

467. **[playwriter](https://github.com/remorses/playwriter)** - ⭐ 482
   The better playwright MCP: works as a browser extension. No context bloat. More capable.

468. **[UnityMCP](https://github.com/Arodoid/UnityMCP)** - ⭐ 481

469. **[openapi-mcp-generator](https://github.com/harsha-iiiv/openapi-mcp-generator)** - ⭐ 481
   A tool that converts OpenAPI specifications to MCP server

470. **[telegram-mcp](https://github.com/chigwell/telegram-mcp)** - ⭐ 480

471. **[MCPSpy](https://github.com/alex-ilgayev/MCPSpy)** - ⭐ 479
   MCP Monitoring with eBPF

472. **[douyin-mcp-server](https://github.com/yzfly/douyin-mcp-server)** - ⭐ 479
   提取抖音无水印视频链接，视频文案，douyin-mcp-server

473. **[mcp-youtube](https://github.com/anaisbetts/mcp-youtube)** - ⭐ 475
...
476. **[obsidian-mcp-tools](https://github.com/jacksteamdev/obsidian-mcp-tools)** - ⭐ 474
...
479. **[sentry-mcp](https://github.com/getsentry/sentry-mcp)** - ⭐ 470
...
484. **[clickup-mcp-server](https://github.com/taazkareem/clickup-mcp-server)** - ⭐ 462
...
487. **[echokit_server](https://github.com/second-state/echokit_server)** - ⭐ 461
...
489. **[next-devtools-mcp](https://github.com/vercel/next-devtools-mcp)** - ⭐ 459
   Next.js Development for Coding Agent

490. **[UnrealMCP](https://github.com/kvick-games/UnrealMCP)** - ⭐ 453
   MCP to allow AI agents to control Unreal

491. **[atlas-mcp-server](https://github.com/cyanheads/atlas-mcp-server)** - ⭐ 452
   A Model Context Protocol (MCP) server for ATLAS, a Neo4j-powered task management system for LLM Agents - implementing a three-tier architecture (Projects, Tasks, Knowledge) to manage complex workflows. Now with Deep Research.

492. **[drawio-mcp-server](https://github.com/lgazo/drawio-mcp-server)** - ⭐ 452
   Draw.io Model Context Protocol (MCP) Server

493. **[copilot-mcp](https://github.com/VikashLoomba/copilot-mcp)** - ⭐ 450
...
494. **[rails-mcp-server](https://github.com/maquina-app/rails-mcp-server)** - ⭐ 449
   A Ruby gem implementation of a Model Context Protocol (MCP) server for Rails projects. This server allows LLMs (Large Language Models) to interact with Rails projects through the Model Context Protocol.

495. **[cli](https://github.com/smithery-ai/cli)** - ⭐ 447
   Install, manage and develop MCP servers

496. **[argo](https://github.com/xark-argo/argo)** - ⭐ 442
   ARGO is an open-source AI Agent platform that brings Local Manus to your desktop. With one-click model downloads, seamless closed LLM integration, and offline-first RAG knowledge bases, ARGO becomes a DeepResearch powerhouse for autonomous thinking, task planning, and 100% of your data stays locally. Support Win/Mac/Docker.

497. **[chroma-mcp](https://github.com/chroma-core/chroma-mcp)** - ⭐ 442
   A Model Context Protocol (MCP) server implementation that provides database capabilities for Chroma

498. **[n8n-workflow-builder](https://github.com/makafeli/n8n-workflow-builder)** - ⭐ 440
   AI assistant integration for n8n workflow automation through Model Context Protocol (MCP). Connect Claude Desktop, ChatGPT, and other AI assistants to n8n for natural language workflow management.

499. **[llm-mcp-rag](https://github.com/KelvinQiu802/llm-mcp-rag)** - ⭐ 438
   LLM + MCP + RAG = Magic

500. **[docker-mcp](https://github.com/QuantGeekDev/docker-mcp)** - ⭐ 435
   A docker MCP Server (modelcontextprotocol)

501. **[director](https://github.com/director-run/director)** - ⭐ 434
   MCP Playbooks for AI agents

502. **[mcpe](https://github.com/ReMinecraftPE/mcpe)** - ⭐ 434
...
504. **[davinci-resolve-mcp](https://github.com/samuelgursky/davinci-resolve-mcp)** - ⭐ 431
   MCP server integration for DaVinci Resolve

505. **[nexus](https://github.com/grafbase/nexus)** - ⭐ 430
   Govern & Secure your AI

506. **[adb-mcp](https://github.com/mikechambers/adb-mcp)** - ⭐ 428

507. **[mcp-remote-macos-use](https://github.com/baryhuang/mcp-remote-macos-use)** - ⭐ 425
...
510. **[borsa-mcp](https://github.com/saidsurucu/borsa-mcp)** - ⭐ 419
...
512. **[MCP-Zero](https://github.com/xfey/MCP-Zero)** - ⭐ 418
   MCP-Zero: Active Tool Discovery for Autonomous LLM Agents

513. **[minecraft-mcp-server](https://github.com/yuniko-software/minecraft-mcp-server)** - ⭐ 416
   A Minecraft MCP Server powered by Mineflayer API. It allows to control a Minecraft character in real-time, allowing AI assistants to build structures, explore the world, and interact with the game environment through natural language instruction

514. **[kratos-transport](https://github.com/tx7do/kratos-transport)** - ⭐ 414
   kratos transport layer extension, support: rabbitmq,kafka,rocketmq,activemq,apollo,mcp,tcp,websocket...

515. **[mcpstore](https://github.com/whillhill/mcpstore)** - ⭐ 414
   开盒即用的优雅管理mcp服务 | 结合Agent框架 | 作者听劝 | 已发布pypi | Vue页面demo 

516. **[mcp-security](https://github.com/google/mcp-security)** - ⭐ 414

517. **[mcpadapt](https://github.com/grll/mcpadapt)** - ⭐ 413
   Unlock 650+ MCP servers tools in your favorite agentic framework.

518. **[vibe-check-mcp-server](https://github.com/PV-Bhat/vibe-check-mcp-server)** - ⭐ 412
...
523. **[brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server)** - ⭐ 404

524. **[xhs-mcp](https://github.com/jobsonlook/xhs-mcp)** - ⭐ 402
   小红书MCP服务 x-s x-t js逆向

525. **[learn-low-code-agentic-ai](https://github.com/panaversity/learn-low-code-agentic-ai)** - ⭐ 400
...
526. **[RestClient.Net](https://github.com/MelbourneDeveloper/RestClient.Net)** - ⭐ 400
   The safest way to make REST calls in C# with an MCP Generator

527. **[shinkai-local-ai-agents](https://github.com/dcSpark/shinkai-local-ai-agents)** - ⭐ 400
...
528. **[mcp-cli](https://github.com/wong2/mcp-cli)** - ⭐ 397
   A CLI inspector for the Model Context Protocol

529. **[freecad-mcp](https://github.com/neka-nat/freecad-mcp)** - ⭐ 396
   FreeCAD MCP(Model Context Protocol) server

530. **[mcp-server](https://github.com/PortSwigger/mcp-server)** - ⭐ 396
   MCP Server for Burp

531. **[mcp-hub](https://github.com/ravitemer/mcp-hub)** - ⭐ 395
   A centralized manager for Model Context Protocol (MCP) servers with dynamic server management and monitoring

532. **[alpaca-mcp-server](https://github.com/alpacahq/alpaca-mcp-server)** - ⭐ 394
...
534. **[tsidp](https://github.com/tailscale/tsidp)** - ⭐ 391
...
536. **[web-search-mcp](https://github.com/mrkrsl/web-search-mcp)** - ⭐ 389
   A simple, locally hosted Web Search MCP server for use with Local LLMs

537. **[Godot-MCP](https://github.com/ee0pdt/Godot-MCP)** - ⭐ 388
   An MCP for Godot that lets you create and edit games in the Godot game engine with tools like Claude

538. **[MCP-Kali-Server](https://github.com/Wh0am123/MCP-Kali-Server)** - ⭐ 388
   MCP configuration to connect AI agent to a Linux machine.

539. **[kmcp](https://github.com/kagent-dev/kmcp)** - ⭐ 387
   CLI tool and Kubernetes Controller for building, testing and deploying MCP servers

540. **[AgentX](https://github.com/lucky-aeon/AgentX)** - ⭐ 385
...
542. **[MetasploitMCP](https://github.com/GH05TCREW/MetasploitMCP)** - ⭐ 382
   MCP Server for Metasploit

543. **[NetCoreKevin](https://github.com/junkai-li/NetCoreKevin)** - ⭐ 382
...
544. **[mcp-gateway](https://github.com/microsoft/mcp-gateway)** - ⭐ 381
   MCP Gateway is a reverse proxy and management layer for MCP servers, enabling scalable, session-aware stateful routing and lifecycle management of MCP servers in Kubernetes environments.

545. **[himarket](https://github.com/higress-group/himarket)** - ⭐ 381
...
552. **[GhidrAssistMCP](https://github.com/jtang613/GhidrAssistMCP)** - ⭐ 376
   An MCP extension for Ghidra

553. **[ai4j](https://github.com/LnYo-Cly/ai4j)** - ⭐ 374
...
554. **[mcp-hfspace](https://github.com/evalstate/mcp-hfspace)** - ⭐ 374
   MCP Server to Use HuggingFace spaces, easy configuration and Claude Desktop mode. 

555. **[memento-mcp](https://github.com/gannonh/memento-mcp)** - ⭐ 374
...
558. **[Anemoi](https://github.com/Coral-Protocol/Anemoi)** - ⭐ 370
   Anemoi: A Semi-Centralized Multi-agent Systems Based on Agent-to-Agent Communication MCP server from Coral Protocol

559. **[azure-ai-travel-agents](https://github.com/Azure-Samples/azure-ai-travel-agents)** - ⭐ 369
...
560. **[labs-ai-tools-for-devs](https://github.com/docker/labs-ai-tools-for-devs)** - ⭐ 369
   Your trusted home for discovering MCP tools – seamlessly integrated into Docker

561. **[mcp-registry](https://github.com/docker/mcp-registry)** - ⭐ 369
   Official Docker MCP registry 

562. **[MCP-SecurityTools](https://github.com/Ta0ing/MCP-SecurityTools)** - ⭐ 369
   MCP-SecurityTools 是一个专注于收录和更新网络安全领域 MCP 的开源项目，旨在汇总、整理和优化各类与 MCP 相关的安全工具、技术及实战经验。

563. **[mcp](https://github.com/baidu-maps/mcp)** - ⭐ 367
   Baidu Map MCP Server

564. **[graphlit-mcp-server](https://github.com/graphlit/graphlit-mcp-server)** - ⭐ 366
   Model Context Protocol (MCP) Server for Graphlit Platform

565. **[pdf-reader-mcp](https://github.com/SylphxAI/pdf-reader-mcp)** - ⭐ 366
...
568. **[bagel](https://github.com/Extelligence-ai/bagel)** - ⭐ 365
   Chat with your robotics, drone, and IoT data — ChatGPT for the physical world.

569. **[ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server)** - ⭐ 365
   A Model Context Protocol (MCP) server for interacting with Microsoft 365 and Office services through the Graph API

570. **[airtable-mcp-server](https://github.com/domdomegg/airtable-mcp-server)** - ⭐ 365
   🗂️🤖 Airtable Model Context Protocol Server, for allowing AI systems to interact with your Airtable bases

571. **[mcp-adapter](https://github.com/WordPress/mcp-adapter)** - ⭐ 365
   An MCP adapter that bridges the Abilities API to the Model Context Protocol, enabling MCP clients to discover and invoke WordPress plugin, theme, and core abilities programmatically.

572. **[mcp-nixos](https://github.com/utensils/mcp-nixos)** - ⭐ 362
   MCP-NixOS - Model Context Protocol Server for NixOS resources

573. **[mcp-sdk-php](https://github.com/logiscape/mcp-sdk-php)** - ⭐ 361
   Model Context Protocol SDK for PHP

574. **[mcp-searxng](https://github.com/ihor-sokoliuk/mcp-searxng)** - ⭐ 360
   MCP Server for SearXNG

575. **[mcp-redis](https://github.com/redis/mcp-redis)** - ⭐ 358
   The official Redis MCP Server is a natural language interface designed for agentic applications to manage and search data in Redis efficiently

576. **[station](https://github.com/cloudshipai/station)** - ⭐ 358
...
580. **[mcp-server-youtube-transcript](https://github.com/kimtaeyoon83/mcp-server-youtube-transcript)** - ⭐ 351
   This is an MCP server that allows you to directly download transcripts of YouTube videos.

581. **[yutu](https://github.com/eat-pray-ai/yutu)** - ⭐ 351
   A fully functional MCP server and CLI for YouTube

582. **[MCPSharp](https://github.com/afrise/MCPSharp)** - ⭐ 350
   MCPSharp is a .NET library that helps you build Model Context Protocol (MCP) servers and clients - the standardized API protocol used by AI assistants and models.

583. **[agent-builder](https://github.com/strands-agents/agent-builder)** - ⭐ 348
...
587. **[tfmcp](https://github.com/nwiizo/tfmcp)** - ⭐ 346
   🌍 Terraform Model Context Protocol (MCP) Tool - An experimental CLI tool that enables AI assistants to manage and operate Terraform environments. Supports reading Terraform configurations, analyzing plans, applying configurations, and managing state with Claude Desktop integration. ⚡️

588. **[mcpmark](https://github.com/eval-sys/mcpmark)** - ⭐ 346
   MCPMark is a comprehensive, stress-testing MCP benchmark designed to evaluate model and agent capabilities in real-world MCP use.

589. **[automation-mcp](https://github.com/ashwwwin/automation-mcp)** - ⭐ 346
   Control your Mac with detailed mouse, keyboard, screen, and window management capabilities.

590. **[mcp](https://github.com/mondaycom/mcp)** - ⭐ 346
   Enable AI agents to work reliably - giving them secure access to structured data, tools to take action, and the context needed to make smart decisions.

591. **[pokemon-chat](https://github.com/skygazer42/pokemon-chat)** - ⭐ 345
   基于 LightRAG、LangGraph、MCP、RagFlow、微调LLMs宝可梦主题的专有领域智能聊天助手

592. **[kicad-mcp](https://github.com/lamaalrajih/kicad-mcp)** - ⭐ 345
   Model Context Protocol server for KiCad on Mac, Windows, and Linux

593. **[mcpr](https://github.com/conikeec/mcpr)** - ⭐ 344
   Model Context Protocol (MCP) implementation in Rust

594. **[archestra](https://github.com/archestra-ai/archestra)** - ⭐ 344
...
596. **[mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry)** - ⭐ 343
...
597. **[ableton-live-mcp-server](https://github.com/Simon-Kansara/ableton-live-mcp-server)** - ⭐ 342
...
599. **[daan](https://github.com/pluveto/daan)** - ⭐ 339
   ✨Lightweight LLM Client with MCP 🔌 & Characters 👤

600. **[Redbook-Search-Comment-MCP2.0](https://github.com/chenningling/Redbook-Search-Comment-MCP2.0)** - ⭐ 339
...
603. **[awesome-cursor-mpc-server](https://github.com/kleneway/awesome-cursor-mpc-server)** - ⭐ 337
   Example of an MCP server with custom tools that can be called directly from cursor

604. **[lunar](https://github.com/TheLunarCompany/lunar)** - ⭐ 337
   lunar.dev: Ground Control for 3rd Party APIs

605. **[mcp-teams-server](https://github.com/InditexTech/mcp-teams-server)** - ⭐ 337
   An MCP (Model Context Protocol) server implementation for Microsoft Teams integration, providing capabilities to read messages, create messages, reply to messages, mention members.

606. **[MCP](https://github.com/jina-ai/MCP)** - ⭐ 337
   Official Jina AI Remote MCP Server

607. **[minion-agent](https://github.com/femto/minion-agent)** - ⭐ 336
   A simple agent framework that's capable of browser use + mcp + auto instrument + plan + deep  research + more

608. **[mcp-graphql](https://github.com/blurrah/mcp-graphql)** - ⭐ 336
   Model Context Protocol server for GraphQL

609. **[mcp-google-ads](https://github.com/cohnen/mcp-google-ads)** - ⭐ 336
   An MCP tool that connects Google Ads with Claude AI/Cursor and others, allowing you to analyze your advertising data through natural language conversations. This integration gives you access to campaign information, performance metrics, keyword analytics, and ad management—all through simple chat with Claude, Cursor or Windsurf.

610. **[paws-on-mcp](https://github.com/hemanth/paws-on-mcp)** - ⭐ 335
   A comprehensive Model Context Protocol (MCP) server implementing the latest specification.

611. **[devtools-debugger-mcp](https://github.com/ScriptedAlchemy/devtools-debugger-mcp)** - ⭐ 335
   An MCP server exposing full Chrome DevTools Protocol debugging: breakpoints, step/run, call stacks, eval, and source maps.

612. **[Construction-Hazard-Detection](https://github.com/yihong1120/Construction-Hazard-Detection)** - ⭐ 335
...
614. **[todoist-mcp-server](https://github.com/abhiz123/todoist-mcp-server)** - ⭐ 334
   MCP server for Todoist integration enabling natural language task management with Claude

615. **[xcode-mcp-server](https://github.com/r-huijts/xcode-mcp-server)** - ⭐ 334
   MCP Server implementation for Xcode integration

616. **[a2a-directory](https://github.com/sing1ee/a2a-directory)** - ⭐ 332
   Agent2Agent (A2A) – AgentCards, Servers, Clients, Docs

617. **[prism-insight](https://github.com/dragon1086/prism-insight)** - ⭐ 332
   AI-based stock analysis and trading system

618. **[docfork-mcp](https://github.com/docfork/docfork-mcp)** - ⭐ 331
   Up-to-date documentation for devs and AI agents.

619. **[UnrealGenAISupport](https://github.com/prajwalshettydev/UnrealGenAISupport)** - ⭐ 330
...
620. **[twitter-mcp](https://github.com/EnesCinr/twitter-mcp)** - ⭐ 329
   A Model Context Protocol server allows to interact with Twitter, enabling posting tweets and searching Twitter.

621. **[base-mcp](https://github.com/base/base-mcp)** - ⭐ 329
   A Model Context Protocol (MCP) server that provides onchain tools for LLMs, allowing them to interact with the Base network and Coinbase API.

622. **[f2c-mcp](https://github.com/f2c-ai/f2c-mcp)** - ⭐ 329
   F2C MCP Server

623. **[mcp-mermaid](https://github.com/hustcc/mcp-mermaid)** - ⭐ 328
...
626. **[WebMCP](https://github.com/jasonjmcghee/WebMCP)** - ⭐ 326
...
628. **[interactive-mcp](https://github.com/ttommyth/interactive-mcp)** - ⭐ 324
   Vibe coding should have human in the loop! interactive-mcp: Local, cross-platform MCP server for interact with your AI Agent

629. **[hermes-mcp](https://github.com/cloudwalk/hermes-mcp)** - ⭐ 323
   Elixir Model Context Protocol (MCP) SDK

630. **[mcp-for-next.js](https://github.com/vercel-labs/mcp-for-next.js)** - ⭐ 321

631. **[MemoryMesh](https://github.com/CheMiguel23/MemoryMesh)** - ⭐ 320
...
633. **[Minecraft-Hack-BaseClient](https://github.com/OxideWaveLength/Minecraft-Hack-BaseClient)** - ⭐ 317
   This is a Minecraft Base Client

634. **[moling](https://github.com/gojue/moling)** - ⭐ 317
   MoLing is a computer-use and browser-use based MCP server. It is a locally deployed, dependency-free office AI assistant.

635. **[mcp-apple-notes](https://github.com/RafalWilinski/mcp-apple-notes)** - ⭐ 316
...
640. **[BloodHound-MCP-AI](https://github.com/MorDavid/BloodHound-MCP-AI)** - ⭐ 312
...
642. **[mcp-selenium](https://github.com/angiejones/mcp-selenium)** - ⭐ 311
   An MCP implementation for Selenium WebDriver

643. **[cocos-mcp-server](https://github.com/DaxianLee/cocos-mcp-server)** - ⭐ 311
...
645. **[nuwax](https://github.com/nuwax-ai/nuwax)** - ⭐ 310
...
649. **[mcp-reddit](https://github.com/adhikasp/mcp-reddit)** - ⭐ 309
   A Model Context Protocol (MCP) server that provides tools for fetching and analyzing Reddit content.

650. **[langconnect-client](https://github.com/teddynote-lab/langconnect-client)** - ⭐ 308
   A Modern GUI Interface for Vector Database Management(Supports MCP integration)

651. **[ClimateTraceKMP](https://github.com/joreilly/ClimateTraceKMP)** - ⭐ 306
   Kotlin/Compose Multiplatform project to show climate related emission data from https://climatetrace.org/data.

652. **[mcp-servers-hub](https://github.com/apappascs/mcp-servers-hub)** - ⭐ 304
   Discover the most comprehensive and up-to-date collection of MCP servers in the market. This repository serves as a centralized hub, offering an extensive catalog of open-source and proprietary MCP servers, complete with features, documentation links, and contributors.

653. **[lark-openapi-mcp](https://github.com/larksuite/lark-openapi-mcp)** - ⭐ 304
   飞书/Lark官方 OpenAPI MCP

654. **[revit-mcp](https://github.com/revit-mcp/revit-mcp)** - ⭐ 304
   AI-Powered Revit Modeling

655. **[agent](https://github.com/1mcp-app/agent)** - ⭐ 302
   A unified Model Context Protocol server implementation that aggregates multiple MCP servers into one.

656. **[automcp](https://github.com/NapthaAI/automcp)** - ⭐ 301
   Easily convert tool, agents and orchestrators from existing agent frameworks to MCP servers

657. **[obsidian-mcp-server](https://github.com/cyanheads/obsidian-mcp-server)** - ⭐ 301
   Obsidian Knowledge-Management MCP (Model Context Protocol) server that enables AI agents and development tools to interact with an Obsidian vault. It provides a comprehensive suite of tools for reading, writing, searching, and managing notes, tags, and frontmatter, acting as a bridge to the Obsidian Local REST API plugin.

658. **[codexia](https://github.com/milisp/codexia)** - ⭐ 301
...
660. **[mcp-sse](https://github.com/sidharthrajaram/mcp-sse)** - ⭐ 300
   A working pattern for SSE-based MCP clients and servers

661. **[Rube](https://github.com/ComposioHQ/Rube)** - ⭐ 297
...
662. **[investor-agent](https://github.com/ferdousbhai/investor-agent)** - ⭐ 296
   A Model Context Protocol server for building an investor agent

663. **[vscode-mcp-server](https://github.com/juehang/vscode-mcp-server)** - ⭐ 296
   MCP server to expose VS Code editing features to an LLM for AI coding

664. **[mcprouter](https://github.com/chatmcp/mcprouter)** - ⭐ 296
   api router for MCP Servers

665. **[abcoder](https://github.com/cloudwego/abcoder)** - ⭐ 295
   deep, reliable and confidential coding-context

666. **[code-sandbox-mcp](https://github.com/Automata-Labs-team/code-sandbox-mcp)** - ⭐ 295
   An MCP server to create secure code sandbox environment for executing code within Docker containers. This MCP server provides AI applications with a safe and isolated environment for running code while maintaining security through containerization.

667. **[gptr-mcp](https://github.com/assafelovic/gptr-mcp)** - ⭐ 294
   MCP server for enabling LLM applications to perform deep research via the MCP protocol

668. **[mcp-calculator](https://github.com/78/mcp-calculator)** - ⭐ 294
   Xiaozhi MCP sample program

669. **[mcp-server](https://github.com/mapbox/mcp-server)** - ⭐ 293
   Mapbox Model Context Protocol (MCP) server

670. **[chunkhound](https://github.com/chunkhound/chunkhound)** - ⭐ 293
   Deep Research for Code & Files

671. **[Ace-Mcp-Node](https://github.com/yeuxuan/Ace-Mcp-Node)** - ⭐ 292
...
672. **[sdk-typescript](https://github.com/strands-agents/sdk-typescript)** - ⭐ 291
   A model-driven approach to building AI agents in just a few lines of code. 
...
677. **[Feishu-MCP](https://github.com/cso1z/Feishu-MCP)** - ⭐ 288
   为 Cursor、Windsurf、Cline 和其他 AI 驱动的编码工具提供访问、编辑和结构化处理飞书文档的能力，基于 Model Context Protocol 服务器实现。

678. **[blender-mcp-vxai](https://github.com/VxASI/blender-mcp-vxai)** - ⭐ 287

679. **[llm-context.py](https://github.com/cyberchitta/llm-context.py)** - ⭐ 286
   Share code with LLMs via Model Context Protocol or clipboard. Rule-based customization enables easy switching between different tasks (like code review and documentation). Includes smart code outlining.

680. **[aws-mcp](https://github.com/RafalWilinski/aws-mcp)** - ⭐ 286
   Talk with your AWS using Claude. Model Context Protocol (MCP) server for AWS. Better Amazon Q alternative.

681. **[sonarqube-mcp-server](https://github.com/SonarSource/sonarqube-mcp-server)** - ⭐ 286
   SonarQube MCP Server

682. **[aider-mcp-server](https://github.com/disler/aider-mcp-server)** - ⭐ 285
   Minimal MCP Server for Aider

683. **[deepseek-mcp-server](https://github.com/DMontgomery40/deepseek-mcp-server)** - ⭐ 285
   Model Context Protocol server for DeepSeek's advanced language models

684. **[mcp-for-argocd](https://github.com/argoproj-labs/mcp-for-argocd)** - ⭐ 285
   An implementation of Model Context Protocol (MCP) server for Argo CD.

685. **[o3-search-mcp](https://github.com/yoshiko-pg/o3-search-mcp)** - ⭐ 285
...
690. **[reddit-mcp-buddy](https://github.com/karanb192/reddit-mcp-buddy)** - ⭐ 279
   Clean, LLM-optimized Reddit MCP server. Browse posts, search content, analyze users. No fluff, just Reddit data.

691. **[lets-learn-mcp-csharp](https://github.com/microsoft/lets-learn-mcp-csharp)** - ⭐ 278

692. **[remote-mcp-server-with-auth](https://github.com/coleam00/remote-mcp-server-with-auth)** - ⭐ 278
...
693. **[mcp-server-simulator-ios-idb](https://github.com/InditexTech/mcp-server-simulator-ios-idb)** - ⭐ 278
   A Model Context Protocol (MCP) server that enables LLMs to interact with iOS simulators through natural language commands.

694. **[mcpsvr](https://github.com/nanbingxyz/mcpsvr)** - ⭐ 277
   Discover Exceptional MCP Servers

695. **[ast-grep-mcp](https://github.com/ast-grep/ast-grep-mcp)** - ⭐ 276

696. **[utcp-specification](https://github.com/universal-tool-calling-protocol/utcp-specification)** - ⭐ 276
   The specification for the Universal Tool Calling Protocol

697. **[perplexity-mcp](https://github.com/jsonallen/perplexity-mcp)** - ⭐ 275
   A Model Context Protocol (MCP) server that provides web search functionality using Perplexity AI's API.

698. **[perplexity-mcp](https://github.com/DaInfernalCoder/perplexity-mcp)** - ⭐ 275
...
699. **[consult7](https://github.com/szeider/consult7)** - ⭐ 275
   MCP server to consult a language model with large context size

700. **[mcp-everything-search](https://github.com/mamertofabian/mcp-everything-search)** - ⭐ 275

701. **[mcp-server-mas-sequential-thinking](https://github.com/FradSer/mcp-server-mas-sequential-thinking)** - ⭐ 274
   An advanced sequential thinking process using a Multi-Agent System (MAS) built with the Agno framework and served via MCP.

702. **[mcp-manager](https://github.com/zueai/mcp-manager)** - ⭐ 273
   simple web ui to manage mcp (model context protocol) servers in the claude app

703. **[dify-mcp-server](https://github.com/YanxingLiu/dify-mcp-server)** - ⭐ 272
   Model Context Protocol (MCP) Server for dify workflows

704. **[generator](https://github.com/context-hub/generator)** - ⭐ 272
   CTX: a tool that solves the context management gap when working with LLMs like ChatGPT or Claude. It helps developers organize and automatically collect information from their codebase into structured documents that can be easily shared with AI assistants.

705. **[droidmind](https://github.com/hyperb1iss/droidmind)** - ⭐ 272
...
709. **[mcp-aktools](https://github.com/aahl/mcp-aktools)** - ⭐ 270
   📈 提供股票、加密货币的数据查询和分析功能MCP服务器

710. **[FileScopeMCP](https://github.com/admica/FileScopeMCP)** - ⭐ 270
   Analyzes your codebase identifying important files based on dependency relationships. Generates diagrams and importance scores per file, helping AI assistants understand the codebase. Automatically parses popular programming languages such as Python, C, C++, Rust, Zig, Lua.

711. **[minthcm](https://github.com/minthcm/minthcm)** - ⭐ 269
   First AI‑enabled open-source Human Capital Management system that you can start using today.

712. **[claude-modular](https://github.com/oxygen-fragment/claude-modular)** - ⭐ 269
   Production-ready modular Claude Code framework with 30+ commands, token optimization, and MCP server integration. Achieves 2-10x productivity gains through   systematic command organization and hierarchical configuration.

713. **[mcp-mongo-server](https://github.com/kiliczsh/mcp-mongo-server)** - ⭐ 268
   A Model Context Protocol Server for MongoDB

714. **[MCP-Server-Playwright](https://github.com/VikashLoomba/MCP-Server-Playwright)** - ⭐ 268
...
717. **[mcp-server-code-execution-mode](https://github.com/elusznik/mcp-server-code-execution-mode)** - ⭐ 268
   An MCP server that executes Python code in isolated rootless containers with optional MCP server proxying. Implementation of Anthropic's and Cloudflare's ideas for reducing MCP tool definitions context bloat.

718. **[cclsp](https://github.com/ktnyt/cclsp)** - ⭐ 267
...
720. **[agentcontrolplane](https://github.com/humanlayer/agentcontrolplane)** - ⭐ 265
...
721. **[mcp-reasoner](https://github.com/Jacck/mcp-reasoner)** - ⭐ 264
   A systematic reasoning MCP server implementation for Claude Desktop with beam search and thought evaluation.

722. **[tradingview-mcp](https://github.com/atilaahmettaner/tradingview-mcp)** - ⭐ 263
...
723. **[tinystruct](https://github.com/tinystruct/tinystruct)** - ⭐ 263
...
724. **[rhinomcp](https://github.com/jingcheng-chen/rhinomcp)** - ⭐ 263
...
726. **[mcp-database-server](https://github.com/executeautomation/mcp-database-server)** - ⭐ 262
...
728. **[metorial-index](https://github.com/metorial/metorial-index)** - ⭐ 261
   Metorial MCP Index - An ever growing list of open source MCP servers 📁 🎉

729. **[maverick-mcp](https://github.com/wshobson/maverick-mcp)** - ⭐ 260
   MaverickMCP - Personal Stock Analysis MCP Server

730. **[proximity](https://github.com/fr0gger/proximity)** - ⭐ 260
   Proximity is a MCP security scanner powered with NOVA

731. **[claude-talk-to-figma-mcp](https://github.com/arinspunk/claude-talk-to-figma-mcp)** - ⭐ 260
...
732. **[DeepWideResearch](https://github.com/PuppyAgent/DeepWideResearch)** - ⭐ 260
...
734. **[mcp-server-12306](https://github.com/drfccv/mcp-server-12306)** - ⭐ 258
   12306 MCP Server​​ 是一个基于 ​​Model Context Protocol (MCP)​​ 的高性能火车票查询后端系统。它通过标准化接口提供官方 12306 的实时数据服务，包括余票查询、车站信息、列车经停站、中转换乘方案等核心功能。

735. **[chrome-devtools-mcp](https://github.com/benjaminr/chrome-devtools-mcp)** - ⭐ 257
   An MCP Server for Chrome DevTools, following the Chrome DevTools Protocol. Integrates with Claude Desktop and Claude Code.

736. **[osp_marketing_tools](https://github.com/open-strategy-partners/osp_marketing_tools)** - ⭐ 257
   A Model Context Protocol (MCP) server that empowers LLMs to use some of Open Srategy Partners' core writing and product marketing techniques.

737. **[MCPControl](https://github.com/claude-did-this/MCPControl)** - ⭐ 256
   MCP server for Windows OS automation

738. **[mcp-server-apple-shortcuts](https://github.com/recursechat/mcp-server-apple-shortcuts)** - ⭐ 256

739. **[gemini-flow](https://github.com/clduab11/gemini-flow)** - ⭐ 256
   rUv's Claude-Flow, translated to the new Gemini CLI; transforming it into an autonomous AI development team.

740. **[mcp940](https://github.com/WangTingZheng/mcp940)** - ⭐ 255
   Source code of minecraft 1.12

741. **[admin](https://github.com/decocms/admin)** - ⭐ 253
   Define and compose secure MCPs in TypeScript. Generate AI workflows and agents with React + Tailwind UI. Deploy anywhere.

742. **[mesh](https://github.com/decocms/mesh)** - ⭐ 253
   Define and compose secure MCPs in TypeScript. Generate AI workflows and agents with React + Tailwind UI. Deploy anywhere.

743. **[mcp-documentation-server](https://github.com/andrea9293/mcp-documentation-server)** - ⭐ 252
...
746. **[obsidian-mcp](https://github.com/newtype-01/obsidian-mcp)** - ⭐ 248
...
749. **[project-nova](https://github.com/dujonwalker/project-nova)** - ⭐ 247
...
751. **[powerbi-modeling-mcp](https://github.com/microsoft/powerbi-modeling-mcp)** - ⭐ 246
...
754. **[agentscope-runtime](https://github.com/agentscope-ai/agentscope-runtime)** - ⭐ 245
   A Production-Ready Runtime Framework for Agent Deployment and Tool Sandbox

755. **[code-reasoning](https://github.com/mettamatt/code-reasoning)** - ⭐ 244
   A code reasoning MCP server, a fork of sequential-thinking

756. **[home-assistant-vibecode-agent](https://github.com/Coolver/home-assistant-vibecode-agent)** - ⭐ 244
...
757. **[hass-mcp](https://github.com/voska/hass-mcp)** - ⭐ 244
...
760. **[mcp-feedback-collector](https://github.com/sanshao85/mcp-feedback-collector)** - ⭐ 241
   一个现代化的 Model Context Protocol (MCP) 服务器，为AI助手提供交互式用户反馈收集功能。

761. **[mcp-server-gemini](https://github.com/aliargun/mcp-server-gemini)** - ⭐ 241
   MCP server implementation for Google's Gemini API

762. **[mcp-chatbot](https://github.com/3choff/mcp-chatbot)** - ⭐ 240
   A simple CLI chatbot that demonstrates the integration of the Model Context Protocol (MCP).

763. **[mcp-gdrive](https://github.com/isaacphi/mcp-gdrive)** - ⭐ 240
   Model Context Protocol (MCP) Server for reading from Google Drive and editing Google Sheets

764. **[mcp-odoo](https://github.com/tuanle96/mcp-odoo)** - ⭐ 240
   MCP Server for Odoo

765. **[cuga-agent](https://github.com/cuga-project/cuga-agent)** - ⭐ 239
...
767. **[mcp-server](https://github.com/strands-agents/mcp-server)** - ⭐ 238
...
771. **[skillz](https://github.com/intellectronica/skillz)** - ⭐ 236
   An MCP server for loading skills (shim for non-claude clients).

772. **[apollo-mcp-server](https://github.com/apollographql/apollo-mcp-server)** - ⭐ 235
   Apollo MCP Server

773. **[mcp-prompt-server](https://github.com/gdli6177/mcp-prompt-server)** - ⭐ 235
   这是一个基于Model Context Protocol (MCP)的服务器，用于根据用户任务需求提供预设的prompt模板，帮助Cline/Cursor/Windsurf...更高效地执行各种任务。服务器将预设的prompt作为工具(tools)返回，以便在Cursor和Windsurf等编辑器中更好地使用。

774. **[claude-code-mcpinstall](https://github.com/undeadpickle/claude-code-mcpinstall)** - ⭐ 234
   Easy guide to installing Claude Code MCPs globally on your machine.

775. **[NFTIAI](https://github.com/Axarb/NFTIAI)** - ⭐ 234
...
776. **[jadx-mcp-server](https://github.com/zinja-coder/jadx-mcp-server)** - ⭐ 234
   MCP server for JADX-AI Plugin

777. **[claude_code-gemini-mcp](https://github.com/RaiAnsar/claude_code-gemini-mcp)** - ⭐ 233
   Simplified Gemini for Claude Code. 

778. **[mcp-on-vercel](https://github.com/vercel-labs/mcp-on-vercel)** - ⭐ 232

779. **[Windows-MCP.Net](https://github.com/AIDotNet/Windows-MCP.Net)** - ⭐ 232
   A .NET-based Windows desktop automation MCP (Model Context Protocol) server that provides AI assistants with the ability to interact with the Windows desktop environment.

780. **[weather-mcp-server](https://github.com/ezh0v/weather-mcp-server)** - ⭐ 232
...
781. **[mcp-server-code-runner](https://github.com/formulahendry/mcp-server-code-runner)** - ⭐ 232
   Code Runner MCP Server

782. **[notebooklm-mcp](https://github.com/PleasePrompto/notebooklm-mcp)** - ⭐ 232
...
784. **[g-search-mcp](https://github.com/jae-jae/g-search-mcp)** - ⭐ 231
   A powerful MCP server for Google search that enables parallel searching with multiple keywords simultaneously.

785. **[mcp](https://github.com/salesforcecli/mcp)** - ⭐ 231
   MCP Server for interacting with Salesforce instances

786. **[firebase-mcp](https://github.com/gannonh/firebase-mcp)** - ⭐ 230
   🔥 Model Context Protocol (MCP) server for Firebase.

787. **[mcp2py](https://github.com/MaximeRivest/mcp2py)** - ⭐ 230
   Turn any MCP server into a Python module

788. **[Lambda-MCP-Server](https://github.com/mikegc-aws/Lambda-MCP-Server)** - ⭐ 230
   Creates a simple MCP tool server with "streaming" HTTP.

789. **[elasticsearch-mcp-server](https://github.com/cr7258/elasticsearch-mcp-server)** - ⭐ 229
   A Model Context Protocol (MCP) server implementation that provides Elasticsearch and OpenSearch interaction.

790. **[x64DbgMCPServer](https://github.com/AgentSmithers/x64DbgMCPServer)** - ⭐ 229
   x64DbgMCPServer made from c# with Claude, Windsurf and Cursor support

791. **[anytype-mcp](https://github.com/anyproto/anytype-mcp)** - ⭐ 229
   An MCP server enabling AI assistants to interact with Anytype - your encrypted, local and collaborative wiki - to organize objects, lists, and more through natural language.

792. **[MCPBench](https://github.com/modelscope/MCPBench)** - ⭐ 228
   The evaluation benchmark on MCP servers

793. **[human-mcp](https://github.com/mrgoonie/human-mcp)** - ⭐ 228

794. **[MCP-connect](https://github.com/EvalsOne/MCP-connect)** - ⭐ 227
   Enables cloud-based AI services to access local Stdio based MCP servers via HTTP requests

795. **[doris-mcp-server](https://github.com/apache/doris-mcp-server)** - ⭐ 227
   Apache Doris MCP Server

796. **[cobolt](https://github.com/platinum-hill/cobolt)** - ⭐ 226
...
797. **[mcp-foundry](https://github.com/azure-ai-foundry/mcp-foundry)** - ⭐ 226
   A MCP Server for Azure AI Foundry: it's now moved to cloud, check the new Foundry MCP Server

798. **[enterprise-mcp-course](https://github.com/decodingai-magazine/enterprise-mcp-course)** - ⭐ 226
...
799. **[mcp_chatbot](https://github.com/keli-wen/mcp_chatbot)** - ⭐ 224
   A chatbot implementation compatible with MCP (terminal / streamlit supported)

800. **[rust-docs-mcp-server](https://github.com/Govcraft/rust-docs-mcp-server)** - ⭐ 224
   🦀 Prevents outdated Rust code suggestions from AI assistants. This MCP server fetches current crate docs, uses embeddings/LLMs, and provides accurate context via a tool call.

801. **[mcp_massive](https://github.com/massive-com/mcp_massive)** - ⭐ 224
...
803. **[sample-serverless-mcp-servers](https://github.com/aws-samples/sample-serverless-mcp-servers)** - ⭐ 223
   Sample implementations of AI Agents and MCP Servers running on AWS Serverless compute

804. **[mcp_flutter](https://github.com/Arenukvern/mcp_flutter)** - ⭐ 223
   MCP server and MCP Toolkit  for Flutter and Dart VM - supports dynamic tooling

805. **[foundry-mcp-server](https://github.com/PraneshASP/foundry-mcp-server)** - ⭐ 222
   An experimental MCP Server for foundry built for Solidity devs

806. **[langgraph-whatsapp-agent](https://github.com/lgesuellip/langgraph-whatsapp-agent)** - ⭐ 220
...
807. **[xiaozhi-client](https://github.com/shenjingnan/xiaozhi-client)** - ⭐ 220
   小智AI客户端，目前主要用于MCP的对接

808. **[llamacloud-mcp](https://github.com/run-llama/llamacloud-mcp)** - ⭐ 219

809. **[home-assistant-cursor-agent](https://github.com/Coolver/home-assistant-cursor-agent)** - ⭐ 219
...
810. **[agent-mcp-lab](https://github.com/WaveSpeedAI/agent-mcp-lab)** - ⭐ 219

811. **[awesome-mcp-servers](https://github.com/PipedreamHQ/awesome-mcp-servers)** - ⭐ 219
   A collection of MCP servers

812. **[xiyan_mcp_server](https://github.com/XGenerationLab/xiyan_mcp_server)** - ⭐ 219
   A Model Context Protocol (MCP) server that enables natural language queries to databases

813. **[mcp-server-tree-sitter](https://github.com/wrale/mcp-server-tree-sitter)** - ⭐ 219
   MCP Server for Tree-sitter

814. **[mcp-telegram](https://github.com/dryeab/mcp-telegram)** - ⭐ 219
   MCP Server for Telegram

815. **[mcp](https://github.com/hopx-ai/mcp)** - ⭐ 217

816. **[dat](https://github.com/hexinfo/dat)** - ⭐ 217
   Asking yours data in a natural language way through pre-modeling (data models and semantic models).

817. **[bazi-mcp](https://github.com/cantian-ai/bazi-mcp)** - ⭐ 216
   MCP server for Bazi (八字) information

818. **[claude-codex-settings](https://github.com/fcakyon/claude-codex-settings)** - ⭐ 216
   My personal Claude Code and OpenAI Codex setup with battle-tested skills, commands, hooks, agents and MCP servers that I use daily.

819. **[image-gen-server](https://github.com/fengin/image-gen-server)** - ⭐ 215
   一个能与Cursor集成的图片生成mcp server工具，实现调用即梦逆向接口

820. **[mcp-twikit](https://github.com/adhikasp/mcp-twikit)** - ⭐ 215
   A Model Context Protocol (MCP) server for interacting with Twitter.

821. **[octocode](https://github.com/Muvon/octocode)** - ⭐ 215
   Semantic code searcher and codebase utility with AI memory onboard

822. **[mcp-server-commands](https://github.com/g0t4/mcp-server-commands)** - ⭐ 214
   Model Context Protocol server to run commands

823. **[mq](https://github.com/harehare/mq)** - ⭐ 214
   jq-like command-line tool for markdown processing

824. **[human-in-the-loop](https://github.com/KOBA789/human-in-the-loop)** - ⭐ 213
   An MCP (Model Context Protocol) server that allows AI assistants to ask questions to humans via Discord.

825. **[browser-control-mcp](https://github.com/eyalzh/browser-control-mcp)** - ⭐ 212
   MCP server paired with a browser extension that enables AI agents to control the user's browser.

826. **[mcp-proxy](https://github.com/punkpeye/mcp-proxy)** - ⭐ 212
   A TypeScript SSE proxy for MCP servers that use stdio transport.

827. **[mcp-compass](https://github.com/liuyoshio/mcp-compass)** - ⭐ 212
   MCP Discovery & Recommendation Service - Find the right MCP server for your needs

828. **[mcp-maigret](https://github.com/BurtTheCoder/mcp-maigret)** - ⭐ 212
   MCP server for maigret, a powerful OSINT tool that collects user account information from various public sources. 

829. **[CodeGraphContext](https://github.com/Shashankss1205/CodeGraphContext)** - ⭐ 212
   An MCP server that indexes local code into a graph database to provide context to AI assistants.

830. **[todoist-ai](https://github.com/Doist/todoist-ai)** - ⭐ 212
   A set of tools to connect to AI agents, to allow them to use Todoist on a user's behalf. Includes MCP support.

831. **[claude-code-statusline](https://github.com/rz1989s/claude-code-statusline)** - ⭐ 211
...
832. **[mcp-ical](https://github.com/Omar-V2/mcp-ical)** - ⭐ 211
   A Model Context Protocol Server that allows you to interact with your MacOS Calendar through natural language.

833. **[vibevideo-mcp](https://github.com/hyepartners-gmail/vibevideo-mcp)** - ⭐ 210
   Agent MCP for ffmpeg

834. **[gibber-mcp](https://github.com/antonpk1/gibber-mcp)** - ⭐ 210
   Tiny MCP server with cryptography tools, sufficient to establish end-to-end encryption between LLM agents

835. **[Autono](https://github.com/vortezwohl/Autono)** - ⭐ 210
   A ReAct-Based Highly Robust Autonomous Agent Framework.

836. **[mcp_code_executor](https://github.com/bazinga012/mcp_code_executor)** - ⭐ 210
   The MCP Code Executor is an MCP server that allows LLMs to execute Python code within a specified Conda environment.

837. **[lihil](https://github.com/raceychan/lihil)** - ⭐ 210
   2X faster ASGI web framework for python, offering high-level development, low-level performance.

838. **[safe-mcp](https://github.com/SAFE-MCP/safe-mcp)** - ⭐ 210
   SAFE-MCP is a comprehensive security framework for documenting and mitigating threats in the AI Agent ecosystem.

839. **[effect-mcp](https://github.com/tim-smart/effect-mcp)** - ⭐ 209

840. **[uber-eats-mcp-server](https://github.com/ericzakariasson/uber-eats-mcp-server)** - ⭐ 209

841. **[razorpay-mcp-server](https://github.com/razorpay/razorpay-mcp-server)** - ⭐ 209
...
843. **[iam-policy-autopilot](https://github.com/awslabs/iam-policy-autopilot)** - ⭐ 208
...
848. **[spring-ai-summary](https://github.com/java-ai-tech/spring-ai-summary)** - ⭐ 207
   SpringAI，LLM，MCP，Embedding

849. **[openapi-to-mcpserver](https://github.com/higress-group/openapi-to-mcpserver)** - ⭐ 206
   A tool&lib that can automatically convert OpenAPI documents into Higress remote MCP server configurations.

850. **[multimodal-mcp-client](https://github.com/Ejb503/multimodal-mcp-client)** - ⭐ 206
   A Multi-modal MCP client for voice powered agentic workflows

851. **[Alice](https://github.com/pmbstyle/Alice)** - ⭐ 206
...
852. **[mcp-rb](https://github.com/funwarioisii/mcp-rb)** - ⭐ 205
   A lightweight Ruby framework for building MCP servers with a Sinatra-like DSL

853. **[omnicoreagent](https://github.com/omnirexflora-labs/omnicoreagent)** - ⭐ 205
...
854. **[mcp-openapi-server](https://github.com/ivo-toby/mcp-openapi-server)** - ⭐ 205
   MCP Server (Model Context Protocol) for turning OpenAPI specifications into a MCP Resource

855. **[lokka](https://github.com/merill/lokka)** - ⭐ 205
   MCP (Model Context Protocol) for Microsoft 365. Includes support for Microsoft Graph and other services

856. **[mermaid-mcp-server](https://github.com/peng-shawn/mermaid-mcp-server)** - ⭐ 205
   A Model Context Protocol (MCP) server that converts Mermaid diagrams to PNG images

857. **[Android-MCP](https://github.com/CursorTouch/Android-MCP)** - ⭐ 205
...
864. **[mcp-server](https://github.com/volcengine/mcp-server)** - ⭐ 203
   Volcengine MCP Servers

865. **[sqrl](https://github.com/DataSQRL/sqrl)** - ⭐ 202
   Data Pipeline Automation Framework to build MCP servers, data APIs, and data lakes with SQL.

866. **[playwright-mcp](https://github.com/cloudflare/playwright-mcp)** - ⭐ 202
   Playwright MCP fork that works with Cloudflare Browser Rendering

867. **[mcp-server-milvus](https://github.com/zilliztech/mcp-server-milvus)** - ⭐ 202
   Model Context Protocol Servers for Milvus

868. **[mineru-tianshu](https://github.com/magicyuan876/mineru-tianshu)** - ⭐ 202
   天枢 - 企业级 AI 一站式数据预处理平台 | PDF/Office转Markdown | 支持MCP协议AI助手集成 | Vue3+FastAPI全栈方案 | 文档解析 | 多模态信息提取

869. **[Remote-MCP](https://github.com/ssut/Remote-MCP)** - ⭐ 201
   A type-safe solution to remote MCP communication, enabling effortless integration for centralized management of Model Context.

870. **[MARM-Systems](https://github.com/Lyellr88/MARM-Systems)** - ⭐ 201
...
871. **[cpp-mcp](https://github.com/hkr04/cpp-mcp)** - ⭐ 201
   Lightweight C++ MCP (Model Context Protocol) SDK

872. **[OSWorld-MCP](https://github.com/X-PLUG/OSWorld-MCP)** - ⭐ 200

873. **[facebook-ads-mcp-server](https://github.com/gomarble-ai/facebook-ads-mcp-server)** - ⭐ 200

874. **[sora-mcp](https://github.com/Doriandarko/sora-mcp)** - ⭐ 200
   An MCP server to use Sora video generation APIs

875. **[melrose](https://github.com/emicklei/melrose)** - ⭐ 200
   interactive programming of melodies, producing MIDI 

876. **[kite-mcp-server](https://github.com/zerodha/kite-mcp-server)** - ⭐ 199
   Zerodha Kite MCP server

877. **[outlook-mcp](https://github.com/ryaker/outlook-mcp)** - ⭐ 199
   MCP server for Claude to access Outlook data via Microsoft Graph API

878. **[private-journal-mcp](https://github.com/obra/private-journal-mcp)** - ⭐ 198
   A lightweight MCP server that provides Claude with a private journaling capability to process feelings and thoughts

879. **[mathom](https://github.com/stephenlacy/mathom)** - ⭐ 198
   Run and monitor MCP servers locally

880. **[composer-trade-mcp](https://github.com/invest-composer/composer-trade-mcp)** - ⭐ 198
   Composer's MCP server lets MCP-enabled LLMs like Claude backtest trading ideas and automatically invest in them for you

881. **[studio-rust-mcp-server](https://github.com/Roblox/studio-rust-mcp-server)** - ⭐ 198
   Standalone Roblox Studio MCP Server

882. **[y-cli](https://github.com/luohy15/y-cli)** - ⭐ 197
   A Tiny Terminal Chat App for AI Models with MCP Client Support

883. **[ruby_llm-mcp](https://github.com/patvice/ruby_llm-mcp)** - ⭐ 197
   Full-featured MCP support for Ruby and RubyLLM—making it easy to build structured, composable LLM workflows in pure Ruby.

884. **[spotify-mcp-server](https://github.com/marcelmarais/spotify-mcp-server)** - ⭐ 196
   Lightweight MCP server for Spotify

885. **[1c_mcp](https://github.com/vladimir-kharin/1c_mcp)** - ⭐ 196
...
886. **[mcp-portal-transparencia](https://github.com/dutradotdev/mcp-portal-transparencia)** - ⭐ 195
   MCP para orquestração automatizada de chamadas à API do Portal da Transparência do Governo Federal brasileiro

887. **[mcp-server-rag-web-browser](https://github.com/apify/mcp-server-rag-web-browser)** - ⭐ 195
...
890. **[one-mcp](https://github.com/burugo/one-mcp)** - ⭐ 194
...
891. **[ht-mcp](https://github.com/memextech/ht-mcp)** - ⭐ 193
   Pure Rust implementation of MCP server for headless terminal 

892. **[penpot-mcp](https://github.com/montevive/penpot-mcp)** - ⭐ 193
   Penpot MCP server

893. **[mongodb-lens](https://github.com/furey/mongodb-lens)** - ⭐ 192
   🍃🔎 MongoDB Lens: Full Featured MCP Server for MongoDB Databases

894. **[strava-mcp](https://github.com/r-huijts/strava-mcp)** - ⭐ 192
   A Model Context Protocol (MCP) server that connects to Strava API, providing tools to access Strava data through LLMs

895. **[mcp](https://github.com/Snowflake-Labs/mcp)** - ⭐ 192
   MCP Server for Snowflake including Cortex AI, object management, SQL orchestration, semantic view consumption, and more

896. **[rmcp](https://github.com/finite-sample/rmcp)** - ⭐ 192
   R MCP Server

897. **[solon-ai](https://github.com/opensolon/solon-ai)** - ⭐ 192
...
898. **[BifrostMCP](https://github.com/biegehydra/BifrostMCP)** - ⭐ 191
   VSCode Extension with an MCP server that exposes semantic tools like Find Usages and Rename to LLMs

899. **[opik-mcp](https://github.com/comet-ml/opik-mcp)** - ⭐ 191
   Model Context Protocol (MCP) implementation for Opik enabling seamless IDE integration and unified access to prompts, projects, traces, and metrics. 

900. **[unsplash-mcp-server](https://github.com/hellokaton/unsplash-mcp-server)** - ⭐ 191
   🔎 A MCP server for Unsplash image search.

901. **[mcp-server-deep-research](https://github.com/reading-plus-ai/mcp-server-deep-research)** - ⭐ 191
...
906. **[smart-tree](https://github.com/8b-is/smart-tree)** - ⭐ 190
...
907. **[lean-lsp-mcp](https://github.com/oOo0oOo/lean-lsp-mcp)** - ⭐ 190
   Lean Theorem Prover MCP

908. **[mcp-proxy-server](https://github.com/adamwattis/mcp-proxy-server)** - ⭐ 189
   An MCP proxy server that aggregates and serves multiple MCP resource servers through a single interface

909. **[nano-agent](https://github.com/disler/nano-agent)** - ⭐ 189
   A MCP Server for a small scale engineering agents with multi-provider LLM support.

910. **[metorial-platform](https://github.com/metorial/metorial-platform)** - ⭐ 189
   The engine powering hundreds of thousands of MCP connections 🤖 🔥

911. **[seo-mcp](https://github.com/cnych/seo-mcp)** - ⭐ 188
...
912. **[Mimir](https://github.com/orneryd/Mimir)** - ⭐ 188
...
913. **[claude-skills-mcp](https://github.com/K-Dense-AI/claude-skills-mcp)** - ⭐ 188
   MCP server for searching and retrieving Claude Agent Skills using vector search

914. **[code-sandbox-mcp](https://github.com/philschmid/code-sandbox-mcp)** - ⭐ 187

915. **[mcp-usecase](https://github.com/teddynote-lab/mcp-usecase)** - ⭐ 187

916. **[mcp-injection-experiments](https://github.com/invariantlabs-ai/mcp-injection-experiments)** - ⭐ 187
   Code snippets to reproduce MCP tool poisoning attacks.

917. **[antd-components-mcp](https://github.com/zhixiaoqiang/antd-components-mcp)** - ⭐ 187
   An MCP service for Ant Design components query | 一个减少 Ant Design 组件代码生成幻觉的 MCP 服务，包含系统提示词、组件文档、API 文档、代码示例和更新日志查询

918. **[mcp-n8n-workflow-builder](https://github.com/salacoste/mcp-n8n-workflow-builder)** - ⭐ 187
   MCP server for Claude / Cursor building n8n workflow 

919. **[mcp-trends-hub](https://github.com/baranwang/mcp-trends-hub)** - ⭐ 187
   基于 Model Context Protocol (MCP) 协议的全网热点趋势一站式聚合服务

920. **[MCP-server-client-computer-use-ai-sdk](https://github.com/mediar-ai/MCP-server-client-computer-use-ai-sdk)** - ⭐ 186

921. **[phone-mcp](https://github.com/hao-cyber/phone-mcp)** - ⭐ 186
   A phone control plugin for MCP that allows you to control your Android phone through ADB commands to connect any human

922. **[waldzell-mcp](https://github.com/waldzellai/waldzell-mcp)** - ⭐ 186
   Waldzell AI's monorepo of MCP servers. Use in Claude Desktop, Cline, Roo Code, and more!

923. **[Omni-Adapter](https://github.com/HuChundong/Omni-Adapter)** - ⭐ 186
...
926. **[AutoDocs](https://github.com/TrySita/AutoDocs)** - ⭐ 185
...
927. **[nosia](https://github.com/dilolabs/nosia)** - ⭐ 185
   Self-hosted AI RAG + MCP Platform

928. **[a2a_mcp-example](https://github.com/ishanExtreme/a2a_mcp-example)** - ⭐ 184
   An example showing how A2A and MCP can be used together

929. **[ProxmoxMCP](https://github.com/canvrno/ProxmoxMCP)** - ⭐ 184
   MCP for Proxmox integration in Cline

930. **[ai-infrastructure-agent](https://github.com/VersusControl/ai-infrastructure-agent)** - ⭐ 184
...
931. **[supabase-mcp](https://github.com/coleam00/supabase-mcp)** - ⭐ 184
   Supabase MCP server created in Python.

932. **[sec-edgar-mcp](https://github.com/stefanoamorelli/sec-edgar-mcp)** - ⭐ 183
   A SEC EDGAR MCP (Model Context Protocol) Server

933. **[gcp-mcp](https://github.com/eniayomi/gcp-mcp)** - ⭐ 183
   A Model Context Protocol (MCP) server that enables AI assistants like Claude to interact with your Google Cloud Platform environment. This allows for natural language querying and management of your GCP resources during conversations.

934. **[armor-crypto-mcp](https://github.com/armorwallet/armor-crypto-mcp)** - ⭐ 183
   The MCP server for interacting with Blockchain, Swaps, Strategic Planning and more.

935. **[thinkchain](https://github.com/martinbowling/thinkchain)** - ⭐ 182
...
936. **[mcp-openai-gemini-llama-example](https://github.com/philschmid/mcp-openai-gemini-llama-example)** - ⭐ 182

937. **[MiroRL](https://github.com/MiroMindAI/MiroRL)** - ⭐ 182
   MiroRL is  an MCP-first reinforcement learning framework for deep research agent.

938. **[auto-mcp](https://github.com/brizzai/auto-mcp)** - ⭐ 182
   Transform any OpenAPI/Swagger definition into a fully-featured Model Context Protocol (MCP) server

939. **[Google-Search-MCP-Server](https://github.com/mixelpixx/Google-Search-MCP-Server)** - ⭐ 182
...
940. **[dynatrace-mcp](https://github.com/dynatrace-oss/dynatrace-mcp)** - ⭐ 181
   MCP server for Dynatrace Observability

941. **[mcp-linkedin](https://github.com/adhikasp/mcp-linkedin)** - ⭐ 181
   A Model Context Protocol (MCP) server that provides tools to interact with LinkedIn's Feeds and Job API.

942. **[mcp_forge](https://github.com/mlzoo/mcp_forge)** - ⭐ 181
   这是一个专为开发企业级MCP server而设计的通用开发框架

943. **[utcp-mcp](https://github.com/universal-tool-calling-protocol/utcp-mcp)** - ⭐ 181
   All-in-one MCP server that can connect your AI agents to any native endpoint, powered by UTCP

944. **[litemcp](https://github.com/wong2/litemcp)** - ⭐ 180
   A TypeScript framework for building MCP servers elegantly

945. **[siconos](https://github.com/siconos/siconos)** - ⭐ 180
   Simulation framework for nonsmooth dynamical systems

946. **[persistent-ai-memory](https://github.com/savantskie/persistent-ai-memory)** - ⭐ 180
   A persistent local memory for AI, LLMs, or Copilot in VS Code.

947. **[dify-plugin-tools-mcp_sse](https://github.com/junjiem/dify-plugin-tools-mcp_sse)** - ⭐ 179
   Dify 1.0 Plugin MCP HTTP with SSE or Streamable HTTP transport Tools

948. **[mcp-server-trello](https://github.com/delorenj/mcp-server-trello)** - ⭐ 179
   A Model Context Protocol (MCP) server that provides tools for interacting with Trello boards.

949. **[jebmcp](https://github.com/dawnslab/jebmcp)** - ⭐ 179

950. **[quarkus-mcp-servers](https://github.com/quarkiverse/quarkus-mcp-servers)** - ⭐ 178
   Model Context Protocol Servers in Quarkus

951. **[mcp-text-editor](https://github.com/tumf/mcp-text-editor)** - ⭐ 178

952. **[mcp-proxy-server](https://github.com/ptbsare/mcp-proxy-server)** - ⭐ 178
   This server acts as a central hub for Model Context Protocol (MCP) resource servers.

953. **[claude-code-mcp](https://github.com/auchenberg/claude-code-mcp)** - ⭐ 178
   claude-code-mcp

954. **[mcp-obsidian](https://github.com/bitbonsai/mcp-obsidian)** - ⭐ 178
   A lightweight Model Context Protocol (MCP) server for safe Obsidian vault access

955. **[Google-Scholar-MCP-Server](https://github.com/JackKuo666/Google-Scholar-MCP-Server)** - ⭐ 178
...
956. **[ha-mcp-for-xiaozhi](https://github.com/c1pher-cn/ha-mcp-for-xiaozhi)** - ⭐ 178
   Homeassistant MCP server for 小智AI

957. **[anki-mcp-server](https://github.com/scorzeth/anki-mcp-server)** - ⭐ 177
   An MCP server for Anki

958. **[tripo-mcp](https://github.com/VAST-AI-Research/tripo-mcp)** - ⭐ 177
   Official MCP server for Tripo

959. **[gram](https://github.com/speakeasy-api/gram)** - ⭐ 177
   Platform to create, curate and host MCP servers ⚒️ Build production quality tools for your agents.

960. **[yahoo-finance-mcp](https://github.com/Alex2Yang97/yahoo-finance-mcp)** - ⭐ 176
   This is a Model Context Protocol (MCP) server that provides comprehensive financial data from Yahoo Finance. It allows you to retrieve detailed information about stocks, including historical prices, company information, financial statements, options data, and market news.

961. **[k8s-mcp-server](https://github.com/alexei-led/k8s-mcp-server)** - ⭐ 176
   K8s-mcp-server is a Model Context Protocol (MCP) server that enables AI assistants like Claude to securely execute Kubernetes commands. It provides a bridge between language models and essential Kubernetes CLI tools including kubectl, helm, istioctl, and argocd, allowing AI systems to assist with cluster management, troubleshooting, and deployments

962. **[TradingAgents-MCPmode](https://github.com/guangxiangdebizi/TradingAgents-MCPmode)** - ⭐ 175
   TradingAgents-MCPmode 是一个创新的多智能体交易分析系统，集成了 Model Context Protocol (MCP) 工具，实现了智能化的股票分析和交易决策流程。系统通过多个专业化智能体的协作，提供全面的市场分析、投资建议和风险管理。

963. **[protoc-gen-go-mcp](https://github.com/redpanda-data/protoc-gen-go-mcp)** - ⭐ 175
   Go protobuf compiler extension to turn any gRPC service into an MCP server

964. **[mongo-mcp](https://github.com/QuantGeekDev/mongo-mcp)** - ⭐ 174
   A mongo db server for the model context protocol (MCP)

965. **[geminimcp](https://github.com/GuDaStudio/geminimcp)** - ⭐ 174
...
966. **[mcp-server-duckdb](https://github.com/ktanaka101/mcp-server-duckdb)** - ⭐ 172
   A Model Context Protocol (MCP) server implementation for DuckDB, providing database interaction capabilities

967. **[skunit](https://github.com/mehrandvd/skunit)** - ⭐ 172
   skUnit is a testing tool for AI units, such as IChatClient, MCP Servers and agents.

968. **[gistpad-mcp](https://github.com/lostintangent/gistpad-mcp)** - ⭐ 172
   📓 An MCP server for managing your personal knowledge, daily notes, and re-usable prompts via GitHub Gists

969. **[bilibili-mcp-server](https://github.com/huccihuang/bilibili-mcp-server)** - ⭐ 171
   MCP Server for the Bilibili API, supporting various operations.

970. **[mcp-echarts](https://github.com/hustcc/mcp-echarts)** - ⭐ 171
   🧬 Generate visual charts using ECharts with AI MCP dynamically, used for chart generation and data analysis.

971. **[mcp-snowflake-server](https://github.com/isaacwasserman/mcp-snowflake-server)** - ⭐ 170

972. **[tmux-mcp](https://github.com/nickgnd/tmux-mcp)** - ⭐ 170
   A MCP server for our beloved terminal multiplexer tmux.

973. **[MCP-Checklists](https://github.com/MCP-Manager/MCP-Checklists)** - ⭐ 170

974. **[servicenow-mcp](https://github.com/echelon-ai-labs/servicenow-mcp)** - ⭐ 169
   MCP Server for ServiceNow

975. **[quarkus-mcp-server](https://github.com/quarkiverse/quarkus-mcp-server)** - ⭐ 169
   This extension enables developers to implement the MCP server features easily.

976. **[ida-mcp-server-plugin](https://github.com/taida957789/ida-mcp-server-plugin)** - ⭐ 169
   IDA Pro Plugin for serving MCP SSE server for cursor / claude

977. **[figma-flutter-mcp](https://github.com/mhmzdev/figma-flutter-mcp)** - ⭐ 169
   An MCP server that provides the coding agents Figma's design token to write Flutter code.

978. **[pbi-desktop-mcp-public](https://github.com/maxanatsko/pbi-desktop-mcp-public)** - ⭐ 169
...
979. **[obsidian-mcp-plugin](https://github.com/aaronsb/obsidian-mcp-plugin)** - ⭐ 168
   High-performance Model Context Protocol (MCP) server for Obsidian that provides AI tools with direct vault access through semantic operations and HTTP transport.

980. **[things-mcp](https://github.com/hald/things-mcp)** - ⭐ 168
   Things.app MCP Server

981. **[mcp-server-siri-shortcuts](https://github.com/dvcrn/mcp-server-siri-shortcuts)** - ⭐ 167
   MCP for calling Siri Shorcuts from LLMs

982. **[mcp-chat](https://github.com/PipedreamHQ/mcp-chat)** - ⭐ 167
   Examples of using Pipedream's MCP server in your app or AI agent.

983. **[google-docs-mcp](https://github.com/a-bonus/google-docs-mcp)** - ⭐ 167
...
984. **[aws-mcp-server](https://github.com/alexei-led/aws-mcp-server)** - ⭐ 166
   A lightweight service that enables AI assistants to execute AWS CLI commands (in safe containerized environment) through the Model Context Protocol (MCP). Bridges Claude, Cursor, and other MCP-aware AI tools with AWS CLI for enhanced cloud infrastructure management.

985. **[ha-mcp](https://github.com/homeassistant-ai/ha-mcp)** - ⭐ 166
   The Unofficial and Awesome Home Assistant MCP Server

986. **[KiCAD-MCP-Server](https://github.com/mixelpixx/KiCAD-MCP-Server)** - ⭐ 165
   KiCAD MCP is a Model Context Protocol (MCP) implementation that enables Large Language Models (LLMs) like Claude to directly interact with KiCAD for printed circuit board design.

987. **[mcp-scholarly](https://github.com/adityak74/mcp-scholarly)** - ⭐ 165
   A MCP server to search for accurate academic articles.

988. **[zotero-mcp](https://github.com/cookjohn/zotero-mcp)** - ⭐ 165
...
989. **[ssh-mcp](https://github.com/tufantunc/ssh-mcp)** - ⭐ 164
   MCP server exposing SSH control for Linux servers via Model Context Protocol.

990. **[yt-dlp-mcp](https://github.com/kevinwatt/yt-dlp-mcp)** - ⭐ 164
   A Model Context Protocol (MCP) server that bridges Video & Audio content with Large Language Models using yt-dlp.

991. **[mcp-servers-nix](https://github.com/natsukium/mcp-servers-nix)** - ⭐ 164
   A Nix-based configuration framework for Model Control Protocol (MCP) servers with ready-to-use packages.

992. **[command](https://github.com/scopecraft/command)** - ⭐ 164
   Scopecraft Command - A CLI and MCP server for Markdown-Driven Task Management (MDTM)

993. **[pctx](https://github.com/portofcontext/pctx)** - ⭐ 164
...
994. **[Chanakya-Local-Friend](https://github.com/Rishabh-Bajpai/Chanakya-Local-Friend)** - ⭐ 164
...
995. **[aws-finops-mcp-server](https://github.com/ravikiranvm/aws-finops-mcp-server)** - ⭐ 163
   An MCP (Model Context Protocol) server that brings powerful AWS FinOps capabilities directly into your AI assistant. Analyze cloud costs, audit for waste, and get budget insights using natural language, all while keeping your credentials secure on your local machine.

996. **[mcp-use-ts](https://github.com/mcp-use/mcp-use-ts)** - ⭐ 163
   mcp-use is the framework for MCP with the best DX - Build AI agents, create MCP   servers with UI widgets, and debug with built-in inspector. Includes client SDK, server SDK, React hooks, and powerful dev tools.

997. **[facebook-ads-library-mcp](https://github.com/talknerdytome-labs/facebook-ads-library-mcp)** - ⭐ 163
   MCP Server for Facebook ADs Library - Get instant answers from FB's ad library

998. **[openapi-mcp](https://github.com/ckanthony/openapi-mcp)** - ⭐ 162
   Dockerized MCP Server to allow your AI agent to access any API with existing api docs

999. **[mcp-gsc](https://github.com/AminForou/mcp-gsc)** - ⭐ 161
   Google Search Console Insights with Claude AI for SEOs

1000. **[mcp-server-weaviate](https://github.com/weaviate/mcp-server-weaviate)** - ⭐ 160
   MCP (Model Context Protocol) server for Weaviate

1001. **[xero-mcp-server](https://github.com/XeroAPI/xero-mcp-server)** - ⭐ 160
   An MCP server that integrates with the MCP protocol. https://modelcontextprotocol.io/introduction

1002. **[hf-mcp-server](https://github.com/huggingface/hf-mcp-server)** - ⭐ 160
   Hugging Face MCP Server

1003. **[mcp-telegram](https://github.com/sparfenyuk/mcp-telegram)** - ⭐ 160
   MCP server to work with Telegram through MTProto

1004. **[fetch-mcp](https://github.com/egoist/fetch-mcp)** - ⭐ 160
   An MCP server for fetching URLs / Youtube video transcript.

1005. **[discordmcp](https://github.com/v-3/discordmcp)** - ⭐ 159
   Discord MCP Server for Claude Integration

1006. **[meilisearch-mcp](https://github.com/meilisearch/meilisearch-mcp)** - ⭐ 158
   A Model Context Protocol (MCP) server for interacting with Meilisearch through LLM interfaces.

1007. **[google-analytics-mcp](https://github.com/surendranb/google-analytics-mcp)** - ⭐ 158
...
1008. **[spotinfo](https://github.com/alexei-led/spotinfo)** - ⭐ 158
   CLI for exploring AWS EC2 Spot inventory. Inspect AWS Spot instance types, saving, price, and interruption frequency.

1009. **[mcp](https://github.com/magicuidesign/mcp)** - ⭐ 157
   Official Magic UI MCP server.

1010. **[lsp-mcp](https://github.com/jonrad/lsp-mcp)** - ⭐ 156
   An Model Context Protocol (MCP) server that provides LLMs/AI Agents with the capabilities of a language server protocol (LSP) server. This gives the AI the ability to get language aware context from the codebase.

1011. **[git-mcp-server](https://github.com/cyanheads/git-mcp-server)** - ⭐ 156
   An MCP (Model Context Protocol) server enabling LLMs and AI agents to interact with Git repositories. Provides tools for comprehensive Git operations including clone, commit, branch, diff, log, status, push, pull, merge, rebase, worktree, tag management, and more, via the MCP standard. STDIO & HTTP.

1012. **[jmap-mcp](https://github.com/wyattjoh/jmap-mcp)** - ⭐ 156
   A Model Context Protocol (MCP) server that provides tools for interacting with JMAP (JSON Meta Application Protocol) email servers. Built with Deno and using the jmap-jam client library.

1013. **[Quickchart-MCP-Server](https://github.com/GongRzhe/Quickchart-MCP-Server)** - ⭐ 155
...
1014. **[wikipedia-mcp](https://github.com/Rudra-ravi/wikipedia-mcp)** - ⭐ 155
   A Model Context Protocol (MCP) server that retrieves information from Wikipedia to provide context to LLMs.

1015. **[mcp-shell-server](https://github.com/tumf/mcp-shell-server)** - ⭐ 155

1016. **[cli-mcp-server](https://github.com/MladenSU/cli-mcp-server)** - ⭐ 155
   Command line interface for MCP clients with secure execution and customizable security policies

1017. **[dbt-llm-agent](https://github.com/pragunbhutani/dbt-llm-agent)** - ⭐ 155
   LLM based AI Agent to automate Data Analysis for dbt projects with remote MCP server

1018. **[pg-aiguide](https://github.com/timescale/pg-aiguide)** - ⭐ 155
   MCP server and Claude plugin for Postgres skills and documentation. Helps AI coding tools generate better PostgreSQL code.

1019. **[mcp-logseq](https://github.com/ergut/mcp-logseq)** - ⭐ 155
   MCP server to interact with LogSeq via its Local HTTP API - enabling AI assistants like Claude to seamlessly read, write, and manage your LogSeq graph.

1020. **[sketchup-mcp](https://github.com/mhyrr/sketchup-mcp)** - ⭐ 154
   Sketchup Model Context Protocol

1021. **[app-store-connect-mcp-server](https://github.com/JoshuaRileyDev/app-store-connect-mcp-server)** - ⭐ 154

1022. **[keyboard-local](https://github.com/keyboard-dev/keyboard-local)** - ⭐ 154
   One MCP Server, All Your Apps, Privacy First

1023. **[UnityNaturalMCP](https://github.com/notargs/UnityNaturalMCP)** - ⭐ 154
   UnityNaturalMCP is an MCP server implementation for Unity that aims for a "natural" user experience.

1024. **[ai-counsel](https://github.com/blueman82/ai-counsel)** - ⭐ 154
   True deliberative consensus MCP server where AI models debate and refine positions across multiple rounds

1025. **[slack-mcp-client](https://github.com/tuannvm/slack-mcp-client)** - ⭐ 153
...
1026. **[compliant-llm](https://github.com/fiddlecube/compliant-llm)** - ⭐ 153
   Build Secure and Compliant AI agents and MCP Servers. YC W23

1027. **[frida-mcp](https://github.com/dnakov/frida-mcp)** - ⭐ 152
   MCP stdio server for frida

1028. **[touchdesigner-mcp](https://github.com/8beeeaaat/touchdesigner-mcp)** - ⭐ 152
   MCP server for TouchDesigner

1029. **[python-mcp-server-client](https://github.com/GobinFan/python-mcp-server-client)** - ⭐ 151
   支持查询主流agent框架技术文档的MCP server（支持stdio和sse两种传输协议）, 支持 langchain、llama-index、autogen、agno、openai-agents-sdk、mcp-doc、camel-ai 和 crew-ai

1030. **[mcp-access-point](https://github.com/sxhxliang/mcp-access-point)** - ⭐ 151
   Turn a web server into an MCP server in one click without making any code changes.

1031. **[mcp-client-go](https://github.com/yincongcyincong/mcp-client-go)** - ⭐ 149
   mcp client for Go (Golang). Integrate multiple  Model Context Protocol (MCP) servers

1032. **[mcp-google-map](https://github.com/cablate/mcp-google-map)** - ⭐ 149
   A powerful Model Context Protocol (MCP) server providing comprehensive Google Maps API integration with LLM processing capabilities.

1033. **[mcp-agent-langchainjs](https://github.com/Azure-Samples/mcp-agent-langchainjs)** - ⭐ 149
...
1034. **[tinymcp](https://github.com/golioth/tinymcp)** - ⭐ 148
   Let LLMs control embedded devices via the Model Context Protocol.

1035. **[mcp-server-langfuse](https://github.com/langfuse/mcp-server-langfuse)** - ⭐ 148
   Model Context Protocol (MCP) Server for Langfuse Prompt Management. This server allows you to access and manage your Langfuse prompts through the Model Context Protocol.

1036. **[photoshop-python-api-mcp-server](https://github.com/loonghao/photoshop-python-api-mcp-server)** - ⭐ 147
   A Model Context Protocol (MCP) server that interfaces with Adobe Photoshop's Python API. Enables LLMs to execute image editing operations, automate workflows, and manage Photoshop tasks through structured commands and context-aware interactions.

1037. **[after-effects-mcp](https://github.com/Dakkshin/after-effects-mcp)** - ⭐ 145
   MCP Server for Adobe After Effects. Enables remote control (compositions, text, shapes, solids, properties) via the Model Context Protocol using ExtendScript.

1038. **[mcp-1panel](https://github.com/1Panel-dev/mcp-1panel)** - ⭐ 144
   mcp-1panel is an implementation of the Model Context Protocol (MCP) server for 1Panel.

1039. **[figma-mcp-server](https://github.com/TimHolden/figma-mcp-server)** - ⭐ 144
   Model Context Protocol server implementation for Figma API

1040. **[mcp-solver](https://github.com/szeider/mcp-solver)** - ⭐ 144
   Model Context Protocol (MCP) server for constraint optimization and solving"

1041. **[comfyui-mcp-server](https://github.com/joenorton/comfyui-mcp-server)** - ⭐ 143
   lightweight Python-based MCP (Model Context Protocol) server for local ComfyUI

1042. **[OpenDataMCP](https://github.com/OpenDataMCP/OpenDataMCP)** - ⭐ 141
   Connect any Open Data to any LLM with Model Context Protocol.

1043. **[Log-Analyzer-with-MCP](https://github.com/awslabs/Log-Analyzer-with-MCP)** - ⭐ 141
   A Model Context Protocol (MCP) server that provides AI assistants access to AWS CloudWatch Logs for analysis, searching, and correlation

1044. **[aitour26-WRK540-unlock-your-agents-potential-with-model-context-protocol](https://github.com/microsoft/aitour26-WRK540-unlock-your-agents-potential-with-model-context-protocol)** - ⭐ 141

1045. **[node-code-sandbox-mcp](https://github.com/alfonsograziano/node-code-sandbox-mcp)** - ⭐ 140
   A Node.js–based Model Context Protocol server that spins up disposable Docker containers to execute arbitrary JavaScript.

1046. **[mcptools](https://github.com/posit-dev/mcptools)** - ⭐ 140
   Model Context Protocol For R

1047. **[notion-mcp-server](https://github.com/awkoy/notion-mcp-server)** - ⭐ 139
   **Notion MCP Server** is a Model Context Protocol (MCP) server implementation that enables AI assistants to interact with Notion's API. This production-ready server provides a complete set of tools.

1048. **[cursor-notebook-mcp](https://github.com/jbeno/cursor-notebook-mcp)** - ⭐ 139
   Model Context Protocol (MCP) server designed to allow AI agents within Cursor to interact with Jupyter Notebook (.ipynb) files

1049. **[mcp-mysql-server](https://github.com/f4ww4z/mcp-mysql-server)** - ⭐ 137
   A Model Context Protocol server for MySQL database operations

1050. **[solana-mcp](https://github.com/sendaifun/solana-mcp)** - ⭐ 137
   A Model Context Protocol server for interacting with the Solana blockchain, powered by the Solana Agent Kit (https://github.com/sendaifun/solana-agent-kit)

1051. **[mcp-server-calculator](https://github.com/githejie/mcp-server-calculator)** - ⭐ 137
   A Model Context Protocol server for calculating.

1052. **[guidance-for-deploying-model-context-protocol-servers-on-aws](https://github.com/aws-solutions-library-samples/guidance-for-deploying-model-context-protocol-servers-on-aws)** - ⭐ 133
...
1053. **[agentql-mcp](https://github.com/tinyfish-io/agentql-mcp)** - ⭐ 133
   Model Context Protocol server that integrates AgentQL's data extraction capabilities.

1054. **[SecureMCP](https://github.com/makalin/SecureMCP)** - ⭐ 132
...
1055. **[agent-toolkit](https://github.com/datacommonsorg/agent-toolkit)** - ⭐ 132
   Tools and agents for interacting with the Data Commons Knowledge Graph using the Model Context Protocol (MCP).

1056. **[mcp-server-starrocks](https://github.com/StarRocks/mcp-server-starrocks)** - ⭐ 132
   StarRocks MCP (Model Context Protocol) Server

1057. **[mcp-servers](https://github.com/cursor/mcp-servers)** - ⭐ 132
   A list of MCP (Model Context Protocol) servers for developer tools and services

1058. **[bilibili-mcp-js](https://github.com/34892002/bilibili-mcp-js)** - ⭐ 131
   Bilibili video search MCP (Model Context Protocol) service - 哔哩哔哩视频搜索MCP服务

1059. **[metatrader-mcp-server](https://github.com/ariadng/metatrader-mcp-server)** - ⭐ 130
   Model Context Protocol (MCP) to enable AI LLMs to trade using MetaTrader platform

1060. **[mcp-bigquery-server](https://github.com/ergut/mcp-bigquery-server)** - ⭐ 129
   A Model Context Protocol (MCP) server that provides secure, read-only access to BigQuery datasets. Enables Large Language Models (LLMs) to safely query and analyze data through a standardized interface.

1061. **[ultimate_mcp_server](https://github.com/Dicklesworthstone/ultimate_mcp_server)** - ⭐ 129
   The Ultimate Model Context Protocol (MCP) Server, providing unified access to a wide variety of useful and powerful tools.

1062. **[mcp-gateway](https://github.com/acehoss/mcp-gateway)** - ⭐ 128
...
1063. **[mcp-server-aws](https://github.com/rishikavikondala/mcp-server-aws)** - ⭐ 126
   A Model Context Protocol server implementation for operations on AWS resources

1064. **[mcp-server-reddit](https://github.com/Hawstein/mcp-server-reddit)** - ⭐ 126
   A Model Context Protocol (MCP) server that provides tools for fetching Reddit content, including frontpage posts, subreddit information and hot posts, post details, and comments.

1065. **[mcp-shark](https://github.com/mcp-shark/mcp-shark)** - ⭐ 126
...
1066. **[buttplug-mcp](https://github.com/ConAcademy/buttplug-mcp)** - ⭐ 124
   Buttplug.io Model Context Protocol (MCP) Server

1067. **[zotero-mcp](https://github.com/kujenga/zotero-mcp)** - ⭐ 124
   Model Context Protocol (MCP) server for the Zotero API, in Python

1068. **[zettelkasten-mcp](https://github.com/entanglr/zettelkasten-mcp)** - ⭐ 124
   A Model Context Protocol (MCP) server that implements the Zettelkasten knowledge management methodology, allowing you to create, link, explore and synthesize atomic notes through Claude and other MCP-compatible clients.

1069. **[laravel-loop](https://github.com/kirschbaum-development/laravel-loop)** - ⭐ 123
   Laravel Loop is a powerful Model Context Protocol (MCP) server designed specifically for Laravel applications. It connects your Laravel application with AI assistants using the MCP protocol.

1070. **[mcp-evals](https://github.com/mclenhard/mcp-evals)** - ⭐ 122
   A Node.js package and GitHub Action for evaluating MCP (Model Context Protocol) tool implementations using LLM-based scoring. This helps ensure your MCP server's tools are working correctly and performing well.

1071. **[dart-mcp-server](https://github.com/its-dart/dart-mcp-server)** - ⭐ 122
   Dart AI Model Context Protocol (MCP) server

1072. **[codeql-mcp](https://github.com/JordyZomer/codeql-mcp)** - ⭐ 122
...
1073. **[A2A-MCP-Server](https://github.com/GongRzhe/A2A-MCP-Server)** - ⭐ 121
...
1074. **[mcp-server-bigquery](https://github.com/LucasHild/mcp-server-bigquery)** - ⭐ 120
   A Model Context Protocol server that provides access to BigQuery

1075. **[freecad_mcp](https://github.com/bonninr/freecad_mcp)** - ⭐ 120
...
1076. **[UnityMCP](https://github.com/isuzu-shiranui/UnityMCP)** - ⭐ 119
   Unity Editor integration with Model Context Protocol (MCP) enabling AI assistants like Claude to interact with Unity projects. Features a TypeScript MCP server and C# Unity plugin with extensible command handler architecture, TCP/IP communication, and dynamic plugin discovery.

1077. **[plane-mcp-server](https://github.com/makeplane/plane-mcp-server)** - ⭐ 119
   Plane's Official Model Context Protocol Server 🔌 ⌨️ 🔥

1078. **[MaxMSP-MCP-Server](https://github.com/tiianhk/MaxMSP-MCP-Server)** - ⭐ 119
   MCP (Model Context Protocol) Server for Max (Max/MSP/Jitter)

1079. **[mcp-server-odoo](https://github.com/ivnvxd/mcp-server-odoo)** - ⭐ 118
   A Model Context Protocol (MCP) server that enables AI assistants to securely interact with Odoo ERP systems through standardized resources and tools for data retrieval and manipulation.

1080. **[tiktok-mcp](https://github.com/Seym0n/tiktok-mcp)** - ⭐ 117
   Model Context Protocol (MCP) with TikTok integration

1081. **[ghost-mcp](https://github.com/MFYDev/ghost-mcp)** - ⭐ 117
   A Model Context Protocol (MCP) server for interacting with Ghost CMS through LLM interfaces like Claude. Allow you to control your Ghost blog by simply asking Claude etc.

1082. **[zig-mcp](https://github.com/zig-wasm/zig-mcp)** - ⭐ 116
   Model Context Protocol (MCP) server that provides up-to-date documentation for the Zig programming language standard library and builtin functions

1083. **[Frappe_Assistant_Core](https://github.com/buildswithpaul/Frappe_Assistant_Core)** - ⭐ 114
   Infrastructure that connects LLMs to ERPNext. Frappe Assistant Core works with the Model Context Protocol (MCP) to expose ERPNext functionality to any compatible Language Model

1084. **[cli](https://github.com/mcpgod/cli)** - ⭐ 113
   Fine-grained control over model context protocol (MCP) clients, servers, and tools. Context is God.

1085. **[AgentDNS-Node](https://github.com/jsjfai/AgentDNS-Node)** - ⭐ 113
...
1086. **[MCP2Lambda](https://github.com/danilop/MCP2Lambda)** - ⭐ 112
   Run any AWS Lambda function as a Large Language Model (LLM) tool without code changes using Anthropic's Model Context Protocol (MCP).

1087. **[jupyter-notebook-mcp](https://github.com/jjsantos01/jupyter-notebook-mcp)** - ⭐ 111
   A Model Context Protocol (MCP) for Jupyter Notebook

1088. **[notion-mcp](https://github.com/ccabanillas/notion-mcp)** - ⭐ 111
   A Model Context Protocol (MCP) server implementation for Notion integration, providing a standardized interface for interacting with Notion's API.

1089. **[mcp-watch](https://github.com/kapilduraphe/mcp-watch)** - ⭐ 111
   A comprehensive security scanner for Model Context Protocol (MCP) servers that detects vulnerabilities and security issues in your MCP server implementations.

1090. **[mcp-jfrog](https://github.com/jfrog/mcp-jfrog)** - ⭐ 110
   Model Context Protocol (MCP) Server for the JFrog Platform API, enabling repository management, build tracking, release lifecycle management, and more.

1091. **[mcp-hubspot](https://github.com/peakmojo/mcp-hubspot)** - ⭐ 110
   A Model Context Protocol (MCP) server that enables AI assistants to interact with HubSpot CRM data, providing built-in vector storage and caching mechanisms help overcome HubSpot API limitations while improving response times.

1092. **[intervals-mcp-server](https://github.com/mvilanova/intervals-mcp-server)** - ⭐ 110
   Model Context Protocol (MCP) server for connecting Claude and ChatGPT with the Intervals.icu API.

1093. **[foxy-contexts](https://github.com/strowk/foxy-contexts)** - ⭐ 109
   Foxy contexts is a library for building context servers supporting Model Context Protocol

1094. **[teslamate-mcp](https://github.com/cobanov/teslamate-mcp)** - ⭐ 109
   A Model Context Protocol (MCP) server that provides access to your TeslaMate database, allowing AI assistants to query Tesla vehicle data and analytics.

1095. **[OmniFocus-MCP](https://github.com/themotionmachine/OmniFocus-MCP)** - ⭐ 109
   Let LLMs interface with your tasks and projects through the Model Context Protocol. Add, organize, and query your OmniFocus database with natural language commands.

1096. **[iphone-mcp](https://github.com/Lakr233/iphone-mcp)** - ⭐ 108
...
1097. **[modex](https://github.com/theronic/modex)** - ⭐ 108
   Modex is a Clojure MCP Library to augment your AI models with Tools, Resources & Prompts using Clojure (Model Context Protocol). Implements MCP Server & Client.

1098. **[google-workspace-mcp](https://github.com/aaronsb/google-workspace-mcp)** - ⭐ 107
   A Model Context Protocol (MCP) server that provides authenticated access to Google Workspace APIs, offering integrated Authentication, Gmail, Calendar, and Drive functionality

1099. **[DINO-X-MCP](https://github.com/IDEA-Research/DINO-X-MCP)** - ⭐ 107
   Official DINO-X Model Context Protocol (MCP) server that empowers LLMs with real-world visual perception through image object detection, localization, and captioning APIs.

1100. **[obsidian-claude-code-mcp](https://github.com/iansinnott/obsidian-claude-code-mcp)** - ⭐ 107
   Connect Claude Code and other AI tools to your Obsidian notes using Model Context Protocol (MCP)

1101. **[paperless-mcp](https://github.com/nloui/paperless-mcp)** - ⭐ 106
   An MCP (Model Context Protocol) server for interacting with a Paperless-NGX API server. This server provides tools for managing documents, tags, correspondents, and document types in your Paperless-NGX instance.

1102. **[mcp-ts-template](https://github.com/cyanheads/mcp-ts-template)** - ⭐ 106
...
1103. **[SwiftMCP](https://github.com/Cocoanetics/SwiftMCP)** - ⭐ 106
   Model Context Protocol Server for Swift

1104. **[smileyCoin](https://github.com/fefergrgrgrg/smileyCoin)** - ⭐ 104
   simple web ui to manage mcp (model context protocol) servers in the claude app

1105. **[mcp-probe](https://github.com/conikeec/mcp-probe)** - ⭐ 104
   A Model Context Protocol (MCP) client library and debugging toolkit in Rust. This foundation provides both a production-ready SDK for building MCP integrations and the core architecture for an interactive debugger.

1106. **[xcodeproj-mcp-server](https://github.com/giginet/xcodeproj-mcp-server)** - ⭐ 104
   A Model Context Protocol Server to manipulate *.xcodeproj

1107. **[mcp](https://github.com/MariaDB/mcp)** - ⭐ 104
   MariaDB MCP (Model Context Protocol) server implementation

1108. **[gemini-desktop](https://github.com/kkrishnan90/gemini-desktop)** - ⭐ 103
...
1109. **[mcp-tool-kit](https://github.com/getfounded/mcp-tool-kit)** - ⭐ 103
   Agentic abstraction layer for building high precision vertical AI agents written in python for Model Context Protocol.

1110. **[Fabric-Analytics-MCP](https://github.com/santhoshravindran7/Fabric-Analytics-MCP)** - ⭐ 102
...
1111. **[aks-mcp](https://github.com/Azure/aks-mcp)** - ⭐ 102
   A Model Context Protocol (MCP) server that enables AI assistants to interact with AKS clusters. It serves as a bridge between AI tools (like Claude, Cursor, and GitHub Copilot) and AKS.

1112. **[netbox-mcp-server](https://github.com/netboxlabs/netbox-mcp-server)** - ⭐ 102
   Model Context Protocol (MCP) server for read-only interaction with NetBox data in LLMs

1113. **[Easy-MCP-AutoCad](https://github.com/zh19980811/Easy-MCP-AutoCad)** - ⭐ 102
   这个项目是一个基于Model Context Protocol (MCP)的AutoCAD集成服务器，它允许通过自然语言与AutoCAD进行交互。通过这个服务器，用户可以使用Claude等大型语言模型来创建、修改和分析AutoCAD图纸，同时还可以存储和查询CAD元素的相关数据。目前制作参考学习，仅实现端到端之间的通信，具体工具函数尚未晚上

1114. **[memory-mcp-server](https://github.com/okooo5km/memory-mcp-server)** - ⭐ 102
   A Model Context Protocol server that provides knowledge graph management capabilities. 

1115. **[awesome-context-engineering](https://github.com/jihoo-kim/awesome-context-engineering)** - ⭐ 101
...
1116. **[easy-code-reader](https://github.com/FangYuan33/easy-code-reader)** - ⭐ 101
   A powerful MCP (Model Context Protocol) server for intelligently reading Java source code.

1117. **[erickwendel-contributions-mcp](https://github.com/ErickWendel/erickwendel-contributions-mcp)** - ⭐ 100
   A Model Context Protocol (MCP) server that provides tools to query Erick Wendel's contributions across different platforms

1118. **[a2a-mcp-tutorial](https://github.com/Tsadoq/a2a-mcp-tutorial)** - ⭐ 100
   A tutorial on how to use Model Context Protocol by Anthropic and Agent2Agent Protocol by Google

1119. **[deep-code-reasoning-mcp](https://github.com/haasonsaas/deep-code-reasoning-mcp)** - ⭐ 99
   A Model Context Protocol (MCP) server that provides advanced code analysis and reasoning capabilities powered by Google's Gemini AI

1120. **[mcp-typescript-sdk](https://github.com/emqx/mcp-typescript-sdk)** - ⭐ 98
   A TypeScript SDK for implementing Model Context Protocol (MCP) over MQTT, supporting both browser and Node.js environments.

1121. **[mcp-kit](https://github.com/my-mcp-hub/mcp-kit)** - ⭐ 98
   A CLI tool to create MCP (Model Context Protocol) applications with ease.

1122. **[mcp-prompts](https://github.com/sparesparrow/mcp-prompts)** - ⭐ 98
   Model Context Protocol server for managing, storing, and providing prompts and prompt templates for LLM interactions. 

1123. **[sample-agentic-ai-demos](https://github.com/aws-samples/sample-agentic-ai-demos)** - ⭐ 98
   Collection of examples of how to use Model Context Protocol with AWS.

1124. **[strudel-mcp-server](https://github.com/williamzujkowski/strudel-mcp-server)** - ⭐ 98
   A Model Context Protocol (MCP) server that gives Claude direct control over Strudel.cc for AI-assisted music generation and live coding.

1125. **[infobus-mcp](https://github.com/simovilab/infobus-mcp)** - ⭐ 97
   Model Context Protocol server enabling AI assistants to access transit information through standardized interfaces

1126. **[mcp_on_ruby](https://github.com/rubyonai/mcp_on_ruby)** - ⭐ 97
   💎 A Ruby implementation of the Model Context Protocol

1127. **[mcp-victoriametrics](https://github.com/VictoriaMetrics-Community/mcp-victoriametrics)** - ⭐ 97
   The implementation of Model Context Protocol (MCP) server for VictoriaMetrics

1128. **[mcp-client-nodejs](https://github.com/ConardLi/mcp-client-nodejs)** - ⭐ 96
   Node.js Client Implementation for Model Context Protocol (MCP)

1129. **[all-in-one-model-context-protocol](https://github.com/nguyenvanduocit/all-in-one-model-context-protocol)** - ⭐ 96
   🚀 All-in-one MCP server with AI search, RAG, and multi-service integrations (GitLab/Jira/Confluence/YouTube) for AI-enhanced development workflows

1130. **[sqlite-explorer-fastmcp-mcp-server](https://github.com/hannesrudolph/sqlite-explorer-fastmcp-mcp-server)** - ⭐ 96
   An MCP server that provides safe, read-only access to SQLite databases through Model Context Protocol (MCP). This server is built with the FastMCP framework, which enables LLMs to explore and query SQLite databases with built-in safety features and query validation.

1131. **[gtasks-mcp](https://github.com/zcaceres/gtasks-mcp)** - ⭐ 96
   A Google Tasks Model Context Protocol Server for Claude

1132. **[mcp-local-rag](https://github.com/nkapila6/mcp-local-rag)** - ⭐ 95
   "primitive" RAG-like web search model context protocol (MCP) server that runs locally. ✨ no APIs ✨

1133. **[mcp-virustotal](https://github.com/BurtTheCoder/mcp-virustotal)** - ⭐ 95
   A Model Context Protocol (MCP) server for querying the VirusTotal API.

1134. **[awesome-mcp-enterprise](https://github.com/bh-rat/awesome-mcp-enterprise)** - ⭐ 94
   A curated list of awesome MCP (Model Context Protocol) tools, platforms, and services for enterprises.

1135. **[server-google-news](https://github.com/ChanMeng666/server-google-news)** - ⭐ 94
   【Star-crossed coders unite!⭐️】Model Context Protocol (MCP) server implementation providing Google News search capabilities via SerpAPI, with automatic news categorization and multi-language support.

1136. **[MiniMax-MCP-JS](https://github.com/MiniMax-AI/MiniMax-MCP-JS)** - ⭐ 94
   Official MiniMax Model Context Protocol (MCP) JavaScript implementation that provides seamless integration with MiniMax's powerful AI capabilities including image generation, video generation, text-to-speech, and voice cloning APIs.

1137. **[systemprompt-mcp-server](https://github.com/systempromptio/systemprompt-mcp-server)** - ⭐ 94
...
1138. **[mcp-windows-desktop-automation](https://github.com/mario-andreschak/mcp-windows-desktop-automation)** - ⭐ 94
   A Model Context Protocol (MCP) server for Windows desktop automation using AutoIt.

1139. **[swiftlens](https://github.com/swiftlens/swiftlens)** - ⭐ 94
...
1140. **[terminal-controller-mcp](https://github.com/GongRzhe/terminal-controller-mcp)** - ⭐ 93
   A Model Context Protocol (MCP) server that enables secure terminal command execution, directory navigation, and file system operations through a standardized interface.

1141. **[MasterMCP](https://github.com/slowmist/MasterMCP)** - ⭐ 93
...
1142. **[mcp-checkpoint](https://github.com/aira-security/mcp-checkpoint)** - ⭐ 93
...
1143. **[ableton-mcp-extended](https://github.com/uisato/ableton-mcp-extended)** - ⭐ 92
   Ableton Live MCP (Model Context Protocol) server that allows control directly through AI assistants.

1144. **[ruby-mcp-client](https://github.com/simonx1/ruby-mcp-client)** - ⭐ 91
   This is a Ruby implementation of MCP (Model Context Protocol) client

1145. **[mcp-replicate](https://github.com/deepfates/mcp-replicate)** - ⭐ 91
   Model Context Protocol server for Replicate's API

1146. **[searxng-mul-mcp](https://github.com/jae-jae/searxng-mul-mcp)** - ⭐ 91
   A Model Context Protocol (MCP) server for SearXNG search engine with multi-query parallel search support

1147. **[mcp-server](https://github.com/webflow/mcp-server)** - ⭐ 89
   Model Context Protocol (MCP) server for the Webflow Data API.

1148. **[square-mcp-server](https://github.com/square/square-mcp-server)** - ⭐ 89
   A Model Context Protocol (MCP) server for square

1149. **[mcp-web-ui](https://github.com/MegaGrindStone/mcp-web-ui)** - ⭐ 88
   MCP Web UI is a web-based user interface that serves as a Host within the Model Context Protocol (MCP) architecture. It provides a powerful and user-friendly interface for interacting with Large Language Models (LLMs) while managing context aggregation and coordination between clients and servers.

1150. **[mcp-server-gsc](https://github.com/ahonn/mcp-server-gsc)** - ⭐ 87
   A Model Context Protocol (MCP) server providing access to Google Search Console

1151. **[sandbox-mcp](https://github.com/pottekkat/sandbox-mcp)** - ⭐ 87
   A Model Context Protocol (MCP) server that enables LLMs to run ANY code safely in isolated Docker containers.

1152. **[mcp-server-idapro](https://github.com/fdrechsler/mcp-server-idapro)** - ⭐ 87
   A Model Context Protocol (MCP) server that enables AI assistants to interact with IDA Pro for reverse engineering and binary analysis tasks.

1153. **[mcp-ui](https://github.com/machaojin1917939763/mcp-ui)** - ⭐ 86
   基于MCP(Model Context Protocol)的智能聊天应用，支持Web和桌面环境。集成OpenAI/Anthropic API，提供MCP服务器的所有工具能力。简洁现代的UI设计，支持跨平台部署。

1154. **[pluggedin-app](https://github.com/VeriTeknik/pluggedin-app)** - ⭐ 86
   The Crossroads for AI Data Exchanges. A unified, self-hostable web interface for discovering, configuring, and managing Model Context Protocol (MCP) servers—bringing together AI tools, workspaces, prompts, and logs from multiple MCP sources (Claude, Cursor, etc.) under one roof.

1155. **[typst-mcp](https://github.com/johannesbrandenburger/typst-mcp)** - ⭐ 86
   Typst MCP Server is an MCP (Model Context Protocol) implementation that helps AI models interact with Typst, a markup-based typesetting system. The server provides tools for converting between LaTeX and Typst, validating Typst syntax, and generating images from Typst code.

1156. **[mcp-trino](https://github.com/tuannvm/mcp-trino)** - ⭐ 86
   A high-performance Model Context Protocol (MCP) server for Trino implemented in Go.

1157. **[molecule-mcp](https://github.com/ChatMol/molecule-mcp)** - ⭐ 85
   A model-context-protocol server for molecules.

1158. **[github-stars](https://github.com/ccbikai/github-stars)** - ⭐ 85
   A Cloudflare-powered MCP (Model Context Protocol) Server that allows you to search and query your GitHub starred repositories using natural language.

1159. **[github-stars](https://github.com/miantiao-me/github-stars)** - ⭐ 85
   A Cloudflare-powered MCP (Model Context Protocol) Server that allows you to search and query your GitHub starred repositories using natural language.

1160. **[JavaSinkTracer_MCP](https://github.com/Zacarx/JavaSinkTracer_MCP)** - ⭐ 85
   基于函数级污点分析的 Java 源代码漏洞审计工具JavaSinkTracer，通过 Model Context Protocol (MCP) 为 AI 助手提供安全分析能力。

1161. **[opencv-mcp-server](https://github.com/GongRzhe/opencv-mcp-server)** - ⭐ 84
...
1162. **[ragie-mcp-server](https://github.com/ragieai/ragie-mcp-server)** - ⭐ 83
   Ragie Model Context Protocol Server

1163. **[mcp-graphiti](https://github.com/rawr-ai/mcp-graphiti)** - ⭐ 83
   Graphiti Model Context Protocol (MCP) Server - An MCP server for knowledge graph management via Graphiti

1164. **[memory-mcp-server-go](https://github.com/okooo5km/memory-mcp-server-go)** - ⭐ 83
   A Model Context Protocol server that provides knowledge graph management capabilities.

1165. **[Financial-Modeling-Prep-MCP-Server](https://github.com/imbenrabi/Financial-Modeling-Prep-MCP-Server)** - ⭐ 83
   A Model Context Protocol (MCP) implementation for Financial Modeling Prep, enabling AI assistants to access and analyze financial data, stock information, company fundamentals, and market insights.

1166. **[openai-gpt-image-mcp](https://github.com/SureScaleAI/openai-gpt-image-mcp)** - ⭐ 82
   A Model Context Protocol (MCP) tool server for OpenAI's GPT-4o/gpt-image-1 image generation and editing APIs.

1167. **[Awesome-Claude-MCP-Servers](https://github.com/win4r/Awesome-Claude-MCP-Servers)** - ⭐ 82
   A curated list of Model Context Protocol (MCP) servers optimized for Claude AI assistants.

1168. **[node-candidate-mcp-server](https://github.com/jhgaylor/node-candidate-mcp-server)** - ⭐ 82
   A Model Context Protocol (MCP) server library that gives LLMs access to information about a candidate.

1169. **[gis-mcp](https://github.com/mahdin75/gis-mcp)** - ⭐ 82
   A Model Context Protocol (MCP) server implementation that connects Large Language Models (LLMs) to GIS operations using GIS libraries, enabling AI assistants to perform geospatial operations and transformations.

1170. **[splunk-mcp](https://github.com/livehybrid/splunk-mcp)** - ⭐ 82
   A Model Context Protocol (MCP) implementation for Splunk Enterprise and Cloud integration with Cursor IDE or Claude

1171. **[mcp-server](https://github.com/keboola/mcp-server)** - ⭐ 81
   Model Context Protocol (MCP) Server for the Keboola Platform

1172. **[mcp-rs-template](https://github.com/linux-china/mcp-rs-template)** - ⭐ 81
   Model Context Protocol (MCP) CLI server template for Rust

1173. **[sh-disney-mcp](https://github.com/syyuan14/sh-disney-mcp)** - ⭐ 81
   sh-disney-mcp 是一个基于 Model Context Protocol (MCP) 的mcp server，旨在通过标准化的接口，帮助大模型快速获取上海迪士尼乐园的门票价格和售卖状态信息

1174. **[model-context-protocol-mcp-hands-on-with-agentic-ai-2034200](https://github.com/LinkedInLearning/model-context-protocol-mcp-hands-on-with-agentic-ai-2034200)** - ⭐ 81
...
1175. **[mcphub](https://github.com/Cognitive-Stack/mcphub)** - ⭐ 79
...
1176. **[anki-mcp-server](https://github.com/CamdenClark/anki-mcp-server)** - ⭐ 78
   A model context protocol server that connects to Anki through AnkiConnect

1177. **[legion-mcp](https://github.com/TheRaLabs/legion-mcp)** - ⭐ 78
   A server that helps people access and query data in databases using the Legion Query Runner with Model Context Protocol (MCP) in Python.

1178. **[identity](https://github.com/agntcy/identity)** - ⭐ 78
...
1179. **[aws-security-mcp](https://github.com/groovyBugify/aws-security-mcp)** - ⭐ 78
   A Model Context Protocol server that connects AI assistants like Claude to AWS security services, allowing them to autonomously query, inspect, and analyze AWS infrastructure for security issues and misconfigurations.

1180. **[mcp-memory-libsql](https://github.com/spences10/mcp-memory-libsql)** - ⭐ 78
   🧠 High-performance persistent memory system for Model Context Protocol (MCP) powered by libSQL. Features vector search, semantic knowledge storage, and efficient relationship management - perfect for AI agents and knowledge graph applications.

1181. **[office-editor-mcp](https://github.com/theWDY/office-editor-mcp)** - ⭐ 78
   基于MCP(Model Context Protocol)的Office文档处理助手，支持在MCP Client中创建和编辑Word、Excel、Powerpoint文档。

1182. **[mcp-azure-devops](https://github.com/Vortiago/mcp-azure-devops)** - ⭐ 77
   A Model Context Protocol (MCP) server enabling AI assistants to interact with Azure DevOps services via Python SDK.

1183. **[deepl-mcp-server](https://github.com/DeepLcom/deepl-mcp-server)** - ⭐ 77
   A Model Context Protocol (MCP) server that provides translation capabilities using the DeepL API.

1184. **[mcp-excel-server](https://github.com/yzfly/mcp-excel-server)** - ⭐ 76
...
1185. **[pinescript-mcp-server](https://github.com/cklose2000/pinescript-mcp-server)** - ⭐ 76
   A Model Context Protocol (MCP) server for working with TradingView PineScript

1186. **[dicom-mcp](https://github.com/ChristianHinge/dicom-mcp)** - ⭐ 75
   Model Context Protocol (MCP) for interacting with dicom servers (PACS etc.)

1187. **[sample-agents-with-nova-act-and-mcp](https://github.com/aws-samples/sample-agents-with-nova-act-and-mcp)** - ⭐ 75
...
1188. **[jvm-mcp-server](https://github.com/xzq-xu/jvm-mcp-server)** - ⭐ 75
   This is an implementation project of a JVM-based MCP (Model Context Protocol) server. The project aims to provide a standardized MCP server implementation for the JVM platform, enabling AI models to better interact with the Java ecosystem.

1189. **[github-chat-mcp](https://github.com/AsyncFuncAI/github-chat-mcp)** - ⭐ 75
   A Model Context Protocol (MCP) for analyzing and querying GitHub repositories using the GitHub Chat API.

1190. **[IB_MCP](https://github.com/rcontesti/IB_MCP)** - ⭐ 75
   This project provides an Interactive Brokers (IB) API interface using the Model Context Protocol (MCP).

1191. **[mcp-monitor](https://github.com/seekrays/mcp-monitor)** - ⭐ 75
   A system monitoring tool that exposes system metrics via the Model Context Protocol (MCP). This tool allows LLMs to retrieve real-time system information through an MCP-compatible interface.

1192. **[tester-mcp-client](https://github.com/apify/tester-mcp-client)** - ⭐ 74
   Model Context Protocol (MCP) Client for Apify's Actors

1193. **[NASA-MCP-server](https://github.com/ProgramComputer/NASA-MCP-server)** - ⭐ 74
   A Model Context Protocol (MCP) server for NASA APIs, providing a standardized interface for AI models to interact with NASA's vast array of data sources.

1194. **[mcp-kafka](https://github.com/kanapuli/mcp-kafka)** - ⭐ 74
   A Model Context Protocol Server to perform Kafka client operations

1195. **[woocommerce-mcp-server](https://github.com/techspawn/woocommerce-mcp-server)** - ⭐ 73
   A WooCommerce (MCP) Model Context Protocol server

1196. **[youtrack-mcp](https://github.com/tonyzorin/youtrack-mcp)** - ⭐ 73
...
1197. **[codeglide-mcpgen](https://github.com/CodeGlide/codeglide-mcpgen)** - ⭐ 73
   Generation of Secure MCP (Model Context Protocol) Servers from API source code at Scale

1198. **[mcp-server-circleci](https://github.com/CircleCI-Public/mcp-server-circleci)** - ⭐ 73
   A specialized server implementation for the Model Context Protocol (MCP) designed to integrate with CircleCI's development workflow. This project serves as a bridge between CircleCI's infrastructure and the Model Context Protocol, enabling enhanced AI-powered development experiences.

1199. **[Delphi-MCP-Server](https://github.com/GDKsoftware/Delphi-MCP-Server)** - ⭐ 73
   Native Delphi Server implementation of the Model Context Protocol (MCP)

1200. **[rust-mcp-schema](https://github.com/rust-mcp-stack/rust-mcp-schema)** - ⭐ 72
   A type-safe implementation of the official Model Context Protocol (MCP) schema in Rust.

1201. **[imessage-query-fastmcp-mcp-server](https://github.com/hannesrudolph/imessage-query-fastmcp-mcp-server)** - ⭐ 71
   An MCP server that provides safe access to your iMessage database through Model Context Protocol (MCP). This server is built with the FastMCP framework and the imessagedb library, enabling LLMs to query and analyze iMessage conversations with proper phone number validation and attachment handling.

1202. **[ChEMBL-MCP-Server](https://github.com/Augmented-Nature/ChEMBL-MCP-Server)** - ⭐ 71
   A comprehensive Model Context Protocol (MCP) server providing advanced access to the ChEMBL chemical database.

1203. **[google-cloud-mcp](https://github.com/krzko/google-cloud-mcp)** - ⭐ 71
   🤖 A Model Context Protocol (MCP) server for Google Cloud (GCP)

1204. **[cve-search_mcp](https://github.com/roadwy/cve-search_mcp)** - ⭐ 71
   A Model Context Protocol (MCP) server for querying the CVE-Search API

1205. **[codebase-mcp](https://github.com/DeDeveloper23/codebase-mcp)** - ⭐ 70
   Model Context Protocol implementation for retrieving codebases using RepoMix

1206. **[choturobo](https://github.com/vishalmysore/choturobo)** - ⭐ 70
...
1207. **[healthcare-mcp-public](https://github.com/Cicatriiz/healthcare-mcp-public)** - ⭐ 70
   A Model Context Protocol (MCP) server providing AI assistants with access to healthcare data and medical information tools, including FDA drug info, PubMed, medRxiv, NCBI Bookshelf, clinical trials, ICD-10, DICOM metadata, and a medical calculator.

1208. **[airtable-mcp](https://github.com/felores/airtable-mcp)** - ⭐ 69
   Search, create and update Airtable bases, tables, fields, and records using Claude Desktop and MCP (Model Context Protocol) clients

1209. **[mcp-sqlite](https://github.com/jparkerweb/mcp-sqlite)** - ⭐ 69
   🐇 Model Context Protocol (MCP) server that provides comprehensive SQLite database interaction capabilities

1210. **[MCP-server-Deepseek_R1](https://github.com/66julienmartin/MCP-server-Deepseek_R1)** - ⭐ 68
   A Model Context Protocol (MCP) server implementation connecting Claude Desktop with DeepSeek's language models (R1/V3)

1211. **[ccxt-mcp](https://github.com/lazy-dinosaur/ccxt-mcp)** - ⭐ 68
   CCXT MCP Server bridges the gap between AI models and cryptocurrency trading by providing a standardized interface through the Model Context Protocol. Created to empower automated trading strategies, this tool allows AI assistants like Claude and GPT to directly interact with over 100 cryptocurrency exchanges without requiring users to write comple

1212. **[agentic-tools-mcp](https://github.com/Pimzino/agentic-tools-mcp)** - ⭐ 67
   A comprehensive Model Context Protocol (MCP) server providing AI assistants with powerful task management and agent memories capabilities with project-specific storage.

1213. **[MCPhoenix](https://github.com/jmanhype/MCPhoenix)** - ⭐ 67
   A simplified implementation of the Model Context Protocol (MCP) server using Elixir's Phoenix Framework.

1214. **[mcp_gradio_client](https://github.com/justjoehere/mcp_gradio_client)** - ⭐ 67
   This is a proof of concept repo on how to create a gradio UI using the Model Context Protocol Client Python SDK.

1215. **[gmail-mcp-server](https://github.com/jasonsum/gmail-mcp-server)** - ⭐ 67
   Model Context Protocol (MCP) server for Gmail

1216. **[mcp-metatrader5-server](https://github.com/Qoyyuum/mcp-metatrader5-server)** - ⭐ 67
...
1217. **[optuna-mcp](https://github.com/optuna/optuna-mcp)** - ⭐ 66
   The Optuna MCP Server is a Model Context Protocol (MCP) server to interact with Optuna APIs.

1218. **[deepview-mcp](https://github.com/ai-1st/deepview-mcp)** - ⭐ 66
   DeepView MCP is a Model Context Protocol server that enables IDEs like Cursor and Windsurf to analyze large codebases using Gemini 2.5 Pro's extensive context window.

1219. **[wecom-bot-mcp-server](https://github.com/loonghao/wecom-bot-mcp-server)** - ⭐ 66
...
1220. **[OmniMCP](https://github.com/OpenAdaptAI/OmniMCP)** - ⭐ 65
   OmniMCP uses Microsoft OmniParser and Model Context Protocol (MCP) to provide AI models with rich UI context and powerful interaction capabilities.

1221. **[Mureka-mcp](https://github.com/SkyworkAI/Mureka-mcp)** - ⭐ 65
   generate lyrics, song and background music(instrumental). Model Context Protocol (MCP) server.

1222. **[piapi-mcp-server](https://github.com/apinetwork/piapi-mcp-server)** - ⭐ 65
   A TypeScript implementation of a Model Context Protocol (MCP) server that integrates with PiAPI's API. PiAPI makes user able to generate media content with Midjourney/Flux/Kling/LumaLabs/Udio/Chrip/Trellis directly from Claude or any other MCP-compatible apps.

1223. **[mcp-server-email](https://github.com/Shy2593666979/mcp-server-email)** - ⭐ 65
...
1224. **[mcp-server-datahub](https://github.com/acryldata/mcp-server-datahub)** - ⭐ 65
   The official Model Context Protocol (MCP) server for DataHub (https://datahub.com)

1225. **[uml-mcp](https://github.com/antoinebou12/uml-mcp)** - ⭐ 64
...
1226. **[lsd-mcp](https://github.com/lsd-so/lsd-mcp)** - ⭐ 64
   LSD Model Context Protocol

1227. **[raindrop-io-mcp-server](https://github.com/hiromitsusasaki/raindrop-io-mcp-server)** - ⭐ 64
   An integration that allows LLMs to interact with Raindrop.io bookmarks using the Model Context Protocol (MCP).

1228. **[svelte5-mcp](https://github.com/StudentOfJS/svelte5-mcp)** - ⭐ 64
   A specialized Model Context Protocol (MCP) server for Svelte 5 frontend development

1229. **[HopperMCP](https://github.com/MxIris-Reverse-Engineering/HopperMCP)** - ⭐ 64
   A Model Context Protocol server for Hopper Disassembler

1230. **[mcp-outline](https://github.com/Vortiago/mcp-outline)** - ⭐ 64
   A Model Context Protocol (MCP) server enabling AI assistants to interact with Outline documentation services.

1231. **[community-servers](https://github.com/mcp-get/community-servers)** - ⭐ 63
...
1232. **[markitdown_mcp_server](https://github.com/KorigamiK/markitdown_mcp_server)** - ⭐ 63
   A Model Context Protocol (MCP) server that converts various file formats to Markdown using the MarkItDown utility.

1233. **[vibe-blocks-mcp](https://github.com/majidmanzarpour/vibe-blocks-mcp)** - ⭐ 63
...
1234. **[BurpSuite-MCP-Server](https://github.com/X3r0K/BurpSuite-MCP-Server)** - ⭐ 63
   BurpSuite MCP Server:  A powerful Model Context Protocol (MCP) server implementation for BurpSuite, providing programmatic access to Burp's core functionalities.

1235. **[m3](https://github.com/rafiattrach/m3)** - ⭐ 63
...
1236. **[QuickMCP](https://github.com/gunpal5/QuickMCP)** - ⭐ 63
   Effortlessly Build Model Context Protocol Servers with OpenAPI or Swagger or Google Discovery Specifications

1237. **[loki-mcp](https://github.com/grafana/loki-mcp)** - ⭐ 63
   An MCP ( Model Context Protocol ) Server for Grafana Loki

1238. **[mcp-fal](https://github.com/am0y/mcp-fal)** - ⭐ 62
   A Model Context Protocol (MCP) server for interacting with fal.ai models and services.

1239. **[usolver](https://github.com/sdiehl/usolver)** - ⭐ 62
   A model context protocol server for solving combinatorial optimization problems with logical and numerical constraints.

1240. **[mcp-velociraptor](https://github.com/mgreen27/mcp-velociraptor)** - ⭐ 62
   VelociraptorMCP is a Model Context Protocol bridge for exposing LLMs to MCP clients.

1241. **[boilerplate-mcp-server](https://github.com/aashari/boilerplate-mcp-server)** - ⭐ 62
   TypeScript Model Context Protocol (MCP) server boilerplate providing IP lookup tools/resources. Includes CLI support and extensible structure for connecting AI systems (LLMs) to external data sources like ip-api.com. Ideal template for creating new MCP integrations via Node.js.

1242. **[mcp](https://github.com/vuetifyjs/mcp)** - ⭐ 62
   🤖 A Model Context Protocol (MCP) library for use with Agentic chat bots

1243. **[mcp-fhir](https://github.com/flexpa/mcp-fhir)** - ⭐ 62
   A Model Context Protocol implementation for FHIR

1244. **[contentful-mcp](https://github.com/ivo-toby/contentful-mcp)** - ⭐ 61
   MCP (Model Context Protocol) server for the Contentful Management API

1245. **[mcp-sdk](https://github.com/AntigmaLabs/mcp-sdk)** - ⭐ 61
   Minimalistic Rust Implementation Of Model Context Protocol from Anthropic

1246. **[mcpr](https://github.com/devOpifex/mcpr)** - ⭐ 61
   Model Context Protocol server and client for R

1247. **[voice-mcp-agent](https://github.com/den-vasyliev/voice-mcp-agent)** - ⭐ 61
...
1248. **[nutrient-dws-mcp-server](https://github.com/PSPDFKit/nutrient-dws-mcp-server)** - ⭐ 61
   A Model Context Protocol (MCP) server implementation that integrates with the Nutrient Document Web Service (DWS) Processor API, providing powerful PDF processing capabilities for AI assistants.

1249. **[mcp-tutorials](https://github.com/chenmingyong0423/mcp-tutorials)** - ⭐ 61
   Model Context Protocol(MCP) 中文教程讲解

1250. **[mcp-jenkins](https://github.com/lanbaoshen/mcp-jenkins)** - ⭐ 61
   The Model Context Protocol (MCP) is an open-source implementation that bridges Jenkins with AI language models following Anthropic's MCP specification. This project enables secure, contextual AI interactions with Jenkins tools while maintaining data privacy and security.

1251. **[anubis-mcp](https://github.com/zoedsoupe/anubis-mcp)** - ⭐ 61
   Elixir Model Context Protocol (MCP) SDK (hermes-mcp fork)

1252. **[ocaml-mcp-sdk](https://github.com/bmorphism/ocaml-mcp-sdk)** - ⭐ 60
   OCaml SDK for Model Context Protocol using Jane Street's oxcaml_effect library

1253. **[ollama-mcp-db](https://github.com/robdodson/ollama-mcp-db)** - ⭐ 60
...
1254. **[bitbucket-mcp](https://github.com/MatanYemini/bitbucket-mcp)** - ⭐ 60
   Bitbucket MCP - A Model Context Protocol (MCP) server for integrating with Bitbucket Cloud and Server APIs

1255. **[mcp-miro](https://github.com/k-jarzyna/mcp-miro)** - ⭐ 59
   Miro integration for Model Context Protocol

1256. **[daipendency-mcp](https://github.com/daipendency/daipendency-mcp)** - ⭐ 59
   Model Context Protocol server for Daipendency

1257. **[rember-mcp](https://github.com/rember/rember-mcp)** - ⭐ 59
   A Model Context Protocol (MCP) server for Rember.

1258. **[mcp-server-okppt](https://github.com/NeekChaw/mcp-server-okppt)** - ⭐ 59
...
1259. **[CanvasMCPClient](https://github.com/n00bvn/CanvasMCPClient)** - ⭐ 59
   Canvas MCP Client is an open-source, self-hostable dashboard application built around an infinite, zoomable, and pannable canvas. It provides a unified interface for interacting with multiple MCP (Model Context Protocol) servers through a flexible, widget-based system.

1260. **[FNewsCrawler](https://github.com/noimank/FNewsCrawler)** - ⭐ 59
   一个专门为大模型设计的财经信息MCP（Model Context Protocol）服务，通过高效的爬虫技术从各大财经网站（同花顺、东方财富等）获取实时资讯，为AI模型提供准确、及时的财经数据支持。

1261. **[mcp-hub](https://github.com/lobstercare/mcp-hub)** - ⭐ 58
   A curated list of awesome Model Context Protocol (MCP) servers.

1262. **[mcp_zoomeye](https://github.com/zoomeye-ai/mcp_zoomeye)** - ⭐ 58
   A Model Context Protocol server that provides network asset information based on query conditions. This server allows LLMs to obtain network asset information and supports querying network asset information by zoomeye dork etc.

1263. **[mcp-server-axiom](https://github.com/axiomhq/mcp-server-axiom)** - ⭐ 58
   Axiom Model Context Protocol Server

1264. **[mcp-cn](https://github.com/mengjian-github/mcp-cn)** - ⭐ 58
...
1265. **[junos-mcp-server](https://github.com/Juniper/junos-mcp-server)** - ⭐ 57
...
1266. **[mcp-gemini-search](https://github.com/arjunprabhulal/mcp-gemini-search)** - ⭐ 57
   Model Context Protocol (MCP) with Gemini 2.5 Pro. Convert conversational queries into flight searches using Gemini's function calling capabilities and MCP's flight search tools

1267. **[mcp-think-tank](https://github.com/flight505/mcp-think-tank)** - ⭐ 57
...
1268. **[chess-mcp](https://github.com/pab1it0/chess-mcp)** - ⭐ 57
   A Model Context Protocol server for Chess.com's Published Data API.  This provides access to Chess.com player data, game records, and other public information through standardized MCP interfaces, allowing AI assistants to search and analyze chess information.

1269. **[create-mcp-app](https://github.com/boguan/create-mcp-app)** - ⭐ 57
   A CLI tool for quickly scaffolding Model Context Protocol (MCP) server applications with TypeScript support and modern development tooling

1270. **[mcp-hetzner](https://github.com/dkruyt/mcp-hetzner)** - ⭐ 57
   A Model Context Protocol (MCP) server for interacting with the Hetzner Cloud API. This server allows language models to manage Hetzner Cloud resources through structured functions.

1271. **[AllVoiceLab-MCP](https://github.com/allvoicelab/AllVoiceLab-MCP)** - ⭐ 56
...
1272. **[nutrient-document-engine-mcp-server](https://github.com/PSPDFKit/nutrient-document-engine-mcp-server)** - ⭐ 56
   A Model Context Protocol (MCP) server implementation exposes document processing capabilities through natural language, supporting both direct human interaction and AI agent tool calling.

1273. **[perfetto-mcp](https://github.com/antarikshc/perfetto-mcp)** - ⭐ 56
...
1274. **[mobile-mcp](https://github.com/runablehq/mobile-mcp)** - ⭐ 56
   A Model Context Protocol (MCP) server that provides mobile automation capabilities.

1275. **[umbraco-mcp](https://github.com/Matthew-Wise/umbraco-mcp)** - ⭐ 55
   A model context protocol  (MCP) server for Umbraco 

1276. **[mkp](https://github.com/StacklokLabs/mkp)** - ⭐ 55
   MKP is a Model Context Protocol (MCP) server for Kubernetes

1277. **[airtable-mcp](https://github.com/rashidazarang/airtable-mcp)** - ⭐ 55
   Airtable integration for AI-powered applications via Anthropic's Model Context Protocol (MCP)

1278. **[actual-mcp](https://github.com/s-stefanov/actual-mcp)** - ⭐ 55
   Model Context Protocol for Actual Budget API

1279. **[mcp-servers](https://github.com/pulsemcp/mcp-servers)** - ⭐ 55
   MCP (Model Context Protocol) Servers authored and maintained by the PulseMCP team. We build reliable servers thoughtfully designed specifically for MCP Client-powered workflows.

1280. **[mcp-wolframalpha](https://github.com/akalaric/mcp-wolframalpha)** - ⭐ 55
   A Python-powered Model Context Protocol MCP server and client that uses Wolfram Alpha via API.

1281. **[x64dbgMCP](https://github.com/Wasdubya/x64dbgMCP)** - ⭐ 55
   Model Context Protocol for x64dbg & x32dbg

1282. **[openai-mcp-client](https://github.com/ResoluteError/openai-mcp-client)** - ⭐ 54
   A rudimentary implementation of Anthropic's Model Context Protocol with OpenAIs Model

1283. **[mcp-headless-gmail](https://github.com/baryhuang/mcp-headless-gmail)** - ⭐ 54
   A MCP (Model Context Protocol) server that provides get, send Gmails without local credential or token setup.

1284. **[math-mcp](https://github.com/EthanHenrickson/math-mcp)** - ⭐ 54
   A Model Context Protocol (MCP) server that provides basic mathematical and statistical functions to Large Language Models (LLMs). This server enables LLMs to perform accurate numerical calculations through a simple API.

1285. **[ig-mcp](https://github.com/jlbadano/ig-mcp)** - ⭐ 54
...
1286. **[mcp-server-azure-ai-agents](https://github.com/farzad528/mcp-server-azure-ai-agents)** - ⭐ 53
   Model Context Protocol Servers for Azure AI Search

1287. **[mono-mcp](https://github.com/sin4ch/mono-mcp)** - ⭐ 53
   A comprehensive Model Context Protocol (MCP) server for Nigerian banking operations using the Mono Open Banking API.

1288. **[ashra-mcp](https://github.com/getrupt/ashra-mcp)** - ⭐ 53
   A Model Context Protocol server for Ashra

1289. **[gomcp](https://github.com/llmcontext/gomcp)** - ⭐ 52
   Unofficial Golang SDK for Anthropic Model Context Protocol

1290. **[mcp-client-capabilities](https://github.com/apify/mcp-client-capabilities)** - ⭐ 52
   Index of all Model Context Protocol (MCP) clients and their capabilities

1291. **[mcp-gopls](https://github.com/hloiseau/mcp-gopls)** - ⭐ 52
   Model Context Protocol (MCP) server for Go using gopls – LSP-powered analysis, tests, coverage, and tooling.

1292. **[clarity-mcp-server](https://github.com/microsoft/clarity-mcp-server)** - ⭐ 52
   A Model Context Protocol (MCP) server for Microsoft Clarity

1293. **[appium-mcp](https://github.com/Rahulec08/appium-mcp)** - ⭐ 52
...
1294. **[mcp_newsnow](https://github.com/sligter/mcp_newsnow)** - ⭐ 52
   一个基于 Model Context Protocol (MCP) 的新闻聚合服务器，通过 Newsnow API 提供多平台热点新闻和趋势话题。

1295. **[ocaml-mcp](https://github.com/tmattio/ocaml-mcp)** - ⭐ 51
   OCaml implementation of the Model Context Protocol (MCP)

1296. **[nasdaq-data-link-mcp](https://github.com/stefanoamorelli/nasdaq-data-link-mcp)** - ⭐ 51
   A Nasdaq Data Link MCP (Model Context Protocol) Server

1297. **[mssql_mcp_server](https://github.com/JexinSam/mssql_mcp_server)** - ⭐ 51
   A Model Context Protocol (MCP) server facilitating secure interactions with MSSQL databases.

1298. **[ynab-mcp-server](https://github.com/calebl/ynab-mcp-server)** - ⭐ 51
   Model Context Protocol for YNAB (you need a budget)

1299. **[client](https://github.com/php-mcp/client)** - ⭐ 51
   Core PHP implementation for the Model Context Protocol (MCP) Client

1300. **[cap-mcp-plugin](https://github.com/gavdilabs/cap-mcp-plugin)** - ⭐ 51
   MCP (Model Context Protocol) server plugin for CAP NodeJS

1301. **[anki-mcp-server](https://github.com/ankimcp/anki-mcp-server)** - ⭐ 51
   A Model Context Protocol (MCP) server that enables AI assistants to interact with Anki, the spaced repetition flashcard application.

1302. **[mcp-manager](https://github.com/MediaPublishing/mcp-manager)** - ⭐ 50
   A web-based GUI tool for managing Model Context Protocol (MCP) servers in Claude and Cursor

1303. **[mxcp](https://github.com/raw-labs/mxcp)** - ⭐ 50
   Model eXecution + Context Protocol: Enterprise-Grade Data-to-AI Infrastructure

1304. **[adx-mcp-server](https://github.com/pab1it0/adx-mcp-server)** - ⭐ 50
   A Model Context Protocol (MCP) server that enables AI assistants to query and analyze Azure Data Explorer databases through standardized interfaces.

1305. **[context-optimizer-mcp-server](https://github.com/malaksedarous/context-optimizer-mcp-server)** - ⭐ 50
   A Model Context Protocol (MCP) server that provides context optimization tools for AI coding assistants including GitHub Copilot, Cursor AI, Claude Desktop, and other MCP-compatible assistants enabling them to extract targeted information rather than processing large terminal outputs and files wasting their context.

1306. **[awesome-remote-mcp-servers](https://github.com/sylviangth/awesome-remote-mcp-servers)** - ⭐ 50
   A curated list of Hosted & Managed Model Context Protocol (MCP) Servers accessible via a simple URL endpoint.

1307. **[mcp-cpp](https://github.com/Neumann-Labs/mcp-cpp)** - ⭐ 50
   A C++ SDK for the Model Context Protocol (MCP). The SDK will provide a framework for creating MCP servers and clients in C++.

1308. **[joplin-mcp-server](https://github.com/dweigend/joplin-mcp-server)** - ⭐ 49
   A Model Context Protocol (MCP) Server for https://joplinapp.org/ that enables note access through the https://modelcontextprotocol.io. Perfect for integration with AI assistants like Claude.

1309. **[MCP4EDA](https://github.com/NellyW8/MCP4EDA)** - ⭐ 49
...
1310. **[EnergyPlus-MCP](https://github.com/LBNL-ETA/EnergyPlus-MCP)** - ⭐ 49
...
1311. **[mcp-docs-service](https://github.com/alekspetrov/mcp-docs-service)** - ⭐ 49
   MCP Documentation Management Service - A Model Context Protocol implementation for documentation management

1312. **[purple-mcp](https://github.com/Sentinel-One/purple-mcp)** - ⭐ 49
...
1313. **[MySQL_MCP](https://github.com/guangxiangdebizi/MySQL_MCP)** - ⭐ 49
   这是一个功能强大且易用的MySQL数据库MCP（Model Context Protocol）服务器，让你的AI助手可以安全地进行完整的数据库操作，支持多数据库连接管理、增删改查、事务管理和智能回滚功能。

1314. **[trpc-mcp-go](https://github.com/trpc-group/trpc-mcp-go)** - ⭐ 48
   Go implementation of the Model Context Protocol (MCP) with comprehensive Streamable HTTP, STDIO, and SSE support. 

1315. **[oatpp-mcp](https://github.com/oatpp/oatpp-mcp)** - ⭐ 48
   Anthropic’s Model Context Protocol implementation for Oat++

1316. **[geoserver-mcp](https://github.com/mahdin75/geoserver-mcp)** - ⭐ 48
   A Model Context Protocol (MCP) server implementation that connects LLMs to the GeoServer REST API

1317. **[bloodhound_mcp](https://github.com/mwnickerson/bloodhound_mcp)** - ⭐ 48
   A Model Context Protocol (MCP) server to converse with data in Bloodhound

1318. **[gomcp](https://github.com/localrivet/gomcp)** - ⭐ 48
...
1319. **[mcp](https://github.com/twelvedata/mcp)** - ⭐ 48
...
1320. **[mcp-bridge-api](https://github.com/INQUIRELAB/mcp-bridge-api)** - ⭐ 48
...
1321. **[bc-code-intelligence-mcp](https://github.com/JeremyVyska/bc-code-intelligence-mcp)** - ⭐ 48
...
1322. **[adk-mcp-a2a-crash-course](https://github.com/chongdashu/adk-mcp-a2a-crash-course)** - ⭐ 48
...
1323. **[mcp-security-audit](https://github.com/qianniuspace/mcp-security-audit)** - ⭐ 48
   A powerful MCP (Model Context Protocol) Server that audits npm package dependencies for security vulnerabilities. Built with remote npm registry integration for real-time security checks.

1324. **[anysite-mcp-server](https://github.com/anysiteio/anysite-mcp-server)** - ⭐ 48
   A Model Context Protocol (MCP) server that provides comprehensive access to LinkedIn data and functionalities using the AnySite API, enabling not only data retrieval but also robust management of user accounts.

1325. **[vrchat-mcp](https://github.com/sawa-zen/vrchat-mcp)** - ⭐ 48
   This project is a Model Context Protocol (MCP) server for interacting with the VRChat API.

1326. **[mcpo_docker_use](https://github.com/flyfox666/mcpo_docker_use)** - ⭐ 48
...
1327. **[tripadvisor-mcp](https://github.com/pab1it0/tripadvisor-mcp)** - ⭐ 47
...
1328. **[model-context-protocol-rb](https://github.com/dickdavis/model-context-protocol-rb)** - ⭐ 47
   An implementation of the Model Context Protocol in Ruby.

1329. **[go-mcp-mysql](https://github.com/Zhwt/go-mcp-mysql)** - ⭐ 47
   Zero burden, ready-to-use Model Context Protocol (MCP) server for interacting with MySQL and automation. No Node.js or Python environment needed.

1330. **[mcp](https://github.com/goplus/mcp)** - ⭐ 47
...
1331. **[kuon](https://github.com/lissettecarlr/kuon)** - ⭐ 47
...
1332. **[scheduler-mcp](https://github.com/PhialsBasement/scheduler-mcp)** - ⭐ 47
...
1333. **[mcp](https://github.com/abap-ai/mcp)** - ⭐ 47
   ABAP MCP - Model Context Protocol - Server SDK

1334. **[mcp-kubernetes](https://github.com/Azure/mcp-kubernetes)** - ⭐ 47
   A Model Context Protocol (MCP) server that enables AI assistants to interact with Kubernetes clusters. It serves as a bridge between AI tools (like Claude, Cursor, and GitHub Copilot) and Kubernetes

1335. **[kroger-mcp](https://github.com/CupOfOwls/kroger-mcp)** - ⭐ 47
...
1336. **[1xn-vmcp](https://github.com/1xn-labs/1xn-vmcp)** - ⭐ 47
   vMCP - Virtual Model Context Protocol

1337. **[mcp-server](https://github.com/inkdropapp/mcp-server)** - ⭐ 46
   Inkdrop Model Context Protocol Server

1338. **[mcp-openapi-schema](https://github.com/hannesj/mcp-openapi-schema)** - ⭐ 46
   OpenAPI Schema Model Context Protocol Server

1339. **[mcp-mermaid-validator](https://github.com/rtuin/mcp-mermaid-validator)** - ⭐ 46
   A Model Context Protocol server that validates and renders Mermaid diagrams.

1340. **[claude-mcp-setup](https://github.com/patruff/claude-mcp-setup)** - ⭐ 46
   Easy setup script for Anthropic Claude Model Context Protocol (MCP) servers on Windows

1341. **[langchain-mcp-client](https://github.com/guinacio/langchain-mcp-client)** - ⭐ 46
   This Streamlit application provides a user interface for connecting to MCP (Model Context Protocol) servers and interacting with them using different LLM providers (OpenAI, Anthropic, Google, Ollama).

1342. **[stackoverflow-mcp](https://github.com/gscalzo/stackoverflow-mcp)** - ⭐ 46
   A Model Context Protocol server for querying Stack Overflow to help AI models find programming solutions

1343. **[ticktick-mcp-server](https://github.com/alexarevalo9/ticktick-mcp-server)** - ⭐ 46
   A Model Context Protocol (MCP) server designed to integrate with the TickTick task management platform, enabling intelligent context-aware task operations and automation.

1344. **[mcp-sdk](https://github.com/symfony/mcp-sdk)** - ⭐ 45
   Model Context Protocol SDK for Client and Server applications in PHP

1345. **[freecad-mcp](https://github.com/contextform/freecad-mcp)** - ⭐ 45
   FreeCAD MCP - Open-source Model Context Protocol server for FreeCAD automation

1346. **[vchart-mcp-server](https://github.com/VisActor/vchart-mcp-server)** - ⭐ 45
   A Model Context Protocol (MCP) server for the @visactor/vchart that enables AI assistants to generate interactive charts and visualizations.

1347. **[Homeassistant-server-mcp](https://github.com/hekmon8/Homeassistant-server-mcp)** - ⭐ 45
   A Model Context Protocol (MCP) server for interacting with Home Assistant. This server provides tools to control and monitor your Home Assistant devices through MCP-enabled applications.

1348. **[mcp-oauth-gateway](https://github.com/atrawog/mcp-oauth-gateway)** - ⭐ 45
...
1349. **[shadowgit-mcp](https://github.com/blade47/shadowgit-mcp)** - ⭐ 45
...
1350. **[fastmail-mcp](https://github.com/MadLlama25/fastmail-mcp)** - ⭐ 45
...
1351. **[mcp-open-library](https://github.com/8enSmith/mcp-open-library)** - ⭐ 45
   A Model Context Protocol (MCP) server for the Internet Archive's Open Library API that enables AI assistants to search for book and author information.

1352. **[AI-Cursor-Scraping-Assistant](https://github.com/TheWebScrapingClub/AI-Cursor-Scraping-Assistant)** - ⭐ 45
...
1353. **[mcp-youtube](https://github.com/adhikasp/mcp-youtube)** - ⭐ 44
   Model Context Protocol to fetch youtube transcript

1354. **[flightradar24-mcp-server](https://github.com/sunsetcoder/flightradar24-mcp-server)** - ⭐ 44
   Model Context Protocol server for Flight Tracking

1355. **[podman-mcp-server](https://github.com/manusa/podman-mcp-server)** - ⭐ 44
   Model Context Protocol (MCP) server for container runtimes (Podman and Docker)

1356. **[Koppla](https://github.com/ruudmens/Koppla)** - ⭐ 44
   A Model-Context-Protocol (MCP) Server for Active Directory

1357. **[hackmd-mcp](https://github.com/yuna0x0/hackmd-mcp)** - ⭐ 44
   A Model Context Protocol server for integrating HackMD's note-taking platform with AI assistants.

1358. **[go-mcp](https://github.com/MegaGrindStone/go-mcp)** - ⭐ 44
...
1359. **[vue-mcp-next](https://github.com/tuskermanshu/vue-mcp-next)** - ⭐ 44
...
1360. **[mcp-gitee](https://github.com/oschina/mcp-gitee)** - ⭐ 44
   mcp-gitee is a Model Context Protocol (MCP) server implementation for Gitee. It provides a set of tools that interact with Gitee's API, allowing AI assistants to manage repository, issues, pull requests, etc.

1361. **[OneCite](https://github.com/HzaCode/OneCite)** - ⭐ 44
...
1362. **[MCPP.Net](https://github.com/xuzeyu91/MCPP.Net)** - ⭐ 44
   Model Context Protocol Platform，统一管理你的MCP服务

1363. **[APIWeaver](https://github.com/GongRzhe/APIWeaver)** - ⭐ 44
...
1364. **[gopher-mcp](https://github.com/GopherSecurity/gopher-mcp)** - ⭐ 44
   MCP C++ SDK - Model Context Protocol implementation in CPP with enterprise-grade security, visibility and connectivity.

1365. **[mcp-starter-template](https://github.com/StevenStavrakis/mcp-starter-template)** - ⭐ 43
   An opinionated starter template for making Model Context Protocol (MCP) servers

1366. **[wechat-mcp](https://github.com/JettChenT/wechat-mcp)** - ⭐ 43
   Model Context Protocol for WeChat

1367. **[mcp-made-simple](https://github.com/chongdashu/mcp-made-simple)** - ⭐ 43
   Model Context Protocol (MCP) Made Simple - Code for the tutorial series - focusing on practical ways to understand and use MCP

1368. **[ns-mcp-server](https://github.com/r-huijts/ns-mcp-server)** - ⭐ 43
   A Model Context Protocol (MCP) server that provides access to NS (Dutch Railways) travel information through Claude AI. This server enables Claude to fetch real-time train travel information and disruptions using the official Dutch NS API.

1369. **[dataproduct-mcp](https://github.com/entropy-data/dataproduct-mcp)** - ⭐ 43
...
1370. **[erpnext-mcp-server](https://github.com/rakeshgangwar/erpnext-mcp-server)** - ⭐ 43
   Connect AI assistants to your ERPNext instance via the Model Context Protocol (MCP) using the official Frappe API.

1371. **[mcp-rdf-explorer](https://github.com/emekaokoye/mcp-rdf-explorer)** - ⭐ 43
...
1372. **[calculator-mcp-server](https://github.com/huhabla/calculator-mcp-server)** - ⭐ 43
   A Model Context Protocol (MCP) server that provides Claude with advanced mathematical calculation capabilities

1373. **[MediaWiki-MCP-Server](https://github.com/ProfessionalWiki/MediaWiki-MCP-Server)** - ⭐ 43
   Model Context Protocol (MCP) Server to connect your AI with any MediaWiki

1374. **[langchaingo-mcp-adapter](https://github.com/i2y/langchaingo-mcp-adapter)** - ⭐ 42
   A Go adapter that bridges LangChain Go tools with Model Context Protocol (MCP) servers.

1375. **[solana-dev-mcp](https://github.com/solana-foundation/solana-dev-mcp)** - ⭐ 42
   Solana Model Context Protocol (MCP) Demo

1376. **[salesforce-mcp-server](https://github.com/kablewy/salesforce-mcp-server)** - ⭐ 42
   Model Context Protocol server for Salesforce REST API integration

1377. **[mcp-graphql-schema](https://github.com/hannesj/mcp-graphql-schema)** - ⭐ 42
   GraphQL Schema Model Context Protocol Server

1378. **[openrpc-mcp-server](https://github.com/shanejonas/openrpc-mcp-server)** - ⭐ 42
   A Model Context Protocol (MCP) server that provides JSON-RPC functionality through OpenRPC.

1379. **[awesome-mcp-servers](https://github.com/mctrinh/awesome-mcp-servers)** - ⭐ 42
   A curated list of excellent Model Context Protocol (MCP) servers.

1380. **[mcp-agents-hub](https://github.com/mcp-agents-ai/mcp-agents-hub)** - ⭐ 42
   The open-source ecosystem for building, discovering, and deploying Model Context Protocol servers and clients.

1381. **[thingspanel-mcp](https://github.com/ThingsPanel/thingspanel-mcp)** - ⭐ 42
...
1382. **[mcp-playground](https://github.com/Elkhn/mcp-playground)** - ⭐ 42
   A Streamlit-based chat app for LLMs with plug-and-play tool support via Model Context Protocol (MCP), powered by LangChain, LangGraph, and Docker.

1383. **[MCP-Airflow-API](https://github.com/call518/MCP-Airflow-API)** - ⭐ 42
...
1384. **[mcp-things3](https://github.com/drjforrest/mcp-things3)** - ⭐ 42
...
1385. **[ollama-mcp-bridge](https://github.com/jonigl/ollama-mcp-bridge)** - ⭐ 42
   Extend the Ollama API with dynamic AI tool integration from multiple MCP (Model Context Protocol) servers. Fully compatible, transparent, and developer-friendly, ideal for building powerful local LLM applications, AI agents, and custom chatbots

1386. **[mcp-openmsx](https://github.com/nataliapc/mcp-openmsx)** - ⭐ 42
...
1387. **[taskMaster-todoist-mcp](https://github.com/mingolladaniele/taskMaster-todoist-mcp)** - ⭐ 42
...
1388. **[meme-mcp](https://github.com/haltakov/meme-mcp)** - ⭐ 42
   A simple Model Context Protocol (MCP) server for generating memes using the ImgFlip API

1389. **[google_ads_mcp](https://github.com/google-marketing-solutions/google_ads_mcp)** - ⭐ 42
   The Google Ads MCP Server is an implementation of the Model Context Protocol (MCP) that enables Large Language Models (LLMs), such as Gemini, to interact directly with the Google Ads API.

1390. **[mcp-gearbox](https://github.com/rohitsoni007/mcp-gearbox)** - ⭐ 42
   A modern desktop application for managing Model Context Protocol (MCP) servers across multiple AI agents

1391. **[pdf-mcp](https://github.com/saury1120/pdf-mcp)** - ⭐ 42
   一个强大的 PDF 处理 MCP（Model Context Protocol）服务，提供全面的 PDF 文档分析功能

1392. **[Claude-Project-Coordinator](https://github.com/M-Pineapple/Claude-Project-Coordinator)** - ⭐ 42
...
1393. **[mcp-servers-kagi](https://github.com/ac3xx/mcp-servers-kagi)** - ⭐ 41
   A Model Context Protocol server implementation for Kagi's API

1394. **[python-notebook-mcp](https://github.com/UsamaK98/python-notebook-mcp)** - ⭐ 41
   Lightweight Python Notebook MCP - Enable AI assistants to create, edit, and view Jupyter notebooks via Model Context Protocol

1395. **[rhinoMcpServer](https://github.com/always-tinkering/rhinoMcpServer)** - ⭐ 41
...
1396. **[mcp-ai-memory](https://github.com/scanadi/mcp-ai-memory)** - ⭐ 41
   A production-ready Model Context Protocol (MCP) server for semantic memory management

1397. **[mcp-server](https://github.com/profullstack/mcp-server)** - ⭐ 41
   A generic, modular server for implementing the Model Context Protocol (MCP). 

1398. **[MCPApp](https://github.com/tanaikech/MCPApp)** - ⭐ 41
   This text introduces the Model Context Protocol (MCP) for AI interaction, exploring Google Apps Script (GAS) as a server option. It shows feasibility with a sample but notes the lack of a GAS SDK, aiming to encourage understanding and development.

1399. **[vercel-ai-docs-mcp](https://github.com/IvanAmador/vercel-ai-docs-mcp)** - ⭐ 41
   A Model Context Protocol (MCP) server that provides AI-powered search and querying capabilities for the Vercel AI SDK documentation. This project enables developers to ask questions about the Vercel AI SDK and receive accurate, contextualized responses based on the official documentation.

1400. **[abaqus-mcp-server](https://github.com/jianzhichun/abaqus-mcp-server)** - ⭐ 41
...
1401. **[pprof-analyzer-mcp](https://github.com/ZephyrDeng/pprof-analyzer-mcp)** - ⭐ 41
   This is a Model Context Protocol (MCP) server implemented in Go, providing a tool to analyze Go pprof performance profiles.

1402. **[excalidraw-mcp](https://github.com/i-tozer/excalidraw-mcp)** - ⭐ 41
   Model Context Protocol (MCP) server for Excalidraw - Work in Progress

1403. **[awesome-mcp-security](https://github.com/AIM-Intelligence/awesome-mcp-security)** - ⭐ 41
   Security Threats related with MCP (Model Context Protocol), MCP Servers and more

1404. **[mcp-swagger-server](https://github.com/zaizaizhao/mcp-swagger-server)** - ⭐ 41
   MCP Swagger Server 将任何符合 OpenAPI/Swagger 规范的 REST API 转换为 Model Context Protocol (MCP) 格式，让 AI 助手能够理解和调用您的 API。

1405. **[mcp-amadeus](https://github.com/donghyun-chae/mcp-amadeus)** - ⭐ 41
   Amadeus MCP(Model Context Protocol) Server

1406. **[mcp-server-synology](https://github.com/atom2ueki/mcp-server-synology)** - ⭐ 41
...
1407. **[mcp-server-js](https://github.com/yepcode/mcp-server-js)** - ⭐ 40
...
1408. **[dify-mcp-server](https://github.com/AI-FE/dify-mcp-server)** - ⭐ 40
   A Model Context Protocol server for Dify

1409. **[world_bank_mcp_server](https://github.com/anshumax/world_bank_mcp_server)** - ⭐ 40
   An implementation of the Model Context Protocol for the World Bank open data API

1410. **[mcp-auth-servers](https://github.com/Azure-Samples/mcp-auth-servers)** - ⭐ 40
   🔒 Reference MCP servers that demo how authentication works with the current Model Context Protocol spec.

1411. **[mcp](https://github.com/Azure-Samples/mcp)** - ⭐ 40
...
1412. **[MCPollinations](https://github.com/pinkpixel-dev/MCPollinations)** - ⭐ 40
   A Model Context Protocol (MCP) server that enables AI assistants to generate images, text, and audio through the Pollinations APIs. Supports customizable parameters, image saving, and multiple model options.

1413. **[mcp_rails_template](https://github.com/seuros/mcp_rails_template)** - ⭐ 40
   A minimal Rails API template for creating MCP (Model Context Protocol) servers with robust tool execution capabilities and examples.

1414. **[esa-mcp-server](https://github.com/esaio/esa-mcp-server)** - ⭐ 40
   esa.io の公式 MCP(Model Context Protocol)サーバー(STDIO Transport版)

1415. **[mcp](https://github.com/40ants/mcp)** - ⭐ 40
   40ANTS-MCP is a framework for building Model Context Protocol servers in Common Lisp

1416. **[mcp-container-ts](https://github.com/Azure-Samples/mcp-container-ts)** - ⭐ 40
   This is a quick start guide that provides the basic building blocks to set up a remote Model Context Protocol (MCP) server using Azure Container Apps. The MCP server is built using Node.js and TypeScript, and it can be used to run various tools and services in a serverless environment.

1417. **[agentic-mcp-client](https://github.com/peakmojo/agentic-mcp-client)** - ⭐ 40
   A standalone agent runner that executes tasks using MCP (Model Context Protocol) tools via Anthropic Claude, AWS BedRock and OpenAI APIs. It enables AI agents to run autonomously in cloud environments and interact with various systems securely.

1418. **[any2markdown](https://github.com/WW-AI-Lab/any2markdown)** - ⭐ 40
...
1419. **[gradle-mcp-server](https://github.com/IlyaGulya/gradle-mcp-server)** - ⭐ 40
   A Model Context Protocol (MCP) server to enable AI tools to interact with Gradle projects programmatically.

1420. **[mcp-auth-proxy](https://github.com/sigbit/mcp-auth-proxy)** - ⭐ 40
   MCP Auth Proxy is a secure OAuth 2.1 authentication proxy for Model Context Protocol (MCP) servers

1421. **[nmap-mcp-server](https://github.com/PhialsBasement/nmap-mcp-server)** - ⭐ 40
   A Model Context Protocol (MCP) server that enables AI assistants to perform network scanning operations using NMAP

1422. **[contentful-mcp-server](https://github.com/contentful/contentful-mcp-server)** - ⭐ 40
   MCP (Model Context Protocol) server for the Contentful Management API

1423. **[DecompilerServer](https://github.com/pardeike/DecompilerServer)** - ⭐ 40
...
1424. **[sharepoint-mcp](https://github.com/DEmodoriGatsuO/sharepoint-mcp)** - ⭐ 39
...
1425. **[zendesk-mcp-server](https://github.com/reminia/zendesk-mcp-server)** - ⭐ 39
   A Model Context Protocol server for Zendesk

1426. **[mcp_code_analyzer](https://github.com/emiryasar/mcp_code_analyzer)** - ⭐ 39
   A Model Context Protocol (MCP) server implementation for comprehensive code analysis. This tool integrates with Claude Desktop to provide code analysis capabilities through natural language interactions.

1427. **[instagram-engagement-mcp](https://github.com/Bob-lance/instagram-engagement-mcp)** - ⭐ 39
...
1428. **[mcp-crypto-price](https://github.com/truss44/mcp-crypto-price)** - ⭐ 39
   A Model Context Protocol (MCP) server that provides real-time cryptocurrency analysis via CoinCap's API. Enables Claude and other MCP clients to fetch crypto prices, analyze market trends, and track historical data.

1429. **[mcp_server_filesystem](https://github.com/MarcusJellinghaus/mcp_server_filesystem)** - ⭐ 39
   MCP File System Server: A secure Model Context Protocol server that provides file operations for AI assistants. Enables Claude and other assistants to safely read, write, and list files in a designated project directory with robust path validation and security controls.

1430. **[osm-mcp](https://github.com/wiseman/osm-mcp)** - ⭐ 39
   Model Context Protocol server for OpenStreetMap data

1431. **[tuisic](https://github.com/Dark-Kernel/tuisic)** - ⭐ 39
...
1432. **[caldav-mcp](https://github.com/dominik1001/caldav-mcp)** - ⭐ 39
   A CalDAV client using Model Context Protocol (MCP) to expose calendar operations as tools for AI assistants.

1433. **[devcontext](https://github.com/aiurda/devcontext)** - ⭐ 39
   DevContext is a cutting-edge Model Context Protocol (MCP) server designed to provide developers with continuous, project-centric context awareness. Unlike traditional context systems, DevContext continuously learns from and adapts to your development patterns and delivers highly relevant context providing a deeper understanding of your codebase.

1434. **[mcp-server-ledger](https://github.com/minhyeoky/mcp-server-ledger)** - ⭐ 39
   A Model Context Protocol server for interacting with Ledger CLI, a powerful double-entry accounting system. This server enables Large Language Models to query and analyze financial data through a standardized interface, making it easy for AI assistants to help with financial reporting, budget analysis, and accounting tasks.

1435. **[algorand-mcp](https://github.com/GoPlausible/algorand-mcp)** - ⭐ 38
   Algorand Model Context Protocol (Server & Client)

1436. **[mailgun-mcp-server](https://github.com/mailgun/mailgun-mcp-server)** - ⭐ 38
   Implementation of Model Context Protocol server for Mailgun APIs

1437. **[beemcp](https://github.com/OkGoDoIt/beemcp)** - ⭐ 38
   BeeMCP: an unofficial Model Context Protocol (MCP) server that connects your Bee wearable lifelogger to AI via the Model Context Protocol

1438. **[mcp](https://github.com/kyopark2014/mcp)** - ⭐ 38
   It shows how to use model-context-protocol. 

1439. **[middy-mcp](https://github.com/fredericbarthelet/middy-mcp)** - ⭐ 38
   Middy middleware for Model Context Protocol server hosting on AWS Lambda

1440. **[mcp-shell](https://github.com/hdresearch/mcp-shell)** - ⭐ 38
   Execute a secure shell in Claude Desktop using the Model Context Protocol.

1441. **[dev-to-mcp](https://github.com/nickytonline/dev-to-mcp)** - ⭐ 38
   A remote Model Context Protocol (MCP) server for interacting with the dev.to public API without requiring authentication.

1442. **[mcp](https://github.com/getAlby/mcp)** - ⭐ 38
   Connect a bitcoin lightning wallet to your LLM using Nostr Wallet Connect and Model Context Protocol

1443. **[kafka-mcp-server](https://github.com/tuannvm/kafka-mcp-server)** - ⭐ 38
   A Model Context Protocol (MCP) server for Apache Kafka implemented in Go, leveraging franz-go and mcp-go.

1444. **[autoteam](https://github.com/diazoxide/autoteam)** - ⭐ 38
   Orchestrate AI agents with YAML-driven workflows via universal Model Context Protocol (MCP)

1445. **[mcp-konnect](https://github.com/Kong/mcp-konnect)** - ⭐ 38
   A Model Context Protocol (MCP) server for interacting with Kong Konnect APIs, allowing AI assistants to query and analyze Kong Gateway configurations, traffic, and analytics.

1446. **[offeryn](https://github.com/avahowell/offeryn)** - ⭐ 38
   Build tools for LLMs in Rust using Model Context Protocol

1447. **[lisply-mcp](https://github.com/gornskew/lisply-mcp)** - ⭐ 38
   Model Context Protocol (MCP) server to manage and talk to compliant "Lisply" lisp-speaking backend services

1448. **[ai-humanizer-mcp-server](https://github.com/Text2Go/ai-humanizer-mcp-server)** - ⭐ 38
   A powerful Model Context Protocol (MCP) server that helps refine AI-generated content to sound more natural and human-like. Built with advanced AI detection and text enhancement capabilities.

1449. **[pagerduty-mcp-server](https://github.com/PagerDuty/pagerduty-mcp-server)** - ⭐ 38
   PagerDuty's official local MCP (Model Context Protocol) server which provides tools to interact with your PagerDuty account directly from your MCP-enabled client.

1450. **[clinicaltrialsgov-mcp-server](https://github.com/cyanheads/clinicaltrialsgov-mcp-server)** - ⭐ 38
...
1451. **[godoctor](https://github.com/danicat/godoctor)** - ⭐ 38
   A Model Context Protocol server for Go developers

1452. **[beanquery-mcp](https://github.com/vanto/beanquery-mcp)** - ⭐ 38
...
1453. **[mcp-ssh](https://github.com/AiondaDotCom/mcp-ssh)** - ⭐ 37
   A Model Context Protocol (MCP) server for managing and controlling SSH connections.

1454. **[davinci-resolve-mcp](https://github.com/apvlv/davinci-resolve-mcp)** - ⭐ 37
   A Model Context Protocol (MCP) server for interacting with DaVinci Resolve and Fusion

1455. **[zig-mcp-server](https://github.com/openSVM/zig-mcp-server)** - ⭐ 37
   A Model Context Protocol (MCP) server that provides Zig language tooling, code analysis, and documentation access. This server enhances AI capabilities with Zig-specific functionality including code optimization, compute unit estimation, code generation, and best practices recommendations.

1456. **[MCPToolBenchPP](https://github.com/mcp-tool-bench/MCPToolBenchPP)** - ⭐ 37
   MCPToolBench++ MCP Model Context Protocol Tool Use Benchmark on AI Agent and Model Tool Use Ability

1457. **[mcp-victorialogs](https://github.com/VictoriaMetrics-Community/mcp-victorialogs)** - ⭐ 37
   The implementation of Model Context Protocol (MCP) server for VictoriaLogs.

1458. **[bookstack-mcp-server](https://github.com/pnocera/bookstack-mcp-server)** - ⭐ 37
   A Model Context Protocol (MCP) server providing full access to BookStack's knowledge management capabilities

1459. **[youtrack-mcp](https://github.com/itsalfredakku/youtrack-mcp)** - ⭐ 37
   An MCP (Model Context Protocol) server that provides YouTrack REST API access to AI agents

1460. **[ContextPods](https://github.com/conorluddy/ContextPods)** - ⭐ 37
   Model Context Protocol management suite/factory. An MCP that can generate and manage other local MCPs in multiple languages. Uses the official SDKs for code gen.

1461. **[modular-mcp](https://github.com/d-kimuson/modular-mcp)** - ⭐ 37
   A Model Context Protocol (MCP) proxy server that enables efficient management of large tool collections across multiple MCP servers by grouping them and loading tool schemas on-demand.

1462. **[mmcp](https://github.com/koki-develop/mmcp)** - ⭐ 37
   🛠️ Manage your MCP (Model Context Protocol) server definitions in one place and apply them to supported agents.

1463. **[mcp-all-in-one](https://github.com/vtxf/mcp-all-in-one)** - ⭐ 37
...
1464. **[openai-mcp](https://github.com/arthurcolle/openai-mcp)** - ⭐ 36
   OpenAI Code Assistant Model Context Protocol (MCP) Server

1465. **[mcp-flight-search](https://github.com/arjunprabhulal/mcp-flight-search)** - ⭐ 36
   MCP Server implementation for the Model Context Protocol (MCP) enabling AI tool usage - Realtime Flight Search 

1466. **[mcp-go](https://github.com/riza-io/mcp-go)** - ⭐ 36
   Build Model Context Protocol (MCP) servers in Go

1467. **[Mcp.Net](https://github.com/SamFold/Mcp.Net)** - ⭐ 36
   A fully featured C# implementation of Anthropic's Model Context Protocol (MCP)

1468. **[mcp-server-leetcode](https://github.com/doggybee/mcp-server-leetcode)** - ⭐ 36
...
1469. **[pubmed-mcp-server](https://github.com/cyanheads/pubmed-mcp-server)** - ⭐ 36
...
1470. **[baseline-mcp-server](https://github.com/yamanoku/baseline-mcp-server)** - ⭐ 36
   特定のWeb APIに関するBaselineの状況を提供するModel Context Protocolサーバー

1471. **[okta-mcp-server](https://github.com/fctr-id/okta-mcp-server)** - ⭐ 36
   The Okta MCP Server is a groundbreaking tool built by the team at Fctr that enables AI models to interact directly with your Okta environment using the Model Context Protocol (MCP). Built specifically for IAM engineers, security teams, and Okta administrators, it implements the MCP specification to help work with Okta enitities

1472. **[example-mcp-server](https://github.com/kirill-markin/example-mcp-server)** - ⭐ 36
   A ready-to-use MCP (Model Context Protocol) server template for extending Cursor IDE with custom tools. Deploy your own server to Heroku with one click, create custom commands, and enhance your Cursor IDE experience. Perfect for developers who want to add their own tools and commands to Cursor IDE without complex setup.

1473. **[vikunja-mcp](https://github.com/democratize-technology/vikunja-mcp)** - ⭐ 36
   Model Context Protocol server for Vikunja task management. Enables AI assistants to interact with Vikunja instances via MCP.

1474. **[mcp-logic](https://github.com/angrysky56/mcp-logic)** - ⭐ 36
...
1475. **[How-To-Create-MCP-Server](https://github.com/nisalgunawardhana/How-To-Create-MCP-Server)** - ⭐ 36
   This guide will help you set up a basic MCP (Model Context Protocol) server in .NET, configure it in VS Code, and interact with it using Copilot Chat.

1476. **[mcp-governance-sdk](https://github.com/ithena-one/mcp-governance-sdk)** - ⭐ 36
   Enterprise Governance Layer (Identity, RBAC, Credentials, Auditing, Logging, Tracing) for the Model Context Protocol SDK

1477. **[mcp-filter](https://github.com/pro-vi/mcp-filter)** - ⭐ 36
   A proxy MCP (Model Context Protocol) server that filters the upstream tool surface to just the tools you need.

1478. **[paper-search-mcp-nodejs](https://github.com/Dianel555/paper-search-mcp-nodejs)** - ⭐ 36
...
1479. **[mlb-api-mcp](https://github.com/guillochon/mlb-api-mcp)** - ⭐ 35
...
1480. **[bsky-mcp-server](https://github.com/brianellin/bsky-mcp-server)** - ⭐ 35
   Bluesky MCP (Model Context Protocol) Server

1481. **[mcpmc](https://github.com/gerred/mcpmc)** - ⭐ 35
   Model Context Protocol Minecraft Server

1482. **[open-ghl-mcp](https://github.com/basicmachines-co/open-ghl-mcp)** - ⭐ 35
   An open source Model Context Protocol server for GoHighLevel API v2 with OAuth

1483. **[mcp-server-ios-simulator](https://github.com/atom2ueki/mcp-server-ios-simulator)** - ⭐ 35
   Model Context Protocol (MCP) implementation for iOS simulators

1484. **[esa-mcp-server](https://github.com/d-kimuson/esa-mcp-server)** - ⭐ 35
   esa の Model Context Protocol サーバー実装

1485. **[webscraping-ai-mcp-server](https://github.com/webscraping-ai/webscraping-ai-mcp-server)** - ⭐ 35
    A Model Context Protocol (MCP) server implementation that integrates with WebScraping.AI for web data extraction capabilities.

1486. **[McpDotNet.Extensions.SemanticKernel](https://github.com/StefH/McpDotNet.Extensions.SemanticKernel)** - ⭐ 35
   Microsoft SemanticKernel integration for the Model Context Protocol (MCP). Enables seamless use of MCP tools as AI functions.

1487. **[matlab-mcp](https://github.com/Tsuchijo/matlab-mcp)** - ⭐ 35
   Model Context Protocol server to let LLMs write and execute matlab scripts 

1488. **[binance-mcp-server](https://github.com/AnalyticAce/binance-mcp-server)** - ⭐ 35
...
1489. **[mcp-langchain-ts-client](https://github.com/isaacwasserman/mcp-langchain-ts-client)** - ⭐ 35
   LangChain.js client for Model Context Protocol.

1490. **[repl-mcp](https://github.com/simm-is/repl-mcp)** - ⭐ 35
   Model Context Protocol Clojure support including REPL integration with development tools.

1491. **[mcp-design-system-extractor](https://github.com/freema/mcp-design-system-extractor)** - ⭐ 35
   MCP (Model Context Protocol) server that enables AI assistants to interact with Storybook design systems. Extract component HTML, analyze styles, and help with design system adoption and refactoring.

1492. **[mcp-anywhere](https://github.com/locomotive-agency/mcp-anywhere)** - ⭐ 35
...
1493. **[semanticscholar-MCP-Server](https://github.com/JackKuo666/semanticscholar-MCP-Server)** - ⭐ 35
   🔍 This project implements a Model Context Protocol (MCP) server for interacting with the Semantic Scholar API. It provides tools for searching papers, retrieving paper and author details, and fetching citations and references.

1494. **[OmniMind](https://github.com/Techiral/OmniMind)** - ⭐ 35
...
1495. **[dramacraft](https://github.com/whatyun/dramacraft)** - ⭐ 35
   DramaCraft 是一个专业的短剧视频编辑 MCP (Model Context Protocol) 服务，集成国产中文大模型 API，实现剪映的智能自动化编辑功能。项目已完成从视频分析到草稿生成的完整解决方案

1496. **[mcp-sitecore-server](https://github.com/Antonytm/mcp-sitecore-server)** - ⭐ 35
   Model Context Protocol server for Sitecore

1497. **[attio-mcp-server](https://github.com/kesslerio/attio-mcp-server)** - ⭐ 35
   Attio Model Context Protocol (MCP) server implementation

1498. **[Unreal_mcp](https://github.com/ChiR24/Unreal_mcp)** - ⭐ 35
...
1499. **[keycloak-model-context-protocol](https://github.com/ChristophEnglisch/keycloak-model-context-protocol)** - ⭐ 34
...
1500. **[mcp-scala](https://github.com/windymelt/mcp-scala)** - ⭐ 34
   Model Context Protocol server written in Scala

1501. **[shodan-mcp-server](https://github.com/Cyreslab-AI/shodan-mcp-server)** - ⭐ 34
   A Model Context Protocol server that provides access to Shodan API functionality

1502. **[tomtom-mcp](https://github.com/tomtom-international/tomtom-mcp)** - ⭐ 34
   A Model Context Protocol (MCP) server providing TomTom's location services, search, routing, and traffic data to AI agents.

1503. **[mcp-file-context-server](https://github.com/bsmi021/mcp-file-context-server)** - ⭐ 34
   A Model Context Protocol (MCP) server that provides file system context to Large Language Models (LLMs). This server enables LLMs to read, search, and analyze code files with advanced caching and real-time file watching capabilities.

1504. **[Claude-Deep-Research](https://github.com/mcherukara/Claude-Deep-Research)** - ⭐ 34
   An MCP (Model Context Protocol) server that enables comprehensive research capabilities for Claude

1505. **[HAL](https://github.com/DeanWard/HAL)** - ⭐ 34
   HAL (HTTP API Layer) is a Model Context Protocol (MCP) server that provides HTTP API capabilities to Large Language Models.

1506. **[shotgrid-mcp-server](https://github.com/loonghao/shotgrid-mcp-server)** - ⭐ 34
   A Model Context Protocol (MCP) server for Autodesk ShotGrid/Flow Production Tracking (FPT) with comprehensive CRUD operations and data management capabilities.

1507. **[FastDomainCheck-MCP-Server](https://github.com/bingal/FastDomainCheck-MCP-Server)** - ⭐ 34
   A Model Context Protocol for checking domain name registration status in bulk.

1508. **[grafana-mcp-analyzer](https://github.com/SailingCoder/grafana-mcp-analyzer)** - ⭐ 34
   让AI助手直接分析你的Grafana监控数据 - A Model Context Protocol server for Grafana data analysis

1509. **[code-mcp](https://github.com/54yyyu/code-mcp)** - ⭐ 34
...
1510. **[mcp-security-inspector](https://github.com/purpleroc/mcp-security-inspector)** - ⭐ 34
   一个用于检测Model Context Protocol (MCP)安全性的Chrome扩展工具。

1511. **[codebase-mcp](https://github.com/danyQe/codebase-mcp)** - ⭐ 34
...
1512. **[mcp-client-auth](https://github.com/dzhng/mcp-client-auth)** - ⭐ 34
...
1513. **[mcp-gateway](https://github.com/theognis1002/mcp-gateway)** - ⭐ 34
...
1514. **[mcp-android-server-python](https://github.com/nim444/mcp-android-server-python)** - ⭐ 34
   MCP Android agent - This project provides an *MCP (Model Context Protocol)* server for automating Android devices using uiautomator2. It's designed to be easily plugged into AI agents like GitHub Copilot Chat, Claude, or Open Interpreter to control Android devices through natural language.

1515. **[salesforce-mcp-server](https://github.com/jaworjar95/salesforce-mcp-server)** - ⭐ 34
   A comprehensive Model Context Protocol (MCP) server that provides seamless Salesforce integration for AI development tools like Claude Desktop, Cline, and other MCP-compatible clients.

1516. **[mcp-local-rag](https://github.com/shinpr/mcp-local-rag)** - ⭐ 34
   Privacy-first local RAG server for Cursor, Claude Code, and more — powered by the Model Context Protocol.

1517. **[activitywatch-mcp-server](https://github.com/8bitgentleman/activitywatch-mcp-server)** - ⭐ 33
   Model Context Protocol server for ActivityWatch time tracking data

1518. **[mcp-server-opendal](https://github.com/Xuanwo/mcp-server-opendal)** - ⭐ 33
   Model Context Protocol Server for Apache OpenDAL™

1519. **[canvas-mcp](https://github.com/vishalsachdev/canvas-mcp)** - ⭐ 33
   A Model Context Protocol server to run locally and connect to a Canvas LMS 

1520. **[prometheus_mcp_server](https://github.com/CaesarYangs/prometheus_mcp_server)** - ⭐ 33
...
1521. **[nuclei-mcp](https://github.com/addcontent/nuclei-mcp)** - ⭐ 33
...
1522. **[mcp-google-calendar](https://github.com/markelaugust74/mcp-google-calendar)** - ⭐ 33
...
1523. **[MCP-Server-Creator](https://github.com/GongRzhe/MCP-Server-Creator)** - ⭐ 33
...
1524. **[coin_api_mcp](https://github.com/longmans/coin_api_mcp)** - ⭐ 33
   A Model Context Protocol server that provides access to CoinMarketCap's cryptocurrency data. This server enables AI-powered applications to retrieve cryptocurrency listings, quotes, and detailed information about various coins.

1525. **[aio-mcp](https://github.com/athapong/aio-mcp)** - ⭐ 33
...
1526. **[postman-mcp](https://github.com/SalehKhatri/postman-mcp)** - ⭐ 33
...
1527. **[mcp-prompt-server-go](https://github.com/smallnest/mcp-prompt-server-go)** - ⭐ 33
...
1528. **[adk-python-mcp-client](https://github.com/arjunprabhulal/adk-python-mcp-client)** - ⭐ 33
   Demo of ADK (Agent Development Kit) as an MCP (Model Context Protocol) client for flight search capabilities.

1529. **[mcp-gemini-server](https://github.com/bsmi021/mcp-gemini-server)** - ⭐ 33
   This project provides a dedicated MCP (Model Context Protocol) server that wraps the @google/genai SDK. It exposes Google's Gemini model capabilities as standard MCP tools, allowing other LLMs (like Cline) or MCP-compatible systems to leverage Gemini's features as a backend workhorse.

1530. **[mcp_weather_server](https://github.com/isdaniel/mcp_weather_server)** - ⭐ 33
   A Model Context Protocol (MCP) server that provides weather information using the Open-Meteo API.

1531. **[fast-filesystem-mcp](https://github.com/efforthye/fast-filesystem-mcp)** - ⭐ 33
   A high-performance Model Context Protocol (MCP) server that provides secure filesystem access for Claude and other AI assistants.

1532. **[jina-mcp-tools](https://github.com/PsychArch/jina-mcp-tools)** - ⭐ 33
   A Model Context Protocol (MCP) server that integrates with Jina AI Search Foundation APIs.

1533. **[mcp-nats](https://github.com/sinadarbouy/mcp-nats)** - ⭐ 32
   A Model Context Protocol (MCP) server for NATS messaging system integration

1534. **[MayaMCP](https://github.com/PatrickPalmer/MayaMCP)** - ⭐ 32
   Model Context Protocol (MCP) server implementation for Autodesk Maya

1535. **[imap-mcp](https://github.com/non-dirty/imap-mcp)** - ⭐ 32
   IMAP Model Context Protocol server for interactive email processing

1536. **[mcp-mistral-ocr](https://github.com/everaldo/mcp-mistral-ocr)** - ⭐ 32
   Model Context Protocol (MCP) Server for Mistral OCR API

1537. **[rust-analyzer-mcp](https://github.com/zeenix/rust-analyzer-mcp)** - ⭐ 32
   A Model Context Protocol (MCP) server that provides integration with rust-analyzer

1538. **[a11y-mcp](https://github.com/priyankark/a11y-mcp)** - ⭐ 32
   An MCP (Model Context Protocol) server for performing accessibility audits on webpages using axe-core. Use the results in an agentic loop with your favorite AI assistants (Amp/Cline/Cursor/GH Copilot) and let them fix a11y issues for you!

1539. **[zilliz-mcp-server](https://github.com/zilliztech/zilliz-mcp-server)** - ⭐ 32
...
1540. **[azure-functions-mcp-extension](https://github.com/Azure/azure-functions-mcp-extension)** - ⭐ 32
   Model Context Protocol extension for Azure Functions.

1541. **[mcp-accessibility-scanner](https://github.com/JustasMonkev/mcp-accessibility-scanner)** - ⭐ 32
   An MCP (Model Context Protocol) server for performing accessibility audits on webpages using axe-core.

1542. **[codex-mcp-go](https://github.com/w31r4/codex-mcp-go)** - ⭐ 32
...
1543. **[Outlook_Calendar_MCP](https://github.com/merajmehrabi/Outlook_Calendar_MCP)** - ⭐ 32
   A Model Context Protocol (MCP) server that allows Claude to access and manage your local Microsfot Outlook calendar (Windows only).

1544. **[linkedin-mcpserver](https://github.com/felipfr/linkedin-mcpserver)** - ⭐ 32
   A powerful Model Context Protocol server for LinkedIn API integration

1545. **[godot-mcp](https://github.com/bradypp/godot-mcp)** - ⭐ 32
   A Model Context Protocol (MCP) server for interacting with the Godot game engine.

1546. **[mcp-registry](https://github.com/ARadRareness/mcp-registry)** - ⭐ 32
   A central registry and HTTP interface for coordinating Model Context Protocol (MCP) servers.

1547. **[altium-mcp](https://github.com/coffeenmusic/altium-mcp)** - ⭐ 31
   Altium Model Context Protocol server and Altium API script

1548. **[mcp-wikidata](https://github.com/zzaebok/mcp-wikidata)** - ⭐ 31
   A server implementation for Wikidata API using the Model Context Protocol (MCP).

1549. **[mcp-api-gateway](https://github.com/rflpazini/mcp-api-gateway)** - ⭐ 31
   A universal MCP (Model Context Protocol) server to integrate any API with Claude Desktop using only Docker configurations.

1550. **[mcp-pyautogui-server](https://github.com/hetaoBackend/mcp-pyautogui-server)** - ⭐ 31
   A MCP (Model Context Protocol) server that provides automated GUI testing and control capabilities through PyAutoGUI.

1551. **[PixVerse-MCP](https://github.com/PixVerseAI/PixVerse-MCP)** - ⭐ 31
   Official PixVerse Model Context Protocol (MCP) server that enables interaction with powerful AI video generation APIs.

1552. **[mcp-aoai-web-browsing](https://github.com/kimtth/mcp-aoai-web-browsing)** - ⭐ 31
   A minimal Model Context Protocol 🖥️ server/client🧑‍💻with Azure OpenAI and 🌐 web browser control via Playwright.

1553. **[McpToolkit](https://github.com/nuskey8/McpToolkit)** - ⭐ 31
   Lightweight, fast, NativeAOT compatible MCP (Model Context Protocol) framework for .NET

1554. **[Scientific-Papers-MCP](https://github.com/benedict2310/Scientific-Papers-MCP)** - ⭐ 31
...
1555. **[mcp-server-weibo](https://github.com/Selenium39/mcp-server-weibo)** - ⭐ 31
   Model Context Protocol服务器，用于抓取微博用户信息、动态和搜索功能

1556. **[mentor-mcp-server](https://github.com/cyanheads/mentor-mcp-server)** - ⭐ 31
...
1557. **[MCPDocSearch](https://github.com/alizdavoodi/MCPDocSearch)** - ⭐ 31
...
1558. **[crawl-mcp](https://github.com/wutongci/crawl-mcp)** - ⭐ 31
   完整的微信文章抓取MCP服务器 - 基于Model Context Protocol (MCP)的智能网页抓取工具，专为Cursor IDE和AI工具设计。

1559. **[simple-psql-mcp](https://github.com/NetanelBollag/simple-psql-mcp)** - ⭐ 31
...
1560. **[mcp-front](https://github.com/stainless-api/mcp-front)** - ⭐ 31
   Auth proxy for Model Context Protocol servers - adds authentication to MCP tools for Claude.ai, Claude Code, Cursor, Gemini

1561. **[linkedin-mcp-server](https://github.com/Dishant27/linkedin-mcp-server)** - ⭐ 31
   Model Context Protocol (MCP) server for LinkedIn API integration

1562. **[storyblok-mcp-server](https://github.com/Kiran1689/storyblok-mcp-server)** - ⭐ 31
...
1563. **[sunnysideFigma-Context-MCP](https://github.com/tercumantanumut/sunnysideFigma-Context-MCP)** - ⭐ 31
...
1564. **[PubChem-MCP-Server](https://github.com/Augmented-Nature/PubChem-MCP-Server)** - ⭐ 31
   A comprehensive Model Context Protocol (MCP) server for accessing the PubChem chemical database. This server provides access to over 110 million chemical compounds with extensive molecular properties, bioassay data, and chemical informatics tools.

1565. **[xiaohongshu-mcp-python](https://github.com/luyike221/xiaohongshu-mcp-python)** - ⭐ 31
...
1566. **[langfuse-mcp](https://github.com/avivsinai/langfuse-mcp)** - ⭐ 31
   A Model Context Protocol (MCP) server for Langfuse, enabling AI agents to query Langfuse trace data for enhanced debugging and observability

1567. **[nostr-mcp-server](https://github.com/AustinKelsay/nostr-mcp-server)** - ⭐ 30
   A Model Context Protocol (MCP) server that provides Nostr capabilities to LLMs like Claude.

1568. **[pan-mcp-relay](https://github.com/PaloAltoNetworks/pan-mcp-relay)** - ⭐ 30
   Palo Alto Networks AI Runtime Security Model Context Protocol (MCP) Relay Server

1569. **[chatwork-mcp-server](https://github.com/chatwork/chatwork-mcp-server)** - ⭐ 30
   ChatworkをAIから操作するためのMCP(Model Context Protocol)サーバー

1570. **[dev-kit](https://github.com/nguyenvanduocit/dev-kit)** - ⭐ 30
   [Model Context Protocol] Dev Kit - anything a developer need for him day to day works

1571. **[metabase-mcp](https://github.com/jerichosequitin/metabase-mcp)** - ⭐ 30
...
1572. **[wezterm-mcp](https://github.com/hiraishikentaro/wezterm-mcp)** - ⭐ 30
   About A Model Context Protocol server that executes commands in the current WezTerm session

1573. **[mcp-wasm](https://github.com/beekmarks/mcp-wasm)** - ⭐ 30
   A proof-of-concept implementation of a Model Context Protocol (MCP) server that runs in WebAssembly (WASM) within a web browser. This project demonstrates the integration of MCP tools and resources in a browser environment.

1574. **[mcp-weather](https://github.com/TimLukaHorstmann/mcp-weather)** - ⭐ 30
   A Model Context Protocol (MCP) server that provides hourly and daily weather forecasts using the AccuWeather API.

1575. **[mcp-databricks-server](https://github.com/RafaelCartenet/mcp-databricks-server)** - ⭐ 30
...
1576. **[mcp-codestyle-server](https://github.com/itxaiohanglover/mcp-codestyle-server)** - ⭐ 30
...
1577. **[claude-mcp](https://github.com/cnych/claude-mcp)** - ⭐ 29
   Claude Unified Model Context Interaction Protocol

1578. **[MCP-Server-Starter](https://github.com/TheSethRose/MCP-Server-Starter)** - ⭐ 29
   A Model Context Protocol server starter template

1579. **[openbim-mcp](https://github.com/helenkwok/openbim-mcp)** - ⭐ 29
   Model Context Protocol (MCP) server for openBIM

1580. **[mcp-server-dumplingai](https://github.com/DumplingAI/mcp-server-dumplingai)** - ⭐ 29
   MCP (Model Context Protocol) server for Dumpling AI

1581. **[mcp-cyclops](https://github.com/cyclops-ui/mcp-cyclops)** - ⭐ 29
   Model Context Protocol server for Cyclops

1582. **[mcp-badges](https://github.com/mcpx-dev/mcp-badges)** - ⭐ 29
   Get your projects MCP (Model Context Protocol)  badges

1583. **[apisix-mcp](https://github.com/api7/apisix-mcp)** - ⭐ 29
   APISIX Model Context Protocol (MCP) server is used to bridge large language models (LLMs) with the APISIX Admin API.

1584. **[authenticator_mcp](https://github.com/firstorderai/authenticator_mcp)** - ⭐ 29
   A secure MCP (Model Context Protocol) server that enables AI agents to interact with the Authenticator App.

1585. **[clap-mcp](https://github.com/gakonst/clap-mcp)** - ⭐ 29
   A Rust framework that bridges clap command-line applications with the Model Context Protocol (MCP)

1586. **[mcp-appium-gestures](https://github.com/AppiumTestDistribution/mcp-appium-gestures)** - ⭐ 29
   This is a Model Context Protocol (MCP) server providing resources and tools for Appium mobile gestures using Actions API..

1587. **[mcp-attr](https://github.com/frozenlib/mcp-attr)** - ⭐ 29
   A library for declaratively building Model Context Protocol servers.

1588. **[awesome-blockchain-mcps](https://github.com/royyannick/awesome-blockchain-mcps)** - ⭐ 29
...
1589. **[rails-pg-extras-mcp](https://github.com/pawurb/rails-pg-extras-mcp)** - ⭐ 29
   MCP (Model Context Protocol) LLM interface for rails-pg-extras gem

1590. **[mcpc](https://github.com/OlaHulleberg/mcpc)** - ⭐ 29
...
1591. **[Smart-Thinking](https://github.com/Leghis/Smart-Thinking)** - ⭐ 29
   Smart-Thinking is a Model Context Protocol (MCP) server that delivers graph-based, multi-step reasoning without relying on external AI APIs. Everything happens locally: similarity search, heuristic-based scoring, verification tracking, memory, and visualization all run in a deterministic pipeline designed for transparency and reproducibility.

1592. **[mcp-hacker-news](https://github.com/paabloLC/mcp-hacker-news)** - ⭐ 29
...
1593. **[mcp-google-cse](https://github.com/Richard-Weiss/mcp-google-cse)** - ⭐ 29
   A Model Context Protocol server that provides search capabilities using a Google CSE (custom search engine).

1594. **[seatunnel-mcp](https://github.com/ocean-zhc/seatunnel-mcp)** - ⭐ 29
...
1595. **[midi-mcp-server](https://github.com/tubone24/midi-mcp-server)** - ⭐ 29
...
1596. **[mcp-bundle](https://github.com/symfony/mcp-bundle)** - ⭐ 29
   Symfony integration bundle for Model Context Protocol (via official mcp/sdk)

1597. **[EU_AI_ACT_MCP](https://github.com/SonnyLabs/EU_AI_ACT_MCP)** - ⭐ 29
   EU AI Act MCP (Model Context Protocol) that connects to your AI agents, helping you to comply with the EU AI Act.

1598. **[mcp-browser-agent](https://github.com/imprvhub/mcp-browser-agent)** - ⭐ 29
   A Model Context Protocol (MCP) integration that provides Claude Desktop with autonomous browser automation capabilities. This agent enables Claude to interact with web content, manipulate DOM elements, execute JavaScript, and perform API requests.

1599. **[codebadger](https://github.com/Lekssays/codebadger)** - ⭐ 29
...
1600. **[hana-mcp-server](https://github.com/HatriGt/hana-mcp-server)** - ⭐ 28
   Model Context Server Protocol for your HANA DB

1601. **[mcp-server-lib.el](https://github.com/laurynas-biveinis/mcp-server-lib.el)** - ⭐ 28
   Emacs Lisp implementation of the Model Context Protocol

1602. **[sketchfab-mcp-server](https://github.com/gregkop/sketchfab-mcp-server)** - ⭐ 28
   This is an MCP (Model Context Protocol) Server for discovering and downloading 3D models 

1603. **[maven-mcp-server](https://github.com/Bigsy/maven-mcp-server)** - ⭐ 28
   An MCP (Model Context Protocol) server that provides tools for checking Maven dependency versions.

1604. **[mcp-testing-framework](https://github.com/L-Qun/mcp-testing-framework)** - ⭐ 28
   Testing framework for Model Context Protocol (MCP)

1605. **[laravel-mcp-sdk](https://github.com/mohamedahmed01/laravel-mcp-sdk)** - ⭐ 28
   Laravel Based Implementation for Model Context Protocol

1606. **[vsc-mcp](https://github.com/thomasgazzoni/vsc-mcp)** - ⭐ 28
   This project provides tools that expose Language Server Protocol (LSP) functionality as MCP (Model Context Protocol) tools

1607. **[YFinance-Trader-MCP-ClaudeDesktop](https://github.com/SaintDoresh/YFinance-Trader-MCP-ClaudeDesktop)** - ⭐ 28
   An MCP (Model Context Protocol) tool that provides stock market data and trading capabilities using the yfinance library, specifically adapted for Claude Desktop.

1608. **[mcp-websocket](https://github.com/virajsharma2000/mcp-websocket)** - ⭐ 28
   This server implements an MCP (Model Context Protocol) server with WebSocket enhancements for real-time data updates.

1609. **[MCP-Scanner](https://github.com/knostic/MCP-Scanner)** - ⭐ 28
...
1610. **[mcp-server-weibo](https://github.com/qinyuanpei/mcp-server-weibo)** - ⭐ 28
   基于 Model Context Protocol 的微博数据接口服务器 - 实时获取微博用户信息、动态内容、热搜榜单、粉丝关注数据。支持用户搜索、内容搜索、话题分析，为 AI 应用提供完整的微博数据接入方案。

1611. **[macOS-Notification-MCP](https://github.com/devizor/macOS-Notification-MCP)** - ⭐ 28
...
1612. **[AlphaFold-MCP-Server](https://github.com/Augmented-Nature/AlphaFold-MCP-Server)** - ⭐ 28
   A comprehensive Model Context Protocol (MCP) server that provides access to the AlphaFold Protein Structure Database through a rich set of tools and resources for protein structure prediction analysis.

1613. **[mcp_autogen_sse_stdio](https://github.com/SaM-92/mcp_autogen_sse_stdio)** - ⭐ 28
   This repository demonstrates how to use AutoGen to integrate local and remote MCP (Model Context Protocol) servers. It showcases a local math tool (math_server.py) using Stdio and a remote Apify tool (RAG Web Browser Actor) via SSE for tasks like arithmetic and web browsing.

1614. **[mattermost-mcp-host](https://github.com/jagan-shanmugam/mattermost-mcp-host)** - ⭐ 28
   A Mattermost integration that connects to Model Context Protocol (MCP) servers, leveraging a LangGraph-based Agent.

1615. **[directus-mcp-server](https://github.com/rijkvanzanten/directus-mcp-server)** - ⭐ 28
   Model Context Protocol server for Directus

1616. **[mcp](https://github.com/fastly/mcp)** - ⭐ 28
   Model Context Protocol (MCP) server for AI-powered Fastly CDN management.

1617. **[nchan-mcp-transport](https://github.com/ConechoAI/nchan-mcp-transport)** - ⭐ 28
...
1618. **[ai-vision-mcp](https://github.com/tan-yong-sheng/ai-vision-mcp)** - ⭐ 28
   A Model Context Protocol (MCP) server that provides vision capabilities to analyze image and video

1619. **[TAM-MCP-Server](https://github.com/gvaibhav/TAM-MCP-Server)** - ⭐ 28
...
1620. **[rod-mcp](https://github.com/go-rod/rod-mcp)** - ⭐ 27
   Model Context Protocol Server of Rod

1621. **[asterisk-mcp-server](https://github.com/winfunc/asterisk-mcp-server)** - ⭐ 27
   Asterisk Model Context Protocol (MCP) server.

1622. **[biothings-mcp](https://github.com/longevity-genie/biothings-mcp)** - ⭐ 27
   MCP (Model Context Protocol) server for biothings

1623. **[NetContextServer](https://github.com/willibrandon/NetContextServer)** - ⭐ 27
   A .NET implementation of the Model Context Protocol enabling AI assistants to explore and understand .NET codebases.

1624. **[do-remote-mcp-server-template](https://github.com/do-community/do-remote-mcp-server-template)** - ⭐ 27
   A Model Context Protocol (MCP) server that checks domain name availability using WHOIS lookups and DNS resolution

1625. **[dap_mcp](https://github.com/KashunCheng/dap_mcp)** - ⭐ 27
   Model Context Protocol (MCP) server that interacts with a Debugger

1626. **[Memgpt-MCP-Server](https://github.com/Vic563/Memgpt-MCP-Server)** - ⭐ 27
   A Model Context Protocol (MCP) server that provides persistent memory and multi-model LLM support.

1627. **[searxng-mcp](https://github.com/tisDDM/searxng-mcp)** - ⭐ 27
...
1628. **[browserai-mcp](https://github.com/brightdata/browserai-mcp)** - ⭐ 27
   A powerful Model Context Protocol (MCP) server that provides an access to serverless browser for AI agents and apps

1629. **[excel-reader-mcp](https://github.com/ArchimedesCrypto/excel-reader-mcp)** - ⭐ 27
...
1630. **[notion-mcp](https://github.com/Badhansen/notion-mcp)** - ⭐ 27
   A simple Model Context Protocol (MCP) server that integrates with Notion's API to manage my personal todo list.

1631. **[keynote-mcp](https://github.com/easychen/keynote-mcp)** - ⭐ 27
   A Model Context Protocol (MCP) server that enables AI assistants to control Keynote presentations through AppleScript automation.

1632. **[mcp-etherscan-server](https://github.com/crazyrabbitLTC/mcp-etherscan-server)** - ⭐ 27
   An MCP (Model Context Protocol) server that provides Ethereum blockchain data tools via Etherscan's API. Features include checking ETH balances, viewing transaction history, tracking ERC20 transfers, fetching contract ABIs, monitoring gas prices, and resolving ENS names.

1633. **[aws-mcp](https://github.com/lokeswaran-aj/aws-mcp)** - ⭐ 27
   An MCP(Model Context Protocol) Server for AWS services

1634. **[MCPCorpus](https://github.com/Snakinya/MCPCorpus)** - ⭐ 27
...
1635. **[mcp-ollama-agent](https://github.com/ausboss/mcp-ollama-agent)** - ⭐ 27
...
1636. **[claude-code-mcp](https://github.com/zebbern/claude-code-mcp)** - ⭐ 27
...
1637. **[univer-mcp](https://github.com/dream-num/univer-mcp)** - ⭐ 27
   AI-powered spreadsheet automation through Model Context Protocol (MCP) server for Univer

1638. **[mcp-googletasks](https://github.com/arpitbatra123/mcp-googletasks)** - ⭐ 27
...
1639. **[mcp-for-security-python](https://github.com/f1tz/mcp-for-security-python)** - ⭐ 27
...
1640. **[mcp_server](https://github.com/peppemas/mcp_server)** - ⭐ 27
   A C++ implementation of a Model Context Protocol Server with a pluggable module architecture.

1641. **[mcp-frontend-testing](https://github.com/StudentOfJS/mcp-frontend-testing)** - ⭐ 26
   Frontend testing tools for Model Context Protocol

1642. **[google-workspace-mcp-server](https://github.com/epaproditus/google-workspace-mcp-server)** - ⭐ 26
   A Model Context Protocol server for Google Workspace integration (Gmail and Calendar)

1643. **[pptx-xlsx-mcp](https://github.com/jenstangen1/pptx-xlsx-mcp)** - ⭐ 26
   Antrophics Model context protocol to edit powerpoint files

1644. **[actor-critic-thinking-mcp](https://github.com/aquarius-wing/actor-critic-thinking-mcp)** - ⭐ 26
   A dual-perspective thinking analysis server based on Model Context Protocol (MCP), providing comprehensive performance evaluation through Actor-Critic methodology.

1645. **[mcp-web-browser](https://github.com/random-robbie/mcp-web-browser)** - ⭐ 26
   An advanced web browsing server for the Model Context Protocol (MCP) powered by Playwright, enabling headless browser interactions through a flexible, secure API.

1646. **[VercelGenUI_MCP](https://github.com/JamesSloan/VercelGenUI_MCP)** - ⭐ 26
   Proof of concept chat AI combining the Model Context Protocol (MCP) with Vercel's AI SDK UI

1647. **[minds-mcp](https://github.com/mindsdb/minds-mcp)** - ⭐ 26
...
1648. **[MCP-BOE](https://github.com/ComputingVictor/MCP-BOE)** - ⭐ 26
...
1649. **[mcp-tool-filter](https://github.com/Portkey-AI/mcp-tool-filter)** - ⭐ 26
...
1650. **[email-mcp](https://github.com/TimeCyber/email-mcp)** - ⭐ 26
   一个让AI轻松接管邮箱的MCP服务，基于 Model Context Protocol (MCP) 构建，支持在 MCP-X,Claude Desktop 等 MCP 客户端中使用。

1651. **[nvim-mcp](https://github.com/linw1995/nvim-mcp)** - ⭐ 26
...
1652. **[workflows-mcp-server](https://github.com/cyanheads/workflows-mcp-server)** - ⭐ 26
...
1653. **[filesystem-mcp-server](https://github.com/cyanheads/filesystem-mcp-server)** - ⭐ 26
   A Model Context Protocol (MCP) server for platform-agnostic file capabilities, including advanced search/replace and directory tree traversal

1654. **[openapi-mcp-generator](https://github.com/abutbul/openapi-mcp-generator)** - ⭐ 26
...
1655. **[mcp-server-giphy](https://github.com/magarcia/mcp-server-giphy)** - ⭐ 26
   An implementation of Giphy integration with Model Context Protocol

1656. **[nettune](https://github.com/jtsang4/nettune)** - ⭐ 26
...
1657. **[framer-plugin-mcp](https://github.com/Sheshiyer/framer-plugin-mcp)** - ⭐ 26
   A Model Context Protocol (MCP) server for creating and managing Framer plugins with web3 capabilities

1658. **[alpaca-mcp-server](https://github.com/tedlikeskix/alpaca-mcp-server)** - ⭐ 25
   Model Context Protocol (MCP) server for Alpaca trading API

1659. **[gyazo-mcp-server](https://github.com/nota/gyazo-mcp-server)** - ⭐ 25
   Official Model Context Protocol server for Gyazo

1660. **[Healthcare-MCP](https://github.com/innovaccer/Healthcare-MCP)** - ⭐ 25
...
1661. **[semrush-mcp](https://github.com/mrkooblu/semrush-mcp)** - ⭐ 25
   A Model Context Protocol (MCP) server implementation that provides tools for accessing Semrush API data.

1662. **[mcp-php](https://github.com/garyblankenship/mcp-php)** - ⭐ 25
   model context protocol or mcp for php laravel

1663. **[xmind-generator-mcp](https://github.com/BangyiZhang/xmind-generator-mcp)** - ⭐ 25
   An MCP (Model Context Protocol) server for generating Xmind mind maps. This server allows LLMs to create structured mind maps through the MCP protocol.

1664. **[mcp-writer-substack](https://github.com/jonathan-politzki/mcp-writer-substack)** - ⭐ 25
   Model Context Protocol to bridge in Substack writings to Claude.

1665. **[mcp-advisor](https://github.com/olaservo/mcp-advisor)** - ⭐ 25
   MCP Server to assist LLMs and humans on Model Context Protocol spec compliance and understanding

1666. **[mcp-media-processor](https://github.com/maoxiaoke/mcp-media-processor)** - ⭐ 25
   A Node.js server implementing Model Context Protocol (MCP) for media processing operations, providing powerful video and image manipulation capabilities.

1667. **[php-mcp](https://github.com/dtyq/php-mcp)** - ⭐ 25
...
1668. **[systemprompt-mcp-notion](https://github.com/Ejb503/systemprompt-mcp-notion)** - ⭐ 25
...
1669. **[mcp-webdriveragent](https://github.com/AppiumTestDistribution/mcp-webdriveragent)** - ⭐ 25
   This is a Model Context Protocol (MCP) server that provides tools for building and signing WebDriverAgent for iOS.

1670. **[seo-insights-mcp-server](https://github.com/mrgoonie/seo-insights-mcp-server)** - ⭐ 25
...
1671. **[turn-based-game-mcp](https://github.com/github-samples/turn-based-game-mcp)** - ⭐ 25
...
1672. **[org-mcp](https://github.com/laurynas-biveinis/org-mcp)** - ⭐ 25
   Emacs Org-mode integration with Model Context Protocol (MCP) for AI-assisted task management

1673. **[taiwan-holiday-mcp](https://github.com/lis186/taiwan-holiday-mcp)** - ⭐ 25
   一個基於 Model Context Protocol (MCP) 的台灣假期查詢伺服器，為 AI 工具提供準確的台灣國定假日資訊。

1674. **[alibabacloud-dataworks-mcp-server](https://github.com/aliyun/alibabacloud-dataworks-mcp-server)** - ⭐ 25
   A Model Context Protocol (MCP) server that provides tools for AI, allowing it to interact with the DataWorks Open API through a standardized interface. This implementation is based on the Aliyun Open API and enables AI agents to perform cloud resources operations seamlessly.

1675. **[mcp-manager](https://github.com/nstebbins/mcp-manager)** - ⭐ 25
   CLI tool for managing Model Context Protocol (MCP) servers in one place & using them across them different clients

1676. **[php-mcp-sdk](https://github.com/dalehurley/php-mcp-sdk)** - ⭐ 25
...
1677. **[mcp-domain-availability](https://github.com/imprvhub/mcp-domain-availability)** - ⭐ 25
   A Model Context Protocol (MCP) server that enables Claude Desktop to check domain availability across 50+ TLDs. Features DNS/WHOIS verification, bulk checking, and smart suggestions. Zero-clone installation via uvx.

1678. **[lunchmoney-mcp](https://github.com/akutishevsky/lunchmoney-mcp)** - ⭐ 25
...
1679. **[Unlock-your-agents-potential-with-Model-Context-Protocol-PostgreSQL-Workshop](https://github.com/gloveboxes/Unlock-your-agents-potential-with-Model-Context-Protocol-PostgreSQL-Workshop)** - ⭐ 24

1680. **[slack-mcp-server](https://github.com/AVIMBU/slack-mcp-server)** - ⭐ 24
   A Model Context Protocol Server for Interacting with Slack

1681. **[n8n-mcp](https://github.com/vredrick/n8n-mcp)** - ⭐ 24
   n8n MCP Server - Documentation and tools for n8n nodes via Model Context Protocol with SSE support

1682. **[adb-mcp](https://github.com/srmorete/adb-mcp)** - ⭐ 24
   An MCP (Model Context Protocol) server for interacting with Android devices through ADB in TypeScript.

1683. **[ton-blockchain-mcp](https://github.com/devonmojito/ton-blockchain-mcp)** - ⭐ 24
   A Model Context Protocol (MCP) server written in Python for natural language interaction with the TON blockchain 💎

1684. **[ccmcp](https://github.com/gsong/ccmcp)** - ⭐ 24
   A CLI tool that intelligently discovers, validates, and selects MCP (Model Context Protocol) server configurations for Claude Code.

1685. **[mcp-bash](https://github.com/patrickomatik/mcp-bash)** - ⭐ 24
...
1686. **[agent-hub-mcp](https://github.com/gilbarbara/agent-hub-mcp)** - ⭐ 24
   A Model Context Protocol (MCP) server that enables communication and coordination between multiple AI agents

1687. **[mcp-structured-thinking](https://github.com/Promptly-Technologies-LLC/mcp-structured-thinking)** - ⭐ 24
...
1688. **[Volatility-MCP-Server](https://github.com/bornpresident/Volatility-MCP-Server)** - ⭐ 24
   A Model Context Protocol (MCP) server that integrates Volatility 3 memory forensics framework with Claude

1689. **[opnsense-mcp-server](https://github.com/floriangrousset/opnsense-mcp-server)** - ⭐ 24
...
1690. **[taskflow-mcp](https://github.com/pinkpixel-dev/taskflow-mcp)** - ⭐ 24
   A task management Model Context Protocol (MCP) server that helps AI assistants break down user requests into manageable tasks with subtasks, dependencies, and notes. Enforces a structured workflow with user approval steps.

1691. **[n8n-AI-agent-DVM-MCP-client](https://github.com/r0d8lsh0p/n8n-AI-agent-DVM-MCP-client)** - ⭐ 24
...
1692. **[puppeteer-mcp-claude](https://github.com/jaenster/puppeteer-mcp-claude)** - ⭐ 24
...
1693. **[mcp-server-semgrep](https://github.com/Szowesgad/mcp-server-semgrep)** - ⭐ 24
   MCP Server Semgrep is a [Model Context Protocol](https://modelcontextprotocol.io) compliant server that integrates the powerful Semgrep static analysis tool with AI assistants like Anthropic Claude. It enables advanced code analysis, security vulnerability detection, and code quality improvements directly through a conversational interface.

1694. **[deep-research-mcp](https://github.com/pinkpixel-dev/deep-research-mcp)** - ⭐ 24
   A Model Context Protocol (MCP) compliant server designed for comprehensive web research. It uses Tavily's Search and Crawl APIs to gather detailed information on a given topic, then structures this data in a format perfect for LLMs to create high-quality markdown documents.

1695. **[symfony-mcp-server](https://github.com/klapaudius/symfony-mcp-server)** - ⭐ 24
   A Symfony package designed for building secure servers based on the Model Context Protocol, utilizing Server-Sent Events (SSE) and/or StreamableHTTP for real-time communication. It offers a scalable tool system tailored for enterprise-grade applications.

1696. **[nebulagraph-mcp-server](https://github.com/nebula-contrib/nebulagraph-mcp-server)** - ⭐ 24
   Model Context Protocol Server for NebulaGraph 3.x

1697. **[Model-Context-Protocol](https://github.com/Coding-Crashkurse/Model-Context-Protocol)** - ⭐ 23

1698. **[greptimedb-mcp-server](https://github.com/GreptimeTeam/greptimedb-mcp-server)** - ⭐ 23
   A Model Context Protocol (MCP) server for GreptimeDB

1699. **[mcp-server](https://github.com/blockscout/mcp-server)** - ⭐ 23
   Wraps Blockscout APIs and exposes blockchain data by Model Context Protocol

1700. **[postgres-mcp-server](https://github.com/ahmedmustahid/postgres-mcp-server)** - ⭐ 23
   MCP (Model Context Protocol) Server for postgres Database

1701. **[clay-mcp](https://github.com/clay-inc/clay-mcp)** - ⭐ 23
   A simple Model Context Protocol (MCP) server for Clay.

1702. **[jigsawstack-mcp-server](https://github.com/JigsawStack/jigsawstack-mcp-server)** - ⭐ 23
   Model Context Protocol Server that allows AI models to interact with JigsawStack models!

1703. **[FalkorDB-MCPServer](https://github.com/FalkorDB/FalkorDB-MCPServer)** - ⭐ 23
   FalkorDB-MCPServer is an MCP (Model Context Protocol) server that connects LLMs to FalkorDB

1704. **[freepik-mcp](https://github.com/freepik-company/freepik-mcp)** - ⭐ 23
   The Freepik enables popular agent Model Context Protocol (MCP) to integrate with Freepik APIs through function calling.

1705. **[metabase-mcp-server](https://github.com/hyeongjun-dev/metabase-mcp-server)** - ⭐ 23
   A Model Context Protocol server that integrates AI assistants with Metabase analytics platform

1706. **[brlaw_mcp_server](https://github.com/pdmtt/brlaw_mcp_server)** - ⭐ 23
   A MCP (Model Context Protocol) server for agent-driven research on Brazilian law using official sources

1707. **[Python-Runtime-Interpreter-MCP-Server](https://github.com/hileamlakB/Python-Runtime-Interpreter-MCP-Server)** - ⭐ 23
   PRIMS is a lightweight, open-source Model Context Protocol (MCP) server that lets LLM agents safely execute arbitrary Python code in a secure, throw-away sandbox.

1708. **[MCP](https://github.com/EduBase/MCP)** - ⭐ 23
   The EduBase MCP server enables Claude and other LLMs to interact with EduBase's comprehensive e-learning platform through the Model Context Protocol (MCP).

1709. **[nobitex-mcp-server](https://github.com/xmannii/nobitex-mcp-server)** - ⭐ 23
   a Model Context Protocol (MCP) server that provides access to cryptocurrency market data from the Nobitex API.

1710. **[batchdata-mcp-real-estate](https://github.com/zellerhaus/batchdata-mcp-real-estate)** - ⭐ 23
...
1711. **[DeepResearchMCP](https://github.com/ameeralns/DeepResearchMCP)** - ⭐ 23
...
1712. **[calendar-mcp](https://github.com/deciduus/calendar-mcp)** - ⭐ 23
...
1713. **[cortex](https://github.com/FreePeak/cortex)** - ⭐ 23
...
1714. **[kaggle-mcp](https://github.com/54yyyu/kaggle-mcp)** - ⭐ 23
...
1715. **[mcp-ffmpeg-helper](https://github.com/sworddut/mcp-ffmpeg-helper)** - ⭐ 23
   一个基于 Model Context Protocol (MCP) 的 FFmpeg 辅助工具，提供视频处理功能。

1716. **[paraview_mcp](https://github.com/LLNL/paraview_mcp)** - ⭐ 23
...
1717. **[bgg-mcp](https://github.com/kkjdaniel/bgg-mcp)** - ⭐ 23
   BGG MCP provides access to BoardGameGeek and a variety of board game related data through the Model Context Protocol. Enabling retrieval and filtering of board game data, user collections, and profiles.

1718. **[aistudio-mcp-server](https://github.com/eternnoir/aistudio-mcp-server)** - ⭐ 23
...
1719. **[whistle-mcp](https://github.com/7gugu/whistle-mcp)** - ⭐ 23
...
1720. **[google-search-console-mcp-server](https://github.com/Shin-sibainu/google-search-console-mcp-server)** - ⭐ 23
   Model Context Protocol server for Google Search Console API - integrate with Claude Code and Claude Desktop

1721. **[reaper-mcp](https://github.com/itsuzef/reaper-mcp)** - ⭐ 23
   A comprehensive Model Context Protocol (MCP) server that enables AI agents to create fully mixed and mastered tracks in REAPER with both MIDI and audio capabilities.

1722. **[python-sequential-thinking-mcp](https://github.com/XD3an/python-sequential-thinking-mcp)** - ⭐ 23
...
1723. **[lineshopping-api-mcp](https://github.com/woraphol-j/lineshopping-api-mcp)** - ⭐ 23
...
1724. **[mcp-zap-server](https://github.com/dtkmn/mcp-zap-server)** - ⭐ 23
   A Spring Boot application exposing OWASP ZAP as an MCP (Model Context Protocol) server. It lets any MCP‑compatible AI agent (e.g., Claude Desktop, Cursor) orchestrate ZAP actions—spider, active scan, import OpenAPI specs, and generate reports.

1725. **[mcp_rss](https://github.com/buhe/mcp_rss)** - ⭐ 23
   MCP RSS is a Model Context Protocol (MCP) server for interacting with RSS feeds.

1726. **[home-assistant-mcp](https://github.com/hpohlmann/home-assistant-mcp)** - ⭐ 23
...
1727. **[mcp-twitter-server](https://github.com/crazyrabbitLTC/mcp-twitter-server)** - ⭐ 22
   Model Context Protocol Server for Accessing twitter

1728. **[mcp-server-oracle](https://github.com/hdcola/mcp-server-oracle)** - ⭐ 22
   Model Context Protocol server to access oracle database

1729. **[lightdash-mcp-server](https://github.com/syucream/lightdash-mcp-server)** - ⭐ 22
   A MCP(Model Context Protocol) server that accesses to Lightdash

1730. **[mcp-pa-ai-agent](https://github.com/zhangzhongnan928/mcp-pa-ai-agent)** - ⭐ 22
   A personal assistant AI agent built with the Model Context Protocol (MCP)

1731. **[higress-ops-mcp-server](https://github.com/higress-group/higress-ops-mcp-server)** - ⭐ 22
   A Model Context Protocol (MCP) server implementation that enables comprehensive configuration and management of Higress.

1732. **[Elysia-mcp](https://github.com/keithagroves/Elysia-mcp)** - ⭐ 22
   Model Context Protocol (MCP) Server for Bun and Elysia

1733. **[lua-resty-mcp](https://github.com/ufownl/lua-resty-mcp)** - ⭐ 22
   Model Context Protocol SDK implemented in Lua for OpenResty

1734. **[dynamic-fastmcp](https://github.com/ragieai/dynamic-fastmcp)** - ⭐ 22
...
1735. **[mcp-flux-studio](https://github.com/jmanhype/mcp-flux-studio)** - ⭐ 22
   A Model Context Protocol server for Flux image generation, providing tools for image generation, manipulation, and control

1736. **[DANP-Engine](https://github.com/DANP-LABS/DANP-Engine)** - ⭐ 22
   A trusted AI Model Context Protocol (MCP) runtime for secure, decentralized AI tools and services.

1737. **[mcp-sync](https://github.com/ztripez/mcp-sync)** - ⭐ 22
   Sync MCP (Model Context Protocol) configurations across AI tools

1738. **[mcp-sse-authenticated-cloud-run](https://github.com/the-freetech-company/mcp-sse-authenticated-cloud-run)** - ⭐ 22
   Host an Model Context Protocol SSE deployment on Cloud Run, Authenticating with IAM.

1739. **[mcp-server-starter-ts](https://github.com/alexanderop/mcp-server-starter-ts)** - ⭐ 22
   A minimal TypeScript starter template for building Model Context Protocol (MCP) servers.

1740. **[forgejo-mcp](https://github.com/goern/forgejo-mcp)** - ⭐ 22
...
1741. **[prometheus-mcp](https://github.com/idanfishman/prometheus-mcp)** - ⭐ 22
   A Model Context Protocol (MCP) server implementation that provides AI agents with programmatic access to Prometheus metrics via a unified interface.

1742. **[mcp-zero](https://github.com/zeromicro/mcp-zero)** - ⭐ 22
   Model Context Protocol (MCP) server for go-zero framework - Generate APIs, RPC services, and models with AI assistance.

1743. **[reaper-reapy-mcp](https://github.com/wegitor/reaper-reapy-mcp)** - ⭐ 22
...
1744. **[MobSF-MCP](https://github.com/il-il1/MobSF-MCP)** - ⭐ 22
   a Node.js-based Model Context Protocol implementation for MobSF

1745. **[enhanced-mcp-memory](https://github.com/cbunting99/enhanced-mcp-memory)** - ⭐ 22
   An enhanced MCP (Model Context Protocol) server for intelligent memory and task management, designed for AI assistants and development workflows. Features semantic search, automatic task extraction, knowledge graphs, and comprehensive project management.

1746. **[vision-one-mcp-server](https://github.com/trendmicro/vision-one-mcp-server)** - ⭐ 22
...
1747. **[async-mcp](https://github.com/v3g42/async-mcp)** - ⭐ 22
   A minimalistic async Rust implementation of the Model Context Protocol (MCP).

1748. **[xhs-mcp](https://github.com/Algovate/xhs-mcp)** - ⭐ 22
   用于小红书（xiaohongshu.com）的 Model Context Protocol（MCP）服务器与 CLI 工具，支持登录、发布、搜索、推荐等自动化能力

1749. **[MCP-Developer-SubAgent](https://github.com/gensecaihq/MCP-Developer-SubAgent)** - ⭐ 22
...
1750. **[quickbooks-online-mcp-server](https://github.com/intuit/quickbooks-online-mcp-server)** - ⭐ 22
...
1751. **[mcpagentai](https://github.com/mcpagents-ai/mcpagentai)** - ⭐ 22
...
1752. **[aisdk-mcp-bridge](https://github.com/vrknetha/aisdk-mcp-bridge)** - ⭐ 22
...
1753. **[bzm-mcp](https://github.com/Blazemeter/bzm-mcp)** - ⭐ 22
...
1754. **[p5js-ai-editor](https://github.com/adilmoujahid/p5js-ai-editor)** - ⭐ 22
...
1755. **[strava-mcp](https://github.com/kw510/strava-mcp)** - ⭐ 22
...
1756. **[fastify-mcp](https://github.com/haroldadmin/fastify-mcp)** - ⭐ 22
   A Fastify plugin to run Model Context Protocol (MCP) servers

1757. **[meeting-mcp](https://github.com/Meeting-BaaS/meeting-mcp)** - ⭐ 22
   Model Context Protocol server for AI assistants to create meeting bots, search transcripts, and manage meeting recordings.

1758. **[datagouv-mcp](https://github.com/datagouv/datagouv-mcp)** - ⭐ 22
...
1759. **[bridge-mcp](https://github.com/codingjam/bridge-mcp)** - ⭐ 21
...
1760. **[powerplatform-mcp](https://github.com/michsob/powerplatform-mcp)** - ⭐ 21
   PowerPlatform Model Context Protocol server

1761. **[RevitMCP](https://github.com/oakplank/RevitMCP)** - ⭐ 21
   model context protocol for Autodesk Revit

1762. **[cml-mcp](https://github.com/xorrkaz/cml-mcp)** - ⭐ 21
   A Model Context Protocol (MCP) Server for Cisco Modeling Labs (CML)

1763. **[github-repo-mcp](https://github.com/Ryan0204/github-repo-mcp)** - ⭐ 21
   Model Context Protocol server for Github Repo // Reading Github Repo

1764. **[mcpsharepoint](https://github.com/BrianCusack/mcpsharepoint)** - ⭐ 21
   Model Context Protocol server that provides access to Organisational SharePoint.

1765. **[dbt-docs-mcp](https://github.com/mattijsdp/dbt-docs-mcp)** - ⭐ 21
   MCP (model context protocol) server for interacting with dbt Docs

1766. **[mcp-slicer](https://github.com/zhaoyouj/mcp-slicer)** - ⭐ 21
   A Model Context Protocol server for 3D Slicer integration

1767. **[MCPSecBench](https://github.com/AIS2Lab/MCPSecBench)** - ⭐ 21
   MCPSecBench: A Systematic Security Benchmark and Playground for Testing Model Context Protocols

1768. **[command-executor-mcp-server](https://github.com/Sunwood-ai-labs/command-executor-mcp-server)** - ⭐ 21
   Model Context Protocol Server for Safely Executing Pre-approved Commands

1769. **[mcp-caiyun-weather](https://github.com/caiyunapp/mcp-caiyun-weather)** - ⭐ 21
   A Model Context Protocol (MCP) server for Caiyun (ColorfulClouds) Weather.

1770. **[emqx-mcp-server](https://github.com/Benniu/emqx-mcp-server)** - ⭐ 21
   A Model Context Protocol (MCP) server implementation that provides EMQX MQTT broker interaction.

1771. **[mcp-claude-spotify](https://github.com/imprvhub/mcp-claude-spotify)** - ⭐ 21
   An integration that allows Claude Desktop to interact with Spotify using the Model Context Protocol (MCP).

1772. **[mcp-sentry](https://github.com/MCP-100/mcp-sentry)** - ⭐ 21
   A Model Context Protocol server for retrieving and analyzing issues from Sentry.io

1773. **[zillow-mcp-server](https://github.com/sap156/zillow-mcp-server)** - ⭐ 21
   Zillow MCP Server for real estate data access via the Model Context Protocol

1774. **[ddg_search](https://github.com/OEvortex/ddg_search)** - ⭐ 21
   A powerful Model Context Protocol (MCP) server for web search and URL content extraction using DuckDuckGo.

1775. **[fastify-mcp-server](https://github.com/flaviodelgrosso/fastify-mcp-server)** - ⭐ 21
   Fastify plugin to easily spin up Model Context Protocol (MCP) HTTP servers

1776. **[modao-proto-mcp](https://github.com/modao-dev/modao-proto-mcp)** - ⭐ 21
...
1777. **[cursor-db-mcp](https://github.com/jbdamask/cursor-db-mcp)** - ⭐ 21
   Model Context Protocol server for querying Cursor chat history

1778. **[mcp-korean-spell](https://github.com/winterjung/mcp-korean-spell)** - ⭐ 21
   MCP(Model Context Protocol) server designed for Korean spell checking

1779. **[solana-mcp](https://github.com/tony-42069/solana-mcp)** - ⭐ 21
...
1780. **[DocsRay](https://github.com/MIMICLab/DocsRay)** - ⭐ 21
   Lightweight PDF Q&A tool powered by RAG (Retrieval-Augmented Generation) with MCP (Model Context Protocol) Support.

1781. **[mcp-task-manager-server](https://github.com/bsmi021/mcp-task-manager-server)** - ⭐ 21
   A local Model Context Protocol (MCP) server providing backend tools for client-driven project and task management using a SQLite database.

1782. **[nestjs-mcp](https://github.com/bamada/nestjs-mcp)** - ⭐ 21
   NestJS module for seamless Model Context Protocol (MCP) server integration using decorators.

1783. **[omop_mcp](https://github.com/OHNLP/omop_mcp)** - ⭐ 21
...
1784. **[MCPRules](https://github.com/bartwisch/MCPRules)** - ⭐ 21
...
1. **[chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat)** - ⭐ 40,070
   基于大模型搭建的聊天机器人，同时支持 微信公众号、企业微信应用、飞书、钉钉 等接入，可选择ChatGPT/Claude/DeepSeek/文心一言/讯飞星火/通义千问/ Gemini/GLM-4/Kimi/LinkAI，能处理文本、语音和图片，访问操作系统和互联网，支持基于自有知识库进行定制企业智能客服。

2. **[agentscope](https://github.com/agentscope-ai/agentscope)** - ⭐ 14,404
   AgentScope: Agent-Oriented Programming for Building LLM Applications

3. **[bytebot](https://github.com/bytebot-ai/bytebot)** - ⭐ 9,936
   Bytebot is a self-hosted AI desktop agent that automates computer tasks through natural language commands, operating within a containerized Linux desktop environment.

4. **[valuecell](https://github.com/ValueCell-ai/valuecell)** - ⭐ 7,394
   ValueCell is a community-driven, multi-agent platform for financial applications.

5. **[ruoyi-ai](https://github.com/ageerle/ruoyi-ai)** - ⭐ 4,528
   RuoYi AI 是一个全栈式 AI 开发平台，旨在帮助开发者快速构建和部署个性化的 AI 应用。

6. **[shippie](https://github.com/mattzcarey/shippie)** - ⭐ 2,303
...
10. **[openinference](https://github.com/Arize-ai/openinference)** - ⭐ 760
...
15. **[flow-like](https://github.com/TM9657/flow-like)** - ⭐ 514
   Flow-Like: Strongly Typed Enterprise Scale Workflows. Built for scalability, speed, seamless AI integration and rich customization.

16. **[voicemode](https://github.com/mbailey/voicemode)** - ⭐ 491
...
1. **[n8n](https://github.com/n8n-io/n8n)** - ⭐ 162,318
   Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.

2. **[kong](https://github.com/Kong/kong)** - ⭐ 42,364
   🦍 The Cloud-Native Gateway for APIs & AI

3. **[LocalAI](https://github.com/mudler/LocalAI)** - ⭐ 40,069
   :robot: The free, Open Source alternative to OpenAI, Claude and others. Self-hosted and local-first. Drop-in replacement for OpenAI,  running on consumer-grade hardware. No GPU required. Runs gguf, transformers, diffusers and many more. Features: Generate Text, MCP, Audio, Video, Images, Voice Cloning, Distributed, P2P and decentralized inference

4. **[FastGPT](https://github.com/labring/FastGPT)** - ⭐ 26,544
   FastGPT is a knowledge-based platform built on the LLMs, offers a comprehensive suite of out-of-the-box capabilities such as data processing, RAG retrieval, and visual AI workflow orchestration, letting you easily develop and deploy complex question-answering systems without the need for extensive setup or configuration.

5. **[kratos](https://github.com/go-kratos/kratos)** - ⭐ 25,199
   Your ultimate Go microservices framework for the cloud-native era.

6. **[excelize](https://github.com/qax-os/excelize)** - ⭐ 20,026
   Go language library for reading and writing Microsoft Excel™ (XLAM / XLSM / XLSX / XLTM / XLTX) spreadsheets

7. **[plate](https://github.com/udecode/plate)** - ⭐ 15,599
...
9. **[AstrBot](https://github.com/AstrBotDevs/AstrBot)** - ⭐ 14,111
...
10. **[Fay](https://github.com/xszyou/Fay)** - ⭐ 12,169
   fay是一个帮助数字人（2.5d、3d、移动、pc、网页）或大语言模型（openai兼容、deepseek）连通业务系统的mcp框架。

11. **[ui](https://github.com/creativetimofficial/ui)** - ⭐ 11,389
   Open-source components, blocks, and AI agents designed to speed up your workflow. Import them seamlessly into your favorite tools through Registry and MCPs.

12. **[note-gen](https://github.com/codexu/note-gen)** - ⭐ 10,163
   A cross-platform Markdown AI note-taking software.

13. **[langchain4j](https://github.com/langchain4j/langchain4j)** - ⭐ 9,931
   LangChain4j is an open-source Java library that simplifies the integration of LLMs into Java applications through a unified API, providing access to popular LLMs and vector databases. It makes implementing RAG, tool calling (including support for MCP), and agents easy. LangChain4j integrates seamlessly with various enterprise Java frameworks.

14. **[OpenMetadata](https://github.com/open-metadata/OpenMetadata)** - ⭐ 8,210
   OpenMetadata is a unified metadata platform for data discovery, data observability, and data governance powered by a central metadata repository, in-depth column level lineage, and seamless team collaboration.

15. **[Upsonic](https://github.com/Upsonic/Upsonic)** - ⭐ 7,727
   Agent Framework For Fintech and Banks

16. **[astron-agent](https://github.com/iflytek/astron-agent)** - ⭐ 7,550
   Enterprise-grade, commercial-friendly agentic workflow platform for building next-generation SuperAgents.

17. **[lamda](https://github.com/firerpa/lamda)** - ⭐ 7,459
    The most powerful Android RPA agent framework, next generation of mobile automation robots.

18. **[adk-go](https://github.com/google/adk-go)** - ⭐ 6,240
   An open-source, code-first Go toolkit for building, evaluating, and deploying sophisticated AI agents with flexibility and control.

19. **[53AIHub](https://github.com/53AI/53AIHub)** - ⭐ 5,416
...
20. **[deepchat](https://github.com/ThinkInAIXYZ/deepchat)** - ⭐ 5,152
   🐬DeepChat - A smart assistant that connects powerful AI to your personal world

21. **[Viper](https://github.com/FunnyWolf/Viper)** - ⭐ 4,618
   Adversary simulation and Red teaming platform with AI

22. **[magic](https://github.com/dtyq/magic)** - ⭐ 4,388
   Super Magic. The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)

23. **[ENScan_GO](https://github.com/wgpsec/ENScan_GO)** - ⭐ 4,114
   一款基于各大企业信息API的工具，解决在遇到的各种针对国内企业信息收集难题。一键收集控股公司ICP备案、APP、小程序、微信公众号等信息聚合导出。支持MCP接入

24. **[nexent](https://github.com/ModelEngine-Group/nexent)** - ⭐ 4,078
...
25. **[ag2](https://github.com/ag2ai/ag2)** - ⭐ 3,927
   AG2 (formerly AutoGen): The Open-Source AgentOS. Join us at: https://discord.gg/pAbnFJrkgZ

26. **[koog](https://github.com/JetBrains/koog)** - ⭐ 3,519
...
27. **[solon](https://github.com/opensolon/solon)** - ⭐ 2,674
...
28. **[semantic-router](https://github.com/vllm-project/semantic-router)** - ⭐ 2,389
   Intelligent Router for Mixture-of-Models

29. **[ultracite](https://github.com/haydenbleasel/ultracite)** - ⭐ 2,366
   A highly opinionated, zero-configuration linter and formatter.

30. **[harbor](https://github.com/av/harbor)** - ⭐ 2,183
   Effortlessly run LLM backends, APIs, frontends, and services with one command.

31. **[amazon-q-developer-cli](https://github.com/aws/amazon-q-developer-cli)** - ⭐ 1,845
   ✨ Agentic chat experience in your terminal. Build applications using natural language.

32. **[MinecraftDev](https://github.com/minecraft-dev/MinecraftDev)** - ⭐ 1,685
   Plugin for IntelliJ IDEA that gives special support for Minecraft modding projects.

33. **[generative-ai](https://github.com/genieincodebottle/generative-ai)** - ⭐ 1,651
   Comprehensive resources on Generative AI, including a detailed roadmap, projects, use cases, interview preparation, and coding preparation.

34. **[MultiAgentPPT](https://github.com/johnson7788/MultiAgentPPT)** - ⭐ 1,437
...
35. **[mcpelauncher-manifest](https://github.com/minecraft-linux/mcpelauncher-manifest)** - ⭐ 1,385
   The main repository for the Linux and Mac OS Bedrock edition Minecraft launcher.

36. **[mcpp-standard](https://github.com/Sunrisepeak/mcpp-standard)** - ⭐ 1,263
   D2X | Modern C++ Core Language Features - "A C++ tutorial project focused on practical"

37. **[awesome-hacking-lists](https://github.com/taielab/awesome-hacking-lists)** - ⭐ 1,250
   A curated collection of top-tier penetration testing tools and productivity utilities across multiple domains. Join us to explore, contribute, and enhance your hacking toolkit!

38. **[NagaAgent](https://github.com/Xxiii8322766509/NagaAgent)** - ⭐ 1,222
   A simple yet powerful agent framework for personal assistants, designed to enable intelligent interaction, multi-agent collaboration, and seamless tool integration.

39. **[langchain4j-aideepin](https://github.com/moyangzhan/langchain4j-aideepin)** - ⭐ 1,049
   基于AI的工作效率提升工具（聊天、绘画、知识库、工作流、 MCP服务市场、语音输入输出、长期记忆） | Ai-based productivity tools (Chat,Draw,RAG,Workflow,MCP marketplace, ASR,TTS, Long-term memory etc)

40. **[any-agent](https://github.com/mozilla-ai/any-agent)** - ⭐ 1,047
   A single interface to use and evaluate different agent frameworks 

41. **[zen](https://github.com/sheshbabu/zen)** - ⭐ 980
   Selfhosted notes app. Single golang binary, notes stored as markdown within SQLite, full-text search, very low resource usage

42. **[openops](https://github.com/openops-cloud/openops)** - ⭐ 965
   The batteries-included, No-Code FinOps automation platform, with the AI you trust.

43. **[arduino-mcp2515](https://github.com/autowp/arduino-mcp2515)** - ⭐ 948
   Arduino MCP2515 CAN interface library

44. **[open-trading-api](https://github.com/koreainvestment/open-trading-api)** - ⭐ 933
   Korea Investment & Securities Open API Github

45. **[BuildingAI](https://github.com/BidingCC/BuildingAI)** - ⭐ 916
...
46. **[AIPex](https://github.com/AIPexStudio/AIPex)** - ⭐ 893
...
47. **[claude-chatgpt-mcp](https://github.com/syedazharmbnr1/claude-chatgpt-mcp)** - ⭐ 759
   A Claude MCP tool to interact with the ChatGPT desktop app on macOS

48. **[MCPELauncher](https://github.com/zhuowei/MCPELauncher)** - ⭐ 718
   Source code for BlockLauncher, a launcher that patches Minecraft for Android

49. **[bytechef](https://github.com/bytechefhq/bytechef)** - ⭐ 682
...
50. **[JiwuChat](https://github.com/KiWi233333/JiwuChat)** - ⭐ 675
   JiwuChat 🍂 : 轻量级跨平台IM聊天应用，集成AI机器人( DeepSeek/Gemini/Kimi... )、音视频通话及AI购物。支持多端消息同步，自定义主题，高效便捷  🍒

51. **[aderyn](https://github.com/Cyfrin/aderyn)** - ⭐ 672
   Solidity Static Analyzer that easily integrates into your editor

52. **[infio-copilot](https://github.com/infiolab/infio-copilot)** - ⭐ 606
   A Cursor-inspired AI assistant for Obsidian that offers smart autocomplete and interactive chat with your selected notes

53. **[cloudsword](https://github.com/wgpsec/cloudsword)** - ⭐ 572
   一款帮助云租户发现和测试云上风险、增强云上防护能力的综合性开源工具

54. **[LightAgent](https://github.com/wanxingai/LightAgent)** - ⭐ 433
...
55. **[LightAgent](https://github.com/wxai-space/LightAgent)** - ⭐ 430
   LightAgent: Lightweight AI agent framework with memory, tools & tree-of-thought. Supports multi-agent collaboration, self-learning, and major LLMs (OpenAI/DeepSeek/Qwen). Open-source with MCP/SSE protocol integration.

56. **[mcpi](https://github.com/martinohanlon/mcpi)** - ⭐ 380
   Minecraft: Pi Edition API Python Library

57. **[volcano-sdk](https://github.com/Kong/volcano-sdk)** - ⭐ 379
   🌋 Build AI agents that seamlessly combine LLM reasoning with real-world actions via MCP tools — in just a few lines of TypeScript.

58. **[Adafruit-MCP23017-Arduino-Library](https://github.com/adafruit/Adafruit-MCP23017-Arduino-Library)** - ⭐ 374
   Arduino Library for Adafruit MCP23017

59. **[ai-code-helper](https://github.com/liyupi/ai-code-helper)** - ⭐ 369
...
63. **[browser-operator-core](https://github.com/BrowserOperator/browser-operator-core)** - ⭐ 344
   Browser Operator - The AI browser with built in Multi-Agent platform! Open source alternative to ChatGPT Atlas, Perplexity Comet, Dia and Microsoft CoPilot Edge Browser

64. **[exograph](https://github.com/exograph/exograph)** - ⭐ 337
   Build production-ready backends in minutes

65. **[graphrag-toolkit](https://github.com/awslabs/graphrag-toolkit)** - ⭐ 335
   Python toolkit for building graph-enhanced GenAI applications

66. **[MCprep](https://github.com/Moo-Ack-Productions/MCprep)** - ⭐ 330
   Blender python addon to increase workflow for creating minecraft renders and animations

67. **[UE5-MCP](https://github.com/VedantRGosavi/UE5-MCP)** - ⭐ 322
   MCP for Unreal Engine 5

68. **[Sentient](https://github.com/existence-master/Sentient)** - ⭐ 322
   A personal AI assistant for everyone

69. **[MCPanelViewController](https://github.com/matthewcheok/MCPanelViewController)** - ⭐ 319
   Drop-in panel control for iOS with blurring background and screen-edge activation gestures.

70. **[eechat](https://github.com/Lucassssss/eechat)** - ⭐ 313
   🚀 Powerful Local AI Chat Application - Mcp, Secure, Efficient, Personalized 本地化部署的大模型客户端

71. **[news-agents](https://github.com/eugeneyan/news-agents)** - ⭐ 307
   📰 Building News Agents to Summarize News with MCP, Q, and tmux

72. **[napi](https://github.com/nanoapi-io/napi)** - ⭐ 291
   Software architecture tooling for the AI age

73. **[depyler](https://github.com/paiml/depyler)** - ⭐ 287
   Compiles Python to Rust, helping transition off of Python to Energy Efficient and Safe Rust Code

74. **[edumcp](https://github.com/aieducations/edumcp)** - ⭐ 264
   EDUMCP is a protocol that integrates the Model Context Protocol (MCP) with applications in the education field, dedicated to achieving seamless interconnection and interoperability among different AI models, educational applications, smart hardware, and teaching AGENTs.

75. **[MCPDict](https://github.com/MaigoAkisame/MCPDict)** - ⭐ 259
   Android App: 漢字古今中外讀音查詢

76. **[building-an-agentic-system](https://github.com/gerred/building-an-agentic-system)** - ⭐ 249
   An in-depth book and reference on building agentic systems like Claude Code

77. **[MCPMappingViewer](https://github.com/bspkrs/MCPMappingViewer)** - ⭐ 242
   A small GUI for viewing the mappings from Minecraft obfuscated code names to MCP code names.

78. **[ai4eh](https://github.com/ethiack/ai4eh)** - ⭐ 238
   AI for Ethical Hacking - Workshop

79. **[MCPConfig](https://github.com/MinecraftForge/MCPConfig)** - ⭐ 237
   Public facing repo for MCP SRG mappings.

80. **[MCPU](https://github.com/cpldcpu/MCPU)** - ⭐ 230
   MCPU - A Minimal 8Bit CPU in a 32 Macrocell CPLD

81. **[Minecraft-Deobfuscator3000](https://github.com/SimplyProgrammer/Minecraft-Deobfuscator3000)** - ⭐ 230
   Powerful and universal deobfuscator for Minecraft mods and java decompiler!

82. **[IDA-NO-MCP](https://github.com/P4nda0s/IDA-NO-MCP)** - ⭐ 226
   Say goodbye to the complex, verbose, and laggy interaction mode of IDA Pro MCP

83. **[oreilly-ai-agents](https://github.com/sinanuozdemir/oreilly-ai-agents)** - ⭐ 221
   An introduction to the world of AI Agents

84. **[stock-scanner-mcp](https://github.com/wbsu2003/stock-scanner-mcp)** - ⭐ 219
   这是一个基于 FastAPI-MCP 的股票分析服务，旨在通过 MCP 工具函数接口提供股票相关的综合数据和分析能力，包括价格、评分、技术报告和 AI 分析。

85. **[mcpfp](https://github.com/MauritsWilke/mcpfp)** - ⭐ 218
...
88. **[amical](https://github.com/amicalhq/amical)** - ⭐ 204
...
89. **[BaseLayer](https://github.com/zwgnr/BaseLayer)** - ⭐ 199
   Re-usable multi part components built on React Aria and TailwindCSS. 

90. **[MCP-919](https://github.com/Marcelektro/MCP-919)** - ⭐ 190
   Fully working & decompiled MCP for Minecraft 1.8.9 

91. **[MCPScan](https://github.com/antgroup/MCPScan)** - ⭐ 188

92. **[AuditLuma](https://github.com/Vistaminc/AuditLuma)** - ⭐ 186
   AuditLuma是一个AI+智能体代码审计系统，它利用多个AI代理和先进的技术，包括多代理合作协议（MCP）和Self-RAG（检索增强生成），为代码库提供全面的安全分析，目前已经支持ollama部署的本地大模型

93. **[Toucan](https://github.com/TheAgentArk/Toucan)** - ⭐ 185
   Official repo of Toucan: Synthesizing 1.5M Tool-Agentic Data from Real-World MCP Environments

94. **[mangaba_ai](https://github.com/Mangaba-ai/mangaba_ai)** - ⭐ 181
...
95. **[MCP-Defender](https://github.com/MCP-Defender/MCP-Defender)** - ⭐ 164
...
1. **[modelcontextprotocol](https://github.com/modelcontextprotocol/modelcontextprotocol)** - ⭐ 6,582
   Specification and documentation for the Model Context Protocol

2. **[jar-analyzer](https://github.com/jar-analyzer/jar-analyzer)** - ⭐ 1,825
...
5. **[self-dify](https://github.com/datawhalechina/self-dify)** - ⭐ 204
