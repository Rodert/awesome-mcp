...
1. **[dify](https://github.com/langgenius/dify)** - ⭐ 125,327
   Production-ready platform for agentic workflow development.

2. **[open-webui](https://github.com/open-webui/open-webui)** - ⭐ 120,114
   User-friendly AI Interface (Supports Ollama, OpenAI API, ...)

3. **[gemini-cli](https://github.com/google-gemini/gemini-cli)** - ⭐ 90,300
   An open-source AI agent that brings the power of Gemini directly into your terminal.

4. **[awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)** - ⭐ 78,516
   A collection of MCP servers.

5. **[netdata](https://github.com/netdata/netdata)** - ⭐ 77,291
   The fastest path to AI-powered full stack observability, even for lean teams.

6. **[servers](https://github.com/modelcontextprotocol/servers)** - ⭐ 75,850
   Model Context Protocol Servers

7. **[ragflow](https://github.com/infiniflow/ragflow)** - ⭐ 71,183
   RAGFlow is a leading open-source Retrieval-Augmented Generation (RAG) engine that fuses cutting-edge RAG with Agent capabilities to create a superior context layer for LLMs

8. **[lobe-chat](https://github.com/lobehub/lobe-chat)** - ⭐ 69,957
...
9. **[anything-llm](https://github.com/Mintplex-Labs/anything-llm)** - ⭐ 53,077
   The all-in-one Desktop & Docker AI application with built-in RAG, AI agents, No-code agent builder, MCP compatibility,  and more.

10. **[JeecgBoot](https://github.com/jeecgboot/JeecgBoot)** - ⭐ 44,966
...
11. **[TrendRadar](https://github.com/sansan0/TrendRadar)** - ⭐ 42,656
...
12. **[context7](https://github.com/upstash/context7)** - ⭐ 41,400
...
15. **[LibreChat](https://github.com/danny-avila/LibreChat)** - ⭐ 32,946
   Enhanced ChatGPT Clone: Features Agents, MCP, DeepSeek, Anthropic, AWS, OpenAI, Responses API, Azure, Groq, o1, GPT-5, Mistral, OpenRouter, Vertex AI, Gemini, Artifacts, AI model switching, message search, Code Interpreter, langchain, DALL-E-3, OpenAPI Actions, Functions, Secure Multi-User Auth, Presets, open-source for self-hosting. Active.

16. **[1Panel](https://github.com/1Panel-dev/1Panel)** - ⭐ 32,790
   🔥 1Panel provides an intuitive web interface and MCP Server to manage websites, files, containers, databases, and LLMs on a Linux server.

17. **[nacos](https://github.com/alibaba/nacos)** - ⭐ 32,493
   an easy-to-use dynamic service discovery, configuration and service management platform for building AI cloud native applications.

18. **[PDFMathTranslate](https://github.com/PDFMathTranslate/PDFMathTranslate)** - ⭐ 31,142
   [EMNLP 2025 Demo] PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/MCP/Docker/Zotero

19. **[composio](https://github.com/ComposioHQ/composio)** - ⭐ 26,333
   Composio equips your AI agents & LLMs with 100+ high-quality integrations via function calling

20. **[github-mcp-server](https://github.com/github/github-mcp-server)** - ⭐ 25,757
   GitHub's official MCP Server

21. **[goose](https://github.com/block/goose)** - ⭐ 25,666
   an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM

22. **[ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub)** - ⭐ 25,601
   In-depth tutorials on LLMs, RAGs and real-world AI agent applications.

23. **[playwright-mcp](https://github.com/microsoft/playwright-mcp)** - ⭐ 25,304
   Playwright MCP server

24. **[gpt-researcher](https://github.com/assafelovic/gpt-researcher)** - ⭐ 24,777
   An LLM agent that conducts deep research (local and web) on any given topic and generates a long report with citations.

25. **[xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)** - ⭐ 23,036
   An MCP-based chatbot | 一个基于MCP的聊天机器人

26. **[UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)** - ⭐ 21,889
   The Open-Source Multimodal AI Agent Stack: Connecting Cutting-Edge AI Models and Agent Infra

27. **[fastmcp](https://github.com/jlowin/fastmcp)** - ⭐ 21,812
   🚀 The fast, Pythonic way to build MCP servers and clients

28. **[repomix](https://github.com/yamadashy/repomix)** - ⭐ 21,103
   📦 Repomix is a powerful tool that packs your entire repository into a single, AI-friendly file. Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools like Claude, ChatGPT, DeepSeek, Perplexity, Gemini, Gemma, Llama, Grok, and more.

29. **[python-sdk](https://github.com/modelcontextprotocol/python-sdk)** - ⭐ 21,033
   The official Python SDK for Model Context Protocol servers and clients

30. **[activepieces](https://github.com/activepieces/activepieces)** - ⭐ 20,269
   AI Agents & MCPs & AI Workflow Automation • (~400 MCP servers for AI agents) • AI Automation / AI Agent with MCPs • AI Workflows & AI Agents • MCPs for AI Agents

31. **[MaxKB](https://github.com/1Panel-dev/MaxKB)** - ⭐ 19,776
   🔥 MaxKB is an open-source platform for building enterprise-grade agents.  强大易用的开源企业级智能体平台。

32. **[chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp)** - ⭐ 19,769
   Chrome DevTools for coding agents

33. **[mastra](https://github.com/mastra-ai/mastra)** - ⭐ 19,218
   From the team behind Gatsby, Mastra is a framework for building AI-powered applications and agents with a modern TypeScript stack.

34. **[serena](https://github.com/oraios/serena)** - ⭐ 18,396
   A powerful coding agent toolkit providing semantic retrieval and editing capabilities (MCP server & other integrations)

35. **[agentic](https://github.com/transitive-bullshit/agentic)** - ⭐ 18,088
   Your API ⇒ Paid MCP. Instantly.

36. **[blender-mcp](https://github.com/ahujasid/blender-mcp)** - ⭐ 14,892

37. **[mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners)** - ⭐ 14,001
   This open-source curriculum introduces the fundamentals of Model Context Protocol (MCP) through real-world, cross-language examples in .NET, Java, TypeScript, JavaScript, Rust and Python. Designed for developers, it focuses on practical techniques for building modular, scalable, and secure AI workflows from session setup to service orchestration.

38. **[filestash](https://github.com/mickael-kerjean/filestash)** - ⭐ 13,374
   :file_folder: What Dropbox should have been if it was based on SFTP, S3, FTP, SMB, NFS, WebDAV, Git, and more

39. **[trigger.dev](https://github.com/triggerdotdev/trigger.dev)** - ⭐ 13,253
   Trigger.dev – build and deploy fully‑managed AI agents and workflows

40. **[Qwen-Agent](https://github.com/QwenLM/Qwen-Agent)** - ⭐ 12,890
   Agent framework and applications built upon Qwen>=3.0, featuring Function Calling, MCP, Code Interpreter, RAG, Chrome extension, etc.

41. **[Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP)** - ⭐ 12,461
   MCP server to provide Figma layout information to AI coding agents like Cursor

42. **[genai-toolbox](https://github.com/googleapis/genai-toolbox)** - ⭐ 12,347
   MCP Toolbox for Databases is an open source MCP server for databases.

43. **[n8n-mcp](https://github.com/czlonkowski/n8n-mcp)** - ⭐ 11,496
   A MCP for Claude Desktop / Claude Code / Windsurf / Cursor to build n8n workflows for you 

44. **[fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)** - ⭐ 11,352
   Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!

45. **[claude-flow](https://github.com/ruvnet/claude-flow)** - ⭐ 11,313
...
46. **[typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk)** - ⭐ 11,259
   The official TypeScript SDK for Model Context Protocol servers and clients

47. **[pal-mcp-server](https://github.com/BeehiveInnovations/pal-mcp-server)** - ⭐ 10,779
   The power of Claude Code / GeminiCLI / CodexCLI + [Gemini / OpenAI / OpenRouter / Azure / Grok / Ollama / Custom Model / All Of The Above] working as one.

48. **[nginx-ui](https://github.com/0xJacky/nginx-ui)** - ⭐ 10,371
   Yet another WebUI for Nginx

49. **[cc-switch](https://github.com/farion1231/cc-switch)** - ⭐ 10,277
   A cross-platform desktop All-in-One assistant tool for Claude Code, Codex & Gemini CLI.

50. **[gateway](https://github.com/Portkey-AI/gateway)** - ⭐ 10,237
   A blazing fast AI Gateway with integrated guardrails. Route to 200+ LLMs, 50+ AI Guardrails with 1 fast & friendly API.

51. **[zen-mcp-server](https://github.com/BeehiveInnovations/zen-mcp-server)** - ⭐ 9,890
   The power of Claude Code / GeminiCLI / CodexCLI + [Gemini / OpenAI / OpenRouter / Azure / Grok / Ollama / Custom Model / All Of The Above] working as one.

52. **[mcp-chrome](https://github.com/hangwin/mcp-chrome)** - ⭐ 9,859
   Chrome MCP Server is a Chrome extension-based Model Context Protocol (MCP) server that exposes your Chrome browser functionality to AI assistants like Claude, enabling complex browser automation, content analysis, and semantic search.

53. **[XHS-Downloader](https://github.com/JoeanAmier/XHS-Downloader)** - ⭐ 9,700
   小红书（XiaoHongShu、RedNote）链接提取/作品采集工具：提取账号发布、收藏、点赞、专辑作品链接；提取搜索结果作品、用户链接；采集小红书作品信息；提取小红书作品下载地址；下载小红书无水印作品文件

54. **[mcp-use](https://github.com/mcp-use/mcp-use)** - ⭐ 8,874
   mcp-use is the easiest way to interact with mcp servers with custom agents

55. **[Scrapling](https://github.com/D4Vinci/Scrapling)** - ⭐ 8,569
   🕷️ An undetectable, powerful, flexible, high-performance Python library to make Web Scraping Easy and Effortless as it should be!

56. **[awesome-ai-apps](https://github.com/Arindam200/awesome-ai-apps)** - ⭐ 8,393
   A collection of projects showcasing RAG, agents, workflows, and other AI use cases

57. **[inspector](https://github.com/modelcontextprotocol/inspector)** - ⭐ 8,226
   Visual testing tool for MCP servers

58. **[xiaozhi-esp32-server](https://github.com/xinnan-tech/xiaozhi-esp32-server)** - ⭐ 8,207
   本项目为xiaozhi-esp32提供后端服务，帮助您快速搭建ESP32设备控制服务器。Backend service for xiaozhi-esp32, helps you quickly build an ESP32 device control server.

59. **[mcp-go](https://github.com/mark3labs/mcp-go)** - ⭐ 7,952
   A Go implementation of the Model Context Protocol (MCP), enabling seamless integration between LLM applications and external data sources and tools.

60. **[xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp)** - ⭐ 7,945
   MCP for xiaohongshu.com

61. **[mcp-agent](https://github.com/lastmile-ai/mcp-agent)** - ⭐ 7,924
   Build effective agents using Model Context Protocol and simple workflow patterns

62. **[mcp](https://github.com/awslabs/mcp)** - ⭐ 7,829
   AWS MCP Servers — helping you get the most out of AWS, wherever you use MCP.

63. **[git-mcp](https://github.com/idosal/git-mcp)** - ⭐ 7,346
...
65. **[awesome-LLM-resources](https://github.com/WangRongsheng/awesome-LLM-resources)** - ⭐ 7,243
   🧑‍🚀 全世界最好的LLM资料总结（多模态生成、Agent、辅助编程、AI审稿、数据处理、模型训练、模型推理、o1 模型、MCP、小语言模型、视觉语言模型） | Summary of the world's best LLM resources. 

66. **[GhidraMCP](https://github.com/LaurieWired/GhidraMCP)** - ⭐ 7,024
   MCP Server for Ghidra

67. **[browser-tools-mcp](https://github.com/AgentDeskAI/browser-tools-mcp)** - ⭐ 6,969
   Monitor browser logs directly from Cursor and other MCP compatible IDEs.

68. **[Skill_Seekers](https://github.com/yusufkaraaslan/Skill_Seekers)** - ⭐ 6,366
   Convert documentation websites, GitHub repositories, and PDFs into Claude AI skills with automatic conflict detection

69. **[registry](https://github.com/modelcontextprotocol/registry)** - ⭐ 6,233
   A community driven registry service for Model Context Protocol (MCP) servers.

70. **[awesome-mcp-clients](https://github.com/punkpeye/awesome-mcp-clients)** - ⭐ 6,162
   A collection of MCP clients.

71. **[cursor-talk-to-figma-mcp](https://github.com/grab/cursor-talk-to-figma-mcp)** - ⭐ 5,872
...
72. **[hexstrike-ai](https://github.com/0x4m4/hexstrike-ai)** - ⭐ 5,792
   HexStrike AI MCP Agents is an advanced MCP server that lets AI agents (Claude, GPT, Copilot, etc.) autonomously run 150+ cybersecurity tools for automated pentesting, vulnerability discovery, bug bounty automation, and security research. Seamlessly bridge LLMs with real-world offensive security capabilities.

73. **[klavis](https://github.com/Klavis-AI/klavis)** - ⭐ 5,581
   Klavis AI (YC X25):  MCP integration platforms that let AI agents use tools reliably at any scale

74. **[Awesome-MCP-ZH](https://github.com/yzfly/Awesome-MCP-ZH)** - ⭐ 5,552
   MCP 资源精选， MCP指南，Claude MCP，MCP Servers, MCP Clients

75. **[astron-rpa](https://github.com/iflytek/astron-rpa)** - ⭐ 5,499
   Agent-ready RPA suite with out-of-the-box automation tools. Built for individuals and enterprises.

76. **[mcp](https://github.com/BrowserMCP/mcp)** - ⭐ 5,395
   Browser MCP is a Model Context Provider (MCP) server that allows AI applications to control your browser

77. **[firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server)** - ⭐ 5,233
   🔥 Official Firecrawl MCP Server - Adds powerful web scraping and search to Cursor, Claude and any other LLM clients.

78. **[DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP)** - ⭐ 5,209
   This is MCP server for Claude that gives it terminal control, file system search and diff file editing capabilities

79. **[whatsapp-mcp](https://github.com/lharries/whatsapp-mcp)** - ⭐ 5,188
   WhatsApp MCP server

80. **[mcp-playwright](https://github.com/executeautomation/mcp-playwright)** - ⭐ 5,129
   Playwright Model Context Protocol Server - Tool to automate Browsers and APIs in Claude Desktop, Cline, Cursor IDE and More 🔌

81. **[awesome-mcp-servers](https://github.com/appcypher/awesome-mcp-servers)** - ⭐ 5,051
   Awesome MCP Servers - A curated list of Model Context Protocol servers

82. **[gaianet-node](https://github.com/GaiaNet-AI/gaianet-node)** - ⭐ 5,006
   Install, run and deploy your own decentralized AI agent service

83. **[claude-context](https://github.com/zilliztech/claude-context)** - ⭐ 4,990
   Code search MCP for Claude Code. Make entire codebase the context for any coding agent.

84. **[ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp)** - ⭐ 4,947
   AI-powered reverse engineering assistant that bridges IDA Pro with language models through MCP.

85. **[5ire](https://github.com/nanbingxyz/5ire)** - ⭐ 4,929
   5ire is a cross-platform desktop AI assistant, MCP client. It compatible with major service providers,  supports local knowledge base and  tools via model context protocol servers .

86. **[Everywhere](https://github.com/DearVa/Everywhere)** - ⭐ 4,915
...
87. **[sdk-python](https://github.com/strands-agents/sdk-python)** - ⭐ 4,842
   A model-driven approach to building AI agents in just a few lines of code.

88. **[voltagent](https://github.com/VoltAgent/voltagent)** - ⭐ 4,770
   AI Agent Engineering Platform built on an Open Source TypeScript AI Agent Framework

89. **[unity-mcp](https://github.com/CoplayDev/unity-mcp)** - ⭐ 4,713
   Unity MCP acts as a bridge, allowing AI assistants (like Claude, Cursor) to interact directly with your Unity Editor via a local MCP (Model Context Protocol) Client. Give your LLM tools to manage assets, control scenes, edit scripts, and automate tasks within Unity.

90. **[aci](https://github.com/aipotheosis-labs/aci)** - ⭐ 4,695
   ACI.dev is the open source tool-calling platform that hooks up 600+ tools into any agentic IDE or custom AI agent through direct function calling or a unified MCP server. The birthplace of VibeOps.

91. **[Kiln](https://github.com/Kiln-AI/Kiln)** - ⭐ 4,529
   Build, Evaluate, and Optimize AI Systems. Includes evals, RAG, agents, fine-tuning, synthetic data generation, dataset management, MCP, and more.

92. **[casibase](https://github.com/casibase/casibase)** - ⭐ 4,380
   ⚡️AI Cloud OS: Open-source enterprise-level AI knowledge base and MCP (model-context-protocol)/A2A (agent-to-agent) management platform with admin UI, user management and Single-Sign-On⚡️, supports ChatGPT, Claude, Llama, Ollama, HuggingFace, etc., chat bot demo: https://ai.casibase.com, admin UI demo: https://ai-admin.casibase.com

93. **[microsandbox](https://github.com/zerocore-ai/microsandbox)** - ⭐ 4,334
...
96. **[memU](https://github.com/NevaMind-AI/memU)** - ⭐ 4,106
   Memory infrastructure for LLMs and AI agents

97. **[magic-mcp](https://github.com/21st-dev/magic-mcp)** - ⭐ 4,096
   It's like v0 but in your Cursor/WindSurf/Cline. 21st dev Magic MCP server for working with your frontend like Magic

98. **[mcp-ui](https://github.com/MCP-UI-Org/mcp-ui)** - ⭐ 3,991
   UI over MCP. Create next-gen UI experiences with the protocol and SDK!

99. **[mcp-atlassian](https://github.com/sooperset/mcp-atlassian)** - ⭐ 3,934
   MCP server for Atlassian tools (Confluence, Jira)

100. **[Olares](https://github.com/beclab/Olares)** - ⭐ 3,888
   Olares: An Open-Source Personal Cloud to Reclaim Your Data

101. **[Windows-MCP](https://github.com/CursorTouch/Windows-MCP)** - ⭐ 3,875
   MCP Server for Computer Use in Windows

102. **[directories](https://github.com/pontusab/directories)** - ⭐ 3,868
   The Cursor & Windsurf community, find rules and MCPs

103. **[mcpo](https://github.com/open-webui/mcpo)** - ⭐ 3,855
   A simple, secure MCP-to-OpenAPI proxy server

104. **[learn-agentic-ai](https://github.com/panaversity/learn-agentic-ai)** - ⭐ 3,810
...
106. **[wanwu](https://github.com/UnicomAI/wanwu)** - ⭐ 3,724
   China Unicom's Yuanjing Wanwu Agent Platform is an enterprise-grade, multi-tenant AI agent development platform. It helps users build applications such as intelligent agents, workflows, and rag, and also supports model management. The platform features a developer-friendly license, and we welcome all developers to build upon the platform.

107. **[notion-mcp-server](https://github.com/makenotion/notion-mcp-server)** - ⭐ 3,681
   Official Notion MCP Server

108. **[MemOS](https://github.com/MemTensor/MemOS)** - ⭐ 3,671
...
109. **[telegram-search](https://github.com/groupultra/telegram-search)** - ⭐ 3,666
   🔍 导出并模糊搜索 Telegram 聊天记录 | Export and fuzzy search your Telegram chat history

110. **[spec-workflow-mcp](https://github.com/Pimzino/spec-workflow-mcp)** - ⭐ 3,601
...
112. **[go-sdk](https://github.com/modelcontextprotocol/go-sdk)** - ⭐ 3,584
   The official Go SDK for Model Context Protocol servers and clients. Maintained in collaboration with Google.

113. **[fast-agent](https://github.com/evalstate/fast-agent)** - ⭐ 3,581
   Define, Prompt and Test MCP enabled Agents and Workflows

114. **[XcodeBuildMCP](https://github.com/cameroncooke/XcodeBuildMCP)** - ⭐ 3,567
   A Model Context Protocol (MCP) server that provides Xcode-related tools for integration with AI assistants and other MCP clients.

115. **[exa-mcp-server](https://github.com/exa-labs/exa-mcp-server)** - ⭐ 3,519
   Exa MCP for web search and web crawling!

116. **[mcp-feedback-enhanced](https://github.com/Minidoracat/mcp-feedback-enhanced)** - ⭐ 3,506
   Enhanced MCP server for interactive user feedback and command execution in AI-assisted development, featuring dual interface support (Web UI and Desktop Application) with intelligent environment detection and cross-platform compatibility.

117. **[mcp-server-chart](https://github.com/antvis/mcp-server-chart)** - ⭐ 3,482
   🤖 A visualization mcp contains 25+ visual charts using @antvis. Using for chart generation and data analysis.

118. **[ciso-assistant-community](https://github.com/intuitem/ciso-assistant-community)** - ⭐ 3,463
...
119. **[AionUi](https://github.com/iOfficeAI/AionUi)** - ⭐ 3,418
...
120. **[cipher](https://github.com/campfirein/cipher)** - ⭐ 3,413
...
121. **[kreuzberg](https://github.com/kreuzberg-dev/kreuzberg)** - ⭐ 3,341
...
122. **[go-whatsapp-web-multidevice](https://github.com/aldinokemal/go-whatsapp-web-multidevice)** - ⭐ 3,340
   GOWA - WhatsApp REST API with support for UI, Multi Account, Webhooks, and MCP. Built with Golang for efficient memory use. 

123. **[awesome-mcp-servers](https://github.com/wong2/awesome-mcp-servers)** - ⭐ 3,301
   A curated list of Model Context Protocol (MCP) servers

124. **[PeopleInSpace](https://github.com/joreilly/PeopleInSpace)** - ⭐ 3,292
   Kotlin Multiplatform sample with SwiftUI, Jetpack Compose, Compose for Wear, Compose for Desktop, and Compose for Web clients along with Ktor backend.

125. **[mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare)** - ⭐ 3,267

126. **[langchain-mcp-adapters](https://github.com/langchain-ai/langchain-mcp-adapters)** - ⭐ 3,255
   LangChain 🔌 MCP

127. **[MCP-Chinese-Getting-Started-Guide](https://github.com/liaokongVFX/MCP-Chinese-Getting-Started-Guide)** - ⭐ 3,251
   Model Context Protocol(MCP) 编程极速入门

128. **[metorial](https://github.com/metorial/metorial)** - ⭐ 3,199
   Connect any AI model to 600+ integrations; powered by MCP 📡 🚀

129. **[PPTAgent](https://github.com/icip-cas/PPTAgent)** - ⭐ 3,111
   An Autonomous Agentic Framework for Reflective PowerPoint Generation

130. **[excel-mcp-server](https://github.com/haris-musa/excel-mcp-server)** - ⭐ 3,106
   A Model Context Protocol server for Excel file manipulation

131. **[py-xiaozhi](https://github.com/huangjunsen0406/py-xiaozhi)** - ⭐ 3,084
   A Python-based Xiaozhi AI for users who want the full Xiaozhi experience without owning specialized hardware.

132. **[mcp-context-forge](https://github.com/IBM/mcp-context-forge)** - ⭐ 3,075
   A Model Context Protocol (MCP) Gateway & Registry. Serves as a central management point for tools, resources, and prompts that can be accessed by MCP-compatible LLM applications. Converts REST API endpoints to MCP, composes virtual MCP servers with added security and observability, and converts between protocols (stdio, SSE, Streamable HTTP).

133. **[learn-ai-engineering](https://github.com/ashishps1/learn-ai-engineering)** - ⭐ 3,069
   Learn AI and LLMs from scratch using free resources

134. **[java-sdk](https://github.com/modelcontextprotocol/java-sdk)** - ⭐ 3,053
   The official Java SDK for Model Context Protocol servers and clients. Maintained in collaboration with Spring AI

135. **[octelium](https://github.com/octelium/octelium)** - ⭐ 3,043
   A next-gen FOSS self-hosted unified zero trust secure access platform that can operate as a remote access VPN, a ZTNA platform, API/AI/MCP gateway, a PaaS, an ngrok-alternative and a homelab infrastructure.

136. **[boost](https://github.com/laravel/boost)** - ⭐ 3,027
   Laravel-focused MCP server for augmenting your AI powered local development experience.

137. **[mobile-mcp](https://github.com/mobile-next/mobile-mcp)** - ⭐ 3,025
   Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators, Simulators and Real Devices)

138. **[mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase)** - ⭐ 3,021
   Allow LLMs to control a browser with Browserbase and Stagehand

139. **[osaurus](https://github.com/dinoki-ai/osaurus)** - ⭐ 2,998
...
140. **[claude-code-guide](https://github.com/zebbern/claude-code-guide)** - ⭐ 2,957
...
141. **[n8n-nodes-mcp](https://github.com/nerding-io/n8n-nodes-mcp)** - ⭐ 2,950
   n8n custom node for MCP

142. **[core](https://github.com/cheshire-cat-ai/core)** - ⭐ 2,945
   AI agent microservice

143. **[mcp](https://github.com/google/mcp)** - ⭐ 2,893
   Google 💚 MCP

144. **[fastmcp](https://github.com/punkpeye/fastmcp)** - ⭐ 2,866
   A TypeScript framework for building MCP servers.

145. **[rikkahub](https://github.com/rikkahub/rikkahub)** - ⭐ 2,855
   RikkaHub is an Android APP that supports for multiple LLM providers.

146. **[rust-sdk](https://github.com/modelcontextprotocol/rust-sdk)** - ⭐ 2,807
   The official Rust SDK for the Model Context Protocol

147. **[AI-Infra-Guard](https://github.com/Tencent/AI-Infra-Guard)** - ⭐ 2,754
...
148. **[mcp-obsidian](https://github.com/MarkusPfundstein/mcp-obsidian)** - ⭐ 2,667
   MCP server that interacts with Obsidian via the Obsidian rest API community plugin

149. **[shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server)** - ⭐ 2,585
...
152. **[claude-plugins-official](https://github.com/anthropics/claude-plugins-official)** - ⭐ 2,416
...
154. **[mcp](https://github.com/microsoft/mcp)** - ⭐ 2,405
   Catalog of official Microsoft MCP (Model Context Protocol) server implementations for AI-powered data access and tool integration

155. **[supabase-mcp](https://github.com/supabase-community/supabase-mcp)** - ⭐ 2,375
   Connect Supabase to your AI assistants

156. **[supergateway](https://github.com/supercorp-ai/supergateway)** - ⭐ 2,357
   Run MCP stdio servers over SSE and SSE over stdio. AI gateway.

157. **[markdownify-mcp](https://github.com/zcaceres/markdownify-mcp)** - ⭐ 2,342
   A Model Context Protocol server for converting almost anything to Markdown

158. **[basic-memory](https://github.com/basicmachines-co/basic-memory)** - ⭐ 2,326
   AI conversations that actually remember. Never re-explain your project to your AI again. Join our Discord: https://discord.gg/tyvKNccgqN

159. **[MCP-SuperAssistant](https://github.com/srbhptl39/MCP-SuperAssistant)** - ⭐ 2,197
   Brings MCP to ChatGPT, DeepSeek, Perplexity, Grok, Gemini, Google AI Studio, OpenRouter, DeepSeek, T3 Chat and more...

160. **[buildwithclaude](https://github.com/davepoon/buildwithclaude)** - ⭐ 2,185
...
162. **[mcp-proxy](https://github.com/sparfenyuk/mcp-proxy)** - ⭐ 2,144
   A bridge between Streamable HTTP and stdio MCP transports

163. **[ableton-mcp](https://github.com/ahujasid/ableton-mcp)** - ⭐ 2,120

164. **[mcp-grafana](https://github.com/grafana/mcp-grafana)** - ⭐ 2,099
   MCP server for Grafana

165. **[claude-code-subagents-collection](https://github.com/davepoon/claude-code-subagents-collection)** - ⭐ 2,098
   Claude Code Subagents & Commands Collection + CLI Tool

166. **[ddgs](https://github.com/deedy5/ddgs)** - ⭐ 2,069
...
168. **[papersgpt-for-zotero](https://github.com/papersgpt/papersgpt-for-zotero)** - ⭐ 2,034
...
169. **[kagent](https://github.com/kagent-dev/kagent)** - ⭐ 2,022
   Cloud Native Agentic AI | Discord: https://bit.ly/kagentdiscord

170. **[arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server)** - ⭐ 2,022
   A Model Context Protocol server for searching and analyzing arXiv papers

171. **[DevDocs](https://github.com/cyberagiinc/DevDocs)** - ⭐ 2,003
   Completely free, private, UI based Tech Documentation MCP server. Designed for coders and software developers in mind. Easily integrate into Cursor, Windsurf, Cline, Roo Code, Claude Desktop App 

172. **[Unla](https://github.com/AmoyLab/Unla)** - ⭐ 1,991
   🧩 MCP Gateway - A lightweight gateway service that instantly transforms existing MCP Servers and APIs into MCP servers with zero code changes. Features Docker deployment and management UI, requiring no infrastructure modifications.

173. **[lemonade](https://github.com/lemonade-sdk/lemonade)** - ⭐ 1,984
   Lemonade helps users discover and run local AI apps by serving optimized LLMs right from their own GPUs and NPUs. Join our discord: https://discord.gg/5xXzkMu8Zk

174. **[superglue](https://github.com/superglue-ai/superglue)** - ⭐ 1,970
   superglue (YC W25) builds integrations and tools from natural language. Get production-grade tools for long tail and enterprise systems.

175. **[mcp-shrimp-task-manager](https://github.com/cjo4m06/mcp-shrimp-task-manager)** - ⭐ 1,963
   Shrimp Task Manager is a task tool built for AI Agents, emphasizing chain-of-thought, reflection, and style consistency. It converts natural language into structured dev tasks with dependency tracking and iterative refinement, enabling agent-like developer behavior in reasoning AI systems.

176. **[sandbox](https://github.com/agent-infra/sandbox)** - ⭐ 1,963
   All-in-One Sandbox for AI Agents that combines Browser, Shell, File, MCP and VSCode Server in a single Docker container.

177. **[mcpso](https://github.com/chatmcp/mcpso)** - ⭐ 1,955
   directory for Awesome MCP Servers

178. **[mcp-crawl4ai-rag](https://github.com/coleam00/mcp-crawl4ai-rag)** - ⭐ 1,953
...
181. **[brightdata-mcp](https://github.com/brightdata/brightdata-mcp)** - ⭐ 1,873
   A powerful Model Context Protocol (MCP) server that provides an all-in-one solution for public web access.

182. **[modelcontextprotocol](https://github.com/perplexityai/modelcontextprotocol)** - ⭐ 1,872
   The official MCP server implementation for the Perplexity API Platform

183. **[dbhub](https://github.com/bytebase/dbhub)** - ⭐ 1,872
   Zero-dependency, token-efficient database MCP server for Postgres, MySQL, SQL Server, MariaDB, SQLite.

184. **[gemini-mcp-tool](https://github.com/jamubc/gemini-mcp-tool)** - ⭐ 1,824
...
187. **[sanic-web](https://github.com/apconw/sanic-web)** - ⭐ 1,799
...
188. **[mcp-cli](https://github.com/chrishayuk/mcp-cli)** - ⭐ 1,798

189. **[postgres-mcp](https://github.com/crystaldba/postgres-mcp)** - ⭐ 1,795
   Postgres MCP Pro provides configurable read/write access and performance analysis for you and your AI agents.

190. **[agentset](https://github.com/agentset-ai/agentset)** - ⭐ 1,779
   The open-source RAG platform: built-in citations, deep research, 22+ file formats, partitions, MCP server, and more.

191. **[opendia](https://github.com/aaronjmars/opendia)** - ⭐ 1,749
   Connect your browser to AI models. Just use Dia on Chrome, Arc or Firefox.

192. **[mcphub](https://github.com/samanhappy/mcphub)** - ⭐ 1,701
   A unified hub for centrally managing and dynamically orchestrating multiple MCP servers/APIs into separate endpoints with flexible routing strategies

193. **[Dive](https://github.com/OpenAgentPlatform/Dive)** - ⭐ 1,689
   Dive is an open-source MCP Host Desktop Application that seamlessly integrates with any LLMs supporting function calling capabilities. ✨

194. **[mcphub.nvim](https://github.com/ravitemer/mcphub.nvim)** - ⭐ 1,686
   An MCP client for Neovim that seamlessly integrates MCP servers into your editing workflow with an intuitive interface for managing, testing, and using MCP servers with your favorite chat plugins.

195. **[AIaW](https://github.com/NitroRCr/AIaW)** - ⭐ 1,672
...
197. **[mcpb](https://github.com/modelcontextprotocol/mcpb)** - ⭐ 1,632
   Desktop Extensions: One-click local MCP server installation in desktop apps

198. **[bifrost](https://github.com/maximhq/bifrost)** - ⭐ 1,629
...
201. **[anyquery](https://github.com/julien040/anyquery)** - ⭐ 1,580
...
203. **[inspector](https://github.com/MCPJam/inspector)** - ⭐ 1,557
   Local inspector for ChatGPT apps & MCP servers

204. **[agentgateway](https://github.com/agentgateway/agentgateway)** - ⭐ 1,549
   Next Generation Agentic Proxy for AI Agents and MCP servers

205. **[super-agent-party](https://github.com/heshengtao/super-agent-party)** - ⭐ 1,546
...
208. **[mcp-router](https://github.com/mcp-router/mcp-router)** - ⭐ 1,529
...
212. **[mcp-installer](https://github.com/anaisbetts/mcp-installer)** - ⭐ 1,491
   An MCP server that installs other MCP servers for you

213. **[playwriter](https://github.com/remorses/playwriter)** - ⭐ 1,477
...
216. **[mcptools](https://github.com/f/mcptools)** - ⭐ 1,432
   A command-line interface for interacting with MCP (Model Context Protocol) servers using both stdio and HTTP transport.

217. **[ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp)** - ⭐ 1,422
   MCP server for interacting with the iOS simulator

218. **[rulego](https://github.com/rulego/rulego)** - ⭐ 1,399
   ⛓️RuleGo is a lightweight, high-performance, embedded, next-generation component orchestration rule engine framework for Go.

219. **[Office-PowerPoint-MCP-Server](https://github.com/GongRzhe/Office-PowerPoint-MCP-Server)** - ⭐ 1,392
   A MCP (Model Context Protocol) server for PowerPoint manipulation using python-pptx. This server provides tools for creating, editing, and manipulating PowerPoint presentations through the MCP protocol.

220. **[MAI-UI](https://github.com/Tongyi-MAI/MAI-UI)** - ⭐ 1,385
   MAI-UI: Real-World Centric Foundation GUI Agents ranging from 2B to 235B

221. **[mcp-scan](https://github.com/invariantlabs-ai/mcp-scan)** - ⭐ 1,383
   Constrain, log and scan your MCP connections for security vulnerabilities.

222. **[Office-Word-MCP-Server](https://github.com/GongRzhe/Office-Word-MCP-Server)** - ⭐ 1,380
   A Model Context Protocol (MCP) server for creating, reading, and manipulating Microsoft Word documents. This server enables AI assistants to work with Word documents through a standardized interface, providing rich document editing capabilities.

223. **[mcp-language-server](https://github.com/isaacphi/mcp-language-server)** - ⭐ 1,376
   mcp-language-server gives MCP enabled clients access semantic tools like get definition, references, rename, and diagnostics.

224. **[mcp_agent_mail](https://github.com/Dicklesworthstone/mcp_agent_mail)** - ⭐ 1,375
   Like gmail for your coding agents. Lets various different agents communicate and coordinate with each other.

225. **[yu-ai-agent](https://github.com/liyupi/yu-ai-agent)** - ⭐ 1,369
...
226. **[godot-mcp](https://github.com/Coding-Solo/godot-mcp)** - ⭐ 1,351
   MCP server for interfacing with Godot game engine. Provides tools for launching the editor, running projects, and capturing debug output.

227. **[pg-aiguide](https://github.com/timescale/pg-aiguide)** - ⭐ 1,339
   MCP server and Claude plugin for Postgres skills and documentation. Helps AI coding tools generate better PostgreSQL code.

228. **[nerve](https://github.com/evilsocket/nerve)** - ⭐ 1,314
   The Simple Agent Development Kit.

229. **[php-sdk](https://github.com/modelcontextprotocol/php-sdk)** - ⭐ 1,295
...
231. **[LitterBox](https://github.com/BlackSnufkin/LitterBox)** - ⭐ 1,269
   A secure sandbox environment for malware developers and red teamers to test payloads against detection mechanisms before deployment. Integrates with LLM agents via MCP for enhanced analysis capabilities.

232. **[Risuai](https://github.com/kwaroran/Risuai)** - ⭐ 1,268
   Make your own story. User-friendly software for LLM roleplaying

233. **[mcp](https://github.com/MicrosoftDocs/mcp)** - ⭐ 1,267
   Official Microsoft Learn MCP Server – powering LLMs and AI agents with real-time, trusted Microsoft docs & code samples.

234. **[mcp-obsidian](https://github.com/smithery-ai/mcp-obsidian)** - ⭐ 1,266
   A connector for Claude Desktop to read and search an Obsidian vault.

235. **[docker-mcp-tutorial](https://github.com/theNetworkChuck/docker-mcp-tutorial)** - ⭐ 1,261
   Complete tutorial materials for building MCP servers with Docker - from NetworkChuck's video

236. **[code-mode](https://github.com/universal-tool-calling-protocol/code-mode)** - ⭐ 1,253
...
244. **[kotlin-sdk](https://github.com/modelcontextprotocol/kotlin-sdk)** - ⭐ 1,210
   The official Kotlin SDK for Model Context Protocol servers and clients. Maintained in collaboration with JetBrains

245. **[deepwiki-mcp](https://github.com/regenrek/deepwiki-mcp)** - ⭐ 1,210
   📖 MCP server for fetch deepwiki.com and get latest knowledge in Cursor and other Code Editors

246. **[mcp-unity](https://github.com/CoderGamester/mcp-unity)** - ⭐ 1,207
...
247. **[mcp-remote](https://github.com/geelen/mcp-remote)** - ⭐ 1,201

248. **[A2V](https://github.com/Devin-AXIS/A2V)** - ⭐ 1,200
   A2V: Next-Gen AI Value Compute Protocol.                                                                                 

249. **[grafbase](https://github.com/grafbase/grafbase)** - ⭐ 1,199
   The Grafbase GraphQL Federation Gateway

250. **[ai](https://github.com/stripe/ai)** - ⭐ 1,191
...
253. **[swift-sdk](https://github.com/modelcontextprotocol/swift-sdk)** - ⭐ 1,171
...
256. **[MiniMax-MCP](https://github.com/MiniMax-AI/MiniMax-MCP)** - ⭐ 1,155
   Official MiniMax Model Context Protocol (MCP) server that enables interaction with powerful Text to Speech, image generation and video generation APIs.

257. **[elevenlabs-mcp](https://github.com/elevenlabs/elevenlabs-mcp)** - ⭐ 1,142
   The official ElevenLabs MCP server

258. **[azure-devops-mcp](https://github.com/microsoft/azure-devops-mcp)** - ⭐ 1,140
   The MCP server for Azure DevOps, bringing the power of Azure DevOps directly to your agents.

259. **[mcp-gateway](https://github.com/docker/mcp-gateway)** - ⭐ 1,139
   docker mcp CLI plugin / MCP Gateway

260. **[cunzhi](https://github.com/imhuso/cunzhi)** - ⭐ 1,137
   告别AI提前终止烦恼，助力AI更加持久

261. **[terraform-mcp-server](https://github.com/hashicorp/terraform-mcp-server)** - ⭐ 1,129
   The Terraform MCP Server provides seamless integration with Terraform ecosystem, enabling advanced automation and interaction capabilities for Infrastructure as Code (IaC) development.

262. **[mcp-memory-service](https://github.com/doobidoo/mcp-memory-service)** - ⭐ 1,125
   Stop re-explaining your project to AI every session. Automatic context memory for Claude, VS Code, Cursor, and 13+ AI tools.

263. **[awesome-agent-skills](https://github.com/heilcheng/awesome-agent-skills)** - ⭐ 1,120
...
266. **[Agent-MCP](https://github.com/rinadelph/Agent-MCP)** - ⭐ 1,114
   Agent-MCP is a framework for creating multi-agent systems that enables coordinated, efficient AI collaboration through the Model Context Protocol (MCP). The system is designed for developers building AI applications that benefit from multiple specialized agents working in parallel on different aspects of a project.

267. **[solace-agent-mesh](https://github.com/SolaceLabs/solace-agent-mesh)** - ⭐ 1,095
   An event-driven framework designed to build and orchestrate multi-agent AI systems. It enables seamless integration of AI agents with real-world data sources and systems, facilitating complex, multi-step workflows.

268. **[AWorld](https://github.com/inclusionAI/AWorld)** - ⭐ 1,091
   Build, evaluate and train General Multi-Agent Assistance with ease

269. **[google_workspace_mcp](https://github.com/taylorwilsdon/google_workspace_mcp)** - ⭐ 1,089
...
270. **[slack-mcp-server](https://github.com/korotovsky/slack-mcp-server)** - ⭐ 1,084
...
271. **[Peekaboo](https://github.com/steipete/Peekaboo)** - ⭐ 1,077
   Peekaboo is a macOS CLI & optional MCP server that enables AI agents to capture screenshots of applications, or the entire system, with optional visual question answering through local or remote AI models.

272. **[xiaozhi-esp32-server-java](https://github.com/joey-zhou/xiaozhi-esp32-server-java)** - ⭐ 1,076
   小智ESP32的Java企业级管理平台，提供设备监控、音色定制、角色切换和对话记录管理的前后端及服务端一体化解决方案

273. **[google-analytics-mcp](https://github.com/googleanalytics/google-analytics-mcp)** - ⭐ 1,066

274. **[cui](https://github.com/wbopan/cui)** - ⭐ 1,064
   A web UI for Claude Code agents

275. **[tavily-mcp](https://github.com/tavily-ai/tavily-mcp)** - ⭐ 1,063
   Production ready MCP server with real-time search, extract, map & crawl.

276. **[flock](https://github.com/Onelevenvy/flock)** - ⭐ 1,060
   Flock is a workflow-based low-code platform for rapidly building chatbots, RAG, and coordinating multi-agent teams, powered by LangGraph, Langchain, FastAPI, and NextJS.（Flock 是一个基于workflow工作流的低代码平台，用于快速构建聊天机器人、RAG、Agent和Muti-Agent应用，采用 LangGraph、Langchain、FastAPI 和 NextJS 构建。）

277. **[mysql_mcp_server](https://github.com/designcomputer/mysql_mcp_server)** - ⭐ 1,059
   A Model Context Protocol (MCP) server that enables secure interaction with MySQL databases

278. **[xhs-toolkit](https://github.com/aki66938/xhs-toolkit)** - ⭐ 1,054
   📕 小红书创作者MCP工具包 - 支持与AI客户端集成的内容创作和发布工具

279. **[jadx-ai-mcp](https://github.com/zinja-coder/jadx-ai-mcp)** - ⭐ 1,045
   Plugin for JADX to integrate MCP server

280. **[mcp-server-mysql](https://github.com/benborla/mcp-server-mysql)** - ⭐ 1,045
...
287. **[ApeRAG](https://github.com/apecloud/ApeRAG)** - ⭐ 1,007
   ApeRAG: Production-ready GraphRAG with multi-modal indexing, AI agents, MCP support, and scalable K8s deployment

288. **[mcp-boilerplate](https://github.com/iannuttall/mcp-boilerplate)** - ⭐ 995
   A remote Cloudflare MCP server boilerplate with user authentication and Stripe for paid tools.

289. **[claude-code-mcp](https://github.com/steipete/claude-code-mcp)** - ⭐ 992
...
292. **[wenyan-mcp](https://github.com/caol64/wenyan-mcp)** - ⭐ 975
   文颜 MCP Server 可以让 AI 自动将 Markdown 文章排版后发布至微信公众号。

293. **[kubernetes-mcp-server](https://github.com/containers/kubernetes-mcp-server)** - ⭐ 973
   Model Context Protocol (MCP) server for Kubernetes and OpenShift

294. **[better-chatbot](https://github.com/cgoinglove/better-chatbot)** - ⭐ 970
   Just a Better Chatbot. Powered by Agent & MCP & Workflows.

295. **[trustgraph](https://github.com/trustgraph-ai/trustgraph)** - ⭐ 969
   The Context Graph Factory for AI. Build, manage, and deploy AI-optimized Context Graphs.

296. **[claude-init](https://github.com/cfrs2005/claude-init)** - ⭐ 958
   Claude Code 中文开发套件 - 为中国开发者定制的零门槛 AI 编程环境。一键安装完整中文化体验，集成 MCP 服务器、智能上下文管理、安全扫描，支持免翻墙访问。让 AI 编程更简单。

297. **[ollama-mcp-bridge](https://github.com/patruff/ollama-mcp-bridge)** - ⭐ 955
...
300. **[quickstart-resources](https://github.com/modelcontextprotocol/quickstart-resources)** - ⭐ 941
...
303. **[claude-code-plugins-plus-skills](https://github.com/jeremylongshore/claude-code-plugins-plus-skills)** - ⭐ 928
...
308. **[short-video-maker](https://github.com/gyoridavid/short-video-maker)** - ⭐ 908
   Creates short videos for TikTok, Instagram Reels, and YouTube Shorts using the Model Context Protocol (MCP) and a REST API.

309. **[Gmail-MCP-Server](https://github.com/GongRzhe/Gmail-MCP-Server)** - ⭐ 906
   A Model Context Protocol (MCP) server for Gmail integration in Claude Desktop with auto authentication support. This server enables AI assistants to manage Gmail through natural language interactions.

310. **[ai-dev-tools-zoomcamp](https://github.com/DataTalksClub/ai-dev-tools-zoomcamp)** - ⭐ 904
...
311. **[ref-tools-mcp](https://github.com/ref-tools/ref-tools-mcp)** - ⭐ 904
   Helping coding agents never make mistakes working with public or private libraries without wasting the context window.

312. **[zotero-mcp](https://github.com/54yyyu/zotero-mcp)** - ⭐ 902
   Zotero MCP: Connects your Zotero research library with Claude and other AI assistants via the Model Context Protocol to discuss papers, get summaries, analyze citations, and more.

313. **[mcpdoc](https://github.com/langchain-ai/mcpdoc)** - ⭐ 900
   Expose llms-txt to IDEs for development

314. **[docs-mcp-server](https://github.com/arabold/docs-mcp-server)** - ⭐ 896
   Grounded Docs MCP Server: Open-Source Alternative to Context7, Nia, and Ref.Tools

315. **[mcp-windbg](https://github.com/svnscha/mcp-windbg)** - ⭐ 896
   Model Context Protocol for WinDBG

316. **[mcp-framework](https://github.com/QuantGeekDev/mcp-framework)** - ⭐ 890
   A framework for writing MCP (Model Context Protocol) servers in Typescript

317. **[Pixelle-MCP](https://github.com/AIDC-AI/Pixelle-MCP)** - ⭐ 889
   An Open-Source Multimodal AIGC Solution based on ComfyUI + MCP + LLM  https://pixelle.ai

318. **[MCP-Bridge](https://github.com/SecretiveShell/MCP-Bridge)** - ⭐ 888
   A middleware to provide an openAI compatible endpoint that can call MCP tools

319. **[nuxt-mcp-dev](https://github.com/antfu/nuxt-mcp-dev)** - ⭐ 887
   MCP server helping models to understand your Vite/Nuxt app better.

320. **[Awesome-MCP-Servers](https://github.com/YuzeHao2023/Awesome-MCP-Servers)** - ⭐ 883
   A curated list of Model Context Protocol (MCP) servers 

321. **[tools](https://github.com/strands-agents/tools)** - ⭐ 882
   A set of tools that gives agents powerful capabilities.

322. **[mix.core](https://github.com/mixcore/mix.core)** - ⭐ 880
   🚀 A future-proof enterprise web CMS supporting both headless and decoupled approaches. Build any type of app with customizable APIs on ASP.NET Core/.NET Core. Completely open-source and designed for flexibility.

323. **[mongodb-mcp-server](https://github.com/mongodb-js/mongodb-mcp-server)** - ⭐ 876
   A Model Context Protocol server to connect to MongoDB databases and MongoDB Atlas Clusters.

324. **[google-calendar-mcp](https://github.com/nspady/google-calendar-mcp)** - ⭐ 873
   MCP integration for Google Calendar to manage events.

325. **[gitlab-mcp](https://github.com/zereight/gitlab-mcp)** - ⭐ 872
...
328. **[mcp-neo4j](https://github.com/neo4j-contrib/mcp-neo4j)** - ⭐ 867
   Neo4j Labs Model Context Protocol servers

329. **[agentic-radar](https://github.com/splx-ai/agentic-radar)** - ⭐ 867
   A security scanner for your LLM agentic workflows

330. **[mcp-browser-use](https://github.com/Saik0s/mcp-browser-use)** - ⭐ 867

331. **[mcp-course](https://github.com/huggingface/mcp-course)** - ⭐ 866

332. **[gemini-nexus](https://github.com/yeahhe365/gemini-nexus)** - ⭐ 863
...
335. **[mcpm.sh](https://github.com/pathintegral-institute/mcpm.sh)** - ⭐ 852
...
338. **[jupyter-mcp-server](https://github.com/datalayer/jupyter-mcp-server)** - ⭐ 843
   🪐 🔧 Model Context Protocol (MCP) Server for Jupyter.

339. **[hyper-mcp](https://github.com/tuananh/hyper-mcp)** - ⭐ 835
   📦️ A fast, secure MCP server that extends its capabilities through WebAssembly plugins.

340. **[AI-Gateway](https://github.com/Azure-Samples/AI-Gateway)** - ⭐ 835
...
341. **[todo-for-ai](https://github.com/todo-for-ai/todo-for-ai)** - ⭐ 835
...
342. **[memory-bank-mcp](https://github.com/alioshr/memory-bank-mcp)** - ⭐ 834
   A Model Context Protocol (MCP) server implementation for remote memory bank management, inspired by Cline Memory Bank.

343. **[scira-mcp-chat](https://github.com/zaidmukaddam/scira-mcp-chat)** - ⭐ 825
   A minimalistic MCP client with a good feature set.

344. **[OpenDerisk](https://github.com/derisk-ai/OpenDerisk)** - ⭐ 823
...
345. **[supabase-mcp-server](https://github.com/alexander-zuev/supabase-mcp-server)** - ⭐ 816
   Query MCP enables end-to-end management of Supabase via chat interface: read & write query executions, management API support, automatic migration versioning, access to logs and much more.

346. **[mcp-sequential-thinking](https://github.com/arben-adm/mcp-sequential-thinking)** - ⭐ 815

347. **[yokai](https://github.com/ankorstore/yokai)** - ⭐ 813
   Simple, modular, and observable Go framework for backend applications.

348. **[statespace](https://github.com/statespace-tech/statespace)** - ⭐ 811
...
350. **[golf](https://github.com/golf-mcp/golf)** - ⭐ 807
   Production-Ready MCP Server Framework • Build, deploy & scale secure AI agent infrastructure • Includes Auth, Observability, Debugger, Telemetry & Runtime • Run real-world MCPs powering AI Agents 

351. **[trpc-agent-go](https://github.com/trpc-group/trpc-agent-go)** - ⭐ 805
   trpc-agent-go is a powerful Go framework for building intelligent agent systems using large language models (LLMs) and tools.

352. **[wassette](https://github.com/microsoft/wassette)** - ⭐ 804
   Wassette: A security-oriented runtime that runs WebAssembly Components via MCP

353. **[DeepMCPAgent](https://github.com/cryxnet/DeepMCPAgent)** - ⭐ 802
...
356. **[openapi-servers](https://github.com/open-webui/openapi-servers)** - ⭐ 798
   OpenAPI Tool Servers

357. **[browser-use-mcp-server](https://github.com/kontext-dev/browser-use-mcp-server)** - ⭐ 792
   Browse the web, directly from Cursor etc.

358. **[MCP-Security-Checklist](https://github.com/slowmist/MCP-Security-Checklist)** - ⭐ 787
   A comprehensive security checklist for MCP-based AI tools. Built by SlowMist to safeguard LLM plugin ecosystems.

359. **[MCPJungle](https://github.com/mcpjungle/MCPJungle)** - ⭐ 786
   Self-hosted MCP Gateway and Registry for AI agents

360. **[arcade-mcp](https://github.com/ArcadeAI/arcade-mcp)** - ⭐ 784
   The best way to create, deploy, and share MCP Servers

361. **[bank-api](https://github.com/erwinkramer/bank-api)** - ⭐ 776
   The Bank API is a design reference project suitable to bootstrap development for a compliant and modern API.

362. **[excel-mcp-server](https://github.com/negokaz/excel-mcp-server)** - ⭐ 773
   A Model Context Protocol (MCP) server that reads and writes MS Excel data

363. **[mcp-knowledge-graph](https://github.com/shaneholloman/mcp-knowledge-graph)** - ⭐ 766
   MCP server enabling persistent memory for Claude through a local knowledge graph - fork focused on local development

364. **[acemcp](https://github.com/qy527145/acemcp)** - ⭐ 761
   一个将ACE(Augment Context Engine) 做成MCP的项目

365. **[Context](https://github.com/indragiek/Context)** - ⭐ 761
   Native macOS client for Model Context Protocol (MCP)

366. **[agent-kit](https://github.com/inngest/agent-kit)** - ⭐ 760
   AgentKit: Build multi-agent networks in TypeScript with deterministic routing and rich tooling via MCP.

367. **[vibetest-use](https://github.com/browser-use/vibetest-use)** - ⭐ 756
   Vibetest MCP - automated QA testing using Browser-Use agents

368. **[qgis_mcp](https://github.com/jjsantos01/qgis_mcp)** - ⭐ 755
   Model Context Protocol (MCP) that allows LLMs to use QGIS Desktop

369. **[runno](https://github.com/taybenlor/runno)** - ⭐ 754
...
371. **[k8m](https://github.com/weibaohui/k8m)** - ⭐ 750
   一款轻量级、跨平台的 Mini Kubernetes AI Dashboard，支持大模型+智能体+MCP(支持设置操作权限)，集成多集群管理、智能分析、实时异常检测等功能，支持多架构并可单文件部署，助力高效集群管理与运维优化。

372. **[vllora](https://github.com/vllora/vllora)** - ⭐ 750
   Debug your AI agents

373. **[mcp-marketplace](https://github.com/cline/mcp-marketplace)** - ⭐ 747
...
374. **[mcp-scanner](https://github.com/cisco-ai-defense/mcp-scanner)** - ⭐ 742
   Scan MCP servers for potential threats & security findings.

375. **[AITreasureBox](https://github.com/superiorlu/AITreasureBox)** - ⭐ 739
   🤖 Collect practical AI repos, tools, websites, papers and tutorials on AI. 实用的AI百宝箱 💎 

376. **[lisa.py](https://github.com/ant4g0nist/lisa.py)** - ⭐ 738
   LLDB MCP Integration + other helpful commands

377. **[Unity-MCP](https://github.com/IvanMurzak/Unity-MCP)** - ⭐ 735
   AI-powered bridge connecting LLMs and advanced AI agents to the Unity Editor via the Model Context Protocol (MCP). Chat with AI to generate code, debug errors, and automate game development tasks directly within your project.

378. **[heurist-agent-framework](https://github.com/heurist-network/heurist-agent-framework)** - ⭐ 732
   A flexible multi-interface AI agent framework for building agents with reasoning, tool use, memory, deep research, blockchain interaction, MCP, and agents-as-a-service.

379. **[mcp-server](https://github.com/financial-datasets/mcp-server)** - ⭐ 727
   An MCP server for interacting with the Financial Datasets stock market API.

380. **[wordpress-mcp](https://github.com/Automattic/wordpress-mcp)** - ⭐ 719
...
381. **[context-portal](https://github.com/GreatScottyMac/context-portal)** - ⭐ 715
...
382. **[duckduckgo-mcp-server](https://github.com/nickclyde/duckduckgo-mcp-server)** - ⭐ 715
   A Model Context Protocol (MCP) server that provides web search capabilities through DuckDuckGo, with additional features for content fetching and parsing.

383. **[passage-of-time-mcp](https://github.com/jlumbroso/passage-of-time-mcp)** - ⭐ 709
...
384. **[apple-docs-mcp](https://github.com/kimsungwhee/apple-docs-mcp)** - ⭐ 709
   MCP server for Apple Developer Documentation - Search iOS/macOS/SwiftUI/UIKit docs, WWDC videos, Swift/Objective-C APIs & code examples in Claude, Cursor & AI assistants

385. **[coderunner](https://github.com/instavm/coderunner)** - ⭐ 707
   A secure local sandbox to run LLM-generated code using Apple containers

386. **[openmcp-client](https://github.com/LSTM-Kirigaya/openmcp-client)** - ⭐ 704
   All in one vscode plugin for mcp developer

387. **[mcp](https://github.com/hyperbrowserai/mcp)** - ⭐ 703
   A MCP server implementation for hyperbrowser

388. **[llm-functions](https://github.com/sigoden/llm-functions)** - ⭐ 696
   Easily create LLM tools and agents using plain Bash/JavaScript/Python functions.

389. **[linkedin-mcp-server](https://github.com/stickerdaniel/linkedin-mcp-server)** - ⭐ 692
...
390. **[nanobot](https://github.com/nanobot-ai/nanobot)** - ⭐ 692
   Build MCP Agents

391. **[just-prompt](https://github.com/disler/just-prompt)** - ⭐ 690
...
392. **[apify-mcp-server](https://github.com/apify/apify-mcp-server)** - ⭐ 683
   The Apify MCP server enables your AI agents to extract data from social media, search engines, maps, e-commerce sites, or any other website using thousands of ready-made scrapers, crawlers, and automation tools available on the Apify Store.

393. **[mcporter](https://github.com/steipete/mcporter)** - ⭐ 680
   Call MCPs via TypeScript, masquerading as simple TypeScript API. Or package them as cli.

394. **[MassGen](https://github.com/massgen/MassGen)** - ⭐ 680
...
395. **[langgraph-mcp-agents](https://github.com/teddynote-lab/langgraph-mcp-agents)** - ⭐ 676
...
396. **[ruby-sdk](https://github.com/modelcontextprotocol/ruby-sdk)** - ⭐ 676
   The official Ruby SDK for the Model Context Protocol. Maintained in collaboration with Shopify.

397. **[12306-mcp](https://github.com/Joooook/12306-mcp)** - ⭐ 674
   This is a 12306 ticket search server based on the Model Context Protocol (MCP).

398. **[HowToCook-mcp](https://github.com/worryzyy/HowToCook-mcp)** - ⭐ 673
   基于Anduin2017 / HowToCook （程序员在家做饭指南）的mcp server

399. **[Claude-Code-Everything-You-Need-to-Know](https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know)** - ⭐ 670
   The ultimate all-in-one guide to mastering Claude Code. From setup, prompt engineering, commands, hooks, workflows, automation, and integrations, to MCP servers, tools, and the BMAD method—packed with step-by-step tutorials, real-world examples, and expert strategies to make this the global go-to repo for Claude mastery.

400. **[octocode-mcp](https://github.com/bgauryy/octocode-mcp)** - ⭐ 666
   MCP server for semantic code research and context generation on real-time using LLM patterns | Search naturally across public & private repos based on your permissions | Transform any accessible codebase/s into AI-optimized knowledge on simple and complex flows | Find real implementations and live docs from anywhere

401. **[fetch-mcp](https://github.com/zcaceres/fetch-mcp)** - ⭐ 666
   A flexible HTTP fetching Model Context Protocol server.

402. **[code-index-mcp](https://github.com/johnhuang316/code-index-mcp)** - ⭐ 666
   A Model Context Protocol (MCP) server that helps large language models index, search, and analyze code repositories with minimal setup

403. **[mcp-server-docker](https://github.com/ckreiling/mcp-server-docker)** - ⭐ 665
   MCP server for Docker

404. **[clojure-mcp](https://github.com/bhauman/clojure-mcp)** - ⭐ 662
   Clojure MCP

405. **[go-mcp](https://github.com/ThinkInAIXYZ/go-mcp)** - ⭐ 658
...
406. **[mcp-client-cli](https://github.com/adhikasp/mcp-client-cli)** - ⭐ 658
   A simple CLI to run LLM prompt and implement MCP client.

407. **[yacy_grid_mcp](https://github.com/yacy/yacy_grid_mcp)** - ⭐ 655
   The YaCy Grid Master Connect Program

408. **[himarket](https://github.com/higress-group/himarket)** - ⭐ 655
...
409. **[llm-server-docs](https://github.com/varunvasudeva1/llm-server-docs)** - ⭐ 651
   End-to-end documentation to set up your own local & fully private LLM server on Debian. Equipped with chat, web search, RAG, model management, MCP servers, image generation, and TTS.

410. **[mcp-clickhouse](https://github.com/ClickHouse/mcp-clickhouse)** - ⭐ 644
   Connect ClickHouse to your AI assistants.

411. **[annas-mcp](https://github.com/iosifache/annas-mcp)** - ⭐ 642
   MCP server and CLI tool for searching and downloading documents from Anna's Archive

412. **[claude-code-plugins-plus](https://github.com/jeremylongshore/claude-code-plugins-plus)** - ⭐ 641
...
413. **[laravel-restify](https://github.com/BinarCode/laravel-restify)** - ⭐ 640
   Laravel API for Ai Agents and humans.

414. **[llm-search](https://github.com/snexus/llm-search)** - ⭐ 640
   Querying local documents, powered by LLM

415. **[enrichmcp](https://github.com/featureform/enrichmcp)** - ⭐ 640
   EnrichMCP is a python framework for building data driven MCP servers

416. **[python-utcp](https://github.com/universal-tool-calling-protocol/python-utcp)** - ⭐ 634
   Official python implementation of UTCP. UTCP is an open standard that lets AI agents call any API directly, without extra middleware.

417. **[cuga-agent](https://github.com/cuga-project/cuga-agent)** - ⭐ 633
...
418. **[android-mcp-server](https://github.com/minhalvp/android-mcp-server)** - ⭐ 632
   An MCP server that provides control over Android devices via adb

419. **[open-ptc-agent](https://github.com/Chen-zexi/open-ptc-agent)** - ⭐ 631
   An open source implementation of code execution with MCP (Programatic Tool Calling) 

420. **[wcgw](https://github.com/rusiaaman/wcgw)** - ⭐ 630
   Shell and coding agent on claude desktop app

421. **[mcp-mem0](https://github.com/coleam00/mcp-mem0)** - ⭐ 630
   MCP server for long term agent memory with Mem0. Also useful as a template to get you started building your own MCP server with Python!

422. **[mcp](https://github.com/laravel/mcp)** - ⭐ 628
   Rapidly build MCP servers for your Laravel applications.

423. **[awesome-mcp-security](https://github.com/Puliczek/awesome-mcp-security)** - ⭐ 621
   🔥🔒 Awesome MCP (Model Context Protocol) Security 🖥️

424. **[RAGLight](https://github.com/Bessouat40/RAGLight)** - ⭐ 621
   RAGLight is a modular framework for Retrieval-Augmented Generation (RAG). It makes it easy to plug in different LLMs, embeddings, and vector stores, and now includes seamless MCP integration to connect external tools and data sources.

425. **[obsidian-mcp](https://github.com/StevenStavrakis/obsidian-mcp)** - ⭐ 617
   A simple MCP server for Obsidian

426. **[workers-mcp](https://github.com/cloudflare/workers-mcp)** - ⭐ 616
   Talk to a Cloudflare Worker from Claude Desktop!

427. **[mcp-proxy](https://github.com/TBXark/mcp-proxy)** - ⭐ 615
   An MCP proxy server that aggregates and serves multiple MCP resource servers through a single HTTP server.

428. **[phpMyFAQ](https://github.com/thorsten/phpMyFAQ)** - ⭐ 611
   phpMyFAQ - Open Source FAQ web application for PHP 8.3+ and MySQL, PostgreSQL and other databases

429. **[samples](https://github.com/strands-agents/samples)** - ⭐ 604
   Agent samples built using the Strands Agents SDK.

430. **[mem-agent-mcp](https://github.com/firstbatchxyz/mem-agent-mcp)** - ⭐ 599
   mem-agent mcp server

431. **[gcloud-mcp](https://github.com/googleapis/gcloud-mcp)** - ⭐ 599
   gcloud MCP server

432. **[FantasyPremierLeague](https://github.com/joreilly/FantasyPremierLeague)** - ⭐ 592
   Fantasy Premier League Kotlin/Compose Multiplatform sample 

433. **[mcp-google-sheets](https://github.com/xing5/mcp-google-sheets)** - ⭐ 591
   This MCP server integrates with your Google Drive and Google Sheets, to enable creating and modifying spreadsheets.

434. **[awesome-web3-mcp-servers](https://github.com/demcp/awesome-web3-mcp-servers)** - ⭐ 590
...
435. **[mcp-link](https://github.com/automation-ai-labs/mcp-link)** - ⭐ 589
   Convert Any OpenAPI V3 API to MCP Server

436. **[vibe](https://github.com/mondaycom/vibe)** - ⭐ 588
   🎨 Vibe Design System - Official monday.com UI resources for application development in React.js

437. **[mcp-server-elasticsearch](https://github.com/elastic/mcp-server-elasticsearch)** - ⭐ 588

438. **[mcp_excalidraw](https://github.com/yctimlin/mcp_excalidraw)** - ⭐ 585

439. **[FLUJO](https://github.com/mario-andreschak/FLUJO)** - ⭐ 584
   MCP-Hub and -Inspector, Multi-Model Workflow and Chat Interface 

440. **[tome](https://github.com/runebookai/tome)** - ⭐ 583
   a magical LLM desktop client that makes it easy for *anyone* to use LLMs and MCP

441. **[yargi-mcp](https://github.com/saidsurucu/yargi-mcp)** - ⭐ 582
   MCP Server For Turkish Legal Databases

442. **[daydreams](https://github.com/daydreamsai/daydreams)** - ⭐ 581
   Daydreams is a set of tools for building agents for commerce

443. **[mcp-filesystem-server](https://github.com/mark3labs/mcp-filesystem-server)** - ⭐ 578
   Go server implementing Model Context Protocol (MCP) for filesystem operations.

444. **[blueprint-mcp](https://github.com/ArcadeAI/blueprint-mcp)** - ⭐ 574
   Diagram generation for understanding codebases and system architecture using Nano Banana Pro.

445. **[dexto](https://github.com/truffle-ai/dexto)** - ⭐ 573
   Dexto is a general-purpose agent harness for building and orchestrating agentic applications.

446. **[langgraph-mcp](https://github.com/esxr/langgraph-mcp)** - ⭐ 567
   LangGraph solution template for MCP

447. **[FofaMap](https://github.com/asaotomo/FofaMap)** - ⭐ 564
...
448. **[voicemode](https://github.com/mbailey/voicemode)** - ⭐ 559
   VoiceMode MCP brings natural conversations to Claude Code

449. **[obot](https://github.com/obot-platform/obot)** - ⭐ 557
   Complete MCP Platform -- Hosting, Registry, Gateway, and Chat Client

450. **[mcp-pointer](https://github.com/etsd-tech/mcp-pointer)** - ⭐ 555
   MCP tool: let you point at DOM elements for your favorite agentic coding tool. Let AI see what you see.

451. **[spotify-mcp](https://github.com/varunneal/spotify-mcp)** - ⭐ 554
   MCP to connect your LLM with Spotify.

452. **[mcp-sequentialthinking-tools](https://github.com/spences10/mcp-sequentialthinking-tools)** - ⭐ 553
   🧠 An adaptation of the MCP Sequential Thinking Server to guide tool usage. This server provides recommendations for which MCP tools would be most effective at each stage.

453. **[mem0-mcp](https://github.com/mem0ai/mem0-mcp)** - ⭐ 552

454. **[MCP-Nest](https://github.com/rekog-labs/MCP-Nest)** - ⭐ 547
   A NestJS module to effortlessly create Model Context Protocol (MCP) servers for exposing AI tools, resources, and prompts.

455. **[a-share-mcp-is-just-i-need](https://github.com/24mlight/a-share-mcp-is-just-i-need)** - ⭐ 546

456. **[mcp-shield](https://github.com/riseandignite/mcp-shield)** - ⭐ 542
   Security scanner for MCP servers

457. **[telegram-mcp](https://github.com/chigwell/telegram-mcp)** - ⭐ 542
   Telegram MCP server powered by Telethon to let MCP clients read chats, manage groups, and send/modify messages, media, contacts, and settings.

458. **[macos-automator-mcp](https://github.com/steipete/macos-automator-mcp)** - ⭐ 540
   An MCP server to run AppleScript and JXA (JavaScript for Automation) to macOS.

459. **[drawio-mcp-server](https://github.com/lgazo/drawio-mcp-server)** - ⭐ 539
   Draw.io Model Context Protocol (MCP) Server

460. **[MCP-Universe](https://github.com/SalesforceAIResearch/MCP-Universe)** - ⭐ 537
   MCP-Universe is a comprehensive framework designed for developing, testing, and benchmarking AI agents

461. **[pg-mcp-server](https://github.com/stuzero/pg-mcp-server)** - ⭐ 533

462. **[vite-plugin-vue-mcp](https://github.com/webfansplz/vite-plugin-vue-mcp)** - ⭐ 533
   Vite plugin that enables a MCP server helping models to understand your Vue app better.

463. **[manim-mcp-server](https://github.com/abhiemj/manim-mcp-server)** - ⭐ 533

464. **[evo-ai](https://github.com/EvolutionAPI/evo-ai)** - ⭐ 532
   Evo AI is an open-source platform for creating and managing AI agents, enabling integration with different AI models and services.

465. **[LLMTornado](https://github.com/lofcz/LLMTornado)** - ⭐ 532
   The .NET library to build AI agents with 25+ built-in connectors.

466. **[fastapi-mcp-langgraph-template](https://github.com/NicholasGoh/fastapi-mcp-langgraph-template)** - ⭐ 531
   A modern template for agentic orchestration — built for rapid iteration and scalable deployment using highly customizable, community-supported tools like MCP, LangGraph, and more.

467. **[mcp-handler](https://github.com/vercel/mcp-handler)** - ⭐ 531
   Easily spin up an MCP Server on Next.js, Nuxt, Svelte, and more

468. **[mcp-server-neon](https://github.com/neondatabase/mcp-server-neon)** - ⭐ 530
   MCP server for interacting with Neon Management API and databases

469. **[dolphin-mcp](https://github.com/QuixiAI/dolphin-mcp)** - ⭐ 529

470. **[google-search](https://github.com/web-agent-master/google-search)** - ⭐ 525
   A Playwright-based Node.js tool that bypasses search engine anti-scraping mechanisms to execute Google searches. Local alternative to SERP APIs with MCP server integration.

471. **[wren-engine](https://github.com/Canner/wren-engine)** - ⭐ 525
   🤖 The Semantic Engine for Model Context Protocol(MCP) Clients and AI Agents 🔥 

472. **[paper-search-mcp](https://github.com/openags/paper-search-mcp)** - ⭐ 523
   A MCP for searching and downloading academic papers from multiple sources like arXiv, PubMed, bioRxiv, etc.

473. **[mcp-for-security](https://github.com/cyproxio/mcp-for-security)** - ⭐ 522
   MCP for Security: A collection of Model Context Protocol servers for popular security tools like SQLMap, FFUF, NMAP, Masscan and more. Integrate security testing and penetration testing into AI workflows.

474. **[mcp-server-data-exploration](https://github.com/reading-plus-ai/mcp-server-data-exploration)** - ⭐ 521

475. **[mcp.el](https://github.com/lizqwerscott/mcp.el)** - ⭐ 521
   An Mcp client inside Emacs

476. **[multimodal-agents-course](https://github.com/the-ai-merge/multimodal-agents-course)** - ⭐ 520
   An MCP Multimodal AI Agent with eyes and ears!

477. **[douyin-mcp-server](https://github.com/yzfly/douyin-mcp-server)** - ⭐ 519
   提取抖音无水印视频链接，视频文案，douyin-mcp-server

478. **[ethora](https://github.com/dappros/ethora)** - ⭐ 517
...
479. **[pgmcp](https://github.com/subnetmarco/pgmcp)** - ⭐ 517
   An MCP server to query any Postgres database in natural language.

480. **[awesome-mcp-servers](https://github.com/TensorBlock/awesome-mcp-servers)** - ⭐ 517
   A comprehensive collection of Model Context Protocol (MCP) servers

481. **[ghostcrew](https://github.com/GH05TCREW/ghostcrew)** - ⭐ 515
...
482. **[mcpcan](https://github.com/Kymo-MCP/mcpcan)** - ⭐ 515
...
483. **[obsidian-mcp-tools](https://github.com/jacksteamdev/obsidian-mcp-tools)** - ⭐ 515
   Add Obsidian integrations like semantic search and custom Templater prompts to Claude or any MCP client.

484. **[homeassistant-mcp](https://github.com/tevonsb/homeassistant-mcp)** - ⭐ 512
   A MCP server for Home Assistant

485. **[line-bot-mcp-server](https://github.com/line/line-bot-mcp-server)** - ⭐ 510
   MCP server that integrates the LINE Messaging API to connect an AI Agent to the LINE Official Account.

486. **[gateway](https://github.com/centralmind/gateway)** - ⭐ 510
   Universal MCP-Server for your Databases optimized for LLMs and AI-Agents.

487. **[apple-health-mcp](https://github.com/neiltron/apple-health-mcp)** - ⭐ 509
   MCP server for querying Apple Health data with natural language and SQL

488. **[ida-mcp-server](https://github.com/MxIris-Reverse-Engineering/ida-mcp-server)** - ⭐ 509
   A Model Context Protocol server for IDA

489. **[cloud-run-mcp](https://github.com/GoogleCloudPlatform/cloud-run-mcp)** - ⭐ 507
   MCP server to deploy apps to Cloud Run

490. **[multimodal-agents-course](https://github.com/multi-modal-ai/multimodal-agents-course)** - ⭐ 507
   An MCP Multimodal AI Agent with eyes and ears!

491. **[iterm-mcp](https://github.com/ferrislucas/iterm-mcp)** - ⭐ 507
   A Model Context Protocol server that executes commands in the current iTerm session - useful for REPL and CLI assistance

492. **[echokit_server](https://github.com/second-state/echokit_server)** - ⭐ 506
   Open Source Voice Agent Platform

493. **[next-devtools-mcp](https://github.com/vercel/next-devtools-mcp)** - ⭐ 505
   Next.js Development for Coding Agent

494. **[mcp-server-weread](https://github.com/freestylefly/mcp-server-weread)** - ⭐ 504
   微信读书MCP

495. **[mcp-get](https://github.com/michaellatman/mcp-get)** - ⭐ 501

496. **[cclsp](https://github.com/ktnyt/cclsp)** - ⭐ 499
   Claude Code LSP: enhance your Claude Code experience with non-IDE dependent LSP integration.

497. **[openapi-mcp-generator](https://github.com/harsha-iiiv/openapi-mcp-generator)** - ⭐ 498
   A tool that converts OpenAPI specifications to MCP server

498. **[mcp-server-bash-sdk](https://github.com/muthuishere/mcp-server-bash-sdk)** - ⭐ 498
   Yes Mcp server in bash

499. **[brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server)** - ⭐ 495

500. **[reverse-engineering-assistant](https://github.com/cyberkaida/reverse-engineering-assistant)** - ⭐ 494
   MCP server for reverse engineering tasks in Ghidra 👩‍💻

501. **[sentry-mcp](https://github.com/getsentry/sentry-mcp)** - ⭐ 493
   An MCP server for interacting with Sentry via LLMs.

502. **[PentestAgent](https://github.com/GH05TCREW/PentestAgent)** - ⭐ 493
...
503. **[awesome-a2a](https://github.com/ai-boost/awesome-a2a)** - ⭐ 492
   Agent2Agent (A2A) – awesome A2A agents, tools, servers & clients, all in one place.

504. **[UnityMCP](https://github.com/Arodoid/UnityMCP)** - ⭐ 491

505. **[UnityMCP](https://github.com/jackwrichards/UnityMCP)** - ⭐ 490

506. **[MCPSpy](https://github.com/alex-ilgayev/MCPSpy)** - ⭐ 488
   MCP Monitoring with eBPF

507. **[web-agent-protocol](https://github.com/OTA-Tech-AI/web-agent-protocol)** - ⭐ 488
   🌐Web Agent Protocol (WAP) - Record and replay user interactions in the browser with MCP support

508. **[mcp-youtube](https://github.com/anaisbetts/mcp-youtube)** - ⭐ 486
   A Model-Context Protocol Server for YouTube

509. **[apple-doc-mcp](https://github.com/MightyDillah/apple-doc-mcp)** - ⭐ 485
   MCP server providing seamless access to Apple Developer Documentation with smart search and wildcard support

510. **[claude-debugs-for-you](https://github.com/jasonjmcghee/claude-debugs-for-you)** - ⭐ 481
   Enable any LLM (e.g. Claude) to interactively debug any language for you via MCP and a VS Code Extension

511. **[mcp-pandoc](https://github.com/vivekVells/mcp-pandoc)** - ⭐ 478
   MCP server for document format conversion using pandoc.

512. **[rails-mcp-server](https://github.com/maquina-app/rails-mcp-server)** - ⭐ 475
   A Ruby gem implementation of a Model Context Protocol (MCP) server for Rails projects. This server allows LLMs (Large Language Models) to interact with Rails projects through the Model Context Protocol.

513. **[CyberStrikeAI](https://github.com/Ed1s0nZ/CyberStrikeAI)** - ⭐ 473
...
514. **[UnrealMCP](https://github.com/kvick-games/UnrealMCP)** - ⭐ 472
   MCP to allow AI agents to control Unreal

515. **[aser](https://github.com/AmeNetwork/aser)** - ⭐ 471
   Aser is a lightweight, self-assembling AI Agent frame.

516. **[open-multi-agent-canvas](https://github.com/CopilotKit/open-multi-agent-canvas)** - ⭐ 470
   The open-source multi-agent chat interface that lets you manage multiple agents in one dynamic conversation and add MCP servers for deep research

517. **[mcp-gsuite](https://github.com/MarkusPfundstein/mcp-gsuite)** - ⭐ 470
   MCP Server to interact with Google Gsuite prodcuts

518. **[mcp-client-for-ollama](https://github.com/jonigl/mcp-client-for-ollama)** - ⭐ 467
   A text-based user interface (TUI) client for interacting with MCP servers using Ollama. Features include agent mode, multi-server, model switching, streaming responses, tool management, human-in-the-loop, thinking mode, model params config, MCP prompts, custom system prompt and saved preferences. Built for developers working with local LLMs.

519. **[AnyTool](https://github.com/HKUDS/AnyTool)** - ⭐ 466
   "AnyTool: Universal Tool-Use Layer for AI Agents"

520. **[laravel](https://github.com/php-mcp/laravel)** - ⭐ 465
   An SDK building Laravel MCP servers

521. **[cli](https://github.com/smithery-ai/cli)** - ⭐ 465
   Install, manage and develop MCP servers

522. **[chroma-mcp](https://github.com/chroma-core/chroma-mcp)** - ⭐ 465
   A Model Context Protocol (MCP) server implementation that provides database capabilities for Chroma

523. **[clickup-mcp-server](https://github.com/taazkareem/clickup-mcp-server)** - ⭐ 462
   ClickUp MCP Server - Integrate ClickUp project management with AI through Model Context Protocol

524. **[doctor](https://github.com/sisig-ai/doctor)** - ⭐ 461
   Doctor is a tool for discovering, crawl, and indexing web sites to be exposed as an MCP server for LLM agents.

525. **[deeppowers](https://github.com/deeppowers/deeppowers)** - ⭐ 460
...
526. **[llm-mcp-rag](https://github.com/KelvinQiu802/llm-mcp-rag)** - ⭐ 460
   LLM + MCP + RAG = Magic

527. **[n8n-workflow-builder](https://github.com/makafeli/n8n-workflow-builder)** - ⭐ 459
   AI assistant integration for n8n workflow automation through Model Context Protocol (MCP). Connect Claude Desktop, ChatGPT, and other AI assistants to n8n for natural language workflow management.

528. **[copilot-mcp](https://github.com/VikashLoomba/copilot-mcp)** - ⭐ 457
...
529. **[davinci-resolve-mcp](https://github.com/samuelgursky/davinci-resolve-mcp)** - ⭐ 457
   MCP server integration for DaVinci Resolve

530. **[atlas-mcp-server](https://github.com/cyanheads/atlas-mcp-server)** - ⭐ 456
   A Model Context Protocol (MCP) server for ATLAS, a Neo4j-powered task management system for LLM Agents - implementing a three-tier architecture (Projects, Tasks, Knowledge) to manage complex workflows. Now with Deep Research.

531. **[dbt-mcp](https://github.com/dbt-labs/dbt-mcp)** - ⭐ 453
   A MCP (Model Context Protocol) server for interacting with dbt.

532. **[argo](https://github.com/xark-argo/argo)** - ⭐ 452
   ARGO is an open-source AI Agent platform that brings Local Manus to your desktop. With one-click model downloads, seamless closed LLM integration, and offline-first RAG knowledge bases, ARGO becomes a DeepResearch powerhouse for autonomous thinking, task planning, and 100% of your data stays locally. Support Win/Mac/Docker.

533. **[director](https://github.com/director-run/director)** - ⭐ 450
   MCP Playbooks for AI agents

534. **[vibe-check-mcp-server](https://github.com/PV-Bhat/vibe-check-mcp-server)** - ⭐ 450
   Vibe Check is a tool that provides mentor-like feedback to AI Agents, preventing tunnel-vision, over-engineering and reasoning lock-in for complex and long-horizon agent workflows. KISS your over-eager AI Agents goodbye! Effective for: Coding, Ambiguous Tasks, High-Risk tasks

535. **[haiku.rag](https://github.com/ggozad/haiku.rag)** - ⭐ 445
   Opinionated agentic RAG powered by LanceDB, Pydantic AI, and Docling

536. **[freecad-mcp](https://github.com/neka-nat/freecad-mcp)** - ⭐ 444
   FreeCAD MCP(Model Context Protocol) server

537. **[docker-mcp](https://github.com/QuantGeekDev/docker-mcp)** - ⭐ 443
   A docker MCP Server (modelcontextprotocol)

538. **[flux-operator](https://github.com/controlplaneio-fluxcd/flux-operator)** - ⭐ 443
   GitOps on Autopilot Mode

539. **[adb-mcp](https://github.com/mikechambers/adb-mcp)** - ⭐ 442

540. **[nexus](https://github.com/grafbase/nexus)** - ⭐ 441
   Govern & Secure your AI

541. **[alpaca-mcp-server](https://github.com/alpacahq/alpaca-mcp-server)** - ⭐ 439
   Alpaca’s official MCP Server lets you trade stocks, ETFs, crypto, and options, run data analysis, and build strategies in plain English directly from your favorite LLM tools and IDEs

542. **[borsa-mcp](https://github.com/saidsurucu/borsa-mcp)** - ⭐ 438
   MCP Server for Turkish & American Stock Exchange and Fund Data

543. **[mcpe](https://github.com/ReMinecraftPE/mcpe)** - ⭐ 438
   ReMinecraftPE - A custom experience based on Minecraft PE as of 2011.

544. **[mcp-remote-macos-use](https://github.com/baryhuang/mcp-remote-macos-use)** - ⭐ 438
   The only general AI agent that does NOT requires extra API key, giving you full control on your local and remote MacOs from Claude Desktop App

545. **[MCP-Kali-Server](https://github.com/Wh0am123/MCP-Kali-Server)** - ⭐ 436
   MCP configuration to connect AI agent to a Linux machine.

546. **[minecraft-mcp-server](https://github.com/yuniko-software/minecraft-mcp-server)** - ⭐ 435
   A Minecraft MCP Server powered by Mineflayer API. It allows to control a Minecraft character in real-time, allowing AI assistants to build structures, explore the world, and interact with the game environment through natural language instruction

547. **[web-search-mcp](https://github.com/mrkrsl/web-search-mcp)** - ⭐ 435
   A simple, locally hosted Web Search MCP server for use with Local LLMs

548. **[MCP-Zero](https://github.com/xfey/MCP-Zero)** - ⭐ 431
   MCP-Zero: Active Tool Discovery for Autonomous LLM Agents

549. **[mcp-send-email](https://github.com/resend/mcp-send-email)** - ⭐ 424
   Send emails directly from Cursor with this email sending MCP server

550. **[mcp-security](https://github.com/google/mcp-security)** - ⭐ 421

551. **[mcp-bench](https://github.com/Accenture/mcp-bench)** - ⭐ 420
   MCP-Bench: Benchmarking Tool-Using LLM Agents with Complex Real-World Tasks via MCP Servers

552. **[mcp-server-spec-driven-development](https://github.com/formulahendry/mcp-server-spec-driven-development)** - ⭐ 420
   Spec-Driven Development MCP Server, not just Vibe Coding

553. **[pdf-reader-mcp](https://github.com/SylphxAI/pdf-reader-mcp)** - ⭐ 420
   📄 Production-ready MCP server for PDF processing - 5-10x faster with parallel processing and 94%+ test coverage

554. **[youtube-mcp-server](https://github.com/ZubeidHendricks/youtube-mcp-server)** - ⭐ 419
   MCP Server for YouTube API, enabling video management, Shorts creation, and advanced analytics

555. **[tsidp](https://github.com/tailscale/tsidp)** - ⭐ 419
   A simple OIDC / OAuth Identity Provider (IdP) server for your tailnet.

556. **[mcp-server](https://github.com/PortSwigger/mcp-server)** - ⭐ 418
   MCP Server for Burp

557. **[mcpstore](https://github.com/whillhill/mcpstore)** - ⭐ 418
   开盒即用的优雅管理mcp服务 | 结合Agent框架 | 作者听劝 | 已发布pypi | Vue页面demo 

558. **[joinly](https://github.com/joinly-ai/joinly)** - ⭐ 418
   Make your meetings accessible to AI Agents

559. **[kratos-transport](https://github.com/tx7do/kratos-transport)** - ⭐ 418
   kratos transport layer extension, support: rabbitmq,kafka,rocketmq,activemq,apollo,mcp,tcp,websocket...

560. **[mcp-adapter](https://github.com/WordPress/mcp-adapter)** - ⭐ 417
   An MCP adapter that bridges the Abilities API to the Model Context Protocol, enabling MCP clients to discover and invoke WordPress plugin, theme, and core abilities programmatically.

561. **[Godot-MCP](https://github.com/ee0pdt/Godot-MCP)** - ⭐ 416
   An MCP for Godot that lets you create and edit games in the Godot game engine with tools like Claude

562. **[xhs-mcp](https://github.com/jobsonlook/xhs-mcp)** - ⭐ 415
   小红书MCP服务 x-s x-t js逆向

563. **[mcpadapt](https://github.com/grll/mcpadapt)** - ⭐ 415
   Unlock 650+ MCP servers tools in your favorite agentic framework.

564. **[MetasploitMCP](https://github.com/GH05TCREW/MetasploitMCP)** - ⭐ 414
   MCP Server for Metasploit

565. **[archestra](https://github.com/archestra-ai/archestra)** - ⭐ 412
   Enterprise-ready MCP gateway, MCP registry & orchestrator

566. **[mcp-hub](https://github.com/ravitemer/mcp-hub)** - ⭐ 411
   A centralized manager for Model Context Protocol (MCP) servers with dynamic server management and monitoring

567. **[learn-low-code-agentic-ai](https://github.com/panaversity/learn-low-code-agentic-ai)** - ⭐ 409
...
568. **[mcp-gateway](https://github.com/microsoft/mcp-gateway)** - ⭐ 409
   MCP Gateway is a reverse proxy and management layer for MCP servers, enabling scalable, session-aware stateful routing and lifecycle management of MCP servers in Kubernetes environments.

569. **[meta-ads-mcp](https://github.com/pipeboard-co/meta-ads-mcp)** - ⭐ 407
   MCP server to manage Facebook and Instagram Ads (Meta Ads)

570. **[AgentX](https://github.com/lucky-aeon/AgentX)** - ⭐ 405
   AgentX 致力于让小白也能无门槛通过自然语言打造属于自己的 Agent。AgentX 采用了自研 MCP 网关，模型高可用组件打造高可用

571. **[shinkai-local-ai-agents](https://github.com/dcSpark/shinkai-local-ai-agents)** - ⭐ 405
...
572. **[ai-trader](https://github.com/whchien/ai-trader)** - ⭐ 404
   Backtrader-powered backtesting framework for algorithmic trading, featuring 20+ strategies, multi-market support, CLI tools, and an integrated MCP server for professional traders.

573. **[mcp-cli](https://github.com/wong2/mcp-cli)** - ⭐ 402
   A CLI inspector for the Model Context Protocol

574. **[talk-to-girlfriend-ai](https://github.com/arlanrakh/talk-to-girlfriend-ai)** - ⭐ 402
   im busy building ai agents so why not let an ai talk to my girlfriend? 

575. **[NetCoreKevin](https://github.com/junkai-li/NetCoreKevin)** - ⭐ 401
...
576. **[RestClient.Net](https://github.com/MelbourneDeveloper/RestClient.Net)** - ⭐ 401
   The safest way to make REST calls in C# with an MCP Generator

577. **[kmcp](https://github.com/kagent-dev/kmcp)** - ⭐ 401
   CLI tool and Kubernetes Controller for building, testing and deploying MCP servers

578. **[applescript-mcp](https://github.com/peakmojo/applescript-mcp)** - ⭐ 397
   MCP server that execute applescript giving you full control of your Mac

579. **[awesome-mcp-devtools](https://github.com/punkpeye/awesome-mcp-devtools)** - ⭐ 397
   A curated list of developer tools, SDKs, libraries, and testing utilities for Model Context Protocol (MCP) server development.

580. **[Software-planning-mcp](https://github.com/NightTrek/Software-planning-mcp)** - ⭐ 395
   An experiment in software planning using MCP

581. **[TuriX-CUA](https://github.com/TurixAI/TuriX-CUA)** - ⭐ 395
   This is the official website for TuriX Computer-use-Agent

582. **[Mantic.sh](https://github.com/marcoaapfortes/Mantic.sh)** - ⭐ 395
   A structural code search engine for Al agents.

583. **[MCP](https://github.com/jina-ai/MCP)** - ⭐ 393
   Official Jina AI Remote MCP Server

584. **[CoexistAI](https://github.com/SPThole/CoexistAI)** - ⭐ 393
   CoexistAI is a modular, developer-friendly research assistant framework . It enables you to build, search, summarize, and automate research workflows using LLMs, web search, Reddit, YouTube, and mapping tools—all with simple MCP tool calls or API calls or Python functions. 

585. **[azure-ai-travel-agents](https://github.com/Azure-Samples/azure-ai-travel-agents)** - ⭐ 393
...
586. **[GhidrAssistMCP](https://github.com/jtang613/GhidrAssistMCP)** - ⭐ 393
   An MCP extension for Ghidra

587. **[mcp-registry](https://github.com/docker/mcp-registry)** - ⭐ 393
   Official Docker MCP registry 

588. **[mcp-server-motherduck](https://github.com/motherduckdb/mcp-server-motherduck)** - ⭐ 389
   MCP server for DuckDB and MotherDuck

589. **[mcp-nixos](https://github.com/utensils/mcp-nixos)** - ⭐ 387
   MCP-NixOS - Model Context Protocol Server for NixOS resources

590. **[memento-mcp](https://github.com/gannonh/memento-mcp)** - ⭐ 386
   Memento MCP: A Knowledge Graph Memory System for LLMs

591. **[biomcp](https://github.com/genomoncology/biomcp)** - ⭐ 386
   BioMCP: Biomedical Model Context Protocol

592. **[ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server)** - ⭐ 384
   A Model Context Protocol (MCP) server for interacting with Microsoft 365 and Office services through the Graph API

593. **[chatluna](https://github.com/ChatLunaLab/chatluna)** - ⭐ 383
...
594. **[mcp-redis](https://github.com/redis/mcp-redis)** - ⭐ 383
   The official Redis MCP Server is a natural language interface designed for agentic applications to manage and search data in Redis efficiently

595. **[mcp-searxng](https://github.com/ihor-sokoliuk/mcp-searxng)** - ⭐ 383
   MCP Server for SearXNG

596. **[mcp-alchemy](https://github.com/runekaagaard/mcp-alchemy)** - ⭐ 382
   A MCP (model context protocol) server that gives the LLM access to and knowledge about relational databases like SQLite, Postgresql, MySQL & MariaDB, Oracle, and MS-SQL.

597. **[airtable-mcp-server](https://github.com/domdomegg/airtable-mcp-server)** - ⭐ 382
   🗂️🤖 Airtable Model Context Protocol Server, for allowing AI systems to interact with your Airtable bases

598. **[groq-desktop-beta](https://github.com/groq/groq-desktop-beta)** - ⭐ 381
   Local Groq Desktop chat app with MCP support

599. **[ai4j](https://github.com/LnYo-Cly/ai4j)** - ⭐ 381
...
600. **[lunar](https://github.com/TheLunarCompany/lunar)** - ⭐ 381
   lunar.dev: Agent native MCP Gateway for governance and security

601. **[sdk-typescript](https://github.com/strands-agents/sdk-typescript)** - ⭐ 380
   A model-driven approach to building AI agents in just a few lines of code. 

602. **[mcp](https://github.com/baidu-maps/mcp)** - ⭐ 379
   Baidu Map MCP Server

603. **[mcp-hfspace](https://github.com/evalstate/mcp-hfspace)** - ⭐ 378
   MCP Server to Use HuggingFace spaces, easy configuration and Claude Desktop mode. 

604. **[MCP-SecurityTools](https://github.com/Ta0ing/MCP-SecurityTools)** - ⭐ 377
   MCP-SecurityTools 是一个专注于收录和更新网络安全领域 MCP 的开源项目，旨在汇总、整理和优化各类与 MCP 相关的安全工具、技术及实战经验。

605. **[labs-ai-tools-for-devs](https://github.com/docker/labs-ai-tools-for-devs)** - ⭐ 375
   Your trusted home for discovering MCP tools – seamlessly integrated into Docker

606. **[station](https://github.com/cloudshipai/station)** - ⭐ 375
   Station is our open-source runtime that lets teams deploy agents on their own infrastructure with full control.

607. **[mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry)** - ⭐ 374
...
608. **[mcp-server-youtube-transcript](https://github.com/kimtaeyoon83/mcp-server-youtube-transcript)** - ⭐ 373
   This is an MCP server that allows you to directly download transcripts of YouTube videos.

609. **[FinanceMCP](https://github.com/guangxiangdebizi/FinanceMCP)** - ⭐ 373
...
610. **[notebooklm-mcp](https://github.com/PleasePrompto/notebooklm-mcp)** - ⭐ 373
   MCP server for NotebookLM - Let your AI agents (Claude Code, Codex) research documentation directly with grounded, citation-backed answers from Gemini. Persistent auth, library management, cross-client sharing. Zero hallucinations, just your knowledge base.

611. **[docfork-mcp](https://github.com/docfork/docfork-mcp)** - ⭐ 371
   Up-to-date Documentation for AI Agents.

612. **[Anemoi](https://github.com/Coral-Protocol/Anemoi)** - ⭐ 370
   Anemoi: A Semi-Centralized Multi-agent Systems Based on Agent-to-Agent Communication MCP server from Coral Protocol

613. **[bagel](https://github.com/Extelligence-ai/bagel)** - ⭐ 369
   Chat with your robotics, drone, and IoT data — ChatGPT for the physical world.

614. **[minion-agent](https://github.com/femto/minion-agent)** - ⭐ 369
   A simple agent framework that's capable of browser use + mcp + auto instrument + plan + deep  research + more

615. **[mcp-code-graph](https://github.com/JudiniLabs/mcp-code-graph)** - ⭐ 369
   MCP Server for code graph analysis and visualization by CodeGPT

616. **[mcp-server](https://github.com/e2b-dev/mcp-server)** - ⭐ 369
   Giving Claude ability to run code with E2B via MCP (Model Context Protocol)

617. **[graphlit-mcp-server](https://github.com/graphlit/graphlit-mcp-server)** - ⭐ 368
   Model Context Protocol (MCP) Server for Graphlit Platform

618. **[mcp-k8s-go](https://github.com/strowk/mcp-k8s-go)** - ⭐ 368
   MCP server connecting to Kubernetes

619. **[cocos-mcp-server](https://github.com/DaxianLee/cocos-mcp-server)** - ⭐ 367
...
620. **[agent-builder](https://github.com/strands-agents/agent-builder)** - ⭐ 367
   An example agent demonstrating streaming, tool use, and interactivity from your terminal. This agent builder can help you to build your own agents and tools.

621. **[mnemo](https://github.com/MnemoAI/mnemo)** - ⭐ 365
   A MCP-Ready Intelligence Engine for Data & Agent-as-a-Service.

622. **[mcpmark](https://github.com/eval-sys/mcpmark)** - ⭐ 363
   MCPMark is a comprehensive, stress-testing MCP benchmark designed to evaluate model and agent capabilities in real-world MCP use.

623. **[docling-mcp](https://github.com/docling-project/docling-mcp)** - ⭐ 362
   Making docling agentic through MCP

624. **[mcp-sdk-php](https://github.com/logiscape/mcp-sdk-php)** - ⭐ 361
   Model Context Protocol SDK for PHP

625. **[Redbook-Search-Comment-MCP2.0](https://github.com/chenningling/Redbook-Search-Comment-MCP2.0)** - ⭐ 361
...
626. **[yutu](https://github.com/eat-pray-ai/yutu)** - ⭐ 360
   A fully functional MCP server and CLI for YouTube

627. **[kicad-mcp](https://github.com/lamaalrajih/kicad-mcp)** - ⭐ 359
   Model Context Protocol server for KiCad on Mac, Windows, and Linux

628. **[mcp-mermaid](https://github.com/hustcc/mcp-mermaid)** - ⭐ 359
   ❤️ Generate mermaid diagram and chart with AI MCP dynamically.

629. **[MCPSharp](https://github.com/afrise/MCPSharp)** - ⭐ 358
   MCPSharp is a .NET library that helps you build Model Context Protocol (MCP) servers and clients - the standardized API protocol used by AI assistants and models.

630. **[mcp-server-airbnb](https://github.com/openbnb-org/mcp-server-airbnb)** - ⭐ 357
   Search Airbnb using your AI Agent

631. **[mcp](https://github.com/mondaycom/mcp)** - ⭐ 356
   Enable AI agents to work reliably - giving them secure access to structured data, tools to take action, and the context needed to make smart decisions.

632. **[mcp-google-ads](https://github.com/cohnen/mcp-google-ads)** - ⭐ 355
   An MCP tool that connects Google Ads with Claude AI/Cursor and others, allowing you to analyze your advertising data through natural language conversations. This integration gives you access to campaign information, performance metrics, keyword analytics, and ad management—all through simple chat with Claude, Cursor or Windsurf.

633. **[UnrealGenAISupport](https://github.com/prajwalshettydev/UnrealGenAISupport)** - ⭐ 354
...
634. **[mcp2mqtt](https://github.com/mcp2everything/mcp2mqtt)** - ⭐ 353
   本项目通过将 MCP 协议转换为 MQTT 协议，我们能够利用强大的大型语言模型（LLMs），就能轻松操控您的智能家居、机器人或其他硬件设备。

635. **[evm-mcp-server](https://github.com/mcpdotdirect/evm-mcp-server)** - ⭐ 352
   MCP server that provides LLMs with tools for interacting with EVM networks

636. **[lark-openapi-mcp](https://github.com/larksuite/lark-openapi-mcp)** - ⭐ 352
   飞书/Lark官方 OpenAPI MCP

637. **[tfmcp](https://github.com/nwiizo/tfmcp)** - ⭐ 351
   🌍 Terraform Model Context Protocol (MCP) Tool - An experimental CLI tool that enables AI assistants to manage and operate Terraform environments. Supports reading Terraform configurations, analyzing plans, applying configurations, and managing state with Claude Desktop integration. ⚡️

638. **[pokemon-chat](https://github.com/skygazer42/pokemon-chat)** - ⭐ 350
   基于 LightRAG、LangGraph、MCP、RagFlow、微调LLMs宝可梦主题的专有领域智能聊天助手

639. **[puppeteer-mcp-server](https://github.com/merajmehrabi/puppeteer-mcp-server)** - ⭐ 350
   This MCP server provides browser automation capabilities through Puppeteer, allowing interaction with both new browser instances and existing Chrome windows.

640. **[codexia](https://github.com/milisp/codexia)** - ⭐ 350
   A powerfull GUI and Toolkit for Codex CLI + Claude Code. FileTree + prompt notepad + git worktree and more

641. **[automation-mcp](https://github.com/ashwwwin/automation-mcp)** - ⭐ 349
   Control your Mac with detailed mouse, keyboard, screen, and window management capabilities.

642. **[claude-codepro](https://github.com/maxritter/claude-codepro)** - ⭐ 349
...
643. **[mcpr](https://github.com/conikeec/mcpr)** - ⭐ 348
   Model Context Protocol (MCP) implementation in Rust

644. **[mineru-tianshu](https://github.com/magicyuan876/mineru-tianshu)** - ⭐ 348
   天枢 - 企业级 AI 一站式数据预处理平台 | PDF/Office转Markdown | 支持MCP协议AI助手集成 | Vue3+FastAPI全栈方案 | 文档解析 | 多模态信息提取

645. **[todoist-mcp-server](https://github.com/abhiz123/todoist-mcp-server)** - ⭐ 347
   MCP server for Todoist integration enabling natural language task management with Claude

646. **[prism-insight](https://github.com/dragon1086/prism-insight)** - ⭐ 347
   AI-based stock analysis and trading system

647. **[ableton-live-mcp-server](https://github.com/Simon-Kansara/ableton-live-mcp-server)** - ⭐ 346
   MCP Server implementation for Ableton Live OSC control

648. **[edgeone-pages-mcp](https://github.com/TencentEdgeOne/edgeone-pages-mcp)** - ⭐ 346
   An MCP service designed for deploying HTML content to EdgeOne Pages and obtaining an accessible public URL.

649. **[mcp-graphql](https://github.com/blurrah/mcp-graphql)** - ⭐ 345
   Model Context Protocol server for GraphQL

650. **[mcp-teams-server](https://github.com/InditexTech/mcp-teams-server)** - ⭐ 343
   An MCP (Model Context Protocol) server implementation for Microsoft Teams integration, providing capabilities to read messages, create messages, reply to messages, mention members.

651. **[home-assistant-vibecode-agent](https://github.com/Coolver/home-assistant-vibecode-agent)** - ⭐ 343
...
652. **[applescript-mcp](https://github.com/joshrutkowski/applescript-mcp)** - ⭐ 343
   A macOS AppleScript MCP server

653. **[run-model-context-protocol-servers-with-aws-lambda](https://github.com/awslabs/run-model-context-protocol-servers-with-aws-lambda)** - ⭐ 342
   Run existing Model Context Protocol (MCP) stdio-based servers in AWS Lambda functions

654. **[sonarqube-mcp-server](https://github.com/SonarSource/sonarqube-mcp-server)** - ⭐ 342
   SonarQube MCP Server

655. **[agent](https://github.com/1mcp-app/agent)** - ⭐ 341
   A unified Model Context Protocol server implementation that aggregates multiple MCP servers into one.

656. **[daan](https://github.com/pluveto/daan)** - ⭐ 341
   ✨Lightweight LLM Client with MCP 🔌 & Characters 👤

657. **[Construction-Hazard-Detection](https://github.com/yihong1120/Construction-Hazard-Detection)** - ⭐ 341
   Enhances construction site safety using YOLO for object detection, identifying hazards like workers without helmets or safety vests, and proximity to machinery or vehicles. HDBSCAN clusters safety cone coordinates to create monitored zones. Post-processing algorithms improve detection accuracy.

658. **[xcode-mcp-server](https://github.com/r-huijts/xcode-mcp-server)** - ⭐ 341
   MCP Server implementation for Xcode integration

659. **[linear-mcp-server](https://github.com/jerhadf/linear-mcp-server)** - ⭐ 341
   A server that integrates Linear's project management system with the Model Context Protocol (MCP) to allow LLMs to interact with Linear.

660. **[twitter-mcp](https://github.com/EnesCinr/twitter-mcp)** - ⭐ 340
   A Model Context Protocol server allows to interact with Twitter, enabling posting tweets and searching Twitter.

661. **[f2c-mcp](https://github.com/f2c-ai/f2c-mcp)** - ⭐ 340
   F2C MCP Server

662. **[reddit-mcp-buddy](https://github.com/karanb192/reddit-mcp-buddy)** - ⭐ 339
   Clean, LLM-optimized Reddit MCP server. Browse posts, search content, analyze users. No fluff, just Reddit data.

663. **[awesome-cursor-mpc-server](https://github.com/kleneway/awesome-cursor-mpc-server)** - ⭐ 337
   Example of an MCP server with custom tools that can be called directly from cursor

664. **[a2a-directory](https://github.com/sing1ee/a2a-directory)** - ⭐ 337
   Agent2Agent (A2A) – AgentCards, Servers, Clients, Docs

665. **[devtools-debugger-mcp](https://github.com/ScriptedAlchemy/devtools-debugger-mcp)** - ⭐ 337
   An MCP server exposing full Chrome DevTools Protocol debugging: breakpoints, step/run, call stacks, eval, and source maps.

666. **[RetroMCP-Java](https://github.com/MCPHackers/RetroMCP-Java)** - ⭐ 336
   A rewrite of MCP to provide support for many versions of Minecraft which were never supported by original MCP

667. **[lanhu-mcp](https://github.com/dsphper/lanhu-mcp)** - ⭐ 336
   ⚡ 需求分析效率提升 200%！全球首个为 AI 编程时代设计的团队协作 MCP 服务器，自动分析需求自动编写前后端代码，下载切图

668. **[db-mcp-server](https://github.com/FreePeak/db-mcp-server)** - ⭐ 336
   A powerful multi-database server implementing the Model Context Protocol (MCP) to provide AI assistants with structured access to databases.

669. **[paws-on-mcp](https://github.com/hemanth/paws-on-mcp)** - ⭐ 334
   A comprehensive Model Context Protocol (MCP) server implementing the latest specification.

670. **[WebMCP](https://github.com/jasonjmcghee/WebMCP)** - ⭐ 333
...
671. **[base-mcp](https://github.com/base/base-mcp)** - ⭐ 333
   A Model Context Protocol (MCP) server that provides onchain tools for LLMs, allowing them to interact with the Base network and Coinbase API.

672. **[devopness](https://github.com/devopness/devopness)** - ⭐ 333
   DevOps Happiness: 1-click or 1-prompt MCP. Deploy apps + infra + CI/CD on your cloud. Happy humans + reliable agents. 🚀

673. **[Feishu-MCP](https://github.com/cso1z/Feishu-MCP)** - ⭐ 333
   为 Cursor、Windsurf、Cline 和其他 AI 驱动的编码工具提供访问、编辑和结构化处理飞书文档的能力，基于 Model Context Protocol 服务器实现。

674. **[prometheus-mcp-server](https://github.com/pab1it0/prometheus-mcp-server)** - ⭐ 332
   A Model Context Protocol (MCP) server that enables AI agents and LLMs to query and analyze Prometheus metrics through standardized interfaces.

675. **[interactive-mcp](https://github.com/ttommyth/interactive-mcp)** - ⭐ 331
   Vibe coding should have human in the loop! interactive-mcp: Local, cross-platform MCP server for interact with your AI Agent

676. **[hermes-mcp](https://github.com/cloudwalk/hermes-mcp)** - ⭐ 330
   Elixir Model Context Protocol (MCP) SDK

677. **[nuwax](https://github.com/nuwax-ai/nuwax)** - ⭐ 330
...
678. **[mcp-reddit](https://github.com/adhikasp/mcp-reddit)** - ⭐ 329
   A Model Context Protocol (MCP) server that provides tools for fetching and analyzing Reddit content.

679. **[mcp-apple-notes](https://github.com/RafalWilinski/mcp-apple-notes)** - ⭐ 328
   Talk with your notes in Claude. RAG over your Apple Notes using Model Context Protocol.

680. **[laravel-mcp-server](https://github.com/opgginc/laravel-mcp-server)** - ⭐ 326
   A Laravel package for implementing secure Model Context Protocol servers using Streamable HTTP and SSE transport, providing real-time communication and a scalable tool system for enterprise environments.

681. **[mcp-for-next.js](https://github.com/vercel-labs/mcp-for-next.js)** - ⭐ 326

682. **[MemoryMesh](https://github.com/CheMiguel23/MemoryMesh)** - ⭐ 326
...
683. **[droidmind](https://github.com/hyperb1iss/droidmind)** - ⭐ 326
   Control your Android devices with AI using Model Context Protocol

684. **[mcp-gateway](https://github.com/lasso-security/mcp-gateway)** - ⭐ 326
   A plugin-based gateway that orchestrates other MCPs and allows developers to build upon it enterprise-grade agents.

685. **[mcp-selenium](https://github.com/angiejones/mcp-selenium)** - ⭐ 325
   An MCP implementation for Selenium WebDriver

686. **[BloodHound-MCP-AI](https://github.com/MorDavid/BloodHound-MCP-AI)** - ⭐ 323
   BloodHound-MCP-AI is integration that connects BloodHound with AI through Model Context Protocol, allowing security professionals to analyze Active Directory attack paths using natural language instead of complex Cypher queries.

687. **[css-mcp](https://github.com/stolinski/css-mcp)** - ⭐ 323

688. **[open-mcp](https://github.com/wegotdocs/open-mcp)** - ⭐ 323

689. **[CodeGraphContext](https://github.com/Shashankss1205/CodeGraphContext)** - ⭐ 323
   An MCP server plus a CLI tool that indexes local code into a graph database to provide context to AI assistants.

690. **[Rube](https://github.com/ComposioHQ/Rube)** - ⭐ 322
...
691. **[revit-mcp](https://github.com/revit-mcp/revit-mcp)** - ⭐ 322
   AI-Powered Revit Modeling

692. **[moling](https://github.com/gojue/moling)** - ⭐ 321
   MoLing is a computer-use and browser-use based MCP server. It is a locally deployed, dependency-free office AI assistant.

693. **[obsidian-mcp-server](https://github.com/cyanheads/obsidian-mcp-server)** - ⭐ 321
   Obsidian Knowledge-Management MCP (Model Context Protocol) server that enables AI agents and development tools to interact with an Obsidian vault. It provides a comprehensive suite of tools for reading, writing, searching, and managing notes, tags, and frontmatter, acting as a bridge to the Obsidian Local REST API plugin.

694. **[mcsmcp](https://github.com/microsoft/mcsmcp)** - ⭐ 321
   Lab for creating an MCP Server and using it in Microsoft Copilot Studio.

695. **[Ace-Mcp-Node](https://github.com/yeuxuan/Ace-Mcp-Node)** - ⭐ 320
...
696. **[mcp-calculator](https://github.com/78/mcp-calculator)** - ⭐ 317
   Xiaozhi MCP sample program

697. **[Minecraft-Hack-BaseClient](https://github.com/OxideWaveLength/Minecraft-Hack-BaseClient)** - ⭐ 317
   This is a Minecraft Base Client

698. **[agentscope-runtime](https://github.com/agentscope-ai/agentscope-runtime)** - ⭐ 317
   A Production-Ready Runtime Framework for Agent Deployment and Tool Sandbox

699. **[claude-codex-settings](https://github.com/fcakyon/claude-codex-settings)** - ⭐ 317
   My personal Claude Code and OpenAI Codex setup with battle-tested skills, commands, hooks, agents and MCP servers that I use daily.

700. **[emcee](https://github.com/mattt/emcee)** - ⭐ 316
   MCP generator for OpenAPIs 🫳🎤💥

701. **[awesome-claude-code-plugins](https://github.com/ccplugins/awesome-claude-code-plugins)** - ⭐ 316
   Awesome Claude Code plugins — a curated list of slash commands, subagents, MCP servers, and hooks for Claude Code

702. **[mcp-server-azure-devops](https://github.com/Tiberriver256/mcp-server-azure-devops)** - ⭐ 315
   An MCP server for Azure DevOps

703. **[langconnect-client](https://github.com/teddynote-lab/langconnect-client)** - ⭐ 314
   A Modern GUI Interface for Vector Database Management(Supports MCP integration)

704. **[gemini-flow](https://github.com/clduab11/gemini-flow)** - ⭐ 314
   rUv's Claude-Flow, translated to the new Gemini CLI; transforming it into an autonomous AI development team.

705. **[autogenstudio-skills](https://github.com/madtank/autogenstudio-skills)** - ⭐ 313
   Repo of skills for autogen studio using model context protocol (mcp)

706. **[ClimateTraceKMP](https://github.com/joreilly/ClimateTraceKMP)** - ⭐ 313
   Kotlin/Compose Multiplatform project to show climate related emission data from https://climatetrace.org/data.

707. **[mcp](https://github.com/IBM/mcp)** - ⭐ 313
   A collection of Model Context Protocol (MCP) servers, clients and developer tools by IBM.

708. **[skillz](https://github.com/intellectronica/skillz)** - ⭐ 313
   An MCP server for loading skills (shim for non-claude clients).

709. **[mcp-obsidian](https://github.com/bitbonsai/mcp-obsidian)** - ⭐ 311
   A lightweight Model Context Protocol (MCP) server for safe Obsidian vault access

710. **[abcoder](https://github.com/cloudwego/abcoder)** - ⭐ 310
   deep, reliable and confidential coding-context

711. **[vscode-mcp-server](https://github.com/juehang/vscode-mcp-server)** - ⭐ 310
   MCP server to expose VS Code editing features to an LLM for AI coding

712. **[WireMCP](https://github.com/0xKoda/WireMCP)** - ⭐ 310
   An MCP for WireShark (tshark). Empower LLM's with realtime network traffic analysis capability

713. **[mcp-servers-hub](https://github.com/apappascs/mcp-servers-hub)** - ⭐ 309
   Discover the most comprehensive and up-to-date collection of MCP servers in the market. This repository serves as a centralized hub, offering an extensive catalog of open-source and proprietary MCP servers, complete with features, documentation links, and contributors.

714. **[agentcontrolplane](https://github.com/humanlayer/agentcontrolplane)** - ⭐ 305
...
715. **[mesh](https://github.com/decocms/mesh)** - ⭐ 304
   One secure endpoint for every MCP server. Deploy anywhere.

716. **[gptr-mcp](https://github.com/assafelovic/gptr-mcp)** - ⭐ 303
   MCP server for enabling LLM applications to perform deep research via the MCP protocol

717. **[mcp-sse](https://github.com/sidharthrajaram/mcp-sse)** - ⭐ 303
   A working pattern for SSE-based MCP clients and servers

718. **[code-sandbox-mcp](https://github.com/Automata-Labs-team/code-sandbox-mcp)** - ⭐ 302
   An MCP server to create secure code sandbox environment for executing code within Docker containers. This MCP server provides AI applications with a safe and isolated environment for running code while maintaining security through containerization.

719. **[openmcp](https://github.com/getdatanaut/openmcp)** - ⭐ 302
   Turn any openapi file into an mcp server, with just the tools you need.

720. **[automcp](https://github.com/NapthaAI/automcp)** - ⭐ 301
   Easily convert tool, agents and orchestrators from existing agent frameworks to MCP servers

721. **[mcprouter](https://github.com/chatmcp/mcprouter)** - ⭐ 301
   api router for MCP Servers

722. **[mcp-server](https://github.com/mapbox/mcp-server)** - ⭐ 301
   Mapbox Model Context Protocol (MCP) server

723. **[powerbi-modeling-mcp](https://github.com/microsoft/powerbi-modeling-mcp)** - ⭐ 300
   The Power BI Modeling MCP Server, brings Power BI semantic modeling capabilities to your AI agents.

724. **[mcp-aktools](https://github.com/aahl/mcp-aktools)** - ⭐ 299
   📈 提供股票、加密货币的数据查询和分析功能MCP服务器

725. **[investor-agent](https://github.com/ferdousbhai/investor-agent)** - ⭐ 298
   A Model Context Protocol server for building an investor agent

726. **[mcp-git-ingest](https://github.com/adhikasp/mcp-git-ingest)** - ⭐ 297
   A Model Context Protocol (MCP) server that helps read GitHub repository structure and important files.

727. **[mcp-for-argocd](https://github.com/argoproj-labs/mcp-for-argocd)** - ⭐ 297
   An implementation of Model Context Protocol (MCP) server for Argo CD.

728. **[mcp-claude-code](https://github.com/SDGLBL/mcp-claude-code)** - ⭐ 296
   MCP implementation of Claude Code capabilities and more

729. **[deep-research-mcp](https://github.com/Ozamatash/deep-research-mcp)** - ⭐ 296

730. **[ast-grep-mcp](https://github.com/ast-grep/ast-grep-mcp)** - ⭐ 296

731. **[tradingview-mcp](https://github.com/atilaahmettaner/tradingview-mcp)** - ⭐ 295
...
732. **[mcp-server-code-execution-mode](https://github.com/elusznik/mcp-server-code-execution-mode)** - ⭐ 293
   An MCP server that executes Python code in isolated rootless containers with optional MCP server proxying. Implementation of Anthropic's and Cloudflare's ideas for reducing MCP tool definitions context bloat.

733. **[DeepWideResearch](https://github.com/puppyone-ai/DeepWideResearch)** - ⭐ 292
   Agentic RAG for any scenario. Customize sources, depth, and width

734. **[ebook-mcp](https://github.com/onebirdrocks/ebook-mcp)** - ⭐ 292
...
735. **[maverick-mcp](https://github.com/wshobson/maverick-mcp)** - ⭐ 292
   MaverickMCP - Personal Stock Analysis MCP Server

736. **[llm-context.py](https://github.com/cyberchitta/llm-context.py)** - ⭐ 289
   Share code with LLMs via Model Context Protocol or clipboard. Rule-based customization enables easy switching between different tasks (like code review and documentation). Includes smart code outlining.

737. **[aws-mcp](https://github.com/RafalWilinski/aws-mcp)** - ⭐ 289
   Talk with your AWS using Claude. Model Context Protocol (MCP) server for AWS. Better Amazon Q alternative.

738. **[deepseek-mcp-server](https://github.com/DMontgomery40/deepseek-mcp-server)** - ⭐ 288
   Model Context Protocol server for DeepSeek's advanced language models

739. **[claude-talk-to-figma-mcp](https://github.com/arinspunk/claude-talk-to-figma-mcp)** - ⭐ 288
...
740. **[Android-MCP](https://github.com/CursorTouch/Android-MCP)** - ⭐ 288
   Lightweight MCP Server for interacting with Android Operating System.

741. **[open-skills](https://github.com/instavm/open-skills)** - ⭐ 287
   OpenSkills: Run Claude Skills Locally using any LLM

742. **[blender-mcp-vxai](https://github.com/VxASI/blender-mcp-vxai)** - ⭐ 286

743. **[mysql_mcp_server_pro](https://github.com/wenb1n-dev/mysql_mcp_server_pro)** - ⭐ 286
...
744. **[o3-search-mcp](https://github.com/yoshiko-pg/o3-search-mcp)** - ⭐ 285
   MCP server for OpenAI o3 web search

745. **[mssql_mcp_server](https://github.com/RichardHan/mssql_mcp_server)** - ⭐ 285
...
746. **[aider-mcp-server](https://github.com/disler/aider-mcp-server)** - ⭐ 284
   Minimal MCP Server for Aider

747. **[mcp-everything-search](https://github.com/mamertofabian/mcp-everything-search)** - ⭐ 284

748. **[generator](https://github.com/context-hub/generator)** - ⭐ 284
   CTX: a tool that solves the context management gap when working with LLMs like ChatGPT or Claude. It helps developers organize and automatically collect information from their codebase into structured documents that can be easily shared with AI assistants.

749. **[meGPT](https://github.com/adrianco/meGPT)** - ⭐ 283
   Code to process many kinds of content by an author into an MCP server

750. **[hydra-mcp-solana](https://github.com/hydra-mcp/hydra-mcp-solana)** - ⭐ 283
   hydra-ai

751. **[lets-learn-mcp-csharp](https://github.com/microsoft/lets-learn-mcp-csharp)** - ⭐ 283

752. **[mcp-server-simulator-ios-idb](https://github.com/InditexTech/mcp-server-simulator-ios-idb)** - ⭐ 283
   A Model Context Protocol (MCP) server that enables LLMs to interact with iOS simulators through natural language commands.

753. **[mcpsvr](https://github.com/nanbingxyz/mcpsvr)** - ⭐ 283
   Discover Exceptional MCP Servers

754. **[DeepWideResearch](https://github.com/PuppyAgent/DeepWideResearch)** - ⭐ 281
   Agentic RAG for any scenario. Customize sources, depth, and width

755. **[utcp-specification](https://github.com/universal-tool-calling-protocol/utcp-specification)** - ⭐ 281
   The specification for the Universal Tool Calling Protocol

756. **[mcp-server-mas-sequential-thinking](https://github.com/FradSer/mcp-server-mas-sequential-thinking)** - ⭐ 281
   An advanced sequential thinking process using a Multi-Agent System (MAS) built with the Agno framework and served via MCP.

757. **[tinystruct](https://github.com/tinystruct/tinystruct)** - ⭐ 281
...
758. **[mcp-database-server](https://github.com/executeautomation/mcp-database-server)** - ⭐ 281
   MCP Database Server is a new MCP Server which helps connect with Sqlite, SqlServer and Posgresql Databases

759. **[remote-mcp-server-with-auth](https://github.com/coleam00/remote-mcp-server-with-auth)** - ⭐ 280
...
760. **[consult7](https://github.com/szeider/consult7)** - ⭐ 279
   MCP server to consult a language model with large context size

761. **[perplexity-mcp](https://github.com/DaInfernalCoder/perplexity-mcp)** - ⭐ 279
...
762. **[minthcm](https://github.com/minthcm/minthcm)** - ⭐ 279
   First AI‑enabled open-source Human Capital Management system that you can start using today.

763. **[mcp-manager](https://github.com/zueai/mcp-manager)** - ⭐ 278
   simple web ui to manage mcp (model context protocol) servers in the claude app

764. **[mcp-neovim-server](https://github.com/bigcodegen/mcp-neovim-server)** - ⭐ 277
   Control Neovim using Model Context Protocol (MCP) and the official neovim/node-client JavaScript library

765. **[MaaMCP](https://github.com/MAA-AI/MaaMCP)** - ⭐ 277
   基于 MaaFramework 的 MCP 服务器 为 AI 助手提供 Android 设备和 Windows 桌面自动化能力

766. **[dify-mcp-server](https://github.com/YanxingLiu/dify-mcp-server)** - ⭐ 276
   Model Context Protocol (MCP) Server for dify workflows

767. **[MCP-handle](https://github.com/WeatherPal-AI/MCP-handle)** - ⭐ 276
   MCP integration platforms making AI-Agents developers focusing on their own tasks

768. **[mcp-linker](https://github.com/milisp/mcp-linker)** - ⭐ 276
...
769. **[perplexity-mcp](https://github.com/jsonallen/perplexity-mcp)** - ⭐ 275
   A Model Context Protocol (MCP) server that provides web search functionality using Perplexity AI's API.

770. **[laravel-claude-code-setup](https://github.com/laraben/laravel-claude-code-setup)** - ⭐ 274
   One-command setup for AI-powered Laravel development with Claude Code and MCP servers

771. **[MCP-Server-Playwright](https://github.com/VikashLoomba/MCP-Server-Playwright)** - ⭐ 274
   MCP server for browser automation using Playwright

772. **[FileScopeMCP](https://github.com/admica/FileScopeMCP)** - ⭐ 274
   Analyzes your codebase identifying important files based on dependency relationships. Generates diagrams and importance scores per file, helping AI assistants understand the codebase. Automatically parses popular programming languages such as Python, C, C++, Rust, Zig, Lua.

773. **[chrome-devtools-mcp](https://github.com/benjaminr/chrome-devtools-mcp)** - ⭐ 274
   An MCP Server for Chrome DevTools, following the Chrome DevTools Protocol. Integrates with Claude Desktop and Claude Code.

774. **[AI-Kline](https://github.com/QuantML-C/AI-Kline)** - ⭐ 274
...
775. **[rhinomcp](https://github.com/jingcheng-chen/rhinomcp)** - ⭐ 274
   RhinoMCP connects Rhino 3D to AI Agent through the Model Context Protocol (MCP)

776. **[one-mcp](https://github.com/burugo/one-mcp)** - ⭐ 274
...
777. **[ddddocr](https://github.com/86maid/ddddocr)** - ⭐ 273
...
778. **[stealth-browser-mcp](https://github.com/vibheksoni/stealth-browser-mcp)** - ⭐ 273
   The only browser automation that bypasses anti-bot systems. AI writes network hooks, clones UIs pixel-perfect via simple chat.

779. **[apktool-mcp-server](https://github.com/zinja-coder/apktool-mcp-server)** - ⭐ 273
   A MCP Server for APK Tool (Part of Android Reverse Engineering MCP Suites)

780. **[mcp-reasoner](https://github.com/Jacck/mcp-reasoner)** - ⭐ 272
   A systematic reasoning MCP server implementation for Claude Desktop with beam search and thought evaluation.

781. **[mcp-mongo-server](https://github.com/kiliczsh/mcp-mongo-server)** - ⭐ 272
   A Model Context Protocol Server for MongoDB

782. **[mcp-youtube-transcript](https://github.com/jkawamoto/mcp-youtube-transcript)** - ⭐ 271
   MCP server retrieving transcripts of YouTube videos

783. **[jinni](https://github.com/smat-dev/jinni)** - ⭐ 270
   Bring your project into LLM context - tool and MCP server

784. **[proximity](https://github.com/fr0gger/proximity)** - ⭐ 269
   Proximity is a MCP security scanner powered with NOVA

785. **[claude-modular](https://github.com/oxygen-fragment/claude-modular)** - ⭐ 269
   Production-ready modular Claude Code framework with 30+ commands, token optimization, and MCP server integration. Achieves 2-10x productivity gains through   systematic command organization and hierarchical configuration.

786. **[metorial-index](https://github.com/metorial/metorial-index)** - ⭐ 269
   Metorial MCP Index - An ever growing list of open source MCP servers 📁 🎉

787. **[mq](https://github.com/harehare/mq)** - ⭐ 269
   jq-like command-line tool for markdown processing

788. **[MCPControl](https://github.com/claude-did-this/MCPControl)** - ⭐ 267
   MCP server for Windows OS automation

789. **[imagesorcery-mcp](https://github.com/sunriseapps/imagesorcery-mcp)** - ⭐ 266
   An MCP server providing tools for image processing operations

790. **[obsidian-mcp](https://github.com/newtype-01/obsidian-mcp)** - ⭐ 266
   Obsidian MCP (Model Context Protocol) Server

791. **[mcp940](https://github.com/WangTingZheng/mcp940)** - ⭐ 265
   Source code of minecraft 1.12

792. **[ultra-mcp](https://github.com/RealMikeChong/ultra-mcp)** - ⭐ 264
   100x Your Claude Code, Gemini CLI, Cursor and/or any coding tools with MCP client support

793. **[AetherLink](https://github.com/1600822305/AetherLink)** - ⭐ 264
...
794. **[x64DbgMCPServer](https://github.com/AgentSmithers/x64DbgMCPServer)** - ⭐ 264
   x64DbgMCPServer made from c# with Claude, Windsurf and Cursor support

795. **[mcp-server-apple-shortcuts](https://github.com/recursechat/mcp-server-apple-shortcuts)** - ⭐ 264

796. **[model-context-protocol-resources](https://github.com/cyanheads/model-context-protocol-resources)** - ⭐ 263
   Exploring the Model Context Protocol (MCP) through practical guides, clients, and servers I've built while learning about this new protocol.

797. **[mcp-documentation-server](https://github.com/andrea9293/mcp-documentation-server)** - ⭐ 262
...
798. **[jadx-mcp-server](https://github.com/zinja-coder/jadx-mcp-server)** - ⭐ 261
   MCP server for JADX-AI Plugin

799. **[telegram-mcp](https://github.com/chaindead/telegram-mcp)** - ⭐ 260
   Telegram MCP for managing dialogs, messages, drafts, read statuses, and more.

800. **[mcp-omnisearch](https://github.com/spences10/mcp-omnisearch)** - ⭐ 259
   🔍 A Model Context Protocol (MCP) server providing unified access to multiple search engines (Tavily, Brave, Kagi), AI tools (Perplexity, FastGPT), and content processing services (Jina AI, Kagi). Combines search, AI responses, content processing, and enhancement features through a single interface.

801. **[osp_marketing_tools](https://github.com/open-strategy-partners/osp_marketing_tools)** - ⭐ 259
   A Model Context Protocol (MCP) server that empowers LLMs to use some of Open Srategy Partners' core writing and product marketing techniques.

802. **[mcp](https://github.com/oracle/mcp)** - ⭐ 259
...
803. **[kagimcp](https://github.com/kagisearch/kagimcp)** - ⭐ 259
   The Official Model Context Protocol (MCP) server for Kagi search & other tools.

804. **[mcp-server-12306](https://github.com/drfccv/mcp-server-12306)** - ⭐ 258
   12306 MCP Server​​ 是一个基于 ​​Model Context Protocol (MCP)​​ 的高性能火车票查询后端系统。它通过标准化接口提供官方 12306 的实时数据服务，包括余票查询、车站信息、列车经停站、中转换乘方案等核心功能。

805. **[claude-code-statusline](https://github.com/rz1989s/claude-code-statusline)** - ⭐ 258
...
806. **[hass-mcp](https://github.com/voska/hass-mcp)** - ⭐ 256
   Home Assistant MCP Server

807. **[safe-mcp](https://github.com/SAFE-MCP/safe-mcp)** - ⭐ 256
   SAFE-MCP is a comprehensive security framework for documenting and mitigating threats in the AI Agent ecosystem.

808. **[mcp-odoo](https://github.com/tuanle96/mcp-odoo)** - ⭐ 254
   MCP Server for Odoo

809. **[admin](https://github.com/decocms/admin)** - ⭐ 253
   Define and compose secure MCPs in TypeScript. Generate AI workflows and agents with React + Tailwind UI. Deploy anywhere.

810. **[deepcontext-mcp](https://github.com/Wildcard-Official/deepcontext-mcp)** - ⭐ 253
   DeepContext is an MCP server that adds symbol-aware semantic search to Claude Code, Codex CLI, and other agents for faster, smarter context on large codebases.

811. **[project-nova](https://github.com/dujonwalker/project-nova)** - ⭐ 253
...
812. **[unreal-engine-mcp](https://github.com/flopperam/unreal-engine-mcp)** - ⭐ 253
...
813. **[app-store-connect-mcp-server](https://github.com/JoshuaRileyDev/app-store-connect-mcp-server)** - ⭐ 253

814. **[reddit-mcp](https://github.com/Arindam200/reddit-mcp)** - ⭐ 251
   Model Context Protocol server implementation for Reddit

815. **[iam-policy-autopilot](https://github.com/awslabs/iam-policy-autopilot)** - ⭐ 251
   IAM Policy Autopilot is an open source static code analysis tool that helps you quickly create baseline AWS IAM policies that you can refine as your application evolves. This tool is available as a command-line utility and MCP server for use within AI coding assistants for quickly building IAM policies.

816. **[django-mcp-server](https://github.com/gts360/django-mcp-server)** - ⭐ 251
   Django MCP Server is a Django extensions to easily enable AI Agents to interact with Django Apps through the Model Context Protocol it works equally well on WSGI and ASGI

817. **[claude-skills-mcp](https://github.com/K-Dense-AI/claude-skills-mcp)** - ⭐ 251
   MCP server for searching and retrieving Claude Agent Skills using vector search

818. **[solon-ai](https://github.com/opensolon/solon-ai)** - ⭐ 250
...
819. **[aci-mcp](https://github.com/aipotheosis-labs/aci-mcp)** - ⭐ 250
   MCP server(s) for Aipolabs ACI.dev

820. **[mcp-server](https://github.com/strands-agents/mcp-server)** - ⭐ 249
   This MCP server provides documentation about Strands Agents to your GenAI tools, so you can use your favorite AI coding assistant to vibe-code Strands Agents.

821. **[mcp-gdrive](https://github.com/isaacphi/mcp-gdrive)** - ⭐ 249
   Model Context Protocol (MCP) Server for reading from Google Drive and editing Google Sheets

822. **[geminimcp](https://github.com/GuDaStudio/geminimcp)** - ⭐ 249
...
823. **[api200](https://github.com/API-200/api200)** - ⭐ 248
   API 200 is an open source API gateway to simplify 3rd-party integrations. Import endpoints, set up caching, retries, and mocks. Access all services via one URL. Monitor logs, track errors, and get alerts on API incidents.

824. **[apollo-mcp-server](https://github.com/apollographql/apollo-mcp-server)** - ⭐ 248
   Apollo MCP Server

825. **[code-reasoning](https://github.com/mettamatt/code-reasoning)** - ⭐ 248
   A code reasoning MCP server, a fork of sequential-thinking

826. **[anytype-mcp](https://github.com/anyproto/anytype-mcp)** - ⭐ 248
   An MCP server enabling AI assistants to interact with Anytype - your encrypted, local and collaborative wiki - to organize objects, lists, and more through natural language.

827. **[suppr-mcp](https://github.com/WildDataX/suppr-mcp)** - ⭐ 246
    超能文献|AI驱动的文档翻译与学术搜索服务。支持PDF、DOCX、PPTX等多格式文档的高质量翻译（支持11种语言），特别优化了数学公式翻译。同时提供PubMed学术文献智能搜索功能。更多访问：https://suppr.wilddata.cn

828. **[mcp-server-gemini](https://github.com/aliargun/mcp-server-gemini)** - ⭐ 243
   MCP server implementation for Google's Gemini API

829. **[MARM-Systems](https://github.com/Lyellr88/MARM-Systems)** - ⭐ 243
...
830. **[doris-mcp-server](https://github.com/apache/doris-mcp-server)** - ⭐ 243
   Apache Doris MCP Server

831. **[g-search-mcp](https://github.com/jae-jae/g-search-mcp)** - ⭐ 242
   A powerful MCP server for Google search that enables parallel searching with multiple keywords simultaneously.

832. **[mcp-chatbot](https://github.com/3choff/mcp-chatbot)** - ⭐ 242
   A simple CLI chatbot that demonstrates the integration of the Model Context Protocol (MCP).

833. **[mcp](https://github.com/salesforcecli/mcp)** - ⭐ 242
   MCP Server for interacting with Salesforce instances

834. **[Context-Engine](https://github.com/m1rl0k/Context-Engine)** - ⭐ 242
...
835. **[mcp-feedback-collector](https://github.com/sanshao85/mcp-feedback-collector)** - ⭐ 241
   一个现代化的 Model Context Protocol (MCP) 服务器，为AI助手提供交互式用户反馈收集功能。

836. **[chat-mcp](https://github.com/AI-QL/chat-mcp)** - ⭐ 241
   A Desktop Chat App that leverages MCP(Model Context Protocol) to interface with other LLMs.

837. **[mcp-prompt-server](https://github.com/gdli6177/mcp-prompt-server)** - ⭐ 241
   这是一个基于Model Context Protocol (MCP)的服务器，用于根据用户任务需求提供预设的prompt模板，帮助Cline/Cursor/Windsurf...更高效地执行各种任务。服务器将预设的prompt作为工具(tools)返回，以便在Cursor和Windsurf等编辑器中更好地使用。

838. **[enterprise-mcp-course](https://github.com/decodingai-magazine/enterprise-mcp-course)** - ⭐ 241
...
843. **[PIXRA](https://github.com/dodufish/PIXRA)** - ⭐ 239
   Pixelize the real world on-chain

844. **[mcp_massive](https://github.com/massive-com/mcp_massive)** - ⭐ 239
   An MCP server for Massive.com Financial Market Data

845. **[rust-docs-mcp-server](https://github.com/Govcraft/rust-docs-mcp-server)** - ⭐ 238
   🦀 Prevents outdated Rust code suggestions from AI assistants. This MCP server fetches current crate docs, uses embeddings/LLMs, and provides accurate context via a tool call.

846. **[human-mcp](https://github.com/mrgoonie/human-mcp)** - ⭐ 238

847. **[video-editing-mcp](https://github.com/burningion/video-editing-mcp)** - ⭐ 237
   MCP Interface for Video Jungle

848. **[claude_code-gemini-mcp](https://github.com/RaiAnsar/claude_code-gemini-mcp)** - ⭐ 237
   Simplified Gemini for Claude Code. 

849. **[mcp-server-tree-sitter](https://github.com/wrale/mcp-server-tree-sitter)** - ⭐ 237
   MCP Server for Tree-sitter

850. **[bazi-mcp](https://github.com/cantian-ai/bazi-mcp)** - ⭐ 236
   MCP server for Bazi (八字) information

851. **[claude-code-mcpinstall](https://github.com/undeadpickle/claude-code-mcpinstall)** - ⭐ 235
   Easy guide to installing Claude Code MCPs globally on your machine.

852. **[NFTIAI](https://github.com/Axarb/NFTIAI)** - ⭐ 235
...
853. **[elasticsearch-mcp-server](https://github.com/cr7258/elasticsearch-mcp-server)** - ⭐ 235
   A Model Context Protocol (MCP) server implementation that provides Elasticsearch and OpenSearch interaction.

854. **[AEnvironment](https://github.com/inclusionAI/AEnvironment)** - ⭐ 235
   Standardized environment infrastructure for Agentic AI development.

855. **[mcp2py](https://github.com/MaximeRivest/mcp2py)** - ⭐ 234
   Turn any MCP server into a Python module

856. **[MCPBench](https://github.com/modelscope/MCPBench)** - ⭐ 234
   The evaluation benchmark on MCP servers

857. **[mcp-on-vercel](https://github.com/vercel-labs/mcp-on-vercel)** - ⭐ 234

858. **[xiaozhi-client](https://github.com/shenjingnan/xiaozhi-client)** - ⭐ 234
   小智AI客户端，目前主要用于MCP的对接

859. **[weather-mcp-server](https://github.com/ezh0v/weather-mcp-server)** - ⭐ 234
   A lightweight Model Context Protocol (MCP) server that enables AI assistants like Claude to retrieve and interpret real-time weather data. Discuss on Hacker News:

860. **[firebase-mcp](https://github.com/gannonh/firebase-mcp)** - ⭐ 233
   🔥 Model Context Protocol (MCP) server for Firebase.

861. **[mcp-server-code-runner](https://github.com/formulahendry/mcp-server-code-runner)** - ⭐ 233
   Code Runner MCP Server

862. **[Lambda-MCP-Server](https://github.com/mikegc-aws/Lambda-MCP-Server)** - ⭐ 233
   Creates a simple MCP tool server with "streaming" HTTP.

863. **[mcp-foundry](https://github.com/microsoft-foundry/mcp-foundry)** - ⭐ 230
   A MCP Server for Azure AI Foundry: it's now moved to cloud, check the new Foundry MCP Server

864. **[mcp_flutter](https://github.com/Arenukvern/mcp_flutter)** - ⭐ 230
   MCP server and MCP Toolkit  for Flutter and Dart VM - supports dynamic tooling

865. **[dat](https://github.com/hexinfo/dat)** - ⭐ 229
   Asking yours data in a natural language way through pre-modeling (data models and semantic models).

866. **[MCP-connect](https://github.com/EvalsOne/MCP-connect)** - ⭐ 229
   Enables cloud-based AI services to access local Stdio based MCP servers via HTTP requests

867. **[spring-ai-summary](https://github.com/java-ai-tech/spring-ai-summary)** - ⭐ 229
   SpringAI，LLM，MCP，Embedding

868. **[browser-control-mcp](https://github.com/eyalzh/browser-control-mcp)** - ⭐ 228
   MCP server paired with a browser extension that enables AI agents to control the user's browser.

869. **[xiyan_mcp_server](https://github.com/XGenerationLab/xiyan_mcp_server)** - ⭐ 228
   A Model Context Protocol (MCP) server that enables natural language queries to databases

870. **[mcp-foundry](https://github.com/azure-ai-foundry/mcp-foundry)** - ⭐ 227
   A MCP Server for Azure AI Foundry: it's now moved to cloud, check the new Foundry MCP Server

871. **[foundry-mcp-server](https://github.com/PraneshASP/foundry-mcp-server)** - ⭐ 227
   An experimental MCP Server for foundry built for Solidity devs

872. **[mcp-telegram](https://github.com/dryeab/mcp-telegram)** - ⭐ 227
   MCP Server for Telegram

873. **[mcp_chatbot](https://github.com/keli-wen/mcp_chatbot)** - ⭐ 227
   A chatbot implementation compatible with MCP (terminal / streamlit supported)

874. **[cobolt](https://github.com/platinum-hill/cobolt)** - ⭐ 226
...
875. **[sample-serverless-mcp-servers](https://github.com/aws-samples/sample-serverless-mcp-servers)** - ⭐ 226
   Sample implementations of AI Agents and MCP Servers running on AWS Serverless compute

876. **[ai-agent-team](https://github.com/peterfei/ai-agent-team)** - ⭐ 226
   AI Agent Team-拥有24/7专业AI开发团队：产品经理、前端开发、后端开发、测试工程师、DevOps工程师、技术负责人。一键安装，支持中英文命令，大幅提升开发效率！

877. **[awesome-mcp-servers](https://github.com/PipedreamHQ/awesome-mcp-servers)** - ⭐ 226
   A collection of MCP servers

878. **[ha-mcp](https://github.com/homeassistant-ai/ha-mcp)** - ⭐ 226
   The Unofficial and Awesome Home Assistant MCP Server

879. **[private-journal-mcp](https://github.com/obra/private-journal-mcp)** - ⭐ 224
   A lightweight MCP server that provides Claude with a private journaling capability to process feelings and thoughts

880. **[1c_mcp](https://github.com/vladimir-kharin/1c_mcp)** - ⭐ 224
...
881. **[mcp-ical](https://github.com/Omar-V2/mcp-ical)** - ⭐ 224
   A Model Context Protocol Server that allows you to interact with your MacOS Calendar through natural language.

882. **[notebooklm-mcp](https://github.com/jacob-bd/notebooklm-mcp)** - ⭐ 224

883. **[studio-rust-mcp-server](https://github.com/Roblox/studio-rust-mcp-server)** - ⭐ 223
   Standalone Roblox Studio MCP Server

884. **[lyraios](https://github.com/GalaxyLLMCI/lyraios)** - ⭐ 223
...
885. **[octocode](https://github.com/Muvon/octocode)** - ⭐ 222
   Semantic code searcher and codebase utility with AI memory onboard

886. **[langgraph-whatsapp-agent](https://github.com/lgesuellip/langgraph-whatsapp-agent)** - ⭐ 220
...
887. **[agent-mcp-lab](https://github.com/WaveSpeedAI/agent-mcp-lab)** - ⭐ 220

888. **[mcp-proxy-for-aws](https://github.com/aws/mcp-proxy-for-aws)** - ⭐ 220
   AWS MCP Proxy Server

889. **[mcp-server-commands](https://github.com/g0t4/mcp-server-commands)** - ⭐ 220
   Model Context Protocol server to run commands

890. **[home-assistant-cursor-agent](https://github.com/Coolver/home-assistant-cursor-agent)** - ⭐ 219
...
891. **[mcp-server](https://github.com/volcengine/mcp-server)** - ⭐ 219
   Volcengine MCP Servers

892. **[mcp-proxy](https://github.com/punkpeye/mcp-proxy)** - ⭐ 219
   A TypeScript SSE proxy for MCP servers that use stdio transport.

893. **[llamacloud-mcp](https://github.com/run-llama/llamacloud-mcp)** - ⭐ 218

894. **[mcp-twikit](https://github.com/adhikasp/mcp-twikit)** - ⭐ 218
   A Model Context Protocol (MCP) server for interacting with Twitter.

895. **[image-gen-server](https://github.com/fengin/image-gen-server)** - ⭐ 217
   一个能与Cursor集成的图片生成mcp server工具，实现调用即梦逆向接口

896. **[mcp-maigret](https://github.com/BurtTheCoder/mcp-maigret)** - ⭐ 217
   MCP server for maigret, a powerful OSINT tool that collects user account information from various public sources. 

897. **[remote-swe-agents](https://github.com/aws-samples/remote-swe-agents)** - ⭐ 217
   Autonomous SWE agent working in the cloud! (a.k.a. Vibe coding with Bedrock)

898. **[openapi-to-mcpserver](https://github.com/higress-group/openapi-to-mcpserver)** - ⭐ 217
   A tool&lib that can automatically convert OpenAPI documents into Higress remote MCP server configurations.

899. **[mcp-compass](https://github.com/liuyoshio/mcp-compass)** - ⭐ 216
   MCP Discovery & Recommendation Service - Find the right MCP server for your needs

900. **[Alice](https://github.com/pmbstyle/Alice)** - ⭐ 216
...
901. **[KiCAD-MCP-Server](https://github.com/mixelpixx/KiCAD-MCP-Server)** - ⭐ 216
   KiCAD MCP is a Model Context Protocol (MCP) implementation that enables Large Language Models (LLMs) like Claude to directly interact with KiCAD for printed circuit board design.

902. **[lean-lsp-mcp](https://github.com/oOo0oOo/lean-lsp-mcp)** - ⭐ 216
   Lean Theorem Prover MCP

903. **[strava-mcp](https://github.com/r-huijts/strava-mcp)** - ⭐ 215
   A Model Context Protocol (MCP) server that connects to Strava API, providing tools to access Strava data through LLMs

904. **[tentix](https://github.com/labring/tentix)** - ⭐ 214
...
905. **[mac_messages_mcp](https://github.com/carterlasalle/mac_messages_mcp)** - ⭐ 214
   An MCP server that securely interfaces with your iMessage database via the Model Context Protocol (MCP), allowing LLMs to query and analyze iMessage conversations. It includes robust phone number validation, attachment processing, contact management, group chat handling, and full support for sending and receiving messages.

906. **[effect-mcp](https://github.com/tim-smart/effect-mcp)** - ⭐ 214

907. **[CAD-MCP](https://github.com/daobataotie/CAD-MCP)** - ⭐ 213
   CAD MCP Server

908. **[human-in-the-loop](https://github.com/KOBA789/human-in-the-loop)** - ⭐ 213
   An MCP (Model Context Protocol) server that allows AI assistants to ask questions to humans via Discord.

909. **[lihil](https://github.com/raceychan/lihil)** - ⭐ 213
   2X faster ASGI web framework for python, offering high-level development, low-level performance.

910. **[mcp_code_executor](https://github.com/bazinga012/mcp_code_executor)** - ⭐ 213
   The MCP Code Executor is an MCP server that allows LLMs to execute Python code within a specified Conda environment.

911. **[Mimir](https://github.com/orneryd/Mimir)** - ⭐ 213
...
912. **[learn-agentic-ai-from-low-code-to-code](https://github.com/panaversity/learn-agentic-ai-from-low-code-to-code)** - ⭐ 213
   Build production-grade agents with OpenAI AgentKit, a no-code platfrom.

913. **[playwright-mcp](https://github.com/cloudflare/playwright-mcp)** - ⭐ 213
   Playwright MCP fork that works with Cloudflare Browser Rendering

914. **[omnicoreagent](https://github.com/omnirexflora-labs/omnicoreagent)** - ⭐ 213
...
915. **[vibevideo-mcp](https://github.com/hyepartners-gmail/vibevideo-mcp)** - ⭐ 212
   Agent MCP for ffmpeg

916. **[outlook-mcp](https://github.com/ryaker/outlook-mcp)** - ⭐ 212
   MCP server for Claude to access Outlook data via Microsoft Graph API

917. **[Autono](https://github.com/vortezwohl/Autono)** - ⭐ 211
   A ReAct-Based Highly Robust Autonomous Agent Framework.

918. **[razorpay-mcp-server](https://github.com/razorpay/razorpay-mcp-server)** - ⭐ 211
   Razorpay's Official MCP Server

919. **[uber-eats-mcp-server](https://github.com/ericzakariasson/uber-eats-mcp-server)** - ⭐ 211

920. **[mcp-openapi-server](https://github.com/ivo-toby/mcp-openapi-server)** - ⭐ 211
   MCP Server (Model Context Protocol) for turning OpenAPI specifications into a MCP Resource

921. **[plate-playground-template](https://github.com/udecode/plate-playground-template)** - ⭐ 211
   Plate AI template with React 19, Next 16, Tailwind 4, MCP.

922. **[mermaid-mcp-server](https://github.com/peng-shawn/mermaid-mcp-server)** - ⭐ 211
   A Model Context Protocol (MCP) server that converts Mermaid diagrams to PNG images

923. **[gibber-mcp](https://github.com/antonpk1/gibber-mcp)** - ⭐ 210
   Tiny MCP server with cryptography tools, sufficient to establish end-to-end encryption between LLM agents

924. **[figma-mcp](https://github.com/MatthewDailey/figma-mcp)** - ⭐ 210
   ModelContextProtocol for Figma's REST API

925. **[lokka](https://github.com/merill/lokka)** - ⭐ 210
   MCP (Model Context Protocol) for Microsoft 365. Includes support for Microsoft Graph and other services

926. **[cpp-mcp](https://github.com/hkr04/cpp-mcp)** - ⭐ 210
   Lightweight C++ MCP (Model Context Protocol) SDK

927. **[spotify-mcp-server](https://github.com/marcelmarais/spotify-mcp-server)** - ⭐ 210
   Lightweight MCP server for Spotify

928. **[MiroRL](https://github.com/MiroMindAI/MiroRL)** - ⭐ 210
   MiroRL is  an MCP-first reinforcement learning framework for deep research agent.

929. **[Agentfy](https://github.com/Agentfy-io/Agentfy)** - ⭐ 210
...
930. **[mcp-server-milvus](https://github.com/zilliztech/mcp-server-milvus)** - ⭐ 209
   Model Context Protocol Servers for Milvus

931. **[composer-trade-mcp](https://github.com/invest-composer/composer-trade-mcp)** - ⭐ 209
   Composer's MCP server lets MCP-enabled LLMs like Claude backtest trading ideas and automatically invest in them for you

932. **[mcp-taskmanager](https://github.com/kazuph/mcp-taskmanager)** - ⭐ 208

933. **[penpot-mcp](https://github.com/montevive/penpot-mcp)** - ⭐ 208
   Penpot MCP server

934. **[multimodal-mcp-client](https://github.com/Ejb503/multimodal-mcp-client)** - ⭐ 208
   A Multi-modal MCP client for voice powered agentic workflows

935. **[things-mcp](https://github.com/hald/things-mcp)** - ⭐ 208
   Things.app MCP Server

936. **[mindmap-mcp-server](https://github.com/YuChenSSR/mindmap-mcp-server)** - ⭐ 207
   mindmap, mcp server, artifact

937. **[ruby_llm-mcp](https://github.com/patvice/ruby_llm-mcp)** - ⭐ 207
   Full-featured MCP support for Ruby and RubyLLM—making it easy to build structured, composable LLM workflows in pure Ruby.

938. **[facebook-ads-mcp-server](https://github.com/gomarble-ai/facebook-ads-mcp-server)** - ⭐ 207

939. **[antd-components-mcp](https://github.com/zhixiaoqiang/antd-components-mcp)** - ⭐ 207
   An MCP service for Ant Design components query | 一个减少 Ant Design 组件代码生成幻觉的 MCP 服务，包含系统提示词、组件文档、API 文档、代码示例和更新日志查询

940. **[smart-tree](https://github.com/8b-is/smart-tree)** - ⭐ 207
...
941. **[mcp-context-protector](https://github.com/trailofbits/mcp-context-protector)** - ⭐ 206
   MCP security wrapper

942. **[CAAL](https://github.com/CoreWorxLab/CAAL)** - ⭐ 206
   Local voice assistant that learns new abilities via auto-discovered n8n workflows exposed as tools via MCP

943. **[OSWorld-MCP](https://github.com/X-PLUG/OSWorld-MCP)** - ⭐ 205

944. **[mcp-rb](https://github.com/funwarioisii/mcp-rb)** - ⭐ 205
   A lightweight Ruby framework for building MCP servers with a Sinatra-like DSL

945. **[notion_mcp](https://github.com/danhilse/notion_mcp)** - ⭐ 205
   A simple MCP integration that allows Claude to read and manage a personal Notion todo list

946. **[kite-mcp-server](https://github.com/zerodha/kite-mcp-server)** - ⭐ 205
   Zerodha Kite MCP server

947. **[AutomatedEmulation](https://github.com/iknowjason/AutomatedEmulation)** - ⭐ 204
...
948. **[sqrl](https://github.com/DataSQRL/sqrl)** - ⭐ 204
   Data Pipeline Automation Framework to build MCP servers, data APIs, and data lakes with SQL.

949. **[melrose](https://github.com/emicklei/melrose)** - ⭐ 204
   interactive programming of melodies, producing MIDI 

950. **[Remote-MCP](https://github.com/ssut/Remote-MCP)** - ⭐ 204
   A type-safe solution to remote MCP communication, enabling effortless integration for centralized management of Model Context.

951. **[zotero-mcp](https://github.com/cookjohn/zotero-mcp)** - ⭐ 204
...
952. **[sora-mcp](https://github.com/Doriandarko/sora-mcp)** - ⭐ 203
   An MCP server to use Sora video generation APIs

953. **[langchain-mcp](https://github.com/rectalogic/langchain-mcp)** - ⭐ 203
   Model Context Protocol tool support for LangChain

954. **[automagik-genie](https://github.com/namastexlabs/automagik-genie)** - ⭐ 203
   🧞 Automagik Genie – bootstrap, update, and roll back AI agent workspaces with a single CLI + MCP toolkit.

955. **[anki-mcp-server](https://github.com/nailuoGG/anki-mcp-server)** - ⭐ 202
   MCP server for Anki via AnkiConnect

956. **[ticktick-mcp](https://github.com/jacepark12/ticktick-mcp)** - ⭐ 202
   MCP server that interacts with TickTick (Dida 365) via the TickTick Open API

957. **[ssh-mcp](https://github.com/tufantunc/ssh-mcp)** - ⭐ 202
   MCP server exposing SSH control for Linux servers via Model Context Protocol.

958. **[jebmcp](https://github.com/dawnslab/jebmcp)** - ⭐ 201

959. **[mcp](https://github.com/hopx-ai/mcp)** - ⭐ 200

960. **[c2sagent](https://github.com/C2SAgent/c2sagent)** - ⭐ 200
...
964. **[TradingAgents-MCPmode](https://github.com/guangxiangdebizi/TradingAgents-MCPmode)** - ⭐ 200
   TradingAgents-MCPmode 是一个创新的多智能体交易分析系统，集成了 Model Context Protocol (MCP) 工具，实现了智能化的股票分析和交易决策流程。系统通过多个专业化智能体的协作，提供全面的市场分析、投资建议和风险管理。

965. **[google-docs-mcp](https://github.com/a-bonus/google-docs-mcp)** - ⭐ 200
...
966. **[mathom](https://github.com/stephenlacy/mathom)** - ⭐ 199
   Run and monitor MCP servers locally

967. **[unsplash-mcp-server](https://github.com/hellokaton/unsplash-mcp-server)** - ⭐ 198
   🔎 A MCP server for Unsplash image search.

968. **[mastergo-magic-mcp](https://github.com/mastergo-design/mastergo-magic-mcp)** - ⭐ 198
...
969. **[jetski](https://github.com/hyprmcp/jetski)** - ⭐ 198
...
970. **[mcp-server-deep-research](https://github.com/reading-plus-ai/mcp-server-deep-research)** - ⭐ 197

971. **[mcp-server-rag-web-browser](https://github.com/apify/mcp-server-rag-web-browser)** - ⭐ 197
   A MCP Server for the RAG Web Browser Actor

972. **[ht-mcp](https://github.com/memextech/ht-mcp)** - ⭐ 197
   Pure Rust implementation of MCP server for headless terminal 

973. **[mcp-server-trello](https://github.com/delorenj/mcp-server-trello)** - ⭐ 197
   A Model Context Protocol (MCP) server that provides tools for interacting with Trello boards.

974. **[claude-historian-mcp](https://github.com/Vvkmnn/claude-historian-mcp)** - ⭐ 196
   🤖 An MCP server for surfacing useful Claude Code conversation history

975. **[ProxmoxMCP](https://github.com/canvrno/ProxmoxMCP)** - ⭐ 196
   MCP for Proxmox integration in Cline

976. **[BifrostMCP](https://github.com/biegehydra/BifrostMCP)** - ⭐ 196
   VSCode Extension with an MCP server that exposes semantic tools like Find Usages and Rename to LLMs

977. **[cognition-wheel](https://github.com/Hormold/cognition-wheel)** - ⭐ 196
   A Model Context Protocol (MCP) server that implements a "wisdom of crowds" approach to AI reasoning by consulting multiple state-of-the-art language models in parallel and synthesizing their responses.

978. **[mcp-trends-hub](https://github.com/baranwang/mcp-trends-hub)** - ⭐ 196
   基于 Model Context Protocol (MCP) 协议的全网热点趋势一站式聚合服务

979. **[mcp-portal-transparencia](https://github.com/dutradotdev/mcp-portal-transparencia)** - ⭐ 195
   MCP para orquestração automatizada de chamadas à API do Portal da Transparência do Governo Federal brasileiro

980. **[opik-mcp](https://github.com/comet-ml/opik-mcp)** - ⭐ 195
   Model Context Protocol (MCP) implementation for Opik enabling seamless IDE integration and unified access to prompts, projects, traces, and metrics. 

981. **[rmcp](https://github.com/finite-sample/rmcp)** - ⭐ 195
   R MCP Server

982. **[mongodb-lens](https://github.com/furey/mongodb-lens)** - ⭐ 194
   🍃🔎 MongoDB Lens: Full Featured MCP Server for MongoDB Databases

983. **[phone-mcp](https://github.com/hao-cyber/phone-mcp)** - ⭐ 194
   A phone control plugin for MCP that allows you to control your Android phone through ADB commands to connect any human

984. **[mcp-proxy-server](https://github.com/adamwattis/mcp-proxy-server)** - ⭐ 194
   An MCP proxy server that aggregates and serves multiple MCP resource servers through a single interface

985. **[metorial-platform](https://github.com/metorial/metorial-platform)** - ⭐ 194
   The engine powering hundreds of thousands of MCP connections 🤖 🔥

986. **[Google-Scholar-MCP-Server](https://github.com/JackKuo666/Google-Scholar-MCP-Server)** - ⭐ 194
...
987. **[mcp-n8n-workflow-builder](https://github.com/salacoste/mcp-n8n-workflow-builder)** - ⭐ 194
   AI-powered n8n workflow automation through natural language. MCP server enabling Claude AI & Cursor IDE to create, manage, and monitor workflows via Model Context Protocol. Multi-instance support, 17 tools, comprehensive docs. Build workflows conversationally without manual JSON editing.

988. **[obsidian-mcp-plugin](https://github.com/aaronsb/obsidian-mcp-plugin)** - ⭐ 193
   High-performance Model Context Protocol (MCP) server for Obsidian that provides AI tools with direct vault access through semantic operations and HTTP transport.

989. **[ha-mcp-for-xiaozhi](https://github.com/c1pher-cn/ha-mcp-for-xiaozhi)** - ⭐ 192
   Homeassistant MCP server for 小智AI

990. **[waldzell-mcp](https://github.com/waldzellai/waldzell-mcp)** - ⭐ 192
   Waldzell AI's monorepo of MCP servers. Use in Claude Desktop, Cline, Roo Code, and more!

991. **[sec-edgar-mcp](https://github.com/stefanoamorelli/sec-edgar-mcp)** - ⭐ 192
   A SEC EDGAR MCP (Model Context Protocol) Server

992. **[yt-dlp-mcp](https://github.com/kevinwatt/yt-dlp-mcp)** - ⭐ 192
   A Model Context Protocol (MCP) server that bridges Video & Audio content with Large Language Models using yt-dlp.

993. **[nano-agent](https://github.com/disler/nano-agent)** - ⭐ 191
   A MCP Server for a small scale engineering agents with multi-provider LLM support.

994. **[easy-mcp](https://github.com/zcaceres/easy-mcp)** - ⭐ 191
   Absurdly easy Model Context Protocol Servers in Typescript

995. **[mcp-guardian](https://github.com/eqtylab/mcp-guardian)** - ⭐ 191
   Manage / Proxy / Secure your MCP Servers

996. **[gcp-mcp](https://github.com/eniayomi/gcp-mcp)** - ⭐ 191
   A Model Context Protocol (MCP) server that enables AI assistants like Claude to interact with your Google Cloud Platform environment. This allows for natural language querying and management of your GCP resources during conversations.

997. **[tmux-mcp](https://github.com/nickgnd/tmux-mcp)** - ⭐ 191
   A MCP server for our beloved terminal multiplexer tmux.

998. **[seo-mcp](https://github.com/cnych/seo-mcp)** - ⭐ 190
...
999. **[MCP-server-client-computer-use-ai-sdk](https://github.com/mediar-ai/MCP-server-client-computer-use-ai-sdk)** - ⭐ 189

1000. **[dynatrace-mcp](https://github.com/dynatrace-oss/dynatrace-mcp)** - ⭐ 189
   MCP server for Dynatrace Observability

1001. **[mcp_forge](https://github.com/mlzoo/mcp_forge)** - ⭐ 188
   这是一个专为开发企业级MCP server而设计的通用开发框架

1002. **[gram](https://github.com/speakeasy-api/gram)** - ⭐ 188
   Platform to create, curate and host MCP servers ⚒️ Build production quality tools for your agents.

1003. **[wavefront](https://github.com/rootflo/wavefront)** - ⭐ 188
   🔥🔥🔥 Enterprise AI middleware, alternative to unifyapps, n8n, lyzr

1004. **[code-sandbox-mcp](https://github.com/philschmid/code-sandbox-mcp)** - ⭐ 187

1005. **[mcp-usecase](https://github.com/teddynote-lab/mcp-usecase)** - ⭐ 187

1006. **[mcp-injection-experiments](https://github.com/invariantlabs-ai/mcp-injection-experiments)** - ⭐ 187
   Code snippets to reproduce MCP tool poisoning attacks.

1007. **[Omni-Adapter](https://github.com/HuChundong/Omni-Adapter)** - ⭐ 186
   多平台 文生图/图生图 等能力接入MCP

1008. **[AutoDocs](https://github.com/TrySita/AutoDocs)** - ⭐ 186
...
1009. **[nosia](https://github.com/dilolabs/nosia)** - ⭐ 186
   Self-hosted AI RAG + MCP Platform

1010. **[utcp-mcp](https://github.com/universal-tool-calling-protocol/utcp-mcp)** - ⭐ 186
   All-in-one MCP server that can connect your AI agents to any native endpoint, powered by UTCP

1011. **[supabase-mcp](https://github.com/coleam00/supabase-mcp)** - ⭐ 186
   Supabase MCP server created in Python.

1012. **[yahoo-finance-mcp](https://github.com/Alex2Yang97/yahoo-finance-mcp)** - ⭐ 186
   This is a Model Context Protocol (MCP) server that provides comprehensive financial data from Yahoo Finance. It allows you to retrieve detailed information about stocks, including historical prices, company information, financial statements, options data, and market news.

1013. **[auto-mcp](https://github.com/brizzai/auto-mcp)** - ⭐ 185
   Transform any OpenAPI/Swagger definition into a fully-featured Model Context Protocol (MCP) server

1014. **[persistent-ai-memory](https://github.com/savantskie/persistent-ai-memory)** - ⭐ 185
   A persistent local memory for AI, LLMs, or Copilot in VS Code.

1015. **[armor-crypto-mcp](https://github.com/armorwallet/armor-crypto-mcp)** - ⭐ 185
   The MCP server for interacting with Blockchain, Swaps, Strategic Planning and more.

1016. **[mcp-linkedin](https://github.com/adhikasp/mcp-linkedin)** - ⭐ 185
   A Model Context Protocol (MCP) server that provides tools to interact with LinkedIn's Feeds and Job API.

1017. **[a2a_mcp-example](https://github.com/ishanExtreme/a2a_mcp-example)** - ⭐ 184
   An example showing how A2A and MCP can be used together

1018. **[ai-infrastructure-agent](https://github.com/VersusControl/ai-infrastructure-agent)** - ⭐ 184
...
1019. **[mcp-echarts](https://github.com/hustcc/mcp-echarts)** - ⭐ 184
   🧬 Generate visual charts using ECharts with AI MCP dynamically, used for chart generation and data analysis.

1020. **[litemcp](https://github.com/wong2/litemcp)** - ⭐ 183
   A TypeScript framework for building MCP servers elegantly

1021. **[atlassian-mcp-server](https://github.com/atlassian/atlassian-mcp-server)** - ⭐ 183
   Remote MCP Server that securely connects Jira and Confluence with your LLM, IDE, or agent platform of choice.

1022. **[thinkchain](https://github.com/martinbowling/thinkchain)** - ⭐ 182
...
1023. **[mcp-openai-gemini-llama-example](https://github.com/philschmid/mcp-openai-gemini-llama-example)** - ⭐ 182

1024. **[pbi-desktop-mcp-public](https://github.com/maxanatsko/pbi-desktop-mcp-public)** - ⭐ 182
...
1025. **[figma-flutter-mcp](https://github.com/mhmzdev/figma-flutter-mcp)** - ⭐ 181
   An MCP server that provides the coding agents Figma's design token to write Flutter code.

1026. **[siconos](https://github.com/siconos/siconos)** - ⭐ 180
   Simulation framework for nonsmooth dynamical systems

1027. **[gistpad-mcp](https://github.com/lostintangent/gistpad-mcp)** - ⭐ 180
   📓 An MCP server for managing your personal knowledge, daily notes, and re-usable prompts via GitHub Gists

1028. **[MCP-Checklists](https://github.com/MCP-Manager/MCP-Checklists)** - ⭐ 180

1029. **[dify-plugin-tools-mcp_sse](https://github.com/junjiem/dify-plugin-tools-mcp_sse)** - ⭐ 180
   Dify 1.0 Plugin MCP HTTP with SSE or Streamable HTTP transport Tools

1030. **[hf-mcp-server](https://github.com/huggingface/hf-mcp-server)** - ⭐ 180
   Hugging Face MCP Server

1031. **[quarkus-mcp-servers](https://github.com/quarkiverse/quarkus-mcp-servers)** - ⭐ 180
   Model Context Protocol Servers in Quarkus

1032. **[mcp-proxy-server](https://github.com/ptbsare/mcp-proxy-server)** - ⭐ 180
   This server acts as a central hub for Model Context Protocol (MCP) resource servers.

1033. **[servicenow-mcp](https://github.com/echelon-ai-labs/servicenow-mcp)** - ⭐ 180
   MCP Server for ServiceNow

1034. **[protoc-gen-go-mcp](https://github.com/redpanda-data/protoc-gen-go-mcp)** - ⭐ 179
   Go protobuf compiler extension to turn any gRPC service into an MCP server

1035. **[mcp-text-editor](https://github.com/tumf/mcp-text-editor)** - ⭐ 178

1036. **[claude-code-mcp](https://github.com/auchenberg/claude-code-mcp)** - ⭐ 178
   claude-code-mcp

1037. **[k8s-mcp-server](https://github.com/alexei-led/k8s-mcp-server)** - ⭐ 178
   K8s-mcp-server is a Model Context Protocol (MCP) server that enables AI assistants like Claude to securely execute Kubernetes commands. It provides a bridge between language models and essential Kubernetes CLI tools including kubectl, helm, istioctl, and argocd, allowing AI systems to assist with cluster management, troubleshooting, and deployments

1038. **[mcp-gsc](https://github.com/AminForou/mcp-gsc)** - ⭐ 178
   Google Search Console Insights with Claude AI for SEOs

1039. **[tripo-mcp](https://github.com/VAST-AI-Research/tripo-mcp)** - ⭐ 177
   Official MCP server for Tripo

1040. **[anki-mcp-server](https://github.com/scorzeth/anki-mcp-server)** - ⭐ 176
   An MCP server for Anki

1041. **[mcp-servers-nix](https://github.com/natsukium/mcp-servers-nix)** - ⭐ 176
   A Nix-based configuration framework for Model Control Protocol (MCP) servers with ready-to-use packages.

1042. **[cheatengine-mcp-bridge](https://github.com/miscusi-peek/cheatengine-mcp-bridge)** - ⭐ 175
...
1043. **[aitour26-WRK540-unlock-your-agents-potential-with-model-context-protocol](https://github.com/microsoft/aitour26-WRK540-unlock-your-agents-potential-with-model-context-protocol)** - ⭐ 175

1044. **[quarkus-mcp-server](https://github.com/quarkiverse/quarkus-mcp-server)** - ⭐ 174
   This extension enables developers to implement the MCP server features easily.

1045. **[ida-mcp-server-plugin](https://github.com/taida957789/ida-mcp-server-plugin)** - ⭐ 173
   IDA Pro Plugin for serving MCP SSE server for cursor / claude

1046. **[mongo-mcp](https://github.com/QuantGeekDev/mongo-mcp)** - ⭐ 173
   A mongo db server for the model context protocol (MCP)

1047. **[bilibili-mcp-server](https://github.com/huccihuang/bilibili-mcp-server)** - ⭐ 173
   MCP Server for the Bilibili API, supporting various operations.

1048. **[skunit](https://github.com/mehrandvd/skunit)** - ⭐ 173
   skUnit is a testing tool for AI units, such as IChatClient, MCP Servers and agents.

1049. **[mcp-run-python](https://github.com/pydantic/mcp-run-python)** - ⭐ 173
   MCP server to run Python code in a sandbox.

1050. **[mcp-server-duckdb](https://github.com/ktanaka101/mcp-server-duckdb)** - ⭐ 172
   A Model Context Protocol (MCP) server implementation for DuckDB, providing database interaction capabilities

1051. **[gemini-cli-desktop](https://github.com/Piebald-AI/gemini-cli-desktop)** - ⭐ 172
   Web/desktop UI for Gemini CLI/Qwen Code.  Manage projects, switch between tools, search across past conversations, and manage MCP servers, all from one multilingual interface, locally or remotely.

1052. **[mcp-snowflake-server](https://github.com/isaacwasserman/mcp-snowflake-server)** - ⭐ 171

1053. **[mcp-server-siri-shortcuts](https://github.com/dvcrn/mcp-server-siri-shortcuts)** - ⭐ 171
   MCP for calling Siri Shorcuts from LLMs

1054. **[pctx](https://github.com/portofcontext/pctx)** - ⭐ 171
...
1055. **[aws-finops-mcp-server](https://github.com/ravikiranvm/aws-finops-mcp-server)** - ⭐ 171
   An MCP (Model Context Protocol) server that brings powerful AWS FinOps capabilities directly into your AI assistant. Analyze cloud costs, audit for waste, and get budget insights using natural language, all while keeping your credentials secure on your local machine.

1056. **[mcp-chat](https://github.com/PipedreamHQ/mcp-chat)** - ⭐ 169
   Examples of using Pipedream's MCP server in your app or AI agent.

1057. **[aws-mcp-server](https://github.com/alexei-led/aws-mcp-server)** - ⭐ 169
   A lightweight service that enables AI assistants to execute AWS CLI commands (in safe containerized environment) through the Model Context Protocol (MCP). Bridges Claude, Cursor, and other MCP-aware AI tools with AWS CLI for enhanced cloud infrastructure management.

1058. **[frida-mcp](https://github.com/dnakov/frida-mcp)** - ⭐ 169
   MCP stdio server for frida

1059. **[ai-counsel](https://github.com/blueman82/ai-counsel)** - ⭐ 169
   True deliberative consensus MCP server where AI models debate and refine positions across multiple rounds

1060. **[mcp-scholarly](https://github.com/adityak74/mcp-scholarly)** - ⭐ 168
   A MCP server to search for accurate academic articles.

1061. **[MakeMoneyWithAI](https://github.com/garylab/MakeMoneyWithAI)** - ⭐ 168
   A list of open-source AI projects you can use to generate income easily.

1062. **[openapi-mcp](https://github.com/ckanthony/openapi-mcp)** - ⭐ 168
   Dockerized MCP Server to allow your AI agent to access any API with existing api docs

1063. **[git-mcp-server](https://github.com/cyanheads/git-mcp-server)** - ⭐ 167
   An MCP (Model Context Protocol) server enabling LLMs and AI agents to interact with Git repositories. Provides tools for comprehensive Git operations including clone, commit, branch, diff, log, status, push, pull, merge, rebase, worktree, tag management, and more, via the MCP standard. STDIO & HTTP.

1064. **[Revornix](https://github.com/Qingyon-AI/Revornix)** - ⭐ 167
...
1065. **[google-analytics-mcp](https://github.com/surendranb/google-analytics-mcp)** - ⭐ 167
...
1066. **[y-gui](https://github.com/luohy15/y-gui)** - ⭐ 167
   A Tiny Web Chat App for AI Models with MCP Client Support

1067. **[wikipedia-mcp](https://github.com/Rudra-ravi/wikipedia-mcp)** - ⭐ 167
   A Model Context Protocol (MCP) server that retrieves information from Wikipedia to provide context to LLMs.

1068. **[tomcp](https://github.com/Ami3466/tomcp)** - ⭐ 166
   Turn any website or doc into an MCP server

1069. **[command](https://github.com/scopecraft/command)** - ⭐ 166
   Scopecraft Command - A CLI and MCP server for Markdown-Driven Task Management (MDTM)

1070. **[touchdesigner-mcp](https://github.com/8beeeaaat/touchdesigner-mcp)** - ⭐ 166
   MCP server for TouchDesigner

1071. **[facebook-ads-library-mcp](https://github.com/talknerdytome-labs/facebook-ads-library-mcp)** - ⭐ 165
   MCP Server for Facebook ADs Library - Get instant answers from FB's ad library

1072. **[mcp-use-ts](https://github.com/mcp-use/mcp-use-ts)** - ⭐ 165
   mcp-use is the framework for MCP with the best DX - Build AI agents, create MCP   servers with UI widgets, and debug with built-in inspector. Includes client SDK, server SDK, React hooks, and powerful dev tools.

1073. **[Chanakya-Local-Friend](https://github.com/Rishabh-Bajpai/Chanakya-Local-Friend)** - ⭐ 165
...
1074. **[xero-mcp-server](https://github.com/XeroAPI/xero-mcp-server)** - ⭐ 165
   An MCP server that integrates with the MCP protocol. https://modelcontextprotocol.io/introduction

1075. **[discordmcp](https://github.com/v-3/discordmcp)** - ⭐ 164
   Discord MCP Server for Claude Integration

1076. **[toolbase](https://github.com/Toolbase-AI/toolbase)** - ⭐ 164
   A desktop application that adds powerful tools to Claude and AI platforms

1077. **[keyboard-local](https://github.com/keyboard-dev/keyboard-local)** - ⭐ 163
   One MCP Server, All Your Apps, Privacy First

1078. **[mcp-logseq](https://github.com/ergut/mcp-logseq)** - ⭐ 162
   MCP server to interact with LogSeq via its Local HTTP API - enabling AI assistants like Claude to seamlessly read, write, and manage your LogSeq graph.

1079. **[smart-coding-mcp](https://github.com/omar-haris/smart-coding-mcp)** - ⭐ 162
...
1080. **[meilisearch-mcp](https://github.com/meilisearch/meilisearch-mcp)** - ⭐ 162
   A Model Context Protocol (MCP) server for interacting with Meilisearch through LLM interfaces.

1081. **[claudepro-directory](https://github.com/JSONbored/claudepro-directory)** - ⭐ 162
...
1082. **[mcp-server-weaviate](https://github.com/weaviate/mcp-server-weaviate)** - ⭐ 161
   MCP (Model Context Protocol) server for Weaviate

1083. **[mcp-telegram](https://github.com/sparfenyuk/mcp-telegram)** - ⭐ 161
   MCP server to work with Telegram through MTProto

1084. **[dify-mcp-client](https://github.com/3dify-project/dify-mcp-client)** - ⭐ 161
   MCP Client as an Agent Strategy Plugin. Support GUI operation via UI-TARS-SDK.

1085. **[lsp-mcp](https://github.com/jonrad/lsp-mcp)** - ⭐ 161
   An Model Context Protocol (MCP) server that provides LLMs/AI Agents with the capabilities of a language server protocol (LSP) server. This gives the AI the ability to get language aware context from the codebase.

1086. **[binary_ninja_mcp](https://github.com/fosdickio/binary_ninja_mcp)** - ⭐ 161
   A Binary Ninja plugin containing an MCP server that enables seamless integration with your favorite LLM/MCP client.

1087. **[mcp-google-map](https://github.com/cablate/mcp-google-map)** - ⭐ 160
   A powerful Model Context Protocol (MCP) server providing comprehensive Google Maps API integration with LLM processing capabilities.

1088. **[mcp-agent-langchainjs](https://github.com/Azure-Samples/mcp-agent-langchainjs)** - ⭐ 160
...
1089. **[after-effects-mcp](https://github.com/Dakkshin/after-effects-mcp)** - ⭐ 160
   MCP Server for Adobe After Effects. Enables remote control (compositions, text, shapes, solids, properties) via the Model Context Protocol using ExtendScript.

1090. **[mcp](https://github.com/magicuidesign/mcp)** - ⭐ 159
   Official Magic UI MCP server.

1091. **[tableau-mcp](https://github.com/tableau/tableau-mcp)** - ⭐ 159
...
1092. **[cli-mcp-server](https://github.com/MladenSU/cli-mcp-server)** - ⭐ 159
   Command line interface for MCP clients with secure execution and customizable security policies

1093. **[jmap-mcp](https://github.com/wyattjoh/jmap-mcp)** - ⭐ 159
   A Model Context Protocol (MCP) server that provides tools for interacting with JMAP (JSON Meta Application Protocol) email servers. Built with Deno and using the jmap-jam client library.

1094. **[dbt-llm-agent](https://github.com/pragunbhutani/dbt-llm-agent)** - ⭐ 159
   LLM based AI Agent to automate Data Analysis for dbt projects with remote MCP server

1095. **[mcp-server-wazuh](https://github.com/gbrigandi/mcp-server-wazuh)** - ⭐ 159
   MCP Server for Wazuh SIEM

1096. **[mcp-access-point](https://github.com/sxhxliang/mcp-access-point)** - ⭐ 158
   Turn a web server into an MCP server in one click without making any code changes.

1097. **[comfyui-mcp-server](https://github.com/joenorton/comfyui-mcp-server)** - ⭐ 158
   lightweight Python-based MCP (Model Context Protocol) server for local ComfyUI

1098. **[remote-mcp-server](https://github.com/gleanwork/remote-mcp-server)** - ⭐ 158
   Remote MCP Server that securely connects Enterprise context with your LLM, IDE, or agent platform of choice.

1099. **[sketchup-mcp](https://github.com/mhyrr/sketchup-mcp)** - ⭐ 158
   Sketchup Model Context Protocol

1100. **[markmap-mcp-server](https://github.com/jinzcdev/markmap-mcp-server)** - ⭐ 158
   An MCP server for converting Markdown to interactive mind maps with export support (PNG/JPG/SVG).

1101. **[fetch-mcp](https://github.com/egoist/fetch-mcp)** - ⭐ 157
   An MCP server for fetching URLs / Youtube video transcript.

1102. **[spotinfo](https://github.com/alexei-led/spotinfo)** - ⭐ 157
   CLI for exploring AWS EC2 Spot inventory. Inspect AWS Spot instance types, saving, price, and interruption frequency.

1103. **[Quickchart-MCP-Server](https://github.com/GongRzhe/Quickchart-MCP-Server)** - ⭐ 157
...
1104. **[UnityNaturalMCP](https://github.com/notargs/UnityNaturalMCP)** - ⭐ 157
   UnityNaturalMCP is an MCP server implementation for Unity that aims for a "natural" user experience.

1105. **[install-mcp](https://github.com/supermemoryai/install-mcp)** - ⭐ 156
   A simple CLI to install MCP servers into any client - auth included!

1106. **[toolsdk-mcp-registry](https://github.com/toolsdk-ai/toolsdk-mcp-registry)** - ⭐ 156
...
1107. **[mcp-shell-server](https://github.com/tumf/mcp-shell-server)** - ⭐ 156

1108. **[compliant-llm](https://github.com/fiddlecube/compliant-llm)** - ⭐ 156
   Build Secure and Compliant AI agents and MCP Servers. YC W23

1109. **[slack-mcp-client](https://github.com/tuannvm/slack-mcp-client)** - ⭐ 155
...
1110. **[integrate-mcp-with-copilot](https://github.com/skills/integrate-mcp-with-copilot)** - ⭐ 155
   Learn how to use MCP Servers with GitHub Copilot

1111. **[mcp-client-slackbot](https://github.com/sooperset/mcp-client-slackbot)** - ⭐ 154
   Simple Slackbot MCP Client

1112. **[photoshop-python-api-mcp-server](https://github.com/loonghao/photoshop-python-api-mcp-server)** - ⭐ 154
   A Model Context Protocol (MCP) server that interfaces with Adobe Photoshop's Python API. Enables LLMs to execute image editing operations, automate workflows, and manage Photoshop tasks through structured commands and context-aware interactions.

1113. **[flights-mcp](https://github.com/ravinahp/flights-mcp)** - ⭐ 153
   An MCP server to search for flights.

1114. **[XPack-MCP-Marketplace](https://github.com/xpack-ai/XPack-MCP-Marketplace)** - ⭐ 153
...
1115. **[python-mcp-server-client](https://github.com/GobinFan/python-mcp-server-client)** - ⭐ 152
   支持查询主流agent框架技术文档的MCP server（支持stdio和sse两种传输协议）, 支持 langchain、llama-index、autogen、agno、openai-agents-sdk、mcp-doc、camel-ai 和 crew-ai

1116. **[mcp-server-langfuse](https://github.com/langfuse/mcp-server-langfuse)** - ⭐ 151
   Model Context Protocol (MCP) Server for Langfuse Prompt Management. This server allows you to access and manage your Langfuse prompts through the Model Context Protocol.

1117. **[open-streetmap-mcp](https://github.com/jagan-shanmugam/open-streetmap-mcp)** - ⭐ 151
   An OpenStreetMap MCP server implementation that enhances LLM capabilities with location-based services and geospatial data.

1118. **[alibabacloud-tablestore-mcp-server](https://github.com/aliyun/alibabacloud-tablestore-mcp-server)** - ⭐ 151

1119. **[mcp-opennutrition](https://github.com/deadletterq/mcp-opennutrition)** - ⭐ 151
...
1120. **[mcp-summarizer](https://github.com/0xshellming/mcp-summarizer)** - ⭐ 150
   MCP Server for AI Summarization

1121. **[mcp-server-metamcp](https://github.com/metatool-ai/mcp-server-metamcp)** - ⭐ 150
   MCP Server MetaMCP manages all your other MCPs in one MCP.

1122. **[claude-config-editor](https://github.com/gagarinyury/claude-config-editor)** - ⭐ 150
...
1123. **[discord-mcp](https://github.com/SaseQ/discord-mcp)** - ⭐ 150
   A MCP server for the Discord integration. Enable your AI assistants to seamlessly interact with Discord. Enhance your Discord experience with powerful automation capabilities.

1124. **[mcp-client-go](https://github.com/yincongcyincong/mcp-client-go)** - ⭐ 149
   mcp client for Go (Golang). Integrate multiple  Model Context Protocol (MCP) servers

1125. **[tinymcp](https://github.com/golioth/tinymcp)** - ⭐ 149
   Let LLMs control embedded devices via the Model Context Protocol.

1126. **[web3-research-mcp](https://github.com/aaronjmars/web3-research-mcp)** - ⭐ 149
   Deep Research for crypto - free & fully local

1127. **[MCPHub-Desktop](https://github.com/Jeamee/MCPHub-Desktop)** - ⭐ 149
   Desktop APP for Discover and Install MCP Servers

1128. **[awesome-claude-dxt](https://github.com/milisp/awesome-claude-dxt)** - ⭐ 149
   Awesome Claude Desktop Extensions (dxt) (not only Claude) mcpb

1129. **[tmcp](https://github.com/paoloricciuti/tmcp)** - ⭐ 149
   Typescript SDK to build MCP servers in an agnostic way

1130. **[opentelemetry-mcp-server](https://github.com/traceloop/opentelemetry-mcp-server)** - ⭐ 148
   Unified MCP server for querying OpenTelemetry traces across multiple backends (Jaeger, Tempo, Traceloop, etc.), enabling AI agents to analyze distributed traces for automated debugging and observability.

1131. **[mcp-simple-pubmed](https://github.com/andybrandt/mcp-simple-pubmed)** - ⭐ 148
   MCP server for searching and querying PubMed medical papers/research database

1132. **[pg-mcp-server](https://github.com/ericzakariasson/pg-mcp-server)** - ⭐ 148
   MCP Server for Postgres

1133. **[mcp-server-example](https://github.com/alejandro-ao/mcp-server-example)** - ⭐ 148
   A simple MCP server to search for documentation (tutorial)

1134. **[mcp-gateway](https://github.com/lightconetech/mcp-gateway)** - ⭐ 148
   A gateway demo for MCP SSE Server

1135. **[instagram_dm_mcp](https://github.com/trypeggy/instagram_dm_mcp)** - ⭐ 148
   Instagram Direct messages MCP

1136. **[mcptools](https://github.com/posit-dev/mcptools)** - ⭐ 147
   Model Context Protocol For R

1137. **[eShopLite](https://github.com/Azure-Samples/eShopLite)** - ⭐ 147
   eShopLite is a set of reference .NET applications implementing an eCommerce site with features like Semantic Search, MCP, Reasoning models and more.

1138. **[superset-mcp](https://github.com/aptro/superset-mcp)** - ⭐ 147
   connect to 50+ data stores via superset mcp server. Can use with open ai agent sdk, Claude app, cursor, windsurf

1139. **[mcp-solver](https://github.com/szeider/mcp-solver)** - ⭐ 147
   Model Context Protocol (MCP) server for constraint optimization and solving"

1140. **[mcp-servers](https://github.com/cursor/mcp-servers)** - ⭐ 147
   A list of MCP (Model Context Protocol) servers for developer tools and services

1141. **[mcp-cli](https://github.com/philschmid/mcp-cli)** - ⭐ 147
   Lighweight CLI to interact with MCP servers

1142. **[make-mcp-server](https://github.com/integromat/make-mcp-server)** - ⭐ 146
   Make MCP Server

1143. **[Gemini-mcp](https://github.com/LKbaba/Gemini-mcp)** - ⭐ 146
   MCP server implementation for Google's Gemini API

1144. **[any-chat-completions-mcp](https://github.com/pyroprompts/any-chat-completions-mcp)** - ⭐ 146
   MCP Server for using any LLM as a Tool

1145. **[DrissionPageMCP](https://github.com/wxhzhwxhzh/DrissionPageMCP)** - ⭐ 146
   基于DrissionPage和FastMCP的浏览器自动化MCP服务器，提供丰富的浏览器操作API供AI调用

1146. **[relay](https://github.com/prism-php/relay)** - ⭐ 145
   An MCP client tool for Prism

1147. **[mcp-server-weread](https://github.com/ChenyqThu/mcp-server-weread)** - ⭐ 145

1148. **[figma-mcp-server](https://github.com/TimHolden/figma-mcp-server)** - ⭐ 145
   Model Context Protocol server implementation for Figma API

1149. **[Log-Analyzer-with-MCP](https://github.com/awslabs/Log-Analyzer-with-MCP)** - ⭐ 145
   A Model Context Protocol (MCP) server that provides AI assistants access to AWS CloudWatch Logs for analysis, searching, and correlation

1150. **[website-downloader](https://github.com/pskill9/website-downloader)** - ⭐ 144
   MCP server to download entire websites

1151. **[OpenDataMCP](https://github.com/OpenDataMCP/OpenDataMCP)** - ⭐ 144
   Connect any Open Data to any LLM with Model Context Protocol.

1152. **[goku](https://github.com/jcaromiq/goku)** - ⭐ 144
   Goku is an HTTP load testing application written in Rust 

1153. **[postman-mcp-server](https://github.com/delano/postman-mcp-server)** - ⭐ 144
   An MCP server that provides access to Postman.

1154. **[cursor-notebook-mcp](https://github.com/jbeno/cursor-notebook-mcp)** - ⭐ 144
   Model Context Protocol (MCP) server designed to allow AI agents within Cursor to interact with Jupyter Notebook (.ipynb) files

1155. **[decipher-research-agent](https://github.com/mtwn105/decipher-research-agent)** - ⭐ 144
   Turn topics, links, and files into AI-generated research notebooks — summarize, explore, and ask anything.

1156. **[mcp-1panel](https://github.com/1Panel-dev/mcp-1panel)** - ⭐ 143
   mcp-1panel is an implementation of the Model Context Protocol (MCP) server for 1Panel.

1157. **[metatrader-mcp-server](https://github.com/ariadng/metatrader-mcp-server)** - ⭐ 143
   Model Context Protocol (MCP) to enable AI LLMs to trade using MetaTrader platform

1158. **[mcp-shark](https://github.com/mcp-shark/mcp-shark)** - ⭐ 143
...
1159. **[scrapeless-mcp-server](https://github.com/scrapeless-ai/scrapeless-mcp-server)** - ⭐ 143
   Scrapeless Mcp Server

1160. **[pubmearch](https://github.com/Darkroaster/pubmearch)** - ⭐ 142
   A PubMed MCP server.

1161. **[ultimate_mcp_client](https://github.com/Dicklesworthstone/ultimate_mcp_client)** - ⭐ 142

1162. **[ReActMCP](https://github.com/mshojaei77/ReActMCP)** - ⭐ 141
   ReActMCP is a reactive MCP client that empowers AI assistants to instantly respond with real-time, Markdown-formatted web search insights powered by the Exa API.

1163. **[mcp](https://github.com/neo4j/mcp)** - ⭐ 141
   Neo4j official MCP Server

1164. **[kom](https://github.com/weibaohui/kom)** - ⭐ 141
   kom 是一个用于 Kubernetes 操作的工具，SDK级的kubectl、client-go的使用封装。并且支持作为管理k8s 的 MCP server。 它提供了一系列功能来管理 Kubernetes 资源，包括创建、更新、删除和获取资源，甚至使用SQL查询k8s资源。这个项目支持多种 Kubernetes 资源类型的操作，并能够处理自定义资源定义（CRD）。 通过使用 kom，你可以轻松地进行资源的增删改查和日志获取以及操作POD内文件等动作。

1165. **[postman-mcp-server](https://github.com/postmanlabs/postman-mcp-server)** - ⭐ 141
   Connect your AI to your APIs on Postman

1166. **[node-code-sandbox-mcp](https://github.com/alfonsograziano/node-code-sandbox-mcp)** - ⭐ 140
   A Node.js–based Model Context Protocol server that spins up disposable Docker containers to execute arbitrary JavaScript.

1167. **[notion-mcp-server](https://github.com/awkoy/notion-mcp-server)** - ⭐ 140
   **Notion MCP Server** is a Model Context Protocol (MCP) server implementation that enables AI assistants to interact with Notion's API. This production-ready server provides a complete set of tools.

1168. **[solana-mcp](https://github.com/sendaifun/solana-mcp)** - ⭐ 140
   A Model Context Protocol server for interacting with the Solana blockchain, powered by the Solana Agent Kit (https://github.com/sendaifun/solana-agent-kit)

1169. **[quick-data-mcp](https://github.com/disler/quick-data-mcp)** - ⭐ 140
   Prompt focused MCP Server for .json and .csv agentic data analytics for Claude Code

1170. **[mcp-mysql-server](https://github.com/f4ww4z/mcp-mysql-server)** - ⭐ 140
   A Model Context Protocol server for MySQL database operations

1171. **[powerpoint](https://github.com/supercurses/powerpoint)** - ⭐ 140
   A MCP Server for creating Powerpoint Presentations

1172. **[In-Memoria](https://github.com/pi22by7/In-Memoria)** - ⭐ 140
   Persistent Intelligence Infrastructure for AI Agents

1173. **[mcp-dotnet-samples](https://github.com/microsoft/mcp-dotnet-samples)** - ⭐ 140
   A comprehensive set of samples of creating and using MCP servers and clients with .NET

1174. **[claudex](https://github.com/Mng-dev-ai/claudex)** - ⭐ 140
...
1175. **[agentor](https://github.com/CelestoAI/agentor)** - ⭐ 139
...
1176. **[mcp-montano-server](https://github.com/lucasmontano/mcp-montano-server)** - ⭐ 139
   Simple MCP Server Implementation

1177. **[open-responses-server](https://github.com/teabranch/open-responses-server)** - ⭐ 139
   Wraps any OpenAI API interface as Responses with MCPs support so it supports Codex. Adding any missing stateful features. Ollama and Vllm compliant.

1178. **[mcp-3D-printer-server](https://github.com/DMontgomery40/mcp-3D-printer-server)** - ⭐ 139
   Connects MCP to major 3D printer APIs (Orca, Bambu, OctoPrint, Klipper, Duet, Repetier, Prusa, Creality). Control prints, monitor status, and perform advanced STL operations like scaling, rotation, sectional editing, and base extension. Includes slicing and visualization.

1179. **[task-orchestrator](https://github.com/jpicklyk/task-orchestrator)** - ⭐ 139
...
1180. **[datagov-mcp](https://github.com/aviveldan/datagov-mcp)** - ⭐ 138
   MCP server for Israel Government Data

1181. **[mcp-interviewer](https://github.com/microsoft/mcp-interviewer)** - ⭐ 138
   Catch MCP server issues before your agents do.

1182. **[agentql-mcp](https://github.com/tinyfish-io/agentql-mcp)** - ⭐ 138
   Model Context Protocol server that integrates AgentQL's data extraction capabilities.

1183. **[MCP-X](https://github.com/TimeCyber/MCP-X)** - ⭐ 138
...
1184. **[osint-tools-mcp-server](https://github.com/frishtik/osint-tools-mcp-server)** - ⭐ 138
   MCP server exposing multiple OSINT tools for AI assistants like Claude

1185. **[eion](https://github.com/eiondb/eion)** - ⭐ 138
   Shared Memory Storage for Multi-Agent Systems

1186. **[mcp-server-starrocks](https://github.com/StarRocks/mcp-server-starrocks)** - ⭐ 138
   StarRocks MCP (Model Context Protocol) Server

1187. **[mcp-discord](https://github.com/hanweg/mcp-discord)** - ⭐ 138
   MCP server for discord bot

1188. **[hypertool-mcp](https://github.com/toolprint/hypertool-mcp)** - ⭐ 138
   Dynamically expose tools from proxied servers based on an Agent Persona

1189. **[mcp-server-calculator](https://github.com/githejie/mcp-server-calculator)** - ⭐ 137
   A Model Context Protocol server for calculating.

1190. **[google-slides-mcp](https://github.com/matteoantoci/google-slides-mcp)** - ⭐ 137
   MCP Server for Google Slides

1191. **[mssql-mcp](https://github.com/Aaronontheweb/mssql-mcp)** - ⭐ 137
   MSSQL Server MCP implementation written in C#

1192. **[rust-mcp-sdk](https://github.com/rust-mcp-stack/rust-mcp-sdk)** - ⭐ 136
   A high-performance, asynchronous toolkit for building MCP servers and clients in Rust.

1193. **[doc-ops-mcp](https://github.com/Tele-AI/doc-ops-mcp)** - ⭐ 135
   MCP server for seamless document format conversion and processing

1194. **[guidance-for-deploying-model-context-protocol-servers-on-aws](https://github.com/aws-solutions-library-samples/guidance-for-deploying-model-context-protocol-servers-on-aws)** - ⭐ 135
...
1195. **[systemprompt-code-orchestrator](https://github.com/systempromptio/systemprompt-code-orchestrator)** - ⭐ 135
     MCP server for orchestrating AI coding agents (Claude Code CLI & Gemini CLI). Features task management, process execution, Git integration, and dynamic resource discovery. Full TypeScript implementation with Docker support and Cloudflare Tunnel integration. 

1196. **[mcp-k8s](https://github.com/silenceper/mcp-k8s)** - ⭐ 135
   A Kubernetes MCP (Model Control Protocol) server that enables interaction with Kubernetes clusters through MCP tools.

1197. **[mkinf](https://github.com/mkinf-io/mkinf)** - ⭐ 134
   mkinf SDK to interact with mkinf hub MCP servers

1198. **[SecureMCP](https://github.com/makalin/SecureMCP)** - ⭐ 134
...
1199. **[wa_llm](https://github.com/ilanbenb/wa_llm)** - ⭐ 134
   A WhatsApp bot that can participate in group conversations, powered by AI. The bot monitors group messages and responds when mentioned.

1200. **[bilibili-mcp-js](https://github.com/34892002/bilibili-mcp-js)** - ⭐ 134
   Bilibili video search MCP (Model Context Protocol) service - 哔哩哔哩视频搜索MCP服务

1201. **[autocad-mcp](https://github.com/puran-water/autocad-mcp)** - ⭐ 134
...
1202. **[plane-mcp-server](https://github.com/makeplane/plane-mcp-server)** - ⭐ 134
   Plane's Official Model Context Protocol Server 🔌 ⌨️ 🔥

1203. **[Multi-Source-Media-MCP-Server](https://github.com/Decade-qiu/Multi-Source-Media-MCP-Server)** - ⭐ 133
   An MCP Tool Implementation for Multi-Source Image Access & Generation

1204. **[mcp-server-serper](https://github.com/marcopesani/mcp-server-serper)** - ⭐ 133
   Serper MCP Server supporting search and webpage scraping

1205. **[agent-toolkit](https://github.com/datacommonsorg/agent-toolkit)** - ⭐ 133
   Tools and agents for interacting with the Data Commons Knowledge Graph using the Model Context Protocol (MCP).

1206. **[garmin_mcp](https://github.com/Taxuspt/garmin_mcp)** - ⭐ 133
   MCP server to access Garmin data

1207. **[hayhooks](https://github.com/deepset-ai/hayhooks)** - ⭐ 133
   Easily deploy Haystack pipelines as REST APIs and MCP Tools.

1208. **[zettelkasten-mcp](https://github.com/entanglr/zettelkasten-mcp)** - ⭐ 133
   A Model Context Protocol (MCP) server that implements the Zettelkasten knowledge management methodology, allowing you to create, link, explore and synthesize atomic notes through Claude and other MCP-compatible clients.

1209. **[LMStudio-MCP](https://github.com/infinitimeless/LMStudio-MCP)** - ⭐ 133
   A Model Control Protocol (MCP) server that allows Claude to communicate with locally running LLM models via LM Studio.

1210. **[obsidian-claude-code-mcp](https://github.com/iansinnott/obsidian-claude-code-mcp)** - ⭐ 133
   Connect Claude Code and other AI tools to your Obsidian notes using Model Context Protocol (MCP)

1211. **[mcp-think-tool](https://github.com/DannyMac180/mcp-think-tool)** - ⭐ 132
   An MCP server implementing the think tool for Claude

1212. **[backlog-mcp-server](https://github.com/nulab/backlog-mcp-server)** - ⭐ 132

1213. **[memory-graph](https://github.com/memory-graph/memory-graph)** - ⭐ 132
   A graph DB-based MCP memory server for coding agents with intelligent relationship tracking

1214. **[mcp-server-typescript](https://github.com/dataforseo/mcp-server-typescript)** - ⭐ 132
   DataForSEO API modelcontextprotocol server 

1215. **[code-assistant](https://github.com/stippi/code-assistant)** - ⭐ 132
   An LLM-powered, autonomous coding assistant. Also offers an MCP and ACP mode.

1216. **[mcp-bigquery-server](https://github.com/ergut/mcp-bigquery-server)** - ⭐ 131
   A Model Context Protocol (MCP) server that provides secure, read-only access to BigQuery datasets. Enables Large Language Models (LLMs) to safely query and analyze data through a standardized interface.

1217. **[Gitingest-MCP](https://github.com/puravparab/Gitingest-MCP)** - ⭐ 131
   mcp server for gitingest

1218. **[graphiti-mcp-server](https://github.com/gifflet/graphiti-mcp-server)** - ⭐ 131
   Graphiti MCP Server

1219. **[cupertino](https://github.com/mihaelamj/cupertino)** - ⭐ 131
   A local Apple Documentation crawler and MCP server. Written in Swift.

1220. **[MaxMSP-MCP-Server](https://github.com/tiianhk/MaxMSP-MCP-Server)** - ⭐ 131
   MCP (Model Context Protocol) Server for Max (Max/MSP/Jitter)

1221. **[logfire-mcp](https://github.com/pydantic/logfire-mcp)** - ⭐ 131
   The Logfire MCP Server is here! :tada:

1222. **[mcp-email-server](https://github.com/ai-zerolab/mcp-email-server)** - ⭐ 131
   IMAP and SMTP via MCP Server

1223. **[mcp-server-reddit](https://github.com/Hawstein/mcp-server-reddit)** - ⭐ 130
   A Model Context Protocol (MCP) server that provides tools for fetching Reddit content, including frontpage posts, subreddit information and hot posts, post details, and comments.

1224. **[k8s-mcp-server](https://github.com/reza-gholizade/k8s-mcp-server)** - ⭐ 130
   Manage Your Kubernetes Cluster with k8s mcp-server

1225. **[MCP-PostgreSQL-Ops](https://github.com/call518/MCP-PostgreSQL-Ops)** - ⭐ 130
...
1226. **[frontmcp](https://github.com/agentfront/frontmcp)** - ⭐ 130
   TypeScript-first framework for the Model Context Protocol (MCP). You write clean, typed code; FrontMCP handles the protocol, transport, DI, session/auth, and execution flow.

1227. **[mcp-gateway](https://github.com/acehoss/mcp-gateway)** - ⭐ 130
...
1228. **[N8N2MCP](https://github.com/Super-Chain/N8N2MCP)** - ⭐ 130
   Convert N8N agent / workflow into MCP servers, you can use it in Claude / Cursor / Super Chain 

1229. **[polymarket-mcp-server](https://github.com/caiovicentino/polymarket-mcp-server)** - ⭐ 130
   🤖 AI-Powered MCP Server for Polymarket - Enable Claude to trade prediction markets with 45 tools, real-time monitoring, and enterprise-grade safety features

1230. **[vulnerable-mcp-servers-lab](https://github.com/appsecco/vulnerable-mcp-servers-lab)** - ⭐ 130
   A collection of servers which are deliberately vulnerable to learn Pentesting MCP Servers.

1231. **[ultimate_mcp_server](https://github.com/Dicklesworthstone/ultimate_mcp_server)** - ⭐ 129
   The Ultimate Model Context Protocol (MCP) Server, providing unified access to a wide variety of useful and powerful tools.

1232. **[mcp-chat](https://github.com/Flux159/mcp-chat)** - ⭐ 129
   Open Source Generic MCP Client for testing & evaluating mcp servers and agents

1233. **[mcp-server-guide](https://github.com/figma/mcp-server-guide)** - ⭐ 129
   A guide on how to use the Figma MCP server

1234. **[AgentCrew](https://github.com/saigontechnology/AgentCrew)** - ⭐ 129
   Chat application with multi-agents system supports multi-models and MCP

1235. **[mcp-server-odoo](https://github.com/ivnvxd/mcp-server-odoo)** - ⭐ 129
   A Model Context Protocol (MCP) server that enables AI assistants to securely interact with Odoo ERP systems through standardized resources and tools for data retrieval and manipulation.

1236. **[xhs-mcp-server](https://github.com/aicu-icu/xhs-mcp-server)** - ⭐ 128
   小红书MCP服务器 | 基于Electron+小红书Web API。一键安装运行、极速抓取笔记、评论、用户等数据并让AI智能分析、整理与导出

1237. **[aws-cost-explorer-mcp-server](https://github.com/aarora79/aws-cost-explorer-mcp-server)** - ⭐ 128
   MCP server for understanding AWS spend

1238. **[awesome-crypto-mcp-servers](https://github.com/badkk/awesome-crypto-mcp-servers)** - ⭐ 128
   A collection of crypto MCP servers.

1239. **[freecad_mcp](https://github.com/bonninr/freecad_mcp)** - ⭐ 128
...
1240. **[zotero-mcp](https://github.com/kujenga/zotero-mcp)** - ⭐ 128
   Model Context Protocol (MCP) server for the Zotero API, in Python

1241. **[intervals-mcp-server](https://github.com/mvilanova/intervals-mcp-server)** - ⭐ 128
   Model Context Protocol (MCP) server for connecting Claude and ChatGPT with the Intervals.icu API.

1242. **[mcp-server-aws](https://github.com/rishikavikondala/mcp-server-aws)** - ⭐ 128
   A Model Context Protocol server implementation for operations on AWS resources

1243. **[think-mcp-server](https://github.com/PhillipRt/think-mcp-server)** - ⭐ 127

1244. **[ghost-mcp](https://github.com/MFYDev/ghost-mcp)** - ⭐ 127
   A Model Context Protocol (MCP) server for interacting with Ghost CMS through LLM interfaces like Claude. Allow you to control your Ghost blog by simply asking Claude etc.

1245. **[strudel-mcp-server](https://github.com/williamzujkowski/strudel-mcp-server)** - ⭐ 127
   A Model Context Protocol (MCP) server that gives Claude direct control over Strudel.cc for AI-assisted music generation and live coding.

1246. **[Frappe_Assistant_Core](https://github.com/buildswithpaul/Frappe_Assistant_Core)** - ⭐ 127
   Infrastructure that connects LLMs to ERPNext. Frappe Assistant Core works with the Model Context Protocol (MCP) to expose ERPNext functionality to any compatible Language Model

1247. **[mcp-server-plugin](https://github.com/JetBrains/mcp-server-plugin)** - ⭐ 127
   JetBrains MCP Server Plugin

1248. **[crawl4ai-mcp-server](https://github.com/weidwonder/crawl4ai-mcp-server)** - ⭐ 126
   用于提供给本地开发者的 LLM的高效互联网搜索&内容获取的MCP Server， 节省你的token

1249. **[CreatorBox](https://github.com/xiesx123/CreatorBox)** - ⭐ 126
   🚀🎬 Flexible, efficient, and scalable toolbox for editing and dubbing, unleashing creative potential

1250. **[play-store-mcp](https://github.com/antoniolg/play-store-mcp)** - ⭐ 126
   An MCP server that connects to Play Store Console and release new App versions from an MCP Client

1251. **[mcp-server-manifest](https://github.com/Zomato/mcp-server-manifest)** - ⭐ 126

1252. **[A2A-MCP-Server](https://github.com/GongRzhe/A2A-MCP-Server)** - ⭐ 126
...
1253. **[magg](https://github.com/sitbon/magg)** - ⭐ 126
   Magg: The MCP Aggregator

1254. **[claude-prompts-mcp](https://github.com/minipuft/claude-prompts-mcp)** - ⭐ 126
   MCP prompt template server: hot-reload, thinking frameworks, quality gates

1255. **[mcp-server-macos-use](https://github.com/mediar-ai/mcp-server-macos-use)** - ⭐ 125
   AI agent that controls computer with OS-level tools, MCP compatible, works with any model

1256. **[zabbix-mcp-server](https://github.com/mpeirone/zabbix-mcp-server)** - ⭐ 125
...
1257. **[play-store-mcp](https://github.com/devexpert-io/play-store-mcp)** - ⭐ 125
   An MCP server that connects to Play Store Console and release new App versions from an MCP Client

1258. **[dart-mcp-server](https://github.com/its-dart/dart-mcp-server)** - ⭐ 125
   Dart AI Model Context Protocol (MCP) server

1259. **[mcp-server-apache-airflow](https://github.com/yangkyeongmo/mcp-server-apache-airflow)** - ⭐ 125

1260. **[specs-workflow-mcp](https://github.com/kingkongshot/specs-workflow-mcp)** - ⭐ 125
   Intelligent spec workflow management MCP server

1261. **[codeql-mcp](https://github.com/JordyZomer/codeql-mcp)** - ⭐ 124
...
1262. **[mcp-client-server](https://github.com/willccbb/mcp-client-server)** - ⭐ 124
   An MCP Server that's also an MCP Client. Useful for letting Claude develop and test MCPs without needing to reset the application.

1263. **[dify-plugin-agent-mcp_sse](https://github.com/junjiem/dify-plugin-agent-mcp_sse)** - ⭐ 124
   Dify 1.0 Plugin Support MCP Tools Agent strategies

1264. **[mcp-evals](https://github.com/mclenhard/mcp-evals)** - ⭐ 124
   A Node.js package and GitHub Action for evaluating MCP (Model Context Protocol) tool implementations using LLM-based scoring. This helps ensure your MCP server's tools are working correctly and performing well.

1265. **[mcp-server-ccxt](https://github.com/doggybee/mcp-server-ccxt)** - ⭐ 124
   High-performance CCXT MCP server for cryptocurrency exchange integration

1266. **[buttplug-mcp](https://github.com/ConAcademy/buttplug-mcp)** - ⭐ 123
   Buttplug.io Model Context Protocol (MCP) Server

1267. **[laravel-loop](https://github.com/kirschbaum-development/laravel-loop)** - ⭐ 123
   Laravel Loop is a powerful Model Context Protocol (MCP) server designed specifically for Laravel applications. It connects your Laravel application with AI assistants using the MCP protocol.

1268. **[ZotLink](https://github.com/TonybotNi/ZotLink)** - ⭐ 123
...
1269. **[mcp-linear](https://github.com/tacticlaunch/mcp-linear)** - ⭐ 123
...
1270. **[Human-In-the-Loop-MCP-Server](https://github.com/GongRzhe/Human-In-the-Loop-MCP-Server)** - ⭐ 123
...
1271. **[ollama-mcp](https://github.com/rawveg/ollama-mcp)** - ⭐ 123
   An MCP Server for Ollama

1272. **[OmniFocus-MCP](https://github.com/themotionmachine/OmniFocus-MCP)** - ⭐ 123
   Let LLMs interface with your tasks and projects through the Model Context Protocol. Add, organize, and query your OmniFocus database with natural language commands.

1273. **[esp-mcp](https://github.com/horw/esp-mcp)** - ⭐ 123
   Centralize ESP32 related commands and simplify getting started with seamless, LLM-driven interaction and help.

1274. **[mcp-rubber-duck](https://github.com/nesquikm/mcp-rubber-duck)** - ⭐ 122
   An MCP server that acts as a bridge to query multiple OpenAI-compatible LLMs with MCP tool access. Just like rubber duck debugging, explain your problems to various AI "ducks" who can actually research and get different perspectives!

1275. **[mcp-svelte-docs](https://github.com/spences10/mcp-svelte-docs)** - ⭐ 122
   🔍 MCP server that lets you search and access Svelte documentation with built-in caching

1276. **[linear-mcp](https://github.com/cline/linear-mcp)** - ⭐ 122
   a private MCP server for accessing Linear

1277. **[zig-mcp](https://github.com/zig-wasm/zig-mcp)** - ⭐ 122
   Model Context Protocol (MCP) server that provides up-to-date documentation for the Zig programming language standard library and builtin functions

1278. **[beyond-mcp](https://github.com/disler/beyond-mcp)** - ⭐ 122
   It's time to push beyond MCP Servers... Right?

1279. **[mcp-read-website-fast](https://github.com/just-every/mcp-read-website-fast)** - ⭐ 122
   Quickly reads webpages and converts to markdown for fast, token efficient web scraping

1280. **[mcp](https://github.com/pronskiy/mcp)** - ⭐ 121
   🐉 The fast, PHP way to build MCP servers

1281. **[muppet](https://github.com/muppet-dev/muppet)** - ⭐ 121
   MCP Servers SDK for TypeScript

1282. **[unreal-analyzer-mcp](https://github.com/ayeletstudioindia/unreal-analyzer-mcp)** - ⭐ 121
   MCP server for Unreal Engine 5

1283. **[tiktok-mcp](https://github.com/Seym0n/tiktok-mcp)** - ⭐ 121
   Model Context Protocol (MCP) with TikTok integration

1284. **[mevzuat-mcp](https://github.com/saidsurucu/mevzuat-mcp)** - ⭐ 121
   MCP Server for Searching Turkish Legislation

1285. **[penpot-mcp](https://github.com/penpot/penpot-mcp)** - ⭐ 121
   Penpot's official MCP Server

1286. **[mcp-streamable-http](https://github.com/invariantlabs-ai/mcp-streamable-http)** - ⭐ 121
   Example implementation of MCP Streamable HTTP client/server in Python and TypeScript.

1287. **[life-sciences](https://github.com/anthropics/life-sciences)** - ⭐ 121
...
1288. **[mcp_server_exe](https://github.com/shadowcz007/mcp_server_exe)** - ⭐ 120
   小智 & Cursor 的 MCP 启动器 - MCP For Cursor&xiaozhi。打包成可执行文件。Turn MCP server into an executable file

1289. **[mcp-server-bigquery](https://github.com/LucasHild/mcp-server-bigquery)** - ⭐ 120
   A Model Context Protocol server that provides access to BigQuery

1290. **[UnityMCP](https://github.com/isuzu-shiranui/UnityMCP)** - ⭐ 120
   Unity Editor integration with Model Context Protocol (MCP) enabling AI assistants like Claude to interact with Unity projects. Features a TypeScript MCP server and C# Unity plugin with extensible command handler architecture, TCP/IP communication, and dynamic plugin discovery.

1291. **[radare2-mcp](https://github.com/radareorg/radare2-mcp)** - ⭐ 120
   MCP stdio server for radare2

1292. **[aws-lambda-mcp-cookbook](https://github.com/ran-isenberg/aws-lambda-mcp-cookbook)** - ⭐ 120
...
1293. **[concierge](https://github.com/concierge-hq/concierge)** - ⭐ 120
   Open Source AI platform to build Agentic workflows, MCP servers and ChatGPT apps 

1294. **[mcp-endpoint-server](https://github.com/xinnan-tech/mcp-endpoint-server)** - ⭐ 119
   xiaozhi mcp接入点服务器，用于自定义mcp服务注册，方便拓展小智服务端工具调用

1295. **[n8n-mcp-server](https://github.com/illuminaresolutions/n8n-mcp-server)** - ⭐ 119
   MCP server implementation for n8n workflow automation

1296. **[ffmpeg-mcp](https://github.com/egoist/ffmpeg-mcp)** - ⭐ 119
   An MCP server for FFmpeg

1297. **[mcp-package-version](https://github.com/sammcj/mcp-package-version)** - ⭐ 119
   An MCP server that provides LLMs with the latest stable package versions when coding

1298. **[mcp-apache-spark-history-server](https://github.com/kubeflow/mcp-apache-spark-history-server)** - ⭐ 119
   MCP Server for Apache Spark History Server. The bridge between Agentic AI and Apache Spark.

1299. **[aicode-toolkit](https://github.com/AgiFlow/aicode-toolkit)** - ⭐ 119
   Toolkit for Coding Agents to work reliably with repo of any size.

1300. **[paiml-mcp-agent-toolkit](https://github.com/paiml/paiml-mcp-agent-toolkit)** - ⭐ 117
   Pragmatic AI Labs MCP Agent Toolkit - An MCP Server designed to make code with agents more deterministic

1301. **[mcp-server-datadog](https://github.com/winor30/mcp-server-datadog)** - ⭐ 117

1302. **[mcp-server-salesforce](https://github.com/tsmztech/mcp-server-salesforce)** - ⭐ 117
   Salesforce MCP Server

1303. **[remote-mcp-functions-dotnet](https://github.com/Azure-Samples/remote-mcp-functions-dotnet)** - ⭐ 116
...
1304. **[elevenlabs-mcp-server](https://github.com/mamertofabian/elevenlabs-mcp-server)** - ⭐ 116

1305. **[mcp-server](https://github.com/browserstack/mcp-server)** - ⭐ 116
   BrowserStack's Official MCP Server

1306. **[mcp-watch](https://github.com/kapilduraphe/mcp-watch)** - ⭐ 116
   A comprehensive security scanner for Model Context Protocol (MCP) servers that detects vulnerabilities and security issues in your MCP server implementations.

1307. **[kodit](https://github.com/helixml/kodit)** - ⭐ 115
   👩‍💻 MCP server to index external repositories

1308. **[VisionCraft-MCP-Server](https://github.com/augmentedstartups/VisionCraft-MCP-Server)** - ⭐ 115
...
1309. **[ssh-mcp-server](https://github.com/classfang/ssh-mcp-server)** - ⭐ 115
   基于 SSH 的 MCP 服务器 🧙‍♀️。已被MCP官方收录 🎉。 SSH MCP Server 🧙‍♀️. It has been included in the community MCP repository 🎉.

1310. **[sudocode](https://github.com/sudocode-ai/sudocode)** - ⭐ 115
   Lightweight agent orchestration dev tool that lives in your repo

1311. **[jupyter-notebook-mcp](https://github.com/jjsantos01/jupyter-notebook-mcp)** - ⭐ 114
   A Model Context Protocol (MCP) for Jupyter Notebook

1312. **[mcp_proxy_rust](https://github.com/tidewave-ai/mcp_proxy_rust)** - ⭐ 114
   A proxy to use HTTP/SSE MCPs from STDIO clients

1313. **[MakerAi](https://github.com/gustavoeenriquez/MakerAi)** - ⭐ 114
...
1314. **[codex-mcp-server](https://github.com/cexll/codex-mcp-server)** - ⭐ 114
   Codex Mcp Server 

1315. **[mcp-devtools](https://github.com/sammcj/mcp-devtools)** - ⭐ 114
   A modular MCP server that provides commonly used developer tools for AI coding agents

1316. **[MCppServer](https://github.com/Noeli14/MCppServer)** - ⭐ 114
   Fast and super efficient Minecraft Server written in C++

1317. **[shopify-mcp](https://github.com/GeLi2001/shopify-mcp)** - ⭐ 114
   MCP server for Shopify api, usable on mcp hosts such as Claude and Cursor

1318. **[memorizer-v1](https://github.com/petabridge/memorizer-v1)** - ⭐ 114
   Vector-search powered agent memory MCP server

1319. **[seo-research-mcp](https://github.com/egebese/seo-research-mcp)** - ⭐ 114
...
1320. **[mcp-server](https://github.com/InterviewReady/mcp-server)** - ⭐ 113
   An MCP server for InterviewReady

1321. **[mcp-hubspot](https://github.com/peakmojo/mcp-hubspot)** - ⭐ 113
   A Model Context Protocol (MCP) server that enables AI assistants to interact with HubSpot CRM data, providing built-in vector storage and caching mechanisms help overcome HubSpot API limitations while improving response times.

1322. **[cli](https://github.com/mcpgod/cli)** - ⭐ 113
   Fine-grained control over model context protocol (MCP) clients, servers, and tools. Context is God.

1323. **[mcp-server-asana](https://github.com/roychri/mcp-server-asana)** - ⭐ 113

1324. **[MCP2Lambda](https://github.com/danilop/MCP2Lambda)** - ⭐ 112
   Run any AWS Lambda function as a Large Language Model (LLM) tool without code changes using Anthropic's Model Context Protocol (MCP).

1325. **[mcp-mianshiya-server](https://github.com/yuyuanweb/mcp-mianshiya-server)** - ⭐ 112
   基于 Spring AI 的面试鸭搜索题目的 MCP Server 服务，快速让 AI 搜索企业面试真题和答案

1326. **[swagger-mcp](https://github.com/dcolley/swagger-mcp)** - ⭐ 112
   Swagger to MCP server

1327. **[SmartDB_MCP](https://github.com/wenb1n-dev/SmartDB_MCP)** - ⭐ 112
...
1328. **[rust-mcp-filesystem](https://github.com/rust-mcp-stack/rust-mcp-filesystem)** - ⭐ 112
   Blazing-fast, asynchronous MCP server for seamless filesystem operations.

1329. **[notion-mcp](https://github.com/ccabanillas/notion-mcp)** - ⭐ 111
   A Model Context Protocol (MCP) server implementation for Notion integration, providing a standardized interface for interacting with Notion's API.

1330. **[punkpeye_awesome-mcp-servers](https://github.com/MCP-Mirror/punkpeye_awesome-mcp-servers)** - ⭐ 111
   Mirror of https://github.com/punkpeye/awesome-mcp-servers

1331. **[Deepseek-Thinking-Claude-3.5-Sonnet-CLINE-MCP](https://github.com/newideas99/Deepseek-Thinking-Claude-3.5-Sonnet-CLINE-MCP)** - ⭐ 111
...
1332. **[iphone-mcp](https://github.com/Lakr233/iphone-mcp)** - ⭐ 111
...
1333. **[remote-mcp-apim-functions-python](https://github.com/Azure-Samples/remote-mcp-apim-functions-python)** - ⭐ 111
   Azure API Management as AI Gateway to Remote MCP servers.

1334. **[teslamate-mcp](https://github.com/cobanov/teslamate-mcp)** - ⭐ 111
   A Model Context Protocol (MCP) server that provides access to your TeslaMate database, allowing AI assistants to query Tesla vehicle data and analytics.

1335. **[mcpauth](https://github.com/mcpauth/mcpauth)** - ⭐ 111
   Authentication for MCP Servers

1336. **[mcp](https://github.com/MariaDB/mcp)** - ⭐ 111
   MariaDB MCP (Model Context Protocol) server implementation

1337. **[paperless-mcp](https://github.com/nloui/paperless-mcp)** - ⭐ 111
   An MCP (Model Context Protocol) server for interacting with a Paperless-NGX API server. This server provides tools for managing documents, tags, correspondents, and document types in your Paperless-NGX instance.

1338. **[turbo-flow-claude](https://github.com/marcuspat/turbo-flow-claude)** - ⭐ 111
...
1339. **[mcp-jfrog](https://github.com/jfrog/mcp-jfrog)** - ⭐ 110
   Model Context Protocol (MCP) Server for the JFrog Platform API, enabling repository management, build tracking, release lifecycle management, and more.

1340. **[google-sheets-mcp](https://github.com/mkummer225/google-sheets-mcp)** - ⭐ 110
   Google Sheets MCP Server 📊🤖

1341. **[computer-use-mcp](https://github.com/domdomegg/computer-use-mcp)** - ⭐ 110
   💻 Give AI models complete control of your computer (probably a bad idea)

1342. **[unifi-network-mcp](https://github.com/sirkirby/unifi-network-mcp)** - ⭐ 110
   MCP server implementation for the UniFi network application

1343. **[foxy-contexts](https://github.com/strowk/foxy-contexts)** - ⭐ 110
   Foxy contexts is a library for building context servers supporting Model Context Protocol

1344. **[MCP-oura](https://github.com/YuzeHao2023/MCP-oura)** - ⭐ 110
   MCP server for Oura API integration

1345. **[mcp-victoriametrics](https://github.com/VictoriaMetrics-Community/mcp-victoriametrics)** - ⭐ 110
   The implementation of Model Context Protocol (MCP) server for VictoriaMetrics

1346. **[server-wp-mcp](https://github.com/emzimmer/server-wp-mcp)** - ⭐ 110

1347. **[SwiftMCP](https://github.com/Cocoanetics/SwiftMCP)** - ⭐ 110
   Model Context Protocol Server for Swift

1348. **[mcp-ts-template](https://github.com/cyanheads/mcp-ts-template)** - ⭐ 110
...
1349. **[hub-mcp](https://github.com/docker/hub-mcp)** - ⭐ 110
   Docker Hub MCP Server

1350. **[matlab-mcp-core-server](https://github.com/matlab/matlab-mcp-core-server)** - ⭐ 110
   Run MATLAB® using AI applications with the official MATLAB MCP Server from MathWorks®. This MCP server for MATLAB supports a wide range of coding agents like Claude Code® and Visual Studio® Code.

1351. **[linux-mcp-server](https://github.com/rhel-lightspeed/linux-mcp-server)** - ⭐ 110
   Tools to allow LLM clients to interact with Linux systems remotely

1352. **[google-workspace-mcp](https://github.com/aaronsb/google-workspace-mcp)** - ⭐ 109
   A Model Context Protocol (MCP) server that provides authenticated access to Google Workspace APIs, offering integrated Authentication, Gmail, Calendar, and Drive functionality

1353. **[livebook_tools](https://github.com/thmsmlr/livebook_tools)** - ⭐ 109
   Powertools for livebook.dev — AI Code Editing, MCP Servers, and Running Livebooks from the CLI

1354. **[ffmpeg-mcp](https://github.com/video-creator/ffmpeg-mcp)** - ⭐ 109
...
1355. **[xcodeproj-mcp-server](https://github.com/giginet/xcodeproj-mcp-server)** - ⭐ 109
   A Model Context Protocol Server to manipulate *.xcodeproj

1356. **[vscode-as-mcp-server](https://github.com/acomagu/vscode-as-mcp-server)** - ⭐ 109
...
1357. **[MCP-searxng](https://github.com/SecretiveShell/MCP-searxng)** - ⭐ 109
   MCP server for connecting agentic systems to search systems via searXNG

1358. **[modex](https://github.com/theronic/modex)** - ⭐ 108
   Modex is a Clojure MCP Library to augment your AI models with Tools, Resources & Prompts using Clojure (Model Context Protocol). Implements MCP Server & Client.

1359. **[share-best-mcp](https://github.com/shareAI-lab/share-best-mcp)** - ⭐ 108
   世界上最好的MCP Servers的列表,The best mcp servers in the world.

1360. **[minesweeper-mcp-server](https://github.com/tonypan2/minesweeper-mcp-server)** - ⭐ 108
   An MCP server for playing Minesweeper

1361. **[OpenSCAD-MCP-Server](https://github.com/jhacksman/OpenSCAD-MCP-Server)** - ⭐ 108
   Devin's attempt at creating an OpenSCAD MCP Server that takes a user prompt and generates a preview image and 3d file.

1362. **[mcp-memory](https://github.com/Puliczek/mcp-memory)** - ⭐ 108
...
1363. **[mcp-server](https://github.com/bitwarden/mcp-server)** - ⭐ 108
   MCP server for interaction with Bitwarden.

1364. **[DINO-X-MCP](https://github.com/IDEA-Research/DINO-X-MCP)** - ⭐ 107
   Official DINO-X Model Context Protocol (MCP) server that empowers LLMs with real-world visual perception through image object detection, localization, and captioning APIs.

1365. **[apple-rag-mcp](https://github.com/BingoWon/apple-rag-mcp)** - ⭐ 107
    MCP server providing AI agents with instant access to Apple developer documentation via RAG technology

1366. **[netbox-mcp-server](https://github.com/netboxlabs/netbox-mcp-server)** - ⭐ 107
   Model Context Protocol (MCP) server for read-only interaction with NetBox data in LLMs

1367. **[Easy-MCP-AutoCad](https://github.com/zh19980811/Easy-MCP-AutoCad)** - ⭐ 107
   这个项目是一个基于Model Context Protocol (MCP)的AutoCAD集成服务器，它允许通过自然语言与AutoCAD进行交互。通过这个服务器，用户可以使用Claude等大型语言模型来创建、修改和分析AutoCAD图纸，同时还可以存储和查询CAD元素的相关数据。目前制作参考学习，仅实现端到端之间的通信，具体工具函数尚未晚上

1368. **[pentest-mcp](https://github.com/DMontgomery40/pentest-mcp)** - ⭐ 107
   NOT for educational purposes: An MCP server for professional penetration testers including STDIO/HTTP/SSE support, nmap, go/dirbuster, nikto, JtR, hashcat, wordlist building, and more.

1369. **[mcpproxy-go](https://github.com/smart-mcp-proxy/mcpproxy-go)** - ⭐ 106
   Supercharge AI Agents, Safely

1370. **[slack-mcp-server](https://github.com/ubie-oss/slack-mcp-server)** - ⭐ 106
   A Slack MCP server

1371. **[mcp-probe](https://github.com/conikeec/mcp-probe)** - ⭐ 106
   A Model Context Protocol (MCP) client library and debugging toolkit in Rust. This foundation provides both a production-ready SDK for building MCP integrations and the core architecture for an interactive debugger.

1372. **[ai-command](https://github.com/mcp-wp/ai-command)** - ⭐ 106
   Control WordPress using WP-CLI, AI, and MCP.

1373. **[drawio2go](https://github.com/Menghuan1918/drawio2go)** - ⭐ 106
   A modern DrawIO editor application.  AI-Powered, Human-AI Collaboration | AI 加持，人机共绘drawio

1374. **[crypto-indicators-mcp](https://github.com/kukapay/crypto-indicators-mcp)** - ⭐ 105
   An MCP server providing a range of cryptocurrency technical analysis indicators and strategies.

1375. **[mcp-redmine](https://github.com/runekaagaard/mcp-redmine)** - ⭐ 105
   A redmine MCP server covering close to 100% of redmines API

1376. **[payloadcmsmcp](https://github.com/disruption-hub/payloadcmsmcp)** - ⭐ 105
   Payload CMS MCP Server

1377. **[mcp_client](https://github.com/theailanguage/mcp_client)** - ⭐ 105
   MCP Client Implementation using Python, LangGraph and Gemini

1378. **[easy-code-reader](https://github.com/FangYuan33/easy-code-reader)** - ⭐ 105
   A powerful MCP (Model Context Protocol) server for intelligently reading Java source code.

1379. **[gRPC-zig](https://github.com/ziglana/gRPC-zig)** - ⭐ 105
   blazigly fast gRPC/MCP client & server implementation in zig

1380. **[aks-mcp](https://github.com/Azure/aks-mcp)** - ⭐ 105
   A Model Context Protocol (MCP) server that enables AI assistants to interact with AKS clusters. It serves as a bridge between AI tools (like Claude, Cursor, and GitHub Copilot) and AKS.

1381. **[Fabric-Analytics-MCP](https://github.com/santhoshravindran7/Fabric-Analytics-MCP)** - ⭐ 105
...
1382. **[mcp-tool-kit](https://github.com/getfounded/mcp-tool-kit)** - ⭐ 105
   Agentic abstraction layer for building high precision vertical AI agents written in python for Model Context Protocol.

1383. **[mcp-client](https://github.com/punkpeye/mcp-client)** - ⭐ 105
   An MCP client for Node.js.

1384. **[mcp-checkpoint](https://github.com/aira-security/mcp-checkpoint)** - ⭐ 105
...
1385. **[smileyCoin](https://github.com/fefergrgrgrg/smileyCoin)** - ⭐ 104
   simple web ui to manage mcp (model context protocol) servers in the claude app

1386. **[gemini-desktop](https://github.com/kkrishnan90/gemini-desktop)** - ⭐ 104
...
1387. **[selfhosted-supabase-mcp](https://github.com/HenkDz/selfhosted-supabase-mcp)** - ⭐ 104
   An MCP Server for your Self Hosted Supabase

1388. **[gemini-cli-mcp-server](https://github.com/centminmod/gemini-cli-mcp-server)** - ⭐ 104

1389. **[oracle-mcp-server](https://github.com/danielmeppiel/oracle-mcp-server)** - ⭐ 104
   MCP Server for working with large Oracle databases

1390. **[sourcerer-mcp](https://github.com/st3v3nmw/sourcerer-mcp)** - ⭐ 104
   MCP for semantic code search & navigation that reduces token waste

1391. **[mcp-bsl-platform-context](https://github.com/alkoleft/mcp-bsl-platform-context)** - ⭐ 104
   MCP сервер для AI-ассистентов (справка по синтаксису и объектной модели 1С:Предприятие)

1392. **[memory-bank-MCP](https://github.com/tuncer-byte/memory-bank-MCP)** - ⭐ 103
...
1393. **[mcp](https://github.com/frappe/mcp)** - ⭐ 103
   Frappe MCP allows Frappe apps to function as MCP servers

1394. **[solana-mcp](https://github.com/solanamcp/solana-mcp)** - ⭐ 103
   Solana Agent Kit MCP Server 

1395. **[neurolink](https://github.com/juspay/neurolink)** - ⭐ 103
   Universal AI Development Platform with MCP server integration, multi-provider support, and professional CLI. Build, test, and deploy AI applications with multiple ai providers.

1396. **[game-asset-mcp](https://github.com/MubarakHAlketbi/game-asset-mcp)** - ⭐ 103
   An MCP server for creating 2D/3D game assets from text using Hugging Face AI models.

1397. **[awesome-context-engineering](https://github.com/jihoo-kim/awesome-context-engineering)** - ⭐ 103
...
1398. **[dash-mcp-server](https://github.com/Kapeli/dash-mcp-server)** - ⭐ 103
   MCP server for Dash, the macOS documentation browser

1399. **[swiftlens](https://github.com/swiftlens/swiftlens)** - ⭐ 103
...
1400. **[isaac-sim-mcp](https://github.com/omni-mcp/isaac-sim-mcp)** - ⭐ 103
   Isaac Simulation MCP Extension and Server

1401. **[mcp.science](https://github.com/pathintegral-institute/mcp.science)** - ⭐ 103
   Open Source MCP Servers for Scientific Research

1402. **[memory-mcp-server](https://github.com/okooo5km/memory-mcp-server)** - ⭐ 102
   A Model Context Protocol server that provides knowledge graph management capabilities. 

1403. **[a2a-mcp-tutorial](https://github.com/Tsadoq/a2a-mcp-tutorial)** - ⭐ 102
   A tutorial on how to use Model Context Protocol by Anthropic and Agent2Agent Protocol by Google

1404. **[csharp-runner](https://github.com/sdcb/csharp-runner)** - ⭐ 102
   fast, secure c# runner

1405. **[deep-code-reasoning-mcp](https://github.com/haasonsaas/deep-code-reasoning-mcp)** - ⭐ 102
   A Model Context Protocol (MCP) server that provides advanced code analysis and reasoning capabilities powered by Google's Gemini AI

1406. **[erickwendel-contributions-mcp](https://github.com/ErickWendel/erickwendel-contributions-mcp)** - ⭐ 102
   A Model Context Protocol (MCP) server that provides tools to query Erick Wendel's contributions across different platforms

1407. **[raindrop-mcp](https://github.com/adeze/raindrop-mcp)** - ⭐ 102
   Raindrop MCP Server

1408. **[mcpm](https://github.com/MCP-Club/mcpm)** - ⭐ 102
...
1409. **[agentcare-mcp](https://github.com/Kartha-AI/agentcare-mcp)** - ⭐ 102
   MCP Server for EMRs with FHIR

1410. **[NornicDB](https://github.com/orneryd/NornicDB)** - ⭐ 102
...
1411. **[aseprite-mcp](https://github.com/diivi/aseprite-mcp)** - ⭐ 102
   MCP server for interacting with the Aseprite API

1412. **[server-google-news](https://github.com/ChanMeng666/server-google-news)** - ⭐ 102
   【Star-crossed coders unite!⭐️】Model Context Protocol (MCP) server implementation providing Google News search capabilities via SerpAPI, with automatic news categorization and multi-language support.

1413. **[mcp-prompts](https://github.com/sparesparrow/mcp-prompts)** - ⭐ 101
   Model Context Protocol server for managing, storing, and providing prompts and prompt templates for LLM interactions. 

1414. **[vectorize-mcp-server](https://github.com/vectorize-io/vectorize-mcp-server)** - ⭐ 101
   Official Vectorize MCP Server

1415. **[http-oauth-mcp-server](https://github.com/NapthaAI/http-oauth-mcp-server)** - ⭐ 101
...
1416. **[chronulus-mcp](https://github.com/ChronulusAI/chronulus-mcp)** - ⭐ 101
   MCP Server for Chronulus AI Forecasting and Prediction Agents

1417. **[freqtrade-mcp](https://github.com/kukapay/freqtrade-mcp)** - ⭐ 101
   An MCP server that integrates with the Freqtrade cryptocurrency trading bot.

1418. **[remote-mcp-functions](https://github.com/Azure-Samples/remote-mcp-functions)** - ⭐ 101
   Landing page for Remote MCP Server efforts in Azure Functions with links to all language stack specific repos.

1419. **[btp-sap-odata-to-mcp-server](https://github.com/lemaiwo/btp-sap-odata-to-mcp-server)** - ⭐ 101
   BTP CloudFoundry Node.js MCP server for SAP OData services integration

1420. **[claude-code-mcp-enhanced](https://github.com/grahama1970/claude-code-mcp-enhanced)** - ⭐ 101
...
1421. **[polymarket-mcp](https://github.com/berlinbra/polymarket-mcp)** - ⭐ 101
   MCP Server for PolyMarket API

1422. **[railway-mcp-server](https://github.com/railwayapp/railway-mcp-server)** - ⭐ 101
   Official Railway MCP Server for interacting with your Railway account

1423. **[-mcp-to-skill-converter](https://github.com/GBSOSS/-mcp-to-skill-converter)** - ⭐ 100
      Convert any MCP server into a Claude Skill with 90% context savings

1424. **[mcp-hono-stateless](https://github.com/mhart/mcp-hono-stateless)** - ⭐ 100
   An example Hono MCP server using Streamable HTTP

1425. **[Wazuh-MCP-Server](https://github.com/gensecaihq/Wazuh-MCP-Server)** - ⭐ 100
...
1426. **[portainer-mcp](https://github.com/portainer/portainer-mcp)** - ⭐ 100
   Portainer MCP server

1427. **[AgentBoard](https://github.com/igrigorik/AgentBoard)** - ⭐ 100
...
1428. **[spring-documentation-mcp-server](https://github.com/andrlange/spring-documentation-mcp-server)** - ⭐ 100
   Spring Boot based MCP Server provide full Spring Ecosystem Documentation for LLMs

1429. **[mcp-windows-desktop-automation](https://github.com/mario-andreschak/mcp-windows-desktop-automation)** - ⭐ 100
   A Model Context Protocol (MCP) server for Windows desktop automation using AutoIt.

1430. **[ableton-mcp-extended](https://github.com/uisato/ableton-mcp-extended)** - ⭐ 99
   Ableton Live MCP (Model Context Protocol) server that allows control directly through AI assistants.

1431. **[mcp](https://github.com/taskade/mcp)** - ⭐ 99
   🤖 Taskade MCP · Official MCP server and OpenAPI to MCP codegen. Build AI agent tools from any OpenAPI API and connect to Claude, Cursor, and more.

1432. **[sample-agentic-ai-demos](https://github.com/aws-samples/sample-agentic-ai-demos)** - ⭐ 99
   Collection of examples of how to use Model Context Protocol with AWS.

1433. **[next-mcp-server](https://github.com/vertile-ai/next-mcp-server)** - ⭐ 99
   Help LLMs to understand your Next apps better

1434. **[complete-intro-to-mcp](https://github.com/btholt/complete-intro-to-mcp)** - ⭐ 99
   The Complete Intro to MCP Servers, as taught for Frontend Masters by Brian Holt

1435. **[turbular](https://github.com/raeudigerRaeffi/turbular)** - ⭐ 99
   A MCP server allowing LLM agents to easily connect and retrieve data from any database

1436. **[pywss](https://github.com/czasg/pywss)** - ⭐ 99
   一个轻量级的 Python Web 框架，一站式集成 MCP SSE、StreamHTTP 和 MCPO 协议，助你轻松构建MCP Server🔥

1437. **[mighty-security](https://github.com/NineSunsInc/mighty-security)** - ⭐ 99
   Don't Simply Trust MCP Server Code, Validate and Scan

1438. **[autodev-codebase](https://github.com/anrgct/autodev-codebase)** - ⭐ 99
...
1439. **[mcp-virustotal](https://github.com/BurtTheCoder/mcp-virustotal)** - ⭐ 99
   A Model Context Protocol (MCP) server for querying the VirusTotal API.

1440. **[mcp-server-atlassian-bitbucket](https://github.com/aashari/mcp-server-atlassian-bitbucket)** - ⭐ 99
   Node.js/TypeScript MCP server for Atlassian Bitbucket. Enables AI systems (LLMs) to interact with workspaces, repositories, and pull requests via tools (list, get, comment, search). Connects AI directly to version control workflows through the standard MCP interface.

1441. **[mcp-typescript-sdk](https://github.com/emqx/mcp-typescript-sdk)** - ⭐ 98
   A TypeScript SDK for implementing Model Context Protocol (MCP) over MQTT, supporting both browser and Node.js environments.

1442. **[mcp-sse-demo](https://github.com/cnych/mcp-sse-demo)** - ⭐ 98
   claude mcp sse demo with server and client(cli、web)

1443. **[mcp_on_ruby](https://github.com/rubyonai/mcp_on_ruby)** - ⭐ 98
   💎 A Ruby implementation of the Model Context Protocol

1444. **[mcp-shodan](https://github.com/BurtTheCoder/mcp-shodan)** - ⭐ 98
   MCP server for querying the Shodan API

1445. **[atomic-red-team-mcp](https://github.com/cyberbuff/atomic-red-team-mcp)** - ⭐ 98
   MCP server for Atomic Red Team

1446. **[mcp-client-nodejs](https://github.com/ConardLi/mcp-client-nodejs)** - ⭐ 98
   Node.js Client Implementation for Model Context Protocol (MCP)

1447. **[sqlite-explorer-fastmcp-mcp-server](https://github.com/hannesrudolph/sqlite-explorer-fastmcp-mcp-server)** - ⭐ 97
   An MCP server that provides safe, read-only access to SQLite databases through Model Context Protocol (MCP). This server is built with the FastMCP framework, which enables LLMs to explore and query SQLite databases with built-in safety features and query validation.

1448. **[gtasks-mcp](https://github.com/zcaceres/gtasks-mcp)** - ⭐ 97
   A Google Tasks Model Context Protocol Server for Claude

1449. **[finance-trading-ai-agents-mcp](https://github.com/aitrados/finance-trading-ai-agents-mcp)** - ⭐ 97
...
1450. **[IntelliConnect](https://github.com/ruanrongman/IntelliConnect)** - ⭐ 97
   本项目为xiaozhi-esp32提供后端服务  |  A Powerful AI agent IoT platform core.

1451. **[all-in-one-model-context-protocol](https://github.com/nguyenvanduocit/all-in-one-model-context-protocol)** - ⭐ 96
   🚀 All-in-one MCP server with AI search, RAG, and multi-service integrations (GitLab/Jira/Confluence/YouTube) for AI-enhanced development workflows

1452. **[MiniMax-MCP-JS](https://github.com/MiniMax-AI/MiniMax-MCP-JS)** - ⭐ 96
   Official MiniMax Model Context Protocol (MCP) JavaScript implementation that provides seamless integration with MiniMax's powerful AI capabilities including image generation, video generation, text-to-speech, and voice cloning APIs.

1453. **[searxng-mul-mcp](https://github.com/jae-jae/searxng-mul-mcp)** - ⭐ 96
   A Model Context Protocol (MCP) server for SearXNG search engine with multi-query parallel search support

1454. **[mcp-local-rag](https://github.com/nkapila6/mcp-local-rag)** - ⭐ 96
   "primitive" RAG-like web search model context protocol (MCP) server that runs locally. ✨ no APIs ✨

1455. **[gemini-mcp-desktop-client](https://github.com/duke7able/gemini-mcp-desktop-client)** - ⭐ 96
   first gemini based desktop client for MCP

1456. **[mcp-kit](https://github.com/my-mcp-hub/mcp-kit)** - ⭐ 95
   A CLI tool to create MCP (Model Context Protocol) applications with ease.

1457. **[awesome-mcp-enterprise](https://github.com/bh-rat/awesome-mcp-enterprise)** - ⭐ 95
   A curated list of awesome MCP (Model Context Protocol) tools, platforms, and services for enterprises.

1458. **[systemprompt-mcp-server](https://github.com/systempromptio/systemprompt-mcp-server)** - ⭐ 95
...
1459. **[mcp-server](https://github.com/webflow/mcp-server)** - ⭐ 95
   Model Context Protocol (MCP) server for the Webflow Data API.

1460. **[ruby-mcp-client](https://github.com/simonx1/ruby-mcp-client)** - ⭐ 94
   This is a Ruby implementation of MCP (Model Context Protocol) client

1461. **[typst-mcp](https://github.com/johannesbrandenburger/typst-mcp)** - ⭐ 94
   Typst MCP Server is an MCP (Model Context Protocol) implementation that helps AI models interact with Typst, a markup-based typesetting system. The server provides tools for converting between LaTeX and Typst, validating Typst syntax, and generating images from Typst code.

1462. **[terminal-controller-mcp](https://github.com/GongRzhe/terminal-controller-mcp)** - ⭐ 94
   A Model Context Protocol (MCP) server that enables secure terminal command execution, directory navigation, and file system operations through a standardized interface.

1463. **[JavaSinkTracer_MCP](https://github.com/Zacarx/JavaSinkTracer_MCP)** - ⭐ 94
   基于函数级污点分析的 Java 源代码漏洞审计工具JavaSinkTracer，通过 Model Context Protocol (MCP) 为 AI 助手提供安全分析能力。

1464. **[infobus-mcp](https://github.com/simovilab/infobus-mcp)** - ⭐ 93
   Model Context Protocol server enabling AI assistants to access transit information through standardized interfaces

1465. **[MasterMCP](https://github.com/slowmist/MasterMCP)** - ⭐ 92
...
1466. **[mcp-replicate](https://github.com/deepfates/mcp-replicate)** - ⭐ 92
   Model Context Protocol server for Replicate's API

1467. **[mcp-server-gsc](https://github.com/ahonn/mcp-server-gsc)** - ⭐ 92
   A Model Context Protocol (MCP) server providing access to Google Search Console

1468. **[mcp-server-idapro](https://github.com/fdrechsler/mcp-server-idapro)** - ⭐ 92
   A Model Context Protocol (MCP) server that enables AI assistants to interact with IDA Pro for reverse engineering and binary analysis tasks.

1469. **[github-stars](https://github.com/miantiao-me/github-stars)** - ⭐ 92
   A Cloudflare-powered MCP (Model Context Protocol) Server that allows you to search and query your GitHub starred repositories using natural language.

1470. **[Financial-Modeling-Prep-MCP-Server](https://github.com/imbenrabi/Financial-Modeling-Prep-MCP-Server)** - ⭐ 91
   A Model Context Protocol (MCP) implementation for Financial Modeling Prep, enabling AI assistants to access and analyze financial data, stock information, company fundamentals, and market insights.

1471. **[square-mcp-server](https://github.com/square/square-mcp-server)** - ⭐ 90
   A Model Context Protocol (MCP) server for square

1472. **[sandbox-mcp](https://github.com/pottekkat/sandbox-mcp)** - ⭐ 90
   A Model Context Protocol (MCP) server that enables LLMs to run ANY code safely in isolated Docker containers.

1473. **[gis-mcp](https://github.com/mahdin75/gis-mcp)** - ⭐ 90
   A Model Context Protocol (MCP) server implementation that connects Large Language Models (LLMs) to GIS operations using GIS libraries, enabling AI assistants to perform geospatial operations and transformations.

1474. **[mcp-graphiti](https://github.com/rawr-ai/mcp-graphiti)** - ⭐ 90
   Graphiti Model Context Protocol (MCP) Server - An MCP server for knowledge graph management via Graphiti

1475. **[pluggedin-app](https://github.com/VeriTeknik/pluggedin-app)** - ⭐ 89
   The Crossroads for AI Data Exchanges. A unified, self-hostable web interface for discovering, configuring, and managing Model Context Protocol (MCP) servers—bringing together AI tools, workspaces, prompts, and logs from multiple MCP sources (Claude, Cursor, etc.) under one roof.

1476. **[a2ajava](https://github.com/vishalmysore/a2ajava)** - ⭐ 89
...
1477. **[mcp-python-interpreter](https://github.com/yzfly/mcp-python-interpreter)** - ⭐ 88
   MCP Python Interpreter: run python code. Python-mcp-server, mcp-python-server, Code Executor

1478. **[octagon-mcp-server](https://github.com/OctagonAI/octagon-mcp-server)** - ⭐ 88
...
1479. **[ToolsForMCPServer](https://github.com/tanaikech/ToolsForMCPServer)** - ⭐ 88
   The Gemini CLI confirmed that the MCP server built with Google Apps Script (GAS), a low-code platform, offers immense possibilities. If you've created snippets for GAS, these could be revitalized and/or leveraged in new ways by using them as the MCP server. The Gemini CLI and other MCP clients will be useful in achieving this.

1480. **[spring-ai-playground](https://github.com/spring-ai-community/spring-ai-playground)** - ⭐ 87
...
1481. **[mcp-web-ui](https://github.com/MegaGrindStone/mcp-web-ui)** - ⭐ 87
   MCP Web UI is a web-based user interface that serves as a Host within the Model Context Protocol (MCP) architecture. It provides a powerful and user-friendly interface for interacting with Large Language Models (LLMs) while managing context aggregation and coordination between clients and servers.

1482. **[mcp-trino](https://github.com/tuannvm/mcp-trino)** - ⭐ 87
   A high-performance Model Context Protocol (MCP) server for Trino implemented in Go.

1483. **[opencv-mcp-server](https://github.com/GongRzhe/opencv-mcp-server)** - ⭐ 87
...
1484. **[mcp-ui](https://github.com/machaojin1917939763/mcp-ui)** - ⭐ 86
   基于MCP(Model Context Protocol)的智能聊天应用，支持Web和桌面环境。集成OpenAI/Anthropic API，提供MCP服务器的所有工具能力。简洁现代的UI设计，支持跨平台部署。

1485. **[molecule-mcp](https://github.com/ChatMol/molecule-mcp)** - ⭐ 86
   A model-context-protocol server for molecules.

1486. **[model-context-protocol-mcp-hands-on-with-agentic-ai-2034200](https://github.com/LinkedInLearning/model-context-protocol-mcp-hands-on-with-agentic-ai-2034200)** - ⭐ 86
...
1487. **[mcp-server-and-gw](https://github.com/boilingdata/mcp-server-and-gw)** - ⭐ 86
   An MCP stdio to HTTP SSE transport gateway with example server and MCP client

1488. **[mcp-cli](https://github.com/apify/mcp-cli)** - ⭐ 86
...
1489. **[github-stars](https://github.com/ccbikai/github-stars)** - ⭐ 85
   A Cloudflare-powered MCP (Model Context Protocol) Server that allows you to search and query your GitHub starred repositories using natural language.

1490. **[furi](https://github.com/ashwwwin/furi)** - ⭐ 85
   CLI & API for MCP management

1491. **[ragie-mcp-server](https://github.com/ragieai/ragie-mcp-server)** - ⭐ 85
   Ragie Model Context Protocol Server

1492. **[openai-gpt-image-mcp](https://github.com/SureScaleAI/openai-gpt-image-mcp)** - ⭐ 85
   A Model Context Protocol (MCP) tool server for OpenAI's GPT-4o/gpt-image-1 image generation and editing APIs.

1493. **[action_mcp](https://github.com/seuros/action_mcp)** - ⭐ 84
   Rails Engine with MCP compliant Spec.

1494. **[deepl-mcp-server](https://github.com/DeepLcom/deepl-mcp-server)** - ⭐ 84
   A Model Context Protocol (MCP) server that provides translation capabilities using the DeepL API.

1495. **[memory-mcp-server-go](https://github.com/okooo5km/memory-mcp-server-go)** - ⭐ 83
   A Model Context Protocol server that provides knowledge graph management capabilities.

1496. **[splunk-mcp](https://github.com/livehybrid/splunk-mcp)** - ⭐ 83
   A Model Context Protocol (MCP) implementation for Splunk Enterprise and Cloud integration with Cursor IDE or Claude

1497. **[spiceflow](https://github.com/remorses/spiceflow)** - ⭐ 83
   Super Simple API framework, type safe, automatic OpenAPI, MCP support, client RPC, streaming with SSE

1498. **[Polymcp](https://github.com/poly-mcp/Polymcp)** - ⭐ 83
   Polymcp provides a simple and efficient way to interact with MCP servers using custom agents

1499. **[pinescript-mcp-server](https://github.com/cklose2000/pinescript-mcp-server)** - ⭐ 82
   A Model Context Protocol (MCP) server for working with TradingView PineScript

1500. **[node-candidate-mcp-server](https://github.com/jhgaylor/node-candidate-mcp-server)** - ⭐ 81
   A Model Context Protocol (MCP) server library that gives LLMs access to information about a candidate.

1501. **[mcp-rs-template](https://github.com/linux-china/mcp-rs-template)** - ⭐ 81
   Model Context Protocol (MCP) CLI server template for Rust

1502. **[sh-disney-mcp](https://github.com/syyuan14/sh-disney-mcp)** - ⭐ 81
   sh-disney-mcp 是一个基于 Model Context Protocol (MCP) 的mcp server，旨在通过标准化的接口，帮助大模型快速获取上海迪士尼乐园的门票价格和售卖状态信息

1503. **[mcphub](https://github.com/Cognitive-Stack/mcphub)** - ⭐ 81
...
1504. **[mcp-memory-libsql](https://github.com/spences10/mcp-memory-libsql)** - ⭐ 81
   🧠 High-performance persistent memory system for Model Context Protocol (MCP) powered by libSQL. Features vector search, semantic knowledge storage, and efficient relationship management - perfect for AI agents and knowledge graph applications.

1505. **[Awesome-Claude-MCP-Servers](https://github.com/win4r/Awesome-Claude-MCP-Servers)** - ⭐ 80
   A curated list of Model Context Protocol (MCP) servers optimized for Claude AI assistants.

1506. **[mcp-server](https://github.com/keboola/mcp-server)** - ⭐ 80
   Model Context Protocol (MCP) Server for the Keboola Platform

1507. **[mcp-server-stability-ai](https://github.com/tadasant/mcp-server-stability-ai)** - ⭐ 80
...
1508. **[legion-mcp](https://github.com/TheRaLabs/legion-mcp)** - ⭐ 80
   A server that helps people access and query data in databases using the Legion Query Runner with Model Context Protocol (MCP) in Python.

1509. **[IB_MCP](https://github.com/rcontesti/IB_MCP)** - ⭐ 80
   This project provides an Interactive Brokers (IB) API interface using the Model Context Protocol (MCP).

1510. **[office-editor-mcp](https://github.com/theWDY/office-editor-mcp)** - ⭐ 79
   基于MCP(Model Context Protocol)的Office文档处理助手，支持在MCP Client中创建和编辑Word、Excel、Powerpoint文档。

1511. **[anki-mcp-server](https://github.com/CamdenClark/anki-mcp-server)** - ⭐ 79
   A model context protocol server that connects to Anki through AnkiConnect

1512. **[identity](https://github.com/agntcy/identity)** - ⭐ 79
...
1513. **[Delphi-MCP-Server](https://github.com/GDKsoftware/Delphi-MCP-Server)** - ⭐ 79
   Native Delphi Server implementation of the Model Context Protocol (MCP)

1514. **[mcp-excel-server](https://github.com/yzfly/mcp-excel-server)** - ⭐ 79
...
1515. **[mcp-gateway](https://github.com/hyprmcp/mcp-gateway)** - ⭐ 79
...
1516. **[NASA-MCP-server](https://github.com/ProgramComputer/NASA-MCP-server)** - ⭐ 79
   A Model Context Protocol (MCP) server for NASA APIs, providing a standardized interface for AI models to interact with NASA's vast array of data sources.

1517. **[aws-security-mcp](https://github.com/groovyBugify/aws-security-mcp)** - ⭐ 79
   A Model Context Protocol server that connects AI assistants like Claude to AWS security services, allowing them to autonomously query, inspect, and analyze AWS infrastructure for security issues and misconfigurations.

1518. **[mcp-sqlite](https://github.com/jparkerweb/mcp-sqlite)** - ⭐ 79
   🐇 Model Context Protocol (MCP) server that provides comprehensive SQLite database interaction capabilities

1519. **[toolhive-studio](https://github.com/stacklok/toolhive-studio)** - ⭐ 79
   ToolHive is an application that allows you to install, manage and run MCP servers and connect them to AI agents

1520. **[github-chat-mcp](https://github.com/AsyncFuncAI/github-chat-mcp)** - ⭐ 78
   A Model Context Protocol (MCP) for analyzing and querying GitHub repositories using the GitHub Chat API.

1521. **[mcp-azure-devops](https://github.com/Vortiago/mcp-azure-devops)** - ⭐ 78
   A Model Context Protocol (MCP) server enabling AI assistants to interact with Azure DevOps services via Python SDK.

1522. **[dicom-mcp](https://github.com/ChristianHinge/dicom-mcp)** - ⭐ 78
   Model Context Protocol (MCP) for interacting with dicom servers (PACS etc.)

1523. **[cve-search_mcp](https://github.com/roadwy/cve-search_mcp)** - ⭐ 77
   A Model Context Protocol (MCP) server for querying the CVE-Search API

1524. **[mcp-discovery](https://github.com/rust-mcp-stack/mcp-discovery)** - ⭐ 77
   A command-line tool written in Rust for discovering and documenting MCP Server capabilities.

1525. **[mcp-monitor](https://github.com/seekrays/mcp-monitor)** - ⭐ 76
   A system monitoring tool that exposes system metrics via the Model Context Protocol (MCP). This tool allows LLMs to retrieve real-time system information through an MCP-compatible interface.

1526. **[tester-mcp-client](https://github.com/apify/tester-mcp-client)** - ⭐ 76
   Model Context Protocol (MCP) Client for Apify's Actors

1527. **[codeglide-mcpgen](https://github.com/CodeGlide/codeglide-mcpgen)** - ⭐ 76
   Generation of Secure MCP (Model Context Protocol) Servers from API source code at Scale

1528. **[sample-agents-with-nova-act-and-mcp](https://github.com/aws-samples/sample-agents-with-nova-act-and-mcp)** - ⭐ 75
...
1529. **[jvm-mcp-server](https://github.com/xzq-xu/jvm-mcp-server)** - ⭐ 75
   This is an implementation project of a JVM-based MCP (Model Context Protocol) server. The project aims to provide a standardized MCP server implementation for the JVM platform, enabling AI models to better interact with the Java ecosystem.

1530. **[mcp-server-circleci](https://github.com/CircleCI-Public/mcp-server-circleci)** - ⭐ 75
   A specialized server implementation for the Model Context Protocol (MCP) designed to integrate with CircleCI's development workflow. This project serves as a bridge between CircleCI's infrastructure and the Model Context Protocol, enabling enhanced AI-powered development experiences.

1531. **[google-cloud-mcp](https://github.com/krzko/google-cloud-mcp)** - ⭐ 75
   🤖 A Model Context Protocol (MCP) server for Google Cloud (GCP)

1532. **[woocommerce-mcp-server](https://github.com/techspawn/woocommerce-mcp-server)** - ⭐ 75
   A WooCommerce (MCP) Model Context Protocol server

1533. **[mcp-kafka](https://github.com/kanapuli/mcp-kafka)** - ⭐ 74
   A Model Context Protocol Server to perform Kafka client operations

1534. **[youtrack-mcp](https://github.com/tonyzorin/youtrack-mcp)** - ⭐ 74
...
1535. **[actual-mcp](https://github.com/s-stefanov/actual-mcp)** - ⭐ 74
   Model Context Protocol for Actual Budget API

1536. **[imessage-query-fastmcp-mcp-server](https://github.com/hannesrudolph/imessage-query-fastmcp-mcp-server)** - ⭐ 73
   An MCP server that provides safe access to your iMessage database through Model Context Protocol (MCP). This server is built with the FastMCP framework and the imessagedb library, enabling LLMs to query and analyze iMessage conversations with proper phone number validation and attachment handling.

1537. **[anubis-mcp](https://github.com/zoedsoupe/anubis-mcp)** - ⭐ 73
   Elixir Model Context Protocol (MCP) SDK (hermes-mcp fork)

1538. **[rust-mcp-schema](https://github.com/rust-mcp-stack/rust-mcp-schema)** - ⭐ 72
   A type-safe implementation of the official Model Context Protocol (MCP) schema in Rust.

1539. **[ChEMBL-MCP-Server](https://github.com/Augmented-Nature/ChEMBL-MCP-Server)** - ⭐ 72
   A comprehensive Model Context Protocol (MCP) server providing advanced access to the ChEMBL chemical database.

1540. **[healthcare-mcp-public](https://github.com/Cicatriiz/healthcare-mcp-public)** - ⭐ 72
   A Model Context Protocol (MCP) server providing AI assistants with access to healthcare data and medical information tools, including FDA drug info, PubMed, medRxiv, NCBI Bookshelf, clinical trials, ICD-10, DICOM metadata, and a medical calculator.

1541. **[mcp-outline](https://github.com/Vortiago/mcp-outline)** - ⭐ 72
   A Model Context Protocol (MCP) server enabling AI assistants to interact with Outline documentation services.

1542. **[chat.md](https://github.com/rusiaaman/chat.md)** - ⭐ 72
   An md file as a chat interface and editable history in one.

1543. **[agentic-tools-mcp](https://github.com/Pimzino/agentic-tools-mcp)** - ⭐ 72
   A comprehensive Model Context Protocol (MCP) server providing AI assistants with powerful task management and agent memories capabilities with project-specific storage.

1544. **[anki-mcp-server](https://github.com/ankimcp/anki-mcp-server)** - ⭐ 72
   A Model Context Protocol (MCP) server that enables AI assistants to interact with Anki, the spaced repetition flashcard application.

1545. **[choturobo](https://github.com/vishalmysore/choturobo)** - ⭐ 71
...
1546. **[wecom-bot-mcp-server](https://github.com/loonghao/wecom-bot-mcp-server)** - ⭐ 70
...
1547. **[mcp-metatrader5-server](https://github.com/Qoyyuum/mcp-metatrader5-server)** - ⭐ 70
...
1548. **[airtable-mcp](https://github.com/felores/airtable-mcp)** - ⭐ 70
   Search, create and update Airtable bases, tables, fields, and records using Claude Desktop and MCP (Model Context Protocol) clients

1549. **[FNewsCrawler](https://github.com/noimank/FNewsCrawler)** - ⭐ 70
   一个专门为大模型设计的财经信息MCP（Model Context Protocol）服务，通过高效的爬虫技术从各大财经网站（同花顺、东方财富等）获取实时资讯，为AI模型提供准确、及时的财经数据支持。

1550. **[loki-mcp](https://github.com/grafana/loki-mcp)** - ⭐ 70
   An MCP ( Model Context Protocol ) Server for Grafana Loki

1551. **[codebase-mcp](https://github.com/DeDeveloper23/codebase-mcp)** - ⭐ 69
   Model Context Protocol implementation for retrieving codebases using RepoMix

1552. **[ccxt-mcp](https://github.com/lazy-dinosaur/ccxt-mcp)** - ⭐ 69
   CCXT MCP Server bridges the gap between AI models and cryptocurrency trading by providing a standardized interface through the Model Context Protocol. Created to empower automated trading strategies, this tool allows AI assistants like Claude and GPT to directly interact with over 100 cryptocurrency exchanges without requiring users to write comple

1553. **[perfetto-mcp](https://github.com/antarikshc/perfetto-mcp)** - ⭐ 69
...
1554. **[Mureka-mcp](https://github.com/SkyworkAI/Mureka-mcp)** - ⭐ 69
   generate lyrics, song and background music(instrumental). Model Context Protocol (MCP) server.

1555. **[MCP-server-Deepseek_R1](https://github.com/66julienmartin/MCP-server-Deepseek_R1)** - ⭐ 68
   A Model Context Protocol (MCP) server implementation connecting Claude Desktop with DeepSeek's language models (R1/V3)

1556. **[HopperMCP](https://github.com/MxIris-Reverse-Engineering/HopperMCP)** - ⭐ 68
   A Model Context Protocol server for Hopper Disassembler

1557. **[agenite](https://github.com/subeshb1/agenite)** - ⭐ 68
...
1558. **[bitbucket-mcp](https://github.com/MatanYemini/bitbucket-mcp)** - ⭐ 68
   Bitbucket MCP - A Model Context Protocol (MCP) server for integrating with Bitbucket Cloud and Server APIs

1559. **[MCPhoenix](https://github.com/jmanhype/MCPhoenix)** - ⭐ 67
   A simplified implementation of the Model Context Protocol (MCP) server using Elixir's Phoenix Framework.

1560. **[mcp_gradio_client](https://github.com/justjoehere/mcp_gradio_client)** - ⭐ 67
   This is a proof of concept repo on how to create a gradio UI using the Model Context Protocol Client Python SDK.

1561. **[gmail-mcp-server](https://github.com/jasonsum/gmail-mcp-server)** - ⭐ 67
   Model Context Protocol (MCP) server for Gmail

1562. **[optuna-mcp](https://github.com/optuna/optuna-mcp)** - ⭐ 67
   The Optuna MCP Server is a Model Context Protocol (MCP) server to interact with Optuna APIs.

1563. **[deepview-mcp](https://github.com/ai-1st/deepview-mcp)** - ⭐ 67
   DeepView MCP is a Model Context Protocol server that enables IDEs like Cursor and Windsurf to analyze large codebases using Gemini 2.5 Pro's extensive context window.

1564. **[mcp-server-email](https://github.com/Shy2593666979/mcp-server-email)** - ⭐ 67
...
1565. **[ollama-mcp-client](https://github.com/mihirrd/ollama-mcp-client)** - ⭐ 67
   MCP client for local ollama models

1566. **[SillyTavern-MCP-Client](https://github.com/bmen25124/SillyTavern-MCP-Client)** - ⭐ 67
   An extension of MCP for SillyTavern.

1567. **[OmniMCP](https://github.com/OpenAdaptAI/OmniMCP)** - ⭐ 67
   OmniMCP uses Microsoft OmniParser and Model Context Protocol (MCP) to provide AI models with rich UI context and powerful interaction capabilities.

1568. **[mcp-velociraptor](https://github.com/mgreen27/mcp-velociraptor)** - ⭐ 67
   VelociraptorMCP is a Model Context Protocol bridge for exposing LLMs to MCP clients.

1569. **[bridge4simulator](https://github.com/AppGram/bridge4simulator)** - ⭐ 67
...
1570. **[raindrop-io-mcp-server](https://github.com/hiromitsusasaki/raindrop-io-mcp-server)** - ⭐ 66
   An integration that allows LLMs to interact with Raindrop.io bookmarks using the Model Context Protocol (MCP).

1571. **[mcp-fal](https://github.com/am0y/mcp-fal)** - ⭐ 66
   A Model Context Protocol (MCP) server for interacting with fal.ai models and services.

1572. **[deepseek-thinker-mcp](https://github.com/ruixingshi/deepseek-thinker-mcp)** - ⭐ 66
...
1573. **[vibe-blocks-mcp](https://github.com/majidmanzarpour/vibe-blocks-mcp)** - ⭐ 66
...
1574. **[mcp-server-datahub](https://github.com/acryldata/mcp-server-datahub)** - ⭐ 66
   The official Model Context Protocol (MCP) server for DataHub (https://datahub.com)

1575. **[mcp-client-python](https://github.com/alejandro-ao/mcp-client-python)** - ⭐ 66

1576. **[piapi-mcp-server](https://github.com/apinetwork/piapi-mcp-server)** - ⭐ 66
   A TypeScript implementation of a Model Context Protocol (MCP) server that integrates with PiAPI's API. PiAPI makes user able to generate media content with Midjourney/Flux/Kling/LumaLabs/Udio/Chrip/Trellis directly from Claude or any other MCP-compatible apps.

1577. **[boilerplate-mcp-server](https://github.com/aashari/boilerplate-mcp-server)** - ⭐ 66
   TypeScript Model Context Protocol (MCP) server boilerplate providing IP lookup tools/resources. Includes CLI support and extensible structure for connecting AI systems (LLMs) to external data sources like ip-api.com. Ideal template for creating new MCP integrations via Node.js.

1578. **[Nano-Banana-MCP](https://github.com/ConechoAI/Nano-Banana-MCP)** - ⭐ 66
   A Nano Banana MCP server, which you can integrate to cursor/claude code and any mcp client

1579. **[paper-search-mcp-nodejs](https://github.com/Dianel555/paper-search-mcp-nodejs)** - ⭐ 66
...
1580. **[markitdown_mcp_server](https://github.com/KorigamiK/markitdown_mcp_server)** - ⭐ 65
   A Model Context Protocol (MCP) server that converts various file formats to Markdown using the MarkItDown utility.

1581. **[QuickMCP](https://github.com/gunpal5/QuickMCP)** - ⭐ 65
   Effortlessly Build Model Context Protocol Servers with OpenAPI or Swagger or Google Discovery Specifications

1582. **[mcp](https://github.com/vuetifyjs/mcp)** - ⭐ 65
   🤖 A Model Context Protocol (MCP) library for use with Agentic chat bots

1583. **[ViaMCP](https://github.com/ViaVersionMCP/ViaMCP)** - ⭐ 65
   Client-side Implementation of the Via* projects for MCP

1584. **[BurpSuite-MCP-Server](https://github.com/X3r0K/BurpSuite-MCP-Server)** - ⭐ 65
   BurpSuite MCP Server:  A powerful Model Context Protocol (MCP) server implementation for BurpSuite, providing programmatic access to Burp's core functionalities.

1585. **[mcp-jenkins](https://github.com/lanbaoshen/mcp-jenkins)** - ⭐ 65
   The Model Context Protocol (MCP) is an open-source implementation that bridges Jenkins with AI language models following Anthropic's MCP specification. This project enables secure, contextual AI interactions with Jenkins tools while maintaining data privacy and security.

1586. **[m3](https://github.com/rafiattrach/m3)** - ⭐ 65
...
1587. **[mcp-tutorials](https://github.com/chenmingyong0423/mcp-tutorials)** - ⭐ 65
   Model Context Protocol(MCP) 中文教程讲解

1588. **[awesome-mcp-best-practices](https://github.com/lirantal/awesome-mcp-best-practices)** - ⭐ 64
   Build Awesome MCPs with Awesome Best Practices for MCP Servers and MCP Clients

1589. **[uml-mcp](https://github.com/antoinebou12/uml-mcp)** - ⭐ 64
...
1590. **[lsd-mcp](https://github.com/lsd-so/lsd-mcp)** - ⭐ 64
   LSD Model Context Protocol

1591. **[svelte5-mcp](https://github.com/StudentOfJS/svelte5-mcp)** - ⭐ 64
   A specialized Model Context Protocol (MCP) server for Svelte 5 frontend development

1592. **[ollama-mcp-client](https://github.com/anjor/ollama-mcp-client)** - ⭐ 64

1593. **[spring-ai](https://github.com/eazybytes/spring-ai)** - ⭐ 64
   From Java Dev to AI Engineer: Spring AI Fast Track

1594. **[ig-mcp](https://github.com/jlbadano/ig-mcp)** - ⭐ 64
...
1595. **[community-servers](https://github.com/mcp-get/community-servers)** - ⭐ 63
...
1596. **[mcp-fhir](https://github.com/flexpa/mcp-fhir)** - ⭐ 63
   A Model Context Protocol implementation for FHIR

1597. **[mcp-config](https://github.com/marcusschiesser/mcp-config)** - ⭐ 63
   A CLI tool for easy installation of MCP servers and managing their configuration

1598. **[x64dbgMCP](https://github.com/Wasdubya/x64dbgMCP)** - ⭐ 63
   Model Context Protocol for x64dbg & x32dbg

1599. **[CanvasMCPClient](https://github.com/n00bvn/CanvasMCPClient)** - ⭐ 63
   Canvas MCP Client is an open-source, self-hostable dashboard application built around an infinite, zoomable, and pannable canvas. It provides a unified interface for interacting with multiple MCP (Model Context Protocol) servers through a flexible, widget-based system.

1600. **[usolver](https://github.com/sdiehl/usolver)** - ⭐ 62
   A model context protocol server for solving combinatorial optimization problems with logical and numerical constraints.

1601. **[mcp-sdk](https://github.com/AntigmaLabs/mcp-sdk)** - ⭐ 62
   Minimalistic Rust Implementation Of Model Context Protocol from Anthropic

1602. **[nutrient-dws-mcp-server](https://github.com/PSPDFKit/nutrient-dws-mcp-server)** - ⭐ 62
   A Model Context Protocol (MCP) server implementation that integrates with the Nutrient Document Web Service (DWS) Processor API, providing powerful PDF processing capabilities for AI assistants.

1603. **[mcp-durable-object-client](https://github.com/Dhravya/mcp-durable-object-client)** - ⭐ 62
   testing mcps

1604. **[mcp-openapi-schema-explorer](https://github.com/kadykov/mcp-openapi-schema-explorer)** - ⭐ 62
   MCP server providing token-efficient access to OpenAPI/Swagger specs via MCP Resources for client-side exploration.

1605. **[ynab-mcp-server](https://github.com/calebl/ynab-mcp-server)** - ⭐ 62
   Model Context Protocol for YNAB (you need a budget)

1606. **[mcp-client-capabilities](https://github.com/apify/mcp-client-capabilities)** - ⭐ 62
   Index of all Model Context Protocol (MCP) clients and their capabilities

1607. **[contentful-mcp](https://github.com/ivo-toby/contentful-mcp)** - ⭐ 61
   MCP (Model Context Protocol) server for the Contentful Management API

1608. **[mcpr](https://github.com/devOpifex/mcpr)** - ⭐ 61
   Model Context Protocol server and client for R

1609. **[voice-mcp-agent](https://github.com/den-vasyliev/voice-mcp-agent)** - ⭐ 61
...
1610. **[mcp-server-okppt](https://github.com/NeekChaw/mcp-server-okppt)** - ⭐ 61
...
1611. **[kollektiv-mcp](https://github.com/alexander-zuev/kollektiv-mcp)** - ⭐ 61
...
1612. **[airtable-mcp](https://github.com/rashidazarang/airtable-mcp)** - ⭐ 61
   Airtable integration for AI-powered applications via Anthropic's Model Context Protocol (MCP)

1613. **[ollama-mcp-db](https://github.com/robdodson/ollama-mcp-db)** - ⭐ 61
...
1614. **[math-mcp](https://github.com/EthanHenrickson/math-mcp)** - ⭐ 61
   A Model Context Protocol (MCP) server that provides basic mathematical and statistical functions to Large Language Models (LLMs). This server enables LLMs to perform accurate numerical calculations through a simple API.

1615. **[Unreal_mcp](https://github.com/ChiR24/Unreal_mcp)** - ⭐ 61
...
1616. **[mcp-cn](https://github.com/mengjian-github/mcp-cn)** - ⭐ 60
...
1617. **[ocaml-mcp-sdk](https://github.com/bmorphism/ocaml-mcp-sdk)** - ⭐ 60
   OCaml SDK for Model Context Protocol using Jane Street's oxcaml_effect library

1618. **[mcp-hetzner](https://github.com/dkruyt/mcp-hetzner)** - ⭐ 60
   A Model Context Protocol (MCP) server for interacting with the Hetzner Cloud API. This server allows language models to manage Hetzner Cloud resources through structured functions.

1619. **[tiny-mcp](https://github.com/wdndev/tiny-mcp)** - ⭐ 60
   Python 实现 MCP client / service

1620. **[ipybox](https://github.com/gradion-ai/ipybox)** - ⭐ 60
   Python code execution sandbox with programmatic MCP tool calling (PTC)

1621. **[mcp-miro](https://github.com/k-jarzyna/mcp-miro)** - ⭐ 59
   Miro integration for Model Context Protocol

1622. **[daipendency-mcp](https://github.com/daipendency/daipendency-mcp)** - ⭐ 59
   Model Context Protocol server for Daipendency

1623. **[rember-mcp](https://github.com/rember/rember-mcp)** - ⭐ 59
   A Model Context Protocol (MCP) server for Rember.

1624. **[mcp_zoomeye](https://github.com/zoomeye-ai/mcp_zoomeye)** - ⭐ 59
   A Model Context Protocol server that provides network asset information based on query conditions. This server allows LLMs to obtain network asset information and supports querying network asset information by zoomeye dork etc.

1625. **[yamcp](https://github.com/hamidra/yamcp)** - ⭐ 59
   Organize your MCP servers in local workspaces, share them as Yet-Another-MCP through a single command

1626. **[turbomcp](https://github.com/Epistates/turbomcp)** - ⭐ 59
   A full featured, enterprise grade rust MCP SDK

1627. **[mcp-wolframalpha](https://github.com/akalaric/mcp-wolframalpha)** - ⭐ 59
   A Python-powered Model Context Protocol MCP server and client that uses Wolfram Alpha via API.

1628. **[google_ads_mcp](https://github.com/google-marketing-solutions/google_ads_mcp)** - ⭐ 59
   The Google Ads MCP Server is an implementation of the Model Context Protocol (MCP) that enables Large Language Models (LLMs), such as Gemini, to interact directly with the Google Ads API.

1629. **[mcp-gopls](https://github.com/hloiseau/mcp-gopls)** - ⭐ 59
   Model Context Protocol (MCP) server for Go using gopls – LSP-powered analysis, tests, coverage, and tooling.

1630. **[mcp-hub](https://github.com/lobstercare/mcp-hub)** - ⭐ 58
   A curated list of awesome Model Context Protocol (MCP) servers.

1631. **[mcp-server-axiom](https://github.com/axiomhq/mcp-server-axiom)** - ⭐ 58
   Axiom Model Context Protocol Server

1632. **[junos-mcp-server](https://github.com/Juniper/junos-mcp-server)** - ⭐ 58
...
1633. **[smart-pet-with-mcp](https://github.com/shijianzhong/smart-pet-with-mcp)** - ⭐ 58
   一个桌宠形式的mcp client，可以对接任意mcp server,配合测试的mcp server 开源地址：https://github.com/shijianzhong/mcp-server-for-pc

1634. **[baml-agents](https://github.com/Elijas/baml-agents)** - ⭐ 58
   Building Agents with LLM structured generation (BAML), MCP Tools, and 12-Factor Agents principles

1635. **[mobile-mcp](https://github.com/runablehq/mobile-mcp)** - ⭐ 58
   A Model Context Protocol (MCP) server that provides mobile automation capabilities.

1636. **[ncp](https://github.com/portel-dev/ncp)** - ⭐ 58
...
1637. **[gopher-mcp](https://github.com/GopherSecurity/gopher-mcp)** - ⭐ 58
   MCP C++ SDK - Model Context Protocol implementation in CPP with enterprise-grade security, visibility and connectivity.

1638. **[mcp-gemini-search](https://github.com/arjunprabhulal/mcp-gemini-search)** - ⭐ 57
   Model Context Protocol (MCP) with Gemini 2.5 Pro. Convert conversational queries into flight searches using Gemini's function calling capabilities and MCP's flight search tools

1639. **[chess-mcp](https://github.com/pab1it0/chess-mcp)** - ⭐ 57
   A Model Context Protocol server for Chess.com's Published Data API.  This provides access to Chess.com player data, game records, and other public information through standardized MCP interfaces, allowing AI assistants to search and analyze chess information.

1640. **[create-mcp-app](https://github.com/boguan/create-mcp-app)** - ⭐ 57
   A CLI tool for quickly scaffolding Model Context Protocol (MCP) server applications with TypeScript support and modern development tooling

1641. **[quick-mcp-example](https://github.com/ALucek/quick-mcp-example)** - ⭐ 57
   Short and sweet example MCP server / client implementation for Tools, Resources and Prompts.

1642. **[mcp-clojure-sdk](https://github.com/unravel-team/mcp-clojure-sdk)** - ⭐ 57
   A Clojure SDK to create MCP servers (and eventually clients)

1643. **[mcp_newsnow](https://github.com/sligter/mcp_newsnow)** - ⭐ 57
   一个基于 Model Context Protocol (MCP) 的新闻聚合服务器，通过 Newsnow API 提供多平台热点新闻和趋势话题。

1644. **[metis-router](https://github.com/metis-mantis/metis-router)** - ⭐ 56
   MCP router and Web Based MCP client

1645. **[mcp-think-tank](https://github.com/flight505/mcp-think-tank)** - ⭐ 56
...
1646. **[AllVoiceLab-MCP](https://github.com/allvoicelab/AllVoiceLab-MCP)** - ⭐ 56
...
1647. **[nutrient-document-engine-mcp-server](https://github.com/PSPDFKit/nutrient-document-engine-mcp-server)** - ⭐ 56
   A Model Context Protocol (MCP) server implementation exposes document processing capabilities through natural language, supporting both direct human interaction and AI agent tool calling.

1648. **[mcp-servers](https://github.com/pulsemcp/mcp-servers)** - ⭐ 56
   MCP (Model Context Protocol) Servers authored and maintained by the PulseMCP team. We build reliable servers thoughtfully designed specifically for MCP Client-powered workflows.

1649. **[Intelli](https://github.com/intelligentnode/Intelli)** - ⭐ 56
   Build multi-model chatbots and agents from intent.

1650. **[MySQL_MCP](https://github.com/guangxiangdebizi/MySQL_MCP)** - ⭐ 56
   这是一个功能强大且易用的MySQL数据库MCP（Model Context Protocol）服务器，让你的AI助手可以安全地进行完整的数据库操作，支持多数据库连接管理、增删改查、事务管理和智能回滚功能。

1651. **[ashra-mcp](https://github.com/getrupt/ashra-mcp)** - ⭐ 56
   A Model Context Protocol server for Ashra

1652. **[mcp-manager](https://github.com/MediaPublishing/mcp-manager)** - ⭐ 56
   A web-based GUI tool for managing Model Context Protocol (MCP) servers in Claude and Cursor

1653. **[umbraco-mcp](https://github.com/Matthew-Wise/umbraco-mcp)** - ⭐ 55
   A model context protocol  (MCP) server for Umbraco 

1654. **[mkp](https://github.com/StacklokLabs/mkp)** - ⭐ 55
   MKP is a Model Context Protocol (MCP) server for Kubernetes

1655. **[mcp-thinking](https://github.com/mattzcarey/mcp-thinking)** - ⭐ 55
   thinking tool for claude desktop/mcp clients using Deepseek reasoner

1656. **[EnergyPlus-MCP](https://github.com/LBNL-ETA/EnergyPlus-MCP)** - ⭐ 55
...
1657. **[clarity-mcp-server](https://github.com/microsoft/clarity-mcp-server)** - ⭐ 55
   A Model Context Protocol (MCP) server for Microsoft Clarity

1658. **[appium-mcp](https://github.com/Rahulec08/appium-mcp)** - ⭐ 54
...
1659. **[openai-mcp-client](https://github.com/ResoluteError/openai-mcp-client)** - ⭐ 54
   A rudimentary implementation of Anthropic's Model Context Protocol with OpenAIs Model

1660. **[mcp-headless-gmail](https://github.com/baryhuang/mcp-headless-gmail)** - ⭐ 54
   A MCP (Model Context Protocol) server that provides get, send Gmails without local credential or token setup.

1661. **[purple-mcp](https://github.com/Sentinel-One/purple-mcp)** - ⭐ 54
...
1662. **[geoserver-mcp](https://github.com/mahdin75/geoserver-mcp)** - ⭐ 54
   A Model Context Protocol (MCP) server implementation that connects LLMs to the GeoServer REST API

1663. **[mono-mcp](https://github.com/sin4ch/mono-mcp)** - ⭐ 54
   A comprehensive Model Context Protocol (MCP) server for Nigerian banking operations using the Mono Open Banking API.

1664. **[xiaozhi-mcp-client](https://github.com/shadowcz007/xiaozhi-mcp-client)** - ⭐ 53
   可视化的配置和管理，给xiaozhi接入mcp

1665. **[mcp-openai](https://github.com/S1M0N38/mcp-openai)** - ⭐ 53
   🔗 MCP Client with OpenAI compatible API

1666. **[mcp-bridge-api](https://github.com/INQUIRELAB/mcp-bridge-api)** - ⭐ 53
...
1667. **[qu3-app](https://github.com/qu3ai/qu3-app)** - ⭐ 52
   Quantum-proof MCP Server and Client Interactions

1668. **[NoLLMChat](https://github.com/zrg-team/NoLLMChat)** - ⭐ 52
...
1669. **[mcp-server-azure-ai-agents](https://github.com/farzad528/mcp-server-azure-ai-agents)** - ⭐ 52
   Model Context Protocol Servers for Azure AI Search

1670. **[gomcp](https://github.com/llmcontext/gomcp)** - ⭐ 52
   Unofficial Golang SDK for Anthropic Model Context Protocol

1671. **[nasdaq-data-link-mcp](https://github.com/stefanoamorelli/nasdaq-data-link-mcp)** - ⭐ 52
   A Nasdaq Data Link MCP (Model Context Protocol) Server

1672. **[mssql_mcp_server](https://github.com/JexinSam/mssql_mcp_server)** - ⭐ 52
   A Model Context Protocol (MCP) server facilitating secure interactions with MSSQL databases.

1673. **[client](https://github.com/php-mcp/client)** - ⭐ 52
   Core PHP implementation for the Model Context Protocol (MCP) Client

1674. **[cap-mcp-plugin](https://github.com/gavdilabs/cap-mcp-plugin)** - ⭐ 52
   MCP (Model Context Protocol) server plugin for CAP NodeJS

1675. **[mcp-cpp](https://github.com/Neumann-Labs/mcp-cpp)** - ⭐ 52
   A C++ SDK for the Model Context Protocol (MCP). The SDK will provide a framework for creating MCP servers and clients in C++.

1676. **[ocaml-mcp](https://github.com/tmattio/ocaml-mcp)** - ⭐ 52
   OCaml implementation of the Model Context Protocol (MCP)

1677. **[awesome-remote-mcp-servers](https://github.com/sylviangth/awesome-remote-mcp-servers)** - ⭐ 52
   A curated list of Hosted & Managed Model Context Protocol (MCP) Servers accessible via a simple URL endpoint.

1678. **[mcp-app-demo](https://github.com/pomerium/mcp-app-demo)** - ⭐ 52
...
1679. **[erpnext-mcp-server](https://github.com/rakeshgangwar/erpnext-mcp-server)** - ⭐ 52
   Connect AI assistants to your ERPNext instance via the Model Context Protocol (MCP) using the official Frappe API.

1680. **[mxcp](https://github.com/raw-labs/mxcp)** - ⭐ 52
   Model eXecution + Context Protocol: Enterprise-Grade Data-to-AI Infrastructure

1681. **[mcp-open-library](https://github.com/8enSmith/mcp-open-library)** - ⭐ 52
   A Model Context Protocol (MCP) server for the Internet Archive's Open Library API that enables AI assistants to search for book and author information.

1682. **[mcp-docs-service](https://github.com/alekspetrov/mcp-docs-service)** - ⭐ 52
   MCP Documentation Management Service - A Model Context Protocol implementation for documentation management

1683. **[mcp](https://github.com/twelvedata/mcp)** - ⭐ 52
...
1684. **[fastmail-mcp](https://github.com/MadLlama25/fastmail-mcp)** - ⭐ 52
...
1685. **[mcp-client](https://github.com/rakesh-eltropy/mcp-client)** - ⭐ 51

1686. **[windbg-ext-mcp](https://github.com/NadavLor/windbg-ext-mcp)** - ⭐ 51
...
1687. **[vrchat-mcp](https://github.com/sawa-zen/vrchat-mcp)** - ⭐ 51
   This project is a Model Context Protocol (MCP) server for interacting with the VRChat API.

1688. **[ticktick-mcp-server](https://github.com/alexarevalo9/ticktick-mcp-server)** - ⭐ 51
   A Model Context Protocol (MCP) server designed to integrate with the TickTick task management platform, enabling intelligent context-aware task operations and automation.

1689. **[bloodhound_mcp](https://github.com/mwnickerson/bloodhound_mcp)** - ⭐ 51
   A Model Context Protocol (MCP) server to converse with data in Bloodhound

1690. **[mcp-all-in-one](https://github.com/vtxf/mcp-all-in-one)** - ⭐ 51
...
1691. **[AgentDNS-Node](https://github.com/jsjfai/AgentDNS-Node)** - ⭐ 50
...
1692. **[context-optimizer-mcp-server](https://github.com/malaksedarous/context-optimizer-mcp-server)** - ⭐ 50
   A Model Context Protocol (MCP) server that provides context optimization tools for AI coding assistants including GitHub Copilot, Cursor AI, Claude Desktop, and other MCP-compatible assistants enabling them to extract targeted information rather than processing large terminal outputs and files wasting their context.

1693. **[adx-mcp-server](https://github.com/pab1it0/adx-mcp-server)** - ⭐ 50
   A Model Context Protocol (MCP) server that enables AI assistants to query and analyze Azure Data Explorer databases through standardized interfaces.

1694. **[MCP4EDA](https://github.com/NellyW8/MCP4EDA)** - ⭐ 50
...
1695. **[mcp](https://github.com/abap-ai/mcp)** - ⭐ 50
   ABAP MCP - Model Context Protocol - Server SDK

1696. **[adk-mcp-a2a-crash-course](https://github.com/chongdashu/adk-mcp-a2a-crash-course)** - ⭐ 50
...
1697. **[podman-mcp-server](https://github.com/manusa/podman-mcp-server)** - ⭐ 50
   Model Context Protocol (MCP) server for container runtimes (Podman and Docker)

1698. **[joplin-mcp-server](https://github.com/dweigend/joplin-mcp-server)** - ⭐ 50
   A Model Context Protocol (MCP) Server for https://joplinapp.org/ that enables note access through the https://modelcontextprotocol.io. Perfect for integration with AI assistants like Claude.

1699. **[ibkr-mcp-server](https://github.com/seriallazer/ibkr-mcp-server)** - ⭐ 50
   MCP Server for IBKR Client

1700. **[mcp-guard](https://github.com/General-Analysis/mcp-guard)** - ⭐ 50
   MCP Guard secures your MCP client from prompt injection attacks and more.

1701. **[bc-code-intelligence-mcp](https://github.com/JeremyVyska/bc-code-intelligence-mcp)** - ⭐ 50
...
1702. **[freecad-mcp](https://github.com/contextform/freecad-mcp)** - ⭐ 50
   FreeCAD MCP - Open-source Model Context Protocol server for FreeCAD automation

1703. **[mcp-security-audit](https://github.com/qianniuspace/mcp-security-audit)** - ⭐ 50
   A powerful MCP (Model Context Protocol) Server that audits npm package dependencies for security vulnerabilities. Built with remote npm registry integration for real-time security checks.

1704. **[gomcp](https://github.com/localrivet/gomcp)** - ⭐ 49
...
1705. **[mcpo_docker_use](https://github.com/flyfox666/mcpo_docker_use)** - ⭐ 49
...
1706. **[create-mcp](https://github.com/zueai/create-mcp)** - ⭐ 49
...
1715. **[mcp-mermaid-validator](https://github.com/rtuin/mcp-mermaid-validator)** - ⭐ 48
   A Model Context Protocol server that validates and renders Mermaid diagrams.

1716. **[auto-MCP-client](https://github.com/Chen-speculation/auto-MCP-client)** - ⭐ 48
...
1717. **[mcp-client-demo](https://github.com/KelvinQiu802/mcp-client-demo)** - ⭐ 48

1718. **[puremd-mcp](https://github.com/puremd/puremd-mcp)** - ⭐ 48
   Unblock, scrape, and search tools for MCP clients

1719. **[MediaWiki-MCP-Server](https://github.com/ProfessionalWiki/MediaWiki-MCP-Server)** - ⭐ 48
   Model Context Protocol (MCP) Server to connect your AI with any MediaWiki

1720. **[rag-app-on-aws](https://github.com/genieincodebottle/rag-app-on-aws)** - ⭐ 48
...
1721. **[1xn-vmcp](https://github.com/1xn-labs/1xn-vmcp)** - ⭐ 48
   vMCP - Virtual Model Context Protocol

1722. **[mcp-oauth-gateway](https://github.com/atrawog/mcp-oauth-gateway)** - ⭐ 48
...
1723. **[ollama-mcp-bridge](https://github.com/jonigl/ollama-mcp-bridge)** - ⭐ 47
   Extend the Ollama API with dynamic AI tool integration from multiple MCP (Model Context Protocol) servers. Fully compatible, transparent, and developer-friendly, ideal for building powerful local LLM applications, AI agents, and custom chatbots

1724. **[tripadvisor-mcp](https://github.com/pab1it0/tripadvisor-mcp)** - ⭐ 47
...
1725. **[model-context-protocol-rb](https://github.com/dickdavis/model-context-protocol-rb)** - ⭐ 47
   An implementation of the Model Context Protocol in Ruby.

1726. **[kuon](https://github.com/lissettecarlr/kuon)** - ⭐ 47
...
1727. **[scheduler-mcp](https://github.com/PhialsBasement/scheduler-mcp)** - ⭐ 47
...
1728. **[kroger-mcp](https://github.com/CupOfOwls/kroger-mcp)** - ⭐ 47
...
1729. **[mcp_demo](https://github.com/Ming-jiayou/mcp_demo)** - ⭐ 47
   A simple example of building an MCP client using C#.

1730. **[vchart-mcp-server](https://github.com/VisActor/vchart-mcp-server)** - ⭐ 47
   A Model Context Protocol (MCP) server for the @visactor/vchart that enables AI assistants to generate interactive charts and visualizations.

1731. **[mcp-things3](https://github.com/drjforrest/mcp-things3)** - ⭐ 47
...
1732. **[mcp-kubernetes](https://github.com/Azure/mcp-kubernetes)** - ⭐ 47
   A Model Context Protocol (MCP) server that enables AI assistants to interact with Kubernetes clusters. It serves as a bridge between AI tools (like Claude, Cursor, and GitHub Copilot) and Kubernetes

1733. **[FreeCAD-MCP](https://github.com/ATOI-Ming/FreeCAD-MCP)** - ⭐ 47
...
1734. **[mcp-swagger-server](https://github.com/zaizaizhao/mcp-swagger-server)** - ⭐ 47
   MCP Swagger Server 将任何符合 OpenAPI/Swagger 规范的 REST API 转换为 Model Context Protocol (MCP) 格式，让 AI 助手能够理解和调用您的 API。

1735. **[mcp-server-synology](https://github.com/atom2ueki/mcp-server-synology)** - ⭐ 47
...
1736. **[claude-mcp-setup](https://github.com/patruff/claude-mcp-setup)** - ⭐ 47
   Easy setup script for Anthropic Claude Model Context Protocol (MCP) servers on Windows

1737. **[mcp-gearbox](https://github.com/rohitsoni007/mcp-gearbox)** - ⭐ 46
   A modern desktop application for managing Model Context Protocol (MCP) servers across multiple AI agents

1738. **[mcp-server](https://github.com/inkdropapp/mcp-server)** - ⭐ 46
   Inkdrop Model Context Protocol Server

1739. **[mcp-openapi-schema](https://github.com/hannesj/mcp-openapi-schema)** - ⭐ 46
   OpenAPI Schema Model Context Protocol Server

1740. **[langchain-mcp-client](https://github.com/guinacio/langchain-mcp-client)** - ⭐ 46
   This Streamlit application provides a user interface for connecting to MCP (Model Context Protocol) servers and interacting with them using different LLM providers (OpenAI, Anthropic, Google, Ollama).

1741. **[APIWeaver](https://github.com/GongRzhe/APIWeaver)** - ⭐ 46
...
1742. **[ns-mcp-server](https://github.com/r-huijts/ns-mcp-server)** - ⭐ 46
   A Model Context Protocol (MCP) server that provides access to NS (Dutch Railways) travel information through Claude AI. This server enables Claude to fetch real-time train travel information and disruptions using the official Dutch NS API.

1743. **[DecompilerServer](https://github.com/pardeike/DecompilerServer)** - ⭐ 46
...
1744. **[eliza-plugin-mcp](https://github.com/fleek-platform/eliza-plugin-mcp)** - ⭐ 46
   ElizaOS plugin allowing agents to connect to MCP servers

1745. **[dramacraft](https://github.com/whatyun/dramacraft)** - ⭐ 46
   DramaCraft 是一个专业的短剧视频编辑 MCP (Model Context Protocol) 服务，集成国产中文大模型 API，实现剪映的智能自动化编辑功能。项目已完成从视频分析到草稿生成的完整解决方案

1746. **[Homeassistant-server-mcp](https://github.com/hekmon8/Homeassistant-server-mcp)** - ⭐ 46
   A Model Context Protocol (MCP) server for interacting with Home Assistant. This server provides tools to control and monitor your Home Assistant devices through MCP-enabled applications.

1747. **[go-mcp](https://github.com/MegaGrindStone/go-mcp)** - ⭐ 46
...
1748. **[Aspire.MCP.Sample](https://github.com/elbruno/Aspire.MCP.Sample)** - ⭐ 46
   Sample MCP Server and MCP client with Aspire

1749. **[AI-Cursor-Scraping-Assistant](https://github.com/TheWebScrapingClub/AI-Cursor-Scraping-Assistant)** - ⭐ 45
...
1750. **[mcp-sdk](https://github.com/symfony/mcp-sdk)** - ⭐ 45
   Model Context Protocol SDK for Client and Server applications in PHP

1751. **[shadowgit-mcp](https://github.com/blade47/shadowgit-mcp)** - ⭐ 45
...
1752. **[Koppla](https://github.com/ruudmens/Koppla)** - ⭐ 45
   A Model-Context-Protocol (MCP) Server for Active Directory

1753. **[hackmd-mcp](https://github.com/yuna0x0/hackmd-mcp)** - ⭐ 45
   A Model Context Protocol server for integrating HackMD's note-taking platform with AI assistants.

1754. **[mcp-made-simple](https://github.com/chongdashu/mcp-made-simple)** - ⭐ 45
   Model Context Protocol (MCP) Made Simple - Code for the tutorial series - focusing on practical ways to understand and use MCP

1755. **[zendesk-mcp-server](https://github.com/reminia/zendesk-mcp-server)** - ⭐ 45
   A Model Context Protocol server for Zendesk

1756. **[Serper-search-mcp](https://github.com/NightTrek/Serper-search-mcp)** - ⭐ 45
   Un-official Serper Google search server for Cline and other MCP clients

1757. **[mcpcat-python-sdk](https://github.com/MCPCat/mcpcat-python-sdk)** - ⭐ 45
   MCPcat is an analytics platform for MCP server owners 🐱.

1758. **[mcp-rdf-explorer](https://github.com/emekaokoye/mcp-rdf-explorer)** - ⭐ 45
...
1759. **[mcp-lite-dev](https://github.com/datawhalechina/mcp-lite-dev)** - ⭐ 45
   共学《MCP极简开发》项目代码

1760. **[mcp-server-kibana](https://github.com/TocharianOU/mcp-server-kibana)** - ⭐ 45
   MCP server for Kibana, Access search and manage Kibana in MCP Client.

1761. **[pprof-analyzer-mcp](https://github.com/ZephyrDeng/pprof-analyzer-mcp)** - ⭐ 45
   This is a Model Context Protocol (MCP) server implemented in Go, providing a tool to analyze Go pprof performance profiles.

1762. **[codex-mcp-go](https://github.com/w31r4/codex-mcp-go)** - ⭐ 45
...
1763. **[mcp-youtube](https://github.com/adhikasp/mcp-youtube)** - ⭐ 45
   Model Context Protocol to fetch youtube transcript

1764. **[xiaohongshu-mcp-python](https://github.com/luyike221/xiaohongshu-mcp-python)** - ⭐ 45
...
1765. **[youtube-mcp-server](https://github.com/mourad-ghafiri/youtube-mcp-server)** - ⭐ 45
   A powerful Model Context Protocol (MCP) server for YouTube video transcription and metadata extraction.

1766. **[mcp-gitee](https://github.com/oschina/mcp-gitee)** - ⭐ 44
   mcp-gitee is a Model Context Protocol (MCP) server implementation for Gitee. It provides a set of tools that interact with Gitee's API, allowing AI assistants to manage repository, issues, pull requests, etc.

1767. **[flightradar24-mcp-server](https://github.com/sunsetcoder/flightradar24-mcp-server)** - ⭐ 44
   Model Context Protocol server for Flight Tracking

1768. **[vue-mcp-next](https://github.com/tuskermanshu/vue-mcp-next)** - ⭐ 44
...
1769. **[OneCite](https://github.com/HzaCode/OneCite)** - ⭐ 44
...
1770. **[calculator-mcp-server](https://github.com/huhabla/calculator-mcp-server)** - ⭐ 44
   A Model Context Protocol (MCP) server that provides Claude with advanced mathematical calculation capabilities

1771. **[mcp-starter-template](https://github.com/StevenStavrakis/mcp-starter-template)** - ⭐ 44
   An opinionated starter template for making Model Context Protocol (MCP) servers

1772. **[langchaingo-mcp-adapter](https://github.com/i2y/langchaingo-mcp-adapter)** - ⭐ 44
   A Go adapter that bridges LangChain Go tools with Model Context Protocol (MCP) servers.

1773. **[wechat-mcp](https://github.com/JettChenT/wechat-mcp)** - ⭐ 44
   Model Context Protocol for WeChat

1774. **[generic-mcp-client-chat](https://github.com/rom1504/generic-mcp-client-chat)** - ⭐ 44
   Generic MCP Client to use any MCP tool in a chat

1775. **[spring-ai-mcp-client](https://github.com/ogulcanarbc/spring-ai-mcp-client)** - ⭐ 44
...
1776. **[modular-mcp](https://github.com/d-kimuson/modular-mcp)** - ⭐ 44
   A Model Context Protocol (MCP) proxy server that enables efficient management of large tool collections across multiple MCP servers by grouping them and loading tool schemas on-demand.

1777. **[marinade-finance-mcp-server](https://github.com/lorine93s/marinade-finance-mcp-server)** - ⭐ 44
   Marinade Finance MCP Server is an MCP server specifically designed for the Marinade Finance.

1778. **[Claude-Project-Coordinator](https://github.com/M-Pineapple/Claude-Project-Coordinator)** - ⭐ 44
...
1779. **[thingspanel-mcp](https://github.com/ThingsPanel/thingspanel-mcp)** - ⭐ 44
...
1780. **[esa-mcp-server](https://github.com/esaio/esa-mcp-server)** - ⭐ 44
   esa.io の公式 MCP(Model Context Protocol)サーバー(STDIO Transport版)

1781. **[mcp-auth-servers](https://github.com/Azure-Samples/mcp-auth-servers)** - ⭐ 44
   🔒 Reference MCP servers that demo how authentication works with the current Model Context Protocol spec.

1782. **[MCPP.Net](https://github.com/xuzeyu91/MCPP.Net)** - ⭐ 43
   Model Context Protocol Platform，统一管理你的MCP服务

1783. **[dataproduct-mcp](https://github.com/entropy-data/dataproduct-mcp)** - ⭐ 43
...
1784. **[mcp-playground](https://github.com/Elkhn/mcp-playground)** - ⭐ 43
   A Streamlit-based chat app for LLMs with plug-and-play tool support via Model Context Protocol (MCP), powered by LangChain, LangGraph, and Docker.

1785. **[meme-mcp](https://github.com/haltakov/meme-mcp)** - ⭐ 43
   A simple Model Context Protocol (MCP) server for generating memes using the ImgFlip API

1786. **[awesome-mcp-security](https://github.com/AIM-Intelligence/awesome-mcp-security)** - ⭐ 43
   Security Threats related with MCP (Model Context Protocol), MCP Servers and more

1787. **[taskMaster-todoist-mcp](https://github.com/mingolladaniele/taskMaster-todoist-mcp)** - ⭐ 43
...
1788. **[tuisic](https://github.com/Dark-Kernel/tuisic)** - ⭐ 43
...
1789. **[LLaMa-MCP-Streamlit](https://github.com/Nikunj2003/LLaMa-MCP-Streamlit)** - ⭐ 43
   AI assistant built with Streamlit, NVIDIA NIM (LLaMa 3.3:70B) / Ollama, and Model Control Protocol (MCP).

1790. **[pdf-mcp](https://github.com/saury1120/pdf-mcp)** - ⭐ 43
   一个强大的 PDF 处理 MCP（Model Context Protocol）服务，提供全面的 PDF 文档分析功能

1791. **[mcp-agents-hub](https://github.com/mcp-agents-ai/mcp-agents-hub)** - ⭐ 43
   The open-source ecosystem for building, discovering, and deploying Model Context Protocol servers and clients.

1792. **[scaled-mcp](https://github.com/Traego/scaled-mcp)** - ⭐ 43
   ScaledMCP is a horizontally scalabled MCP and A2A Server. You know, for AI.

1793. **[mcp-victorialogs](https://github.com/VictoriaMetrics-Community/mcp-victorialogs)** - ⭐ 43
   The implementation of Model Context Protocol (MCP) server for VictoriaLogs.

1794. **[solana-dev-mcp](https://github.com/solana-foundation/solana-dev-mcp)** - ⭐ 42
   Solana Model Context Protocol (MCP) Demo

1795. **[salesforce-mcp-server](https://github.com/kablewy/salesforce-mcp-server)** - ⭐ 42
   Model Context Protocol server for Salesforce REST API integration

1796. **[mcp-graphql-schema](https://github.com/hannesj/mcp-graphql-schema)** - ⭐ 42
   GraphQL Schema Model Context Protocol Server

1797. **[openrpc-mcp-server](https://github.com/shanejonas/openrpc-mcp-server)** - ⭐ 42
   A Model Context Protocol (MCP) server that provides JSON-RPC functionality through OpenRPC.

1798. **[awesome-mcp-servers](https://github.com/mctrinh/awesome-mcp-servers)** - ⭐ 42
   A curated list of excellent Model Context Protocol (MCP) servers.

1799. **[MCP-Airflow-API](https://github.com/call518/MCP-Airflow-API)** - ⭐ 42
...
1800. **[mcp-openmsx](https://github.com/nataliapc/mcp-openmsx)** - ⭐ 42
...
1801. **[python-notebook-mcp](https://github.com/UsamaK98/python-notebook-mcp)** - ⭐ 42
   Lightweight Python Notebook MCP - Enable AI assistants to create, edit, and view Jupyter notebooks via Model Context Protocol

1802. **[rhinoMcpServer](https://github.com/always-tinkering/rhinoMcpServer)** - ⭐ 42
...
1803. **[vercel-ai-docs-mcp](https://github.com/IvanAmador/vercel-ai-docs-mcp)** - ⭐ 42
   A Model Context Protocol (MCP) server that provides AI-powered search and querying capabilities for the Vercel AI SDK documentation. This project enables developers to ask questions about the Vercel AI SDK and receive accurate, contextualized responses based on the official documentation.

1804. **[mcp-amadeus](https://github.com/donghyun-chae/mcp-amadeus)** - ⭐ 42
   Amadeus MCP(Model Context Protocol) Server

1805. **[world_bank_mcp_server](https://github.com/anshumax/world_bank_mcp_server)** - ⭐ 42
   An implementation of the Model Context Protocol for the World Bank open data API

1806. **[mcp-servers-kagi](https://github.com/ac3xx/mcp-servers-kagi)** - ⭐ 42
   A Model Context Protocol server implementation for Kagi's API

1807. **[mcp-container-ts](https://github.com/Azure-Samples/mcp-container-ts)** - ⭐ 42
   This is a quick start guide that provides the basic building blocks to set up a remote Model Context Protocol (MCP) server using Azure Container Apps. The MCP server is built using Node.js and TypeScript, and it can be used to run various tools and services in a serverless environment.

1808. **[abaqus-mcp-server](https://github.com/jianzhichun/abaqus-mcp-server)** - ⭐ 42
...
1809. **[excalidraw-mcp](https://github.com/i-tozer/excalidraw-mcp)** - ⭐ 42
   Model Context Protocol (MCP) server for Excalidraw - Work in Progress

1810. **[pubmed-mcp-server](https://github.com/cyanheads/pubmed-mcp-server)** - ⭐ 42
...
1811. **[mcp-server-ledger](https://github.com/minhyeoky/mcp-server-ledger)** - ⭐ 42
   A Model Context Protocol server for interacting with Ledger CLI, a powerful double-entry accounting system. This server enables Large Language Models to query and analyze financial data through a standardized interface, making it easy for AI assistants to help with financial reporting, budget analysis, and accounting tasks.

1812. **[bookstack-mcp-server](https://github.com/pnocera/bookstack-mcp-server)** - ⭐ 42
   A Model Context Protocol (MCP) server providing full access to BookStack's knowledge management capabilities

1813. **[canvas-mcp](https://github.com/vishalsachdev/canvas-mcp)** - ⭐ 42
   A Model Context Protocol server to run locally and connect to a Canvas LMS 

1814. **[quickbooks-online-mcp-server](https://github.com/intuit/quickbooks-online-mcp-server)** - ⭐ 42
...
1815. **[MCPApp](https://github.com/tanaikech/MCPApp)** - ⭐ 42
   This text introduces the Model Context Protocol (MCP) for AI interaction, exploring Google Apps Script (GAS) as a server option. It shows feasibility with a sample but notes the lack of a GAS SDK, aiming to encourage understanding and development.

1816. **[mcp-server](https://github.com/profullstack/mcp-server)** - ⭐ 41
   A generic, modular server for implementing the Model Context Protocol (MCP). 

1817. **[mcp-server-js](https://github.com/yepcode/mcp-server-js)** - ⭐ 41
...
1826. **[caldav-mcp](https://github.com/dominik1001/caldav-mcp)** - ⭐ 41
   A CalDAV client using Model Context Protocol (MCP) to expose calendar operations as tools for AI assistants.

1827. **[semanticscholar-MCP-Server](https://github.com/JackKuo666/semanticscholar-MCP-Server)** - ⭐ 41
   🔍 This project implements a Model Context Protocol (MCP) server for interacting with the Semantic Scholar API. It provides tools for searching papers, retrieving paper and author details, and fetching citations and references.

1828. **[dynamic-shell-server](https://github.com/codelion/dynamic-shell-server)** - ⭐ 41
   Dynamic Shell Command MCP Server

1829. **[beemcp](https://github.com/OkGoDoIt/beemcp)** - ⭐ 41
   BeeMCP: an unofficial Model Context Protocol (MCP) server that connects your Bee wearable lifelogger to AI via the Model Context Protocol

1830. **[ai-humanizer-mcp-server](https://github.com/Text2Go/ai-humanizer-mcp-server)** - ⭐ 41
   A powerful Model Context Protocol (MCP) server that helps refine AI-generated content to sound more natural and human-like. Built with advanced AI detection and text enhancement capabilities.

1831. **[dify-mcp-server](https://github.com/AI-FE/dify-mcp-server)** - ⭐ 40
   A Model Context Protocol server for Dify

1832. **[mcp](https://github.com/Azure-Samples/mcp)** - ⭐ 40
...
1833. **[MCPollinations](https://github.com/pinkpixel-dev/MCPollinations)** - ⭐ 40
   A Model Context Protocol (MCP) server that enables AI assistants to generate images, text, and audio through the Pollinations APIs. Supports customizable parameters, image saving, and multiple model options.

1834. **[mcp_rails_template](https://github.com/seuros/mcp_rails_template)** - ⭐ 40
   A minimal Rails API template for creating MCP (Model Context Protocol) servers with robust tool execution capabilities and examples.

1835. **[agentic-mcp-client](https://github.com/peakmojo/agentic-mcp-client)** - ⭐ 40
   A standalone agent runner that executes tasks using MCP (Model Context Protocol) tools via Anthropic Claude, AWS BedRock and OpenAI APIs. It enables AI agents to run autonomously in cloud environments and interact with various systems securely.

1836. **[gradle-mcp-server](https://github.com/IlyaGulya/gradle-mcp-server)** - ⭐ 40
   A Model Context Protocol (MCP) server to enable AI tools to interact with Gradle projects programmatically.

1837. **[nmap-mcp-server](https://github.com/PhialsBasement/nmap-mcp-server)** - ⭐ 40
   A Model Context Protocol (MCP) server that enables AI assistants to perform network scanning operations using NMAP

1838. **[contentful-mcp-server](https://github.com/contentful/contentful-mcp-server)** - ⭐ 40
   MCP (Model Context Protocol) server for the Contentful Management API

1839. **[pagerduty-mcp-server](https://github.com/PagerDuty/pagerduty-mcp-server)** - ⭐ 40
   PagerDuty's official local MCP (Model Context Protocol) server which provides tools to interact with your PagerDuty account directly from your MCP-enabled client.

1840. **[zig-mcp-server](https://github.com/openSVM/zig-mcp-server)** - ⭐ 40
   A Model Context Protocol (MCP) server that provides Zig language tooling, code analysis, and documentation access. This server enhances AI capabilities with Zig-specific functionality including code optimization, compute unit estimation, code generation, and best practices recommendations.

1841. **[kafka-mcp-server](https://github.com/tuannvm/kafka-mcp-server)** - ⭐ 40
   A Model Context Protocol (MCP) server for Apache Kafka implemented in Go, leveraging franz-go and mcp-go.

1842. **[repl-mcp](https://github.com/simm-is/repl-mcp)** - ⭐ 40
   Model Context Protocol Clojure support including REPL integration with development tools.

1843. **[mcp-filter](https://github.com/pro-vi/mcp-filter)** - ⭐ 40
   A proxy MCP (Model Context Protocol) server that filters the upstream tool surface to just the tools you need.

1844. **[instagram-engagement-mcp](https://github.com/Bob-lance/instagram-engagement-mcp)** - ⭐ 40
...
1845. **[dotcom.chat](https://github.com/kamath/dotcom.chat)** - ⭐ 40
   A simple NextJS MCP client with sensible keybindings

1846. **[mailgun-mcp-server](https://github.com/mailgun/mailgun-mcp-server)** - ⭐ 40
   Implementation of Model Context Protocol server for Mailgun APIs

1847. **[vikunja-mcp](https://github.com/democratize-technology/vikunja-mcp)** - ⭐ 40
   Model Context Protocol server for Vikunja task management. Enables AI assistants to interact with Vikunja instances via MCP.

1848. **[browser-use-mcp-client](https://github.com/Linzo99/browser-use-mcp-client)** - ⭐ 40
   A MCP client for browser-use

1849. **[mcp-zenml](https://github.com/zenml-io/mcp-zenml)** - ⭐ 40
   MCP server to connect an MCP client (Cursor, Claude Desktop etc) with your ZenML MLOps and LLMOps pipelines

1850. **[youtrack-mcp](https://github.com/devstroop/youtrack-mcp)** - ⭐ 40
   An MCP (Model Context Protocol) server that provides YouTrack REST API access to AI agents

1851. **[beanquery-mcp](https://github.com/vanto/beanquery-mcp)** - ⭐ 40
...
1852. **[rust-analyzer-mcp](https://github.com/zeenix/rust-analyzer-mcp)** - ⭐ 40
   A Model Context Protocol (MCP) server that provides integration with rust-analyzer

1853. **[mcp-shell](https://github.com/hdresearch/mcp-shell)** - ⭐ 40
   Execute a secure shell in Claude Desktop using the Model Context Protocol.

1854. **[shotgrid-mcp-server](https://github.com/loonghao/shotgrid-mcp-server)** - ⭐ 40
   A Model Context Protocol (MCP) server for Autodesk ShotGrid/Flow Production Tracking (FPT) with comprehensive CRUD operations and data management capabilities.

1855. **[attio-mcp-server](https://github.com/kesslerio/attio-mcp-server)** - ⭐ 40
   Attio Model Context Protocol (MCP) server implementation

1856. **[sharepoint-mcp](https://github.com/DEmodoriGatsuO/sharepoint-mcp)** - ⭐ 39
...
1857. **[mcp_code_analyzer](https://github.com/emiryasar/mcp_code_analyzer)** - ⭐ 39
   A Model Context Protocol (MCP) server implementation for comprehensive code analysis. This tool integrates with Claude Desktop to provide code analysis capabilities through natural language interactions.

1858. **[mcp-crypto-price](https://github.com/truss44/mcp-crypto-price)** - ⭐ 39
   A Model Context Protocol (MCP) server that provides real-time cryptocurrency analysis via CoinCap's API. Enables Claude and other MCP clients to fetch crypto prices, analyze market trends, and track historical data.

1859. **[osm-mcp](https://github.com/wiseman/osm-mcp)** - ⭐ 39
   Model Context Protocol server for OpenStreetMap data

1860. **[mmcp](https://github.com/koki-develop/mmcp)** - ⭐ 39
   🛠️ Manage your MCP (Model Context Protocol) server definitions in one place and apply them to supported agents.

1861. **[clinicaltrialsgov-mcp-server](https://github.com/cyanheads/clinicaltrialsgov-mcp-server)** - ⭐ 39
...
1862. **[mcp-codestyle-server](https://github.com/itxaiohanglover/mcp-codestyle-server)** - ⭐ 39
...
1863. **[mcp-desktop](https://github.com/http4k/mcp-desktop)** - ⭐ 39
   http4k MCP Desktop Client

1864. **[mcp-client-server-host-demo](https://github.com/danwritecode/mcp-client-server-host-demo)** - ⭐ 39
   A quick pokemon demo to showcase MCP server, client, and host

1865. **[mcp-logic](https://github.com/angrysky56/mcp-logic)** - ⭐ 39
...
1866. **[mcp](https://github.com/kyopark2014/mcp)** - ⭐ 39
   It shows how to use model-context-protocol. 

1867. **[mcp-toolbox-sdk-go](https://github.com/googleapis/mcp-toolbox-sdk-go)** - ⭐ 39
   Go SDK for interacting with the MCP Toolbox for Databases.

1868. **[mealie-mcp-server](https://github.com/rldiao/mealie-mcp-server)** - ⭐ 39
   MCP server that exposes Mealie APIs to MCP clients such as Claude Desktop

1869. **[autoteam](https://github.com/diazoxide/autoteam)** - ⭐ 38
   Orchestrate AI agents with YAML-driven workflows via universal Model Context Protocol (MCP)

1870. **[algorand-mcp](https://github.com/GoPlausible/algorand-mcp)** - ⭐ 38
   Algorand Model Context Protocol (Server & Client)

1871. **[middy-mcp](https://github.com/fredericbarthelet/middy-mcp)** - ⭐ 38
   Middy middleware for Model Context Protocol server hosting on AWS Lambda

1872. **[dev-to-mcp](https://github.com/nickytonline/dev-to-mcp)** - ⭐ 38
   A remote Model Context Protocol (MCP) server for interacting with the dev.to public API without requiring authentication.

1873. **[mcp-konnect](https://github.com/Kong/mcp-konnect)** - ⭐ 38
   A Model Context Protocol (MCP) server for interacting with Kong Konnect APIs, allowing AI assistants to query and analyze Kong Gateway configurations, traffic, and analytics.

1874. **[How-To-Create-MCP-Server](https://github.com/nisalgunawardhana/How-To-Create-MCP-Server)** - ⭐ 38
   This guide will help you set up a basic MCP (Model Context Protocol) server in .NET, configure it in VS Code, and interact with it using Copilot Chat.

1875. **[mcp-ssh](https://github.com/AiondaDotCom/mcp-ssh)** - ⭐ 38
   A Model Context Protocol (MCP) server for managing and controlling SSH connections.

1876. **[activitywatch-mcp-server](https://github.com/8bitgentleman/activitywatch-mcp-server)** - ⭐ 38
   Model Context Protocol server for ActivityWatch time tracking data

1877. **[mcp-center](https://github.com/nautilus-ops/mcp-center)** - ⭐ 38
   A centralized platform for managing and connecting MCP servers. MCP Center provides a high-performance proxy service that enables seamless communication between MCP clients and multiple MCP servers.

1878. **[anki-mcp](https://github.com/nietus/anki-mcp)** - ⭐ 38
   MCP server for anki

1879. **[davinci-resolve-mcp](https://github.com/apvlv/davinci-resolve-mcp)** - ⭐ 38
   A Model Context Protocol (MCP) server for interacting with DaVinci Resolve and Fusion

1880. **[Claude-Deep-Research](https://github.com/mcherukara/Claude-Deep-Research)** - ⭐ 38
   An MCP (Model Context Protocol) server that enables comprehensive research capabilities for Claude

1881. **[openrouter-deep-research-mcp](https://github.com/wheattoast11/openrouter-deep-research-mcp)** - ⭐ 38
...
1882. **[mcp-client-example](https://github.com/artemnovichkov/mcp-client-example)** - ⭐ 37
   Learn how to implement MCP client with SwiftUI and Anthropic API

1883. **[offeryn](https://github.com/avahowell/offeryn)** - ⭐ 37
   Build tools for LLMs in Rust using Model Context Protocol

1884. **[MCPToolBenchPP](https://github.com/mcp-tool-bench/MCPToolBenchPP)** - ⭐ 37
   MCPToolBench++ MCP Model Context Protocol Tool Use Benchmark on AI Agent and Model Tool Use Ability

1885. **[youtrack-mcp](https://github.com/itsalfredakku/youtrack-mcp)** - ⭐ 37
   An MCP (Model Context Protocol) server that provides YouTrack REST API access to AI agents

1886. **[ContextPods](https://github.com/conorluddy/ContextPods)** - ⭐ 37
   Model Context Protocol management suite/factory. An MCP that can generate and manage other local MCPs in multiple languages. Uses the official SDKs for code gen.

1887. **[okta-mcp-server](https://github.com/fctr-id/okta-mcp-server)** - ⭐ 37
   The Okta MCP Server is a groundbreaking tool built by the team at Fctr that enables AI models to interact directly with your Okta environment using the Model Context Protocol (MCP). Built specifically for IAM engineers, security teams, and Okta administrators, it implements the MCP specification to help work with Okta enitities

1888. **[mcp-sitecore-server](https://github.com/Antonytm/mcp-sitecore-server)** - ⭐ 37
   Model Context Protocol server for Sitecore

1889. **[McpDotNet.Extensions.SemanticKernel](https://github.com/StefH/McpDotNet.Extensions.SemanticKernel)** - ⭐ 37
   Microsoft SemanticKernel integration for the Model Context Protocol (MCP). Enables seamless use of MCP tools as AI functions.

1890. **[shodan-mcp-server](https://github.com/Cyreslab-AI/shodan-mcp-server)** - ⭐ 37
   A Model Context Protocol server that provides access to Shodan API functionality

1891. **[solscan-mcp](https://github.com/wowinter13/solscan-mcp)** - ⭐ 37
   An MCP server for querying Solana transactions using natural language with Solscan API

1892. **[mcp-android-server-python](https://github.com/nim444/mcp-android-server-python)** - ⭐ 37
   MCP Android agent - This project provides an *MCP (Model Context Protocol)* server for automating Android devices using uiautomator2. It's designed to be easily plugged into AI agents like GitHub Copilot Chat, Claude, or Open Interpreter to control Android devices through natural language.

1893. **[RedBook-Search-Comment-MCP](https://github.com/chenningling/RedBook-Search-Comment-MCP)** - ⭐ 37
   这是一款基于 Playwright 开发的小红书自动搜索和评论工具，作为 MCP Server，可通过特定配置接入 MCP Client，帮助用户自动完成登录小红书、搜索关键词、获取笔记内容及发布智能评论等操作。

1894. **[DeepCo](https://github.com/succlz123/DeepCo)** - ⭐ 37
   A Chat Client for LLMs, written in Compose Multiplatform.

1895. **[binance-mcp-server](https://github.com/AnalyticAce/binance-mcp-server)** - ⭐ 37
...
1896. **[matlab-mcp](https://github.com/Tsuchijo/matlab-mcp)** - ⭐ 37
   Model Context Protocol server to let LLMs write and execute matlab scripts 

1897. **[bsky-mcp-server](https://github.com/brianellin/bsky-mcp-server)** - ⭐ 37
   Bluesky MCP (Model Context Protocol) Server

1898. **[mcp_weather_server](https://github.com/isdaniel/mcp_weather_server)** - ⭐ 37
   A Model Context Protocol (MCP) server that provides weather information using the Open-Meteo API.

1899. **[nuclei-mcp](https://github.com/addcontent/nuclei-mcp)** - ⭐ 37
...
1900. **[open-ghl-mcp](https://github.com/basicmachines-co/open-ghl-mcp)** - ⭐ 37
   An open source Model Context Protocol server for GoHighLevel API v2 with OAuth

1901. **[mcp-server-leetcode](https://github.com/doggybee/mcp-server-leetcode)** - ⭐ 36
...
1902. **[openai-mcp](https://github.com/arthurcolle/openai-mcp)** - ⭐ 36
   OpenAI Code Assistant Model Context Protocol (MCP) Server

1903. **[mcp-flight-search](https://github.com/arjunprabhulal/mcp-flight-search)** - ⭐ 36
   MCP Server implementation for the Model Context Protocol (MCP) enabling AI tool usage - Realtime Flight Search 

1904. **[mcp-go](https://github.com/riza-io/mcp-go)** - ⭐ 36
   Build Model Context Protocol (MCP) servers in Go

1905. **[Mcp.Net](https://github.com/SamFold/Mcp.Net)** - ⭐ 36
   A fully featured C# implementation of Anthropic's Model Context Protocol (MCP)

1906. **[baseline-mcp-server](https://github.com/yamanoku/baseline-mcp-server)** - ⭐ 36
   特定のWeb APIに関するBaselineの状況を提供するModel Context Protocolサーバー

1907. **[example-mcp-server](https://github.com/kirill-markin/example-mcp-server)** - ⭐ 36
   A ready-to-use MCP (Model Context Protocol) server template for extending Cursor IDE with custom tools. Deploy your own server to Heroku with one click, create custom commands, and enhance your Cursor IDE experience. Perfect for developers who want to add their own tools and commands to Cursor IDE without complex setup.

1908. **[mcp-governance-sdk](https://github.com/ithena-one/mcp-governance-sdk)** - ⭐ 36
   Enterprise Governance Layer (Identity, RBAC, Credentials, Auditing, Logging, Tracing) for the Model Context Protocol SDK

1909. **[mcpmc](https://github.com/gerred/mcpmc)** - ⭐ 36
   Model Context Protocol Minecraft Server

1910. **[mcp-design-system-extractor](https://github.com/freema/mcp-design-system-extractor)** - ⭐ 36
   MCP (Model Context Protocol) server that enables AI assistants to interact with Storybook design systems. Extract component HTML, analyze styles, and help with design system adoption and refactoring.

1911. **[OmniMind](https://github.com/Techiral/OmniMind)** - ⭐ 36
...
1912. **[fast-filesystem-mcp](https://github.com/efforthye/fast-filesystem-mcp)** - ⭐ 36
   A high-performance Model Context Protocol (MCP) server that provides secure filesystem access for Claude and other AI assistants.

1913. **[webscraping-ai-mcp-server](https://github.com/webscraping-ai/webscraping-ai-mcp-server)** - ⭐ 36
    A Model Context Protocol (MCP) server implementation that integrates with WebScraping.AI for web data extraction capabilities.

1914. **[flutter-mcp-ai-chat](https://github.com/leehack/flutter-mcp-ai-chat)** - ⭐ 36
   Demonstrate how to implement MCP Client in Flutter application with AI.

1915. **[mcp-server-ios-simulator](https://github.com/atom2ueki/mcp-server-ios-simulator)** - ⭐ 36
   Model Context Protocol (MCP) implementation for iOS simulators

1916. **[FastDomainCheck-MCP-Server](https://github.com/bingal/FastDomainCheck-MCP-Server)** - ⭐ 36
   A Model Context Protocol for checking domain name registration status in bulk.

1917. **[HAL](https://github.com/DeanWard/HAL)** - ⭐ 36
   HAL (HTTP API Layer) is a Model Context Protocol (MCP) server that provides HTTP API capabilities to Large Language Models.

1918. **[godot-mcp](https://github.com/bradypp/godot-mcp)** - ⭐ 36
   A Model Context Protocol (MCP) server for interacting with the Godot game engine.

1919. **[mlb-api-mcp](https://github.com/guillochon/mlb-api-mcp)** - ⭐ 35
...
1920. **[esa-mcp-server](https://github.com/d-kimuson/esa-mcp-server)** - ⭐ 35
   esa の Model Context Protocol サーバー実装

1921. **[mcp-langchain-ts-client](https://github.com/isaacwasserman/mcp-langchain-ts-client)** - ⭐ 35
   LangChain.js client for Model Context Protocol.

1922. **[mcp-anywhere](https://github.com/locomotive-agency/mcp-anywhere)** - ⭐ 35
...
1923. **[mcp-local-rag](https://github.com/shinpr/mcp-local-rag)** - ⭐ 35
   Privacy-first local RAG server for Cursor, Claude Code, and more — powered by the Model Context Protocol.

1924. **[grafana-mcp-analyzer](https://github.com/SailingCoder/grafana-mcp-analyzer)** - ⭐ 35
   让AI助手直接分析你的Grafana监控数据 - A Model Context Protocol server for Grafana data analysis

1925. **[mcp-mistral-ocr](https://github.com/everaldo/mcp-mistral-ocr)** - ⭐ 35
   Model Context Protocol (MCP) Server for Mistral OCR API

1926. **[linkedin-mcp-server](https://github.com/Dishant27/linkedin-mcp-server)** - ⭐ 35
   Model Context Protocol (MCP) server for LinkedIn API integration

1927. **[mcp-pyautogui-server](https://github.com/hetaoBackend/mcp-pyautogui-server)** - ⭐ 35
   A MCP (Model Context Protocol) server that provides automated GUI testing and control capabilities through PyAutoGUI.

1928. **[mcp-gateway](https://github.com/theognis1002/mcp-gateway)** - ⭐ 35
...
1929. **[mcp-toolkit](https://github.com/metosin/mcp-toolkit)** - ⭐ 35
   a lib to build MCP clients and MCP servers in Clojure(script)

1930. **[smythos-studio](https://github.com/SmythOS/smythos-studio)** - ⭐ 35
...
1931. **[tomtom-mcp](https://github.com/tomtom-international/tomtom-mcp)** - ⭐ 35
   A Model Context Protocol (MCP) server providing TomTom's location services, search, routing, and traffic data to AI agents.

1932. **[altium-mcp](https://github.com/coffeenmusic/altium-mcp)** - ⭐ 35
   Altium Model Context Protocol server and Altium API script

1933. **[code-mcp](https://github.com/54yyyu/code-mcp)** - ⭐ 35
...
1934. **[codebadger](https://github.com/Lekssays/codebadger)** - ⭐ 35
...
1935. **[keycloak-model-context-protocol](https://github.com/ChristophEnglisch/keycloak-model-context-protocol)** - ⭐ 34
...
1936. **[mcp-file-context-server](https://github.com/bsmi021/mcp-file-context-server)** - ⭐ 34
   A Model Context Protocol (MCP) server that provides file system context to Large Language Models (LLMs). This server enables LLMs to read, search, and analyze code files with advanced caching and real-time file watching capabilities.

1937. **[mcp-security-inspector](https://github.com/purpleroc/mcp-security-inspector)** - ⭐ 34
   一个用于检测Model Context Protocol (MCP)安全性的Chrome扩展工具。

1938. **[codebase-mcp](https://github.com/danyQe/codebase-mcp)** - ⭐ 34
...
1939. **[mcp-client-auth](https://github.com/dzhng/mcp-client-auth)** - ⭐ 34
...
1940. **[salesforce-mcp-server](https://github.com/jaworjar95/salesforce-mcp-server)** - ⭐ 34
   A comprehensive Model Context Protocol (MCP) server that provides seamless Salesforce integration for AI development tools like Claude Desktop, Cline, and other MCP-compatible clients.

1941. **[coin_api_mcp](https://github.com/longmans/coin_api_mcp)** - ⭐ 34
   A Model Context Protocol server that provides access to CoinMarketCap's cryptocurrency data. This server enables AI-powered applications to retrieve cryptocurrency listings, quotes, and detailed information about various coins.

1942. **[mcp-accessibility-scanner](https://github.com/JustasMonkev/mcp-accessibility-scanner)** - ⭐ 34
   An MCP (Model Context Protocol) server for performing accessibility audits on webpages using axe-core.

1943. **[Readwise-Reader-MCP](https://github.com/edricgsh/Readwise-Reader-MCP)** - ⭐ 34
   A Model Context Protocol (MCP) server for the Readwise Reader API, built with TypeScript and the official Claude SDK.

1944. **[ai-vision-mcp](https://github.com/tan-yong-sheng/ai-vision-mcp)** - ⭐ 34
   A Model Context Protocol (MCP) server that provides vision capabilities to analyze image and video

1945. **[MCPSwiftWrapper](https://github.com/jamesrochabrun/MCPSwiftWrapper)** - ⭐ 34
   A light wrapper around mcp-swift-sdk for easy usage of MCP clients in Swift

1946. **[metabase-mcp](https://github.com/jerichosequitin/metabase-mcp)** - ⭐ 34
...
1947. **[adk-python-mcp-client](https://github.com/arjunprabhulal/adk-python-mcp-client)** - ⭐ 34
   Demo of ADK (Agent Development Kit) as an MCP (Model Context Protocol) client for flight search capabilities.

1948. **[imap-mcp](https://github.com/non-dirty/imap-mcp)** - ⭐ 34
   IMAP Model Context Protocol server for interactive email processing

1949. **[mcp-front](https://github.com/stainless-api/mcp-front)** - ⭐ 34
   Auth proxy for Model Context Protocol servers - adds authentication to MCP tools for Claude.ai, Claude Code, Cursor, Gemini

1950. **[chat-nextjs-mcp-client](https://github.com/shricodev/chat-nextjs-mcp-client)** - ⭐ 34
   ⚡ Chat MCP Client for Remote hosted MCP Servers (with Composio) and locally hosted MCP servers. 📡

1951. **[mcp-gemini-server](https://github.com/bsmi021/mcp-gemini-server)** - ⭐ 33
   This project provides a dedicated MCP (Model Context Protocol) server that wraps the @google/genai SDK. It exposes Google's Gemini model capabilities as standard MCP tools, allowing other LLMs (like Cline) or MCP-compatible systems to leverage Gemini's features as a backend workhorse.

1952. **[mcp-scala](https://github.com/windymelt/mcp-scala)** - ⭐ 33
   Model Context Protocol server written in Scala

1953. **[mcp-server-opendal](https://github.com/Xuanwo/mcp-server-opendal)** - ⭐ 33
   Model Context Protocol Server for Apache OpenDAL™

1954. **[prometheus_mcp_server](https://github.com/CaesarYangs/prometheus_mcp_server)** - ⭐ 33
...
1955. **[mcp-google-calendar](https://github.com/markelaugust74/mcp-google-calendar)** - ⭐ 33
...
1956. **[aio-mcp](https://github.com/athapong/aio-mcp)** - ⭐ 33
...
1957. **[mcp-prompt-server-go](https://github.com/smallnest/mcp-prompt-server-go)** - ⭐ 33
...
1958. **[jina-mcp-tools](https://github.com/PsychArch/jina-mcp-tools)** - ⭐ 33
   A Model Context Protocol (MCP) server that integrates with Jina AI Search Foundation APIs.

1959. **[a11y-mcp](https://github.com/priyankark/a11y-mcp)** - ⭐ 33
   An MCP (Model Context Protocol) server for performing accessibility audits on webpages using axe-core. Use the results in an agentic loop with your favorite AI assistants (Amp/Cline/Cursor/GH Copilot) and let them fix a11y issues for you!

1960. **[mcp-registry](https://github.com/ARadRareness/mcp-registry)** - ⭐ 33
   A central registry and HTTP interface for coordinating Model Context Protocol (MCP) servers.

1961. **[Scientific-Papers-MCP](https://github.com/benedict2310/Scientific-Papers-MCP)** - ⭐ 33
...
1962. **[linkedin-mcpserver](https://github.com/felipfr/linkedin-mcpserver)** - ⭐ 33
   A powerful Model Context Protocol server for LinkedIn API integration

1963. **[llm-tools-mcp](https://github.com/VirtusLab/llm-tools-mcp)** - ⭐ 33
   Connect to MCP servers right from your shell. Plugin for simonw/llm.

1964. **[Outlook_Calendar_MCP](https://github.com/merajmehrabi/Outlook_Calendar_MCP)** - ⭐ 33
   A Model Context Protocol (MCP) server that allows Claude to access and manage your local Microsfot Outlook calendar (Windows only).

1965. **[langfuse-mcp](https://github.com/avivsinai/langfuse-mcp)** - ⭐ 33
   A Model Context Protocol (MCP) server for Langfuse, enabling AI agents to query Langfuse trace data for enhanced debugging and observability

1966. **[MCP-Server-Creator](https://github.com/GongRzhe/MCP-Server-Creator)** - ⭐ 33
...
1967. **[agent-mcp-gateway](https://github.com/roddutra/agent-mcp-gateway)** - ⭐ 33
...
1968. **[MayaMCP](https://github.com/PatrickPalmer/MayaMCP)** - ⭐ 33
   Model Context Protocol (MCP) server implementation for Autodesk Maya

1969. **[lunchmoney-mcp](https://github.com/akutishevsky/lunchmoney-mcp)** - ⭐ 33
...
1970. **[RiMCP_hybrid](https://github.com/h7lu/RiMCP_hybrid)** - ⭐ 33
   Rimworld Coding RAG MCP server

1971. **[meta-prompt-mcp-server](https://github.com/tisu19021997/meta-prompt-mcp-server)** - ⭐ 33
   Turn any MCP Client into a "multi-agent" system (via prompting)

1972. **[postman-mcp](https://github.com/SalehKhatri/postman-mcp)** - ⭐ 32
...
1973. **[mcp-nats](https://github.com/sinadarbouy/mcp-nats)** - ⭐ 32
   A Model Context Protocol (MCP) server for NATS messaging system integration

1974. **[zilliz-mcp-server](https://github.com/zilliztech/zilliz-mcp-server)** - ⭐ 32
...
1975. **[azure-functions-mcp-extension](https://github.com/Azure/azure-functions-mcp-extension)** - ⭐ 32
   Model Context Protocol extension for Azure Functions.

1976. **[McpToolkit](https://github.com/nuskey8/McpToolkit)** - ⭐ 32
   Lightweight, fast, NativeAOT compatible MCP (Model Context Protocol) framework for .NET

1977. **[mentor-mcp-server](https://github.com/cyanheads/mentor-mcp-server)** - ⭐ 32
...
1978. **[mcp-bundle](https://github.com/symfony/mcp-bundle)** - ⭐ 32
   Symfony integration bundle for Model Context Protocol (via official mcp/sdk)

1979. **[mcp-api-gateway](https://github.com/rflpazini/mcp-api-gateway)** - ⭐ 32
   A universal MCP (Model Context Protocol) server to integrate any API with Claude Desktop using only Docker configurations.

1980. **[laravel-mcp-client](https://github.com/scriptoshi/laravel-mcp-client)** - ⭐ 32

1981. **[crawl-mcp](https://github.com/wutongci/crawl-mcp)** - ⭐ 32
   完整的微信文章抓取MCP服务器 - 基于Model Context Protocol (MCP)的智能网页抓取工具，专为Cursor IDE和AI工具设计。

1982. **[mcp-domain-availability](https://github.com/imprvhub/mcp-domain-availability)** - ⭐ 32
   A Model Context Protocol (MCP) server that enables Claude Desktop to check domain availability across 50+ TLDs. Features DNS/WHOIS verification, bulk checking, and smart suggestions. Zero-clone installation via uvx.

1983. **[macOS-Notification-MCP](https://github.com/devizor/macOS-Notification-MCP)** - ⭐ 32
...
1984. **[discourse-mcp](https://github.com/discourse/discourse-mcp)** - ⭐ 32
   MCP client for Discourse sites

1985. **[mcp-databricks-server](https://github.com/RafaelCartenet/mcp-databricks-server)** - ⭐ 32
...
1992. **[simple-psql-mcp](https://github.com/NetanelBollag/simple-psql-mcp)** - ⭐ 31
...
1993. **[storyblok-mcp-server](https://github.com/Kiran1689/storyblok-mcp-server)** - ⭐ 31
...
1994. **[sunnysideFigma-Context-MCP](https://github.com/tercumantanumut/sunnysideFigma-Context-MCP)** - ⭐ 31
...
1995. **[mcp-wikidata](https://github.com/zzaebok/mcp-wikidata)** - ⭐ 31
   A server implementation for Wikidata API using the Model Context Protocol (MCP).

1996. **[wezterm-mcp](https://github.com/hiraishikentaro/wezterm-mcp)** - ⭐ 31
   About A Model Context Protocol server that executes commands in the current WezTerm session

1997. **[MCPCorpus](https://github.com/Snakinya/MCPCorpus)** - ⭐ 31
...
1998. **[seatunnel-mcp](https://github.com/ocean-zhc/seatunnel-mcp)** - ⭐ 31
...
1999. **[mcp_server](https://github.com/peppemas/mcp_server)** - ⭐ 31
   A C++ implementation of a Model Context Protocol Server with a pluggable module architecture.

2000. **[lets-learn-mcp-java](https://github.com/microsoft/lets-learn-mcp-java)** - ⭐ 31
   Learn how to build Java-based MCP Servers and Clients with LangChain4J and Quarkus

2001. **[mcp-browser-agent](https://github.com/imprvhub/mcp-browser-agent)** - ⭐ 31
   A Model Context Protocol (MCP) integration that provides Claude Desktop with autonomous browser automation capabilities. This agent enables Claude to interact with web content, manipulate DOM elements, execute JavaScript, and perform API requests.

2002. **[mcp-server-lib.el](https://github.com/laurynas-biveinis/mcp-server-lib.el)** - ⭐ 31
   Emacs Lisp implementation of the Model Context Protocol

2003. **[azure-container-apps-ai-mcp](https://github.com/Azure-Samples/azure-container-apps-ai-mcp)** - ⭐ 31
...
2004. **[mcp-weather](https://github.com/TimLukaHorstmann/mcp-weather)** - ⭐ 31
   A Model Context Protocol (MCP) server that provides hourly and daily weather forecasts using the AccuWeather API.

2005. **[PubChem-MCP-Server](https://github.com/Augmented-Nature/PubChem-MCP-Server)** - ⭐ 30
   A comprehensive Model Context Protocol (MCP) server for accessing the PubChem chemical database. This server provides access to over 110 million chemical compounds with extensive molecular properties, bioassay data, and chemical informatics tools.

2006. **[mcp-google-cse](https://github.com/Richard-Weiss/mcp-google-cse)** - ⭐ 30
   A Model Context Protocol server that provides search capabilities using a Google CSE (custom search engine).

2007. **[nostr-mcp-server](https://github.com/AustinKelsay/nostr-mcp-server)** - ⭐ 30
   A Model Context Protocol (MCP) server that provides Nostr capabilities to AI agents

2008. **[pan-mcp-relay](https://github.com/PaloAltoNetworks/pan-mcp-relay)** - ⭐ 30
   Palo Alto Networks AI Runtime Security Model Context Protocol (MCP) Relay Server

2009. **[chatwork-mcp-server](https://github.com/chatwork/chatwork-mcp-server)** - ⭐ 30
   ChatworkをAIから操作するためのMCP(Model Context Protocol)サーバー

2010. **[dev-kit](https://github.com/nguyenvanduocit/dev-kit)** - ⭐ 30
   [Model Context Protocol] Dev Kit - anything a developer need for him day to day works

2011. **[mcp-wasm](https://github.com/beekmarks/mcp-wasm)** - ⭐ 30
   A proof-of-concept implementation of a Model Context Protocol (MCP) server that runs in WebAssembly (WASM) within a web browser. This project demonstrates the integration of MCP tools and resources in a browser environment.

2012. **[mcp-hacker-news](https://github.com/paabloLC/mcp-hacker-news)** - ⭐ 30
...
2013. **[openbim-mcp](https://github.com/helenkwok/openbim-mcp)** - ⭐ 30
   Model Context Protocol (MCP) server for openBIM

2014. **[authenticator_mcp](https://github.com/firstorderai/authenticator_mcp)** - ⭐ 30
   A secure MCP (Model Context Protocol) server that enables AI agents to interact with the Authenticator App.

2015. **[mcpc](https://github.com/OlaHulleberg/mcpc)** - ⭐ 30
...
2016. **[Smart-Thinking](https://github.com/Leghis/Smart-Thinking)** - ⭐ 30
   Smart-Thinking is a Model Context Protocol (MCP) server that delivers graph-based, multi-step reasoning without relying on external AI APIs. Everything happens locally: similarity search, heuristic-based scoring, verification tracking, memory, and visualization all run in a deterministic pipeline designed for transparency and reproducibility.

2017. **[midi-mcp-server](https://github.com/tubone24/midi-mcp-server)** - ⭐ 30
...
2018. **[EU_AI_ACT_MCP](https://github.com/SonnyLabs/EU_AI_ACT_MCP)** - ⭐ 30
   EU AI Act MCP (Model Context Protocol) that connects to your AI agents, helping you to comply with the EU AI Act.

2019. **[AlphaFold-MCP-Server](https://github.com/Augmented-Nature/AlphaFold-MCP-Server)** - ⭐ 30
   A comprehensive Model Context Protocol (MCP) server that provides access to the AlphaFold Protein Structure Database through a rich set of tools and resources for protein structure prediction analysis.

2020. **[hana-mcp-server](https://github.com/HatriGt/hana-mcp-server)** - ⭐ 30
   Model Context Server Protocol for your HANA DB

2021. **[clap-mcp](https://github.com/gakonst/clap-mcp)** - ⭐ 30
   A Rust framework that bridges clap command-line applications with the Model Context Protocol (MCP)

2022. **[PRD-MCP-Server](https://github.com/Saml1211/PRD-MCP-Server)** - ⭐ 30
   Flagship Model Context Protocol server for generating Product Requirement Documents (PRDs) from codebase context.

2023. **[demo-mcp-server-client-implementation](https://github.com/mschwarzmueller/demo-mcp-server-client-implementation)** - ⭐ 30
   A demo implementation of a MCP server (consuming a dummy API) and basic client.

2024. **[awesome-devops-mcp](https://github.com/agenticdevops/awesome-devops-mcp)** - ⭐ 30
   List of Awesome MCP Servers and Clients for building Agentic Devops 

2025. **[zerodha-mcp](https://github.com/mtwn105/zerodha-mcp)** - ⭐ 30
   Zerodha MCP Server & Client - AI Agent (w/Agno & w/Google ADK)

2026. **[mcp-ollama](https://github.com/emgeee/mcp-ollama)** - ⭐ 30
   Query model running with Ollama from within Claude Desktop or other MCP clients

2027. **[mcp-client](https://github.com/edanyal/mcp-client)** - ⭐ 30
   Typescript mcp client library.

2028. **[postmancer](https://github.com/hijaz/postmancer)** - ⭐ 30
   An experimental MCP server Rest Client intended to be a replacement of tools postman & insomnia

2029. **[apisix-mcp](https://github.com/api7/apisix-mcp)** - ⭐ 30
   APISIX Model Context Protocol (MCP) server is used to bridge large language models (LLMs) with the APISIX Admin API.

2030. **[polymarket-mcp](https://github.com/ozgureyilmaz/polymarket-mcp)** - ⭐ 30
...
2031. **[pentestMCP](https://github.com/ramkansal/pentestMCP)** - ⭐ 30
   pentestMCP: AI-Powered Penetration Testing via MCP, an MCP designed for penetration testers.

2032. **[org-mcp](https://github.com/laurynas-biveinis/org-mcp)** - ⭐ 30
   Emacs Org-mode integration with Model Context Protocol (MCP) for AI-assisted task management

2033. **[awesome-blockchain-mcps](https://github.com/royyannick/awesome-blockchain-mcps)** - ⭐ 30
...
2034. **[mcp-inception](https://github.com/tanevanwifferen/mcp-inception)** - ⭐ 30
   Call another MCP client from your MCP client. Offload context windows, delegate tasks, split between models

2035. **[MCP-Server-Starter](https://github.com/TheSethRose/MCP-Server-Starter)** - ⭐ 29
   A Model Context Protocol server starter template

2036. **[mcp-server-dumplingai](https://github.com/DumplingAI/mcp-server-dumplingai)** - ⭐ 29
   MCP (Model Context Protocol) server for Dumpling AI

2037. **[mcp-cyclops](https://github.com/cyclops-ui/mcp-cyclops)** - ⭐ 29
   Model Context Protocol server for Cyclops

2038. **[mcp-badges](https://github.com/mcpx-dev/mcp-badges)** - ⭐ 29
   Get your projects MCP (Model Context Protocol)  badges

2039. **[mcp-appium-gestures](https://github.com/AppiumTestDistribution/mcp-appium-gestures)** - ⭐ 29
   This is a Model Context Protocol (MCP) server providing resources and tools for Appium mobile gestures using Actions API..

2040. **[mcp-attr](https://github.com/frozenlib/mcp-attr)** - ⭐ 29
   A library for declaratively building Model Context Protocol servers.

2041. **[rails-pg-extras-mcp](https://github.com/pawurb/rails-pg-extras-mcp)** - ⭐ 29
   MCP (Model Context Protocol) LLM interface for rails-pg-extras gem

2042. **[maven-mcp-server](https://github.com/Bigsy/maven-mcp-server)** - ⭐ 29
   An MCP (Model Context Protocol) server that provides tools for checking Maven dependency versions.

2043. **[dap_mcp](https://github.com/KashunCheng/dap_mcp)** - ⭐ 29
   Model Context Protocol (MCP) server that interacts with a Debugger

2044. **[browserai-mcp](https://github.com/brightdata/browserai-mcp)** - ⭐ 29
   A powerful Model Context Protocol (MCP) server that provides an access to serverless browser for AI agents and apps

2045. **[mcp-googletasks](https://github.com/arpitbatra123/mcp-googletasks)** - ⭐ 29
...
2046. **[mcp-tool-filter](https://github.com/Portkey-AI/mcp-tool-filter)** - ⭐ 29
...
2047. **[mcp-sync](https://github.com/ztripez/mcp-sync)** - ⭐ 29
   Sync MCP (Model Context Protocol) configurations across AI tools

2048. **[nvim-mcp](https://github.com/linw1995/nvim-mcp)** - ⭐ 29
...
2049. **[reaper-reapy-mcp](https://github.com/wegitor/reaper-reapy-mcp)** - ⭐ 29
...
2050. **[reaper-mcp](https://github.com/itsuzef/reaper-mcp)** - ⭐ 29
   A comprehensive Model Context Protocol (MCP) server that enables AI agents to create fully mixed and mastered tracks in REAPER with both MIDI and audio capabilities.

2051. **[luke-desktop](https://github.com/DrJonBrock/luke-desktop)** - ⭐ 29
   A modern desktop client for Claude AI with MCP server support, built with Tauri, React, and TypeScript.

2052. **[xmind-generator-mcp](https://github.com/BangyiZhang/xmind-generator-mcp)** - ⭐ 29
   An MCP (Model Context Protocol) server for generating Xmind mind maps. This server allows LLMs to create structured mind maps through the MCP protocol.

2053. **[p4mcp-server](https://github.com/perforce/p4mcp-server)** - ⭐ 29
...
2054. **[univer-mcp](https://github.com/dream-num/univer-mcp)** - ⭐ 29
   AI-powered spreadsheet automation through Model Context Protocol (MCP) server for Univer

2055. **[sketchfab-mcp-server](https://github.com/gregkop/sketchfab-mcp-server)** - ⭐ 28
   This is an MCP (Model Context Protocol) Server for discovering and downloading 3D models 

2056. **[mcp-testing-framework](https://github.com/L-Qun/mcp-testing-framework)** - ⭐ 28
   Testing framework for Model Context Protocol (MCP)

2057. **[laravel-mcp-sdk](https://github.com/mohamedahmed01/laravel-mcp-sdk)** - ⭐ 28
   Laravel Based Implementation for Model Context Protocol

2058. **[mcp-websocket](https://github.com/virajsharma2000/mcp-websocket)** - ⭐ 28
   This server implements an MCP (Model Context Protocol) server with WebSocket enhancements for real-time data updates.

2059. **[MCP-Scanner](https://github.com/knostic/MCP-Scanner)** - ⭐ 28
...
2060. **[mcp-server-weibo](https://github.com/qinyuanpei/mcp-server-weibo)** - ⭐ 28
   基于 Model Context Protocol 的微博数据接口服务器 - 实时获取微博用户信息、动态内容、热搜榜单、粉丝关注数据。支持用户搜索、内容搜索、话题分析，为 AI 应用提供完整的微博数据接入方案。

2061. **[mcp_autogen_sse_stdio](https://github.com/SaM-92/mcp_autogen_sse_stdio)** - ⭐ 28
   This repository demonstrates how to use AutoGen to integrate local and remote MCP (Model Context Protocol) servers. It showcases a local math tool (math_server.py) using Stdio and a remote Apify tool (RAG Web Browser Actor) via SSE for tasks like arithmetic and web browsing.

2062. **[mattermost-mcp-host](https://github.com/jagan-shanmugam/mattermost-mcp-host)** - ⭐ 28
   A Mattermost integration that connects to Model Context Protocol (MCP) servers, leveraging a LangGraph-based Agent.

2063. **[mcp](https://github.com/fastly/mcp)** - ⭐ 28
   Model Context Protocol (MCP) server for AI-powered Fastly CDN management.

2064. **[nchan-mcp-transport](https://github.com/ConechoAI/nchan-mcp-transport)** - ⭐ 28
...
2065. **[TAM-MCP-Server](https://github.com/gvaibhav/TAM-MCP-Server)** - ⭐ 28
...
2066. **[mcp-etherscan-server](https://github.com/crazyrabbitLTC/mcp-etherscan-server)** - ⭐ 28
   An MCP (Model Context Protocol) server that provides Ethereum blockchain data tools via Etherscan's API. Features include checking ETH balances, viewing transaction history, tracking ERC20 transfers, fetching contract ABIs, monitoring gas prices, and resolving ENS names.

2067. **[mcp-for-security-python](https://github.com/f1tz/mcp-for-security-python)** - ⭐ 28
...
2068. **[n8n-mcp](https://github.com/vredrick/n8n-mcp)** - ⭐ 28
   n8n MCP Server - Documentation and tools for n8n nodes via Model Context Protocol with SSE support

2069. **[supermcp](https://github.com/dhanababum/supermcp)** - ⭐ 28
...
2070. **[rod-mcp](https://github.com/go-rod/rod-mcp)** - ⭐ 28
   Model Context Protocol Server of Rod

2071. **[filesystem-mcp-server](https://github.com/cyanheads/filesystem-mcp-server)** - ⭐ 28
   A Model Context Protocol (MCP) server for platform-agnostic file capabilities, including advanced search/replace and directory tree traversal

2072. **[NetContextServer](https://github.com/willibrandon/NetContextServer)** - ⭐ 28
   A .NET implementation of the Model Context Protocol enabling AI assistants to explore and understand .NET codebases.

2073. **[Volatility-MCP-Server](https://github.com/bornpresident/Volatility-MCP-Server)** - ⭐ 28
   A Model Context Protocol (MCP) server that integrates Volatility 3 memory forensics framework with Claude

2074. **[openai-mcp-agent-dotnet](https://github.com/Azure-Samples/openai-mcp-agent-dotnet)** - ⭐ 28
   Sample to create an AI Agent using OpenAI models with any MCP server running on Azure Container Apps

2075. **[phonepi-mcp](https://github.com/priyankark/phonepi-mcp)** - ⭐ 28
...
2076. **[adb-mcp](https://github.com/srmorete/adb-mcp)** - ⭐ 28
   An MCP (Model Context Protocol) server for interacting with Android devices through ADB in TypeScript.

2077. **[mcp-tools](https://github.com/clerk/mcp-tools)** - ⭐ 28
   Tools for building modern & secure MCP integrations across the client and server side

2078. **[actor-critic-thinking-mcp](https://github.com/aquarius-wing/actor-critic-thinking-mcp)** - ⭐ 28
   A dual-perspective thinking analysis server based on Model Context Protocol (MCP), providing comprehensive performance evaluation through Actor-Critic methodology.

2079. **[vsc-mcp](https://github.com/thomasgazzoni/vsc-mcp)** - ⭐ 28
   This project provides tools that expose Language Server Protocol (LSP) functionality as MCP (Model Context Protocol) tools

2080. **[cca-mcp-configurator](https://github.com/doggy8088/cca-mcp-configurator)** - ⭐ 28
   一個簡單易用的網頁工具，用於管理 GitHub Copilot 的 MCP (Model Context Protocol) 設定

2081. **[asterisk-mcp-server](https://github.com/winfunc/asterisk-mcp-server)** - ⭐ 28
   Asterisk Model Context Protocol (MCP) server.

2082. **[searxng-mcp](https://github.com/tisDDM/searxng-mcp)** - ⭐ 28
...
2083. **[email-mcp](https://github.com/TimeCyber/email-mcp)** - ⭐ 28
   一个让AI轻松接管邮箱的MCP服务，基于 Model Context Protocol (MCP) 构建，支持在 MCP-X,Claude Desktop 等 MCP 客户端中使用。

2084. **[YFinance-Trader-MCP-ClaudeDesktop](https://github.com/SaintDoresh/YFinance-Trader-MCP-ClaudeDesktop)** - ⭐ 27
   An MCP (Model Context Protocol) tool that provides stock market data and trading capabilities using the yfinance library, specifically adapted for Claude Desktop.

2085. **[biothings-mcp](https://github.com/longevity-genie/biothings-mcp)** - ⭐ 27
   MCP (Model Context Protocol) server for biothings

2086. **[Memgpt-MCP-Server](https://github.com/Vic563/Memgpt-MCP-Server)** - ⭐ 27
   A Model Context Protocol (MCP) server that provides persistent memory and multi-model LLM support.

2087. **[excel-reader-mcp](https://github.com/ArchimedesCrypto/excel-reader-mcp)** - ⭐ 27
...
2088. **[notion-mcp](https://github.com/Badhansen/notion-mcp)** - ⭐ 27
   A simple Model Context Protocol (MCP) server that integrates with Notion's API to manage my personal todo list.

2089. **[keynote-mcp](https://github.com/easychen/keynote-mcp)** - ⭐ 27
   A Model Context Protocol (MCP) server that enables AI assistants to control Keynote presentations through AppleScript automation.

2090. **[aws-mcp](https://github.com/lokeswaran-aj/aws-mcp)** - ⭐ 27
   An MCP(Model Context Protocol) Server for AWS services

2091. **[mcp-ollama-agent](https://github.com/ausboss/mcp-ollama-agent)** - ⭐ 27
...
2092. **[claude-code-mcp](https://github.com/zebbern/claude-code-mcp)** - ⭐ 27
...
2093. **[mcpc](https://github.com/apify/mcpc)** - ⭐ 27
   Universal command-line client for the Model Context Protocol (MCP)

2094. **[mcp-proxy](https://github.com/stephenlacy/mcp-proxy)** - ⭐ 27
   Fast rust MCP proxy between stdio and SSE

2095. **[Learn-Model-Context-Protocol-with-Python](https://github.com/PacktPublishing/Learn-Model-Context-Protocol-with-Python)** - ⭐ 27
   Learn Model Context Protocol with Python, published by Packt

2096. **[gaia-x](https://github.com/YFGaia/gaia-x)** - ⭐ 27
...
2097. **[VercelGenUI_MCP](https://github.com/JamesSloan/VercelGenUI_MCP)** - ⭐ 27
   Proof of concept chat AI combining the Model Context Protocol (MCP) with Vercel's AI SDK UI

2098. **[paraview_mcp](https://github.com/llnl/paraview_mcp)** - ⭐ 27
...
2099. **[workflows-mcp-server](https://github.com/cyanheads/workflows-mcp-server)** - ⭐ 27
...
2104. **[mcp-zap-server](https://github.com/dtkmn/mcp-zap-server)** - ⭐ 27
   A Spring Boot application exposing OWASP ZAP as an MCP (Model Context Protocol) server. It lets any MCP‑compatible AI agent (e.g., Claude Desktop, Cursor) orchestrate ZAP actions—spider, active scan, import OpenAPI specs, and generate reports.

2105. **[twenty-crm-mcp-server](https://github.com/mhenry3164/twenty-crm-mcp-server)** - ⭐ 27
...
2106. **[google-workspace-mcp-server](https://github.com/epaproditus/google-workspace-mcp-server)** - ⭐ 27
   A Model Context Protocol server for Google Workspace integration (Gmail and Calendar)

2107. **[nettune](https://github.com/jtsang4/nettune)** - ⭐ 27
...
2108. **[keycloak-mcp-server](https://github.com/sshaaf/keycloak-mcp-server)** - ⭐ 27
...
2109. **[modao-proto-mcp](https://github.com/modao-dev/modao-proto-mcp)** - ⭐ 27
...
2110. **[mcp-structured-thinking](https://github.com/Promptly-Technologies-LLC/mcp-structured-thinking)** - ⭐ 27
...
2111. **[SUMO-MCP-Server](https://github.com/XRDS76354/SUMO-MCP-Server)** - ⭐ 27
...
2112. **[directus-mcp-server](https://github.com/rijkvanzanten/directus-mcp-server)** - ⭐ 26
   Model Context Protocol server for Directus

2113. **[framer-plugin-mcp](https://github.com/Sheshiyer/framer-plugin-mcp)** - ⭐ 26
   A Model Context Protocol (MCP) server for creating and managing Framer plugins with web3 capabilities

2114. **[do-remote-mcp-server-template](https://github.com/do-community/do-remote-mcp-server-template)** - ⭐ 26
   A Model Context Protocol (MCP) server that checks domain name availability using WHOIS lookups and DNS resolution

2115. **[mcp-frontend-testing](https://github.com/StudentOfJS/mcp-frontend-testing)** - ⭐ 26
   Frontend testing tools for Model Context Protocol

2116. **[pptx-xlsx-mcp](https://github.com/jenstangen1/pptx-xlsx-mcp)** - ⭐ 26
   Antrophics Model context protocol to edit powerpoint files

2117. **[mcp-web-browser](https://github.com/random-robbie/mcp-web-browser)** - ⭐ 26
   An advanced web browsing server for the Model Context Protocol (MCP) powered by Playwright, enabling headless browser interactions through a flexible, secure API.

2118. **[minds-mcp](https://github.com/mindsdb/minds-mcp)** - ⭐ 26
...
2119. **[openapi-mcp-generator](https://github.com/abutbul/openapi-mcp-generator)** - ⭐ 26
...
2123. **[mcp-client-x](https://github.com/RGGH/mcp-client-x)** - ⭐ 26
   Python MCP client + server example

2124. **[mcp-gateway](https://github.com/lucky-aeon/mcp-gateway)** - ⭐ 26
...
2125. **[mcp-log-proxy](https://github.com/emicklei/mcp-log-proxy)** - ⭐ 26
   a web logging proxy for MCP client-server communication

2126. **[langchain-mcp-tools-py](https://github.com/hideya/langchain-mcp-tools-py)** - ⭐ 26
   MCP to LangChain Tools Conversion Utility / Python

2127. **[Python-Runtime-Interpreter-MCP-Server](https://github.com/hileamlakB/Python-Runtime-Interpreter-MCP-Server)** - ⭐ 26
   PRIMS is a lightweight, open-source Model Context Protocol (MCP) server that lets LLM agents safely execute arbitrary Python code in a secure, throw-away sandbox.

2128. **[seo-insights-mcp-server](https://github.com/mrgoonie/seo-insights-mcp-server)** - ⭐ 26
...
2129. **[datagouv-mcp](https://github.com/datagouv/datagouv-mcp)** - ⭐ 26
...
2130. **[mcp-server-giphy](https://github.com/magarcia/mcp-server-giphy)** - ⭐ 25
   An implementation of Giphy integration with Model Context Protocol

2131. **[MCP-BOE](https://github.com/ComputingVictor/MCP-BOE)** - ⭐ 25
...
2132. **[alpaca-mcp-server](https://github.com/tedlikeskix/alpaca-mcp-server)** - ⭐ 25
   Model Context Protocol (MCP) server for Alpaca trading API

2133. **[gyazo-mcp-server](https://github.com/nota/gyazo-mcp-server)** - ⭐ 25
   Official Model Context Protocol server for Gyazo

2134. **[Healthcare-MCP](https://github.com/innovaccer/Healthcare-MCP)** - ⭐ 25
...
2135. **[mcp-php](https://github.com/garyblankenship/mcp-php)** - ⭐ 25
   model context protocol or mcp for php laravel

2136. **[mcp-writer-substack](https://github.com/jonathan-politzki/mcp-writer-substack)** - ⭐ 25
   Model Context Protocol to bridge in Substack writings to Claude.

2137. **[mcp-media-processor](https://github.com/maoxiaoke/mcp-media-processor)** - ⭐ 25
   A Node.js server implementing Model Context Protocol (MCP) for media processing operations, providing powerful video and image manipulation capabilities.

2138. **[mcp-webdriveragent](https://github.com/AppiumTestDistribution/mcp-webdriveragent)** - ⭐ 25
   This is a Model Context Protocol (MCP) server that provides tools for building and signing WebDriverAgent for iOS.

2139. **[turn-based-game-mcp](https://github.com/github-samples/turn-based-game-mcp)** - ⭐ 25
...
2140. **[taiwan-holiday-mcp](https://github.com/lis186/taiwan-holiday-mcp)** - ⭐ 25
   一個基於 Model Context Protocol (MCP) 的台灣假期查詢伺服器，為 AI 工具提供準確的台灣國定假日資訊。

2141. **[alibabacloud-dataworks-mcp-server](https://github.com/aliyun/alibabacloud-dataworks-mcp-server)** - ⭐ 25
   A Model Context Protocol (MCP) server that provides tools for AI, allowing it to interact with the DataWorks Open API through a standardized interface. This implementation is based on the Aliyun Open API and enables AI agents to perform cloud resources operations seamlessly.

2142. **[mcp-manager](https://github.com/nstebbins/mcp-manager)** - ⭐ 25
   CLI tool for managing Model Context Protocol (MCP) servers in one place & using them across them different clients

2143. **[php-mcp-sdk](https://github.com/dalehurley/php-mcp-sdk)** - ⭐ 25
...
2144. **[taskflow-mcp](https://github.com/pinkpixel-dev/taskflow-mcp)** - ⭐ 25
   A task management Model Context Protocol (MCP) server that helps AI assistants break down user requests into manageable tasks with subtasks, dependencies, and notes. Enforces a structured workflow with user approval steps.

2145. **[symfony-mcp-server](https://github.com/klapaudius/symfony-mcp-server)** - ⭐ 25
   A Symfony package designed for building secure servers based on the Model Context Protocol, utilizing Server-Sent Events (SSE) and/or StreamableHTTP for real-time communication. It offers a scalable tool system tailored for enterprise-grade applications.

2146. **[FalkorDB-MCPServer](https://github.com/FalkorDB/FalkorDB-MCPServer)** - ⭐ 25
   FalkorDB-MCPServer is an MCP (Model Context Protocol) server that connects LLMs to FalkorDB

2147. **[dynamic-fastmcp](https://github.com/ragieai/dynamic-fastmcp)** - ⭐ 25
...
2148. **[ton-blockchain-mcp](https://github.com/devonmojito/ton-blockchain-mcp)** - ⭐ 25
   A Model Context Protocol (MCP) server written in Python for natural language interaction with the TON blockchain 💎

2149. **[ida-headless-mcp](https://github.com/zboralski/ida-headless-mcp)** - ⭐ 25
   Headless IDA Pro binary analysis via Model Context Protocol

2150. **[elysia-mcp](https://github.com/kerlos/elysia-mcp)** - ⭐ 25
   ElysiaJS plugin for Model Context Protocol with HTTP transport

2151. **[mcp-server-semgrep](https://github.com/VetCoders/mcp-server-semgrep)** - ⭐ 25
   MCP Server Semgrep is a [Model Context Protocol](https://modelcontextprotocol.io) compliant server that integrates the powerful Semgrep static analysis tool with AI assistants like Anthropic Claude. It enables advanced code analysis, security vulnerability detection, and code quality improvements directly through a conversational interface.

2152. **[deep-research-mcp](https://github.com/pinkpixel-dev/deep-research-mcp)** - ⭐ 25
   A Model Context Protocol (MCP) compliant server designed for comprehensive web research. It uses Tavily's Search and Crawl APIs to gather detailed information on a given topic, then structures this data in a format perfect for LLMs to create high-quality markdown documents.

2153. **[WebSearch-MCP](https://github.com/mnhlt/WebSearch-MCP)** - ⭐ 25
...
2154. **[levante](https://github.com/levante-hub/levante)** - ⭐ 25
   Levante - Personal, Secure, Free, Local AI, MCP Client

2155. **[ai-foundry-agents-samples](https://github.com/Azure-Samples/ai-foundry-agents-samples)** - ⭐ 25
   Azure AI Foundry - Agents related sample code

2156. **[mcpmcp-server](https://github.com/glenngillen/mcpmcp-server)** - ⭐ 25
   Discover, setup, and integrate MCP servers with your favorite clients. Unlock the full potential of AI in your daily workflow.

2157. **[puzzlebox](https://github.com/cliffhall/puzzlebox)** - ⭐ 25
...
2158. **[Tiny-OAI-MCP-Agent](https://github.com/jalr4ever/Tiny-OAI-MCP-Agent)** - ⭐ 25
   A MCP protocol agent that operates a SQLite using natural language by OpenAI-Compatible LLM.

2159. **[mcp-server-fuzzer](https://github.com/Agent-Hellboy/mcp-server-fuzzer)** - ⭐ 25
   A generic mcp server fuzzer

2160. **[slack-mcp-server](https://github.com/AVIMBU/slack-mcp-server)** - ⭐ 25
   A Model Context Protocol Server for Interacting with Slack

2161. **[vision-one-mcp-server](https://github.com/trendmicro/vision-one-mcp-server)** - ⭐ 25
...
2162. **[whistle-mcp](https://github.com/7gugu/whistle-mcp)** - ⭐ 25
...
2163. **[omop_mcp](https://github.com/OHNLP/omop_mcp)** - ⭐ 25
...
2164. **[firefox-devtools-mcp](https://github.com/freema/firefox-devtools-mcp)** - ⭐ 25
   Model Context Protocol server for Firefox DevTools - enables AI assistants to inspect and control Firefox browser through the Remote Debugging Protocol

2165. **[MCP-Developer-SubAgent](https://github.com/gensecaihq/MCP-Developer-SubAgent)** - ⭐ 25
...
2166. **[React-Native-MCP](https://github.com/MrNitro360/React-Native-MCP)** - ⭐ 25
...
2167. **[systemprompt-mcp-notion](https://github.com/Ejb503/systemprompt-mcp-notion)** - ⭐ 24
...
2168. **[semrush-mcp](https://github.com/mrkooblu/semrush-mcp)** - ⭐ 24
   A Model Context Protocol (MCP) server implementation that provides tools for accessing Semrush API data.

2169. **[MalwareBazaar_MCP](https://github.com/mytechnotalent/MalwareBazaar_MCP)** - ⭐ 24
   An AI-driven MCP server that autonomously interfaces with Malware Bazaar, delivering real-time threat intel and sample metadata for authorized cybersecurity research workflows.

2170. **[Unlock-your-agents-potential-with-Model-Context-Protocol-PostgreSQL-Workshop](https://github.com/gloveboxes/Unlock-your-agents-potential-with-Model-Context-Protocol-PostgreSQL-Workshop)** - ⭐ 24

2171. **[ccmcp](https://github.com/gsong/ccmcp)** - ⭐ 24
   A CLI tool that intelligently discovers, validates, and selects MCP (Model Context Protocol) server configurations for Claude Code.

2172. **[agent-hub-mcp](https://github.com/gilbarbara/agent-hub-mcp)** - ⭐ 24
   A Model Context Protocol (MCP) server that enables communication and coordination between multiple AI agents

2173. **[opnsense-mcp-server](https://github.com/floriangrousset/opnsense-mcp-server)** - ⭐ 24
...
2174. **[n8n-AI-agent-DVM-MCP-client](https://github.com/r0d8lsh0p/n8n-AI-agent-DVM-MCP-client)** - ⭐ 24
...
2175. **[puppeteer-mcp-claude](https://github.com/jaenster/puppeteer-mcp-claude)** - ⭐ 24
...
2176. **[mcp-server-semgrep](https://github.com/Szowesgad/mcp-server-semgrep)** - ⭐ 24
   MCP Server Semgrep is a [Model Context Protocol](https://modelcontextprotocol.io) compliant server that integrates the powerful Semgrep static analysis tool with AI assistants like Anthropic Claude. It enables advanced code analysis, security vulnerability detection, and code quality improvements directly through a conversational interface.

2177. **[nebulagraph-mcp-server](https://github.com/nebula-contrib/nebulagraph-mcp-server)** - ⭐ 24
   Model Context Protocol Server for NebulaGraph 3.x

2178. **[python-sequential-thinking-mcp](https://github.com/XD3an/python-sequential-thinking-mcp)** - ⭐ 24
...
2179. **[clay-mcp](https://github.com/clay-inc/clay-mcp)** - ⭐ 24
   A simple Model Context Protocol (MCP) server for Clay.

2180. **[MCP](https://github.com/EduBase/MCP)** - ⭐ 24
   The EduBase MCP server enables Claude and other LLMs to interact with EduBase's comprehensive e-learning platform through the Model Context Protocol (MCP).

2181. **[kaggle-mcp](https://github.com/54yyyu/kaggle-mcp)** - ⭐ 24
...
2182. **[google-search-console-mcp-server](https://github.com/Shin-sibainu/google-search-console-mcp-server)** - ⭐ 24
   Model Context Protocol server for Google Search Console API - integrate with Claude Code and Claude Desktop

2183. **[mcp-task-manager-server](https://github.com/bsmi021/mcp-task-manager-server)** - ⭐ 24
   A local Model Context Protocol (MCP) server providing backend tools for client-driven project and task management using a SQLite database.

2184. **[brlaw_mcp_server](https://github.com/pdmtt/brlaw_mcp_server)** - ⭐ 24
   A MCP (Model Context Protocol) server for agent-driven research on Brazilian law using official sources

2185. **[DeepResearchMCP](https://github.com/ameeralns/DeepResearchMCP)** - ⭐ 24
...
2186. **[aistudio-mcp-server](https://github.com/eternnoir/aistudio-mcp-server)** - ⭐ 24
...
2187. **[MCPSecBench](https://github.com/AIS2Lab/MCPSecBench)** - ⭐ 24
   MCPSecBench: A Systematic Security Benchmark and Playground for Testing Model Context Protocols

2188. **[mcp-template-dotnet](https://github.com/NikiforovAll/mcp-template-dotnet)** - ⭐ 24
   This repository contains a template for creating a Model Context Protocol (MCP) applications in .NET.

2189. **[xhs-mcp](https://github.com/Algovate/xhs-mcp)** - ⭐ 24
   用于小红书（xiaohongshu.com）的 Model Context Protocol（MCP）服务器与 CLI 工具，支持登录、发布、搜索、推荐等自动化能力

2190. **[mcp-playground](https://github.com/zanetworker/mcp-playground)** - ⭐ 24
   Simple MCP Client for remote MCP Servers 🌐

2191. **[awesome-mcp-lists](https://github.com/collabnix/awesome-mcp-lists)** - ⭐ 24
   A Curated List of MCP Servers, Clients and Toolkits

2192. **[mcp_streamable_http](https://github.com/theailanguage/mcp_streamable_http)** - ⭐ 24
   Educational repo for MCP streamable HTTP servers and clients

2193. **[Awesome-MCP](https://github.com/Albertchamberlain/Awesome-MCP)** - ⭐ 24
   Awesome-MCP Servers & Clients & Funny things

2194. **[openai-copilot](https://github.com/feiskyer/openai-copilot)** - ⭐ 24
   Your life Copilot powered by LLM models (CLI interface for LLM models with MCP tools).

2195. **[freepik-mcp](https://github.com/freepik-company/freepik-mcp)** - ⭐ 24
   The Freepik enables popular agent Model Context Protocol (MCP) to integrate with Freepik APIs through function calling.

2196. **[powerplatform-mcp](https://github.com/michsob/powerplatform-mcp)** - ⭐ 24
   PowerPlatform Model Context Protocol server

2197. **[bgg-mcp](https://github.com/kkjdaniel/bgg-mcp)** - ⭐ 24
   BGG MCP provides access to BoardGameGeek and a variety of board game related data through the Model Context Protocol. Enabling retrieval and filtering of board game data, user collections, and profiles.

2198. **[Model-Context-Protocol](https://github.com/Coding-Crashkurse/Model-Context-Protocol)** - ⭐ 23

2199. **[greptimedb-mcp-server](https://github.com/GreptimeTeam/greptimedb-mcp-server)** - ⭐ 23
   A Model Context Protocol (MCP) server for GreptimeDB

2200. **[mcp-server](https://github.com/blockscout/mcp-server)** - ⭐ 23
   Wraps Blockscout APIs and exposes blockchain data by Model Context Protocol

2201. **[jigsawstack-mcp-server](https://github.com/JigsawStack/jigsawstack-mcp-server)** - ⭐ 23
   Model Context Protocol Server that allows AI models to interact with JigsawStack models!

2202. **[metabase-mcp-server](https://github.com/hyeongjun-dev/metabase-mcp-server)** - ⭐ 23
   A Model Context Protocol server that integrates AI assistants with Metabase analytics platform

2203. **[calendar-mcp](https://github.com/deciduus/calendar-mcp)** - ⭐ 23
...
2204. **[cortex](https://github.com/FreePeak/cortex)** - ⭐ 23
...
2205. **[paraview_mcp](https://github.com/LLNL/paraview_mcp)** - ⭐ 23
   ParaView-MCP integrates multimodal LLMs with ParaView via Model Context Protocol, enabling natural language control of scientific visualizations. The agent observes the viewport for visual feedback, making complex visualization tool accessible to all users while providing intelligent automation for experts.

2206. **[lineshopping-api-mcp](https://github.com/woraphol-j/lineshopping-api-mcp)** - ⭐ 23
...
2207. **[mcp_rss](https://github.com/buhe/mcp_rss)** - ⭐ 23
   MCP RSS is a Model Context Protocol (MCP) server for interacting with RSS feeds.

2208. **[home-assistant-mcp](https://github.com/hpohlmann/home-assistant-mcp)** - ⭐ 23
...
2209. **[mcp-twitter-server](https://github.com/crazyrabbitLTC/mcp-twitter-server)** - ⭐ 23
   Model Context Protocol Server for Accessing twitter

2210. **[fastify-mcp](https://github.com/haroldadmin/fastify-mcp)** - ⭐ 23
   A Fastify plugin to run Model Context Protocol (MCP) servers

2211. **[batchdata-mcp-real-estate](https://github.com/zellerhaus/batchdata-mcp-real-estate)** - ⭐ 23
...
2212. **[lua-resty-mcp](https://github.com/ufownl/lua-resty-mcp)** - ⭐ 23
   Model Context Protocol SDK implemented in Lua for OpenResty

2213. **[mcp-server-starter-ts](https://github.com/alexanderop/mcp-server-starter-ts)** - ⭐ 23
   A minimal TypeScript starter template for building Model Context Protocol (MCP) servers.

2214. **[strava-mcp](https://github.com/kw510/strava-mcp)** - ⭐ 23
...
2215. **[mcp-slicer](https://github.com/zhaoyouj/mcp-slicer)** - ⭐ 23
   A Model Context Protocol server for 3D Slicer integration

2216. **[forgejo-mcp](https://github.com/goern/forgejo-mcp)** - ⭐ 23
...
2217. **[identity-spec](https://github.com/agntcy/identity-spec)** - ⭐ 23
   AGNTCY Identity allows to onboard, create and verify identities for Agents, Model Context Protocol (MCP) Servers and Multi-Agent Systems (MASs).

2218. **[embedded-debugger-mcp](https://github.com/Adancurusul/embedded-debugger-mcp)** - ⭐ 23
   A Model Context Protocol server for embedded debugging with probe-rs - supports ARM Cortex-M, RISC-V debugging via J-Link, ST-Link, and more

2219. **[enhanced-mcp-memory](https://github.com/cbunting99/enhanced-mcp-memory)** - ⭐ 23
   An enhanced MCP (Model Context Protocol) server for intelligent memory and task management, designed for AI assistants and development workflows. Features semantic search, automatic task extraction, knowledge graphs, and comprehensive project management.

2220. **[mcp-ffmpeg-helper](https://github.com/sworddut/mcp-ffmpeg-helper)** - ⭐ 23
   一个基于 Model Context Protocol (MCP) 的 FFmpeg 辅助工具，提供视频处理功能。

2221. **[mcp-client-agent](https://github.com/shane-kercheval/mcp-client-agent)** - ⭐ 23
   CLI that uses DSPy to interact with MCP servers.

2222. **[mcp-community](https://github.com/Mirascope/mcp-community)** - ⭐ 23
   Easily run, deploy, and connect to MCP servers

2223. **[MiAO-MCP-for-Unity](https://github.com/MiAO-AI-Lab/MiAO-MCP-for-Unity)** - ⭐ 23
...
2224. **[MCP-123](https://github.com/Tylersuard/MCP-123)** - ⭐ 23
   The easiest possible implementation of an MCP server and client.  Set up a server or a client in 2 lines of code.

2225. **[readwise-vector-db](https://github.com/leonardsellem/readwise-vector-db)** - ⭐ 23
...
2226. **[jsonv-ts](https://github.com/dswbx/jsonv-ts)** - ⭐ 23
   JSON Schema builder and validator for TypeScript with static type inference, Hono middleware for OpenAPI generation and validation, and MCP server/client implementation. Lightweight, dependency-free, and built on Web Standards.

2227. **[zillow-mcp-server](https://github.com/sap156/zillow-mcp-server)** - ⭐ 23
   Zillow MCP Server for real estate data access via the Model Context Protocol

2228. **[solana-mcp](https://github.com/tony-42069/solana-mcp)** - ⭐ 23
...
2229. **[minimax_search](https://github.com/MiniMax-AI/minimax_search)** - ⭐ 23
   MiniMax Search is an MCP (Model Context Protocol) server that provides web search and browsing capabilities.

2230. **[aisdk-mcp-bridge](https://github.com/vrknetha/aisdk-mcp-bridge)** - ⭐ 23
...
2231. **[RevitMCP](https://github.com/oakplank/RevitMCP)** - ⭐ 23
   model context protocol for Autodesk Revit

2232. **[nlweb-net](https://github.com/nlweb-ai/nlweb-net)** - ⭐ 23
...
2233. **[mcp-server-tauri](https://github.com/hypothesi/mcp-server-tauri)** - ⭐ 23
   A Model Context Protocol (MCP) server and plugin for Tauri v2 development

2234. **[nobitex-mcp-server](https://github.com/xmannii/nobitex-mcp-server)** - ⭐ 22
   a Model Context Protocol (MCP) server that provides access to cryptocurrency market data from the Nobitex API.

2235. **[mcp-server-oracle](https://github.com/hdcola/mcp-server-oracle)** - ⭐ 22
   Model Context Protocol server to access oracle database

2236. **[lightdash-mcp-server](https://github.com/syucream/lightdash-mcp-server)** - ⭐ 22
   A MCP(Model Context Protocol) server that accesses to Lightdash

2237. **[mcp-pa-ai-agent](https://github.com/zhangzhongnan928/mcp-pa-ai-agent)** - ⭐ 22
   A personal assistant AI agent built with the Model Context Protocol (MCP)

2238. **[higress-ops-mcp-server](https://github.com/higress-group/higress-ops-mcp-server)** - ⭐ 22
   A Model Context Protocol (MCP) server implementation that enables comprehensive configuration and management of Higress.

2239. **[Elysia-mcp](https://github.com/keithagroves/Elysia-mcp)** - ⭐ 22
   Model Context Protocol (MCP) Server for Bun and Elysia

2240. **[mcp-flux-studio](https://github.com/jmanhype/mcp-flux-studio)** - ⭐ 22
   A Model Context Protocol server for Flux image generation, providing tools for image generation, manipulation, and control

2241. **[DANP-Engine](https://github.com/DANP-LABS/DANP-Engine)** - ⭐ 22
   A trusted AI Model Context Protocol (MCP) runtime for secure, decentralized AI tools and services.

2242. **[mcp-sse-authenticated-cloud-run](https://github.com/the-freetech-company/mcp-sse-authenticated-cloud-run)** - ⭐ 22
   Host an Model Context Protocol SSE deployment on Cloud Run, Authenticating with IAM.

2243. **[prometheus-mcp](https://github.com/idanfishman/prometheus-mcp)** - ⭐ 22
   A Model Context Protocol (MCP) server implementation that provides AI agents with programmatic access to Prometheus metrics via a unified interface.

2244. **[MobSF-MCP](https://github.com/il-il1/MobSF-MCP)** - ⭐ 22
   a Node.js-based Model Context Protocol implementation for MobSF

2245. **[async-mcp](https://github.com/v3g42/async-mcp)** - ⭐ 22
   A minimalistic async Rust implementation of the Model Context Protocol (MCP).

2246. **[mcpagentai](https://github.com/mcpagents-ai/mcpagentai)** - ⭐ 22
...
2247. **[bzm-mcp](https://github.com/Blazemeter/bzm-mcp)** - ⭐ 22
...
2248. **[p5js-ai-editor](https://github.com/adilmoujahid/p5js-ai-editor)** - ⭐ 22
...
2249. **[meeting-mcp](https://github.com/Meeting-BaaS/meeting-mcp)** - ⭐ 22
   Model Context Protocol server for AI assistants to create meeting bots, search transcripts, and manage meeting recordings.

2250. **[cursor-db-mcp](https://github.com/jbdamask/cursor-db-mcp)** - ⭐ 22
   Model Context Protocol server for querying Cursor chat history

2251. **[github-repo-mcp](https://github.com/Ryan0204/github-repo-mcp)** - ⭐ 22
   Model Context Protocol server for Github Repo // Reading Github Repo

2252. **[mcp-caiyun-weather](https://github.com/caiyunapp/mcp-caiyun-weather)** - ⭐ 22
   A Model Context Protocol (MCP) server for Caiyun (ColorfulClouds) Weather.

2253. **[nestjs-mcp](https://github.com/bamada/nestjs-mcp)** - ⭐ 22
   NestJS module for seamless Model Context Protocol (MCP) server integration using decorators.

2254. **[openproject-mcp-server](https://github.com/AndyEverything/openproject-mcp-server)** - ⭐ 22
   A Model Context Protocol (MCP) server that provides seamless integration with OpenProject API v3.

2255. **[printify-mcp](https://github.com/TSavo/printify-mcp)** - ⭐ 22
   A Model Context Protocol (MCP) server for integrating AI assistants with Printify's print-on-demand platform

2256. **[silverbullet-mcp](https://github.com/Ahmad-A0/silverbullet-mcp)** - ⭐ 22
   A Model Context Protocol (MCP) server to interact with your SilverBullet notes and data.

2257. **[svgmaker-mcp](https://github.com/GenWaveLLC/svgmaker-mcp)** - ⭐ 22
...
2258. **[openscad-mcp](https://github.com/quellant/openscad-mcp)** - ⭐ 22
   A Model Context Protocol (MCP) server for OpenSCAD 3D modeling and rendering

2259. **[ddg_search](https://github.com/OEvortex/ddg_search)** - ⭐ 22
   A powerful Model Context Protocol (MCP) server for web search and URL content extraction using DuckDuckGo.

2260. **[mcp-claude-spotify](https://github.com/imprvhub/mcp-claude-spotify)** - ⭐ 22
   An integration that allows Claude Desktop to interact with Spotify using the Model Context Protocol (MCP).

2261. **[cf-mcp-client](https://github.com/cpage-pivotal/cf-mcp-client)** - ⭐ 22
   Tanzu Platform Chat

2262. **[supabase-mcp-client](https://github.com/tambo-ai/supabase-mcp-client)** - ⭐ 22
   Supabase MCP client react app with Tambo

2263. **[biznagafest-mcp](https://github.com/0GiS0/biznagafest-mcp)** - ⭐ 22
   MCP Servers en Málaga con salero

2264. **[langchain-mcp-tools-ts](https://github.com/hideya/langchain-mcp-tools-ts)** - ⭐ 22
   MCP to LangChain Tools Conversion Utility / TypeScript

2265. **[pulse-editor](https://github.com/ClayPulse/pulse-editor)** - ⭐ 22
...
2266. **[codesys-mcp-toolkit](https://github.com/johannesPettersson80/codesys-mcp-toolkit)** - ⭐ 22
   Model Context Protocol server for CODESYS automation platform

2267. **[bridge-mcp](https://github.com/codingjam/bridge-mcp)** - ⭐ 21
...
2268. **[cml-mcp](https://github.com/xorrkaz/cml-mcp)** - ⭐ 21
   A Model Context Protocol (MCP) Server for Cisco Modeling Labs (CML)

2269. **[mcpsharepoint](https://github.com/BrianCusack/mcpsharepoint)** - ⭐ 21
   Model Context Protocol server that provides access to Organisational SharePoint.

2270. **[dbt-docs-mcp](https://github.com/mattijsdp/dbt-docs-mcp)** - ⭐ 21
   MCP (model context protocol) server for interacting with dbt Docs

2271. **[command-executor-mcp-server](https://github.com/Sunwood-ai-labs/command-executor-mcp-server)** - ⭐ 21
   Model Context Protocol Server for Safely Executing Pre-approved Commands

2272. **[emqx-mcp-server](https://github.com/Benniu/emqx-mcp-server)** - ⭐ 21
   A Model Context Protocol (MCP) server implementation that provides EMQX MQTT broker interaction.

2273. **[mcp-sentry](https://github.com/MCP-100/mcp-sentry)** - ⭐ 21
   A Model Context Protocol server for retrieving and analyzing issues from Sentry.io

2274. **[fastify-mcp-server](https://github.com/flaviodelgrosso/fastify-mcp-server)** - ⭐ 21
   Fastify plugin to easily spin up Model Context Protocol (MCP) HTTP servers

2275. **[mcp-korean-spell](https://github.com/winterjung/mcp-korean-spell)** - ⭐ 21
   MCP(Model Context Protocol) server designed for Korean spell checking

2276. **[DocsRay](https://github.com/MIMICLab/DocsRay)** - ⭐ 21
   Lightweight PDF Q&A tool powered by RAG (Retrieval-Augmented Generation) with MCP (Model Context Protocol) Support.

2277. **[MCPRules](https://github.com/bartwisch/MCPRules)** - ⭐ 21
...
2278. **[code-context-mcp](https://github.com/fkesheh/code-context-mcp)** - ⭐ 21
   A Model Context Protocol (MCP) server for providing code context from git repositories

2279. **[slack-mcp-client](https://github.com/csonigo/slack-mcp-client)** - ⭐ 21
   An MCP client for slack in Typescript

2280. **[mcp-knowledge-base](https://github.com/hjlee94/mcp-knowledge-base)** - ⭐ 21
   MCP agent/client/server implementation for private knowledge base

2281. **[google-search-console-mcp](https://github.com/surendranb/google-search-console-mcp)** - ⭐ 21
   Google Search Console MCP Server for Claude, Cursor, Windsurf and other MCP Clients

2282. **[awesome-mcp](https://github.com/MCPHubCloud/awesome-mcp)** - ⭐ 21
   A collection of mcp servers/client/sdks

2283. **[MCP_A2A](https://github.com/regismesquita/MCP_A2A)** - ⭐ 21
...
2284. **[aj-mcp](https://github.com/lightweight-component/aj-mcp)** - ⭐ 21
   Simple MCP SDK in Java

2285. **[mcp-reticle](https://github.com/LabTerminal/mcp-reticle)** - ⭐ 21
   Reticle intercepts, visualizes, and profiles JSON-RPC traffic between your LLM and MCP servers in real-time, with zero latency overhead. Stop debugging blind. Start seeing everything.

2286. **[skill-mcp](https://github.com/fkesheh/skill-mcp)** - ⭐ 20
...
2287. **[ib-mcp-cache-server](https://github.com/ibproduct/ib-mcp-cache-server)** - ⭐ 20
   Memory Cache Server for use with supported MCP API Clients.

2288. **[hs-mcp](https://github.com/buecking/hs-mcp)** - ⭐ 20
   Haskell server/client for MCP (Model Context Protocol)

2289. **[zotero-mcp-server](https://github.com/swairshah/zotero-mcp-server)** - ⭐ 20
   MCP server to expose local zotero repository to MCP clients 

2290. **[metals-standalone-client](https://github.com/jpablo/metals-standalone-client)** - ⭐ 20
   Minimal Metals stand alone client that allows running the metals mcp server

2291. **[nix-mcp-servers](https://github.com/ismail-kattakath/nix-mcp-servers)** - ⭐ 20
   A nix flake for configuring Model Context Protocol (MCP) servers across supported AI assistant clients

2292. **[mcp-server-runner](https://github.com/yonaka15/mcp-server-runner)** - ⭐ 20
...
2293. **[congressMCP](https://github.com/amurshak/congressMCP)** - ⭐ 20
   An MCP server allowing AI agents and MCP clients to interface with the Congress.gov API

2294. **[mcp-ai-agent](https://github.com/fkesheh/mcp-ai-agent)** - ⭐ 20
...
2295. **[server-sharepoint](https://github.com/Zerg00s/server-sharepoint)** - ⭐ 20
...
2296. **[d365fo-client](https://github.com/mafzaal/d365fo-client)** - ⭐ 20
...
2303. **[room-mcp](https://github.com/agree-able/room-mcp)** - ⭐ 19
   Allow MCP clients like claude-desktop to use rooms to coordinate with other agents

2304. **[mcp-deepseek-demo](https://github.com/Ulanxx/mcp-deepseek-demo)** - ⭐ 19
   deepseek 结合 mcp 场景，最小用例，包括 client and server

2305. **[starbase](https://github.com/metorial/starbase)** - ⭐ 19
   Connect, explore, and test any MCP server with AI models 🤖 ⚡

2306. **[guidance-for-scalable-model-inference-and-agentic-ai-on-amazon-eks](https://github.com/aws-solutions-library-samples/guidance-for-scalable-model-inference-and-agentic-ai-on-amazon-eks)** - ⭐ 19
...
2307. **[mcp-framework](https://github.com/koki7o/mcp-framework)** - ⭐ 19
   Rust MCP framework for building AI agents

2308. **[flutter-ai-labs](https://github.com/theshivamlko/flutter-ai-labs)** - ⭐ 19
   A curated collection of LLM-powered Flutter apps built using RAG, AI Agents, Multi-Agent Systems, MCP, and Voice Agents.

2309. **[mcp-client-cli](https://github.com/thedotmack/mcp-client-cli)** - ⭐ 19
   Command-line interface for any Model Context Protocol (MCP) server.

2310. **[agent-twitter-client-mcp](https://github.com/ryanmac/agent-twitter-client-mcp)** - ⭐ 18
...
2311. **[mcp-server-client-demo](https://github.com/S1LV3RJ1NX/mcp-server-client-demo)** - ⭐ 18
   Streamable HTTP based MCP server and Client demo with auto registry, Dockerfile setup and env. 

2312. **[linux-command-mcp](https://github.com/xkiranj/linux-command-mcp)** - ⭐ 18
   MCP server and client for running Linux commands

2313. **[eleven.shopping](https://github.com/elevenlabs/eleven.shopping)** - ⭐ 18
   ElevenLabs Agent with Storefront MCP UI Server & MCP UI client

2314. **[typescript-mcp-client](https://github.com/CodelyTV/typescript-mcp-client)** - ⭐ 18

2315. **[lotus-wisdom-mcp](https://github.com/linxule/lotus-wisdom-mcp)** - ⭐ 18
...
2316. **[openpyxl-mcp-server](https://github.com/jonemo/openpyxl-mcp-server)** - ⭐ 18
...
2317. **[sufetch](https://github.com/productdevbook/sufetch)** - ⭐ 18
   Type-safe OpenAPI clients with MCP server for AI-driven API exploration

2318. **[agent-mcp](https://github.com/grupa-ai/agent-mcp)** - ⭐ 18
   MCPAgent for Grupa.AI Multi-agent Collaboration Network (MACNET) with Model Context Protocol (MCP) capabilities baked in

2319. **[mcp-server](https://github.com/paperinvest/mcp-server)** - ⭐ 18
   Official MCP server for Paper's trading platform - enables AI assistants to interact with Paper's API

2320. **[relace-mcp](https://github.com/possible055/relace-mcp)** - ⭐ 18
   Unofficial Relace MCP client with AI features. Personal project; not affiliated with or endorsed by Relace

2321. **[SimpleMcp.Demo](https://github.com/hassanhabib/SimpleMcp.Demo)** - ⭐ 18
   Simplest Possible Demo for Building MCP Server & Client

2322. **[mcp-web-scraper](https://github.com/Decodo/mcp-web-scraper)** - ⭐ 17
   The Decodo MCP server which enables MCP clients to interface with services.

2323. **[MCP-Mastery-with-Claude-and-Langchain](https://github.com/laxmimerit/MCP-Mastery-with-Claude-and-Langchain)** - ⭐ 17
   Build MCP servers & clients with Python, Streamlit, ChromaDB, LangChain, LangGraph agents, and Ollama integrations

2324. **[smartlead-mcp-server](https://github.com/jonathan-politzki/smartlead-mcp-server)** - ⭐ 17
   Local version of Smartlead MCP for quick download and deployment to MCP compatible clients or n8n.

2325. **[mcp-http-client-example](https://github.com/slavashvets/mcp-http-client-example)** - ⭐ 17
   Simple example client demonstrating how to connect to MCP servers over HTTP (SSE)

2326. **[rollbar-mcp-server](https://github.com/rollbar/rollbar-mcp-server)** - ⭐ 17
   Pre-release - Model Context Protocol server for Rollbar

2327. **[jiki](https://github.com/teilomillet/jiki)** - ⭐ 17

2328. **[mcpx](https://github.com/AIGC-Hackers/mcpx)** - ⭐ 17
...
2329. **[MCP-Development-with-Rust](https://github.com/RustSandbox/MCP-Development-with-Rust)** - ⭐ 17
...
2330. **[mcp-copilot](https://github.com/tshu-w/mcp-copilot)** - ⭐ 17
   A meta MCP server that seamlessly scales LLMs to 1000+ MCP servers through automatic routing.

2331. **[deep-research](https://github.com/ssdeanx/deep-research)** - ⭐ 17
...
2332. **[mcpbi](https://github.com/jonaolden/mcpbi)** - ⭐ 17
   PowerBI MCP server to give LLM clients (Claude, GH Copilot,etc) context from locally running PowerBI Desktop instances.

2333. **[muxi](https://github.com/ranaroussi/muxi)** - ⭐ 17
   An extensible AI agents framework

2334. **[mcp-email-client](https://github.com/gamalan/mcp-email-client)** - ⭐ 16
   Email Client as MCP Server. Feature: multiple configuration, more than just gmail

2335. **[mcp-oauth-proxy](https://github.com/obot-platform/mcp-oauth-proxy)** - ⭐ 16
   Oauth 2.1 proxy server that can autheticate client and proxy requests to mcp server

2336. **[oneshot](https://github.com/Destiner/oneshot)** - ⭐ 16
   Anthropic MCP client for macOS

2337. **[unity-mcp](https://github.com/wondeks/unity-mcp)** - ⭐ 16
   A Unity MCP server that allows MCP clients like Claude Desktop or Cursor to perform Unity Editor actions.

2338. **[CereBro](https://github.com/rob1997/CereBro)** - ⭐ 16
   A model-agnostic MCP Client-Server for .Net and Unity

2339. **[google-drive-mcp](https://github.com/piotr-agier/google-drive-mcp)** - ⭐ 16
...
2340. **[mssqlclient-mcp-server](https://github.com/aadversteeg/mssqlclient-mcp-server)** - ⭐ 16
...
2341. **[lite-mcp-client](https://github.com/sligter/lite-mcp-client)** - ⭐ 16
   Lite-MCP-Client是一个基于命令行的轻量级MCP客户端工具

2342. **[EasyMCP](https://github.com/mshojaei77/EasyMCP)** - ⭐ 16
...
2343. **[askit](https://github.com/johnrobinsn/askit)** - ⭐ 16
   LLM Function Calling Library and CLI with Support for MCP Servers

2344. **[mcp-libsql](https://github.com/Xexr/mcp-libsql)** - ⭐ 16
...
2345. **[context-lens](https://github.com/cornelcroi/context-lens)** - ⭐ 16
...
2346. **[google-scholar-mcp](https://github.com/mochow13/google-scholar-mcp)** - ⭐ 16
   An MCP server for Google Scholar written in TypeScript with Streamable HTTP

2347. **[mcp-installer](https://github.com/joobisb/mcp-installer)** - ⭐ 16
   Simplifies the installation and management of MCP (Model Context Protocol) servers across different AI clients.

2348. **[appvector-mcp](https://github.com/Multivariate-AI-Inc/appvector-mcp)** - ⭐ 16
...
2352. **[ACP-MCP-Server](https://github.com/GongRzhe/ACP-MCP-Server)** - ⭐ 16
...
2353. **[mcp_client](https://github.com/app-appplayer/mcp_client)** - ⭐ 15

2354. **[MCP-Analyzer](https://github.com/klara-research/MCP-Analyzer)** - ⭐ 15
   An MCP server to read MCP logs to debug directly inside the client

2355. **[mistr-agent](https://github.com/itisaevalex/mistr-agent)** - ⭐ 15
...
2356. **[mcp-server](https://github.com/HarperFast/mcp-server)** - ⭐ 15
   An MCP server providing an interface for MCP clients to access data within Harper.

2357. **[protocols-io-mcp-server](https://github.com/hqn21/protocols-io-mcp-server)** - ⭐ 15
   An MCP server that enables MCP clients like Claude Desktop to interact with data from protocols.io.

2358. **[sveltekit-mcp-starter](https://github.com/axel-rock/sveltekit-mcp-starter)** - ⭐ 15

2359. **[MCP-Agent](https://github.com/CursorTouch/MCP-Agent)** - ⭐ 15
   Connect to any MCP servers using agents

2360. **[systemprompt-mcp-core](https://github.com/Ejb503/systemprompt-mcp-core)** - ⭐ 14
   The core MCP extension for Systemprompt MCP multimodal client

2361. **[Open-MCP-Client](https://github.com/GongRzhe/Open-MCP-Client)** - ⭐ 14
...
2362. **[signal-mcp-client](https://github.com/piebro/signal-mcp-client)** - ⭐ 14
   An MCP client that uses signal for sending and receiving messages.

2363. **[mcp-this](https://github.com/shane-kercheval/mcp-this)** - ⭐ 14
...
2364. **[github-repos-manager-mcp](https://github.com/kurdin/github-repos-manager-mcp)** - ⭐ 14
...
2365. **[unity-editor-mcp](https://github.com/ozankasikci/unity-editor-mcp)** - ⭐ 14
   An MCP server and client for LLMs to interact with Unity Projects

2366. **[vite-plugin-mcp-client-tools](https://github.com/atesgoral/vite-plugin-mcp-client-tools)** - ⭐ 14
   Pluggable Vite MCP plugin that brings client-side tools to your existing Vite setup

2367. **[llm-sse-mcp-demo-2025](https://github.com/nlinhvu/llm-sse-mcp-demo-2025)** - ⭐ 14
...
2368. **[mcp-bundler](https://github.com/wrtnlabs/mcp-bundler)** - ⭐ 14
   Is the MCP configuration too complicated? You can easily share your own simplified setup!

2369. **[mcp-cli](https://github.com/tilesprivacy/mcp-cli)** - ⭐ 14
   Interactive CLI client for remote Model Context Protocol (MCP) servers with OAuth 2.0 support.

2370. **[mcp-tui](https://github.com/msabramo/mcp-tui)** - ⭐ 14
   MCP host app w/ textual user interface, in Python

2371. **[substack-mcp](https://github.com/marcomoauro/substack-mcp)** - ⭐ 14
...
2374. **[spring-ai-mcp-deepseek](https://github.com/firefly0512/spring-ai-mcp-deepseek)** - ⭐ 13
   使用 Spring AI 整合 MCP 服务，包括 MCP server 和 deepseek client

2375. **[llamacppMCPClientDemo](https://github.com/brucepro/llamacppMCPClientDemo)** - ⭐ 13
   standalone react MCP client using SSE

2376. **[sample-multi-tenant-saas-mcp-server](https://github.com/aws-samples/sample-multi-tenant-saas-mcp-server)** - ⭐ 13
   Multi-Tenant remote MCP server with Amazon Cognito and remote client with Amazon Bedrock hosted on AWS

2377. **[mcp-chat-client](https://github.com/Ceeon/mcp-chat-client)** - ⭐ 13
   基于高德地图MCP服务的聊天客户端

2378. **[mcp-client-compatibility](https://github.com/tadata-org/mcp-client-compatibility)** - ⭐ 13

2379. **[mcp-client-laravel](https://github.com/RedberryProducts/mcp-client-laravel)** - ⭐ 13
...
2380. **[mcp-web-client](https://github.com/hemanth/mcp-web-client)** - ⭐ 13
   A web-based client for connecting to MCP servers with OAuth support

2381. **[mcp-client-for-weather-example](https://github.com/a-persimmons/mcp-client-for-weather-example)** - ⭐ 13
   一个MCP客户端实践：实现LLM调用天气MCP服务端查询天气的快速示例

2382. **[mcp-perplexity-server](https://github.com/PoliTwit1984/mcp-perplexity-server)** - ⭐ 13
...
2383. **[mcp-more](https://github.com/toosean/mcp-more)** - ⭐ 13
   A modern desktop application for managing Model Context Protocol (MCP) servers.

2384. **[MCP-Manager-GUI](https://github.com/gabrielbacha/MCP-Manager-GUI)** - ⭐ 13
   MCP Toggle is a simple GUI tool to help you manage MCP servers across clients seamlessly.

2385. **[easy-mcp-use](https://github.com/dforel/easy-mcp-use)** - ⭐ 13
...
2386. **[mcphawk](https://github.com/tech4242/mcphawk)** - ⭐ 13
...
2387. **[mcp-server-templates](https://github.com/Data-Everything/mcp-server-templates)** - ⭐ 13
   A flexible platform that provides Docker & Kubernetes backends, a lightweight CLI (mcpt), and client utilities for seamless MCP integration. Spin up servers from templates, route requests through a single endpoint with load balancing, and support both deployed (HTTP) and local (stdio) transports — all with sensible defaults and YAML-based configs.

2388. **[hoot](https://github.com/Portkey-AI/hoot)** - ⭐ 13
   MCP Testing Tool — Like Postman, but for the Model Context Protocol.

2389. **[Frontapp-MCP](https://github.com/zqushair/Frontapp-MCP)** - ⭐ 12
   MCP server and client for Frontapp

2390. **[llama-nexus](https://github.com/LlamaEdge/llama-nexus)** - ⭐ 12
   A gateway service designed to manage and orchestrate OpenAI-compatible API servers with MCP support.

2391. **[mcp-client-and-proxy](https://github.com/appsecco/mcp-client-and-proxy)** - ⭐ 12
   A universal MCP client with proxying feature to interact with MCP Servers which support STDIO transport.

2392. **[mcp-client-langchain-ts](https://github.com/hideya/mcp-client-langchain-ts)** - ⭐ 12
   Simple MCP Client CLI Implementation Using LangChain ReAct Agent / TypeScript

2393. **[st_rag_mcp](https://github.com/digital-duck/st_rag_mcp)** - ⭐ 12
   MCP streamlit client with RAG support for tool search

2394. **[n8n-coolify-mcp-tools](https://github.com/wrediam/n8n-coolify-mcp-tools)** - ⭐ 12
...
2395. **[mcp-server-manager](https://github.com/infinitimeless/mcp-server-manager)** - ⭐ 12
   A tool to create, build, and manage MCP servers for use with Claude and other MCP clients

2396. **[mcp-test-client](https://github.com/crazyrabbitLTC/mcp-test-client)** - ⭐ 12
   MCP Test Client is a TypeScript testing utility for Model Context Protocol (MCP) servers.

2397. **[MCP-Client-Server-for-agents](https://github.com/qmatteoq/MCP-Client-Server-for-agents)** - ⭐ 12
   This project demonstrates a Model Context Protocol (MCP) server and client implementation in .NET

2398. **[capture-mcp-server](https://github.com/blencorp/capture-mcp-server)** - ⭐ 12
...
2399. **[mcp-safe-run](https://github.com/ithena-one/mcp-safe-run)** - ⭐ 12
...
2403. **[deep-research](https://github.com/troyhantech/deep-research)** - ⭐ 12
   A minimalist deep research framework for any OpenAI API compatible LLMs. 

2404. **[SchemaPin](https://github.com/ThirdKeyAI/SchemaPin)** - ⭐ 12
   The SchemaPin protocol for cryptographically signing and verifying AI agent tool schemas to prevent supply-chain attacks.

2405. **[Tinvo](https://github.com/imxcstar/Tinvo)** - ⭐ 12
   LLM AI Client based on Blazor. (openai, chatgpt, llama, ollama, onnx, deepseekr1...)

2406. **[signoz-mcp-server](https://github.com/DrDroidLab/signoz-mcp-server)** - ⭐ 12
   Connect your Signoz Instance with Cursor, Claude Desktop or any other MCP Compatible Client

2407. **[mcp_client_rust](https://github.com/darinkishore/mcp_client_rust)** - ⭐ 11

2408. **[mcp-client](https://github.com/EuclideanAI/mcp-client)** - ⭐ 11
...
2409. **[MCP_Client](https://github.com/andrewdeng318/MCP_Client)** - ⭐ 11

2410. **[mcp-spotify-player](https://github.com/vsaez/mcp-spotify-player)** - ⭐ 11
   MCP server to manage Spotify from MCP clients

2411. **[gemma-mcp](https://github.com/monatis/gemma-mcp)** - ⭐ 11
   MCP Client for Gemma-3

2412. **[ckan-mcp-server](https://github.com/ondics/ckan-mcp-server)** - ⭐ 11
...
2413. **[trebuchet](https://github.com/fuzzball-muck/trebuchet)** - ⭐ 11
   A MUD/MUCK/MUSH chat client with MCP/GUI support.

2414. **[mcp-wikipedia](https://github.com/algonacci/mcp-wikipedia)** - ⭐ 11
   MCP server to give client the ability to access Wikipedia pages

2415. **[mlb-mcp](https://github.com/etweisberg/mlb-mcp)** - ⭐ 11
   MCP server for advanced baseball analytics (statcast, fangraphs, baseball reference, mlb stats API) with client demo 

2416. **[systemprompt-mcp-gmail](https://github.com/Ejb503/systemprompt-mcp-gmail)** - ⭐ 11
...
2417. **[mcp-client-app](https://github.com/RegiByte/mcp-client-app)** - ⭐ 11
   A mcp client chat application built for learning purposes

2418. **[mcp-browser-automation](https://github.com/hrmeetsingh/mcp-browser-automation)** - ⭐ 11
   Model Context Protocol based AI Agent that runs a browser from Claude desktop

2419. **[simple-nodejs-mcp-client](https://github.com/sawa-zen/simple-nodejs-mcp-client)** - ⭐ 11
...
2420. **[Wwise-MCP](https://github.com/BilkentAudio/Wwise-MCP)** - ⭐ 11
...
2424. **[langchain-mcp-tools-ts-usage](https://github.com/hideya/langchain-mcp-tools-ts-usage)** - ⭐ 11
   MCP Tools Usage From LangChain ReAct Agent / Example in TypeScript

2425. **[mcp-chat-widget](https://github.com/aimdoc-ai/mcp-chat-widget)** - ⭐ 11
...
2426. **[muster](https://github.com/giantswarm/muster)** - ⭐ 11
   MCP tool management and workflow proxy

2427. **[claude_autoapprove](https://github.com/PyneSys/claude_autoapprove)** - ⭐ 11
   Autoapprove support for claude

2428. **[peta-core](https://github.com/dunialabs/peta-core)** - ⭐ 11
   Peta core: The Control Plane for MCP — secure vault, managed runtime, audit trail, and policy-based approvals.

2429. **[oauth-callback](https://github.com/kriasoft/oauth-callback)** - ⭐ 11
   Lightweight OAuth 2.0 authorization code capture for CLI tools & desktop   apps. Works with Node.js, Deno, Bun. MCP SDK ready.

2430. **[create-mcp-server-kit](https://github.com/Epi-1120/create-mcp-server-kit)** - ⭐ 10
   Scaffold a production-ready Model Context Protocol (MCP) server in seconds.

2431. **[langchain-mcp-client](https://github.com/datalayer/langchain-mcp-client)** - ⭐ 10
   🦜🔗 LangChain Model Context Protocol (MCP) Client

2432. **[mcp-client-langchain-py](https://github.com/hideya/mcp-client-langchain-py)** - ⭐ 10
   Simple MCP Client CLI Implementation Using LangChain ReAct Agent / Python

2433. **[openalgo-mcp](https://github.com/marketcalls/openalgo-mcp)** - ⭐ 10
   Documentation

2434. **[mcp_client_openai](https://github.com/liangpn/mcp_client_openai)** - ⭐ 10
   适配Openai SDK构建MCP Client

2435. **[mcp-serverman](https://github.com/benhaotang/mcp-serverman)** - ⭐ 10
   a cli/mcp server tool for managing mcp server json config file with version control, profiles and multi-client support

2436. **[py-mcp-sse](https://github.com/jayliangdl/py-mcp-sse)** - ⭐ 10
   MCP Client 与 MCP Server基于SSE方式的样例实现（Python版本）

2437. **[mcpkit](https://github.com/cybertheory/mcpkit)** - ⭐ 10
   Easy to use Official MCP Registry Client UI. npx @cybertheory/mcpkit

2438. **[AIFoundry-MCPConnector-FabricGraphQL](https://github.com/LazaUK/AIFoundry-MCPConnector-FabricGraphQL)** - ⭐ 10
...
2439. **[server](https://github.com/mcpfinder/server)** - ⭐ 10
...
2440. **[kanboard-mcp](https://github.com/ChristianJStarr/kanboard-mcp)** - ⭐ 10
...
2441. **[emotion_ai](https://github.com/angrysky56/emotion_ai)** - ⭐ 10
...
2442. **[mcp-express-adapter](https://github.com/Moe03/mcp-express-adapter)** - ⭐ 10
   Run multiple MCP clients on a NodeJS Express server (adapter/middleware)

2443. **[mcp-trace](https://github.com/zabirauf/mcp-trace)** - ⭐ 10
   A TUI to probe the calls between MCP client and server

2444. **[fusion-mcp-server](https://github.com/Joe-Spencer/fusion-mcp-server)** - ⭐ 10
...
2445. **[semantictool](https://github.com/promptmesh/semantictool)** - ⭐ 10
   tool management service for performing vector tool calling at scale.

2446. **[mcp-server-blog](https://github.com/portal-labs-infrastructure/mcp-server-blog)** - ⭐ 10
   Example of a MCP implementation using TypeScript and OAuth.

2447. **[unity-mcp-template](https://github.com/dunward/unity-mcp-template)** - ⭐ 10
   Simple template project for controlling Unity via MCP

2448. **[davinci-mcp-professional](https://github.com/Positronikal/davinci-mcp-professional)** - ⭐ 10
...
2449. **[codepilot](https://github.com/rohittcodes/codepilot)** - ⭐ 10
   A multi-agent CLI tool powered by Swarms-rs and Composio

2450. **[mcp-server-gemini-pro](https://github.com/gurveeer/mcp-server-gemini-pro)** - ⭐ 10
...
2451. **[MCP-Platform](https://github.com/Data-Everything/MCP-Platform)** - ⭐ 10
   A flexible platform that provides Docker & Kubernetes backends, a lightweight CLI (mcpt), and client utilities for seamless MCP integration. Spin up servers from templates, route requests through a single endpoint with load balancing, and support both deployed (HTTP) and local (stdio) transports — all with sensible defaults and YAML-based configs

2452. **[awesome-mcp-hardware](https://github.com/beriberikix/awesome-mcp-hardware)** - ⭐ 10
   Awesome list of MCP servers for interacting with hardware and the physical world.

2453. **[polaris](https://github.com/octu0/polaris)** - ⭐ 10
   Distributed AI Agent Framework

2454. **[mcp-agent-proxy](https://github.com/mashh-lab/mcp-agent-proxy)** - ⭐ 10
...
1. **[chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat)** - ⭐ 40,521
   基于大模型搭建的聊天机器人，同时支持 微信公众号、企业微信应用、飞书、钉钉 等接入，可选择ChatGPT/Claude/DeepSeek/文心一言/讯飞星火/通义千问/ Gemini/GLM-4/Kimi/LinkAI，能处理文本、语音和图片，访问操作系统和互联网，支持基于自有知识库进行定制企业智能客服。

2. **[agentscope](https://github.com/agentscope-ai/agentscope)** - ⭐ 15,340
   AgentScope: Agent-Oriented Programming for Building LLM Applications

3. **[bytebot](https://github.com/bytebot-ai/bytebot)** - ⭐ 10,163
   Bytebot is a self-hosted AI desktop agent that automates computer tasks through natural language commands, operating within a containerized Linux desktop environment.

4. **[valuecell](https://github.com/ValueCell-ai/valuecell)** - ⭐ 8,021
   ValueCell is a community-driven, multi-agent platform for financial applications.

5. **[deepchat](https://github.com/ThinkInAIXYZ/deepchat)** - ⭐ 5,330
   🐬DeepChat - A smart assistant that connects powerful AI to your personal world

6. **[ruoyi-ai](https://github.com/ageerle/ruoyi-ai)** - ⭐ 4,634
   RuoYi AI 是一个全栈式 AI 开发平台，旨在帮助开发者快速构建和部署个性化的 AI 应用。

7. **[koog](https://github.com/JetBrains/koog)** - ⭐ 3,602
...
11. **[openinference](https://github.com/Arize-ai/openinference)** - ⭐ 799
...
1. **[n8n](https://github.com/n8n-io/n8n)** - ⭐ 167,740
   Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.

2. **[kong](https://github.com/Kong/kong)** - ⭐ 42,506
   🦍 The Cloud-Native Gateway for APIs & AI

3. **[LocalAI](https://github.com/mudler/LocalAI)** - ⭐ 41,218
   :robot: The free, Open Source alternative to OpenAI, Claude and others. Self-hosted and local-first. Drop-in replacement for OpenAI,  running on consumer-grade hardware. No GPU required. Runs gguf, transformers, diffusers and many more. Features: Generate Text, MCP, Audio, Video, Images, Voice Cloning, Distributed, P2P and decentralized inference

4. **[FastGPT](https://github.com/labring/FastGPT)** - ⭐ 26,827
   FastGPT is a knowledge-based platform built on the LLMs, offers a comprehensive suite of out-of-the-box capabilities such as data processing, RAG retrieval, and visual AI workflow orchestration, letting you easily develop and deploy complex question-answering systems without the need for extensive setup or configuration.

5. **[kratos](https://github.com/go-kratos/kratos)** - ⭐ 25,319
   Your ultimate Go microservices framework for the cloud-native era.

6. **[excelize](https://github.com/qax-os/excelize)** - ⭐ 20,172
   Go language library for reading and writing Microsoft Excel™ (XLAM / XLSM / XLSX / XLTM / XLTX) spreadsheets

7. **[plate](https://github.com/udecode/plate)** - ⭐ 15,731
   Rich-text editor with AI, MCP, and shadcn/ui

8. **[AstrBot](https://github.com/AstrBotDevs/AstrBot)** - ⭐ 14,841
...
12. **[note-gen](https://github.com/codexu/note-gen)** - ⭐ 10,470
   A cross-platform Markdown AI note-taking software.

13. **[langchain4j](https://github.com/langchain4j/langchain4j)** - ⭐ 10,307
   LangChain4j is an open-source Java library that simplifies the integration of LLMs into Java applications through a unified API, providing access to popular LLMs and vector databases. It makes implementing RAG, tool calling (including support for MCP), and agents easy. LangChain4j integrates seamlessly with various enterprise Java frameworks.

14. **[OpenMetadata](https://github.com/open-metadata/OpenMetadata)** - ⭐ 8,392
   OpenMetadata is a unified metadata platform for data discovery, data observability, and data governance powered by a central metadata repository, in-depth column level lineage, and seamless team collaboration.

15. **[astron-agent](https://github.com/iflytek/astron-agent)** - ⭐ 8,373
   Enterprise-grade, commercial-friendly agentic workflow platform for building next-generation SuperAgents.

16. **[Upsonic](https://github.com/Upsonic/Upsonic)** - ⭐ 7,733
   Agent Framework For Fintech and Banks

17. **[lamda](https://github.com/firerpa/lamda)** - ⭐ 7,536
    The most powerful Android RPA agent framework, next generation of mobile automation robots.

18. **[53AIHub](https://github.com/53AI/53AIHub)** - ⭐ 6,981
...
19. **[adk-go](https://github.com/google/adk-go)** - ⭐ 6,604
   An open-source, code-first Go toolkit for building, evaluating, and deploying sophisticated AI agents with flexibility and control.

20. **[Viper](https://github.com/FunnyWolf/Viper)** - ⭐ 4,632
   Adversary simulation and Red teaming platform with AI

21. **[magic](https://github.com/dtyq/magic)** - ⭐ 4,430
   Super Magic. The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)

22. **[ENScan_GO](https://github.com/wgpsec/ENScan_GO)** - ⭐ 4,149
...
24. **[ag2](https://github.com/ag2ai/ag2)** - ⭐ 4,023
   AG2 (formerly AutoGen): The Open-Source AgentOS. Join us at: https://discord.gg/sNGSwQME3x

25. **[kubefwd](https://github.com/txn2/kubefwd)** - ⭐ 4,001
   Bulk port forwarding Kubernetes services for local development.

26. **[Yuxi-Know](https://github.com/xerrors/Yuxi-Know)** - ⭐ 3,826
...
28. **[semantic-router](https://github.com/vllm-project/semantic-router)** - ⭐ 2,699
...
30. **[ultracite](https://github.com/haydenbleasel/ultracite)** - ⭐ 2,526
   A highly opinionated, zero-configuration linter and formatter.

31. **[harbor](https://github.com/av/harbor)** - ⭐ 2,242
   Effortlessly run LLM backends, APIs, frontends, and services with one command.

32. **[amazon-q-developer-cli](https://github.com/aws/amazon-q-developer-cli)** - ⭐ 1,869
   ✨ Agentic chat experience in your terminal. Build applications using natural language.

33. **[Continuous-Claude-v3](https://github.com/parcadei/Continuous-Claude-v3)** - ⭐ 1,806
   Context management for Claude Code. Hooks maintain state via ledgers and handoffs. MCP execution without context pollution. Agent orchestration with isolated context windows.

34. **[generative-ai](https://github.com/genieincodebottle/generative-ai)** - ⭐ 1,725
   Comprehensive resources on Generative AI, including a detailed roadmap, projects, use cases, interview preparation, and coding preparation.

35. **[MinecraftDev](https://github.com/minecraft-dev/MinecraftDev)** - ⭐ 1,697
...
37. **[mcpelauncher-manifest](https://github.com/minecraft-linux/mcpelauncher-manifest)** - ⭐ 1,412
   The main repository for the Linux and Mac OS Bedrock edition Minecraft launcher.

38. **[d2mcpp](https://github.com/mcpp-community/d2mcpp)** - ⭐ 1,390
...
40. **[NagaAgent](https://github.com/Xxiii8322766509/NagaAgent)** - ⭐ 1,298
   A simple yet powerful agent framework for personal assistants, designed to enable intelligent interaction, multi-agent collaboration, and seamless tool integration.

41. **[paperdebugger](https://github.com/PaperDebugger/paperdebugger)** - ⭐ 1,262
...
43. **[BuildingAI](https://github.com/BidingCC/BuildingAI)** - ⭐ 1,141
...
44. **[langchain4j-aideepin](https://github.com/moyangzhan/langchain4j-aideepin)** - ⭐ 1,097
   基于AI的工作效率提升工具（聊天、绘画、知识库、工作流、 MCP服务市场、语音输入输出、长期记忆） | Ai-based productivity tools (Chat,Draw,RAG,Workflow,MCP marketplace, ASR,TTS, Long-term memory etc)

45. **[Gearboy](https://github.com/drhelius/Gearboy)** - ⭐ 1,073
   Game Boy / Gameboy Color emulator and debugger for macOS, Windows, Linux, BSD and RetroArch.

46. **[any-agent](https://github.com/mozilla-ai/any-agent)** - ⭐ 1,064
   A single interface to use and evaluate different agent frameworks 

47. **[zen](https://github.com/sheshbabu/zen)** - ⭐ 1,003
   Selfhosted notes app. Single golang binary, notes stored as markdown within SQLite, full-text search, very low resource usage

48. **[AIPex](https://github.com/AIPexStudio/AIPex)** - ⭐ 995
...
49. **[openops](https://github.com/openops-cloud/openops)** - ⭐ 976
   The batteries-included, No-Code FinOps automation platform, with the AI you trust.

50. **[open-trading-api](https://github.com/koreainvestment/open-trading-api)** - ⭐ 962
   Korea Investment & Securities Open API Github

51. **[arduino-mcp2515](https://github.com/autowp/arduino-mcp2515)** - ⭐ 952
   Arduino MCP2515 CAN interface library

52. **[claude-chatgpt-mcp](https://github.com/syedazharmbnr1/claude-chatgpt-mcp)** - ⭐ 761
   A Claude MCP tool to interact with the ChatGPT desktop app on macOS

53. **[MCPELauncher](https://github.com/zhuowei/MCPELauncher)** - ⭐ 724
   Source code for BlockLauncher, a launcher that patches Minecraft for Android

54. **[aderyn](https://github.com/Cyfrin/aderyn)** - ⭐ 696
   Solidity Static Analyzer that easily integrates into your editor

55. **[bytechef](https://github.com/bytechefhq/bytechef)** - ⭐ 694
...
56. **[JiwuChat](https://github.com/KiWi233333/JiwuChat)** - ⭐ 689
...
63. **[AIWriteX](https://github.com/iniwap/AIWriteX)** - ⭐ 447
...
66. **[IDA-NO-MCP](https://github.com/P4nda0s/IDA-NO-MCP)** - ⭐ 410
   Say goodbye to the complex, verbose, and laggy interaction mode of IDA Pro MCP

67. **[browser-operator-core](https://github.com/BrowserOperator/browser-operator-core)** - ⭐ 408
...
69. **[mcp-cn-a-stock](https://github.com/elsejj/mcp-cn-a-stock)** - ⭐ 383
   这是一个为大模型提供 A 股数据的的 MCP(Model Content Protocol) 服务。

70. **[volcano-sdk](https://github.com/Kong/volcano-sdk)** - ⭐ 383
...
74. **[chunkhound](https://github.com/chunkhound/chunkhound)** - ⭐ 362
...
78. **[UE5-MCP](https://github.com/VedantRGosavi/UE5-MCP)** - ⭐ 331
   MCP for Unreal Engine 5

79. **[bridle](https://github.com/neiii/bridle)** - ⭐ 323
...
83. **[amical](https://github.com/amicalhq/amical)** - ⭐ 309
...
85. **[chatlog_alpha](https://github.com/teest114514/chatlog_alpha)** - ⭐ 296
   原 [chatlog]项目（一个微信数据库读取及提供mcp服务开源软件）的二次开发，会尽可能同步最新开源解密源码

86. **[depyler](https://github.com/paiml/depyler)** - ⭐ 294
   Compiles Python to Rust, helping transition off of Python to Energy Efficient and Safe Rust Code

87. **[napi](https://github.com/nanoapi-io/napi)** - ⭐ 292
   Software architecture tooling for the AI age

88. **[ios-simulator-skill](https://github.com/conorluddy/ios-simulator-skill)** - ⭐ 281
...
91. **[MCPDict](https://github.com/MaigoAkisame/MCPDict)** - ⭐ 259
   Android App: 漢字古今中外讀音查詢

92. **[MCP-Defender](https://github.com/MCP-Defender/MCP-Defender)** - ⭐ 243
   Desktop app that automatically scans and blocks malicious MCP traffic in AI apps like Cursor, Claude, VS Code and Windsurf.

93. **[MCPMappingViewer](https://github.com/bspkrs/MCPMappingViewer)** - ⭐ 242
   A small GUI for viewing the mappings from Minecraft obfuscated code names to MCP code names.

94. **[ai4eh](https://github.com/ethiack/ai4eh)** - ⭐ 240
   AI for Ethical Hacking - Workshop

95. **[MCPConfig](https://github.com/MinecraftForge/MCPConfig)** - ⭐ 239
   Public facing repo for MCP SRG mappings.

96. **[oreilly-ai-agents](https://github.com/sinanuozdemir/oreilly-ai-agents)** - ⭐ 235
...
100. **[mcpfp](https://github.com/MauritsWilke/mcpfp)** - ⭐ 218
...
103. **[mcpat](https://github.com/HewlettPackard/mcpat)** - ⭐ 208
...
110. **[claude-ipc-mcp](https://github.com/jdez427/claude-ipc-mcp)** - ⭐ 119
   AI-to-AI communication protocol for Claude, Gemini, and other AI assistants

111. **[STAMP](https://github.com/KatherLab/STAMP)** - ⭐ 106
   Solid Tumor Associative Modeling in Pathology

112. **[mcp-in-action](https://github.com/huangjia2019/mcp-in-action)** - ⭐ 101
   极客时间MCP新课已经上线！超2000同学一起开启MCP学习之旅！

113. **[TensorBlock-Studio](https://github.com/TensorBlock/TensorBlock-Studio)** - ⭐ 71
   A lightweight, open, and extensible multi-LLM interaction studio.

114. **[lycoris](https://github.com/solaoi/lycoris)** - ⭐ 68
...
115. **[tiktok-mcp](https://github.com/yap-audio/tiktok-mcp)** - ⭐ 63
   A Model Context Protocol service for TikTok video discovery and metadata extraction.

116. **[seekchat](https://github.com/seekrays/seekchat)** - ⭐ 61
   ✨ A Sleek and Powerful AI Desktop Assistant that supports MCP integration✨

117. **[houdini-mcp](https://github.com/capoom/houdini-mcp)** - ⭐ 48
   Houdini integration through the Model Context Protocol

118. **[mcp-java8-sdk](https://github.com/krrr/mcp-java8-sdk)** - ⭐ 46
   Backported Model Context Protocol SDK for Java 8

119. **[zentrun](https://github.com/andrewsky-labs/zentrun)** - ⭐ 31
   Prompt-driven automation platform - Transform natural language into executable workflows

120. **[awesome-mcp-list](https://github.com/notedit/awesome-mcp-list)** - ⭐ 28
   Awesome Model Context Protocol Service List

121. **[adk-mcp-gemma3](https://github.com/arjunprabhulal/adk-mcp-gemma3)** - ⭐ 26
   Build AI Agent using Google ADK , MCP and Gemma 3 model

122. **[Wireshark_mcp](https://github.com/jayimu/Wireshark_mcp)** - ⭐ 25
...
123. **[codai](https://github.com/codai-agent/codai)** - ⭐ 24
...
124. **[hands-on-ai-building-ai-agents-with-model-context-protocol-mcp-and-agent2agent-a2a-6055298](https://github.com/LinkedInLearning/hands-on-ai-building-ai-agents-with-model-context-protocol-mcp-and-agent2agent-a2a-6055298)** - ⭐ 24
...
125. **[cursor-like-pro](https://github.com/gifflet/cursor-like-pro)** - ⭐ 17
   Cursor IDE like Pro

126. **[n8n-operator](https://github.com/jakub-k-slys/n8n-operator)** - ⭐ 14
   Kubernetes Operator for N8n, a fair-code workflow automation platform with native AI capabilities.

127. **[ai-tools](https://github.com/elsejj/ai-tools)** - ⭐ 13
...
1. **[YC-Killer](https://github.com/sahibzada-allahyar/YC-Killer)** - ⭐ 2,612
...
1. **[modelcontextprotocol](https://github.com/modelcontextprotocol/modelcontextprotocol)** - ⭐ 6,856
...
3. **[ai-guide](https://github.com/liyupi/ai-guide)** - ⭐ 934
