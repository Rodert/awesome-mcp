...
1. **[dify](https://github.com/langgenius/dify)** - ⭐ 128,206
   Production-ready platform for agentic workflow development.

2. **[open-webui](https://github.com/open-webui/open-webui)** - ⭐ 122,449
   User-friendly AI Interface (Supports Ollama, OpenAI API, ...)

3. **[gemini-cli](https://github.com/google-gemini/gemini-cli)** - ⭐ 93,111
   An open-source AI agent that brings the power of Gemini directly into your terminal.

4. **[awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)** - ⭐ 80,029
   A collection of MCP servers.

5. **[servers](https://github.com/modelcontextprotocol/servers)** - ⭐ 77,616
   Model Context Protocol Servers

6. **[netdata](https://github.com/netdata/netdata)** - ⭐ 77,574
   The fastest path to AI-powered full stack observability, even for lean teams.

7. **[ragflow](https://github.com/infiniflow/ragflow)** - ⭐ 72,476
   RAGFlow is a leading open-source Retrieval-Augmented Generation (RAG) engine that fuses cutting-edge RAG with Agent capabilities to create a superior context layer for LLMs

8. **[lobehub](https://github.com/lobehub/lobehub)** - ⭐ 71,615
...
10. **[anything-llm](https://github.com/Mintplex-Labs/anything-llm)** - ⭐ 54,010
   The all-in-one Desktop & Docker AI application with built-in RAG, AI agents, No-code agent builder, MCP compatibility,  and more.

11. **[JeecgBoot](https://github.com/jeecgboot/JeecgBoot)** - ⭐ 45,134
...
12. **[TrendRadar](https://github.com/sansan0/TrendRadar)** - ⭐ 45,126
...
13. **[context7](https://github.com/upstash/context7)** - ⭐ 44,228
   Context7 MCP Server -- Up-to-date code documentation for LLMs and AI code editors

14. **[LocalAI](https://github.com/mudler/LocalAI)** - ⭐ 42,491
   :robot: The free, Open Source alternative to OpenAI, Claude and others. Self-hosted and local-first. Drop-in replacement,  running on consumer-grade hardware. No GPU required. Runs gguf, transformers, diffusers and many more. Features: Generate Text, MCP, Audio, Video, Images, Voice Cloning, Distributed, P2P and decentralized inference

15. **[mindsdb](https://github.com/mindsdb/mindsdb)** - ⭐ 38,345
...
17. **[everything-claude-code](https://github.com/affaan-m/everything-claude-code)** - ⭐ 35,489
   Complete Claude Code configuration collection - agents, skills, hooks, commands, rules, MCPs. Battle-tested configs from an Anthropic hackathon winner.

18. **[LibreChat](https://github.com/danny-avila/LibreChat)** - ⭐ 33,489
   Enhanced ChatGPT Clone: Features Agents, MCP, DeepSeek, Anthropic, AWS, OpenAI, Responses API, Azure, Groq, o1, GPT-5, Mistral, OpenRouter, Vertex AI, Gemini, Artifacts, AI model switching, message search, Code Interpreter, langchain, DALL-E-3, OpenAPI Actions, Functions, Secure Multi-User Auth, Presets, open-source for self-hosting. Active.

19. **[1Panel](https://github.com/1Panel-dev/1Panel)** - ⭐ 33,078
   🔥 1Panel provides an intuitive web interface and MCP Server to manage websites, files, containers, databases, and LLMs on a Linux server.

20. **[nacos](https://github.com/alibaba/nacos)** - ⭐ 32,592
   an easy-to-use dynamic service discovery, configuration and service management platform for building AI cloud native applications.

21. **[PDFMathTranslate](https://github.com/PDFMathTranslate/PDFMathTranslate)** - ⭐ 31,598
   [EMNLP 2025 Demo] PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/MCP/Docker/Zotero

22. **[goose](https://github.com/block/goose)** - ⭐ 29,587
   an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM

23. **[ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub)** - ⭐ 27,555
   In-depth tutorials on LLMs, RAGs and real-world AI agent applications.

24. **[github-mcp-server](https://github.com/github/github-mcp-server)** - ⭐ 26,493
   GitHub's official MCP Server

25. **[playwright-mcp](https://github.com/microsoft/playwright-mcp)** - ⭐ 26,469
   Playwright MCP server

26. **[composio](https://github.com/ComposioHQ/composio)** - ⭐ 26,463
   Composio equips your AI agents & LLMs with 100+ high-quality integrations via function calling

27. **[gpt-researcher](https://github.com/assafelovic/gpt-researcher)** - ⭐ 25,133
   An autonomous agent that conducts deep research on any data using any LLM providers.

28. **[UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)** - ⭐ 25,059
   The Open-Source Multimodal AI Agent Stack: Connecting Cutting-Edge AI Models and Agent Infra

29. **[gin-vue-admin](https://github.com/flipped-aurora/gin-vue-admin)** - ⭐ 24,276
...
30. **[xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)** - ⭐ 23,695
   An MCP-based chatbot | 一个基于MCP的聊天机器人

31. **[chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp)** - ⭐ 22,834
   Chrome DevTools for coding agents

32. **[fastmcp](https://github.com/jlowin/fastmcp)** - ⭐ 22,465
   🚀 The fast, Pythonic way to build MCP servers and clients

33. **[repomix](https://github.com/yamadashy/repomix)** - ⭐ 21,584
   📦 Repomix is a powerful tool that packs your entire repository into a single, AI-friendly file. Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools like Claude, ChatGPT, DeepSeek, Perplexity, Gemini, Gemma, Llama, Grok, and more.

34. **[python-sdk](https://github.com/modelcontextprotocol/python-sdk)** - ⭐ 21,443
   The official Python SDK for Model Context Protocol servers and clients

35. **[mastra](https://github.com/mastra-ai/mastra)** - ⭐ 20,624
   From the team behind Gatsby, Mastra is a framework for building AI-powered applications and agents with a modern TypeScript stack.

36. **[activepieces](https://github.com/activepieces/activepieces)** - ⭐ 20,561
   AI Agents & MCPs & AI Workflow Automation • (~400 MCP servers for AI agents) • AI Automation / AI Agent with MCPs • AI Workflows & AI Agents • MCPs for AI Agents

37. **[MaxKB](https://github.com/1Panel-dev/MaxKB)** - ⭐ 19,984
   🔥 MaxKB is an open-source platform for building enterprise-grade agents.  强大易用的开源企业级智能体平台。

38. **[serena](https://github.com/oraios/serena)** - ⭐ 19,510
   A powerful coding agent toolkit providing semantic retrieval and editing capabilities (MCP server & other integrations)

39. **[agentic](https://github.com/transitive-bullshit/agentic)** - ⭐ 18,118
   Your API ⇒ Paid MCP. Instantly.

40. **[blender-mcp](https://github.com/ahujasid/blender-mcp)** - ⭐ 16,738

41. **[agentscope](https://github.com/agentscope-ai/agentscope)** - ⭐ 16,045
   AgentScope: Agent-Oriented Programming for Building LLM Applications

42. **[cc-switch](https://github.com/farion1231/cc-switch)** - ⭐ 15,072
   A cross-platform desktop All-in-One assistant tool for Claude Code, Codex, OpenCode & Gemini CLI.

43. **[mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners)** - ⭐ 14,199
   This open-source curriculum introduces the fundamentals of Model Context Protocol (MCP) through real-world, cross-language examples in .NET, Java, TypeScript, JavaScript, Rust and Python. Designed for developers, it focuses on practical techniques for building modular, scalable, and secure AI workflows from session setup to service orchestration.

44. **[electerm](https://github.com/electerm/electerm)** - ⭐ 13,526
   📻Terminal/ssh/sftp/ftp/telnet/serialport/RDP/VNC client(linux, mac, win)

45. **[trigger.dev](https://github.com/triggerdotdev/trigger.dev)** - ⭐ 13,485
   Trigger.dev – build and deploy fully‑managed AI agents and workflows

46. **[filestash](https://github.com/mickael-kerjean/filestash)** - ⭐ 13,423
   :file_folder: What Dropbox should have been if it was based on SFTP, S3, FTP, SMB, NFS, WebDAV, Git, and more

47. **[claude-flow](https://github.com/ruvnet/claude-flow)** - ⭐ 13,379
...
48. **[Qwen-Agent](https://github.com/QwenLM/Qwen-Agent)** - ⭐ 13,104
   Agent framework and applications built upon Qwen>=3.0, featuring Function Calling, MCP, Code Interpreter, RAG, Chrome extension, etc.

49. **[n8n-mcp](https://github.com/czlonkowski/n8n-mcp)** - ⭐ 12,982
   A MCP for Claude Desktop / Claude Code / Windsurf / Cursor to build n8n workflows for you 

50. **[Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP)** - ⭐ 12,906
   MCP server to provide Figma layout information to AI coding agents like Cursor

51. **[genai-toolbox](https://github.com/googleapis/genai-toolbox)** - ⭐ 12,678
   MCP Toolbox for Databases is an open source MCP server for databases.

52. **[fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)** - ⭐ 11,470
   Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!

53. **[typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk)** - ⭐ 11,455
   The official TypeScript SDK for Model Context Protocol servers and clients

54. **[pal-mcp-server](https://github.com/BeehiveInnovations/pal-mcp-server)** - ⭐ 10,974
   The power of Claude Code / GeminiCLI / CodexCLI + [Gemini / OpenAI / OpenRouter / Azure / Grok / Ollama / Custom Model / All Of The Above] working as one.

55. **[nginx-ui](https://github.com/0xJacky/nginx-ui)** - ⭐ 10,492
   Yet another WebUI for Nginx

56. **[gateway](https://github.com/Portkey-AI/gateway)** - ⭐ 10,455
   A blazing fast AI Gateway with integrated guardrails. Route to 200+ LLMs, 50+ AI Guardrails with 1 fast & friendly API.

57. **[mcp-chrome](https://github.com/hangwin/mcp-chrome)** - ⭐ 10,199
   Chrome MCP Server is a Chrome extension-based Model Context Protocol (MCP) server that exposes your Chrome browser functionality to AI assistants like Claude, enabling complex browser automation, content analysis, and semantic search.

58. **[XHS-Downloader](https://github.com/JoeanAmier/XHS-Downloader)** - ⭐ 9,931
...
60. **[mcp-use](https://github.com/mcp-use/mcp-use)** - ⭐ 9,024
   mcp-use is the easiest way to interact with mcp servers with custom agents

61. **[Scrapling](https://github.com/D4Vinci/Scrapling)** - ⭐ 8,877
   🕷️ An undetectable, powerful, flexible, high-performance Python library to make Web Scraping Easy and Effortless as it should be!

62. **[awesome-ai-apps](https://github.com/Arindam200/awesome-ai-apps)** - ⭐ 8,711
   A collection of projects showcasing RAG, agents, workflows, and other AI use cases

63. **[Skill_Seekers](https://github.com/yusufkaraaslan/Skill_Seekers)** - ⭐ 8,577
   Convert documentation websites, GitHub repositories, and PDFs into Claude AI skills with automatic conflict detection

64. **[xiaozhi-esp32-server](https://github.com/xinnan-tech/xiaozhi-esp32-server)** - ⭐ 8,496
   本项目为xiaozhi-esp32提供后端服务，帮助您快速搭建ESP32设备控制服务器。Backend service for xiaozhi-esp32, helps you quickly build an ESP32 device control server.

65. **[inspector](https://github.com/modelcontextprotocol/inspector)** - ⭐ 8,487
   Visual testing tool for MCP servers

66. **[xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp)** - ⭐ 8,398
   MCP for xiaohongshu.com

67. **[mcp-go](https://github.com/mark3labs/mcp-go)** - ⭐ 8,080
   A Go implementation of the Model Context Protocol (MCP), enabling seamless integration between LLM applications and external data sources and tools.

68. **[mcp](https://github.com/awslabs/mcp)** - ⭐ 8,006
   Official AWS MCP Servers

69. **[mcp-agent](https://github.com/lastmile-ai/mcp-agent)** - ⭐ 7,987
   Build effective agents using Model Context Protocol and simple workflow patterns

70. **[git-mcp](https://github.com/idosal/git-mcp)** - ⭐ 7,491
   Put an end to code hallucinations! GitMCP is a free, open-source, remote MCP server for any GitHub project

71. **[awesome-LLM-resources](https://github.com/WangRongsheng/awesome-LLM-resources)** - ⭐ 7,444
...
73. **[GhidraMCP](https://github.com/LaurieWired/GhidraMCP)** - ⭐ 7,195
   MCP Server for Ghidra

74. **[browser-tools-mcp](https://github.com/AgentDeskAI/browser-tools-mcp)** - ⭐ 7,029
   Monitor browser logs directly from Cursor and other MCP compatible IDEs.

75. **[memU](https://github.com/NevaMind-AI/memU)** - ⭐ 6,524
   Memory for 24/7 proactive agents like openclaw (moltbot, clawdbot).

76. **[hexstrike-ai](https://github.com/0x4m4/hexstrike-ai)** - ⭐ 6,423
   HexStrike AI MCP Agents is an advanced MCP server that lets AI agents (Claude, GPT, Copilot, etc.) autonomously run 150+ cybersecurity tools for automated pentesting, vulnerability discovery, bug bounty automation, and security research. Seamlessly bridge LLMs with real-world offensive security capabilities.

77. **[registry](https://github.com/modelcontextprotocol/registry)** - ⭐ 6,342
   A community driven registry service for Model Context Protocol (MCP) servers.

78. **[awesome-mcp-clients](https://github.com/punkpeye/awesome-mcp-clients)** - ⭐ 6,254
   A collection of MCP clients.

79. **[cursor-talk-to-figma-mcp](https://github.com/grab/cursor-talk-to-figma-mcp)** - ⭐ 6,223
...
80. **[astron-rpa](https://github.com/iflytek/astron-rpa)** - ⭐ 6,119
   Agent-ready RPA suite with out-of-the-box automation tools. Built for individuals and enterprises.

81. **[Awesome-MCP-ZH](https://github.com/yzfly/Awesome-MCP-ZH)** - ⭐ 6,000
   MCP 资源精选， MCP指南，Claude MCP，MCP Servers, MCP Clients

82. **[mcp](https://github.com/BrowserMCP/mcp)** - ⭐ 5,649
   Browser MCP is a Model Context Provider (MCP) server that allows AI applications to control your browser

83. **[kreuzberg](https://github.com/kreuzberg-dev/kreuzberg)** - ⭐ 5,629
...
84. **[antigravity-awesome-skills](https://github.com/sickn33/antigravity-awesome-skills)** - ⭐ 5,627
...
85. **[klavis](https://github.com/Klavis-AI/klavis)** - ⭐ 5,615
   Klavis AI (YC X25):  MCP integration platforms that let AI agents use tools reliably at any scale

86. **[claude-plugins-official](https://github.com/anthropics/claude-plugins-official)** - ⭐ 5,581
   Official, Anthropic-managed directory of high quality Claude Code Plugins.

87. **[unity-mcp](https://github.com/CoplayDev/unity-mcp)** - ⭐ 5,513
   Unity MCP acts as a bridge, allowing AI assistants (like Claude, Cursor) to interact directly with your Unity Editor via a local MCP (Model Context Protocol) Client. Give your LLM tools to manage assets, control scenes, edit scripts, and automate tasks within Unity.

88. **[firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server)** - ⭐ 5,376
   🔥 Official Firecrawl MCP Server - Adds powerful web scraping and search to Cursor, Claude and any other LLM clients.

89. **[DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP)** - ⭐ 5,366
   This is MCP server for Claude that gives it terminal control, file system search and diff file editing capabilities

90. **[Everywhere](https://github.com/DearVa/Everywhere)** - ⭐ 5,331
   Context-aware AI assistant for your desktop. Ready to respond intelligently, seamlessly integrating multiple LLMs and MCP tools.

91. **[voltagent](https://github.com/VoltAgent/voltagent)** - ⭐ 5,299
   AI Agent Engineering Platform built on an Open Source TypeScript AI Agent Framework

92. **[whatsapp-mcp](https://github.com/lharries/whatsapp-mcp)** - ⭐ 5,286
   WhatsApp MCP server

93. **[ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp)** - ⭐ 5,286
   AI-powered reverse engineering assistant that bridges IDA Pro with language models through MCP.

94. **[claude-context](https://github.com/zilliztech/claude-context)** - ⭐ 5,216
   Code search MCP for Claude Code. Make entire codebase the context for any coding agent.

95. **[mcp-playwright](https://github.com/executeautomation/mcp-playwright)** - ⭐ 5,190
   Playwright Model Context Protocol Server - Tool to automate Browsers and APIs in Claude Desktop, Cline, Cursor IDE and More 🔌

96. **[awesome-mcp-servers](https://github.com/appcypher/awesome-mcp-servers)** - ⭐ 5,104
   Awesome MCP Servers - A curated list of Model Context Protocol servers

97. **[gaianet-node](https://github.com/GaiaNet-AI/gaianet-node)** - ⭐ 5,010
   Install, run and deploy your own decentralized AI agent service

98. **[5ire](https://github.com/nanbingxyz/5ire)** - ⭐ 4,991
   5ire is a cross-platform desktop AI assistant, MCP client. It compatible with major service providers,  supports local knowledge base and  tools via model context protocol servers .

99. **[sdk-python](https://github.com/strands-agents/sdk-python)** - ⭐ 4,988
   A model-driven approach to building AI agents in just a few lines of code.

100. **[UltraRAG](https://github.com/OpenBMB/UltraRAG)** - ⭐ 4,875
...
102. **[Kiln](https://github.com/Kiln-AI/Kiln)** - ⭐ 4,607
   Build, Evaluate, and Optimize AI Systems. Includes evals, RAG, agents, fine-tuning, synthetic data generation, dataset management, MCP, and more.

103. **[microsandbox](https://github.com/zerocore-ai/microsandbox)** - ⭐ 4,514
   opensource self-hosted sandboxes for ai agents

104. **[casibase](https://github.com/casibase/casibase)** - ⭐ 4,419
   ⚡️AI Cloud OS: Open-source enterprise-level AI knowledge base and MCP (model-context-protocol)/A2A (agent-to-agent) management platform with admin UI, user management and Single-Sign-On⚡️, supports ChatGPT, Claude, Llama, Ollama, HuggingFace, etc., chat bot demo: https://ai.casibase.com, admin UI demo: https://ai-admin.casibase.com

105. **[deep-research](https://github.com/u14app/deep-research)** - ⭐ 4,365
   Use any LLMs (Large Language Models) for Deep Research. Support SSE API and MCP server.

106. **[mcp-ui](https://github.com/MCP-UI-Org/mcp-ui)** - ⭐ 4,259
   UI over MCP. Create next-gen UI experiences with the protocol and SDK!

107. **[httprunner](https://github.com/httprunner/httprunner)** - ⭐ 4,253
   HttpRunner 是一款开源的 API/UI 测试框架，简单易用，功能强大，具有丰富的插件化机制和高度的可扩展能力。

108. **[magic-mcp](https://github.com/21st-dev/magic-mcp)** - ⭐ 4,189
   It's like v0 but in your Cursor/WindSurf/Cline. 21st dev Magic MCP server for working with your frontend like Magic

109. **[mcp-atlassian](https://github.com/sooperset/mcp-atlassian)** - ⭐ 4,126
   MCP server for Atlassian tools (Confluence, Jira)

110. **[wanwu](https://github.com/UnicomAI/wanwu)** - ⭐ 4,096
   China Unicom's Yuanjing Wanwu Agent Platform is an enterprise-grade, multi-tenant AI agent development platform. It helps users build applications such as intelligent agents, workflows, and rag, and also supports model management. The platform features a developer-friendly license, and we welcome all developers to build upon the platform.

111. **[Windows-MCP](https://github.com/CursorTouch/Windows-MCP)** - ⭐ 4,065
   MCP Server for Computer Use in Windows

112. **[Olares](https://github.com/beclab/Olares)** - ⭐ 4,000
   Olares: An Open-Source Personal Cloud to Reclaim Your Data

113. **[XcodeBuildMCP](https://github.com/cameroncooke/XcodeBuildMCP)** - ⭐ 3,930
   A Model Context Protocol (MCP) server that provides Xcode-related tools for integration with AI assistants and other MCP clients.

114. **[mcpo](https://github.com/open-webui/mcpo)** - ⭐ 3,928
   A simple, secure MCP-to-OpenAPI proxy server

115. **[directories](https://github.com/pontusab/directories)** - ⭐ 3,892
   The Cursor & Windsurf community, find rules and MCPs

116. **[learn-agentic-ai](https://github.com/panaversity/learn-agentic-ai)** - ⭐ 3,883
   Learn Agentic AI using Dapr Agentic Cloud Ascent (DACA) Design Pattern and Agent-Native Cloud Technologies: OpenAI Agents SDK, Memory, MCP, A2A, Knowledge Graphs, Dapr, Rancher Desktop, and Kubernetes.

117. **[csharp-sdk](https://github.com/modelcontextprotocol/csharp-sdk)** - ⭐ 3,841
   The official C# SDK for Model Context Protocol servers and clients. Maintained in collaboration with Microsoft.

118. **[notion-mcp-server](https://github.com/makenotion/notion-mcp-server)** - ⭐ 3,811
   Official Notion MCP Server

119. **[spec-workflow-mcp](https://github.com/Pimzino/spec-workflow-mcp)** - ⭐ 3,800
   A Model Context Protocol (MCP) server that provides structured spec-driven development workflow tools for AI-assisted software development, featuring a real-time web dashboard and VSCode extension for monitoring and managing your project's progress directly in your development environment.

120. **[go-sdk](https://github.com/modelcontextprotocol/go-sdk)** - ⭐ 3,739
   The official Go SDK for Model Context Protocol servers and clients. Maintained in collaboration with Google.

121. **[MemOS](https://github.com/MemTensor/MemOS)** - ⭐ 3,710
...
122. **[telegram-search](https://github.com/groupultra/telegram-search)** - ⭐ 3,707
   🔍 导出并模糊搜索 Telegram 聊天记录 | Export and fuzzy search your Telegram chat history

123. **[exa-mcp-server](https://github.com/exa-labs/exa-mcp-server)** - ⭐ 3,701
   Exa MCP for web search and web crawling!

124. **[fast-agent](https://github.com/evalstate/fast-agent)** - ⭐ 3,647
   Define, Prompt and Test MCP enabled Agents and Workflows

125. **[core](https://github.com/opensumi/core)** - ⭐ 3,595
   A framework helps you quickly build AI Native IDE products. MCP Client, supports Model Context Protocol (MCP) tools via MCP server.

126. **[mcp-server-chart](https://github.com/antvis/mcp-server-chart)** - ⭐ 3,595
   🤖 A visualization mcp & skills contains 25+ visual charts using @antvis. Using for chart generation and data analysis.

127. **[mcp-feedback-enhanced](https://github.com/Minidoracat/mcp-feedback-enhanced)** - ⭐ 3,558
   Enhanced MCP server for interactive user feedback and command execution in AI-assisted development, featuring dual interface support (Web UI and Desktop Application) with intelligent environment detection and cross-platform compatibility.

128. **[ciso-assistant-community](https://github.com/intuitem/ciso-assistant-community)** - ⭐ 3,548
...
129. **[cipher](https://github.com/campfirein/cipher)** - ⭐ 3,475
...
130. **[awesome-mcp-servers](https://github.com/wong2/awesome-mcp-servers)** - ⭐ 3,471
...
132. **[Continuous-Claude-v3](https://github.com/parcadei/Continuous-Claude-v3)** - ⭐ 3,442
   Context management for Claude Code. Hooks maintain state via ledgers and handoffs. MCP execution without context pollution. Agent orchestration with isolated context windows.

133. **[go-whatsapp-web-multidevice](https://github.com/aldinokemal/go-whatsapp-web-multidevice)** - ⭐ 3,431
   GOWA - WhatsApp REST API with support for UI, Multi Account, Webhooks, and MCP, and Chatwoot. Built with Golang for efficient memory use. 

134. **[mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare)** - ⭐ 3,350

135. **[langchain-mcp-adapters](https://github.com/langchain-ai/langchain-mcp-adapters)** - ⭐ 3,316
   LangChain 🔌 MCP

136. **[MCP-Chinese-Getting-Started-Guide](https://github.com/liaokongVFX/MCP-Chinese-Getting-Started-Guide)** - ⭐ 3,304
   Model Context Protocol(MCP) 编程极速入门

137. **[PeopleInSpace](https://github.com/joreilly/PeopleInSpace)** - ⭐ 3,298
   Kotlin Multiplatform sample with SwiftUI, Jetpack Compose, Compose for Wear, Compose for Desktop, and Compose for Web clients along with Ktor backend.

138. **[learn-ai-engineering](https://github.com/ashishps1/learn-ai-engineering)** - ⭐ 3,285
   Learn AI and LLMs from scratch using free resources

139. **[PPTAgent](https://github.com/icip-cas/PPTAgent)** - ⭐ 3,265
   An Agentic Framework for Reflective PowerPoint Generation

140. **[mobile-mcp](https://github.com/mobile-next/mobile-mcp)** - ⭐ 3,263
   Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators, Simulators and Real Devices)

141. **[claude-code-guide](https://github.com/zebbern/claude-code-guide)** - ⭐ 3,251
...
142. **[excel-mcp-server](https://github.com/haris-musa/excel-mcp-server)** - ⭐ 3,247
   A Model Context Protocol server for Excel file manipulation

143. **[metorial](https://github.com/metorial/metorial)** - ⭐ 3,211
   Connect any AI model to 600+ integrations; powered by MCP 📡 🚀

144. **[mcp-context-forge](https://github.com/IBM/mcp-context-forge)** - ⭐ 3,210
   A Model Context Protocol (MCP) Gateway & Registry. Serves as a central management point for tools, resources, and prompts that can be accessed by MCP-compatible LLM applications. Converts REST API endpoints to MCP, composes virtual MCP servers with added security and observability, and converts between protocols (stdio, SSE, Streamable HTTP).

145. **[boost](https://github.com/laravel/boost)** - ⭐ 3,174
   Laravel-focused MCP server for augmenting your AI powered local development experience.

146. **[osaurus](https://github.com/dinoki-ai/osaurus)** - ⭐ 3,157
...
147. **[py-xiaozhi](https://github.com/huangjunsen0406/py-xiaozhi)** - ⭐ 3,155
   A Python-based Xiaozhi AI for users who want the full Xiaozhi experience without owning specialized hardware.

148. **[java-sdk](https://github.com/modelcontextprotocol/java-sdk)** - ⭐ 3,118
   The official Java SDK for Model Context Protocol servers and clients. Maintained in collaboration with Spring AI

149. **[mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase)** - ⭐ 3,100
   Allow LLMs to control a browser with Browserbase and Stagehand

150. **[octelium](https://github.com/octelium/octelium)** - ⭐ 3,097
   A next-gen FOSS self-hosted unified zero trust secure access platform that can operate as a remote access VPN, a ZTNA platform, API/AI/MCP gateway, a PaaS, an ngrok-alternative and a homelab infrastructure.

151. **[mcp](https://github.com/google/mcp)** - ⭐ 3,047
   Google 💚 MCP

152. **[rikkahub](https://github.com/rikkahub/rikkahub)** - ⭐ 3,022
   RikkaHub is an Android APP that supports for multiple LLM providers.

153. **[n8n-nodes-mcp](https://github.com/nerding-io/n8n-nodes-mcp)** - ⭐ 2,970
   n8n custom node for MCP

154. **[core](https://github.com/cheshire-cat-ai/core)** - ⭐ 2,956
   AI agent microservice

155. **[rust-sdk](https://github.com/modelcontextprotocol/rust-sdk)** - ⭐ 2,911
   The official Rust SDK for the Model Context Protocol

156. **[fastmcp](https://github.com/punkpeye/fastmcp)** - ⭐ 2,901
   A TypeScript framework for building MCP servers.

157. **[AI-Infra-Guard](https://github.com/Tencent/AI-Infra-Guard)** - ⭐ 2,873
...
158. **[mcp-obsidian](https://github.com/MarkusPfundstein/mcp-obsidian)** - ⭐ 2,781
   MCP server that interacts with Obsidian via the Obsidian rest API community plugin

159. **[playwriter](https://github.com/remorses/playwriter)** - ⭐ 2,674
   MCP to control your Chrome window via extension. Runs Playwright code in a stateful sandbox. 

160. **[shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server)** - ⭐ 2,629
...
163. **[mcp](https://github.com/microsoft/mcp)** - ⭐ 2,504
   Catalog of official Microsoft MCP (Model Context Protocol) server implementations for AI-powered data access and tool integration

164. **[supabase-mcp](https://github.com/supabase-community/supabase-mcp)** - ⭐ 2,438
   Connect Supabase to your AI assistants

165. **[basic-memory](https://github.com/basicmachines-co/basic-memory)** - ⭐ 2,431
   AI conversations that actually remember. Never re-explain your project to your AI again. Join our Discord: https://discord.gg/tyvKNccgqN

166. **[supergateway](https://github.com/supercorp-ai/supergateway)** - ⭐ 2,397
   Run MCP stdio servers over SSE and SSE over stdio. AI gateway.

167. **[markdownify-mcp](https://github.com/zcaceres/markdownify-mcp)** - ⭐ 2,382
   A Model Context Protocol server for converting almost anything to Markdown

168. **[sandbox](https://github.com/agent-infra/sandbox)** - ⭐ 2,342
   All-in-One Sandbox for AI Agents that combines Browser, Shell, File, MCP and VSCode Server in a single Docker container.

169. **[buildwithclaude](https://github.com/davepoon/buildwithclaude)** - ⭐ 2,335
   A single hub to find Claude Skills, Agents, Commands, Hooks, Plugins, and Marketplace collections to extend Claude Code

170. **[archestra](https://github.com/archestra-ai/archestra)** - ⭐ 2,284
   Secure gateway for MCP, A2A, LLM; MCP registry & orchestrator

171. **[MCP-SuperAssistant](https://github.com/srbhptl39/MCP-SuperAssistant)** - ⭐ 2,242
   Brings MCP to ChatGPT, DeepSeek, Perplexity, Grok, Gemini, Google AI Studio, OpenRouter, DeepSeek, T3 Chat and more...

172. **[mcp-proxy](https://github.com/sparfenyuk/mcp-proxy)** - ⭐ 2,214
   A bridge between Streamable HTTP and stdio MCP transports

173. **[mcp-grafana](https://github.com/grafana/mcp-grafana)** - ⭐ 2,209
   MCP server for Grafana

174. **[ableton-mcp](https://github.com/ahujasid/ableton-mcp)** - ⭐ 2,195

175. **[chatmcp](https://github.com/daodao97/chatmcp)** - ⭐ 2,168
   ChatMCP is an AI chat client implementing the Model Context Protocol (MCP).

176. **[ddgs](https://github.com/deedy5/ddgs)** - ⭐ 2,117
...
178. **[arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server)** - ⭐ 2,099
...
180. **[lemonade](https://github.com/lemonade-sdk/lemonade)** - ⭐ 2,086
   Lemonade helps users discover and run local AI apps by serving optimized LLMs right from their own GPUs and NPUs. Join our discord: https://discord.gg/5xXzkMu8Zk

181. **[comfyui_LLM_party](https://github.com/heshengtao/comfyui_LLM_party)** - ⭐ 2,085
   LLM Agent Framework in ComfyUI includes MCP sever, Omost,GPT-sovits, ChatTTS,GOT-OCR2.0, and FLUX prompt nodes,access to Feishu,discord,and adapts to all llms with similar openai / aisuite interfaces, such as o1,ollama, gemini, grok, qwen, GLM, deepseek, kimi,doubao. Adapted to local llms, vlm, gguf such as llama-3.3 Janus-Pro, Linkage graphRAG

182. **[papersgpt-for-zotero](https://github.com/papersgpt/papersgpt-for-zotero)** - ⭐ 2,078
...
184. **[Unla](https://github.com/AmoyLab/Unla)** - ⭐ 2,020
   🧩 MCP Gateway - A lightweight gateway service that instantly transforms existing MCP Servers and APIs into MCP servers with zero code changes. Features Docker deployment and management UI, requiring no infrastructure modifications.

185. **[dbhub](https://github.com/bytebase/dbhub)** - ⭐ 2,012
...
187. **[mcp-crawl4ai-rag](https://github.com/coleam00/mcp-crawl4ai-rag)** - ⭐ 1,982
   Web Crawling and RAG Capabilities for AI Agents and AI Coding Assistants

188. **[superglue](https://github.com/superglue-ai/superglue)** - ⭐ 1,975
   superglue (YC W25) builds integrations and tools from natural language. Get production-grade tools for long tail and enterprise systems.

189. **[metamcp](https://github.com/metatool-ai/metamcp)** - ⭐ 1,974
   MCP Aggregator, Orchestrator, Middleware, Gateway in one docker

190. **[brightdata-mcp](https://github.com/brightdata/brightdata-mcp)** - ⭐ 1,969
   A powerful Model Context Protocol (MCP) server that provides an all-in-one solution for public web access.

191. **[mcpso](https://github.com/chatmcp/mcpso)** - ⭐ 1,963
   directory for Awesome MCP Servers

192. **[bifrost](https://github.com/maximhq/bifrost)** - ⭐ 1,959
   Fastest LLM gateway (50x faster than LiteLLM) with adaptive load balancer, cluster mode, guardrails, 1000+ models support & <100 µs overhead at 5k RPS.

193. **[postgres-mcp](https://github.com/crystaldba/postgres-mcp)** - ⭐ 1,938
   Postgres MCP Pro provides configurable read/write access and performance analysis for you and your AI agents.

194. **[gemini-mcp-tool](https://github.com/jamubc/gemini-mcp-tool)** - ⭐ 1,915
   MCP server that enables AI assistants to interact with Google Gemini CLI, leveraging Gemini's massive token window for large file analysis and codebase understanding

195. **[modelcontextprotocol](https://github.com/perplexityai/modelcontextprotocol)** - ⭐ 1,908
   The official MCP server implementation for the Perplexity API Platform

196. **[Aix-DB](https://github.com/apconw/Aix-DB)** - ⭐ 1,904
   Aix-DB 基于 LangChain/LangGraph 框架，结合 MCP Skills 多智能体协作架构，实现自然语言到数据洞察的端到端转换。

197. **[yomo](https://github.com/yomorun/yomo)** - ⭐ 1,882
   🦖 Serverless AI Agent Framework with Geo-distributed Edge AI Infra.

198. **[mcp-cli](https://github.com/chrishayuk/mcp-cli)** - ⭐ 1,869

199. **[witsy](https://github.com/nbonamy/witsy)** - ⭐ 1,845
   Witsy: desktop AI assistant / universal MCP client

200. **[awesome-agent-skills](https://github.com/heilcheng/awesome-agent-skills)** - ⭐ 1,841
   A curated list of skills, tools, tutorials, and capabilities for AI coding agents (Claude, Codex, Copilot, VS Code)

201. **[agentset](https://github.com/agentset-ai/agentset)** - ⭐ 1,830
   The open-source RAG platform: built-in citations, deep research, 22+ file formats, partitions, MCP server, and more.

202. **[beelzebub](https://github.com/mariocandela/beelzebub)** - ⭐ 1,826
...
205. **[mcphub](https://github.com/samanhappy/mcphub)** - ⭐ 1,757
...
207. **[Dive](https://github.com/OpenAgentPlatform/Dive)** - ⭐ 1,722
   Dive is an open-source MCP Host Desktop Application that seamlessly integrates with any LLMs supporting function calling capabilities. ✨

208. **[mcphub.nvim](https://github.com/ravitemer/mcphub.nvim)** - ⭐ 1,702
   An MCP client for Neovim that seamlessly integrates MCP servers into your editing workflow with an intuitive interface for managing, testing, and using MCP servers with your favorite chat plugins.

209. **[mcpb](https://github.com/modelcontextprotocol/mcpb)** - ⭐ 1,680
   Desktop Extensions: One-click local MCP server installation in desktop apps

210. **[mcp-router](https://github.com/mcp-router/mcp-router)** - ⭐ 1,671
   A Unified MCP Server Management App (MCP Manager).

211. **[agentgateway](https://github.com/agentgateway/agentgateway)** - ⭐ 1,671
   Next Generation Agentic Proxy for AI Agents and MCP servers

212. **[interactive-feedback-mcp](https://github.com/noopstudios/interactive-feedback-mcp)** - ⭐ 1,662
   Interactive User Feedback MCP

213. **[super-agent-party](https://github.com/heshengtao/super-agent-party)** - ⭐ 1,653
...
214. **[zenfeed](https://github.com/glidea/zenfeed)** - ⭐ 1,635
   Make RSS 📰 great again with AI 🧠✨!! [拯救你的颈椎 - 数字健康工具：https://forcebreak.zenfeed.xyz]

215. **[inspector](https://github.com/MCPJam/inspector)** - ⭐ 1,634
   Test & Debug MCP servers, ChatGPT apps, and MCP Apps (ext-apps)

216. **[anyquery](https://github.com/julien040/anyquery)** - ⭐ 1,606
   Query anything (GitHub, Notion, +40 more) with SQL and let LLMs (ChatGPT, Claude) connect to using MCP

217. **[Peekaboo](https://github.com/steipete/Peekaboo)** - ⭐ 1,606
   Peekaboo is a macOS CLI & optional MCP server that enables AI agents to capture screenshots of applications, or the entire system, with optional visual question answering through local or remote AI models.

218. **[codemcp](https://github.com/ezyang/codemcp)** - ⭐ 1,604
   Coding assistant MCP for Claude Desktop

219. **[godot-mcp](https://github.com/Coding-Solo/godot-mcp)** - ⭐ 1,604
   MCP server for interfacing with Godot game engine. Provides tools for launching the editor, running projects, and capturing debug output.

220. **[mcp_agent_mail](https://github.com/Dicklesworthstone/mcp_agent_mail)** - ⭐ 1,589
   Like gmail for your coding agents. Lets various different agents communicate and coordinate with each other.

221. **[MAI-UI](https://github.com/Tongyi-MAI/MAI-UI)** - ⭐ 1,586
   MAI-UI: Real-World Centric Foundation GUI Agents ranging from 2B to 235B

222. **[Continuous-Claude-v2](https://github.com/parcadei/Continuous-Claude-v2)** - ⭐ 1,575
   Context management for Claude Code. Hooks maintain state via ledgers and handoffs. MCP execution without context pollution. Agent orchestration with isolated context windows.

223. **[py-gpt](https://github.com/szczyglis-dev/py-gpt)** - ⭐ 1,575
   Desktop AI Assistant powered by GPT-5, GPT-4, o1, o3, Gemini, Claude, Ollama, DeepSeek, Perplexity, Grok, Bielik, chat, vision, voice, RAG, image and video generation, agents, tools, MCP, plugins, speech synthesis and recognition, web search, memory, presets, assistants,and more. Linux, Windows, Mac

224. **[kubb](https://github.com/kubb-labs/kubb)** - ⭐ 1,570
   🧩 The Ultimate Toolkit for Generating Type-Safe API Clients, Hooks, and Validators.

225. **[yu-ai-agent](https://github.com/liyupi/yu-ai-agent)** - ⭐ 1,565
...
226. **[toolhive](https://github.com/stacklok/toolhive)** - ⭐ 1,556
   ToolHive makes deploying MCP servers easy, secure and fun

227. **[n8n-mcp-server](https://github.com/leonardsellem/n8n-mcp-server)** - ⭐ 1,555
   MCP server that provides tools and resources for interacting with n8n API

228. **[ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp)** - ⭐ 1,547
   MCP server for interacting with the iOS simulator

229. **[mcphost](https://github.com/mark3labs/mcphost)** - ⭐ 1,531
   A CLI host application that enables Large Language Models (LLMs) to interact with external tools through the Model Context Protocol (MCP).

230. **[Office-Word-MCP-Server](https://github.com/GongRzhe/Office-Word-MCP-Server)** - ⭐ 1,515
...
246. **[docker-mcp-tutorial](https://github.com/theNetworkChuck/docker-mcp-tutorial)** - ⭐ 1,311
   Complete tutorial materials for building MCP servers with Docker - from NetworkChuck's video

247. **[Risuai](https://github.com/kwaroran/Risuai)** - ⭐ 1,299
...
251. **[code-mode](https://github.com/universal-tool-calling-protocol/code-mode)** - ⭐ 1,291
...
254. **[google_workspace_mcp](https://github.com/taylorwilsdon/google_workspace_mcp)** - ⭐ 1,258
...
256. **[mcp-memory-service](https://github.com/doobidoo/mcp-memory-service)** - ⭐ 1,242
   Stop re-explaining your project to AI every session. Automatic context memory for Claude, VS Code, Cursor, and 13+ AI tools.

257. **[ai](https://github.com/stripe/ai)** - ⭐ 1,238
   One-stop shop for building AI-powered products and businesses with Stripe.

258. **[slack-mcp-server](https://github.com/korotovsky/slack-mcp-server)** - ⭐ 1,236
   The most powerful MCP Slack Server with no permission requirements, Apps support, GovSlack, DMs, Group DMs and smart history fetch logic.

259. **[web-eval-agent](https://github.com/refreshdotdev/web-eval-agent)** - ⭐ 1,235
   An MCP server that autonomously evaluates web applications. 

260. **[kotlin-sdk](https://github.com/modelcontextprotocol/kotlin-sdk)** - ⭐ 1,235
   The official Kotlin SDK for Model Context Protocol servers and clients. Maintained in collaboration with JetBrains

261. **[mcp-remote](https://github.com/geelen/mcp-remote)** - ⭐ 1,234

262. **[deepwiki-mcp](https://github.com/regenrek/deepwiki-mcp)** - ⭐ 1,228
   📖 MCP server for fetch deepwiki.com and get latest knowledge in Cursor and other Code Editors

263. **[web-eval-agent](https://github.com/withRefresh/web-eval-agent)** - ⭐ 1,226
   An MCP server that autonomously evaluates web applications. 

264. **[MiniMax-MCP](https://github.com/MiniMax-AI/MiniMax-MCP)** - ⭐ 1,225
   Official MiniMax Model Context Protocol (MCP) server that enables interaction with powerful Text to Speech, image generation and video generation APIs.

265. **[RisuAI](https://github.com/kwaroran/RisuAI)** - ⭐ 1,222
   Make your own story. User-friendly software for LLM roleplaying

266. **[sre](https://github.com/SmythOS/sre)** - ⭐ 1,220
   The SmythOS Runtime Environment (SRE) is an open-source, cloud-native runtime for agentic AI. Secure, modular, and production-ready, it lets developers build, run, and manage intelligent agents across local, cloud, and edge environments.

267. **[claude-code-plugins-plus-skills](https://github.com/jeremylongshore/claude-code-plugins-plus-skills)** - ⭐ 1,208
   Hundreds of Claude Code plugins with embedded AI skills. Learn via interactive Jupyter tutorials.

268. **[mcp-gateway](https://github.com/docker/mcp-gateway)** - ⭐ 1,207
   docker mcp CLI plugin / MCP Gateway

269. **[swift-sdk](https://github.com/modelcontextprotocol/swift-sdk)** - ⭐ 1,206
   The official Swift SDK for Model Context Protocol servers and clients.

270. **[azure-devops-mcp](https://github.com/microsoft/azure-devops-mcp)** - ⭐ 1,204
   The MCP server for Azure DevOps, bringing the power of Azure DevOps directly to your agents.

271. **[grafbase](https://github.com/grafbase/grafbase)** - ⭐ 1,203
   The Grafbase GraphQL Federation Gateway

272. **[A2V](https://github.com/Devin-AXIS/A2V)** - ⭐ 1,200
   A2V: Next-Gen AI Value Compute Protocol.                                                                                 

273. **[mcp-server-qdrant](https://github.com/qdrant/mcp-server-qdrant)** - ⭐ 1,193
   An official Qdrant Model Context Protocol (MCP) server implementation

274. **[xmcp](https://github.com/basementstudio/xmcp)** - ⭐ 1,190
   The TypeScript MCP framework

275. **[google-analytics-mcp](https://github.com/googleanalytics/google-analytics-mcp)** - ⭐ 1,189

276. **[cunzhi](https://github.com/imhuso/cunzhi)** - ⭐ 1,187
   告别AI提前终止烦恼，助力AI更加持久

277. **[terraform-mcp-server](https://github.com/hashicorp/terraform-mcp-server)** - ⭐ 1,187
   The Terraform MCP Server provides seamless integration with Terraform ecosystem, enabling advanced automation and interaction capabilities for Infrastructure as Code (IaC) development.

278. **[npcpy](https://github.com/NPC-Worldwide/npcpy)** - ⭐ 1,184
   The python library for research and development in NLP, multimodal LLMs, Agents, ML, Knowledge Graphs, and more.

279. **[mcp-golang](https://github.com/metoro-io/mcp-golang)** - ⭐ 1,184
   Write Model Context Protocol servers in few lines of go code. Docs at https://mcpgolang.com . Created by https://metoro.io

280. **[elevenlabs-mcp](https://github.com/elevenlabs/elevenlabs-mcp)** - ⭐ 1,181
   The official ElevenLabs MCP server

281. **[jadx-ai-mcp](https://github.com/zinja-coder/jadx-ai-mcp)** - ⭐ 1,181
   Plugin for JADX to integrate MCP server

282. **[zotero-mcp](https://github.com/54yyyu/zotero-mcp)** - ⭐ 1,171
   Zotero MCP: Connects your Zotero research library with Claude and other AI assistants via the Model Context Protocol to discuss papers, get summaries, analyze citations, and more.

283. **[mcporter](https://github.com/steipete/mcporter)** - ⭐ 1,159
   Call MCPs via TypeScript, masquerading as simple TypeScript API. Or package them as cli.

284. **[tavily-mcp](https://github.com/tavily-ai/tavily-mcp)** - ⭐ 1,141
   Production ready MCP server with real-time search, extract, map & crawl.

285. **[Agent-MCP](https://github.com/rinadelph/Agent-MCP)** - ⭐ 1,140
   Agent-MCP is a framework for creating multi-agent systems that enables coordinated, efficient AI collaboration through the Model Context Protocol (MCP). The system is designed for developers building AI applications that benefit from multiple specialized agents working in parallel on different aspects of a project.

286. **[mcp-server-mysql](https://github.com/benborla/mcp-server-mysql)** - ⭐ 1,136
   A Model Context Protocol server that provides read-only access to MySQL databases. This server enables LLMs to inspect database schemas and execute read-only queries.

287. **[cli](https://github.com/TanStack/cli)** - ⭐ 1,135
   The official TanStack CLI - Project Scaffolding, MCP Server, Agent Skills Installation, etc

288. **[fast-mcp](https://github.com/yjacquin/fast-mcp)** - ⭐ 1,125
   A Ruby Implementation of the Model Context Protocol

289. **[iMCP](https://github.com/mattt/iMCP)** - ⭐ 1,123
   A macOS app that provides an MCP server to your Messages, Contacts, Reminders and more

290. **[tuui](https://github.com/AI-QL/tuui)** - ⭐ 1,121
   A desktop MCP client designed as a tool unitary utility integration, accelerating AI adoption through the Model Context Protocol (MCP) and enabling cross-vendor LLM API orchestration.

291. **[trustgraph](https://github.com/trustgraph-ai/trustgraph)** - ⭐ 1,120
   The Context Graph Engine for AI. Build, manage, and deploy AI-optimized Context Graphs.

292. **[xiaozhi-esp32-server-java](https://github.com/joey-zhou/xiaozhi-esp32-server-java)** - ⭐ 1,118
   小智ESP32的Java企业级管理平台，提供设备监控、音色定制、角色切换和对话记录管理的前后端及服务端一体化解决方案

293. **[AWorld](https://github.com/inclusionAI/AWorld)** - ⭐ 1,113
   Build, evaluate and train General Multi-Agent Assistance with ease

294. **[mysql_mcp_server](https://github.com/designcomputer/mysql_mcp_server)** - ⭐ 1,107
   A Model Context Protocol (MCP) server that enables secure interaction with MySQL databases

295. **[cui](https://github.com/wbopan/cui)** - ⭐ 1,103
   A web UI for Claude Code agents

296. **[xhs-toolkit](https://github.com/aki66938/xhs-toolkit)** - ⭐ 1,099
   📕 小红书创作者MCP工具包 - 支持与AI客户端集成的内容创作和发布工具

297. **[kubernetes-mcp-server](https://github.com/containers/kubernetes-mcp-server)** - ⭐ 1,073
   Model Context Protocol (MCP) server for Kubernetes and OpenShift

298. **[grepai](https://github.com/yoanbernabeu/grepai)** - ⭐ 1,070
   Semantic Search & Call Graphs for AI Agents (100% Local)

299. **[flock](https://github.com/Onelevenvy/flock)** - ⭐ 1,068
   Flock is a workflow-based low-code platform for rapidly building chatbots, RAG, and coordinating multi-agent teams, powered by LangGraph, Langchain, FastAPI, and NextJS.（Flock 是一个基于workflow工作流的低代码平台，用于快速构建聊天机器人、RAG、Agent和Muti-Agent应用，采用 LangGraph、Langchain、FastAPI 和 NextJS 构建。）

300. **[claude-code-mcp](https://github.com/steipete/claude-code-mcp)** - ⭐ 1,047
   Claude Code as one-shot MCP server to have an agent in your agent.

301. **[SearChat](https://github.com/sear-chat/SearChat)** - ⭐ 1,037
   Search + Chat = SearChat(AI Chat with Search), Support OpenAI/Anthropic/VertexAI/Gemini, DeepResearch, SearXNG, Docker.  AI对话式搜索引擎，支持DeepResearch, 支持OpenAI/Anthropic/VertexAI/Gemini接口、聚合搜索引擎SearXNG，支持Docker一键部署。

302. **[ext-apps](https://github.com/modelcontextprotocol/ext-apps)** - ⭐ 1,037
...
306. **[use-mcp](https://github.com/modelcontextprotocol/use-mcp)** - ⭐ 1,026
...
308. **[lets-learn-mcp-python](https://github.com/microsoft/lets-learn-mcp-python)** - ⭐ 1,024
   MCP Python Tutorial 

309. **[Awesome-MCP-Servers](https://github.com/YuzeHao2023/Awesome-MCP-Servers)** - ⭐ 1,019
   A curated list of Model Context Protocol (MCP) servers 

310. **[claude-init](https://github.com/cfrs2005/claude-init)** - ⭐ 1,013
...
312. **[mcp-boilerplate](https://github.com/iannuttall/mcp-boilerplate)** - ⭐ 1,000
   A remote Cloudflare MCP server boilerplate with user authentication and Stripe for paid tools.

313. **[better-chatbot](https://github.com/cgoinglove/better-chatbot)** - ⭐ 997
   Just a Better Chatbot. Powered by Agent & MCP & Workflows.

314. **[awesome-remote-mcp-servers](https://github.com/jaw9c/awesome-remote-mcp-servers)** - ⭐ 986
   Remote MCP Servers

315. **[docs-mcp-server](https://github.com/arabold/docs-mcp-server)** - ⭐ 979
   Grounded Docs MCP Server: Open-Source Alternative to Context7, Nia, and Ref.Tools

316. **[quickstart-resources](https://github.com/modelcontextprotocol/quickstart-resources)** - ⭐ 973
   A repository of servers and clients from the Model Context Protocol tutorials

317. **[fetcher-mcp](https://github.com/jae-jae/fetcher-mcp)** - ⭐ 971
   MCP server for fetch web page content using Playwright headless browser.

318. **[Gmail-MCP-Server](https://github.com/GongRzhe/Gmail-MCP-Server)** - ⭐ 969
...
321. **[ollama-mcp-bridge](https://github.com/patruff/ollama-mcp-bridge)** - ⭐ 960
   Bridge between Ollama and MCP servers, enabling local LLMs to use Model Context Protocol tools

322. **[WebMCP](https://github.com/MiguelsPizza/WebMCP)** - ⭐ 958
   Bringing the power of MCP to the web

323. **[ai-dev-tools-zoomcamp](https://github.com/DataTalksClub/ai-dev-tools-zoomcamp)** - ⭐ 953
...
324. **[RedNote-MCP](https://github.com/iFurySt/RedNote-MCP)** - ⭐ 953
   🚀MCP server for accessing RedNote(XiaoHongShu, xhs).

325. **[short-video-maker](https://github.com/gyoridavid/short-video-maker)** - ⭐ 948
   Creates short videos for TikTok, Instagram Reels, and YouTube Shorts using the Model Context Protocol (MCP) and a REST API.

326. **[CloudBase-MCP](https://github.com/TencentCloudBase/CloudBase-MCP)** - ⭐ 947
      CloudBase MCP - Connect CloudBase to your AI Agent.     Go from AI prompt to live app. 

327. **[ref-tools-mcp](https://github.com/ref-tools/ref-tools-mcp)** - ⭐ 945
   Helping coding agents never make mistakes working with public or private libraries without wasting the context window.

328. **[todo-for-ai](https://github.com/todo-for-ai/todo-for-ai)** - ⭐ 943
...
329. **[mcp-jetbrains](https://github.com/JetBrains/mcp-jetbrains)** - ⭐ 942
   A model context protocol server to work with JetBrains IDEs: IntelliJ, PyCharm, WebStorm, etc. Also, works with Android Studio

330. **[google-calendar-mcp](https://github.com/nspady/google-calendar-mcp)** - ⭐ 941
   MCP integration for Google Calendar to manage events.

331. **[mcp-windbg](https://github.com/svnscha/mcp-windbg)** - ⭐ 938
   Model Context Protocol for WinDBG

332. **[gemini-nexus](https://github.com/yeahhe365/gemini-nexus)** - ⭐ 932
...
334. **[mcpdoc](https://github.com/langchain-ai/mcpdoc)** - ⭐ 921
   Expose llms-txt to IDEs for development

335. **[tools](https://github.com/strands-agents/tools)** - ⭐ 918
...
337. **[mongodb-mcp-server](https://github.com/mongodb-js/mongodb-mcp-server)** - ⭐ 905
   A Model Context Protocol server to connect to MongoDB databases and MongoDB Atlas Clusters.

338. **[Pixelle-MCP](https://github.com/AIDC-AI/Pixelle-MCP)** - ⭐ 903
   An Open-Source Multimodal AIGC Solution based on ComfyUI + MCP + LLM  https://pixelle.ai

339. **[agentic-radar](https://github.com/splx-ai/agentic-radar)** - ⭐ 900
...
343. **[agents](https://github.com/inkeep/agents)** - ⭐ 888
...
348. **[MCProtocolLib](https://github.com/GeyserMC/MCProtocolLib)** - ⭐ 876
   A library for communication with a Minecraft client/server.

349. **[jupyter-mcp-server](https://github.com/datalayer/jupyter-mcp-server)** - ⭐ 872
   🪐 🔧 Model Context Protocol (MCP) Server for Jupyter.

350. **[openapi-mcp-server](https://github.com/janwilmake/openapi-mcp-server)** - ⭐ 870
   Allow AI to wade through complex OpenAPIs using Simple Language

351. **[mcpm.sh](https://github.com/pathintegral-institute/mcpm.sh)** - ⭐ 870
   CLI MCP package manager & registry for all platforms and all clients. Search & configure MCP servers. Advanced Router & Profile features.

352. **[mcp-course](https://github.com/huggingface/mcp-course)** - ⭐ 869

353. **[Unity-MCP](https://github.com/IvanMurzak/Unity-MCP)** - ⭐ 869
...
357. **[AI-Gateway](https://github.com/Azure-Samples/AI-Gateway)** - ⭐ 847
...
358. **[trpc-agent-go](https://github.com/trpc-group/trpc-agent-go)** - ⭐ 846
   trpc-agent-go is a powerful Go framework for building intelligent agent systems using large language models (LLMs) and tools.

359. **[hyper-mcp](https://github.com/hyper-mcp-rs/hyper-mcp)** - ⭐ 845
   📦️ A fast, secure MCP server that extends its capabilities through WebAssembly plugins.

360. **[MCPJungle](https://github.com/mcpjungle/MCPJungle)** - ⭐ 836
...
366. **[openapi-servers](https://github.com/open-webui/openapi-servers)** - ⭐ 820
   OpenAPI Tool Servers

367. **[wassette](https://github.com/microsoft/wassette)** - ⭐ 820
   Wassette: A security-oriented runtime that runs WebAssembly Components via MCP

368. **[yokai](https://github.com/ankorstore/yokai)** - ⭐ 818
   Simple, modular, and observable Go framework for backend applications.

369. **[excel-mcp-server](https://github.com/negokaz/excel-mcp-server)** - ⭐ 817
   A Model Context Protocol (MCP) server that reads and writes MS Excel data

370. **[himarket](https://github.com/higress-group/himarket)** - ⭐ 817
...
372. **[statespace](https://github.com/statespace-tech/statespace)** - ⭐ 815
   Turn your data into shareable RAG apps in minutes. All in pure Markdown. Zero boilerplate.

373. **[toolfront](https://github.com/statespace-tech/toolfront)** - ⭐ 809
   Turn your data into shareable RAG apps in minutes. All in pure Markdown. Zero boilerplate.

374. **[golf](https://github.com/golf-mcp/golf)** - ⭐ 809
   Production-Ready MCP Server Framework • Build, deploy & scale secure AI agent infrastructure • Includes Auth, Observability, Debugger, Telemetry & Runtime • Run real-world MCPs powering AI Agents 

375. **[server](https://github.com/php-mcp/server)** - ⭐ 806
   Core PHP implementation for the Model Context Protocol (MCP) server

376. **[mcp-cli](https://github.com/philschmid/mcp-cli)** - ⭐ 805
...
380. **[MCP-Security-Checklist](https://github.com/slowmist/MCP-Security-Checklist)** - ⭐ 796
   A comprehensive security checklist for MCP-based AI tools. Built by SlowMist to safeguard LLM plugin ecosystems.

381. **[arcade-mcp](https://github.com/ArcadeAI/arcade-mcp)** - ⭐ 794
   The best way to create, deploy, and share MCP Servers

382. **[Claude-Code-Everything-You-Need-to-Know](https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know)** - ⭐ 793
...
384. **[acemcp](https://github.com/qy527145/acemcp)** - ⭐ 784
   一个将ACE(Augment Context Engine) 做成MCP的项目

385. **[agent-kit](https://github.com/inngest/agent-kit)** - ⭐ 777
   AgentKit: Build multi-agent networks in TypeScript with deterministic routing and rich tooling via MCP.

386. **[mcp-knowledge-graph](https://github.com/shaneholloman/mcp-knowledge-graph)** - ⭐ 776
   MCP server enabling persistent memory for Claude through a local knowledge graph - fork focused on local development

387. **[kubectl-mcp-server](https://github.com/rohitg00/kubectl-mcp-server)** - ⭐ 776
   A Model Context Protocol (MCP) server for Kubernetes. Install: npx kubectl-mcp-server or pip install kubectl-mcp-server

388. **[linkedin-mcp-server](https://github.com/stickerdaniel/linkedin-mcp-server)** - ⭐ 774
...
389. **[apple-docs-mcp](https://github.com/kimsungwhee/apple-docs-mcp)** - ⭐ 773
   MCP server for Apple Developer Documentation - Search iOS/macOS/SwiftUI/UIKit docs, WWDC videos, Swift/Objective-C APIs & code examples in Claude, Cursor & AI assistants

390. **[claude-delegator](https://github.com/jarrodwatts/claude-delegator)** - ⭐ 772
   Delegate tasks to Codex GPT 5.2 directly from within Claude Code.

391. **[qgis_mcp](https://github.com/jjsantos01/qgis_mcp)** - ⭐ 771
   Model Context Protocol (MCP) that allows LLMs to use QGIS Desktop

392. **[Context](https://github.com/indragiek/Context)** - ⭐ 769
   Native macOS client for Model Context Protocol (MCP)

393. **[vibetest-use](https://github.com/browser-use/vibetest-use)** - ⭐ 765
   Vibetest MCP - automated QA testing using Browser-Use agents

394. **[vllora](https://github.com/vllora/vllora)** - ⭐ 765
   Debug your AI agents

395. **[duckduckgo-mcp-server](https://github.com/nickclyde/duckduckgo-mcp-server)** - ⭐ 765
   A Model Context Protocol (MCP) server that provides web search capabilities through DuckDuckGo, with additional features for content fetching and parsing.

396. **[k8m](https://github.com/weibaohui/k8m)** - ⭐ 763
   一款轻量级、跨平台的 Mini Kubernetes AI Dashboard，支持大模型+智能体+MCP(支持设置操作权限)，集成多集群管理、智能分析、实时异常检测等功能，支持多架构并可单文件部署，助力高效集群管理与运维优化。

397. **[mcp-scanner](https://github.com/cisco-ai-defense/mcp-scanner)** - ⭐ 762
   Scan MCP servers for potential threats & security findings.

398. **[runno](https://github.com/taybenlor/runno)** - ⭐ 758
   Sandboxed runtime for programming languages and WASI binaries. Works in the browser, on your server, or via MCP.

399. **[heurist-agent-framework](https://github.com/heurist-network/heurist-agent-framework)** - ⭐ 754
...
404. **[apify-mcp-server](https://github.com/apify/apify-mcp-server)** - ⭐ 738
...
406. **[coderunner](https://github.com/instavm/coderunner)** - ⭐ 731
   A secure local sandbox to run LLM-generated code using Apple containers

407. **[code-index-mcp](https://github.com/johnhuang316/code-index-mcp)** - ⭐ 724
   A Model Context Protocol (MCP) server that helps large language models index, search, and analyze code repositories with minimal setup

408. **[glean](https://github.com/LeslieLeung/glean)** - ⭐ 724
   A self-hosted RSS reader and personal knowledge management tool.

409. **[nanobot](https://github.com/nanobot-ai/nanobot)** - ⭐ 723
   Build MCP Agents
...
412. **[annas-mcp](https://github.com/iosifache/annas-mcp)** - ⭐ 712
   MCP server and CLI tool for searching and downloading documents from Anna's Archive

413. **[MassGen](https://github.com/massgen/MassGen)** - ⭐ 712
...
414. **[passage-of-time-mcp](https://github.com/jlumbroso/passage-of-time-mcp)** - ⭐ 710
...
415. **[llm-functions](https://github.com/sigoden/llm-functions)** - ⭐ 705
   Easily create LLM tools and agents using plain Bash/JavaScript/Python functions.

416. **[just-prompt](https://github.com/disler/just-prompt)** - ⭐ 705
...
417. **[12306-mcp](https://github.com/Joooook/12306-mcp)** - ⭐ 702
   This is a 12306 ticket search server based on the Model Context Protocol (MCP).

418. **[ruby-sdk](https://github.com/modelcontextprotocol/ruby-sdk)** - ⭐ 700
   The official Ruby SDK for the Model Context Protocol. Maintained in collaboration with Shopify.

419. **[octocode-mcp](https://github.com/bgauryy/octocode-mcp)** - ⭐ 699
   MCP server for semantic code research and context generation on real-time using LLM patterns | Search naturally across public & private repos based on your permissions | Transform any accessible codebase/s into AI-optimized knowledge on simple and complex flows | Find real implementations and live docs from anywhere

420. **[notebooklm-mcp](https://github.com/PleasePrompto/notebooklm-mcp)** - ⭐ 689
   MCP server for NotebookLM - Let your AI agents (Claude Code, Codex) research documentation directly with grounded, citation-backed answers from Gemini. Persistent auth, library management, cross-client sharing. Zero hallucinations, just your knowledge base.

421. **[HowToCook-mcp](https://github.com/worryzyy/HowToCook-mcp)** - ⭐ 684
   基于Anduin2017 / HowToCook （程序员在家做饭指南）的mcp server

422. **[langgraph-mcp-agents](https://github.com/teddynote-lab/langgraph-mcp-agents)** - ⭐ 683
...
423. **[notebooklm-mcp-cli](https://github.com/jacob-bd/notebooklm-mcp-cli)** - ⭐ 682

424. **[fetch-mcp](https://github.com/zcaceres/fetch-mcp)** - ⭐ 679
   A flexible HTTP fetching Model Context Protocol server.

425. **[clojure-mcp](https://github.com/bhauman/clojure-mcp)** - ⭐ 675
   Clojure MCP

426. **[mcp-clickhouse](https://github.com/ClickHouse/mcp-clickhouse)** - ⭐ 672
   Connect ClickHouse to your AI assistants.

427. **[llm-server-docs](https://github.com/varunvasudeva1/llm-server-docs)** - ⭐ 671
   End-to-end documentation to set up your own local & fully private LLM server on Debian. Equipped with chat, web search, RAG, model management, MCP servers, image generation, and TTS.

428. **[mcp_excalidraw](https://github.com/yctimlin/mcp_excalidraw)** - ⭐ 671

429. **[mcp-server-docker](https://github.com/ckreiling/mcp-server-docker)** - ⭐ 670
   MCP server for Docker

430. **[cuga-agent](https://github.com/cuga-project/cuga-agent)** - ⭐ 665
...
431. **[go-mcp](https://github.com/ThinkInAIXYZ/go-mcp)** - ⭐ 664
...
432. **[mcp-client-cli](https://github.com/adhikasp/mcp-client-cli)** - ⭐ 661
   A simple CLI to run LLM prompt and implement MCP client.

433. **[browserwing](https://github.com/browserwing/browserwing)** - ⭐ 660
...
434. **[yacy_grid_mcp](https://github.com/yacy/yacy_grid_mcp)** - ⭐ 654
   The YaCy Grid Master Connect Program

435. **[android-mcp-server](https://github.com/minhalvp/android-mcp-server)** - ⭐ 654
   An MCP server that provides control over Android devices via adb

436. **[mcp](https://github.com/laravel/mcp)** - ⭐ 653
   Rapidly build MCP servers for your Laravel applications.

437. **[awesome-mcp-security](https://github.com/Puliczek/awesome-mcp-security)** - ⭐ 646
   🔥🔒 Awesome MCP (Model Context Protocol) Security 🖥️

438. **[laravel-restify](https://github.com/BinarCode/laravel-restify)** - ⭐ 645
   Laravel API for Ai Agents and humans.

439. **[open-ptc-agent](https://github.com/Chen-zexi/open-ptc-agent)** - ⭐ 644
   An open source implementation of code execution with MCP (Programatic Tool Calling) 

440. **[llm-search](https://github.com/snexus/llm-search)** - ⭐ 643
   Querying local documents, powered by LLM

441. **[enrichmcp](https://github.com/featureform/enrichmcp)** - ⭐ 642
   EnrichMCP is a python framework for building data driven MCP servers

442. **[claude-code-plugins-plus](https://github.com/jeremylongshore/claude-code-plugins-plus)** - ⭐ 641
...
443. **[telegram-mcp](https://github.com/chigwell/telegram-mcp)** - ⭐ 641
   Telegram MCP server powered by Telethon to let MCP clients read chats, manage groups, and send/modify messages, media, contacts, and settings.

444. **[mcp-mem0](https://github.com/coleam00/mcp-mem0)** - ⭐ 639
   MCP server for long term agent memory with Mem0. Also useful as a template to get you started building your own MCP server with Python!

445. **[gcloud-mcp](https://github.com/googleapis/gcloud-mcp)** - ⭐ 639
   gcloud MCP server

446. **[wcgw](https://github.com/rusiaaman/wcgw)** - ⭐ 637
   Shell and coding agent on mcp clients

447. **[python-utcp](https://github.com/universal-tool-calling-protocol/python-utcp)** - ⭐ 636
   Official python implementation of UTCP. UTCP is an open standard that lets AI agents call any API directly, without extra middleware.

448. **[RAGLight](https://github.com/Bessouat40/RAGLight)** - ⭐ 635
   RAGLight is a modular framework for Retrieval-Augmented Generation (RAG). It makes it easy to plug in different LLMs, embeddings, and vector stores, and now includes seamless MCP integration to connect external tools and data sources.

449. **[mcp-google-sheets](https://github.com/xing5/mcp-google-sheets)** - ⭐ 633
   This MCP server integrates with your Google Drive and Google Sheets, to enable creating and modifying spreadsheets.

450. **[obsidian-mcp](https://github.com/StevenStavrakis/obsidian-mcp)** - ⭐ 629
   A simple MCP server for Obsidian

451. **[samples](https://github.com/strands-agents/samples)** - ⭐ 628
...
455. **[workers-mcp](https://github.com/cloudflare/workers-mcp)** - ⭐ 618
   Talk to a Cloudflare Worker from Claude Desktop!

456. **[CyberStrikeAI](https://github.com/Ed1s0nZ/CyberStrikeAI)** - ⭐ 618
   CyberStrikeAI is an AI-native security testing platform built in Go. It integrates 100+ security tools, an intelligent orchestration engine, role-based testing with predefined security roles, a skills system with specialized testing skills, and comprehensive lifecycle management capabilities.

457. **[drawio-mcp-server](https://github.com/lgazo/drawio-mcp-server)** - ⭐ 616
   Draw.io Model Context Protocol (MCP) Server

458. **[phpMyFAQ](https://github.com/thorsten/phpMyFAQ)** - ⭐ 611
   phpMyFAQ - Open Source FAQ web application for PHP 8.3+ and MySQL, PostgreSQL and other databases

459. **[nuwax](https://github.com/nuwax-ai/nuwax)** - ⭐ 609
...
460. **[mem-agent-mcp](https://github.com/firstbatchxyz/mem-agent-mcp)** - ⭐ 604
   mem-agent mcp server

461. **[mcp-server-elasticsearch](https://github.com/elastic/mcp-server-elasticsearch)** - ⭐ 603

462. **[a-share-mcp-is-just-i-need](https://github.com/24mlight/a-share-mcp-is-just-i-need)** - ⭐ 600

463. **[vibe](https://github.com/mondaycom/vibe)** - ⭐ 599
   🎨 Vibe Design System - Official monday.com UI resources for application development in React.js

464. **[mcp-link](https://github.com/automation-ai-labs/mcp-link)** - ⭐ 597
   Convert Any OpenAPI V3 API to MCP Server

465. **[macos-automator-mcp](https://github.com/steipete/macos-automator-mcp)** - ⭐ 597
   An MCP server to run AppleScript and JXA (JavaScript for Automation) to macOS.

466. **[paper-search-mcp](https://github.com/openags/paper-search-mcp)** - ⭐ 597
   A MCP for searching and downloading academic papers from multiple sources like arXiv, PubMed, bioRxiv, etc.

467. **[yargi-mcp](https://github.com/saidsurucu/yargi-mcp)** - ⭐ 596
...
470. **[FofaMap](https://github.com/asaotomo/FofaMap)** - ⭐ 588
...
471. **[mcp-filesystem-server](https://github.com/mark3labs/mcp-filesystem-server)** - ⭐ 588
...
473. **[daydreams](https://github.com/daydreamsai/daydreams)** - ⭐ 584
   Daydreams is a set of tools for building agents for commerce

474. **[tome](https://github.com/runebookai/tome)** - ⭐ 582
   a magical LLM desktop client that makes it easy for *anyone* to use LLMs and MCP

475. **[mcpcan](https://github.com/Kymo-MCP/mcpcan)** - ⭐ 582
...
476. **[obot](https://github.com/obot-platform/obot)** - ⭐ 581
   Complete MCP Platform -- Hosting, Registry, Gateway, and Chat Client

477. **[dexto](https://github.com/truffle-ai/dexto)** - ⭐ 580
   A coding agent and general agent harness for building and orchestrating agentic applications.

478. **[blueprint-mcp](https://github.com/ArcadeAI/blueprint-mcp)** - ⭐ 575
   Diagram generation for understanding codebases and system architecture using Nano Banana Pro.

479. **[mem0-mcp](https://github.com/mem0ai/mem0-mcp)** - ⭐ 575

480. **[brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server)** - ⭐ 573

481. **[langgraph-mcp](https://github.com/esxr/langgraph-mcp)** - ⭐ 572
   LangGraph solution template for MCP

482. **[next-devtools-mcp](https://github.com/vercel/next-devtools-mcp)** - ⭐ 569
...
485. **[obsidian-mcp-tools](https://github.com/jacksteamdev/obsidian-mcp-tools)** - ⭐ 560
   Add Obsidian integrations like semantic search and custom Templater prompts to Claude or any MCP client.

486. **[zypher-agent](https://github.com/corespeed-io/zypher-agent)** - ⭐ 558
   A minimal yet powerful framework for creating AI agents with full control over tools, providers, and execution flow.

487. **[douyin-mcp-server](https://github.com/yzfly/douyin-mcp-server)** - ⭐ 558
   提取抖音无水印视频链接，视频文案，douyin-mcp-server，mcp，claude skill

488. **[mcp-pointer](https://github.com/etsd-tech/mcp-pointer)** - ⭐ 557
...
490. **[mcp-handler](https://github.com/vercel/mcp-handler)** - ⭐ 552
...
492. **[manim-mcp-server](https://github.com/abhiemj/manim-mcp-server)** - ⭐ 548

493. **[cclsp](https://github.com/ktnyt/cclsp)** - ⭐ 547
...
502. **[pg-mcp-server](https://github.com/stuzero/pg-mcp-server)** - ⭐ 533

503. **[fastapi-mcp-langgraph-template](https://github.com/NicholasGoh/fastapi-mcp-langgraph-template)** - ⭐ 533
   A modern template for agentic orchestration — built for rapid iteration and scalable deployment using highly customizable, community-supported tools like MCP, LangGraph, and more.

504. **[dolphin-mcp](https://github.com/QuixiAI/dolphin-mcp)** - ⭐ 532

505. **[tda](https://github.com/irockel/tda)** - ⭐ 532
   TDA - Thread Dump Analyzer

506. **[awesome-mcp-servers](https://github.com/TensorBlock/awesome-mcp-servers)** - ⭐ 532
   A comprehensive collection of Model Context Protocol (MCP) servers

507. **[sentry-mcp](https://github.com/getsentry/sentry-mcp)** - ⭐ 532
   An MCP server for interacting with Sentry via LLMs.

508. **[apple-doc-mcp](https://github.com/MightyDillah/apple-doc-mcp)** - ⭐ 530
   MCP server providing seamless access to Apple Developer Documentation with smart search and wildcard support

509. **[echokit_server](https://github.com/second-state/echokit_server)** - ⭐ 530
   Open Source Voice Agent Platform

510. **[Mantic.sh](https://github.com/marcoaapfortes/Mantic.sh)** - ⭐ 529
   A structural code search engine for Al agents.

511. **[multimodal-agents-course](https://github.com/the-ai-merge/multimodal-agents-course)** - ⭐ 529
   An MCP Multimodal AI Agent with eyes and ears!

512. **[homeassistant-mcp](https://github.com/tevonsb/homeassistant-mcp)** - ⭐ 528
   A MCP server for Home Assistant

513. **[cloud-run-mcp](https://github.com/GoogleCloudPlatform/cloud-run-mcp)** - ⭐ 528
   MCP server to deploy apps to Cloud Run

514. **[mcp.el](https://github.com/lizqwerscott/mcp.el)** - ⭐ 527
   An Mcp client inside Emacs

515. **[TuriX-CUA](https://github.com/TurixAI/TuriX-CUA)** - ⭐ 523
   This is the official website for TuriX Computer-use-Agent

516. **[mcp-server-data-exploration](https://github.com/reading-plus-ai/mcp-server-data-exploration)** - ⭐ 522

517. **[pgmcp](https://github.com/subnetmarco/pgmcp)** - ⭐ 519
   An MCP server to query any Postgres database in natural language.

518. **[ethora](https://github.com/dappros/ethora)** - ⭐ 518
...
519. **[line-bot-mcp-server](https://github.com/line/line-bot-mcp-server)** - ⭐ 517
   MCP server that integrates the LINE Messaging API to connect an AI Agent to the LINE Official Account.

520. **[iterm-mcp](https://github.com/ferrislucas/iterm-mcp)** - ⭐ 517
   A Model Context Protocol server that executes commands in the current iTerm session - useful for REPL and CLI assistance

521. **[ghostcrew](https://github.com/GH05TCREW/ghostcrew)** - ⭐ 515
...
522. **[gateway](https://github.com/centralmind/gateway)** - ⭐ 515
   Universal MCP-Server for your Databases optimized for LLMs and AI-Agents.

523. **[apple-health-mcp](https://github.com/neiltron/apple-health-mcp)** - ⭐ 514
   MCP server for querying Apple Health data with natural language and SQL

524. **[ida-mcp-server](https://github.com/MxIris-Reverse-Engineering/ida-mcp-server)** - ⭐ 514
   A Model Context Protocol server for IDA

525. **[mcp-server-weread](https://github.com/freestylefly/mcp-server-weread)** - ⭐ 514
   微信读书MCP

526. **[mcp-client-for-ollama](https://github.com/jonigl/mcp-client-for-ollama)** - ⭐ 513
   A text-based user interface (TUI) client for interacting with MCP servers using Ollama. Features include agent mode, multi-server, model switching, streaming responses, tool management, human-in-the-loop, thinking mode, model params config, MCP prompts, custom system prompt and saved preferences. Built for developers working with local LLMs.

527. **[reverse-engineering-assistant](https://github.com/cyberkaida/reverse-engineering-assistant)** - ⭐ 511
   MCP server for reverse engineering tasks in Ghidra 👩‍💻

528. **[openapi-mcp-generator](https://github.com/harsha-iiiv/openapi-mcp-generator)** - ⭐ 509
   A tool that converts OpenAPI specifications to MCP server

529. **[multimodal-agents-course](https://github.com/multi-modal-ai/multimodal-agents-course)** - ⭐ 507
   An MCP Multimodal AI Agent with eyes and ears!

530. **[mcp-get](https://github.com/michaellatman/mcp-get)** - ⭐ 505

531. **[awesome-a2a](https://github.com/ai-boost/awesome-a2a)** - ⭐ 504
   Agent2Agent (A2A) – awesome A2A agents, tools, servers & clients, all in one place.

532. **[mcp-server-bash-sdk](https://github.com/muthuishere/mcp-server-bash-sdk)** - ⭐ 501
   Yes Mcp server in bash

533. **[drift](https://github.com/dadbodgeoff/drift)** - ⭐ 501
...
534. **[UnityMCP](https://github.com/jackwrichards/UnityMCP)** - ⭐ 498

535. **[davinci-resolve-mcp](https://github.com/samuelgursky/davinci-resolve-mcp)** - ⭐ 498
   MCP server integration for DaVinci Resolve

536. **[MCPSpy](https://github.com/alex-ilgayev/MCPSpy)** - ⭐ 496
   MCP Monitoring with eBPF

537. **[PentestAgent](https://github.com/GH05TCREW/PentestAgent)** - ⭐ 493
...
538. **[UnityMCP](https://github.com/Arodoid/UnityMCP)** - ⭐ 491

539. **[web-agent-protocol](https://github.com/OTA-Tech-AI/web-agent-protocol)** - ⭐ 490
   🌐Web Agent Protocol (WAP) - Record and replay user interactions in the browser with MCP support

540. **[mcp-youtube](https://github.com/anaisbetts/mcp-youtube)** - ⭐ 490
   A Model-Context Protocol Server for YouTube

541. **[web-search-mcp](https://github.com/mrkrsl/web-search-mcp)** - ⭐ 489
   A simple, locally hosted Web Search MCP server for use with Local LLMs

542. **[mcp-pandoc](https://github.com/vivekVells/mcp-pandoc)** - ⭐ 488
   MCP server for document format conversion using pandoc.

543. **[rails-mcp-server](https://github.com/maquina-app/rails-mcp-server)** - ⭐ 487
   A Ruby gem implementation of a Model Context Protocol (MCP) server for Rails projects. This server allows LLMs (Large Language Models) to interact with Rails projects through the Model Context Protocol.

544. **[talk-to-girlfriend-ai](https://github.com/arlanrakh/talk-to-girlfriend-ai)** - ⭐ 487
   im busy building ai agents so why not let an ai talk to my girlfriend? 

545. **[UnrealMCP](https://github.com/kvick-games/UnrealMCP)** - ⭐ 486
   MCP to allow AI agents to control Unreal

546. **[borsa-mcp](https://github.com/saidsurucu/borsa-mcp)** - ⭐ 486
   MCP Server for Turkish & American Stock Exchange and Fund Data

547. **[claude-debugs-for-you](https://github.com/jasonjmcghee/claude-debugs-for-you)** - ⭐ 483
   Enable any LLM (e.g. Claude) to interactively debug any language for you via MCP and a VS Code Extension

548. **[freecad-mcp](https://github.com/neka-nat/freecad-mcp)** - ⭐ 483
   FreeCAD MCP(Model Context Protocol) server

549. **[ha-mcp](https://github.com/homeassistant-ai/ha-mcp)** - ⭐ 481
   The Unofficial and Awesome Home Assistant MCP Server

550. **[haiku.rag](https://github.com/ggozad/haiku.rag)** - ⭐ 480
   Opinionated agentic RAG powered by LanceDB, Pydantic AI, and Docling

551. **[llm-mcp-rag](https://github.com/KelvinQiu802/llm-mcp-rag)** - ⭐ 480
   LLM + MCP + RAG = Magic
...
554. **[AnyTool](https://github.com/HKUDS/AnyTool)** - ⭐ 477
   "AnyTool: Universal Tool-Use Layer for AI Agents"

555. **[mcp-adapter](https://github.com/WordPress/mcp-adapter)** - ⭐ 476
   An MCP adapter that bridges the Abilities API to the Model Context Protocol, enabling MCP clients to discover and invoke WordPress plugin, theme, and core abilities programmatically.

556. **[n8n-workflow-builder](https://github.com/makafeli/n8n-workflow-builder)** - ⭐ 474
   AI assistant integration for n8n workflow automation through Model Context Protocol (MCP). Connect Claude Desktop, ChatGPT, and other AI assistants to n8n for natural language workflow management.

557. **[mcp-gsuite](https://github.com/MarkusPfundstein/mcp-gsuite)** - ⭐ 473
   MCP Server to interact with Google Gsuite prodcuts

558. **[MetasploitMCP](https://github.com/GH05TCREW/MetasploitMCP)** - ⭐ 472
   MCP Server for Metasploit

559. **[open-multi-agent-canvas](https://github.com/CopilotKit/open-multi-agent-canvas)** - ⭐ 471
   The open-source multi-agent chat interface that lets you manage multiple agents in one dynamic conversation and add MCP servers for deep research

560. **[dbt-mcp](https://github.com/dbt-labs/dbt-mcp)** - ⭐ 470
   A MCP (Model Context Protocol) server for interacting with dbt.

561. **[alpaca-mcp-server](https://github.com/alpacahq/alpaca-mcp-server)** - ⭐ 470
   Alpaca’s official MCP Server lets you trade stocks, ETFs, crypto, and options, run data analysis, and build strategies in plain English directly from your favorite LLM tools and IDEs

562. **[aser](https://github.com/AmeNetwork/aser)** - ⭐ 469
   Aser is a lightweight, self-assembling AI Agent frame.

563. **[laravel](https://github.com/php-mcp/laravel)** - ⭐ 469
   An SDK building Laravel MCP servers

564. **[bm.md](https://github.com/miantiao-me/bm.md)** - ⭐ 469
...
567. **[atlas-mcp-server](https://github.com/cyanheads/atlas-mcp-server)** - ⭐ 464
   A Model Context Protocol (MCP) server for ATLAS, a Neo4j-powered task management system for LLM Agents - implementing a three-tier architecture (Projects, Tasks, Knowledge) to manage complex workflows. Now with Deep Research.

568. **[cupertino](https://github.com/mihaelamj/cupertino)** - ⭐ 463
   A local Apple Documentation crawler and MCP server. Written in Swift.

569. **[clickup-mcp-server](https://github.com/taazkareem/clickup-mcp-server)** - ⭐ 462
   ClickUp MCP Server - Integrate ClickUp project management with AI through Model Context Protocol

570. **[copilot-mcp](https://github.com/VikashLoomba/copilot-mcp)** - ⭐ 462
...
571. **[nexus](https://github.com/Nexus-Router/nexus)** - ⭐ 462
   Govern & Secure your AI

572. **[doctor](https://github.com/sisig-ai/doctor)** - ⭐ 461
   Doctor is a tool for discovering, crawl, and indexing web sites to be exposed as an MCP server for LLM agents.

573. **[deeppowers](https://github.com/deeppowers/deeppowers)** - ⭐ 460
...
574. **[flux-operator](https://github.com/controlplaneio-fluxcd/flux-operator)** - ⭐ 460
   GitOps on Autopilot Mode

575. **[vibe-check-mcp-server](https://github.com/PV-Bhat/vibe-check-mcp-server)** - ⭐ 460
   Vibe Check is a tool that provides mentor-like feedback to AI Agents, preventing tunnel-vision, over-engineering and reasoning lock-in for complex and long-horizon agent workflows. KISS your over-eager AI Agents goodbye! Effective for: Coding, Ambiguous Tasks, High-Risk tasks

576. **[mcp-server-youtube-transcript](https://github.com/kimtaeyoon83/mcp-server-youtube-transcript)** - ⭐ 459
   This is an MCP server that allows you to directly download transcripts of YouTube videos.

577. **[director](https://github.com/director-run/director)** - ⭐ 458
   MCP Playbooks for AI agents

578. **[pdf-reader-mcp](https://github.com/SylphxAI/pdf-reader-mcp)** - ⭐ 458
   📄 Production-ready MCP server for PDF processing - 5-10x faster with parallel processing and 94%+ test coverage

579. **[mcp-server](https://github.com/PortSwigger/mcp-server)** - ⭐ 457
   MCP Server for Burp

580. **[minecraft-mcp-server](https://github.com/yuniko-software/minecraft-mcp-server)** - ⭐ 455
   A Minecraft MCP Server powered by Mineflayer API. It allows to control a Minecraft character in real-time, allowing AI assistants to build structures, explore the world, and interact with the game environment through natural language instruction

581. **[adb-mcp](https://github.com/mikechambers/adb-mcp)** - ⭐ 454

582. **[mcp-remote-macos-use](https://github.com/baryhuang/mcp-remote-macos-use)** - ⭐ 452
   The only general AI agent that does NOT requires extra API key, giving you full control on your local and remote MacOs from Claude Desktop App

583. **[ai-trader](https://github.com/whchien/ai-trader)** - ⭐ 450
   Backtrader-powered backtesting framework for algorithmic trading, featuring 20+ strategies, multi-market support, CLI tools, and an integrated MCP server for professional traders.

584. **[docker-mcp](https://github.com/QuantGeekDev/docker-mcp)** - ⭐ 447
...
591. **[mcp-send-email](https://github.com/resend/mcp-send-email)** - ⭐ 440
   Send emails directly from Cursor with this email sending MCP server

592. **[meta-ads-mcp](https://github.com/pipeboard-co/meta-ads-mcp)** - ⭐ 439
   MCP server to manage Facebook and Instagram Ads (Meta Ads)

593. **[skybridge](https://github.com/alpic-ai/skybridge)** - ⭐ 437
   Skybridge is a framework for building ChatGPT & MCP Apps

594. **[mcp-bench](https://github.com/Accenture/mcp-bench)** - ⭐ 436
   MCP-Bench: Benchmarking Tool-Using LLM Agents with Complex Real-World Tasks via MCP Servers

595. **[MCP](https://github.com/jina-ai/MCP)** - ⭐ 435
   Official Jina AI Remote MCP Server

596. **[youtube-mcp-server](https://github.com/ZubeidHendricks/youtube-mcp-server)** - ⭐ 434
   MCP Server for YouTube API, enabling video management, Shorts creation, and advanced analytics

597. **[mcp-security](https://github.com/google/mcp-security)** - ⭐ 433

598. **[Godot-MCP](https://github.com/ee0pdt/Godot-MCP)** - ⭐ 432
   An MCP for Godot that lets you create and edit games in the Godot game engine with tools like Claude

599. **[ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server)** - ⭐ 432
   A Model Context Protocol (MCP) server for interacting with Microsoft 365 and Office services through the Graph API

600. **[sdk-typescript](https://github.com/strands-agents/sdk-typescript)** - ⭐ 429
   A model-driven approach to building AI agents in just a few lines of code. 

601. **[joinly](https://github.com/joinly-ai/joinly)** - ⭐ 428
   Make your meetings accessible to AI Agents

602. **[xhs-mcp](https://github.com/jobsonlook/xhs-mcp)** - ⭐ 427
   小红书MCP服务 x-s x-t js逆向

603. **[mcp-hub](https://github.com/ravitemer/mcp-hub)** - ⭐ 426
   A centralized manager for Model Context Protocol (MCP) servers with dynamic server management and monitoring

604. **[AgentX](https://github.com/lucky-aeon/AgentX)** - ⭐ 425
   AgentX 致力于让小白也能无门槛通过自然语言打造属于自己的 Agent。AgentX 采用了自研 MCP 网关，模型高可用组件打造高可用

605. **[awesome-claude-code-plugins](https://github.com/ccplugins/awesome-claude-code-plugins)** - ⭐ 423
   Awesome Claude Code plugins — a curated list of slash commands, subagents, MCP servers, and hooks for Claude Code

606. **[mineru-tianshu](https://github.com/magicyuan876/mineru-tianshu)** - ⭐ 423
...
611. **[CoexistAI](https://github.com/SPThole/CoexistAI)** - ⭐ 418
   CoexistAI is a modular, developer-friendly research assistant framework . It enables you to build, search, summarize, and automate research workflows using LLMs, web search, Reddit, YouTube, and mapping tools—all with simple MCP tool calls or API calls or Python functions. 

612. **[learn-low-code-agentic-ai](https://github.com/panaversity/learn-low-code-agentic-ai)** - ⭐ 417
...
613. **[cocos-mcp-server](https://github.com/DaxianLee/cocos-mcp-server)** - ⭐ 417
...
614. **[mcpadapt](https://github.com/grll/mcpadapt)** - ⭐ 416
   Unlock 650+ MCP servers tools in your favorite agentic framework.

615. **[mcp-nixos](https://github.com/utensils/mcp-nixos)** - ⭐ 416
...
619. **[mcp-searxng](https://github.com/ihor-sokoliuk/mcp-searxng)** - ⭐ 412
   MCP Server for SearXNG

620. **[mcp-registry](https://github.com/docker/mcp-registry)** - ⭐ 411
   Official Docker MCP registry 

621. **[shinkai-local-ai-agents](https://github.com/dcSpark/shinkai-local-ai-agents)** - ⭐ 411
...
622. **[azure-ai-travel-agents](https://github.com/Azure-Samples/azure-ai-travel-agents)** - ⭐ 411
...
623. **[NetCoreKevin](https://github.com/junkai-li/NetCoreKevin)** - ⭐ 410
...
624. **[mcp-redis](https://github.com/redis/mcp-redis)** - ⭐ 410
   The official Redis MCP Server is a natural language interface designed for agentic applications to manage and search data in Redis efficiently

625. **[lanhu-mcp](https://github.com/dsphper/lanhu-mcp)** - ⭐ 410
   ⚡ 需求分析效率提升 200%！全球首个为 AI 编程时代设计的团队协作 MCP 服务器，自动分析需求自动编写前后端代码，下载切图

626. **[work-iq-mcp](https://github.com/microsoft/work-iq-mcp)** - ⭐ 410
   MCP Server and CLI for accessing Work IQ

627. **[mcp-cli](https://github.com/wong2/mcp-cli)** - ⭐ 409
   A CLI inspector for the Model Context Protocol

628. **[mcp-server-motherduck](https://github.com/motherduckdb/mcp-server-motherduck)** - ⭐ 409
   MCP server for DuckDB and MotherDuck

629. **[GhidrAssistMCP](https://github.com/jtang613/GhidrAssistMCP)** - ⭐ 408
   An MCP extension for Ghidra

630. **[FinanceMCP](https://github.com/guangxiangdebizi/FinanceMCP)** - ⭐ 408
...
631. **[lark-openapi-mcp](https://github.com/larksuite/lark-openapi-mcp)** - ⭐ 407
   飞书/Lark官方 OpenAPI MCP

632. **[awesome-mcp-devtools](https://github.com/punkpeye/awesome-mcp-devtools)** - ⭐ 405
   A curated list of developer tools, SDKs, libraries, and testing utilities for Model Context Protocol (MCP) server development.

633. **[mcp-obsidian](https://github.com/bitbonsai/mcp-obsidian)** - ⭐ 404
   A lightweight Model Context Protocol (MCP) server for safe Obsidian vault access

634. **[docfork](https://github.com/docfork/docfork)** - ⭐ 403
   Docfork - Up-to-date Docs for AI Agents.

635. **[biomcp](https://github.com/genomoncology/biomcp)** - ⭐ 403
   BioMCP: Biomedical Model Context Protocol

636. **[RestClient.Net](https://github.com/MelbourneDeveloper/RestClient.Net)** - ⭐ 402
   The safest way to make REST calls in C# with an MCP Generator

637. **[airtable-mcp-server](https://github.com/domdomegg/airtable-mcp-server)** - ⭐ 401
   🗂️🤖 Airtable Model Context Protocol Server, for allowing AI systems to interact with your Airtable bases

638. **[codexia](https://github.com/milisp/codexia)** - ⭐ 401
   A powerfull GUI and Toolkit for Codex CLI + Claude Code. FileTree + prompt notepad + git worktree and more

639. **[Software-planning-mcp](https://github.com/NightTrek/Software-planning-mcp)** - ⭐ 398
   An experiment in software planning using MCP

640. **[agentscope-runtime](https://github.com/agentscope-ai/agentscope-runtime)** - ⭐ 396
...
641. **[unreal-engine-mcp](https://github.com/flopperam/unreal-engine-mcp)** - ⭐ 395
...
642. **[lunar](https://github.com/TheLunarCompany/lunar)** - ⭐ 394
   lunar.dev: Agent native MCP Gateway for governance and security

643. **[claude-codex-settings](https://github.com/fcakyon/claude-codex-settings)** - ⭐ 394
   My personal Claude Code and OpenAI Codex setup with battle-tested skills, commands, hooks, agents and MCP servers that I use daily.

644. **[mcp](https://github.com/baidu-maps/mcp)** - ⭐ 393
   Baidu Map MCP Server

645. **[memento-mcp](https://github.com/gannonh/memento-mcp)** - ⭐ 392
   Memento MCP: A Knowledge Graph Memory System for LLMs

646. **[mcp-mermaid](https://github.com/hustcc/mcp-mermaid)** - ⭐ 391
   ❤️ Generate mermaid diagram and chart with AI MCP dynamically.

647. **[chatluna](https://github.com/ChatLunaLab/chatluna)** - ⭐ 391
...
648. **[Feishu-MCP](https://github.com/cso1z/Feishu-MCP)** - ⭐ 390
   为 Cursor、Windsurf、Cline 和其他 AI 驱动的编码工具提供访问、编辑和结构化处理飞书文档的能力，基于 Model Context Protocol 服务器实现。

649. **[mcp-alchemy](https://github.com/runekaagaard/mcp-alchemy)** - ⭐ 387
   A MCP (model context protocol) server that gives the LLM access to and knowledge about relational databases like SQLite, Postgresql, MySQL & MariaDB, Oracle, and MS-SQL.

650. **[docling-mcp](https://github.com/docling-project/docling-mcp)** - ⭐ 386
   Making docling agentic through MCP

651. **[home-assistant-vibecode-agent](https://github.com/Coolver/home-assistant-vibecode-agent)** - ⭐ 385
...
652. **[groq-desktop-beta](https://github.com/groq/groq-desktop-beta)** - ⭐ 383
   Local Groq Desktop chat app with MCP support

653. **[MCP-SecurityTools](https://github.com/Ta0ing/MCP-SecurityTools)** - ⭐ 383
   MCP-SecurityTools 是一个专注于收录和更新网络安全领域 MCP 的开源项目，旨在汇总、整理和优化各类与 MCP 相关的安全工具、技术及实战经验。

654. **[mcp-google-ads](https://github.com/cohnen/mcp-google-ads)** - ⭐ 382
   An MCP tool that connects Google Ads with Claude AI/Cursor and others, allowing you to analyze your advertising data through natural language conversations. This integration gives you access to campaign information, performance metrics, keyword analytics, and ad management—all through simple chat with Claude, Cursor or Windsurf.

655. **[ai4j](https://github.com/LnYo-Cly/ai4j)** - ⭐ 381
...
656. **[mcp-hfspace](https://github.com/evalstate/mcp-hfspace)** - ⭐ 381
   MCP Server to Use HuggingFace spaces, easy configuration and Claude Desktop mode. 

657. **[edgeone-pages-mcp](https://github.com/TencentEdgeOne/edgeone-pages-mcp)** - ⭐ 380
   An MCP service designed for deploying HTML content to EdgeOne Pages and obtaining an accessible public URL.

658. **[minion-agent](https://github.com/femto/minion-agent)** - ⭐ 379
   A simple agent framework that's capable of browser use + mcp + auto instrument + plan + deep  research + more

659. **[station](https://github.com/cloudshipai/station)** - ⭐ 378
   Station is our open-source runtime that lets teams deploy agents on their own infrastructure with full control.

660. **[mcpmark](https://github.com/eval-sys/mcpmark)** - ⭐ 378
   MCPMark is a comprehensive, stress-testing MCP benchmark designed to evaluate model and agent capabilities in real-world MCP use.

661. **[agent-builder](https://github.com/strands-agents/agent-builder)** - ⭐ 377
   An example agent demonstrating streaming, tool use, and interactivity from your terminal. This agent builder can help you to build your own agents and tools.

662. **[Agentfy](https://github.com/Agentfy-io/Agentfy)** - ⭐ 377
...
663. **[UnrealGenAISupport](https://github.com/prajwalshettydev/UnrealGenAISupport)** - ⭐ 376
...
664. **[labs-ai-tools-for-devs](https://github.com/docker/labs-ai-tools-for-devs)** - ⭐ 375
   Your trusted home for discovering MCP tools – seamlessly integrated into Docker

665. **[kicad-mcp](https://github.com/lamaalrajih/kicad-mcp)** - ⭐ 375
   Model Context Protocol server for KiCad on Mac, Windows, and Linux

666. **[mcp-code-graph](https://github.com/JudiniLabs/mcp-code-graph)** - ⭐ 374
   MCP Server for code graph analysis and visualization by CodeGPT

667. **[Anemoi](https://github.com/Coral-Protocol/Anemoi)** - ⭐ 373
   Anemoi: A Semi-Centralized Multi-agent Systems Based on Agent-to-Agent Communication MCP server from Coral Protocol

668. **[mcp-server](https://github.com/e2b-dev/mcp-server)** - ⭐ 373
   Giving Claude ability to run code with E2B via MCP (Model Context Protocol)

669. **[prism-insight](https://github.com/dragon1086/prism-insight)** - ⭐ 373
...
676. **[mcp-k8s-go](https://github.com/strowk/mcp-k8s-go)** - ⭐ 369
...
680. **[sonarqube-mcp-server](https://github.com/SonarSource/sonarqube-mcp-server)** - ⭐ 364
   SonarQube MCP Server

681. **[OpenContext](https://github.com/0xranx/OpenContext)** - ⭐ 364
   A personal context store for AI agents and assistants—reuse your existing coding agent CLI (Codex/Claude/OpenCode) with built‑in Skills/tools and a desktop GUI to capture, search, and reuse project knowledge across agents and repos.

682. **[reddit-mcp-buddy](https://github.com/karanb192/reddit-mcp-buddy)** - ⭐ 363
...
685. **[agent](https://github.com/1mcp-app/agent)** - ⭐ 360
...
688. **[CodeGraphContext](https://github.com/CodeGraphContext/CodeGraphContext)** - ⭐ 358
   An MCP server plus a CLI tool that indexes local code into a graph database to provide context to AI assistants.

689. **[mcp2mqtt](https://github.com/mcp2everything/mcp2mqtt)** - ⭐ 357
   本项目通过将 MCP 协议转换为 MQTT 协议，我们能够利用强大的大型语言模型（LLMs），就能轻松操控您的智能家居、机器人或其他硬件设备。

690. **[better-icons](https://github.com/better-auth/better-icons)** - ⭐ 357
...
692. **[applescript-mcp](https://github.com/joshrutkowski/applescript-mcp)** - ⭐ 354
   A macOS AppleScript MCP server

693. **[ableton-live-mcp-server](https://github.com/Simon-Kansara/ableton-live-mcp-server)** - ⭐ 354
   MCP Server implementation for Ableton Live OSC control

694. **[tfmcp](https://github.com/nwiizo/tfmcp)** - ⭐ 353
   🌍 Terraform Model Context Protocol (MCP) Tool - An experimental CLI tool that enables AI assistants to manage and operate Terraform environments. Supports reading Terraform configurations, analyzing plans, applying configurations, and managing state with Claude Desktop integration. ⚡️

695. **[vtcode](https://github.com/vinhnx/vtcode)** - ⭐ 353
...
699. **[mcpr](https://github.com/conikeec/mcpr)** - ⭐ 351
   Model Context Protocol (MCP) implementation in Rust

700. **[open-skills](https://github.com/instavm/open-skills)** - ⭐ 350
   OpenSkills: Run Claude Skills Locally using any LLM

701. **[mcp-teams-server](https://github.com/InditexTech/mcp-teams-server)** - ⭐ 349
   An MCP (Model Context Protocol) server implementation for Microsoft Teams integration, providing capabilities to read messages, create messages, reply to messages, mention members.

702. **[f2c-mcp](https://github.com/f2c-ai/f2c-mcp)** - ⭐ 349
   F2C MCP Server

703. **[tradingview-mcp](https://github.com/atilaahmettaner/tradingview-mcp)** - ⭐ 349
...
704. **[xcode-mcp-server](https://github.com/r-huijts/xcode-mcp-server)** - ⭐ 348
   MCP Server implementation for Xcode integration

705. **[powerbi-modeling-mcp](https://github.com/microsoft/powerbi-modeling-mcp)** - ⭐ 348
   The Power BI Modeling MCP Server, brings Power BI semantic modeling capabilities to your AI agents.

706. **[obsidian-mcp-server](https://github.com/cyanheads/obsidian-mcp-server)** - ⭐ 347
   Obsidian Knowledge-Management MCP (Model Context Protocol) server that enables AI agents and development tools to interact with an Obsidian vault. It provides a comprehensive suite of tools for reading, writing, searching, and managing notes, tags, and frontmatter, acting as a bridge to the Obsidian Local REST API plugin.

707. **[Construction-Hazard-Detection](https://github.com/yihong1120/Construction-Hazard-Detection)** - ⭐ 347
   Enhances construction site safety using YOLO for object detection, identifying hazards like workers without helmets or safety vests, and proximity to machinery or vehicles. HDBSCAN clusters safety cone coordinates to create monitored zones. Post-processing algorithms improve detection accuracy.

708. **[run-model-context-protocol-servers-with-aws-lambda](https://github.com/awslabs/run-model-context-protocol-servers-with-aws-lambda)** - ⭐ 346
   Run existing Model Context Protocol (MCP) stdio-based servers in AWS Lambda functions

709. **[revit-mcp](https://github.com/revit-mcp/revit-mcp)** - ⭐ 344
   AI-Powered Revit Modeling

710. **[linear-mcp-server](https://github.com/jerhadf/linear-mcp-server)** - ⭐ 343
   A server that integrates Linear's project management system with the Model Context Protocol (MCP) to allow LLMs to interact with Linear.

711. **[RetroMCP-Java](https://github.com/MCPHackers/RetroMCP-Java)** - ⭐ 343
   A rewrite of MCP to provide support for many versions of Minecraft which were never supported by original MCP

712. **[mcp-apple-notes](https://github.com/RafalWilinski/mcp-apple-notes)** - ⭐ 342
   Talk with your notes in Claude. RAG over your Apple Notes using Model Context Protocol.

713. **[mcp-gateway](https://github.com/lasso-security/mcp-gateway)** - ⭐ 342
   A plugin-based gateway that orchestrates other MCPs and allows developers to build upon it enterprise-grade agents.

714. **[skillz](https://github.com/intellectronica/skillz)** - ⭐ 342
   An MCP server for loading skills (shim for non-claude clients).

715. **[mcp-reddit](https://github.com/adhikasp/mcp-reddit)** - ⭐ 341
   A Model Context Protocol (MCP) server that provides tools for fetching and analyzing Reddit content.

716. **[a2a-directory](https://github.com/sing1ee/a2a-directory)** - ⭐ 340
   Agent2Agent (A2A) – AgentCards, Servers, Clients, Docs

717. **[droidmind](https://github.com/hyperb1iss/droidmind)** - ⭐ 340
   Control your Android devices with AI using Model Context Protocol

718. **[WireMCP](https://github.com/0xKoda/WireMCP)** - ⭐ 340
   An MCP for WireShark (tshark). Empower LLM's with realtime network traffic analysis capability

719. **[devopness](https://github.com/devopness/devopness)** - ⭐ 340
   DevOps Happiness: 1-click or 1-prompt MCP. Deploy apps + infra + CI/CD on your cloud. Happy humans + reliable agents. 🚀

720. **[base-mcp](https://github.com/base/base-mcp)** - ⭐ 339
   A Model Context Protocol (MCP) server that provides onchain tools for LLMs, allowing them to interact with the Base network and Coinbase API.

721. **[mcp-aktools](https://github.com/aahl/mcp-aktools)** - ⭐ 339
   📈 提供股票、加密货币的数据查询和分析功能MCP服务器

722. **[daan](https://github.com/pluveto/daan)** - ⭐ 338
   ✨Lightweight LLM Client with MCP 🔌 & Characters 👤

723. **[awesome-cursor-mpc-server](https://github.com/kleneway/awesome-cursor-mpc-server)** - ⭐ 338
   Example of an MCP server with custom tools that can be called directly from cursor

724. **[MoltBrain](https://github.com/nhevers/MoltBrain)** - ⭐ 338
   Long-term memory layer for OpenClaw & MoltBook agents that learns and recalls your project context automatically.

725. **[devtools-debugger-mcp](https://github.com/ScriptedAlchemy/devtools-debugger-mcp)** - ⭐ 337
   An MCP server exposing full Chrome DevTools Protocol debugging: breakpoints, step/run, call stacks, eval, and source maps.

726. **[db-mcp-server](https://github.com/FreePeak/db-mcp-server)** - ⭐ 336
   A powerful multi-database server implementing the Model Context Protocol (MCP) to provide AI assistants with structured access to databases.

727. **[mcp-for-next.js](https://github.com/vercel-labs/mcp-for-next.js)** - ⭐ 336

728. **[mcp-selenium](https://github.com/angiejones/mcp-selenium)** - ⭐ 336
   An MCP implementation for Selenium WebDriver

729. **[WebMCP](https://github.com/jasonjmcghee/WebMCP)** - ⭐ 335
...
730. **[BloodHound-MCP-AI](https://github.com/MorDavid/BloodHound-MCP-AI)** - ⭐ 335
   BloodHound-MCP-AI is integration that connects BloodHound with AI through Model Context Protocol, allowing security professionals to analyze Active Directory attack paths using natural language instead of complex Cypher queries.

731. **[Android-MCP](https://github.com/CursorTouch/Android-MCP)** - ⭐ 334
   Lightweight MCP Server for interacting with Android Operating System.

732. **[maverick-mcp](https://github.com/wshobson/maverick-mcp)** - ⭐ 333
   MaverickMCP - Personal Stock Analysis MCP Server

733. **[hermes-mcp](https://github.com/cloudwalk/hermes-mcp)** - ⭐ 332
   Elixir Model Context Protocol (MCP) SDK

734. **[paws-on-mcp](https://github.com/hemanth/paws-on-mcp)** - ⭐ 332
   A comprehensive Model Context Protocol (MCP) server implementing the latest specification.

735. **[mcp-calculator](https://github.com/78/mcp-calculator)** - ⭐ 332
...
740. **[open-mcp](https://github.com/wegotdocs/open-mcp)** - ⭐ 328

741. **[Ace-Mcp-Node](https://github.com/yeuxuan/Ace-Mcp-Node)** - ⭐ 327
...
742. **[mcsmcp](https://github.com/microsoft/mcsmcp)** - ⭐ 327
...
745. **[vscode-mcp-server](https://github.com/juehang/vscode-mcp-server)** - ⭐ 324
   MCP server to expose VS Code editing features to an LLM for AI coding

746. **[mesh](https://github.com/decocms/mesh)** - ⭐ 324
   One secure endpoint for every MCP server. Deploy anywhere.

747. **[mcp-server-azure-devops](https://github.com/Tiberriver256/mcp-server-azure-devops)** - ⭐ 323
   An MCP server for Azure DevOps

748. **[mcp](https://github.com/IBM/mcp)** - ⭐ 323
   A collection of Model Context Protocol (MCP) servers, clients and developer tools by IBM.

749. **[Rube](https://github.com/ComposioHQ/Rube)** - ⭐ 322
...
750. **[agentcontrolplane](https://github.com/humanlayer/agentcontrolplane)** - ⭐ 322
...
751. **[AgentChat](https://github.com/Shy2593666979/AgentChat)** - ⭐ 322
...
753. **[redd-archiver](https://github.com/19-84/redd-archiver)** - ⭐ 319
...
754. **[Minecraft-Hack-BaseClient](https://github.com/OxideWaveLength/Minecraft-Hack-BaseClient)** - ⭐ 318
   This is a Minecraft Base Client

755. **[ast-grep-mcp](https://github.com/ast-grep/ast-grep-mcp)** - ⭐ 318

756. **[claude-code-statusline](https://github.com/rz1989s/claude-code-statusline)** - ⭐ 318
...
757. **[langconnect-client](https://github.com/teddynote-lab/langconnect-client)** - ⭐ 317
   A Modern GUI Interface for Vector Database Management(Supports MCP integration)

758. **[stealth-browser-mcp](https://github.com/vibheksoni/stealth-browser-mcp)** - ⭐ 317
   The only browser automation that bypasses anti-bot systems. AI writes network hooks, clones UIs pixel-perfect via simple chat.

759. **[ClimateTraceKMP](https://github.com/joreilly/ClimateTraceKMP)** - ⭐ 317
   Kotlin/Compose Multiplatform project to show climate related emission data from https://climatetrace.org/data.

760. **[emcee](https://github.com/mattt/emcee)** - ⭐ 313
   MCP generator for OpenAPIs 🫳🎤💥

761. **[claude-talk-to-figma-mcp](https://github.com/arinspunk/claude-talk-to-figma-mcp)** - ⭐ 313
...
762. **[autogenstudio-skills](https://github.com/madtank/autogenstudio-skills)** - ⭐ 312
   Repo of skills for autogen studio using model context protocol (mcp)

763. **[mcp-servers-hub](https://github.com/apappascs/mcp-servers-hub)** - ⭐ 312
   Discover the most comprehensive and up-to-date collection of MCP servers in the market. This repository serves as a centralized hub, offering an extensive catalog of open-source and proprietary MCP servers, complete with features, documentation links, and contributors.

764. **[mcp-for-argocd](https://github.com/argoproj-labs/mcp-for-argocd)** - ⭐ 312
...
769. **[mcp-server](https://github.com/mapbox/mcp-server)** - ⭐ 306
   Mapbox Model Context Protocol (MCP) server

770. **[ebook-mcp](https://github.com/onebirdrocks/ebook-mcp)** - ⭐ 306
...
772. **[mcp-sse](https://github.com/sidharthrajaram/mcp-sse)** - ⭐ 303
   A working pattern for SSE-based MCP clients and servers

773. **[mcprouter](https://github.com/chatmcp/mcprouter)** - ⭐ 303
   api router for MCP Servers

774. **[investor-agent](https://github.com/ferdousbhai/investor-agent)** - ⭐ 303
   A Model Context Protocol server for building an investor agent

775. **[openmcp](https://github.com/getdatanaut/openmcp)** - ⭐ 302
   Turn any openapi file into an mcp server, with just the tools you need.

776. **[automcp](https://github.com/NapthaAI/automcp)** - ⭐ 302
   Easily convert tool, agents and orchestrators from existing agent frameworks to MCP servers

777. **[deep-research-mcp](https://github.com/Ozamatash/deep-research-mcp)** - ⭐ 302

778. **[mcp-server-code-execution-mode](https://github.com/elusznik/mcp-server-code-execution-mode)** - ⭐ 302
   An MCP server that executes Python code in isolated rootless containers with optional MCP server proxying. Implementation of Anthropic's and Cloudflare's ideas for reducing MCP tool definitions context bloat.

779. **[zotero-mcp](https://github.com/cookjohn/zotero-mcp)** - ⭐ 301
...
785. **[mcp-claude-code](https://github.com/SDGLBL/mcp-claude-code)** - ⭐ 298
   MCP implementation of Claude Code capabilities and more

786. **[mcp-git-ingest](https://github.com/adhikasp/mcp-git-ingest)** - ⭐ 297
   A Model Context Protocol (MCP) server that helps read GitHub repository structure and important files.

787. **[x64DbgMCPServer](https://github.com/AgentSmithers/x64DbgMCPServer)** - ⭐ 297
   x64DbgMCPServer made from c# with Claude, Windsurf and Cursor support

788. **[DeepWideResearch](https://github.com/puppyone-ai/DeepWideResearch)** - ⭐ 295
   Agentic RAG for any scenario. Customize sources, depth, and width

789. **[mcp-server-apple-shortcuts](https://github.com/recursechat/mcp-server-apple-shortcuts)** - ⭐ 294

790. **[mcp-everything-search](https://github.com/mamertofabian/mcp-everything-search)** - ⭐ 294

791. **[AI-Kline](https://github.com/QuantML-C/AI-Kline)** - ⭐ 292
...
792. **[MaaMCP](https://github.com/MAA-AI/MaaMCP)** - ⭐ 292
   基于 MaaFramework 的 MCP 服务器 为 AI 助手提供 Android 设备和 Windows 桌面自动化能力

793. **[generator](https://github.com/context-hub/generator)** - ⭐ 292
   CTX: a tool that solves the context management gap when working with LLMs like ChatGPT or Claude. It helps developers organize and automatically collect information from their codebase into structured documents that can be easily shared with AI assistants.

794. **[mcp-server-simulator-ios-idb](https://github.com/InditexTech/mcp-server-simulator-ios-idb)** - ⭐ 291
   A Model Context Protocol (MCP) server that enables LLMs to interact with iOS simulators through natural language commands.

795. **[mysql_mcp_server_pro](https://github.com/wenb1n-dev/mysql_mcp_server_pro)** - ⭐ 291
...
796. **[aider-mcp-server](https://github.com/disler/aider-mcp-server)** - ⭐ 291
   Minimal MCP Server for Aider

797. **[mcp-youtube-transcript](https://github.com/jkawamoto/mcp-youtube-transcript)** - ⭐ 291
   MCP server retrieving transcripts of YouTube videos

798. **[llm-context.py](https://github.com/cyberchitta/llm-context.py)** - ⭐ 291
   Share code with LLMs via Model Context Protocol or clipboard. Rule-based customization enables easy switching between different tasks (like code review and documentation). Includes smart code outlining.

799. **[solon-ai](https://github.com/opensolon/solon-ai)** - ⭐ 291
...
800. **[aws-mcp](https://github.com/RafalWilinski/aws-mcp)** - ⭐ 290
   Talk with your AWS using Claude. Model Context Protocol (MCP) server for AWS. Better Amazon Q alternative.

801. **[blender-mcp-vxai](https://github.com/VxASI/blender-mcp-vxai)** - ⭐ 288

802. **[mcp-server-mas-sequential-thinking](https://github.com/FradSer/mcp-server-mas-sequential-thinking)** - ⭐ 287
   An advanced sequential thinking process using a Multi-Agent System (MAS) built with the Agno framework and served via MCP.

803. **[obsidian-mcp](https://github.com/newtype-01/obsidian-mcp)** - ⭐ 287
   Obsidian MCP (Model Context Protocol) Server

804. **[consult7](https://github.com/szeider/consult7)** - ⭐ 287
   MCP server to consult a language model with large context size

805. **[o3-search-mcp](https://github.com/yoshiko-pg/o3-search-mcp)** - ⭐ 287
   MCP server for OpenAI o3 web search

806. **[mq](https://github.com/harehare/mq)** - ⭐ 287
   jq-like command-line tool for markdown processing

807. **[apktool-mcp-server](https://github.com/zinja-coder/apktool-mcp-server)** - ⭐ 286
   A MCP Server for APK Tool (Part of Android Reverse Engineering MCP Suites)

808. **[mcpsvr](https://github.com/nanbingxyz/mcpsvr)** - ⭐ 285
   Discover Exceptional MCP Servers

809. **[rhinomcp](https://github.com/jingcheng-chen/rhinomcp)** - ⭐ 285
   RhinoMCP connects Rhino 3D to AI Agent through the Model Context Protocol (MCP)

810. **[claude-code-mastery](https://github.com/TheDecipherist/claude-code-mastery)** - ⭐ 285
   The complete guide to Claude Code: CLAUDE.md, hooks, skills, MCP servers, and commands

811. **[lets-learn-mcp-csharp](https://github.com/microsoft/lets-learn-mcp-csharp)** - ⭐ 284

812. **[KiCAD-MCP-Server](https://github.com/mixelpixx/KiCAD-MCP-Server)** - ⭐ 284
   KiCAD MCP is a Model Context Protocol (MCP) implementation that enables Large Language Models (LLMs) like Claude to directly interact with KiCAD for printed circuit board design.

813. **[hydra-mcp-solana](https://github.com/hydra-mcp/hydra-mcp-solana)** - ⭐ 283
   hydra-ai

814. **[meGPT](https://github.com/adrianco/meGPT)** - ⭐ 283
   Code to process many kinds of content by an author into an MCP server

815. **[mcp-neovim-server](https://github.com/bigcodegen/mcp-neovim-server)** - ⭐ 283
   Control Neovim using Model Context Protocol (MCP) and the official neovim/node-client JavaScript library

816. **[utcp-specification](https://github.com/universal-tool-calling-protocol/utcp-specification)** - ⭐ 283
   The specification for the Universal Tool Calling Protocol

817. **[mcp-linker](https://github.com/milisp/mcp-linker)** - ⭐ 283
...
818. **[anything-to-notebooklm](https://github.com/joeseesun/anything-to-notebooklm)** - ⭐ 283
   Claude Skill: Multi-source content processor for NotebookLM. Supports WeChat articles, web pages, YouTube, PDF, Markdown, search queries → Podcast/PPT/MindMap/Quiz etc.

819. **[minthcm](https://github.com/minthcm/minthcm)** - ⭐ 282
   First AI‑enabled open-source Human Capital Management system that you can start using today.

820. **[remote-mcp-server-with-auth](https://github.com/coleam00/remote-mcp-server-with-auth)** - ⭐ 282
...
821. **[perplexity-mcp](https://github.com/DaInfernalCoder/perplexity-mcp)** - ⭐ 281
...
822. **[DeepWideResearch](https://github.com/PuppyAgent/DeepWideResearch)** - ⭐ 281
   Agentic RAG for any scenario. Customize sources, depth, and width

823. **[jadx-mcp-server](https://github.com/zinja-coder/jadx-mcp-server)** - ⭐ 281
   MCP server for JADX-AI Plugin

824. **[mcp-manager](https://github.com/zueai/mcp-manager)** - ⭐ 280
   simple web ui to manage mcp (model context protocol) servers in the claude app

825. **[ddddocr](https://github.com/86maid/ddddocr)** - ⭐ 280
...
826. **[mcp](https://github.com/oracle/mcp)** - ⭐ 280
...
827. **[app-store-connect-mcp-server](https://github.com/JoshuaRileyDev/app-store-connect-mcp-server)** - ⭐ 280

828. **[skillport](https://github.com/gotalab/skillport)** - ⭐ 280
   Bring Agent Skills to Any AI Agent and Coding Agent — via CLI or MCP. Manage once, serve anywhere.

829. **[perplexity-mcp](https://github.com/jsonallen/perplexity-mcp)** - ⭐ 279
   A Model Context Protocol (MCP) server that provides web search functionality using Perplexity AI's API.

830. **[MCP-handle](https://github.com/WeatherPal-AI/MCP-handle)** - ⭐ 278
   MCP integration platforms making AI-Agents developers focusing on their own tasks

831. **[chrome-devtools-mcp](https://github.com/benjaminr/chrome-devtools-mcp)** - ⭐ 278
   An MCP Server for Chrome DevTools, following the Chrome DevTools Protocol. Integrates with Claude Desktop and Claude Code.

832. **[safe-mcp](https://github.com/SAFE-MCP/safe-mcp)** - ⭐ 278
   SAFE-MCP is a comprehensive security framework for documenting and mitigating threats in the AI Agent ecosystem.

833. **[mcp940](https://github.com/WangTingZheng/mcp940)** - ⭐ 277
   Source code of minecraft 1.12

834. **[mcp-documentation-server](https://github.com/andrea9293/mcp-documentation-server)** - ⭐ 277
...
835. **[kagimcp](https://github.com/kagisearch/kagimcp)** - ⭐ 277
   The Official Model Context Protocol (MCP) server for Kagi search & other tools.

836. **[laravel-claude-code-setup](https://github.com/laraben/laravel-claude-code-setup)** - ⭐ 277
   One-command setup for AI-powered Laravel development with Claude Code and MCP servers

837. **[MCPControl](https://github.com/claude-did-this/MCPControl)** - ⭐ 277
   MCP server for Windows OS automation

838. **[burp-ai-agent](https://github.com/six2dez/burp-ai-agent)** - ⭐ 277
   Burp Suite extension that adds built-in MCP tooling, AI-assisted analysis, privacy controls, passive and active scanning and more

839. **[Context-Engine](https://github.com/m1rl0k/Context-Engine)** - ⭐ 276
   Context-Engine MCP - Agentic Context Compression Suite

840. **[FileScopeMCP](https://github.com/admica/FileScopeMCP)** - ⭐ 276
   Analyzes your codebase identifying important files based on dependency relationships. Generates diagrams and importance scores per file, helping AI assistants understand the codebase. Automatically parses popular programming languages such as Python, C, C++, Rust, Zig, Lua.

841. **[imagesorcery-mcp](https://github.com/sunriseapps/imagesorcery-mcp)** - ⭐ 276
   An MCP server providing tools for image processing operations

842. **[MCP-Server-Playwright](https://github.com/VikashLoomba/MCP-Server-Playwright)** - ⭐ 276
   MCP server for browser automation using Playwright

843. **[todoist-ai](https://github.com/Doist/todoist-ai)** - ⭐ 276
   A set of tools to connect to AI agents, to allow them to use Todoist on a user's behalf. Includes MCP support.

844. **[mcp-mongo-server](https://github.com/kiliczsh/mcp-mongo-server)** - ⭐ 276
   A Model Context Protocol Server for MongoDB

845. **[dify-mcp-server](https://github.com/YanxingLiu/dify-mcp-server)** - ⭐ 274
   Model Context Protocol (MCP) Server for dify workflows

846. **[mcp-reasoner](https://github.com/Jacck/mcp-reasoner)** - ⭐ 274
   A systematic reasoning MCP server implementation for Claude Desktop with beam search and thought evaluation.

847. **[telegram-mcp](https://github.com/chaindead/telegram-mcp)** - ⭐ 274
   Telegram MCP for managing dialogs, messages, drafts, read statuses, and more.

848. **[anytype-mcp](https://github.com/anyproto/anytype-mcp)** - ⭐ 274
   An MCP server enabling AI assistants to interact with Anytype - your encrypted, local and collaborative wiki - to organize objects, lists, and more through natural language.

849. **[metorial-index](https://github.com/metorial/metorial-index)** - ⭐ 273
   Metorial MCP Index - An ever growing list of open source MCP servers 📁 🎉

850. **[google-docs-mcp](https://github.com/a-bonus/google-docs-mcp)** - ⭐ 272
...
851. **[proximity](https://github.com/Nova-Hunting/proximity)** - ⭐ 271
   Proximity is a MCP security scanner powered with NOVA

852. **[hass-mcp](https://github.com/voska/hass-mcp)** - ⭐ 271
   Home Assistant MCP Server

853. **[geminimcp](https://github.com/GuDaStudio/geminimcp)** - ⭐ 271
...
854. **[aitour26-WRK540-unlock-your-agents-potential-with-model-context-protocol](https://github.com/microsoft/aitour26-WRK540-unlock-your-agents-potential-with-model-context-protocol)** - ⭐ 270

855. **[jinni](https://github.com/smat-dev/jinni)** - ⭐ 269
   Bring your project into LLM context - tool and MCP server

856. **[proximity](https://github.com/fr0gger/proximity)** - ⭐ 269
   Proximity is a MCP security scanner powered with NOVA

857. **[claude-modular](https://github.com/oxygen-fragment/claude-modular)** - ⭐ 268
   Production-ready modular Claude Code framework with 30+ commands, token optimization, and MCP server integration. Achieves 2-10x productivity gains through   systematic command organization and hierarchical configuration.

858. **[AetherLink](https://github.com/1600822305/AetherLink)** - ⭐ 268
...
859. **[things-mcp](https://github.com/hald/things-mcp)** - ⭐ 268
   Things.app MCP Server

860. **[model-context-protocol-resources](https://github.com/cyanheads/model-context-protocol-resources)** - ⭐ 266
   Exploring the Model Context Protocol (MCP) through practical guides, clients, and servers I've built while learning about this new protocol.

861. **[ultra-mcp](https://github.com/RealMikeChong/ultra-mcp)** - ⭐ 266
   100x Your Claude Code, Gemini CLI, Cursor and/or any coding tools with MCP client support

862. **[mcp-server-12306](https://github.com/drfccv/mcp-server-12306)** - ⭐ 266
   12306 MCP Server​​ 是一个基于 ​​Model Context Protocol (MCP)​​ 的高性能火车票查询后端系统。它通过标准化接口提供官方 12306 的实时数据服务，包括余票查询、车站信息、列车经停站、中转换乘方案等核心功能。

863. **[mcp-omnisearch](https://github.com/spences10/mcp-omnisearch)** - ⭐ 265
   🔍 A Model Context Protocol (MCP) server providing unified access to multiple search engines (Tavily, Brave, Kagi), AI tools (Perplexity, FastGPT), and content processing services (Jina AI, Kagi). Combines search, AI responses, content processing, and enhancement features through a single interface.

864. **[atlassian-mcp-server](https://github.com/atlassian/atlassian-mcp-server)** - ⭐ 265
   Remote MCP Server that securely connects Jira and Confluence with your LLM, IDE, or agent platform of choice.

865. **[iam-policy-autopilot](https://github.com/awslabs/iam-policy-autopilot)** - ⭐ 263
   IAM Policy Autopilot is an open source static code analysis tool that helps you quickly create baseline AWS IAM policies that you can refine as your application evolves. This tool is available as a command-line utility and MCP server for use within AI coding assistants for quickly building IAM policies.

866. **[mcp-odoo](https://github.com/tuanle96/mcp-odoo)** - ⭐ 262
   MCP Server for Odoo

867. **[mcp](https://github.com/salesforcecli/mcp)** - ⭐ 262
   MCP Server for interacting with Salesforce instances

868. **[ai-agent-team](https://github.com/peterfei/ai-agent-team)** - ⭐ 261
   AI Agent Team-拥有24/7专业AI开发团队：产品经理、前端开发、后端开发、测试工程师、DevOps工程师、技术负责人。一键安装，支持中英文命令，大幅提升开发效率！

869. **[reddit-mcp](https://github.com/Arindam200/reddit-mcp)** - ⭐ 260
   Model Context Protocol server implementation for Reddit

870. **[osp_marketing_tools](https://github.com/open-strategy-partners/osp_marketing_tools)** - ⭐ 259
   A Model Context Protocol (MCP) server that empowers LLMs to use some of Open Srategy Partners' core writing and product marketing techniques.

871. **[django-mcp-server](https://github.com/gts360/django-mcp-server)** - ⭐ 259
   Django MCP Server is a Django extensions to easily enable AI Agents to interact with Django Apps through the Model Context Protocol it works equally well on WSGI and ASGI

872. **[vestige](https://github.com/samvallad33/vestige)** - ⭐ 258
   Cognitive memory MCP server for Claude - FSRS-6, spreading activation, synaptic tagging, and 130 years of memory research

873. **[mcp-server](https://github.com/strands-agents/mcp-server)** - ⭐ 257
   This MCP server provides documentation about Strands Agents to your GenAI tools, so you can use your favorite AI coding assistant to vibe-code Strands Agents.

874. **[ssh-mcp](https://github.com/tufantunc/ssh-mcp)** - ⭐ 257
   MCP server exposing SSH control for Linux servers via Model Context Protocol.

875. **[project-nova](https://github.com/dujonwalker/project-nova)** - ⭐ 256
...
876. **[deepcontext-mcp](https://github.com/Wildcard-Official/deepcontext-mcp)** - ⭐ 256
   DeepContext is an MCP server that adds symbol-aware semantic search to Claude Code, Codex CLI, and other agents for faster, smarter context on large codebases.

877. **[mcp-gdrive](https://github.com/isaacphi/mcp-gdrive)** - ⭐ 256
   Model Context Protocol (MCP) Server for reading from Google Drive and editing Google Sheets

878. **[apollo-mcp-server](https://github.com/apollographql/apollo-mcp-server)** - ⭐ 256
   Apollo MCP Server

879. **[mcp-ical](https://github.com/Omar-V2/mcp-ical)** - ⭐ 255
   A Model Context Protocol Server that allows you to interact with your MacOS Calendar through natural language.

880. **[studio-rust-mcp-server](https://github.com/Roblox/studio-rust-mcp-server)** - ⭐ 255
   Standalone Roblox Studio MCP Server

881. **[admin](https://github.com/decocms/admin)** - ⭐ 253
   Define and compose secure MCPs in TypeScript. Generate AI workflows and agents with React + Tailwind UI. Deploy anywhere.

882. **[mcp-server-tree-sitter](https://github.com/wrale/mcp-server-tree-sitter)** - ⭐ 253
   MCP Server for Tree-sitter

883. **[CAAL](https://github.com/CoreWorxLab/CAAL)** - ⭐ 253
   Local voice assistant that learns new abilities via auto-discovered n8n workflows exposed as tools via MCP

884. **[lean-lsp-mcp](https://github.com/oOo0oOo/lean-lsp-mcp)** - ⭐ 253
   Lean Theorem Prover MCP

885. **[xiaozhi-client](https://github.com/shenjingnan/xiaozhi-client)** - ⭐ 252
   小智AI客户端，目前主要用于MCP的对接

886. **[api200](https://github.com/API-200/api200)** - ⭐ 252
   API 200 is an open source API gateway to simplify 3rd-party integrations. Import endpoints, set up caching, retries, and mocks. Access all services via one URL. Monitor logs, track errors, and get alerts on API incidents.

887. **[doris-mcp-server](https://github.com/apache/doris-mcp-server)** - ⭐ 251
   Apache Doris MCP Server

888. **[g-search-mcp](https://github.com/jae-jae/g-search-mcp)** - ⭐ 250
   A powerful MCP server for Google search that enables parallel searching with multiple keywords simultaneously.

889. **[code-reasoning](https://github.com/mettamatt/code-reasoning)** - ⭐ 250
   A code reasoning MCP server, a fork of sequential-thinking

890. **[aci-mcp](https://github.com/aipotheosis-labs/aci-mcp)** - ⭐ 250
   MCP server(s) for Aipolabs ACI.dev

891. **[mcp_massive](https://github.com/massive-com/mcp_massive)** - ⭐ 250
   An MCP server for Massive.com Financial Market Data

892. **[private-journal-mcp](https://github.com/obra/private-journal-mcp)** - ⭐ 250
   A lightweight MCP server that provides Claude with a private journaling capability to process feelings and thoughts

893. **[1c_mcp](https://github.com/vladimir-kharin/1c_mcp)** - ⭐ 250
...
894. **[Lynkr](https://github.com/Fast-Editor/Lynkr)** - ⭐ 250
   Streamline your workflow with Lynkr, a CLI tool that acts as an HTTP proxy for efficient code interactions using Claude Code CLI.

895. **[AEnvironment](https://github.com/inclusionAI/AEnvironment)** - ⭐ 249
   Standardized environment infrastructure for Agentic AI development.

896. **[enterprise-mcp-course](https://github.com/decodingai-magazine/enterprise-mcp-course)** - ⭐ 249
...
897. **[MARM-Systems](https://github.com/Lyellr88/MARM-Systems)** - ⭐ 249
...
898. **[rust-docs-mcp-server](https://github.com/Govcraft/rust-docs-mcp-server)** - ⭐ 247
   🦀 Prevents outdated Rust code suggestions from AI assistants. This MCP server fetches current crate docs, uses embeddings/LLMs, and provides accurate context via a tool call.

899. **[claude-recall](https://github.com/nhevers/claude-recall)** - ⭐ 247
   Long-term memory layer for MoltBot & Claude Code that learns and recalls your project context automatically

900. **[spring-ai-summary](https://github.com/java-ai-tech/spring-ai-summary)** - ⭐ 247
   SpringAI，LLM，MCP，Embedding

901. **[suppr-mcp](https://github.com/WildDataX/suppr-mcp)** - ⭐ 246
    超能文献|AI驱动的文档翻译与学术搜索服务。支持PDF、DOCX、PPTX等多格式文档的高质量翻译（支持11种语言），特别优化了数学公式翻译。同时提供PubMed学术文献智能搜索功能。更多访问：https://suppr.wilddata.cn

902. **[mcp-cli](https://github.com/apify/mcp-cli)** - ⭐ 246
...
903. **[next-lens](https://github.com/1weiho/next-lens)** - ⭐ 246
   A CLI that scans Next.js routes and provides quick insights from your terminal, web UI, and MCP.

904. **[bazi-mcp](https://github.com/cantian-ai/bazi-mcp)** - ⭐ 245
   MCP server for Bazi (八字) information

905. **[mcp_flutter](https://github.com/Arenukvern/mcp_flutter)** - ⭐ 245
   MCP server and MCP Toolkit  for Flutter and Dart VM - supports dynamic tooling

906. **[wexin-read-mcp](https://github.com/Bwkyd/wexin-read-mcp)** - ⭐ 244
   能够让大模型阅读微信公众号文章，使用浏览器模拟绕过反爬虫。

907. **[mcp-server-gemini](https://github.com/aliargun/mcp-server-gemini)** - ⭐ 244
   MCP server implementation for Google's Gemini API

908. **[Windows-MCP.Net](https://github.com/AIDotNet/Windows-MCP.Net)** - ⭐ 244
   A .NET-based Windows desktop automation MCP (Model Context Protocol) server that provides AI assistants with the ability to interact with the Windows desktop environment.

909. **[elasticsearch-mcp-server](https://github.com/cr7258/elasticsearch-mcp-server)** - ⭐ 244
   A Model Context Protocol (MCP) server implementation that provides Elasticsearch and OpenSearch interaction.

910. **[Windows-MCP.Net](https://github.com/shuyu-labs/Windows-MCP.Net)** - ⭐ 243
   A .NET-based Windows desktop automation MCP (Model Context Protocol) server that provides AI assistants with the ability to interact with the Windows desktop environment.

911. **[chat-mcp](https://github.com/AI-QL/chat-mcp)** - ⭐ 243
   A Desktop Chat App that leverages MCP(Model Context Protocol) to interface with other LLMs.

912. **[mcp-chatbot](https://github.com/3choff/mcp-chatbot)** - ⭐ 243
   A simple CLI chatbot that demonstrates the integration of the Model Context Protocol (MCP).

913. **[Unreal_mcp](https://github.com/ChiR24/Unreal_mcp)** - ⭐ 243
...
914. **[mcp-feedback-collector](https://github.com/sanshao85/mcp-feedback-collector)** - ⭐ 241
   一个现代化的 Model Context Protocol (MCP) 服务器，为AI助手提供交互式用户反馈收集功能。

915. **[video-editing-mcp](https://github.com/burningion/video-editing-mcp)** - ⭐ 241
   MCP Interface for Video Jungle

916. **[mcp-prompt-server](https://github.com/gdli6177/mcp-prompt-server)** - ⭐ 240
   这是一个基于Model Context Protocol (MCP)的服务器，用于根据用户任务需求提供预设的prompt模板，帮助Cline/Cursor/Windsurf...更高效地执行各种任务。服务器将预设的prompt作为工具(tools)返回，以便在Cursor和Windsurf等编辑器中更好地使用。

917. **[claude-code-mcpinstall](https://github.com/undeadpickle/claude-code-mcpinstall)** - ⭐ 240
   Easy guide to installing Claude Code MCPs globally on your machine.

918. **[cheatengine-mcp-bridge](https://github.com/miscusi-peek/cheatengine-mcp-bridge)** - ⭐ 240
...
919. **[PIXRA](https://github.com/dodufish/PIXRA)** - ⭐ 239
   Pixelize the real world on-chain

920. **[human-mcp](https://github.com/mrgoonie/human-mcp)** - ⭐ 239

921. **[claude_code-gemini-mcp](https://github.com/RaiAnsar/claude_code-gemini-mcp)** - ⭐ 238
   Simplified Gemini for Claude Code. 

922. **[mcp-server-code-runner](https://github.com/formulahendry/mcp-server-code-runner)** - ⭐ 238
   Code Runner MCP Server

923. **[weather-mcp-server](https://github.com/ezh0v/weather-mcp-server)** - ⭐ 238
   A lightweight Model Context Protocol (MCP) server that enables AI assistants like Claude to retrieve and interpret real-time weather data. Discuss on Hacker News:

924. **[MCPBench](https://github.com/modelscope/MCPBench)** - ⭐ 238
   The evaluation benchmark on MCP servers

925. **[mcp-on-vercel](https://github.com/vercel-labs/mcp-on-vercel)** - ⭐ 237

926. **[browser-control-mcp](https://github.com/eyalzh/browser-control-mcp)** - ⭐ 237
   MCP server paired with a browser extension that enables AI agents to control the user's browser.

927. **[foundry-mcp-server](https://github.com/PraneshASP/foundry-mcp-server)** - ⭐ 236
   An experimental MCP Server for foundry built for Solidity devs

928. **[firebase-mcp](https://github.com/gannonh/firebase-mcp)** - ⭐ 236
   🔥 Model Context Protocol (MCP) server for Firebase.

929. **[mcp-server](https://github.com/volcengine/mcp-server)** - ⭐ 236
   Volcengine MCP Servers

930. **[NFTIAI](https://github.com/Axarb/NFTIAI)** - ⭐ 235
...
931. **[mcp2py](https://github.com/MaximeRivest/mcp2py)** - ⭐ 235
   Turn any MCP server into a Python module

932. **[dat](https://github.com/hexinfo/dat)** - ⭐ 235
   Asking yours data in a natural language way through pre-modeling (data models and semantic models).

933. **[mcp-proxy-for-aws](https://github.com/aws/mcp-proxy-for-aws)** - ⭐ 235
   AWS MCP Proxy Server

934. **[vllm-mlx](https://github.com/waybarrios/vllm-mlx)** - ⭐ 235
...
935. **[mcp_chatbot](https://github.com/keli-wen/mcp_chatbot)** - ⭐ 234
   A chatbot implementation compatible with MCP (terminal / streamlit supported)

936. **[outlook-mcp](https://github.com/ryaker/outlook-mcp)** - ⭐ 233
   MCP server for Claude to access Outlook data via Microsoft Graph API

937. **[mac_messages_mcp](https://github.com/carterlasalle/mac_messages_mcp)** - ⭐ 233
   An MCP server that securely interfaces with your iMessage database via the Model Context Protocol (MCP), allowing LLMs to query and analyze iMessage conversations. It includes robust phone number validation, attachment processing, contact management, group chat handling, and full support for sending and receiving messages.

938. **[mcp-security-hub](https://github.com/FuzzingLabs/mcp-security-hub)** - ⭐ 233
   A growing collection of MCP servers bringing offensive security tools to AI assistants. Nmap, Ghidra, Nuclei, SQLMap, Hashcat and more.

939. **[mcp-proxy](https://github.com/punkpeye/mcp-proxy)** - ⭐ 232
   A TypeScript streamable HTTP and SSE proxy for MCP servers that use stdio transport.

940. **[Lambda-MCP-Server](https://github.com/mikegc-aws/Lambda-MCP-Server)** - ⭐ 232
   Creates a simple MCP tool server with "streaming" HTTP.

941. **[strava-mcp](https://github.com/r-huijts/strava-mcp)** - ⭐ 232
   A Model Context Protocol (MCP) server that connects to Strava API, providing tools to access Strava data through LLMs

942. **[MCP-connect](https://github.com/EvalsOne/MCP-connect)** - ⭐ 231
   Enables cloud-based AI services to access local Stdio based MCP servers via HTTP requests

943. **[mcp-foundry](https://github.com/microsoft-foundry/mcp-foundry)** - ⭐ 230
   A MCP Server for Azure AI Foundry: it's now moved to cloud, check the new Foundry MCP Server

944. **[CAD-MCP](https://github.com/daobataotie/CAD-MCP)** - ⭐ 230
   CAD MCP Server

945. **[xiyan_mcp_server](https://github.com/XGenerationLab/xiyan_mcp_server)** - ⭐ 229
   A Model Context Protocol (MCP) server that enables natural language queries to databases

946. **[openapi-to-mcpserver](https://github.com/higress-group/openapi-to-mcpserver)** - ⭐ 229
   A tool&lib that can automatically convert OpenAPI documents into Higress remote MCP server configurations.

947. **[mcp-telegram](https://github.com/dryeab/mcp-telegram)** - ⭐ 228
   MCP Server for Telegram

948. **[sample-serverless-mcp-servers](https://github.com/aws-samples/sample-serverless-mcp-servers)** - ⭐ 227
   Sample implementations of AI Agents and MCP Servers running on AWS Serverless compute

949. **[mcp-foundry](https://github.com/azure-ai-foundry/mcp-foundry)** - ⭐ 227
   A MCP Server for Azure AI Foundry: it's now moved to cloud, check the new Foundry MCP Server

950. **[cobolt](https://github.com/platinum-hill/cobolt)** - ⭐ 227
...
951. **[octocode](https://github.com/Muvon/octocode)** - ⭐ 227
   Semantic code searcher and codebase utility with AI memory onboard

952. **[awesome-mcp-servers](https://github.com/PipedreamHQ/awesome-mcp-servers)** - ⭐ 226
   A collection of MCP servers

953. **[MiroRL](https://github.com/MiroMindAI/MiroRL)** - ⭐ 226
   MiroRL is  an MCP-first reinforcement learning framework for deep research agent.

954. **[omnicoreagent](https://github.com/omnirexflora-labs/omnicoreagent)** - ⭐ 226
...
955. **[lyraios](https://github.com/GalaxyLLMCI/lyraios)** - ⭐ 224
...
956. **[remote-swe-agents](https://github.com/aws-samples/remote-swe-agents)** - ⭐ 224
   Autonomous SWE agent working in the cloud! (a.k.a. Vibe coding with Bedrock)

957. **[Alice](https://github.com/pmbstyle/Alice)** - ⭐ 224
...
958. **[ticktick-mcp](https://github.com/jacepark12/ticktick-mcp)** - ⭐ 224
   MCP server that interacts with TickTick (Dida 365) via the TickTick Open API

959. **[Mimir](https://github.com/orneryd/Mimir)** - ⭐ 224
...
960. **[gemini-cli-desktop](https://github.com/Piebald-AI/gemini-cli-desktop)** - ⭐ 224
   Web/desktop UI for Gemini CLI/Qwen Code.  Manage projects, switch between tools, search across past conversations, and manage MCP servers, all from one multilingual interface, locally or remotely.

961. **[mcp-server-commands](https://github.com/g0t4/mcp-server-commands)** - ⭐ 223
   Model Context Protocol server to run commands

962. **[spotify-mcp-server](https://github.com/marcelmarais/spotify-mcp-server)** - ⭐ 223
   Lightweight MCP server for Spotify

963. **[llamacloud-mcp](https://github.com/run-llama/llamacloud-mcp)** - ⭐ 222

964. **[langgraph-whatsapp-agent](https://github.com/lgesuellip/langgraph-whatsapp-agent)** - ⭐ 222
...
965. **[mcp-maigret](https://github.com/BurtTheCoder/mcp-maigret)** - ⭐ 222
   MCP server for maigret, a powerful OSINT tool that collects user account information from various public sources. 

966. **[mcp-gsc](https://github.com/AminForou/mcp-gsc)** - ⭐ 222
   Google Search Console Insights with Claude AI for SEOs

967. **[agent-mcp-lab](https://github.com/WaveSpeedAI/agent-mcp-lab)** - ⭐ 221

968. **[effect-mcp](https://github.com/tim-smart/effect-mcp)** - ⭐ 221

969. **[mcp-twikit](https://github.com/adhikasp/mcp-twikit)** - ⭐ 220
   A Model Context Protocol (MCP) server for interacting with Twitter.

970. **[mcp-compass](https://github.com/liuyoshio/mcp-compass)** - ⭐ 220
   MCP Discovery & Recommendation Service - Find the right MCP server for your needs

971. **[smart-tree](https://github.com/8b-is/smart-tree)** - ⭐ 220
...
972. **[home-assistant-cursor-agent](https://github.com/Coolver/home-assistant-cursor-agent)** - ⭐ 219
...
973. **[facebook-ads-mcp-server](https://github.com/gomarble-ai/facebook-ads-mcp-server)** - ⭐ 219

974. **[mcp-server-trello](https://github.com/delorenj/mcp-server-trello)** - ⭐ 219
   A Model Context Protocol (MCP) server that provides tools for interacting with Trello boards.

975. **[penpot-mcp](https://github.com/montevive/penpot-mcp)** - ⭐ 218
   Penpot MCP server

976. **[obsidian-mcp-plugin](https://github.com/aaronsb/obsidian-mcp-plugin)** - ⭐ 218
   High-performance Model Context Protocol (MCP) server for Obsidian that provides AI tools with direct vault access through semantic operations and HTTP transport.

977. **[antd-components-mcp](https://github.com/zhixiaoqiang/antd-components-mcp)** - ⭐ 218
   An MCP service for Ant Design components query | 一个减少 Ant Design 组件代码生成幻觉的 MCP 服务，包含系统提示词、组件文档、API 文档、代码示例和更新日志查询

978. **[mcp](https://github.com/Snowflake-Labs/mcp)** - ⭐ 218
   MCP Server for Snowflake including Cortex AI, object management, SQL orchestration, semantic view consumption, and more

979. **[image-gen-server](https://github.com/fengin/image-gen-server)** - ⭐ 217
   一个能与Cursor集成的图片生成mcp server工具，实现调用即梦逆向接口

980. **[vulnerable-mcp-servers-lab](https://github.com/appsecco/vulnerable-mcp-servers-lab)** - ⭐ 217
   A collection of servers which are deliberately vulnerable to learn Pentesting MCP Servers.

981. **[tentix](https://github.com/labring/tentix)** - ⭐ 216
...
982. **[playwright-mcp](https://github.com/cloudflare/playwright-mcp)** - ⭐ 216
   Playwright MCP fork that works with Cloudflare Browser Rendering

983. **[mermaid-mcp-server](https://github.com/peng-shawn/mermaid-mcp-server)** - ⭐ 216
   A Model Context Protocol (MCP) server that converts Mermaid diagrams to PNG images

984. **[c2sagent](https://github.com/C2SAgent/c2sagent)** - ⭐ 216
...
985. **[Google-Scholar-MCP-Server](https://github.com/JackKuo666/Google-Scholar-MCP-Server)** - ⭐ 216
...
986. **[human-in-the-loop](https://github.com/KOBA789/human-in-the-loop)** - ⭐ 215
   An MCP (Model Context Protocol) server that allows AI assistants to ask questions to humans via Discord.

987. **[mcp-openapi-server](https://github.com/ivo-toby/mcp-openapi-server)** - ⭐ 215
   MCP Server (Model Context Protocol) for turning OpenAPI specifications into a MCP Resource

988. **[learn-agentic-ai-from-low-code-to-code](https://github.com/panaversity/learn-agentic-ai-from-low-code-to-code)** - ⭐ 214
   Build production-grade agents with OpenAI AgentKit, a no-code platfrom.

989. **[vibevideo-mcp](https://github.com/hyepartners-gmail/vibevideo-mcp)** - ⭐ 214
   Agent MCP for ffmpeg

990. **[mcp-server-milvus](https://github.com/zilliztech/mcp-server-milvus)** - ⭐ 214
   Model Context Protocol Servers for Milvus

991. **[lokka](https://github.com/merill/lokka)** - ⭐ 214
   MCP (Model Context Protocol) for Microsoft 365. Includes support for Microsoft Graph and other services

992. **[domainstack.io](https://github.com/jakejarvis/domainstack.io)** - ⭐ 214
   🧰 All-in-one domain name intelligence as a service

993. **[Google-Search-MCP-Server](https://github.com/mixelpixx/Google-Search-MCP-Server)** - ⭐ 214
...
994. **[claude-historian-mcp](https://github.com/Vvkmnn/claude-historian-mcp)** - ⭐ 214
   🤖 An MCP server for surfacing useful Claude Code conversation history

995. **[mcp_code_executor](https://github.com/bazinga012/mcp_code_executor)** - ⭐ 213
   The MCP Code Executor is an MCP server that allows LLMs to execute Python code within a specified Conda environment.

996. **[mindmap-mcp-server](https://github.com/YuChenSSR/mindmap-mcp-server)** - ⭐ 213
   mindmap, mcp server, artifact

997. **[razorpay-mcp-server](https://github.com/razorpay/razorpay-mcp-server)** - ⭐ 213
   Razorpay's Official MCP Server

998. **[anki-mcp-server](https://github.com/nailuoGG/anki-mcp-server)** - ⭐ 213
   MCP server for Anki via AnkiConnect

999. **[composer-trade-mcp](https://github.com/invest-composer/composer-trade-mcp)** - ⭐ 213
   Composer's MCP server lets MCP-enabled LLMs like Claude backtest trading ideas and automatically invest in them for you

1000. **[TradingAgents-MCPmode](https://github.com/guangxiangdebizi/TradingAgents-MCPmode)** - ⭐ 213
   TradingAgents-MCPmode 是一个创新的多智能体交易分析系统，集成了 Model Context Protocol (MCP) 工具，实现了智能化的股票分析和交易决策流程。系统通过多个专业化智能体的协作，提供全面的市场分析、投资建议和风险管理。

1001. **[plate-playground-template](https://github.com/udecode/plate-playground-template)** - ⭐ 213
   Plate AI template with React 19, Next 16, Tailwind 4, MCP.

1002. **[lihil](https://github.com/raceychan/lihil)** - ⭐ 212
   2X faster ASGI web framework for python, offering high-level development, low-level performance.

1003. **[cpp-mcp](https://github.com/hkr04/cpp-mcp)** - ⭐ 212
   Lightweight C++ MCP (Model Context Protocol) SDK

1004. **[stitch](https://github.com/gemini-cli-extensions/stitch)** - ⭐ 212
   The Stitch extension for Gemini CLI enables you to interact with the Stitch MCP server using natural language commands. 

1005. **[uber-eats-mcp-server](https://github.com/ericzakariasson/uber-eats-mcp-server)** - ⭐ 211

1006. **[gibber-mcp](https://github.com/antonpk1/gibber-mcp)** - ⭐ 211
   Tiny MCP server with cryptography tools, sufficient to establish end-to-end encryption between LLM agents

1007. **[ruby_llm-mcp](https://github.com/patvice/ruby_llm-mcp)** - ⭐ 211
   Full-featured MCP support for Ruby and RubyLLM—making it easy to build structured, composable LLM workflows in pure Ruby.

1008. **[Autono](https://github.com/vortezwohl/Autono)** - ⭐ 210
   A ReAct-Based Highly Robust Autonomous Agent Framework.

1009. **[mcp-taskmanager](https://github.com/kazuph/mcp-taskmanager)** - ⭐ 210

1010. **[yt-dlp-mcp](https://github.com/kevinwatt/yt-dlp-mcp)** - ⭐ 210
   A Model Context Protocol (MCP) server that bridges Video & Audio content with Large Language Models using yt-dlp.

1011. **[multimodal-mcp-client](https://github.com/Ejb503/multimodal-mcp-client)** - ⭐ 209
   A Multi-modal MCP client for voice powered agentic workflows

1012. **[figma-mcp](https://github.com/MatthewDailey/figma-mcp)** - ⭐ 209
   ModelContextProtocol for Figma's REST API

1013. **[kite-mcp-server](https://github.com/zerodha/kite-mcp-server)** - ⭐ 209
   Zerodha Kite MCP server

1014. **[tmux-mcp](https://github.com/nickgnd/tmux-mcp)** - ⭐ 209
   A MCP server for our beloved terminal multiplexer tmux.

1015. **[jebmcp](https://github.com/dawnslab/jebmcp)** - ⭐ 209

1016. **[automagik-genie](https://github.com/namastexlabs/automagik-genie)** - ⭐ 207
   🧞 Automagik Genie – bootstrap, update, and roll back AI agent workspaces with a single CLI + MCP toolkit.

1017. **[mastergo-magic-mcp](https://github.com/mastergo-design/mastergo-magic-mcp)** - ⭐ 207
...
1018. **[mcp-context-protector](https://github.com/trailofbits/mcp-context-protector)** - ⭐ 206
   MCP security wrapper

1019. **[mcp-rb](https://github.com/funwarioisii/mcp-rb)** - ⭐ 206
   A lightweight Ruby framework for building MCP servers with a Sinatra-like DSL

1020. **[Remote-MCP](https://github.com/ssut/Remote-MCP)** - ⭐ 206
   A type-safe solution to remote MCP communication, enabling effortless integration for centralized management of Model Context.

1021. **[OSWorld-MCP](https://github.com/X-PLUG/OSWorld-MCP)** - ⭐ 205

1022. **[notion_mcp](https://github.com/danhilse/notion_mcp)** - ⭐ 205
   A simple MCP integration that allows Claude to read and manage a personal Notion todo list

1023. **[melrose](https://github.com/emicklei/melrose)** - ⭐ 205
   interactive programming of melodies, producing MIDI 

1024. **[mcp-trends-hub](https://github.com/baranwang/mcp-trends-hub)** - ⭐ 205
   基于 Model Context Protocol (MCP) 协议的全网热点趋势一站式聚合服务

1025. **[mcp-n8n-workflow-builder](https://github.com/salacoste/mcp-n8n-workflow-builder)** - ⭐ 205
   AI-powered n8n workflow automation through natural language. MCP server enabling Claude AI & Cursor IDE to create, manage, and monitor workflows via Model Context Protocol. Multi-instance support, 17 tools, comprehensive docs. Build workflows conversationally without manual JSON editing.

1026. **[AutomatedEmulation](https://github.com/iknowjason/AutomatedEmulation)** - ⭐ 204
...
1027. **[sqrl](https://github.com/DataSQRL/sqrl)** - ⭐ 204
   Data Pipeline Automation Framework to build MCP servers, data APIs, and data lakes with SQL.

1028. **[jetski](https://github.com/hyprmcp/jetski)** - ⭐ 204
...
1029. **[ha-mcp-for-xiaozhi](https://github.com/c1pher-cn/ha-mcp-for-xiaozhi)** - ⭐ 204
   Homeassistant MCP server for 小智AI

1030. **[langchain-mcp](https://github.com/rectalogic/langchain-mcp)** - ⭐ 204
   Model Context Protocol tool support for LangChain

1031. **[sora-mcp](https://github.com/Doriandarko/sora-mcp)** - ⭐ 203
   An MCP server to use Sora video generation APIs

1032. **[mcp-server-deep-research](https://github.com/reading-plus-ai/mcp-server-deep-research)** - ⭐ 203

1033. **[ht-mcp](https://github.com/memextech/ht-mcp)** - ⭐ 203
   Pure Rust implementation of MCP server for headless terminal 

1034. **[y-cli](https://github.com/luohy15/y-cli)** - ⭐ 202
   A Tiny Terminal Chat App for AI Models with MCP Client Support

1035. **[unsplash-mcp-server](https://github.com/hellokaton/unsplash-mcp-server)** - ⭐ 201
   🔎 A MCP server for Unsplash image search.

1036. **[binary_ninja_mcp](https://github.com/fosdickio/binary_ninja_mcp)** - ⭐ 201
   A Binary Ninja plugin containing an MCP server that enables seamless integration with your favorite LLM/MCP client.

1037. **[gram](https://github.com/speakeasy-api/gram)** - ⭐ 201
   Power your product agents with MCP! 

1038. **[mcp](https://github.com/hopx-ai/mcp)** - ⭐ 200

1039. **[mathom](https://github.com/stephenlacy/mathom)** - ⭐ 199
   Run and monitor MCP servers locally

1040. **[BifrostMCP](https://github.com/biegehydra/BifrostMCP)** - ⭐ 199
   VSCode Extension with an MCP server that exposes semantic tools like Find Usages and Rename to LLMs

1041. **[ai-infrastructure-agent](https://github.com/VersusControl/ai-infrastructure-agent)** - ⭐ 199
...
1042. **[phone-mcp](https://github.com/hao-cyber/phone-mcp)** - ⭐ 199
   A phone control plugin for MCP that allows you to control your Android phone through ADB commands to connect any human

1043. **[mcp-echarts](https://github.com/hustcc/mcp-echarts)** - ⭐ 199
   🧬 Generate visual charts using ECharts with AI MCP dynamically, used for chart generation and data analysis.

1044. **[pctx](https://github.com/portofcontext/pctx)** - ⭐ 198
...
1045. **[mcp-server-rag-web-browser](https://github.com/apify/mcp-server-rag-web-browser)** - ⭐ 197
   A MCP Server for the RAG Web Browser Actor

1046. **[rmcp](https://github.com/finite-sample/rmcp)** - ⭐ 197
   R MCP Server

1047. **[mongodb-lens](https://github.com/furey/mongodb-lens)** - ⭐ 197
   🍃🔎 MongoDB Lens: Full Featured MCP Server for MongoDB Databases

1048. **[metorial-platform](https://github.com/metorial/metorial-platform)** - ⭐ 197
   The engine powering hundreds of thousands of MCP connections 🤖 🔥

1049. **[ProxmoxMCP](https://github.com/canvrno/ProxmoxMCP)** - ⭐ 196
   MCP for Proxmox integration in Cline

1050. **[cognition-wheel](https://github.com/Hormold/cognition-wheel)** - ⭐ 196
   A Model Context Protocol (MCP) server that implements a "wisdom of crowds" approach to AI reasoning by consulting multiple state-of-the-art language models in parallel and synthesizing their responses.

1051. **[opik-mcp](https://github.com/comet-ml/opik-mcp)** - ⭐ 196
   Model Context Protocol (MCP) implementation for Opik enabling seamless IDE integration and unified access to prompts, projects, traces, and metrics. 

1052. **[yahoo-finance-mcp](https://github.com/Alex2Yang97/yahoo-finance-mcp)** - ⭐ 196
   This is a Model Context Protocol (MCP) server that provides comprehensive financial data from Yahoo Finance. It allows you to retrieve detailed information about stocks, including historical prices, company information, financial statements, options data, and market news.

1053. **[sec-edgar-mcp](https://github.com/stefanoamorelli/sec-edgar-mcp)** - ⭐ 196
   A SEC EDGAR MCP (Model Context Protocol) Server

1054. **[claude-self-reflect](https://github.com/ramakay/claude-self-reflect)** - ⭐ 196
   Claude forgets everything. This fixes that. 🔗 www.npmjs.com/package/claude-self-reflect

1055. **[mcp-server-guide](https://github.com/figma/mcp-server-guide)** - ⭐ 196
   A guide on how to use the Figma MCP server

1056. **[mcp-portal-transparencia](https://github.com/dutradotdev/mcp-portal-transparencia)** - ⭐ 195
   MCP para orquestração automatizada de chamadas à API do Portal da Transparência do Governo Federal brasileiro

1057. **[nano-agent](https://github.com/disler/nano-agent)** - ⭐ 195
   A MCP Server for a small scale engineering agents with multi-provider LLM support.

1058. **[dynatrace-mcp](https://github.com/dynatrace-oss/dynatrace-mcp)** - ⭐ 195
   MCP server for Dynatrace Observability

1059. **[wavefront](https://github.com/rootflo/wavefront)** - ⭐ 194
   🔥🔥🔥 Enterprise AI middleware, alternative to unifyapps, n8n, lyzr

1060. **[mcp-proxy-server](https://github.com/adamwattis/mcp-proxy-server)** - ⭐ 193
   An MCP proxy server that aggregates and serves multiple MCP resource servers through a single interface

1061. **[waldzell-mcp](https://github.com/waldzellai/waldzell-mcp)** - ⭐ 193
   Waldzell AI's monorepo of MCP servers. Use in Claude Desktop, Cline, Roo Code, and more!

1062. **[nosia](https://github.com/dilolabs/nosia)** - ⭐ 193
   Self-hosted AI RAG + MCP Platform

1063. **[gcp-mcp](https://github.com/eniayomi/gcp-mcp)** - ⭐ 192
   A Model Context Protocol (MCP) server that enables AI assistants like Claude to interact with your Google Cloud Platform environment. This allows for natural language querying and management of your GCP resources during conversations.

1064. **[mcp-guardian](https://github.com/eqtylab/mcp-guardian)** - ⭐ 192
   Manage / Proxy / Secure your MCP Servers

1065. **[mcp_forge](https://github.com/mlzoo/mcp_forge)** - ⭐ 192
   这是一个专为开发企业级MCP server而设计的通用开发框架

1066. **[mcp-launchpad](https://github.com/kenneth-liao/mcp-launchpad)** - ⭐ 192
...
1067. **[easy-mcp](https://github.com/zcaceres/easy-mcp)** - ⭐ 191
   Absurdly easy Model Context Protocol Servers in Typescript

1068. **[figma-flutter-mcp](https://github.com/mhmzdev/figma-flutter-mcp)** - ⭐ 191
   An MCP server that provides the coding agents Figma's design token to write Flutter code.

1069. **[seo-mcp](https://github.com/cnych/seo-mcp)** - ⭐ 190
...
1070. **[MCP-server-client-computer-use-ai-sdk](https://github.com/mediar-ai/MCP-server-client-computer-use-ai-sdk)** - ⭐ 190

1071. **[pbi-desktop-mcp-public](https://github.com/maxanatsko/pbi-desktop-mcp-public)** - ⭐ 190
...
1072. **[frida-mcp](https://github.com/dnakov/frida-mcp)** - ⭐ 190
   MCP stdio server for frida

1073. **[persistent-ai-memory](https://github.com/savantskie/persistent-ai-memory)** - ⭐ 190
   A persistent local memory for AI, LLMs, or Copilot in VS Code.

1074. **[MakeMoneyWithAI](https://github.com/garylab/MakeMoneyWithAI)** - ⭐ 190
   A list of open-source AI projects you can use to generate income easily.

1075. **[armor-crypto-mcp](https://github.com/armorwallet/armor-crypto-mcp)** - ⭐ 189
   The MCP server for interacting with Blockchain, Swaps, Strategic Planning and more.

1076. **[utcp-mcp](https://github.com/universal-tool-calling-protocol/utcp-mcp)** - ⭐ 189
   All-in-one MCP server that can connect your AI agents to any native endpoint, powered by UTCP

1077. **[servicenow-mcp](https://github.com/echelon-ai-labs/servicenow-mcp)** - ⭐ 189
   MCP Server for ServiceNow

1078. **[mcp-servers-nix](https://github.com/natsukium/mcp-servers-nix)** - ⭐ 189
   A Nix-based configuration framework for Model Control Protocol (MCP) servers with ready-to-use packages.

1079. **[RelaMind](https://github.com/El-12stu/RelaMind)** - ⭐ 188
   基于 AI 的个人成长轨迹分析系统，通过记录生活、回顾历史、分析模式帮助用户更好地理解自己，实现持续成长。包含智能路由、RAG 检索、自主任务智能体等功能。

1080. **[hf-mcp-server](https://github.com/huggingface/hf-mcp-server)** - ⭐ 188
   Hugging Face MCP Server

1081. **[touchdesigner-mcp](https://github.com/8beeeaaat/touchdesigner-mcp)** - ⭐ 187
   MCP server for TouchDesigner

1082. **[AutoDocs](https://github.com/TrySita/AutoDocs)** - ⭐ 187
...
1083. **[code-sandbox-mcp](https://github.com/philschmid/code-sandbox-mcp)** - ⭐ 187

1084. **[mcp-usecase](https://github.com/teddynote-lab/mcp-usecase)** - ⭐ 187

1085. **[mcp-injection-experiments](https://github.com/invariantlabs-ai/mcp-injection-experiments)** - ⭐ 187
   Code snippets to reproduce MCP tool poisoning attacks.

1086. **[supabase-mcp](https://github.com/coleam00/supabase-mcp)** - ⭐ 187
   Supabase MCP server created in Python.

1087. **[mcp-linkedin](https://github.com/adhikasp/mcp-linkedin)** - ⭐ 187
   A Model Context Protocol (MCP) server that provides tools to interact with LinkedIn's Feeds and Job API.

1088. **[Omni-Adapter](https://github.com/HuChundong/Omni-Adapter)** - ⭐ 186
   多平台 文生图/图生图 等能力接入MCP

1089. **[auto-mcp](https://github.com/brizzai/auto-mcp)** - ⭐ 186
   Transform any OpenAPI/Swagger definition into a fully-featured Model Context Protocol (MCP) server

1090. **[mcp-agent-graph](https://github.com/keta1930/mcp-agent-graph)** - ⭐ 186
   MCP Agent Graph is a Multi-Agent System built on the principles of Context Engineering

1091. **[claudex](https://github.com/Mng-dev-ai/claudex)** - ⭐ 186
...
1092. **[a2a_mcp-example](https://github.com/ishanExtreme/a2a_mcp-example)** - ⭐ 184
   An example showing how A2A and MCP can be used together

1093. **[EdgeBox](https://github.com/BIGPPWONG/EdgeBox)** - ⭐ 184
...
1094. **[litemcp](https://github.com/wong2/litemcp)** - ⭐ 184
   A TypeScript framework for building MCP servers elegantly

1095. **[gistpad-mcp](https://github.com/lostintangent/gistpad-mcp)** - ⭐ 184
   📓 An MCP server for managing your personal knowledge, daily notes, and re-usable prompts via GitHub Gists

1096. **[MCP-Checklists](https://github.com/MCP-Manager/MCP-Checklists)** - ⭐ 184

1097. **[Security-Detections-MCP](https://github.com/MHaggis/Security-Detections-MCP)** - ⭐ 184
   MCP to help Defenders Detection Engineer Harder and Smarter

1098. **[wikipedia-mcp](https://github.com/Rudra-ravi/wikipedia-mcp)** - ⭐ 183
   A Model Context Protocol (MCP) server that retrieves information from Wikipedia to provide context to LLMs.

1099. **[after-effects-mcp](https://github.com/Dakkshin/after-effects-mcp)** - ⭐ 183
   MCP Server for Adobe After Effects. Enables remote control (compositions, text, shapes, solids, properties) via the Model Context Protocol using ExtendScript.

1100. **[thinkchain](https://github.com/martinbowling/thinkchain)** - ⭐ 182
...
1101. **[mcp-openai-gemini-llama-example](https://github.com/philschmid/mcp-openai-gemini-llama-example)** - ⭐ 182

1102. **[siconos](https://github.com/siconos/siconos)** - ⭐ 182
   Simulation framework for nonsmooth dynamical systems

1103. **[mcp-proxy-server](https://github.com/ptbsare/mcp-proxy-server)** - ⭐ 182
   This server acts as a central hub for Model Context Protocol (MCP) resource servers.

1104. **[sudocode](https://github.com/sudocode-ai/sudocode)** - ⭐ 182
   Lightweight agent orchestration dev tool that lives in your repo

1105. **[figma-console-mcp](https://github.com/southleft/figma-console-mcp)** - ⭐ 182
   Your design system as an API. Connect AI to Figma for extraction, creation, and debugging.

1106. **[dify-plugin-tools-mcp_sse](https://github.com/junjiem/dify-plugin-tools-mcp_sse)** - ⭐ 181
   Dify 1.0 Plugin MCP HTTP with SSE or Streamable HTTP transport Tools

1107. **[protoc-gen-go-mcp](https://github.com/redpanda-data/protoc-gen-go-mcp)** - ⭐ 181
   Go protobuf compiler extension to turn any gRPC service into an MCP server

1108. **[Geargrafx](https://github.com/drhelius/Geargrafx)** - ⭐ 181
...
1109. **[quarkus-mcp-servers](https://github.com/quarkiverse/quarkus-mcp-servers)** - ⭐ 181
   Model Context Protocol Servers in Quarkus

1110. **[ai-counsel](https://github.com/blueman82/ai-counsel)** - ⭐ 181
   True deliberative consensus MCP server where AI models debate and refine positions across multiple rounds

1111. **[k8s-mcp-server](https://github.com/alexei-led/k8s-mcp-server)** - ⭐ 181
   K8s-mcp-server is a Model Context Protocol (MCP) server that enables AI assistants like Claude to securely execute Kubernetes commands. It provides a bridge between language models and essential Kubernetes CLI tools including kubectl, helm, istioctl, and argocd, allowing AI systems to assist with cluster management, troubleshooting, and deployments

1112. **[mcp-server-siri-shortcuts](https://github.com/dvcrn/mcp-server-siri-shortcuts)** - ⭐ 179
   MCP for calling Siri Shorcuts from LLMs

1113. **[mcp-text-editor](https://github.com/tumf/mcp-text-editor)** - ⭐ 178

1114. **[claude-code-mcp](https://github.com/auchenberg/claude-code-mcp)** - ⭐ 178
   claude-code-mcp

1115. **[mcp-logseq](https://github.com/ergut/mcp-logseq)** - ⭐ 178
   MCP server to interact with LogSeq via its Local HTTP API - enabling AI assistants like Claude to seamlessly read, write, and manage your LogSeq graph.

1116. **[claude-context-local](https://github.com/FarhanAliRaza/claude-context-local)** - ⭐ 178
...
1117. **[life-sciences](https://github.com/anthropics/life-sciences)** - ⭐ 178
...
1118. **[mcp-servers](https://github.com/cursor/mcp-servers)** - ⭐ 178
   A list of MCP (Model Context Protocol) servers for developer tools and services

1119. **[tripo-mcp](https://github.com/VAST-AI-Research/tripo-mcp)** - ⭐ 177
   Official MCP server for Tripo

1120. **[ida-mcp-server-plugin](https://github.com/taida957789/ida-mcp-server-plugin)** - ⭐ 177
   IDA Pro Plugin for serving MCP SSE server for cursor / claude

1121. **[git-mcp-server](https://github.com/cyanheads/git-mcp-server)** - ⭐ 176
   An MCP (Model Context Protocol) server enabling LLMs and AI agents to interact with Git repositories. Provides tools for comprehensive Git operations including clone, commit, branch, diff, log, status, push, pull, merge, rebase, worktree, tag management, and more, via the MCP standard. STDIO & HTTP.

1122. **[bilibili-mcp-server](https://github.com/huccihuang/bilibili-mcp-server)** - ⭐ 176
   MCP Server for the Bilibili API, supporting various operations.

1123. **[anki-mcp-server](https://github.com/scorzeth/anki-mcp-server)** - ⭐ 175
   An MCP server for Anki

1124. **[quarkus-mcp-server](https://github.com/quarkiverse/quarkus-mcp-server)** - ⭐ 175
   This extension enables developers to implement the MCP server features easily.

1125. **[smart-coding-mcp](https://github.com/omar-haris/smart-coding-mcp)** - ⭐ 175
...
1126. **[spring-ai-playground](https://github.com/JM-Lab/spring-ai-playground)** - ⭐ 175
...
1127. **[comfyui-mcp-server](https://github.com/joenorton/comfyui-mcp-server)** - ⭐ 175
   lightweight Python-based MCP (Model Context Protocol) server for local ComfyUI

1128. **[mongo-mcp](https://github.com/QuantGeekDev/mongo-mcp)** - ⭐ 174
   A mongo db server for the model context protocol (MCP)

1129. **[mcp-snowflake-server](https://github.com/isaacwasserman/mcp-snowflake-server)** - ⭐ 174

1130. **[aws-finops-mcp-server](https://github.com/ravikiranvm/aws-finops-mcp-server)** - ⭐ 174
   An MCP (Model Context Protocol) server that brings powerful AWS FinOps capabilities directly into your AI assistant. Analyze cloud costs, audit for waste, and get budget insights using natural language, all while keeping your credentials secure on your local machine.

1131. **[Revornix](https://github.com/Qingyon-AI/Revornix)** - ⭐ 173
...
1132. **[aws-mcp-server](https://github.com/alexei-led/aws-mcp-server)** - ⭐ 173
   A lightweight service that enables AI assistants to execute AWS CLI commands (in safe containerized environment) through the Model Context Protocol (MCP). Bridges Claude, Cursor, and other MCP-aware AI tools with AWS CLI for enhanced cloud infrastructure management.

1133. **[xero-mcp-server](https://github.com/XeroAPI/xero-mcp-server)** - ⭐ 173
   An MCP server that integrates with the MCP protocol. https://modelcontextprotocol.io/introduction

1134. **[facebook-ads-library-mcp](https://github.com/talknerdytome-labs/facebook-ads-library-mcp)** - ⭐ 173
   MCP Server for Facebook ADs Library - Get instant answers from FB's ad library

1135. **[mcp-chat](https://github.com/PipedreamHQ/mcp-chat)** - ⭐ 172
   Examples of using Pipedream's MCP server in your app or AI agent.

1136. **[concierge](https://github.com/concierge-hq/concierge)** - ⭐ 172
   The fabric layer for building next gen MCP applications

1137. **[burp-mcp-agents](https://github.com/six2dez/burp-mcp-agents)** - ⭐ 172
   Practical setup guides and helpers to connect Burp Suite MCP Server to multiple AI backends (Codex, Gemini, Ollama, ...).

1138. **[tomcp](https://github.com/Ami3466/tomcp)** - ⭐ 171
   Turn any website or doc into an MCP server

1139. **[mcp-server-duckdb](https://github.com/ktanaka101/mcp-server-duckdb)** - ⭐ 171
   A Model Context Protocol (MCP) server implementation for DuckDB, providing database interaction capabilities

1140. **[skunit](https://github.com/mehrandvd/skunit)** - ⭐ 171
   skUnit is a testing tool for AI units, such as IChatClient, MCP Servers and agents.

1141. **[tableau-mcp](https://github.com/tableau/tableau-mcp)** - ⭐ 171
...
1142. **[codex-mcp-server](https://github.com/tuannvm/codex-mcp-server)** - ⭐ 171
   MCP server wrapper for OpenAI Codex CLI that enables Claude Code to leverage Codex's AI capabilities directly.

1143. **[Text2Sql.Net](https://github.com/AIDotNet/Text2Sql.Net)** - ⭐ 170
   Text2Sql.Net 是一个使用DotNet和Semantic Kernel开发的Text2Sql工具

1144. **[discordmcp](https://github.com/v-3/discordmcp)** - ⭐ 170
   Discord MCP Server for Claude Integration

1145. **[mcp-google-map](https://github.com/cablate/mcp-google-map)** - ⭐ 170
   A powerful Model Context Protocol (MCP) server providing comprehensive Google Maps API integration with LLM processing capabilities.

1146. **[mcp-scholarly](https://github.com/adityak74/mcp-scholarly)** - ⭐ 170
   A MCP server to search for accurate academic articles.

1147. **[google-analytics-mcp](https://github.com/surendranb/google-analytics-mcp)** - ⭐ 170
...
1148. **[Text2Sql.Net](https://github.com/shuyu-labs/Text2Sql.Net)** - ⭐ 170
   Text2Sql.Net 是一个使用DotNet和Semantic Kernel开发的Text2Sql工具

1149. **[penpot-mcp](https://github.com/penpot/penpot-mcp)** - ⭐ 170
   Penpot's official MCP Server

1150. **[4D-ARE](https://github.com/ybeven/4D-ARE)** - ⭐ 170
...
1151. **[command](https://github.com/scopecraft/command)** - ⭐ 169
   Scopecraft Command - A CLI and MCP server for Markdown-Driven Task Management (MDTM)

1152. **[openapi-mcp](https://github.com/ckanthony/openapi-mcp)** - ⭐ 169
   Dockerized MCP Server to allow your AI agent to access any API with existing api docs

1153. **[discord-mcp](https://github.com/SaseQ/discord-mcp)** - ⭐ 169
   A MCP server for the Discord integration. Enable your AI assistants to seamlessly interact with Discord. Enhance your Discord experience with powerful automation capabilities.

1154. **[mcp](https://github.com/magicuidesign/mcp)** - ⭐ 169
   Official Magic UI MCP server.

1155. **[claudepro-directory](https://github.com/JSONbored/claudepro-directory)** - ⭐ 169
...
1156. **[garmin_mcp](https://github.com/Taxuspt/garmin_mcp)** - ⭐ 169
   MCP server to access Garmin data

1157. **[appium-mcp](https://github.com/appium/appium-mcp)** - ⭐ 168
   Appium MCP on Steroids!

1158. **[y-gui](https://github.com/luohy15/y-gui)** - ⭐ 168
   A Tiny Web Chat App for AI Models with MCP Client Support

1159. **[mcp-server-wazuh](https://github.com/gbrigandi/mcp-server-wazuh)** - ⭐ 168
   MCP Server for Wazuh SIEM

1160. **[Chanakya-Local-Friend](https://github.com/Rishabh-Bajpai/Chanakya-Local-Friend)** - ⭐ 167
...
1161. **[markmap-mcp-server](https://github.com/jinzcdev/markmap-mcp-server)** - ⭐ 167
   An MCP server for converting Markdown to interactive mind maps with export support (PNG/JPG/SVG).

1162. **[sketchup-mcp](https://github.com/mhyrr/sketchup-mcp)** - ⭐ 167
   Sketchup Model Context Protocol

1163. **[mcp-use-ts](https://github.com/mcp-use/mcp-use-ts)** - ⭐ 166
   mcp-use is the framework for MCP with the best DX - Build AI agents, create MCP   servers with UI widgets, and debug with built-in inspector. Includes client SDK, server SDK, React hooks, and powerful dev tools.

1164. **[toolbase](https://github.com/Toolbase-AI/toolbase)** - ⭐ 166
   A desktop application that adds powerful tools to Claude and AI platforms

1165. **[keyboard-local](https://github.com/keyboard-dev/keyboard-local)** - ⭐ 166
   One MCP Server, All Your Apps, Privacy First

1166. **[agentregistry](https://github.com/agentregistry-dev/agentregistry)** - ⭐ 166
   Fast-track AI innovation with a centralized, trusted, curated registry

1167. **[mcp-agent-langchainjs](https://github.com/Azure-Samples/mcp-agent-langchainjs)** - ⭐ 166
...
1168. **[install-mcp](https://github.com/supermemoryai/install-mcp)** - ⭐ 166
   A simple CLI to install MCP servers into any client - auth included!

1169. **[meilisearch-mcp](https://github.com/meilisearch/meilisearch-mcp)** - ⭐ 164
   A Model Context Protocol (MCP) server for interacting with Meilisearch through LLM interfaces.

1170. **[mcp-shell-server](https://github.com/tumf/mcp-shell-server)** - ⭐ 164

1171. **[mcp-access-point](https://github.com/sxhxliang/mcp-access-point)** - ⭐ 164
   Turn a web server into an MCP server in one click without making any code changes.

1172. **[dify-mcp-client](https://github.com/3dify-project/dify-mcp-client)** - ⭐ 163
   MCP Client as an Agent Strategy Plugin. Support GUI operation via UI-TARS-SDK.

1173. **[mcp-telegram](https://github.com/sparfenyuk/mcp-telegram)** - ⭐ 163
   MCP server to work with Telegram through MTProto

1174. **[mcp](https://github.com/neo4j/mcp)** - ⭐ 163
   Neo4j official MCP Server

1175. **[lsp-mcp](https://github.com/jonrad/lsp-mcp)** - ⭐ 162
   An Model Context Protocol (MCP) server that provides LLMs/AI Agents with the capabilities of a language server protocol (LSP) server. This gives the AI the ability to get language aware context from the codebase.

1176. **[c4-genai-suite](https://github.com/codecentric/c4-genai-suite)** - ⭐ 162
   c4 GenAI Suite

1177. **[cli-mcp-server](https://github.com/MladenSU/cli-mcp-server)** - ⭐ 162
   Command line interface for MCP clients with secure execution and customizable security policies

1178. **[mcp-server-weaviate](https://github.com/weaviate/mcp-server-weaviate)** - ⭐ 161
   MCP (Model Context Protocol) server for Weaviate

1179. **[gbox](https://github.com/babelcloud/gbox)** - ⭐ 161
   Cli and MCP for gbox. Enable AI agents to operate Android/Browser/Desktop like human.

1180. **[postman-mcp-server](https://github.com/postmanlabs/postman-mcp-server)** - ⭐ 161
   Connect your AI to your APIs on Postman

1181. **[DrissionPageMCP](https://github.com/wxhzhwxhzh/DrissionPageMCP)** - ⭐ 161
   基于DrissionPage和FastMCP的浏览器自动化MCP服务器，提供丰富的浏览器操作API供AI调用

1182. **[jmap-mcp](https://github.com/wyattjoh/jmap-mcp)** - ⭐ 160
   A Model Context Protocol (MCP) server that provides tools for interacting with JMAP (JSON Meta Application Protocol) email servers. Built with Deno and using the jmap-jam client library.

1183. **[integrate-mcp-with-copilot](https://github.com/skills/integrate-mcp-with-copilot)** - ⭐ 160
   Learn how to use MCP Servers with GitHub Copilot

1184. **[claude-config-editor](https://github.com/gagarinyury/claude-config-editor)** - ⭐ 160
...
1185. **[dbt-llm-agent](https://github.com/pragunbhutani/dbt-llm-agent)** - ⭐ 159
   LLM based AI Agent to automate Data Analysis for dbt projects with remote MCP server

1186. **[Quickchart-MCP-Server](https://github.com/GongRzhe/Quickchart-MCP-Server)** - ⭐ 159
...
1187. **[Companion](https://github.com/mattt/Companion)** - ⭐ 159
   Your neighborhood friendly MCP utility for macOS, iOS, and visionOS

1188. **[docs](https://github.com/strands-agents/docs)** - ⭐ 159
   Documentation for the Strands Agents SDK. A model-driven approach to building AI agents in just a few lines of code. 

1189. **[UnityNaturalMCP](https://github.com/notargs/UnityNaturalMCP)** - ⭐ 159
   UnityNaturalMCP is an MCP server implementation for Unity that aims for a "natural" user experience.

1190. **[remote-mcp-server](https://github.com/gleanwork/remote-mcp-server)** - ⭐ 158
   Remote MCP Server that securely connects Enterprise context with your LLM, IDE, or agent platform of choice.

1191. **[slack-mcp-client](https://github.com/tuannvm/slack-mcp-client)** - ⭐ 158
...
1192. **[open-streetmap-mcp](https://github.com/jagan-shanmugam/open-streetmap-mcp)** - ⭐ 158
   An OpenStreetMap MCP server implementation that enhances LLM capabilities with location-based services and geospatial data.

1193. **[gate22](https://github.com/aipotheosis-labs/gate22)** - ⭐ 158
...
1194. **[photoshop-python-api-mcp-server](https://github.com/loonghao/photoshop-python-api-mcp-server)** - ⭐ 158
   A Model Context Protocol (MCP) server that interfaces with Adobe Photoshop's Python API. Enables LLMs to execute image editing operations, automate workflows, and manage Photoshop tasks through structured commands and context-aware interactions.

1195. **[opentelemetry-mcp-server](https://github.com/traceloop/opentelemetry-mcp-server)** - ⭐ 158
   Unified MCP server for querying OpenTelemetry traces across multiple backends (Jaeger, Tempo, Traceloop, etc.), enabling AI agents to analyze distributed traces for automated debugging and observability.

1196. **[pg-mcp-server](https://github.com/ericzakariasson/pg-mcp-server)** - ⭐ 158
   MCP Server for Postgres

1197. **[pageindex-mcp](https://github.com/VectifyAI/pageindex-mcp)** - ⭐ 158
...
1198. **[fetch-mcp](https://github.com/egoist/fetch-mcp)** - ⭐ 157
   An MCP server for fetching URLs / Youtube video transcript.

1199. **[spotinfo](https://github.com/alexei-led/spotinfo)** - ⭐ 157
   CLI for exploring AWS EC2 Spot inventory. Inspect AWS Spot instance types, saving, price, and interruption frequency.

1200. **[compliant-llm](https://github.com/fiddlecube/compliant-llm)** - ⭐ 157
   Build Secure and Compliant AI agents and MCP Servers. YC W23

1201. **[toolsdk-mcp-registry](https://github.com/toolsdk-ai/toolsdk-mcp-registry)** - ⭐ 157
...
1202. **[mcp-client-slackbot](https://github.com/sooperset/mcp-client-slackbot)** - ⭐ 156
   Simple Slackbot MCP Client

1203. **[flights-mcp](https://github.com/ravinahp/flights-mcp)** - ⭐ 156
   An MCP server to search for flights.

1204. **[recall](https://github.com/joseairosa/recall)** - ⭐ 156
   Give Claude perfect recall - Redis-powered persistent memory for LLMs

1205. **[alibabacloud-tablestore-mcp-server](https://github.com/aliyun/alibabacloud-tablestore-mcp-server)** - ⭐ 155

1206. **[superset-mcp](https://github.com/aptro/superset-mcp)** - ⭐ 155
   connect to 50+ data stores via superset mcp server. Can use with open ai agent sdk, Claude app, cursor, windsurf

1207. **[polymarket-mcp-server](https://github.com/caiovicentino/polymarket-mcp-server)** - ⭐ 155
   🤖 AI-Powered MCP Server for Polymarket - Enable Claude to trade prediction markets with 45 tools, real-time monitoring, and enterprise-grade safety features

1208. **[XPack-MCP-Marketplace](https://github.com/xpack-ai/XPack-MCP-Marketplace)** - ⭐ 155
...
1209. **[awesome-a2a](https://github.com/pab1it0/awesome-a2a)** - ⭐ 154
   Agent2Agent (A2A) – awesome A2A agents, tools, servers & clients, all in one place. 

1210. **[mcp-opennutrition](https://github.com/deadletterq/mcp-opennutrition)** - ⭐ 154
...
1211. **[mcp-server-langfuse](https://github.com/langfuse/mcp-server-langfuse)** - ⭐ 154
   Model Context Protocol (MCP) Server for Langfuse Prompt Management. This server allows you to access and manage your Langfuse prompts through the Model Context Protocol.

1212. **[MCP-Salesforce](https://github.com/smn2gnt/MCP-Salesforce)** - ⭐ 154
   MCP Salesforce connector

1213. **[obsidian-claude-code-mcp](https://github.com/iansinnott/obsidian-claude-code-mcp)** - ⭐ 154
   Connect Claude Code and other AI tools to your Obsidian notes using Model Context Protocol (MCP)

1214. **[tmcp](https://github.com/paoloricciuti/tmcp)** - ⭐ 154
   Typescript SDK to build MCP servers in an agnostic way

1215. **[mcp-simple-pubmed](https://github.com/andybrandt/mcp-simple-pubmed)** - ⭐ 153
   MCP server for searching and querying PubMed medical papers/research database

1216. **[metatrader-mcp-server](https://github.com/ariadng/metatrader-mcp-server)** - ⭐ 153
   Model Context Protocol (MCP) to enable AI LLMs to trade using MetaTrader platform

1217. **[SharpToolsMCP](https://github.com/kooshi/SharpToolsMCP)** - ⭐ 153
   A suite of MCP tools for AIs to analyze and modify C# solutions with high signal, Roslyn powered context.

1218. **[python-mcp-server-client](https://github.com/GobinFan/python-mcp-server-client)** - ⭐ 153
   支持查询主流agent框架技术文档的MCP server（支持stdio和sse两种传输协议）, 支持 langchain、llama-index、autogen、agno、openai-agents-sdk、mcp-doc、camel-ai 和 crew-ai

1219. **[mcp-summarizer](https://github.com/0xshellming/mcp-summarizer)** - ⭐ 152
   MCP Server for AI Summarization

1220. **[web3-research-mcp](https://github.com/aaronjmars/web3-research-mcp)** - ⭐ 152
   Deep Research for crypto - free & fully local

1221. **[mcptools](https://github.com/posit-dev/mcptools)** - ⭐ 152
   Model Context Protocol For R

1222. **[mcp-shark](https://github.com/mcp-shark/mcp-shark)** - ⭐ 152
...
1223. **[mcp-3D-printer-server](https://github.com/DMontgomery40/mcp-3D-printer-server)** - ⭐ 152
   Connects MCP to major 3D printer APIs (Orca, Bambu, OctoPrint, Klipper, Duet, Repetier, Prusa, Creality). Control prints, monitor status, and perform advanced STL operations like scaling, rotation, sectional editing, and base extension. Includes slicing and visualization.

1224. **[eShopLite](https://github.com/Azure-Samples/eShopLite)** - ⭐ 151
   eShopLite is a set of reference .NET applications implementing an eCommerce site with features like Semantic Search, MCP, Reasoning models and more.

1225. **[awesome-claude-dxt](https://github.com/milisp/awesome-claude-dxt)** - ⭐ 151
   Awesome Claude Desktop Extensions (dxt) (not only Claude) mcpb

1226. **[instagram_dm_mcp](https://github.com/trypeggy/instagram_dm_mcp)** - ⭐ 151
   Instagram Direct messages MCP

1227. **[task-orchestrator](https://github.com/jpicklyk/task-orchestrator)** - ⭐ 151
...
1228. **[mcp-gateway](https://github.com/lightconetech/mcp-gateway)** - ⭐ 151
   A gateway demo for MCP SSE Server

1229. **[mcp-email-server](https://github.com/ai-zerolab/mcp-email-server)** - ⭐ 151
   IMAP and SMTP via MCP Server

1230. **[mcp-server-metamcp](https://github.com/metatool-ai/mcp-server-metamcp)** - ⭐ 150
   MCP Server MetaMCP manages all your other MCPs in one MCP.

1231. **[scrapeless-mcp-server](https://github.com/scrapeless-ai/scrapeless-mcp-server)** - ⭐ 150
   Scrapeless Mcp Server

1232. **[mcp-server-example](https://github.com/alejandro-ao/mcp-server-example)** - ⭐ 150
   A simple MCP server to search for documentation (tutorial)

1233. **[mcp-solver](https://github.com/szeider/mcp-solver)** - ⭐ 150
   Model Context Protocol (MCP) server for constraint optimization and solving"

1234. **[lucid-agents](https://github.com/daydreamsai/lucid-agents)** - ⭐ 150
...
1235. **[sunpeak](https://github.com/Sunpeak-AI/sunpeak)** - ⭐ 150
   Local-first ChatGPT App framework.

1236. **[GEmojiSharp](https://github.com/hlaueriksson/GEmojiSharp)** - ⭐ 149
   :octocat: GitHub Emoji for C#, dotnet and beyond

1237. **[mcp-dotnet-samples](https://github.com/microsoft/mcp-dotnet-samples)** - ⭐ 149
   A comprehensive set of samples of creating and using MCP servers and clients with .NET

1238. **[chatgpt-copilot](https://github.com/feiskyer/chatgpt-copilot)** - ⭐ 149
   ChatGPT Copilot Extension for Visual Studio Code

1239. **[sandboxed.sh](https://github.com/Th0rgal/sandboxed.sh)** - ⭐ 149
   Self-hosted orchestrator for AI autonomous agents. Run Claude Code & Open Code in isolated linux workspaces. Manage your skills, configs and encrypted secrets with a git repo.

1240. **[tinymcp](https://github.com/golioth/tinymcp)** - ⭐ 148
   Let LLMs control embedded devices via the Model Context Protocol.

1241. **[MCPHub-Desktop](https://github.com/Jeamee/MCPHub-Desktop)** - ⭐ 148
   Desktop APP for Discover and Install MCP Servers

1242. **[mcp-client-go](https://github.com/yincongcyincong/mcp-client-go)** - ⭐ 148
   mcp client for Go (Golang). Integrate multiple  Model Context Protocol (MCP) servers

1243. **[make-mcp-server](https://github.com/integromat/make-mcp-server)** - ⭐ 148
   Make MCP Server

1244. **[cursor-notebook-mcp](https://github.com/jbeno/cursor-notebook-mcp)** - ⭐ 148
   Model Context Protocol (MCP) server designed to allow AI agents within Cursor to interact with Jupyter Notebook (.ipynb) files

1245. **[plane-mcp-server](https://github.com/makeplane/plane-mcp-server)** - ⭐ 148
   Plane's Official Model Context Protocol Server 🔌 ⌨️ 🔥

1246. **[Context-Engineering-for-Multi-Agent-Systems](https://github.com/Denis2054/Context-Engineering-for-Multi-Agent-Systems)** - ⭐ 148
...
1247. **[relay](https://github.com/prism-php/relay)** - ⭐ 147
   An MCP client tool for Prism

1248. **[any-chat-completions-mcp](https://github.com/pyroprompts/any-chat-completions-mcp)** - ⭐ 147
   MCP Server for using any LLM as a Tool

1249. **[Log-Analyzer-with-MCP](https://github.com/awslabs/Log-Analyzer-with-MCP)** - ⭐ 147
   A Model Context Protocol (MCP) server that provides AI assistants access to AWS CloudWatch Logs for analysis, searching, and correlation

1250. **[CreatorBox](https://github.com/xiesx123/CreatorBox)** - ⭐ 147
   🚀🎬灵活、高效、可扩展，专属剪辑配音工具箱，释放创作潜力 . Flexible, efficient, and scalable toolbox for editing and dubbing, unleashing creative potential

1251. **[solana-mcp](https://github.com/sendaifun/solana-mcp)** - ⭐ 147
   A Model Context Protocol server for interacting with the Solana blockchain, powered by the Solana Agent Kit (https://github.com/sendaifun/solana-agent-kit)

1252. **[Gemini-mcp](https://github.com/LKbaba/Gemini-mcp)** - ⭐ 146
   MCP server implementation for Google's Gemini API

1253. **[decipher-research-agent](https://github.com/mtwn105/decipher-research-agent)** - ⭐ 146
   Turn topics, links, and files into AI-generated research notebooks — summarize, explore, and ask anything.

1254. **[open-responses-server](https://github.com/teabranch/open-responses-server)** - ⭐ 146
   Wraps any OpenAI API interface as Responses with MCPs support so it supports Codex. Adding any missing stateful features. Ollama and Vllm compliant.

1255. **[mcp-mysql-server](https://github.com/f4ww4z/mcp-mysql-server)** - ⭐ 146
   A Model Context Protocol server for MySQL database operations

1256. **[strudel-mcp-server](https://github.com/williamzujkowski/strudel-mcp-server)** - ⭐ 146
   A Model Context Protocol (MCP) server that gives Claude direct control over Strudel.cc for AI-assisted music generation and live coding.

1257. **[matlab-mcp-core-server](https://github.com/matlab/matlab-mcp-core-server)** - ⭐ 146
   Run MATLAB® using AI applications with the official MATLAB MCP Server from MathWorks®. This MCP server for MATLAB supports a wide range of coding agents like Claude Code® and Visual Studio® Code.

1258. **[osint-tools-mcp-server](https://github.com/frishtik/osint-tools-mcp-server)** - ⭐ 146
   MCP server exposing multiple OSINT tools for AI assistants like Claude

1259. **[mcp-server-weread](https://github.com/ChenyqThu/mcp-server-weread)** - ⭐ 145

1260. **[figma-mcp-server](https://github.com/TimHolden/figma-mcp-server)** - ⭐ 145
   Model Context Protocol server implementation for Figma API

1261. **[ultimate_mcp_client](https://github.com/Dicklesworthstone/ultimate_mcp_client)** - ⭐ 145

1262. **[postman-mcp-server](https://github.com/delano/postman-mcp-server)** - ⭐ 145
   An MCP server that provides access to Postman.

1263. **[hypertool-mcp](https://github.com/toolprint/hypertool-mcp)** - ⭐ 145
   Dynamically expose tools from proxied servers based on an Agent Persona

1264. **[In-Memoria](https://github.com/pi22by7/In-Memoria)** - ⭐ 145
   Persistent Intelligence Infrastructure for AI Agents

1265. **[agentor](https://github.com/CelestoAI/agentor)** - ⭐ 145
...
1266. **[goku](https://github.com/jcaromiq/goku)** - ⭐ 145
   Goku is an HTTP load testing application written in Rust 

1267. **[autocad-mcp](https://github.com/puran-water/autocad-mcp)** - ⭐ 145
...
1268. **[code-assistant](https://github.com/stippi/code-assistant)** - ⭐ 145
   An LLM-powered, autonomous coding assistant. Also offers an MCP and ACP mode.

1269. **[linux-mcp-server](https://github.com/rhel-lightspeed/linux-mcp-server)** - ⭐ 145
   Tools to allow LLM clients to interact with Linux systems remotely

1270. **[uaip](https://github.com/concierge-hq/uaip)** - ⭐ 144
...
1271. **[google-slides-mcp](https://github.com/matteoantoci/google-slides-mcp)** - ⭐ 144
   MCP Server for Google Slides

1272. **[website-downloader](https://github.com/pskill9/website-downloader)** - ⭐ 144
   MCP server to download entire websites

1273. **[notion-mcp-server](https://github.com/awkoy/notion-mcp-server)** - ⭐ 144
   **Notion MCP Server** is a Model Context Protocol (MCP) server implementation that enables AI assistants to interact with Notion's API. This production-ready server provides a complete set of tools.

1274. **[OpenDataMCP](https://github.com/OpenDataMCP/OpenDataMCP)** - ⭐ 143
   Connect any Open Data to any LLM with Model Context Protocol.

1275. **[mcp-servers](https://github.com/charIesding/mcp-servers)** - ⭐ 143
   mcp server implementations

1276. **[pubmearch](https://github.com/Darkroaster/pubmearch)** - ⭐ 143
   A PubMed MCP server.

1277. **[quick-data-mcp](https://github.com/disler/quick-data-mcp)** - ⭐ 143
   Prompt focused MCP Server for .json and .csv agentic data analytics for Claude Code

1278. **[mcp-1panel](https://github.com/1Panel-dev/mcp-1panel)** - ⭐ 143
   mcp-1panel is an implementation of the Model Context Protocol (MCP) server for 1Panel.

1279. **[mcp-server-starrocks](https://github.com/StarRocks/mcp-server-starrocks)** - ⭐ 143
   StarRocks MCP (Model Context Protocol) Server

1280. **[seo-research-mcp](https://github.com/egebese/seo-research-mcp)** - ⭐ 143
...
1281. **[ssh-mcp-server](https://github.com/classfang/ssh-mcp-server)** - ⭐ 143
   基于 SSH 的 MCP 服务器 🧙‍♀️。已被MCP官方收录 🎉。 SSH MCP Server 🧙‍♀️. It has been included in the community MCP repository 🎉.

1282. **[kom](https://github.com/weibaohui/kom)** - ⭐ 142
   kom 是一个用于 Kubernetes 操作的工具，SDK级的kubectl、client-go的使用封装。并且支持作为管理k8s 的 MCP server。 它提供了一系列功能来管理 Kubernetes 资源，包括创建、更新、删除和获取资源，甚至使用SQL查询k8s资源。这个项目支持多种 Kubernetes 资源类型的操作，并能够处理自定义资源定义（CRD）。 通过使用 kom，你可以轻松地进行资源的增删改查和日志获取以及操作POD内文件等动作。

1283. **[mcp-interviewer](https://github.com/microsoft/mcp-interviewer)** - ⭐ 142
   Catch MCP server issues before your agents do.

1284. **[openagent](https://github.com/Th0rgal/openagent)** - ⭐ 142
   Self-hosted orchestrator for AI autonomous agents. Run Claude Code & Open Code in isolated linux workspaces. Manage your skills, configs and encrypted secrets with a git repo.

1285. **[logfire-mcp](https://github.com/pydantic/logfire-mcp)** - ⭐ 142
   The Logfire MCP Server is here! :tada:

1286. **[MaxMSP-MCP-Server](https://github.com/tiianhk/MaxMSP-MCP-Server)** - ⭐ 142
   MCP (Model Context Protocol) Server for Max (Max/MSP/Jitter)

1287. **[node-code-sandbox-mcp](https://github.com/alfonsograziano/node-code-sandbox-mcp)** - ⭐ 142
   A Node.js–based Model Context Protocol server that spins up disposable Docker containers to execute arbitrary JavaScript.

1288. **[zabbix-mcp-server](https://github.com/mpeirone/zabbix-mcp-server)** - ⭐ 142
...
1289. **[ReActMCP](https://github.com/mshojaei77/ReActMCP)** - ⭐ 141
   ReActMCP is a reactive MCP client that empowers AI assistants to instantly respond with real-time, Markdown-formatted web search insights powered by the Exa API.

1290. **[mcp-discord](https://github.com/hanweg/mcp-discord)** - ⭐ 141
   MCP server for discord bot

1291. **[mcp-server-calculator](https://github.com/githejie/mcp-server-calculator)** - ⭐ 141
   A Model Context Protocol server for calculating.

1292. **[mcp-server-odoo](https://github.com/ivnvxd/mcp-server-odoo)** - ⭐ 141
   A Model Context Protocol (MCP) server that enables AI assistants to securely interact with Odoo ERP systems through standardized resources and tools for data retrieval and manipulation.

1293. **[mcp-server-gsc](https://github.com/ahonn/mcp-server-gsc)** - ⭐ 141
   A Model Context Protocol (MCP) server providing access to Google Search Console

1294. **[rust-mcp-sdk](https://github.com/rust-mcp-stack/rust-mcp-sdk)** - ⭐ 141
   A high-performance, asynchronous toolkit for building MCP servers and clients in Rust.

1295. **[agentql-mcp](https://github.com/tinyfish-io/agentql-mcp)** - ⭐ 141
   Model Context Protocol server that integrates AgentQL's data extraction capabilities.

1296. **[AgentCrew](https://github.com/saigontechnology/AgentCrew)** - ⭐ 141
   Chat application with multi-agents system supports multi-models and MCP

1297. **[powerpoint](https://github.com/supercurses/powerpoint)** - ⭐ 140
   A MCP Server for creating Powerpoint Presentations

1298. **[refref](https://github.com/refrefhq/refref)** - ⭐ 140
   🌟 Open Source Referral and Affiliate Marketing Platform - Launch your referral program in minutes!

1299. **[coolify-mcp](https://github.com/StuMason/coolify-mcp)** - ⭐ 140
   MCP server for Coolify. 35 tools for managing self-hosted PaaS through AI assistants.

1300. **[opencode-studio](https://github.com/Microck/opencode-studio)** - ⭐ 140
   web GUI for securely managing local OpenCode configuration

1301. **[bilibili-mcp-js](https://github.com/34892002/bilibili-mcp-js)** - ⭐ 140
   Bilibili video search MCP (Model Context Protocol) service - 哔哩哔哩视频搜索MCP服务

1302. **[mcp-montano-server](https://github.com/lucasmontano/mcp-montano-server)** - ⭐ 139
   Simple MCP Server Implementation

1303. **[MCP-X](https://github.com/TimeCyber/MCP-X)** - ⭐ 139
...
1304. **[wa_llm](https://github.com/ilanbenb/wa_llm)** - ⭐ 139
   A WhatsApp bot that can participate in group conversations, powered by AI. The bot monitors group messages and responds when mentioned.

1305. **[mcp-k8s](https://github.com/silenceper/mcp-k8s)** - ⭐ 139
   A Kubernetes MCP (Model Control Protocol) server that enables interaction with Kubernetes clusters through MCP tools.

1306. **[intervals-mcp-server](https://github.com/mvilanova/intervals-mcp-server)** - ⭐ 139
   Model Context Protocol (MCP) server for connecting Claude and ChatGPT with the Intervals.icu API.

1307. **[eion](https://github.com/eiondb/eion)** - ⭐ 138
   Shared Memory Storage for Multi-Agent Systems

1308. **[systemprompt-code-orchestrator](https://github.com/systempromptio/systemprompt-code-orchestrator)** - ⭐ 138
     MCP server for orchestrating AI coding agents (Claude Code CLI & Gemini CLI). Features task management, process execution, Git integration, and dynamic resource discovery. Full TypeScript implementation with Docker support and Cloudflare Tunnel integration. 

1309. **[frontmcp](https://github.com/agentfront/frontmcp)** - ⭐ 138
   TypeScript-first framework for the Model Context Protocol (MCP). You write clean, typed code; FrontMCP handles the protocol, transport, DI, session/auth, and execution flow.

1310. **[graphiti-mcp-server](https://github.com/gifflet/graphiti-mcp-server)** - ⭐ 138
   Graphiti MCP Server

1311. **[backlog-mcp-server](https://github.com/nulab/backlog-mcp-server)** - ⭐ 138

1312. **[mssql-mcp](https://github.com/Aaronontheweb/mssql-mcp)** - ⭐ 138
   MSSQL Server MCP implementation written in C#

1313. **[memory-graph](https://github.com/memory-graph/memory-graph)** - ⭐ 138
   A graph DB-based MCP memory server for coding agents with intelligent relationship tracking

1314. **[Frappe_Assistant_Core](https://github.com/buildswithpaul/Frappe_Assistant_Core)** - ⭐ 138
   Infrastructure that connects LLMs to ERPNext. Frappe Assistant Core works with the Model Context Protocol (MCP) to expose ERPNext functionality to any compatible Language Model

1315. **[datagov-mcp](https://github.com/aviveldan/datagov-mcp)** - ⭐ 137
   MCP server for Israel Government Data

1316. **[SecureMCP](https://github.com/makalin/SecureMCP)** - ⭐ 137
...
1317. **[guidance-for-deploying-model-context-protocol-servers-on-aws](https://github.com/aws-solutions-library-samples/guidance-for-deploying-model-context-protocol-servers-on-aws)** - ⭐ 137
...
1318. **[k8s-mcp-server](https://github.com/reza-gholizade/k8s-mcp-server)** - ⭐ 137
   Manage Your Kubernetes Cluster with k8s mcp-server

1319. **[unifi-network-mcp](https://github.com/sirkirby/unifi-network-mcp)** - ⭐ 137
   MCP server implementation for the UniFi network application

1320. **[mcp-server-typescript](https://github.com/dataforseo/mcp-server-typescript)** - ⭐ 137
   DataForSEO API modelcontextprotocol server 

1321. **[doc-ops-mcp](https://github.com/Tele-AI/doc-ops-mcp)** - ⭐ 136
   MCP server for seamless document format conversion and processing

1322. **[ghost-mcp](https://github.com/MFYDev/ghost-mcp)** - ⭐ 136
   A Model Context Protocol (MCP) server for interacting with Ghost CMS through LLM interfaces like Claude. Allow you to control your Ghost blog by simply asking Claude etc.

1323. **[agent-toolkit](https://github.com/datacommonsorg/agent-toolkit)** - ⭐ 136
   Tools and agents for interacting with the Data Commons Knowledge Graph using the Model Context Protocol (MCP).

1324. **[mcp-server-serper](https://github.com/marcopesani/mcp-server-serper)** - ⭐ 136
   Serper MCP Server supporting search and webpage scraping

1325. **[drawio2go](https://github.com/Menghuan1918/drawio2go)** - ⭐ 136
   A modern DrawIO editor application.  AI-Powered, Human-AI Collaboration | AI 加持，人机共绘drawio

1326. **[ultimate_mcp_server](https://github.com/Dicklesworthstone/ultimate_mcp_server)** - ⭐ 135
   The Ultimate Model Context Protocol (MCP) Server, providing unified access to a wide variety of useful and powerful tools.

1327. **[hayhooks](https://github.com/deepset-ai/hayhooks)** - ⭐ 135
   Easily deploy Haystack pipelines as REST APIs and MCP Tools.

1328. **[MCP-PostgreSQL-Ops](https://github.com/call518/MCP-PostgreSQL-Ops)** - ⭐ 135
...
1329. **[mkinf](https://github.com/mkinf-io/mkinf)** - ⭐ 134
   mkinf SDK to interact with mkinf hub MCP servers

1330. **[zettelkasten-mcp](https://github.com/entanglr/zettelkasten-mcp)** - ⭐ 134
   A Model Context Protocol (MCP) server that implements the Zettelkasten knowledge management methodology, allowing you to create, link, explore and synthesize atomic notes through Claude and other MCP-compatible clients.

1331. **[mcp-server-reddit](https://github.com/Hawstein/mcp-server-reddit)** - ⭐ 134
   A Model Context Protocol (MCP) server that provides tools for fetching Reddit content, including frontpage posts, subreddit information and hot posts, post details, and comments.

1332. **[LMStudio-MCP](https://github.com/infinitimeless/LMStudio-MCP)** - ⭐ 134
   A Model Control Protocol (MCP) server that allows Claude to communicate with locally running LLM models via LM Studio.

1333. **[OmniFocus-MCP](https://github.com/themotionmachine/OmniFocus-MCP)** - ⭐ 134
   Let LLMs interface with your tasks and projects through the Model Context Protocol. Add, organize, and query your OmniFocus database with natural language commands.

1334. **[Multi-Source-Media-MCP-Server](https://github.com/Decade-qiu/Multi-Source-Media-MCP-Server)** - ⭐ 133
   An MCP Tool Implementation for Multi-Source Image Access & Generation

1335. **[Awesome-MCP](https://github.com/AlexMili/Awesome-MCP)** - ⭐ 133
   Awesome ModelContextProtocol resources - A curated list of MCP resources

1336. **[mcp-think-tool](https://github.com/DannyMac180/mcp-think-tool)** - ⭐ 133
   An MCP server implementing the think tool for Claude

1337. **[mcp-server-manifest](https://github.com/Zomato/mcp-server-manifest)** - ⭐ 133

1338. **[radare2-mcp](https://github.com/radareorg/radare2-mcp)** - ⭐ 133
   MCP stdio server for radare2

1339. **[Polymcp](https://github.com/poly-mcp/Polymcp)** - ⭐ 133
   Polymcp provides a simple and efficient way to interact with MCP servers using custom agents

1340. **[Gitingest-MCP](https://github.com/puravparab/Gitingest-MCP)** - ⭐ 132
   mcp server for gitingest

1341. **[mcp-bigquery-server](https://github.com/ergut/mcp-bigquery-server)** - ⭐ 132
   A Model Context Protocol (MCP) server that provides secure, read-only access to BigQuery datasets. Enables Large Language Models (LLMs) to safely query and analyze data through a standardized interface.

1342. **[mcp-server-macos-use](https://github.com/mediar-ai/mcp-server-macos-use)** - ⭐ 132
   AI agent that controls computer with OS-level tools, MCP compatible, works with any model

1343. **[mcp-server-apache-airflow](https://github.com/yangkyeongmo/mcp-server-apache-airflow)** - ⭐ 132

1344. **[mcp-chat](https://github.com/Flux159/mcp-chat)** - ⭐ 132
   Open Source Generic MCP Client for testing & evaluating mcp servers and agents

1345. **[xhs-mcp-server](https://github.com/aicu-icu/xhs-mcp-server)** - ⭐ 132
   小红书MCP服务器 | 基于Electron+小红书Web API。一键安装运行、极速抓取笔记、评论、用户等数据并让AI智能分析、整理与导出

1346. **[freecad_mcp](https://github.com/bonninr/freecad_mcp)** - ⭐ 132
...
1347. **[ragrabbit](https://github.com/madarco/ragrabbit)** - ⭐ 131
   Open Source, Self-Hosted, AI Search and LLM.txt for your website

1348. **[jupyter-ai-agents](https://github.com/datalayer/jupyter-ai-agents)** - ⭐ 131
   🪐 🤖 AI Agents for JupyterLab with 🔧 MCP tools - Chat interface for optimized notebook interaction and code execution.

1349. **[ollama-mcp](https://github.com/rawveg/ollama-mcp)** - ⭐ 131
   An MCP Server for Ollama

1350. **[mcp-gateway](https://github.com/acehoss/mcp-gateway)** - ⭐ 130
...
1351. **[A2A-MCP-Server](https://github.com/GongRzhe/A2A-MCP-Server)** - ⭐ 130
...
1352. **[claude-prompts](https://github.com/minipuft/claude-prompts)** - ⭐ 130
   MCP prompt template server: hot-reload, thinking frameworks, quality gates

1353. **[esp-mcp](https://github.com/horw/esp-mcp)** - ⭐ 130
   Centralize ESP32 related commands and simplify getting started with seamless, LLM-driven interaction and help.

1354. **[mcp-rubber-duck](https://github.com/nesquikm/mcp-rubber-duck)** - ⭐ 130
   An MCP server that acts as a bridge to query multiple OpenAI-compatible LLMs with MCP tool access. Just like rubber duck debugging, explain your problems to various AI "ducks" who can actually research and get different perspectives!

1355. **[play-store-mcp](https://github.com/antoniolg/play-store-mcp)** - ⭐ 130
   An MCP server that connects to Play Store Console and release new App versions from an MCP Client

1356. **[Human-In-the-Loop-MCP-Server](https://github.com/GongRzhe/Human-In-the-Loop-MCP-Server)** - ⭐ 130
...
1357. **[mcp-crash-course](https://github.com/emarco177/mcp-crash-course)** - ⭐ 130
...
1358. **[medusa](https://github.com/Pantheon-Security/medusa)** - ⭐ 130
...
1359. **[awesome-crypto-mcp-servers](https://github.com/badkk/awesome-crypto-mcp-servers)** - ⭐ 129
   A collection of crypto MCP servers.

1360. **[N8N2MCP](https://github.com/Super-Chain/N8N2MCP)** - ⭐ 129
   Convert N8N agent / workflow into MCP servers, you can use it in Claude / Cursor / Super Chain 

1361. **[dify-plugin-agent-mcp_sse](https://github.com/junjiem/dify-plugin-agent-mcp_sse)** - ⭐ 129
   Dify 1.0 Plugin Support MCP Tools Agent strategies

1362. **[codeql-mcp](https://github.com/JordyZomer/codeql-mcp)** - ⭐ 129
...
1363. **[aicode-toolkit](https://github.com/AgiFlow/aicode-toolkit)** - ⭐ 129
   Toolkit for Coding Agents to work reliably with repo of any size.

1364. **[mcp-read-website-fast](https://github.com/just-every/mcp-read-website-fast)** - ⭐ 129
   Quickly reads webpages and converts to markdown for fast, token efficient web scraping

1365. **[mcpd](https://github.com/mozilla-ai/mcpd)** - ⭐ 129
...
1366. **[aws-cost-explorer-mcp-server](https://github.com/aarora79/aws-cost-explorer-mcp-server)** - ⭐ 128
   MCP server for understanding AWS spend

1367. **[mcp-server-aws](https://github.com/rishikavikondala/mcp-server-aws)** - ⭐ 128
   A Model Context Protocol server implementation for operations on AWS resources

1368. **[zotero-mcp](https://github.com/kujenga/zotero-mcp)** - ⭐ 128
   Model Context Protocol (MCP) server for the Zotero API, in Python

1369. **[magg](https://github.com/sitbon/magg)** - ⭐ 128
   Magg: The MCP Aggregator

1370. **[mcp_server_exe](https://github.com/shadowcz007/mcp_server_exe)** - ⭐ 128
   小智 & Cursor 的 MCP 启动器 - MCP For Cursor&xiaozhi。打包成可执行文件。Turn MCP server into an executable file

1371. **[marionette_mcp](https://github.com/leancodepl/marionette_mcp)** - ⭐ 128
...
1372. **[mcp-server-plugin](https://github.com/JetBrains/mcp-server-plugin)** - ⭐ 127
   JetBrains MCP Server Plugin

1373. **[crawl4ai-mcp-server](https://github.com/weidwonder/crawl4ai-mcp-server)** - ⭐ 127
   用于提供给本地开发者的 LLM的高效互联网搜索&内容获取的MCP Server， 节省你的token

1374. **[beyond-mcp](https://github.com/disler/beyond-mcp)** - ⭐ 127
   It's time to push beyond MCP Servers... Right?

1375. **[zig-mcp](https://github.com/zig-wasm/zig-mcp)** - ⭐ 127
   Model Context Protocol (MCP) server that provides up-to-date documentation for the Zig programming language standard library and builtin functions

1376. **[dart-mcp-server](https://github.com/its-dart/dart-mcp-server)** - ⭐ 127
   Dart AI Model Context Protocol (MCP) server

1377. **[ChatPPT-MCP](https://github.com/YOOTeam/ChatPPT-MCP)** - ⭐ 127
...
1378. **[laravel-loop](https://github.com/kirschbaum-development/laravel-loop)** - ⭐ 127
   Laravel Loop is a powerful Model Context Protocol (MCP) server designed specifically for Laravel applications. It connects your Laravel application with AI assistants using the MCP protocol.

1379. **[aleph](https://github.com/Hmbown/aleph)** - ⭐ 127
   Skill + MCP server for recursive LLM reasoning. Load context, iterate with search/code/think tools, converge on answers.

1380. **[think-mcp-server](https://github.com/PhillipRt/think-mcp-server)** - ⭐ 126

1381. **[claude-prompts-mcp](https://github.com/minipuft/claude-prompts-mcp)** - ⭐ 126
   MCP prompt template server: hot-reload, thinking frameworks, quality gates

1382. **[specs-workflow-mcp](https://github.com/kingkongshot/specs-workflow-mcp)** - ⭐ 126
   Intelligent spec workflow management MCP server

1383. **[unreal-analyzer-mcp](https://github.com/ayeletstudioindia/unreal-analyzer-mcp)** - ⭐ 126
   MCP server for Unreal Engine 5

1384. **[tiktok-mcp](https://github.com/Seym0n/tiktok-mcp)** - ⭐ 126
   Model Context Protocol (MCP) with TikTok integration

1385. **[codex-mcp-server](https://github.com/cexll/codex-mcp-server)** - ⭐ 126
   Codex Mcp Server 

1386. **[mcp-server-ccxt](https://github.com/doggybee/mcp-server-ccxt)** - ⭐ 126
   High-performance CCXT MCP server for cryptocurrency exchange integration

1387. **[play-store-mcp](https://github.com/devexpert-io/play-store-mcp)** - ⭐ 125
   An MCP server that connects to Play Store Console and release new App versions from an MCP Client

1388. **[uLoopMCP](https://github.com/hatayama/uLoopMCP)** - ⭐ 125
   Your Unity project's AI autopilot. Compile, test, debug, repeat—until it just works.

1389. **[ZotLink](https://github.com/TonybotNi/ZotLink)** - ⭐ 125
...
1390. **[ksail](https://github.com/devantler-tech/ksail)** - ⭐ 125
   CLI tool for creating, maintaining and operating Kubernetes clusters.

1391. **[mcp-client-server](https://github.com/willccbb/mcp-client-server)** - ⭐ 124
   An MCP Server that's also an MCP Client. Useful for letting Claude develop and test MCPs without needing to reset the application.

1392. **[mcp-linear](https://github.com/tacticlaunch/mcp-linear)** - ⭐ 124
...
1393. **[mcp-evals](https://github.com/mclenhard/mcp-evals)** - ⭐ 124
   A Node.js package and GitHub Action for evaluating MCP (Model Context Protocol) tool implementations using LLM-based scoring. This helps ensure your MCP server's tools are working correctly and performing well.

1394. **[mcp-streamable-http](https://github.com/invariantlabs-ai/mcp-streamable-http)** - ⭐ 124
   Example implementation of MCP Streamable HTTP client/server in Python and TypeScript.

1395. **[mcp-endpoint-server](https://github.com/xinnan-tech/mcp-endpoint-server)** - ⭐ 124
   xiaozhi mcp接入点服务器，用于自定义mcp服务注册，方便拓展小智服务端工具调用

1396. **[mcp-server](https://github.com/browserstack/mcp-server)** - ⭐ 124
   BrowserStack's Official MCP Server

1397. **[mcp-server-datadog](https://github.com/winor30/mcp-server-datadog)** - ⭐ 124

1398. **[buttplug-mcp](https://github.com/ConAcademy/buttplug-mcp)** - ⭐ 123
   Buttplug.io Model Context Protocol (MCP) Server

1399. **[mcp](https://github.com/pronskiy/mcp)** - ⭐ 123
   🐉 The fast, PHP way to build MCP servers

1400. **[mcp-svelte-docs](https://github.com/spences10/mcp-svelte-docs)** - ⭐ 123
   🔍 MCP server that lets you search and access Svelte documentation with built-in caching

1401. **[linear-mcp](https://github.com/cline/linear-mcp)** - ⭐ 123
   a private MCP server for accessing Linear

1402. **[forgetful](https://github.com/ScottRBK/forgetful)** - ⭐ 123
   Opensource Memory for Agents

1403. **[aws-lambda-mcp-cookbook](https://github.com/ran-isenberg/aws-lambda-mcp-cookbook)** - ⭐ 122
...
1404. **[openapi](https://github.com/samchon/openapi)** - ⭐ 122
   OpenAPI definitions, converters and LLM function calling schema composer.

1405. **[mcp-apache-spark-history-server](https://github.com/kubeflow/mcp-apache-spark-history-server)** - ⭐ 122
   MCP Server for Apache Spark History Server. The bridge between Agentic AI and Apache Spark.

1406. **[paiml-mcp-agent-toolkit](https://github.com/paiml/paiml-mcp-agent-toolkit)** - ⭐ 122
   Pragmatic AI Labs MCP Agent Toolkit - An MCP Server designed to make code with agents more deterministic

1407. **[rust-mcp-filesystem](https://github.com/rust-mcp-stack/rust-mcp-filesystem)** - ⭐ 122
   Blazing-fast, asynchronous MCP server for seamless filesystem operations.

1408. **[mcp-server-bigquery](https://github.com/LucasHild/mcp-server-bigquery)** - ⭐ 122
   A Model Context Protocol server that provides access to BigQuery

1409. **[mcp](https://github.com/MariaDB/mcp)** - ⭐ 122
   MariaDB MCP (Model Context Protocol) server implementation

1410. **[muppet](https://github.com/muppet-dev/muppet)** - ⭐ 121
   MCP Servers SDK for TypeScript

1411. **[mevzuat-mcp](https://github.com/saidsurucu/mevzuat-mcp)** - ⭐ 121
   MCP Server for Searching Turkish Legislation

1412. **[computer-use-mcp](https://github.com/domdomegg/computer-use-mcp)** - ⭐ 121
   💻 Give AI models complete control of your computer (probably a bad idea)

1413. **[laravel-toon](https://github.com/mischasigtermans/laravel-toon)** - ⭐ 121
   TOON encoding for Laravel. Encode data for AI/LLMs with ~50% fewer tokens than JSON.

1414. **[mcp-watch](https://github.com/kapilduraphe/mcp-watch)** - ⭐ 120
   A comprehensive security scanner for Model Context Protocol (MCP) servers that detects vulnerabilities and security issues in your MCP server implementations.

1415. **[shopify-mcp](https://github.com/GeLi2001/shopify-mcp)** - ⭐ 120
   MCP server for Shopify api, usable on mcp hosts such as Claude and Cursor

1416. **[mcp-package-version](https://github.com/sammcj/mcp-package-version)** - ⭐ 120
   An MCP server that provides LLMs with the latest stable package versions when coding

1417. **[ffmpeg-mcp](https://github.com/egoist/ffmpeg-mcp)** - ⭐ 120
   An MCP server for FFmpeg

1418. **[paperless-mcp](https://github.com/nloui/paperless-mcp)** - ⭐ 120
   An MCP (Model Context Protocol) server for interacting with a Paperless-NGX API server. This server provides tools for managing documents, tags, correspondents, and document types in your Paperless-NGX instance.

1419. **[UnityMCP](https://github.com/isuzu-shiranui/UnityMCP)** - ⭐ 119
   Unity Editor integration with Model Context Protocol (MCP) enabling AI assistants like Claude to interact with Unity projects. Features a TypeScript MCP server and C# Unity plugin with extensible command handler architecture, TCP/IP communication, and dynamic plugin discovery.

1420. **[n8n-mcp-server](https://github.com/illuminaresolutions/n8n-mcp-server)** - ⭐ 119
   MCP server implementation for n8n workflow automation

1421. **[MakerAi](https://github.com/gustavoeenriquez/MakerAi)** - ⭐ 119
...
1422. **[mcp-devtools](https://github.com/sammcj/mcp-devtools)** - ⭐ 119
   A modular MCP server that provides commonly used developer tools for AI coding agents

1423. **[mcp-redmine](https://github.com/runekaagaard/mcp-redmine)** - ⭐ 119
   A redmine MCP server covering close to 100% of redmines API

1424. **[jupyter-notebook-mcp](https://github.com/jjsantos01/jupyter-notebook-mcp)** - ⭐ 118
   A Model Context Protocol (MCP) for Jupyter Notebook

1425. **[mcp-server-salesforce](https://github.com/tsmztech/mcp-server-salesforce)** - ⭐ 118
   Salesforce MCP Server

1426. **[easy-code-reader](https://github.com/FangYuan33/easy-code-reader)** - ⭐ 118
   A powerful MCP (Model Context Protocol) server for intelligently reading Java source code.

1427. **[remote-mcp-functions-dotnet](https://github.com/Azure-Samples/remote-mcp-functions-dotnet)** - ⭐ 117
...
1428. **[memorizer-v1](https://github.com/petabridge/memorizer-v1)** - ⭐ 117
   Vector-search powered agent memory MCP server

1429. **[elevenlabs-mcp-server](https://github.com/mamertofabian/elevenlabs-mcp-server)** - ⭐ 117

1430. **[isaac-sim-mcp](https://github.com/omni-mcp/isaac-sim-mcp)** - ⭐ 117
   Isaac Simulation MCP Extension and Server

1431. **[mcp-victoriametrics](https://github.com/VictoriaMetrics-Community/mcp-victoriametrics)** - ⭐ 117
   The implementation of Model Context Protocol (MCP) server for VictoriaMetrics

1432. **[VisionCraft-MCP-Server](https://github.com/augmentedstartups/VisionCraft-MCP-Server)** - ⭐ 117
...
1433. **[mcp-mianshiya-server](https://github.com/yuyuanweb/mcp-mianshiya-server)** - ⭐ 117
   基于 Spring AI 的面试鸭搜索题目的 MCP Server 服务，快速让 AI 搜索企业面试真题和答案

1434. **[turbo-flow-claude](https://github.com/marcuspat/turbo-flow-claude)** - ⭐ 117
...
1435. **[SmartDB_MCP](https://github.com/wenb1n-dev/SmartDB_MCP)** - ⭐ 116
...
1436. **[gemini-mcp](https://github.com/RLabs-Inc/gemini-mcp)** - ⭐ 116
   MCP Server that enables Claude code to interact with Gemini

1437. **[MCP-Workspace-Server](https://github.com/answerlink/MCP-Workspace-Server)** - ⭐ 116
...
1438. **[NornicDB](https://github.com/orneryd/NornicDB)** - ⭐ 116
...
1439. **[hub-mcp](https://github.com/docker/hub-mcp)** - ⭐ 116
   Docker Hub MCP Server

1440. **[kodit](https://github.com/helixml/kodit)** - ⭐ 115
   👩‍💻 MCP server to index external repositories

1441. **[mcp_proxy_rust](https://github.com/tidewave-ai/mcp_proxy_rust)** - ⭐ 115
   A proxy to use HTTP/SSE MCPs from STDIO clients

1442. **[OpenSCAD-MCP-Server](https://github.com/jhacksman/OpenSCAD-MCP-Server)** - ⭐ 115
   Devin's attempt at creating an OpenSCAD MCP Server that takes a user prompt and generates a preview image and 3d file.

1443. **[mcp-ts-template](https://github.com/cyanheads/mcp-ts-template)** - ⭐ 115
...
1444. **[google-workspace-mcp](https://github.com/aaronsb/google-workspace-mcp)** - ⭐ 115
   A Model Context Protocol (MCP) server that provides authenticated access to Google Workspace APIs, offering integrated Authentication, Gmail, Calendar, and Drive functionality

1445. **[mcpproxy-go](https://github.com/smart-mcp-proxy/mcpproxy-go)** - ⭐ 115
   Supercharge AI Agents, Safely

1446. **[mcp-bsl-platform-context](https://github.com/alkoleft/mcp-bsl-platform-context)** - ⭐ 115
   MCP сервер для AI-ассистентов (справка по синтаксису и объектной модели 1С:Предприятие)

1447. **[kindly-web-search-mcp-server](https://github.com/Shelpuk-AI-Technology-Consulting/kindly-web-search-mcp-server)** - ⭐ 115
...
1448. **[mcp-server-asana](https://github.com/roychri/mcp-server-asana)** - ⭐ 114

1449. **[MCppServer](https://github.com/Noeli14/MCppServer)** - ⭐ 114
   Fast and super efficient Minecraft Server written in C++

1450. **[mcp-server](https://github.com/InterviewReady/mcp-server)** - ⭐ 114
   An MCP server for InterviewReady

1451. **[teslamate-mcp](https://github.com/cobanov/teslamate-mcp)** - ⭐ 114
   A Model Context Protocol (MCP) server that provides access to your TeslaMate database, allowing AI assistants to query Tesla vehicle data and analytics.

1452. **[SwiftMCP](https://github.com/Cocoanetics/SwiftMCP)** - ⭐ 114
   Model Context Protocol Server for Swift

1453. **[mcp-memory](https://github.com/Puliczek/mcp-memory)** - ⭐ 114
...
1454. **[mcp-server](https://github.com/bitwarden/mcp-server)** - ⭐ 114
   MCP server for interaction with Bitwarden.

1455. **[aseprite-mcp](https://github.com/diivi/aseprite-mcp)** - ⭐ 114
   MCP server for interacting with the Aseprite API

1456. **[cli](https://github.com/mcpgod/cli)** - ⭐ 113
   Fine-grained control over model context protocol (MCP) clients, servers, and tools. Context is God.

1457. **[remote-mcp-apim-functions-python](https://github.com/Azure-Samples/remote-mcp-apim-functions-python)** - ⭐ 113
   Azure API Management as AI Gateway to Remote MCP servers.

1458. **[MCP-oura](https://github.com/YuzeHao2023/MCP-oura)** - ⭐ 113
   MCP server for Oura API integration

1459. **[iphone-mcp](https://github.com/Lakr233/iphone-mcp)** - ⭐ 113
...
1460. **[Easy-MCP-AutoCad](https://github.com/zh19980811/Easy-MCP-AutoCad)** - ⭐ 113
   这个项目是一个基于Model Context Protocol (MCP)的AutoCAD集成服务器，它允许通过自然语言与AutoCAD进行交互。通过这个服务器，用户可以使用Claude等大型语言模型来创建、修改和分析AutoCAD图纸，同时还可以存储和查询CAD元素的相关数据。目前制作参考学习，仅实现端到端之间的通信，具体工具函数尚未晚上

1461. **[xcodeproj-mcp-server](https://github.com/giginet/xcodeproj-mcp-server)** - ⭐ 113
   A Model Context Protocol Server to manipulate *.xcodeproj

1462. **[swagger-mcp](https://github.com/dcolley/swagger-mcp)** - ⭐ 113
   Swagger to MCP server

1463. **[-mcp-to-skill-converter](https://github.com/GBSOSS/-mcp-to-skill-converter)** - ⭐ 113
      Convert any MCP server into a Claude Skill with 90% context savings

1464. **[server-google-news](https://github.com/ChanMeng666/server-google-news)** - ⭐ 113
   【Star-crossed coders unite!⭐️】Model Context Protocol (MCP) server implementation providing Google News search capabilities via SerpAPI, with automatic news categorization and multi-language support.

1465. **[polymarket-mcp](https://github.com/berlinbra/polymarket-mcp)** - ⭐ 113
   MCP Server for PolyMarket API

1466. **[mcp-hubspot](https://github.com/peakmojo/mcp-hubspot)** - ⭐ 112
   A Model Context Protocol (MCP) server that enables AI assistants to interact with HubSpot CRM data, providing built-in vector storage and caching mechanisms help overcome HubSpot API limitations while improving response times.

1467. **[ffmpeg-mcp](https://github.com/video-creator/ffmpeg-mcp)** - ⭐ 112
...
1468. **[netbox-mcp-server](https://github.com/netboxlabs/netbox-mcp-server)** - ⭐ 112
   Model Context Protocol (MCP) server for read-only interaction with NetBox data in LLMs

1469. **[foxy-contexts](https://github.com/strowk/foxy-contexts)** - ⭐ 112
   Foxy contexts is a library for building context servers supporting Model Context Protocol

1470. **[swiftlens](https://github.com/swiftlens/swiftlens)** - ⭐ 112
...
1471. **[google-sheets-mcp](https://github.com/mkummer225/google-sheets-mcp)** - ⭐ 112
   Google Sheets MCP Server 📊🤖

1472. **[railway-mcp-server](https://github.com/railwayapp/railway-mcp-server)** - ⭐ 112
   Official Railway MCP Server for interacting with your Railway account

1473. **[Wazuh-MCP-Server](https://github.com/gensecaihq/Wazuh-MCP-Server)** - ⭐ 112
...
1474. **[computer-control-mcp](https://github.com/AB498/computer-control-mcp)** - ⭐ 112
   MCP server that provides computer control capabilities, like mouse, keyboard, OCR, etc. using PyAutoGUI, RapidOCR, ONNXRuntime. Similar to 'computer-use' by Anthropic. With Zero External Dependencies.

1475. **[robloxstudio-mcp](https://github.com/boshyxd/robloxstudio-mcp)** - ⭐ 112
   Create agentic AI workflows in ROBLOX Studio

1476. **[nextcloud-mcp-server](https://github.com/cbcoutinho/nextcloud-mcp-server)** - ⭐ 112
   Nextcloud MCP Server

1477. **[MCP2Lambda](https://github.com/danilop/MCP2Lambda)** - ⭐ 111
   Run any AWS Lambda function as a Large Language Model (LLM) tool without code changes using Anthropic's Model Context Protocol (MCP).

1478. **[notion-mcp](https://github.com/ccabanillas/notion-mcp)** - ⭐ 111
   A Model Context Protocol (MCP) server implementation for Notion integration, providing a standardized interface for interacting with Notion's API.

1479. **[punkpeye_awesome-mcp-servers](https://github.com/MCP-Mirror/punkpeye_awesome-mcp-servers)** - ⭐ 111
   Mirror of https://github.com/punkpeye/awesome-mcp-servers

1480. **[Deepseek-Thinking-Claude-3.5-Sonnet-CLINE-MCP](https://github.com/newideas99/Deepseek-Thinking-Claude-3.5-Sonnet-CLINE-MCP)** - ⭐ 111
...
1481. **[remote-mcp-functions-python](https://github.com/Azure-Samples/remote-mcp-functions-python)** - ⭐ 111
   Getting Started with Remote MCP Servers using Azure Functions (Python)

1482. **[MCP-searxng](https://github.com/SecretiveShell/MCP-searxng)** - ⭐ 111
   MCP server for connecting agentic systems to search systems via searXNG

1483. **[spring-documentation-mcp-server](https://github.com/andrlange/spring-documentation-mcp-server)** - ⭐ 111
   Spring Boot based MCP Server provide full Spring Ecosystem Documentation for LLMs

1484. **[raindrop-mcp](https://github.com/adeze/raindrop-mcp)** - ⭐ 111
   Raindrop MCP Server

1485. **[exstruct](https://github.com/harumiWeb/exstruct)** - ⭐ 111
   Excel to structured JSON (tables, shapes, charts) for LLM/RAG pipelines

1486. **[pentest-mcp](https://github.com/DMontgomery40/pentest-mcp)** - ⭐ 111
   NOT for educational purposes: An MCP server for professional penetration testers including STDIO/HTTP/SSE support, nmap, go/dirbuster, nikto, JtR, hashcat, wordlist building, and more.

1487. **[web-scout-mcp](https://github.com/pinkpixel-dev/web-scout-mcp)** - ⭐ 111
   A powerful MCP server extension providing web search and content extraction capabilities. Integrates DuckDuckGo search functionality and URL content extraction into your MCP environment, enabling AI assistants to search the web and extract webpage content programmatically.

1488. **[mcp-checkpoint](https://github.com/aira-security/mcp-checkpoint)** - ⭐ 110
...
1489. **[mcpauth](https://github.com/mcpauth/mcpauth)** - ⭐ 110
   Authentication for MCP Servers

1490. **[mcp-jfrog](https://github.com/jfrog/mcp-jfrog)** - ⭐ 110
   Model Context Protocol (MCP) Server for the JFrog Platform API, enabling repository management, build tracking, release lifecycle management, and more.

1491. **[livebook_tools](https://github.com/thmsmlr/livebook_tools)** - ⭐ 110
   Powertools for livebook.dev — AI Code Editing, MCP Servers, and Running Livebooks from the CLI

1492. **[vscode-as-mcp-server](https://github.com/acomagu/vscode-as-mcp-server)** - ⭐ 110
...
1493. **[dash-mcp-server](https://github.com/Kapeli/dash-mcp-server)** - ⭐ 110
   MCP server for Dash, the macOS documentation browser

1494. **[gRPC-zig](https://github.com/ziglana/gRPC-zig)** - ⭐ 110
   blazigly fast gRPC/MCP client & server implementation in zig

1495. **[server-wp-mcp](https://github.com/emzimmer/server-wp-mcp)** - ⭐ 109

1496. **[crypto-indicators-mcp](https://github.com/kukapay/crypto-indicators-mcp)** - ⭐ 109
   An MCP server providing a range of cryptocurrency technical analysis indicators and strategies.

1497. **[ai-command](https://github.com/mcp-wp/ai-command)** - ⭐ 109
   Control WordPress using WP-CLI, AI, and MCP.

1498. **[modex](https://github.com/theronic/modex)** - ⭐ 109
   Modex is a Clojure MCP Library to augment your AI models with Tools, Resources & Prompts using Clojure (Model Context Protocol). Implements MCP Server & Client.

1499. **[hevy-mcp](https://github.com/chrisdoc/hevy-mcp)** - ⭐ 109
   Manage your Hevy workouts, routines, folders, and exercise templates. Create and update sessions faster, organize plans, and search exercises to build workouts quickly. Stay synced with changes so your training log is always up to date.

1500. **[game-asset-mcp](https://github.com/MubarakHAlketbi/game-asset-mcp)** - ⭐ 109
   An MCP server for creating 2D/3D game assets from text using Hugging Face AI models.

1501. **[comet-mcp](https://github.com/hanzili/comet-mcp)** - ⭐ 109
   MCP Server connecting to Perplexity Comet browser

1502. **[DINO-X-MCP](https://github.com/IDEA-Research/DINO-X-MCP)** - ⭐ 108
   Official DINO-X Model Context Protocol (MCP) server that empowers LLMs with real-world visual perception through image object detection, localization, and captioning APIs.

1503. **[share-best-mcp](https://github.com/shareAI-lab/share-best-mcp)** - ⭐ 108
   世界上最好的MCP Servers的列表,The best mcp servers in the world.

1504. **[minesweeper-mcp-server](https://github.com/tonypan2/minesweeper-mcp-server)** - ⭐ 108
   An MCP server for playing Minesweeper

1505. **[asyncmcp](https://github.com/bh-rat/asyncmcp)** - ⭐ 108
   Async transport layers for MCP

1506. **[mcp_client](https://github.com/theailanguage/mcp_client)** - ⭐ 108
   MCP Client Implementation using Python, LangGraph and Gemini

1507. **[oracle-mcp-server](https://github.com/danielmeppiel/oracle-mcp-server)** - ⭐ 108
   MCP Server for working with large Oracle databases

1508. **[aks-mcp](https://github.com/Azure/aks-mcp)** - ⭐ 108
   A Model Context Protocol (MCP) server that enables AI assistants to interact with AKS clusters. It serves as a bridge between AI tools (like Claude, Cursor, and GitHub Copilot) and AKS.

1509. **[Taiwan-Health-MCP](https://github.com/healthymind-tech/Taiwan-Health-MCP)** - ⭐ 108

1510. **[UnityMCPIntegration](https://github.com/quazaai/UnityMCPIntegration)** - ⭐ 108
   Enable AI Agents to Control Unity

1511. **[portainer-mcp](https://github.com/portainer/portainer-mcp)** - ⭐ 108
   Portainer MCP server

1512. **[kibitz](https://github.com/nick1udwig/kibitz)** - ⭐ 107
   The coding agent for professionals

1513. **[slack-mcp-server](https://github.com/ubie-oss/slack-mcp-server)** - ⭐ 107
   A Slack MCP server

1514. **[Hegelion](https://github.com/Hmbown/Hegelion)** - ⭐ 107
   Dialectical reasoning architecture for LLMs (Thesis → Antithesis → Synthesis)

1515. **[selfhosted-supabase-mcp](https://github.com/HenkDz/selfhosted-supabase-mcp)** - ⭐ 107
   An MCP Server for your Self Hosted Supabase

1516. **[mcp-tool-kit](https://github.com/getfounded/mcp-tool-kit)** - ⭐ 107
   Agentic abstraction layer for building high precision vertical AI agents written in python for Model Context Protocol.

1517. **[payloadcmsmcp](https://github.com/disruption-hub/payloadcmsmcp)** - ⭐ 107
   Payload CMS MCP Server

1518. **[gemini-cli-mcp-server](https://github.com/centminmod/gemini-cli-mcp-server)** - ⭐ 107

1519. **[ableton-mcp-extended](https://github.com/uisato/ableton-mcp-extended)** - ⭐ 107
   Ableton Live MCP (Model Context Protocol) server that allows control directly through AI assistants.

1520. **[memov](https://github.com/memovai/memov)** - ⭐ 107
   Give git-like & traceable memory to any coding agents and OpenClaw(Moltbot, Clawdbot). By https://memov.ai/

1521. **[apple-rag-mcp](https://github.com/BingoWon/apple-rag-mcp)** - ⭐ 106
    MCP server providing AI agents with instant access to Apple developer documentation via RAG technology

1522. **[mcp-probe](https://github.com/conikeec/mcp-probe)** - ⭐ 106
   A Model Context Protocol (MCP) client library and debugging toolkit in Rust. This foundation provides both a production-ready SDK for building MCP integrations and the core architecture for an interactive debugger.

1523. **[mcp-client](https://github.com/punkpeye/mcp-client)** - ⭐ 106
   An MCP client for Node.js.

1524. **[Financial-Modeling-Prep-MCP-Server](https://github.com/imbenrabi/Financial-Modeling-Prep-MCP-Server)** - ⭐ 106
   A Model Context Protocol (MCP) implementation for Financial Modeling Prep, enabling AI assistants to access and analyze financial data, stock information, company fundamentals, and market insights.

1525. **[augments-mcp-server](https://github.com/augmnt/augments-mcp-server)** - ⭐ 106
   Comprehensive MCP server providing real-time framework documentation access for Claude Code with intelligent caching, multi-source integration, and context-aware assistance.

1526. **[toolhive-studio](https://github.com/stacklok/toolhive-studio)** - ⭐ 106
   ToolHive is an application that allows you to install, manage and run MCP servers and connect them to AI agents

1527. **[Fabric-Analytics-MCP](https://github.com/santhoshravindran7/Fabric-Analytics-MCP)** - ⭐ 105
...
1528. **[mcp](https://github.com/frappe/mcp)** - ⭐ 105
   Frappe MCP allows Frappe apps to function as MCP servers

1529. **[mcp-prompts](https://github.com/sparesparrow/mcp-prompts)** - ⭐ 105
   Model Context Protocol server for managing, storing, and providing prompts and prompt templates for LLM interactions. 

1530. **[mcp-server-atlassian-bitbucket](https://github.com/aashari/mcp-server-atlassian-bitbucket)** - ⭐ 105
   Node.js/TypeScript MCP server for Atlassian Bitbucket. Enables AI systems (LLMs) to interact with workspaces, repositories, and pull requests via tools (list, get, comment, search). Connects AI directly to version control workflows through the standard MCP interface.

1531. **[flowlens-mcp-server](https://github.com/magentic/flowlens-mcp-server)** - ⭐ 105
...
1532. **[ZipAgent](https://github.com/JiayuXu0/ZipAgent)** - ⭐ 104
   轻量级AI Agent框架，让你5分钟构建专属智能助手。Lightweight AI Agent framework. Build your AI assistant in 5 minutes.

1533. **[mcp.science](https://github.com/pathintegral-institute/mcp.science)** - ⭐ 104
   Open Source MCP Servers for Scientific Research

1534. **[sourcerer-mcp](https://github.com/st3v3nmw/sourcerer-mcp)** - ⭐ 104
   MCP for semantic code search & navigation that reduces token waste

1535. **[agentcare-mcp](https://github.com/Kartha-AI/agentcare-mcp)** - ⭐ 104
   MCP Server for EMRs with FHIR

1536. **[csharp-runner](https://github.com/sdcb/csharp-runner)** - ⭐ 104
   fast, secure c# runner

1537. **[freqtrade-mcp](https://github.com/kukapay/freqtrade-mcp)** - ⭐ 104
   An MCP server that integrates with the Freqtrade cryptocurrency trading bot.

1538. **[mcp-virustotal](https://github.com/BurtTheCoder/mcp-virustotal)** - ⭐ 104
   A Model Context Protocol (MCP) server for querying the VirusTotal API.

1539. **[typescript-utcp](https://github.com/universal-tool-calling-protocol/typescript-utcp)** - ⭐ 104
...
1540. **[typst-mcp](https://github.com/johannesbrandenburger/typst-mcp)** - ⭐ 104
   Typst MCP Server is an MCP (Model Context Protocol) implementation that helps AI models interact with Typst, a markup-based typesetting system. The server provides tools for converting between LaTeX and Typst, validating Typst syntax, and generating images from Typst code.

1541. **[awesome-context-engineering](https://github.com/jihoo-kim/awesome-context-engineering)** - ⭐ 104
...
1542. **[template-repo](https://github.com/AndrewAltimit/template-repo)** - ⭐ 104
...
1543. **[mcpm](https://github.com/MCP-Club/mcpm)** - ⭐ 104
...
1544. **[gemini-desktop](https://github.com/kkrishnan90/gemini-desktop)** - ⭐ 103
...
1545. **[smileyCoin](https://github.com/fefergrgrgrg/smileyCoin)** - ⭐ 103
   simple web ui to manage mcp (model context protocol) servers in the claude app

1546. **[memory-bank-MCP](https://github.com/tuncer-byte/memory-bank-MCP)** - ⭐ 103
...
1547. **[solana-mcp](https://github.com/solanamcp/solana-mcp)** - ⭐ 103
   Solana Agent Kit MCP Server 

1548. **[GenesisCore](https://github.com/AIGODLIKE/GenesisCore)** - ⭐ 103
   One click installation! BlenderMCP tool that supports DeepSeek, Claude, and others, fully integrated into Blender!

1549. **[ARIES](https://github.com/Chieko-Seren/ARIES)** - ⭐ 103
...
1550. **[http-oauth-mcp-server](https://github.com/NapthaAI/http-oauth-mcp-server)** - ⭐ 103
...
1551. **[chronulus-mcp](https://github.com/ChronulusAI/chronulus-mcp)** - ⭐ 103
   MCP Server for Chronulus AI Forecasting and Prediction Agents

1552. **[vectorize-mcp-server](https://github.com/vectorize-io/vectorize-mcp-server)** - ⭐ 103
   Official Vectorize MCP Server

1553. **[awesome-x402](https://github.com/xpaysh/awesome-x402)** - ⭐ 103
   🚀 Curated list of x402 resources: HTTP 402 Payment Required protocol for blockchain payments, crypto micropayments, AI agents, API monetization. Includes SDKs (TypeScript, Python, Rust), examples, facilitators (Coinbase, Cloudflare), MCP integration, tutorials. Accept USDC payments with one line of code. Perfect for AI agent economy.

1554. **[IntelliConnect](https://github.com/ruanrongman/IntelliConnect)** - ⭐ 103
   本项目为xiaozhi-esp32提供后端服务  |  A Powerful AI agent IoT platform core.

1555. **[memory-mcp-server](https://github.com/okooo5km/memory-mcp-server)** - ⭐ 102
   A Model Context Protocol server that provides knowledge graph management capabilities. 

1556. **[erickwendel-contributions-mcp](https://github.com/ErickWendel/erickwendel-contributions-mcp)** - ⭐ 102
   A Model Context Protocol (MCP) server that provides tools to query Erick Wendel's contributions across different platforms

1557. **[a2a-mcp-tutorial](https://github.com/Tsadoq/a2a-mcp-tutorial)** - ⭐ 102
   A tutorial on how to use Model Context Protocol by Anthropic and Agent2Agent Protocol by Google

1558. **[remote-mcp-functions](https://github.com/Azure-Samples/remote-mcp-functions)** - ⭐ 102
   Landing page for Remote MCP Server efforts in Azure Functions with links to all language stack specific repos.

1559. **[deep-code-reasoning-mcp](https://github.com/haasonsaas/deep-code-reasoning-mcp)** - ⭐ 102
   A Model Context Protocol (MCP) server that provides advanced code analysis and reasoning capabilities powered by Google's Gemini AI

1560. **[mcp-shodan](https://github.com/BurtTheCoder/mcp-shodan)** - ⭐ 102
   MCP server for querying the Shodan API

1561. **[JavaSinkTracer_MCP](https://github.com/Zacarx/JavaSinkTracer_MCP)** - ⭐ 102
   基于函数级污点分析的 Java 源代码漏洞审计工具JavaSinkTracer，通过 Model Context Protocol (MCP) 为 AI 助手提供安全分析能力。

1562. **[finance-trading-ai-agents-mcp](https://github.com/aitrados/finance-trading-ai-agents-mcp)** - ⭐ 102
...
1563. **[apple-health-mcp-server](https://github.com/the-momentum/apple-health-mcp-server)** - ⭐ 102
   MCP server for querying Apple Health data with natural language using DuckDB under the hood.

1564. **[neurolink](https://github.com/juspay/neurolink)** - ⭐ 101
   Universal AI Development Platform with MCP server integration, multi-provider support, and professional CLI. Build, test, and deploy AI applications with multiple ai providers.

1565. **[btp-sap-odata-to-mcp-server](https://github.com/lemaiwo/btp-sap-odata-to-mcp-server)** - ⭐ 101
   BTP CloudFoundry Node.js MCP server for SAP OData services integration

1566. **[alibabacloud-ack-mcp-server](https://github.com/aliyun/alibabacloud-ack-mcp-server)** - ⭐ 101
...
1567. **[linggen](https://github.com/linggen/linggen)** - ⭐ 101
   A local-first memory layer for AI (Cursor, Zed, Claude). Persistent architectural context via semantic search.

1568. **[mcp-toolkit](https://github.com/nuxt-modules/mcp-toolkit)** - ⭐ 101
   Create MCP servers directly in your Nuxt application. Define tools, resources, and prompts with a simple and intuitive API.

1569. **[sqlite-explorer-fastmcp-mcp-server](https://github.com/hannesrudolph/sqlite-explorer-fastmcp-mcp-server)** - ⭐ 100
   An MCP server that provides safe, read-only access to SQLite databases through Model Context Protocol (MCP). This server is built with the FastMCP framework, which enables LLMs to explore and query SQLite databases with built-in safety features and query validation.

1570. **[claude-code-mcp-enhanced](https://github.com/grahama1970/claude-code-mcp-enhanced)** - ⭐ 100
...
1571. **[mcp-hono-stateless](https://github.com/mhart/mcp-hono-stateless)** - ⭐ 100
   An example Hono MCP server using Streamable HTTP

1572. **[AgentBoard](https://github.com/igrigorik/AgentBoard)** - ⭐ 100
...
1573. **[autodev-codebase](https://github.com/anrgct/autodev-codebase)** - ⭐ 100
...
1574. **[complete-intro-to-mcp](https://github.com/btholt/complete-intro-to-mcp)** - ⭐ 100
   The Complete Intro to MCP Servers, as taught for Frontend Masters by Brian Holt

1575. **[pocketbase-mcp](https://github.com/mrwyndham/pocketbase-mcp)** - ⭐ 100
   MCP server for building PocketBase apps really quickly - Need a front end quick consider FastPocket

1576. **[mcp-screenshot-website-fast](https://github.com/just-every/mcp-screenshot-website-fast)** - ⭐ 100
   Quickly screenshots webpages and converts to an LLM friendly size

1577. **[gtasks-mcp](https://github.com/zcaceres/gtasks-mcp)** - ⭐ 100
   A Google Tasks Model Context Protocol Server for Claude

1578. **[seline](https://github.com/tercumantanumut/seline)** - ⭐ 100
   seline agent with a style

1579. **[akshare-one-mcp](https://github.com/zwldarren/akshare-one-mcp)** - ⭐ 100
   MCP server that provides access to Chinese stock market data using akshare-one

1580. **[sample-agentic-ai-demos](https://github.com/aws-samples/sample-agentic-ai-demos)** - ⭐ 99
   Collection of examples of how to use Model Context Protocol with AWS.

1581. **[mcp-windows-desktop-automation](https://github.com/mario-andreschak/mcp-windows-desktop-automation)** - ⭐ 99
   A Model Context Protocol (MCP) server for Windows desktop automation using AutoIt.

1582. **[next-mcp-server](https://github.com/vertile-ai/next-mcp-server)** - ⭐ 99
   Help LLMs to understand your Next apps better

1583. **[turbular](https://github.com/raeudigerRaeffi/turbular)** - ⭐ 99
   A MCP server allowing LLM agents to easily connect and retrieve data from any database

1584. **[pywss](https://github.com/czasg/pywss)** - ⭐ 99
   一个轻量级的 Python Web 框架，一站式集成 MCP SSE、StreamHTTP 和 MCPO 协议，助你轻松构建MCP Server🔥

1585. **[mighty-security](https://github.com/NineSunsInc/mighty-security)** - ⭐ 99
   Don't Simply Trust MCP Server Code, Validate and Scan

1586. **[academic-search-mcp-server](https://github.com/afrise/academic-search-mcp-server)** - ⭐ 99
...
1587. **[mcp](https://github.com/taskade/mcp)** - ⭐ 99
   🤖 Taskade MCP · Official MCP server and OpenAPI to MCP codegen. Build AI agent tools from any OpenAPI API and connect to Claude, Cursor, and more.

1588. **[mcp-server](https://github.com/webflow/mcp-server)** - ⭐ 99
   Model Context Protocol (MCP) server for the Webflow Data API.

1589. **[mcp-local-rag](https://github.com/nkapila6/mcp-local-rag)** - ⭐ 99
   "primitive" RAG-like web search model context protocol (MCP) server that runs locally. ✨ no APIs ✨

1590. **[mcp_on_ruby](https://github.com/rubyonai/mcp_on_ruby)** - ⭐ 98
   💎 A Ruby implementation of the Model Context Protocol

1591. **[atomic-red-team-mcp](https://github.com/cyberbuff/atomic-red-team-mcp)** - ⭐ 98
   MCP server for Atomic Red Team

1592. **[mcp-client-nodejs](https://github.com/ConardLi/mcp-client-nodejs)** - ⭐ 98
   Node.js Client Implementation for Model Context Protocol (MCP)

1593. **[mysql-mcp-server-sse](https://github.com/mangooer/mysql-mcp-server-sse)** - ⭐ 98
...
1594. **[anki-mcp-server](https://github.com/ankimcp/anki-mcp-server)** - ⭐ 98
   A Model Context Protocol (MCP) server that enables AI assistants to interact with Anki, the spaced repetition flashcard application.

1595. **[MiniMax-MCP-JS](https://github.com/MiniMax-AI/MiniMax-MCP-JS)** - ⭐ 98
   Official MiniMax Model Context Protocol (MCP) JavaScript implementation that provides seamless integration with MiniMax's powerful AI capabilities including image generation, video generation, text-to-speech, and voice cloning APIs.

1596. **[mcp-sse-demo](https://github.com/cnych/mcp-sse-demo)** - ⭐ 97
   claude mcp sse demo with server and client(cli、web)

1597. **[gemini-mcp-desktop-client](https://github.com/duke7able/gemini-mcp-desktop-client)** - ⭐ 97
   first gemini based desktop client for MCP

1598. **[searxng-mul-mcp](https://github.com/jae-jae/searxng-mul-mcp)** - ⭐ 97
   A Model Context Protocol (MCP) server for SearXNG search engine with multi-query parallel search support

1599. **[lapras-mcp-server](https://github.com/lapras-inc/lapras-mcp-server)** - ⭐ 97
   lapras.com 公式MCP Server

1600. **[github-stars](https://github.com/miantiao-me/github-stars)** - ⭐ 97
   A Cloudflare-powered MCP (Model Context Protocol) Server that allows you to search and query your GitHub starred repositories using natural language.

1601. **[terminal-controller-mcp](https://github.com/GongRzhe/terminal-controller-mcp)** - ⭐ 97
   A Model Context Protocol (MCP) server that enables secure terminal command execution, directory navigation, and file system operations through a standardized interface.

1602. **[go-utcp](https://github.com/universal-tool-calling-protocol/go-utcp)** - ⭐ 97
    Official Go implementation of the UTCP 

1603. **[mcp-typescript-sdk](https://github.com/emqx/mcp-typescript-sdk)** - ⭐ 97
   A TypeScript SDK for implementing Model Context Protocol (MCP) over MQTT, supporting both browser and Node.js environments.

1604. **[powerbi-mcp](https://github.com/sulaiman013/powerbi-mcp)** - ⭐ 97
   MCP server for natural language interaction with Power BI datasets

1605. **[all-in-one-model-context-protocol](https://github.com/nguyenvanduocit/all-in-one-model-context-protocol)** - ⭐ 97
   🚀 All-in-one MCP server with AI search, RAG, and multi-service integrations (GitLab/Jira/Confluence/YouTube) for AI-enhanced development workflows

1606. **[systemprompt-mcp-server](https://github.com/systempromptio/systemprompt-mcp-server)** - ⭐ 97
...
1607. **[gis-mcp](https://github.com/mahdin75/gis-mcp)** - ⭐ 97
   A Model Context Protocol (MCP) server implementation that connects Large Language Models (LLMs) to GIS operations using GIS libraries, enabling AI assistants to perform geospatial operations and transformations.

1608. **[heimdall-mcp-server](https://github.com/lcbcFoo/heimdall-mcp-server)** - ⭐ 96
   Your AI Coding Assistant's Long-Term Memory

1609. **[godoc-mcp](https://github.com/mrjoshuak/godoc-mcp)** - ⭐ 96
   go doc mcp server

1610. **[mcp-kit](https://github.com/my-mcp-hub/mcp-kit)** - ⭐ 96
   A CLI tool to create MCP (Model Context Protocol) applications with ease.

1611. **[langgraph-ai](https://github.com/piyushagni5/langgraph-ai)** - ⭐ 96
   LangGraph AI Repository

1612. **[sandbox-mcp](https://github.com/pottekkat/sandbox-mcp)** - ⭐ 96
   A Model Context Protocol (MCP) server that enables LLMs to run ANY code safely in isolated Docker containers.

1613. **[Vibe-Coder-MCP](https://github.com/freshtechbro/Vibe-Coder-MCP)** - ⭐ 96
    Vibe-Coder-MCP server extends AI assistants with specialized software development tools.

1614. **[mcp-graphiti](https://github.com/rawr-ai/mcp-graphiti)** - ⭐ 96
   Graphiti Model Context Protocol (MCP) Server - An MCP server for knowledge graph management via Graphiti

1615. **[code-pathfinder](https://github.com/shivasurya/code-pathfinder)** - ⭐ 96
...
1616. **[awesome-mcp-enterprise](https://github.com/bh-rat/awesome-mcp-enterprise)** - ⭐ 95
   A curated list of awesome MCP (Model Context Protocol) tools, platforms, and services for enterprises.

1617. **[api2mcp4j](https://github.com/TheEterna/api2mcp4j)** - ⭐ 95
...
1618. **[gossiphs](https://github.com/williamfzc/gossiphs)** - ⭐ 95
...
1619. **[wanaku](https://github.com/wanaku-ai/wanaku)** - ⭐ 95
   Wanaku MCP Router

1620. **[rust-docs-mcp](https://github.com/snowmead/rust-docs-mcp)** - ⭐ 95
   MCP server for agents to explore rust docs, analyze source code, and build with confidence

1621. **[alibaba-cloud-ops-mcp-server](https://github.com/aliyun/alibaba-cloud-ops-mcp-server)** - ⭐ 95
   AlibabaCloud CloudOps MCP Server

1622. **[falcon-mcp](https://github.com/CrowdStrike/falcon-mcp)** - ⭐ 95
   Connect AI agents to CrowdStrike Falcon for automated security analysis and threat hunting

1623. **[FirstData](https://github.com/MLT-OSS/FirstData)** - ⭐ 95
   The World's Most Comprehensive, Authoritative, and Structured Open Source Data Source Knowledge Base

1624. **[ruby-mcp-client](https://github.com/simonx1/ruby-mcp-client)** - ⭐ 94
   This is a Ruby implementation of MCP (Model Context Protocol) client

1625. **[opencv-mcp-server](https://github.com/GongRzhe/opencv-mcp-server)** - ⭐ 94
...
1626. **[editor-mcp-server](https://github.com/playcanvas/editor-mcp-server)** - ⭐ 94
   MCP Server for AI automation of the PlayCanvas Editor

1627. **[ToolsForMCPServer](https://github.com/tanaikech/ToolsForMCPServer)** - ⭐ 94
   The Gemini CLI confirmed that the MCP server built with Google Apps Script (GAS), a low-code platform, offers immense possibilities. If you've created snippets for GAS, these could be revitalized and/or leveraged in new ways by using them as the MCP server. The Gemini CLI and other MCP clients will be useful in achieving this.

1628. **[infobus-mcp](https://github.com/simovilab/infobus-mcp)** - ⭐ 93
   Model Context Protocol server enabling AI assistants to access transit information through standardized interfaces

1629. **[elektron-mcp](https://github.com/zerubeus/elektron-mcp)** - ⭐ 93
   MCP sever for controlling Elektron devices using LLMs

1630. **[MasterMCP](https://github.com/slowmist/MasterMCP)** - ⭐ 93
...
1631. **[mcp-replicate](https://github.com/deepfates/mcp-replicate)** - ⭐ 93
   Model Context Protocol server for Replicate's API

1632. **[gospy](https://github.com/monsterxx03/gospy)** - ⭐ 93
   Non-Invasive goroutine inspector

1633. **[brave-search-mcp](https://github.com/mikechao/brave-search-mcp)** - ⭐ 93
...
1634. **[agents](https://github.com/astronomer/agents)** - ⭐ 93
   AI agent tooling for data engineering workflows.

1635. **[mcp-server-idapro](https://github.com/fdrechsler/mcp-server-idapro)** - ⭐ 92
   A Model Context Protocol (MCP) server that enables AI assistants to interact with IDA Pro for reverse engineering and binary analysis tasks.

1636. **[mcp-server](https://github.com/OctopusDeploy/mcp-server)** - ⭐ 92
   Octopus Deploy Official MCP Server

1637. **[snippy](https://github.com/Azure-Samples/snippy)** - ⭐ 92
...
1638. **[a2ajava](https://github.com/vishalmysore/a2ajava)** - ⭐ 92
...
1639. **[open-mcp-auth-proxy](https://github.com/wso2/open-mcp-auth-proxy)** - ⭐ 92
   Authentication and Authorization Proxy for MCP Servers

1640. **[yfinance-mcp](https://github.com/narumiruna/yfinance-mcp)** - ⭐ 92

1641. **[needle-mcp](https://github.com/needle-ai/needle-mcp)** - ⭐ 92
   Needle MCP Server for easy RAG.Long-term memory for LLMs.

1642. **[AgentUp](https://github.com/always-further/AgentUp)** - ⭐ 92
   Portable , scalable , secure AI Agents

1643. **[google-tag-manager-mcp-server](https://github.com/stape-io/google-tag-manager-mcp-server)** - ⭐ 92
   MCP server for Google Tag Manager

1644. **[zed-mcp-server-context7](https://github.com/akbxr/zed-mcp-server-context7)** - ⭐ 92
   Context7 MCP Server for Zed

1645. **[diagram-mcp-server](https://github.com/andrewmoshu/diagram-mcp-server)** - ⭐ 92
   An MCP server that seamlessly creates infrastructure diagrams for AWS, Azure, GCP, Kubernetes and more

1646. **[square-mcp-server](https://github.com/square/square-mcp-server)** - ⭐ 91
   A Model Context Protocol (MCP) server for square

1647. **[sparql-llm](https://github.com/sib-swiss/sparql-llm)** - ⭐ 91
   🦜✨ Chat system, MCP server, and reusable components to improve LLMs capabilities when generating SPARQL queries

1648. **[octagon-mcp-server](https://github.com/OctagonAI/octagon-mcp-server)** - ⭐ 91
...
1649. **[pluggedin-app](https://github.com/VeriTeknik/pluggedin-app)** - ⭐ 91
   The Crossroads for AI Data Exchanges. A unified, self-hostable web interface for discovering, configuring, and managing Model Context Protocol (MCP) servers—bringing together AI tools, workspaces, prompts, and logs from multiple MCP sources (Claude, Cursor, etc.) under one roof.

1650. **[litegraph](https://github.com/litegraphdb/litegraph)** - ⭐ 91
...
1651. **[mcpcat-typescript-sdk](https://github.com/MCPCat/mcpcat-typescript-sdk)** - ⭐ 90
   MCPcat is an analytics platform for MCP server owners 🐱.

1652. **[model-context-protocol-mcp-hands-on-with-agentic-ai-2034200](https://github.com/LinkedInLearning/model-context-protocol-mcp-hands-on-with-agentic-ai-2034200)** - ⭐ 90
...
1653. **[mcp-trino](https://github.com/tuannvm/mcp-trino)** - ⭐ 90
   A high-performance Model Context Protocol (MCP) server for Trino implemented in Go.

1654. **[openai-gpt-image-mcp](https://github.com/SureScaleAI/openai-gpt-image-mcp)** - ⭐ 90
   A Model Context Protocol (MCP) tool server for OpenAI's GPT-4o/gpt-image-1 image generation and editing APIs.

1655. **[spring-ai-playground](https://github.com/spring-ai-community/spring-ai-playground)** - ⭐ 89
...
1656. **[mikrotik-mcp](https://github.com/jeff-nasseri/mikrotik-mcp)** - ⭐ 89
   MCP server for Mikrotik

1657. **[flexible-graphrag](https://github.com/stevereiner/flexible-graphrag)** - ⭐ 89
...
1658. **[outline-mcp-server](https://github.com/mmmeff/outline-mcp-server)** - ⭐ 89
   It's an MCP server... for Outline (the documentation platform!)

1659. **[splunk-mcp](https://github.com/livehybrid/splunk-mcp)** - ⭐ 89
   A Model Context Protocol (MCP) implementation for Splunk Enterprise and Cloud integration with Cursor IDE or Claude

1660. **[molecule-mcp](https://github.com/ChatMol/molecule-mcp)** - ⭐ 88
   A model-context-protocol server for molecules.

1661. **[mcp-server-and-gw](https://github.com/boilingdata/mcp-server-and-gw)** - ⭐ 88
   An MCP stdio to HTTP SSE transport gateway with example server and MCP client

1662. **[mcp-memory-keeper](https://github.com/mkreyman/mcp-memory-keeper)** - ⭐ 88
   MCP server for persistent context management in AI coding assistants

1663. **[deepl-mcp-server](https://github.com/DeepLcom/deepl-mcp-server)** - ⭐ 88
   A Model Context Protocol (MCP) server that provides translation capabilities using the DeepL API.

1664. **[IB_MCP](https://github.com/rcontesti/IB_MCP)** - ⭐ 88
   This project provides an Interactive Brokers (IB) API interface using the Model Context Protocol (MCP).

1665. **[semantic-scholar-fastmcp-mcp-server](https://github.com/zongmin-yu/semantic-scholar-fastmcp-mcp-server)** - ⭐ 88
   A FastMCP server implementation for the Semantic Scholar API, providing comprehensive access to academic paper data, author information, and citation networks.

1666. **[mcp-agent](https://github.com/Haohao-end/mcp-agent)** - ⭐ 87
   A modular Python framework implementing the Model Context Protocol (MCP). It features a standardized client-server architecture over StdIO, integrating LLMs with external tools, real-time weather data fetching, and an advanced RAG (Retrieval-Augmented Generation) system.

1667. **[mcp-python-interpreter](https://github.com/yzfly/mcp-python-interpreter)** - ⭐ 87
   MCP Python Interpreter: run python code. Python-mcp-server, mcp-python-server, Code Executor

1668. **[vibe](https://github.com/michiosw/vibe)** - ⭐ 87
   Open-Source AI-powered web browser. Browse the web with your own LLM API key. Alternative to Dia / Comet.

1669. **[mem0-mcp](https://github.com/pinkpixel-dev/mem0-mcp)** - ⭐ 87
   ✨ mem0 MCP Server: A memory system using mem0 for AI applications with model context protocl (MCP) integration. Enables long-term memory for AI agents as a drop-in MCP server.

1670. **[chat-ui](https://github.com/AI-QL/chat-ui)** - ⭐ 87
...
1671. **[achatbot](https://github.com/ai-bot-pro/achatbot)** - ⭐ 87
...
1672. **[mcpgen](https://github.com/lyeslabs/mcpgen)** - ⭐ 87
   Generate Go MCP server boilerplate from OpenAPI 3 specifications

1673. **[schedcp](https://github.com/eunomia-bpf/schedcp)** - ⭐ 87
   MCP Server for Linux Scheduler Management and Auto optimization

1674. **[mcp-ui](https://github.com/machaojin1917939763/mcp-ui)** - ⭐ 87
   基于MCP(Model Context Protocol)的智能聊天应用，支持Web和桌面环境。集成OpenAI/Anthropic API，提供MCP服务器的所有工具能力。简洁现代的UI设计，支持跨平台部署。

1675. **[action_mcp](https://github.com/seuros/action_mcp)** - ⭐ 87
   Rails Engine with MCP compliant Spec.

1676. **[Matryoshka](https://github.com/yogthos/Matryoshka)** - ⭐ 87
   MCP server for token-efficient large document analysis via the use of REPL state

1677. **[arxiv-latex-mcp](https://github.com/takashiishida/arxiv-latex-mcp)** - ⭐ 87
   MCP server that uses arxiv-to-prompt to fetch and process arXiv LaTeX sources for precise interpretation of mathematical expressions in scientific papers.

1678. **[pinescript-mcp-server](https://github.com/cklose2000/pinescript-mcp-server)** - ⭐ 86
   A Model Context Protocol (MCP) server for working with TradingView PineScript

1679. **[react-agent-hooks](https://github.com/chuanqisun/react-agent-hooks)** - ⭐ 86
   Turn React hooks into LLM tools

1680. **[mcp-server-llamacloud](https://github.com/run-llama/mcp-server-llamacloud)** - ⭐ 86
   A MCP server connecting to managed indexes on LlamaCloud

1681. **[vggt-mps](https://github.com/jmanhype/vggt-mps)** - ⭐ 86
   VGGT 3D Vision Agent optimized for Apple Silicon with Metal Performance Shaders

1682. **[slidev-mcp](https://github.com/LSTM-Kirigaya/slidev-mcp)** - ⭐ 86
   mcp server for slidev to make web ppt quickly and elegantly

1683. **[awsome_kali_MCPServers](https://github.com/ccq1/awsome_kali_MCPServers)** - ⭐ 86
   awsome kali MCPServers is a set of MCP servers tailored for Kali Linux

1684. **[memory-mcp-server-go](https://github.com/okooo5km/memory-mcp-server-go)** - ⭐ 86
   A Model Context Protocol server that provides knowledge graph management capabilities.

1685. **[FrontAgent](https://github.com/ceilf6/FrontAgent)** - ⭐ 86
   AI agent platform for frontend engineering with SDD constraints & MCP-controlled automation. | 面向前端工程的企业级 AI Agent 平台

1686. **[awesome-openid-connect](https://github.com/cerberauth/awesome-openid-connect)** - ⭐ 86
...
1687. **[tiger-cli](https://github.com/timescale/tiger-cli)** - ⭐ 86
   Tiger CLI is the command-line interface for Tiger Cloud. It includes an MCP server for helping coding agents write production-level Postgres code.

1688. **[mcp-rest-api](https://github.com/dkmaker/mcp-rest-api)** - ⭐ 86
   A TypeScript-based MCP server that enables testing of REST APIs through Cline. This tool allows you to test and interact with any REST API endpoints directly from your development environment.

1689. **[apps-sdk-template](https://github.com/alpic-ai/apps-sdk-template)** - ⭐ 86
   A minimalist Typescript ChatGPT App based on the Skybridge framework

1690. **[browser-debugger-cli](https://github.com/szymdzum/browser-debugger-cli)** - ⭐ 86
   CLI tool for agents to quickly access browser telemetry (DOM, network, console) via Chrome DevTools Protocol.

1691. **[mcp-dbutils](https://github.com/donghao1393/mcp-dbutils)** - ⭐ 86
...
1692. **[github-stars](https://github.com/ccbikai/github-stars)** - ⭐ 85
   A Cloudflare-powered MCP (Model Context Protocol) Server that allows you to search and query your GitHub starred repositories using natural language.

1693. **[ragie-mcp-server](https://github.com/ragieai/ragie-mcp-server)** - ⭐ 85
   Ragie Model Context Protocol Server

1694. **[furi](https://github.com/ashwwwin/furi)** - ⭐ 85
   CLI & API for MCP management

1695. **[agent-tool-protocol](https://github.com/mondaycom/agent-tool-protocol)** - ⭐ 85
   Agent Tool Protocol

1696. **[paper-search-mcp-nodejs](https://github.com/Dianel555/paper-search-mcp-nodejs)** - ⭐ 85
...
1697. **[google_ads_mcp](https://github.com/google-marketing-solutions/google_ads_mcp)** - ⭐ 85
   The Google Ads MCP Server is an implementation of the Model Context Protocol (MCP) that enables Large Language Models (LLMs), such as Gemini, to interact directly with the Google Ads API.

1698. **[leetcode-mcp-server](https://github.com/jinzcdev/leetcode-mcp-server)** - ⭐ 85
   An MCP server enabling automated access to LeetCode's problems, solutions, and public data with optional authentication for user-specific features, supporting leetcode.com & leetcode.cn sites.

1699. **[mcp-dockmaster](https://github.com/dcSpark/mcp-dockmaster)** - ⭐ 84
...
1700. **[spiceflow](https://github.com/remorses/spiceflow)** - ⭐ 84
   Super Simple API framework, type safe, automatic OpenAPI, MCP support, client RPC, streaming with SSE

1701. **[fhir-mcp-server](https://github.com/wso2/fhir-mcp-server)** - ⭐ 84
   FHIR MCP Server – helping you expose any FHIR Server or API as a MCP Server.

1702. **[narsil-mcp](https://github.com/postrv/narsil-mcp)** - ⭐ 84
   Rust MCP server for comprehensive code intelligence - 90 tools, 32 languages, security scanning, call graphs, and more

1703. **[cve-search_mcp](https://github.com/roadwy/cve-search_mcp)** - ⭐ 84
   A Model Context Protocol (MCP) server for querying the CVE-Search API

1704. **[z-image-studio](https://github.com/iconben/z-image-studio)** - ⭐ 84
...
1705. **[mcp](https://github.com/twilio-labs/mcp)** - ⭐ 84
   Monorepo providing 1) OpenAPI to MCP Tool generator 2) Exposing all of Twilio's API as MCP Tools

1706. **[amap-mcp-server](https://github.com/sugarforever/amap-mcp-server)** - ⭐ 83
   高德地图MCP Server，支持stdio, sse和streamable-http

1707. **[mcp-node](https://github.com/algolia/mcp-node)** - ⭐ 83
   MCP server for interacting with Algolia

1708. **[Delphi-MCP-Server](https://github.com/GDKsoftware/Delphi-MCP-Server)** - ⭐ 83
   Native Delphi Server implementation of the Model Context Protocol (MCP)

1709. **[claude-swarm](https://github.com/cj-vana/claude-swarm)** - ⭐ 83
...
1710. **[mcp-memory-libsql](https://github.com/spences10/mcp-memory-libsql)** - ⭐ 82
   🧠 High-performance persistent memory system for Model Context Protocol (MCP) powered by libSQL. Features vector search, semantic knowledge storage, and efficient relationship management - perfect for AI agents and knowledge graph applications.

1711. **[mcp-n8n-builder](https://github.com/spences10/mcp-n8n-builder)** - ⭐ 82
   🪄 MCP server for programmatic creation and management of n8n workflows. Enables AI assistants to build, modify, and manage workflows without direct user intervention through a comprehensive set of tools and resources for interacting with n8n's REST API.

1712. **[legion-mcp](https://github.com/TheRaLabs/legion-mcp)** - ⭐ 82
   A server that helps people access and query data in databases using the Legion Query Runner with Model Context Protocol (MCP) in Python.

1713. **[mcp-github-project-manager](https://github.com/kunwarVivek/mcp-github-project-manager)** - ⭐ 82
   a mcp server to manage github project's functionality 

1714. **[xiaozhi-mcp-ha](https://github.com/mac8005/xiaozhi-mcp-ha)** - ⭐ 82
   A Home Assistant Custom Integration (HACS) that connects Xiaozhi ESP32 AI chatbot to Home Assistant via MCP

1715. **[Nano-Banana-MCP](https://github.com/ConechoAI/Nano-Banana-MCP)** - ⭐ 82
   A Nano Banana MCP server, which you can integrate to cursor/claude code and any mcp client

1716. **[mcp-sqlite](https://github.com/jparkerweb/mcp-sqlite)** - ⭐ 82
   🐇 Model Context Protocol (MCP) server that provides comprehensive SQLite database interaction capabilities

1717. **[mcp-local-rag](https://github.com/shinpr/mcp-local-rag)** - ⭐ 82
...
1718. **[viper](https://github.com/ozanunal0/viper)** - ⭐ 82
...
1719. **[agentic-stock-research-system](https://github.com/rooneyrulz/agentic-stock-research-system)** - ⭐ 82
...
1720. **[reddit-research-mcp](https://github.com/king-of-the-grackles/reddit-research-mcp)** - ⭐ 82
...
1721. **[FNewsCrawler](https://github.com/noimank/FNewsCrawler)** - ⭐ 82
   一个专门为大模型设计的财经信息MCP（Model Context Protocol）服务，通过高效的爬虫技术从各大财经网站（同花顺、东方财富等）获取实时资讯，为AI模型提供准确、及时的财经数据支持。

1722. **[node-candidate-mcp-server](https://github.com/jhgaylor/node-candidate-mcp-server)** - ⭐ 81
   A Model Context Protocol (MCP) server library that gives LLMs access to information about a candidate.

1723. **[mcp-rs-template](https://github.com/linux-china/mcp-rs-template)** - ⭐ 81
   Model Context Protocol (MCP) CLI server template for Rust

1724. **[sh-disney-mcp](https://github.com/syyuan14/sh-disney-mcp)** - ⭐ 81
   sh-disney-mcp 是一个基于 Model Context Protocol (MCP) 的mcp server，旨在通过标准化的接口，帮助大模型快速获取上海迪士尼乐园的门票价格和售卖状态信息

1725. **[mcphub](https://github.com/Cognitive-Stack/mcphub)** - ⭐ 81
...
1726. **[mcp-excel-server](https://github.com/yzfly/mcp-excel-server)** - ⭐ 81
...
1727. **[Awesome-Claude-MCP-Servers](https://github.com/win4r/Awesome-Claude-MCP-Servers)** - ⭐ 81
   A curated list of Model Context Protocol (MCP) servers optimized for Claude AI assistants.

1728. **[office-editor-mcp](https://github.com/theWDY/office-editor-mcp)** - ⭐ 81
   基于MCP(Model Context Protocol)的Office文档处理助手，支持在MCP Client中创建和编辑Word、Excel、Powerpoint文档。

1729. **[loki-mcp](https://github.com/grafana/loki-mcp)** - ⭐ 81
   An MCP ( Model Context Protocol ) Server for Grafana Loki

1730. **[context-sync](https://github.com/Intina47/context-sync)** - ⭐ 81
...
1731. **[idun-agent-platform](https://github.com/Idun-Group/idun-agent-platform)** - ⭐ 81
...
1732. **[identity](https://github.com/agntcy/identity)** - ⭐ 81
...
1733. **[QMT-MCP](https://github.com/guangxiangdebizi/QMT-MCP)** - ⭐ 81
    QMT-MCP 模块化量化交易助手

1734. **[dicom-mcp](https://github.com/ChristianHinge/dicom-mcp)** - ⭐ 81
   Model Context Protocol (MCP) for interacting with dicom servers (PACS etc.)

1735. **[perfetto-mcp](https://github.com/antarikshc/perfetto-mcp)** - ⭐ 81
...
1736. **[rohlik-mcp](https://github.com/tomaspavlin/rohlik-mcp)** - ⭐ 80
   MCP server that lets you shop groceries across the Rohlik Group platforms (Rohlik.cz, Knuspr.de, Gurkerl.at, Kifli.hu, Sezamo.ro)

1737. **[cursor-rust-tools](https://github.com/terhechte/cursor-rust-tools)** - ⭐ 80
   A MCP server to allow the LLM in Cursor to access Rust Analyzer, Crate Docs and Cargo Commands.

1738. **[mcp-server](https://github.com/keboola/mcp-server)** - ⭐ 80
   Model Context Protocol (MCP) Server for the Keboola Platform

1739. **[ramparts](https://github.com/highflame-ai/ramparts)** - ⭐ 80
   mcp scan that scans any mcp server for indirect attack vectors and security or configuration vulnerabilities

1740. **[mcp-server-stability-ai](https://github.com/tadasant/mcp-server-stability-ai)** - ⭐ 80
...
1741. **[aws-security-mcp](https://github.com/groovyBugify/aws-security-mcp)** - ⭐ 80
   A Model Context Protocol server that connects AI assistants like Claude to AWS security services, allowing them to autonomously query, inspect, and analyze AWS infrastructure for security issues and misconfigurations.

1742. **[MCPay](https://github.com/microchipgnu/MCPay)** - ⭐ 80
   Open-source Infrastructure for MCP and x402

1743. **[anki-mcp-server](https://github.com/CamdenClark/anki-mcp-server)** - ⭐ 80
   A model context protocol server that connects to Anki through AnkiConnect

1744. **[mcp-gateway](https://github.com/hyprmcp/mcp-gateway)** - ⭐ 80
...
1745. **[mcp-discovery](https://github.com/rust-mcp-stack/mcp-discovery)** - ⭐ 80
   A command-line tool written in Rust for discovering and documenting MCP Server capabilities.

1746. **[NASA-MCP-server](https://github.com/ProgramComputer/NASA-MCP-server)** - ⭐ 80
   A Model Context Protocol (MCP) server for NASA APIs, providing a standardized interface for AI models to interact with NASA's vast array of data sources.

1747. **[healthcare-mcp-public](https://github.com/Cicatriiz/healthcare-mcp-public)** - ⭐ 80
   A Model Context Protocol (MCP) server providing AI assistants with access to healthcare data and medical information tools, including FDA drug info, PubMed, medRxiv, NCBI Bookshelf, clinical trials, ICD-10, DICOM metadata, and a medical calculator.

1748. **[oxylabs-mcp](https://github.com/oxylabs/oxylabs-mcp)** - ⭐ 80
   Official Oxylabs MCP integration

1749. **[mcp-outline](https://github.com/Vortiago/mcp-outline)** - ⭐ 80
   A Model Context Protocol (MCP) server enabling AI assistants to interact with Outline documentation services.

1750. **[anubis-mcp](https://github.com/zoedsoupe/anubis-mcp)** - ⭐ 80
   Elixir Model Context Protocol (MCP) SDK (hermes-mcp fork)

1751. **[fastmcp-boilerplate](https://github.com/punkpeye/fastmcp-boilerplate)** - ⭐ 79
   A simple MCP server built using FastMCP, TypeScript, ESLint, and Prettier.

1752. **[github-chat-mcp](https://github.com/AsyncFuncAI/github-chat-mcp)** - ⭐ 79
   A Model Context Protocol (MCP) for analyzing and querying GitHub repositories using the GitHub Chat API.

1753. **[codemirror-mcp](https://github.com/marimo-team/codemirror-mcp)** - ⭐ 79
   CodeMirror extension to hook up a Model Context Provider (MCP)

1754. **[jira-mcp](https://github.com/nguyenvanduocit/jira-mcp)** - ⭐ 79
...
1755. **[ls-mcp](https://github.com/lirantal/ls-mcp)** - ⭐ 79
   List MCP Server configurations in your system used by AI applications like Cursor, Claude Desktop, VS Code and others

1756. **[mcp-server-any-openapi](https://github.com/baryhuang/mcp-server-any-openapi)** - ⭐ 79
...
1757. **[arbor](https://github.com/Anandb71/arbor)** - ⭐ 79
   Graph-native code intelligence that replaces embedding-based RAG with deterministic program understanding.

1758. **[bitbucket-mcp](https://github.com/MatanYemini/bitbucket-mcp)** - ⭐ 79
   Bitbucket MCP - A Model Context Protocol (MCP) server for integrating with Bitbucket Cloud and Server APIs

1759. **[mcp-azure-devops](https://github.com/Vortiago/mcp-azure-devops)** - ⭐ 78
   A Model Context Protocol (MCP) server enabling AI assistants to interact with Azure DevOps services via Python SDK.

1760. **[actual-mcp](https://github.com/s-stefanov/actual-mcp)** - ⭐ 78
   Model Context Protocol for Actual Budget API

1761. **[mcp-metatrader5-server](https://github.com/Qoyyuum/mcp-metatrader5-server)** - ⭐ 78
...
1762. **[awesome-osint-mcp-servers](https://github.com/soxoj/awesome-osint-mcp-servers)** - ⭐ 78
   A curated list of OSINT MCP servers. Pull requests are welcomed!

1763. **[lucidity-mcp](https://github.com/hyperb1iss/lucidity-mcp)** - ⭐ 77
...
1764. **[advanced-unity-mcp](https://github.com/codemaestroai/advanced-unity-mcp)** - ⭐ 77
   Public repository for Advanced Unity MCP by Code Maestro (www.code-maestro.com).

1765. **[visual-ui-debug-agent-mcp](https://github.com/samihalawa/visual-ui-debug-agent-mcp)** - ⭐ 77
   VUDA is an autonomous debugging agent that empowers AI models to visually analyze, test, and debug web

1766. **[devex](https://github.com/ParthKapoor-dev/devex)** - ⭐ 77
   ⚡️ Devex — A Fast, Secure, and Scalable Repl-as-a-Service Platform built for Developers 🚀

1767. **[mcp-monitor](https://github.com/seekrays/mcp-monitor)** - ⭐ 77
   A system monitoring tool that exposes system metrics via the Model Context Protocol (MCP). This tool allows LLMs to retrieve real-time system information through an MCP-compatible interface.

1768. **[mcp-openapi](https://github.com/ReAPI-com/mcp-openapi)** - ⭐ 77
   OpenAPI specification MCP server.

1769. **[gitlab-mr-mcp](https://github.com/kopfrechner/gitlab-mr-mcp)** - ⭐ 77
   Interact seamlessly with GitLab repositories to manage merge requests and issues. Fetch details, add comments, and streamline your code review process with ease.

1770. **[tester-mcp-client](https://github.com/apify/tester-mcp-client)** - ⭐ 77
   Model Context Protocol (MCP) Client for Apify's Actors

1771. **[terminal_server](https://github.com/theailanguage/terminal_server)** - ⭐ 77
   MCP server that can execute terminal commands

1772. **[mcp-canvas-lms](https://github.com/DMontgomery40/mcp-canvas-lms)** - ⭐ 77
...
1773. **[woocommerce-mcp-server](https://github.com/techspawn/woocommerce-mcp-server)** - ⭐ 77
   A WooCommerce (MCP) Model Context Protocol server

1774. **[google-cloud-mcp](https://github.com/krzko/google-cloud-mcp)** - ⭐ 77
   🤖 A Model Context Protocol (MCP) server for Google Cloud (GCP)

1775. **[mcp-reticle](https://github.com/LabTerminal/mcp-reticle)** - ⭐ 77
   Reticle intercepts, visualizes, and profiles JSON-RPC traffic between your LLM and MCP servers in real-time, with zero latency overhead. Stop debugging blind. Start seeing everything.

1776. **[mcp-server](https://github.com/cap-js/mcp-server)** - ⭐ 77
   MCP server for AI-assisted development of CAP applications

1777. **[x64dbgMCP](https://github.com/Wasdubya/x64dbgMCP)** - ⭐ 77
   Model Context Protocol for x64dbg & x32dbg

1778. **[mcp-gemini-google-search](https://github.com/yukukotani/mcp-gemini-google-search)** - ⭐ 76
   MCP server for Google Search integration using Gemini's built-in search capabilities

1779. **[youtrack-mcp](https://github.com/tonyzorin/youtrack-mcp)** - ⭐ 76
...
1780. **[codeglide-mcpgen](https://github.com/CodeGlide/codeglide-mcpgen)** - ⭐ 76
   Generation of Secure MCP (Model Context Protocol) Servers from API source code at Scale

1781. **[mcp-server-circleci](https://github.com/CircleCI-Public/mcp-server-circleci)** - ⭐ 76
   A specialized server implementation for the Model Context Protocol (MCP) designed to integrate with CircleCI's development workflow. This project serves as a bridge between CircleCI's infrastructure and the Model Context Protocol, enabling enhanced AI-powered development experiences.

1782. **[cursor10x-mcp](https://github.com/aiurda/cursor10x-mcp)** - ⭐ 76
   The Cursor10x MCP is a persistent multi-dimensional memory system for Cursor that enhances AI assistants with conversation context, project history, and code relationships across sessions.

1783. **[ExternalAttacker-MCP](https://github.com/MorDavid/ExternalAttacker-MCP)** - ⭐ 76
   A modular external attack surface mapping tool integrating tools for automated reconnaissance and bug bounty workflows.

1784. **[fabric-mcp](https://github.com/ksylvan/fabric-mcp)** - ⭐ 76
   Fabric MCP Server: Seamlessly integrate Fabric AI capabilities into MCP-enabled tools like IDEs and chat interfaces.

1785. **[imessage-query-fastmcp-mcp-server](https://github.com/hannesrudolph/imessage-query-fastmcp-mcp-server)** - ⭐ 76
   An MCP server that provides safe access to your iMessage database through Model Context Protocol (MCP). This server is built with the FastMCP framework and the imessagedb library, enabling LLMs to query and analyze iMessage conversations with proper phone number validation and attachment handling.

1786. **[mcp-jenkins](https://github.com/lanbaoshen/mcp-jenkins)** - ⭐ 76
   The Model Context Protocol (MCP) is an open-source implementation that bridges Jenkins with AI language models following Anthropic's MCP specification. This project enables secure, contextual AI interactions with Jenkins tools while maintaining data privacy and security.

1787. **[ols4](https://github.com/EBISPOT/ols4)** - ⭐ 75
   The EMBL-EBI Ontology Lookup Service (OLS)

1788. **[sample-agents-with-nova-act-and-mcp](https://github.com/aws-samples/sample-agents-with-nova-act-and-mcp)** - ⭐ 75
...
1789. **[agentic-coding](https://github.com/sammcj/agentic-coding)** - ⭐ 75
   Agentic Coding Rules, Templates etc...

1790. **[ChEMBL-MCP-Server](https://github.com/Augmented-Nature/ChEMBL-MCP-Server)** - ⭐ 75
   A comprehensive Model Context Protocol (MCP) server providing advanced access to the ChEMBL chemical database.

1791. **[mcp-forge](https://github.com/achetronic/mcp-forge)** - ⭐ 75
   A complete MCP server template that include vitamins (oauth authentication included)

1792. **[Mureka-mcp](https://github.com/SkyworkAI/Mureka-mcp)** - ⭐ 75
   generate lyrics, song and background music(instrumental). Model Context Protocol (MCP) server.

1793. **[mcp-llm](https://github.com/sammcj/mcp-llm)** - ⭐ 75
    An MCP server that provides LLMs access to other LLMs

1794. **[xclaude-plugin](https://github.com/conorluddy/xclaude-plugin)** - ⭐ 75
...
1795. **[mcp-llms-txt-explorer](https://github.com/thedaviddias/mcp-llms-txt-explorer)** - ⭐ 74
   MCP to explore websites with llms.txt files

1796. **[jvm-mcp-server](https://github.com/xzq-xu/jvm-mcp-server)** - ⭐ 74
   This is an implementation project of a JVM-based MCP (Model Context Protocol) server. The project aims to provide a standardized MCP server implementation for the JVM platform, enabling AI models to better interact with the Java ecosystem.

1797. **[mcp-kafka](https://github.com/kanapuli/mcp-kafka)** - ⭐ 74
   A Model Context Protocol Server to perform Kafka client operations

1798. **[agentic-tools-mcp](https://github.com/Pimzino/agentic-tools-mcp)** - ⭐ 74
   A comprehensive Model Context Protocol (MCP) server providing AI assistants with powerful task management and agent memories capabilities with project-specific storage.

1799. **[zed-mcp-server-github](https://github.com/LoamStudios/zed-mcp-server-github)** - ⭐ 74
   A GitHub MCP Server extension for Zed

1800. **[glif-mcp-server](https://github.com/glifxyz/glif-mcp-server)** - ⭐ 74
   Easily run glif.app AI workflows inside your LLM: image generators, memes, selfies, and more. Glif supports all major multimedia AI models inside one app

1801. **[code-to-tree](https://github.com/micl2e2/code-to-tree)** - ⭐ 74
   A runtime-free MCP server that converts source code into AST🌲, regardless of language.

1802. **[bridge4simulator](https://github.com/AppGram/bridge4simulator)** - ⭐ 74
...
1803. **[iron-manus-mcp](https://github.com/dnnyngyen/iron-manus-mcp)** - ⭐ 74
   Iron Manus MCP (+ J.A.R.V.I.S. Orchestration)

1804. **[spring-ai](https://github.com/eazybytes/spring-ai)** - ⭐ 74
   From Java Dev to AI Engineer: Spring AI Fast Track

1805. **[fullstack-langgraph-nextjs-agent](https://github.com/agentailor/fullstack-langgraph-nextjs-agent)** - ⭐ 74
...
1806. **[stock-mcp](https://github.com/huweihua123/stock-mcp)** - ⭐ 74
   专业的金融市场数据 MCP 服务器 - 支持A股/美股/加密货币，原生 MCP 协议，AI Agent 友好

1807. **[wecom-bot-mcp-server](https://github.com/loonghao/wecom-bot-mcp-server)** - ⭐ 73
...
1808. **[bing-search-mcp](https://github.com/leehanchung/bing-search-mcp)** - ⭐ 73
   MCP Server for Bing Search API

1809. **[rust-mcp-schema](https://github.com/rust-mcp-stack/rust-mcp-schema)** - ⭐ 72
   A type-safe implementation of the official Model Context Protocol (MCP) schema in Rust.

1810. **[masquerade](https://github.com/postralai/masquerade)** - ⭐ 72
   The Privacy Firewall for LLMs

1811. **[conductor-tasks](https://github.com/hridaya423/conductor-tasks)** - ⭐ 72
   A task management system designed for AI development

1812. **[codebase-mcp](https://github.com/DeDeveloper23/codebase-mcp)** - ⭐ 72
   Model Context Protocol implementation for retrieving codebases using RepoMix

1813. **[SillyTavern-MCP-Client](https://github.com/bmen25124/SillyTavern-MCP-Client)** - ⭐ 72
   An extension of MCP for SillyTavern.

1814. **[ophis](https://github.com/njayp/ophis)** - ⭐ 72
   Transform any Cobra CLI into an MCP server

1815. **[choturobo](https://github.com/vishalmysore/choturobo)** - ⭐ 72
...
1816. **[mcp-fal](https://github.com/am0y/mcp-fal)** - ⭐ 72
   A Model Context Protocol (MCP) server for interacting with fal.ai models and services.

1817. **[surrealmcp](https://github.com/surrealdb/surrealmcp)** - ⭐ 72
   The official MCP server for SurrealDB

1818. **[claude-desktop-extension-bear-notes](https://github.com/vasylenko/claude-desktop-extension-bear-notes)** - ⭐ 72
   Claude Desktop extension with bundled MCP Server for Bear note taking app

1819. **[chat.md](https://github.com/rusiaaman/chat.md)** - ⭐ 71
   An md file as a chat interface and editable history in one.

1820. **[ytt-mcp](https://github.com/cottongeeks/ytt-mcp)** - ⭐ 71
   MCP server to fetch YouTube transcripts

1821. **[MCP-wolfram-alpha](https://github.com/SecretiveShell/MCP-wolfram-alpha)** - ⭐ 71
   Connect your chat repl to wolfram alpha computational intelligence

1822. **[Custom-MCP-Server](https://github.com/Sharan-Kumar-R/Custom-MCP-Server)** - ⭐ 71
   MCP server for scraping LinkedIn, Facebook, Instagram profiles and Google search.

1823. **[ccxt-mcp](https://github.com/lazy-dinosaur/ccxt-mcp)** - ⭐ 71
   CCXT MCP Server bridges the gap between AI models and cryptocurrency trading by providing a standardized interface through the Model Context Protocol. Created to empower automated trading strategies, this tool allows AI assistants like Claude and GPT to directly interact with over 100 cryptocurrency exchanges without requiring users to write comple

1824. **[airtable-mcp](https://github.com/felores/airtable-mcp)** - ⭐ 70
   Search, create and update Airtable bases, tables, fields, and records using Claude Desktop and MCP (Model Context Protocol) clients

1825. **[railway-mcp](https://github.com/jason-tan-swe/railway-mcp)** - ⭐ 70
   An unofficial and community-built MCP server for integrating with https://railway.app

1826. **[MCP-server-Deepseek_R1](https://github.com/66julienmartin/MCP-server-Deepseek_R1)** - ⭐ 70
   A Model Context Protocol (MCP) server implementation connecting Claude Desktop with DeepSeek's language models (R1/V3)

1827. **[mcp-client-capabilities](https://github.com/apify/mcp-client-capabilities)** - ⭐ 70
   Index of all Model Context Protocol (MCP) clients and their capabilities

1828. **[HopperMCP](https://github.com/MxIris-Reverse-Engineering/HopperMCP)** - ⭐ 70
   A Model Context Protocol server for Hopper Disassembler

1829. **[ncp](https://github.com/portel-dev/ncp)** - ⭐ 70
...
1830. **[BurpSuite-MCP-Server](https://github.com/X3r0K/BurpSuite-MCP-Server)** - ⭐ 70
   BurpSuite MCP Server:  A powerful Model Context Protocol (MCP) server implementation for BurpSuite, providing programmatic access to Burp's core functionalities.

1831. **[template-mcp-server](https://github.com/mcpdotdirect/template-mcp-server)** - ⭐ 70
   Template to quickly set up your own MCP server 

1832. **[bitcoin-mcp](https://github.com/AbdelStark/bitcoin-mcp)** - ⭐ 70
   Bitcoin & Lightning Network MCP Server.

1833. **[mcp-server-email](https://github.com/Shy2593666979/mcp-server-email)** - ⭐ 69
...
1834. **[OmniMCP](https://github.com/OpenAdaptAI/OmniMCP)** - ⭐ 69
   OmniMCP uses Microsoft OmniParser and Model Context Protocol (MCP) to provide AI models with rich UI context and powerful interaction capabilities.

1835. **[github-brain](https://github.com/wham/github-brain)** - ⭐ 69
   An experimental MCP server that summarizes GitHub discussions, issues, and pull requests using a fast local database.

1836. **[perplexity-mcp-zerver](https://github.com/wysh3/perplexity-mcp-zerver)** - ⭐ 69
   MCP web search using perplexity without any API KEYS 

1837. **[mcp-client-python](https://github.com/alejandro-ao/mcp-client-python)** - ⭐ 69

1838. **[gopher-mcp](https://github.com/GopherSecurity/gopher-mcp)** - ⭐ 69
   MCP C++ SDK - Model Context Protocol implementation in CPP with enterprise-grade security, visibility and connectivity.

1839. **[windbg-ext-mcp](https://github.com/NadavLor/windbg-ext-mcp)** - ⭐ 69
...
1840. **[unreal-mcp](https://github.com/runreal/unreal-mcp)** - ⭐ 69
   MCP server for Unreal Engine that uses Unreal Python Remote Execution

1841. **[mcp-velociraptor](https://github.com/mgreen27/mcp-velociraptor)** - ⭐ 68
   VelociraptorMCP is a Model Context Protocol bridge for exposing LLMs to MCP clients.

1842. **[blender-open-mcp](https://github.com/dhakalnirajan/blender-open-mcp)** - ⭐ 68
   Open Models MCP for Blender Using Ollama

1843. **[ClueoMCP](https://github.com/ClueoFoundation/ClueoMCP)** - ⭐ 68
...
1844. **[mcp-hetzner](https://github.com/dkruyt/mcp-hetzner)** - ⭐ 68
   A Model Context Protocol (MCP) server for interacting with the Hetzner Cloud API. This server allows language models to manage Hetzner Cloud resources through structured functions.

1845. **[tauri-plugin-mcp](https://github.com/P3GLEG/tauri-plugin-mcp)** - ⭐ 68
...
1846. **[rtfmbro-mcp](https://github.com/marckrenn/rtfmbro-mcp)** - ⭐ 68
   rtfmbro provides always-up-to-date, version-specific package documentation as context for coding agents. An alternative to context7

1847. **[gdai-mcp-plugin-godot](https://github.com/3ddelano/gdai-mcp-plugin-godot)** - ⭐ 68
...
1848. **[vibe-blocks-mcp](https://github.com/majidmanzarpour/vibe-blocks-mcp)** - ⭐ 68
...
1849. **[ig-mcp](https://github.com/jlbadano/ig-mcp)** - ⭐ 68
...
1850. **[ollama-mcp-client](https://github.com/mihirrd/ollama-mcp-client)** - ⭐ 67
   MCP client for local ollama models

1851. **[agenite](https://github.com/subeshb1/agenite)** - ⭐ 67
...
1852. **[MCPhoenix](https://github.com/jmanhype/MCPhoenix)** - ⭐ 67
   A simplified implementation of the Model Context Protocol (MCP) server using Elixir's Phoenix Framework.

1853. **[mcp_gradio_client](https://github.com/justjoehere/mcp_gradio_client)** - ⭐ 67
   This is a proof of concept repo on how to create a gradio UI using the Model Context Protocol Client Python SDK.

1854. **[gmail-mcp-server](https://github.com/jasonsum/gmail-mcp-server)** - ⭐ 67
   Model Context Protocol (MCP) server for Gmail

1855. **[optuna-mcp](https://github.com/optuna/optuna-mcp)** - ⭐ 67
   The Optuna MCP Server is a Model Context Protocol (MCP) server to interact with Optuna APIs.

1856. **[anilist-mcp](https://github.com/yuna0x0/anilist-mcp)** - ⭐ 67
   AniList MCP server for accessing anime and manga data

1857. **[piapi-mcp-server](https://github.com/apinetwork/piapi-mcp-server)** - ⭐ 67
   A TypeScript implementation of a Model Context Protocol (MCP) server that integrates with PiAPI's API. PiAPI makes user able to generate media content with Midjourney/Flux/Kling/LumaLabs/Udio/Chrip/Trellis directly from Claude or any other MCP-compatible apps.

1858. **[deepseek-thinker-mcp](https://github.com/ruixingshi/deepseek-thinker-mcp)** - ⭐ 67
...
1859. **[deepview-mcp](https://github.com/ai-1st/deepview-mcp)** - ⭐ 67
   DeepView MCP is a Model Context Protocol server that enables IDEs like Cursor and Windsurf to analyze large codebases using Gemini 2.5 Pro's extensive context window.

1860. **[unitree-go2-mcp-server](https://github.com/lpigeon/unitree-go2-mcp-server)** - ⭐ 67
   The Unitree Go2 MCP Server is a server built on the MCP that enables users to control the Unitree Go2 robot using natural language commands interpreted by a LLM.

1861. **[ynab-mcp-server](https://github.com/calebl/ynab-mcp-server)** - ⭐ 67
   Model Context Protocol for YNAB (you need a budget)

1862. **[math-mcp](https://github.com/EthanHenrickson/math-mcp)** - ⭐ 67
   A Model Context Protocol (MCP) server that provides basic mathematical and statistical functions to Large Language Models (LLMs). This server enables LLMs to perform accurate numerical calculations through a simple API.

1863. **[openfoam-mcp-server](https://github.com/webworn/openfoam-mcp-server)** - ⭐ 67
   LLM-powered OpenFOAM MCP server for intelligent CFD education with Socratic questioning and expert error resolution

1864. **[raindrop-io-mcp-server](https://github.com/hiromitsusasaki/raindrop-io-mcp-server)** - ⭐ 67
   An integration that allows LLMs to interact with Raindrop.io bookmarks using the Model Context Protocol (MCP).

1865. **[mcp-openmemory](https://github.com/baryhuang/mcp-openmemory)** - ⭐ 67
   Simple standalone MCP server giving Claude the ability to remember your conversations and learn from them over time.

1866. **[mcp](https://github.com/vuetifyjs/mcp)** - ⭐ 67
   🤖 A Model Context Protocol (MCP) library for use with Agentic chat bots

1867. **[m3](https://github.com/rafiattrach/m3)** - ⭐ 67
...
1868. **[uml-mcp](https://github.com/antoinebou12/uml-mcp)** - ⭐ 67
...
1869. **[mcp-server-datahub](https://github.com/acryldata/mcp-server-datahub)** - ⭐ 66
   The official Model Context Protocol (MCP) server for DataHub (https://datahub.com)

1870. **[boilerplate-mcp-server](https://github.com/aashari/boilerplate-mcp-server)** - ⭐ 66
   TypeScript Model Context Protocol (MCP) server boilerplate providing IP lookup tools/resources. Includes CLI support and extensible structure for connecting AI systems (LLMs) to external data sources like ip-api.com. Ideal template for creating new MCP integrations via Node.js.

1871. **[awesome-mcp-best-practices](https://github.com/lirantal/awesome-mcp-best-practices)** - ⭐ 66
   Build Awesome MCPs with Awesome Best Practices for MCP Servers and MCP Clients

1872. **[QuickMCP](https://github.com/gunpal5/QuickMCP)** - ⭐ 66
   Effortlessly Build Model Context Protocol Servers with OpenAPI or Swagger or Google Discovery Specifications

1873. **[nautex](https://github.com/hmldns/nautex)** - ⭐ 66
   MCP server for guiding Coding Agents via end-to-end requirements to implementation plan pipeline

1874. **[monarch-mcp-server](https://github.com/robcerda/monarch-mcp-server)** - ⭐ 66
   MCP Server for use with Monarch Money

1875. **[markitdown_mcp_server](https://github.com/KorigamiK/markitdown_mcp_server)** - ⭐ 66
   A Model Context Protocol (MCP) server that converts various file formats to Markdown using the MarkItDown utility.

1876. **[mcp-server-node](https://github.com/lucianoayres/mcp-server-node)** - ⭐ 66
...
1877. **[mcp-wolframalpha](https://github.com/akalaric/mcp-wolframalpha)** - ⭐ 66
   A Python-powered Model Context Protocol MCP server and client that uses Wolfram Alpha via API.

1878. **[lazy-mcp](https://github.com/voicetreelab/lazy-mcp)** - ⭐ 66
     MCP proxy server with lazy loading support - reduces context usage through on-demand tool activation

1879. **[ViaMCP](https://github.com/ViaVersionMCP/ViaMCP)** - ⭐ 65
   Client-side Implementation of the Via* projects for MCP

1880. **[mcp-tutorials](https://github.com/chenmingyong0423/mcp-tutorials)** - ⭐ 65
   Model Context Protocol(MCP) 中文教程讲解

1881. **[community-servers](https://github.com/mcp-get/community-servers)** - ⭐ 65
...
1882. **[flapi](https://github.com/DataZooDE/flapi)** - ⭐ 65
...
1883. **[shinzo-ts](https://github.com/shinzo-labs/shinzo-ts)** - ⭐ 65
...
1884. **[nav2_mcp_server](https://github.com/ajtudela/nav2_mcp_server)** - ⭐ 65
   MCP server that provides tools and resources to control and monitor robots using Nav2.

1885. **[slither-mcp](https://github.com/trailofbits/slither-mcp)** - ⭐ 65
   MCP server for Slither static analysis of Solidity smart contracts

1886. **[turbomcp](https://github.com/Epistates/turbomcp)** - ⭐ 65
   A full featured, enterprise grade rust MCP SDK

1887. **[wasmcp](https://github.com/wasmcp/wasmcp)** - ⭐ 65
   Build MCP servers with WebAssembly components

1888. **[mcp4k](https://github.com/ondrsh/mcp4k)** - ⭐ 65
   Compiler-driven MCP framework for Kotlin Multiplatform

1889. **[lsd-mcp](https://github.com/lsd-so/lsd-mcp)** - ⭐ 64
   LSD Model Context Protocol

1890. **[svelte5-mcp](https://github.com/StudentOfJS/svelte5-mcp)** - ⭐ 64
   A specialized Model Context Protocol (MCP) server for Svelte 5 frontend development

1891. **[ollama-mcp-client](https://github.com/anjor/ollama-mcp-client)** - ⭐ 64

1892. **[mcp-config](https://github.com/marcusschiesser/mcp-config)** - ⭐ 64
   A CLI tool for easy installation of MCP servers and managing their configuration

1893. **[crash-mcp](https://github.com/nikkoxgonzales/crash-mcp)** - ⭐ 64
   MCP server for structured and efficient reasoning with step validation, branching, and revisions.

1894. **[CanvasMCPClient](https://github.com/n00bvn/CanvasMCPClient)** - ⭐ 64
   Canvas MCP Client is an open-source, self-hostable dashboard application built around an infinite, zoomable, and pannable canvas. It provides a unified interface for interacting with multiple MCP (Model Context Protocol) servers through a flexible, widget-based system.

1895. **[VibeShift](https://github.com/GroundNG/VibeShift)** - ⭐ 64
   [MCP Server] The Security Agent for AI assisted coding

1896. **[amazon-mcp](https://github.com/Fewsats/amazon-mcp)** - ⭐ 64
   Amazon MCP server to search & buy products using the L402

1897. **[ros2_mcp](https://github.com/wise-vision/ros2_mcp)** - ⭐ 64
   Advanced MCP Server ROS 2 bridging AI agents straight into robotics

1898. **[airtable-mcp](https://github.com/rashidazarang/airtable-mcp)** - ⭐ 64
   Airtable integration for AI-powered applications via Anthropic's Model Context Protocol (MCP)

1899. **[django-ai-boost](https://github.com/vintasoftware/django-ai-boost)** - ⭐ 64
   A MCP server for Django applications, inspired by Laravel Boost.

1900. **[MySQL_MCP](https://github.com/guangxiangdebizi/MySQL_MCP)** - ⭐ 64
   这是一个功能强大且易用的MySQL数据库MCP（Model Context Protocol）服务器，让你的AI助手可以安全地进行完整的数据库操作，支持多数据库连接管理、增删改查、事务管理和智能回滚功能。

1901. **[deep-research-mcp-server](https://github.com/ssdeanx/deep-research-mcp-server)** - ⭐ 64
   MCP Deep Research Server using Gemini creating a Research AI Agent

1902. **[robot_MCP](https://github.com/IliaLarchenko/robot_MCP)** - ⭐ 64
   A simple MCP server for the SO-ARM100 control

1903. **[mcpc](https://github.com/mcpc-tech/mcpc)** - ⭐ 64
   Build agentic-MCP servers by composing existing MCP tools.

1904. **[mcp-discord](https://github.com/barryyip0625/mcp-discord)** - ⭐ 64
   Implement Discord MCP server enabling AI assistants to interact with the Discord platform.

1905. **[mcp-fhir](https://github.com/flexpa/mcp-fhir)** - ⭐ 63
   A Model Context Protocol implementation for FHIR

1906. **[mcp-sdk](https://github.com/AntigmaLabs/mcp-sdk)** - ⭐ 63
   Minimalistic Rust Implementation Of Model Context Protocol from Anthropic

1907. **[mcp-bear](https://github.com/jkawamoto/mcp-bear)** - ⭐ 63
   A MCP server for interacting with Bear note-taking software.

1908. **[mcp-server-ccxt](https://github.com/Nayshins/mcp-server-ccxt)** - ⭐ 63
   Cryptocurrency Market Data MCP Server

1909. **[sub-agents-mcp](https://github.com/shinpr/sub-agents-mcp)** - ⭐ 63
   Define task-specific AI sub-agents in Markdown for any MCP-compatible tool.

1910. **[mcp-openapi-schema-explorer](https://github.com/kadykov/mcp-openapi-schema-explorer)** - ⭐ 63
   MCP server providing token-efficient access to OpenAPI/Swagger specs via MCP Resource Templates for client-side exploration.

1911. **[ipybox](https://github.com/gradion-ai/ipybox)** - ⭐ 63
   Python code execution sandbox with programmatic MCP tool calling (PTC)

1912. **[mcp-arr](https://github.com/aplaceforallmystuff/mcp-arr)** - ⭐ 63
   MCP server for *arr media management suite

1913. **[nutrient-dws-mcp-server](https://github.com/PSPDFKit/nutrient-dws-mcp-server)** - ⭐ 63
   A Model Context Protocol (MCP) server implementation that integrates with the Nutrient Document Web Service (DWS) Processor API, providing powerful PDF processing capabilities for AI assistants.

1914. **[tiny-mcp](https://github.com/wdndev/tiny-mcp)** - ⭐ 63
   Python 实现 MCP client / service

1915. **[junos-mcp-server](https://github.com/Juniper/junos-mcp-server)** - ⭐ 63
...
1916. **[usolver](https://github.com/sdiehl/usolver)** - ⭐ 62
   A model context protocol server for solving combinatorial optimization problems with logical and numerical constraints.

1917. **[mcp-durable-object-client](https://github.com/Dhravya/mcp-durable-object-client)** - ⭐ 62
   testing mcps

1918. **[voice-mcp-agent](https://github.com/den-vasyliev/voice-mcp-agent)** - ⭐ 62
...
1919. **[mcp_newsnow](https://github.com/sligter/mcp_newsnow)** - ⭐ 62
   一个基于 Model Context Protocol (MCP) 的新闻聚合服务器，通过 Newsnow API 提供多平台热点新闻和趋势话题。

1920. **[mcp-gopls](https://github.com/hloiseau/mcp-gopls)** - ⭐ 62
   Model Context Protocol (MCP) server for Go using gopls – LSP-powered analysis, tests, coverage, and tooling.

1921. **[mcp-miro](https://github.com/k-jarzyna/mcp-miro)** - ⭐ 62
   Miro integration for Model Context Protocol

1922. **[mcp_zoomeye](https://github.com/zoomeye-ai/mcp_zoomeye)** - ⭐ 62
   A Model Context Protocol server that provides network asset information based on query conditions. This server allows LLMs to obtain network asset information and supports querying network asset information by zoomeye dork etc.

1923. **[mcp-server-okppt](https://github.com/NeekChaw/mcp-server-okppt)** - ⭐ 62
...
1924. **[agent-toolkit](https://github.com/sanity-io/agent-toolkit)** - ⭐ 62
   Collection of resources to help AI agents build better with Sanity.

1925. **[roundtable](https://github.com/askbudi/roundtable)** - ⭐ 62
...
1926. **[XActions](https://github.com/nirholas/XActions)** - ⭐ 62
...
1927. **[contentful-mcp](https://github.com/ivo-toby/contentful-mcp)** - ⭐ 61
   MCP (Model Context Protocol) server for the Contentful Management API

1928. **[kollektiv-mcp](https://github.com/alexander-zuev/kollektiv-mcp)** - ⭐ 61
...
1929. **[ollama-mcp-db](https://github.com/robdodson/ollama-mcp-db)** - ⭐ 61
...
1930. **[mcp-cn](https://github.com/mengjian-github/mcp-cn)** - ⭐ 61
...
1935. **[meta-mcp](https://github.com/brijr/meta-mcp)** - ⭐ 61
   MCP Server for connecting to the Meta Marketing API

1936. **[ableton-copilot-mcp](https://github.com/xiaolaa2/ableton-copilot-mcp)** - ⭐ 61
...
1937. **[mcpr](https://github.com/devOpifex/mcpr)** - ⭐ 60
   Model Context Protocol server and client for R

1938. **[rember-mcp](https://github.com/rember/rember-mcp)** - ⭐ 60
   A Model Context Protocol (MCP) server for Rember.

1939. **[chess-mcp](https://github.com/pab1it0/chess-mcp)** - ⭐ 60
   A Model Context Protocol server for Chess.com's Published Data API.  This provides access to Chess.com player data, game records, and other public information through standardized MCP interfaces, allowing AI assistants to search and analyze chess information.

1940. **[devto-mcp](https://github.com/Arindam200/devto-mcp)** - ⭐ 60
   MCP Server of DevTo

1941. **[mcp-difyworkflow-server](https://github.com/gotoolkits/mcp-difyworkflow-server)** - ⭐ 60
   mcp-difyworkflow-server is an mcp server Tools application that implements the query and invocation of Dify workflows, supporting the on-demand operation of multiple custom Dify workflows.

1942. **[pydantic-rpc](https://github.com/i2y/pydantic-rpc)** - ⭐ 60
...
1943. **[fred-mcp-server](https://github.com/stefanoamorelli/fred-mcp-server)** - ⭐ 60
   Open-source FRED MCP Server (Federal Reserve Economic Data)

1944. **[google-ai-mode-mcp](https://github.com/PleasePrompto/google-ai-mode-mcp)** - ⭐ 60
...
1945. **[mcp-clojure-sdk](https://github.com/unravel-team/mcp-clojure-sdk)** - ⭐ 60
   A Clojure SDK to create MCP servers (and eventually clients)

1946. **[interactive-brokers-mcp](https://github.com/code-rabi/interactive-brokers-mcp)** - ⭐ 60
   Interactive Brokers MCP Server

1947. **[ocaml-mcp-sdk](https://github.com/bmorphism/ocaml-mcp-sdk)** - ⭐ 59
   OCaml SDK for Model Context Protocol using Jane Street's oxcaml_effect library

1948. **[daipendency-mcp](https://github.com/daipendency/daipendency-mcp)** - ⭐ 59
   Model Context Protocol server for Daipendency

1949. **[smart-pet-with-mcp](https://github.com/shijianzhong/smart-pet-with-mcp)** - ⭐ 59
   一个桌宠形式的mcp client，可以对接任意mcp server,配合测试的mcp server 开源地址：https://github.com/shijianzhong/mcp-server-for-pc

1950. **[cline-mcp-memory-bank](https://github.com/dazeb/cline-mcp-memory-bank)** - ⭐ 59
   A memory system for Cline that tracks progress between conversations.

1951. **[shadcn-ui-mcp-server](https://github.com/ymadd/shadcn-ui-mcp-server)** - ⭐ 59
   MCP server for shadcn/ui component references

1952. **[autosteer](https://github.com/notch-ai/autosteer)** - ⭐ 59
   Desktop app for multi-workspace Claude Code management

1953. **[mcp-server-echart](https://github.com/cnkanwei/mcp-server-echart)** - ⭐ 59
   基于 mcp-go 框架构建的 mcp 服务，它提供了一个能动态生成 ECharts 图表页面的工具。

1954. **[nocodb-mcp-server](https://github.com/edwinbernadus/nocodb-mcp-server)** - ⭐ 59
   nocodb mcp server

1955. **[xiaozhi-mcp-client](https://github.com/shadowcz007/xiaozhi-mcp-client)** - ⭐ 59
   可视化的配置和管理，给xiaozhi接入mcp

1956. **[nutrient-document-engine-mcp-server](https://github.com/PSPDFKit/nutrient-document-engine-mcp-server)** - ⭐ 59
   A Model Context Protocol (MCP) server implementation exposes document processing capabilities through natural language, supporting both direct human interaction and AI agent tool calling.

1957. **[purple-mcp](https://github.com/Sentinel-One/purple-mcp)** - ⭐ 59
...
1958. **[ida-mcp-rs](https://github.com/blacktop/ida-mcp-rs)** - ⭐ 59
   Headless IDA MCP Server

1959. **[mcp-all-in-one](https://github.com/vtxf/mcp-all-in-one)** - ⭐ 59
...
1960. **[MediaWiki-MCP-Server](https://github.com/ProfessionalWiki/MediaWiki-MCP-Server)** - ⭐ 59
   Model Context Protocol (MCP) Server to connect your AI with any MediaWiki

1961. **[mcp-hub](https://github.com/lobstercare/mcp-hub)** - ⭐ 58
   A curated list of awesome Model Context Protocol (MCP) servers.

1962. **[baml-agents](https://github.com/Elijas/baml-agents)** - ⭐ 58
   Building Agents with LLM structured generation (BAML), MCP Tools, and 12-Factor Agents principles

1963. **[mcp-servers](https://github.com/pulsemcp/mcp-servers)** - ⭐ 58
   MCP (Model Context Protocol) Servers authored and maintained by the PulseMCP team. We build reliable servers thoughtfully designed specifically for MCP Client-powered workflows.

1964. **[ashra-mcp](https://github.com/getrupt/ashra-mcp)** - ⭐ 58
   A Model Context Protocol server for Ashra

1965. **[create-mcp-app](https://github.com/boguan/create-mcp-app)** - ⭐ 58
   A CLI tool for quickly scaffolding Model Context Protocol (MCP) server applications with TypeScript support and modern development tooling

1966. **[mcp-server-axiom](https://github.com/axiomhq/mcp-server-axiom)** - ⭐ 58
   Axiom Model Context Protocol Server

1967. **[quick-mcp-example](https://github.com/ALucek/quick-mcp-example)** - ⭐ 58
   Short and sweet example MCP server / client implementation for Tools, Resources and Prompts.

1968. **[EnergyPlus-MCP](https://github.com/LBNL-ETA/EnergyPlus-MCP)** - ⭐ 58
...
1969. **[mcpserver](https://github.com/2234839/mcpserver)** - ⭐ 58
   为claude code+glm 添加上眼睛

1970. **[mobile-mcp](https://github.com/runablehq/mobile-mcp)** - ⭐ 58
   A Model Context Protocol (MCP) server that provides mobile automation capabilities.

1971. **[MCP4EDA](https://github.com/NellyW8/MCP4EDA)** - ⭐ 58
...
1972. **[fastmail-mcp](https://github.com/MadLlama25/fastmail-mcp)** - ⭐ 58
...
1973. **[MCP-Dandan](https://github.com/82ch/MCP-Dandan)** - ⭐ 57
   MCP Security Solution for Agentic AI — real-time proxying, behavior analysis, and malicious tool detection

1974. **[mcp-gemini-search](https://github.com/arjunprabhulal/mcp-gemini-search)** - ⭐ 57
   Model Context Protocol (MCP) with Gemini 2.5 Pro. Convert conversational queries into flight searches using Gemini's function calling capabilities and MCP's flight search tools

1975. **[clarity-mcp-server](https://github.com/microsoft/clarity-mcp-server)** - ⭐ 57
   A Model Context Protocol (MCP) server for Microsoft Clarity

1976. **[metis-router](https://github.com/metis-mantis/metis-router)** - ⭐ 57
   MCP router and Web Based MCP client

1977. **[Archive-Agent](https://github.com/shredEngineer/Archive-Agent)** - ⭐ 57
   Find your files with natural language and ask questions.

1978. **[erpnext-mcp-server](https://github.com/rakeshgangwar/erpnext-mcp-server)** - ⭐ 57
   Connect AI assistants to your ERPNext instance via the Model Context Protocol (MCP) using the official Frappe API.

1979. **[job-searchoor](https://github.com/0xDAEF0F/job-searchoor)** - ⭐ 57
   A simple MCP server that delivers you jobs based on your needs

1980. **[sublinear-time-solver](https://github.com/ruvnet/sublinear-time-solver)** - ⭐ 57
...
1992. **[adbfriend](https://github.com/mikepenz/adbfriend)** - ⭐ 56
   Android ADB CLI tool including integrated MCP Server with common adb actions used during development

1993. **[geoserver-mcp](https://github.com/mahdin75/geoserver-mcp)** - ⭐ 56
   A Model Context Protocol (MCP) server implementation that connects LLMs to the GeoServer REST API

1994. **[scrapegraph-mcp](https://github.com/ScrapeGraphAI/scrapegraph-mcp)** - ⭐ 56
   ScapeGraph MCP Server

1995. **[mcp_server_gdb](https://github.com/pansila/mcp_server_gdb)** - ⭐ 56
   MCP Server to expose the GDB debugging capabilities

1996. **[mkp](https://github.com/StacklokLabs/mkp)** - ⭐ 56
   MKP is a Model Context Protocol (MCP) server for Kubernetes

1997. **[xiaohongshu-mcp-python](https://github.com/luyike221/xiaohongshu-mcp-python)** - ⭐ 56
...
1998. **[claude-mermaid](https://github.com/veelenga/claude-mermaid)** - ⭐ 56
   MCP Server to previewing mermaid diagrams

1999. **[solana-mcp-server](https://github.com/openSVM/solana-mcp-server)** - ⭐ 55
   solana mcp sever to enable solana rpc methods

2000. **[umbraco-mcp](https://github.com/Matthew-Wise/umbraco-mcp)** - ⭐ 55
   A model context protocol  (MCP) server for Umbraco 

2001. **[mcp-bridge-api](https://github.com/INQUIRELAB/mcp-bridge-api)** - ⭐ 55
...
2002. **[Alph](https://github.com/Aqualia/Alph)** - ⭐ 55
   Universal MCP Server Configuration Manager

2003. **[time-mcp](https://github.com/yokingma/time-mcp)** - ⭐ 55
   ⏰ Time MCP Server: Giving LLMs Time Awareness Capabilities

2004. **[mcd-mcp-server](https://github.com/M-China/mcd-mcp-server)** - ⭐ 55
   McDonald's China MCP Server Integration Guide

2005. **[mcp-server-flomo](https://github.com/chatmcp/mcp-server-flomo)** - ⭐ 55
   Write notes to Flomo

2006. **[mcp-open-library](https://github.com/8enSmith/mcp-open-library)** - ⭐ 55
   A Model Context Protocol (MCP) server for the Internet Archive's Open Library API that enables AI assistants to search for book and author information.

2007. **[joplin-mcp-server](https://github.com/dweigend/joplin-mcp-server)** - ⭐ 55
   A Model Context Protocol (MCP) Server for https://joplinapp.org/ that enables note access through the https://modelcontextprotocol.io. Perfect for integration with AI assistants like Claude.

2008. **[appium-mcp](https://github.com/Rahulec08/appium-mcp)** - ⭐ 55
...
2009. **[FreeCAD-MCP](https://github.com/ATOI-Ming/FreeCAD-MCP)** - ⭐ 55
...
2010. **[quickbooks-online-mcp-server](https://github.com/intuit/quickbooks-online-mcp-server)** - ⭐ 55
...
2011. **[stackoverflow-mcp](https://github.com/gscalzo/stackoverflow-mcp)** - ⭐ 55
   A Model Context Protocol server for querying Stack Overflow to help AI models find programming solutions

2012. **[astro-mcp](https://github.com/morinokami/astro-mcp)** - ⭐ 55
   MCP server to support Astro project development

2013. **[openai-mcp-client](https://github.com/ResoluteError/openai-mcp-client)** - ⭐ 54
   A rudimentary implementation of Anthropic's Model Context Protocol with OpenAIs Model

2014. **[mcp-headless-gmail](https://github.com/baryhuang/mcp-headless-gmail)** - ⭐ 54
   A MCP (Model Context Protocol) server that provides get, send Gmails without local credential or token setup.

2015. **[podman-mcp-server](https://github.com/manusa/podman-mcp-server)** - ⭐ 54
   Model Context Protocol (MCP) server for container runtimes (Podman and Docker)

2016. **[bc-code-intelligence-mcp](https://github.com/JeremyVyska/bc-code-intelligence-mcp)** - ⭐ 54
...
2017. **[fhir-mcp-server](https://github.com/the-momentum/fhir-mcp-server)** - ⭐ 54
   FHIR MCP Server for handling medical data standard.

2018. **[minibridge](https://github.com/acuvity/minibridge)** - ⭐ 54
   Make your MCP servers secure and production ready

2019. **[web2mcp](https://github.com/neelsomani/web2mcp)** - ⭐ 54
   Generate an MCP for any web app

2020. **[MCP_Atom_of_Thoughts](https://github.com/kbsooo/MCP_Atom_of_Thoughts)** - ⭐ 54
...
2021. **[mssql_mcp_server](https://github.com/JexinSam/mssql_mcp_server)** - ⭐ 54
   A Model Context Protocol (MCP) server facilitating secure interactions with MSSQL databases.

2022. **[temporal-mcp](https://github.com/Mocksi/temporal-mcp)** - ⭐ 54
   Empowering AI with Workflow Orchestration

2023. **[mcp-ssh](https://github.com/shuakami/mcp-ssh)** - ⭐ 54
   🔐 SSH MCP Tool - AI-powered SSH management through MCP protocol | 基于MCP协议的SSH工具，为AI提供SSH远程操作能力

2024. **[joplin-mcp](https://github.com/alondmnt/joplin-mcp)** - ⭐ 54
   MCP server for the Joplin note taking app

2025. **[mcp](https://github.com/abap-ai/mcp)** - ⭐ 54
   ABAP MCP - Model Context Protocol - Server SDK

2026. **[freecad-mcp](https://github.com/contextform/freecad-mcp)** - ⭐ 54
   FreeCAD MCP - Open-source Model Context Protocol server for FreeCAD automation

2027. **[ticktick-mcp-server](https://github.com/alexarevalo9/ticktick-mcp-server)** - ⭐ 54
   A Model Context Protocol (MCP) server designed to integrate with the TickTick task management platform, enabling intelligent context-aware task operations and automation.

2028. **[mcp-openai](https://github.com/S1M0N38/mcp-openai)** - ⭐ 53
   🔗 MCP Client with OpenAI compatible API

2029. **[qu3-app](https://github.com/qu3ai/qu3-app)** - ⭐ 53
   Quantum-proof MCP Server and Client Interactions

2030. **[NoLLMChat](https://github.com/zrg-team/NoLLMChat)** - ⭐ 53
...
2031. **[nasdaq-data-link-mcp](https://github.com/stefanoamorelli/nasdaq-data-link-mcp)** - ⭐ 53
   A Nasdaq Data Link MCP (Model Context Protocol) Server

2032. **[mcp-shell](https://github.com/sonirico/mcp-shell)** - ⭐ 53
   Give hands to AI. MCP server to run shell commands securely, auditably, and on demand.

2033. **[gomcp](https://github.com/llmcontext/gomcp)** - ⭐ 53
   Unofficial Golang SDK for Anthropic Model Context Protocol

2034. **[mxcp](https://github.com/raw-labs/mxcp)** - ⭐ 53
   Model eXecution + Context Protocol: Enterprise-Grade Data-to-AI Infrastructure

2035. **[mcp-server-azure-ai-agents](https://github.com/farzad528/mcp-server-azure-ai-agents)** - ⭐ 53
   Model Context Protocol Servers for Azure AI Search

2036. **[awesome-remote-mcp-servers](https://github.com/sylviangth/awesome-remote-mcp-servers)** - ⭐ 53
   A curated list of Hosted & Managed Model Context Protocol (MCP) Servers accessible via a simple URL endpoint.

2037. **[mcp-docs-service](https://github.com/alekspetrov/mcp-docs-service)** - ⭐ 53
   MCP Documentation Management Service - A Model Context Protocol implementation for documentation management

2038. **[ollama-mcp-bridge](https://github.com/jonigl/ollama-mcp-bridge)** - ⭐ 53
   Extend the Ollama API with dynamic AI tool integration from multiple MCP (Model Context Protocol) servers. Fully compatible, transparent, and developer-friendly, ideal for building powerful local LLM applications, AI agents, and custom chatbots

2039. **[client](https://github.com/php-mcp/client)** - ⭐ 53
   Core PHP implementation for the Model Context Protocol (MCP) Client

2040. **[mcp-batchit](https://github.com/ryanjoachim/mcp-batchit)** - ⭐ 53
...
2041. **[user-feedback-mcp](https://github.com/mrexodia/user-feedback-mcp)** - ⭐ 53
   Simple MCP Server to enable a human-in-the-loop workflow in tools like Cline and Cursor.

2042. **[mcp-secrets-plugin](https://github.com/amirshk/mcp-secrets-plugin)** - ⭐ 53
...
2043. **[naver-search-mcp](https://github.com/isnow890/naver-search-mcp)** - ⭐ 53
...
2044. **[trpc-mcp-go](https://github.com/trpc-group/trpc-mcp-go)** - ⭐ 53
   Go implementation of the Model Context Protocol (MCP) with comprehensive Streamable HTTP, STDIO, and SSE support. 

2045. **[DecompilerServer](https://github.com/pardeike/DecompilerServer)** - ⭐ 53
...
2046. **[cosmotop](https://github.com/bjia56/cosmotop)** - ⭐ 53
   Multiplatform system monitoring tool using Cosmopolitan Libc

2047. **[sympy-mcp](https://github.com/sdiehl/sympy-mcp)** - ⭐ 53
   A MCP server for symbolic manipulation of mathematical expressions

2048. **[bloodhound_mcp](https://github.com/mwnickerson/bloodhound_mcp)** - ⭐ 53
   A Model Context Protocol (MCP) server to converse with data in Bloodhound

2049. **[python](https://github.com/mcp-auth/python)** - ⭐ 53
   🔐 Plug-and-play auth for Python MCP servers.

2050. **[chucknorris](https://github.com/pollinations/chucknorris)** - ⭐ 53
...
2051. **[ibkr-mcp-server](https://github.com/seriallazer/ibkr-mcp-server)** - ⭐ 53
   MCP Server for IBKR Client

2052. **[cap-mcp-plugin](https://github.com/gavdilabs/cap-mcp-plugin)** - ⭐ 52
   MCP (Model Context Protocol) server plugin for CAP NodeJS

2053. **[mcp-cpp](https://github.com/Neumann-Labs/mcp-cpp)** - ⭐ 52
   A C++ SDK for the Model Context Protocol (MCP). The SDK will provide a framework for creating MCP servers and clients in C++.

2054. **[ocaml-mcp](https://github.com/tmattio/ocaml-mcp)** - ⭐ 52
   OCaml implementation of the Model Context Protocol (MCP)

2055. **[mcp-app-demo](https://github.com/pomerium/mcp-app-demo)** - ⭐ 52
...
2056. **[mcp](https://github.com/twelvedata/mcp)** - ⭐ 52
...
2057. **[mcp-duckdb-memory-server](https://github.com/IzumiSy/mcp-duckdb-memory-server)** - ⭐ 52
   MCP Memory Server with DuckDB backend

2058. **[vrchat-mcp](https://github.com/sawa-zen/vrchat-mcp)** - ⭐ 52
   This project is a Model Context Protocol (MCP) server for interacting with the VRChat API.

2059. **[adx-mcp-server](https://github.com/pab1it0/adx-mcp-server)** - ⭐ 52
   A Model Context Protocol (MCP) server that enables AI assistants to query and analyze Azure Data Explorer databases through standardized interfaces.

2060. **[medical-mcp](https://github.com/JamesANZ/medical-mcp)** - ⭐ 52
...
2061. **[A2A_ADK_MCP](https://github.com/RubensZimbres/A2A_ADK_MCP)** - ⭐ 52
   Multi-Agent Systems with Google's Agent Development Kit + A2A + MCP

2062. **[claude-code-emacs](https://github.com/yuya373/claude-code-emacs)** - ⭐ 52
...
2063. **[vscode-mcp](https://github.com/tjx666/vscode-mcp)** - ⭐ 52
...
2064. **[talkito](https://github.com/robdmac/talkito)** - ⭐ 52
...
2065. **[zendesk-mcp-server](https://github.com/reminia/zendesk-mcp-server)** - ⭐ 52
   A Model Context Protocol server for Zendesk

2066. **[mcp-client](https://github.com/rakesh-eltropy/mcp-client)** - ⭐ 51

2067. **[Memory-Plus](https://github.com/Yuchen20/Memory-Plus)** - ⭐ 51
...
2068. **[context-optimizer-mcp-server](https://github.com/malaksedarous/context-optimizer-mcp-server)** - ⭐ 51
   A Model Context Protocol (MCP) server that provides context optimization tools for AI coding assistants including GitHub Copilot, Cursor AI, Claude Desktop, and other MCP-compatible assistants enabling them to extract targeted information rather than processing large terminal outputs and files wasting their context.

2069. **[go-mcp-mysql](https://github.com/Zhwt/go-mcp-mysql)** - ⭐ 51
   Zero burden, ready-to-use Model Context Protocol (MCP) server for interacting with MySQL and automation. No Node.js or Python environment needed.

2070. **[adk-mcp-a2a-crash-course](https://github.com/chongdashu/adk-mcp-a2a-crash-course)** - ⭐ 51
...
2071. **[deploystack](https://github.com/deploystackio/deploystack)** - ⭐ 51
   Open source MCP hosting - deploy MCP servers to HTTP endpoints for n8n, Dify, Voiceflow, and any MCP client.

2072. **[baba_is_eval](https://github.com/lennart-finke/baba_is_eval)** - ⭐ 51
   Claude  et al. play the brilliant puzzle title "Baba is You"

2073. **[trellis_blender](https://github.com/FishWoWater/trellis_blender)** - ⭐ 51
   Blender plugin for TRELLIS and TRELLIS.2 (3D AIGC Model, Text-to-3D, Image-to-3D)

2074. **[mcp-server-synology](https://github.com/atom2ueki/mcp-server-synology)** - ⭐ 51
...
2075. **[gomcp](https://github.com/localrivet/gomcp)** - ⭐ 51
...
2076. **[swift-mcp-gui](https://github.com/NakaokaRei/swift-mcp-gui)** - ⭐ 51
   MCP server that can execute commands such as keyboard input and mouse movement on macOS

2077. **[mcp-server-kibana](https://github.com/TocharianOU/mcp-server-kibana)** - ⭐ 51
   MCP server for Kibana, Access search and manage Kibana in MCP Client.

2078. **[mcp-swagger-server](https://github.com/zaizaizhao/mcp-swagger-server)** - ⭐ 51
   MCP Swagger Server 将任何符合 OpenAPI/Swagger 规范的 REST API 转换为 Model Context Protocol (MCP) 格式，让 AI 助手能够理解和调用您的 API。

2079. **[puremd-mcp](https://github.com/puremd/puremd-mcp)** - ⭐ 51
   Unblock, scrape, and search tools for MCP clients

2080. **[WeChat-MCP](https://github.com/BiboyQG/WeChat-MCP)** - ⭐ 51
   WeChat-MCP: let Claude/ChatGPT and other AI assistants read and reply to WeChat for you

2081. **[Perigon.CLI](https://github.com/AterDev/Perigon.CLI)** - ⭐ 50
...
2082. **[AgentDNS-Node](https://github.com/jsjfai/AgentDNS-Node)** - ⭐ 50
...
2083. **[mcp-guard](https://github.com/General-Analysis/mcp-guard)** - ⭐ 50
   MCP Guard secures your MCP client from prompt injection attacks and more.

2084. **[mcp-security-audit](https://github.com/qianniuspace/mcp-security-audit)** - ⭐ 50
   A powerful MCP (Model Context Protocol) Server that audits npm package dependencies for security vulnerabilities. Built with remote npm registry integration for real-time security checks.

2085. **[rag-app-on-aws](https://github.com/genieincodebottle/rag-app-on-aws)** - ⭐ 50
...
2086. **[mcp-server-atlassian-jira](https://github.com/aashari/mcp-server-atlassian-jira)** - ⭐ 50
...
2091. **[supermcp](https://github.com/dhanababum/supermcp)** - ⭐ 50
...
2092. **[n8n-workflow-builder-mcp](https://github.com/ifmelate/n8n-workflow-builder-mcp)** - ⭐ 50
   MCP server that allow LLM in agent mode builds n8n workflows for you

2093. **[mcp-server-tauri](https://github.com/hypothesi/mcp-server-tauri)** - ⭐ 50
   A Model Context Protocol (MCP) server and plugin for Tauri v2 development

2094. **[tripadvisor-mcp](https://github.com/pab1it0/tripadvisor-mcp)** - ⭐ 50
...
2095. **[mcp-gearbox](https://github.com/rohitsoni007/mcp-gearbox)** - ⭐ 50
   A modern desktop application for managing Model Context Protocol (MCP) servers across multiple AI agents

2096. **[whois-mcp](https://github.com/bharathvaj-ganesan/whois-mcp)** - ⭐ 49
   MCP Server for whois lookups.

2097. **[mcpo_docker_use](https://github.com/flyfox666/mcpo_docker_use)** - ⭐ 49
...
2098. **[create-mcp](https://github.com/zueai/create-mcp)** - ⭐ 49
...
2099. **[rulego-server](https://github.com/rulego/rulego-server)** - ⭐ 49
   A lightweight dependency-free workflow automation platform. Supports iPaaS, stream computing, MCP, and AI capabilities. 

2100. **[oatpp-mcp](https://github.com/oatpp/oatpp-mcp)** - ⭐ 49
   Anthropic’s Model Context Protocol implementation for Oat++

2101. **[AI-Cursor-Scraping-Assistant](https://github.com/TheWebScrapingClub/AI-Cursor-Scraping-Assistant)** - ⭐ 49
...
2102. **[mcp-oauth-gateway](https://github.com/atrawog/mcp-oauth-gateway)** - ⭐ 49
...
2103. **[scheduler-mcp](https://github.com/PhialsBasement/scheduler-mcp)** - ⭐ 49
...
2104. **[linux-do-mcp](https://github.com/Pleasurecruise/linux-do-mcp)** - ⭐ 49
   A MCP Server For LINUX DO community

2105. **[academia_mcp](https://github.com/IlyaGusev/academia_mcp)** - ⭐ 49
   Academia MCP server: Tools for automatic scientific research

2106. **[Navidrome-MCP](https://github.com/Blakeem/Navidrome-MCP)** - ⭐ 49
...
2107. **[anysite-mcp-server](https://github.com/anysiteio/anysite-mcp-server)** - ⭐ 49
   A Model Context Protocol (MCP) server that provides comprehensive access to LinkedIn data and functionalities using the Anysite API, enabling not only data retrieval but also robust management of user accounts.

2108. **[model-context-protocol-rb](https://github.com/dickdavis/model-context-protocol-rb)** - ⭐ 49
   An implementation of the Model Context Protocol in Ruby.

2109. **[pubmed-mcp-server](https://github.com/cyanheads/pubmed-mcp-server)** - ⭐ 49
...
2110. **[mcp-mermaid-validator](https://github.com/rtuin/mcp-mermaid-validator)** - ⭐ 49
   A Model Context Protocol server that validates and renders Mermaid diagrams.

2111. **[rs-utcp](https://github.com/universal-tool-calling-protocol/rs-utcp)** - ⭐ 49
   Official Rust implementation of the UTCP

2112. **[xc-mcp](https://github.com/conorluddy/xc-mcp)** - ⭐ 49
...
2113. **[mcp-atlassian-server](https://github.com/phuc-nt/mcp-atlassian-server)** - ⭐ 49
   MCP server connecting AI assistants with Jira & Confluence for smart project management.

2114. **[mcp](https://github.com/goplus/mcp)** - ⭐ 48
...
2115. **[auto-MCP-client](https://github.com/Chen-speculation/auto-MCP-client)** - ⭐ 48
...
2116. **[mcp-client-demo](https://github.com/KelvinQiu802/mcp-client-demo)** - ⭐ 48

2117. **[1xn-vmcp](https://github.com/1xn-labs/1xn-vmcp)** - ⭐ 48
   vMCP - Virtual Model Context Protocol

2118. **[mcp-kubernetes](https://github.com/Azure/mcp-kubernetes)** - ⭐ 48
   A Model Context Protocol (MCP) server that enables AI assistants to interact with Kubernetes clusters. It serves as a bridge between AI tools (like Claude, Cursor, and GitHub Copilot) and Kubernetes

2119. **[mcp-things3](https://github.com/drjforrest/mcp-things3)** - ⭐ 48
...
2120. **[nowledge-mem](https://github.com/nowledge-co/nowledge-mem)** - ⭐ 48
   Memory and context manager just works.

2121. **[gemini-cloud-assist-mcp](https://github.com/GoogleCloudPlatform/gemini-cloud-assist-mcp)** - ⭐ 48
   An MCP Server for Gemini Cloud Assist; provides tools to assist with your tasks on GCP

2122. **[vchart-mcp-server](https://github.com/VisActor/vchart-mcp-server)** - ⭐ 48
   A Model Context Protocol (MCP) server for the @visactor/vchart that enables AI assistants to generate interactive charts and visualizations.

2123. **[matlab-mcp-server](https://github.com/subspace-lab/matlab-mcp-server)** - ⭐ 48
   Matlab MCP Server in python

2124. **[mcp-server-chart-minio](https://github.com/zaizaizhao/mcp-server-chart-minio)** - ⭐ 48
   mcp-server-chart私有化部署方案

2125. **[mcp-gitee](https://github.com/oschina/mcp-gitee)** - ⭐ 48
   mcp-gitee is a Model Context Protocol (MCP) server implementation for Gitee. It provides a set of tools that interact with Gitee's API, allowing AI assistants to manage repository, issues, pull requests, etc.

2126. **[hmr](https://github.com/promplate/hmr)** - ⭐ 48
   Real hot-module reload for Python—side effects handled reactively. https://py3.online/hmr

2127. **[CodeMCP](https://github.com/SimplyLiz/CodeMCP)** - ⭐ 48
   Code intelligence for AI assistants - MCP server, CLI, and HTTP API with symbol navigation, impact analysis, and architecture mapping

2128. **[mcp-server](https://github.com/inkdropapp/mcp-server)** - ⭐ 48
   Inkdrop Model Context Protocol Server

2129. **[tuisic](https://github.com/Dark-Kernel/tuisic)** - ⭐ 48
...
2130. **[attio-mcp-server](https://github.com/kesslerio/attio-mcp-server)** - ⭐ 48
   Attio Model Context Protocol (MCP) server implementation

2131. **[canvas-mcp](https://github.com/vishalsachdev/canvas-mcp)** - ⭐ 48
   A Model Context Protocol server to run locally and connect to a Canvas LMS 

2132. **[mcp_demo](https://github.com/Ming-jiayou/mcp_demo)** - ⭐ 48
   A simple example of building an MCP client using C#.

2133. **[kuon](https://github.com/lissettecarlr/kuon)** - ⭐ 47
...
2140. **[crawlbase-mcp](https://github.com/crawlbase/crawlbase-mcp)** - ⭐ 47
   Crawlbase MCP Server connects AI agents and LLMs with real-time web data. It powers Claude, Cursor, and Windsurf integrations with battle-tested web scraping, JavaScript rendering, and anti-bot protection enabling structured, live data inside your AI workflows.

2141. **[ai-humanizer-mcp-server](https://github.com/Text2Go/ai-humanizer-mcp-server)** - ⭐ 47
   A powerful Model Context Protocol (MCP) server that helps refine AI-generated content to sound more natural and human-like. Built with advanced AI detection and text enhancement capabilities.

2142. **[UnrealMotionGraphicsMCP](https://github.com/winyunq/UnrealMotionGraphicsMCP)** - ⭐ 47
...
2143. **[mcp-openapi-schema](https://github.com/hannesj/mcp-openapi-schema)** - ⭐ 46
   OpenAPI Schema Model Context Protocol Server

2144. **[langchain-mcp-client](https://github.com/guinacio/langchain-mcp-client)** - ⭐ 46
   This Streamlit application provides a user interface for connecting to MCP (Model Context Protocol) servers and interacting with them using different LLM providers (OpenAI, Anthropic, Google, Ollama).

2145. **[APIWeaver](https://github.com/GongRzhe/APIWeaver)** - ⭐ 46
...
2146. **[ns-mcp-server](https://github.com/r-huijts/ns-mcp-server)** - ⭐ 46
   A Model Context Protocol (MCP) server that provides access to NS (Dutch Railways) travel information through Claude AI. This server enables Claude to fetch real-time train travel information and disruptions using the official Dutch NS API.

2147. **[eliza-plugin-mcp](https://github.com/fleek-platform/eliza-plugin-mcp)** - ⭐ 46
   ElizaOS plugin allowing agents to connect to MCP servers

2148. **[Homeassistant-server-mcp](https://github.com/hekmon8/Homeassistant-server-mcp)** - ⭐ 46
   A Model Context Protocol (MCP) server for interacting with Home Assistant. This server provides tools to control and monitor your Home Assistant devices through MCP-enabled applications.

2149. **[Aspire.MCP.Sample](https://github.com/elbruno/Aspire.MCP.Sample)** - ⭐ 46
   Sample MCP Server and MCP client with Aspire

2150. **[mcp-lite-dev](https://github.com/datawhalechina/mcp-lite-dev)** - ⭐ 46
   共学《MCP极简开发》项目代码

2151. **[mcp-victorialogs](https://github.com/VictoriaMetrics-Community/mcp-victorialogs)** - ⭐ 46
   The implementation of Model Context Protocol (MCP) server for VictoriaLogs.

2152. **[shadowgit-mcp](https://github.com/blade47/shadowgit-mcp)** - ⭐ 46
...
2153. **[codex-mcp-go](https://github.com/w31r4/codex-mcp-go)** - ⭐ 46
...
2154. **[image-gen-mcp](https://github.com/lansespirit/image-gen-mcp)** - ⭐ 46
   An MCP server that integrates with gpt-image-1 & Gemini imagen4 model for text-to-image generation services

2155. **[steel-mcp-server](https://github.com/steel-dev/steel-mcp-server)** - ⭐ 46
   MCP Server for interacting with a Steel web browser

2156. **[dremio-mcp](https://github.com/dremio/dremio-mcp)** - ⭐ 46
   Dremio MCP server

2157. **[hackmd-mcp](https://github.com/yuna0x0/hackmd-mcp)** - ⭐ 46
   A Model Context Protocol server for integrating HackMD's note-taking platform with AI assistants.

2158. **[mcp](https://github.com/40ants/mcp)** - ⭐ 46
   40ANTS-MCP is a framework for building Model Context Protocol servers in Common Lisp

2159. **[semanticscholar-MCP-Server](https://github.com/JackKuo666/semanticscholar-MCP-Server)** - ⭐ 46
   🔍 This project implements a Model Context Protocol (MCP) server for interacting with the Semantic Scholar API. It provides tools for searching papers, retrieving paper and author details, and fetching citations and references.

2160. **[mcp-sdk](https://github.com/symfony/mcp-sdk)** - ⭐ 45
   Model Context Protocol SDK for Client and Server applications in PHP

2161. **[mcp-made-simple](https://github.com/chongdashu/mcp-made-simple)** - ⭐ 45
   Model Context Protocol (MCP) Made Simple - Code for the tutorial series - focusing on practical ways to understand and use MCP

2162. **[Serper-search-mcp](https://github.com/NightTrek/Serper-search-mcp)** - ⭐ 45
   Un-official Serper Google search server for Cline and other MCP clients

2163. **[mcpcat-python-sdk](https://github.com/MCPCat/mcpcat-python-sdk)** - ⭐ 45
   MCPcat is an analytics platform for MCP server owners 🐱.

2164. **[mcp-rdf-explorer](https://github.com/emekaokoye/mcp-rdf-explorer)** - ⭐ 45
...
2165. **[mcp-youtube](https://github.com/adhikasp/mcp-youtube)** - ⭐ 45
   Model Context Protocol to fetch youtube transcript

2166. **[sample-agentic-ai-web](https://github.com/aws-samples/sample-agentic-ai-web)** - ⭐ 45
...
2167. **[excalidraw-mcp](https://github.com/i-tozer/excalidraw-mcp)** - ⭐ 45
   Model Context Protocol (MCP) server for Excalidraw - Work in Progress

2168. **[calculator-mcp-server](https://github.com/huhabla/calculator-mcp-server)** - ⭐ 45
   A Model Context Protocol (MCP) server that provides Claude with advanced mathematical calculation capabilities

2169. **[marinade-finance-mcp-server](https://github.com/lorine93s/marinade-finance-mcp-server)** - ⭐ 45
   Marinade Finance MCP Server is an MCP server specifically designed for the Marinade Finance.

2170. **[mcp-server-atlassian-confluence](https://github.com/aashari/mcp-server-atlassian-confluence)** - ⭐ 45
   Node.js/TypeScript MCP server for Atlassian Confluence. Provides tools enabling AI systems (LLMs) to list/get spaces & pages (content formatted as Markdown) and search via CQL. Connects AI seamlessly to Confluence knowledge bases using the standard MCP interface.

2171. **[meme-mcp](https://github.com/haltakov/meme-mcp)** - ⭐ 45
   A simple Model Context Protocol (MCP) server for generating memes using the ImgFlip API

2172. **[vercel-ai-docs-mcp](https://github.com/IvanAmador/vercel-ai-docs-mcp)** - ⭐ 45
   A Model Context Protocol (MCP) server that provides AI-powered search and querying capabilities for the Vercel AI SDK documentation. This project enables developers to ask questions about the Vercel AI SDK and receive accurate, contextualized responses based on the official documentation.

2173. **[awesome-mcp-security](https://github.com/AIM-Intelligence/awesome-mcp-security)** - ⭐ 45
   Security Threats related with MCP (Model Context Protocol), MCP Servers and more

2174. **[langchaingo-mcp-adapter](https://github.com/i2y/langchaingo-mcp-adapter)** - ⭐ 45
   A Go adapter that bridges LangChain Go tools with Model Context Protocol (MCP) servers.

2175. **[dataproduct-mcp](https://github.com/entropy-data/dataproduct-mcp)** - ⭐ 45
...
2176. **[mcp-starter-template](https://github.com/StevenStavrakis/mcp-starter-template)** - ⭐ 45
   An opinionated starter template for making Model Context Protocol (MCP) servers

2177. **[tiger-slack](https://github.com/timescale/tiger-slack)** - ⭐ 45
   Real-time Slack ingest and MCP server to power your agentic Slack bots

2178. **[advanced-homeassistant-mcp](https://github.com/jango-blockchained/advanced-homeassistant-mcp)** - ⭐ 45
   An advanced MCP server for Home Assistant. 🔋 Batteries included.

2179. **[flightradar24-mcp-server](https://github.com/sunsetcoder/flightradar24-mcp-server)** - ⭐ 45
   Model Context Protocol server for Flight Tracking

2180. **[Reversecore_MCP](https://github.com/sjkim1127/Reversecore_MCP)** - ⭐ 45
...
2181. **[EDT-MCP](https://github.com/DitriXNew/EDT-MCP)** - ⭐ 45
   MCP for 1C:EDT

2182. **[modular-mcp](https://github.com/d-kimuson/modular-mcp)** - ⭐ 45
   A Model Context Protocol (MCP) proxy server that enables efficient management of large tool collections across multiple MCP servers by grouping them and loading tool schemas on-demand.

2183. **[esa-mcp-server](https://github.com/esaio/esa-mcp-server)** - ⭐ 45
   esa.io の公式 MCP(Model Context Protocol)サーバー(STDIO Transport版)

2184. **[godot-mcp](https://github.com/bradypp/godot-mcp)** - ⭐ 45
   A Model Context Protocol (MCP) server for interacting with the Godot game engine.

2185. **[moondream-mcp](https://github.com/ColeMurray/moondream-mcp)** - ⭐ 45
   Moondream MCP Server in Python

2186. **[mcp_server_notify](https://github.com/Cactusinhand/mcp_server_notify)** - ⭐ 45
   Send system notification when Agent task is done.

2187. **[abaqus-mcp-server](https://github.com/jianzhichun/abaqus-mcp-server)** - ⭐ 45
...
2188. **[mcp-mail](https://github.com/shuakami/mcp-mail)** - ⭐ 45
   📧 MCP Mail Tool - AI-powered email management tool | 基于 MCP 的智能邮件管理工具

2189. **[clinicaltrialsgov-mcp-server](https://github.com/cyanheads/clinicaltrialsgov-mcp-server)** - ⭐ 45
...
2190. **[pprof-analyzer-mcp](https://github.com/ZephyrDeng/pprof-analyzer-mcp)** - ⭐ 44
   This is a Model Context Protocol (MCP) server implemented in Go, providing a tool to analyze Go pprof performance profiles.

2191. **[vue-mcp-next](https://github.com/tuskermanshu/vue-mcp-next)** - ⭐ 44
...
2192. **[generic-mcp-client-chat](https://github.com/rom1504/generic-mcp-client-chat)** - ⭐ 44
   Generic MCP Client to use any MCP tool in a chat

2193. **[spring-ai-mcp-client](https://github.com/ogulcanarbc/spring-ai-mcp-client)** - ⭐ 44
...
2194. **[Claude-Project-Coordinator](https://github.com/M-Pineapple/Claude-Project-Coordinator)** - ⭐ 44
...
2195. **[thingspanel-mcp](https://github.com/ThingsPanel/thingspanel-mcp)** - ⭐ 44
...
2200. **[gnome-mcp-server](https://github.com/bilelmoussaoui/gnome-mcp-server)** - ⭐ 44
   Grant the AI octopus access to a portion of your desktop

2201. **[ainovelprompter](https://github.com/danielsobrado/ainovelprompter)** - ⭐ 44
   Create the prompts you need to write your Novel using AI

2202. **[mcp-typescribe](https://github.com/yWorks/mcp-typescribe)** - ⭐ 44
   An MCP server implementation enabling LLMs to work with new APIs and frameworks

2203. **[code-screenshot-mcp](https://github.com/MoussaabBadla/code-screenshot-mcp)** - ⭐ 44
   MCP server for generating beautiful code screenshots directly from Claude

2204. **[mcp-tts](https://github.com/blacktop/mcp-tts)** - ⭐ 44
   MCP Server for Text to Speech

2205. **[mcp-dap-server](https://github.com/go-delve/mcp-dap-server)** - ⭐ 44
   MCP server to communicate with DAP servers allowing AI Agents the ability to debug live programs.

2206. **[mcp](https://github.com/getAlby/mcp)** - ⭐ 44
   Connect a bitcoin lightning wallet to your LLM using Nostr Wallet Connect and Model Context Protocol

2207. **[skrills](https://github.com/athola/skrills)** - ⭐ 44
...
2208. **[globalping-mcp-server](https://github.com/jsdelivr/globalping-mcp-server)** - ⭐ 44
   Remote MCP server that gives LLMs access to run network commands

2209. **[powhttp-mcp](https://github.com/usestring/powhttp-mcp)** - ⭐ 44
   MCP server enabling agents to debug HTTP requests better (using powhttp)

2210. **[scaled-mcp](https://github.com/Traego/scaled-mcp)** - ⭐ 44
   ScaledMCP is a horizontally scalabled MCP and A2A Server. You know, for AI.

2211. **[buildkite-mcp-server](https://github.com/buildkite/buildkite-mcp-server)** - ⭐ 44
   Official MCP Server for Buildkite.

2212. **[langfuse-mcp](https://github.com/avivsinai/langfuse-mcp)** - ⭐ 44
   A Model Context Protocol (MCP) server for Langfuse, enabling AI agents to query Langfuse trace data for enhanced debugging and observability

2213. **[js](https://github.com/mcp-auth/js)** - ⭐ 44
   🔐 Plug-and-play auth for Node.js MCP servers.

2214. **[luma-mcp](https://github.com/JochenYang/luma-mcp)** - ⭐ 44
...
2215. **[mcp-image](https://github.com/shinpr/mcp-image)** - ⭐ 44
...
2216. **[blockbench-mcp-plugin](https://github.com/jasonjgardner/blockbench-mcp-plugin)** - ⭐ 44
   Adds MCP server to Blockbench

2217. **[mcp-metabase-server](https://github.com/easecloudio/mcp-metabase-server)** - ⭐ 44
   A comprehensive MCP server for Metabase with 70+ tools.

2218. **[rust-analyzer-mcp](https://github.com/zeenix/rust-analyzer-mcp)** - ⭐ 44
   A Model Context Protocol (MCP) server that provides integration with rust-analyzer

2219. **[desktop](https://github.com/agentify-sh/desktop)** - ⭐ 44
...
2220. **[wechat-mcp](https://github.com/JettChenT/wechat-mcp)** - ⭐ 43
   Model Context Protocol for WeChat

2221. **[MCPP.Net](https://github.com/xuzeyu91/MCPP.Net)** - ⭐ 43
   Model Context Protocol Platform，统一管理你的MCP服务

2222. **[mcp-playground](https://github.com/Elkhn/mcp-playground)** - ⭐ 43
   A Streamlit-based chat app for LLMs with plug-and-play tool support via Model Context Protocol (MCP), powered by LangChain, LangGraph, and Docker.

2223. **[taskMaster-todoist-mcp](https://github.com/mingolladaniele/taskMaster-todoist-mcp)** - ⭐ 43
...
2224. **[LLaMa-MCP-Streamlit](https://github.com/Nikunj2003/LLaMa-MCP-Streamlit)** - ⭐ 43
   AI assistant built with Streamlit, NVIDIA NIM (LLaMa 3.3:70B) / Ollama, and Model Control Protocol (MCP).

2225. **[pdf-mcp](https://github.com/saury1120/pdf-mcp)** - ⭐ 43
   一个强大的 PDF 处理 MCP（Model Context Protocol）服务，提供全面的 PDF 文档分析功能

2226. **[mcp-agents-hub](https://github.com/mcp-agents-ai/mcp-agents-hub)** - ⭐ 43
   The open-source ecosystem for building, discovering, and deploying Model Context Protocol servers and clients.

2227. **[mcp-servers-kagi](https://github.com/ac3xx/mcp-servers-kagi)** - ⭐ 43
   A Model Context Protocol server implementation for Kagi's API

2228. **[world_bank_mcp_server](https://github.com/anshumax/world_bank_mcp_server)** - ⭐ 43
   An implementation of the Model Context Protocol for the World Bank open data API

2229. **[bookstack-mcp-server](https://github.com/pnocera/bookstack-mcp-server)** - ⭐ 43
   A Model Context Protocol (MCP) server providing full access to BookStack's knowledge management capabilities

2230. **[mcp-container-ts](https://github.com/Azure-Samples/mcp-container-ts)** - ⭐ 43
   This is a quick start guide that provides the basic building blocks to set up a remote Model Context Protocol (MCP) server using Azure Container Apps. The MCP server is built using Node.js and TypeScript, and it can be used to run various tools and services in a serverless environment.

2231. **[mcp-server-ledger](https://github.com/minhyeoky/mcp-server-ledger)** - ⭐ 43
   A Model Context Protocol server for interacting with Ledger CLI, a powerful double-entry accounting system. This server enables Large Language Models to query and analyze financial data through a standardized interface, making it easy for AI assistants to help with financial reporting, budget analysis, and accounting tasks.

2232. **[vikunja-mcp](https://github.com/democratize-technology/vikunja-mcp)** - ⭐ 43
   Model Context Protocol server for Vikunja task management. Enables AI assistants to interact with Vikunja instances via MCP.

2233. **[any2markdown](https://github.com/WW-AI-Lab/any2markdown)** - ⭐ 43
...
2234. **[mcp-graphql-schema](https://github.com/hannesj/mcp-graphql-schema)** - ⭐ 43
   GraphQL Schema Model Context Protocol Server

2235. **[openrpc-mcp-server](https://github.com/shanejonas/openrpc-mcp-server)** - ⭐ 43
   A Model Context Protocol (MCP) server that provides JSON-RPC functionality through OpenRPC.

2236. **[python-notebook-mcp](https://github.com/UsamaK98/python-notebook-mcp)** - ⭐ 43
   Lightweight Python Notebook MCP - Enable AI assistants to create, edit, and view Jupyter notebooks via Model Context Protocol

2237. **[beemcp](https://github.com/OkGoDoIt/beemcp)** - ⭐ 43
   BeeMCP: an unofficial Model Context Protocol (MCP) server that connects your Bee wearable lifelogger to AI via the Model Context Protocol

2238. **[godoctor](https://github.com/danicat/godoctor)** - ⭐ 43
   A Model Context Protocol server for Go developers

2239. **[mcp-openmsx](https://github.com/nataliapc/mcp-openmsx)** - ⭐ 43
...
2240. **[devcontext](https://github.com/aiurda/devcontext)** - ⭐ 43
   DevContext is a cutting-edge Model Context Protocol (MCP) server designed to provide developers with continuous, project-centric context awareness. Unlike traditional context systems, DevContext continuously learns from and adapts to your development patterns and delivers highly relevant context providing a deeper understanding of your codebase.

2241. **[MCP-Airflow-API](https://github.com/call518/MCP-Airflow-API)** - ⭐ 43
...
2242. **[chrome-debug-mcp](https://github.com/robertheadley/chrome-debug-mcp)** - ⭐ 43
   An MCP server to allow you to debug webpages using LLMs

2243. **[mcp-yfinance-server](https://github.com/Adity-star/mcp-yfinance-server)** - ⭐ 43
   Real-time stock API with Python, MCP server example, yfinance stock analysis dashboard

2244. **[mcp-rquest](https://github.com/xxxbrian/mcp-rquest)** - ⭐ 43
...
2245. **[mcp-zen](https://github.com/199-mcp/mcp-zen)** - ⭐ 43
   Enhanced Zen MCP Server with 'zen' default tool and improvements

2246. **[inAI-wiki](https://github.com/inai-sandy/inAI-wiki)** - ⭐ 43
   🌍 The open-source Wikipedia of AI — 2M+ apps, agents, LLMs & datasets. Updated daily with tools, tutorials & news.

2247. **[MCPApp](https://github.com/tanaikech/MCPApp)** - ⭐ 43
   This text introduces the Model Context Protocol (MCP) for AI interaction, exploring Google Apps Script (GAS) as a server option. It shows feasibility with a sample but notes the lack of a GAS SDK, aiming to encourage understanding and development.

2248. **[dynamic-fastmcp](https://github.com/ragieai/dynamic-fastmcp)** - ⭐ 43
...
2249. **[caldav-mcp](https://github.com/dominik1001/caldav-mcp)** - ⭐ 43
   A CalDAV client using Model Context Protocol (MCP) to expose calendar operations as tools for AI assistants.

2250. **[pagerduty-mcp-server](https://github.com/PagerDuty/pagerduty-mcp-server)** - ⭐ 43
   PagerDuty's official local MCP (Model Context Protocol) server which provides tools to interact with your PagerDuty account directly from your MCP-enabled client.

2251. **[mcp-amadeus](https://github.com/donghyun-chae/mcp-amadeus)** - ⭐ 43
   Amadeus MCP(Model Context Protocol) Server

2252. **[cinema4d-mcp](https://github.com/ttiimmaacc/cinema4d-mcp)** - ⭐ 43
   Cinema 4D plugin integrating Claude AI for prompt-driven 3D modeling, scene creation, and manipulation.

2253. **[solana-dev-mcp](https://github.com/solana-foundation/solana-dev-mcp)** - ⭐ 42
   Solana Model Context Protocol (MCP) Demo

2254. **[awesome-mcp-servers](https://github.com/mctrinh/awesome-mcp-servers)** - ⭐ 42
   A curated list of excellent Model Context Protocol (MCP) servers.

2255. **[mcp_server_filesystem](https://github.com/MarcusJellinghaus/mcp_server_filesystem)** - ⭐ 42
   MCP File System Server: A secure Model Context Protocol server that provides file operations for AI assistants. Enables Claude and other assistants to safely read, write, and list files in a designated project directory with robust path validation and security controls.

2256. **[gradle-mcp-server](https://github.com/IlyaGulya/gradle-mcp-server)** - ⭐ 42
   A Model Context Protocol (MCP) server to enable AI tools to interact with Gradle projects programmatically.

2257. **[mcp-ai-memory](https://github.com/scanadi/mcp-ai-memory)** - ⭐ 42
   A production-ready Model Context Protocol (MCP) server for semantic memory management

2258. **[youtrack-mcp](https://github.com/devstroop/youtrack-mcp)** - ⭐ 42
   An MCP (Model Context Protocol) server that provides YouTrack REST API access to AI agents

2259. **[Claude-Deep-Research](https://github.com/mcherukara/Claude-Deep-Research)** - ⭐ 42
   An MCP (Model Context Protocol) server that enables comprehensive research capabilities for Claude

2260. **[agentic-developer-mcp](https://github.com/teabranch/agentic-developer-mcp)** - ⭐ 42
   An MCP server that scales development into controllable agentic, recursive flows, and build a feature from bottom-up

2261. **[mcp-server-arangodb](https://github.com/ravenwits/mcp-server-arangodb)** - ⭐ 42
   This is a TypeScript-based MCP server that provides database interaction capabilities through ArangoDB. It implements core database operations and allows seamless integration with ArangoDB through MCP tools. You can use it wih Claude app and also extension for VSCode that works with mcp like Cline!

2262. **[ai-software-architect](https://github.com/codenamev/ai-software-architect)** - ⭐ 42
...
2263. **[mobile-dev-mcp-server](https://github.com/jsuarezruiz/mobile-dev-mcp-server)** - ⭐ 42
   This is a MCP designed to manage and interact with mobile devices and simulators.

2264. **[python-dependency-manager-companion-mcp-server](https://github.com/KemingHe/python-dependency-manager-companion-mcp-server)** - ⭐ 42
   Self-updating MCP server to cross-ref latest official pip, conda, poetry, uv, pixi, and pdm docs

2265. **[contentful-mcp-server](https://github.com/contentful/contentful-mcp-server)** - ⭐ 42
   MCP (Model Context Protocol) server for the Contentful Management API

2266. **[repl-mcp](https://github.com/simm-is/repl-mcp)** - ⭐ 42
   Model Context Protocol Clojure support including REPL integration with development tools.

2267. **[cli](https://github.com/syrin-labs/cli)** - ⭐ 42
   Runtime intelligence system that makes MCP servers debuggable, testable, and safe to run in production.

2268. **[mcp-design-system-extractor](https://github.com/freema/mcp-design-system-extractor)** - ⭐ 42
   MCP (Model Context Protocol) server that enables AI assistants to interact with Storybook design systems. Extract component HTML, analyze styles, and help with design system adoption and refactoring.

2269. **[shotgrid-mcp-server](https://github.com/loonghao/shotgrid-mcp-server)** - ⭐ 42
   A Model Context Protocol (MCP) server for Autodesk ShotGrid/Flow Production Tracking (FPT) with comprehensive CRUD operations and data management capabilities.

2270. **[prism-mcp-rs](https://github.com/prismworks-ai/prism-mcp-rs)** - ⭐ 42
   Enterprise-grade Rust implementation of Anthropic's MCP protocol

2271. **[lighthouse-mcp-server](https://github.com/danielsogl/lighthouse-mcp-server)** - ⭐ 42
   MCP server that enables AI agents to perform comprehensive web audits using Google Lighthouse with 13+ tools for performance, accessibility, SEO, and security analysis.

2272. **[platform-context-exporter](https://github.com/alkoleft/platform-context-exporter)** - ⭐ 41
   Инструмент для выгрузки синтаксис помощника в файлы

2273. **[mcp-server](https://github.com/profullstack/mcp-server)** - ⭐ 41
   A generic, modular server for implementing the Model Context Protocol (MCP). 

2274. **[mcp-server-js](https://github.com/yepcode/mcp-server-js)** - ⭐ 41
...
2275. **[dynamic-shell-server](https://github.com/codelion/dynamic-shell-server)** - ⭐ 41
   Dynamic Shell Command MCP Server

2276. **[zig-mcp-server](https://github.com/openSVM/zig-mcp-server)** - ⭐ 41
   A Model Context Protocol (MCP) server that provides Zig language tooling, code analysis, and documentation access. This server enhances AI capabilities with Zig-specific functionality including code optimization, compute unit estimation, code generation, and best practices recommendations.

2277. **[kafka-mcp-server](https://github.com/tuannvm/kafka-mcp-server)** - ⭐ 41
   A Model Context Protocol (MCP) server for Apache Kafka implemented in Go, leveraging franz-go and mcp-go.

2278. **[mcp](https://github.com/Azure-Samples/mcp)** - ⭐ 41
...
2279. **[salesforce-mcp-server](https://github.com/kablewy/salesforce-mcp-server)** - ⭐ 41
   Model Context Protocol server for Salesforce REST API integration

2280. **[mailgun-mcp-server](https://github.com/mailgun/mailgun-mcp-server)** - ⭐ 41
   Implementation of Model Context Protocol server for Mailgun APIs

2281. **[mcp-toolbox-sdk-go](https://github.com/googleapis/mcp-toolbox-sdk-go)** - ⭐ 41
   Go SDK for interacting with the MCP Toolbox for Databases.

2282. **[mcp-logic](https://github.com/angrysky56/mcp-logic)** - ⭐ 41
...
2283. **[dify-mcp-server](https://github.com/AI-FE/dify-mcp-server)** - ⭐ 41
   A Model Context Protocol server for Dify

2284. **[ZMCPTools](https://github.com/ZachHandley/ZMCPTools)** - ⭐ 41
   A custom TypeScript MCP Server intended to be used with Claude Code

2285. **[zed-mcp-server-sequential-thinking](https://github.com/LoamStudios/zed-mcp-server-sequential-thinking)** - ⭐ 41
   A sequential thinking MCP server extension for Zed

2286. **[kanban-mcp](https://github.com/bradrisse/kanban-mcp)** - ⭐ 41
...
2287. **[p4mcp-server](https://github.com/perforce/p4mcp-server)** - ⭐ 41
...
2288. **[locallama-mcp](https://github.com/Heratiki/locallama-mcp)** - ⭐ 41
...
2289. **[mcp-codestyle-server](https://github.com/itxaiohanglover/mcp-codestyle-server)** - ⭐ 41
...
2290. **[davinci-resolve-mcp](https://github.com/apvlv/davinci-resolve-mcp)** - ⭐ 41
   A Model Context Protocol (MCP) server for interacting with DaVinci Resolve and Fusion

2291. **[seekcode](https://github.com/seekrays/seekcode)** - ⭐ 41
   A clean and efficient code snippet and clipboard management tool designed for developers

2292. **[illustrator-mcp-server](https://github.com/spencerhhubert/illustrator-mcp-server)** - ⭐ 41
   mcp server to run scripts on adobe illustrator

2293. **[activitywatch-mcp-server](https://github.com/8bitgentleman/activitywatch-mcp-server)** - ⭐ 41
   Model Context Protocol server for ActivityWatch time tracking data

2294. **[gimp-mcp](https://github.com/maorcc/gimp-mcp)** - ⭐ 41
   GIMP MCP server

2295. **[mcp_rails_template](https://github.com/seuros/mcp_rails_template)** - ⭐ 40
   A minimal Rails API template for creating MCP (Model Context Protocol) servers with robust tool execution capabilities and examples.

2296. **[agentic-mcp-client](https://github.com/peakmojo/agentic-mcp-client)** - ⭐ 40
   A standalone agent runner that executes tasks using MCP (Model Context Protocol) tools via Anthropic Claude, AWS BedRock and OpenAI APIs. It enables AI agents to run autonomously in cloud environments and interact with various systems securely.

2297. **[nmap-mcp-server](https://github.com/PhialsBasement/nmap-mcp-server)** - ⭐ 40
   A Model Context Protocol (MCP) server that enables AI assistants to perform network scanning operations using NMAP

2298. **[instagram-engagement-mcp](https://github.com/Bob-lance/instagram-engagement-mcp)** - ⭐ 40
...
2299. **[browser-use-mcp-client](https://github.com/Linzo99/browser-use-mcp-client)** - ⭐ 40
   A MCP client for browser-use

2300. **[mcp-zenml](https://github.com/zenml-io/mcp-zenml)** - ⭐ 40
   MCP server to connect an MCP client (Cursor, Claude Desktop etc) with your ZenML MLOps and LLMOps pipelines

2301. **[beanquery-mcp](https://github.com/vanto/beanquery-mcp)** - ⭐ 40
...
2302. **[mcp-shell](https://github.com/hdresearch/mcp-shell)** - ⭐ 40
   Execute a secure shell in Claude Desktop using the Model Context Protocol.

2303. **[mcp-ssh](https://github.com/AiondaDotCom/mcp-ssh)** - ⭐ 40
   A Model Context Protocol (MCP) server for managing and controlling SSH connections.

2304. **[osm-mcp](https://github.com/wiseman/osm-mcp)** - ⭐ 40
   Model Context Protocol server for OpenStreetMap data

2305. **[codebadger](https://github.com/Lekssays/codebadger)** - ⭐ 40
...
2306. **[bsky-mcp-server](https://github.com/brianellin/bsky-mcp-server)** - ⭐ 40
   Bluesky MCP (Model Context Protocol) Server

2307. **[just-mcp](https://github.com/toolprint/just-mcp)** - ⭐ 40
   Share the same project justfile tasks with your AI Coding Agent.

2308. **[scraps](https://github.com/boykush/scraps)** - ⭐ 40
   Scraps is a portable CLI knowledge hub for managing interconnected Markdown documentation with Wiki-link notation.

2309. **[imap-mcp](https://github.com/non-dirty/imap-mcp)** - ⭐ 40
   IMAP Model Context Protocol server for interactive email processing

2310. **[anki-mcp](https://github.com/nietus/anki-mcp)** - ⭐ 40
   MCP server for anki

2311. **[sugar](https://github.com/roboticforce/sugar)** - ⭐ 40
   🍰 Sugar - The autonomous layer for AI coding agents

2312. **[lc2mcp](https://github.com/xiaotonng/lc2mcp)** - ⭐ 40
   Convert LangChain tools to FastMCP tools

2313. **[firefox-devtools-mcp](https://github.com/freema/firefox-devtools-mcp)** - ⭐ 40
   Model Context Protocol server for Firefox DevTools - enables AI assistants to inspect and control Firefox browser through the Remote Debugging Protocol

2314. **[dotcom.chat](https://github.com/kamath/dotcom.chat)** - ⭐ 39
   A simple NextJS MCP client with sensible keybindings

2315. **[MCPollinations](https://github.com/pinkpixel-dev/MCPollinations)** - ⭐ 39
   A Model Context Protocol (MCP) server that enables AI assistants to generate images, text, and audio through the Pollinations APIs. Supports customizable parameters, image saving, and multiple model options.

2316. **[sharepoint-mcp](https://github.com/DEmodoriGatsuO/sharepoint-mcp)** - ⭐ 39
...
2317. **[mcp_code_analyzer](https://github.com/emiryasar/mcp_code_analyzer)** - ⭐ 39
   A Model Context Protocol (MCP) server implementation for comprehensive code analysis. This tool integrates with Claude Desktop to provide code analysis capabilities through natural language interactions.

2318. **[mcp-crypto-price](https://github.com/truss44/mcp-crypto-price)** - ⭐ 39
   A Model Context Protocol (MCP) server that provides real-time cryptocurrency analysis via CoinCap's API. Enables Claude and other MCP clients to fetch crypto prices, analyze market trends, and track historical data.

2319. **[mmcp](https://github.com/koki-develop/mmcp)** - ⭐ 39
   🛠️ Manage your MCP (Model Context Protocol) server definitions in one place and apply them to supported agents.

2320. **[mcp-desktop](https://github.com/http4k/mcp-desktop)** - ⭐ 39
   http4k MCP Desktop Client

2321. **[mcp-client-server-host-demo](https://github.com/danwritecode/mcp-client-server-host-demo)** - ⭐ 39
   A quick pokemon demo to showcase MCP server, client, and host

2322. **[mcp](https://github.com/kyopark2014/mcp)** - ⭐ 39
   It shows how to use model-context-protocol. 

2323. **[openrouter-deep-research-mcp](https://github.com/wheattoast11/openrouter-deep-research-mcp)** - ⭐ 39
...
2324. **[mssql-mcp](https://github.com/daobataotie/mssql-mcp)** - ⭐ 39
   mssql mcp server

2325. **[mcp_ctl](https://github.com/runablehq/mcp_ctl)** - ⭐ 39
   A package manager to manage all your mcp servers across platforms

2326. **[algorand-mcp](https://github.com/GoPlausible/algorand-mcp)** - ⭐ 39
   Algorand Model Context Protocol (Server & Client)

2327. **[How-To-Create-MCP-Server](https://github.com/nisalgunawardhana/How-To-Create-MCP-Server)** - ⭐ 39
   This guide will help you set up a basic MCP (Model Context Protocol) server in .NET, configure it in VS Code, and interact with it using Copilot Chat.

2328. **[mcp-panther](https://github.com/panther-labs/mcp-panther)** - ⭐ 39
   Write detections, investigate alerts, and query logs from your favorite AI agents

2329. **[MCPToolBenchPP](https://github.com/mcp-tool-bench/MCPToolBenchPP)** - ⭐ 39
   MCPToolBench++ MCP Model Context Protocol Tool Use Benchmark on AI Agent and Model Tool Use Ability

2330. **[MayaMCP](https://github.com/PatrickPalmer/MayaMCP)** - ⭐ 39
   Model Context Protocol (MCP) server implementation for Autodesk Maya

2331. **[mcp-android-server-python](https://github.com/nim444/mcp-android-server-python)** - ⭐ 39
   MCP Android agent - This project provides an *MCP (Model Context Protocol)* server for automating Android devices using uiautomator2. It's designed to be easily plugged into AI agents like GitHub Copilot Chat, Claude, or Open Interpreter to control Android devices through natural language.

2332. **[binance-mcp-server](https://github.com/AnalyticAce/binance-mcp-server)** - ⭐ 39
...
2333. **[nia](https://github.com/nozomio-labs/nia)** - ⭐ 39
...
2334. **[middy-mcp](https://github.com/fredericbarthelet/middy-mcp)** - ⭐ 38
   Middy middleware for Model Context Protocol server hosting on AWS Lambda

2335. **[dev-to-mcp](https://github.com/nickytonline/dev-to-mcp)** - ⭐ 38
   A remote Model Context Protocol (MCP) server for interacting with the dev.to public API without requiring authentication.

2336. **[mcp-center](https://github.com/nautilus-ops/mcp-center)** - ⭐ 38
   A centralized platform for managing and connecting MCP servers. MCP Center provides a high-performance proxy service that enables seamless communication between MCP clients and multiple MCP servers.

2337. **[McpDotNet.Extensions.SemanticKernel](https://github.com/StefH/McpDotNet.Extensions.SemanticKernel)** - ⭐ 38
   Microsoft SemanticKernel integration for the Model Context Protocol (MCP). Enables seamless use of MCP tools as AI functions.

2338. **[okta-mcp-server](https://github.com/fctr-id/okta-mcp-server)** - ⭐ 38
   The Okta MCP Server is a groundbreaking tool built by the team at Fctr that enables AI models to interact directly with your Okta environment using the Model Context Protocol (MCP). Built specifically for IAM engineers, security teams, and Okta administrators, it implements the MCP specification to help work with Okta enitities

2339. **[grafana-mcp-analyzer](https://github.com/SailingCoder/grafana-mcp-analyzer)** - ⭐ 38
   让AI助手直接分析你的Grafana监控数据 - A Model Context Protocol server for Grafana data analysis

2340. **[mcp_weather_server](https://github.com/isdaniel/mcp_weather_server)** - ⭐ 38
   A Model Context Protocol (MCP) server that provides weather information using the Open-Meteo API.

2341. **[open-ghl-mcp](https://github.com/basicmachines-co/open-ghl-mcp)** - ⭐ 38
   An open source Model Context Protocol server for GoHighLevel API v2 with OAuth

2342. **[shodan-mcp-server](https://github.com/Cyreslab-AI/shodan-mcp-server)** - ⭐ 38
   A Model Context Protocol server that provides access to Shodan API functionality

2343. **[discourse-mcp](https://github.com/discourse/discourse-mcp)** - ⭐ 38
   MCP client for Discourse sites

2344. **[mcp-server-webcrawl](https://github.com/pragmar/mcp-server-webcrawl)** - ⭐ 38
   MCP server tailored to connecting web crawler data and archives

2345. **[pbixray-mcp-server](https://github.com/jonaolden/pbixray-mcp-server)** - ⭐ 38
...
2346. **[yandex-tracker-mcp](https://github.com/aikts/yandex-tracker-mcp)** - ⭐ 38
   Yandex Tracker MCP Server with OAuth2 support

2347. **[prompt-decorators](https://github.com/synaptiai/prompt-decorators)** - ⭐ 38
...
2348. **[ContextPods](https://github.com/conorluddy/ContextPods)** - ⭐ 38
   Model Context Protocol management suite/factory. An MCP that can generate and manage other local MCPs in multiple languages. Uses the official SDKs for code gen.

2349. **[DeepCo](https://github.com/succlz123/DeepCo)** - ⭐ 38
   A Chat Client for LLMs, written in Compose Multiplatform.

2350. **[vancouver](https://github.com/jameslong/vancouver)** - ⭐ 38
   Simple MCP server library for Elixir.

2351. **[cdk_pywrapper](https://github.com/sebotic/cdk_pywrapper)** - ⭐ 38
   A Python wrapper for the Chemistry Development Kit (CDK)

2352. **[neurondb](https://github.com/neurondb/neurondb)** - ⭐ 38
   PostgreSQL extension for vector search, embeddings, and ML, plus NeuronAgent runtime and NeuronMCP server.

2353. **[mocxykit](https://github.com/shunseven/mocxykit)** - ⭐ 38
...
2354. **[search-scrape](https://github.com/DevsHero/search-scrape)** - ⭐ 38
...
2355. **[mcp-obsidian](https://github.com/fazer-ai/mcp-obsidian)** - ⭐ 38
   MCP server for Obsidian (TypeScript + Bun)

2356. **[steampipe-mcp](https://github.com/turbot/steampipe-mcp)** - ⭐ 38
   Enable AI assistants to explore and query your Steampipe data!

2357. **[HAL](https://github.com/DeanWard/HAL)** - ⭐ 38
   HAL (HTTP API Layer) is a Model Context Protocol (MCP) server that provides HTTP API capabilities to Large Language Models.

2358. **[ai-vision-mcp](https://github.com/tan-yong-sheng/ai-vision-mcp)** - ⭐ 38
   A Model Context Protocol (MCP) server that provides vision capabilities to analyze image and video

2359. **[vscode-agent-todos](https://github.com/digitarald/vscode-agent-todos)** - ⭐ 38
   Gives VS Code agent mode planning superpowers with dynamic todo lists

2360. **[metabase-mcp](https://github.com/jerichosequitin/metabase-mcp)** - ⭐ 38
...
2361. **[autoteam](https://github.com/diazoxide/autoteam)** - ⭐ 37
   Orchestrate AI agents with YAML-driven workflows via universal Model Context Protocol (MCP)

2362. **[mcp-konnect](https://github.com/Kong/mcp-konnect)** - ⭐ 37
   A Model Context Protocol (MCP) server for interacting with Kong Konnect APIs, allowing AI assistants to query and analyze Kong Gateway configurations, traffic, and analytics.

2363. **[mcp-client-example](https://github.com/artemnovichkov/mcp-client-example)** - ⭐ 37
   Learn how to implement MCP client with SwiftUI and Anthropic API

2364. **[offeryn](https://github.com/avahowell/offeryn)** - ⭐ 37
   Build tools for LLMs in Rust using Model Context Protocol

2365. **[youtrack-mcp](https://github.com/itsalfredakku/youtrack-mcp)** - ⭐ 37
   An MCP (Model Context Protocol) server that provides YouTrack REST API access to AI agents

2366. **[mcp-sitecore-server](https://github.com/Antonytm/mcp-sitecore-server)** - ⭐ 37
   Model Context Protocol server for Sitecore

2367. **[solscan-mcp](https://github.com/wowinter13/solscan-mcp)** - ⭐ 37
   An MCP server for querying Solana transactions using natural language with Solscan API

2368. **[RedBook-Search-Comment-MCP](https://github.com/chenningling/RedBook-Search-Comment-MCP)** - ⭐ 37
   这是一款基于 Playwright 开发的小红书自动搜索和评论工具，作为 MCP Server，可通过特定配置接入 MCP Client，帮助用户自动完成登录小红书、搜索关键词、获取笔记内容及发布智能评论等操作。

2369. **[matlab-mcp](https://github.com/Tsuchijo/matlab-mcp)** - ⭐ 37
   Model Context Protocol server to let LLMs write and execute matlab scripts 

2370. **[nuclei-mcp](https://github.com/addcontent/nuclei-mcp)** - ⭐ 37
...
2371. **[mcp-summarization-functions](https://github.com/Braffolk/mcp-summarization-functions)** - ⭐ 37
   Provides summarised output from various actions that could otherwise eat up tokens and cause crashes for AI agents 

2372. **[mcp-server-ios-simulator](https://github.com/atom2ueki/mcp-server-ios-simulator)** - ⭐ 37
   Model Context Protocol (MCP) implementation for iOS simulators

2373. **[altium-mcp](https://github.com/coffeenmusic/altium-mcp)** - ⭐ 37
   Altium Model Context Protocol server and Altium API script

2374. **[mcp-pyautogui-server](https://github.com/hetaoBackend/mcp-pyautogui-server)** - ⭐ 37
   A MCP (Model Context Protocol) server that provides automated GUI testing and control capabilities through PyAutoGUI.

2375. **[mcp-tasks](https://github.com/flesler/mcp-tasks)** - ⭐ 37
   A comprehensive and efficient MCP server for task management with multi-format support (Markdown, JSON, YAML)

2376. **[webscraping-ai-mcp-server](https://github.com/webscraping-ai/webscraping-ai-mcp-server)** - ⭐ 37
    A Model Context Protocol (MCP) server implementation that integrates with WebScraping.AI for web data extraction capabilities.

2377. **[smythos-studio](https://github.com/SmythOS/smythos-studio)** - ⭐ 37
...
2378. **[openai-mcp](https://github.com/arthurcolle/openai-mcp)** - ⭐ 37
   OpenAI Code Assistant Model Context Protocol (MCP) Server

2379. **[dexpaprika-mcp](https://github.com/coinpaprika/dexpaprika-mcp)** - ⭐ 37
...
2380. **[Mcp.Net](https://github.com/SamFold/Mcp.Net)** - ⭐ 37
   A fully featured C# implementation of Anthropic's Model Context Protocol (MCP)

2381. **[mcpmc](https://github.com/gerred/mcpmc)** - ⭐ 37
   Model Context Protocol Minecraft Server

2382. **[mcp-server-leetcode](https://github.com/doggybee/mcp-server-leetcode)** - ⭐ 37
...
2383. **[fast-filesystem-mcp](https://github.com/efforthye/fast-filesystem-mcp)** - ⭐ 37
   A high-performance Model Context Protocol (MCP) server that provides secure filesystem access for Claude and other AI assistants.

2384. **[thoughtbox](https://github.com/Kastalien-Research/thoughtbox)** - ⭐ 37
...
2385. **[apple-books-mcp](https://github.com/vgnshiyer/apple-books-mcp)** - ⭐ 37
   Apple Books MCP Server

2386. **[comfy-mcp-server](https://github.com/lalanikarim/comfy-mcp-server)** - ⭐ 37
   A server using FastMCP framework to generate images based on prompts via a remote Comfy server.

2387. **[pdf-rag-mcp-server](https://github.com/hyson666/pdf-rag-mcp-server)** - ⭐ 37
   PDF RAG server for cursor.

2388. **[kitwork](https://github.com/kitwork/kitwork)** - ⭐ 37
...
2389. **[agent-mcp-gateway](https://github.com/roddutra/agent-mcp-gateway)** - ⭐ 37
...
2390. **[ask-user-questions-mcp](https://github.com/paulp-o/ask-user-questions-mcp)** - ⭐ 37
...
2391. **[octomind](https://github.com/Muvon/octomind)** - ⭐ 37
   Highly configurable autonomous efficient-first agentic AI framework for CLI

2392. **[mcp-flight-search](https://github.com/arjunprabhulal/mcp-flight-search)** - ⭐ 36
   MCP Server implementation for the Model Context Protocol (MCP) enabling AI tool usage - Realtime Flight Search 

2393. **[mcp-go](https://github.com/riza-io/mcp-go)** - ⭐ 36
   Build Model Context Protocol (MCP) servers in Go

2394. **[baseline-mcp-server](https://github.com/yamanoku/baseline-mcp-server)** - ⭐ 36
   特定のWeb APIに関するBaselineの状況を提供するModel Context Protocolサーバー

2395. **[example-mcp-server](https://github.com/kirill-markin/example-mcp-server)** - ⭐ 36
   A ready-to-use MCP (Model Context Protocol) server template for extending Cursor IDE with custom tools. Deploy your own server to Heroku with one click, create custom commands, and enhance your Cursor IDE experience. Perfect for developers who want to add their own tools and commands to Cursor IDE without complex setup.

2396. **[mcp-governance-sdk](https://github.com/ithena-one/mcp-governance-sdk)** - ⭐ 36
   Enterprise Governance Layer (Identity, RBAC, Credentials, Auditing, Logging, Tracing) for the Model Context Protocol SDK

2397. **[OmniMind](https://github.com/Techiral/OmniMind)** - ⭐ 36
...
2398. **[flutter-mcp-ai-chat](https://github.com/leehack/flutter-mcp-ai-chat)** - ⭐ 36
   Demonstrate how to implement MCP Client in Flutter application with AI.

2399. **[FastDomainCheck-MCP-Server](https://github.com/bingal/FastDomainCheck-MCP-Server)** - ⭐ 36
   A Model Context Protocol for checking domain name registration status in bulk.

2400. **[mcp-debug](https://github.com/giantswarm/mcp-debug)** - ⭐ 36

2401. **[mlb-api-mcp](https://github.com/guillochon/mlb-api-mcp)** - ⭐ 36
...
2402. **[code-mcp](https://github.com/54yyyu/code-mcp)** - ⭐ 36
...
2403. **[mcp-anywhere](https://github.com/locomotive-agency/mcp-anywhere)** - ⭐ 36
...
2404. **[keycloak-model-context-protocol](https://github.com/ChristophEnglisch/keycloak-model-context-protocol)** - ⭐ 36
...
2405. **[MCPNotes](https://github.com/9Ninety/MCPNotes)** - ⭐ 36
   A simple note-taking MCP server for recording and managing notes with AI models.

2406. **[MCP-Server-Creator](https://github.com/GongRzhe/MCP-Server-Creator)** - ⭐ 36
...
2407. **[lunchmoney-mcp](https://github.com/akutishevsky/lunchmoney-mcp)** - ⭐ 36
...
2408. **[mcp-wikidata](https://github.com/zzaebok/mcp-wikidata)** - ⭐ 36
   A server implementation for Wikidata API using the Model Context Protocol (MCP).

2409. **[mcp-gateway](https://github.com/theognis1002/mcp-gateway)** - ⭐ 36
...
2410. **[mcp-mistral-ocr](https://github.com/everaldo/mcp-mistral-ocr)** - ⭐ 36
   Model Context Protocol (MCP) Server for Mistral OCR API

2411. **[Readwise-Reader-MCP](https://github.com/edricgsh/Readwise-Reader-MCP)** - ⭐ 36
   A Model Context Protocol (MCP) server for the Readwise Reader API, built with TypeScript and the official Claude SDK.

2412. **[gemini-superclaude-mcp-server](https://github.com/Dianel555/gemini-superclaude-mcp-server)** - ⭐ 36
...
2413. **[tasker-mcp](https://github.com/dceluis/tasker-mcp)** - ⭐ 36
   An MCP server for Android's Tasker automation app.

2414. **[MCP-Microsoft-Office](https://github.com/Aanerud/MCP-Microsoft-Office)** - ⭐ 36
   an local MCP server you can run on your env, connecting you to Microsoft Graph, and the complete M365 eco system.

2415. **[nostr-mcp](https://github.com/AbdelStark/nostr-mcp)** - ⭐ 36
   A Nostr MCP server that allows to interact with Nostr, enabling posting notes, and more.

2416. **[mcp-server-antv](https://github.com/antvis/mcp-server-antv)** - ⭐ 36
...
2417. **[FastAPI-BitNet](https://github.com/grctest/FastAPI-BitNet)** - ⭐ 36
   Running Microsoft's BitNet inference framework via FastAPI, Uvicorn and Docker.

2418. **[mcp-ssh-manager](https://github.com/bvisible/mcp-ssh-manager)** - ⭐ 36
...
2419. **[polymarket-mcp](https://github.com/ozgureyilmaz/polymarket-mcp)** - ⭐ 36
   a mcp server for polymarket

2420. **[TWSEMCPServer](https://github.com/twjackysu/TWSEMCPServer)** - ⭐ 36
   台灣證交所OpenAPI 的 MCP Server

2421. **[Scientific-Papers-MCP](https://github.com/benedict2310/Scientific-Papers-MCP)** - ⭐ 36
...
2422. **[GDB-MCP](https://github.com/smadi0x86/GDB-MCP)** - ⭐ 36
   An MCP server that enables LLMs to interact with GDB and LLDB for binary debugging and analysis.

2423. **[codex-specialized-subagents](https://github.com/leonardsellem/codex-specialized-subagents)** - ⭐ 36
   MCP server that lets Codex delegate to isolated codex exec sub-agents, selecting repo+global skills automatically

2424. **[mcp-gemini-server](https://github.com/bsmi021/mcp-gemini-server)** - ⭐ 35
   This project provides a dedicated MCP (Model Context Protocol) server that wraps the @google/genai SDK. It exposes Google's Gemini model capabilities as standard MCP tools, allowing other LLMs (like Cline) or MCP-compatible systems to leverage Gemini's features as a backend workhorse.

2425. **[esa-mcp-server](https://github.com/d-kimuson/esa-mcp-server)** - ⭐ 35
   esa の Model Context Protocol サーバー実装

2426. **[mcp-langchain-ts-client](https://github.com/isaacwasserman/mcp-langchain-ts-client)** - ⭐ 35
   LangChain.js client for Model Context Protocol.

2427. **[linkedin-mcp-server](https://github.com/Dishant27/linkedin-mcp-server)** - ⭐ 35
   Model Context Protocol (MCP) server for LinkedIn API integration

2428. **[mcp-toolkit](https://github.com/metosin/mcp-toolkit)** - ⭐ 35
   a lib to build MCP clients and MCP servers in Clojure(script)

2429. **[tomtom-mcp](https://github.com/tomtom-international/tomtom-mcp)** - ⭐ 35
   A Model Context Protocol (MCP) server providing TomTom's location services, search, routing, and traffic data to AI agents.

2430. **[codebase-mcp](https://github.com/danyQe/codebase-mcp)** - ⭐ 35
...
2431. **[mcp-bundle](https://github.com/symfony/mcp-bundle)** - ⭐ 35
   Symfony integration bundle for Model Context Protocol (via official mcp/sdk)

2432. **[teams-mcp](https://github.com/floriscornel/teams-mcp)** - ⭐ 35
...
2433. **[mcp-databricks-server](https://github.com/RafaelCartenet/mcp-databricks-server)** - ⭐ 35
...
2434. **[mcp-front](https://github.com/stainless-api/mcp-front)** - ⭐ 35
   Auth proxy for Model Context Protocol servers - adds authentication to MCP tools for Claude.ai, Claude Code, Cursor, Gemini

2435. **[reaper-reapy-mcp](https://github.com/wegitor/reaper-reapy-mcp)** - ⭐ 35
...
2436. **[mcp-sandbox](https://github.com/JohanLi233/mcp-sandbox)** - ⭐ 35
   Python sandboxes for llms

2437. **[ai-workshop](https://github.com/dotnet-presentations/ai-workshop)** - ⭐ 35
   Building GenAI Apps in C#: AI Templates, GitHub Models, Azure OpenAI & More

2438. **[mcp-crew-ai](https://github.com/adam-paterson/mcp-crew-ai)** - ⭐ 35
   MCP Crew AI Server is a lightweight Python-based server designed to run, manage and create CrewAI workflows.

2439. **[mcp-tung-shing](https://github.com/baranwang/mcp-tung-shing)** - ⭐ 35
   中国传统黄历 MCP 服务 | Chinese Traditional Almanac MCP Service

2440. **[agentic-commerce-protocol-demo](https://github.com/locus-technologies/agentic-commerce-protocol-demo)** - ⭐ 35
   Reference implementation of OpenAI's Agentic Commerce Protocol (ACP)

2441. **[pentestMCP](https://github.com/ramkansal/pentestMCP)** - ⭐ 35
   pentestMCP: AI-Powered Penetration Testing via MCP, an MCP designed for penetration testers.

2442. **[coin_api_mcp](https://github.com/longmans/coin_api_mcp)** - ⭐ 35
   A Model Context Protocol server that provides access to CoinMarketCap's cryptocurrency data. This server enables AI-powered applications to retrieve cryptocurrency listings, quotes, and detailed information about various coins.

2443. **[mcp-accessibility-scanner](https://github.com/JustasMonkev/mcp-accessibility-scanner)** - ⭐ 35
   An MCP (Model Context Protocol) server for performing accessibility audits on webpages using axe-core.

2444. **[trivy-mcp](https://github.com/aquasecurity/trivy-mcp)** - ⭐ 35
   Trivy plugin for starting an MCP server

2445. **[mcp-server-security-standard](https://github.com/mcp-security-standard/mcp-server-security-standard)** - ⭐ 35
...
2446. **[mcp-security-inspector](https://github.com/purpleroc/mcp-security-inspector)** - ⭐ 34
   一个用于检测Model Context Protocol (MCP)安全性的Chrome扩展工具。

2447. **[mcp-client-auth](https://github.com/dzhng/mcp-client-auth)** - ⭐ 34
...
2448. **[salesforce-mcp-server](https://github.com/jaworjar95/salesforce-mcp-server)** - ⭐ 34
   A comprehensive Model Context Protocol (MCP) server that provides seamless Salesforce integration for AI development tools like Claude Desktop, Cline, and other MCP-compatible clients.

2449. **[MCPSwiftWrapper](https://github.com/jamesrochabrun/MCPSwiftWrapper)** - ⭐ 34
   A light wrapper around mcp-swift-sdk for easy usage of MCP clients in Swift

2450. **[chat-nextjs-mcp-client](https://github.com/shricodev/chat-nextjs-mcp-client)** - ⭐ 34
   ⚡ Chat MCP Client for Remote hosted MCP Servers (with Composio) and locally hosted MCP servers. 📡

2451. **[RiMCP_hybrid](https://github.com/h7lu/RiMCP_hybrid)** - ⭐ 34
   Rimworld Coding RAG MCP server

2452. **[mcp-starter](https://github.com/instructa/mcp-starter)** - ⭐ 34
   A super simple Starter to build your own MCP Server

2453. **[mcp-server-opendal](https://github.com/Xuanwo/mcp-server-opendal)** - ⭐ 34
   Model Context Protocol Server for Apache OpenDAL™

2454. **[meta-prompt-mcp-server](https://github.com/tisu19021997/meta-prompt-mcp-server)** - ⭐ 34
   Turn any MCP Client into a "multi-agent" system (via prompting)

2455. **[aio-mcp](https://github.com/athapong/aio-mcp)** - ⭐ 34
...
2456. **[tinyagent](https://github.com/askbudi/tinyagent)** - ⭐ 34
   Tiny Agent: Production-Ready LLM Agent SDK for Every Developer

2457. **[llm-tools-mcp](https://github.com/VirtusLab/llm-tools-mcp)** - ⭐ 34
   Connect to MCP servers right from your shell. Plugin for simonw/llm.

2458. **[macOS-Notification-MCP](https://github.com/devizor/macOS-Notification-MCP)** - ⭐ 34
...
2459. **[linkedin-mcpserver](https://github.com/felipfr/linkedin-mcpserver)** - ⭐ 34
   A powerful Model Context Protocol server for LinkedIn API integration

2460. **[jina-mcp-tools](https://github.com/PsychArch/jina-mcp-tools)** - ⭐ 34
   A Model Context Protocol (MCP) server that integrates with Jina AI Search Foundation APIs.

2461. **[a11y-mcp](https://github.com/priyankark/a11y-mcp)** - ⭐ 34
   An MCP (Model Context Protocol) server for performing accessibility audits on webpages using axe-core. Use the results in an agentic loop with your favorite AI assistants (Amp/Cline/Cursor/GH Copilot) and let them fix a11y issues for you!

2462. **[linkedapi-mcp](https://github.com/Linked-API/linkedapi-mcp)** - ⭐ 34
   MCP server that lets AI assistants control LinkedIn accounts and retrieve real-time data.

2463. **[mcp](https://github.com/screenshotone/mcp)** - ⭐ 34
   A simple implementation of an MCP server for the ScreenshotOne API

2464. **[storybook-mcp](https://github.com/mcpland/storybook-mcp)** - ⭐ 34
   A MCP server for Storybook.

2465. **[diy-tools-mcp](https://github.com/hesreallyhim/diy-tools-mcp)** - ⭐ 34
   An MCP server that allows users to dynamically add custom tools/functions at runtime

2466. **[whatsapp-mcp](https://github.com/felipeadeildo/whatsapp-mcp)** - ⭐ 34
   WhatsApp Unofficial MCP Server

2467. **[godoc-mcp-server](https://github.com/yikakia/godoc-mcp-server)** - ⭐ 34
   A mcp server provide infomation from pkg.go.dev. For all golang programmers

2468. **[Web-Algebra](https://github.com/AtomGraph/Web-Algebra)** - ⭐ 34
   Suite of generic Linked Data/SPARQL as well as LinkedDataHub-specific MCP tools

2469. **[unreal-mcp](https://github.com/runeape-sats/unreal-mcp)** - ⭐ 34
   Unreal Engine MCP server for Claude Desktop (early alpha preview)

2470. **[DBJavaGenix](https://github.com/ZhaoXingPeng/DBJavaGenix)** - ⭐ 34
...
2471. **[mcp-prompt-server-go](https://github.com/smallnest/mcp-prompt-server-go)** - ⭐ 34
...
2475. **[org-mcp](https://github.com/laurynas-biveinis/org-mcp)** - ⭐ 34
   Emacs Org-mode integration with Model Context Protocol (MCP) for AI-assisted task management

2476. **[mcp-file-context-server](https://github.com/bsmi021/mcp-file-context-server)** - ⭐ 33
   A Model Context Protocol (MCP) server that provides file system context to Large Language Models (LLMs). This server enables LLMs to read, search, and analyze code files with advanced caching and real-time file watching capabilities.

2477. **[adk-python-mcp-client](https://github.com/arjunprabhulal/adk-python-mcp-client)** - ⭐ 33
   Demo of ADK (Agent Development Kit) as an MCP (Model Context Protocol) client for flight search capabilities.

2478. **[mcp-scala](https://github.com/windymelt/mcp-scala)** - ⭐ 33
   Model Context Protocol server written in Scala

2479. **[prometheus_mcp_server](https://github.com/CaesarYangs/prometheus_mcp_server)** - ⭐ 33
...
2480. **[mcp-google-calendar](https://github.com/markelaugust74/mcp-google-calendar)** - ⭐ 33
...
2481. **[mcp-registry](https://github.com/ARadRareness/mcp-registry)** - ⭐ 33
   A central registry and HTTP interface for coordinating Model Context Protocol (MCP) servers.

2482. **[Outlook_Calendar_MCP](https://github.com/merajmehrabi/Outlook_Calendar_MCP)** - ⭐ 33
   A Model Context Protocol (MCP) server that allows Claude to access and manage your local Microsfot Outlook calendar (Windows only).

2483. **[mcp-server-text-editor](https://github.com/bhouston/mcp-server-text-editor)** - ⭐ 33
   An open source implementation of the Claude built-in text editor tool

2484. **[claude-code-mcp](https://github.com/KunihiroS/claude-code-mcp)** - ⭐ 33
   MCP Server connects with claude code local command.

2485. **[postman-mcp](https://github.com/SalehKhatri/postman-mcp)** - ⭐ 33
...
2486. **[McpToolkit](https://github.com/nuskey8/McpToolkit)** - ⭐ 33
   Lightweight, fast, NativeAOT compatible MCP (Model Context Protocol) framework for .NET

2487. **[mcp-api-gateway](https://github.com/rflpazini/mcp-api-gateway)** - ⭐ 33
   A universal MCP (Model Context Protocol) server to integrate any API with Claude Desktop using only Docker configurations.

2488. **[mcp-browser-agent](https://github.com/imprvhub/mcp-browser-agent)** - ⭐ 33
   A Model Context Protocol (MCP) integration that provides Claude Desktop with autonomous browser automation capabilities. This agent enables Claude to interact with web content, manipulate DOM elements, execute JavaScript, and perform API requests.

2489. **[evernote-mcp-server](https://github.com/brentmid/evernote-mcp-server)** - ⭐ 33
   Evernote MCP server - allows LLMs that support MCP (like Claude Desktop) to query your notes in Evernote

2490. **[twenty-crm-mcp-server](https://github.com/mhenry3164/twenty-crm-mcp-server)** - ⭐ 33
...
2491. **[filesystem-mcp-server](https://github.com/cyanheads/filesystem-mcp-server)** - ⭐ 33
   A Model Context Protocol (MCP) server for platform-agnostic file capabilities, including advanced search/replace and directory tree traversal

2492. **[nostr-mcp-server](https://github.com/AustinKelsay/nostr-mcp-server)** - ⭐ 33
   A Model Context Protocol (MCP) server that provides Nostr capabilities to AI agents

2493. **[React-Native-MCP](https://github.com/MrNitro360/React-Native-MCP)** - ⭐ 33
...
2494. **[iotdb-mcp-server](https://github.com/apache/iotdb-mcp-server)** - ⭐ 33
   Apache IoTDB MCP Server

2495. **[codelogic-mcp-server](https://github.com/CodeLogicIncEngineering/codelogic-mcp-server)** - ⭐ 33
   An MCP Server to utilize Codelogic's rich software dependency data in your AI programming assistant.

2496. **[1mcp](https://github.com/buremba/1mcp)** - ⭐ 33
   Let your agent write code and execute code directly in the browser with WASM

2497. **[DMCPServer](https://github.com/Daniel09Fernandes/DMCPServer)** - ⭐ 33
   Dinos MCP Server, make your code, on MCP Action and execute by AI

2498. **[Handler](https://github.com/alDuncanson/Handler)** - ⭐ 33
   A2A Protocol client and developer toolkit.

2499. **[mcp-server](https://github.com/VapiAI/mcp-server)** - ⭐ 33
   Vapi MCP Server

2500. **[claude-mcp](https://github.com/cnych/claude-mcp)** - ⭐ 33
   Claude Unified Model Context Interaction Protocol

2501. **[mcp-sync](https://github.com/ztripez/mcp-sync)** - ⭐ 33
   Sync MCP (Model Context Protocol) configurations across AI tools

2502. **[awesome-blockchain-mcps](https://github.com/royyannick/awesome-blockchain-mcps)** - ⭐ 33
...
2503. **[mcp-veo2](https://github.com/mario-andreschak/mcp-veo2)** - ⭐ 33
   MCP for Video- or Image-Generation with Google VEO2

2504. **[kaggle-mcp](https://github.com/arrismo/kaggle-mcp)** - ⭐ 33
   MCP server for Kaggle

2505. **[any-script-mcp](https://github.com/izumin5210/any-script-mcp)** - ⭐ 33
   An MCP server that exposes arbitrary CLI tools and shell scripts as MCP Tools

2506. **[mcp-launcher](https://github.com/moeru-ai/mcp-launcher)** - ⭐ 33
   🐳🧩 Easy to use MCP builder & launcher for all possible MCP servers, just like Ollama for models!

2507. **[kanban-mcp](https://github.com/eyalzh/kanban-mcp)** - ⭐ 33
   MCP server providing kanban-based task management memory for complex multi-session workflows with AI agents

2508. **[modao-proto-mcp](https://github.com/modao-dev/modao-proto-mcp)** - ⭐ 33
...
2509. **[adeu](https://github.com/dealfluence/adeu)** - ⭐ 33
...
2510. **[wezterm-mcp](https://github.com/hiraishikentaro/wezterm-mcp)** - ⭐ 32
   About A Model Context Protocol server that executes commands in the current WezTerm session

2511. **[mcp-nats](https://github.com/sinadarbouy/mcp-nats)** - ⭐ 32
   A Model Context Protocol (MCP) server for NATS messaging system integration

2512. **[zilliz-mcp-server](https://github.com/zilliztech/zilliz-mcp-server)** - ⭐ 32
...
2513. **[azure-functions-mcp-extension](https://github.com/Azure/azure-functions-mcp-extension)** - ⭐ 32
   Model Context Protocol extension for Azure Functions.

2514. **[mentor-mcp-server](https://github.com/cyanheads/mentor-mcp-server)** - ⭐ 32
...
2515. **[laravel-mcp-client](https://github.com/scriptoshi/laravel-mcp-client)** - ⭐ 32

2516. **[crawl-mcp](https://github.com/wutongci/crawl-mcp)** - ⭐ 32
   完整的微信文章抓取MCP服务器 - 基于Model Context Protocol (MCP)的智能网页抓取工具，专为Cursor IDE和AI工具设计。

2517. **[mcp-domain-availability](https://github.com/imprvhub/mcp-domain-availability)** - ⭐ 32
   A Model Context Protocol (MCP) server that enables Claude Desktop to check domain availability across 50+ TLDs. Features DNS/WHOIS verification, bulk checking, and smart suggestions. Zero-clone installation via uvx.

2518. **[fantasy-football-mcp-public](https://github.com/derekrbreese/fantasy-football-mcp-public)** - ⭐ 32
...
2519. **[sunnysideFigma-Context-MCP](https://github.com/tercumantanumut/sunnysideFigma-Context-MCP)** - ⭐ 32
...
2520. **[openbim-mcp](https://github.com/helenkwok/openbim-mcp)** - ⭐ 32
   Model Context Protocol (MCP) server for openBIM

2521. **[openscad-mcp](https://github.com/quellant/openscad-mcp)** - ⭐ 32
   A Model Context Protocol (MCP) server for OpenSCAD 3D modeling and rendering

2522. **[mcpc](https://github.com/OlaHulleberg/mcpc)** - ⭐ 32
...
2523. **[authenticator_mcp](https://github.com/firstorderai/authenticator_mcp)** - ⭐ 32
   A secure MCP (Model Context Protocol) server that enables AI agents to interact with the Authenticator App.

2524. **[storyblok-mcp-server](https://github.com/Kiran1689/storyblok-mcp-server)** - ⭐ 32
...
2525. **[mcp-zap-server](https://github.com/dtkmn/mcp-zap-server)** - ⭐ 32
   A Spring Boot application exposing OWASP ZAP as an MCP (Model Context Protocol) server. It lets any MCP‑compatible AI agent (e.g., Claude Desktop, Cursor) orchestrate ZAP actions—spider, active scan, import OpenAPI specs, and generate reports.

2526. **[n8n-mcp](https://github.com/vredrick/n8n-mcp)** - ⭐ 32
   n8n MCP Server - Documentation and tools for n8n nodes via Model Context Protocol with SSE support

2527. **[mcp_server](https://github.com/peppemas/mcp_server)** - ⭐ 32
   A C++ implementation of a Model Context Protocol Server with a pluggable module architecture.

2528. **[mcp-googletasks](https://github.com/arpitbatra123/mcp-googletasks)** - ⭐ 32
...
2529. **[mcp-tool-filter](https://github.com/Portkey-AI/mcp-tool-filter)** - ⭐ 32
...
2530. **[mermaid-mcp](https://github.com/Narasimhaponnada/mermaid-mcp)** - ⭐ 32

2531. **[gno](https://github.com/gmickel/gno)** - ⭐ 32
...
2532. **[mcp-server](https://github.com/membranehq/mcp-server)** - ⭐ 32
   MCP Server for Membrane

2533. **[copilot-security-instructions](https://github.com/Robotti-io/copilot-security-instructions)** - ⭐ 32
...
2534. **[pushover-mcp](https://github.com/AshikNesin/pushover-mcp)** - ⭐ 32
   A MCP implementation for sending notifications via Pushover

2535. **[Direwolf](https://github.com/Framebuffers/Direwolf)** - ⭐ 32
   Distributed Data Processing Pipeline for MCP.

2536. **[imagegen-mcp](https://github.com/spartanz51/imagegen-mcp)** - ⭐ 32
   MCP server for OpenAI Image Generation & Editing — text-to-image, image-to-image (with mask), no extra plugins.

2537. **[awesome-devops-mcp](https://github.com/agenticdevops/awesome-devops-mcp)** - ⭐ 32
   List of Awesome MCP Servers and Clients for building Agentic Devops 

2538. **[embedded-debugger-mcp](https://github.com/Adancurusul/embedded-debugger-mcp)** - ⭐ 32
   A Model Context Protocol server for embedded debugging with probe-rs - supports ARM Cortex-M, RISC-V debugging via J-Link, ST-Link, and more

2539. **[PixVerse-MCP](https://github.com/PixVerseAI/PixVerse-MCP)** - ⭐ 31
   Official PixVerse Model Context Protocol (MCP) server that enables interaction with powerful AI video generation APIs.

2540. **[MCPDocSearch](https://github.com/alizdavoodi/MCPDocSearch)** - ⭐ 31
...
2541. **[simple-psql-mcp](https://github.com/NetanelBollag/simple-psql-mcp)** - ⭐ 31
...
2542. **[MCPCorpus](https://github.com/Snakinya/MCPCorpus)** - ⭐ 31
...
2543. **[seatunnel-mcp](https://github.com/ocean-zhc/seatunnel-mcp)** - ⭐ 31
...
2544. **[lets-learn-mcp-java](https://github.com/microsoft/lets-learn-mcp-java)** - ⭐ 31
   Learn how to build Java-based MCP Servers and Clients with LangChain4J and Quarkus

2545. **[mcp-server-lib.el](https://github.com/laurynas-biveinis/mcp-server-lib.el)** - ⭐ 31
   Emacs Lisp implementation of the Model Context Protocol

2546. **[azure-container-apps-ai-mcp](https://github.com/Azure-Samples/azure-container-apps-ai-mcp)** - ⭐ 31
...
2547. **[mcp-weather](https://github.com/TimLukaHorstmann/mcp-weather)** - ⭐ 31
   A Model Context Protocol (MCP) server that provides hourly and daily weather forecasts using the AccuWeather API.

2548. **[PubChem-MCP-Server](https://github.com/Augmented-Nature/PubChem-MCP-Server)** - ⭐ 31
   A comprehensive Model Context Protocol (MCP) server for accessing the PubChem chemical database. This server provides access to over 110 million chemical compounds with extensive molecular properties, bioassay data, and chemical informatics tools.

2549. **[mcp-wasm](https://github.com/beekmarks/mcp-wasm)** - ⭐ 31
   A proof-of-concept implementation of a Model Context Protocol (MCP) server that runs in WebAssembly (WASM) within a web browser. This project demonstrates the integration of MCP tools and resources in a browser environment.

2550. **[Smart-Thinking](https://github.com/Leghis/Smart-Thinking)** - ⭐ 31
   Smart-Thinking is a Model Context Protocol (MCP) server that delivers graph-based, multi-step reasoning without relying on external AI APIs. Everything happens locally: similarity search, heuristic-based scoring, verification tracking, memory, and visualization all run in a deterministic pipeline designed for transparency and reproducibility.

2551. **[AlphaFold-MCP-Server](https://github.com/Augmented-Nature/AlphaFold-MCP-Server)** - ⭐ 31
   A comprehensive Model Context Protocol (MCP) server that provides access to the AlphaFold Protein Structure Database through a rich set of tools and resources for protein structure prediction analysis.

2552. **[PRD-MCP-Server](https://github.com/Saml1211/PRD-MCP-Server)** - ⭐ 31
   Flagship Model Context Protocol server for generating Product Requirement Documents (PRDs) from codebase context.

2553. **[keynote-mcp](https://github.com/easychen/keynote-mcp)** - ⭐ 31
   A Model Context Protocol (MCP) server that enables AI assistants to control Keynote presentations through AppleScript automation.

2554. **[keycloak-mcp-server](https://github.com/sshaaf/keycloak-mcp-server)** - ⭐ 31
...
2555. **[dev-kit](https://github.com/nguyenvanduocit/dev-kit)** - ⭐ 31
   [Model Context Protocol] Dev Kit - anything a developer need for him day to day works

2556. **[yahoo-finance-server](https://github.com/AgentX-ai/yahoo-finance-server)** - ⭐ 31
...
2557. **[midi-mcp-server](https://github.com/tubone24/midi-mcp-server)** - ⭐ 31
...
2558. **[postmancer](https://github.com/hijaz/postmancer)** - ⭐ 31
   An experimental MCP server Rest Client intended to be a replacement of tools postman & insomnia

2559. **[apisix-mcp](https://github.com/api7/apisix-mcp)** - ⭐ 31
   APISIX Model Context Protocol (MCP) server is used to bridge large language models (LLMs) with the APISIX Admin API.

2560. **[dap_mcp](https://github.com/KashunCheng/dap_mcp)** - ⭐ 31
   Model Context Protocol (MCP) server that interacts with a Debugger

2561. **[chatwork-mcp-server](https://github.com/chatwork/chatwork-mcp-server)** - ⭐ 31
   ChatworkをAIから操作するためのMCP(Model Context Protocol)サーバー

2562. **[zerodha-mcp](https://github.com/mtwn105/zerodha-mcp)** - ⭐ 31
   Zerodha MCP Server & Client - AI Agent (w/Agno & w/Google ADK)

2563. **[SUMO-MCP-Server](https://github.com/XRDS76354/SUMO-MCP-Server)** - ⭐ 31
...
2564. **[mcp-server-fuzzer](https://github.com/Agent-Hellboy/mcp-server-fuzzer)** - ⭐ 31
   A generic mcp server fuzzer

2565. **[capacities-mcp](https://github.com/jem-computer/capacities-mcp)** - ⭐ 31
   Capacities×MCP

2566. **[context-awesome](https://github.com/bh-rat/context-awesome)** - ⭐ 31
   awesome-lists now available as MCP server for you agent.

2567. **[machinepal](https://github.com/skalenetwork/machinepal)** - ⭐ 31
   The Cloud-Native MCP and X402 Gateway to Run and Monetize your AI Agents and Services, as well as optimize your AI costs

2568. **[jlcpcb-parts-mcp](https://github.com/nvsofts/jlcpcb-parts-mcp)** - ⭐ 31
   JLCPCB PCBA向けの、部品探しを補助するためのMCPサーバー

2569. **[fastmcp-threatintel](https://github.com/4R9UN/fastmcp-threatintel)** - ⭐ 31
   AI-Powered Threat Intelligence MCP tool

2570. **[ptt_mcp_server](https://github.com/PyPtt/ptt_mcp_server)** - ⭐ 31
   The best PTT MCP server

2571. **[shadcn-svelte-mcp](https://github.com/Michael-Obele/shadcn-svelte-mcp)** - ⭐ 31
   Mastra MCP server and tooling for the shadcn-svelte component docs and developer utilities.

2572. **[unplugin-mcp](https://github.com/situ2001/unplugin-mcp)** - ⭐ 31
...
2573. **[mcp-server](https://github.com/HuaweiCloudDeveloper/mcp-server)** - ⭐ 31
   Provide different cloud products  MCP Server tools to  help developers  manage cloud resources  with AI-agent

2574. **[reaper-mcp](https://github.com/itsuzef/reaper-mcp)** - ⭐ 31
   A comprehensive Model Context Protocol (MCP) server that enables AI agents to create fully mixed and mastered tracks in REAPER with both MIDI and audio capabilities.

2575. **[octave-mcp](https://github.com/elevanaltd/octave-mcp)** - ⭐ 31
...
2593. **[nvim-mcp](https://github.com/linw1995/nvim-mcp)** - ⭐ 30
...
2594. **[mcp-appium-gestures](https://github.com/AppiumTestDistribution/mcp-appium-gestures)** - ⭐ 30
   This is a Model Context Protocol (MCP) server providing resources and tools for Appium mobile gestures using Actions API..

2595. **[mcp-for-security-python](https://github.com/f1tz/mcp-for-security-python)** - ⭐ 30
...
2596. **[searxng-mcp](https://github.com/tisDDM/searxng-mcp)** - ⭐ 30
...
2597. **[metabase-mcp](https://github.com/hluaguo/metabase-mcp)** - ⭐ 30
...
2598. **[maven-mcp-server](https://github.com/Bigsy/maven-mcp-server)** - ⭐ 30
   An MCP (Model Context Protocol) server that provides tools for checking Maven dependency versions.

2599. **[MCP-Scanner](https://github.com/knostic/MCP-Scanner)** - ⭐ 30
...
2606. **[airflow-mcp-server](https://github.com/abhishekbhakat/airflow-mcp-server)** - ⭐ 30
   MCP Server for Apache Airflow

2607. **[AskUserQuestionPlus](https://github.com/JoJoJotarou/AskUserQuestionPlus)** - ⭐ 30
...
2608. **[Learn-Model-Context-Protocol-with-Python](https://github.com/PacktPublishing/Learn-Model-Context-Protocol-with-Python)** - ⭐ 30
   Learn Model Context Protocol with Python, published by Packt

2609. **[fal-mcp-server](https://github.com/raveenb/fal-mcp-server)** - ⭐ 30
   MCP server for Fal.ai - Generate images, videos, music and audio with Claude

2610. **[mcp-appstore](https://github.com/appreply-co/mcp-appstore)** - ⭐ 30
...
2611. **[kafka-schema-reg-mcp](https://github.com/aywengo/kafka-schema-reg-mcp)** - ⭐ 30
   A comprehensive Message Control Protocol (MCP) server for Kafka Schema Registry.

2612. **[bitrise-mcp](https://github.com/bitrise-io/bitrise-mcp)** - ⭐ 30
   MCP Server for the Bitrise API, enabling app management, build operations, artifact management and more.

2613. **[generative-ui-playground](https://github.com/CopilotKit/generative-ui-playground)** - ⭐ 30
   Interact with all three types of generative UI, all in one interface

2614. **[itential-mcp](https://github.com/itential/itential-mcp)** - ⭐ 30
   🔌 Itential Platform MCP Server

2615. **[MCP-Server-Starter](https://github.com/TheSethRose/MCP-Server-Starter)** - ⭐ 29
   A Model Context Protocol server starter template

2616. **[mcp-server-dumplingai](https://github.com/DumplingAI/mcp-server-dumplingai)** - ⭐ 29
   MCP (Model Context Protocol) server for Dumpling AI

2617. **[mcp-badges](https://github.com/mcpx-dev/mcp-badges)** - ⭐ 29
   Get your projects MCP (Model Context Protocol)  badges

2618. **[mcp-attr](https://github.com/frozenlib/mcp-attr)** - ⭐ 29
   A library for declaratively building Model Context Protocol servers.

2619. **[rails-pg-extras-mcp](https://github.com/pawurb/rails-pg-extras-mcp)** - ⭐ 29
   MCP (Model Context Protocol) LLM interface for rails-pg-extras gem

2620. **[browserai-mcp](https://github.com/brightdata/browserai-mcp)** - ⭐ 29
   A powerful Model Context Protocol (MCP) server that provides an access to serverless browser for AI agents and apps

2621. **[luke-desktop](https://github.com/DrJonBrock/luke-desktop)** - ⭐ 29
   A modern desktop client for Claude AI with MCP server support, built with Tauri, React, and TypeScript.

2622. **[xmind-generator-mcp](https://github.com/BangyiZhang/xmind-generator-mcp)** - ⭐ 29
   An MCP (Model Context Protocol) server for generating Xmind mind maps. This server allows LLMs to create structured mind maps through the MCP protocol.

2623. **[phonepi-mcp](https://github.com/priyankark/phonepi-mcp)** - ⭐ 29
...
2624. **[actor-critic-thinking-mcp](https://github.com/aquarius-wing/actor-critic-thinking-mcp)** - ⭐ 29
   A dual-perspective thinking analysis server based on Model Context Protocol (MCP), providing comprehensive performance evaluation through Actor-Critic methodology.

2625. **[cca-mcp-configurator](https://github.com/doggy8088/cca-mcp-configurator)** - ⭐ 29
   一個簡單易用的網頁工具，用於管理 GitHub Copilot 的 MCP (Model Context Protocol) 設定

2626. **[rod-mcp](https://github.com/go-rod/rod-mcp)** - ⭐ 29
   Model Context Protocol Server of Rod

2627. **[NetContextServer](https://github.com/willibrandon/NetContextServer)** - ⭐ 29
   A .NET implementation of the Model Context Protocol enabling AI assistants to explore and understand .NET codebases.

2628. **[openai-mcp-agent-dotnet](https://github.com/Azure-Samples/openai-mcp-agent-dotnet)** - ⭐ 29
   Sample to create an AI Agent using OpenAI models with any MCP server running on Azure Container Apps

2629. **[mcp-server-weibo](https://github.com/qinyuanpei/mcp-server-weibo)** - ⭐ 29
   基于 Model Context Protocol 的微博数据接口服务器 - 实时获取微博用户信息、动态内容、热搜榜单、粉丝关注数据。支持用户搜索、内容搜索、话题分析，为 AI 应用提供完整的微博数据接入方案。

2630. **[dockashell](https://github.com/anzax/dockashell)** - ⭐ 29
...
2635. **[mattermost-mcp-host](https://github.com/jagan-shanmugam/mattermost-mcp-host)** - ⭐ 29
   A Mattermost integration that connects to Model Context Protocol (MCP) servers, leveraging a LangGraph-based Agent.

2636. **[biothings-mcp](https://github.com/longevity-genie/biothings-mcp)** - ⭐ 29
   MCP (Model Context Protocol) server for biothings

2637. **[matrix-mcp-server](https://github.com/mjknowles/matrix-mcp-server)** - ⭐ 29
   MCP Server for a Matrix home server integration; chat, manage rooms, etc.

2638. **[mcp-zero](https://github.com/zeromicro/mcp-zero)** - ⭐ 29
   Model Context Protocol (MCP) server for go-zero framework - Generate APIs, RPC services, and models with AI assistance.

2639. **[mcp-bash](https://github.com/patrickomatik/mcp-bash)** - ⭐ 29
...
2640. **[levante](https://github.com/levante-hub/levante)** - ⭐ 29
   Levante - Personal, Secure, Free, Local AI, MCP Client

2641. **[gatekit](https://github.com/gatekit-ai/gatekit)** - ⭐ 29
   A hackable Model Context Protocol (MCP) gateway

2642. **[elysia-mcp](https://github.com/kerlos/elysia-mcp)** - ⭐ 29
   ElysiaJS plugin for Model Context Protocol with HTTP transport

2643. **[google-drive-mcp](https://github.com/piotr-agier/google-drive-mcp)** - ⭐ 29
...
2644. **[chrome-extension-bridge-mcp](https://github.com/Oanakiaja/chrome-extension-bridge-mcp)** - ⭐ 29
   A chrome extension bridge that allows you to connect to a mcp server to use global window object.

2645. **[telegram-mcp-server](https://github.com/kfastov/telegram-mcp-server)** - ⭐ 29
   MCP server implementation for Telegram

2646. **[agent-pm](https://github.com/gannonh/agent-pm)** - ⭐ 29
   MCP server for the planning and execution of AI-assisted development projects.

2647. **[nestjs-starter](https://github.com/hmake98/nestjs-starter)** - ⭐ 29
...
2648. **[ros-mcp](https://github.com/Yutarop/ros-mcp)** - ⭐ 29
   MCP server for ROS to control robots via topics, services, and actions.

2649. **[pfsense-mcp-server](https://github.com/gensecaihq/pfsense-mcp-server)** - ⭐ 29
   pfSense MCP Server enables security administrators to manage their pfSense firewalls using natural language through AI assistants like Claude Desktop. Simply ask "Show me blocked IPs" or "Run a PCI compliance check" instead of navigating complex interfaces. Supports REST/XML-RPC/SSH connections, and includes built-in complian

2650. **[mcp-notify](https://github.com/aahl/mcp-notify)** - ⭐ 29
   💬  MCP Server for notify to Weixin, Telegram, Bark, Lark, 飞书, 钉钉

2651. **[rdkit-mcp-server](https://github.com/tandemai-inc/rdkit-mcp-server)** - ⭐ 29
   MCP server that enables language models to interact with RDKit through natural language

2652. **[Volatility-MCP-Server](https://github.com/bornpresident/Volatility-MCP-Server)** - ⭐ 28
   A Model Context Protocol (MCP) server that integrates Volatility 3 memory forensics framework with Claude

2653. **[sketchfab-mcp-server](https://github.com/gregkop/sketchfab-mcp-server)** - ⭐ 28
   This is an MCP (Model Context Protocol) Server for discovering and downloading 3D models 

2654. **[mcp-testing-framework](https://github.com/L-Qun/mcp-testing-framework)** - ⭐ 28
   Testing framework for Model Context Protocol (MCP)

2655. **[laravel-mcp-sdk](https://github.com/mohamedahmed01/laravel-mcp-sdk)** - ⭐ 28
   Laravel Based Implementation for Model Context Protocol

2656. **[mcp-websocket](https://github.com/virajsharma2000/mcp-websocket)** - ⭐ 28
   This server implements an MCP (Model Context Protocol) server with WebSocket enhancements for real-time data updates.

2657. **[mcp_autogen_sse_stdio](https://github.com/SaM-92/mcp_autogen_sse_stdio)** - ⭐ 28
   This repository demonstrates how to use AutoGen to integrate local and remote MCP (Model Context Protocol) servers. It showcases a local math tool (math_server.py) using Stdio and a remote Apify tool (RAG Web Browser Actor) via SSE for tasks like arithmetic and web browsing.

2658. **[nchan-mcp-transport](https://github.com/ConechoAI/nchan-mcp-transport)** - ⭐ 28
...
2659. **[TAM-MCP-Server](https://github.com/gvaibhav/TAM-MCP-Server)** - ⭐ 28
...
2660. **[mcp-etherscan-server](https://github.com/crazyrabbitLTC/mcp-etherscan-server)** - ⭐ 28
   An MCP (Model Context Protocol) server that provides Ethereum blockchain data tools via Etherscan's API. Features include checking ETH balances, viewing transaction history, tracking ERC20 transfers, fetching contract ABIs, monitoring gas prices, and resolving ENS names.

2661. **[vsc-mcp](https://github.com/thomasgazzoni/vsc-mcp)** - ⭐ 28
   This project provides tools that expose Language Server Protocol (LSP) functionality as MCP (Model Context Protocol) tools

2662. **[asterisk-mcp-server](https://github.com/winfunc/asterisk-mcp-server)** - ⭐ 28
   Asterisk Model Context Protocol (MCP) server.

2663. **[notion-mcp](https://github.com/Badhansen/notion-mcp)** - ⭐ 28
   A simple Model Context Protocol (MCP) server that integrates with Notion's API to manage my personal todo list.

2664. **[YFinance-Trader-MCP-ClaudeDesktop](https://github.com/SaintDoresh/YFinance-Trader-MCP-ClaudeDesktop)** - ⭐ 28
   An MCP (Model Context Protocol) tool that provides stock market data and trading capabilities using the yfinance library, specifically adapted for Claude Desktop.

2665. **[UnrealMCPBridge](https://github.com/appleweed/UnrealMCPBridge)** - ⭐ 28
   An Unreal Engine plugin that implements an MCP server allowing MCP clients to access the UE Editor Python API.

2666. **[openapi-mcp-generator](https://github.com/abutbul/openapi-mcp-generator)** - ⭐ 28
...
2667. **[mcp-ollama-agent](https://github.com/ausboss/mcp-ollama-agent)** - ⭐ 28
...
2668. **[workflows-mcp-server](https://github.com/cyanheads/workflows-mcp-server)** - ⭐ 28
...
2669. **[mcp-proxy](https://github.com/stephenlacy/mcp-proxy)** - ⭐ 28
   Fast rust MCP proxy between stdio and SSE

2670. **[claude-code-mcp](https://github.com/zebbern/claude-code-mcp)** - ⭐ 28
...
2671. **[datagouv-mcp](https://github.com/datagouv/datagouv-mcp)** - ⭐ 28
...
2672. **[taskflow-mcp](https://github.com/pinkpixel-dev/taskflow-mcp)** - ⭐ 28
   A task management Model Context Protocol (MCP) server that helps AI assistants break down user requests into manageable tasks with subtasks, dependencies, and notes. Enforces a structured workflow with user approval steps.

2673. **[framer-plugin-mcp](https://github.com/Sheshiyer/framer-plugin-mcp)** - ⭐ 28
   A Model Context Protocol (MCP) server for creating and managing Framer plugins with web3 capabilities

2674. **[svgmaker-mcp](https://github.com/GenWaveLLC/svgmaker-mcp)** - ⭐ 28
...
2675. **[ida-headless-mcp](https://github.com/zboralski/ida-headless-mcp)** - ⭐ 28
   Headless IDA Pro binary analysis via Model Context Protocol

2676. **[gemsuite-mcp](https://github.com/PV-Bhat/gemsuite-mcp)** - ⭐ 28
...
2677. **[kaggle-mcp](https://github.com/54yyyu/kaggle-mcp)** - ⭐ 28
...
2678. **[google-search-console-mcp-server](https://github.com/Shin-sibainu/google-search-console-mcp-server)** - ⭐ 28
   Model Context Protocol server for Google Search Console API - integrate with Claude Code and Claude Desktop

2679. **[excel-reader-mcp](https://github.com/ArchimedesCrypto/excel-reader-mcp)** - ⭐ 28
...
2680. **[robinhood-mcp-server](https://github.com/rohitsingh-iitd/robinhood-mcp-server)** - ⭐ 28
...
2681. **[Memgpt-MCP-Server](https://github.com/Vic563/Memgpt-MCP-Server)** - ⭐ 27
   A Model Context Protocol (MCP) server that provides persistent memory and multi-model LLM support.

2682. **[aws-mcp](https://github.com/lokeswaran-aj/aws-mcp)** - ⭐ 27
   An MCP(Model Context Protocol) Server for AWS services

2683. **[mcpc](https://github.com/apify/mcpc)** - ⭐ 27
   Universal command-line client for the Model Context Protocol (MCP)

2684. **[gaia-x](https://github.com/YFGaia/gaia-x)** - ⭐ 27
...
2685. **[VercelGenUI_MCP](https://github.com/JamesSloan/VercelGenUI_MCP)** - ⭐ 27
   Proof of concept chat AI combining the Model Context Protocol (MCP) with Vercel's AI SDK UI

2686. **[postgres-mcp-server](https://github.com/ahmedmustahid/postgres-mcp-server)** - ⭐ 27
   MCP (Model Context Protocol) Server for postgres Database

2687. **[mcp](https://github.com/supadata-ai/mcp)** - ⭐ 27
   Official Supadata MCP Server - Adds powerful video & web scraping to Cursor, Claude and any other LLM clients.

2688. **[google-workspace-mcp-server](https://github.com/epaproditus/google-workspace-mcp-server)** - ⭐ 27
   A Model Context Protocol server for Google Workspace integration (Gmail and Calendar)

2689. **[nettune](https://github.com/jtsang4/nettune)** - ⭐ 27
...
2690. **[mcp-structured-thinking](https://github.com/Promptly-Technologies-LLC/mcp-structured-thinking)** - ⭐ 27
...
2691. **[mcp-web-browser](https://github.com/random-robbie/mcp-web-browser)** - ⭐ 27
   An advanced web browsing server for the Model Context Protocol (MCP) powered by Playwright, enabling headless browser interactions through a flexible, secure API.

2692. **[directus-mcp-server](https://github.com/rijkvanzanten/directus-mcp-server)** - ⭐ 27
   Model Context Protocol server for Directus

2693. **[Python-Runtime-Interpreter-MCP-Server](https://github.com/hileamlakB/Python-Runtime-Interpreter-MCP-Server)** - ⭐ 27
   PRIMS is a lightweight, open-source Model Context Protocol (MCP) server that lets LLM agents safely execute arbitrary Python code in a secure, throw-away sandbox.

2694. **[seo-insights-mcp-server](https://github.com/mrgoonie/seo-insights-mcp-server)** - ⭐ 27
...
2695. **[mcp_espn_ff](https://github.com/KBThree13/mcp_espn_ff)** - ⭐ 27
   ESPN Fantasy API with LLMs!

2696. **[nimbletools-core](https://github.com/NimbleBrainInc/nimbletools-core)** - ⭐ 27
   NimbleTools is an open-source MCP runtime. Infrastructure for the agentic web.

2697. **[deno-mcp-template](https://github.com/phughesmcr/deno-mcp-template)** - ⭐ 27
   A template repo for writing and publishing local, remote, DXT, and binary MCP servers using Deno.

2698. **[mcp-stytch-consumer-todo-list](https://github.com/stytchauth/mcp-stytch-consumer-todo-list)** - ⭐ 27
   Workers + Stytch TODO App MCP Server

2699. **[mindbridge-mcp](https://github.com/pinkpixel-dev/mindbridge-mcp)** - ⭐ 27
...
2700. **[php-mcp](https://github.com/dtyq/php-mcp)** - ⭐ 27
...
2701. **[WebSearch-MCP](https://github.com/mnhlt/WebSearch-MCP)** - ⭐ 27
...
2702. **[src-to-kb](https://github.com/vezlo/src-to-kb)** - ⭐ 27
   Convert source code to LLM ready knowledge base

2703. **[Healthcare-MCP](https://github.com/innovaccer/Healthcare-MCP)** - ⭐ 27
...
2704. **[mcp-client-cli](https://github.com/thedotmack/mcp-client-cli)** - ⭐ 27
   Command-line interface for any Model Context Protocol (MCP) server.

2705. **[MCP-BOE](https://github.com/ComputingVictor/MCP-BOE)** - ⭐ 27
...
2706. **[ddg_search](https://github.com/OEvortex/ddg_search)** - ⭐ 27
   A powerful Model Context Protocol (MCP) server for web search and URL content extraction using DuckDuckGo.

2707. **[touchdesigner-mcp-server](https://github.com/bottobot/touchdesigner-mcp-server)** - ⭐ 27
...
2708. **[MCPSecBench](https://github.com/AIS2Lab/MCPSecBench)** - ⭐ 27
   MCPSecBench: A Systematic Security Benchmark and Playground for Testing Model Context Protocols

2709. **[cml-mcp](https://github.com/xorrkaz/cml-mcp)** - ⭐ 27
   A Model Context Protocol (MCP) Server for Cisco Modeling Labs (CML)

2710. **[mcp-log-proxy](https://github.com/emicklei/mcp-log-proxy)** - ⭐ 27
   a web logging proxy for MCP client-server communication

2711. **[Amazing-Marvin-MCP](https://github.com/bgheneti/Amazing-Marvin-MCP)** - ⭐ 27
   Model Context Provider for Amazing Marvin productivity app - Access your tasks, projects, and categories in AI assistants

2712. **[mcp-server](https://github.com/blockscout/mcp-server)** - ⭐ 27
   Wraps Blockscout APIs and exposes blockchain data by Model Context Protocol

2713. **[puppeteer-mcp-claude](https://github.com/jaenster/puppeteer-mcp-claude)** - ⭐ 27
...
2714. **[mcp-writer-substack](https://github.com/jonathan-politzki/mcp-writer-substack)** - ⭐ 27
   Model Context Protocol to bridge in Substack writings to Claude.

2715. **[mcp-frontend-testing](https://github.com/StudentOfJS/mcp-frontend-testing)** - ⭐ 26
   Frontend testing tools for Model Context Protocol

2716. **[do-remote-mcp-server-template](https://github.com/do-community/do-remote-mcp-server-template)** - ⭐ 26
   A Model Context Protocol (MCP) server that checks domain name availability using WHOIS lookups and DNS resolution

2717. **[pptx-xlsx-mcp](https://github.com/jenstangen1/pptx-xlsx-mcp)** - ⭐ 26
   Antrophics Model context protocol to edit powerpoint files

2718. **[minds-mcp](https://github.com/mindsdb/minds-mcp)** - ⭐ 26
...
2719. **[mcp-client-x](https://github.com/RGGH/mcp-client-x)** - ⭐ 26
   Python MCP client + server example

2720. **[mcp-gateway](https://github.com/lucky-aeon/mcp-gateway)** - ⭐ 26
...
2721. **[langchain-mcp-tools-py](https://github.com/hideya/langchain-mcp-tools-py)** - ⭐ 26
   MCP to LangChain Tools Conversion Utility / Python

2722. **[mcp-server-giphy](https://github.com/magarcia/mcp-server-giphy)** - ⭐ 26
   An implementation of Giphy integration with Model Context Protocol

2723. **[MalwareBazaar_MCP](https://github.com/mytechnotalent/MalwareBazaar_MCP)** - ⭐ 26
   An AI-driven MCP server that autonomously interfaces with Malware Bazaar, delivering real-time threat intel and sample metadata for authorized cybersecurity research workflows.

2724. **[omop_mcp](https://github.com/OHNLP/omop_mcp)** - ⭐ 26
...
2725. **[mcp-chain-of-draft-server](https://github.com/bsmi021/mcp-chain-of-draft-server)** - ⭐ 26
   Chain of Draft Server is a powerful AI-driven tool that helps developers make better decisions through systematic, iterative refinement of thoughts and designs. It integrates seamlessly with popular AI agents and provides a structured approach to reasoning, API design, architecture decisions, code reviews, and implementation planning.

2726. **[alibabacloud-dataworks-mcp-server](https://github.com/aliyun/alibabacloud-dataworks-mcp-server)** - ⭐ 26
   A Model Context Protocol (MCP) server that provides tools for AI, allowing it to interact with the DataWorks Open API through a standardized interface. This implementation is based on the Aliyun Open API and enables AI agents to perform cloud resources operations seamlessly.

2727. **[ton-blockchain-mcp](https://github.com/devonmojito/ton-blockchain-mcp)** - ⭐ 26
   A Model Context Protocol (MCP) server written in Python for natural language interaction with the TON blockchain 💎

2728. **[ai-foundry-agents-samples](https://github.com/Azure-Samples/ai-foundry-agents-samples)** - ⭐ 26
   Azure AI Foundry - Agents related sample code

2729. **[freepik-mcp](https://github.com/freepik-company/freepik-mcp)** - ⭐ 26
   The Freepik enables popular agent Model Context Protocol (MCP) to integrate with Freepik APIs through function calling.

2730. **[mcpmcp-server](https://github.com/glenngillen/mcpmcp-server)** - ⭐ 26
   Discover, setup, and integrate MCP servers with your favorite clients. Unlock the full potential of AI in your daily workflow.

2731. **[whistle-mcp](https://github.com/7gugu/whistle-mcp)** - ⭐ 26
...
2732. **[crawl4ai-mcp-server](https://github.com/sadiuysal/crawl4ai-mcp-server)** - ⭐ 26
...
2733. **[MCPServer](https://github.com/rhennigan/MCPServer)** - ⭐ 26
   Implements a model context protocol server using Wolfram Language

2734. **[nebulagraph-mcp-server](https://github.com/nebula-contrib/nebulagraph-mcp-server)** - ⭐ 26
   Model Context Protocol Server for NebulaGraph 3.x

2735. **[Fusion-360-MCP-Server](https://github.com/AuraFriday/Fusion-360-MCP-Server)** - ⭐ 26
   Control Fusion 360 with any AI through Model Context Protocol (MCP)

2736. **[RoslynMCP](https://github.com/carquiza/RoslynMCP)** - ⭐ 26
   A Model Context Protocol (MCP) server that provides C# code analysis capabilities using Microsoft Roslyn

2737. **[taiwan-holiday-mcp](https://github.com/lis186/taiwan-holiday-mcp)** - ⭐ 26
   一個基於 Model Context Protocol (MCP) 的台灣假期查詢伺服器，為 AI 工具提供準確的台灣國定假日資訊。

2738. **[MCP-Developer-SubAgent](https://github.com/gensecaihq/MCP-Developer-SubAgent)** - ⭐ 26
...
2739. **[browser-use-rs](https://github.com/BB-fat/browser-use-rs)** - ⭐ 26
...
2740. **[bear-notes-mcp](https://github.com/bejaminjones/bear-notes-mcp)** - ⭐ 26
   MCP server for Bear app - Full Read + Write AI-powered note management with Claude Desktop

2741. **[alpaca-mcp-server](https://github.com/tedlikeskix/alpaca-mcp-server)** - ⭐ 25
   Model Context Protocol (MCP) server for Alpaca trading API

2742. **[gyazo-mcp-server](https://github.com/nota/gyazo-mcp-server)** - ⭐ 25
   Official Model Context Protocol server for Gyazo

2743. **[mcp-php](https://github.com/garyblankenship/mcp-php)** - ⭐ 25
   model context protocol or mcp for php laravel

2744. **[mcp-media-processor](https://github.com/maoxiaoke/mcp-media-processor)** - ⭐ 25
   A Node.js server implementing Model Context Protocol (MCP) for media processing operations, providing powerful video and image manipulation capabilities.

2745. **[mcp-webdriveragent](https://github.com/AppiumTestDistribution/mcp-webdriveragent)** - ⭐ 25
   This is a Model Context Protocol (MCP) server that provides tools for building and signing WebDriverAgent for iOS.

2746. **[turn-based-game-mcp](https://github.com/github-samples/turn-based-game-mcp)** - ⭐ 25
...
2747. **[mcp-manager](https://github.com/nstebbins/mcp-manager)** - ⭐ 25
   CLI tool for managing Model Context Protocol (MCP) servers in one place & using them across them different clients

2748. **[php-mcp-sdk](https://github.com/dalehurley/php-mcp-sdk)** - ⭐ 25
...
2749. **[symfony-mcp-server](https://github.com/klapaudius/symfony-mcp-server)** - ⭐ 25
   A Symfony package designed for building secure servers based on the Model Context Protocol, utilizing Server-Sent Events (SSE) and/or StreamableHTTP for real-time communication. It offers a scalable tool system tailored for enterprise-grade applications.

2750. **[FalkorDB-MCPServer](https://github.com/FalkorDB/FalkorDB-MCPServer)** - ⭐ 25
   FalkorDB-MCPServer is an MCP (Model Context Protocol) server that connects LLMs to FalkorDB

2751. **[mcp-server-semgrep](https://github.com/VetCoders/mcp-server-semgrep)** - ⭐ 25
   MCP Server Semgrep is a [Model Context Protocol](https://modelcontextprotocol.io) compliant server that integrates the powerful Semgrep static analysis tool with AI assistants like Anthropic Claude. It enables advanced code analysis, security vulnerability detection, and code quality improvements directly through a conversational interface.

2752. **[deep-research-mcp](https://github.com/pinkpixel-dev/deep-research-mcp)** - ⭐ 25
   A Model Context Protocol (MCP) compliant server designed for comprehensive web research. It uses Tavily's Search and Crawl APIs to gather detailed information on a given topic, then structures this data in a format perfect for LLMs to create high-quality markdown documents.

2753. **[puzzlebox](https://github.com/cliffhall/puzzlebox)** - ⭐ 25
...
2754. **[Tiny-OAI-MCP-Agent](https://github.com/jalr4ever/Tiny-OAI-MCP-Agent)** - ⭐ 25
   A MCP protocol agent that operates a SQLite using natural language by OpenAI-Compatible LLM.

2755. **[slack-mcp-server](https://github.com/AVIMBU/slack-mcp-server)** - ⭐ 25
   A Model Context Protocol Server for Interacting with Slack

2756. **[vision-one-mcp-server](https://github.com/trendmicro/vision-one-mcp-server)** - ⭐ 25
...
2757. **[powerplatform-mcp](https://github.com/michsob/powerplatform-mcp)** - ⭐ 25
   PowerPlatform Model Context Protocol server

2758. **[zillow-mcp-server](https://github.com/sap156/zillow-mcp-server)** - ⭐ 25
   Zillow MCP Server for real estate data access via the Model Context Protocol

2759. **[systemprompt-mcp-notion](https://github.com/Ejb503/systemprompt-mcp-notion)** - ⭐ 25
...
2760. **[mcp-config-manager](https://github.com/holstein13/mcp-config-manager)** - ⭐ 25
...
2761. **[mcp-simple-timeserver](https://github.com/andybrandt/mcp-simple-timeserver)** - ⭐ 25
   Simple solution to give Claude ability to check current time via MCP

2762. **[kernel-mcp-server](https://github.com/kernel/kernel-mcp-server)** - ⭐ 25
   Open-source MCP server for secure, low-latency cloud-browser automation on Kernel.

2763. **[FerrumMCP](https://github.com/Eth3rnit3/FerrumMCP)** - ⭐ 25
...
2764. **[mcp_rss](https://github.com/buhe/mcp_rss)** - ⭐ 25
   MCP RSS is a Model Context Protocol (MCP) server for interacting with RSS feeds.

2765. **[minimax_search](https://github.com/MiniMax-AI/minimax_search)** - ⭐ 25
   MiniMax Search is an MCP (Model Context Protocol) server that provides web search and browsing capabilities.

2766. **[enhanced-mcp-memory](https://github.com/cbunting99/enhanced-mcp-memory)** - ⭐ 25
   An enhanced MCP (Model Context Protocol) server for intelligent memory and task management, designed for AI assistants and development workflows. Features semantic search, automatic task extraction, knowledge graphs, and comprehensive project management.

2767. **[agent-hub-mcp](https://github.com/gilbarbara/agent-hub-mcp)** - ⭐ 25
   A Model Context Protocol (MCP) server that enables communication and coordination between multiple AI agents

2768. **[clay-mcp](https://github.com/clay-inc/clay-mcp)** - ⭐ 25
   A simple Model Context Protocol (MCP) server for Clay.

2769. **[meeting-mcp](https://github.com/Meeting-BaaS/meeting-mcp)** - ⭐ 25
   Model Context Protocol server for AI assistants to create meeting bots, search transcripts, and manage meeting recordings.

2770. **[mcp_streamable_http](https://github.com/theailanguage/mcp_streamable_http)** - ⭐ 25
   Educational repo for MCP streamable HTTP servers and clients

2771. **[bgg-mcp](https://github.com/kkjdaniel/bgg-mcp)** - ⭐ 25
   BGG MCP provides access to BoardGameGeek and a variety of board game related data through the Model Context Protocol. Enabling retrieval and filtering of board game data, user collections, and profiles.

2772. **[pulse-editor](https://github.com/ClayPulse/pulse-editor)** - ⭐ 25
...
2773. **[semrush-mcp](https://github.com/mrkooblu/semrush-mcp)** - ⭐ 25
   A Model Context Protocol (MCP) server implementation that provides tools for accessing Semrush API data.

2774. **[ccmcp](https://github.com/gsong/ccmcp)** - ⭐ 25
   A CLI tool that intelligently discovers, validates, and selects MCP (Model Context Protocol) server configurations for Claude Code.

2775. **[awesome-mcp-lists](https://github.com/collabnix/awesome-mcp-lists)** - ⭐ 25
   A Curated List of MCP Servers, Clients and Toolkits

2776. **[chatbot_Shopify](https://github.com/Mobeen-Dev/chatbot_Shopify)** - ⭐ 24
   Agentic Shopify Chatbot with MCP integration, embedded directly into Shopify via a Theme Extension

2777. **[GenomeMCP](https://github.com/Eldergenix/GenomeMCP)** - ⭐ 24
...
2778. **[Unlock-your-agents-potential-with-Model-Context-Protocol-PostgreSQL-Workshop](https://github.com/gloveboxes/Unlock-your-agents-potential-with-Model-Context-Protocol-PostgreSQL-Workshop)** - ⭐ 24

2779. **[opnsense-mcp-server](https://github.com/floriangrousset/opnsense-mcp-server)** - ⭐ 24
...
2780. **[n8n-AI-agent-DVM-MCP-client](https://github.com/r0d8lsh0p/n8n-AI-agent-DVM-MCP-client)** - ⭐ 24
...
2781. **[mcp-server-semgrep](https://github.com/Szowesgad/mcp-server-semgrep)** - ⭐ 24
   MCP Server Semgrep is a [Model Context Protocol](https://modelcontextprotocol.io) compliant server that integrates the powerful Semgrep static analysis tool with AI assistants like Anthropic Claude. It enables advanced code analysis, security vulnerability detection, and code quality improvements directly through a conversational interface.

2782. **[python-sequential-thinking-mcp](https://github.com/XD3an/python-sequential-thinking-mcp)** - ⭐ 24
...
2783. **[MCP](https://github.com/EduBase/MCP)** - ⭐ 24
   The EduBase MCP server enables Claude and other LLMs to interact with EduBase's comprehensive e-learning platform through the Model Context Protocol (MCP).

2784. **[mcp-task-manager-server](https://github.com/bsmi021/mcp-task-manager-server)** - ⭐ 24
   A local Model Context Protocol (MCP) server providing backend tools for client-driven project and task management using a SQLite database.

2785. **[brlaw_mcp_server](https://github.com/pdmtt/brlaw_mcp_server)** - ⭐ 24
   A MCP (Model Context Protocol) server for agent-driven research on Brazilian law using official sources

2786. **[DeepResearchMCP](https://github.com/ameeralns/DeepResearchMCP)** - ⭐ 24
...
2787. **[aistudio-mcp-server](https://github.com/eternnoir/aistudio-mcp-server)** - ⭐ 24
...
2788. **[mcp-template-dotnet](https://github.com/NikiforovAll/mcp-template-dotnet)** - ⭐ 24
   This repository contains a template for creating a Model Context Protocol (MCP) applications in .NET.

2789. **[mcp-playground](https://github.com/zanetworker/mcp-playground)** - ⭐ 24
   Simple MCP Client for remote MCP Servers 🌐

2790. **[Awesome-MCP](https://github.com/Albertchamberlain/Awesome-MCP)** - ⭐ 24
   Awesome-MCP Servers & Clients & Funny things

2791. **[openai-copilot](https://github.com/feiskyer/openai-copilot)** - ⭐ 24
   Your life Copilot powered by LLM models (CLI interface for LLM models with MCP tools).

2792. **[calendar-mcp](https://github.com/deciduus/calendar-mcp)** - ⭐ 24
...
2793. **[readwise-vector-db](https://github.com/leonardsellem/readwise-vector-db)** - ⭐ 24
...
2794. **[nestjs-mcp](https://github.com/bamada/nestjs-mcp)** - ⭐ 24
   NestJS module for seamless Model Context Protocol (MCP) server integration using decorators.

2795. **[forgejo-mcp](https://github.com/goern/forgejo-mcp)** - ⭐ 24
...
2796. **[cfbd-mcp-server](https://github.com/lenwood/cfbd-mcp-server)** - ⭐ 24
   An MCP server enabling CFBD API queries within Claude Desktop.

2797. **[mcp-server-amazon-bedrock](https://github.com/zxkane/mcp-server-amazon-bedrock)** - ⭐ 24
   Model Context Procotol(MCP) server for using Amazon Bedrock Nova Canvas to generate images

2798. **[MiAO-MCP-for-Unity](https://github.com/MiAO-AI-Lab/MiAO-MCP-for-Unity)** - ⭐ 24
...
2799. **[github-repo-mcp](https://github.com/Ryan0204/github-repo-mcp)** - ⭐ 24
   Model Context Protocol server for Github Repo // Reading Github Repo

2800. **[k6-mcp-server](https://github.com/QAInsights/k6-mcp-server)** - ⭐ 24
   k6 MCP server

2801. **[prometheus-mcp](https://github.com/idanfishman/prometheus-mcp)** - ⭐ 24
   A Model Context Protocol (MCP) server implementation that provides AI agents with programmatic access to Prometheus metrics via a unified interface.

2802. **[bzm-mcp](https://github.com/Blazemeter/bzm-mcp)** - ⭐ 24
   Official BlazeMeter MCP Server for AI-driven performance testing

2803. **[metals-standalone-client](https://github.com/jpablo/metals-standalone-client)** - ⭐ 24
   Minimal Metals stand alone client that allows running the metals mcp server

2804. **[mcp-caiyun-weather](https://github.com/caiyunapp/mcp-caiyun-weather)** - ⭐ 24
   A Model Context Protocol (MCP) server for Caiyun (ColorfulClouds) Weather.

2805. **[mcp-desktop-automation](https://github.com/tanob/mcp-desktop-automation)** - ⭐ 24
   A Model Context Protocol server that provides desktop automation capabilities using RobotJS and screenshot capabilities

2806. **[greptimedb-mcp-server](https://github.com/GreptimeTeam/greptimedb-mcp-server)** - ⭐ 24
   A Model Context Protocol (MCP) server for GreptimeDB

2807. **[mcp-slicer](https://github.com/zhaoyouj/mcp-slicer)** - ⭐ 24
   A Model Context Protocol server for 3D Slicer integration

2808. **[mcp-server-excel](https://github.com/sbroenne/mcp-server-excel)** - ⭐ 24
   Excel MCP Server & CLI - 21 tools, 187 operations for AI-powered Excel automation via COM API

2809. **[relace-mcp](https://github.com/possible055/relace-mcp)** - ⭐ 24
   Unofficial Relace MCP client with AI features. Personal project; not affiliated with or endorsed by Relace

2810. **[metabase-mcp-server](https://github.com/hyeongjun-dev/metabase-mcp-server)** - ⭐ 24
   A Model Context Protocol server that integrates AI assistants with Metabase analytics platform

2811. **[batchdata-mcp-real-estate](https://github.com/zellerhaus/batchdata-mcp-real-estate)** - ⭐ 24
...
2812. **[mcp-ffmpeg-helper](https://github.com/sworddut/mcp-ffmpeg-helper)** - ⭐ 24
   一个基于 Model Context Protocol (MCP) 的 FFmpeg 辅助工具，提供视频处理功能。

2813. **[mcp-client-agent](https://github.com/shane-kercheval/mcp-client-agent)** - ⭐ 24
   CLI that uses DSPy to interact with MCP servers.

2814. **[roo-logger](https://github.com/annenpolka/roo-logger)** - ⭐ 24
   An MCP server for logging activity in Roo Code/Cline.

2815. **[identity-spec](https://github.com/agntcy/identity-spec)** - ⭐ 24
   AGNTCY Identity allows to onboard, create and verify identities for Agents, Model Context Protocol (MCP) Servers and Multi-Agent Systems (MASs).

2816. **[apifox-mcp](https://github.com/iwen-conf/apifox-mcp)** - ⭐ 24
   Apifox MCP 服务器 - 让 Claude 等 AI 助手通过自然语言管理你的 Apifox 项目，轻松创建、更新和审计 API 接口

2817. **[mcp-annotated-java-sdk](https://github.com/thought2code/mcp-annotated-java-sdk)** - ⭐ 24
   Annotation-driven MCP dev 🚀 No Spring, Zero Boilerplate, Pure Java

2818. **[cursor-db-mcp](https://github.com/jbdamask/cursor-db-mcp)** - ⭐ 24
   Model Context Protocol server for querying Cursor chat history

2819. **[powerpoint-mcp](https://github.com/Ayushmaniar/powerpoint-mcp)** - ⭐ 24
   Open Source Model Context Protocol server for PowerPoint automation on Windows via pywin32

2820. **[d365fo-client](https://github.com/mafzaal/d365fo-client)** - ⭐ 24
...
2821. **[codesys-mcp-toolkit](https://github.com/johannesPettersson80/codesys-mcp-toolkit)** - ⭐ 24
   Model Context Protocol server for CODESYS automation platform

2822. **[pi-mcp-adapter](https://github.com/nicobailon/pi-mcp-adapter)** - ⭐ 24
   Token-efficient MCP adapter for Pi coding agent

2823. **[Model-Context-Protocol](https://github.com/Coding-Crashkurse/Model-Context-Protocol)** - ⭐ 23

2824. **[jigsawstack-mcp-server](https://github.com/JigsawStack/jigsawstack-mcp-server)** - ⭐ 23
   Model Context Protocol Server that allows AI models to interact with JigsawStack models!

2825. **[cortex](https://github.com/FreePeak/cortex)** - ⭐ 23
...
2826. **[paraview_mcp](https://github.com/LLNL/paraview_mcp)** - ⭐ 23
   ParaView-MCP integrates multimodal LLMs with ParaView via Model Context Protocol, enabling natural language control of scientific visualizations. The agent observes the viewport for visual feedback, making complex visualization tool accessible to all users while providing intelligent automation for experts.

2827. **[lineshopping-api-mcp](https://github.com/woraphol-j/lineshopping-api-mcp)** - ⭐ 23
...
2828. **[home-assistant-mcp](https://github.com/hpohlmann/home-assistant-mcp)** - ⭐ 23
...
2829. **[mcp-twitter-server](https://github.com/crazyrabbitLTC/mcp-twitter-server)** - ⭐ 23
   Model Context Protocol Server for Accessing twitter

2830. **[lua-resty-mcp](https://github.com/ufownl/lua-resty-mcp)** - ⭐ 23
   Model Context Protocol SDK implemented in Lua for OpenResty

2831. **[mcp-server-starter-ts](https://github.com/alexanderop/mcp-server-starter-ts)** - ⭐ 23
   A minimal TypeScript starter template for building Model Context Protocol (MCP) servers.

2832. **[strava-mcp](https://github.com/kw510/strava-mcp)** - ⭐ 23
...
2833. **[mcp-community](https://github.com/Mirascope/mcp-community)** - ⭐ 23
   Easily run, deploy, and connect to MCP servers

2834. **[jsonv-ts](https://github.com/dswbx/jsonv-ts)** - ⭐ 23
   JSON Schema builder and validator for TypeScript with static type inference, Hono middleware for OpenAPI generation and validation, and MCP server/client implementation. Lightweight, dependency-free, and built on Web Standards.

2835. **[solana-mcp](https://github.com/tony-42069/solana-mcp)** - ⭐ 23
...
2836. **[aisdk-mcp-bridge](https://github.com/vrknetha/aisdk-mcp-bridge)** - ⭐ 23
...
2837. **[RevitMCP](https://github.com/oakplank/RevitMCP)** - ⭐ 23
   model context protocol for Autodesk Revit

2838. **[nlweb-net](https://github.com/nlweb-ai/nlweb-net)** - ⭐ 23
...
2839. **[mcp-pa-ai-agent](https://github.com/zhangzhongnan928/mcp-pa-ai-agent)** - ⭐ 23
   A personal assistant AI agent built with the Model Context Protocol (MCP)

2840. **[openproject-mcp-server](https://github.com/AndyEverything/openproject-mcp-server)** - ⭐ 23
   A Model Context Protocol (MCP) server that provides seamless integration with OpenProject API v3.

2841. **[microsoft_fabric_mcp](https://github.com/Augustab/microsoft_fabric_mcp)** - ⭐ 23
   MCP server wrapping around the Fabric Rest API

2842. **[skill-mcp](https://github.com/fkesheh/skill-mcp)** - ⭐ 23
...
2843. **[silverbullet-mcp](https://github.com/Ahmad-A0/silverbullet-mcp)** - ⭐ 23
   A Model Context Protocol (MCP) server to interact with your SilverBullet notes and data.

2844. **[lightdash-mcp-server](https://github.com/syucream/lightdash-mcp-server)** - ⭐ 23
   A MCP(Model Context Protocol) server that accesses to Lightdash

2845. **[MCPbundler](https://github.com/eugenepyvovarov/MCPbundler)** - ⭐ 23

2846. **[balldontlie-mcp](https://github.com/mikechao/balldontlie-mcp)** - ⭐ 23
   An MCP Server implementation that integrates the Balldontlie API, to provide information about players, teams and games for the NBA, NFL and MLB

2847. **[deep-research](https://github.com/ssdeanx/deep-research)** - ⭐ 23
...
2848. **[native-devtools-mcp](https://github.com/sh3ll3x3c/native-devtools-mcp)** - ⭐ 23
   Model Context Protocol server for native app testing 

2849. **[codemesh](https://github.com/kiliman/codemesh)** - ⭐ 22
   The Self-Improving MCP Server - Agents write code to orchestrate multiple MCP servers with intelligent TypeScript execution and auto-augmentation

2850. **[fastify-mcp](https://github.com/haroldadmin/fastify-mcp)** - ⭐ 22
   A Fastify plugin to run Model Context Protocol (MCP) servers

2851. **[MCP-123](https://github.com/Tylersuard/MCP-123)** - ⭐ 22
   The easiest possible implementation of an MCP server and client.  Set up a server or a client in 2 lines of code.

2852. **[nobitex-mcp-server](https://github.com/xmannii/nobitex-mcp-server)** - ⭐ 22
   a Model Context Protocol (MCP) server that provides access to cryptocurrency market data from the Nobitex API.

2853. **[mcp-server-oracle](https://github.com/hdcola/mcp-server-oracle)** - ⭐ 22
   Model Context Protocol server to access oracle database

2854. **[higress-ops-mcp-server](https://github.com/higress-group/higress-ops-mcp-server)** - ⭐ 22
   A Model Context Protocol (MCP) server implementation that enables comprehensive configuration and management of Higress.

2855. **[Elysia-mcp](https://github.com/keithagroves/Elysia-mcp)** - ⭐ 22
   Model Context Protocol (MCP) Server for Bun and Elysia

2856. **[mcp-flux-studio](https://github.com/jmanhype/mcp-flux-studio)** - ⭐ 22
   A Model Context Protocol server for Flux image generation, providing tools for image generation, manipulation, and control

2857. **[DANP-Engine](https://github.com/DANP-LABS/DANP-Engine)** - ⭐ 22
   A trusted AI Model Context Protocol (MCP) runtime for secure, decentralized AI tools and services.

2858. **[mcp-sse-authenticated-cloud-run](https://github.com/the-freetech-company/mcp-sse-authenticated-cloud-run)** - ⭐ 22
   Host an Model Context Protocol SSE deployment on Cloud Run, Authenticating with IAM.

2859. **[MobSF-MCP](https://github.com/il-il1/MobSF-MCP)** - ⭐ 22
   a Node.js-based Model Context Protocol implementation for MobSF

2860. **[async-mcp](https://github.com/v3g42/async-mcp)** - ⭐ 22
   A minimalistic async Rust implementation of the Model Context Protocol (MCP).

2861. **[mcpagentai](https://github.com/mcpagents-ai/mcpagentai)** - ⭐ 22
...
2862. **[p5js-ai-editor](https://github.com/adilmoujahid/p5js-ai-editor)** - ⭐ 22
...
2863. **[printify-mcp](https://github.com/TSavo/printify-mcp)** - ⭐ 22
   A Model Context Protocol (MCP) server for integrating AI assistants with Printify's print-on-demand platform

2864. **[mcp-claude-spotify](https://github.com/imprvhub/mcp-claude-spotify)** - ⭐ 22
   An integration that allows Claude Desktop to interact with Spotify using the Model Context Protocol (MCP).

2865. **[cf-mcp-client](https://github.com/cpage-pivotal/cf-mcp-client)** - ⭐ 22
   Tanzu Platform Chat

2866. **[supabase-mcp-client](https://github.com/tambo-ai/supabase-mcp-client)** - ⭐ 22
   Supabase MCP client react app with Tambo

2867. **[biznagafest-mcp](https://github.com/0GiS0/biznagafest-mcp)** - ⭐ 22
   MCP Servers en Málaga con salero

2868. **[langchain-mcp-tools-ts](https://github.com/hideya/langchain-mcp-tools-ts)** - ⭐ 22
   MCP to LangChain Tools Conversion Utility / TypeScript

2869. **[dbt-docs-mcp](https://github.com/mattijsdp/dbt-docs-mcp)** - ⭐ 22
   MCP (model context protocol) server for interacting with dbt Docs

2870. **[MCP_A2A](https://github.com/regismesquita/MCP_A2A)** - ⭐ 22
...
2871. **[grumpydev-mcp](https://github.com/sinedied/grumpydev-mcp)** - ⭐ 22
   Let the grumpy senior dev review your code with this MCP server

2872. **[Claude-Code-MCP-Manager](https://github.com/qdhenry/Claude-Code-MCP-Manager)** - ⭐ 22
    A comprehensive tool to manage Model Context Protocol (MCP) configurations for Claude code

2873. **[slack-mcp-client](https://github.com/csonigo/slack-mcp-client)** - ⭐ 22
   An MCP client for slack in Typescript

2874. **[Excel-MCP-Server-Master](https://github.com/guillehr2/Excel-MCP-Server-Master)** - ⭐ 22
...
2882. **[holoviz-mcp](https://github.com/MarcSkovMadsen/holoviz-mcp)** - ⭐ 21
   ✨A MCP server that provides intelligent access to the HoloViz ecosystem for humans and AIs.

2883. **[bridge-mcp](https://github.com/codingjam/bridge-mcp)** - ⭐ 21
...
2884. **[mcpsharepoint](https://github.com/BrianCusack/mcpsharepoint)** - ⭐ 21
   Model Context Protocol server that provides access to Organisational SharePoint.

2885. **[command-executor-mcp-server](https://github.com/Sunwood-ai-labs/command-executor-mcp-server)** - ⭐ 21
   Model Context Protocol Server for Safely Executing Pre-approved Commands

2886. **[emqx-mcp-server](https://github.com/Benniu/emqx-mcp-server)** - ⭐ 21
   A Model Context Protocol (MCP) server implementation that provides EMQX MQTT broker interaction.

2887. **[mcp-sentry](https://github.com/MCP-100/mcp-sentry)** - ⭐ 21
   A Model Context Protocol server for retrieving and analyzing issues from Sentry.io

2888. **[fastify-mcp-server](https://github.com/flaviodelgrosso/fastify-mcp-server)** - ⭐ 21
   Fastify plugin to easily spin up Model Context Protocol (MCP) HTTP servers

2889. **[mcp-korean-spell](https://github.com/winterjung/mcp-korean-spell)** - ⭐ 21
   MCP(Model Context Protocol) server designed for Korean spell checking

2890. **[DocsRay](https://github.com/MIMICLab/DocsRay)** - ⭐ 21
   Lightweight PDF Q&A tool powered by RAG (Retrieval-Augmented Generation) with MCP (Model Context Protocol) Support.

2891. **[MCPRules](https://github.com/bartwisch/MCPRules)** - ⭐ 21
...
2892. **[code-context-mcp](https://github.com/fkesheh/code-context-mcp)** - ⭐ 21
   A Model Context Protocol (MCP) server for providing code context from git repositories

2893. **[mcp-knowledge-base](https://github.com/hjlee94/mcp-knowledge-base)** - ⭐ 21
   MCP agent/client/server implementation for private knowledge base

2894. **[awesome-mcp](https://github.com/MCPHubCloud/awesome-mcp)** - ⭐ 21
   A collection of mcp servers/client/sdks

2895. **[mcp-cmd](https://github.com/developit/mcp-cmd)** - ⭐ 21
   CLI for calling successive MCP Server tools

2896. **[server-sharepoint](https://github.com/Zerg00s/server-sharepoint)** - ⭐ 21
...
2907. **[mcp-framework](https://github.com/koki7o/mcp-framework)** - ⭐ 21
   Rust MCP framework for building AI agents

2908. **[kirby-mcp](https://github.com/bnomei/kirby-mcp)** - ⭐ 21
...
2909. **[GUI-MCP](https://github.com/PhialsBasement/GUI-MCP)** - ⭐ 21
...
2910. **[ib-mcp-cache-server](https://github.com/ibproduct/ib-mcp-cache-server)** - ⭐ 21
   Memory Cache Server for use with supported MCP API Clients.

2911. **[hs-mcp](https://github.com/buecking/hs-mcp)** - ⭐ 21
   Haskell server/client for MCP (Model Context Protocol)

2912. **[codebase-context](https://github.com/PatrickSys/codebase-context)** - ⭐ 21
...
2913. **[zotero-mcp-server](https://github.com/swairshah/zotero-mcp-server)** - ⭐ 20
   MCP server to expose local zotero repository to MCP clients 

2914. **[mcp-server-runner](https://github.com/yonaka15/mcp-server-runner)** - ⭐ 20
...
2915. **[mcp-ai-agent](https://github.com/fkesheh/mcp-ai-agent)** - ⭐ 20
...
2916. **[easymcp](https://github.com/promptmesh/easymcp)** - ⭐ 20
   A high performance MCP client sdk for python

2917. **[mcp-server-memos-py](https://github.com/RyoJerryYu/mcp-server-memos-py)** - ⭐ 20
   A Python package enabling LLM models to interact with the Memos server via the MCP interface for searching, creating, retrieving, and managing memos.

2918. **[PDB-MCP-Server](https://github.com/Augmented-Nature/PDB-MCP-Server)** - ⭐ 20
...
2919. **[mcp-prompt-optimizer](https://github.com/Bubobot-Team/mcp-prompt-optimizer)** - ⭐ 20
   Advanced MCP server providing cutting-edge prompt optimization tools with research-backed strategies

2920. **[lotus-wisdom-mcp](https://github.com/linxule/lotus-wisdom-mcp)** - ⭐ 20
...
2921. **[help-scout-mcp-server](https://github.com/drewburchfield/help-scout-mcp-server)** - ⭐ 20
   MCP server for Help Scout - search conversations, threads, and inboxes with AI agents

2922. **[mcpc](https://github.com/micl2e2/mcpc)** - ⭐ 20
   Cross-platform C SDK for Model Context Protocol (MCP), in modern🚀 C23.

2923. **[guidance-for-scalable-model-inference-and-agentic-ai-on-amazon-eks](https://github.com/aws-solutions-library-samples/guidance-for-scalable-model-inference-and-agentic-ai-on-amazon-eks)** - ⭐ 20
...
2924. **[mssqlclient-mcp-server](https://github.com/aadversteeg/mssqlclient-mcp-server)** - ⭐ 20
...
2925. **[Wwise-MCP](https://github.com/BilkentAudio/Wwise-MCP)** - ⭐ 20
...
2926. **[fast-mcp-telegram](https://github.com/leshchenko1979/fast-mcp-telegram)** - ⭐ 20
   Telegram MCP Server and HTTP-MTProto bridge | Multi-user auth, intelligent search, file sending, web setup | Docker & PyPI ready

2927. **[NiFiMCP](https://github.com/ms82119/NiFiMCP)** - ⭐ 19
   An MCP Server and client for communicating with Nifi (v1.28)

2928. **[gemini-mcp-client](https://github.com/angrysky56/gemini-mcp-client)** - ⭐ 19
...
2935. **[mcp-frontend](https://github.com/shaharia-lab/mcp-frontend)** - ⭐ 19
   Frontend for MCP (Model Context Protocol) Kit for Go - A Complete MCP solutions for ready to use

2936. **[minime-mcp](https://github.com/manujbawa/minime-mcp)** - ⭐ 19
...
2937. **[registry](https://github.com/biocontext-ai/registry)** - ⭐ 19
   The BioContextAI Registry for biomedical MCP servers

2938. **[mcp-server-mariadb](https://github.com/abel9851/mcp-server-mariadb)** - ⭐ 19
   An mcp server that provides read-only access to MariaDB.

2939. **[mcp-server](https://github.com/paperinvest/mcp-server)** - ⭐ 19
   Official MCP server for Paper's trading platform - enables AI assistants to interact with Paper's API

2940. **[agent-mcp](https://github.com/grupa-ai/agent-mcp)** - ⭐ 19
   MCPAgent for Grupa.AI Multi-agent Collaboration Network (MACNET) with Model Context Protocol (MCP) capabilities baked in

2941. **[html-to-markdown-mcp](https://github.com/levz0r/html-to-markdown-mcp)** - ⭐ 19
...
2942. **[linux-command-mcp](https://github.com/xkiranj/linux-command-mcp)** - ⭐ 19
   MCP server and client for running Linux commands

2943. **[agent-twitter-client-mcp](https://github.com/ryanmac/agent-twitter-client-mcp)** - ⭐ 19
...
2944. **[mcp-server-client-demo](https://github.com/S1LV3RJ1NX/mcp-server-client-demo)** - ⭐ 19
   Streamable HTTP based MCP server and Client demo with auto registry, Dockerfile setup and env. 

2945. **[mcp-web-scraper](https://github.com/Decodo/mcp-web-scraper)** - ⭐ 19
   The Decodo MCP server which enables MCP clients to interface with services.

2946. **[Unity-AI-Animation](https://github.com/IvanMurzak/Unity-AI-Animation)** - ⭐ 19
...
2947. **[autotask-mcp](https://github.com/asachs01/autotask-mcp)** - ⭐ 19
   MCP server for Kaseya Autotask PSA — 39 tools for companies, tickets, projects, time entries, and more

2948. **[Unity-AI-ProBuilder](https://github.com/IvanMurzak/Unity-AI-ProBuilder)** - ⭐ 19
...
2949. **[notebooklm-mcp-secure](https://github.com/Pantheon-Security/notebooklm-mcp-secure)** - ⭐ 19
   Secure NotebookLM MCP Server - Query Google NotebookLM from Claude/AI agents with 14 security hardening layers

2950. **[eleven.shopping](https://github.com/elevenlabs/eleven.shopping)** - ⭐ 18
   ElevenLabs Agent with Storefront MCP UI Server & MCP UI client

2951. **[typescript-mcp-client](https://github.com/CodelyTV/typescript-mcp-client)** - ⭐ 18

2952. **[openpyxl-mcp-server](https://github.com/jonemo/openpyxl-mcp-server)** - ⭐ 18
...
2959. **[mcp-link](https://github.com/AuraFriday/mcp-link)** - ⭐ 18
...
2960. **[gpt2099.nu](https://github.com/cablehead/gpt2099.nu)** - ⭐ 18
   a Nushell cross.stream extension to interact with LLMs and MCP servers

2961. **[Devmind-MCP](https://github.com/JochenYang/Devmind-MCP)** - ⭐ 18
...
2962. **[seedream-image-mcp](https://github.com/wearzdk/seedream-image-mcp)** - ⭐ 18
   🚀 PixelMCP | 为你的 Cursor、Claude Code 等集成AI绘画能力，让AI生成的页面不再单调！

2963. **[mcp-chat-studio](https://github.com/JoeCastrom/mcp-chat-studio)** - ⭐ 18
...
2964. **[mcp-agent](https://github.com/joshuaalpuerto/mcp-agent)** - ⭐ 18
...
2965. **[Zammad-MCP](https://github.com/basher83/Zammad-MCP)** - ⭐ 18
...
2966. **[mcpx](https://github.com/AIGC-Hackers/mcpx)** - ⭐ 18
...
2967. **[ai-cli](https://github.com/manusa/ai-cli)** - ⭐ 18
   ai-cli lets you go from zero to AI-powered in seconds in a safe, automated and tailored way.

2968. **[mcp-server-microsoft-paint](https://github.com/ghuntley/mcp-server-microsoft-paint)** - ⭐ 18

2969. **[mcp-chain-of-draft-prompt-tool](https://github.com/brendancopley/mcp-chain-of-draft-prompt-tool)** - ⭐ 18
   MCP prompt tool applying Chain-of-Draft (CoD) reasoning - BYOLLM

2970. **[datawrapper-mcp](https://github.com/palewire/datawrapper-mcp)** - ⭐ 18
   A Model Context Protocol (MCP) server for creating Datawrapper charts using AI assistants.

2971. **[codeprism](https://github.com/rustic-ai/codeprism)** - ⭐ 18
...
2972. **[local_faiss_mcp](https://github.com/nonatofabio/local_faiss_mcp)** - ⭐ 18
   Local FAISS vector store as an MCP server – drop-in local RAG for Claude / Copilot / Agents.

2973. **[Augmented-Nature-UniProt-MCP-Server](https://github.com/Augmented-Nature/Augmented-Nature-UniProt-MCP-Server)** - ⭐ 18
   A comprehensive Model Context Protocol (MCP) server providing advanced access to the UniProt protein database. 

2974. **[mcp-oauth-proxy](https://github.com/obot-platform/mcp-oauth-proxy)** - ⭐ 18
   Oauth 2.1 proxy server that can autheticate client and proxy requests to mcp server

2975. **[smartlead-mcp-server](https://github.com/jonathan-politzki/smartlead-mcp-server)** - ⭐ 17
   Local version of Smartlead MCP for quick download and deployment to MCP compatible clients or n8n.

2976. **[mcp-http-client-example](https://github.com/slavashvets/mcp-http-client-example)** - ⭐ 17
   Simple example client demonstrating how to connect to MCP servers over HTTP (SSE)

2977. **[rollbar-mcp-server](https://github.com/rollbar/rollbar-mcp-server)** - ⭐ 17
   Pre-release - Model Context Protocol server for Rollbar

2978. **[jiki](https://github.com/teilomillet/jiki)** - ⭐ 17

2979. **[MCP-Development-with-Rust](https://github.com/RustSandbox/MCP-Development-with-Rust)** - ⭐ 17
...
2980. **[askit](https://github.com/johnrobinsn/askit)** - ⭐ 17
   LLM Function Calling Library and CLI with Support for MCP Servers

2981. **[toolkit-mcp-server](https://github.com/cyanheads/toolkit-mcp-server)** - ⭐ 17
   A Model Context Protocol server providing LLM Agents with system utilities and tools, including IP geolocation, network diagnostics, system monitoring, cryptographic operations, and QR code generation.

2982. **[youtube-mcp-server](https://github.com/0GiS0/youtube-mcp-server)** - ⭐ 17
   Cómo crear MCP Servers y usarlos con GitHub Copilot Chat 🚀💻🤖

2983. **[cmcp](https://github.com/RussellLuo/cmcp)** - ⭐ 17
   A command-line utility for interacting with MCP servers.

2984. **[short-url](https://github.com/fengzhongsen/short-url)** - ⭐ 17
   简单易用的短链接生成工具，完全开源、免费、无需登录，可私有化部署，链接永久有效！

2985. **[it-tools-mcp](https://github.com/wrenchpilot/it-tools-mcp)** - ⭐ 17
...
2986. **[context-lens](https://github.com/cornelcroi/context-lens)** - ⭐ 17
...
2987. **[eraser-io-mcp-server](https://github.com/buck-0x/eraser-io-mcp-server)** - ⭐ 17
   A Python MCP (Model Context Protocol) server and CLI tool to render diagrams using the Eraser API.

2988. **[GUARDRAIL](https://github.com/nshkrdotcom/GUARDRAIL)** - ⭐ 17
   GUARDRAIL - MCP Security - Gateway for Unified Access, Resource Delegation, and Risk-Attenuating Information Limits

2989. **[Air-Quality-Trends-Analysis-Project](https://github.com/dyneth02/Air-Quality-Trends-Analysis-Project)** - ⭐ 17
...
2990. **[MCP-Agent](https://github.com/CursorTouch/MCP-Agent)** - ⭐ 17
   Connect to any MCP servers using agents

2991. **[cheat-engine-server-python](https://github.com/bethington/cheat-engine-server-python)** - ⭐ 17
...
2992. **[ACP-MCP-Server](https://github.com/GongRzhe/ACP-MCP-Server)** - ⭐ 17
...
2993. **[jenkins-mcp-enterprise](https://github.com/Jordan-Jarvis/jenkins-mcp-enterprise)** - ⭐ 17
...
2994. **[muxi](https://github.com/ranaroussi/muxi)** - ⭐ 16
   An extensible AI agents framework

2995. **[mcp-email-client](https://github.com/gamalan/mcp-email-client)** - ⭐ 16
   Email Client as MCP Server. Feature: multiple configuration, more than just gmail

2996. **[oneshot](https://github.com/Destiner/oneshot)** - ⭐ 16
   Anthropic MCP client for macOS

2997. **[unity-mcp](https://github.com/wondeks/unity-mcp)** - ⭐ 16
   A Unity MCP server that allows MCP clients like Claude Desktop or Cursor to perform Unity Editor actions.

2998. **[CereBro](https://github.com/rob1997/CereBro)** - ⭐ 16
   A model-agnostic MCP Client-Server for .Net and Unity

2999. **[lite-mcp-client](https://github.com/sligter/lite-mcp-client)** - ⭐ 16
   Lite-MCP-Client是一个基于命令行的轻量级MCP客户端工具

3000. **[EasyMCP](https://github.com/mshojaei77/EasyMCP)** - ⭐ 16
...
3001. **[google-scholar-mcp](https://github.com/mochow13/google-scholar-mcp)** - ⭐ 16
   An MCP server for Google Scholar written in TypeScript with Streamable HTTP

3002. **[mcp-installer](https://github.com/joobisb/mcp-installer)** - ⭐ 16
   Simplifies the installation and management of MCP (Model Context Protocol) servers across different AI clients.

3003. **[appvector-mcp](https://github.com/Multivariate-AI-Inc/appvector-mcp)** - ⭐ 16
...
3004. **[daiv](https://github.com/srtab/daiv)** - ⭐ 16
...
3005. **[protocols-io-mcp-server](https://github.com/hqn21/protocols-io-mcp-server)** - ⭐ 16
   An MCP server that enables MCP clients like Claude Desktop to interact with data from protocols.io.

3006. **[mcp-progressive-agentskill](https://github.com/cablate/mcp-progressive-agentskill)** - ⭐ 16
...
3007. **[Agentic-MCP-Skill](https://github.com/cablate/Agentic-MCP-Skill)** - ⭐ 16
   Agentic-MCP, Progressive MCP client with three-layer lazy loading. Validates AgentSkills.io pattern for efficient token usage. Use MCP without pre-install & wasting full-loading

3008. **[mcp-chatbot](https://github.com/mctrinh/mcp-chatbot)** - ⭐ 16
...
3009. **[create-mcp](https://github.com/fefergrgrgrg/create-mcp)** - ⭐ 16
   CLI to set up and deploy MCP Servers to Cloudflare Workers in seconds. Just write TypeScript functions to make Cursor MCP tools.

3010. **[pophive-mcp-server](https://github.com/Cicatriiz/pophive-mcp-server)** - ⭐ 16
...
3011. **[github-repos-manager-mcp](https://github.com/kurdin/github-repos-manager-mcp)** - ⭐ 16
...
3012. **[mcpls](https://github.com/bug-ops/mcpls)** - ⭐ 16
   Universal MCP to LSP bridge - expose Language Server Protocol capabilities as MCP tools for AI agents

3013. **[fusion-mcp-server](https://github.com/Joe-Spencer/fusion-mcp-server)** - ⭐ 16
...
3014. **[unity-editor-mcp](https://github.com/ozankasikci/unity-editor-mcp)** - ⭐ 16
   An MCP server and client for LLMs to interact with Unity Projects

3015. **[qdrant-mcp-server](https://github.com/mhalder/qdrant-mcp-server)** - ⭐ 16
   MCP server for semantic search using local Qdrant vector database and OpenAI embeddings

3016. **[docmole](https://github.com/Vigtu/docmole)** - ⭐ 16
   Dig through any documentation with AI - MCP server for Claude, Cursor, and other AI assistants

3017. **[mcp-koii](https://github.com/benjaminr/mcp-koii)** - ⭐ 16
   MCP Server for Teenage Engineering EP-133 KO-II

3018. **[emceepee](https://github.com/eastlondoner/emceepee)** - ⭐ 16
...
3019. **[hasmcp-ce](https://github.com/hasmcp/hasmcp-ce)** - ⭐ 16
   HasMCP Community Edition

3020. **[substack-mcp](https://github.com/marcomoauro/substack-mcp)** - ⭐ 16
...
3021. **[mcp_client](https://github.com/app-appplayer/mcp_client)** - ⭐ 15

3022. **[MCP-Analyzer](https://github.com/klara-research/MCP-Analyzer)** - ⭐ 15
   An MCP server to read MCP logs to debug directly inside the client

3023. **[mistr-agent](https://github.com/itisaevalex/mistr-agent)** - ⭐ 15
...
3024. **[mcp-server](https://github.com/HarperFast/mcp-server)** - ⭐ 15
   An MCP server providing an interface for MCP clients to access data within Harper.

3025. **[sveltekit-mcp-starter](https://github.com/axel-rock/sveltekit-mcp-starter)** - ⭐ 15

3026. **[mcp-this](https://github.com/shane-kercheval/mcp-this)** - ⭐ 15
...
3027. **[QCX](https://github.com/QueueLab/QCX)** - ⭐ 15
   Language to Maps

3028. **[django-firebase-mcp](https://github.com/raghavdasila/django-firebase-mcp)** - ⭐ 15
...
3029. **[claude-server](https://github.com/davidteren/claude-server)** - ⭐ 15
...
3030. **[pinmeto-location-mcp](https://github.com/PinMeTo/pinmeto-location-mcp)** - ⭐ 15
   PinMeTo MCP server that enables users with authorized credentials to unlock their data 

3031. **[grok-faf-mcp](https://github.com/Wolfe-Jam/grok-faf-mcp)** - ⭐ 15
   First MCP server for Grok | FAST⚡️AF • URL-based AI context • Vercel-deployed

3032. **[mcp-server-amazon](https://github.com/rigwild/mcp-server-amazon)** - ⭐ 15
   🛍📦 Unofficial Amazon Model Context Protocol Server (MCP) - Search products and purchase directly from Claude AI! ✨

3033. **[awesome-dxt-mcp](https://github.com/MCPStar/awesome-dxt-mcp)** - ⭐ 15
...
3034. **[npm-search-mcp-server](https://github.com/btwiuse/npm-search-mcp-server)** - ⭐ 15
   MCP server for searching npm packages

3035. **[mcp-client-and-proxy](https://github.com/appsecco/mcp-client-and-proxy)** - ⭐ 15
   A universal MCP client with proxying feature to interact with MCP Servers which support STDIO transport.

3036. **[mcp-server-python-template](https://github.com/sontallive/mcp-server-python-template)** - ⭐ 15
   This template provides a streamlined foundation for building Model Context Protocol (MCP) servers in Python. It's designed to make AI-assisted development of MCP tools easier and more efficient.

3037. **[autowpmcp](https://github.com/Njengah/autowpmcp)** - ⭐ 15
...
3038. **[mcp-graphql-forge](https://github.com/toolprint/mcp-graphql-forge)** - ⭐ 15
   MCP that can proxy any GraphQL API and expose graphql operations as mcp tools.

3039. **[arxiv-mcp-server](https://github.com/anuj0456/arxiv-mcp-server)** - ⭐ 15
...
3040. **[mcp-tui](https://github.com/msabramo/mcp-tui)** - ⭐ 15
   MCP host app w/ textual user interface, in Python

3041. **[ebay-mcp](https://github.com/YosefHayim/ebay-mcp)** - ⭐ 15
...
3042. **[UCAI](https://github.com/nirholas/UCAI)** - ⭐ 15
...
3043. **[context-engineering](https://github.com/timothywarner-org/context-engineering)** - ⭐ 15
...
3044. **[systemprompt-mcp-core](https://github.com/Ejb503/systemprompt-mcp-core)** - ⭐ 14
   The core MCP extension for Systemprompt MCP multimodal client

3045. **[Open-MCP-Client](https://github.com/GongRzhe/Open-MCP-Client)** - ⭐ 14
...
3046. **[signal-mcp-client](https://github.com/piebro/signal-mcp-client)** - ⭐ 14
   An MCP client that uses signal for sending and receiving messages.

3047. **[vite-plugin-mcp-client-tools](https://github.com/atesgoral/vite-plugin-mcp-client-tools)** - ⭐ 14
   Pluggable Vite MCP plugin that brings client-side tools to your existing Vite setup

3048. **[llm-sse-mcp-demo-2025](https://github.com/nlinhvu/llm-sse-mcp-demo-2025)** - ⭐ 14
...
3049. **[mcp-bundler](https://github.com/wrtnlabs/mcp-bundler)** - ⭐ 14
   Is the MCP configuration too complicated? You can easily share your own simplified setup!

3050. **[mcp-turso-cloud](https://github.com/spences10/mcp-turso-cloud)** - ⭐ 14
...
3051. **[ntfy-mcp-server](https://github.com/cyanheads/ntfy-mcp-server)** - ⭐ 14
   An MCP (Model Context Protocol) server designed to interact with the ntfy push notification service. It enables LLMs and AI agents to send notifications to your devices with extensive customization options.

3052. **[gh-mcp](https://github.com/shuymn/gh-mcp)** - ⭐ 14
...
3053. **[the-academy](https://github.com/im-knots/the-academy)** - ⭐ 14
   A Socratic dialogue engine for AI agents. 

3054. **[mcpterm](https://github.com/dwrtz/mcpterm)** - ⭐ 14
   An MCP tool server that provides stateful, TUI-compatible terminal sessions.

3055. **[work-memory-mcp](https://github.com/moontmsai/work-memory-mcp)** - ⭐ 14
   Never lose context again - persistent memory management system for AI-powered workflows across multiple tools

3056. **[hoot](https://github.com/Portkey-AI/hoot)** - ⭐ 14
   MCP Testing Tool — Like Postman, but for the Model Context Protocol.

3057. **[Blender-MCP-Server](https://github.com/poly-mcp/Blender-MCP-Server)** - ⭐ 14
...
3058. **[Frontapp-MCP](https://github.com/zqushair/Frontapp-MCP)** - ⭐ 14
   MCP server and client for Frontapp

3059. **[uk-case-law-mcp-server](https://github.com/georgejeffers/uk-case-law-mcp-server)** - ⭐ 14
   MCP server for UK case law using The National Archives API. Enables LLMs to search, retrieve, and cite UK legal judgments.

3060. **[mcp-server-templates](https://github.com/Data-Everything/mcp-server-templates)** - ⭐ 14
   A flexible platform that provides Docker & Kubernetes backends, a lightweight CLI (mcpt), and client utilities for seamless MCP integration. Spin up servers from templates, route requests through a single endpoint with load balancing, and support both deployed (HTTP) and local (stdio) transports — all with sensible defaults and YAML-based configs.

3061. **[chatgpt-app-typescript-template](https://github.com/pomerium/chatgpt-app-typescript-template)** - ⭐ 14
...
3062. **[mcp-ipfs](https://github.com/alexbakers/mcp-ipfs)** - ⭐ 14
   🪐 MCP IPFS Server 

3063. **[mcp-client-for-weather-example](https://github.com/a-persimmons/mcp-client-for-weather-example)** - ⭐ 14
   一个MCP客户端实践：实现LLM调用天气MCP服务端查询天气的快速示例

3064. **[deep-research](https://github.com/troyhantech/deep-research)** - ⭐ 14
   A minimalist deep research framework for any OpenAI API compatible LLMs. 

3065. **[hive-crypto-mcp](https://github.com/hive-intel/hive-crypto-mcp)** - ⭐ 14
...
3066. **[spring-ai-mcp-deepseek](https://github.com/firefly0512/spring-ai-mcp-deepseek)** - ⭐ 13
   使用 Spring AI 整合 MCP 服务，包括 MCP server 和 deepseek client

3067. **[llamacppMCPClientDemo](https://github.com/brucepro/llamacppMCPClientDemo)** - ⭐ 13
   standalone react MCP client using SSE

3068. **[sample-multi-tenant-saas-mcp-server](https://github.com/aws-samples/sample-multi-tenant-saas-mcp-server)** - ⭐ 13
   Multi-Tenant remote MCP server with Amazon Cognito and remote client with Amazon Bedrock hosted on AWS

3069. **[mcp-chat-client](https://github.com/Ceeon/mcp-chat-client)** - ⭐ 13
   基于高德地图MCP服务的聊天客户端

3070. **[mcp-client-compatibility](https://github.com/tadata-org/mcp-client-compatibility)** - ⭐ 13

3071. **[mcp-client-laravel](https://github.com/RedberryProducts/mcp-client-laravel)** - ⭐ 13
...
3072. **[mcp-web-client](https://github.com/hemanth/mcp-web-client)** - ⭐ 13
   A web-based client for connecting to MCP servers with OAuth support

3073. **[mcp-perplexity-server](https://github.com/PoliTwit1984/mcp-perplexity-server)** - ⭐ 13
...
3074. **[mcp-more](https://github.com/toosean/mcp-more)** - ⭐ 13
   A modern desktop application for managing Model Context Protocol (MCP) servers.

3075. **[MCP-Manager-GUI](https://github.com/gabrielbacha/MCP-Manager-GUI)** - ⭐ 13
   MCP Toggle is a simple GUI tool to help you manage MCP servers across clients seamlessly.

3076. **[easy-mcp-use](https://github.com/dforel/easy-mcp-use)** - ⭐ 13
...
3077. **[mcphawk](https://github.com/tech4242/mcphawk)** - ⭐ 13
...
3078. **[mcp-test-client](https://github.com/crazyrabbitLTC/mcp-test-client)** - ⭐ 13
   MCP Test Client is a TypeScript testing utility for Model Context Protocol (MCP) servers.

3079. **[mcp-config-editor](https://github.com/kaichen/mcp-config-editor)** - ⭐ 13
   A simple GUI for managing MCP servers, for easy toggle mcp servers.

3080. **[deep-directory-tree-mcp](https://github.com/andredezzy/deep-directory-tree-mcp)** - ⭐ 13
...
3081. **[mongo-mcp](https://github.com/1RB/mongo-mcp)** - ⭐ 13
   MCP server that provide tools to LLMs such as claude in cursor to interact with MongoDB

3082. **[mcp-server-subagent](https://github.com/dvcrn/mcp-server-subagent)** - ⭐ 13
   MCP for letting agents delegate tasks to sub-agents (Claude Code, Aider, Q)

3083. **[django-mcp](https://github.com/hyperb1iss/django-mcp)** - ⭐ 13
...
3084. **[memory-mcp-server](https://github.com/hpkv-io/memory-mcp-server)** - ⭐ 13
   A MCP (Model Context Protocol) server providing long-term memory for LLMs

3085. **[mcp-web-search-tool](https://github.com/gabrimatic/mcp-web-search-tool)** - ⭐ 13
   A MCP server providing real-time web search capabilities to any AI model.

3086. **[jadx-mcp-server](https://github.com/Qtty/jadx-mcp-server)** - ⭐ 13
   A Pure-Java MCP Server for JaDX Android Reverse Engineering Tool

3087. **[IoT-Edge-MCP-Server](https://github.com/poly-mcp/IoT-Edge-MCP-Server)** - ⭐ 13
...
3088. **[mcp-jest](https://github.com/josharsh/mcp-jest)** - ⭐ 13
   Automated testing for Model Context Protocol servers. Ship MCP Servers with confidence.

3089. **[mcpdog](https://github.com/kinhunt/mcpdog)** - ⭐ 13
...
3090. **[MCP-Platform](https://github.com/Data-Everything/MCP-Platform)** - ⭐ 13
   A flexible platform that provides Docker & Kubernetes backends, a lightweight CLI (mcpt), and client utilities for seamless MCP integration. Spin up servers from templates, route requests through a single endpoint with load balancing, and support both deployed (HTTP) and local (stdio) transports — all with sensible defaults and YAML-based configs

3091. **[mcp-client-langchain-ts](https://github.com/hideya/mcp-client-langchain-ts)** - ⭐ 13
   Simple MCP Client CLI Implementation Using LangChain ReAct Agent / TypeScript

3092. **[mcp-obsidian](https://github.com/Piotr1215/mcp-obsidian)** - ⭐ 13
   simple mcp server for interacting with local obsidian notes

3093. **[mcp-server-gemini-pro](https://github.com/gurveeer/mcp-server-gemini-pro)** - ⭐ 13
...
3094. **[skill-to-mcp](https://github.com/biocontext-ai/skill-to-mcp)** - ⭐ 13
   Convert AI Skills (Claude Skills format) to MCP server resources - Part of BioContextAI

3095. **[hass-mcp-server](https://github.com/ganhammar/hass-mcp-server)** - ⭐ 13
...
3096. **[local-skills-mcp](https://github.com/kdpa-llc/local-skills-mcp)** - ⭐ 13
   Universal MCP server enabling any LLM or AI agent to utilize expert skills from your local filesystem. Reduces context consumption through lazy loading. Works with Claude, Cline, and any MCP-compatible client.

3097. **[cursor-feedback-extension](https://github.com/jianger666/cursor-feedback-extension)** - ⭐ 13
   Save your Cursor monthly quota! Unlimited AI interactions in one conversation via MCP feedback loop.

3098. **[llama-nexus](https://github.com/LlamaEdge/llama-nexus)** - ⭐ 12
   A gateway service designed to manage and orchestrate OpenAI-compatible API servers with MCP support.

3099. **[st_rag_mcp](https://github.com/digital-duck/st_rag_mcp)** - ⭐ 12
   MCP streamlit client with RAG support for tool search

3100. **[n8n-coolify-mcp-tools](https://github.com/wrediam/n8n-coolify-mcp-tools)** - ⭐ 12
...
3101. **[mcp-server-manager](https://github.com/infinitimeless/mcp-server-manager)** - ⭐ 12
   A tool to create, build, and manage MCP servers for use with Claude and other MCP clients

3102. **[MCP-Client-Server-for-agents](https://github.com/qmatteoq/MCP-Client-Server-for-agents)** - ⭐ 12
   This project demonstrates a Model Context Protocol (MCP) server and client implementation in .NET

3103. **[capture-mcp-server](https://github.com/blencorp/capture-mcp-server)** - ⭐ 12
...
3104. **[mcp-safe-run](https://github.com/ithena-one/mcp-safe-run)** - ⭐ 12
...
3105. **[xcf](https://github.com/CodeFreezeAI/xcf)** - ⭐ 12
   Xcode MCP Server xcf is a 100% Swift based allowing you to integrate Xcode with your favorite AI IDE or MCP Client

3106. **[CursorMCPMonitor](https://github.com/willibrandon/CursorMCPMonitor)** - ⭐ 12
...
3107. **[SchemaPin](https://github.com/ThirdKeyAI/SchemaPin)** - ⭐ 12
   The SchemaPin protocol for cryptographically signing and verifying AI agent tool schemas to prevent supply-chain attacks.

3108. **[Tinvo](https://github.com/imxcstar/Tinvo)** - ⭐ 12
   LLM AI Client based on Blazor. (openai, chatgpt, llama, ollama, onnx, deepseekr1...)

3109. **[signoz-mcp-server](https://github.com/DrDroidLab/signoz-mcp-server)** - ⭐ 12
   Connect your Signoz Instance with Cursor, Claude Desktop or any other MCP Compatible Client

3110. **[gemma-mcp](https://github.com/monatis/gemma-mcp)** - ⭐ 12
   MCP Client for Gemma-3

3111. **[context-kit](https://github.com/eyalzh/context-kit)** - ⭐ 12
   A CLI tool and MCP client, used to create spec files for AI coding agents with context baked in

3112. **[codepilot](https://github.com/rohittcodes/codepilot)** - ⭐ 12
   A multi-agent CLI tool powered by Swarms-rs and Composio

3113. **[mlb-mcp](https://github.com/etweisberg/mlb-mcp)** - ⭐ 12
   MCP server for advanced baseball analytics (statcast, fangraphs, baseball reference, mlb stats API) with client demo 

3114. **[muster](https://github.com/giantswarm/muster)** - ⭐ 12
   MCP tool management and workflow proxy

3115. **[Convert-Markdown-PDF-MCP](https://github.com/seanivore/Convert-Markdown-PDF-MCP)** - ⭐ 12
   Markdown To PDF Conversion MCP

3116. **[vmware-esxi-mcp](https://github.com/uldyssian-sh/vmware-esxi-mcp)** - ⭐ 12
...
3117. **[owl-mcp](https://github.com/ai4curation/owl-mcp)** - ⭐ 12
   MCP server for OWL applications

3118. **[openwebui-mcp-setup](https://github.com/sonzentherevolution/openwebui-mcp-setup)** - ⭐ 12
...
3119. **[porkbun-mcp-server](https://github.com/miraclebakelaser/porkbun-mcp-server)** - ⭐ 12
   MCP server implementation for managing domains, DNS, and SSL via the Porkbun API.

3120. **[mcp-meme-sticky](https://github.com/nkapila6/mcp-meme-sticky)** - ⭐ 12
...
3121. **[proxy-base-agent](https://github.com/TheProxyCompany/proxy-base-agent)** - ⭐ 12
   A stateful agent with 100% reliable tool use. Build custom agents on any LLM with guaranteed state consistency.

3122. **[automagik-tools](https://github.com/namastexlabs/automagik-tools)** - ⭐ 12
   From API to AI in 30 Seconds - Transform any API into an intelligent MCP agent that learns, adapts, and speaks human

3123. **[prompt-engineer-mcp-server](https://github.com/hireshBrem/prompt-engineer-mcp-server)** - ⭐ 12
   Write 10x better prompts using Prompt Engineer MCP server.

3124. **[create-mcp-server-kit](https://github.com/Epi-1120/create-mcp-server-kit)** - ⭐ 12
   Scaffold a production-ready Model Context Protocol (MCP) server in seconds.

3125. **[memory-visualizer](https://github.com/mjherich/memory-visualizer)** - ⭐ 12
...
3126. **[MIST](https://github.com/CLoaKY233/MIST)** - ⭐ 12
...
3127. **[mcp-salesforce](https://github.com/AiondaDotCom/mcp-salesforce)** - ⭐ 12
...
3128. **[llms-txt-generator](https://github.com/aircodelabs/llms-txt-generator)** - ⭐ 12
   The ultimate AI-powered generator for llms.txt and llms-full.txt files. 

3129. **[mcp-windows-automation](https://github.com/mukul975/mcp-windows-automation)** - ⭐ 12
...
3130. **[ckan-mcp-server](https://github.com/ondics/ckan-mcp-server)** - ⭐ 12
...
3131. **[claude_autoapprove](https://github.com/PyneSys/claude_autoapprove)** - ⭐ 12
   Autoapprove support for claude

3132. **[mcp-spotify-player](https://github.com/vsaez/mcp-spotify-player)** - ⭐ 12
   MCP server to manage Spotify from MCP clients

3133. **[gsd-task-manager](https://github.com/vscarpenter/gsd-task-manager)** - ⭐ 12
...
3134. **[vector_mcp](https://github.com/sergiobayona/vector_mcp)** - ⭐ 12
   A server implementation for the Model Context Protocol (MCP) in Ruby.

3135. **[local-mcp-gateway](https://github.com/DXHeroes/local-mcp-gateway)** - ⭐ 12
   Aggregate multiple MCP servers into a single endpoint with web UI, OAuth 2.1, and profile-based tool management

3136. **[ia-na-pratica](https://github.com/Code4Delphi/ia-na-pratica)** - ⭐ 12
   IA na Prática: LLM, RAG, MCP, Agents, Function Calling, Multimodal, TTS/STT e mais

3137. **[predictive-maintenance-mcp](https://github.com/LGDiMaggio/predictive-maintenance-mcp)** - ⭐ 12
...
3141. **[leanmcp-sdk](https://github.com/LeanMCP/leanmcp-sdk)** - ⭐ 12
...
3142. **[universal-crypto-mcp](https://github.com/nirholas/universal-crypto-mcp)** - ⭐ 12
...
3143. **[teamcity-mcp](https://github.com/Daghis/teamcity-mcp)** - ⭐ 12
...
3144. **[mcp_client_rust](https://github.com/darinkishore/mcp_client_rust)** - ⭐ 11

3145. **[mcp-client](https://github.com/EuclideanAI/mcp-client)** - ⭐ 11
...
3146. **[MCP_Client](https://github.com/andrewdeng318/MCP_Client)** - ⭐ 11

3147. **[trebuchet](https://github.com/fuzzball-muck/trebuchet)** - ⭐ 11
   A MUD/MUCK/MUSH chat client with MCP/GUI support.

3148. **[mcp-wikipedia](https://github.com/algonacci/mcp-wikipedia)** - ⭐ 11
   MCP server to give client the ability to access Wikipedia pages

3149. **[systemprompt-mcp-gmail](https://github.com/Ejb503/systemprompt-mcp-gmail)** - ⭐ 11
...
3150. **[mcp-client-app](https://github.com/RegiByte/mcp-client-app)** - ⭐ 11
   A mcp client chat application built for learning purposes

3151. **[mcp-browser-automation](https://github.com/hrmeetsingh/mcp-browser-automation)** - ⭐ 11
   Model Context Protocol based AI Agent that runs a browser from Claude desktop

3152. **[simple-nodejs-mcp-client](https://github.com/sawa-zen/simple-nodejs-mcp-client)** - ⭐ 11
...
3153. **[ggMCP4VSCode](https://github.com/n2ns/ggMCP4VSCode)** - ⭐ 11
   Google Gemini Model Context Protocol (MCP) Client for VS Code. Connect AI assistants to local context & tools.

3154. **[goldrush-mcp-server](https://github.com/covalenthq/goldrush-mcp-server)** - ⭐ 11
...
3155. **[langchain-mcp-tools-ts-usage](https://github.com/hideya/langchain-mcp-tools-ts-usage)** - ⭐ 11
   MCP Tools Usage From LangChain ReAct Agent / Example in TypeScript

3156. **[mcp-chat-widget](https://github.com/aimdoc-ai/mcp-chat-widget)** - ⭐ 11
...
3157. **[oauth-callback](https://github.com/kriasoft/oauth-callback)** - ⭐ 11
   Lightweight OAuth 2.0 authorization code capture for CLI tools & desktop   apps. Works with Node.js, Deno, Bun. MCP SDK ready.

3158. **[semantictool](https://github.com/promptmesh/semantictool)** - ⭐ 11
   tool management service for performing vector tool calling at scale.

3159. **[davinci-mcp-professional](https://github.com/Positronikal/davinci-mcp-professional)** - ⭐ 11
...
3160. **[mcpconnect](https://github.com/rocket-connect/mcpconnect)** - ⭐ 11
   Inspect and debug Model Context Protocol servers directly in your browser.

3161. **[smartlead-mcp-server](https://github.com/LeadMagic/smartlead-mcp-server)** - ⭐ 11
...
3162. **[osmmcp](https://github.com/NERVsystems/osmmcp)** - ⭐ 11
...
3163. **[locust-mcp-server](https://github.com/QAInsights/locust-mcp-server)** - ⭐ 11
   A Model Context Protocol (MCP) server implementation for running Locust load tests. This server enables seamless integration of Locust load testing capabilities with AI-powered development environments.

3164. **[scorable-mcp](https://github.com/root-signals/scorable-mcp)** - ⭐ 11
   MCP for Scorable Evaluation Platform

3165. **[pentest-mcp-server](https://github.com/LayeSec006/pentest-mcp-server)** - ⭐ 11
   MCP server for penetration testing

3166. **[mcp-boilerplate](https://github.com/iamsrikanthnani/mcp-boilerplate)** - ⭐ 11
...
3167. **[emcp](https://github.com/joeymeere/emcp)** - ⭐ 11
   A framework for building simple MCP servers with custom middleware

3168. **[local-history-mcp](https://github.com/xxczaki/local-history-mcp)** - ⭐ 11
   MCP server for accessing VS Code/Cursor's Local History

3169. **[mcp-delphi](https://github.com/flydev-fr/mcp-delphi)** - ⭐ 11
   Delphi and Lazarus/FPC MCP server: build/clean pascal projects via MCP tools.

3170. **[puppeteer-mcp-server](https://github.com/sultannaufal/puppeteer-mcp-server)** - ⭐ 11
...
3171. **[claude-context-local](https://github.com/MikeO-AI/claude-context-local)** - ⭐ 11
...
3172. **[temple-bridge](https://github.com/templetwo/temple-bridge)** - ⭐ 11
...
3173. **[programmatic-tool-calling-ai-sdk](https://github.com/cameronking4/programmatic-tool-calling-ai-sdk)** - ⭐ 11
...
3174. **[_b00t_](https://github.com/elasticdotventures/_b00t_)** - ⭐ 11
   🥾 _b00t_:  brians dotfiles aka state of the art agentic tooling & context initialization

3175. **[langchain-mcp-client](https://github.com/datalayer/langchain-mcp-client)** - ⭐ 10
   🦜🔗 LangChain Model Context Protocol (MCP) Client

3176. **[mcp-client-langchain-py](https://github.com/hideya/mcp-client-langchain-py)** - ⭐ 10
   Simple MCP Client CLI Implementation Using LangChain ReAct Agent / Python

3177. **[openalgo-mcp](https://github.com/marketcalls/openalgo-mcp)** - ⭐ 10
   Documentation

3178. **[mcp_client_openai](https://github.com/liangpn/mcp_client_openai)** - ⭐ 10
   适配Openai SDK构建MCP Client

3179. **[mcp-serverman](https://github.com/benhaotang/mcp-serverman)** - ⭐ 10
   a cli/mcp server tool for managing mcp server json config file with version control, profiles and multi-client support

3180. **[py-mcp-sse](https://github.com/jayliangdl/py-mcp-sse)** - ⭐ 10
   MCP Client 与 MCP Server基于SSE方式的样例实现（Python版本）

3181. **[mcpkit](https://github.com/cybertheory/mcpkit)** - ⭐ 10
   Easy to use Official MCP Registry Client UI. npx @cybertheory/mcpkit

3182. **[AIFoundry-MCPConnector-FabricGraphQL](https://github.com/LazaUK/AIFoundry-MCPConnector-FabricGraphQL)** - ⭐ 10
...
3183. **[server](https://github.com/mcpfinder/server)** - ⭐ 10
...
3184. **[kanboard-mcp](https://github.com/ChristianJStarr/kanboard-mcp)** - ⭐ 10
...
3185. **[emotion_ai](https://github.com/angrysky56/emotion_ai)** - ⭐ 10
...
3186. **[mcp-express-adapter](https://github.com/Moe03/mcp-express-adapter)** - ⭐ 10
   Run multiple MCP clients on a NodeJS Express server (adapter/middleware)

3187. **[mcp-trace](https://github.com/zabirauf/mcp-trace)** - ⭐ 10
   A TUI to probe the calls between MCP client and server

3188. **[mcp-server-blog](https://github.com/portal-labs-infrastructure/mcp-server-blog)** - ⭐ 10
   Example of a MCP implementation using TypeScript and OAuth.

3189. **[unity-mcp-template](https://github.com/dunward/unity-mcp-template)** - ⭐ 10
   Simple template project for controlling Unity via MCP

3190. **[awesome-mcp-hardware](https://github.com/beriberikix/awesome-mcp-hardware)** - ⭐ 10
   Awesome list of MCP servers for interacting with hardware and the physical world.

3191. **[polaris](https://github.com/octu0/polaris)** - ⭐ 10
   Distributed AI Agent Framework

3192. **[mcp-agent-proxy](https://github.com/mashh-lab/mcp-agent-proxy)** - ⭐ 10
   An MCP server that exposes local and remote agents across different servers as MCP tools.

3193. **[amazon-seller-mcp](https://github.com/enginterzi/amazon-seller-mcp)** - ⭐ 10
...
3194. **[auto-mcp-client](https://github.com/down-to-earth1994/auto-mcp-client)** - ⭐ 10
...
3195. **[mcp-add](https://github.com/paoloricciuti/mcp-add)** - ⭐ 10
   Universal cli to add an MCP server to a variety of clients

3196. **[mcp-kit](https://github.com/shaharia-lab/mcp-kit)** - ⭐ 10
   MCP (Model Context Protocol) Kit for Go - A Complete MCP solutions for ready to use

3197. **[CodeCompass](https://github.com/alvinveroy/CodeCompass)** - ⭐ 10
...
3198. **[french-tax-mcp](https://github.com/cornelcroi/french-tax-mcp)** - ⭐ 10
   MCP server for French tax calculations and information - enables AI assistants to provide accurate French tax guidance

3199. **[springboot-ai-mcp-example](https://github.com/duongminhhieu/springboot-ai-mcp-example)** - ⭐ 10
   Example Spring AI Model Context Protocol (MCP)

3200. **[mcp-space](https://github.com/tharuneshwar-s/mcp-space)** - ⭐ 10
...
3201. **[mode-manager-mcp](https://github.com/NiclasOlofsson/mode-manager-mcp)** - ⭐ 10
   MCP Memory Agent Server - A VS Code chatmode and instruction manager with library integration

3202. **[mcp-reporter](https://github.com/cyanheads/mcp-reporter)** - ⭐ 10
...
3203. **[mcp-starter-template-ts](https://github.com/onamfc/mcp-starter-template-ts)** - ⭐ 10
...
3204. **[prometheus-protocol](https://github.com/prometheus-protocol/prometheus-protocol)** - ⭐ 10
...
3205. **[rec-us-mcp-server](https://github.com/elizabethsiegle/rec-us-mcp-server)** - ⭐ 10
   Book a San Francisco tennis court via MCP server w/ auth

3206. **[mcp-demo](https://github.com/sshh12/mcp-demo)** - ⭐ 10
...
3207. **[AgentX-mcp-servers](https://github.com/AgentX-ai/AgentX-mcp-servers)** - ⭐ 10
   List of open sourced MCP servers. MIT license. Managed by AgentX with love.

3208. **[mcp-tradovate](https://github.com/0xjmp/mcp-tradovate)** - ⭐ 10
   MCP server for the Tradovate platform

3209. **[mcp-claude-hackernews](https://github.com/imprvhub/mcp-claude-hackernews)** - ⭐ 10
   An integration that allows Claude Desktop to interact with Hacker News using the Model Context Protocol (MCP).

3210. **[glasses-mcp](https://github.com/gourraguis/glasses-mcp)** - ⭐ 10
   Glasses MCP is a simple MCP server that lets your AI agent see and capture the web 👓

3211. **[ObsidianMCPServer](https://github.com/otaviocc/ObsidianMCPServer)** - ⭐ 10
   A Model Context Protocol (MCP) server that enables AI assistants to interact with your Obsidian vault 

3212. **[mcp-sys-bridge](https://github.com/leynier/mcp-sys-bridge)** - ⭐ 10
...
3213. **[sec-edgar-agentkit](https://github.com/stefanoamorelli/sec-edgar-agentkit)** - ⭐ 10
...
3214. **[druid-mcp-server](https://github.com/iunera/druid-mcp-server)** - ⭐ 10
...
3215. **[companies-house-mcp](https://github.com/stefanoamorelli/companies-house-mcp)** - ⭐ 10
...
3216. **[context-engineering-mcp](https://github.com/bralca/context-engineering-mcp)** - ⭐ 10
...
3217. **[nautobot_mcp](https://github.com/kvncampos/nautobot_mcp)** - ⭐ 10
   Nautobot Model Context Protocol (MCP) Server - Contains STDIO and HTTP Deployments with Embedding Search and RAG.

3218. **[AgentStack](https://github.com/ssdeanx/AgentStack)** - ⭐ 10
...
3219. **[mcp-client-gen](https://github.com/kriasoft/mcp-client-gen)** - ⭐ 10
   Turn any MCP server into a type-safe TypeScript SDK in seconds - with    OAuth 2.1 and multi-provider support

3220. **[mcp-sqlite-server](https://github.com/prayanks/mcp-sqlite-server)** - ⭐ 10
...
3221. **[mcp_documents_reader](https://github.com/xt765/mcp_documents_reader)** - ⭐ 10
...
3222. **[dx-toolkit](https://github.com/youdotcom-oss/dx-toolkit)** - ⭐ 10
   Open-source toolkit enabling developers to integrate You.com's AI capabilities into their workflows

3223. **[ChatSpatial](https://github.com/cafferychen777/ChatSpatial)** - ⭐ 10
...
1. **[chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat)** - ⭐ 40,885
   基于大模型搭建的聊天机器人，同时支持 微信公众号、企业微信应用、飞书、钉钉 等接入，可选择ChatGPT/Claude/DeepSeek/文心一言/讯飞星火/通义千问/ Gemini/GLM-4/Kimi/LinkAI，能处理文本、语音和图片，访问操作系统和互联网，支持基于自有知识库进行定制企业智能客服。

2. **[bytebot](https://github.com/bytebot-ai/bytebot)** - ⭐ 10,321
   Bytebot is a self-hosted AI desktop agent that automates computer tasks through natural language commands, operating within a containerized Linux desktop environment.

3. **[valuecell](https://github.com/ValueCell-ai/valuecell)** - ⭐ 8,755
   ValueCell is a community-driven, multi-agent platform for financial applications.

4. **[deepchat](https://github.com/ThinkInAIXYZ/deepchat)** - ⭐ 5,464
   🐬DeepChat - A smart assistant that connects powerful AI to your personal world

5. **[ruoyi-ai](https://github.com/ageerle/ruoyi-ai)** - ⭐ 4,740
   RuoYi AI 是一个全栈式 AI 开发平台，旨在帮助开发者快速构建和部署个性化的 AI 应用。

6. **[koog](https://github.com/JetBrains/koog)** - ⭐ 3,677
...
9. **[supermemory-mcp](https://github.com/supermemoryai/supermemory-mcp)** - ⭐ 1,600
   Your memories are in ChatGPT... But nowhere else. Universal Memory MCP makes your memories available to every single LLM. No logins or paywall. One command to set it up.

10. **[openinference](https://github.com/Arize-ai/openinference)** - ⭐ 844
   OpenTelemetry Instrumentation for AI Observability

11. **[VectorCode](https://github.com/Davidyz/VectorCode)** - ⭐ 785
...
18. **[self-dify](https://github.com/datawhalechina/self-dify)** - ⭐ 319
...
19. **[mcp-toolbox-sdk-python](https://github.com/googleapis/mcp-toolbox-sdk-python)** - ⭐ 156
...
21. **[terminal-ai](https://github.com/dwmkerr/terminal-ai)** - ⭐ 149
...
22. **[ai](https://github.com/WordPress/ai)** - ⭐ 116
   Demonstrate and deliver AI features by combining all AI Building Blocks into a unified WordPress experience.

23. **[airbyte-agent-connectors](https://github.com/airbytehq/airbyte-agent-connectors)** - ⭐ 102
...
26. **[hm_editor](https://github.com/huimeicloud/hm_editor)** - ⭐ 74
...
33. **[flowllm](https://github.com/FlowLLM-AI/flowllm)** - ⭐ 30
...
40. **[luma-api-mcp](https://github.com/lumalabs/luma-api-mcp)** - ⭐ 20
...
42. **[fast-mcp-client](https://github.com/aswincandra/fast-mcp-client)** - ⭐ 11
   MCP Client Implemented to FastAPI

43. **[novelcrafter-mcp](https://github.com/deadshot465/novelcrafter-mcp)** - ⭐ 10
   An experimental desktop client for using Claude Desktop's MCP with Novelcrafter codices.

44. **[chatbot-spring-ai-mcp-telegram-client](https://github.com/mohamedYoussfi/chatbot-spring-ai-mcp-telegram-client)** - ⭐ 10

### Tools & Libraries

*Development tools and libraries for working with MCP*

1. **[n8n](https://github.com/n8n-io/n8n)** - ⭐ 172,228
   Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.

2. **[kong](https://github.com/Kong/kong)** - ⭐ 42,638
   🦍 The API and AI Gateway

3. **[FastGPT](https://github.com/labring/FastGPT)** - ⭐ 27,042
   FastGPT is a knowledge-based platform built on the LLMs, offers a comprehensive suite of out-of-the-box capabilities such as data processing, RAG retrieval, and visual AI workflow orchestration, letting you easily develop and deploy complex question-answering systems without the need for extensive setup or configuration.

4. **[kratos](https://github.com/go-kratos/kratos)** - ⭐ 25,405
   Your ultimate Go microservices framework for the cloud-native era.

5. **[excelize](https://github.com/qax-os/excelize)** - ⭐ 20,251
   Go language library for reading and writing Microsoft Excel™ (XLAM / XLSM / XLSX / XLTM / XLTX) spreadsheets

6. **[plate](https://github.com/udecode/plate)** - ⭐ 15,858
   Rich-text editor with AI, MCP, and shadcn/ui

7. **[AstrBot](https://github.com/AstrBotDevs/AstrBot)** - ⭐ 15,397
...
10. **[ui](https://github.com/creativetimofficial/ui)** - ⭐ 11,485
   Open-source components, blocks, and AI agents designed to speed up your workflow. Import them seamlessly into your favorite tools through Registry and MCPs.

11. **[note-gen](https://github.com/codexu/note-gen)** - ⭐ 10,668
   A cross-platform Markdown AI note-taking software.

12. **[langchain4j](https://github.com/langchain4j/langchain4j)** - ⭐ 10,584
   LangChain4j is an open-source Java library that simplifies the integration of LLMs into Java applications through a unified API, providing access to popular LLMs and vector databases. It makes implementing RAG, tool calling (including support for MCP), and agents easy. LangChain4j integrates seamlessly with various enterprise Java frameworks.

13. **[astron-agent](https://github.com/iflytek/astron-agent)** - ⭐ 9,081
   Enterprise-grade, commercial-friendly agentic workflow platform for building next-generation SuperAgents.

14. **[OpenMetadata](https://github.com/open-metadata/OpenMetadata)** - ⭐ 8,555
   OpenMetadata is a unified metadata platform for data discovery, data observability, and data governance powered by a central metadata repository, in-depth column level lineage, and seamless team collaboration.

15. **[53AIHub](https://github.com/53AI/53AIHub)** - ⭐ 8,045
...
17. **[lamda](https://github.com/firerpa/lamda)** - ⭐ 7,587
    The most powerful Android RPA agent framework, next generation of mobile automation robots.

18. **[adk-go](https://github.com/google/adk-go)** - ⭐ 6,798
   An open-source, code-first Go toolkit for building, evaluating, and deploying sophisticated AI agents with flexibility and control.

19. **[Viper](https://github.com/FunnyWolf/Viper)** - ⭐ 4,935
...
22. **[Yuxi-Know](https://github.com/xerrors/Yuxi-Know)** - ⭐ 4,144
...
24. **[ag2](https://github.com/ag2ai/ag2)** - ⭐ 4,094
   AG2 (formerly AutoGen): The Open-Source AgentOS. Join us at: https://discord.gg/sNGSwQME3x

25. **[kubefwd](https://github.com/txn2/kubefwd)** - ⭐ 4,029
   Bulk port forwarding Kubernetes services for local development.

26. **[manifest](https://github.com/mnfst/manifest)** - ⭐ 3,295
   A shadcn/ui library for building ChatGPT Apps

27. **[semantic-router](https://github.com/vllm-project/semantic-router)** - ⭐ 3,064
...
29. **[ultracite](https://github.com/haydenbleasel/ultracite)** - ⭐ 2,640
   A highly opinionated, zero-configuration linter and formatter.

30. **[harbor](https://github.com/av/harbor)** - ⭐ 2,393
   One command brings a complete pre-wired LLM stack with hundreds of services to explore.

31. **[easy-vibe](https://github.com/datawhalechina/easy-vibe)** - ⭐ 2,164
...
36. **[d2mcpp](https://github.com/mcpp-community/d2mcpp)** - ⭐ 1,435
   D2X | Modern C++ Core Language Features - "A C++ tutorial project focused on practical"

37. **[mcpelauncher-manifest](https://github.com/minecraft-linux/mcpelauncher-manifest)** - ⭐ 1,432
   The main repository for the Linux and Mac OS Bedrock edition Minecraft launcher.

38. **[mcpp-standard](https://github.com/Sunrisepeak/mcpp-standard)** - ⭐ 1,372
   D2X | Modern C++ Core Language Features - "A C++ tutorial project focused on practical"

39. **[NagaAgent](https://github.com/Xxiii8322766509/NagaAgent)** - ⭐ 1,320
   A simple yet powerful agent framework for personal assistants, designed to enable intelligent interaction, multi-agent collaboration, and seamless tool integration.

40. **[paperdebugger](https://github.com/PaperDebugger/paperdebugger)** - ⭐ 1,308
   A Plugin-Based Multi-Agent System for In-Editor Academic Writing, Review, and Editing

41. **[awesome-hacking-lists](https://github.com/taielab/awesome-hacking-lists)** - ⭐ 1,277
...
43. **[langchain4j-aideepin](https://github.com/moyangzhan/langchain4j-aideepin)** - ⭐ 1,144
   基于AI的工作效率提升工具（聊天、绘画、知识库、工作流、 MCP服务市场、语音输入输出、长期记忆） | Ai-based productivity tools (Chat,Draw,RAG,Workflow,MCP marketplace, ASR,TTS, Long-term memory etc)

44. **[any-agent](https://github.com/mozilla-ai/any-agent)** - ⭐ 1,089
   A single interface to use and evaluate different agent frameworks 

45. **[Gearboy](https://github.com/drhelius/Gearboy)** - ⭐ 1,077
...
48. **[open-trading-api](https://github.com/koreainvestment/open-trading-api)** - ⭐ 993
...
51. **[chunkhound](https://github.com/chunkhound/chunkhound)** - ⭐ 945
...
54. **[aderyn](https://github.com/Cyfrin/aderyn)** - ⭐ 710
   Solidity Static Analyzer that easily integrates into your editor

55. **[bytechef](https://github.com/bytechefhq/bytechef)** - ⭐ 706
...
56. **[JiwuChat](https://github.com/KiWi233333/JiwuChat)** - ⭐ 695
   JiwuChat 🍂 : 轻量级跨平台IM聊天应用，集成AI机器人( DeepSeek/Gemini/Kimi... )、音视频通话及AI购物。支持多端消息同步，自定义主题，高效便捷  🍒

57. **[amical](https://github.com/amicalhq/amical)** - ⭐ 688
...
59. **[voicemode](https://github.com/mbailey/voicemode)** - ⭐ 654
...
63. **[IDA-NO-MCP](https://github.com/P4nda0s/IDA-NO-MCP)** - ⭐ 534
   Say goodbye to the complex, verbose, and laggy interaction mode of IDA Pro MCP

64. **[chatlog_alpha](https://github.com/teest114514/chatlog_alpha)** - ⭐ 526
...
66. **[LightAgent](https://github.com/wanxingai/LightAgent)** - ⭐ 491
...
68. **[ai-code-helper](https://github.com/liyupi/ai-code-helper)** - ⭐ 447
...
69. **[ios-simulator-skill](https://github.com/conorluddy/ios-simulator-skill)** - ⭐ 438
...
78. **[bridle](https://github.com/neiii/bridle)** - ⭐ 368
...
88. **[news-agents](https://github.com/eugeneyan/news-agents)** - ⭐ 310
   📰 Building News Agents to Summarize News with MCP, Q, and tmux

89. **[napi](https://github.com/nanoapi-io/napi)** - ⭐ 294
   Software architecture tooling for the AI age

90. **[awesome-slash](https://github.com/avifenesh/awesome-slash)** - ⭐ 286
   AI writes code. This automates everything else. 9 plugins · 39 agents · 23 skills · for Claude Code, OpenCode, Codex.

91. **[CookHero](https://github.com/Decade-qiu/CookHero)** - ⭐ 286
...
92. **[tool-ui](https://github.com/assistant-ui/tool-ui)** - ⭐ 284
...
98. **[MCPMappingViewer](https://github.com/bspkrs/MCPMappingViewer)** - ⭐ 244
   A small GUI for viewing the mappings from Minecraft obfuscated code names to MCP code names.

99. **[pydantic-deepagents](https://github.com/vstorm-co/pydantic-deepagents)** - ⭐ 244
...
117. **[bluebox-sdk](https://github.com/VectorlyApp/bluebox-sdk)** - ⭐ 166
   Reverse engineer web apps

118. **[codecompanion-history.nvim](https://github.com/ravitemer/codecompanion-history.nvim)** - ⭐ 162
   A history management extension for codecompanion AI chat plugin that enables saving, browsing and restoring chat sessions.

119. **[agentic-ai-systems](https://github.com/ThibautMelen/agentic-ai-systems)** - ⭐ 159
   🐔 Agentic systems explained with chickens. Workflows, agents & orchestration made simple. Mermaid diagrams included

120. **[ZenOps](https://github.com/opsre/ZenOps)** - ⭐ 145
...
122. **[mcp-toolkit](https://github.com/charIesding/mcp-toolkit)** - ⭐ 137
   utilities for mcp

123. **[toon-java](https://github.com/toon-format/toon-java)** - ⭐ 137
   ☕ Community-driven Java implementation of TOON

124. **[mcp-audit](https://github.com/apisec-inc/mcp-audit)** - ⭐ 131
   See what your AI agents can access. Scan MCP configs for exposed secrets, shadow APIs, and AI models. Generate AI-BOMs for compliance.

125. **[x-mcp](https://github.com/xpzouying/x-mcp)** - ⭐ 125
   小红书创作中心
...
149. **[Grapheteria](https://github.com/beubax/Grapheteria)** - ⭐ 59
...
151. **[houdini-mcp](https://github.com/capoom/houdini-mcp)** - ⭐ 48
   Houdini integration through the Model Context Protocol

152. **[chm-converter](https://github.com/DTDucas/chm-converter)** - ⭐ 48
   chm to markdown and vectorDB

153. **[mcp-java8-sdk](https://github.com/krrr/mcp-java8-sdk)** - ⭐ 46
   Backported Model Context Protocol SDK for Java 8

154. **[asya](https://github.com/deliveryhero/asya)** - ⭐ 39
   🎭 Actors on Kubernetes for scalable Gen AI

155. **[ummon](https://github.com/Nayshins/ummon)** - ⭐ 35
   The semantic layer for software engineering: Connect   code to meaning, build on understanding

156. **[xiaozhi-MCPTools](https://github.com/ZhongZiTongXue/xiaozhi-MCPTools)** - ⭐ 34
   一个图形化界面的小智MCP服务连接器，包含多种工具！ 自动部署服务，方便小白给小智Ai添加MCP工具

157. **[advanced-reason-mcp](https://github.com/Kuon-dev/advanced-reason-mcp)** - ⭐ 32
   Enhanced version of "Sequential Thinking" MCP

158. **[zentrun](https://github.com/andrewsky-labs/zentrun)** - ⭐ 31
   Prompt-driven automation platform - Transform natural language into executable workflows

159. **[prompt-pro](https://github.com/timothywarner-org/prompt-pro)** - ⭐ 31
...
160. **[Wireshark_mcp](https://github.com/jayimu/Wireshark_mcp)** - ⭐ 31
...
161. **[awesome-mcp-list](https://github.com/notedit/awesome-mcp-list)** - ⭐ 28
   Awesome Model Context Protocol Service List

162. **[adk-mcp-gemma3](https://github.com/arjunprabhulal/adk-mcp-gemma3)** - ⭐ 27
   Build AI Agent using Google ADK , MCP and Gemma 3 model

163. **[hands-on-ai-building-ai-agents-with-model-context-protocol-mcp-and-agent2agent-a2a-6055298](https://github.com/LinkedInLearning/hands-on-ai-building-ai-agents-with-model-context-protocol-mcp-and-agent2agent-a2a-6055298)** - ⭐ 25
...
164. **[codai](https://github.com/codai-agent/codai)** - ⭐ 24
...
165. **[cursor-like-pro](https://github.com/gifflet/cursor-like-pro)** - ⭐ 17
   Cursor IDE like Pro

166. **[MCPStack](https://github.com/MCP-Pipeline/MCPStack)** - ⭐ 16
   Stack & Orchestrate MCP Tools — The Scikit-Learn-Pipeline Way , For LLMs

167. **[n8n-operator](https://github.com/jakub-k-slys/n8n-operator)** - ⭐ 15
   Kubernetes Operator for N8n, a fair-code workflow automation platform with native AI capabilities.

168. **[ai-tools](https://github.com/elsejj/ai-tools)** - ⭐ 13
   ai-tools  call your llm based tools through shortcut (ctrl-q) in any application

169. **[feather_wand_agent](https://github.com/QAInsights/feather_wand_agent)** - ⭐ 13
...
170. **[mcp-tools](https://github.com/shaharia-lab/mcp-tools)** - ⭐ 11
   Tools for MCP (Model Context Protocol) written in Go

171. **[Unity-AI-Tools-Template](https://github.com/IvanMurzak/Unity-AI-Tools-Template)** - ⭐ 10
   Unity MCP Tool template project

172. **[ai-agents](https://github.com/rjmurillo/ai-agents)** - ⭐ 10
...
1. **[YC-Killer](https://github.com/sahibzada-allahyar/YC-Killer)** - ⭐ 2,646
...
1. **[modelcontextprotocol](https://github.com/modelcontextprotocol/modelcontextprotocol)** - ⭐ 7,061
   Specification and documentation for the Model Context Protocol

2. **[ai-guide](https://github.com/liyupi/ai-guide)** - ⭐ 5,909
...
4. **[LLM-Agents-Ecosystem-Handbook](https://github.com/oxbshw/LLM-Agents-Ecosystem-Handbook)** - ⭐ 371
