...
1. **[dify](https://github.com/langgenius/dify)** - ⭐ 126,277
   Production-ready platform for agentic workflow development.

2. **[open-webui](https://github.com/open-webui/open-webui)** - ⭐ 121,000
   User-friendly AI Interface (Supports Ollama, OpenAI API, ...)

3. **[gemini-cli](https://github.com/google-gemini/gemini-cli)** - ⭐ 91,395
   An open-source AI agent that brings the power of Gemini directly into your terminal.

4. **[awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)** - ⭐ 79,122
   A collection of MCP servers.

5. **[netdata](https://github.com/netdata/netdata)** - ⭐ 77,373
   The fastest path to AI-powered full stack observability, even for lean teams.

6. **[servers](https://github.com/modelcontextprotocol/servers)** - ⭐ 76,475
   Model Context Protocol Servers

7. **[ragflow](https://github.com/infiniflow/ragflow)** - ⭐ 71,632
   RAGFlow is a leading open-source Retrieval-Augmented Generation (RAG) engine that fuses cutting-edge RAG with Agent capabilities to create a superior context layer for LLMs

8. **[lobe-chat](https://github.com/lobehub/lobe-chat)** - ⭐ 70,228
...
9. **[anything-llm](https://github.com/Mintplex-Labs/anything-llm)** - ⭐ 53,447
   The all-in-one Desktop & Docker AI application with built-in RAG, AI agents, No-code agent builder, MCP compatibility,  and more.

10. **[JeecgBoot](https://github.com/jeecgboot/JeecgBoot)** - ⭐ 45,038
...
11. **[TrendRadar](https://github.com/sansan0/TrendRadar)** - ⭐ 43,550
...
12. **[context7](https://github.com/upstash/context7)** - ⭐ 42,348
   Context7 MCP Server -- Up-to-date code documentation for LLMs and AI code editors

13. **[mindsdb](https://github.com/mindsdb/mindsdb)** - ⭐ 38,268
...
15. **[LibreChat](https://github.com/danny-avila/LibreChat)** - ⭐ 33,157
   Enhanced ChatGPT Clone: Features Agents, MCP, DeepSeek, Anthropic, AWS, OpenAI, Responses API, Azure, Groq, o1, GPT-5, Mistral, OpenRouter, Vertex AI, Gemini, Artifacts, AI model switching, message search, Code Interpreter, langchain, DALL-E-3, OpenAPI Actions, Functions, Secure Multi-User Auth, Presets, open-source for self-hosting. Active.

16. **[1Panel](https://github.com/1Panel-dev/1Panel)** - ⭐ 32,890
   🔥 1Panel provides an intuitive web interface and MCP Server to manage websites, files, containers, databases, and LLMs on a Linux server.

17. **[nacos](https://github.com/alibaba/nacos)** - ⭐ 32,530
   an easy-to-use dynamic service discovery, configuration and service management platform for building AI cloud native applications.

18. **[PDFMathTranslate](https://github.com/PDFMathTranslate/PDFMathTranslate)** - ⭐ 31,337
   [EMNLP 2025 Demo] PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/MCP/Docker/Zotero

19. **[ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub)** - ⭐ 26,513
   In-depth tutorials on LLMs, RAGs and real-world AI agent applications.

20. **[composio](https://github.com/ComposioHQ/composio)** - ⭐ 26,371
   Composio equips your AI agents & LLMs with 100+ high-quality integrations via function calling

21. **[goose](https://github.com/block/goose)** - ⭐ 26,078
   an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM

22. **[github-mcp-server](https://github.com/github/github-mcp-server)** - ⭐ 26,024
   GitHub's official MCP Server

23. **[playwright-mcp](https://github.com/microsoft/playwright-mcp)** - ⭐ 25,730
   Playwright MCP server

24. **[gpt-researcher](https://github.com/assafelovic/gpt-researcher)** - ⭐ 24,883
   An LLM agent that conducts deep research (local and web) on any given topic and generates a long report with citations.

25. **[UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)** - ⭐ 24,127
   The Open-Source Multimodal AI Agent Stack: Connecting Cutting-Edge AI Models and Agent Infra

26. **[xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)** - ⭐ 23,309
   An MCP-based chatbot | 一个基于MCP的聊天机器人

27. **[fastmcp](https://github.com/jlowin/fastmcp)** - ⭐ 22,044
   🚀 The fast, Pythonic way to build MCP servers and clients

28. **[chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp)** - ⭐ 21,385
   Chrome DevTools for coding agents

29. **[repomix](https://github.com/yamadashy/repomix)** - ⭐ 21,287
   📦 Repomix is a powerful tool that packs your entire repository into a single, AI-friendly file. Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools like Claude, ChatGPT, DeepSeek, Perplexity, Gemini, Gemma, Llama, Grok, and more.

30. **[python-sdk](https://github.com/modelcontextprotocol/python-sdk)** - ⭐ 21,171
   The official Python SDK for Model Context Protocol servers and clients

31. **[activepieces](https://github.com/activepieces/activepieces)** - ⭐ 20,390
   AI Agents & MCPs & AI Workflow Automation • (~400 MCP servers for AI agents) • AI Automation / AI Agent with MCPs • AI Workflows & AI Agents • MCPs for AI Agents

32. **[MaxKB](https://github.com/1Panel-dev/MaxKB)** - ⭐ 19,864
   🔥 MaxKB is an open-source platform for building enterprise-grade agents.  强大易用的开源企业级智能体平台。

33. **[mastra](https://github.com/mastra-ai/mastra)** - ⭐ 19,358
   From the team behind Gatsby, Mastra is a framework for building AI-powered applications and agents with a modern TypeScript stack.

34. **[serena](https://github.com/oraios/serena)** - ⭐ 18,784
   A powerful coding agent toolkit providing semantic retrieval and editing capabilities (MCP server & other integrations)

35. **[agentic](https://github.com/transitive-bullshit/agentic)** - ⭐ 18,110
   Your API ⇒ Paid MCP. Instantly.

36. **[blender-mcp](https://github.com/ahujasid/blender-mcp)** - ⭐ 15,445

37. **[mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners)** - ⭐ 14,073
...
39. **[trigger.dev](https://github.com/triggerdotdev/trigger.dev)** - ⭐ 13,320
   Trigger.dev – build and deploy fully‑managed AI agents and workflows

40. **[Qwen-Agent](https://github.com/QwenLM/Qwen-Agent)** - ⭐ 12,965
   Agent framework and applications built upon Qwen>=3.0, featuring Function Calling, MCP, Code Interpreter, RAG, Chrome extension, etc.

41. **[Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP)** - ⭐ 12,579
   MCP server to provide Figma layout information to AI coding agents like Cursor

42. **[genai-toolbox](https://github.com/googleapis/genai-toolbox)** - ⭐ 12,452
   MCP Toolbox for Databases is an open source MCP server for databases.

43. **[claude-flow](https://github.com/ruvnet/claude-flow)** - ⭐ 12,342
...
44. **[cc-switch](https://github.com/farion1231/cc-switch)** - ⭐ 11,966
   A cross-platform desktop All-in-One assistant tool for Claude Code, Codex & Gemini CLI.

45. **[n8n-mcp](https://github.com/czlonkowski/n8n-mcp)** - ⭐ 11,883
   A MCP for Claude Desktop / Claude Code / Windsurf / Cursor to build n8n workflows for you 

46. **[fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)** - ⭐ 11,367
   Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!

47. **[typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk)** - ⭐ 11,348
   The official TypeScript SDK for Model Context Protocol servers and clients

48. **[pal-mcp-server](https://github.com/BeehiveInnovations/pal-mcp-server)** - ⭐ 10,870
   The power of Claude Code / GeminiCLI / CodexCLI + [Gemini / OpenAI / OpenRouter / Azure / Grok / Ollama / Custom Model / All Of The Above] working as one.

49. **[nginx-ui](https://github.com/0xJacky/nginx-ui)** - ⭐ 10,422
   Yet another WebUI for Nginx

50. **[gateway](https://github.com/Portkey-AI/gateway)** - ⭐ 10,314
   A blazing fast AI Gateway with integrated guardrails. Route to 200+ LLMs, 50+ AI Guardrails with 1 fast & friendly API.

51. **[mcp-chrome](https://github.com/hangwin/mcp-chrome)** - ⭐ 9,984
   Chrome MCP Server is a Chrome extension-based Model Context Protocol (MCP) server that exposes your Chrome browser functionality to AI assistants like Claude, enabling complex browser automation, content analysis, and semantic search.

52. **[zen-mcp-server](https://github.com/BeehiveInnovations/zen-mcp-server)** - ⭐ 9,890
   The power of Claude Code / GeminiCLI / CodexCLI + [Gemini / OpenAI / OpenRouter / Azure / Grok / Ollama / Custom Model / All Of The Above] working as one.

53. **[XHS-Downloader](https://github.com/JoeanAmier/XHS-Downloader)** - ⭐ 9,795
   小红书（XiaoHongShu、RedNote）链接提取/作品采集工具：提取账号发布、收藏、点赞、专辑作品链接；提取搜索结果作品、用户链接；采集小红书作品信息；提取小红书作品下载地址；下载小红书无水印作品文件

54. **[mcp-use](https://github.com/mcp-use/mcp-use)** - ⭐ 8,942
   mcp-use is the easiest way to interact with mcp servers with custom agents

55. **[Scrapling](https://github.com/D4Vinci/Scrapling)** - ⭐ 8,799
   🕷️ An undetectable, powerful, flexible, high-performance Python library to make Web Scraping Easy and Effortless as it should be!

56. **[awesome-ai-apps](https://github.com/Arindam200/awesome-ai-apps)** - ⭐ 8,548
   A collection of projects showcasing RAG, agents, workflows, and other AI use cases

57. **[inspector](https://github.com/modelcontextprotocol/inspector)** - ⭐ 8,325
   Visual testing tool for MCP servers

58. **[xiaozhi-esp32-server](https://github.com/xinnan-tech/xiaozhi-esp32-server)** - ⭐ 8,301
   本项目为xiaozhi-esp32提供后端服务，帮助您快速搭建ESP32设备控制服务器。Backend service for xiaozhi-esp32, helps you quickly build an ESP32 device control server.

59. **[xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp)** - ⭐ 8,114
   MCP for xiaohongshu.com

60. **[mcp-go](https://github.com/mark3labs/mcp-go)** - ⭐ 7,994
   A Go implementation of the Model Context Protocol (MCP), enabling seamless integration between LLM applications and external data sources and tools.

61. **[mcp-agent](https://github.com/lastmile-ai/mcp-agent)** - ⭐ 7,949
   Build effective agents using Model Context Protocol and simple workflow patterns

62. **[mcp](https://github.com/awslabs/mcp)** - ⭐ 7,893
   AWS MCP Servers — helping you get the most out of AWS, wherever you use MCP.

63. **[git-mcp](https://github.com/idosal/git-mcp)** - ⭐ 7,403
   Put an end to code hallucinations! GitMCP is a free, open-source, remote MCP server for any GitHub project

64. **[awesome-LLM-resources](https://github.com/WangRongsheng/awesome-LLM-resources)** - ⭐ 7,319
...
66. **[GhidraMCP](https://github.com/LaurieWired/GhidraMCP)** - ⭐ 7,087
   MCP Server for Ghidra

67. **[Skill_Seekers](https://github.com/yusufkaraaslan/Skill_Seekers)** - ⭐ 7,008
   Convert documentation websites, GitHub repositories, and PDFs into Claude AI skills with automatic conflict detection

68. **[browser-tools-mcp](https://github.com/AgentDeskAI/browser-tools-mcp)** - ⭐ 6,986
   Monitor browser logs directly from Cursor and other MCP compatible IDEs.

69. **[registry](https://github.com/modelcontextprotocol/registry)** - ⭐ 6,287
   A community driven registry service for Model Context Protocol (MCP) servers.

70. **[awesome-mcp-clients](https://github.com/punkpeye/awesome-mcp-clients)** - ⭐ 6,205
   A collection of MCP clients.

71. **[cursor-talk-to-figma-mcp](https://github.com/grab/cursor-talk-to-figma-mcp)** - ⭐ 6,139
...
72. **[hexstrike-ai](https://github.com/0x4m4/hexstrike-ai)** - ⭐ 6,110
   HexStrike AI MCP Agents is an advanced MCP server that lets AI agents (Claude, GPT, Copilot, etc.) autonomously run 150+ cybersecurity tools for automated pentesting, vulnerability discovery, bug bounty automation, and security research. Seamlessly bridge LLMs with real-world offensive security capabilities.

73. **[Awesome-MCP-ZH](https://github.com/yzfly/Awesome-MCP-ZH)** - ⭐ 5,789
   MCP 资源精选， MCP指南，Claude MCP，MCP Servers, MCP Clients

74. **[astron-rpa](https://github.com/iflytek/astron-rpa)** - ⭐ 5,734
   Agent-ready RPA suite with out-of-the-box automation tools. Built for individuals and enterprises.

75. **[klavis](https://github.com/Klavis-AI/klavis)** - ⭐ 5,594
   Klavis AI (YC X25):  MCP integration platforms that let AI agents use tools reliably at any scale

76. **[mcp](https://github.com/BrowserMCP/mcp)** - ⭐ 5,461
   Browser MCP is a Model Context Provider (MCP) server that allows AI applications to control your browser

77. **[kreuzberg](https://github.com/kreuzberg-dev/kreuzberg)** - ⭐ 5,388
...
78. **[firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server)** - ⭐ 5,284
   🔥 Official Firecrawl MCP Server - Adds powerful web scraping and search to Cursor, Claude and any other LLM clients.

79. **[DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP)** - ⭐ 5,271
   This is MCP server for Claude that gives it terminal control, file system search and diff file editing capabilities

80. **[whatsapp-mcp](https://github.com/lharries/whatsapp-mcp)** - ⭐ 5,217
   WhatsApp MCP server

81. **[mcp-playwright](https://github.com/executeautomation/mcp-playwright)** - ⭐ 5,153
   Playwright Model Context Protocol Server - Tool to automate Browsers and APIs in Claude Desktop, Cline, Cursor IDE and More 🔌

82. **[Everywhere](https://github.com/DearVa/Everywhere)** - ⭐ 5,139
   Context-aware AI assistant for your desktop. Ready to respond intelligently, seamlessly integrating multiple LLMs and MCP tools.

83. **[claude-context](https://github.com/zilliztech/claude-context)** - ⭐ 5,077
   Code search MCP for Claude Code. Make entire codebase the context for any coding agent.

84. **[awesome-mcp-servers](https://github.com/appcypher/awesome-mcp-servers)** - ⭐ 5,071
   Awesome MCP Servers - A curated list of Model Context Protocol servers

85. **[ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp)** - ⭐ 5,063
   AI-powered reverse engineering assistant that bridges IDA Pro with language models through MCP.

86. **[gaianet-node](https://github.com/GaiaNet-AI/gaianet-node)** - ⭐ 5,009
   Install, run and deploy your own decentralized AI agent service

87. **[5ire](https://github.com/nanbingxyz/5ire)** - ⭐ 4,957
   5ire is a cross-platform desktop AI assistant, MCP client. It compatible with major service providers,  supports local knowledge base and  tools via model context protocol servers .

88. **[unity-mcp](https://github.com/CoplayDev/unity-mcp)** - ⭐ 4,941
   Unity MCP acts as a bridge, allowing AI assistants (like Claude, Cursor) to interact directly with your Unity Editor via a local MCP (Model Context Protocol) Client. Give your LLM tools to manage assets, control scenes, edit scripts, and automate tasks within Unity.

89. **[voltagent](https://github.com/VoltAgent/voltagent)** - ⭐ 4,896
   AI Agent Engineering Platform built on an Open Source TypeScript AI Agent Framework

90. **[sdk-python](https://github.com/strands-agents/sdk-python)** - ⭐ 4,893
   A model-driven approach to building AI agents in just a few lines of code.

91. **[memU](https://github.com/NevaMind-AI/memU)** - ⭐ 4,812
...
93. **[Kiln](https://github.com/Kiln-AI/Kiln)** - ⭐ 4,567
   Build, Evaluate, and Optimize AI Systems. Includes evals, RAG, agents, fine-tuning, synthetic data generation, dataset management, MCP, and more.

94. **[microsandbox](https://github.com/zerocore-ai/microsandbox)** - ⭐ 4,414
...
97. **[httprunner](https://github.com/httprunner/httprunner)** - ⭐ 4,241
   HttpRunner 是一款开源的 API/UI 测试框架，简单易用，功能强大，具有丰富的插件化机制和高度的可扩展能力。

98. **[magic-mcp](https://github.com/21st-dev/magic-mcp)** - ⭐ 4,125
   It's like v0 but in your Cursor/WindSurf/Cline. 21st dev Magic MCP server for working with your frontend like Magic

99. **[claude-plugins-official](https://github.com/anthropics/claude-plugins-official)** - ⭐ 4,093
   Official, Anthropic-managed directory of high quality Claude Code Plugins.

100. **[mcp-ui](https://github.com/MCP-UI-Org/mcp-ui)** - ⭐ 4,044
   UI over MCP. Create next-gen UI experiences with the protocol and SDK!

101. **[mcp-atlassian](https://github.com/sooperset/mcp-atlassian)** - ⭐ 4,005
   MCP server for Atlassian tools (Confluence, Jira)

102. **[Windows-MCP](https://github.com/CursorTouch/Windows-MCP)** - ⭐ 3,956
   MCP Server for Computer Use in Windows

103. **[wanwu](https://github.com/UnicomAI/wanwu)** - ⭐ 3,931
   China Unicom's Yuanjing Wanwu Agent Platform is an enterprise-grade, multi-tenant AI agent development platform. It helps users build applications such as intelligent agents, workflows, and rag, and also supports model management. The platform features a developer-friendly license, and we welcome all developers to build upon the platform.

104. **[Olares](https://github.com/beclab/Olares)** - ⭐ 3,927
   Olares: An Open-Source Personal Cloud to Reclaim Your Data

105. **[directories](https://github.com/pontusab/directories)** - ⭐ 3,880
   The Cursor & Windsurf community, find rules and MCPs

106. **[mcpo](https://github.com/open-webui/mcpo)** - ⭐ 3,874
   A simple, secure MCP-to-OpenAPI proxy server

107. **[learn-agentic-ai](https://github.com/panaversity/learn-agentic-ai)** - ⭐ 3,860
   Learn Agentic AI using Dapr Agentic Cloud Ascent (DACA) Design Pattern and Agent-Native Cloud Technologies: OpenAI Agents SDK, Memory, MCP, A2A, Knowledge Graphs, Dapr, Rancher Desktop, and Kubernetes.

108. **[csharp-sdk](https://github.com/modelcontextprotocol/csharp-sdk)** - ⭐ 3,791
   The official C# SDK for Model Context Protocol servers and clients. Maintained in collaboration with Microsoft.

109. **[notion-mcp-server](https://github.com/makenotion/notion-mcp-server)** - ⭐ 3,736
   Official Notion MCP Server

110. **[XcodeBuildMCP](https://github.com/cameroncooke/XcodeBuildMCP)** - ⭐ 3,720
...
112. **[telegram-search](https://github.com/groupultra/telegram-search)** - ⭐ 3,692
   🔍 导出并模糊搜索 Telegram 聊天记录 | Export and fuzzy search your Telegram chat history

113. **[spec-workflow-mcp](https://github.com/Pimzino/spec-workflow-mcp)** - ⭐ 3,690
   A Model Context Protocol (MCP) server that provides structured spec-driven development workflow tools for AI-assisted software development, featuring a real-time web dashboard and VSCode extension for monitoring and managing your project's progress directly in your development environment.

114. **[go-sdk](https://github.com/modelcontextprotocol/go-sdk)** - ⭐ 3,645
   The official Go SDK for Model Context Protocol servers and clients. Maintained in collaboration with Google.

115. **[fast-agent](https://github.com/evalstate/fast-agent)** - ⭐ 3,607
   Define, Prompt and Test MCP enabled Agents and Workflows

116. **[core](https://github.com/opensumi/core)** - ⭐ 3,590
   A framework helps you quickly build AI Native IDE products. MCP Client, supports Model Context Protocol (MCP) tools via MCP server.

117. **[exa-mcp-server](https://github.com/exa-labs/exa-mcp-server)** - ⭐ 3,564
   Exa MCP for web search and web crawling!

118. **[mcp-feedback-enhanced](https://github.com/Minidoracat/mcp-feedback-enhanced)** - ⭐ 3,522
   Enhanced MCP server for interactive user feedback and command execution in AI-assisted development, featuring dual interface support (Web UI and Desktop Application) with intelligent environment detection and cross-platform compatibility.

119. **[mcp-server-chart](https://github.com/antvis/mcp-server-chart)** - ⭐ 3,522
...
122. **[cipher](https://github.com/campfirein/cipher)** - ⭐ 3,441
...
123. **[awesome-mcp-servers](https://github.com/wong2/awesome-mcp-servers)** - ⭐ 3,375
   A curated list of Model Context Protocol (MCP) servers

124. **[go-whatsapp-web-multidevice](https://github.com/aldinokemal/go-whatsapp-web-multidevice)** - ⭐ 3,364
   GOWA - WhatsApp REST API with support for UI, Multi Account, Webhooks, and MCP. Built with Golang for efficient memory use. 

125. **[mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare)** - ⭐ 3,296

126. **[PeopleInSpace](https://github.com/joreilly/PeopleInSpace)** - ⭐ 3,293
   Kotlin Multiplatform sample with SwiftUI, Jetpack Compose, Compose for Wear, Compose for Desktop, and Compose for Web clients along with Ktor backend.

127. **[langchain-mcp-adapters](https://github.com/langchain-ai/langchain-mcp-adapters)** - ⭐ 3,273
   LangChain 🔌 MCP

128. **[MCP-Chinese-Getting-Started-Guide](https://github.com/liaokongVFX/MCP-Chinese-Getting-Started-Guide)** - ⭐ 3,269
   Model Context Protocol(MCP) 编程极速入门

129. **[metorial](https://github.com/metorial/metorial)** - ⭐ 3,204
   Connect any AI model to 600+ integrations; powered by MCP 📡 🚀

130. **[PPTAgent](https://github.com/icip-cas/PPTAgent)** - ⭐ 3,186
   An Autonomous Agentic Framework for Reflective PowerPoint Generation

131. **[excel-mcp-server](https://github.com/haris-musa/excel-mcp-server)** - ⭐ 3,143
   A Model Context Protocol server for Excel file manipulation

132. **[mcp-context-forge](https://github.com/IBM/mcp-context-forge)** - ⭐ 3,109
   A Model Context Protocol (MCP) Gateway & Registry. Serves as a central management point for tools, resources, and prompts that can be accessed by MCP-compatible LLM applications. Converts REST API endpoints to MCP, composes virtual MCP servers with added security and observability, and converts between protocols (stdio, SSE, Streamable HTTP).

133. **[mobile-mcp](https://github.com/mobile-next/mobile-mcp)** - ⭐ 3,108
   Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators, Simulators and Real Devices)

134. **[py-xiaozhi](https://github.com/huangjunsen0406/py-xiaozhi)** - ⭐ 3,103
   A Python-based Xiaozhi AI for users who want the full Xiaozhi experience without owning specialized hardware.

135. **[learn-ai-engineering](https://github.com/ashishps1/learn-ai-engineering)** - ⭐ 3,098
   Learn AI and LLMs from scratch using free resources

136. **[java-sdk](https://github.com/modelcontextprotocol/java-sdk)** - ⭐ 3,078
   The official Java SDK for Model Context Protocol servers and clients. Maintained in collaboration with Spring AI

137. **[claude-code-guide](https://github.com/zebbern/claude-code-guide)** - ⭐ 3,069
...
138. **[mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase)** - ⭐ 3,065
   Allow LLMs to control a browser with Browserbase and Stagehand

139. **[octelium](https://github.com/octelium/octelium)** - ⭐ 3,063
   A next-gen FOSS self-hosted unified zero trust secure access platform that can operate as a remote access VPN, a ZTNA platform, API/AI/MCP gateway, a PaaS, an ngrok-alternative and a homelab infrastructure.

140. **[boost](https://github.com/laravel/boost)** - ⭐ 3,059
   Laravel-focused MCP server for augmenting your AI powered local development experience.

141. **[osaurus](https://github.com/dinoki-ai/osaurus)** - ⭐ 3,043
...
142. **[mcp](https://github.com/google/mcp)** - ⭐ 2,960
   Google 💚 MCP
...
145. **[rikkahub](https://github.com/rikkahub/rikkahub)** - ⭐ 2,916
   RikkaHub is an Android APP that supports for multiple LLM providers.

146. **[fastmcp](https://github.com/punkpeye/fastmcp)** - ⭐ 2,878
   A TypeScript framework for building MCP servers.

147. **[rust-sdk](https://github.com/modelcontextprotocol/rust-sdk)** - ⭐ 2,843
   The official Rust SDK for the Model Context Protocol

148. **[AI-Infra-Guard](https://github.com/Tencent/AI-Infra-Guard)** - ⭐ 2,795
...
149. **[mcp-obsidian](https://github.com/MarkusPfundstein/mcp-obsidian)** - ⭐ 2,713
   MCP server that interacts with Obsidian via the Obsidian rest API community plugin

150. **[shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server)** - ⭐ 2,603
...
153. **[mcp](https://github.com/microsoft/mcp)** - ⭐ 2,447
   Catalog of official Microsoft MCP (Model Context Protocol) server implementations for AI-powered data access and tool integration

154. **[UltraRAG](https://github.com/OpenBMB/UltraRAG)** - ⭐ 2,434
   UltraRAG v2: A Low-Code MCP Framework for Building Complex and Innovative RAG Pipelines

155. **[supabase-mcp](https://github.com/supabase-community/supabase-mcp)** - ⭐ 2,396
   Connect Supabase to your AI assistants

156. **[supergateway](https://github.com/supercorp-ai/supergateway)** - ⭐ 2,372
   Run MCP stdio servers over SSE and SSE over stdio. AI gateway.

157. **[basic-memory](https://github.com/basicmachines-co/basic-memory)** - ⭐ 2,371
   AI conversations that actually remember. Never re-explain your project to your AI again. Join our Discord: https://discord.gg/tyvKNccgqN

158. **[markdownify-mcp](https://github.com/zcaceres/markdownify-mcp)** - ⭐ 2,353
   A Model Context Protocol server for converting almost anything to Markdown

159. **[playwriter](https://github.com/remorses/playwriter)** - ⭐ 2,305
   MCP to control your Chrome window via extension. Runs Playwright code in a stateful sandbox. 

160. **[buildwithclaude](https://github.com/davepoon/buildwithclaude)** - ⭐ 2,265
   A single hub to find Claude Skills, Agents, Commands, Hooks, Plugins, and Marketplace collections to extend Claude Code

161. **[MCP-SuperAssistant](https://github.com/srbhptl39/MCP-SuperAssistant)** - ⭐ 2,216
   Brings MCP to ChatGPT, DeepSeek, Perplexity, Grok, Gemini, Google AI Studio, OpenRouter, DeepSeek, T3 Chat and more...

162. **[mcp-proxy](https://github.com/sparfenyuk/mcp-proxy)** - ⭐ 2,170
   A bridge between Streamable HTTP and stdio MCP transports

163. **[chatmcp](https://github.com/daodao97/chatmcp)** - ⭐ 2,156
   ChatMCP is an AI chat client implementing the Model Context Protocol (MCP).

164. **[ableton-mcp](https://github.com/ahujasid/ableton-mcp)** - ⭐ 2,140
...
167. **[ddgs](https://github.com/deedy5/ddgs)** - ⭐ 2,088
   DDGS | Dux Distributed Global Search. A metasearch library that aggregates results from diverse web search services

168. **[sandbox](https://github.com/agent-infra/sandbox)** - ⭐ 2,077
   All-in-One Sandbox for AI Agents that combines Browser, Shell, File, MCP and VSCode Server in a single Docker container.

169. **[comfyui_LLM_party](https://github.com/heshengtao/comfyui_LLM_party)** - ⭐ 2,073
   LLM Agent Framework in ComfyUI includes MCP sever, Omost,GPT-sovits, ChatTTS,GOT-OCR2.0, and FLUX prompt nodes,access to Feishu,discord,and adapts to all llms with similar openai / aisuite interfaces, such as o1,ollama, gemini, grok, qwen, GLM, deepseek, kimi,doubao. Adapted to local llms, vlm, gguf such as llama-3.3 Janus-Pro, Linkage graphRAG

170. **[kagent](https://github.com/kagent-dev/kagent)** - ⭐ 2,051
   Cloud Native Agentic AI | Discord: https://bit.ly/kagentdiscord

171. **[papersgpt-for-zotero](https://github.com/papersgpt/papersgpt-for-zotero)** - ⭐ 2,043
...
172. **[arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server)** - ⭐ 2,042
   A Model Context Protocol server for searching and analyzing arXiv papers

173. **[lemonade](https://github.com/lemonade-sdk/lemonade)** - ⭐ 2,015
   Lemonade helps users discover and run local AI apps by serving optimized LLMs right from their own GPUs and NPUs. Join our discord: https://discord.gg/5xXzkMu8Zk

174. **[DevDocs](https://github.com/cyberagiinc/DevDocs)** - ⭐ 2,010
   Completely free, private, UI based Tech Documentation MCP server. Designed for coders and software developers in mind. Easily integrate into Cursor, Windsurf, Cline, Roo Code, Claude Desktop App 

175. **[Unla](https://github.com/AmoyLab/Unla)** - ⭐ 2,000
...
178. **[mcp-crawl4ai-rag](https://github.com/coleam00/mcp-crawl4ai-rag)** - ⭐ 1,962
   Web Crawling and RAG Capabilities for AI Agents and AI Coding Assistants

179. **[mcpso](https://github.com/chatmcp/mcpso)** - ⭐ 1,955
   directory for Awesome MCP Servers

180. **[metamcp](https://github.com/metatool-ai/metamcp)** - ⭐ 1,923
   MCP Aggregator, Orchestrator, Middleware, Gateway in one docker

181. **[dbhub](https://github.com/bytebase/dbhub)** - ⭐ 1,919
   Zero-dependency, token-efficient database MCP server for Postgres, MySQL, SQL Server, MariaDB, SQLite.

182. **[brightdata-mcp](https://github.com/brightdata/brightdata-mcp)** - ⭐ 1,916
   A powerful Model Context Protocol (MCP) server that provides an all-in-one solution for public web access.

183. **[yomo](https://github.com/yomorun/yomo)** - ⭐ 1,883
   🦖 Serverless AI Agent Framework with Geo-distributed Edge AI Infra.

184. **[modelcontextprotocol](https://github.com/perplexityai/modelcontextprotocol)** - ⭐ 1,880
   The official MCP server implementation for the Perplexity API Platform

185. **[gemini-mcp-tool](https://github.com/jamubc/gemini-mcp-tool)** - ⭐ 1,845
   MCP server that enables AI assistants to interact with Google Gemini CLI, leveraging Gemini's massive token window for large file analysis and codebase understanding

186. **[postgres-mcp](https://github.com/crystaldba/postgres-mcp)** - ⭐ 1,837
   Postgres MCP Pro provides configurable read/write access and performance analysis for you and your AI agents.

187. **[mcp-cli](https://github.com/chrishayuk/mcp-cli)** - ⭐ 1,829
...
191. **[agentset](https://github.com/agentset-ai/agentset)** - ⭐ 1,793
   The open-source RAG platform: built-in citations, deep research, 22+ file formats, partitions, MCP server, and more.

192. **[opendia](https://github.com/aaronjmars/opendia)** - ⭐ 1,760
   Connect your browser to AI models. Just use Dia on Chrome, Arc or Firefox.

193. **[bifrost](https://github.com/maximhq/bifrost)** - ⭐ 1,741
   Fastest LLM gateway (50x faster than LiteLLM) with adaptive load balancer, cluster mode, guardrails, 1000+ models support & <100 µs overhead at 5k RPS.

194. **[mcphub](https://github.com/samanhappy/mcphub)** - ⭐ 1,721
   A unified hub for centrally managing and dynamically orchestrating multiple MCP servers/APIs into separate endpoints with flexible routing strategies

195. **[Dive](https://github.com/OpenAgentPlatform/Dive)** - ⭐ 1,713
   Dive is an open-source MCP Host Desktop Application that seamlessly integrates with any LLMs supporting function calling capabilities. ✨

196. **[mcphub.nvim](https://github.com/ravitemer/mcphub.nvim)** - ⭐ 1,691
   An MCP client for Neovim that seamlessly integrates MCP servers into your editing workflow with an intuitive interface for managing, testing, and using MCP servers with your favorite chat plugins.

197. **[AIaW](https://github.com/NitroRCr/AIaW)** - ⭐ 1,677
...
198. **[interactive-feedback-mcp](https://github.com/noopstudios/interactive-feedback-mcp)** - ⭐ 1,656
   Interactive User Feedback MCP

199. **[mcpb](https://github.com/modelcontextprotocol/mcpb)** - ⭐ 1,655
   Desktop Extensions: One-click local MCP server installation in desktop apps

200. **[zenfeed](https://github.com/glidea/zenfeed)** - ⭐ 1,620
   Make RSS 📰 great again with AI 🧠✨!!

201. **[codemcp](https://github.com/ezyang/codemcp)** - ⭐ 1,598
   Coding assistant MCP for Claude Desktop

202. **[super-agent-party](https://github.com/heshengtao/super-agent-party)** - ⭐ 1,595
...
203. **[anyquery](https://github.com/julien040/anyquery)** - ⭐ 1,589
   Query anything (GitHub, Notion, +40 more) with SQL and let LLMs (ChatGPT, Claude) connect to using MCP

204. **[agentgateway](https://github.com/agentgateway/agentgateway)** - ⭐ 1,584
   Next Generation Agentic Proxy for AI Agents and MCP servers

205. **[mcp-router](https://github.com/mcp-router/mcp-router)** - ⭐ 1,580
   A Unified MCP Server Management App (MCP Manager).

206. **[Continuous-Claude-v2](https://github.com/parcadei/Continuous-Claude-v2)** - ⭐ 1,575
   Context management for Claude Code. Hooks maintain state via ledgers and handoffs. MCP execution without context pollution. Agent orchestration with isolated context windows.

207. **[inspector](https://github.com/MCPJam/inspector)** - ⭐ 1,568
...
210. **[toolhive](https://github.com/stacklok/toolhive)** - ⭐ 1,529
...
213. **[MAI-UI](https://github.com/Tongyi-MAI/MAI-UI)** - ⭐ 1,504
   MAI-UI: Real-World Centric Foundation GUI Agents ranging from 2B to 235B

214. **[mcp-installer](https://github.com/anaisbetts/mcp-installer)** - ⭐ 1,498
   An MCP server that installs other MCP servers for you

215. **[ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp)** - ⭐ 1,477
   MCP server for interacting with the iOS simulator

216. **[mcp_agent_mail](https://github.com/Dicklesworthstone/mcp_agent_mail)** - ⭐ 1,472
   Like gmail for your coding agents. Lets various different agents communicate and coordinate with each other.

217. **[better-agents](https://github.com/langwatch/better-agents)** - ⭐ 1,446
   Standards for building agents, better

218. **[mcptools](https://github.com/f/mcptools)** - ⭐ 1,441
   A command-line interface for interacting with MCP (Model Context Protocol) servers using both stdio and HTTP transport.

219. **[Office-Word-MCP-Server](https://github.com/GongRzhe/Office-Word-MCP-Server)** - ⭐ 1,441
   A Model Context Protocol (MCP) server for creating, reading, and manipulating Microsoft Word documents. This server enables AI assistants to work with Word documents through a standardized interface, providing rich document editing capabilities.

220. **[MCP-Reborn](https://github.com/Hexeption/MCP-Reborn)** - ⭐ 1,438
   MCP-Reborn is an MCP (Mod Coder Pack) for Minecraft for making modded clients and researching its code. (1.13-1.21.4)

221. **[godot-mcp](https://github.com/Coding-Solo/godot-mcp)** - ⭐ 1,424
   MCP server for interfacing with Godot game engine. Provides tools for launching the editor, running projects, and capturing debug output.

222. **[Office-PowerPoint-MCP-Server](https://github.com/GongRzhe/Office-PowerPoint-MCP-Server)** - ⭐ 1,423
   A MCP (Model Context Protocol) server for PowerPoint manipulation using python-pptx. This server provides tools for creating, editing, and manipulating PowerPoint presentations through the MCP protocol.

223. **[yu-ai-agent](https://github.com/liyupi/yu-ai-agent)** - ⭐ 1,410
...
224. **[rulego](https://github.com/rulego/rulego)** - ⭐ 1,404
   ⛓️RuleGo is a lightweight, high-performance, embedded, next-generation component orchestration rule engine framework for Go.

225. **[mcp-scan](https://github.com/invariantlabs-ai/mcp-scan)** - ⭐ 1,399
   Constrain, log and scan your MCP connections for security vulnerabilities.

226. **[mcp-language-server](https://github.com/isaacphi/mcp-language-server)** - ⭐ 1,390
   mcp-language-server gives MCP enabled clients access semantic tools like get definition, references, rename, and diagnostics.

227. **[pg-aiguide](https://github.com/timescale/pg-aiguide)** - ⭐ 1,383
   MCP server and Claude plugin for Postgres skills and documentation. Helps AI coding tools generate better PostgreSQL code.

228. **[awesome-agent-skills](https://github.com/heilcheng/awesome-agent-skills)** - ⭐ 1,368
...
230. **[php-sdk](https://github.com/modelcontextprotocol/php-sdk)** - ⭐ 1,309
   The official PHP SDK for Model Context Protocol servers and clients. Maintained in collaboration with The PHP Foundation.

231. **[mcp](https://github.com/MicrosoftDocs/mcp)** - ⭐ 1,287
   Official Microsoft Learn MCP Server – powering LLMs and AI agents with real-time, trusted Microsoft docs & code samples.

232. **[Risuai](https://github.com/kwaroran/Risuai)** - ⭐ 1,285
   Make your own story. User-friendly software for LLM roleplaying

233. **[docker-mcp-tutorial](https://github.com/theNetworkChuck/docker-mcp-tutorial)** - ⭐ 1,283
   Complete tutorial materials for building MCP servers with Docker - from NetworkChuck's video

234. **[unreal-mcp](https://github.com/chongdashu/unreal-mcp)** - ⭐ 1,281
   Enable AI assistant clients like Cursor, Windsurf and Claude Desktop to control Unreal Engine through natural language using the Model Context Protocol (MCP).

235. **[LitterBox](https://github.com/BlackSnufkin/LitterBox)** - ⭐ 1,279
   A secure sandbox environment for malware developers and red teamers to test payloads against detection mechanisms before deployment. Integrates with LLM agents via MCP for enhanced analysis capabilities.

236. **[mcp-obsidian](https://github.com/smithery-ai/mcp-obsidian)** - ⭐ 1,276
   A connector for Claude Desktop to read and search an Obsidian vault.

237. **[Claude-Code-Development-Kit](https://github.com/peterkrueck/Claude-Code-Development-Kit)** - ⭐ 1,275
   Handle context at scale - my custom Claude Code workflow including hooks, mcp and sub agents

238. **[code-mode](https://github.com/universal-tool-calling-protocol/code-mode)** - ⭐ 1,266
...
242. **[mcp-unity](https://github.com/CoderGamester/mcp-unity)** - ⭐ 1,232
...
245. **[kotlin-sdk](https://github.com/modelcontextprotocol/kotlin-sdk)** - ⭐ 1,217
   The official Kotlin SDK for Model Context Protocol servers and clients. Maintained in collaboration with JetBrains

246. **[mcp-remote](https://github.com/geelen/mcp-remote)** - ⭐ 1,216

247. **[sre](https://github.com/SmythOS/sre)** - ⭐ 1,214
   The SmythOS Runtime Environment (SRE) is an open-source, cloud-native runtime for agentic AI. Secure, modular, and production-ready, it lets developers build, run, and manage intelligent agents across local, cloud, and edge environments.

248. **[deepwiki-mcp](https://github.com/regenrek/deepwiki-mcp)** - ⭐ 1,212
   📖 MCP server for fetch deepwiki.com and get latest knowledge in Cursor and other Code Editors

249. **[grafbase](https://github.com/grafbase/grafbase)** - ⭐ 1,202
   The Grafbase GraphQL Federation Gateway

250. **[solace-agent-mesh](https://github.com/SolaceLabs/solace-agent-mesh)** - ⭐ 1,201
   An event-driven framework designed to build and orchestrate multi-agent AI systems. It enables seamless integration of AI agents with real-world data sources and systems, facilitating complex, multi-step workflows.

251. **[A2V](https://github.com/Devin-AXIS/A2V)** - ⭐ 1,200
   A2V: Next-Gen AI Value Compute Protocol.                                                                                 

252. **[ai](https://github.com/stripe/ai)** - ⭐ 1,198
   One-stop shop for building AI-powered products and businesses with Stripe.

253. **[MiniMax-MCP](https://github.com/MiniMax-AI/MiniMax-MCP)** - ⭐ 1,191
   Official MiniMax Model Context Protocol (MCP) server that enables interaction with powerful Text to Speech, image generation and video generation APIs.

254. **[xmcp](https://github.com/basementstudio/xmcp)** - ⭐ 1,181
   The TypeScript MCP framework

255. **[swift-sdk](https://github.com/modelcontextprotocol/swift-sdk)** - ⭐ 1,181
   The official Swift SDK for Model Context Protocol servers and clients.

256. **[mcp-golang](https://github.com/metoro-io/mcp-golang)** - ⭐ 1,177
   Write Model Context Protocol servers in few lines of go code. Docs at https://mcpgolang.com . Created by https://metoro.io

257. **[cunzhi](https://github.com/imhuso/cunzhi)** - ⭐ 1,174
   告别AI提前终止烦恼，助力AI更加持久

258. **[npcpy](https://github.com/NPC-Worldwide/npcpy)** - ⭐ 1,169
   The AI toolkit for the AI developer

259. **[mcp-server-qdrant](https://github.com/qdrant/mcp-server-qdrant)** - ⭐ 1,168
   An official Qdrant Model Context Protocol (MCP) server implementation

260. **[mcp-gateway](https://github.com/docker/mcp-gateway)** - ⭐ 1,167
   docker mcp CLI plugin / MCP Gateway

261. **[mcp-memory-service](https://github.com/doobidoo/mcp-memory-service)** - ⭐ 1,162
   Stop re-explaining your project to AI every session. Automatic context memory for Claude, VS Code, Cursor, and 13+ AI tools.

262. **[Peekaboo](https://github.com/steipete/Peekaboo)** - ⭐ 1,155
   Peekaboo is a macOS CLI & optional MCP server that enables AI agents to capture screenshots of applications, or the entire system, with optional visual question answering through local or remote AI models.

263. **[elevenlabs-mcp](https://github.com/elevenlabs/elevenlabs-mcp)** - ⭐ 1,153
   The official ElevenLabs MCP server

264. **[azure-devops-mcp](https://github.com/microsoft/azure-devops-mcp)** - ⭐ 1,152
   The MCP server for Azure DevOps, bringing the power of Azure DevOps directly to your agents.

265. **[terraform-mcp-server](https://github.com/hashicorp/terraform-mcp-server)** - ⭐ 1,149
   The Terraform MCP Server provides seamless integration with Terraform ecosystem, enabling advanced automation and interaction capabilities for Infrastructure as Code (IaC) development.

266. **[google_workspace_mcp](https://github.com/taylorwilsdon/google_workspace_mcp)** - ⭐ 1,146
...
267. **[slack-mcp-server](https://github.com/korotovsky/slack-mcp-server)** - ⭐ 1,137
...
268. **[Agent-MCP](https://github.com/rinadelph/Agent-MCP)** - ⭐ 1,125
   Agent-MCP is a framework for creating multi-agent systems that enables coordinated, efficient AI collaboration through the Model Context Protocol (MCP). The system is designed for developers building AI applications that benefit from multiple specialized agents working in parallel on different aspects of a project.

269. **[google-analytics-mcp](https://github.com/googleanalytics/google-analytics-mcp)** - ⭐ 1,124
...
272. **[AWorld](https://github.com/inclusionAI/AWorld)** - ⭐ 1,098
   Build, evaluate and train General Multi-Agent Assistance with ease

273. **[xiaozhi-esp32-server-java](https://github.com/joey-zhou/xiaozhi-esp32-server-java)** - ⭐ 1,093
   小智ESP32的Java企业级管理平台，提供设备监控、音色定制、角色切换和对话记录管理的前后端及服务端一体化解决方案

274. **[tavily-mcp](https://github.com/tavily-ai/tavily-mcp)** - ⭐ 1,090
   Production ready MCP server with real-time search, extract, map & crawl.

275. **[jadx-ai-mcp](https://github.com/zinja-coder/jadx-ai-mcp)** - ⭐ 1,089
   Plugin for JADX to integrate MCP server

276. **[cui](https://github.com/wbopan/cui)** - ⭐ 1,079
   A web UI for Claude Code agents

277. **[mcp-server-mysql](https://github.com/benborla/mcp-server-mysql)** - ⭐ 1,079
   A Model Context Protocol server that provides read-only access to MySQL databases. This server enables LLMs to inspect database schemas and execute read-only queries.

278. **[mysql_mcp_server](https://github.com/designcomputer/mysql_mcp_server)** - ⭐ 1,074
   A Model Context Protocol (MCP) server that enables secure interaction with MySQL databases

279. **[xhs-toolkit](https://github.com/aki66938/xhs-toolkit)** - ⭐ 1,063
   📕 小红书创作者MCP工具包 - 支持与AI客户端集成的内容创作和发布工具

280. **[flock](https://github.com/Onelevenvy/flock)** - ⭐ 1,061
...
284. **[minima](https://github.com/dmayboroda/minima)** - ⭐ 1,024
   On-premises conversational RAG with configurable containers

285. **[use-mcp](https://github.com/modelcontextprotocol/use-mcp)** - ⭐ 1,022

286. **[lets-learn-mcp-python](https://github.com/microsoft/lets-learn-mcp-python)** - ⭐ 1,019
   MCP Python Tutorial 

287. **[ApeRAG](https://github.com/apecloud/ApeRAG)** - ⭐ 1,019
   ApeRAG: Production-ready GraphRAG with multi-modal indexing, AI agents, MCP support, and scalable K8s deployment

288. **[Awesome-MCP-Servers](https://github.com/YuzeHao2023/Awesome-MCP-Servers)** - ⭐ 1,015
   A curated list of Model Context Protocol (MCP) servers 

289. **[trustgraph](https://github.com/trustgraph-ai/trustgraph)** - ⭐ 1,013
   The Context Graph Factory for AI. Build, manage, and deploy AI-optimized Context Graphs.

290. **[claude-code-mcp](https://github.com/steipete/claude-code-mcp)** - ⭐ 1,006
   Claude Code as one-shot MCP server to have an agent in your agent.

291. **[kubernetes-mcp-server](https://github.com/containers/kubernetes-mcp-server)** - ⭐ 1,006
   Model Context Protocol (MCP) server for Kubernetes and OpenShift

292. **[claude-code-plugins-plus-skills](https://github.com/jeremylongshore/claude-code-plugins-plus-skills)** - ⭐ 1,002
   Hundreds of Claude Code plugins with embedded AI skills. Learn via interactive Jupyter tutorials.

293. **[mcp-boilerplate](https://github.com/iannuttall/mcp-boilerplate)** - ⭐ 997
   A remote Cloudflare MCP server boilerplate with user authentication and Stripe for paid tools.

294. **[iMCP](https://github.com/mattt/iMCP)** - ⭐ 991
   A macOS app that provides an MCP server to your Messages, Contacts, Reminders and more

295. **[wenyan-mcp](https://github.com/caol64/wenyan-mcp)** - ⭐ 985
   文颜 MCP Server 可以让 AI 自动将 Markdown 文章排版后发布至微信公众号。

296. **[zotero-mcp](https://github.com/54yyyu/zotero-mcp)** - ⭐ 983
   Zotero MCP: Connects your Zotero research library with Claude and other AI assistants via the Model Context Protocol to discuss papers, get summaries, analyze citations, and more.

297. **[awesome-remote-mcp-servers](https://github.com/jaw9c/awesome-remote-mcp-servers)** - ⭐ 982
   Remote MCP Servers

298. **[better-chatbot](https://github.com/cgoinglove/better-chatbot)** - ⭐ 981
   Just a Better Chatbot. Powered by Agent & MCP & Workflows.

299. **[claude-init](https://github.com/cfrs2005/claude-init)** - ⭐ 963
   Claude Code 中文开发套件 - 为中国开发者定制的零门槛 AI 编程环境。一键安装完整中文化体验，集成 MCP 服务器、智能上下文管理、安全扫描，支持免翻墙访问。让 AI 编程更简单。

300. **[quickstart-resources](https://github.com/modelcontextprotocol/quickstart-resources)** - ⭐ 960
   A repository of servers and clients from the Model Context Protocol tutorials

301. **[ollama-mcp-bridge](https://github.com/patruff/ollama-mcp-bridge)** - ⭐ 959
   Bridge between Ollama and MCP servers, enabling local LLMs to use Model Context Protocol tools

302. **[fetcher-mcp](https://github.com/jae-jae/fetcher-mcp)** - ⭐ 958
   MCP server for fetch web page content using Playwright headless browser.

303. **[WebMCP](https://github.com/MiguelsPizza/WebMCP)** - ⭐ 953
   Bringing the power of MCP to the web

304. **[RedNote-MCP](https://github.com/iFurySt/RedNote-MCP)** - ⭐ 943
   🚀MCP server for accessing RedNote(XiaoHongShu, xhs).

305. **[mcp-jetbrains](https://github.com/JetBrains/mcp-jetbrains)** - ⭐ 936
   A model context protocol server to work with JetBrains IDEs: IntelliJ, PyCharm, WebStorm, etc. Also, works with Android Studio

306. **[docs-mcp-server](https://github.com/arabold/docs-mcp-server)** - ⭐ 935
   Grounded Docs MCP Server: Open-Source Alternative to Context7, Nia, and Ref.Tools

307. **[ros-mcp-server](https://github.com/robotmcp/ros-mcp-server)** - ⭐ 934
   Connect AI models like Claude & GPT with robots using MCP and ROS.

308. **[CloudBase-MCP](https://github.com/TencentCloudBase/CloudBase-MCP)** - ⭐ 931
      CloudBase MCP - Connect CloudBase to your AI Agent.     Go from AI prompt to live app. 

309. **[ref-tools-mcp](https://github.com/ref-tools/ref-tools-mcp)** - ⭐ 927
   Helping coding agents never make mistakes working with public or private libraries without wasting the context window.

310. **[Gmail-MCP-Server](https://github.com/GongRzhe/Gmail-MCP-Server)** - ⭐ 926
   A Model Context Protocol (MCP) server for Gmail integration in Claude Desktop with auto authentication support. This server enables AI assistants to manage Gmail through natural language interactions.

311. **[ai-dev-tools-zoomcamp](https://github.com/DataTalksClub/ai-dev-tools-zoomcamp)** - ⭐ 925
...
312. **[short-video-maker](https://github.com/gyoridavid/short-video-maker)** - ⭐ 923
   Creates short videos for TikTok, Instagram Reels, and YouTube Shorts using the Model Context Protocol (MCP) and a REST API.

313. **[awesome-devops-mcp-servers](https://github.com/rohitg00/awesome-devops-mcp-servers)** - ⭐ 922
   A curated list of awesome MCP servers focused on DevOps tools and capabilities.

314. **[gitlab-mcp](https://github.com/zereight/gitlab-mcp)** - ⭐ 920
   First gitlab mcp for you

315. **[mcp-windbg](https://github.com/svnscha/mcp-windbg)** - ⭐ 913
   Model Context Protocol for WinDBG

316. **[CloudBase-AI-ToolKit](https://github.com/TencentCloudBase/CloudBase-AI-ToolKit)** - ⭐ 909
      CloudBase MCP - Connect CloudBase to your AI Agent.     Go from AI prompt to live app in one click.

317. **[mcpdoc](https://github.com/langchain-ai/mcpdoc)** - ⭐ 909
   Expose llms-txt to IDEs for development

318. **[Pixelle-MCP](https://github.com/AIDC-AI/Pixelle-MCP)** - ⭐ 897
   An Open-Source Multimodal AIGC Solution based on ComfyUI + MCP + LLM  https://pixelle.ai

319. **[MCP-Bridge](https://github.com/SecretiveShell/MCP-Bridge)** - ⭐ 894
   A middleware to provide an openAI compatible endpoint that can call MCP tools

320. **[google-calendar-mcp](https://github.com/nspady/google-calendar-mcp)** - ⭐ 894
   MCP integration for Google Calendar to manage events.

321. **[mcp-framework](https://github.com/QuantGeekDev/mcp-framework)** - ⭐ 893
   A framework for writing MCP (Model Context Protocol) servers in Typescript

322. **[tools](https://github.com/strands-agents/tools)** - ⭐ 891
   A set of tools that gives agents powerful capabilities.

323. **[nuxt-mcp-dev](https://github.com/antfu/nuxt-mcp-dev)** - ⭐ 890
   MCP server helping models to understand your Vite/Nuxt app better.

324. **[gemini-nexus](https://github.com/yeahhe365/gemini-nexus)** - ⭐ 890
...
325. **[mongodb-mcp-server](https://github.com/mongodb-js/mongodb-mcp-server)** - ⭐ 888
   A Model Context Protocol server to connect to MongoDB databases and MongoDB Atlas Clusters.

326. **[mcporter](https://github.com/steipete/mcporter)** - ⭐ 886
   Call MCPs via TypeScript, masquerading as simple TypeScript API. Or package them as cli.

327. **[mix.core](https://github.com/mixcore/mix.core)** - ⭐ 880
   🚀 A future-proof enterprise web CMS supporting both headless and decoupled approaches. Build any type of app with customizable APIs on ASP.NET Core/.NET Core. Completely open-source and designed for flexibility.

328. **[agentic-radar](https://github.com/splx-ai/agentic-radar)** - ⭐ 877
   A security scanner for your LLM agentic workflows

329. **[mcp-neo4j](https://github.com/neo4j-contrib/mcp-neo4j)** - ⭐ 876
   Neo4j Labs Model Context Protocol servers

330. **[todo-for-ai](https://github.com/todo-for-ai/todo-for-ai)** - ⭐ 875
...
331. **[openapi-mcp-server](https://github.com/janwilmake/openapi-mcp-server)** - ⭐ 871
   Allow AI to wade through complex OpenAPIs using Simple Language

332. **[MCProtocolLib](https://github.com/GeyserMC/MCProtocolLib)** - ⭐ 869
   A library for communication with a Minecraft client/server.

333. **[mcp-browser-use](https://github.com/Saik0s/mcp-browser-use)** - ⭐ 869

334. **[mcp-course](https://github.com/huggingface/mcp-course)** - ⭐ 868

335. **[chatgpt-cli](https://github.com/kardolus/chatgpt-cli)** - ⭐ 868
...
336. **[agents](https://github.com/inkeep/agents)** - ⭐ 865
   Create AI Agents in a No-Code Visual Builder or TypeScript SDK with full 2-way sync. For shipping AI assistants and multi-agent AI workflows.

337. **[mcpm.sh](https://github.com/pathintegral-institute/mcpm.sh)** - ⭐ 860
   CLI MCP package manager & registry for all platforms and all clients. Search & configure MCP servers. Advanced Router & Profile features.

338. **[awesome-mcp-list](https://github.com/MobinX/awesome-mcp-list)** - ⭐ 857
   A concise list for mcp servers

339. **[jupyter-mcp-server](https://github.com/datalayer/jupyter-mcp-server)** - ⭐ 851
   🪐 🔧 Model Context Protocol (MCP) Server for Jupyter.

340. **[mcp-notion-server](https://github.com/suekou/mcp-notion-server)** - ⭐ 843

341. **[memory-bank-mcp](https://github.com/alioshr/memory-bank-mcp)** - ⭐ 843
...
343. **[hyper-mcp](https://github.com/hyper-mcp-rs/hyper-mcp)** - ⭐ 836
   📦️ A fast, secure MCP server that extends its capabilities through WebAssembly plugins.

344. **[hyper-mcp](https://github.com/tuananh/hyper-mcp)** - ⭐ 835
   📦️ A fast, secure MCP server that extends its capabilities through WebAssembly plugins.

345. **[hyper-mcp](https://github.com/joseph-wortmann/hyper-mcp)** - ⭐ 834
   📦️ A fast, secure MCP server that extends its capabilities through WebAssembly plugins.

346. **[scira-mcp-chat](https://github.com/zaidmukaddam/scira-mcp-chat)** - ⭐ 827
   A minimalistic MCP client with a good feature set.

347. **[OpenDerisk](https://github.com/derisk-ai/OpenDerisk)** - ⭐ 825
...
348. **[mcp-sequential-thinking](https://github.com/arben-adm/mcp-sequential-thinking)** - ⭐ 822

349. **[trpc-agent-go](https://github.com/trpc-group/trpc-agent-go)** - ⭐ 821
   trpc-agent-go is a powerful Go framework for building intelligent agent systems using large language models (LLMs) and tools.

350. **[yokai](https://github.com/ankorstore/yokai)** - ⭐ 818
   Simple, modular, and observable Go framework for backend applications.

351. **[statespace](https://github.com/statespace-tech/statespace)** - ⭐ 816
   Turn your data into shareable RAG apps in minutes. All in pure Markdown. Zero boilerplate.

352. **[supabase-mcp-server](https://github.com/alexander-zuev/supabase-mcp-server)** - ⭐ 814
   Query MCP enables end-to-end management of Supabase via chat interface: read & write query executions, management API support, automatic migration versioning, access to logs and much more.

353. **[MCPJungle](https://github.com/mcpjungle/MCPJungle)** - ⭐ 812
...
357. **[openapi-servers](https://github.com/open-webui/openapi-servers)** - ⭐ 805
   OpenAPI Tool Servers

358. **[DeepMCPAgent](https://github.com/cryxnet/DeepMCPAgent)** - ⭐ 803
   Model-agnostic plug-n-play LangChain/LangGraph agents powered entirely by MCP tools over HTTP/SSE.

359. **[server](https://github.com/php-mcp/server)** - ⭐ 801
   Core PHP implementation for the Model Context Protocol (MCP) server

360. **[browser-use-mcp-server](https://github.com/kontext-dev/browser-use-mcp-server)** - ⭐ 798
   Browse the web, directly from Cursor etc.

361. **[context-space](https://github.com/context-space/context-space)** - ⭐ 797
   Ultimate Context Engineering Infrastructure, starting from MCPs and Integrations

362. **[MCP-Security-Checklist](https://github.com/slowmist/MCP-Security-Checklist)** - ⭐ 792
   A comprehensive security checklist for MCP-based AI tools. Built by SlowMist to safeguard LLM plugin ecosystems.

363. **[arcade-mcp](https://github.com/ArcadeAI/arcade-mcp)** - ⭐ 789
   The best way to create, deploy, and share MCP Servers

364. **[excel-mcp-server](https://github.com/negokaz/excel-mcp-server)** - ⭐ 784
   A Model Context Protocol (MCP) server that reads and writes MS Excel data

365. **[Unity-MCP](https://github.com/IvanMurzak/Unity-MCP)** - ⭐ 784
   AI-powered bridge connecting LLMs and advanced AI agents to the Unity Editor via the Model Context Protocol (MCP). Chat with AI to generate code, debug errors, and automate game development tasks directly within your project.

366. **[bank-api](https://github.com/erwinkramer/bank-api)** - ⭐ 778
   The Bank API is a design reference project suitable to bootstrap development for a compliant and modern API.

367. **[acemcp](https://github.com/qy527145/acemcp)** - ⭐ 771
   一个将ACE(Augment Context Engine) 做成MCP的项目

368. **[mcp-knowledge-graph](https://github.com/shaneholloman/mcp-knowledge-graph)** - ⭐ 769
   MCP server enabling persistent memory for Claude through a local knowledge graph - fork focused on local development

369. **[agent-kit](https://github.com/inngest/agent-kit)** - ⭐ 766
   AgentKit: Build multi-agent networks in TypeScript with deterministic routing and rich tooling via MCP.

370. **[qgis_mcp](https://github.com/jjsantos01/qgis_mcp)** - ⭐ 765
   Model Context Protocol (MCP) that allows LLMs to use QGIS Desktop

371. **[Context](https://github.com/indragiek/Context)** - ⭐ 765
   Native macOS client for Model Context Protocol (MCP)

372. **[vibetest-use](https://github.com/browser-use/vibetest-use)** - ⭐ 758
   Vibetest MCP - automated QA testing using Browser-Use agents

373. **[vllora](https://github.com/vllora/vllora)** - ⭐ 757
   Debug your AI agents

374. **[runno](https://github.com/taybenlor/runno)** - ⭐ 756
   Sandboxed runtime for programming languages and WASI binaries. Works in the browser, on your server, or via MCP.

375. **[k8m](https://github.com/weibaohui/k8m)** - ⭐ 754
...
377. **[mcp-marketplace](https://github.com/cline/mcp-marketplace)** - ⭐ 748
...
378. **[mcp-scanner](https://github.com/cisco-ai-defense/mcp-scanner)** - ⭐ 746
   Scan MCP servers for potential threats & security findings.

379. **[heurist-agent-framework](https://github.com/heurist-network/heurist-agent-framework)** - ⭐ 740
   A flexible multi-interface AI agent framework for building agents with reasoning, tool use, memory, deep research, blockchain interaction, MCP, and agents-as-a-service.

380. **[lisa.py](https://github.com/ant4g0nist/lisa.py)** - ⭐ 739
   LLDB MCP Integration + other helpful commands

381. **[AITreasureBox](https://github.com/superiorlu/AITreasureBox)** - ⭐ 739
   🤖 Collect practical AI repos, tools, websites, papers and tutorials on AI. 实用的AI百宝箱 💎 

382. **[himarket](https://github.com/higress-group/himarket)** - ⭐ 738
...
384. **[wordpress-mcp](https://github.com/Automattic/wordpress-mcp)** - ⭐ 730
...
385. **[duckduckgo-mcp-server](https://github.com/nickclyde/duckduckgo-mcp-server)** - ⭐ 728
   A Model Context Protocol (MCP) server that provides web search capabilities through DuckDuckGo, with additional features for content fetching and parsing.

386. **[apple-docs-mcp](https://github.com/kimsungwhee/apple-docs-mcp)** - ⭐ 727
   MCP server for Apple Developer Documentation - Search iOS/macOS/SwiftUI/UIKit docs, WWDC videos, Swift/Objective-C APIs & code examples in Claude, Cursor & AI assistants

387. **[context-portal](https://github.com/GreatScottyMac/context-portal)** - ⭐ 724
...
388. **[linkedin-mcp-server](https://github.com/stickerdaniel/linkedin-mcp-server)** - ⭐ 722
...
389. **[coderunner](https://github.com/instavm/coderunner)** - ⭐ 721
   A secure local sandbox to run LLM-generated code using Apple containers

390. **[zypher-agent](https://github.com/corespeed-io/zypher-agent)** - ⭐ 714
...
393. **[mcp](https://github.com/hyperbrowserai/mcp)** - ⭐ 708
   A MCP server implementation for hyperbrowser

394. **[nanobot](https://github.com/nanobot-ai/nanobot)** - ⭐ 705
   Build MCP Agents

395. **[Claude-Code-Everything-You-Need-to-Know](https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know)** - ⭐ 705
   The ultimate all-in-one guide to mastering Claude Code. From setup, prompt engineering, commands, hooks, workflows, automation, and integrations, to MCP servers, tools, and the BMAD method—packed with step-by-step tutorials, real-world examples, and expert strategies to make this the global go-to repo for Claude mastery.

396. **[apify-mcp-server](https://github.com/apify/apify-mcp-server)** - ⭐ 701
   The Apify MCP server enables your AI agents to extract data from social media, search engines, maps, e-commerce sites, or any other website using thousands of ready-made scrapers, crawlers, and automation tools available on the Apify Store.

397. **[llm-functions](https://github.com/sigoden/llm-functions)** - ⭐ 700
   Easily create LLM tools and agents using plain Bash/JavaScript/Python functions.

398. **[just-prompt](https://github.com/disler/just-prompt)** - ⭐ 696
...
399. **[MassGen](https://github.com/massgen/MassGen)** - ⭐ 695
...
400. **[claude-delegator](https://github.com/jarrodwatts/claude-delegator)** - ⭐ 693
   Delegate tasks to Codex GPT 5.2 directly from within Claude Code.

401. **[mcp-cli](https://github.com/philschmid/mcp-cli)** - ⭐ 692
   Lighweight CLI to interact with MCP servers

402. **[12306-mcp](https://github.com/Joooook/12306-mcp)** - ⭐ 683
   This is a 12306 ticket search server based on the Model Context Protocol (MCP).

403. **[ruby-sdk](https://github.com/modelcontextprotocol/ruby-sdk)** - ⭐ 682
   The official Ruby SDK for the Model Context Protocol. Maintained in collaboration with Shopify.

404. **[langgraph-mcp-agents](https://github.com/teddynote-lab/langgraph-mcp-agents)** - ⭐ 680
...
405. **[code-index-mcp](https://github.com/johnhuang316/code-index-mcp)** - ⭐ 678
   A Model Context Protocol (MCP) server that helps large language models index, search, and analyze code repositories with minimal setup

406. **[HowToCook-mcp](https://github.com/worryzyy/HowToCook-mcp)** - ⭐ 674
   基于Anduin2017 / HowToCook （程序员在家做饭指南）的mcp server

407. **[octocode-mcp](https://github.com/bgauryy/octocode-mcp)** - ⭐ 674
   MCP server for semantic code research and context generation on real-time using LLM patterns | Search naturally across public & private repos based on your permissions | Transform any accessible codebase/s into AI-optimized knowledge on simple and complex flows | Find real implementations and live docs from anywhere

408. **[fetch-mcp](https://github.com/zcaceres/fetch-mcp)** - ⭐ 670
   A flexible HTTP fetching Model Context Protocol server.

409. **[mcp-server-docker](https://github.com/ckreiling/mcp-server-docker)** - ⭐ 668
   MCP server for Docker

410. **[clojure-mcp](https://github.com/bhauman/clojure-mcp)** - ⭐ 667
   Clojure MCP

411. **[llm-server-docs](https://github.com/varunvasudeva1/llm-server-docs)** - ⭐ 662
   End-to-end documentation to set up your own local & fully private LLM server on Debian. Equipped with chat, web search, RAG, model management, MCP servers, image generation, and TTS.

412. **[go-mcp](https://github.com/ThinkInAIXYZ/go-mcp)** - ⭐ 661
...
413. **[mcp-client-cli](https://github.com/adhikasp/mcp-client-cli)** - ⭐ 658
   A simple CLI to run LLM prompt and implement MCP client.

414. **[yacy_grid_mcp](https://github.com/yacy/yacy_grid_mcp)** - ⭐ 654
   The YaCy Grid Master Connect Program

415. **[mcp-clickhouse](https://github.com/ClickHouse/mcp-clickhouse)** - ⭐ 653
   Connect ClickHouse to your AI assistants.

416. **[annas-mcp](https://github.com/iosifache/annas-mcp)** - ⭐ 652
   MCP server and CLI tool for searching and downloading documents from Anna's Archive

417. **[android-mcp-server](https://github.com/minhalvp/android-mcp-server)** - ⭐ 646
   An MCP server that provides control over Android devices via adb

418. **[laravel-restify](https://github.com/BinarCode/laravel-restify)** - ⭐ 643
...
421. **[enrichmcp](https://github.com/featureform/enrichmcp)** - ⭐ 640
   EnrichMCP is a python framework for building data driven MCP servers

422. **[mcp](https://github.com/laravel/mcp)** - ⭐ 638
   Rapidly build MCP servers for your Laravel applications.

423. **[cuga-agent](https://github.com/cuga-project/cuga-agent)** - ⭐ 637
...
424. **[open-ptc-agent](https://github.com/Chen-zexi/open-ptc-agent)** - ⭐ 636
   An open source implementation of code execution with MCP (Programatic Tool Calling) 

425. **[mcp-mem0](https://github.com/coleam00/mcp-mem0)** - ⭐ 636
   MCP server for long term agent memory with Mem0. Also useful as a template to get you started building your own MCP server with Python!

426. **[python-utcp](https://github.com/universal-tool-calling-protocol/python-utcp)** - ⭐ 634
   Official python implementation of UTCP. UTCP is an open standard that lets AI agents call any API directly, without extra middleware.

427. **[RAGLight](https://github.com/Bessouat40/RAGLight)** - ⭐ 634
   RAGLight is a modular framework for Retrieval-Augmented Generation (RAG). It makes it easy to plug in different LLMs, embeddings, and vector stores, and now includes seamless MCP integration to connect external tools and data sources.

428. **[wcgw](https://github.com/rusiaaman/wcgw)** - ⭐ 632
   Shell and coding agent on mcp clients

429. **[awesome-mcp-security](https://github.com/Puliczek/awesome-mcp-security)** - ⭐ 629
   🔥🔒 Awesome MCP (Model Context Protocol) Security 🖥️

430. **[obsidian-mcp](https://github.com/StevenStavrakis/obsidian-mcp)** - ⭐ 622
   A simple MCP server for Obsidian

431. **[mcp-proxy](https://github.com/TBXark/mcp-proxy)** - ⭐ 619
   An MCP proxy server that aggregates and serves multiple MCP resource servers through a single HTTP server.

432. **[workers-mcp](https://github.com/cloudflare/workers-mcp)** - ⭐ 617
   Talk to a Cloudflare Worker from Claude Desktop!

433. **[gcloud-mcp](https://github.com/googleapis/gcloud-mcp)** - ⭐ 615
   gcloud MCP server

434. **[mcp_excalidraw](https://github.com/yctimlin/mcp_excalidraw)** - ⭐ 613

435. **[samples](https://github.com/strands-agents/samples)** - ⭐ 611
   Agent samples built using the Strands Agents SDK.

436. **[phpMyFAQ](https://github.com/thorsten/phpMyFAQ)** - ⭐ 610
   phpMyFAQ - Open Source FAQ web application for PHP 8.3+ and MySQL, PostgreSQL and other databases

437. **[mcp-google-sheets](https://github.com/xing5/mcp-google-sheets)** - ⭐ 604
   This MCP server integrates with your Google Drive and Google Sheets, to enable creating and modifying spreadsheets.

438. **[mem-agent-mcp](https://github.com/firstbatchxyz/mem-agent-mcp)** - ⭐ 599
   mem-agent mcp server

439. **[voicemode](https://github.com/mbailey/voicemode)** - ⭐ 597
   VoiceMode MCP brings natural conversations to Claude Code

440. **[mcp-server-elasticsearch](https://github.com/elastic/mcp-server-elasticsearch)** - ⭐ 596

441. **[awesome-web3-mcp-servers](https://github.com/demcp/awesome-web3-mcp-servers)** - ⭐ 594
...
442. **[FantasyPremierLeague](https://github.com/joreilly/FantasyPremierLeague)** - ⭐ 593
   Fantasy Premier League Kotlin/Compose Multiplatform sample 

443. **[vibe](https://github.com/mondaycom/vibe)** - ⭐ 590
   🎨 Vibe Design System - Official monday.com UI resources for application development in React.js

444. **[mcp-link](https://github.com/automation-ai-labs/mcp-link)** - ⭐ 590
...
446. **[yargi-mcp](https://github.com/saidsurucu/yargi-mcp)** - ⭐ 584
   MCP Server For Turkish Legal Databases

447. **[tome](https://github.com/runebookai/tome)** - ⭐ 583
   a magical LLM desktop client that makes it easy for *anyone* to use LLMs and MCP

448. **[a-share-mcp-is-just-i-need](https://github.com/24mlight/a-share-mcp-is-just-i-need)** - ⭐ 583

449. **[mcp-filesystem-server](https://github.com/mark3labs/mcp-filesystem-server)** - ⭐ 582
   Go server implementing Model Context Protocol (MCP) for filesystem operations.

450. **[daydreams](https://github.com/daydreamsai/daydreams)** - ⭐ 581
   Daydreams is a set of tools for building agents for commerce

451. **[blueprint-mcp](https://github.com/ArcadeAI/blueprint-mcp)** - ⭐ 574
   Diagram generation for understanding codebases and system architecture using Nano Banana Pro.

452. **[dexto](https://github.com/truffle-ai/dexto)** - ⭐ 574
   A general agent harness for building and orchestrating agentic applications.

453. **[FofaMap](https://github.com/asaotomo/FofaMap)** - ⭐ 574
...
454. **[telegram-mcp](https://github.com/chigwell/telegram-mcp)** - ⭐ 574
   Telegram MCP server powered by Telethon to let MCP clients read chats, manage groups, and send/modify messages, media, contacts, and settings.

455. **[langgraph-mcp](https://github.com/esxr/langgraph-mcp)** - ⭐ 571
   LangGraph solution template for MCP

456. **[obot](https://github.com/obot-platform/obot)** - ⭐ 563
   Complete MCP Platform -- Hosting, Registry, Gateway, and Chat Client

457. **[mem0-mcp](https://github.com/mem0ai/mem0-mcp)** - ⭐ 563

458. **[drawio-mcp-server](https://github.com/lgazo/drawio-mcp-server)** - ⭐ 560
   Draw.io Model Context Protocol (MCP) Server

459. **[macos-automator-mcp](https://github.com/steipete/macos-automator-mcp)** - ⭐ 557
   An MCP server to run AppleScript and JXA (JavaScript for Automation) to macOS.

460. **[mcp-pointer](https://github.com/etsd-tech/mcp-pointer)** - ⭐ 555
   MCP tool: let you point at DOM elements for your favorite agentic coding tool. Let AI see what you see.

461. **[spotify-mcp](https://github.com/varunneal/spotify-mcp)** - ⭐ 555
   MCP to connect your LLM with Spotify.

462. **[MCP-Nest](https://github.com/rekog-labs/MCP-Nest)** - ⭐ 555
   A NestJS module to effortlessly create Model Context Protocol (MCP) servers for exposing AI tools, resources, and prompts.

463. **[mcp-sequentialthinking-tools](https://github.com/spences10/mcp-sequentialthinking-tools)** - ⭐ 554
   🧠 An adaptation of the MCP Sequential Thinking Server to guide tool usage. This server provides recommendations for which MCP tools would be most effective at each stage.

464. **[mcpcan](https://github.com/Kymo-MCP/mcpcan)** - ⭐ 550
...
465. **[MCP-Universe](https://github.com/SalesforceAIResearch/MCP-Universe)** - ⭐ 545
   MCP-Universe is a comprehensive framework designed for developing, testing, and benchmarking AI agents

466. **[paper-search-mcp](https://github.com/openags/paper-search-mcp)** - ⭐ 544
   A MCP for searching and downloading academic papers from multiple sources like arXiv, PubMed, bioRxiv, etc.

467. **[mcp-shield](https://github.com/riseandignite/mcp-shield)** - ⭐ 543
   Security scanner for MCP servers

468. **[mcp-handler](https://github.com/vercel/mcp-handler)** - ⭐ 543
   Easily spin up an MCP Server on Next.js, Nuxt, Svelte, and more

469. **[manim-mcp-server](https://github.com/abhiemj/manim-mcp-server)** - ⭐ 541

470. **[vite-plugin-vue-mcp](https://github.com/webfansplz/vite-plugin-vue-mcp)** - ⭐ 536
   Vite plugin that enables a MCP server helping models to understand your Vue app better.

471. **[LLMTornado](https://github.com/lofcz/LLMTornado)** - ⭐ 536
...
473. **[mcp-server-neon](https://github.com/neondatabase/mcp-server-neon)** - ⭐ 533
   MCP server for interacting with Neon Management API and databases

474. **[obsidian-mcp-tools](https://github.com/jacksteamdev/obsidian-mcp-tools)** - ⭐ 533
   Add Obsidian integrations like semantic search and custom Templater prompts to Claude or any MCP client.

475. **[dolphin-mcp](https://github.com/QuixiAI/dolphin-mcp)** - ⭐ 532

476. **[pg-mcp-server](https://github.com/stuzero/pg-mcp-server)** - ⭐ 531

477. **[fastapi-mcp-langgraph-template](https://github.com/NicholasGoh/fastapi-mcp-langgraph-template)** - ⭐ 531
   A modern template for agentic orchestration — built for rapid iteration and scalable deployment using highly customizable, community-supported tools like MCP, LangGraph, and more.

478. **[douyin-mcp-server](https://github.com/yzfly/douyin-mcp-server)** - ⭐ 531
   提取抖音无水印视频链接，视频文案，douyin-mcp-server

479. **[mcp-for-security](https://github.com/cyproxio/mcp-for-security)** - ⭐ 530
   MCP for Security: A collection of Model Context Protocol servers for popular security tools like SQLMap, FFUF, NMAP, Masscan and more. Integrate security testing and penetration testing into AI workflows.

480. **[google-search](https://github.com/web-agent-master/google-search)** - ⭐ 529
   A Playwright-based Node.js tool that bypasses search engine anti-scraping mechanisms to execute Google searches. Local alternative to SERP APIs with MCP server integration.

481. **[wren-engine](https://github.com/Canner/wren-engine)** - ⭐ 529
   🤖 The Semantic Engine for Model Context Protocol(MCP) Clients and AI Agents 🔥 

482. **[multimodal-agents-course](https://github.com/the-ai-merge/multimodal-agents-course)** - ⭐ 525
   An MCP Multimodal AI Agent with eyes and ears!

483. **[next-devtools-mcp](https://github.com/vercel/next-devtools-mcp)** - ⭐ 525
   Next.js Development for Coding Agent

484. **[awesome-mcp-servers](https://github.com/TensorBlock/awesome-mcp-servers)** - ⭐ 523
   A comprehensive collection of Model Context Protocol (MCP) servers

485. **[brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server)** - ⭐ 523

486. **[echokit_server](https://github.com/second-state/echokit_server)** - ⭐ 522
   Open Source Voice Agent Platform

487. **[mcp-server-data-exploration](https://github.com/reading-plus-ai/mcp-server-data-exploration)** - ⭐ 521

488. **[mcp.el](https://github.com/lizqwerscott/mcp.el)** - ⭐ 520
   An Mcp client inside Emacs

489. **[cclsp](https://github.com/ktnyt/cclsp)** - ⭐ 520
   Claude Code LSP: enhance your Claude Code experience with non-IDE dependent LSP integration.

490. **[ethora](https://github.com/dappros/ethora)** - ⭐ 518
...
491. **[homeassistant-mcp](https://github.com/tevonsb/homeassistant-mcp)** - ⭐ 518
   A MCP server for Home Assistant

492. **[pgmcp](https://github.com/subnetmarco/pgmcp)** - ⭐ 517
   An MCP server to query any Postgres database in natural language.

493. **[cloud-run-mcp](https://github.com/GoogleCloudPlatform/cloud-run-mcp)** - ⭐ 516
   MCP server to deploy apps to Cloud Run

494. **[ghostcrew](https://github.com/GH05TCREW/ghostcrew)** - ⭐ 515
...
495. **[gateway](https://github.com/centralmind/gateway)** - ⭐ 514
...
498. **[CyberStrikeAI](https://github.com/Ed1s0nZ/CyberStrikeAI)** - ⭐ 512
   CyberStrikeAI is an AI-native security testing platform built in Go. It integrates 100+ security tools, an intelligent orchestration engine, role-based testing with predefined security roles, a skills system with specialized testing skills, and comprehensive lifecycle management capabilities.

499. **[apple-health-mcp](https://github.com/neiltron/apple-health-mcp)** - ⭐ 511
   MCP server for querying Apple Health data with natural language and SQL

500. **[iterm-mcp](https://github.com/ferrislucas/iterm-mcp)** - ⭐ 510
   A Model Context Protocol server that executes commands in the current iTerm session - useful for REPL and CLI assistance

501. **[multimodal-agents-course](https://github.com/multi-modal-ai/multimodal-agents-course)** - ⭐ 507
   An MCP Multimodal AI Agent with eyes and ears!

502. **[sentry-mcp](https://github.com/getsentry/sentry-mcp)** - ⭐ 507
   An MCP server for interacting with Sentry via LLMs.

503. **[mcp-server-weread](https://github.com/freestylefly/mcp-server-weread)** - ⭐ 506
   微信读书MCP

504. **[openapi-mcp-generator](https://github.com/harsha-iiiv/openapi-mcp-generator)** - ⭐ 502
   A tool that converts OpenAPI specifications to MCP server

505. **[mcp-get](https://github.com/michaellatman/mcp-get)** - ⭐ 502

506. **[apple-doc-mcp](https://github.com/MightyDillah/apple-doc-mcp)** - ⭐ 502
   MCP server providing seamless access to Apple Developer Documentation with smart search and wildcard support

507. **[mcp-server-bash-sdk](https://github.com/muthuishere/mcp-server-bash-sdk)** - ⭐ 501
   Yes Mcp server in bash

508. **[reverse-engineering-assistant](https://github.com/cyberkaida/reverse-engineering-assistant)** - ⭐ 500
   MCP server for reverse engineering tasks in Ghidra 👩‍💻

509. **[UnityMCP](https://github.com/jackwrichards/UnityMCP)** - ⭐ 495

510. **[awesome-a2a](https://github.com/ai-boost/awesome-a2a)** - ⭐ 495
   Agent2Agent (A2A) – awesome A2A agents, tools, servers & clients, all in one place.

511. **[PentestAgent](https://github.com/GH05TCREW/PentestAgent)** - ⭐ 493
...
516. **[mcp-client-for-ollama](https://github.com/jonigl/mcp-client-for-ollama)** - ⭐ 486
   A text-based user interface (TUI) client for interacting with MCP servers using Ollama. Features include agent mode, multi-server, model switching, streaming responses, tool management, human-in-the-loop, thinking mode, model params config, MCP prompts, custom system prompt and saved preferences. Built for developers working with local LLMs.

517. **[claude-debugs-for-you](https://github.com/jasonjmcghee/claude-debugs-for-you)** - ⭐ 483
   Enable any LLM (e.g. Claude) to interactively debug any language for you via MCP and a VS Code Extension

518. **[mcp-pandoc](https://github.com/vivekVells/mcp-pandoc)** - ⭐ 480
   MCP server for document format conversion using pandoc.

519. **[rails-mcp-server](https://github.com/maquina-app/rails-mcp-server)** - ⭐ 478
...
521. **[haiku.rag](https://github.com/ggozad/haiku.rag)** - ⭐ 476
   Opinionated agentic RAG powered by LanceDB, Pydantic AI, and Docling

522. **[mcp-gsuite](https://github.com/MarkusPfundstein/mcp-gsuite)** - ⭐ 472
...
525. **[AnyTool](https://github.com/HKUDS/AnyTool)** - ⭐ 469
   "AnyTool: Universal Tool-Use Layer for AI Agents"

526. **[davinci-resolve-mcp](https://github.com/samuelgursky/davinci-resolve-mcp)** - ⭐ 469
   MCP server integration for DaVinci Resolve

527. **[cli](https://github.com/smithery-ai/cli)** - ⭐ 468
   Install, manage and develop MCP servers

528. **[chroma-mcp](https://github.com/chroma-core/chroma-mcp)** - ⭐ 467
   A Model Context Protocol (MCP) server implementation that provides database capabilities for Chroma

529. **[llm-mcp-rag](https://github.com/KelvinQiu802/llm-mcp-rag)** - ⭐ 467
   LLM + MCP + RAG = Magic

530. **[laravel](https://github.com/php-mcp/laravel)** - ⭐ 465
   An SDK building Laravel MCP servers

531. **[n8n-workflow-builder](https://github.com/makafeli/n8n-workflow-builder)** - ⭐ 465
   AI assistant integration for n8n workflow automation through Model Context Protocol (MCP). Connect Claude Desktop, ChatGPT, and other AI assistants to n8n for natural language workflow management.

532. **[TuriX-CUA](https://github.com/TurixAI/TuriX-CUA)** - ⭐ 465
   This is the official website for TuriX Computer-use-Agent

533. **[borsa-mcp](https://github.com/saidsurucu/borsa-mcp)** - ⭐ 464
   MCP Server for Turkish & American Stock Exchange and Fund Data

534. **[talk-to-girlfriend-ai](https://github.com/arlanrakh/talk-to-girlfriend-ai)** - ⭐ 464
   im busy building ai agents so why not let an ai talk to my girlfriend? 

535. **[Mantic.sh](https://github.com/marcoaapfortes/Mantic.sh)** - ⭐ 463
   A structural code search engine for Al agents.

536. **[clickup-mcp-server](https://github.com/taazkareem/clickup-mcp-server)** - ⭐ 462
   ClickUp MCP Server - Integrate ClickUp project management with AI through Model Context Protocol

537. **[doctor](https://github.com/sisig-ai/doctor)** - ⭐ 461
   Doctor is a tool for discovering, crawl, and indexing web sites to be exposed as an MCP server for LLM agents.

538. **[deeppowers](https://github.com/deeppowers/deeppowers)** - ⭐ 460
...
539. **[copilot-mcp](https://github.com/VikashLoomba/copilot-mcp)** - ⭐ 460
...
540. **[freecad-mcp](https://github.com/neka-nat/freecad-mcp)** - ⭐ 460
   FreeCAD MCP(Model Context Protocol) server

541. **[atlas-mcp-server](https://github.com/cyanheads/atlas-mcp-server)** - ⭐ 458
   A Model Context Protocol (MCP) server for ATLAS, a Neo4j-powered task management system for LLM Agents - implementing a three-tier architecture (Projects, Tasks, Knowledge) to manage complex workflows. Now with Deep Research.

542. **[dbt-mcp](https://github.com/dbt-labs/dbt-mcp)** - ⭐ 457
   A MCP (Model Context Protocol) server for interacting with dbt.

543. **[argo](https://github.com/xark-argo/argo)** - ⭐ 457
   ARGO is an open-source AI Agent platform that brings Local Manus to your desktop. With one-click model downloads, seamless closed LLM integration, and offline-first RAG knowledge bases, ARGO becomes a DeepResearch powerhouse for autonomous thinking, task planning, and 100% of your data stays locally. Support Win/Mac/Docker.

544. **[web-search-mcp](https://github.com/mrkrsl/web-search-mcp)** - ⭐ 455
   A simple, locally hosted Web Search MCP server for use with Local LLMs

545. **[director](https://github.com/director-run/director)** - ⭐ 454
   MCP Playbooks for AI agents

546. **[vibe-check-mcp-server](https://github.com/PV-Bhat/vibe-check-mcp-server)** - ⭐ 452
   Vibe Check is a tool that provides mentor-like feedback to AI Agents, preventing tunnel-vision, over-engineering and reasoning lock-in for complex and long-horizon agent workflows. KISS your over-eager AI Agents goodbye! Effective for: Coding, Ambiguous Tasks, High-Risk tasks

547. **[alpaca-mcp-server](https://github.com/alpacahq/alpaca-mcp-server)** - ⭐ 451
   Alpaca’s official MCP Server lets you trade stocks, ETFs, crypto, and options, run data analysis, and build strategies in plain English directly from your favorite LLM tools and IDEs

548. **[MCP-Kali-Server](https://github.com/Wh0am123/MCP-Kali-Server)** - ⭐ 449
   MCP configuration to connect AI agent to a Linux machine.

549. **[flux-operator](https://github.com/controlplaneio-fluxcd/flux-operator)** - ⭐ 448
   GitOps on Autopilot Mode

550. **[nexus](https://github.com/Nexus-Router/nexus)** - ⭐ 447
   Govern & Secure your AI

551. **[notebooklm-mcp](https://github.com/PleasePrompto/notebooklm-mcp)** - ⭐ 447
   MCP server for NotebookLM - Let your AI agents (Claude Code, Codex) research documentation directly with grounded, citation-backed answers from Gemini. Persistent auth, library management, cross-client sharing. Zero hallucinations, just your knowledge base.

552. **[nexus](https://github.com/grafbase/nexus)** - ⭐ 446
   Govern & Secure your AI

553. **[nexus](https://github.com/nexus-ai-labs/nexus)** - ⭐ 446
   Govern & Secure your AI

554. **[adb-mcp](https://github.com/mikechambers/adb-mcp)** - ⭐ 444

555. **[mcp-remote-macos-use](https://github.com/baryhuang/mcp-remote-macos-use)** - ⭐ 444
   The only general AI agent that does NOT requires extra API key, giving you full control on your local and remote MacOs from Claude Desktop App

556. **[docker-mcp](https://github.com/QuantGeekDev/docker-mcp)** - ⭐ 443
   A docker MCP Server (modelcontextprotocol)

557. **[minecraft-mcp-server](https://github.com/yuniko-software/minecraft-mcp-server)** - ⭐ 443
   A Minecraft MCP Server powered by Mineflayer API. It allows to control a Minecraft character in real-time, allowing AI assistants to build structures, explore the world, and interact with the game environment through natural language instruction

558. **[mcpe](https://github.com/ReMinecraftPE/mcpe)** - ⭐ 439
   ReMinecraftPE - A custom experience based on Minecraft PE as of 2011.

559. **[mcp-server-youtube-transcript](https://github.com/kimtaeyoon83/mcp-server-youtube-transcript)** - ⭐ 439
   This is an MCP server that allows you to directly download transcripts of YouTube videos.

560. **[pdf-reader-mcp](https://github.com/SylphxAI/pdf-reader-mcp)** - ⭐ 436
   📄 Production-ready MCP server for PDF processing - 5-10x faster with parallel processing and 94%+ test coverage

561. **[MCP-Zero](https://github.com/xfey/MCP-Zero)** - ⭐ 435
   MCP-Zero: Active Tool Discovery for Autonomous LLM Agents

562. **[mcp-adapter](https://github.com/WordPress/mcp-adapter)** - ⭐ 435
...
565. **[mcp-security](https://github.com/google/mcp-security)** - ⭐ 428

566. **[tsidp](https://github.com/tailscale/tsidp)** - ⭐ 428
...
569. **[ai-trader](https://github.com/whchien/ai-trader)** - ⭐ 424
   Backtrader-powered backtesting framework for algorithmic trading, featuring 20+ strategies, multi-market support, CLI tools, and an integrated MCP server for professional traders.

570. **[Godot-MCP](https://github.com/ee0pdt/Godot-MCP)** - ⭐ 423
   An MCP for Godot that lets you create and edit games in the Godot game engine with tools like Claude

571. **[archestra](https://github.com/archestra-ai/archestra)** - ⭐ 423
   Enterprise-ready MCP gateway, MCP registry & orchestrator

572. **[MetasploitMCP](https://github.com/GH05TCREW/MetasploitMCP)** - ⭐ 423
   MCP Server for Metasploit

573. **[kratos-transport](https://github.com/tx7do/kratos-transport)** - ⭐ 421
   kratos transport layer extension, support: rabbitmq,kafka,rocketmq,activemq,apollo,mcp,tcp,websocket...

574. **[mcp-gateway](https://github.com/microsoft/mcp-gateway)** - ⭐ 421
   MCP Gateway is a reverse proxy and management layer for MCP servers, enabling scalable, session-aware stateful routing and lifecycle management of MCP servers in Kubernetes environments.

575. **[joinly](https://github.com/joinly-ai/joinly)** - ⭐ 420
   Make your meetings accessible to AI Agents

576. **[xhs-mcp](https://github.com/jobsonlook/xhs-mcp)** - ⭐ 420
   小红书MCP服务 x-s x-t js逆向

577. **[mcp-server-spec-driven-development](https://github.com/formulahendry/mcp-server-spec-driven-development)** - ⭐ 419
   Spec-Driven Development MCP Server, not just Vibe Coding

578. **[mcpstore](https://github.com/whillhill/mcpstore)** - ⭐ 419
   开盒即用的优雅管理mcp服务 | 结合Agent框架 | 作者听劝 | 已发布pypi | Vue页面demo 

579. **[mcp-hub](https://github.com/ravitemer/mcp-hub)** - ⭐ 419
   A centralized manager for Model Context Protocol (MCP) servers with dynamic server management and monitoring

580. **[meta-ads-mcp](https://github.com/pipeboard-co/meta-ads-mcp)** - ⭐ 416
   MCP server to manage Facebook and Instagram Ads (Meta Ads)

581. **[antigravity-awesome-skills](https://github.com/sickn33/antigravity-awesome-skills)** - ⭐ 416
...
582. **[mcpadapt](https://github.com/grll/mcpadapt)** - ⭐ 415
   Unlock 650+ MCP servers tools in your favorite agentic framework.

583. **[learn-low-code-agentic-ai](https://github.com/panaversity/learn-low-code-agentic-ai)** - ⭐ 414
...
584. **[MCP](https://github.com/jina-ai/MCP)** - ⭐ 413
   Official Jina AI Remote MCP Server

585. **[AgentX](https://github.com/lucky-aeon/AgentX)** - ⭐ 412
   AgentX 致力于让小白也能无门槛通过自然语言打造属于自己的 Agent。AgentX 采用了自研 MCP 网关，模型高可用组件打造高可用

586. **[shinkai-local-ai-agents](https://github.com/dcSpark/shinkai-local-ai-agents)** - ⭐ 407
...
587. **[awesome-mcp-devtools](https://github.com/punkpeye/awesome-mcp-devtools)** - ⭐ 406
   A curated list of developer tools, SDKs, libraries, and testing utilities for Model Context Protocol (MCP) server development.

588. **[applescript-mcp](https://github.com/peakmojo/applescript-mcp)** - ⭐ 406
   MCP server that execute applescript giving you full control of your Mac

589. **[mcp-cli](https://github.com/wong2/mcp-cli)** - ⭐ 405
   A CLI inspector for the Model Context Protocol

590. **[NetCoreKevin](https://github.com/junkai-li/NetCoreKevin)** - ⭐ 405
...
591. **[kmcp](https://github.com/kagent-dev/kmcp)** - ⭐ 403
   CLI tool and Kubernetes Controller for building, testing and deploying MCP servers

592. **[azure-ai-travel-agents](https://github.com/Azure-Samples/azure-ai-travel-agents)** - ⭐ 403
...
593. **[RestClient.Net](https://github.com/MelbourneDeveloper/RestClient.Net)** - ⭐ 401
   The safest way to make REST calls in C# with an MCP Generator

594. **[mcp-registry](https://github.com/docker/mcp-registry)** - ⭐ 400
   Official Docker MCP registry 

595. **[GhidrAssistMCP](https://github.com/jtang613/GhidrAssistMCP)** - ⭐ 400
   An MCP extension for Ghidra

596. **[mcp-nixos](https://github.com/utensils/mcp-nixos)** - ⭐ 400
   MCP-NixOS - Model Context Protocol Server for NixOS resources

597. **[sdk-typescript](https://github.com/strands-agents/sdk-typescript)** - ⭐ 400
   A model-driven approach to building AI agents in just a few lines of code. 

598. **[CoexistAI](https://github.com/SPThole/CoexistAI)** - ⭐ 398
   CoexistAI is a modular, developer-friendly research assistant framework . It enables you to build, search, summarize, and automate research workflows using LLMs, web search, Reddit, YouTube, and mapping tools—all with simple MCP tool calls or API calls or Python functions. 

599. **[ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server)** - ⭐ 398
   A Model Context Protocol (MCP) server for interacting with Microsoft 365 and Office services through the Graph API

600. **[mcp-searxng](https://github.com/ihor-sokoliuk/mcp-searxng)** - ⭐ 395
   MCP Server for SearXNG

601. **[biomcp](https://github.com/genomoncology/biomcp)** - ⭐ 395
   BioMCP: Biomedical Model Context Protocol

602. **[mcp-server-motherduck](https://github.com/motherduckdb/mcp-server-motherduck)** - ⭐ 394
   MCP server for DuckDB and MotherDuck

603. **[Software-planning-mcp](https://github.com/NightTrek/Software-planning-mcp)** - ⭐ 393
   An experiment in software planning using MCP

604. **[mcp-redis](https://github.com/redis/mcp-redis)** - ⭐ 391
   The official Redis MCP Server is a natural language interface designed for agentic applications to manage and search data in Redis efficiently

605. **[airtable-mcp-server](https://github.com/domdomegg/airtable-mcp-server)** - ⭐ 390
   🗂️🤖 Airtable Model Context Protocol Server, for allowing AI systems to interact with your Airtable bases

606. **[mcp](https://github.com/baidu-maps/mcp)** - ⭐ 389
   Baidu Map MCP Server

607. **[notebooklm-mcp](https://github.com/jacob-bd/notebooklm-mcp)** - ⭐ 389

608. **[memento-mcp](https://github.com/gannonh/memento-mcp)** - ⭐ 387
   Memento MCP: A Knowledge Graph Memory System for LLMs

609. **[chatluna](https://github.com/ChatLunaLab/chatluna)** - ⭐ 386
...
610. **[cocos-mcp-server](https://github.com/DaxianLee/cocos-mcp-server)** - ⭐ 386
...
611. **[bm.md](https://github.com/miantiao-me/bm.md)** - ⭐ 386
   更好用的 Markdown 排版助手｜一键适配微信公众号、网页与图片。

612. **[mcp-alchemy](https://github.com/runekaagaard/mcp-alchemy)** - ⭐ 385
   A MCP (model context protocol) server that gives the LLM access to and knowledge about relational databases like SQLite, Postgresql, MySQL & MariaDB, Oracle, and MS-SQL.

613. **[lunar](https://github.com/TheLunarCompany/lunar)** - ⭐ 384
   lunar.dev: Agent native MCP Gateway for governance and security

614. **[docfork](https://github.com/docfork/docfork)** - ⭐ 384
   Docfork - Up-to-date Docs for AI Agents.

615. **[mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry)** - ⭐ 383
...
616. **[FinanceMCP](https://github.com/guangxiangdebizi/FinanceMCP)** - ⭐ 383
...
617. **[groq-desktop-beta](https://github.com/groq/groq-desktop-beta)** - ⭐ 381
   Local Groq Desktop chat app with MCP support

618. **[ai4j](https://github.com/LnYo-Cly/ai4j)** - ⭐ 380
...
619. **[mcp-hfspace](https://github.com/evalstate/mcp-hfspace)** - ⭐ 378
   MCP Server to Use HuggingFace spaces, easy configuration and Claude Desktop mode. 

620. **[MCP-SecurityTools](https://github.com/Ta0ing/MCP-SecurityTools)** - ⭐ 377
   MCP-SecurityTools 是一个专注于收录和更新网络安全领域 MCP 的开源项目，旨在汇总、整理和优化各类与 MCP 相关的安全工具、技术及实战经验。

621. **[station](https://github.com/cloudshipai/station)** - ⭐ 377
   Station is our open-source runtime that lets teams deploy agents on their own infrastructure with full control.

622. **[labs-ai-tools-for-devs](https://github.com/docker/labs-ai-tools-for-devs)** - ⭐ 374
   Your trusted home for discovering MCP tools – seamlessly integrated into Docker

623. **[codexia](https://github.com/milisp/codexia)** - ⭐ 374
   A powerfull GUI and Toolkit for Codex CLI + Claude Code. FileTree + prompt notepad + git worktree and more

624. **[mcp-code-graph](https://github.com/JudiniLabs/mcp-code-graph)** - ⭐ 373
   MCP Server for code graph analysis and visualization by CodeGPT

625. **[docfork-mcp](https://github.com/docfork/docfork-mcp)** - ⭐ 372
   Docfork MCP - Up-to-date Docs for AI Agents.

626. **[minion-agent](https://github.com/femto/minion-agent)** - ⭐ 372
   A simple agent framework that's capable of browser use + mcp + auto instrument + plan + deep  research + more

627. **[Anemoi](https://github.com/Coral-Protocol/Anemoi)** - ⭐ 371
   Anemoi: A Semi-Centralized Multi-agent Systems Based on Agent-to-Agent Communication MCP server from Coral Protocol

628. **[claude-codepro](https://github.com/maxritter/claude-codepro)** - ⭐ 370
...
629. **[bagel](https://github.com/Extelligence-ai/bagel)** - ⭐ 370
   Chat with your robotics, drone, and IoT data — ChatGPT for the physical world.

630. **[mcp-mermaid](https://github.com/hustcc/mcp-mermaid)** - ⭐ 370
   ❤️ Generate mermaid diagram and chart with AI MCP dynamically.

631. **[docling-mcp](https://github.com/docling-project/docling-mcp)** - ⭐ 370
   Making docling agentic through MCP

632. **[mcp-server](https://github.com/e2b-dev/mcp-server)** - ⭐ 369
   Giving Claude ability to run code with E2B via MCP (Model Context Protocol)

633. **[agent-builder](https://github.com/strands-agents/agent-builder)** - ⭐ 369
   An example agent demonstrating streaming, tool use, and interactivity from your terminal. This agent builder can help you to build your own agents and tools.

634. **[kicad-mcp](https://github.com/lamaalrajih/kicad-mcp)** - ⭐ 369
   Model Context Protocol server for KiCad on Mac, Windows, and Linux

635. **[mcp-k8s-go](https://github.com/strowk/mcp-k8s-go)** - ⭐ 368
   MCP server connecting to Kubernetes

636. **[graphlit-mcp-server](https://github.com/graphlit/graphlit-mcp-server)** - ⭐ 368
   Model Context Protocol (MCP) Server for Graphlit Platform

637. **[lark-openapi-mcp](https://github.com/larksuite/lark-openapi-mcp)** - ⭐ 368
   飞书/Lark官方 OpenAPI MCP

638. **[Agentfy](https://github.com/Agentfy-io/Agentfy)** - ⭐ 366
...
639. **[mnemo](https://github.com/MnemoAI/mnemo)** - ⭐ 365
   A MCP-Ready Intelligence Engine for Data & Agent-as-a-Service.

640. **[mineru-tianshu](https://github.com/magicyuan876/mineru-tianshu)** - ⭐ 365
   天枢 - 企业级 AI 一站式数据预处理平台 | PDF/Office转Markdown | 支持MCP协议AI助手集成 | Vue3+FastAPI全栈方案 | 文档解析 | 多模态信息提取

641. **[mcpmark](https://github.com/eval-sys/mcpmark)** - ⭐ 364
   MCPMark is a comprehensive, stress-testing MCP benchmark designed to evaluate model and agent capabilities in real-world MCP use.

642. **[Redbook-Search-Comment-MCP2.0](https://github.com/chenningling/Redbook-Search-Comment-MCP2.0)** - ⭐ 363
...
643. **[mcp-google-ads](https://github.com/cohnen/mcp-google-ads)** - ⭐ 363
   An MCP tool that connects Google Ads with Claude AI/Cursor and others, allowing you to analyze your advertising data through natural language conversations. This integration gives you access to campaign information, performance metrics, keyword analytics, and ad management—all through simple chat with Claude, Cursor or Windsurf.

644. **[mcp-server-airbnb](https://github.com/openbnb-org/mcp-server-airbnb)** - ⭐ 363
   Search Airbnb using your AI Agent

645. **[UnrealGenAISupport](https://github.com/prajwalshettydev/UnrealGenAISupport)** - ⭐ 362
...
646. **[mcp-sdk-php](https://github.com/logiscape/mcp-sdk-php)** - ⭐ 361
   Model Context Protocol SDK for PHP

647. **[yutu](https://github.com/eat-pray-ai/yutu)** - ⭐ 361
   A fully functional MCP server and CLI for YouTube

648. **[nuwax](https://github.com/nuwax-ai/nuwax)** - ⭐ 361
...
649. **[mcp](https://github.com/mondaycom/mcp)** - ⭐ 360
   Enable AI agents to work reliably - giving them secure access to structured data, tools to take action, and the context needed to make smart decisions.

650. **[puppeteer-mcp-server](https://github.com/merajmehrabi/puppeteer-mcp-server)** - ⭐ 359
   This MCP server provides browser automation capabilities through Puppeteer, allowing interaction with both new browser instances and existing Chrome windows.

651. **[MCPSharp](https://github.com/afrise/MCPSharp)** - ⭐ 357
   MCPSharp is a .NET library that helps you build Model Context Protocol (MCP) servers and clients - the standardized API protocol used by AI assistants and models.

652. **[Feishu-MCP](https://github.com/cso1z/Feishu-MCP)** - ⭐ 357
   为 Cursor、Windsurf、Cline 和其他 AI 驱动的编码工具提供访问、编辑和结构化处理飞书文档的能力，基于 Model Context Protocol 服务器实现。

653. **[pokemon-chat](https://github.com/skygazer42/pokemon-chat)** - ⭐ 356
   基于 LightRAG、LangGraph、MCP、RagFlow、微调LLMs宝可梦主题的专有领域智能聊天助手

654. **[evm-mcp-server](https://github.com/mcpdotdirect/evm-mcp-server)** - ⭐ 356
   MCP server that provides LLMs with tools for interacting with EVM networks

655. **[automation-mcp](https://github.com/ashwwwin/automation-mcp)** - ⭐ 355
   Control your Mac with detailed mouse, keyboard, screen, and window management capabilities.

656. **[claude-codex-settings](https://github.com/fcakyon/claude-codex-settings)** - ⭐ 355
   My personal Claude Code and OpenAI Codex setup with battle-tested skills, commands, hooks, agents and MCP servers that I use daily.

657. **[mcp2mqtt](https://github.com/mcp2everything/mcp2mqtt)** - ⭐ 354
   本项目通过将 MCP 协议转换为 MQTT 协议，我们能够利用强大的大型语言模型（LLMs），就能轻松操控您的智能家居、机器人或其他硬件设备。

658. **[home-assistant-vibecode-agent](https://github.com/Coolver/home-assistant-vibecode-agent)** - ⭐ 354
...
659. **[lanhu-mcp](https://github.com/dsphper/lanhu-mcp)** - ⭐ 354
   ⚡ 需求分析效率提升 200%！全球首个为 AI 编程时代设计的团队协作 MCP 服务器，自动分析需求自动编写前后端代码，下载切图

660. **[prism-insight](https://github.com/dragon1086/prism-insight)** - ⭐ 353
   AI-based stock analysis and trading system

661. **[applescript-mcp](https://github.com/joshrutkowski/applescript-mcp)** - ⭐ 351
   A macOS AppleScript MCP server

662. **[tfmcp](https://github.com/nwiizo/tfmcp)** - ⭐ 350
   🌍 Terraform Model Context Protocol (MCP) Tool - An experimental CLI tool that enables AI assistants to manage and operate Terraform environments. Supports reading Terraform configurations, analyzing plans, applying configurations, and managing state with Claude Desktop integration. ⚡️

663. **[todoist-mcp-server](https://github.com/abhiz123/todoist-mcp-server)** - ⭐ 350
   MCP server for Todoist integration enabling natural language task management with Claude

664. **[mcpr](https://github.com/conikeec/mcpr)** - ⭐ 349
   Model Context Protocol (MCP) implementation in Rust

665. **[ableton-live-mcp-server](https://github.com/Simon-Kansara/ableton-live-mcp-server)** - ⭐ 349
   MCP Server implementation for Ableton Live OSC control

666. **[edgeone-pages-mcp](https://github.com/TencentEdgeOne/edgeone-pages-mcp)** - ⭐ 349
   An MCP service designed for deploying HTML content to EdgeOne Pages and obtaining an accessible public URL.

667. **[mcp-graphql](https://github.com/blurrah/mcp-graphql)** - ⭐ 348
   Model Context Protocol server for GraphQL

668. **[sonarqube-mcp-server](https://github.com/SonarSource/sonarqube-mcp-server)** - ⭐ 348
   SonarQube MCP Server

669. **[mcp-teams-server](https://github.com/InditexTech/mcp-teams-server)** - ⭐ 347
   An MCP (Model Context Protocol) server implementation for Microsoft Teams integration, providing capabilities to read messages, create messages, reply to messages, mention members.

670. **[agent](https://github.com/1mcp-app/agent)** - ⭐ 347
   A unified Model Context Protocol server implementation that aggregates multiple MCP servers into one.

671. **[f2c-mcp](https://github.com/f2c-ai/f2c-mcp)** - ⭐ 346
   F2C MCP Server

672. **[xcode-mcp-server](https://github.com/r-huijts/xcode-mcp-server)** - ⭐ 346
   MCP Server implementation for Xcode integration

673. **[awesome-claude-code-plugins](https://github.com/ccplugins/awesome-claude-code-plugins)** - ⭐ 346
   Awesome Claude Code plugins — a curated list of slash commands, subagents, MCP servers, and hooks for Claude Code

674. **[reddit-mcp-buddy](https://github.com/karanb192/reddit-mcp-buddy)** - ⭐ 343
   Clean, LLM-optimized Reddit MCP server. Browse posts, search content, analyze users. No fluff, just Reddit data.

675. **[run-model-context-protocol-servers-with-aws-lambda](https://github.com/awslabs/run-model-context-protocol-servers-with-aws-lambda)** - ⭐ 343
   Run existing Model Context Protocol (MCP) stdio-based servers in AWS Lambda functions

676. **[twitter-mcp](https://github.com/EnesCinr/twitter-mcp)** - ⭐ 343
   A Model Context Protocol server allows to interact with Twitter, enabling posting tweets and searching Twitter.

677. **[Construction-Hazard-Detection](https://github.com/yihong1120/Construction-Hazard-Detection)** - ⭐ 342
   Enhances construction site safety using YOLO for object detection, identifying hazards like workers without helmets or safety vests, and proximity to machinery or vehicles. HDBSCAN clusters safety cone coordinates to create monitored zones. Post-processing algorithms improve detection accuracy.

678. **[linear-mcp-server](https://github.com/jerhadf/linear-mcp-server)** - ⭐ 342
   A server that integrates Linear's project management system with the Model Context Protocol (MCP) to allow LLMs to interact with Linear.

679. **[CodeGraphContext](https://github.com/CodeGraphContext/CodeGraphContext)** - ⭐ 342
   An MCP server plus a CLI tool that indexes local code into a graph database to provide context to AI assistants.

680. **[agentscope-runtime](https://github.com/agentscope-ai/agentscope-runtime)** - ⭐ 342
...
681. **[gemini-flow](https://github.com/clduab11/gemini-flow)** - ⭐ 341
   rUv's Claude-Flow, translated to the new Gemini CLI; transforming it into an autonomous AI development team.

682. **[mcp-obsidian](https://github.com/bitbonsai/mcp-obsidian)** - ⭐ 341
   A lightweight Model Context Protocol (MCP) server for safe Obsidian vault access

683. **[unreal-engine-mcp](https://github.com/flopperam/unreal-engine-mcp)** - ⭐ 341
...
684. **[prometheus-mcp-server](https://github.com/pab1it0/prometheus-mcp-server)** - ⭐ 340
   A Model Context Protocol (MCP) server that enables AI agents and LLMs to query and analyze Prometheus metrics through standardized interfaces.

685. **[daan](https://github.com/pluveto/daan)** - ⭐ 339
   ✨Lightweight LLM Client with MCP 🔌 & Characters 👤

686. **[RetroMCP-Java](https://github.com/MCPHackers/RetroMCP-Java)** - ⭐ 339
   A rewrite of MCP to provide support for many versions of Minecraft which were never supported by original MCP

687. **[a2a-directory](https://github.com/sing1ee/a2a-directory)** - ⭐ 338
   Agent2Agent (A2A) – AgentCards, Servers, Clients, Docs

688. **[db-mcp-server](https://github.com/FreePeak/db-mcp-server)** - ⭐ 337
   A powerful multi-database server implementing the Model Context Protocol (MCP) to provide AI assistants with structured access to databases.

689. **[awesome-cursor-mpc-server](https://github.com/kleneway/awesome-cursor-mpc-server)** - ⭐ 337
   Example of an MCP server with custom tools that can be called directly from cursor

690. **[base-mcp](https://github.com/base/base-mcp)** - ⭐ 337
   A Model Context Protocol (MCP) server that provides onchain tools for LLMs, allowing them to interact with the Base network and Coinbase API.

691. **[devtools-debugger-mcp](https://github.com/ScriptedAlchemy/devtools-debugger-mcp)** - ⭐ 336
   An MCP server exposing full Chrome DevTools Protocol debugging: breakpoints, step/run, call stacks, eval, and source maps.

692. **[devopness](https://github.com/devopness/devopness)** - ⭐ 335
   DevOps Happiness: 1-click or 1-prompt MCP. Deploy apps + infra + CI/CD on your cloud. Happy humans + reliable agents. 🚀

693. **[mcp-reddit](https://github.com/adhikasp/mcp-reddit)** - ⭐ 334
   A Model Context Protocol (MCP) server that provides tools for fetching and analyzing Reddit content.

694. **[mcp-gateway](https://github.com/lasso-security/mcp-gateway)** - ⭐ 334
   A plugin-based gateway that orchestrates other MCPs and allows developers to build upon it enterprise-grade agents.

695. **[mcp-for-next.js](https://github.com/vercel-labs/mcp-for-next.js)** - ⭐ 334

696. **[WebMCP](https://github.com/jasonjmcghee/WebMCP)** - ⭐ 333
...
697. **[mcp-apple-notes](https://github.com/RafalWilinski/mcp-apple-notes)** - ⭐ 332
   Talk with your notes in Claude. RAG over your Apple Notes using Model Context Protocol.

698. **[paws-on-mcp](https://github.com/hemanth/paws-on-mcp)** - ⭐ 332
   A comprehensive Model Context Protocol (MCP) server implementing the latest specification.

699. **[droidmind](https://github.com/hyperb1iss/droidmind)** - ⭐ 332
   Control your Android devices with AI using Model Context Protocol

700. **[CodeGraphContext](https://github.com/Shashankss1205/CodeGraphContext)** - ⭐ 331
   An MCP server plus a CLI tool that indexes local code into a graph database to provide context to AI assistants.

701. **[hermes-mcp](https://github.com/cloudwalk/hermes-mcp)** - ⭐ 331
   Elixir Model Context Protocol (MCP) SDK

702. **[interactive-mcp](https://github.com/ttommyth/interactive-mcp)** - ⭐ 330
   Vibe coding should have human in the loop! interactive-mcp: Local, cross-platform MCP server for interact with your AI Agent

703. **[obsidian-mcp-server](https://github.com/cyanheads/obsidian-mcp-server)** - ⭐ 330
   Obsidian Knowledge-Management MCP (Model Context Protocol) server that enables AI agents and development tools to interact with an Obsidian vault. It provides a comprehensive suite of tools for reading, writing, searching, and managing notes, tags, and frontmatter, acting as a bridge to the Obsidian Local REST API plugin.

704. **[mcp-selenium](https://github.com/angiejones/mcp-selenium)** - ⭐ 329
   An MCP implementation for Selenium WebDriver

705. **[BloodHound-MCP-AI](https://github.com/MorDavid/BloodHound-MCP-AI)** - ⭐ 329
   BloodHound-MCP-AI is integration that connects BloodHound with AI through Model Context Protocol, allowing security professionals to analyze Active Directory attack paths using natural language instead of complex Cypher queries.

706. **[revit-mcp](https://github.com/revit-mcp/revit-mcp)** - ⭐ 329
   AI-Powered Revit Modeling

707. **[OpenContext](https://github.com/0xranx/OpenContext)** - ⭐ 329
...
708. **[laravel-mcp-server](https://github.com/opgginc/laravel-mcp-server)** - ⭐ 327
   A Laravel package for implementing secure Model Context Protocol servers using Streamable HTTP and SSE transport, providing real-time communication and a scalable tool system for enterprise environments.

709. **[WireMCP](https://github.com/0xKoda/WireMCP)** - ⭐ 327
   An MCP for WireShark (tshark). Empower LLM's with realtime network traffic analysis capability

710. **[MemoryMesh](https://github.com/CheMiguel23/MemoryMesh)** - ⭐ 326
   A knowledge graph server that uses the Model Context Protocol (MCP) to provide structured memory persistence for AI models.

711. **[css-mcp](https://github.com/stolinski/css-mcp)** - ⭐ 326

712. **[open-mcp](https://github.com/wegotdocs/open-mcp)** - ⭐ 325

713. **[mcp-calculator](https://github.com/78/mcp-calculator)** - ⭐ 325
   Xiaozhi MCP sample program

714. **[skillz](https://github.com/intellectronica/skillz)** - ⭐ 325
   An MCP server for loading skills (shim for non-claude clients).

715. **[mcsmcp](https://github.com/microsoft/mcsmcp)** - ⭐ 324
   Lab for creating an MCP Server and using it in Microsoft Copilot Studio.

716. **[Ace-Mcp-Node](https://github.com/yeuxuan/Ace-Mcp-Node)** - ⭐ 323
...
717. **[Rube](https://github.com/ComposioHQ/Rube)** - ⭐ 322
...
718. **[moling](https://github.com/gojue/moling)** - ⭐ 321
   MoLing is a computer-use and browser-use based MCP server. It is a locally deployed, dependency-free office AI assistant.

719. **[mcp-server-azure-devops](https://github.com/Tiberriver256/mcp-server-azure-devops)** - ⭐ 319
   An MCP server for Azure DevOps

720. **[Minecraft-Hack-BaseClient](https://github.com/OxideWaveLength/Minecraft-Hack-BaseClient)** - ⭐ 318
   This is a Minecraft Base Client

721. **[tradingview-mcp](https://github.com/atilaahmettaner/tradingview-mcp)** - ⭐ 318
...
722. **[mcp](https://github.com/IBM/mcp)** - ⭐ 317
   A collection of Model Context Protocol (MCP) servers, clients and developer tools by IBM.

723. **[vscode-mcp-server](https://github.com/juehang/vscode-mcp-server)** - ⭐ 317
   MCP server to expose VS Code editing features to an LLM for AI coding

724. **[Android-MCP](https://github.com/CursorTouch/Android-MCP)** - ⭐ 316
   Lightweight MCP Server for interacting with Android Operating System.

725. **[abcoder](https://github.com/cloudwego/abcoder)** - ⭐ 315
   deep, reliable and confidential coding-context

726. **[emcee](https://github.com/mattt/emcee)** - ⭐ 314
   MCP generator for OpenAPIs 🫳🎤💥

727. **[langconnect-client](https://github.com/teddynote-lab/langconnect-client)** - ⭐ 314
   A Modern GUI Interface for Vector Database Management(Supports MCP integration)

728. **[agentcontrolplane](https://github.com/humanlayer/agentcontrolplane)** - ⭐ 314
...
729. **[ClimateTraceKMP](https://github.com/joreilly/ClimateTraceKMP)** - ⭐ 313
   Kotlin/Compose Multiplatform project to show climate related emission data from https://climatetrace.org/data.

730. **[autogenstudio-skills](https://github.com/madtank/autogenstudio-skills)** - ⭐ 312
   Repo of skills for autogen studio using model context protocol (mcp)

731. **[mesh](https://github.com/decocms/mesh)** - ⭐ 312
   One secure endpoint for every MCP server. Deploy anywhere.

732. **[mcp-servers-hub](https://github.com/apappascs/mcp-servers-hub)** - ⭐ 311
   Discover the most comprehensive and up-to-date collection of MCP servers in the market. This repository serves as a centralized hub, offering an extensive catalog of open-source and proprietary MCP servers, complete with features, documentation links, and contributors.

733. **[powerbi-modeling-mcp](https://github.com/microsoft/powerbi-modeling-mcp)** - ⭐ 310
   The Power BI Modeling MCP Server, brings Power BI semantic modeling capabilities to your AI agents.

734. **[gptr-mcp](https://github.com/assafelovic/gptr-mcp)** - ⭐ 308
   MCP server for enabling LLM applications to perform deep research via the MCP protocol

735. **[open-skills](https://github.com/instavm/open-skills)** - ⭐ 306
   OpenSkills: Run Claude Skills Locally using any LLM

736. **[code-sandbox-mcp](https://github.com/Automata-Labs-team/code-sandbox-mcp)** - ⭐ 304
   An MCP server to create secure code sandbox environment for executing code within Docker containers. This MCP server provides AI applications with a safe and isolated environment for running code while maintaining security through containerization.

737. **[maverick-mcp](https://github.com/wshobson/maverick-mcp)** - ⭐ 304
   MaverickMCP - Personal Stock Analysis MCP Server

738. **[mcp-sse](https://github.com/sidharthrajaram/mcp-sse)** - ⭐ 303
   A working pattern for SSE-based MCP clients and servers

739. **[mcp-server](https://github.com/mapbox/mcp-server)** - ⭐ 303
   Mapbox Model Context Protocol (MCP) server

740. **[mcprouter](https://github.com/chatmcp/mcprouter)** - ⭐ 303
   api router for MCP Servers

741. **[tinystruct](https://github.com/tinystruct/tinystruct)** - ⭐ 303
...
742. **[mcp-aktools](https://github.com/aahl/mcp-aktools)** - ⭐ 303
   📈 提供股票、加密货币的数据查询和分析功能MCP服务器

743. **[openmcp](https://github.com/getdatanaut/openmcp)** - ⭐ 302
   Turn any openapi file into an mcp server, with just the tools you need.

744. **[automcp](https://github.com/NapthaAI/automcp)** - ⭐ 301
   Easily convert tool, agents and orchestrators from existing agent frameworks to MCP servers

745. **[one-mcp](https://github.com/burugo/one-mcp)** - ⭐ 301
...
746. **[claude-talk-to-figma-mcp](https://github.com/arinspunk/claude-talk-to-figma-mcp)** - ⭐ 301
...
747. **[mcp-for-argocd](https://github.com/argoproj-labs/mcp-for-argocd)** - ⭐ 300
   An implementation of Model Context Protocol (MCP) server for Argo CD.

748. **[ast-grep-mcp](https://github.com/ast-grep/ast-grep-mcp)** - ⭐ 300

749. **[ebook-mcp](https://github.com/onebirdrocks/ebook-mcp)** - ⭐ 299
...
750. **[stealth-browser-mcp](https://github.com/vibheksoni/stealth-browser-mcp)** - ⭐ 298
   The only browser automation that bypasses anti-bot systems. AI writes network hooks, clones UIs pixel-perfect via simple chat.

751. **[deep-research-mcp](https://github.com/Ozamatash/deep-research-mcp)** - ⭐ 297

752. **[deepseek-mcp-server](https://github.com/DMontgomery40/deepseek-mcp-server)** - ⭐ 297
   Model Context Protocol server for DeepSeek's advanced language models

753. **[investor-agent](https://github.com/ferdousbhai/investor-agent)** - ⭐ 297
   A Model Context Protocol server for building an investor agent

754. **[mcp-server-code-execution-mode](https://github.com/elusznik/mcp-server-code-execution-mode)** - ⭐ 297
   An MCP server that executes Python code in isolated rootless containers with optional MCP server proxying. Implementation of Anthropic's and Cloudflare's ideas for reducing MCP tool definitions context bloat.

755. **[mcp-claude-code](https://github.com/SDGLBL/mcp-claude-code)** - ⭐ 296
   MCP implementation of Claude Code capabilities and more

756. **[mcp-git-ingest](https://github.com/adhikasp/mcp-git-ingest)** - ⭐ 296
   A Model Context Protocol (MCP) server that helps read GitHub repository structure and important files.

757. **[DeepWideResearch](https://github.com/puppyone-ai/DeepWideResearch)** - ⭐ 294
   Agentic RAG for any scenario. Customize sources, depth, and width

758. **[browserwing](https://github.com/browserwing/browserwing)** - ⭐ 294
...
759. **[AgentChat](https://github.com/Shy2593666979/AgentChat)** - ⭐ 293
...
760. **[mssql_mcp_server](https://github.com/RichardHan/mssql_mcp_server)** - ⭐ 291
...
761. **[aws-mcp](https://github.com/RafalWilinski/aws-mcp)** - ⭐ 289
   Talk with your AWS using Claude. Model Context Protocol (MCP) server for AWS. Better Amazon Q alternative.

762. **[llm-context.py](https://github.com/cyberchitta/llm-context.py)** - ⭐ 288
   Share code with LLMs via Model Context Protocol or clipboard. Rule-based customization enables easy switching between different tasks (like code review and documentation). Includes smart code outlining.

763. **[mysql_mcp_server_pro](https://github.com/wenb1n-dev/mysql_mcp_server_pro)** - ⭐ 288
...
764. **[mcp-server-apple-shortcuts](https://github.com/recursechat/mcp-server-apple-shortcuts)** - ⭐ 288

765. **[redd-archiver](https://github.com/19-84/redd-archiver)** - ⭐ 288
...
766. **[blender-mcp-vxai](https://github.com/VxASI/blender-mcp-vxai)** - ⭐ 287

767. **[generator](https://github.com/context-hub/generator)** - ⭐ 287
   CTX: a tool that solves the context management gap when working with LLMs like ChatGPT or Claude. It helps developers organize and automatically collect information from their codebase into structured documents that can be easily shared with AI assistants.

768. **[aider-mcp-server](https://github.com/disler/aider-mcp-server)** - ⭐ 286
   Minimal MCP Server for Aider

769. **[mcp-server-simulator-ios-idb](https://github.com/InditexTech/mcp-server-simulator-ios-idb)** - ⭐ 286
   A Model Context Protocol (MCP) server that enables LLMs to interact with iOS simulators through natural language commands.

770. **[mcp-everything-search](https://github.com/mamertofabian/mcp-everything-search)** - ⭐ 286

771. **[mcp-database-server](https://github.com/executeautomation/mcp-database-server)** - ⭐ 286
   MCP Database Server is a new MCP Server which helps connect with Sqlite, SqlServer and Posgresql Databases

772. **[mcp-server-mas-sequential-thinking](https://github.com/FradSer/mcp-server-mas-sequential-thinking)** - ⭐ 286
   An advanced sequential thinking process using a Multi-Agent System (MAS) built with the Agno framework and served via MCP.

773. **[o3-search-mcp](https://github.com/yoshiko-pg/o3-search-mcp)** - ⭐ 285
   MCP server for OpenAI o3 web search

774. **[claude-code-statusline](https://github.com/rz1989s/claude-code-statusline)** - ⭐ 285
...
775. **[hydra-mcp-solana](https://github.com/hydra-mcp/hydra-mcp-solana)** - ⭐ 284
   hydra-ai

776. **[meGPT](https://github.com/adrianco/meGPT)** - ⭐ 283
   Code to process many kinds of content by an author into an MCP server

777. **[lets-learn-mcp-csharp](https://github.com/microsoft/lets-learn-mcp-csharp)** - ⭐ 283

778. **[mcpsvr](https://github.com/nanbingxyz/mcpsvr)** - ⭐ 282
   Discover Exceptional MCP Servers

779. **[consult7](https://github.com/szeider/consult7)** - ⭐ 282
   MCP server to consult a language model with large context size

780. **[perplexity-mcp](https://github.com/DaInfernalCoder/perplexity-mcp)** - ⭐ 282
...
781. **[MaaMCP](https://github.com/MAA-AI/MaaMCP)** - ⭐ 282
   基于 MaaFramework 的 MCP 服务器 为 AI 助手提供 Android 设备和 Windows 桌面自动化能力

782. **[DeepWideResearch](https://github.com/PuppyAgent/DeepWideResearch)** - ⭐ 281
   Agentic RAG for any scenario. Customize sources, depth, and width

783. **[remote-mcp-server-with-auth](https://github.com/coleam00/remote-mcp-server-with-auth)** - ⭐ 281
...
784. **[minthcm](https://github.com/minthcm/minthcm)** - ⭐ 281
   First AI‑enabled open-source Human Capital Management system that you can start using today.

785. **[utcp-specification](https://github.com/universal-tool-calling-protocol/utcp-specification)** - ⭐ 281
   The specification for the Universal Tool Calling Protocol

786. **[AI-Kline](https://github.com/QuantML-C/AI-Kline)** - ⭐ 281
...
787. **[mcp-neovim-server](https://github.com/bigcodegen/mcp-neovim-server)** - ⭐ 280
   Control Neovim using Model Context Protocol (MCP) and the official neovim/node-client JavaScript library

788. **[mcp-manager](https://github.com/zueai/mcp-manager)** - ⭐ 278
   simple web ui to manage mcp (model context protocol) servers in the claude app

789. **[MCP-handle](https://github.com/WeatherPal-AI/MCP-handle)** - ⭐ 278
   MCP integration platforms making AI-Agents developers focusing on their own tasks

790. **[mcp-youtube-transcript](https://github.com/jkawamoto/mcp-youtube-transcript)** - ⭐ 278
   MCP server retrieving transcripts of YouTube videos

791. **[mcp-linker](https://github.com/milisp/mcp-linker)** - ⭐ 277
...
792. **[perplexity-mcp](https://github.com/jsonallen/perplexity-mcp)** - ⭐ 277
   A Model Context Protocol (MCP) server that provides web search functionality using Perplexity AI's API.

793. **[rhinomcp](https://github.com/jingcheng-chen/rhinomcp)** - ⭐ 276
   RhinoMCP connects Rhino 3D to AI Agent through the Model Context Protocol (MCP)

794. **[x64DbgMCPServer](https://github.com/AgentSmithers/x64DbgMCPServer)** - ⭐ 276
   x64DbgMCPServer made from c# with Claude, Windsurf and Cursor support

795. **[chrome-devtools-mcp](https://github.com/benjaminr/chrome-devtools-mcp)** - ⭐ 276
   An MCP Server for Chrome DevTools, following the Chrome DevTools Protocol. Integrates with Claude Desktop and Claude Code.

796. **[FileScopeMCP](https://github.com/admica/FileScopeMCP)** - ⭐ 275
   Analyzes your codebase identifying important files based on dependency relationships. Generates diagrams and importance scores per file, helping AI assistants understand the codebase. Automatically parses popular programming languages such as Python, C, C++, Rust, Zig, Lua.

797. **[apktool-mcp-server](https://github.com/zinja-coder/apktool-mcp-server)** - ⭐ 275
   A MCP Server for APK Tool (Part of Android Reverse Engineering MCP Suites)

798. **[ddddocr](https://github.com/86maid/ddddocr)** - ⭐ 275
...
799. **[mq](https://github.com/harehare/mq)** - ⭐ 275
   jq-like command-line tool for markdown processing

800. **[mcp-mongo-server](https://github.com/kiliczsh/mcp-mongo-server)** - ⭐ 274
   A Model Context Protocol Server for MongoDB

801. **[dify-mcp-server](https://github.com/YanxingLiu/dify-mcp-server)** - ⭐ 274
   Model Context Protocol (MCP) Server for dify workflows

802. **[laravel-claude-code-setup](https://github.com/laraben/laravel-claude-code-setup)** - ⭐ 274
   One-command setup for AI-powered Laravel development with Claude Code and MCP servers

803. **[MCP-Server-Playwright](https://github.com/VikashLoomba/MCP-Server-Playwright)** - ⭐ 274
   MCP server for browser automation using Playwright

804. **[claude-skills-mcp](https://github.com/K-Dense-AI/claude-skills-mcp)** - ⭐ 274
   MCP server for searching and retrieving Claude Agent Skills using vector search

805. **[obsidian-mcp](https://github.com/newtype-01/obsidian-mcp)** - ⭐ 273
   Obsidian MCP (Model Context Protocol) Server

806. **[mcp-reasoner](https://github.com/Jacck/mcp-reasoner)** - ⭐ 273
   A systematic reasoning MCP server implementation for Claude Desktop with beam search and thought evaluation.

807. **[MCPControl](https://github.com/claude-did-this/MCPControl)** - ⭐ 272
   MCP server for Windows OS automation

808. **[jadx-mcp-server](https://github.com/zinja-coder/jadx-mcp-server)** - ⭐ 271
   MCP server for JADX-AI Plugin

809. **[jinni](https://github.com/smat-dev/jinni)** - ⭐ 270
   Bring your project into LLM context - tool and MCP server

810. **[metorial-index](https://github.com/metorial/metorial-index)** - ⭐ 269
   Metorial MCP Index - An ever growing list of open source MCP servers 📁 🎉

811. **[imagesorcery-mcp](https://github.com/sunriseapps/imagesorcery-mcp)** - ⭐ 269
   An MCP server providing tools for image processing operations

812. **[claude-modular](https://github.com/oxygen-fragment/claude-modular)** - ⭐ 268
   Production-ready modular Claude Code framework with 30+ commands, token optimization, and MCP server integration. Achieves 2-10x productivity gains through   systematic command organization and hierarchical configuration.

813. **[mcp-documentation-server](https://github.com/andrea9293/mcp-documentation-server)** - ⭐ 268
...
814. **[mcp](https://github.com/oracle/mcp)** - ⭐ 268
...
815. **[AetherLink](https://github.com/1600822305/AetherLink)** - ⭐ 267
...
816. **[proximity](https://github.com/fr0gger/proximity)** - ⭐ 267
   Proximity is a MCP security scanner powered with NOVA

817. **[mcp940](https://github.com/WangTingZheng/mcp940)** - ⭐ 267
   Source code of minecraft 1.12

818. **[app-store-connect-mcp-server](https://github.com/JoshuaRileyDev/app-store-connect-mcp-server)** - ⭐ 267

819. **[Context-Engine](https://github.com/m1rl0k/Context-Engine)** - ⭐ 267
...
820. **[solon-ai](https://github.com/opensolon/solon-ai)** - ⭐ 265
   Java AI 应用开发框架（支持 LLM，RAG，MCP，Agent）。同时兼容 java8 ~ java25。也可嵌入到 SpringBoot、jFinal、Vert.x、Quarkus 等框架中使用。

821. **[ultra-mcp](https://github.com/RealMikeChong/ultra-mcp)** - ⭐ 265
   100x Your Claude Code, Gemini CLI, Cursor and/or any coding tools with MCP client support

822. **[safe-mcp](https://github.com/SAFE-MCP/safe-mcp)** - ⭐ 265
   SAFE-MCP is a comprehensive security framework for documenting and mitigating threats in the AI Agent ecosystem.

823. **[model-context-protocol-resources](https://github.com/cyanheads/model-context-protocol-resources)** - ⭐ 264
   Exploring the Model Context Protocol (MCP) through practical guides, clients, and servers I've built while learning about this new protocol.

824. **[kagimcp](https://github.com/kagisearch/kagimcp)** - ⭐ 264
   The Official Model Context Protocol (MCP) server for Kagi search & other tools.

825. **[telegram-mcp](https://github.com/chaindead/telegram-mcp)** - ⭐ 263
   Telegram MCP for managing dialogs, messages, drafts, read statuses, and more.

826. **[mcp-omnisearch](https://github.com/spences10/mcp-omnisearch)** - ⭐ 261
   🔍 A Model Context Protocol (MCP) server providing unified access to multiple search engines (Tavily, Brave, Kagi), AI tools (Perplexity, FastGPT), and content processing services (Jina AI, Kagi). Combines search, AI responses, content processing, and enhancement features through a single interface.

827. **[hass-mcp](https://github.com/voska/hass-mcp)** - ⭐ 261
   Home Assistant MCP Server

828. **[osp_marketing_tools](https://github.com/open-strategy-partners/osp_marketing_tools)** - ⭐ 260
   A Model Context Protocol (MCP) server that empowers LLMs to use some of Open Srategy Partners' core writing and product marketing techniques.

829. **[mcp-odoo](https://github.com/tuanle96/mcp-odoo)** - ⭐ 259
   MCP Server for Odoo

830. **[anytype-mcp](https://github.com/anyproto/anytype-mcp)** - ⭐ 258
   An MCP server enabling AI assistants to interact with Anytype - your encrypted, local and collaborative wiki - to organize objects, lists, and more through natural language.

831. **[iam-policy-autopilot](https://github.com/awslabs/iam-policy-autopilot)** - ⭐ 258
   IAM Policy Autopilot is an open source static code analysis tool that helps you quickly create baseline AWS IAM policies that you can refine as your application evolves. This tool is available as a command-line utility and MCP server for use within AI coding assistants for quickly building IAM policies.

832. **[mcp-server-12306](https://github.com/drfccv/mcp-server-12306)** - ⭐ 257
   12306 MCP Server​​ 是一个基于 ​​Model Context Protocol (MCP)​​ 的高性能火车票查询后端系统。它通过标准化接口提供官方 12306 的实时数据服务，包括余票查询、车站信息、列车经停站、中转换乘方案等核心功能。

833. **[KiCAD-MCP-Server](https://github.com/mixelpixx/KiCAD-MCP-Server)** - ⭐ 257
   KiCAD MCP is a Model Context Protocol (MCP) implementation that enables Large Language Models (LLMs) like Claude to directly interact with KiCAD for printed circuit board design.

834. **[reddit-mcp](https://github.com/Arindam200/reddit-mcp)** - ⭐ 255
   Model Context Protocol server implementation for Reddit

835. **[deepcontext-mcp](https://github.com/Wildcard-Official/deepcontext-mcp)** - ⭐ 254
   DeepContext is an MCP server that adds symbol-aware semantic search to Claude Code, Codex CLI, and other agents for faster, smarter context on large codebases.

836. **[admin](https://github.com/decocms/admin)** - ⭐ 253
   Define and compose secure MCPs in TypeScript. Generate AI workflows and agents with React + Tailwind UI. Deploy anywhere.

837. **[geminimcp](https://github.com/GuDaStudio/geminimcp)** - ⭐ 253
...
838. **[zotero-mcp](https://github.com/cookjohn/zotero-mcp)** - ⭐ 253
...
839. **[project-nova](https://github.com/dujonwalker/project-nova)** - ⭐ 252
...
840. **[django-mcp-server](https://github.com/gts360/django-mcp-server)** - ⭐ 252
   Django MCP Server is a Django extensions to easily enable AI Agents to interact with Django Apps through the Model Context Protocol it works equally well on WSGI and ASGI

841. **[mcp-gdrive](https://github.com/isaacphi/mcp-gdrive)** - ⭐ 252
   Model Context Protocol (MCP) Server for reading from Google Drive and editing Google Sheets

842. **[todoist-ai](https://github.com/Doist/todoist-ai)** - ⭐ 252
   A set of tools to connect to AI agents, to allow them to use Todoist on a user's behalf. Includes MCP support.

843. **[apollo-mcp-server](https://github.com/apollographql/apollo-mcp-server)** - ⭐ 251
   Apollo MCP Server

844. **[mcp-server](https://github.com/strands-agents/mcp-server)** - ⭐ 250
   This MCP server provides documentation about Strands Agents to your GenAI tools, so you can use your favorite AI coding assistant to vibe-code Strands Agents.

845. **[aci-mcp](https://github.com/aipotheosis-labs/aci-mcp)** - ⭐ 249
   MCP server(s) for Aipolabs ACI.dev

846. **[mcp](https://github.com/salesforcecli/mcp)** - ⭐ 249
   MCP Server for interacting with Salesforce instances

847. **[doris-mcp-server](https://github.com/apache/doris-mcp-server)** - ⭐ 249
   Apache Doris MCP Server

848. **[api200](https://github.com/API-200/api200)** - ⭐ 248
   API 200 is an open source API gateway to simplify 3rd-party integrations. Import endpoints, set up caching, retries, and mocks. Access all services via one URL. Monitor logs, track errors, and get alerts on API incidents.

849. **[code-reasoning](https://github.com/mettamatt/code-reasoning)** - ⭐ 248
   A code reasoning MCP server, a fork of sequential-thinking

850. **[suppr-mcp](https://github.com/WildDataX/suppr-mcp)** - ⭐ 246
    超能文献|AI驱动的文档翻译与学术搜索服务。支持PDF、DOCX、PPTX等多格式文档的高质量翻译（支持11种语言），特别优化了数学公式翻译。同时提供PubMed学术文献智能搜索功能。更多访问：https://suppr.wilddata.cn

851. **[mcp-server-tree-sitter](https://github.com/wrale/mcp-server-tree-sitter)** - ⭐ 246
   MCP Server for Tree-sitter

852. **[MARM-Systems](https://github.com/Lyellr88/MARM-Systems)** - ⭐ 246
...
853. **[mcp_massive](https://github.com/massive-com/mcp_massive)** - ⭐ 246
   An MCP server for Massive.com Financial Market Data

854. **[ha-mcp](https://github.com/homeassistant-ai/ha-mcp)** - ⭐ 246
   The Unofficial and Awesome Home Assistant MCP Server

855. **[cupertino](https://github.com/mihaelamj/cupertino)** - ⭐ 246
   A local Apple Documentation crawler and MCP server. Written in Swift.

856. **[enterprise-mcp-course](https://github.com/decodingai-magazine/enterprise-mcp-course)** - ⭐ 245
...
857. **[ai-agent-team](https://github.com/peterfei/ai-agent-team)** - ⭐ 245
   AI Agent Team-拥有24/7专业AI开发团队：产品经理、前端开发、后端开发、测试工程师、DevOps工程师、技术负责人。一键安装，支持中英文命令，大幅提升开发效率！

858. **[mcp-server-gemini](https://github.com/aliargun/mcp-server-gemini)** - ⭐ 244
   MCP server implementation for Google's Gemini API

859. **[g-search-mcp](https://github.com/jae-jae/g-search-mcp)** - ⭐ 244
   A powerful MCP server for Google search that enables parallel searching with multiple keywords simultaneously.

860. **[google-docs-mcp](https://github.com/a-bonus/google-docs-mcp)** - ⭐ 243
...
861. **[mcp-chatbot](https://github.com/3choff/mcp-chatbot)** - ⭐ 242
   A simple CLI chatbot that demonstrates the integration of the Model Context Protocol (MCP).

862. **[Windows-MCP.Net](https://github.com/AIDotNet/Windows-MCP.Net)** - ⭐ 242
   A .NET-based Windows desktop automation MCP (Model Context Protocol) server that provides AI assistants with the ability to interact with the Windows desktop environment.

863. **[AEnvironment](https://github.com/inclusionAI/AEnvironment)** - ⭐ 242
   Standardized environment infrastructure for Agentic AI development.

864. **[chat-mcp](https://github.com/AI-QL/chat-mcp)** - ⭐ 241
   A Desktop Chat App that leverages MCP(Model Context Protocol) to interface with other LLMs.

865. **[mcp-prompt-server](https://github.com/gdli6177/mcp-prompt-server)** - ⭐ 241
   这是一个基于Model Context Protocol (MCP)的服务器，用于根据用户任务需求提供预设的prompt模板，帮助Cline/Cursor/Windsurf...更高效地执行各种任务。服务器将预设的prompt作为工具(tools)返回，以便在Cursor和Windsurf等编辑器中更好地使用。

866. **[xiaozhi-client](https://github.com/shenjingnan/xiaozhi-client)** - ⭐ 241
   小智AI客户端，目前主要用于MCP的对接

867. **[next-lens](https://github.com/1weiho/next-lens)** - ⭐ 240
   A CLI that scans Next.js routes and provides quick insights from your terminal, web UI, and MCP.

868. **[rust-docs-mcp-server](https://github.com/Govcraft/rust-docs-mcp-server)** - ⭐ 240
   🦀 Prevents outdated Rust code suggestions from AI assistants. This MCP server fetches current crate docs, uses embeddings/LLMs, and provides accurate context via a tool call.

869. **[mcp-feedback-collector](https://github.com/sanshao85/mcp-feedback-collector)** - ⭐ 240
   一个现代化的 Model Context Protocol (MCP) 服务器，为AI助手提供交互式用户反馈收集功能。

870. **[PIXRA](https://github.com/dodufish/PIXRA)** - ⭐ 239
   Pixelize the real world on-chain

871. **[video-editing-mcp](https://github.com/burningion/video-editing-mcp)** - ⭐ 239
   MCP Interface for Video Jungle

872. **[elasticsearch-mcp-server](https://github.com/cr7258/elasticsearch-mcp-server)** - ⭐ 239
   A Model Context Protocol (MCP) server implementation that provides Elasticsearch and OpenSearch interaction.

873. **[claude_code-gemini-mcp](https://github.com/RaiAnsar/claude_code-gemini-mcp)** - ⭐ 239
   Simplified Gemini for Claude Code. 

874. **[claude-code-mcpinstall](https://github.com/undeadpickle/claude-code-mcpinstall)** - ⭐ 239
   Easy guide to installing Claude Code MCPs globally on your machine.

875. **[human-mcp](https://github.com/mrgoonie/human-mcp)** - ⭐ 239

876. **[mcp-ical](https://github.com/Omar-V2/mcp-ical)** - ⭐ 238
   A Model Context Protocol Server that allows you to interact with your MacOS Calendar through natural language.

877. **[mcp_flutter](https://github.com/Arenukvern/mcp_flutter)** - ⭐ 237
   MCP server and MCP Toolkit  for Flutter and Dart VM - supports dynamic tooling

878. **[weather-mcp-server](https://github.com/ezh0v/weather-mcp-server)** - ⭐ 236
   A lightweight Model Context Protocol (MCP) server that enables AI assistants like Claude to retrieve and interpret real-time weather data. Discuss on Hacker News:

879. **[spring-ai-summary](https://github.com/java-ai-tech/spring-ai-summary)** - ⭐ 236
   SpringAI，LLM，MCP，Embedding

880. **[bazi-mcp](https://github.com/cantian-ai/bazi-mcp)** - ⭐ 235
   MCP server for Bazi (八字) information

881. **[NFTIAI](https://github.com/Axarb/NFTIAI)** - ⭐ 235
...
882. **[MCPBench](https://github.com/modelscope/MCPBench)** - ⭐ 235
   The evaluation benchmark on MCP servers

883. **[mcp-server-code-runner](https://github.com/formulahendry/mcp-server-code-runner)** - ⭐ 235
   Code Runner MCP Server

884. **[foundry-mcp-server](https://github.com/PraneshASP/foundry-mcp-server)** - ⭐ 235
   An experimental MCP Server for foundry built for Solidity devs

885. **[mcp-on-vercel](https://github.com/vercel-labs/mcp-on-vercel)** - ⭐ 235

886. **[mcp2py](https://github.com/MaximeRivest/mcp2py)** - ⭐ 234
   Turn any MCP server into a Python module

887. **[studio-rust-mcp-server](https://github.com/Roblox/studio-rust-mcp-server)** - ⭐ 234
   Standalone Roblox Studio MCP Server

888. **[firebase-mcp](https://github.com/gannonh/firebase-mcp)** - ⭐ 233
   🔥 Model Context Protocol (MCP) server for Firebase.

889. **[private-journal-mcp](https://github.com/obra/private-journal-mcp)** - ⭐ 233
   A lightweight MCP server that provides Claude with a private journaling capability to process feelings and thoughts

890. **[1c_mcp](https://github.com/vladimir-kharin/1c_mcp)** - ⭐ 233
...
891. **[Lambda-MCP-Server](https://github.com/mikegc-aws/Lambda-MCP-Server)** - ⭐ 232
   Creates a simple MCP tool server with "streaming" HTTP.

892. **[browser-control-mcp](https://github.com/eyalzh/browser-control-mcp)** - ⭐ 231
   MCP server paired with a browser extension that enables AI agents to control the user's browser.

893. **[dat](https://github.com/hexinfo/dat)** - ⭐ 231
   Asking yours data in a natural language way through pre-modeling (data models and semantic models).

894. **[mcp-foundry](https://github.com/microsoft-foundry/mcp-foundry)** - ⭐ 230
   A MCP Server for Azure AI Foundry: it's now moved to cloud, check the new Foundry MCP Server

895. **[things-mcp](https://github.com/hald/things-mcp)** - ⭐ 230
   Things.app MCP Server

896. **[MCP-connect](https://github.com/EvalsOne/MCP-connect)** - ⭐ 229
   Enables cloud-based AI services to access local Stdio based MCP servers via HTTP requests

897. **[mcp-telegram](https://github.com/dryeab/mcp-telegram)** - ⭐ 229
   MCP Server for Telegram

898. **[skillport](https://github.com/gotalab/skillport)** - ⭐ 229
   Bring Agent Skills to Any AI Agent and Coding Agent — via CLI or MCP. Manage once, serve anywhere.

899. **[xiyan_mcp_server](https://github.com/XGenerationLab/xiyan_mcp_server)** - ⭐ 228
   A Model Context Protocol (MCP) server that enables natural language queries to databases

900. **[mcp_chatbot](https://github.com/keli-wen/mcp_chatbot)** - ⭐ 228
   A chatbot implementation compatible with MCP (terminal / streamlit supported)

901. **[sample-serverless-mcp-servers](https://github.com/aws-samples/sample-serverless-mcp-servers)** - ⭐ 228
   Sample implementations of AI Agents and MCP Servers running on AWS Serverless compute

902. **[mcp-foundry](https://github.com/azure-ai-foundry/mcp-foundry)** - ⭐ 227
   A MCP Server for Azure AI Foundry: it's now moved to cloud, check the new Foundry MCP Server

903. **[mcp-server](https://github.com/volcengine/mcp-server)** - ⭐ 227
   Volcengine MCP Servers

904. **[mcp-proxy-for-aws](https://github.com/aws/mcp-proxy-for-aws)** - ⭐ 227
   AWS MCP Proxy Server

905. **[awesome-mcp-servers](https://github.com/PipedreamHQ/awesome-mcp-servers)** - ⭐ 225
   A collection of MCP servers

906. **[cobolt](https://github.com/platinum-hill/cobolt)** - ⭐ 225
...
907. **[octocode](https://github.com/Muvon/octocode)** - ⭐ 225
   Semantic code searcher and codebase utility with AI memory onboard

908. **[lean-lsp-mcp](https://github.com/oOo0oOo/lean-lsp-mcp)** - ⭐ 225
   Lean Theorem Prover MCP

909. **[CAAL](https://github.com/CoreWorxLab/CAAL)** - ⭐ 225
   Local voice assistant that learns new abilities via auto-discovered n8n workflows exposed as tools via MCP

910. **[lyraios](https://github.com/GalaxyLLMCI/lyraios)** - ⭐ 223
...
911. **[strava-mcp](https://github.com/r-huijts/strava-mcp)** - ⭐ 223
   A Model Context Protocol (MCP) server that connects to Strava API, providing tools to access Strava data through LLMs

912. **[mcp-server-commands](https://github.com/g0t4/mcp-server-commands)** - ⭐ 221
   Model Context Protocol server to run commands

913. **[mcp-proxy](https://github.com/punkpeye/mcp-proxy)** - ⭐ 221
   A TypeScript streamable HTTP and SSE proxy for MCP servers that use stdio transport.

914. **[CAD-MCP](https://github.com/daobataotie/CAD-MCP)** - ⭐ 221
   CAD MCP Server

915. **[ssh-mcp](https://github.com/tufantunc/ssh-mcp)** - ⭐ 221
   MCP server exposing SSH control for Linux servers via Model Context Protocol.

916. **[langgraph-whatsapp-agent](https://github.com/lgesuellip/langgraph-whatsapp-agent)** - ⭐ 220
...
917. **[agent-mcp-lab](https://github.com/WaveSpeedAI/agent-mcp-lab)** - ⭐ 220

918. **[mac_messages_mcp](https://github.com/carterlasalle/mac_messages_mcp)** - ⭐ 220
   An MCP server that securely interfaces with your iMessage database via the Model Context Protocol (MCP), allowing LLMs to query and analyze iMessage conversations. It includes robust phone number validation, attachment processing, contact management, group chat handling, and full support for sending and receiving messages.

919. **[llamacloud-mcp](https://github.com/run-llama/llamacloud-mcp)** - ⭐ 220

920. **[remote-swe-agents](https://github.com/aws-samples/remote-swe-agents)** - ⭐ 220
   Autonomous SWE agent working in the cloud! (a.k.a. Vibe coding with Bedrock)

921. **[MiroRL](https://github.com/MiroMindAI/MiroRL)** - ⭐ 220
   MiroRL is  an MCP-first reinforcement learning framework for deep research agent.

922. **[home-assistant-cursor-agent](https://github.com/Coolver/home-assistant-cursor-agent)** - ⭐ 219
...
923. **[mcp-twikit](https://github.com/adhikasp/mcp-twikit)** - ⭐ 219
   A Model Context Protocol (MCP) server for interacting with Twitter.

924. **[mcp-maigret](https://github.com/BurtTheCoder/mcp-maigret)** - ⭐ 219
   MCP server for maigret, a powerful OSINT tool that collects user account information from various public sources. 

925. **[openapi-to-mcpserver](https://github.com/higress-group/openapi-to-mcpserver)** - ⭐ 219
   A tool&lib that can automatically convert OpenAPI documents into Higress remote MCP server configurations.

926. **[outlook-mcp](https://github.com/ryaker/outlook-mcp)** - ⭐ 219
   MCP server for Claude to access Outlook data via Microsoft Graph API

927. **[Alice](https://github.com/pmbstyle/Alice)** - ⭐ 218
...
928. **[mcp-compass](https://github.com/liuyoshio/mcp-compass)** - ⭐ 218
   MCP Discovery & Recommendation Service - Find the right MCP server for your needs

929. **[Mimir](https://github.com/orneryd/Mimir)** - ⭐ 218
...
930. **[spotify-mcp-server](https://github.com/marcelmarais/spotify-mcp-server)** - ⭐ 218
   Lightweight MCP server for Spotify

931. **[image-gen-server](https://github.com/fengin/image-gen-server)** - ⭐ 217
   一个能与Cursor集成的图片生成mcp server工具，实现调用即梦逆向接口

932. **[effect-mcp](https://github.com/tim-smart/effect-mcp)** - ⭐ 217

933. **[omnicoreagent](https://github.com/omnirexflora-labs/omnicoreagent)** - ⭐ 217
...
934. **[tentix](https://github.com/labring/tentix)** - ⭐ 215
...
935. **[learn-agentic-ai-from-low-code-to-code](https://github.com/panaversity/learn-agentic-ai-from-low-code-to-code)** - ⭐ 214
   Build production-grade agents with OpenAI AgentKit, a no-code platfrom.

936. **[playwright-mcp](https://github.com/cloudflare/playwright-mcp)** - ⭐ 214
   Playwright MCP fork that works with Cloudflare Browser Rendering

937. **[human-in-the-loop](https://github.com/KOBA789/human-in-the-loop)** - ⭐ 214
   An MCP (Model Context Protocol) server that allows AI assistants to ask questions to humans via Discord.

938. **[lihil](https://github.com/raceychan/lihil)** - ⭐ 213
   2X faster ASGI web framework for python, offering high-level development, low-level performance.

939. **[mcp_code_executor](https://github.com/bazinga012/mcp_code_executor)** - ⭐ 213
   The MCP Code Executor is an MCP server that allows LLMs to execute Python code within a specified Conda environment.

940. **[mermaid-mcp-server](https://github.com/peng-shawn/mermaid-mcp-server)** - ⭐ 213
   A Model Context Protocol (MCP) server that converts Mermaid diagrams to PNG images

941. **[vibevideo-mcp](https://github.com/hyepartners-gmail/vibevideo-mcp)** - ⭐ 213
   Agent MCP for ffmpeg

942. **[lokka](https://github.com/merill/lokka)** - ⭐ 213
   MCP (Model Context Protocol) for Microsoft 365. Includes support for Microsoft Graph and other services

943. **[mcp-openapi-server](https://github.com/ivo-toby/mcp-openapi-server)** - ⭐ 212
   MCP Server (Model Context Protocol) for turning OpenAPI specifications into a MCP Resource

944. **[mcp-server-milvus](https://github.com/zilliztech/mcp-server-milvus)** - ⭐ 212
   Model Context Protocol Servers for Milvus

945. **[smart-tree](https://github.com/8b-is/smart-tree)** - ⭐ 212
...
946. **[mcp-cli](https://github.com/apify/mcp-cli)** - ⭐ 212
...
947. **[aitour26-WRK540-unlock-your-agents-potential-with-model-context-protocol](https://github.com/microsoft/aitour26-WRK540-unlock-your-agents-potential-with-model-context-protocol)** - ⭐ 212

948. **[penpot-mcp](https://github.com/montevive/penpot-mcp)** - ⭐ 212
   Penpot MCP server

949. **[Autono](https://github.com/vortezwohl/Autono)** - ⭐ 211
   A ReAct-Based Highly Robust Autonomous Agent Framework.

950. **[razorpay-mcp-server](https://github.com/razorpay/razorpay-mcp-server)** - ⭐ 211
   Razorpay's Official MCP Server

951. **[plate-playground-template](https://github.com/udecode/plate-playground-template)** - ⭐ 211
   Plate AI template with React 19, Next 16, Tailwind 4, MCP.

952. **[facebook-ads-mcp-server](https://github.com/gomarble-ai/facebook-ads-mcp-server)** - ⭐ 211

953. **[obsidian-mcp-plugin](https://github.com/aaronsb/obsidian-mcp-plugin)** - ⭐ 211
   High-performance Model Context Protocol (MCP) server for Obsidian that provides AI tools with direct vault access through semantic operations and HTTP transport.

954. **[domainstack.io](https://github.com/jakejarvis/domainstack.io)** - ⭐ 211
   🧰 All-in-one domain name intelligence as a service

955. **[uber-eats-mcp-server](https://github.com/ericzakariasson/uber-eats-mcp-server)** - ⭐ 210

956. **[gibber-mcp](https://github.com/antonpk1/gibber-mcp)** - ⭐ 210
   Tiny MCP server with cryptography tools, sufficient to establish end-to-end encryption between LLM agents

957. **[mcp-taskmanager](https://github.com/kazuph/mcp-taskmanager)** - ⭐ 210

958. **[cpp-mcp](https://github.com/hkr04/cpp-mcp)** - ⭐ 210
   Lightweight C++ MCP (Model Context Protocol) SDK

959. **[antd-components-mcp](https://github.com/zhixiaoqiang/antd-components-mcp)** - ⭐ 210
   An MCP service for Ant Design components query | 一个减少 Ant Design 组件代码生成幻觉的 MCP 服务，包含系统提示词、组件文档、API 文档、代码示例和更新日志查询

960. **[figma-mcp](https://github.com/MatthewDailey/figma-mcp)** - ⭐ 209
   ModelContextProtocol for Figma's REST API

961. **[composer-trade-mcp](https://github.com/invest-composer/composer-trade-mcp)** - ⭐ 209
   Composer's MCP server lets MCP-enabled LLMs like Claude backtest trading ideas and automatically invest in them for you

962. **[ruby_llm-mcp](https://github.com/patvice/ruby_llm-mcp)** - ⭐ 209
   Full-featured MCP support for Ruby and RubyLLM—making it easy to build structured, composable LLM workflows in pure Ruby.

963. **[multimodal-mcp-client](https://github.com/Ejb503/multimodal-mcp-client)** - ⭐ 208
   A Multi-modal MCP client for voice powered agentic workflows

964. **[atlassian-mcp-server](https://github.com/atlassian/atlassian-mcp-server)** - ⭐ 208
   Remote MCP Server that securely connects Jira and Confluence with your LLM, IDE, or agent platform of choice.

965. **[c2sagent](https://github.com/C2SAgent/c2sagent)** - ⭐ 208
...
966. **[mindmap-mcp-server](https://github.com/YuChenSSR/mindmap-mcp-server)** - ⭐ 207
   mindmap, mcp server, artifact

967. **[claude-historian-mcp](https://github.com/Vvkmnn/claude-historian-mcp)** - ⭐ 207
   🤖 An MCP server for surfacing useful Claude Code conversation history

968. **[Lynkr](https://github.com/Fast-Editor/Lynkr)** - ⭐ 207
   Streamline your workflow with Lynkr, a CLI tool that acts as an HTTP proxy for efficient code interactions using Claude Code CLI.

969. **[mcp-context-protector](https://github.com/trailofbits/mcp-context-protector)** - ⭐ 206
   MCP security wrapper

970. **[kite-mcp-server](https://github.com/zerodha/kite-mcp-server)** - ⭐ 206
   Zerodha Kite MCP server

971. **[mcp-rb](https://github.com/funwarioisii/mcp-rb)** - ⭐ 206
   A lightweight Ruby framework for building MCP servers with a Sinatra-like DSL

972. **[automagik-genie](https://github.com/namastexlabs/automagik-genie)** - ⭐ 206
   🧞 Automagik Genie – bootstrap, update, and roll back AI agent workspaces with a single CLI + MCP toolkit.

973. **[anki-mcp-server](https://github.com/nailuoGG/anki-mcp-server)** - ⭐ 206
   MCP server for Anki via AnkiConnect

974. **[mcp](https://github.com/Snowflake-Labs/mcp)** - ⭐ 206
   MCP Server for Snowflake including Cortex AI, object management, SQL orchestration, semantic view consumption, and more

975. **[Remote-MCP](https://github.com/ssut/Remote-MCP)** - ⭐ 206
   A type-safe solution to remote MCP communication, enabling effortless integration for centralized management of Model Context.

976. **[ticktick-mcp](https://github.com/jacepark12/ticktick-mcp)** - ⭐ 206
   MCP server that interacts with TickTick (Dida 365) via the TickTick Open API

977. **[OSWorld-MCP](https://github.com/X-PLUG/OSWorld-MCP)** - ⭐ 205

978. **[notion_mcp](https://github.com/danhilse/notion_mcp)** - ⭐ 205
   A simple MCP integration that allows Claude to read and manage a personal Notion todo list

979. **[AutomatedEmulation](https://github.com/iknowjason/AutomatedEmulation)** - ⭐ 204
...
980. **[sqrl](https://github.com/DataSQRL/sqrl)** - ⭐ 204
   Data Pipeline Automation Framework to build MCP servers, data APIs, and data lakes with SQL.

981. **[melrose](https://github.com/emicklei/melrose)** - ⭐ 204
   interactive programming of melodies, producing MIDI 

982. **[yt-dlp-mcp](https://github.com/kevinwatt/yt-dlp-mcp)** - ⭐ 204
   A Model Context Protocol (MCP) server that bridges Video & Audio content with Large Language Models using yt-dlp.

983. **[TradingAgents-MCPmode](https://github.com/guangxiangdebizi/TradingAgents-MCPmode)** - ⭐ 204
   TradingAgents-MCPmode 是一个创新的多智能体交易分析系统，集成了 Model Context Protocol (MCP) 工具，实现了智能化的股票分析和交易决策流程。系统通过多个专业化智能体的协作，提供全面的市场分析、投资建议和风险管理。

984. **[jebmcp](https://github.com/dawnslab/jebmcp)** - ⭐ 204

985. **[cheatengine-mcp-bridge](https://github.com/miscusi-peek/cheatengine-mcp-bridge)** - ⭐ 204
...
986. **[mcp-server-trello](https://github.com/delorenj/mcp-server-trello)** - ⭐ 204
   A Model Context Protocol (MCP) server that provides tools for interacting with Trello boards.

987. **[sora-mcp](https://github.com/Doriandarko/sora-mcp)** - ⭐ 203
   An MCP server to use Sora video generation APIs

988. **[langchain-mcp](https://github.com/rectalogic/langchain-mcp)** - ⭐ 203
   Model Context Protocol tool support for LangChain

989. **[Google-Search-MCP-Server](https://github.com/mixelpixx/Google-Search-MCP-Server)** - ⭐ 202
...
990. **[y-cli](https://github.com/luohy15/y-cli)** - ⭐ 201
   A Tiny Terminal Chat App for AI Models with MCP Client Support

991. **[mcp](https://github.com/hopx-ai/mcp)** - ⭐ 200

992. **[ht-mcp](https://github.com/memextech/ht-mcp)** - ⭐ 200
   Pure Rust implementation of MCP server for headless terminal 

993. **[jetski](https://github.com/hyprmcp/jetski)** - ⭐ 200
...
994. **[mcp-trends-hub](https://github.com/baranwang/mcp-trends-hub)** - ⭐ 200
   基于 Model Context Protocol (MCP) 协议的全网热点趋势一站式聚合服务

995. **[mastergo-magic-mcp](https://github.com/mastergo-design/mastergo-magic-mcp)** - ⭐ 200
...
996. **[mathom](https://github.com/stephenlacy/mathom)** - ⭐ 199
   Run and monitor MCP servers locally

997. **[Google-Scholar-MCP-Server](https://github.com/JackKuo666/Google-Scholar-MCP-Server)** - ⭐ 199
...
998. **[unsplash-mcp-server](https://github.com/hellokaton/unsplash-mcp-server)** - ⭐ 198
   🔎 A MCP server for Unsplash image search.

999. **[mcp-server-deep-research](https://github.com/reading-plus-ai/mcp-server-deep-research)** - ⭐ 198

1000. **[ha-mcp-for-xiaozhi](https://github.com/c1pher-cn/ha-mcp-for-xiaozhi)** - ⭐ 198
   Homeassistant MCP server for 小智AI

1001. **[mcp-server-rag-web-browser](https://github.com/apify/mcp-server-rag-web-browser)** - ⭐ 197
   A MCP Server for the RAG Web Browser Actor

1002. **[BifrostMCP](https://github.com/biegehydra/BifrostMCP)** - ⭐ 197
   VSCode Extension with an MCP server that exposes semantic tools like Find Usages and Rename to LLMs

1003. **[mcp-n8n-workflow-builder](https://github.com/salacoste/mcp-n8n-workflow-builder)** - ⭐ 197
   AI-powered n8n workflow automation through natural language. MCP server enabling Claude AI & Cursor IDE to create, manage, and monitor workflows via Model Context Protocol. Multi-instance support, 17 tools, comprehensive docs. Build workflows conversationally without manual JSON editing.

1004. **[vulnerable-mcp-servers-lab](https://github.com/appsecco/vulnerable-mcp-servers-lab)** - ⭐ 197
   A collection of servers which are deliberately vulnerable to learn Pentesting MCP Servers.

1005. **[ProxmoxMCP](https://github.com/canvrno/ProxmoxMCP)** - ⭐ 196
   MCP for Proxmox integration in Cline

1006. **[cognition-wheel](https://github.com/Hormold/cognition-wheel)** - ⭐ 196
   A Model Context Protocol (MCP) server that implements a "wisdom of crowds" approach to AI reasoning by consulting multiple state-of-the-art language models in parallel and synthesizing their responses.

1007. **[ai-infrastructure-agent](https://github.com/VersusControl/ai-infrastructure-agent)** - ⭐ 196
...
1008. **[mongodb-lens](https://github.com/furey/mongodb-lens)** - ⭐ 196
   🍃🔎 MongoDB Lens: Full Featured MCP Server for MongoDB Databases

1009. **[mcp-portal-transparencia](https://github.com/dutradotdev/mcp-portal-transparencia)** - ⭐ 195
   MCP para orquestração automatizada de chamadas à API do Portal da Transparência do Governo Federal brasileiro

1010. **[opik-mcp](https://github.com/comet-ml/opik-mcp)** - ⭐ 195
   Model Context Protocol (MCP) implementation for Opik enabling seamless IDE integration and unified access to prompts, projects, traces, and metrics. 

1011. **[rmcp](https://github.com/finite-sample/rmcp)** - ⭐ 195
   R MCP Server

1012. **[phone-mcp](https://github.com/hao-cyber/phone-mcp)** - ⭐ 195
   A phone control plugin for MCP that allows you to control your Android phone through ADB commands to connect any human

1013. **[tmux-mcp](https://github.com/nickgnd/tmux-mcp)** - ⭐ 195
   A MCP server for our beloved terminal multiplexer tmux.

1014. **[sec-edgar-mcp](https://github.com/stefanoamorelli/sec-edgar-mcp)** - ⭐ 194
   A SEC EDGAR MCP (Model Context Protocol) Server

1015. **[metorial-platform](https://github.com/metorial/metorial-platform)** - ⭐ 194
   The engine powering hundreds of thousands of MCP connections 🤖 🔥

1016. **[mcp-proxy-server](https://github.com/adamwattis/mcp-proxy-server)** - ⭐ 193
   An MCP proxy server that aggregates and serves multiple MCP resource servers through a single interface

1017. **[nano-agent](https://github.com/disler/nano-agent)** - ⭐ 193
   A MCP Server for a small scale engineering agents with multi-provider LLM support.

1018. **[gemini-cli-desktop](https://github.com/Piebald-AI/gemini-cli-desktop)** - ⭐ 193
   Web/desktop UI for Gemini CLI/Qwen Code.  Manage projects, switch between tools, search across past conversations, and manage MCP servers, all from one multilingual interface, locally or remotely.

1019. **[waldzell-mcp](https://github.com/waldzellai/waldzell-mcp)** - ⭐ 192
   Waldzell AI's monorepo of MCP servers. Use in Claude Desktop, Cline, Roo Code, and more!

1020. **[gcp-mcp](https://github.com/eniayomi/gcp-mcp)** - ⭐ 192
   A Model Context Protocol (MCP) server that enables AI assistants like Claude to interact with your Google Cloud Platform environment. This allows for natural language querying and management of your GCP resources during conversations.

1021. **[wavefront](https://github.com/rootflo/wavefront)** - ⭐ 192
   🔥🔥🔥 Enterprise AI middleware, alternative to unifyapps, n8n, lyzr

1022. **[nosia](https://github.com/dilolabs/nosia)** - ⭐ 192
   Self-hosted AI RAG + MCP Platform

1023. **[claude-self-reflect](https://github.com/ramakay/claude-self-reflect)** - ⭐ 192
   Claude forgets everything. This fixes that. 🔗 www.npmjs.com/package/claude-self-reflect

1024. **[easy-mcp](https://github.com/zcaceres/easy-mcp)** - ⭐ 191
   Absurdly easy Model Context Protocol Servers in Typescript

1025. **[mcp-guardian](https://github.com/eqtylab/mcp-guardian)** - ⭐ 191
   Manage / Proxy / Secure your MCP Servers

1026. **[dynatrace-mcp](https://github.com/dynatrace-oss/dynatrace-mcp)** - ⭐ 191
   MCP server for Dynatrace Observability

1027. **[seo-mcp](https://github.com/cnych/seo-mcp)** - ⭐ 190
...
1028. **[MCP-server-client-computer-use-ai-sdk](https://github.com/mediar-ai/MCP-server-client-computer-use-ai-sdk)** - ⭐ 190

1029. **[gram](https://github.com/speakeasy-api/gram)** - ⭐ 190
   Platform to create, curate and host MCP servers ⚒️ Build production quality tools for your agents.

1030. **[mcp_forge](https://github.com/mlzoo/mcp_forge)** - ⭐ 190
   这是一个专为开发企业级MCP server而设计的通用开发框架

1031. **[mcp-echarts](https://github.com/hustcc/mcp-echarts)** - ⭐ 188
   🧬 Generate visual charts using ECharts with AI MCP dynamically, used for chart generation and data analysis.

1032. **[mcp-gsc](https://github.com/AminForou/mcp-gsc)** - ⭐ 188
   Google Search Console Insights with Claude AI for SEOs

1033. **[yahoo-finance-mcp](https://github.com/Alex2Yang97/yahoo-finance-mcp)** - ⭐ 187
   This is a Model Context Protocol (MCP) server that provides comprehensive financial data from Yahoo Finance. It allows you to retrieve detailed information about stocks, including historical prices, company information, financial statements, options data, and market news.

1034. **[AutoDocs](https://github.com/TrySita/AutoDocs)** - ⭐ 187
...
1035. **[code-sandbox-mcp](https://github.com/philschmid/code-sandbox-mcp)** - ⭐ 187

1036. **[mcp-usecase](https://github.com/teddynote-lab/mcp-usecase)** - ⭐ 187

1037. **[mcp-injection-experiments](https://github.com/invariantlabs-ai/mcp-injection-experiments)** - ⭐ 187
   Code snippets to reproduce MCP tool poisoning attacks.

1038. **[RelaMind](https://github.com/El-12stu/RelaMind)** - ⭐ 187
   基于 AI 的个人成长轨迹分析系统，通过记录生活、回顾历史、分析模式帮助用户更好地理解自己，实现持续成长。包含智能路由、RAG 检索、自主任务智能体等功能。

1039. **[figma-flutter-mcp](https://github.com/mhmzdev/figma-flutter-mcp)** - ⭐ 187
   An MCP server that provides the coding agents Figma's design token to write Flutter code.

1040. **[armor-crypto-mcp](https://github.com/armorwallet/armor-crypto-mcp)** - ⭐ 187
   The MCP server for interacting with Blockchain, Swaps, Strategic Planning and more.

1041. **[Omni-Adapter](https://github.com/HuChundong/Omni-Adapter)** - ⭐ 186
   多平台 文生图/图生图 等能力接入MCP

1042. **[supabase-mcp](https://github.com/coleam00/supabase-mcp)** - ⭐ 186
   Supabase MCP server created in Python.

1043. **[utcp-mcp](https://github.com/universal-tool-calling-protocol/utcp-mcp)** - ⭐ 186
   All-in-one MCP server that can connect your AI agents to any native endpoint, powered by UTCP

1044. **[persistent-ai-memory](https://github.com/savantskie/persistent-ai-memory)** - ⭐ 186
   A persistent local memory for AI, LLMs, or Copilot in VS Code.

1045. **[claude-code-mastery](https://github.com/TheDecipherist/claude-code-mastery)** - ⭐ 186
   The complete guide to Claude Code: CLAUDE.md, hooks, skills, MCP servers, and commands

1046. **[auto-mcp](https://github.com/brizzai/auto-mcp)** - ⭐ 185
   Transform any OpenAPI/Swagger definition into a fully-featured Model Context Protocol (MCP) server

1047. **[mcp-linkedin](https://github.com/adhikasp/mcp-linkedin)** - ⭐ 185
   A Model Context Protocol (MCP) server that provides tools to interact with LinkedIn's Feeds and Job API.

1048. **[a2a_mcp-example](https://github.com/ishanExtreme/a2a_mcp-example)** - ⭐ 184
   An example showing how A2A and MCP can be used together

1049. **[pbi-desktop-mcp-public](https://github.com/maxanatsko/pbi-desktop-mcp-public)** - ⭐ 184
...
1050. **[hf-mcp-server](https://github.com/huggingface/hf-mcp-server)** - ⭐ 184
   Hugging Face MCP Server

1051. **[EdgeBox](https://github.com/BIGPPWONG/EdgeBox)** - ⭐ 183
...
1052. **[litemcp](https://github.com/wong2/litemcp)** - ⭐ 183
   A TypeScript framework for building MCP servers elegantly

1053. **[servicenow-mcp](https://github.com/echelon-ai-labs/servicenow-mcp)** - ⭐ 183
   MCP Server for ServiceNow

1054. **[thinkchain](https://github.com/martinbowling/thinkchain)** - ⭐ 182
...
1055. **[mcp-openai-gemini-llama-example](https://github.com/philschmid/mcp-openai-gemini-llama-example)** - ⭐ 182

1056. **[siconos](https://github.com/siconos/siconos)** - ⭐ 182
   Simulation framework for nonsmooth dynamical systems

1057. **[mcp-proxy-server](https://github.com/ptbsare/mcp-proxy-server)** - ⭐ 182
   This server acts as a central hub for Model Context Protocol (MCP) resource servers.

1058. **[gistpad-mcp](https://github.com/lostintangent/gistpad-mcp)** - ⭐ 181
   📓 An MCP server for managing your personal knowledge, daily notes, and re-usable prompts via GitHub Gists

1059. **[dify-plugin-tools-mcp_sse](https://github.com/junjiem/dify-plugin-tools-mcp_sse)** - ⭐ 181
   Dify 1.0 Plugin MCP HTTP with SSE or Streamable HTTP transport Tools

1060. **[MCP-Checklists](https://github.com/MCP-Manager/MCP-Checklists)** - ⭐ 181

1061. **[mcp-agent-graph](https://github.com/keta1930/mcp-agent-graph)** - ⭐ 180
   MCP Agent Graph is a Multi-Agent System built on the principles of Context Engineering

1062. **[mcp-servers-nix](https://github.com/natsukium/mcp-servers-nix)** - ⭐ 180
   A Nix-based configuration framework for Model Control Protocol (MCP) servers with ready-to-use packages.

1063. **[quarkus-mcp-servers](https://github.com/quarkiverse/quarkus-mcp-servers)** - ⭐ 179
   Model Context Protocol Servers in Quarkus

1064. **[k8s-mcp-server](https://github.com/alexei-led/k8s-mcp-server)** - ⭐ 179
   K8s-mcp-server is a Model Context Protocol (MCP) server that enables AI assistants like Claude to securely execute Kubernetes commands. It provides a bridge between language models and essential Kubernetes CLI tools including kubectl, helm, istioctl, and argocd, allowing AI systems to assist with cluster management, troubleshooting, and deployments

1065. **[Geargrafx](https://github.com/drhelius/Geargrafx)** - ⭐ 179
   PC Engine / TurboGrafx-16 / SuperGrafx / PCE CD-ROM² emulator and debugger for macOS, Windows, Linux, BSD and RetroArch.

1066. **[protoc-gen-go-mcp](https://github.com/redpanda-data/protoc-gen-go-mcp)** - ⭐ 178
   Go protobuf compiler extension to turn any gRPC service into an MCP server

1067. **[mcp-text-editor](https://github.com/tumf/mcp-text-editor)** - ⭐ 178

1068. **[claude-code-mcp](https://github.com/auchenberg/claude-code-mcp)** - ⭐ 178
   claude-code-mcp

1069. **[tripo-mcp](https://github.com/VAST-AI-Research/tripo-mcp)** - ⭐ 177
   Official MCP server for Tripo

1070. **[anki-mcp-server](https://github.com/scorzeth/anki-mcp-server)** - ⭐ 177
   An MCP server for Anki

1071. **[mcp-run-python](https://github.com/pydantic/mcp-run-python)** - ⭐ 177
   MCP server to run Python code in a sandbox.

1072. **[frida-mcp](https://github.com/dnakov/frida-mcp)** - ⭐ 177
   MCP stdio server for frida

1073. **[MakeMoneyWithAI](https://github.com/garylab/MakeMoneyWithAI)** - ⭐ 177
   A list of open-source AI projects you can use to generate income easily.

1074. **[quarkus-mcp-server](https://github.com/quarkiverse/quarkus-mcp-server)** - ⭐ 174
   This extension enables developers to implement the MCP server features easily.

1075. **[ida-mcp-server-plugin](https://github.com/taida957789/ida-mcp-server-plugin)** - ⭐ 174
   IDA Pro Plugin for serving MCP SSE server for cursor / claude

1076. **[mongo-mcp](https://github.com/QuantGeekDev/mongo-mcp)** - ⭐ 174
   A mongo db server for the model context protocol (MCP)

1077. **[bilibili-mcp-server](https://github.com/huccihuang/bilibili-mcp-server)** - ⭐ 174
   MCP Server for the Bilibili API, supporting various operations.

1078. **[wikipedia-mcp](https://github.com/Rudra-ravi/wikipedia-mcp)** - ⭐ 174
   A Model Context Protocol (MCP) server that retrieves information from Wikipedia to provide context to LLMs.

1079. **[mcp-server-siri-shortcuts](https://github.com/dvcrn/mcp-server-siri-shortcuts)** - ⭐ 173
   MCP for calling Siri Shorcuts from LLMs

1080. **[pctx](https://github.com/portofcontext/pctx)** - ⭐ 173
...
1081. **[ai-counsel](https://github.com/blueman82/ai-counsel)** - ⭐ 173
   True deliberative consensus MCP server where AI models debate and refine positions across multiple rounds

1082. **[spring-ai-playground](https://github.com/JM-Lab/spring-ai-playground)** - ⭐ 172
...
1083. **[mcp-snowflake-server](https://github.com/isaacwasserman/mcp-snowflake-server)** - ⭐ 172

1084. **[Revornix](https://github.com/Qingyon-AI/Revornix)** - ⭐ 172
...
1085. **[git-mcp-server](https://github.com/cyanheads/git-mcp-server)** - ⭐ 172
   An MCP (Model Context Protocol) server enabling LLMs and AI agents to interact with Git repositories. Provides tools for comprehensive Git operations including clone, commit, branch, diff, log, status, push, pull, merge, rebase, worktree, tag management, and more, via the MCP standard. STDIO & HTTP.

1086. **[aws-finops-mcp-server](https://github.com/ravikiranvm/aws-finops-mcp-server)** - ⭐ 172
   An MCP (Model Context Protocol) server that brings powerful AWS FinOps capabilities directly into your AI assistant. Analyze cloud costs, audit for waste, and get budget insights using natural language, all while keeping your credentials secure on your local machine.

1087. **[mcp-chat](https://github.com/PipedreamHQ/mcp-chat)** - ⭐ 172
   Examples of using Pipedream's MCP server in your app or AI agent.

1088. **[touchdesigner-mcp](https://github.com/8beeeaaat/touchdesigner-mcp)** - ⭐ 172
   MCP server for TouchDesigner

1089. **[skunit](https://github.com/mehrandvd/skunit)** - ⭐ 171
   skUnit is a testing tool for AI units, such as IChatClient, MCP Servers and agents.

1090. **[mcp-server-duckdb](https://github.com/ktanaka101/mcp-server-duckdb)** - ⭐ 171
   A Model Context Protocol (MCP) server implementation for DuckDB, providing database interaction capabilities

1091. **[tomcp](https://github.com/Ami3466/tomcp)** - ⭐ 171
   Turn any website or doc into an MCP server

1092. **[aws-mcp-server](https://github.com/alexei-led/aws-mcp-server)** - ⭐ 171
   A lightweight service that enables AI assistants to execute AWS CLI commands (in safe containerized environment) through the Model Context Protocol (MCP). Bridges Claude, Cursor, and other MCP-aware AI tools with AWS CLI for enhanced cloud infrastructure management.

1093. **[Text2Sql.Net](https://github.com/AIDotNet/Text2Sql.Net)** - ⭐ 170
   Text2Sql.Net 是一个使用DotNet和Semantic Kernel开发的Text2Sql工具

1094. **[mcp-scholarly](https://github.com/adityak74/mcp-scholarly)** - ⭐ 169
   A MCP server to search for accurate academic articles.

1095. **[command](https://github.com/scopecraft/command)** - ⭐ 169
   Scopecraft Command - A CLI and MCP server for Markdown-Driven Task Management (MDTM)

1096. **[openapi-mcp](https://github.com/ckanthony/openapi-mcp)** - ⭐ 168
   Dockerized MCP Server to allow your AI agent to access any API with existing api docs

1097. **[y-gui](https://github.com/luohy15/y-gui)** - ⭐ 168
   A Tiny Web Chat App for AI Models with MCP Client Support

1098. **[google-analytics-mcp](https://github.com/surendranb/google-analytics-mcp)** - ⭐ 167
...
1099. **[discordmcp](https://github.com/v-3/discordmcp)** - ⭐ 167
   Discord MCP Server for Claude Integration

1100. **[xero-mcp-server](https://github.com/XeroAPI/xero-mcp-server)** - ⭐ 167
   An MCP server that integrates with the MCP protocol. https://modelcontextprotocol.io/introduction

1101. **[facebook-ads-library-mcp](https://github.com/talknerdytome-labs/facebook-ads-library-mcp)** - ⭐ 167
   MCP Server for Facebook ADs Library - Get instant answers from FB's ad library

1102. **[binary_ninja_mcp](https://github.com/fosdickio/binary_ninja_mcp)** - ⭐ 167
   A Binary Ninja plugin containing an MCP server that enables seamless integration with your favorite LLM/MCP client.

1103. **[mcp-google-map](https://github.com/cablate/mcp-google-map)** - ⭐ 167
   A powerful Model Context Protocol (MCP) server providing comprehensive Google Maps API integration with LLM processing capabilities.

1104. **[claudepro-directory](https://github.com/JSONbored/claudepro-directory)** - ⭐ 166
...
1105. **[smart-coding-mcp](https://github.com/omar-haris/smart-coding-mcp)** - ⭐ 165
...
1106. **[mcp-use-ts](https://github.com/mcp-use/mcp-use-ts)** - ⭐ 165
   mcp-use is the framework for MCP with the best DX - Build AI agents, create MCP   servers with UI widgets, and debug with built-in inspector. Includes client SDK, server SDK, React hooks, and powerful dev tools.

1107. **[Chanakya-Local-Friend](https://github.com/Rishabh-Bajpai/Chanakya-Local-Friend)** - ⭐ 165
...
1108. **[toolbase](https://github.com/Toolbase-AI/toolbase)** - ⭐ 165
   A desktop application that adds powerful tools to Claude and AI platforms

1109. **[mcp-logseq](https://github.com/ergut/mcp-logseq)** - ⭐ 164
   MCP server to interact with LogSeq via its Local HTTP API - enabling AI assistants like Claude to seamlessly read, write, and manage your LogSeq graph.

1110. **[mcp-server-wazuh](https://github.com/gbrigandi/mcp-server-wazuh)** - ⭐ 164
   MCP Server for Wazuh SIEM

1111. **[keyboard-local](https://github.com/keyboard-dev/keyboard-local)** - ⭐ 163
   One MCP Server, All Your Apps, Privacy First

1112. **[after-effects-mcp](https://github.com/Dakkshin/after-effects-mcp)** - ⭐ 163
   MCP Server for Adobe After Effects. Enables remote control (compositions, text, shapes, solids, properties) via the Model Context Protocol using ExtendScript.

1113. **[meilisearch-mcp](https://github.com/meilisearch/meilisearch-mcp)** - ⭐ 163
   A Model Context Protocol (MCP) server for interacting with Meilisearch through LLM interfaces.

1114. **[tableau-mcp](https://github.com/tableau/tableau-mcp)** - ⭐ 163
...
1115. **[dify-mcp-client](https://github.com/3dify-project/dify-mcp-client)** - ⭐ 163
   MCP Client as an Agent Strategy Plugin. Support GUI operation via UI-TARS-SDK.

1116. **[claudex](https://github.com/Mng-dev-ai/claudex)** - ⭐ 163
...
1117. **[comfyui-mcp-server](https://github.com/joenorton/comfyui-mcp-server)** - ⭐ 163
   lightweight Python-based MCP (Model Context Protocol) server for local ComfyUI

1118. **[claude-context-local](https://github.com/FarhanAliRaza/claude-context-local)** - ⭐ 163
...
1119. **[mcp-servers](https://github.com/cursor/mcp-servers)** - ⭐ 163
   A list of MCP (Model Context Protocol) servers for developer tools and services

1120. **[mcp-server-weaviate](https://github.com/weaviate/mcp-server-weaviate)** - ⭐ 162
   MCP (Model Context Protocol) server for Weaviate

1121. **[lsp-mcp](https://github.com/jonrad/lsp-mcp)** - ⭐ 162
   An Model Context Protocol (MCP) server that provides LLMs/AI Agents with the capabilities of a language server protocol (LSP) server. This gives the AI the ability to get language aware context from the codebase.

1122. **[mcp-agent-langchainjs](https://github.com/Azure-Samples/mcp-agent-langchainjs)** - ⭐ 162
...
1123. **[mcp-telegram](https://github.com/sparfenyuk/mcp-telegram)** - ⭐ 162
   MCP server to work with Telegram through MTProto

1124. **[markmap-mcp-server](https://github.com/jinzcdev/markmap-mcp-server)** - ⭐ 162
   An MCP server for converting Markdown to interactive mind maps with export support (PNG/JPG/SVG).

1125. **[c4-genai-suite](https://github.com/codecentric/c4-genai-suite)** - ⭐ 161
   c4 GenAI Suite

1126. **[dbt-llm-agent](https://github.com/pragunbhutani/dbt-llm-agent)** - ⭐ 160
   LLM based AI Agent to automate Data Analysis for dbt projects with remote MCP server

1127. **[jmap-mcp](https://github.com/wyattjoh/jmap-mcp)** - ⭐ 160
   A Model Context Protocol (MCP) server that provides tools for interacting with JMAP (JSON Meta Application Protocol) email servers. Built with Deno and using the jmap-jam client library.

1128. **[mcp](https://github.com/magicuidesign/mcp)** - ⭐ 160
   Official Magic UI MCP server.

1129. **[cli-mcp-server](https://github.com/MladenSU/cli-mcp-server)** - ⭐ 160
   Command line interface for MCP clients with secure execution and customizable security policies

1130. **[gbox](https://github.com/babelcloud/gbox)** - ⭐ 159
   Cli and MCP for gbox. Enable AI agents to operate Android/Browser/Desktop like human.

1131. **[mcp-access-point](https://github.com/sxhxliang/mcp-access-point)** - ⭐ 159
   Turn a web server into an MCP server in one click without making any code changes.

1132. **[Quickchart-MCP-Server](https://github.com/GongRzhe/Quickchart-MCP-Server)** - ⭐ 159
...
1133. **[install-mcp](https://github.com/supermemoryai/install-mcp)** - ⭐ 159
   A simple CLI to install MCP servers into any client - auth included!

1134. **[remote-mcp-server](https://github.com/gleanwork/remote-mcp-server)** - ⭐ 158
   Remote MCP Server that securely connects Enterprise context with your LLM, IDE, or agent platform of choice.

1135. **[sketchup-mcp](https://github.com/mhyrr/sketchup-mcp)** - ⭐ 158
   Sketchup Model Context Protocol

1136. **[fetch-mcp](https://github.com/egoist/fetch-mcp)** - ⭐ 157
   An MCP server for fetching URLs / Youtube video transcript.

1137. **[spotinfo](https://github.com/alexei-led/spotinfo)** - ⭐ 157
   CLI for exploring AWS EC2 Spot inventory. Inspect AWS Spot instance types, saving, price, and interruption frequency.

1138. **[UnityNaturalMCP](https://github.com/notargs/UnityNaturalMCP)** - ⭐ 157
   UnityNaturalMCP is an MCP server implementation for Unity that aims for a "natural" user experience.

1139. **[compliant-llm](https://github.com/fiddlecube/compliant-llm)** - ⭐ 157
   Build Secure and Compliant AI agents and MCP Servers. YC W23

1140. **[agentregistry](https://github.com/agentregistry-dev/agentregistry)** - ⭐ 157
   Fast-track AI innovation with a centralized, trusted, curated registry

1141. **[mcp-shell-server](https://github.com/tumf/mcp-shell-server)** - ⭐ 157

1142. **[toolsdk-mcp-registry](https://github.com/toolsdk-ai/toolsdk-mcp-registry)** - ⭐ 156
...
1143. **[photoshop-python-api-mcp-server](https://github.com/loonghao/photoshop-python-api-mcp-server)** - ⭐ 156
   A Model Context Protocol (MCP) server that interfaces with Adobe Photoshop's Python API. Enables LLMs to execute image editing operations, automate workflows, and manage Photoshop tasks through structured commands and context-aware interactions.

1144. **[Companion](https://github.com/mattt/Companion)** - ⭐ 156
   Your neighborhood friendly MCP utility for macOS, iOS, and visionOS

1145. **[open-streetmap-mcp](https://github.com/jagan-shanmugam/open-streetmap-mcp)** - ⭐ 156
   An OpenStreetMap MCP server implementation that enhances LLM capabilities with location-based services and geospatial data.

1146. **[slack-mcp-client](https://github.com/tuannvm/slack-mcp-client)** - ⭐ 155
...
1147. **[integrate-mcp-with-copilot](https://github.com/skills/integrate-mcp-with-copilot)** - ⭐ 155
   Learn how to use MCP Servers with GitHub Copilot

1148. **[recall](https://github.com/joseairosa/recall)** - ⭐ 155
   Give Claude perfect recall - Redis-powered persistent memory for LLMs

1149. **[mcp-client-slackbot](https://github.com/sooperset/mcp-client-slackbot)** - ⭐ 154
   Simple Slackbot MCP Client

1150. **[XPack-MCP-Marketplace](https://github.com/xpack-ai/XPack-MCP-Marketplace)** - ⭐ 154
...
1151. **[awesome-a2a](https://github.com/pab1it0/awesome-a2a)** - ⭐ 154
   Agent2Agent (A2A) – awesome A2A agents, tools, servers & clients, all in one place. 

1152. **[mcp](https://github.com/neo4j/mcp)** - ⭐ 154
   Neo4j official MCP Server

1153. **[docs](https://github.com/strands-agents/docs)** - ⭐ 154
   Documentation for the Strands Agents SDK. A model-driven approach to building AI agents in just a few lines of code. 

1154. **[gate22](https://github.com/aipotheosis-labs/gate22)** - ⭐ 154
...
1155. **[claude-config-editor](https://github.com/gagarinyury/claude-config-editor)** - ⭐ 154
...
1156. **[life-sciences](https://github.com/anthropics/life-sciences)** - ⭐ 154
...
1157. **[flights-mcp](https://github.com/ravinahp/flights-mcp)** - ⭐ 153
   An MCP server to search for flights.

1158. **[discord-mcp](https://github.com/SaseQ/discord-mcp)** - ⭐ 153
   A MCP server for the Discord integration. Enable your AI assistants to seamlessly interact with Discord. Enhance your Discord experience with powerful automation capabilities.

1159. **[pg-mcp-server](https://github.com/ericzakariasson/pg-mcp-server)** - ⭐ 153
   MCP Server for Postgres

1160. **[mcp-server-langfuse](https://github.com/langfuse/mcp-server-langfuse)** - ⭐ 153
   Model Context Protocol (MCP) Server for Langfuse Prompt Management. This server allows you to access and manage your Langfuse prompts through the Model Context Protocol.

1161. **[DrissionPageMCP](https://github.com/wxhzhwxhzh/DrissionPageMCP)** - ⭐ 153
   基于DrissionPage和FastMCP的浏览器自动化MCP服务器，提供丰富的浏览器操作API供AI调用

1162. **[mcp-opennutrition](https://github.com/deadletterq/mcp-opennutrition)** - ⭐ 153
...
1163. **[appium-mcp](https://github.com/appium/appium-mcp)** - ⭐ 153
   Appium MCP on Steroids!

1164. **[python-mcp-server-client](https://github.com/GobinFan/python-mcp-server-client)** - ⭐ 152
   支持查询主流agent框架技术文档的MCP server（支持stdio和sse两种传输协议）, 支持 langchain、llama-index、autogen、agno、openai-agents-sdk、mcp-doc、camel-ai 和 crew-ai

1165. **[MCP-Salesforce](https://github.com/smn2gnt/MCP-Salesforce)** - ⭐ 152
   MCP Salesforce connector

1166. **[mcp-summarizer](https://github.com/0xshellming/mcp-summarizer)** - ⭐ 152
   MCP Server for AI Summarization

1167. **[web3-research-mcp](https://github.com/aaronjmars/web3-research-mcp)** - ⭐ 152
   Deep Research for crypto - free & fully local

1168. **[alibabacloud-tablestore-mcp-server](https://github.com/aliyun/alibabacloud-tablestore-mcp-server)** - ⭐ 152

1169. **[tmcp](https://github.com/paoloricciuti/tmcp)** - ⭐ 151
   Typescript SDK to build MCP servers in an agnostic way

1170. **[mcptools](https://github.com/posit-dev/mcptools)** - ⭐ 151
   Model Context Protocol For R

1171. **[awesome-claude-dxt](https://github.com/milisp/awesome-claude-dxt)** - ⭐ 150
   Awesome Claude Desktop Extensions (dxt) (not only Claude) mcpb

1172. **[mcp-server-metamcp](https://github.com/metatool-ai/mcp-server-metamcp)** - ⭐ 150
   MCP Server MetaMCP manages all your other MCPs in one MCP.

1173. **[eShopLite](https://github.com/Azure-Samples/eShopLite)** - ⭐ 150
   eShopLite is a set of reference .NET applications implementing an eCommerce site with features like Semantic Search, MCP, Reasoning models and more.

1174. **[superset-mcp](https://github.com/aptro/superset-mcp)** - ⭐ 150
   connect to 50+ data stores via superset mcp server. Can use with open ai agent sdk, Claude app, cursor, windsurf

1175. **[tinymcp](https://github.com/golioth/tinymcp)** - ⭐ 149
   Let LLMs control embedded devices via the Model Context Protocol.

1176. **[mcp-simple-pubmed](https://github.com/andybrandt/mcp-simple-pubmed)** - ⭐ 149
   MCP server for searching and querying PubMed medical papers/research database

1177. **[instagram_dm_mcp](https://github.com/trypeggy/instagram_dm_mcp)** - ⭐ 149
   Instagram Direct messages MCP

1178. **[mcp-server-example](https://github.com/alejandro-ao/mcp-server-example)** - ⭐ 149
   A simple MCP server to search for documentation (tutorial)

1179. **[MCPHub-Desktop](https://github.com/Jeamee/MCPHub-Desktop)** - ⭐ 149
   Desktop APP for Discover and Install MCP Servers

1180. **[mcp-server-guide](https://github.com/figma/mcp-server-guide)** - ⭐ 149
   A guide on how to use the Figma MCP server

1181. **[mcp-client-go](https://github.com/yincongcyincong/mcp-client-go)** - ⭐ 148
   mcp client for Go (Golang). Integrate multiple  Model Context Protocol (MCP) servers

1182. **[mcp-gateway](https://github.com/lightconetech/mcp-gateway)** - ⭐ 148
   A gateway demo for MCP SSE Server

1183. **[make-mcp-server](https://github.com/integromat/make-mcp-server)** - ⭐ 148
   Make MCP Server

1184. **[GEmojiSharp](https://github.com/hlaueriksson/GEmojiSharp)** - ⭐ 148
   :octocat: GitHub Emoji for C#, dotnet and beyond

1185. **[opentelemetry-mcp-server](https://github.com/traceloop/opentelemetry-mcp-server)** - ⭐ 148
   Unified MCP server for querying OpenTelemetry traces across multiple backends (Jaeger, Tempo, Traceloop, etc.), enabling AI agents to analyze distributed traces for automated debugging and observability.

1186. **[metatrader-mcp-server](https://github.com/ariadng/metatrader-mcp-server)** - ⭐ 148
   Model Context Protocol (MCP) to enable AI LLMs to trade using MetaTrader platform

1187. **[scrapeless-mcp-server](https://github.com/scrapeless-ai/scrapeless-mcp-server)** - ⭐ 148
   Scrapeless Mcp Server

1188. **[mcp-solver](https://github.com/szeider/mcp-solver)** - ⭐ 147
   Model Context Protocol (MCP) server for constraint optimization and solving"

1189. **[Gemini-mcp](https://github.com/LKbaba/Gemini-mcp)** - ⭐ 146
   MCP server implementation for Google's Gemini API

1190. **[any-chat-completions-mcp](https://github.com/pyroprompts/any-chat-completions-mcp)** - ⭐ 146
   MCP Server for using any LLM as a Tool

1191. **[Log-Analyzer-with-MCP](https://github.com/awslabs/Log-Analyzer-with-MCP)** - ⭐ 146
   A Model Context Protocol (MCP) server that provides AI assistants access to AWS CloudWatch Logs for analysis, searching, and correlation

1192. **[relay](https://github.com/prism-php/relay)** - ⭐ 146
   An MCP client tool for Prism

1193. **[mcp-shark](https://github.com/mcp-shark/mcp-shark)** - ⭐ 146
...
1194. **[chatgpt-copilot](https://github.com/feiskyer/chatgpt-copilot)** - ⭐ 145
   ChatGPT Copilot Extension for Visual Studio Code

1195. **[postman-mcp-server](https://github.com/postmanlabs/postman-mcp-server)** - ⭐ 145
   Connect your AI to your APIs on Postman

1196. **[mcp-server-weread](https://github.com/ChenyqThu/mcp-server-weread)** - ⭐ 145

1197. **[postman-mcp-server](https://github.com/delano/postman-mcp-server)** - ⭐ 145
   An MCP server that provides access to Postman.

1198. **[decipher-research-agent](https://github.com/mtwn105/decipher-research-agent)** - ⭐ 145
   Turn topics, links, and files into AI-generated research notebooks — summarize, explore, and ask anything.

1199. **[lucid-agents](https://github.com/daydreamsai/lucid-agents)** - ⭐ 145
...
1200. **[figma-mcp-server](https://github.com/TimHolden/figma-mcp-server)** - ⭐ 145
   Model Context Protocol server implementation for Figma API

1201. **[garmin_mcp](https://github.com/Taxuspt/garmin_mcp)** - ⭐ 145
   MCP server to access Garmin data

1202. **[website-downloader](https://github.com/pskill9/website-downloader)** - ⭐ 144
   MCP server to download entire websites

1203. **[OpenDataMCP](https://github.com/OpenDataMCP/OpenDataMCP)** - ⭐ 144
   Connect any Open Data to any LLM with Model Context Protocol.

1204. **[goku](https://github.com/jcaromiq/goku)** - ⭐ 144
   Goku is an HTTP load testing application written in Rust 

1205. **[CreatorBox](https://github.com/xiesx123/CreatorBox)** - ⭐ 144
   🚀🎬灵活、高效、可扩展，专属剪辑配音工具箱，释放创作潜力 . Flexible, efficient, and scalable toolbox for editing and dubbing, unleashing creative potential

1206. **[task-orchestrator](https://github.com/jpicklyk/task-orchestrator)** - ⭐ 144
...
1207. **[cursor-notebook-mcp](https://github.com/jbeno/cursor-notebook-mcp)** - ⭐ 144
   Model Context Protocol (MCP) server designed to allow AI agents within Cursor to interact with Jupyter Notebook (.ipynb) files

1208. **[agentor](https://github.com/CelestoAI/agentor)** - ⭐ 144
...
1209. **[mcp-1panel](https://github.com/1Panel-dev/mcp-1panel)** - ⭐ 143
   mcp-1panel is an implementation of the Model Context Protocol (MCP) server for 1Panel.

1210. **[mcp-3D-printer-server](https://github.com/DMontgomery40/mcp-3D-printer-server)** - ⭐ 143
   Connects MCP to major 3D printer APIs (Orca, Bambu, OctoPrint, Klipper, Duet, Repetier, Prusa, Creality). Control prints, monitor status, and perform advanced STL operations like scaling, rotation, sectional editing, and base extension. Includes slicing and visualization.

1211. **[ultimate_mcp_client](https://github.com/Dicklesworthstone/ultimate_mcp_client)** - ⭐ 143

1212. **[In-Memoria](https://github.com/pi22by7/In-Memoria)** - ⭐ 143
   Persistent Intelligence Infrastructure for AI Agents

1213. **[mcp-mysql-server](https://github.com/f4ww4z/mcp-mysql-server)** - ⭐ 143
   A Model Context Protocol server for MySQL database operations

1214. **[mcp-dotnet-samples](https://github.com/microsoft/mcp-dotnet-samples)** - ⭐ 143
   A comprehensive set of samples of creating and using MCP servers and clients with .NET

1215. **[plane-mcp-server](https://github.com/makeplane/plane-mcp-server)** - ⭐ 143
   Plane's Official Model Context Protocol Server 🔌 ⌨️ 🔥

1216. **[pubmearch](https://github.com/Darkroaster/pubmearch)** - ⭐ 142
   A PubMed MCP server.

1217. **[open-responses-server](https://github.com/teabranch/open-responses-server)** - ⭐ 142
   Wraps any OpenAI API interface as Responses with MCPs support so it supports Codex. Adding any missing stateful features. Ollama and Vllm compliant.

1218. **[polymarket-mcp-server](https://github.com/caiovicentino/polymarket-mcp-server)** - ⭐ 142
   🤖 AI-Powered MCP Server for Polymarket - Enable Claude to trade prediction markets with 45 tools, real-time monitoring, and enterprise-grade safety features

1219. **[hypertool-mcp](https://github.com/toolprint/hypertool-mcp)** - ⭐ 142
   Dynamically expose tools from proxied servers based on an Agent Persona

1220. **[ReActMCP](https://github.com/mshojaei77/ReActMCP)** - ⭐ 141
   ReActMCP is a reactive MCP client that empowers AI assistants to instantly respond with real-time, Markdown-formatted web search insights powered by the Exa API.

1221. **[kom](https://github.com/weibaohui/kom)** - ⭐ 141
   kom 是一个用于 Kubernetes 操作的工具，SDK级的kubectl、client-go的使用封装。并且支持作为管理k8s 的 MCP server。 它提供了一系列功能来管理 Kubernetes 资源，包括创建、更新、删除和获取资源，甚至使用SQL查询k8s资源。这个项目支持多种 Kubernetes 资源类型的操作，并能够处理自定义资源定义（CRD）。 通过使用 kom，你可以轻松地进行资源的增删改查和日志获取以及操作POD内文件等动作。

1222. **[quick-data-mcp](https://github.com/disler/quick-data-mcp)** - ⭐ 141
   Prompt focused MCP Server for .json and .csv agentic data analytics for Claude Code

1223. **[notion-mcp-server](https://github.com/awkoy/notion-mcp-server)** - ⭐ 141
   **Notion MCP Server** is a Model Context Protocol (MCP) server implementation that enables AI assistants to interact with Notion's API. This production-ready server provides a complete set of tools.

1224. **[sunpeak](https://github.com/Sunpeak-AI/sunpeak)** - ⭐ 141
   Local-first ChatGPT App framework.

1225. **[mcp-discord](https://github.com/hanweg/mcp-discord)** - ⭐ 141
   MCP server for discord bot

1226. **[node-code-sandbox-mcp](https://github.com/alfonsograziano/node-code-sandbox-mcp)** - ⭐ 140
   A Node.js–based Model Context Protocol server that spins up disposable Docker containers to execute arbitrary JavaScript.

1227. **[solana-mcp](https://github.com/sendaifun/solana-mcp)** - ⭐ 140
   A Model Context Protocol server for interacting with the Solana blockchain, powered by the Solana Agent Kit (https://github.com/sendaifun/solana-agent-kit)

1228. **[powerpoint](https://github.com/supercurses/powerpoint)** - ⭐ 140
   A MCP Server for creating Powerpoint Presentations

1229. **[osint-tools-mcp-server](https://github.com/frishtik/osint-tools-mcp-server)** - ⭐ 140
   MCP server exposing multiple OSINT tools for AI assistants like Claude

1230. **[mcp-server-starrocks](https://github.com/StarRocks/mcp-server-starrocks)** - ⭐ 140
   StarRocks MCP (Model Context Protocol) Server

1231. **[mcp-server-calculator](https://github.com/githejie/mcp-server-calculator)** - ⭐ 140
   A Model Context Protocol server for calculating.

1232. **[mcp-montano-server](https://github.com/lucasmontano/mcp-montano-server)** - ⭐ 139
   Simple MCP Server Implementation

1233. **[MCP-X](https://github.com/TimeCyber/MCP-X)** - ⭐ 139
...
1234. **[agentql-mcp](https://github.com/tinyfish-io/agentql-mcp)** - ⭐ 139
   Model Context Protocol server that integrates AgentQL's data extraction capabilities.

1235. **[obsidian-claude-code-mcp](https://github.com/iansinnott/obsidian-claude-code-mcp)** - ⭐ 139
   Connect Claude Code and other AI tools to your Obsidian notes using Model Context Protocol (MCP)

1236. **[burp-mcp-agents](https://github.com/six2dez/burp-mcp-agents)** - ⭐ 139
   Practical setup guides and helpers to connect Burp Suite MCP Server to multiple AI backends (Codex, Gemini, Ollama, ...).

1237. **[google-slides-mcp](https://github.com/matteoantoci/google-slides-mcp)** - ⭐ 138
   MCP Server for Google Slides

1238. **[datagov-mcp](https://github.com/aviveldan/datagov-mcp)** - ⭐ 138
   MCP server for Israel Government Data

1239. **[mcp-interviewer](https://github.com/microsoft/mcp-interviewer)** - ⭐ 138
   Catch MCP server issues before your agents do.

1240. **[eion](https://github.com/eiondb/eion)** - ⭐ 138
   Shared Memory Storage for Multi-Agent Systems

1241. **[rust-mcp-sdk](https://github.com/rust-mcp-stack/rust-mcp-sdk)** - ⭐ 138
   A high-performance, asynchronous toolkit for building MCP servers and clients in Rust.

1242. **[penpot-mcp](https://github.com/penpot/penpot-mcp)** - ⭐ 138
   Penpot's official MCP Server

1243. **[systemprompt-code-orchestrator](https://github.com/systempromptio/systemprompt-code-orchestrator)** - ⭐ 137
     MCP server for orchestrating AI coding agents (Claude Code CLI & Gemini CLI). Features task management, process execution, Git integration, and dynamic resource discovery. Full TypeScript implementation with Docker support and Cloudflare Tunnel integration. 

1244. **[logfire-mcp](https://github.com/pydantic/logfire-mcp)** - ⭐ 137
   The Logfire MCP Server is here! :tada:

1245. **[autocad-mcp](https://github.com/puran-water/autocad-mcp)** - ⭐ 137
...
1246. **[code-assistant](https://github.com/stippi/code-assistant)** - ⭐ 137
   An LLM-powered, autonomous coding assistant. Also offers an MCP and ACP mode.

1247. **[graphiti-mcp-server](https://github.com/gifflet/graphiti-mcp-server)** - ⭐ 137
   Graphiti MCP Server

1248. **[mssql-mcp](https://github.com/Aaronontheweb/mssql-mcp)** - ⭐ 136
   MSSQL Server MCP implementation written in C#

1249. **[doc-ops-mcp](https://github.com/Tele-AI/doc-ops-mcp)** - ⭐ 136
   MCP server for seamless document format conversion and processing

1250. **[guidance-for-deploying-model-context-protocol-servers-on-aws](https://github.com/aws-solutions-library-samples/guidance-for-deploying-model-context-protocol-servers-on-aws)** - ⭐ 136
...
1251. **[uaip](https://github.com/concierge-hq/uaip)** - ⭐ 136
...
1252. **[SecureMCP](https://github.com/makalin/SecureMCP)** - ⭐ 136
...
1253. **[mcp-k8s](https://github.com/silenceper/mcp-k8s)** - ⭐ 136
   A Kubernetes MCP (Model Control Protocol) server that enables interaction with Kubernetes clusters through MCP tools.

1254. **[bilibili-mcp-js](https://github.com/34892002/bilibili-mcp-js)** - ⭐ 136
   Bilibili video search MCP (Model Context Protocol) service - 哔哩哔哩视频搜索MCP服务

1255. **[mcp-server-odoo](https://github.com/ivnvxd/mcp-server-odoo)** - ⭐ 136
   A Model Context Protocol (MCP) server that enables AI assistants to securely interact with Odoo ERP systems through standardized resources and tools for data retrieval and manipulation.

1256. **[wa_llm](https://github.com/ilanbenb/wa_llm)** - ⭐ 135
   A WhatsApp bot that can participate in group conversations, powered by AI. The bot monitors group messages and responds when mentioned.

1257. **[refref](https://github.com/refrefhq/refref)** - ⭐ 135
   🌟 Open Source Referral and Affiliate Marketing Platform - Launch your referral program in minutes!

1258. **[agent-toolkit](https://github.com/datacommonsorg/agent-toolkit)** - ⭐ 135
   Tools and agents for interacting with the Data Commons Knowledge Graph using the Model Context Protocol (MCP).

1259. **[MaxMSP-MCP-Server](https://github.com/tiianhk/MaxMSP-MCP-Server)** - ⭐ 135
   MCP (Model Context Protocol) Server for Max (Max/MSP/Jitter)

1260. **[strudel-mcp-server](https://github.com/williamzujkowski/strudel-mcp-server)** - ⭐ 135
   A Model Context Protocol (MCP) server that gives Claude direct control over Strudel.cc for AI-assisted music generation and live coding.

1261. **[backlog-mcp-server](https://github.com/nulab/backlog-mcp-server)** - ⭐ 135

1262. **[mkinf](https://github.com/mkinf-io/mkinf)** - ⭐ 134
   mkinf SDK to interact with mkinf hub MCP servers

1263. **[hayhooks](https://github.com/deepset-ai/hayhooks)** - ⭐ 134
   Easily deploy Haystack pipelines as REST APIs and MCP Tools.

1264. **[mcp-server-typescript](https://github.com/dataforseo/mcp-server-typescript)** - ⭐ 134
   DataForSEO API modelcontextprotocol server 

1265. **[mcp-server-serper](https://github.com/marcopesani/mcp-server-serper)** - ⭐ 134
   Serper MCP Server supporting search and webpage scraping

1266. **[zettelkasten-mcp](https://github.com/entanglr/zettelkasten-mcp)** - ⭐ 134
   A Model Context Protocol (MCP) server that implements the Zettelkasten knowledge management methodology, allowing you to create, link, explore and synthesize atomic notes through Claude and other MCP-compatible clients.

1267. **[memory-graph](https://github.com/memory-graph/memory-graph)** - ⭐ 134
   A graph DB-based MCP memory server for coding agents with intelligent relationship tracking

1268. **[Multi-Source-Media-MCP-Server](https://github.com/Decade-qiu/Multi-Source-Media-MCP-Server)** - ⭐ 133
   An MCP Tool Implementation for Multi-Source Image Access & Generation

1269. **[LMStudio-MCP](https://github.com/infinitimeless/LMStudio-MCP)** - ⭐ 133
   A Model Control Protocol (MCP) server that allows Claude to communicate with locally running LLM models via LM Studio.

1270. **[Awesome-MCP](https://github.com/AlexMili/Awesome-MCP)** - ⭐ 133
   Awesome ModelContextProtocol resources - A curated list of MCP resources

1271. **[mcp-think-tool](https://github.com/DannyMac180/mcp-think-tool)** - ⭐ 133
   An MCP server implementing the think tool for Claude

1272. **[mcp-server-reddit](https://github.com/Hawstein/mcp-server-reddit)** - ⭐ 133
   A Model Context Protocol (MCP) server that provides tools for fetching Reddit content, including frontpage posts, subreddit information and hot posts, post details, and comments.

1273. **[k8s-mcp-server](https://github.com/reza-gholizade/k8s-mcp-server)** - ⭐ 133
   Manage Your Kubernetes Cluster with k8s mcp-server

1274. **[seo-research-mcp](https://github.com/egebese/seo-research-mcp)** - ⭐ 133
...
1275. **[Gitingest-MCP](https://github.com/puravparab/Gitingest-MCP)** - ⭐ 132
   mcp server for gitingest

1276. **[zabbix-mcp-server](https://github.com/mpeirone/zabbix-mcp-server)** - ⭐ 132
...
1277. **[mcp-email-server](https://github.com/ai-zerolab/mcp-email-server)** - ⭐ 132
   IMAP and SMTP via MCP Server

1278. **[Frappe_Assistant_Core](https://github.com/buildswithpaul/Frappe_Assistant_Core)** - ⭐ 132
   Infrastructure that connects LLMs to ERPNext. Frappe Assistant Core works with the Model Context Protocol (MCP) to expose ERPNext functionality to any compatible Language Model

1279. **[frontmcp](https://github.com/agentfront/frontmcp)** - ⭐ 132
   TypeScript-first framework for the Model Context Protocol (MCP). You write clean, typed code; FrontMCP handles the protocol, transport, DI, session/auth, and execution flow.

1280. **[vllm-mlx](https://github.com/waybarrios/vllm-mlx)** - ⭐ 132
...
1281. **[mcp-bigquery-server](https://github.com/ergut/mcp-bigquery-server)** - ⭐ 131
   A Model Context Protocol (MCP) server that provides secure, read-only access to BigQuery datasets. Enables Large Language Models (LLMs) to safely query and analyze data through a standardized interface.

1282. **[MCP-PostgreSQL-Ops](https://github.com/call518/MCP-PostgreSQL-Ops)** - ⭐ 131
...
1283. **[ragrabbit](https://github.com/madarco/ragrabbit)** - ⭐ 131
   Open Source, Self-Hosted, AI Search and LLM.txt for your website

1284. **[AgentCrew](https://github.com/saigontechnology/AgentCrew)** - ⭐ 131
   Chat application with multi-agents system supports multi-models and MCP

1285. **[mcp-chat](https://github.com/Flux159/mcp-chat)** - ⭐ 131
   Open Source Generic MCP Client for testing & evaluating mcp servers and agents

1286. **[ghost-mcp](https://github.com/MFYDev/ghost-mcp)** - ⭐ 131
   A Model Context Protocol (MCP) server for interacting with Ghost CMS through LLM interfaces like Claude. Allow you to control your Ghost blog by simply asking Claude etc.

1287. **[awesome-crypto-mcp-servers](https://github.com/badkk/awesome-crypto-mcp-servers)** - ⭐ 130
   A collection of crypto MCP servers.

1288. **[intervals-mcp-server](https://github.com/mvilanova/intervals-mcp-server)** - ⭐ 130
   Model Context Protocol (MCP) server for connecting Claude and ChatGPT with the Intervals.icu API.

1289. **[freecad_mcp](https://github.com/bonninr/freecad_mcp)** - ⭐ 130
...
1290. **[mcp-gateway](https://github.com/acehoss/mcp-gateway)** - ⭐ 129
...
1291. **[N8N2MCP](https://github.com/Super-Chain/N8N2MCP)** - ⭐ 129
   Convert N8N agent / workflow into MCP servers, you can use it in Claude / Cursor / Super Chain 

1292. **[concierge](https://github.com/concierge-hq/concierge)** - ⭐ 129
   Open Source AI platform to build Agentic services, ChatGPT Apps and MCP Servers

1293. **[ultimate_mcp_server](https://github.com/Dicklesworthstone/ultimate_mcp_server)** - ⭐ 129
   The Ultimate Model Context Protocol (MCP) Server, providing unified access to a wide variety of useful and powerful tools.

1294. **[xhs-mcp-server](https://github.com/aicu-icu/xhs-mcp-server)** - ⭐ 129
   小红书MCP服务器 | 基于Electron+小红书Web API。一键安装运行、极速抓取笔记、评论、用户等数据并让AI智能分析、整理与导出

1295. **[zotero-mcp](https://github.com/kujenga/zotero-mcp)** - ⭐ 128
   Model Context Protocol (MCP) server for the Zotero API, in Python

1296. **[aws-cost-explorer-mcp-server](https://github.com/aarora79/aws-cost-explorer-mcp-server)** - ⭐ 128
   MCP server for understanding AWS spend

1297. **[mcp-server-aws](https://github.com/rishikavikondala/mcp-server-aws)** - ⭐ 128
   A Model Context Protocol server implementation for operations on AWS resources

1298. **[jupyter-ai-agents](https://github.com/datalayer/jupyter-ai-agents)** - ⭐ 128
   🪐 🤖 AI Agents for JupyterLab with 🔧 MCP tools - Chat interface for optimized notebook interaction and code execution.

1299. **[OmniFocus-MCP](https://github.com/themotionmachine/OmniFocus-MCP)** - ⭐ 128
   Let LLMs interface with your tasks and projects through the Model Context Protocol. Add, organize, and query your OmniFocus database with natural language commands.

1300. **[play-store-mcp](https://github.com/antoniolg/play-store-mcp)** - ⭐ 128
   An MCP server that connects to Play Store Console and release new App versions from an MCP Client

1301. **[mcp-server-manifest](https://github.com/Zomato/mcp-server-manifest)** - ⭐ 128

1302. **[ssh-mcp-server](https://github.com/classfang/ssh-mcp-server)** - ⭐ 128
   基于 SSH 的 MCP 服务器 🧙‍♀️。已被MCP官方收录 🎉。 SSH MCP Server 🧙‍♀️. It has been included in the community MCP repository 🎉.

1303. **[mcp-server-plugin](https://github.com/JetBrains/mcp-server-plugin)** - ⭐ 127
   JetBrains MCP Server Plugin

1304. **[magg](https://github.com/sitbon/magg)** - ⭐ 127
   Magg: The MCP Aggregator

1305. **[esp-mcp](https://github.com/horw/esp-mcp)** - ⭐ 127
   Centralize ESP32 related commands and simplify getting started with seamless, LLM-driven interaction and help.

1306. **[Human-In-the-Loop-MCP-Server](https://github.com/GongRzhe/Human-In-the-Loop-MCP-Server)** - ⭐ 127
...
1307. **[mcp-server-macos-use](https://github.com/mediar-ai/mcp-server-macos-use)** - ⭐ 127
   AI agent that controls computer with OS-level tools, MCP compatible, works with any model

1308. **[A2A-MCP-Server](https://github.com/GongRzhe/A2A-MCP-Server)** - ⭐ 127
...
1309. **[think-mcp-server](https://github.com/PhillipRt/think-mcp-server)** - ⭐ 126

1310. **[crawl4ai-mcp-server](https://github.com/weidwonder/crawl4ai-mcp-server)** - ⭐ 126
   用于提供给本地开发者的 LLM的高效互联网搜索&内容获取的MCP Server， 节省你的token

1311. **[claude-prompts-mcp](https://github.com/minipuft/claude-prompts-mcp)** - ⭐ 126
   MCP prompt template server: hot-reload, thinking frameworks, quality gates

1312. **[mcp-server-apache-airflow](https://github.com/yangkyeongmo/mcp-server-apache-airflow)** - ⭐ 126

1313. **[specs-workflow-mcp](https://github.com/kingkongshot/specs-workflow-mcp)** - ⭐ 126
   Intelligent spec workflow management MCP server

1314. **[claude-prompts](https://github.com/minipuft/claude-prompts)** - ⭐ 126
   MCP prompt template server: hot-reload, thinking frameworks, quality gates

1315. **[dart-mcp-server](https://github.com/its-dart/dart-mcp-server)** - ⭐ 126
   Dart AI Model Context Protocol (MCP) server

1316. **[codeql-mcp](https://github.com/JordyZomer/codeql-mcp)** - ⭐ 126
...
1317. **[mcpd](https://github.com/mozilla-ai/mcpd)** - ⭐ 126
...
1318. **[mcp-read-website-fast](https://github.com/just-every/mcp-read-website-fast)** - ⭐ 126
   Quickly reads webpages and converts to markdown for fast, token efficient web scraping

1319. **[Context-Engineering-for-Multi-Agent-Systems](https://github.com/Denis2054/Context-Engineering-for-Multi-Agent-Systems)** - ⭐ 126
...
1320. **[sudocode](https://github.com/sudocode-ai/sudocode)** - ⭐ 126
   Lightweight agent orchestration dev tool that lives in your repo

1321. **[play-store-mcp](https://github.com/devexpert-io/play-store-mcp)** - ⭐ 125
   An MCP server that connects to Play Store Console and release new App versions from an MCP Client

1322. **[dify-plugin-agent-mcp_sse](https://github.com/junjiem/dify-plugin-agent-mcp_sse)** - ⭐ 125
   Dify 1.0 Plugin Support MCP Tools Agent strategies

1323. **[ollama-mcp](https://github.com/rawveg/ollama-mcp)** - ⭐ 125
   An MCP Server for Ollama

1324. **[mcp-client-server](https://github.com/willccbb/mcp-client-server)** - ⭐ 124
   An MCP Server that's also an MCP Client. Useful for letting Claude develop and test MCPs without needing to reset the application.

1325. **[mcp-server-ccxt](https://github.com/doggybee/mcp-server-ccxt)** - ⭐ 124
   High-performance CCXT MCP server for cryptocurrency exchange integration

1326. **[buttplug-mcp](https://github.com/ConAcademy/buttplug-mcp)** - ⭐ 124
   Buttplug.io Model Context Protocol (MCP) Server

1327. **[mcp-rubber-duck](https://github.com/nesquikm/mcp-rubber-duck)** - ⭐ 124
   An MCP server that acts as a bridge to query multiple OpenAI-compatible LLMs with MCP tool access. Just like rubber duck debugging, explain your problems to various AI "ducks" who can actually research and get different perspectives!

1328. **[ChatPPT-MCP](https://github.com/YOOTeam/ChatPPT-MCP)** - ⭐ 124
...
1329. **[zig-mcp](https://github.com/zig-wasm/zig-mcp)** - ⭐ 124
   Model Context Protocol (MCP) server that provides up-to-date documentation for the Zig programming language standard library and builtin functions

1330. **[radare2-mcp](https://github.com/radareorg/radare2-mcp)** - ⭐ 124
   MCP stdio server for radare2

1331. **[mcp_server_exe](https://github.com/shadowcz007/mcp_server_exe)** - ⭐ 124
   小智 & Cursor 的 MCP 启动器 - MCP For Cursor&xiaozhi。打包成可执行文件。Turn MCP server into an executable file

1332. **[mcp-evals](https://github.com/mclenhard/mcp-evals)** - ⭐ 123
   A Node.js package and GitHub Action for evaluating MCP (Model Context Protocol) tool implementations using LLM-based scoring. This helps ensure your MCP server's tools are working correctly and performing well.

1333. **[laravel-loop](https://github.com/kirschbaum-development/laravel-loop)** - ⭐ 123
   Laravel Loop is a powerful Model Context Protocol (MCP) server designed specifically for Laravel applications. It connects your Laravel application with AI assistants using the MCP protocol.

1334. **[ZotLink](https://github.com/TonybotNi/ZotLink)** - ⭐ 123
...
1335. **[mcp-linear](https://github.com/tacticlaunch/mcp-linear)** - ⭐ 123
...
1336. **[beyond-mcp](https://github.com/disler/beyond-mcp)** - ⭐ 123
   It's time to push beyond MCP Servers... Right?

1337. **[mcp](https://github.com/pronskiy/mcp)** - ⭐ 123
   🐉 The fast, PHP way to build MCP servers

1338. **[mcp-svelte-docs](https://github.com/spences10/mcp-svelte-docs)** - ⭐ 123
   🔍 MCP server that lets you search and access Svelte documentation with built-in caching

1339. **[aicode-toolkit](https://github.com/AgiFlow/aicode-toolkit)** - ⭐ 123
   Toolkit for Coding Agents to work reliably with repo of any size.

1340. **[drawio2go](https://github.com/Menghuan1918/drawio2go)** - ⭐ 123
   A modern DrawIO editor application.  AI-Powered, Human-AI Collaboration | AI 加持，人机共绘drawio

1341. **[linear-mcp](https://github.com/cline/linear-mcp)** - ⭐ 122
   a private MCP server for accessing Linear

1342. **[unreal-analyzer-mcp](https://github.com/ayeletstudioindia/unreal-analyzer-mcp)** - ⭐ 122
   MCP server for Unreal Engine 5

1343. **[tiktok-mcp](https://github.com/Seym0n/tiktok-mcp)** - ⭐ 122
   Model Context Protocol (MCP) with TikTok integration

1344. **[4D-ARE](https://github.com/ybeven/4D-ARE)** - ⭐ 122
...
1345. **[mcp-streamable-http](https://github.com/invariantlabs-ai/mcp-streamable-http)** - ⭐ 121
   Example implementation of MCP Streamable HTTP client/server in Python and TypeScript.

1346. **[muppet](https://github.com/muppet-dev/muppet)** - ⭐ 121
   MCP Servers SDK for TypeScript

1347. **[mevzuat-mcp](https://github.com/saidsurucu/mevzuat-mcp)** - ⭐ 121
   MCP Server for Searching Turkish Legislation

1348. **[mcp-endpoint-server](https://github.com/xinnan-tech/mcp-endpoint-server)** - ⭐ 121
   xiaozhi mcp接入点服务器，用于自定义mcp服务注册，方便拓展小智服务端工具调用

1349. **[mcp-server-bigquery](https://github.com/LucasHild/mcp-server-bigquery)** - ⭐ 121
   A Model Context Protocol server that provides access to BigQuery

1350. **[aws-lambda-mcp-cookbook](https://github.com/ran-isenberg/aws-lambda-mcp-cookbook)** - ⭐ 121
...
1351. **[openapi](https://github.com/samchon/openapi)** - ⭐ 121
   OpenAPI definitions, converters and LLM function calling schema composer.

1352. **[UnityMCP](https://github.com/isuzu-shiranui/UnityMCP)** - ⭐ 120
   Unity Editor integration with Model Context Protocol (MCP) enabling AI assistants like Claude to interact with Unity projects. Features a TypeScript MCP server and C# Unity plugin with extensible command handler architecture, TCP/IP communication, and dynamic plugin discovery.

1353. **[mcp-server-datadog](https://github.com/winor30/mcp-server-datadog)** - ⭐ 120

1354. **[mcp-watch](https://github.com/kapilduraphe/mcp-watch)** - ⭐ 120
   A comprehensive security scanner for Model Context Protocol (MCP) servers that detects vulnerabilities and security issues in your MCP server implementations.

1355. **[unifi-network-mcp](https://github.com/sirkirby/unifi-network-mcp)** - ⭐ 120
   MCP server implementation for the UniFi network application

1356. **[ffmpeg-mcp](https://github.com/egoist/ffmpeg-mcp)** - ⭐ 119
   An MCP server for FFmpeg

1357. **[mcp-package-version](https://github.com/sammcj/mcp-package-version)** - ⭐ 119
   An MCP server that provides LLMs with the latest stable package versions when coding

1358. **[mcp-apache-spark-history-server](https://github.com/kubeflow/mcp-apache-spark-history-server)** - ⭐ 119
   MCP Server for Apache Spark History Server. The bridge between Agentic AI and Apache Spark.

1359. **[linux-mcp-server](https://github.com/rhel-lightspeed/linux-mcp-server)** - ⭐ 119
   Tools to allow LLM clients to interact with Linux systems remotely

1360. **[codex-mcp-server](https://github.com/cexll/codex-mcp-server)** - ⭐ 119
   Codex Mcp Server 

1361. **[matlab-mcp-core-server](https://github.com/matlab/matlab-mcp-core-server)** - ⭐ 119
   Run MATLAB® using AI applications with the official MATLAB MCP Server from MathWorks®. This MCP server for MATLAB supports a wide range of coding agents like Claude Code® and Visual Studio® Code.

1362. **[n8n-mcp-server](https://github.com/illuminaresolutions/n8n-mcp-server)** - ⭐ 118
   MCP server implementation for n8n workflow automation

1363. **[paiml-mcp-agent-toolkit](https://github.com/paiml/paiml-mcp-agent-toolkit)** - ⭐ 118
   Pragmatic AI Labs MCP Agent Toolkit - An MCP Server designed to make code with agents more deterministic

1364. **[mcp-server](https://github.com/browserstack/mcp-server)** - ⭐ 117
   BrowserStack's Official MCP Server

1365. **[mcp-devtools](https://github.com/sammcj/mcp-devtools)** - ⭐ 117
   A modular MCP server that provides commonly used developer tools for AI coding agents

1366. **[MakerAi](https://github.com/gustavoeenriquez/MakerAi)** - ⭐ 117
...
1367. **[shopify-mcp](https://github.com/GeLi2001/shopify-mcp)** - ⭐ 117
   MCP server for Shopify api, usable on mcp hosts such as Claude and Cursor

1368. **[mcp-server-salesforce](https://github.com/tsmztech/mcp-server-salesforce)** - ⭐ 116
   Salesforce MCP Server

1369. **[remote-mcp-functions-dotnet](https://github.com/Azure-Samples/remote-mcp-functions-dotnet)** - ⭐ 116
...
1370. **[elevenlabs-mcp-server](https://github.com/mamertofabian/elevenlabs-mcp-server)** - ⭐ 116

1371. **[jupyter-notebook-mcp](https://github.com/jjsantos01/jupyter-notebook-mcp)** - ⭐ 116
   A Model Context Protocol (MCP) for Jupyter Notebook

1372. **[mcp](https://github.com/MariaDB/mcp)** - ⭐ 116
   MariaDB MCP (Model Context Protocol) server implementation

1373. **[kodit](https://github.com/helixml/kodit)** - ⭐ 115
   👩‍💻 MCP server to index external repositories

1374. **[VisionCraft-MCP-Server](https://github.com/augmentedstartups/VisionCraft-MCP-Server)** - ⭐ 115
...
1375. **[SmartDB_MCP](https://github.com/wenb1n-dev/SmartDB_MCP)** - ⭐ 115
...
1376. **[rust-mcp-filesystem](https://github.com/rust-mcp-stack/rust-mcp-filesystem)** - ⭐ 115
   Blazing-fast, asynchronous MCP server for seamless filesystem operations.

1377. **[memorizer-v1](https://github.com/petabridge/memorizer-v1)** - ⭐ 115
   Vector-search powered agent memory MCP server

1378. **[computer-use-mcp](https://github.com/domdomegg/computer-use-mcp)** - ⭐ 115
   💻 Give AI models complete control of your computer (probably a bad idea)

1379. **[paperless-mcp](https://github.com/nloui/paperless-mcp)** - ⭐ 115
   An MCP (Model Context Protocol) server for interacting with a Paperless-NGX API server. This server provides tools for managing documents, tags, correspondents, and document types in your Paperless-NGX instance.

1380. **[mcp_proxy_rust](https://github.com/tidewave-ai/mcp_proxy_rust)** - ⭐ 114
   A proxy to use HTTP/SSE MCPs from STDIO clients

1381. **[mcp-server-asana](https://github.com/roychri/mcp-server-asana)** - ⭐ 114

1382. **[hub-mcp](https://github.com/docker/hub-mcp)** - ⭐ 114
   Docker Hub MCP Server

1383. **[mcp-mianshiya-server](https://github.com/yuyuanweb/mcp-mianshiya-server)** - ⭐ 114
   基于 Spring AI 的面试鸭搜索题目的 MCP Server 服务，快速让 AI 搜索企业面试真题和答案

1384. **[turbo-flow-claude](https://github.com/marcuspat/turbo-flow-claude)** - ⭐ 114
...
1385. **[laravel-toon](https://github.com/mischasigtermans/laravel-toon)** - ⭐ 114
   TOON encoding for Laravel. Encode data for AI/LLMs with 40-60% fewer tokens than JSON.

1386. **[MCppServer](https://github.com/Noeli14/MCppServer)** - ⭐ 113
   Fast and super efficient Minecraft Server written in C++

1387. **[mcp-server](https://github.com/InterviewReady/mcp-server)** - ⭐ 113
   An MCP server for InterviewReady

1388. **[cli](https://github.com/mcpgod/cli)** - ⭐ 113
   Fine-grained control over model context protocol (MCP) clients, servers, and tools. Context is God.

1389. **[google-workspace-mcp](https://github.com/aaronsb/google-workspace-mcp)** - ⭐ 113
   A Model Context Protocol (MCP) server that provides authenticated access to Google Workspace APIs, offering integrated Authentication, Gmail, Calendar, and Drive functionality

1390. **[mcp-ts-template](https://github.com/cyanheads/mcp-ts-template)** - ⭐ 113
...
1391. **[teslamate-mcp](https://github.com/cobanov/teslamate-mcp)** - ⭐ 113
   A Model Context Protocol (MCP) server that provides access to your TeslaMate database, allowing AI assistants to query Tesla vehicle data and analytics.

1392. **[uLoopMCP](https://github.com/hatayama/uLoopMCP)** - ⭐ 113
   Your Unity project's AI autopilot. Compile, test, debug, repeat—until it just works.

1393. **[mcp-hubspot](https://github.com/peakmojo/mcp-hubspot)** - ⭐ 112
   A Model Context Protocol (MCP) server that enables AI assistants to interact with HubSpot CRM data, providing built-in vector storage and caching mechanisms help overcome HubSpot API limitations while improving response times.

1394. **[swagger-mcp](https://github.com/dcolley/swagger-mcp)** - ⭐ 112
   Swagger to MCP server

1395. **[iphone-mcp](https://github.com/Lakr233/iphone-mcp)** - ⭐ 112
...
1396. **[remote-mcp-apim-functions-python](https://github.com/Azure-Samples/remote-mcp-apim-functions-python)** - ⭐ 112
   Azure API Management as AI Gateway to Remote MCP servers.

1397. **[ffmpeg-mcp](https://github.com/video-creator/ffmpeg-mcp)** - ⭐ 112
...
1398. **[mcp-victoriametrics](https://github.com/VictoriaMetrics-Community/mcp-victoriametrics)** - ⭐ 112
   The implementation of Model Context Protocol (MCP) server for VictoriaMetrics

1399. **[coolify-mcp](https://github.com/StuMason/coolify-mcp)** - ⭐ 112
   MCP server for Coolify. 35 tools for managing self-hosted PaaS through AI assistants.

1400. **[OpenSCAD-MCP-Server](https://github.com/jhacksman/OpenSCAD-MCP-Server)** - ⭐ 112
   Devin's attempt at creating an OpenSCAD MCP Server that takes a user prompt and generates a preview image and 3d file.

1401. **[mcpproxy-go](https://github.com/smart-mcp-proxy/mcpproxy-go)** - ⭐ 112
   Supercharge AI Agents, Safely

1402. **[opencode-studio](https://github.com/Microck/opencode-studio)** - ⭐ 112
   [WIP] web GUI for securely managing local Opencode configuration

1403. **[MCP2Lambda](https://github.com/danilop/MCP2Lambda)** - ⭐ 111
   Run any AWS Lambda function as a Large Language Model (LLM) tool without code changes using Anthropic's Model Context Protocol (MCP).

1404. **[notion-mcp](https://github.com/ccabanillas/notion-mcp)** - ⭐ 111
   A Model Context Protocol (MCP) server implementation for Notion integration, providing a standardized interface for interacting with Notion's API.

1405. **[punkpeye_awesome-mcp-servers](https://github.com/MCP-Mirror/punkpeye_awesome-mcp-servers)** - ⭐ 111
   Mirror of https://github.com/punkpeye/awesome-mcp-servers

1406. **[Deepseek-Thinking-Claude-3.5-Sonnet-CLINE-MCP](https://github.com/newideas99/Deepseek-Thinking-Claude-3.5-Sonnet-CLINE-MCP)** - ⭐ 111
...
1407. **[mcpauth](https://github.com/mcpauth/mcpauth)** - ⭐ 111
   Authentication for MCP Servers

1408. **[SwiftMCP](https://github.com/Cocoanetics/SwiftMCP)** - ⭐ 111
   Model Context Protocol Server for Swift

1409. **[MCP-oura](https://github.com/YuzeHao2023/MCP-oura)** - ⭐ 111
   MCP server for Oura API integration

1410. **[pageindex-mcp](https://github.com/VectifyAI/pageindex-mcp)** - ⭐ 111
...
1411. **[mcp-jfrog](https://github.com/jfrog/mcp-jfrog)** - ⭐ 110
   Model Context Protocol (MCP) Server for the JFrog Platform API, enabling repository management, build tracking, release lifecycle management, and more.

1412. **[google-sheets-mcp](https://github.com/mkummer225/google-sheets-mcp)** - ⭐ 110
   Google Sheets MCP Server 📊🤖

1413. **[foxy-contexts](https://github.com/strowk/foxy-contexts)** - ⭐ 110
   Foxy contexts is a library for building context servers supporting Model Context Protocol

1414. **[server-wp-mcp](https://github.com/emzimmer/server-wp-mcp)** - ⭐ 110

1415. **[xcodeproj-mcp-server](https://github.com/giginet/xcodeproj-mcp-server)** - ⭐ 110
   A Model Context Protocol Server to manipulate *.xcodeproj

1416. **[livebook_tools](https://github.com/thmsmlr/livebook_tools)** - ⭐ 110
   Powertools for livebook.dev — AI Code Editing, MCP Servers, and Running Livebooks from the CLI

1417. **[mcp-memory](https://github.com/Puliczek/mcp-memory)** - ⭐ 110
...
1418. **[MCP-searxng](https://github.com/SecretiveShell/MCP-searxng)** - ⭐ 110
   MCP server for connecting agentic systems to search systems via searXNG

1419. **[vscode-as-mcp-server](https://github.com/acomagu/vscode-as-mcp-server)** - ⭐ 109
...
1420. **[mcp-server](https://github.com/bitwarden/mcp-server)** - ⭐ 109
   MCP server for interaction with Bitwarden.

1421. **[pentest-mcp](https://github.com/DMontgomery40/pentest-mcp)** - ⭐ 109
   NOT for educational purposes: An MCP server for professional penetration testers including STDIO/HTTP/SSE support, nmap, go/dirbuster, nikto, JtR, hashcat, wordlist building, and more.

1422. **[mcp-checkpoint](https://github.com/aira-security/mcp-checkpoint)** - ⭐ 109
...
1423. **[NornicDB](https://github.com/orneryd/NornicDB)** - ⭐ 109
...
1424. **[aseprite-mcp](https://github.com/diivi/aseprite-mcp)** - ⭐ 109
   MCP server for interacting with the Aseprite API

1425. **[modex](https://github.com/theronic/modex)** - ⭐ 108
   Modex is a Clojure MCP Library to augment your AI models with Tools, Resources & Prompts using Clojure (Model Context Protocol). Implements MCP Server & Client.

1426. **[share-best-mcp](https://github.com/shareAI-lab/share-best-mcp)** - ⭐ 108
   世界上最好的MCP Servers的列表,The best mcp servers in the world.

1427. **[minesweeper-mcp-server](https://github.com/tonypan2/minesweeper-mcp-server)** - ⭐ 108
   An MCP server for playing Minesweeper

1428. **[DINO-X-MCP](https://github.com/IDEA-Research/DINO-X-MCP)** - ⭐ 108
   Official DINO-X Model Context Protocol (MCP) server that empowers LLMs with real-world visual perception through image object detection, localization, and captioning APIs.

1429. **[Easy-MCP-AutoCad](https://github.com/zh19980811/Easy-MCP-AutoCad)** - ⭐ 108
   这个项目是一个基于Model Context Protocol (MCP)的AutoCAD集成服务器，它允许通过自然语言与AutoCAD进行交互。通过这个服务器，用户可以使用Claude等大型语言模型来创建、修改和分析AutoCAD图纸，同时还可以存储和查询CAD元素的相关数据。目前制作参考学习，仅实现端到端之间的通信，具体工具函数尚未晚上

1430. **[asyncmcp](https://github.com/bh-rat/asyncmcp)** - ⭐ 108
   Async transport layers for MCP

1431. **[mcp-redmine](https://github.com/runekaagaard/mcp-redmine)** - ⭐ 108
   A redmine MCP server covering close to 100% of redmines API

1432. **[mcp-bsl-platform-context](https://github.com/alkoleft/mcp-bsl-platform-context)** - ⭐ 108
   MCP сервер для AI-ассистентов (справка по синтаксису и объектной модели 1С:Предприятие)

1433. **[gRPC-zig](https://github.com/ziglana/gRPC-zig)** - ⭐ 108
   blazigly fast gRPC/MCP client & server implementation in zig

1434. **[apple-rag-mcp](https://github.com/BingoWon/apple-rag-mcp)** - ⭐ 107
    MCP server providing AI agents with instant access to Apple developer documentation via RAG technology

1435. **[netbox-mcp-server](https://github.com/netboxlabs/netbox-mcp-server)** - ⭐ 107
   Model Context Protocol (MCP) server for read-only interaction with NetBox data in LLMs

1436. **[mcp-probe](https://github.com/conikeec/mcp-probe)** - ⭐ 107
   A Model Context Protocol (MCP) client library and debugging toolkit in Rust. This foundation provides both a production-ready SDK for building MCP integrations and the core architecture for an interactive debugger.

1437. **[kibitz](https://github.com/nick1udwig/kibitz)** - ⭐ 107
   The coding agent for professionals

1438. **[slack-mcp-server](https://github.com/ubie-oss/slack-mcp-server)** - ⭐ 107
   A Slack MCP server

1439. **[crypto-indicators-mcp](https://github.com/kukapay/crypto-indicators-mcp)** - ⭐ 107
   An MCP server providing a range of cryptocurrency technical analysis indicators and strategies.

1440. **[ai-command](https://github.com/mcp-wp/ai-command)** - ⭐ 107
   Control WordPress using WP-CLI, AI, and MCP.

1441. **[swiftlens](https://github.com/swiftlens/swiftlens)** - ⭐ 107
...
1442. **[MCP-Workspace-Server](https://github.com/answerlink/MCP-Workspace-Server)** - ⭐ 107
...
1443. **[oracle-mcp-server](https://github.com/danielmeppiel/oracle-mcp-server)** - ⭐ 106
   MCP Server for working with large Oracle databases

1444. **[mcp-client](https://github.com/punkpeye/mcp-client)** - ⭐ 106
   An MCP client for Node.js.

1445. **[dash-mcp-server](https://github.com/Kapeli/dash-mcp-server)** - ⭐ 106
   MCP server for Dash, the macOS documentation browser

1446. **[Wazuh-MCP-Server](https://github.com/gensecaihq/Wazuh-MCP-Server)** - ⭐ 106
...
1447. **[Hegelion](https://github.com/Hmbown/Hegelion)** - ⭐ 106
   Dialectical reasoning architecture for LLMs (Thesis → Antithesis → Synthesis)

1448. **[selfhosted-supabase-mcp](https://github.com/HenkDz/selfhosted-supabase-mcp)** - ⭐ 106
   An MCP Server for your Self Hosted Supabase

1449. **[spring-documentation-mcp-server](https://github.com/andrlange/spring-documentation-mcp-server)** - ⭐ 106
   Spring Boot based MCP Server provide full Spring Ecosystem Documentation for LLMs

1450. **[mcp-tool-kit](https://github.com/getfounded/mcp-tool-kit)** - ⭐ 105
   Agentic abstraction layer for building high precision vertical AI agents written in python for Model Context Protocol.

1451. **[payloadcmsmcp](https://github.com/disruption-hub/payloadcmsmcp)** - ⭐ 105
   Payload CMS MCP Server

1452. **[mcp_client](https://github.com/theailanguage/mcp_client)** - ⭐ 105
   MCP Client Implementation using Python, LangGraph and Gemini

1453. **[easy-code-reader](https://github.com/FangYuan33/easy-code-reader)** - ⭐ 105
   A powerful MCP (Model Context Protocol) server for intelligently reading Java source code.

1454. **[aks-mcp](https://github.com/Azure/aks-mcp)** - ⭐ 105
   A Model Context Protocol (MCP) server that enables AI assistants to interact with AKS clusters. It serves as a bridge between AI tools (like Claude, Cursor, and GitHub Copilot) and AKS.

1455. **[Fabric-Analytics-MCP](https://github.com/santhoshravindran7/Fabric-Analytics-MCP)** - ⭐ 105
...
1456. **[ZipAgent](https://github.com/JiayuXu0/ZipAgent)** - ⭐ 105
   轻量级AI Agent框架，让你5分钟构建专属智能助手。Lightweight AI Agent framework. Build your AI assistant in 5 minutes.

1457. **[isaac-sim-mcp](https://github.com/omni-mcp/isaac-sim-mcp)** - ⭐ 105
   Isaac Simulation MCP Extension and Server

1458. **[polymarket-mcp](https://github.com/berlinbra/polymarket-mcp)** - ⭐ 105
   MCP Server for PolyMarket API

1459. **[game-asset-mcp](https://github.com/MubarakHAlketbi/game-asset-mcp)** - ⭐ 105
   An MCP server for creating 2D/3D game assets from text using Hugging Face AI models.

1460. **[smileyCoin](https://github.com/fefergrgrgrg/smileyCoin)** - ⭐ 104
   simple web ui to manage mcp (model context protocol) servers in the claude app

1461. **[gemini-desktop](https://github.com/kkrishnan90/gemini-desktop)** - ⭐ 104
...
1462. **[mcp.science](https://github.com/pathintegral-institute/mcp.science)** - ⭐ 104
   Open Source MCP Servers for Scientific Research

1463. **[sourcerer-mcp](https://github.com/st3v3nmw/sourcerer-mcp)** - ⭐ 104
   MCP for semantic code search & navigation that reduces token waste

1464. **[gemini-cli-mcp-server](https://github.com/centminmod/gemini-cli-mcp-server)** - ⭐ 104

1465. **[mcp](https://github.com/frappe/mcp)** - ⭐ 104
   Frappe MCP allows Frappe apps to function as MCP servers

1466. **[-mcp-to-skill-converter](https://github.com/GBSOSS/-mcp-to-skill-converter)** - ⭐ 104
      Convert any MCP server into a Claude Skill with 90% context savings

1467. **[UnityMCPIntegration](https://github.com/quazaai/UnityMCPIntegration)** - ⭐ 104
   Enable AI Agents to Control Unity

1468. **[raindrop-mcp](https://github.com/adeze/raindrop-mcp)** - ⭐ 104
   Raindrop MCP Server

1469. **[memory-bank-MCP](https://github.com/tuncer-byte/memory-bank-MCP)** - ⭐ 103
...
1470. **[solana-mcp](https://github.com/solanamcp/solana-mcp)** - ⭐ 103
   Solana Agent Kit MCP Server 

1471. **[awesome-context-engineering](https://github.com/jihoo-kim/awesome-context-engineering)** - ⭐ 103
...
1472. **[csharp-runner](https://github.com/sdcb/csharp-runner)** - ⭐ 103
   fast, secure c# runner

1473. **[GenesisCore](https://github.com/AIGODLIKE/GenesisCore)** - ⭐ 103
   One click installation! BlenderMCP tool that supports DeepSeek, Claude, and others, fully integrated into Blender!

1474. **[typescript-utcp](https://github.com/universal-tool-calling-protocol/typescript-utcp)** - ⭐ 103
...
1475. **[ARIES](https://github.com/Chieko-Seren/ARIES)** - ⭐ 103
...
1476. **[server-google-news](https://github.com/ChanMeng666/server-google-news)** - ⭐ 103
   【Star-crossed coders unite!⭐️】Model Context Protocol (MCP) server implementation providing Google News search capabilities via SerpAPI, with automatic news categorization and multi-language support.

1477. **[flowlens-mcp-server](https://github.com/magentic/flowlens-mcp-server)** - ⭐ 103
...
1478. **[railway-mcp-server](https://github.com/railwayapp/railway-mcp-server)** - ⭐ 103
   Official Railway MCP Server for interacting with your Railway account

1479. **[Taiwan-Health-MCP](https://github.com/healthymind-tech/Taiwan-Health-MCP)** - ⭐ 103

1480. **[agentcare-mcp](https://github.com/Kartha-AI/agentcare-mcp)** - ⭐ 103
   MCP Server for EMRs with FHIR

1481. **[mcp-prompts](https://github.com/sparesparrow/mcp-prompts)** - ⭐ 103
   Model Context Protocol server for managing, storing, and providing prompts and prompt templates for LLM interactions. 

1482. **[memory-mcp-server](https://github.com/okooo5km/memory-mcp-server)** - ⭐ 102
   A Model Context Protocol server that provides knowledge graph management capabilities. 

1483. **[deep-code-reasoning-mcp](https://github.com/haasonsaas/deep-code-reasoning-mcp)** - ⭐ 102
   A Model Context Protocol (MCP) server that provides advanced code analysis and reasoning capabilities powered by Google's Gemini AI

1484. **[erickwendel-contributions-mcp](https://github.com/ErickWendel/erickwendel-contributions-mcp)** - ⭐ 102
   A Model Context Protocol (MCP) server that provides tools to query Erick Wendel's contributions across different platforms

1485. **[mcpm](https://github.com/MCP-Club/mcpm)** - ⭐ 102
...
1486. **[freqtrade-mcp](https://github.com/kukapay/freqtrade-mcp)** - ⭐ 102
   An MCP server that integrates with the Freqtrade cryptocurrency trading bot.

1487. **[vectorize-mcp-server](https://github.com/vectorize-io/vectorize-mcp-server)** - ⭐ 102
   Official Vectorize MCP Server

1488. **[chronulus-mcp](https://github.com/ChronulusAI/chronulus-mcp)** - ⭐ 102
   MCP Server for Chronulus AI Forecasting and Prediction Agents

1489. **[a2a-mcp-tutorial](https://github.com/Tsadoq/a2a-mcp-tutorial)** - ⭐ 102
   A tutorial on how to use Model Context Protocol by Anthropic and Agent2Agent Protocol by Google

1490. **[http-oauth-mcp-server](https://github.com/NapthaAI/http-oauth-mcp-server)** - ⭐ 101
...
1491. **[remote-mcp-functions](https://github.com/Azure-Samples/remote-mcp-functions)** - ⭐ 101
   Landing page for Remote MCP Server efforts in Azure Functions with links to all language stack specific repos.

1492. **[btp-sap-odata-to-mcp-server](https://github.com/lemaiwo/btp-sap-odata-to-mcp-server)** - ⭐ 101
   BTP CloudFoundry Node.js MCP server for SAP OData services integration

1493. **[portainer-mcp](https://github.com/portainer/portainer-mcp)** - ⭐ 101
   Portainer MCP server

1494. **[awesome-x402](https://github.com/xpaysh/awesome-x402)** - ⭐ 101
   🚀 Curated list of x402 resources: HTTP 402 Payment Required protocol for blockchain payments, crypto micropayments, AI agents, API monetization. Includes SDKs (TypeScript, Python, Rust), examples, facilitators (Coinbase, Cloudflare), MCP integration, tutorials. Accept USDC payments with one line of code. Perfect for AI agent economy.

1495. **[hevy-mcp](https://github.com/chrisdoc/hevy-mcp)** - ⭐ 101
   Manage your Hevy workouts, routines, folders, and exercise templates. Create and update sessions faster, organize plans, and search exercises to build workouts quickly. Stay synced with changes so your training log is always up to date.

1496. **[claude-code-mcp-enhanced](https://github.com/grahama1970/claude-code-mcp-enhanced)** - ⭐ 100
...
1497. **[mcp-hono-stateless](https://github.com/mhart/mcp-hono-stateless)** - ⭐ 100
   An example Hono MCP server using Streamable HTTP

1498. **[AgentBoard](https://github.com/igrigorik/AgentBoard)** - ⭐ 100
...
1499. **[autodev-codebase](https://github.com/anrgct/autodev-codebase)** - ⭐ 100
...
1500. **[complete-intro-to-mcp](https://github.com/btholt/complete-intro-to-mcp)** - ⭐ 100
   The Complete Intro to MCP Servers, as taught for Frontend Masters by Brian Holt

1501. **[mcp-virustotal](https://github.com/BurtTheCoder/mcp-virustotal)** - ⭐ 100
   A Model Context Protocol (MCP) server for querying the VirusTotal API.

1502. **[linggen](https://github.com/linggen/linggen)** - ⭐ 100
   A local-first memory layer for AI (Cursor, Zed, Claude). Persistent architectural context via semantic search.

1503. **[ableton-mcp-extended](https://github.com/uisato/ableton-mcp-extended)** - ⭐ 100
   Ableton Live MCP (Model Context Protocol) server that allows control directly through AI assistants.

1504. **[sqlite-explorer-fastmcp-mcp-server](https://github.com/hannesrudolph/sqlite-explorer-fastmcp-mcp-server)** - ⭐ 100
   An MCP server that provides safe, read-only access to SQLite databases through Model Context Protocol (MCP). This server is built with the FastMCP framework, which enables LLMs to explore and query SQLite databases with built-in safety features and query validation.

1505. **[mcp-server-atlassian-bitbucket](https://github.com/aashari/mcp-server-atlassian-bitbucket)** - ⭐ 100
   Node.js/TypeScript MCP server for Atlassian Bitbucket. Enables AI systems (LLMs) to interact with workspaces, repositories, and pull requests via tools (list, get, comment, search). Connects AI directly to version control workflows through the standard MCP interface.

1506. **[neurolink](https://github.com/juspay/neurolink)** - ⭐ 100
   Universal AI Development Platform with MCP server integration, multi-provider support, and professional CLI. Build, test, and deploy AI applications with multiple ai providers.

1507. **[augments-mcp-server](https://github.com/augmnt/augments-mcp-server)** - ⭐ 100
   Comprehensive MCP server providing real-time framework documentation access for Claude Code with intelligent caching, multi-source integration, and context-aware assistance.

1508. **[template-repo](https://github.com/AndrewAltimit/template-repo)** - ⭐ 100
...
1509. **[mcp-windows-desktop-automation](https://github.com/mario-andreschak/mcp-windows-desktop-automation)** - ⭐ 99
   A Model Context Protocol (MCP) server for Windows desktop automation using AutoIt.

1510. **[sample-agentic-ai-demos](https://github.com/aws-samples/sample-agentic-ai-demos)** - ⭐ 99
   Collection of examples of how to use Model Context Protocol with AWS.

1511. **[next-mcp-server](https://github.com/vertile-ai/next-mcp-server)** - ⭐ 99
   Help LLMs to understand your Next apps better

1512. **[turbular](https://github.com/raeudigerRaeffi/turbular)** - ⭐ 99
   A MCP server allowing LLM agents to easily connect and retrieve data from any database

1513. **[pywss](https://github.com/czasg/pywss)** - ⭐ 99
   一个轻量级的 Python Web 框架，一站式集成 MCP SSE、StreamHTTP 和 MCPO 协议，助你轻松构建MCP Server🔥

1514. **[mighty-security](https://github.com/NineSunsInc/mighty-security)** - ⭐ 99
   Don't Simply Trust MCP Server Code, Validate and Scan

1515. **[mcp-shodan](https://github.com/BurtTheCoder/mcp-shodan)** - ⭐ 99
   MCP server for querying the Shodan API

1516. **[finance-trading-ai-agents-mcp](https://github.com/aitrados/finance-trading-ai-agents-mcp)** - ⭐ 99
...
1517. **[IntelliConnect](https://github.com/ruanrongman/IntelliConnect)** - ⭐ 99
   本项目为xiaozhi-esp32提供后端服务  |  A Powerful AI agent IoT platform core.

1518. **[alibabacloud-ack-mcp-server](https://github.com/aliyun/alibabacloud-ack-mcp-server)** - ⭐ 99
...
1519. **[codex-mcp-server](https://github.com/tuannvm/codex-mcp-server)** - ⭐ 99
   MCP server wrapper for OpenAI Codex CLI that enables Claude Code to leverage Codex's AI capabilities directly.

1520. **[mcp-sse-demo](https://github.com/cnych/mcp-sse-demo)** - ⭐ 98
   claude mcp sse demo with server and client(cli、web)

1521. **[mcp_on_ruby](https://github.com/rubyonai/mcp_on_ruby)** - ⭐ 98
   💎 A Ruby implementation of the Model Context Protocol

1522. **[atomic-red-team-mcp](https://github.com/cyberbuff/atomic-red-team-mcp)** - ⭐ 98
   MCP server for Atomic Red Team

1523. **[mcp-client-nodejs](https://github.com/ConardLi/mcp-client-nodejs)** - ⭐ 98
   Node.js Client Implementation for Model Context Protocol (MCP)

1524. **[gtasks-mcp](https://github.com/zcaceres/gtasks-mcp)** - ⭐ 98
   A Google Tasks Model Context Protocol Server for Claude

1525. **[forgetful](https://github.com/ScottRBK/forgetful)** - ⭐ 98
   Opensource Memory for Agents

1526. **[mcp-typescript-sdk](https://github.com/emqx/mcp-typescript-sdk)** - ⭐ 97
   A TypeScript SDK for implementing Model Context Protocol (MCP) over MQTT, supporting both browser and Node.js environments.

1527. **[gemini-mcp-desktop-client](https://github.com/duke7able/gemini-mcp-desktop-client)** - ⭐ 97
   first gemini based desktop client for MCP

1528. **[searxng-mul-mcp](https://github.com/jae-jae/searxng-mul-mcp)** - ⭐ 97
   A Model Context Protocol (MCP) server for SearXNG search engine with multi-query parallel search support

1529. **[mcp-screenshot-website-fast](https://github.com/just-every/mcp-screenshot-website-fast)** - ⭐ 97
   Quickly screenshots webpages and converts to an LLM friendly size

1530. **[JavaSinkTracer_MCP](https://github.com/Zacarx/JavaSinkTracer_MCP)** - ⭐ 97
   基于函数级污点分析的 Java 源代码漏洞审计工具JavaSinkTracer，通过 Model Context Protocol (MCP) 为 AI 助手提供安全分析能力。

1531. **[Financial-Modeling-Prep-MCP-Server](https://github.com/imbenrabi/Financial-Modeling-Prep-MCP-Server)** - ⭐ 97
   A Model Context Protocol (MCP) implementation for Financial Modeling Prep, enabling AI assistants to access and analyze financial data, stock information, company fundamentals, and market insights.

1532. **[mysql-mcp-server-sse](https://github.com/mangooer/mysql-mcp-server-sse)** - ⭐ 97
...
1533. **[academic-search-mcp-server](https://github.com/afrise/academic-search-mcp-server)** - ⭐ 97
...
1534. **[mcp-toolkit](https://github.com/nuxt-modules/mcp-toolkit)** - ⭐ 97
   Create MCP servers directly in your Nuxt application. Define tools, resources, and prompts with a simple and intuitive API.

1535. **[gemini-mcp](https://github.com/RLabs-Inc/gemini-mcp)** - ⭐ 97
   MCP Server that enables Claude code to interact with Gemini

1536. **[Polymcp](https://github.com/poly-mcp/Polymcp)** - ⭐ 97
   Polymcp provides a simple and efficient way to interact with MCP servers using custom agents

1537. **[mcp](https://github.com/taskade/mcp)** - ⭐ 96
   🤖 Taskade MCP · Official MCP server and OpenAPI to MCP codegen. Build AI agent tools from any OpenAPI API and connect to Claude, Cursor, and more.

1538. **[all-in-one-model-context-protocol](https://github.com/nguyenvanduocit/all-in-one-model-context-protocol)** - ⭐ 96
   🚀 All-in-one MCP server with AI search, RAG, and multi-service integrations (GitLab/Jira/Confluence/YouTube) for AI-enhanced development workflows

1539. **[MiniMax-MCP-JS](https://github.com/MiniMax-AI/MiniMax-MCP-JS)** - ⭐ 96
   Official MiniMax Model Context Protocol (MCP) JavaScript implementation that provides seamless integration with MiniMax's powerful AI capabilities including image generation, video generation, text-to-speech, and voice cloning APIs.

1540. **[mcp-local-rag](https://github.com/nkapila6/mcp-local-rag)** - ⭐ 96
   "primitive" RAG-like web search model context protocol (MCP) server that runs locally. ✨ no APIs ✨

1541. **[powerbi-mcp](https://github.com/sulaiman013/powerbi-mcp)** - ⭐ 96
   MCP server for natural language interaction with Power BI datasets

1542. **[systemprompt-mcp-server](https://github.com/systempromptio/systemprompt-mcp-server)** - ⭐ 96
...
1543. **[godoc-mcp](https://github.com/mrjoshuak/godoc-mcp)** - ⭐ 96
   go doc mcp server

1544. **[lapras-mcp-server](https://github.com/lapras-inc/lapras-mcp-server)** - ⭐ 96
   lapras.com 公式MCP Server

1545. **[mcp-server](https://github.com/webflow/mcp-server)** - ⭐ 96
   Model Context Protocol (MCP) server for the Webflow Data API.

1546. **[terminal-controller-mcp](https://github.com/GongRzhe/terminal-controller-mcp)** - ⭐ 96
   A Model Context Protocol (MCP) server that enables secure terminal command execution, directory navigation, and file system operations through a standardized interface.

1547. **[typst-mcp](https://github.com/johannesbrandenburger/typst-mcp)** - ⭐ 95
   Typst MCP Server is an MCP (Model Context Protocol) implementation that helps AI models interact with Typst, a markup-based typesetting system. The server provides tools for converting between LaTeX and Typst, validating Typst syntax, and generating images from Typst code.

1548. **[mcp-kit](https://github.com/my-mcp-hub/mcp-kit)** - ⭐ 95
   A CLI tool to create MCP (Model Context Protocol) applications with ease.

1549. **[awesome-mcp-enterprise](https://github.com/bh-rat/awesome-mcp-enterprise)** - ⭐ 95
   A curated list of awesome MCP (Model Context Protocol) tools, platforms, and services for enterprises.

1550. **[api2mcp4j](https://github.com/TheEterna/api2mcp4j)** - ⭐ 95
...
1551. **[gossiphs](https://github.com/williamfzc/gossiphs)** - ⭐ 95
...
1552. **[ruby-mcp-client](https://github.com/simonx1/ruby-mcp-client)** - ⭐ 94
   This is a Ruby implementation of MCP (Model Context Protocol) client

1553. **[go-utcp](https://github.com/universal-tool-calling-protocol/go-utcp)** - ⭐ 94
    Official Go implementation of the UTCP 

1554. **[github-stars](https://github.com/miantiao-me/github-stars)** - ⭐ 94
   A Cloudflare-powered MCP (Model Context Protocol) Server that allows you to search and query your GitHub starred repositories using natural language.

1555. **[langgraph-ai](https://github.com/piyushagni5/langgraph-ai)** - ⭐ 94
   LangGraph AI Repository

1556. **[mcp-graphiti](https://github.com/rawr-ai/mcp-graphiti)** - ⭐ 94
   Graphiti Model Context Protocol (MCP) Server - An MCP server for knowledge graph management via Graphiti

1557. **[figma-console-mcp](https://github.com/southleft/figma-console-mcp)** - ⭐ 94
...
1558. **[Vibe-Coder-MCP](https://github.com/freshtechbro/Vibe-Coder-MCP)** - ⭐ 93
    Vibe-Coder-MCP server extends AI assistants with specialized software development tools.

1559. **[infobus-mcp](https://github.com/simovilab/infobus-mcp)** - ⭐ 93
   Model Context Protocol server enabling AI assistants to access transit information through standardized interfaces

1560. **[mcp-server-gsc](https://github.com/ahonn/mcp-server-gsc)** - ⭐ 93
   A Model Context Protocol (MCP) server providing access to Google Search Console

1561. **[wanaku](https://github.com/wanaku-ai/wanaku)** - ⭐ 93
   Wanaku MCP Router

1562. **[elektron-mcp](https://github.com/zerubeus/elektron-mcp)** - ⭐ 93
   MCP sever for controlling Elektron devices using LLMs

1563. **[MasterMCP](https://github.com/slowmist/MasterMCP)** - ⭐ 93
...
1564. **[mcp-replicate](https://github.com/deepfates/mcp-replicate)** - ⭐ 92
   Model Context Protocol server for Replicate's API

1565. **[mcp-server-idapro](https://github.com/fdrechsler/mcp-server-idapro)** - ⭐ 92
   A Model Context Protocol (MCP) server that enables AI assistants to interact with IDA Pro for reverse engineering and binary analysis tasks.

1566. **[mcp-server](https://github.com/OctopusDeploy/mcp-server)** - ⭐ 92
   Octopus Deploy Official MCP Server

1567. **[snippy](https://github.com/Azure-Samples/snippy)** - ⭐ 92
...
1568. **[alibaba-cloud-ops-mcp-server](https://github.com/aliyun/alibaba-cloud-ops-mcp-server)** - ⭐ 92
   AlibabaCloud CloudOps MCP Server

1569. **[nextcloud-mcp-server](https://github.com/cbcoutinho/nextcloud-mcp-server)** - ⭐ 92
   Nextcloud MCP Server

1570. **[akshare-one-mcp](https://github.com/zwldarren/akshare-one-mcp)** - ⭐ 92
   MCP server that provides access to Chinese stock market data using akshare-one

1571. **[gis-mcp](https://github.com/mahdin75/gis-mcp)** - ⭐ 91
   A Model Context Protocol (MCP) server implementation that connects Large Language Models (LLMs) to GIS operations using GIS libraries, enabling AI assistants to perform geospatial operations and transformations.

1572. **[needle-mcp](https://github.com/needle-ai/needle-mcp)** - ⭐ 91
   Needle MCP Server for easy RAG.Long-term memory for LLMs.

1573. **[open-mcp-auth-proxy](https://github.com/wso2/open-mcp-auth-proxy)** - ⭐ 91
   Authentication and Authorization Proxy for MCP Servers

1574. **[sandbox-mcp](https://github.com/pottekkat/sandbox-mcp)** - ⭐ 91
   A Model Context Protocol (MCP) server that enables LLMs to run ANY code safely in isolated Docker containers.

1575. **[opencv-mcp-server](https://github.com/GongRzhe/opencv-mcp-server)** - ⭐ 91
...
1576. **[square-mcp-server](https://github.com/square/square-mcp-server)** - ⭐ 91
   A Model Context Protocol (MCP) server for square

1577. **[a2ajava](https://github.com/vishalmysore/a2ajava)** - ⭐ 90
...
1578. **[spring-ai-playground](https://github.com/spring-ai-community/spring-ai-playground)** - ⭐ 90
...
1579. **[brave-search-mcp](https://github.com/mikechao/brave-search-mcp)** - ⭐ 90
...
1580. **[mcpcat-typescript-sdk](https://github.com/MCPCat/mcpcat-typescript-sdk)** - ⭐ 90
   MCPcat is an analytics platform for MCP server owners 🐱.

1581. **[computer-control-mcp](https://github.com/AB498/computer-control-mcp)** - ⭐ 90
   MCP server that provides computer control capabilities, like mouse, keyboard, OCR, etc. using PyAutoGUI, RapidOCR, ONNXRuntime. Similar to 'computer-use' by Anthropic. With Zero External Dependencies.

1582. **[seline](https://github.com/tercumantanumut/seline)** - ⭐ 90
   seline agent with a style

1583. **[pluggedin-app](https://github.com/VeriTeknik/pluggedin-app)** - ⭐ 90
   The Crossroads for AI Data Exchanges. A unified, self-hostable web interface for discovering, configuring, and managing Model Context Protocol (MCP) servers—bringing together AI tools, workspaces, prompts, and logs from multiple MCP sources (Claude, Cursor, etc.) under one roof.

1584. **[zed-mcp-server-context7](https://github.com/akbxr/zed-mcp-server-context7)** - ⭐ 89
   Context7 MCP Server for Zed

1585. **[AgentUp](https://github.com/always-further/AgentUp)** - ⭐ 89
   Portable , scalable , secure AI Agents

1586. **[yfinance-mcp](https://github.com/narumiruna/yfinance-mcp)** - ⭐ 89

1587. **[octagon-mcp-server](https://github.com/OctagonAI/octagon-mcp-server)** - ⭐ 88
...
1588. **[ToolsForMCPServer](https://github.com/tanaikech/ToolsForMCPServer)** - ⭐ 88
   The Gemini CLI confirmed that the MCP server built with Google Apps Script (GAS), a low-code platform, offers immense possibilities. If you've created snippets for GAS, these could be revitalized and/or leveraged in new ways by using them as the MCP server. The Gemini CLI and other MCP clients will be useful in achieving this.

1589. **[mcp-agent](https://github.com/Haohao-end/mcp-agent)** - ⭐ 88
   A modular Python framework implementing the Model Context Protocol (MCP). It features a standardized client-server architecture over StdIO, integrating LLMs with external tools, real-time weather data fetching, and an advanced RAG (Retrieval-Augmented Generation) system.

1590. **[litegraph](https://github.com/litegraphdb/litegraph)** - ⭐ 88
...
1591. **[molecule-mcp](https://github.com/ChatMol/molecule-mcp)** - ⭐ 88
   A model-context-protocol server for molecules.

1592. **[editor-mcp-server](https://github.com/playcanvas/editor-mcp-server)** - ⭐ 88
   MCP Server for AI automation of the PlayCanvas Editor

1593. **[sparql-llm](https://github.com/sib-swiss/sparql-llm)** - ⭐ 88
   🦜✨ Chat system, MCP server, and reusable components to improve LLMs capabilities when generating SPARQL queries

1594. **[mcp-python-interpreter](https://github.com/yzfly/mcp-python-interpreter)** - ⭐ 87
   MCP Python Interpreter: run python code. Python-mcp-server, mcp-python-server, Code Executor

1595. **[mcp-web-ui](https://github.com/MegaGrindStone/mcp-web-ui)** - ⭐ 87
   MCP Web UI is a web-based user interface that serves as a Host within the Model Context Protocol (MCP) architecture. It provides a powerful and user-friendly interface for interacting with Large Language Models (LLMs) while managing context aggregation and coordination between clients and servers.

1596. **[mcp-trino](https://github.com/tuannvm/mcp-trino)** - ⭐ 87
   A high-performance Model Context Protocol (MCP) server for Trino implemented in Go.

1597. **[mcp-server-and-gw](https://github.com/boilingdata/mcp-server-and-gw)** - ⭐ 87
   An MCP stdio to HTTP SSE transport gateway with example server and MCP client

1598. **[vibe](https://github.com/michiosw/vibe)** - ⭐ 87
   Open-Source AI-powered web browser. Browse the web with your own LLM API key. Alternative to Dia / Comet.

1599. **[mem0-mcp](https://github.com/pinkpixel-dev/mem0-mcp)** - ⭐ 87
   ✨ mem0 MCP Server: A memory system using mem0 for AI applications with model context protocl (MCP) integration. Enables long-term memory for AI agents as a drop-in MCP server.

1600. **[openai-gpt-image-mcp](https://github.com/SureScaleAI/openai-gpt-image-mcp)** - ⭐ 87
   A Model Context Protocol (MCP) tool server for OpenAI's GPT-4o/gpt-image-1 image generation and editing APIs.

1601. **[google-tag-manager-mcp-server](https://github.com/stape-io/google-tag-manager-mcp-server)** - ⭐ 87
   MCP server for Google Tag Manager

1602. **[chat-ui](https://github.com/AI-QL/chat-ui)** - ⭐ 87
...
1603. **[robloxstudio-mcp](https://github.com/boshyxd/robloxstudio-mcp)** - ⭐ 87
   Create agentic AI workflows in ROBLOX Studio

1604. **[model-context-protocol-mcp-hands-on-with-agentic-ai-2034200](https://github.com/LinkedInLearning/model-context-protocol-mcp-hands-on-with-agentic-ai-2034200)** - ⭐ 86
...
1605. **[react-agent-hooks](https://github.com/chuanqisun/react-agent-hooks)** - ⭐ 86
   Turn React hooks into LLM tools

1606. **[falcon-mcp](https://github.com/CrowdStrike/falcon-mcp)** - ⭐ 86
   Connect AI agents to CrowdStrike Falcon for automated security analysis and threat hunting

1607. **[achatbot](https://github.com/ai-bot-pro/achatbot)** - ⭐ 86
...
1608. **[mcp-server-llamacloud](https://github.com/run-llama/mcp-server-llamacloud)** - ⭐ 86
   A MCP server connecting to managed indexes on LlamaCloud

1609. **[vggt-mps](https://github.com/jmanhype/vggt-mps)** - ⭐ 86
   VGGT 3D Vision Agent optimized for Apple Silicon with Metal Performance Shaders

1610. **[pinescript-mcp-server](https://github.com/cklose2000/pinescript-mcp-server)** - ⭐ 86
   A Model Context Protocol (MCP) server for working with TradingView PineScript

1611. **[slidev-mcp](https://github.com/LSTM-Kirigaya/slidev-mcp)** - ⭐ 86
   mcp server for slidev to make web ppt quickly and elegantly

1612. **[mcp-ui](https://github.com/machaojin1917939763/mcp-ui)** - ⭐ 85
   基于MCP(Model Context Protocol)的智能聊天应用，支持Web和桌面环境。集成OpenAI/Anthropic API，提供MCP服务器的所有工具能力。简洁现代的UI设计，支持跨平台部署。

1613. **[github-stars](https://github.com/ccbikai/github-stars)** - ⭐ 85
   A Cloudflare-powered MCP (Model Context Protocol) Server that allows you to search and query your GitHub starred repositories using natural language.

1614. **[ragie-mcp-server](https://github.com/ragieai/ragie-mcp-server)** - ⭐ 85
   Ragie Model Context Protocol Server

1615. **[action_mcp](https://github.com/seuros/action_mcp)** - ⭐ 85
   Rails Engine with MCP compliant Spec.

1616. **[mcp-memory-keeper](https://github.com/mkreyman/mcp-memory-keeper)** - ⭐ 85
   MCP server for persistent context management in AI coding assistants

1617. **[semantic-scholar-fastmcp-mcp-server](https://github.com/zongmin-yu/semantic-scholar-fastmcp-mcp-server)** - ⭐ 85
   A FastMCP server implementation for the Semantic Scholar API, providing comprehensive access to academic paper data, author information, and citation networks.

1618. **[furi](https://github.com/ashwwwin/furi)** - ⭐ 84
   CLI & API for MCP management

1619. **[deepl-mcp-server](https://github.com/DeepLcom/deepl-mcp-server)** - ⭐ 84
   A Model Context Protocol (MCP) server that provides translation capabilities using the DeepL API.

1620. **[flexible-graphrag](https://github.com/stevereiner/flexible-graphrag)** - ⭐ 84
...
1621. **[mcp-rest-api](https://github.com/dkmaker/mcp-rest-api)** - ⭐ 84
   A TypeScript-based MCP server that enables testing of REST APIs through Cline. This tool allows you to test and interact with any REST API endpoints directly from your development environment.

1622. **[schedcp](https://github.com/eunomia-bpf/schedcp)** - ⭐ 84
   MCP Server for Linux Scheduler Management and Auto optimization

1623. **[splunk-mcp](https://github.com/livehybrid/splunk-mcp)** - ⭐ 84
   A Model Context Protocol (MCP) implementation for Splunk Enterprise and Cloud integration with Cursor IDE or Claude

1624. **[outline-mcp-server](https://github.com/mmmeff/outline-mcp-server)** - ⭐ 84
   It's an MCP server... for Outline (the documentation platform!)

1625. **[mcp-dockmaster](https://github.com/dcSpark/mcp-dockmaster)** - ⭐ 84
...
1626. **[FrontAgent](https://github.com/ceilf6/FrontAgent)** - ⭐ 84
   AI agent platform for frontend engineering with SDD constraints & MCP-controlled automation. | 面向前端工程的企业级 AI Agent 平台

1627. **[spiceflow](https://github.com/remorses/spiceflow)** - ⭐ 83
   Super Simple API framework, type safe, automatic OpenAPI, MCP support, client RPC, streaming with SSE

1628. **[memory-mcp-server-go](https://github.com/okooo5km/memory-mcp-server-go)** - ⭐ 83
   A Model Context Protocol server that provides knowledge graph management capabilities.

1629. **[mcp-node](https://github.com/algolia/mcp-node)** - ⭐ 83
   MCP server for interacting with Algolia

1630. **[awesome-openid-connect](https://github.com/cerberauth/awesome-openid-connect)** - ⭐ 83
...
1631. **[tiger-cli](https://github.com/timescale/tiger-cli)** - ⭐ 83
   Tiger CLI is the command-line interface for Tiger Cloud. It includes an MCP server for helping coding agents write production-level Postgres code.

1632. **[IB_MCP](https://github.com/rcontesti/IB_MCP)** - ⭐ 83
   This project provides an Interactive Brokers (IB) API interface using the Model Context Protocol (MCP).

1633. **[mikrotik-mcp](https://github.com/jeff-nasseri/mikrotik-mcp)** - ⭐ 83
   MCP server for Mikrotik

1634. **[amap-mcp-server](https://github.com/sugarforever/amap-mcp-server)** - ⭐ 82
   高德地图MCP Server，支持stdio, sse和streamable-http

1635. **[agent-tool-protocol](https://github.com/mondaycom/agent-tool-protocol)** - ⭐ 82
   Agent Tool Protocol

1636. **[anki-mcp-server](https://github.com/ankimcp/anki-mcp-server)** - ⭐ 82
   A Model Context Protocol (MCP) server that enables AI assistants to interact with Anki, the spaced repetition flashcard application.

1637. **[node-candidate-mcp-server](https://github.com/jhgaylor/node-candidate-mcp-server)** - ⭐ 81
   A Model Context Protocol (MCP) server library that gives LLMs access to information about a candidate.

1638. **[mcp-rs-template](https://github.com/linux-china/mcp-rs-template)** - ⭐ 81
   Model Context Protocol (MCP) CLI server template for Rust

1639. **[sh-disney-mcp](https://github.com/syyuan14/sh-disney-mcp)** - ⭐ 81
   sh-disney-mcp 是一个基于 Model Context Protocol (MCP) 的mcp server，旨在通过标准化的接口，帮助大模型快速获取上海迪士尼乐园的门票价格和售卖状态信息

1640. **[mcphub](https://github.com/Cognitive-Stack/mcphub)** - ⭐ 81
...
1641. **[mcp-memory-libsql](https://github.com/spences10/mcp-memory-libsql)** - ⭐ 81
   🧠 High-performance persistent memory system for Model Context Protocol (MCP) powered by libSQL. Features vector search, semantic knowledge storage, and efficient relationship management - perfect for AI agents and knowledge graph applications.

1642. **[viper](https://github.com/ozanunal0/viper)** - ⭐ 81
...
1643. **[mcp-excel-server](https://github.com/yzfly/mcp-excel-server)** - ⭐ 81
...
1644. **[claude-swarm](https://github.com/cj-vana/claude-swarm)** - ⭐ 81
...
1645. **[apps-sdk-template](https://github.com/alpic-ai/apps-sdk-template)** - ⭐ 81
   A minimalist Typescript ChatGPT Application

1646. **[Delphi-MCP-Server](https://github.com/GDKsoftware/Delphi-MCP-Server)** - ⭐ 81
   Native Delphi Server implementation of the Model Context Protocol (MCP)

1647. **[mcp-n8n-builder](https://github.com/spences10/mcp-n8n-builder)** - ⭐ 81
   🪄 MCP server for programmatic creation and management of n8n workflows. Enables AI assistants to build, modify, and manage workflows without direct user intervention through a comprehensive set of tools and resources for interacting with n8n's REST API.

1648. **[Unreal_mcp](https://github.com/ChiR24/Unreal_mcp)** - ⭐ 81
...
1649. **[mcp-server](https://github.com/keboola/mcp-server)** - ⭐ 80
   Model Context Protocol (MCP) Server for the Keboola Platform

1650. **[legion-mcp](https://github.com/TheRaLabs/legion-mcp)** - ⭐ 80
   A server that helps people access and query data in databases using the Legion Query Runner with Model Context Protocol (MCP) in Python.

1651. **[mcp-sqlite](https://github.com/jparkerweb/mcp-sqlite)** - ⭐ 80
   🐇 Model Context Protocol (MCP) server that provides comprehensive SQLite database interaction capabilities

1652. **[office-editor-mcp](https://github.com/theWDY/office-editor-mcp)** - ⭐ 80
   基于MCP(Model Context Protocol)的Office文档处理助手，支持在MCP Client中创建和编辑Word、Excel、Powerpoint文档。

1653. **[toolhive-studio](https://github.com/stacklok/toolhive-studio)** - ⭐ 80
   ToolHive is an application that allows you to install, manage and run MCP servers and connect them to AI agents

1654. **[Awesome-Claude-MCP-Servers](https://github.com/win4r/Awesome-Claude-MCP-Servers)** - ⭐ 80
   A curated list of Model Context Protocol (MCP) servers optimized for Claude AI assistants.

1655. **[ramparts](https://github.com/highflame-ai/ramparts)** - ⭐ 80
   mcp scan that scans any mcp server for indirect attack vectors and security or configuration vulnerabilities

1656. **[leetcode-mcp-server](https://github.com/jinzcdev/leetcode-mcp-server)** - ⭐ 80
   An MCP server enabling automated access to LeetCode's problems, solutions, and public data with optional authentication for user-specific features, supporting leetcode.com & leetcode.cn sites.

1657. **[browser-debugger-cli](https://github.com/szymdzum/browser-debugger-cli)** - ⭐ 80
   CLI tool for agents to quickly access browser telemetry (DOM, network, console) via Chrome DevTools Protocol.

1658. **[mcp-server-stability-ai](https://github.com/tadasant/mcp-server-stability-ai)** - ⭐ 80
...
1659. **[aws-security-mcp](https://github.com/groovyBugify/aws-security-mcp)** - ⭐ 80
   A Model Context Protocol server that connects AI assistants like Claude to AWS security services, allowing them to autonomously query, inspect, and analyze AWS infrastructure for security issues and misconfigurations.

1660. **[xiaozhi-mcp-ha](https://github.com/mac8005/xiaozhi-mcp-ha)** - ⭐ 80
   A Home Assistant Custom Integration (HACS) that connects Xiaozhi ESP32 AI chatbot to Home Assistant via MCP

1661. **[mcp](https://github.com/twilio-labs/mcp)** - ⭐ 80
   Monorepo providing 1) OpenAPI to MCP Tool generator 2) Exposing all of Twilio's API as MCP Tools

1662. **[MCPay](https://github.com/microchipgnu/MCPay)** - ⭐ 80
   Open-source Infrastructure for MCP and x402

1663. **[fastmcp-boilerplate](https://github.com/punkpeye/fastmcp-boilerplate)** - ⭐ 79
   A simple MCP server built using FastMCP, TypeScript, ESLint, and Prettier.

1664. **[mcp-gateway](https://github.com/hyprmcp/mcp-gateway)** - ⭐ 79
...
1665. **[anki-mcp-server](https://github.com/CamdenClark/anki-mcp-server)** - ⭐ 79
   A model context protocol server that connects to Anki through AnkiConnect

1666. **[identity](https://github.com/agntcy/identity)** - ⭐ 79
...
1667. **[NASA-MCP-server](https://github.com/ProgramComputer/NASA-MCP-server)** - ⭐ 79
   A Model Context Protocol (MCP) server for NASA APIs, providing a standardized interface for AI models to interact with NASA's vast array of data sources.

1668. **[github-chat-mcp](https://github.com/AsyncFuncAI/github-chat-mcp)** - ⭐ 79
   A Model Context Protocol (MCP) for analyzing and querying GitHub repositories using the GitHub Chat API.

1669. **[codemirror-mcp](https://github.com/marimo-team/codemirror-mcp)** - ⭐ 79
   CodeMirror extension to hook up a Model Context Provider (MCP)

1670. **[jira-mcp](https://github.com/nguyenvanduocit/jira-mcp)** - ⭐ 79
...
1671. **[cursor-rust-tools](https://github.com/terhechte/cursor-rust-tools)** - ⭐ 79
   A MCP server to allow the LLM in Cursor to access Rust Analyzer, Crate Docs and Cargo Commands.

1672. **[mcp-github-project-manager](https://github.com/kunwarVivek/mcp-github-project-manager)** - ⭐ 79
   a mcp server to manage github project's functionality 

1673. **[mcp-azure-devops](https://github.com/Vortiago/mcp-azure-devops)** - ⭐ 78
   A Model Context Protocol (MCP) server enabling AI assistants to interact with Azure DevOps services via Python SDK.

1674. **[dicom-mcp](https://github.com/ChristianHinge/dicom-mcp)** - ⭐ 78
   Model Context Protocol (MCP) for interacting with dicom servers (PACS etc.)

1675. **[ls-mcp](https://github.com/lirantal/ls-mcp)** - ⭐ 78
   List MCP Server configurations in your system used by AI applications like Cursor, Claude Desktop, VS Code and others

1676. **[cve-search_mcp](https://github.com/roadwy/cve-search_mcp)** - ⭐ 78
   A Model Context Protocol (MCP) server for querying the CVE-Search API

1677. **[agentic-stock-research-system](https://github.com/rooneyrulz/agentic-stock-research-system)** - ⭐ 78
...
1678. **[fhir-mcp-server](https://github.com/wso2/fhir-mcp-server)** - ⭐ 78
   FHIR MCP Server – helping you expose any FHIR Server or API as a MCP Server.

1679. **[memov](https://github.com/memovai/memov)** - ⭐ 78
...
1680. **[QMT-MCP](https://github.com/guangxiangdebizi/QMT-MCP)** - ⭐ 78
    QMT-MCP 模块化量化交易助手

1681. **[oxylabs-mcp](https://github.com/oxylabs/oxylabs-mcp)** - ⭐ 78
   Official Oxylabs MCP integration

1682. **[rohlik-mcp](https://github.com/tomaspavlin/rohlik-mcp)** - ⭐ 78
   MCP server that lets you shop groceries across the Rohlik Group platforms (Rohlik.cz, Knuspr.de, Gurkerl.at, Kifli.hu, Sezamo.ro)

1683. **[mcp-discovery](https://github.com/rust-mcp-stack/mcp-discovery)** - ⭐ 77
   A command-line tool written in Rust for discovering and documenting MCP Server capabilities.

1684. **[lucidity-mcp](https://github.com/hyperb1iss/lucidity-mcp)** - ⭐ 77
...
1685. **[advanced-unity-mcp](https://github.com/codemaestroai/advanced-unity-mcp)** - ⭐ 77
   Public repository for Advanced Unity MCP by Code Maestro (www.code-maestro.com).

1686. **[visual-ui-debug-agent-mcp](https://github.com/samihalawa/visual-ui-debug-agent-mcp)** - ⭐ 77
   VUDA is an autonomous debugging agent that empowers AI models to visually analyze, test, and debug web

1687. **[devex](https://github.com/ParthKapoor-dev/devex)** - ⭐ 77
   ⚡️ Devex — A Fast, Secure, and Scalable Repl-as-a-Service Platform built for Developers 🚀

1688. **[reddit-research-mcp](https://github.com/king-of-the-grackles/reddit-research-mcp)** - ⭐ 77
...
1689. **[paper-search-mcp-nodejs](https://github.com/Dianel555/paper-search-mcp-nodejs)** - ⭐ 77
...
1690. **[mcp-monitor](https://github.com/seekrays/mcp-monitor)** - ⭐ 76
   A system monitoring tool that exposes system metrics via the Model Context Protocol (MCP). This tool allows LLMs to retrieve real-time system information through an MCP-compatible interface.

1691. **[tester-mcp-client](https://github.com/apify/tester-mcp-client)** - ⭐ 76
   Model Context Protocol (MCP) Client for Apify's Actors

1692. **[codeglide-mcpgen](https://github.com/CodeGlide/codeglide-mcpgen)** - ⭐ 76
   Generation of Secure MCP (Model Context Protocol) Servers from API source code at Scale

1693. **[google-cloud-mcp](https://github.com/krzko/google-cloud-mcp)** - ⭐ 76
   🤖 A Model Context Protocol (MCP) server for Google Cloud (GCP)

1694. **[woocommerce-mcp-server](https://github.com/techspawn/woocommerce-mcp-server)** - ⭐ 76
   A WooCommerce (MCP) Model Context Protocol server

1695. **[ols4](https://github.com/EBISPOT/ols4)** - ⭐ 76
   The EMBL-EBI Ontology Lookup Service (OLS)

1696. **[gitlab-mr-mcp](https://github.com/kopfrechner/gitlab-mr-mcp)** - ⭐ 76
   Interact seamlessly with GitLab repositories to manage merge requests and issues. Fetch details, add comments, and streamline your code review process with ease.

1697. **[narsil-mcp](https://github.com/postrv/narsil-mcp)** - ⭐ 76
   Rust MCP server for comprehensive code intelligence - 75+ tools, 16 languages, security scanning, call graphs, and more

1698. **[healthcare-mcp-public](https://github.com/Cicatriiz/healthcare-mcp-public)** - ⭐ 76
   A Model Context Protocol (MCP) server providing AI assistants with access to healthcare data and medical information tools, including FDA drug info, PubMed, medRxiv, NCBI Bookshelf, clinical trials, ICD-10, DICOM metadata, and a medical calculator.

1699. **[loki-mcp](https://github.com/grafana/loki-mcp)** - ⭐ 76
   An MCP ( Model Context Protocol ) Server for Grafana Loki

1700. **[sample-agents-with-nova-act-and-mcp](https://github.com/aws-samples/sample-agents-with-nova-act-and-mcp)** - ⭐ 75
...
1701. **[mcp-server-circleci](https://github.com/CircleCI-Public/mcp-server-circleci)** - ⭐ 75
   A specialized server implementation for the Model Context Protocol (MCP) designed to integrate with CircleCI's development workflow. This project serves as a bridge between CircleCI's infrastructure and the Model Context Protocol, enabling enhanced AI-powered development experiences.

1702. **[youtrack-mcp](https://github.com/tonyzorin/youtrack-mcp)** - ⭐ 75
...
1703. **[anubis-mcp](https://github.com/zoedsoupe/anubis-mcp)** - ⭐ 75
   Elixir Model Context Protocol (MCP) SDK (hermes-mcp fork)

1704. **[cursor10x-mcp](https://github.com/aiurda/cursor10x-mcp)** - ⭐ 75
   The Cursor10x MCP is a persistent multi-dimensional memory system for Cursor that enhances AI assistants with conversation context, project history, and code relationships across sessions.

1705. **[mcp-llms-txt-explorer](https://github.com/thedaviddias/mcp-llms-txt-explorer)** - ⭐ 75
   MCP to explore websites with llms.txt files

1706. **[mcp-outline](https://github.com/Vortiago/mcp-outline)** - ⭐ 75
   A Model Context Protocol (MCP) server enabling AI assistants to interact with Outline documentation services.

1707. **[agentic-coding](https://github.com/sammcj/agentic-coding)** - ⭐ 75
   Agentic Coding Rules, Templates etc...

1708. **[context-sync](https://github.com/Intina47/context-sync)** - ⭐ 75
...
1709. **[FNewsCrawler](https://github.com/noimank/FNewsCrawler)** - ⭐ 75
   一个专门为大模型设计的财经信息MCP（Model Context Protocol）服务，通过高效的爬虫技术从各大财经网站（同花顺、东方财富等）获取实时资讯，为AI模型提供准确、及时的财经数据支持。

1710. **[actual-mcp](https://github.com/s-stefanov/actual-mcp)** - ⭐ 75
   Model Context Protocol for Actual Budget API

1711. **[jvm-mcp-server](https://github.com/xzq-xu/jvm-mcp-server)** - ⭐ 74
   This is an implementation project of a JVM-based MCP (Model Context Protocol) server. The project aims to provide a standardized MCP server implementation for the JVM platform, enabling AI models to better interact with the Java ecosystem.

1712. **[mcp-kafka](https://github.com/kanapuli/mcp-kafka)** - ⭐ 74
   A Model Context Protocol Server to perform Kafka client operations

1713. **[imessage-query-fastmcp-mcp-server](https://github.com/hannesrudolph/imessage-query-fastmcp-mcp-server)** - ⭐ 74
   An MCP server that provides safe access to your iMessage database through Model Context Protocol (MCP). This server is built with the FastMCP framework and the imessagedb library, enabling LLMs to query and analyze iMessage conversations with proper phone number validation and attachment handling.

1714. **[ChEMBL-MCP-Server](https://github.com/Augmented-Nature/ChEMBL-MCP-Server)** - ⭐ 74
   A comprehensive Model Context Protocol (MCP) server providing advanced access to the ChEMBL chemical database.

1715. **[agentic-tools-mcp](https://github.com/Pimzino/agentic-tools-mcp)** - ⭐ 73
   A comprehensive Model Context Protocol (MCP) server providing AI assistants with powerful task management and agent memories capabilities with project-specific storage.

1716. **[rust-mcp-schema](https://github.com/rust-mcp-stack/rust-mcp-schema)** - ⭐ 72
   A type-safe implementation of the official Model Context Protocol (MCP) schema in Rust.

1717. **[masquerade](https://github.com/postralai/masquerade)** - ⭐ 72
   The Privacy Firewall for LLMs

1718. **[mcp-metatrader5-server](https://github.com/Qoyyuum/mcp-metatrader5-server)** - ⭐ 72
...
1719. **[perfetto-mcp](https://github.com/antarikshc/perfetto-mcp)** - ⭐ 72
...
1720. **[bitbucket-mcp](https://github.com/MatanYemini/bitbucket-mcp)** - ⭐ 72
   Bitbucket MCP - A Model Context Protocol (MCP) server for integrating with Bitbucket Cloud and Server APIs

1721. **[mcp-canvas-lms](https://github.com/DMontgomery40/mcp-canvas-lms)** - ⭐ 72
...
1722. **[wecom-bot-mcp-server](https://github.com/loonghao/wecom-bot-mcp-server)** - ⭐ 72
...
1723. **[chat.md](https://github.com/rusiaaman/chat.md)** - ⭐ 71
   An md file as a chat interface and editable history in one.

1724. **[choturobo](https://github.com/vishalmysore/choturobo)** - ⭐ 71
...
1725. **[Nano-Banana-MCP](https://github.com/ConechoAI/Nano-Banana-MCP)** - ⭐ 71
   A Nano Banana MCP server, which you can integrate to cursor/claude code and any mcp client

1726. **[codebase-mcp](https://github.com/DeDeveloper23/codebase-mcp)** - ⭐ 71
   Model Context Protocol implementation for retrieving codebases using RepoMix

1727. **[bridge4simulator](https://github.com/AppGram/bridge4simulator)** - ⭐ 71
...
1728. **[airtable-mcp](https://github.com/felores/airtable-mcp)** - ⭐ 70
   Search, create and update Airtable bases, tables, fields, and records using Claude Desktop and MCP (Model Context Protocol) clients

1729. **[railway-mcp](https://github.com/jason-tan-swe/railway-mcp)** - ⭐ 70
   An unofficial and community-built MCP server for integrating with https://railway.app

1730. **[ccxt-mcp](https://github.com/lazy-dinosaur/ccxt-mcp)** - ⭐ 70
   CCXT MCP Server bridges the gap between AI models and cryptocurrency trading by providing a standardized interface through the Model Context Protocol. Created to empower automated trading strategies, this tool allows AI assistants like Claude and GPT to directly interact with over 100 cryptocurrency exchanges without requiring users to write comple

1731. **[MCP-server-Deepseek_R1](https://github.com/66julienmartin/MCP-server-Deepseek_R1)** - ⭐ 70
   A Model Context Protocol (MCP) server implementation connecting Claude Desktop with DeepSeek's language models (R1/V3)

1732. **[fullstack-langgraph-nextjs-agent](https://github.com/agentailor/fullstack-langgraph-nextjs-agent)** - ⭐ 70
...
1733. **[Mureka-mcp](https://github.com/SkyworkAI/Mureka-mcp)** - ⭐ 70
   generate lyrics, song and background music(instrumental). Model Context Protocol (MCP) server.

1734. **[mcp-jenkins](https://github.com/lanbaoshen/mcp-jenkins)** - ⭐ 70
   The Model Context Protocol (MCP) is an open-source implementation that bridges Jenkins with AI language models following Anthropic's MCP specification. This project enables secure, contextual AI interactions with Jenkins tools while maintaining data privacy and security.

1735. **[mcp-server-email](https://github.com/Shy2593666979/mcp-server-email)** - ⭐ 69
...
1736. **[google_ads_mcp](https://github.com/google-marketing-solutions/google_ads_mcp)** - ⭐ 69
   The Google Ads MCP Server is an implementation of the Model Context Protocol (MCP) that enables Large Language Models (LLMs), such as Gemini, to interact directly with the Google Ads API.

1737. **[surrealmcp](https://github.com/surrealdb/surrealmcp)** - ⭐ 69
   The official MCP server for SurrealDB

1738. **[HopperMCP](https://github.com/MxIris-Reverse-Engineering/HopperMCP)** - ⭐ 68
   A Model Context Protocol server for Hopper Disassembler

1739. **[OmniMCP](https://github.com/OpenAdaptAI/OmniMCP)** - ⭐ 68
   OmniMCP uses Microsoft OmniParser and Model Context Protocol (MCP) to provide AI models with rich UI context and powerful interaction capabilities.

1740. **[SillyTavern-MCP-Client](https://github.com/bmen25124/SillyTavern-MCP-Client)** - ⭐ 68
   An extension of MCP for SillyTavern.

1741. **[agenite](https://github.com/subeshb1/agenite)** - ⭐ 67
...
1742. **[MCPhoenix](https://github.com/jmanhype/MCPhoenix)** - ⭐ 67
   A simplified implementation of the Model Context Protocol (MCP) server using Elixir's Phoenix Framework.

1743. **[mcp_gradio_client](https://github.com/justjoehere/mcp_gradio_client)** - ⭐ 67
   This is a proof of concept repo on how to create a gradio UI using the Model Context Protocol Client Python SDK.

1744. **[gmail-mcp-server](https://github.com/jasonsum/gmail-mcp-server)** - ⭐ 67
   Model Context Protocol (MCP) server for Gmail

1745. **[optuna-mcp](https://github.com/optuna/optuna-mcp)** - ⭐ 67
   The Optuna MCP Server is a Model Context Protocol (MCP) server to interact with Optuna APIs.

1746. **[ollama-mcp-client](https://github.com/mihirrd/ollama-mcp-client)** - ⭐ 67
   MCP client for local ollama models

1747. **[mcp-velociraptor](https://github.com/mgreen27/mcp-velociraptor)** - ⭐ 67
   VelociraptorMCP is a Model Context Protocol bridge for exposing LLMs to MCP clients.

1748. **[mcp-client-python](https://github.com/alejandro-ao/mcp-client-python)** - ⭐ 67

1749. **[anilist-mcp](https://github.com/yuna0x0/anilist-mcp)** - ⭐ 67
   AniList MCP server for accessing anime and manga data

1750. **[spring-ai](https://github.com/eazybytes/spring-ai)** - ⭐ 67
   From Java Dev to AI Engineer: Spring AI Fast Track

1751. **[mcp-fal](https://github.com/am0y/mcp-fal)** - ⭐ 67
   A Model Context Protocol (MCP) server for interacting with fal.ai models and services.

1752. **[blender-open-mcp](https://github.com/dhakalnirajan/blender-open-mcp)** - ⭐ 67
   Open Models MCP for Blender Using Ollama

1753. **[deepview-mcp](https://github.com/ai-1st/deepview-mcp)** - ⭐ 66
   DeepView MCP is a Model Context Protocol server that enables IDEs like Cursor and Windsurf to analyze large codebases using Gemini 2.5 Pro's extensive context window.

1754. **[raindrop-io-mcp-server](https://github.com/hiromitsusasaki/raindrop-io-mcp-server)** - ⭐ 66
   An integration that allows LLMs to interact with Raindrop.io bookmarks using the Model Context Protocol (MCP).

1755. **[deepseek-thinker-mcp](https://github.com/ruixingshi/deepseek-thinker-mcp)** - ⭐ 66
...
1756. **[vibe-blocks-mcp](https://github.com/majidmanzarpour/vibe-blocks-mcp)** - ⭐ 66
...
1757. **[mcp-server-datahub](https://github.com/acryldata/mcp-server-datahub)** - ⭐ 66
   The official Model Context Protocol (MCP) server for DataHub (https://datahub.com)

1758. **[piapi-mcp-server](https://github.com/apinetwork/piapi-mcp-server)** - ⭐ 66
   A TypeScript implementation of a Model Context Protocol (MCP) server that integrates with PiAPI's API. PiAPI makes user able to generate media content with Midjourney/Flux/Kling/LumaLabs/Udio/Chrip/Trellis directly from Claude or any other MCP-compatible apps.

1759. **[boilerplate-mcp-server](https://github.com/aashari/boilerplate-mcp-server)** - ⭐ 66
   TypeScript Model Context Protocol (MCP) server boilerplate providing IP lookup tools/resources. Includes CLI support and extensible structure for connecting AI systems (LLMs) to external data sources like ip-api.com. Ideal template for creating new MCP integrations via Node.js.

1760. **[m3](https://github.com/rafiattrach/m3)** - ⭐ 66
...
1761. **[ig-mcp](https://github.com/jlbadano/ig-mcp)** - ⭐ 66
...
1762. **[BurpSuite-MCP-Server](https://github.com/X3r0K/BurpSuite-MCP-Server)** - ⭐ 66
   BurpSuite MCP Server:  A powerful Model Context Protocol (MCP) server implementation for BurpSuite, providing programmatic access to Burp's core functionalities.

1763. **[awesome-mcp-best-practices](https://github.com/lirantal/awesome-mcp-best-practices)** - ⭐ 66
   Build Awesome MCPs with Awesome Best Practices for MCP Servers and MCP Clients

1764. **[mcp](https://github.com/vuetifyjs/mcp)** - ⭐ 66
   🤖 A Model Context Protocol (MCP) library for use with Agentic chat bots

1765. **[markitdown_mcp_server](https://github.com/KorigamiK/markitdown_mcp_server)** - ⭐ 65
   A Model Context Protocol (MCP) server that converts various file formats to Markdown using the MarkItDown utility.

1766. **[QuickMCP](https://github.com/gunpal5/QuickMCP)** - ⭐ 65
   Effortlessly Build Model Context Protocol Servers with OpenAPI or Swagger or Google Discovery Specifications

1767. **[ViaMCP](https://github.com/ViaVersionMCP/ViaMCP)** - ⭐ 65
   Client-side Implementation of the Via* projects for MCP

1768. **[mcp-tutorials](https://github.com/chenmingyong0423/mcp-tutorials)** - ⭐ 65
   Model Context Protocol(MCP) 中文教程讲解

1769. **[uml-mcp](https://github.com/antoinebou12/uml-mcp)** - ⭐ 65
...
1770. **[ynab-mcp-server](https://github.com/calebl/ynab-mcp-server)** - ⭐ 65
   Model Context Protocol for YNAB (you need a budget)

1771. **[community-servers](https://github.com/mcp-get/community-servers)** - ⭐ 65
...
1772. **[lsd-mcp](https://github.com/lsd-so/lsd-mcp)** - ⭐ 64
   LSD Model Context Protocol

1773. **[svelte5-mcp](https://github.com/StudentOfJS/svelte5-mcp)** - ⭐ 64
   A specialized Model Context Protocol (MCP) server for Svelte 5 frontend development

1774. **[ollama-mcp-client](https://github.com/anjor/ollama-mcp-client)** - ⭐ 64

1775. **[mcp-config](https://github.com/marcusschiesser/mcp-config)** - ⭐ 64
   A CLI tool for easy installation of MCP servers and managing their configuration

1776. **[math-mcp](https://github.com/EthanHenrickson/math-mcp)** - ⭐ 64
   A Model Context Protocol (MCP) server that provides basic mathematical and statistical functions to Large Language Models (LLMs). This server enables LLMs to perform accurate numerical calculations through a simple API.

1777. **[crash-mcp](https://github.com/nikkoxgonzales/crash-mcp)** - ⭐ 64
   MCP server for structured and efficient reasoning with step validation, branching, and revisions.

1778. **[CanvasMCPClient](https://github.com/n00bvn/CanvasMCPClient)** - ⭐ 64
   Canvas MCP Client is an open-source, self-hostable dashboard application built around an infinite, zoomable, and pannable canvas. It provides a unified interface for interacting with multiple MCP (Model Context Protocol) servers through a flexible, widget-based system.

1779. **[x64dbgMCP](https://github.com/Wasdubya/x64dbgMCP)** - ⭐ 64
   Model Context Protocol for x64dbg & x32dbg

1780. **[mcp-hetzner](https://github.com/dkruyt/mcp-hetzner)** - ⭐ 64
   A Model Context Protocol (MCP) server for interacting with the Hetzner Cloud API. This server allows language models to manage Hetzner Cloud resources through structured functions.

1781. **[ncp](https://github.com/portel-dev/ncp)** - ⭐ 64
...
1782. **[mcp-fhir](https://github.com/flexpa/mcp-fhir)** - ⭐ 63
   A Model Context Protocol implementation for FHIR

1783. **[mcp-client-capabilities](https://github.com/apify/mcp-client-capabilities)** - ⭐ 63
   Index of all Model Context Protocol (MCP) clients and their capabilities

1784. **[mcp-sdk](https://github.com/AntigmaLabs/mcp-sdk)** - ⭐ 63
   Minimalistic Rust Implementation Of Model Context Protocol from Anthropic

1785. **[airtable-mcp](https://github.com/rashidazarang/airtable-mcp)** - ⭐ 63
   Airtable integration for AI-powered applications via Anthropic's Model Context Protocol (MCP)

1786. **[mcp-openapi-schema-explorer](https://github.com/kadykov/mcp-openapi-schema-explorer)** - ⭐ 63
   MCP server providing token-efficient access to OpenAPI/Swagger specs via MCP Resource Templates for client-side exploration.

1787. **[usolver](https://github.com/sdiehl/usolver)** - ⭐ 62
   A model context protocol server for solving combinatorial optimization problems with logical and numerical constraints.

1788. **[nutrient-dws-mcp-server](https://github.com/PSPDFKit/nutrient-dws-mcp-server)** - ⭐ 62
   A Model Context Protocol (MCP) server implementation that integrates with the Nutrient Document Web Service (DWS) Processor API, providing powerful PDF processing capabilities for AI assistants.

1789. **[mcp-durable-object-client](https://github.com/Dhravya/mcp-durable-object-client)** - ⭐ 62
   testing mcps

1790. **[mcp-wolframalpha](https://github.com/akalaric/mcp-wolframalpha)** - ⭐ 62
   A Python-powered Model Context Protocol MCP server and client that uses Wolfram Alpha via API.

1791. **[tiny-mcp](https://github.com/wdndev/tiny-mcp)** - ⭐ 62
   Python 实现 MCP client / service

1792. **[voice-mcp-agent](https://github.com/den-vasyliev/voice-mcp-agent)** - ⭐ 62
...
1793. **[turbomcp](https://github.com/Epistates/turbomcp)** - ⭐ 62
   A full featured, enterprise grade rust MCP SDK

1794. **[contentful-mcp](https://github.com/ivo-toby/contentful-mcp)** - ⭐ 61
   MCP (Model Context Protocol) server for the Contentful Management API

1795. **[mcpr](https://github.com/devOpifex/mcpr)** - ⭐ 61
   Model Context Protocol server and client for R

1796. **[mcp-server-okppt](https://github.com/NeekChaw/mcp-server-okppt)** - ⭐ 61
...
1797. **[kollektiv-mcp](https://github.com/alexander-zuev/kollektiv-mcp)** - ⭐ 61
...
1798. **[ollama-mcp-db](https://github.com/robdodson/ollama-mcp-db)** - ⭐ 61
...
1799. **[mcp-cn](https://github.com/mengjian-github/mcp-cn)** - ⭐ 61
...
1800. **[ipybox](https://github.com/gradion-ai/ipybox)** - ⭐ 61
   Python code execution sandbox with programmatic MCP tool calling (PTC)

1801. **[mcp-miro](https://github.com/k-jarzyna/mcp-miro)** - ⭐ 61
   Miro integration for Model Context Protocol

1802. **[mcp_newsnow](https://github.com/sligter/mcp_newsnow)** - ⭐ 61
   一个基于 Model Context Protocol (MCP) 的新闻聚合服务器，通过 Newsnow API 提供多平台热点新闻和趋势话题。

1803. **[gopher-mcp](https://github.com/GopherSecurity/gopher-mcp)** - ⭐ 61
   MCP C++ SDK - Model Context Protocol implementation in CPP with enterprise-grade security, visibility and connectivity.

1804. **[ocaml-mcp-sdk](https://github.com/bmorphism/ocaml-mcp-sdk)** - ⭐ 60
   OCaml SDK for Model Context Protocol using Jane Street's oxcaml_effect library

1805. **[yamcp](https://github.com/hamidra/yamcp)** - ⭐ 60
   Organize your MCP servers in local workspaces, share them as Yet-Another-MCP through a single command

1806. **[rember-mcp](https://github.com/rember/rember-mcp)** - ⭐ 60
   A Model Context Protocol (MCP) server for Rember.

1807. **[mcp_zoomeye](https://github.com/zoomeye-ai/mcp_zoomeye)** - ⭐ 60
   A Model Context Protocol server that provides network asset information based on query conditions. This server allows LLMs to obtain network asset information and supports querying network asset information by zoomeye dork etc.

1808. **[arbor](https://github.com/Anandb71/arbor)** - ⭐ 60
   Graph-native code intelligence that replaces embedding-based RAG with deterministic program understanding.

1809. **[daipendency-mcp](https://github.com/daipendency/daipendency-mcp)** - ⭐ 59
   Model Context Protocol server for Daipendency

1810. **[mcp-gopls](https://github.com/hloiseau/mcp-gopls)** - ⭐ 59
   Model Context Protocol (MCP) server for Go using gopls – LSP-powered analysis, tests, coverage, and tooling.

1811. **[chess-mcp](https://github.com/pab1it0/chess-mcp)** - ⭐ 59
   A Model Context Protocol server for Chess.com's Published Data API.  This provides access to Chess.com player data, game records, and other public information through standardized MCP interfaces, allowing AI assistants to search and analyze chess information.

1812. **[mcp-hub](https://github.com/lobstercare/mcp-hub)** - ⭐ 58
   A curated list of awesome Model Context Protocol (MCP) servers.

1813. **[mcp-server-axiom](https://github.com/axiomhq/mcp-server-axiom)** - ⭐ 58
   Axiom Model Context Protocol Server

1814. **[junos-mcp-server](https://github.com/Juniper/junos-mcp-server)** - ⭐ 58
...
1815. **[smart-pet-with-mcp](https://github.com/shijianzhong/smart-pet-with-mcp)** - ⭐ 58
   一个桌宠形式的mcp client，可以对接任意mcp server,配合测试的mcp server 开源地址：https://github.com/shijianzhong/mcp-server-for-pc

1816. **[baml-agents](https://github.com/Elijas/baml-agents)** - ⭐ 58
   Building Agents with LLM structured generation (BAML), MCP Tools, and 12-Factor Agents principles

1817. **[MCP-Dandan](https://github.com/82ch/MCP-Dandan)** - ⭐ 58
   MCP Security Solution for Agentic AI — real-time proxying, behavior analysis, and malicious tool detection

1818. **[mcp-servers](https://github.com/pulsemcp/mcp-servers)** - ⭐ 58
   MCP (Model Context Protocol) Servers authored and maintained by the PulseMCP team. We build reliable servers thoughtfully designed specifically for MCP Client-powered workflows.

1819. **[fred-mcp-server](https://github.com/stefanoamorelli/fred-mcp-server)** - ⭐ 58
   Open-source FRED MCP Server (Federal Reserve Economic Data)

1820. **[mcp-arr](https://github.com/aplaceforallmystuff/mcp-arr)** - ⭐ 58
   MCP server for *arr media management suite

1821. **[mcp-clojure-sdk](https://github.com/unravel-team/mcp-clojure-sdk)** - ⭐ 58
   A Clojure SDK to create MCP servers (and eventually clients)

1822. **[mobile-mcp](https://github.com/runablehq/mobile-mcp)** - ⭐ 57
   A Model Context Protocol (MCP) server that provides mobile automation capabilities.

1823. **[mcp-gemini-search](https://github.com/arjunprabhulal/mcp-gemini-search)** - ⭐ 57
   Model Context Protocol (MCP) with Gemini 2.5 Pro. Convert conversational queries into flight searches using Gemini's function calling capabilities and MCP's flight search tools

1824. **[create-mcp-app](https://github.com/boguan/create-mcp-app)** - ⭐ 57
   A CLI tool for quickly scaffolding Model Context Protocol (MCP) server applications with TypeScript support and modern development tooling

1825. **[quick-mcp-example](https://github.com/ALucek/quick-mcp-example)** - ⭐ 57
   Short and sweet example MCP server / client implementation for Tools, Resources and Prompts.

1826. **[ashra-mcp](https://github.com/getrupt/ashra-mcp)** - ⭐ 57
   A Model Context Protocol server for Ashra

1827. **[clarity-mcp-server](https://github.com/microsoft/clarity-mcp-server)** - ⭐ 57
   A Model Context Protocol (MCP) server for Microsoft Clarity

1828. **[XActions](https://github.com/nirholas/XActions)** - ⭐ 56
...
1829. **[metis-router](https://github.com/metis-mantis/metis-router)** - ⭐ 56
   MCP router and Web Based MCP client

1830. **[mcp-think-tank](https://github.com/flight505/mcp-think-tank)** - ⭐ 56
...
1831. **[nutrient-document-engine-mcp-server](https://github.com/PSPDFKit/nutrient-document-engine-mcp-server)** - ⭐ 56
   A Model Context Protocol (MCP) server implementation exposes document processing capabilities through natural language, supporting both direct human interaction and AI agent tool calling.

1832. **[Intelli](https://github.com/intelligentnode/Intelli)** - ⭐ 56
   Build multi-model chatbots and agents from intent.

1833. **[mcp-manager](https://github.com/MediaPublishing/mcp-manager)** - ⭐ 56
   A web-based GUI tool for managing Model Context Protocol (MCP) servers in Claude and Cursor

1834. **[purple-mcp](https://github.com/Sentinel-One/purple-mcp)** - ⭐ 56
...
1835. **[slither-mcp](https://github.com/trailofbits/slither-mcp)** - ⭐ 56
   MCP server for Slither static analysis of Solidity smart contracts

1836. **[MySQL_MCP](https://github.com/guangxiangdebizi/MySQL_MCP)** - ⭐ 56
   这是一个功能强大且易用的MySQL数据库MCP（Model Context Protocol）服务器，让你的AI助手可以安全地进行完整的数据库操作，支持多数据库连接管理、增删改查、事务管理和智能回滚功能。

1837. **[mcp-thinking](https://github.com/mattzcarey/mcp-thinking)** - ⭐ 56
   thinking tool for claude desktop/mcp clients using Deepseek reasoner

1838. **[EnergyPlus-MCP](https://github.com/LBNL-ETA/EnergyPlus-MCP)** - ⭐ 56
...
1839. **[xiaozhi-mcp-client](https://github.com/shadowcz007/xiaozhi-mcp-client)** - ⭐ 56
   可视化的配置和管理，给xiaozhi接入mcp

1840. **[umbraco-mcp](https://github.com/Matthew-Wise/umbraco-mcp)** - ⭐ 55
   A model context protocol  (MCP) server for Umbraco 

1841. **[AllVoiceLab-MCP](https://github.com/allvoicelab/AllVoiceLab-MCP)** - ⭐ 55
...
1842. **[mkp](https://github.com/StacklokLabs/mkp)** - ⭐ 55
   MKP is a Model Context Protocol (MCP) server for Kubernetes

1843. **[sublinear-time-solver](https://github.com/ruvnet/sublinear-time-solver)** - ⭐ 55
...
1844. **[mono-mcp](https://github.com/sin4ch/mono-mcp)** - ⭐ 55
   A comprehensive Model Context Protocol (MCP) server for Nigerian banking operations using the Mono Open Banking API.

1845. **[mcp-bridge-api](https://github.com/INQUIRELAB/mcp-bridge-api)** - ⭐ 55
...
1846. **[windbg-ext-mcp](https://github.com/NadavLor/windbg-ext-mcp)** - ⭐ 55
...
1847. **[erpnext-mcp-server](https://github.com/rakeshgangwar/erpnext-mcp-server)** - ⭐ 55
   Connect AI assistants to your ERPNext instance via the Model Context Protocol (MCP) using the official Frappe API.

1848. **[appium-mcp](https://github.com/Rahulec08/appium-mcp)** - ⭐ 54
...
1849. **[openai-mcp-client](https://github.com/ResoluteError/openai-mcp-client)** - ⭐ 54
   A rudimentary implementation of Anthropic's Model Context Protocol with OpenAIs Model

1850. **[mcp-headless-gmail](https://github.com/baryhuang/mcp-headless-gmail)** - ⭐ 54
   A MCP (Model Context Protocol) server that provides get, send Gmails without local credential or token setup.

1851. **[geoserver-mcp](https://github.com/mahdin75/geoserver-mcp)** - ⭐ 54
   A Model Context Protocol (MCP) server implementation that connects LLMs to the GeoServer REST API

1852. **[fastmail-mcp](https://github.com/MadLlama25/fastmail-mcp)** - ⭐ 54
...
1853. **[Alph](https://github.com/Aqualia/Alph)** - ⭐ 54
   Universal MCP Server Configuration Manager

1854. **[mcp-all-in-one](https://github.com/vtxf/mcp-all-in-one)** - ⭐ 54
...
1855. **[mcp-openai](https://github.com/S1M0N38/mcp-openai)** - ⭐ 53
   🔗 MCP Client with OpenAI compatible API

1856. **[qu3-app](https://github.com/qu3ai/qu3-app)** - ⭐ 53
   Quantum-proof MCP Server and Client Interactions

1857. **[NoLLMChat](https://github.com/zrg-team/NoLLMChat)** - ⭐ 53
...
1858. **[mssql_mcp_server](https://github.com/JexinSam/mssql_mcp_server)** - ⭐ 53
   A Model Context Protocol (MCP) server facilitating secure interactions with MSSQL databases.

1859. **[nasdaq-data-link-mcp](https://github.com/stefanoamorelli/nasdaq-data-link-mcp)** - ⭐ 53
   A Nasdaq Data Link MCP (Model Context Protocol) Server

1860. **[mcp-shell](https://github.com/sonirico/mcp-shell)** - ⭐ 53
   Give hands to AI. MCP server to run shell commands securely, auditably, and on demand.

1861. **[ticktick-mcp-server](https://github.com/alexarevalo9/ticktick-mcp-server)** - ⭐ 53
   A Model Context Protocol (MCP) server designed to integrate with the TickTick task management platform, enabling intelligent context-aware task operations and automation.

1862. **[MCP4EDA](https://github.com/NellyW8/MCP4EDA)** - ⭐ 53
...
1863. **[mcp-server-azure-ai-agents](https://github.com/farzad528/mcp-server-azure-ai-agents)** - ⭐ 52
   Model Context Protocol Servers for Azure AI Search

1864. **[gomcp](https://github.com/llmcontext/gomcp)** - ⭐ 52
   Unofficial Golang SDK for Anthropic Model Context Protocol

1865. **[client](https://github.com/php-mcp/client)** - ⭐ 52
   Core PHP implementation for the Model Context Protocol (MCP) Client

1866. **[cap-mcp-plugin](https://github.com/gavdilabs/cap-mcp-plugin)** - ⭐ 52
   MCP (Model Context Protocol) server plugin for CAP NodeJS

1867. **[mcp-cpp](https://github.com/Neumann-Labs/mcp-cpp)** - ⭐ 52
   A C++ SDK for the Model Context Protocol (MCP). The SDK will provide a framework for creating MCP servers and clients in C++.

1868. **[ocaml-mcp](https://github.com/tmattio/ocaml-mcp)** - ⭐ 52
   OCaml implementation of the Model Context Protocol (MCP)

1869. **[awesome-remote-mcp-servers](https://github.com/sylviangth/awesome-remote-mcp-servers)** - ⭐ 52
   A curated list of Hosted & Managed Model Context Protocol (MCP) Servers accessible via a simple URL endpoint.

1870. **[mcp-app-demo](https://github.com/pomerium/mcp-app-demo)** - ⭐ 52
...
1871. **[mxcp](https://github.com/raw-labs/mxcp)** - ⭐ 52
   Model eXecution + Context Protocol: Enterprise-Grade Data-to-AI Infrastructure

1872. **[mcp-open-library](https://github.com/8enSmith/mcp-open-library)** - ⭐ 52
   A Model Context Protocol (MCP) server for the Internet Archive's Open Library API that enables AI assistants to search for book and author information.

1873. **[mcp-docs-service](https://github.com/alekspetrov/mcp-docs-service)** - ⭐ 52
   MCP Documentation Management Service - A Model Context Protocol implementation for documentation management

1874. **[mcp](https://github.com/twelvedata/mcp)** - ⭐ 52
...
1875. **[mcp-duckdb-memory-server](https://github.com/IzumiSy/mcp-duckdb-memory-server)** - ⭐ 52
   MCP Memory Server with DuckDB backend

1876. **[mcp-batchit](https://github.com/ryanjoachim/mcp-batchit)** - ⭐ 52
...
1881. **[freecad-mcp](https://github.com/contextform/freecad-mcp)** - ⭐ 52
   FreeCAD MCP - Open-source Model Context Protocol server for FreeCAD automation

1882. **[podman-mcp-server](https://github.com/manusa/podman-mcp-server)** - ⭐ 52
   Model Context Protocol (MCP) server for container runtimes (Podman and Docker)

1883. **[ollama-mcp-bridge](https://github.com/jonigl/ollama-mcp-bridge)** - ⭐ 52
   Extend the Ollama API with dynamic AI tool integration from multiple MCP (Model Context Protocol) servers. Fully compatible, transparent, and developer-friendly, ideal for building powerful local LLM applications, AI agents, and custom chatbots

1884. **[mcp-client](https://github.com/rakesh-eltropy/mcp-client)** - ⭐ 51

1885. **[vrchat-mcp](https://github.com/sawa-zen/vrchat-mcp)** - ⭐ 51
   This project is a Model Context Protocol (MCP) server for interacting with the VRChat API.

1886. **[bloodhound_mcp](https://github.com/mwnickerson/bloodhound_mcp)** - ⭐ 51
   A Model Context Protocol (MCP) server to converse with data in Bloodhound

1887. **[Memory-Plus](https://github.com/Yuchen20/Memory-Plus)** - ⭐ 51
...
1888. **[ibkr-mcp-server](https://github.com/seriallazer/ibkr-mcp-server)** - ⭐ 51
   MCP Server for IBKR Client

1889. **[mcp-ssh](https://github.com/shuakami/mcp-ssh)** - ⭐ 51
   🔐 SSH MCP Tool - AI-powered SSH management through MCP protocol | 基于MCP协议的SSH工具，为AI提供SSH远程操作能力

1890. **[context-optimizer-mcp-server](https://github.com/malaksedarous/context-optimizer-mcp-server)** - ⭐ 51
   A Model Context Protocol (MCP) server that provides context optimization tools for AI coding assistants including GitHub Copilot, Cursor AI, Claude Desktop, and other MCP-compatible assistants enabling them to extract targeted information rather than processing large terminal outputs and files wasting their context.

1891. **[joplin-mcp-server](https://github.com/dweigend/joplin-mcp-server)** - ⭐ 51
   A Model Context Protocol (MCP) Server for https://joplinapp.org/ that enables note access through the https://modelcontextprotocol.io. Perfect for integration with AI assistants like Claude.

1892. **[MediaWiki-MCP-Server](https://github.com/ProfessionalWiki/MediaWiki-MCP-Server)** - ⭐ 51
   Model Context Protocol (MCP) Server to connect your AI with any MediaWiki

1893. **[mcp-auth-proxy](https://github.com/sigbit/mcp-auth-proxy)** - ⭐ 51
   MCP Auth Proxy is a secure OAuth 2.1 authentication proxy for Model Context Protocol (MCP) servers

1894. **[chucknorris](https://github.com/pollinations/chucknorris)** - ⭐ 50
...
1895. **[AgentDNS-Node](https://github.com/jsjfai/AgentDNS-Node)** - ⭐ 50
...
1896. **[adx-mcp-server](https://github.com/pab1it0/adx-mcp-server)** - ⭐ 50
   A Model Context Protocol (MCP) server that enables AI assistants to query and analyze Azure Data Explorer databases through standardized interfaces.

1897. **[adk-mcp-a2a-crash-course](https://github.com/chongdashu/adk-mcp-a2a-crash-course)** - ⭐ 50
...
1898. **[mcp-guard](https://github.com/General-Analysis/mcp-guard)** - ⭐ 50
   MCP Guard secures your MCP client from prompt injection attacks and more.

1899. **[mcp-security-audit](https://github.com/qianniuspace/mcp-security-audit)** - ⭐ 50
   A powerful MCP (Model Context Protocol) Server that audits npm package dependencies for security vulnerabilities. Built with remote npm registry integration for real-time security checks.

1900. **[rag-app-on-aws](https://github.com/genieincodebottle/rag-app-on-aws)** - ⭐ 50
...
1901. **[gomcp](https://github.com/localrivet/gomcp)** - ⭐ 49
...
1902. **[mcpo_docker_use](https://github.com/flyfox666/mcpo_docker_use)** - ⭐ 49
...
1903. **[create-mcp](https://github.com/zueai/create-mcp)** - ⭐ 49
...
1904. **[rulego-server](https://github.com/rulego/rulego-server)** - ⭐ 49
   A lightweight dependency-free workflow automation platform. Supports iPaaS, stream computing, MCP, and AI capabilities. 

1905. **[go-mcp-mysql](https://github.com/Zhwt/go-mcp-mysql)** - ⭐ 49
   Zero burden, ready-to-use Model Context Protocol (MCP) server for interacting with MySQL and automation. No Node.js or Python environment needed.

1906. **[tripadvisor-mcp](https://github.com/pab1it0/tripadvisor-mcp)** - ⭐ 49
...
1907. **[DecompilerServer](https://github.com/pardeike/DecompilerServer)** - ⭐ 49
...
1908. **[google-ai-mode-mcp](https://github.com/PleasePrompto/google-ai-mode-mcp)** - ⭐ 49
...
1912. **[mcp-reticle](https://github.com/LabTerminal/mcp-reticle)** - ⭐ 49
   Reticle intercepts, visualizes, and profiles JSON-RPC traffic between your LLM and MCP servers in real-time, with zero latency overhead. Stop debugging blind. Start seeing everything.

1913. **[oatpp-mcp](https://github.com/oatpp/oatpp-mcp)** - ⭐ 48
   Anthropic’s Model Context Protocol implementation for Oat++

1914. **[anysite-mcp-server](https://github.com/anysiteio/anysite-mcp-server)** - ⭐ 48
   A Model Context Protocol (MCP) server that provides comprehensive access to LinkedIn data and functionalities using the Anysite API, enabling not only data retrieval but also robust management of user accounts.

1915. **[mcp](https://github.com/goplus/mcp)** - ⭐ 48
...
1916. **[mcp-mermaid-validator](https://github.com/rtuin/mcp-mermaid-validator)** - ⭐ 48
   A Model Context Protocol server that validates and renders Mermaid diagrams.

1917. **[auto-MCP-client](https://github.com/Chen-speculation/auto-MCP-client)** - ⭐ 48
...
1918. **[mcp-client-demo](https://github.com/KelvinQiu802/mcp-client-demo)** - ⭐ 48

1919. **[puremd-mcp](https://github.com/puremd/puremd-mcp)** - ⭐ 48
   Unblock, scrape, and search tools for MCP clients

1920. **[1xn-vmcp](https://github.com/1xn-labs/1xn-vmcp)** - ⭐ 48
   vMCP - Virtual Model Context Protocol

1921. **[mcp-oauth-gateway](https://github.com/atrawog/mcp-oauth-gateway)** - ⭐ 48
...
1922. **[FreeCAD-MCP](https://github.com/ATOI-Ming/FreeCAD-MCP)** - ⭐ 48
...
1923. **[mcp-server-atlassian-jira](https://github.com/aashari/mcp-server-atlassian-jira)** - ⭐ 48
...
1924. **[kroger-mcp](https://github.com/CupOfOwls/kroger-mcp)** - ⭐ 48
...
1925. **[rs-utcp](https://github.com/universal-tool-calling-protocol/rs-utcp)** - ⭐ 48
   Official Rust implementation of the UTCP

1926. **[zendesk-mcp-server](https://github.com/reminia/zendesk-mcp-server)** - ⭐ 48
   A Model Context Protocol server for Zendesk

1927. **[youtube-mcp-server](https://github.com/mourad-ghafiri/youtube-mcp-server)** - ⭐ 48
   A powerful Model Context Protocol (MCP) server for YouTube video transcription and metadata extraction.

1928. **[mcp-kubernetes](https://github.com/Azure/mcp-kubernetes)** - ⭐ 48
   A Model Context Protocol (MCP) server that enables AI assistants to interact with Kubernetes clusters. It serves as a bridge between AI tools (like Claude, Cursor, and GitHub Copilot) and Kubernetes

1929. **[mcp-server-synology](https://github.com/atom2ueki/mcp-server-synology)** - ⭐ 48
...
1930. **[model-context-protocol-rb](https://github.com/dickdavis/model-context-protocol-rb)** - ⭐ 47
   An implementation of the Model Context Protocol in Ruby.

1931. **[kuon](https://github.com/lissettecarlr/kuon)** - ⭐ 47
...
1932. **[scheduler-mcp](https://github.com/PhialsBasement/scheduler-mcp)** - ⭐ 47
...
1933. **[mcp_demo](https://github.com/Ming-jiayou/mcp_demo)** - ⭐ 47
   A simple example of building an MCP client using C#.

1934. **[vchart-mcp-server](https://github.com/VisActor/vchart-mcp-server)** - ⭐ 47
   A Model Context Protocol (MCP) server for the @visactor/vchart that enables AI assistants to generate interactive charts and visualizations.

1935. **[mcp-things3](https://github.com/drjforrest/mcp-things3)** - ⭐ 47
...
1936. **[claude-mcp-setup](https://github.com/patruff/claude-mcp-setup)** - ⭐ 47
   Easy setup script for Anthropic Claude Model Context Protocol (MCP) servers on Windows

1937. **[mcp-server-kibana](https://github.com/TocharianOU/mcp-server-kibana)** - ⭐ 47
   MCP server for Kibana, Access search and manage Kibana in MCP Client.

1938. **[mcp-server](https://github.com/inkdropapp/mcp-server)** - ⭐ 47
   Inkdrop Model Context Protocol Server

1939. **[AI-Cursor-Scraping-Assistant](https://github.com/TheWebScrapingClub/AI-Cursor-Scraping-Assistant)** - ⭐ 47
...
1940. **[mcp-gearbox](https://github.com/rohitsoni007/mcp-gearbox)** - ⭐ 46
   A modern desktop application for managing Model Context Protocol (MCP) servers across multiple AI agents

1941. **[mcp-openapi-schema](https://github.com/hannesj/mcp-openapi-schema)** - ⭐ 46
   OpenAPI Schema Model Context Protocol Server

1942. **[langchain-mcp-client](https://github.com/guinacio/langchain-mcp-client)** - ⭐ 46
   This Streamlit application provides a user interface for connecting to MCP (Model Context Protocol) servers and interacting with them using different LLM providers (OpenAI, Anthropic, Google, Ollama).

1943. **[APIWeaver](https://github.com/GongRzhe/APIWeaver)** - ⭐ 46
...
1944. **[ns-mcp-server](https://github.com/r-huijts/ns-mcp-server)** - ⭐ 46
   A Model Context Protocol (MCP) server that provides access to NS (Dutch Railways) travel information through Claude AI. This server enables Claude to fetch real-time train travel information and disruptions using the official Dutch NS API.

1945. **[eliza-plugin-mcp](https://github.com/fleek-platform/eliza-plugin-mcp)** - ⭐ 46
   ElizaOS plugin allowing agents to connect to MCP servers

1946. **[Homeassistant-server-mcp](https://github.com/hekmon8/Homeassistant-server-mcp)** - ⭐ 46
   A Model Context Protocol (MCP) server for interacting with Home Assistant. This server provides tools to control and monitor your Home Assistant devices through MCP-enabled applications.

1947. **[go-mcp](https://github.com/MegaGrindStone/go-mcp)** - ⭐ 46
...
1948. **[Aspire.MCP.Sample](https://github.com/elbruno/Aspire.MCP.Sample)** - ⭐ 46
   Sample MCP Server and MCP client with Aspire

1949. **[mcp-gitee](https://github.com/oschina/mcp-gitee)** - ⭐ 46
   mcp-gitee is a Model Context Protocol (MCP) server implementation for Gitee. It provides a set of tools that interact with Gitee's API, allowing AI assistants to manage repository, issues, pull requests, etc.

1950. **[Koppla](https://github.com/ruudmens/Koppla)** - ⭐ 46
   A Model-Context-Protocol (MCP) Server for Active Directory

1951. **[mcp-lite-dev](https://github.com/datawhalechina/mcp-lite-dev)** - ⭐ 46
   共学《MCP极简开发》项目代码

1952. **[mcp-victorialogs](https://github.com/VictoriaMetrics-Community/mcp-victorialogs)** - ⭐ 46
   The implementation of Model Context Protocol (MCP) server for VictoriaLogs.

1953. **[shadowgit-mcp](https://github.com/blade47/shadowgit-mcp)** - ⭐ 46
...
1954. **[mcp-sdk](https://github.com/symfony/mcp-sdk)** - ⭐ 45
   Model Context Protocol SDK for Client and Server applications in PHP

1955. **[hackmd-mcp](https://github.com/yuna0x0/hackmd-mcp)** - ⭐ 45
   A Model Context Protocol server for integrating HackMD's note-taking platform with AI assistants.

1956. **[mcp-made-simple](https://github.com/chongdashu/mcp-made-simple)** - ⭐ 45
   Model Context Protocol (MCP) Made Simple - Code for the tutorial series - focusing on practical ways to understand and use MCP

1957. **[Serper-search-mcp](https://github.com/NightTrek/Serper-search-mcp)** - ⭐ 45
   Un-official Serper Google search server for Cline and other MCP clients

1958. **[mcpcat-python-sdk](https://github.com/MCPCat/mcpcat-python-sdk)** - ⭐ 45
   MCPcat is an analytics platform for MCP server owners 🐱.

1959. **[mcp-rdf-explorer](https://github.com/emekaokoye/mcp-rdf-explorer)** - ⭐ 45
...
1960. **[pprof-analyzer-mcp](https://github.com/ZephyrDeng/pprof-analyzer-mcp)** - ⭐ 45
   This is a Model Context Protocol (MCP) server implemented in Go, providing a tool to analyze Go pprof performance profiles.

1961. **[codex-mcp-go](https://github.com/w31r4/codex-mcp-go)** - ⭐ 45
...
1962. **[mcp-youtube](https://github.com/adhikasp/mcp-youtube)** - ⭐ 45
   Model Context Protocol to fetch youtube transcript

1963. **[mcp-auth-servers](https://github.com/Azure-Samples/mcp-auth-servers)** - ⭐ 45
   🔒 Reference MCP servers that demo how authentication works with the current Model Context Protocol spec.

1964. **[sample-agentic-ai-web](https://github.com/aws-samples/sample-agentic-ai-web)** - ⭐ 45
...
1965. **[excalidraw-mcp](https://github.com/i-tozer/excalidraw-mcp)** - ⭐ 45
   Model Context Protocol (MCP) server for Excalidraw - Work in Progress

1966. **[calculator-mcp-server](https://github.com/huhabla/calculator-mcp-server)** - ⭐ 45
   A Model Context Protocol (MCP) server that provides Claude with advanced mathematical calculation capabilities

1967. **[marinade-finance-mcp-server](https://github.com/lorine93s/marinade-finance-mcp-server)** - ⭐ 45
   Marinade Finance MCP Server is an MCP server specifically designed for the Marinade Finance.

1968. **[quickbooks-online-mcp-server](https://github.com/intuit/quickbooks-online-mcp-server)** - ⭐ 45
...
1969. **[mcp-server-atlassian-confluence](https://github.com/aashari/mcp-server-atlassian-confluence)** - ⭐ 45
   Node.js/TypeScript MCP server for Atlassian Confluence. Provides tools enabling AI systems (LLMs) to list/get spaces & pages (content formatted as Markdown) and search via CQL. Connects AI seamlessly to Confluence knowledge bases using the standard MCP interface.

1970. **[pubmed-mcp-server](https://github.com/cyanheads/pubmed-mcp-server)** - ⭐ 45
...
1971. **[meme-mcp](https://github.com/haltakov/meme-mcp)** - ⭐ 45
   A simple Model Context Protocol (MCP) server for generating memes using the ImgFlip API

1972. **[flightradar24-mcp-server](https://github.com/sunsetcoder/flightradar24-mcp-server)** - ⭐ 44
   Model Context Protocol server for Flight Tracking

1973. **[vue-mcp-next](https://github.com/tuskermanshu/vue-mcp-next)** - ⭐ 44
...
1974. **[mcp-starter-template](https://github.com/StevenStavrakis/mcp-starter-template)** - ⭐ 44
   An opinionated starter template for making Model Context Protocol (MCP) servers

1975. **[langchaingo-mcp-adapter](https://github.com/i2y/langchaingo-mcp-adapter)** - ⭐ 44
   A Go adapter that bridges LangChain Go tools with Model Context Protocol (MCP) servers.

1976. **[wechat-mcp](https://github.com/JettChenT/wechat-mcp)** - ⭐ 44
   Model Context Protocol for WeChat

1977. **[generic-mcp-client-chat](https://github.com/rom1504/generic-mcp-client-chat)** - ⭐ 44
   Generic MCP Client to use any MCP tool in a chat

1978. **[spring-ai-mcp-client](https://github.com/ogulcanarbc/spring-ai-mcp-client)** - ⭐ 44
...
1979. **[modular-mcp](https://github.com/d-kimuson/modular-mcp)** - ⭐ 44
   A Model Context Protocol (MCP) proxy server that enables efficient management of large tool collections across multiple MCP servers by grouping them and loading tool schemas on-demand.

1980. **[Claude-Project-Coordinator](https://github.com/M-Pineapple/Claude-Project-Coordinator)** - ⭐ 44
...
1981. **[thingspanel-mcp](https://github.com/ThingsPanel/thingspanel-mcp)** - ⭐ 44
...
1982. **[esa-mcp-server](https://github.com/esaio/esa-mcp-server)** - ⭐ 44
   esa.io の公式 MCP(Model Context Protocol)サーバー(STDIO Transport版)

1983. **[mcp-mail](https://github.com/shuakami/mcp-mail)** - ⭐ 44
   📧 MCP Mail Tool - AI-powered email management tool | 基于 MCP 的智能邮件管理工具

1984. **[vercel-ai-docs-mcp](https://github.com/IvanAmador/vercel-ai-docs-mcp)** - ⭐ 44
   A Model Context Protocol (MCP) server that provides AI-powered search and querying capabilities for the Vercel AI SDK documentation. This project enables developers to ask questions about the Vercel AI SDK and receive accurate, contextualized responses based on the official documentation.

1985. **[awesome-mcp-security](https://github.com/AIM-Intelligence/awesome-mcp-security)** - ⭐ 44
   Security Threats related with MCP (Model Context Protocol), MCP Servers and more

1986. **[dataproduct-mcp](https://github.com/entropy-data/dataproduct-mcp)** - ⭐ 44
...
1987. **[tuisic](https://github.com/Dark-Kernel/tuisic)** - ⭐ 44
...
1988. **[MCPP.Net](https://github.com/xuzeyu91/MCPP.Net)** - ⭐ 43
   Model Context Protocol Platform，统一管理你的MCP服务

1989. **[mcp-playground](https://github.com/Elkhn/mcp-playground)** - ⭐ 43
   A Streamlit-based chat app for LLMs with plug-and-play tool support via Model Context Protocol (MCP), powered by LangChain, LangGraph, and Docker.

1990. **[taskMaster-todoist-mcp](https://github.com/mingolladaniele/taskMaster-todoist-mcp)** - ⭐ 43
...
1991. **[LLaMa-MCP-Streamlit](https://github.com/Nikunj2003/LLaMa-MCP-Streamlit)** - ⭐ 43
   AI assistant built with Streamlit, NVIDIA NIM (LLaMa 3.3:70B) / Ollama, and Model Control Protocol (MCP).

1992. **[pdf-mcp](https://github.com/saury1120/pdf-mcp)** - ⭐ 43
   一个强大的 PDF 处理 MCP（Model Context Protocol）服务，提供全面的 PDF 文档分析功能

1993. **[mcp-agents-hub](https://github.com/mcp-agents-ai/mcp-agents-hub)** - ⭐ 43
   The open-source ecosystem for building, discovering, and deploying Model Context Protocol servers and clients.

1994. **[scaled-mcp](https://github.com/Traego/scaled-mcp)** - ⭐ 43
   ScaledMCP is a horizontally scalabled MCP and A2A Server. You know, for AI.

1995. **[mcp-servers-kagi](https://github.com/ac3xx/mcp-servers-kagi)** - ⭐ 43
   A Model Context Protocol server implementation for Kagi's API

1996. **[world_bank_mcp_server](https://github.com/anshumax/world_bank_mcp_server)** - ⭐ 43
   An implementation of the Model Context Protocol for the World Bank open data API

1997. **[bookstack-mcp-server](https://github.com/pnocera/bookstack-mcp-server)** - ⭐ 43
   A Model Context Protocol (MCP) server providing full access to BookStack's knowledge management capabilities

1998. **[mcp](https://github.com/getAlby/mcp)** - ⭐ 43
   Connect a bitcoin lightning wallet to your LLM using Nostr Wallet Connect and Model Context Protocol

1999. **[canvas-mcp](https://github.com/vishalsachdev/canvas-mcp)** - ⭐ 43
   A Model Context Protocol server to run locally and connect to a Canvas LMS 

2000. **[mcp-container-ts](https://github.com/Azure-Samples/mcp-container-ts)** - ⭐ 43
   This is a quick start guide that provides the basic building blocks to set up a remote Model Context Protocol (MCP) server using Azure Container Apps. The MCP server is built using Node.js and TypeScript, and it can be used to run various tools and services in a serverless environment.

2001. **[mcp-server-ledger](https://github.com/minhyeoky/mcp-server-ledger)** - ⭐ 43
   A Model Context Protocol server for interacting with Ledger CLI, a powerful double-entry accounting system. This server enables Large Language Models to query and analyze financial data through a standardized interface, making it easy for AI assistants to help with financial reporting, budget analysis, and accounting tasks.

2002. **[mcp-filter](https://github.com/pro-vi/mcp-filter)** - ⭐ 43
   A proxy MCP (Model Context Protocol) server that filters the upstream tool surface to just the tools you need.

2003. **[abaqus-mcp-server](https://github.com/jianzhichun/abaqus-mcp-server)** - ⭐ 43
...
2004. **[semanticscholar-MCP-Server](https://github.com/JackKuo666/semanticscholar-MCP-Server)** - ⭐ 43
   🔍 This project implements a Model Context Protocol (MCP) server for interacting with the Semantic Scholar API. It provides tools for searching papers, retrieving paper and author details, and fetching citations and references.

2005. **[crawlbase-mcp](https://github.com/crawlbase/crawlbase-mcp)** - ⭐ 43
   Crawlbase MCP Server connects AI agents and LLMs with real-time web data. It powers Claude, Cursor, and Windsurf integrations with battle-tested web scraping, JavaScript rendering, and anti-bot protection enabling structured, live data inside your AI workflows.

2006. **[solana-dev-mcp](https://github.com/solana-foundation/solana-dev-mcp)** - ⭐ 42
   Solana Model Context Protocol (MCP) Demo

2007. **[mcp-graphql-schema](https://github.com/hannesj/mcp-graphql-schema)** - ⭐ 42
   GraphQL Schema Model Context Protocol Server

2008. **[openrpc-mcp-server](https://github.com/shanejonas/openrpc-mcp-server)** - ⭐ 42
   A Model Context Protocol (MCP) server that provides JSON-RPC functionality through OpenRPC.

2009. **[awesome-mcp-servers](https://github.com/mctrinh/awesome-mcp-servers)** - ⭐ 42
   A curated list of excellent Model Context Protocol (MCP) servers.

2010. **[mcp-openmsx](https://github.com/nataliapc/mcp-openmsx)** - ⭐ 42
...
2011. **[python-notebook-mcp](https://github.com/UsamaK98/python-notebook-mcp)** - ⭐ 42
   Lightweight Python Notebook MCP - Enable AI assistants to create, edit, and view Jupyter notebooks via Model Context Protocol

2012. **[rhinoMcpServer](https://github.com/always-tinkering/rhinoMcpServer)** - ⭐ 42
...
2013. **[mcp-amadeus](https://github.com/donghyun-chae/mcp-amadeus)** - ⭐ 42
   Amadeus MCP(Model Context Protocol) Server

2014. **[MCPApp](https://github.com/tanaikech/MCPApp)** - ⭐ 42
   This text introduces the Model Context Protocol (MCP) for AI interaction, exploring Google Apps Script (GAS) as a server option. It shows feasibility with a sample but notes the lack of a GAS SDK, aiming to encourage understanding and development.

2015. **[mcp_server_filesystem](https://github.com/MarcusJellinghaus/mcp_server_filesystem)** - ⭐ 42
   MCP File System Server: A secure Model Context Protocol server that provides file operations for AI assistants. Enables Claude and other assistants to safely read, write, and list files in a designated project directory with robust path validation and security controls.

2016. **[beemcp](https://github.com/OkGoDoIt/beemcp)** - ⭐ 42
   BeeMCP: an unofficial Model Context Protocol (MCP) server that connects your Bee wearable lifelogger to AI via the Model Context Protocol

2017. **[devcontext](https://github.com/aiurda/devcontext)** - ⭐ 42
   DevContext is a cutting-edge Model Context Protocol (MCP) server designed to provide developers with continuous, project-centric context awareness. Unlike traditional context systems, DevContext continuously learns from and adapts to your development patterns and delivers highly relevant context providing a deeper understanding of your codebase.

2018. **[mcp](https://github.com/40ants/mcp)** - ⭐ 42
   40ANTS-MCP is a framework for building Model Context Protocol servers in Common Lisp

2019. **[attio-mcp-server](https://github.com/kesslerio/attio-mcp-server)** - ⭐ 42
   Attio Model Context Protocol (MCP) server implementation

2020. **[MCP-Airflow-API](https://github.com/call518/MCP-Airflow-API)** - ⭐ 42
...
2021. **[ai-humanizer-mcp-server](https://github.com/Text2Go/ai-humanizer-mcp-server)** - ⭐ 42
   A powerful Model Context Protocol (MCP) server that helps refine AI-generated content to sound more natural and human-like. Built with advanced AI detection and text enhancement capabilities.

2022. **[lisply-mcp](https://github.com/gornskew/lisply-mcp)** - ⭐ 42
   Model Context Protocol (MCP) server to manage and talk to compliant "Lisply" lisp-speaking backend services

2023. **[vikunja-mcp](https://github.com/democratize-technology/vikunja-mcp)** - ⭐ 42
   Model Context Protocol server for Vikunja task management. Enables AI assistants to interact with Vikunja instances via MCP.

2024. **[mcp-server](https://github.com/profullstack/mcp-server)** - ⭐ 41
   A generic, modular server for implementing the Model Context Protocol (MCP). 

2025. **[mcp-server-js](https://github.com/yepcode/mcp-server-js)** - ⭐ 41
...
2026. **[godoctor](https://github.com/danicat/godoctor)** - ⭐ 41
   A Model Context Protocol server for Go developers

2027. **[mcp-ai-memory](https://github.com/scanadi/mcp-ai-memory)** - ⭐ 41
   A production-ready Model Context Protocol (MCP) server for semantic memory management

2028. **[any2markdown](https://github.com/WW-AI-Lab/any2markdown)** - ⭐ 41
...
2029. **[caldav-mcp](https://github.com/dominik1001/caldav-mcp)** - ⭐ 41
   A CalDAV client using Model Context Protocol (MCP) to expose calendar operations as tools for AI assistants.

2030. **[dynamic-shell-server](https://github.com/codelion/dynamic-shell-server)** - ⭐ 41
   Dynamic Shell Command MCP Server

2031. **[zig-mcp-server](https://github.com/openSVM/zig-mcp-server)** - ⭐ 41
   A Model Context Protocol (MCP) server that provides Zig language tooling, code analysis, and documentation access. This server enhances AI capabilities with Zig-specific functionality including code optimization, compute unit estimation, code generation, and best practices recommendations.

2032. **[kafka-mcp-server](https://github.com/tuannvm/kafka-mcp-server)** - ⭐ 41
   A Model Context Protocol (MCP) server for Apache Kafka implemented in Go, leveraging franz-go and mcp-go.

2033. **[deploystack](https://github.com/deploystackio/deploystack)** - ⭐ 41
   MCP Management Platform - Centralized credential vault, governance, and token optimization for developers and enterprises.

2034. **[prism-mcp-rs](https://github.com/prismworks-ai/prism-mcp-rs)** - ⭐ 41
   Enterprise-grade Rust implementation of Anthropic's MCP protocol

2035. **[clinicaltrialsgov-mcp-server](https://github.com/cyanheads/clinicaltrialsgov-mcp-server)** - ⭐ 41
...
2039. **[rust-analyzer-mcp](https://github.com/zeenix/rust-analyzer-mcp)** - ⭐ 41
   A Model Context Protocol (MCP) server that provides integration with rust-analyzer

2040. **[salesforce-mcp-server](https://github.com/kablewy/salesforce-mcp-server)** - ⭐ 40
   Model Context Protocol server for Salesforce REST API integration

2041. **[dify-mcp-server](https://github.com/AI-FE/dify-mcp-server)** - ⭐ 40
   A Model Context Protocol server for Dify

2042. **[mcp_rails_template](https://github.com/seuros/mcp_rails_template)** - ⭐ 40
   A minimal Rails API template for creating MCP (Model Context Protocol) servers with robust tool execution capabilities and examples.

2043. **[agentic-mcp-client](https://github.com/peakmojo/agentic-mcp-client)** - ⭐ 40
   A standalone agent runner that executes tasks using MCP (Model Context Protocol) tools via Anthropic Claude, AWS BedRock and OpenAI APIs. It enables AI agents to run autonomously in cloud environments and interact with various systems securely.

2044. **[nmap-mcp-server](https://github.com/PhialsBasement/nmap-mcp-server)** - ⭐ 40
   A Model Context Protocol (MCP) server that enables AI assistants to perform network scanning operations using NMAP

2045. **[contentful-mcp-server](https://github.com/contentful/contentful-mcp-server)** - ⭐ 40
   MCP (Model Context Protocol) server for the Contentful Management API

2046. **[pagerduty-mcp-server](https://github.com/PagerDuty/pagerduty-mcp-server)** - ⭐ 40
   PagerDuty's official local MCP (Model Context Protocol) server which provides tools to interact with your PagerDuty account directly from your MCP-enabled client.

2047. **[repl-mcp](https://github.com/simm-is/repl-mcp)** - ⭐ 40
   Model Context Protocol Clojure support including REPL integration with development tools.

2048. **[instagram-engagement-mcp](https://github.com/Bob-lance/instagram-engagement-mcp)** - ⭐ 40
...
2049. **[dotcom.chat](https://github.com/kamath/dotcom.chat)** - ⭐ 40
   A simple NextJS MCP client with sensible keybindings

2050. **[mailgun-mcp-server](https://github.com/mailgun/mailgun-mcp-server)** - ⭐ 40
   Implementation of Model Context Protocol server for Mailgun APIs

2051. **[browser-use-mcp-client](https://github.com/Linzo99/browser-use-mcp-client)** - ⭐ 40
   A MCP client for browser-use

2052. **[mcp-zenml](https://github.com/zenml-io/mcp-zenml)** - ⭐ 40
   MCP server to connect an MCP client (Cursor, Claude Desktop etc) with your ZenML MLOps and LLMOps pipelines

2053. **[beanquery-mcp](https://github.com/vanto/beanquery-mcp)** - ⭐ 40
...
2054. **[mcp-shell](https://github.com/hdresearch/mcp-shell)** - ⭐ 40
   Execute a secure shell in Claude Desktop using the Model Context Protocol.

2055. **[shotgrid-mcp-server](https://github.com/loonghao/shotgrid-mcp-server)** - ⭐ 40
   A Model Context Protocol (MCP) server for Autodesk ShotGrid/Flow Production Tracking (FPT) with comprehensive CRUD operations and data management capabilities.

2056. **[mcp-toolbox-sdk-go](https://github.com/googleapis/mcp-toolbox-sdk-go)** - ⭐ 40
   Go SDK for interacting with the MCP Toolbox for Databases.

2057. **[mealie-mcp-server](https://github.com/rldiao/mealie-mcp-server)** - ⭐ 40
   MCP server that exposes Mealie APIs to MCP clients such as Claude Desktop

2058. **[godot-mcp](https://github.com/bradypp/godot-mcp)** - ⭐ 40
   A Model Context Protocol (MCP) server for interacting with the Godot game engine.

2059. **[mcp-ssh](https://github.com/AiondaDotCom/mcp-ssh)** - ⭐ 40
   A Model Context Protocol (MCP) server for managing and controlling SSH connections.

2060. **[osm-mcp](https://github.com/wiseman/osm-mcp)** - ⭐ 40
   Model Context Protocol server for OpenStreetMap data

2061. **[mcp-design-system-extractor](https://github.com/freema/mcp-design-system-extractor)** - ⭐ 40
   MCP (Model Context Protocol) server that enables AI assistants to interact with Storybook design systems. Extract component HTML, analyze styles, and help with design system adoption and refactoring.

2062. **[Claude-Deep-Research](https://github.com/mcherukara/Claude-Deep-Research)** - ⭐ 40
   An MCP (Model Context Protocol) server that enables comprehensive research capabilities for Claude

2063. **[MCPollinations](https://github.com/pinkpixel-dev/MCPollinations)** - ⭐ 39
   A Model Context Protocol (MCP) server that enables AI assistants to generate images, text, and audio through the Pollinations APIs. Supports customizable parameters, image saving, and multiple model options.

2064. **[sharepoint-mcp](https://github.com/DEmodoriGatsuO/sharepoint-mcp)** - ⭐ 39
...
2065. **[mcp_code_analyzer](https://github.com/emiryasar/mcp_code_analyzer)** - ⭐ 39
   A Model Context Protocol (MCP) server implementation for comprehensive code analysis. This tool integrates with Claude Desktop to provide code analysis capabilities through natural language interactions.

2066. **[mcp-crypto-price](https://github.com/truss44/mcp-crypto-price)** - ⭐ 39
   A Model Context Protocol (MCP) server that provides real-time cryptocurrency analysis via CoinCap's API. Enables Claude and other MCP clients to fetch crypto prices, analyze market trends, and track historical data.

2067. **[mmcp](https://github.com/koki-develop/mmcp)** - ⭐ 39
   🛠️ Manage your MCP (Model Context Protocol) server definitions in one place and apply them to supported agents.

2068. **[mcp-codestyle-server](https://github.com/itxaiohanglover/mcp-codestyle-server)** - ⭐ 39
...
2069. **[mcp-desktop](https://github.com/http4k/mcp-desktop)** - ⭐ 39
   http4k MCP Desktop Client

2070. **[mcp-client-server-host-demo](https://github.com/danwritecode/mcp-client-server-host-demo)** - ⭐ 39
   A quick pokemon demo to showcase MCP server, client, and host

2071. **[mcp-logic](https://github.com/angrysky56/mcp-logic)** - ⭐ 39
...
2072. **[mcp](https://github.com/kyopark2014/mcp)** - ⭐ 39
   It shows how to use model-context-protocol. 

2073. **[activitywatch-mcp-server](https://github.com/8bitgentleman/activitywatch-mcp-server)** - ⭐ 39
   Model Context Protocol server for ActivityWatch time tracking data

2074. **[openrouter-deep-research-mcp](https://github.com/wheattoast11/openrouter-deep-research-mcp)** - ⭐ 39
...
2075. **[mssql-mcp](https://github.com/daobataotie/mssql-mcp)** - ⭐ 39
   mssql mcp server

2076. **[mcp_ctl](https://github.com/runablehq/mcp_ctl)** - ⭐ 39
   A package manager to manage all your mcp servers across platforms

2077. **[davinci-resolve-mcp](https://github.com/apvlv/davinci-resolve-mcp)** - ⭐ 39
   A Model Context Protocol (MCP) server for interacting with DaVinci Resolve and Fusion

2078. **[algorand-mcp](https://github.com/GoPlausible/algorand-mcp)** - ⭐ 39
   Algorand Model Context Protocol (Server & Client)

2079. **[luma-mcp](https://github.com/JochenYang/luma-mcp)** - ⭐ 39
...
2080. **[autoteam](https://github.com/diazoxide/autoteam)** - ⭐ 38
   Orchestrate AI agents with YAML-driven workflows via universal Model Context Protocol (MCP)

2081. **[middy-mcp](https://github.com/fredericbarthelet/middy-mcp)** - ⭐ 38
   Middy middleware for Model Context Protocol server hosting on AWS Lambda

2082. **[dev-to-mcp](https://github.com/nickytonline/dev-to-mcp)** - ⭐ 38
   A remote Model Context Protocol (MCP) server for interacting with the dev.to public API without requiring authentication.

2083. **[How-To-Create-MCP-Server](https://github.com/nisalgunawardhana/How-To-Create-MCP-Server)** - ⭐ 38
   This guide will help you set up a basic MCP (Model Context Protocol) server in .NET, configure it in VS Code, and interact with it using Copilot Chat.

2084. **[mcp-center](https://github.com/nautilus-ops/mcp-center)** - ⭐ 38
   A centralized platform for managing and connecting MCP servers. MCP Center provides a high-performance proxy service that enables seamless communication between MCP clients and multiple MCP servers.

2085. **[anki-mcp](https://github.com/nietus/anki-mcp)** - ⭐ 38
   MCP server for anki

2086. **[McpDotNet.Extensions.SemanticKernel](https://github.com/StefH/McpDotNet.Extensions.SemanticKernel)** - ⭐ 38
   Microsoft SemanticKernel integration for the Model Context Protocol (MCP). Enables seamless use of MCP tools as AI functions.

2087. **[okta-mcp-server](https://github.com/fctr-id/okta-mcp-server)** - ⭐ 38
   The Okta MCP Server is a groundbreaking tool built by the team at Fctr that enables AI models to interact directly with your Okta environment using the Model Context Protocol (MCP). Built specifically for IAM engineers, security teams, and Okta administrators, it implements the MCP specification to help work with Okta enitities

2088. **[grafana-mcp-analyzer](https://github.com/SailingCoder/grafana-mcp-analyzer)** - ⭐ 38
   让AI助手直接分析你的Grafana监控数据 - A Model Context Protocol server for Grafana data analysis

2089. **[xc-mcp](https://github.com/conorluddy/xc-mcp)** - ⭐ 38
...
2090. **[bsky-mcp-server](https://github.com/brianellin/bsky-mcp-server)** - ⭐ 38
   Bluesky MCP (Model Context Protocol) Server

2091. **[mcp-konnect](https://github.com/Kong/mcp-konnect)** - ⭐ 37
   A Model Context Protocol (MCP) server for interacting with Kong Konnect APIs, allowing AI assistants to query and analyze Kong Gateway configurations, traffic, and analytics.

2092. **[mcp-client-example](https://github.com/artemnovichkov/mcp-client-example)** - ⭐ 37
   Learn how to implement MCP client with SwiftUI and Anthropic API

2093. **[offeryn](https://github.com/avahowell/offeryn)** - ⭐ 37
   Build tools for LLMs in Rust using Model Context Protocol

2094. **[MCPToolBenchPP](https://github.com/mcp-tool-bench/MCPToolBenchPP)** - ⭐ 37
   MCPToolBench++ MCP Model Context Protocol Tool Use Benchmark on AI Agent and Model Tool Use Ability

2095. **[youtrack-mcp](https://github.com/itsalfredakku/youtrack-mcp)** - ⭐ 37
   An MCP (Model Context Protocol) server that provides YouTrack REST API access to AI agents

2096. **[ContextPods](https://github.com/conorluddy/ContextPods)** - ⭐ 37
   Model Context Protocol management suite/factory. An MCP that can generate and manage other local MCPs in multiple languages. Uses the official SDKs for code gen.

2097. **[mcp-sitecore-server](https://github.com/Antonytm/mcp-sitecore-server)** - ⭐ 37
   Model Context Protocol server for Sitecore

2098. **[shodan-mcp-server](https://github.com/Cyreslab-AI/shodan-mcp-server)** - ⭐ 37
   A Model Context Protocol server that provides access to Shodan API functionality

2099. **[solscan-mcp](https://github.com/wowinter13/solscan-mcp)** - ⭐ 37
   An MCP server for querying Solana transactions using natural language with Solscan API

2100. **[mcp-android-server-python](https://github.com/nim444/mcp-android-server-python)** - ⭐ 37
   MCP Android agent - This project provides an *MCP (Model Context Protocol)* server for automating Android devices using uiautomator2. It's designed to be easily plugged into AI agents like GitHub Copilot Chat, Claude, or Open Interpreter to control Android devices through natural language.

2101. **[RedBook-Search-Comment-MCP](https://github.com/chenningling/RedBook-Search-Comment-MCP)** - ⭐ 37
   这是一款基于 Playwright 开发的小红书自动搜索和评论工具，作为 MCP Server，可通过特定配置接入 MCP Client，帮助用户自动完成登录小红书、搜索关键词、获取笔记内容及发布智能评论等操作。

2102. **[DeepCo](https://github.com/succlz123/DeepCo)** - ⭐ 37
   A Chat Client for LLMs, written in Compose Multiplatform.

2103. **[binance-mcp-server](https://github.com/AnalyticAce/binance-mcp-server)** - ⭐ 37
...
2104. **[matlab-mcp](https://github.com/Tsuchijo/matlab-mcp)** - ⭐ 37
   Model Context Protocol server to let LLMs write and execute matlab scripts 

2105. **[mcp_weather_server](https://github.com/isdaniel/mcp_weather_server)** - ⭐ 37
   A Model Context Protocol (MCP) server that provides weather information using the Open-Meteo API.

2106. **[nuclei-mcp](https://github.com/addcontent/nuclei-mcp)** - ⭐ 37
...
2107. **[open-ghl-mcp](https://github.com/basicmachines-co/open-ghl-mcp)** - ⭐ 37
   An open source Model Context Protocol server for GoHighLevel API v2 with OAuth

2108. **[mcp-summarization-functions](https://github.com/Braffolk/mcp-summarization-functions)** - ⭐ 37
   Provides summarised output from various actions that could otherwise eat up tokens and cause crashes for AI agents 

2109. **[HAL](https://github.com/DeanWard/HAL)** - ⭐ 37
   HAL (HTTP API Layer) is a Model Context Protocol (MCP) server that provides HTTP API capabilities to Large Language Models.

2110. **[mcp-server-ios-simulator](https://github.com/atom2ueki/mcp-server-ios-simulator)** - ⭐ 37
   Model Context Protocol (MCP) implementation for iOS simulators

2111. **[illustrator-mcp-server](https://github.com/spencerhhubert/illustrator-mcp-server)** - ⭐ 37
   mcp server to run scripts on adobe illustrator

2112. **[altium-mcp](https://github.com/coffeenmusic/altium-mcp)** - ⭐ 37
   Altium Model Context Protocol server and Altium API script

2113. **[mcp-pyautogui-server](https://github.com/hetaoBackend/mcp-pyautogui-server)** - ⭐ 37
   A MCP (Model Context Protocol) server that provides automated GUI testing and control capabilities through PyAutoGUI.

2114. **[mcp-tasks](https://github.com/flesler/mcp-tasks)** - ⭐ 37
   A comprehensive and efficient MCP server for task management with multi-format support (Markdown, JSON, YAML)

2115. **[webscraping-ai-mcp-server](https://github.com/webscraping-ai/webscraping-ai-mcp-server)** - ⭐ 37
    A Model Context Protocol (MCP) server implementation that integrates with WebScraping.AI for web data extraction capabilities.

2116. **[smythos-studio](https://github.com/SmythOS/smythos-studio)** - ⭐ 37
...
2117. **[mcp-server-leetcode](https://github.com/doggybee/mcp-server-leetcode)** - ⭐ 36
...
2118. **[openai-mcp](https://github.com/arthurcolle/openai-mcp)** - ⭐ 36
   OpenAI Code Assistant Model Context Protocol (MCP) Server

2119. **[mcp-flight-search](https://github.com/arjunprabhulal/mcp-flight-search)** - ⭐ 36
   MCP Server implementation for the Model Context Protocol (MCP) enabling AI tool usage - Realtime Flight Search 

2120. **[mcp-go](https://github.com/riza-io/mcp-go)** - ⭐ 36
   Build Model Context Protocol (MCP) servers in Go

2121. **[Mcp.Net](https://github.com/SamFold/Mcp.Net)** - ⭐ 36
   A fully featured C# implementation of Anthropic's Model Context Protocol (MCP)

2122. **[baseline-mcp-server](https://github.com/yamanoku/baseline-mcp-server)** - ⭐ 36
   特定のWeb APIに関するBaselineの状況を提供するModel Context Protocolサーバー

2123. **[example-mcp-server](https://github.com/kirill-markin/example-mcp-server)** - ⭐ 36
   A ready-to-use MCP (Model Context Protocol) server template for extending Cursor IDE with custom tools. Deploy your own server to Heroku with one click, create custom commands, and enhance your Cursor IDE experience. Perfect for developers who want to add their own tools and commands to Cursor IDE without complex setup.

2124. **[mcp-governance-sdk](https://github.com/ithena-one/mcp-governance-sdk)** - ⭐ 36
   Enterprise Governance Layer (Identity, RBAC, Credentials, Auditing, Logging, Tracing) for the Model Context Protocol SDK

2125. **[mcpmc](https://github.com/gerred/mcpmc)** - ⭐ 36
   Model Context Protocol Minecraft Server

2126. **[OmniMind](https://github.com/Techiral/OmniMind)** - ⭐ 36
...
2127. **[fast-filesystem-mcp](https://github.com/efforthye/fast-filesystem-mcp)** - ⭐ 36
   A high-performance Model Context Protocol (MCP) server that provides secure filesystem access for Claude and other AI assistants.

2128. **[flutter-mcp-ai-chat](https://github.com/leehack/flutter-mcp-ai-chat)** - ⭐ 36
   Demonstrate how to implement MCP Client in Flutter application with AI.

2129. **[FastDomainCheck-MCP-Server](https://github.com/bingal/FastDomainCheck-MCP-Server)** - ⭐ 36
   A Model Context Protocol for checking domain name registration status in bulk.

2130. **[mcp-debug](https://github.com/giantswarm/mcp-debug)** - ⭐ 36

2131. **[mlb-api-mcp](https://github.com/guillochon/mlb-api-mcp)** - ⭐ 36
...
2132. **[code-mcp](https://github.com/54yyyu/code-mcp)** - ⭐ 36
...
2133. **[codebadger](https://github.com/Lekssays/codebadger)** - ⭐ 36
...
2134. **[mcp-anywhere](https://github.com/locomotive-agency/mcp-anywhere)** - ⭐ 36
...
2135. **[dexpaprika-mcp](https://github.com/coinpaprika/dexpaprika-mcp)** - ⭐ 36
...
2136. **[esa-mcp-server](https://github.com/d-kimuson/esa-mcp-server)** - ⭐ 35
   esa の Model Context Protocol サーバー実装

2137. **[mcp-langchain-ts-client](https://github.com/isaacwasserman/mcp-langchain-ts-client)** - ⭐ 35
   LangChain.js client for Model Context Protocol.

2138. **[mcp-local-rag](https://github.com/shinpr/mcp-local-rag)** - ⭐ 35
   Privacy-first local RAG server for Cursor, Claude Code, and more — powered by the Model Context Protocol.

2139. **[linkedin-mcp-server](https://github.com/Dishant27/linkedin-mcp-server)** - ⭐ 35
   Model Context Protocol (MCP) server for LinkedIn API integration

2140. **[mcp-gateway](https://github.com/theognis1002/mcp-gateway)** - ⭐ 35
...
2141. **[mcp-toolkit](https://github.com/metosin/mcp-toolkit)** - ⭐ 35
   a lib to build MCP clients and MCP servers in Clojure(script)

2142. **[tomtom-mcp](https://github.com/tomtom-international/tomtom-mcp)** - ⭐ 35
   A Model Context Protocol (MCP) server providing TomTom's location services, search, routing, and traffic data to AI agents.

2143. **[lunchmoney-mcp](https://github.com/akutishevsky/lunchmoney-mcp)** - ⭐ 35
...
2144. **[mcp-mistral-ocr](https://github.com/everaldo/mcp-mistral-ocr)** - ⭐ 35
   Model Context Protocol (MCP) Server for Mistral OCR API

2145. **[keycloak-model-context-protocol](https://github.com/ChristophEnglisch/keycloak-model-context-protocol)** - ⭐ 35
...
2146. **[codebase-mcp](https://github.com/danyQe/codebase-mcp)** - ⭐ 35
...
2147. **[imap-mcp](https://github.com/non-dirty/imap-mcp)** - ⭐ 35
   IMAP Model Context Protocol server for interactive email processing

2148. **[MCPNotes](https://github.com/9Ninety/MCPNotes)** - ⭐ 35
   A simple note-taking MCP server for recording and managing notes with AI models.

2149. **[ai-vision-mcp](https://github.com/tan-yong-sheng/ai-vision-mcp)** - ⭐ 35
   A Model Context Protocol (MCP) server that provides vision capabilities to analyze image and video

2150. **[agent-mcp-gateway](https://github.com/roddutra/agent-mcp-gateway)** - ⭐ 35
...
2151. **[MCP-Server-Creator](https://github.com/GongRzhe/MCP-Server-Creator)** - ⭐ 35
...
2152. **[mcp-bundle](https://github.com/symfony/mcp-bundle)** - ⭐ 35
   Symfony integration bundle for Model Context Protocol (via official mcp/sdk)

2153. **[mcp-gemini-server](https://github.com/bsmi021/mcp-gemini-server)** - ⭐ 35
   This project provides a dedicated MCP (Model Context Protocol) server that wraps the @google/genai SDK. It exposes Google's Gemini model capabilities as standard MCP tools, allowing other LLMs (like Cline) or MCP-compatible systems to leverage Gemini's features as a backend workhorse.

2154. **[langfuse-mcp](https://github.com/avivsinai/langfuse-mcp)** - ⭐ 35
   A Model Context Protocol (MCP) server for Langfuse, enabling AI agents to query Langfuse trace data for enhanced debugging and observability

2155. **[mcp-file-context-server](https://github.com/bsmi021/mcp-file-context-server)** - ⭐ 34
   A Model Context Protocol (MCP) server that provides file system context to Large Language Models (LLMs). This server enables LLMs to read, search, and analyze code files with advanced caching and real-time file watching capabilities.

2156. **[mcp-security-inspector](https://github.com/purpleroc/mcp-security-inspector)** - ⭐ 34
   一个用于检测Model Context Protocol (MCP)安全性的Chrome扩展工具。

2157. **[mcp-client-auth](https://github.com/dzhng/mcp-client-auth)** - ⭐ 34
...
2158. **[salesforce-mcp-server](https://github.com/jaworjar95/salesforce-mcp-server)** - ⭐ 34
   A comprehensive Model Context Protocol (MCP) server that provides seamless Salesforce integration for AI development tools like Claude Desktop, Cline, and other MCP-compatible clients.

2159. **[coin_api_mcp](https://github.com/longmans/coin_api_mcp)** - ⭐ 34
   A Model Context Protocol server that provides access to CoinMarketCap's cryptocurrency data. This server enables AI-powered applications to retrieve cryptocurrency listings, quotes, and detailed information about various coins.

2160. **[mcp-accessibility-scanner](https://github.com/JustasMonkev/mcp-accessibility-scanner)** - ⭐ 34
   An MCP (Model Context Protocol) server for performing accessibility audits on webpages using axe-core.

2161. **[Readwise-Reader-MCP](https://github.com/edricgsh/Readwise-Reader-MCP)** - ⭐ 34
   A Model Context Protocol (MCP) server for the Readwise Reader API, built with TypeScript and the official Claude SDK.

2162. **[MCPSwiftWrapper](https://github.com/jamesrochabrun/MCPSwiftWrapper)** - ⭐ 34
   A light wrapper around mcp-swift-sdk for easy usage of MCP clients in Swift

2163. **[metabase-mcp](https://github.com/jerichosequitin/metabase-mcp)** - ⭐ 34
...
2164. **[mcp-front](https://github.com/stainless-api/mcp-front)** - ⭐ 34
   Auth proxy for Model Context Protocol servers - adds authentication to MCP tools for Claude.ai, Claude Code, Cursor, Gemini

2165. **[chat-nextjs-mcp-client](https://github.com/shricodev/chat-nextjs-mcp-client)** - ⭐ 34
   ⚡ Chat MCP Client for Remote hosted MCP Servers (with Composio) and locally hosted MCP servers. 📡

2166. **[RiMCP_hybrid](https://github.com/h7lu/RiMCP_hybrid)** - ⭐ 34
   Rimworld Coding RAG MCP server

2167. **[Scientific-Papers-MCP](https://github.com/benedict2310/Scientific-Papers-MCP)** - ⭐ 34
...
2168. **[mcp-starter](https://github.com/instructa/mcp-starter)** - ⭐ 34
   A super simple Starter to build your own MCP Server

2169. **[FastAPI-BitNet](https://github.com/grctest/FastAPI-BitNet)** - ⭐ 34
   Running Microsoft's BitNet inference framework via FastAPI, Uvicorn and Docker.

2170. **[MayaMCP](https://github.com/PatrickPalmer/MayaMCP)** - ⭐ 34
   Model Context Protocol (MCP) server implementation for Autodesk Maya

2171. **[linkedin-mcpserver](https://github.com/felipfr/linkedin-mcpserver)** - ⭐ 34
   A powerful Model Context Protocol server for LinkedIn API integration

2172. **[mcp-server-opendal](https://github.com/Xuanwo/mcp-server-opendal)** - ⭐ 34
   Model Context Protocol Server for Apache OpenDAL™

2173. **[meta-prompt-mcp-server](https://github.com/tisu19021997/meta-prompt-mcp-server)** - ⭐ 34
   Turn any MCP Client into a "multi-agent" system (via prompting)

2174. **[discourse-mcp](https://github.com/discourse/discourse-mcp)** - ⭐ 34
   MCP client for Discourse sites

2175. **[dynamic-fastmcp](https://github.com/ragieai/dynamic-fastmcp)** - ⭐ 34
...
2176. **[adk-python-mcp-client](https://github.com/arjunprabhulal/adk-python-mcp-client)** - ⭐ 33
   Demo of ADK (Agent Development Kit) as an MCP (Model Context Protocol) client for flight search capabilities.

2177. **[mcp-scala](https://github.com/windymelt/mcp-scala)** - ⭐ 33
   Model Context Protocol server written in Scala

2178. **[prometheus_mcp_server](https://github.com/CaesarYangs/prometheus_mcp_server)** - ⭐ 33
...
2179. **[mcp-google-calendar](https://github.com/markelaugust74/mcp-google-calendar)** - ⭐ 33
...
2180. **[aio-mcp](https://github.com/athapong/aio-mcp)** - ⭐ 33
...
2181. **[mcp-prompt-server-go](https://github.com/smallnest/mcp-prompt-server-go)** - ⭐ 33
...
2182. **[jina-mcp-tools](https://github.com/PsychArch/jina-mcp-tools)** - ⭐ 33
   A Model Context Protocol (MCP) server that integrates with Jina AI Search Foundation APIs.

2183. **[a11y-mcp](https://github.com/priyankark/a11y-mcp)** - ⭐ 33
   An MCP (Model Context Protocol) server for performing accessibility audits on webpages using axe-core. Use the results in an agentic loop with your favorite AI assistants (Amp/Cline/Cursor/GH Copilot) and let them fix a11y issues for you!

2184. **[mcp-registry](https://github.com/ARadRareness/mcp-registry)** - ⭐ 33
   A central registry and HTTP interface for coordinating Model Context Protocol (MCP) servers.

2185. **[llm-tools-mcp](https://github.com/VirtusLab/llm-tools-mcp)** - ⭐ 33
   Connect to MCP servers right from your shell. Plugin for simonw/llm.

2186. **[Outlook_Calendar_MCP](https://github.com/merajmehrabi/Outlook_Calendar_MCP)** - ⭐ 33
   A Model Context Protocol (MCP) server that allows Claude to access and manage your local Microsfot Outlook calendar (Windows only).

2187. **[mcp-databricks-server](https://github.com/RafaelCartenet/mcp-databricks-server)** - ⭐ 33
...
2188. **[teams-mcp](https://github.com/floriscornel/teams-mcp)** - ⭐ 33
...
2189. **[mcp-server-text-editor](https://github.com/bhouston/mcp-server-text-editor)** - ⭐ 33
   An open source implementation of the Claude built-in text editor tool

2190. **[claude-code-mcp](https://github.com/KunihiroS/claude-code-mcp)** - ⭐ 33
   MCP Server connects with claude code local command.

2191. **[postman-mcp](https://github.com/SalehKhatri/postman-mcp)** - ⭐ 33
...
2192. **[macOS-Notification-MCP](https://github.com/devizor/macOS-Notification-MCP)** - ⭐ 33
...
2198. **[azure-functions-mcp-extension](https://github.com/Azure/azure-functions-mcp-extension)** - ⭐ 32
   Model Context Protocol extension for Azure Functions.

2199. **[mentor-mcp-server](https://github.com/cyanheads/mentor-mcp-server)** - ⭐ 32
...
2200. **[mcp-api-gateway](https://github.com/rflpazini/mcp-api-gateway)** - ⭐ 32
   A universal MCP (Model Context Protocol) server to integrate any API with Claude Desktop using only Docker configurations.

2201. **[laravel-mcp-client](https://github.com/scriptoshi/laravel-mcp-client)** - ⭐ 32

2202. **[crawl-mcp](https://github.com/wutongci/crawl-mcp)** - ⭐ 32
   完整的微信文章抓取MCP服务器 - 基于Model Context Protocol (MCP)的智能网页抓取工具，专为Cursor IDE和AI工具设计。

2203. **[mcp-domain-availability](https://github.com/imprvhub/mcp-domain-availability)** - ⭐ 32
   A Model Context Protocol (MCP) server that enables Claude Desktop to check domain availability across 50+ TLDs. Features DNS/WHOIS verification, bulk checking, and smart suggestions. Zero-clone installation via uvx.

2204. **[claude-mcp](https://github.com/cnych/claude-mcp)** - ⭐ 32
   Claude Unified Model Context Interaction Protocol

2205. **[fantasy-football-mcp-public](https://github.com/derekrbreese/fantasy-football-mcp-public)** - ⭐ 32
...
2206. **[mcp-wikidata](https://github.com/zzaebok/mcp-wikidata)** - ⭐ 32
   A server implementation for Wikidata API using the Model Context Protocol (MCP).

2207. **[pentestMCP](https://github.com/ramkansal/pentestMCP)** - ⭐ 32
   pentestMCP: AI-Powered Penetration Testing via MCP, an MCP designed for penetration testers.

2208. **[p4mcp-server](https://github.com/perforce/p4mcp-server)** - ⭐ 32
...
2209. **[PixVerse-MCP](https://github.com/PixVerseAI/PixVerse-MCP)** - ⭐ 31
   Official PixVerse Model Context Protocol (MCP) server that enables interaction with powerful AI video generation APIs.

2210. **[mcp-server-weibo](https://github.com/Selenium39/mcp-server-weibo)** - ⭐ 31
   Model Context Protocol服务器，用于抓取微博用户信息、动态和搜索功能

2211. **[MCPDocSearch](https://github.com/alizdavoodi/MCPDocSearch)** - ⭐ 31
...
2212. **[simple-psql-mcp](https://github.com/NetanelBollag/simple-psql-mcp)** - ⭐ 31
...
2213. **[storyblok-mcp-server](https://github.com/Kiran1689/storyblok-mcp-server)** - ⭐ 31
...
2214. **[sunnysideFigma-Context-MCP](https://github.com/tercumantanumut/sunnysideFigma-Context-MCP)** - ⭐ 31
...
2215. **[MCPCorpus](https://github.com/Snakinya/MCPCorpus)** - ⭐ 31
...
2216. **[seatunnel-mcp](https://github.com/ocean-zhc/seatunnel-mcp)** - ⭐ 31
...
2217. **[lets-learn-mcp-java](https://github.com/microsoft/lets-learn-mcp-java)** - ⭐ 31
   Learn how to build Java-based MCP Servers and Clients with LangChain4J and Quarkus

2218. **[mcp-browser-agent](https://github.com/imprvhub/mcp-browser-agent)** - ⭐ 31
   A Model Context Protocol (MCP) integration that provides Claude Desktop with autonomous browser automation capabilities. This agent enables Claude to interact with web content, manipulate DOM elements, execute JavaScript, and perform API requests.

2219. **[mcp-server-lib.el](https://github.com/laurynas-biveinis/mcp-server-lib.el)** - ⭐ 31
   Emacs Lisp implementation of the Model Context Protocol

2220. **[azure-container-apps-ai-mcp](https://github.com/Azure-Samples/azure-container-apps-ai-mcp)** - ⭐ 31
...
2221. **[mcp-weather](https://github.com/TimLukaHorstmann/mcp-weather)** - ⭐ 31
   A Model Context Protocol (MCP) server that provides hourly and daily weather forecasts using the AccuWeather API.

2222. **[mcp_server](https://github.com/peppemas/mcp_server)** - ⭐ 31
   A C++ implementation of a Model Context Protocol Server with a pluggable module architecture.

2223. **[mcp-google-cse](https://github.com/Richard-Weiss/mcp-google-cse)** - ⭐ 31
   A Model Context Protocol server that provides search capabilities using a Google CSE (custom search engine).

2224. **[openbim-mcp](https://github.com/helenkwok/openbim-mcp)** - ⭐ 31
   Model Context Protocol (MCP) server for openBIM

2225. **[org-mcp](https://github.com/laurynas-biveinis/org-mcp)** - ⭐ 31
   Emacs Org-mode integration with Model Context Protocol (MCP) for AI-assisted task management

2226. **[PubChem-MCP-Server](https://github.com/Augmented-Nature/PubChem-MCP-Server)** - ⭐ 31
   A comprehensive Model Context Protocol (MCP) server for accessing the PubChem chemical database. This server provides access to over 110 million chemical compounds with extensive molecular properties, bioassay data, and chemical informatics tools.

2227. **[mcpc](https://github.com/OlaHulleberg/mcpc)** - ⭐ 31
...
2228. **[evernote-mcp-server](https://github.com/brentmid/evernote-mcp-server)** - ⭐ 31
   Evernote MCP server - allows LLMs that support MCP (like Claude Desktop) to query your notes in Evernote

2229. **[thoughtbox](https://github.com/Kastalien-Research/thoughtbox)** - ⭐ 31
...
2230. **[nostr-mcp-server](https://github.com/AustinKelsay/nostr-mcp-server)** - ⭐ 31
   A Model Context Protocol (MCP) server that provides Nostr capabilities to AI agents

2231. **[supermcp](https://github.com/dhanababum/supermcp)** - ⭐ 31
...
2232. **[mcp-wasm](https://github.com/beekmarks/mcp-wasm)** - ⭐ 31
   A proof-of-concept implementation of a Model Context Protocol (MCP) server that runs in WebAssembly (WASM) within a web browser. This project demonstrates the integration of MCP tools and resources in a browser environment.

2233. **[React-Native-MCP](https://github.com/MrNitro360/React-Native-MCP)** - ⭐ 31
...
2234. **[mcp-aoai-web-browsing](https://github.com/kimtth/mcp-aoai-web-browsing)** - ⭐ 30
   A minimal Model Context Protocol 🖥️ server/client🧑‍💻with Azure OpenAI and 🌐 web browser control via Playwright.

2235. **[pan-mcp-relay](https://github.com/PaloAltoNetworks/pan-mcp-relay)** - ⭐ 30
   Palo Alto Networks AI Runtime Security Model Context Protocol (MCP) Relay Server

2236. **[chatwork-mcp-server](https://github.com/chatwork/chatwork-mcp-server)** - ⭐ 30
   ChatworkをAIから操作するためのMCP(Model Context Protocol)サーバー

2237. **[dev-kit](https://github.com/nguyenvanduocit/dev-kit)** - ⭐ 30
   [Model Context Protocol] Dev Kit - anything a developer need for him day to day works

2238. **[authenticator_mcp](https://github.com/firstorderai/authenticator_mcp)** - ⭐ 30
   A secure MCP (Model Context Protocol) server that enables AI agents to interact with the Authenticator App.

2239. **[Smart-Thinking](https://github.com/Leghis/Smart-Thinking)** - ⭐ 30
   Smart-Thinking is a Model Context Protocol (MCP) server that delivers graph-based, multi-step reasoning without relying on external AI APIs. Everything happens locally: similarity search, heuristic-based scoring, verification tracking, memory, and visualization all run in a deterministic pipeline designed for transparency and reproducibility.

2240. **[midi-mcp-server](https://github.com/tubone24/midi-mcp-server)** - ⭐ 30
...
2241. **[EU_AI_ACT_MCP](https://github.com/SonnyLabs/EU_AI_ACT_MCP)** - ⭐ 30
   EU AI Act MCP (Model Context Protocol) that connects to your AI agents, helping you to comply with the EU AI Act.

2242. **[AlphaFold-MCP-Server](https://github.com/Augmented-Nature/AlphaFold-MCP-Server)** - ⭐ 30
   A comprehensive Model Context Protocol (MCP) server that provides access to the AlphaFold Protein Structure Database through a rich set of tools and resources for protein structure prediction analysis.

2243. **[hana-mcp-server](https://github.com/HatriGt/hana-mcp-server)** - ⭐ 30
   Model Context Server Protocol for your HANA DB

2244. **[clap-mcp](https://github.com/gakonst/clap-mcp)** - ⭐ 30
   A Rust framework that bridges clap command-line applications with the Model Context Protocol (MCP)

2245. **[PRD-MCP-Server](https://github.com/Saml1211/PRD-MCP-Server)** - ⭐ 30
   Flagship Model Context Protocol server for generating Product Requirement Documents (PRDs) from codebase context.

2246. **[demo-mcp-server-client-implementation](https://github.com/mschwarzmueller/demo-mcp-server-client-implementation)** - ⭐ 30
   A demo implementation of a MCP server (consuming a dummy API) and basic client.

2247. **[awesome-devops-mcp](https://github.com/agenticdevops/awesome-devops-mcp)** - ⭐ 30
   List of Awesome MCP Servers and Clients for building Agentic Devops 

2248. **[zerodha-mcp](https://github.com/mtwn105/zerodha-mcp)** - ⭐ 30
   Zerodha MCP Server & Client - AI Agent (w/Agno & w/Google ADK)

2249. **[mcp-ollama](https://github.com/emgeee/mcp-ollama)** - ⭐ 30
   Query model running with Ollama from within Claude Desktop or other MCP clients

2250. **[mcp-client](https://github.com/edanyal/mcp-client)** - ⭐ 30
   Typescript mcp client library.

2251. **[postmancer](https://github.com/hijaz/postmancer)** - ⭐ 30
   An experimental MCP server Rest Client intended to be a replacement of tools postman & insomnia

2252. **[apisix-mcp](https://github.com/api7/apisix-mcp)** - ⭐ 30
   APISIX Model Context Protocol (MCP) server is used to bridge large language models (LLMs) with the APISIX Admin API.

2253. **[polymarket-mcp](https://github.com/ozgureyilmaz/polymarket-mcp)** - ⭐ 30
...
2254. **[awesome-blockchain-mcps](https://github.com/royyannick/awesome-blockchain-mcps)** - ⭐ 30
...
2255. **[mcp-inception](https://github.com/tanevanwifferen/mcp-inception)** - ⭐ 30
   Call another MCP client from your MCP client. Offload context windows, delegate tasks, split between models

2256. **[reaper-reapy-mcp](https://github.com/wegitor/reaper-reapy-mcp)** - ⭐ 30
...
2257. **[n8n-mcp](https://github.com/vredrick/n8n-mcp)** - ⭐ 30
   n8n MCP Server - Documentation and tools for n8n nodes via Model Context Protocol with SSE support

2258. **[mcp-java-sdk-examples](https://github.com/thought2code/mcp-java-sdk-examples)** - ⭐ 30
   A collection of MCP server examples developed by various Java SDKs

2259. **[mcp-cyclops](https://github.com/cyclops-ui/mcp-cyclops)** - ⭐ 30
   Model Context Protocol server for Cyclops

2260. **[mcp-tool-filter](https://github.com/Portkey-AI/mcp-tool-filter)** - ⭐ 30
...
2261. **[mermaid-mcp](https://github.com/Narasimhaponnada/mermaid-mcp)** - ⭐ 30

2262. **[filesystem-mcp-server](https://github.com/cyanheads/filesystem-mcp-server)** - ⭐ 30
   A Model Context Protocol (MCP) server for platform-agnostic file capabilities, including advanced search/replace and directory tree traversal

2263. **[twenty-crm-mcp-server](https://github.com/mhenry3164/twenty-crm-mcp-server)** - ⭐ 30
...
2264. **[SUMO-MCP-Server](https://github.com/XRDS76354/SUMO-MCP-Server)** - ⭐ 30
...
2265. **[mcp-zap-server](https://github.com/dtkmn/mcp-zap-server)** - ⭐ 30
   A Spring Boot application exposing OWASP ZAP as an MCP (Model Context Protocol) server. It lets any MCP‑compatible AI agent (e.g., Claude Desktop, Cursor) orchestrate ZAP actions—spider, active scan, import OpenAPI specs, and generate reports.

2266. **[dap_mcp](https://github.com/KashunCheng/dap_mcp)** - ⭐ 30
   Model Context Protocol (MCP) server that interacts with a Debugger

2267. **[mcp-googletasks](https://github.com/arpitbatra123/mcp-googletasks)** - ⭐ 30
...
2268. **[reaper-mcp](https://github.com/itsuzef/reaper-mcp)** - ⭐ 30
   A comprehensive Model Context Protocol (MCP) server that enables AI agents to create fully mixed and mastered tracks in REAPER with both MIDI and audio capabilities.

2269. **[univer-mcp](https://github.com/dream-num/univer-mcp)** - ⭐ 30
   AI-powered spreadsheet automation through Model Context Protocol (MCP) server for Univer

2270. **[mcp-server-tauri](https://github.com/hypothesi/mcp-server-tauri)** - ⭐ 29
   A Model Context Protocol (MCP) server and plugin for Tauri v2 development

2271. **[mcp-hacker-news](https://github.com/paabloLC/mcp-hacker-news)** - ⭐ 29
...
2272. **[MCP-Server-Starter](https://github.com/TheSethRose/MCP-Server-Starter)** - ⭐ 29
   A Model Context Protocol server starter template

2273. **[mcp-server-dumplingai](https://github.com/DumplingAI/mcp-server-dumplingai)** - ⭐ 29
   MCP (Model Context Protocol) server for Dumpling AI

2274. **[mcp-badges](https://github.com/mcpx-dev/mcp-badges)** - ⭐ 29
   Get your projects MCP (Model Context Protocol)  badges

2275. **[mcp-appium-gestures](https://github.com/AppiumTestDistribution/mcp-appium-gestures)** - ⭐ 29
   This is a Model Context Protocol (MCP) server providing resources and tools for Appium mobile gestures using Actions API..

2276. **[mcp-attr](https://github.com/frozenlib/mcp-attr)** - ⭐ 29
   A library for declaratively building Model Context Protocol servers.

2277. **[rails-pg-extras-mcp](https://github.com/pawurb/rails-pg-extras-mcp)** - ⭐ 29
   MCP (Model Context Protocol) LLM interface for rails-pg-extras gem

2278. **[maven-mcp-server](https://github.com/Bigsy/maven-mcp-server)** - ⭐ 29
   An MCP (Model Context Protocol) server that provides tools for checking Maven dependency versions.

2279. **[browserai-mcp](https://github.com/brightdata/browserai-mcp)** - ⭐ 29
   A powerful Model Context Protocol (MCP) server that provides an access to serverless browser for AI agents and apps

2280. **[mcp-sync](https://github.com/ztripez/mcp-sync)** - ⭐ 29
   Sync MCP (Model Context Protocol) configurations across AI tools

2281. **[nvim-mcp](https://github.com/linw1995/nvim-mcp)** - ⭐ 29
...
2282. **[luke-desktop](https://github.com/DrJonBrock/luke-desktop)** - ⭐ 29
   A modern desktop client for Claude AI with MCP server support, built with Tauri, React, and TypeScript.

2283. **[xmind-generator-mcp](https://github.com/BangyiZhang/xmind-generator-mcp)** - ⭐ 29
   An MCP (Model Context Protocol) server for generating Xmind mind maps. This server allows LLMs to create structured mind maps through the MCP protocol.

2284. **[phonepi-mcp](https://github.com/priyankark/phonepi-mcp)** - ⭐ 29
...
2285. **[actor-critic-thinking-mcp](https://github.com/aquarius-wing/actor-critic-thinking-mcp)** - ⭐ 29
   A dual-perspective thinking analysis server based on Model Context Protocol (MCP), providing comprehensive performance evaluation through Actor-Critic methodology.

2286. **[cca-mcp-configurator](https://github.com/doggy8088/cca-mcp-configurator)** - ⭐ 29
   一個簡單易用的網頁工具，用於管理 GitHub Copilot 的 MCP (Model Context Protocol) 設定

2287. **[rod-mcp](https://github.com/go-rod/rod-mcp)** - ⭐ 29
   Model Context Protocol Server of Rod

2288. **[NetContextServer](https://github.com/willibrandon/NetContextServer)** - ⭐ 29
   A .NET implementation of the Model Context Protocol enabling AI assistants to explore and understand .NET codebases.

2289. **[openai-mcp-agent-dotnet](https://github.com/Azure-Samples/openai-mcp-agent-dotnet)** - ⭐ 29
   Sample to create an AI Agent using OpenAI models with any MCP server running on Azure Container Apps

2290. **[keynote-mcp](https://github.com/easychen/keynote-mcp)** - ⭐ 29
   A Model Context Protocol (MCP) server that enables AI assistants to control Keynote presentations through AppleScript automation.

2291. **[modao-proto-mcp](https://github.com/modao-dev/modao-proto-mcp)** - ⭐ 29
...
2292. **[mcp-for-security-python](https://github.com/f1tz/mcp-for-security-python)** - ⭐ 29
...
2293. **[searxng-mcp](https://github.com/tisDDM/searxng-mcp)** - ⭐ 29
...
2294. **[mcp-server-weibo](https://github.com/qinyuanpei/mcp-server-weibo)** - ⭐ 29
   基于 Model Context Protocol 的微博数据接口服务器 - 实时获取微博用户信息、动态内容、热搜榜单、粉丝关注数据。支持用户搜索、内容搜索、话题分析，为 AI 应用提供完整的微博数据接入方案。

2295. **[adb-mcp](https://github.com/srmorete/adb-mcp)** - ⭐ 29
   An MCP (Model Context Protocol) server for interacting with Android devices through ADB in TypeScript.

2296. **[dockashell](https://github.com/anzax/dockashell)** - ⭐ 29
...
2297. **[mcp-ssh-manager](https://github.com/bvisible/mcp-ssh-manager)** - ⭐ 29
...
2298. **[MCP-Scanner](https://github.com/knostic/MCP-Scanner)** - ⭐ 29
...
2299. **[sketchfab-mcp-server](https://github.com/gregkop/sketchfab-mcp-server)** - ⭐ 28
   This is an MCP (Model Context Protocol) Server for discovering and downloading 3D models 

2300. **[mcp-testing-framework](https://github.com/L-Qun/mcp-testing-framework)** - ⭐ 28
   Testing framework for Model Context Protocol (MCP)

2301. **[laravel-mcp-sdk](https://github.com/mohamedahmed01/laravel-mcp-sdk)** - ⭐ 28
   Laravel Based Implementation for Model Context Protocol

2302. **[mcp-websocket](https://github.com/virajsharma2000/mcp-websocket)** - ⭐ 28
   This server implements an MCP (Model Context Protocol) server with WebSocket enhancements for real-time data updates.

2303. **[mcp_autogen_sse_stdio](https://github.com/SaM-92/mcp_autogen_sse_stdio)** - ⭐ 28
   This repository demonstrates how to use AutoGen to integrate local and remote MCP (Model Context Protocol) servers. It showcases a local math tool (math_server.py) using Stdio and a remote Apify tool (RAG Web Browser Actor) via SSE for tasks like arithmetic and web browsing.

2304. **[mattermost-mcp-host](https://github.com/jagan-shanmugam/mattermost-mcp-host)** - ⭐ 28
   A Mattermost integration that connects to Model Context Protocol (MCP) servers, leveraging a LangGraph-based Agent.

2305. **[mcp](https://github.com/fastly/mcp)** - ⭐ 28
   Model Context Protocol (MCP) server for AI-powered Fastly CDN management.

2306. **[nchan-mcp-transport](https://github.com/ConechoAI/nchan-mcp-transport)** - ⭐ 28
...
2307. **[TAM-MCP-Server](https://github.com/gvaibhav/TAM-MCP-Server)** - ⭐ 28
...
2308. **[mcp-etherscan-server](https://github.com/crazyrabbitLTC/mcp-etherscan-server)** - ⭐ 28
   An MCP (Model Context Protocol) server that provides Ethereum blockchain data tools via Etherscan's API. Features include checking ETH balances, viewing transaction history, tracking ERC20 transfers, fetching contract ABIs, monitoring gas prices, and resolving ENS names.

2309. **[Volatility-MCP-Server](https://github.com/bornpresident/Volatility-MCP-Server)** - ⭐ 28
   A Model Context Protocol (MCP) server that integrates Volatility 3 memory forensics framework with Claude

2310. **[mcp-tools](https://github.com/clerk/mcp-tools)** - ⭐ 28
   Tools for building modern & secure MCP integrations across the client and server side

2311. **[vsc-mcp](https://github.com/thomasgazzoni/vsc-mcp)** - ⭐ 28
   This project provides tools that expose Language Server Protocol (LSP) functionality as MCP (Model Context Protocol) tools

2312. **[asterisk-mcp-server](https://github.com/winfunc/asterisk-mcp-server)** - ⭐ 28
   Asterisk Model Context Protocol (MCP) server.

2313. **[email-mcp](https://github.com/TimeCyber/email-mcp)** - ⭐ 28
   一个让AI轻松接管邮箱的MCP服务，基于 Model Context Protocol (MCP) 构建，支持在 MCP-X,Claude Desktop 等 MCP 客户端中使用。

2314. **[keycloak-mcp-server](https://github.com/sshaaf/keycloak-mcp-server)** - ⭐ 28
...
2315. **[biothings-mcp](https://github.com/longevity-genie/biothings-mcp)** - ⭐ 28
   MCP (Model Context Protocol) server for biothings

2316. **[notion-mcp](https://github.com/Badhansen/notion-mcp)** - ⭐ 28
   A simple Model Context Protocol (MCP) server that integrates with Notion's API to manage my personal todo list.

2317. **[paraview_mcp](https://github.com/llnl/paraview_mcp)** - ⭐ 28
...
2318. **[firefox-devtools-mcp](https://github.com/freema/firefox-devtools-mcp)** - ⭐ 28
   Model Context Protocol server for Firefox DevTools - enables AI assistants to inspect and control Firefox browser through the Remote Debugging Protocol

2319. **[matrix-mcp-server](https://github.com/mjknowles/matrix-mcp-server)** - ⭐ 28
   MCP Server for a Matrix home server integration; chat, manage rooms, etc.

2320. **[YFinance-Trader-MCP-ClaudeDesktop](https://github.com/SaintDoresh/YFinance-Trader-MCP-ClaudeDesktop)** - ⭐ 28
   An MCP (Model Context Protocol) tool that provides stock market data and trading capabilities using the yfinance library, specifically adapted for Claude Desktop.

2321. **[UnrealMCPBridge](https://github.com/appleweed/UnrealMCPBridge)** - ⭐ 28
   An Unreal Engine plugin that implements an MCP server allowing MCP clients to access the UE Editor Python API.

2322. **[xhs-mcp](https://github.com/Algovate/xhs-mcp)** - ⭐ 28
   用于小红书（xiaohongshu.com）的 Model Context Protocol（MCP）服务器与 CLI 工具，支持登录、发布、搜索、推荐等自动化能力

2323. **[AI-Tracker](https://github.com/twwch/AI-Tracker)** - ⭐ 28
   本仓库旨在整理关于大语言模型（LLM）底层逻辑、**上下文工程 (Context Engineering)** 以及 **Model Context Protocol (MCP)** 协议的核心学习资源与实战路径。

2324. **[mcp-server-fuzzer](https://github.com/Agent-Hellboy/mcp-server-fuzzer)** - ⭐ 28
   A generic mcp server fuzzer

2325. **[Memgpt-MCP-Server](https://github.com/Vic563/Memgpt-MCP-Server)** - ⭐ 27
   A Model Context Protocol (MCP) server that provides persistent memory and multi-model LLM support.

2326. **[excel-reader-mcp](https://github.com/ArchimedesCrypto/excel-reader-mcp)** - ⭐ 27
...
2327. **[aws-mcp](https://github.com/lokeswaran-aj/aws-mcp)** - ⭐ 27
   An MCP(Model Context Protocol) Server for AWS services

2328. **[mcp-ollama-agent](https://github.com/ausboss/mcp-ollama-agent)** - ⭐ 27
...
2329. **[claude-code-mcp](https://github.com/zebbern/claude-code-mcp)** - ⭐ 27
...
2330. **[mcpc](https://github.com/apify/mcpc)** - ⭐ 27
   Universal command-line client for the Model Context Protocol (MCP)

2331. **[mcp-proxy](https://github.com/stephenlacy/mcp-proxy)** - ⭐ 27
   Fast rust MCP proxy between stdio and SSE

2332. **[Learn-Model-Context-Protocol-with-Python](https://github.com/PacktPublishing/Learn-Model-Context-Protocol-with-Python)** - ⭐ 27
   Learn Model Context Protocol with Python, published by Packt

2333. **[gaia-x](https://github.com/YFGaia/gaia-x)** - ⭐ 27
...
2334. **[VercelGenUI_MCP](https://github.com/JamesSloan/VercelGenUI_MCP)** - ⭐ 27
   Proof of concept chat AI combining the Model Context Protocol (MCP) with Vercel's AI SDK UI

2335. **[workflows-mcp-server](https://github.com/cyanheads/workflows-mcp-server)** - ⭐ 27
...
2336. **[postgres-mcp-server](https://github.com/ahmedmustahid/postgres-mcp-server)** - ⭐ 27
   MCP (Model Context Protocol) Server for postgres Database

2337. **[mcp](https://github.com/supadata-ai/mcp)** - ⭐ 27
   Official Supadata MCP Server - Adds powerful video & web scraping to Cursor, Claude and any other LLM clients.

2338. **[mcp-bash](https://github.com/patrickomatik/mcp-bash)** - ⭐ 27
...
2339. **[google-workspace-mcp-server](https://github.com/epaproditus/google-workspace-mcp-server)** - ⭐ 27
   A Model Context Protocol server for Google Workspace integration (Gmail and Calendar)

2340. **[nettune](https://github.com/jtsang4/nettune)** - ⭐ 27
...
2341. **[mcp-structured-thinking](https://github.com/Promptly-Technologies-LLC/mcp-structured-thinking)** - ⭐ 27
...
2342. **[framer-plugin-mcp](https://github.com/Sheshiyer/framer-plugin-mcp)** - ⭐ 27
   A Model Context Protocol (MCP) server for creating and managing Framer plugins with web3 capabilities

2343. **[mcp-web-browser](https://github.com/random-robbie/mcp-web-browser)** - ⭐ 27
   An advanced web browsing server for the Model Context Protocol (MCP) powered by Playwright, enabling headless browser interactions through a flexible, secure API.

2344. **[directus-mcp-server](https://github.com/rijkvanzanten/directus-mcp-server)** - ⭐ 27
   Model Context Protocol server for Directus

2345. **[Python-Runtime-Interpreter-MCP-Server](https://github.com/hileamlakB/Python-Runtime-Interpreter-MCP-Server)** - ⭐ 27
   PRIMS is a lightweight, open-source Model Context Protocol (MCP) server that lets LLM agents safely execute arbitrary Python code in a secure, throw-away sandbox.

2346. **[openapi-mcp-generator](https://github.com/abutbul/openapi-mcp-generator)** - ⭐ 27
...
2347. **[seo-insights-mcp-server](https://github.com/mrgoonie/seo-insights-mcp-server)** - ⭐ 27
...
2348. **[mcp_espn_ff](https://github.com/KBThree13/mcp_espn_ff)** - ⭐ 27
   ESPN Fantasy API with LLMs!

2349. **[octave-mcp](https://github.com/elevanaltd/octave-mcp)** - ⭐ 27
...
2350. **[nimbletools-core](https://github.com/NimbleBrainInc/nimbletools-core)** - ⭐ 27
   NimbleTools is an open-source MCP runtime. Infrastructure for the agentic web.

2351. **[deno-mcp-template](https://github.com/phughesmcr/deno-mcp-template)** - ⭐ 27
   A template repo for writing and publishing local, remote, DXT, and binary MCP servers using Deno.

2352. **[gemsuite-mcp](https://github.com/PV-Bhat/gemsuite-mcp)** - ⭐ 27
...
2353. **[metabase-mcp](https://github.com/hluaguo/metabase-mcp)** - ⭐ 27
...
2354. **[mcp-stytch-consumer-todo-list](https://github.com/stytchauth/mcp-stytch-consumer-todo-list)** - ⭐ 27
   Workers + Stytch TODO App MCP Server

2355. **[mindbridge-mcp](https://github.com/pinkpixel-dev/mindbridge-mcp)** - ⭐ 27
...
2356. **[memcord](https://github.com/ukkit/memcord)** - ⭐ 27
   🧠 Privacy-first MCP server for AI memory management. Save, search & organize chat history with intelligent  summarization.

2357. **[do-remote-mcp-server-template](https://github.com/do-community/do-remote-mcp-server-template)** - ⭐ 26
   A Model Context Protocol (MCP) server that checks domain name availability using WHOIS lookups and DNS resolution

2358. **[mcp-frontend-testing](https://github.com/StudentOfJS/mcp-frontend-testing)** - ⭐ 26
   Frontend testing tools for Model Context Protocol

2359. **[pptx-xlsx-mcp](https://github.com/jenstangen1/pptx-xlsx-mcp)** - ⭐ 26
   Antrophics Model context protocol to edit powerpoint files

2360. **[minds-mcp](https://github.com/mindsdb/minds-mcp)** - ⭐ 26
...
2364. **[mcp-client-x](https://github.com/RGGH/mcp-client-x)** - ⭐ 26
   Python MCP client + server example

2365. **[mcp-gateway](https://github.com/lucky-aeon/mcp-gateway)** - ⭐ 26
...
2366. **[mcp-log-proxy](https://github.com/emicklei/mcp-log-proxy)** - ⭐ 26
   a web logging proxy for MCP client-server communication

2367. **[langchain-mcp-tools-py](https://github.com/hideya/langchain-mcp-tools-py)** - ⭐ 26
   MCP to LangChain Tools Conversion Utility / Python

2368. **[datagouv-mcp](https://github.com/datagouv/datagouv-mcp)** - ⭐ 26
...
2369. **[mcp-server-giphy](https://github.com/magarcia/mcp-server-giphy)** - ⭐ 26
   An implementation of Giphy integration with Model Context Protocol

2370. **[WebSearch-MCP](https://github.com/mnhlt/WebSearch-MCP)** - ⭐ 26
...
2371. **[MalwareBazaar_MCP](https://github.com/mytechnotalent/MalwareBazaar_MCP)** - ⭐ 26
   An AI-driven MCP server that autonomously interfaces with Malware Bazaar, delivering real-time threat intel and sample metadata for authorized cybersecurity research workflows.

2372. **[omop_mcp](https://github.com/OHNLP/omop_mcp)** - ⭐ 26
...
2373. **[mcp-chain-of-draft-server](https://github.com/bsmi021/mcp-chain-of-draft-server)** - ⭐ 26
   Chain of Draft Server is a powerful AI-driven tool that helps developers make better decisions through systematic, iterative refinement of thoughts and designs. It integrates seamlessly with popular AI agents and provides a structured approach to reasoning, API design, architecture decisions, code reviews, and implementation planning.

2374. **[src-to-kb](https://github.com/vezlo/src-to-kb)** - ⭐ 26
   Convert source code to LLM ready knowledge base

2375. **[alibabacloud-dataworks-mcp-server](https://github.com/aliyun/alibabacloud-dataworks-mcp-server)** - ⭐ 26
   A Model Context Protocol (MCP) server that provides tools for AI, allowing it to interact with the DataWorks Open API through a standardized interface. This implementation is based on the Aliyun Open API and enables AI agents to perform cloud resources operations seamlessly.

2376. **[levante](https://github.com/levante-hub/levante)** - ⭐ 26
   Levante - Personal, Secure, Free, Local AI, MCP Client

2377. **[openscad-mcp](https://github.com/quellant/openscad-mcp)** - ⭐ 26
   A Model Context Protocol (MCP) server for OpenSCAD 3D modeling and rendering

2378. **[mcp-client-cli](https://github.com/thedotmack/mcp-client-cli)** - ⭐ 26
   Command-line interface for any Model Context Protocol (MCP) server.

2379. **[MCP-BOE](https://github.com/ComputingVictor/MCP-BOE)** - ⭐ 25
...
2380. **[alpaca-mcp-server](https://github.com/tedlikeskix/alpaca-mcp-server)** - ⭐ 25
   Model Context Protocol (MCP) server for Alpaca trading API

2381. **[gyazo-mcp-server](https://github.com/nota/gyazo-mcp-server)** - ⭐ 25
   Official Model Context Protocol server for Gyazo

2382. **[Healthcare-MCP](https://github.com/innovaccer/Healthcare-MCP)** - ⭐ 25
...
2383. **[mcp-php](https://github.com/garyblankenship/mcp-php)** - ⭐ 25
   model context protocol or mcp for php laravel

2384. **[mcp-writer-substack](https://github.com/jonathan-politzki/mcp-writer-substack)** - ⭐ 25
   Model Context Protocol to bridge in Substack writings to Claude.

2385. **[mcp-media-processor](https://github.com/maoxiaoke/mcp-media-processor)** - ⭐ 25
   A Node.js server implementing Model Context Protocol (MCP) for media processing operations, providing powerful video and image manipulation capabilities.

2386. **[mcp-webdriveragent](https://github.com/AppiumTestDistribution/mcp-webdriveragent)** - ⭐ 25
   This is a Model Context Protocol (MCP) server that provides tools for building and signing WebDriverAgent for iOS.

2387. **[turn-based-game-mcp](https://github.com/github-samples/turn-based-game-mcp)** - ⭐ 25
...
2388. **[taiwan-holiday-mcp](https://github.com/lis186/taiwan-holiday-mcp)** - ⭐ 25
   一個基於 Model Context Protocol (MCP) 的台灣假期查詢伺服器，為 AI 工具提供準確的台灣國定假日資訊。

2389. **[mcp-manager](https://github.com/nstebbins/mcp-manager)** - ⭐ 25
   CLI tool for managing Model Context Protocol (MCP) servers in one place & using them across them different clients

2390. **[php-mcp-sdk](https://github.com/dalehurley/php-mcp-sdk)** - ⭐ 25
...
2391. **[taskflow-mcp](https://github.com/pinkpixel-dev/taskflow-mcp)** - ⭐ 25
   A task management Model Context Protocol (MCP) server that helps AI assistants break down user requests into manageable tasks with subtasks, dependencies, and notes. Enforces a structured workflow with user approval steps.

2392. **[symfony-mcp-server](https://github.com/klapaudius/symfony-mcp-server)** - ⭐ 25
   A Symfony package designed for building secure servers based on the Model Context Protocol, utilizing Server-Sent Events (SSE) and/or StreamableHTTP for real-time communication. It offers a scalable tool system tailored for enterprise-grade applications.

2393. **[FalkorDB-MCPServer](https://github.com/FalkorDB/FalkorDB-MCPServer)** - ⭐ 25
   FalkorDB-MCPServer is an MCP (Model Context Protocol) server that connects LLMs to FalkorDB

2394. **[ton-blockchain-mcp](https://github.com/devonmojito/ton-blockchain-mcp)** - ⭐ 25
   A Model Context Protocol (MCP) server written in Python for natural language interaction with the TON blockchain 💎

2395. **[ida-headless-mcp](https://github.com/zboralski/ida-headless-mcp)** - ⭐ 25
   Headless IDA Pro binary analysis via Model Context Protocol

2396. **[elysia-mcp](https://github.com/kerlos/elysia-mcp)** - ⭐ 25
   ElysiaJS plugin for Model Context Protocol with HTTP transport

2397. **[mcp-server-semgrep](https://github.com/VetCoders/mcp-server-semgrep)** - ⭐ 25
   MCP Server Semgrep is a [Model Context Protocol](https://modelcontextprotocol.io) compliant server that integrates the powerful Semgrep static analysis tool with AI assistants like Anthropic Claude. It enables advanced code analysis, security vulnerability detection, and code quality improvements directly through a conversational interface.

2398. **[deep-research-mcp](https://github.com/pinkpixel-dev/deep-research-mcp)** - ⭐ 25
   A Model Context Protocol (MCP) compliant server designed for comprehensive web research. It uses Tavily's Search and Crawl APIs to gather detailed information on a given topic, then structures this data in a format perfect for LLMs to create high-quality markdown documents.

2399. **[ai-foundry-agents-samples](https://github.com/Azure-Samples/ai-foundry-agents-samples)** - ⭐ 25
   Azure AI Foundry - Agents related sample code

2400. **[mcpmcp-server](https://github.com/glenngillen/mcpmcp-server)** - ⭐ 25
   Discover, setup, and integrate MCP servers with your favorite clients. Unlock the full potential of AI in your daily workflow.

2401. **[puzzlebox](https://github.com/cliffhall/puzzlebox)** - ⭐ 25
...
2402. **[Tiny-OAI-MCP-Agent](https://github.com/jalr4ever/Tiny-OAI-MCP-Agent)** - ⭐ 25
   A MCP protocol agent that operates a SQLite using natural language by OpenAI-Compatible LLM.

2403. **[slack-mcp-server](https://github.com/AVIMBU/slack-mcp-server)** - ⭐ 25
   A Model Context Protocol Server for Interacting with Slack

2404. **[vision-one-mcp-server](https://github.com/trendmicro/vision-one-mcp-server)** - ⭐ 25
...
2405. **[whistle-mcp](https://github.com/7gugu/whistle-mcp)** - ⭐ 25
...
2406. **[MCP-Developer-SubAgent](https://github.com/gensecaihq/MCP-Developer-SubAgent)** - ⭐ 25
...
2407. **[freepik-mcp](https://github.com/freepik-company/freepik-mcp)** - ⭐ 25
   The Freepik enables popular agent Model Context Protocol (MCP) to integrate with Freepik APIs through function calling.

2408. **[powerplatform-mcp](https://github.com/michsob/powerplatform-mcp)** - ⭐ 25
   PowerPlatform Model Context Protocol server

2409. **[zillow-mcp-server](https://github.com/sap156/zillow-mcp-server)** - ⭐ 25
   Zillow MCP Server for real estate data access via the Model Context Protocol

2410. **[systemprompt-mcp-notion](https://github.com/Ejb503/systemprompt-mcp-notion)** - ⭐ 25
...
2411. **[embedded-debugger-mcp](https://github.com/Adancurusul/embedded-debugger-mcp)** - ⭐ 25
   A Model Context Protocol server for embedded debugging with probe-rs - supports ARM Cortex-M, RISC-V debugging via J-Link, ST-Link, and more

2412. **[mcp-config-manager](https://github.com/holstein13/mcp-config-manager)** - ⭐ 25
...
2413. **[mcp-simple-timeserver](https://github.com/andybrandt/mcp-simple-timeserver)** - ⭐ 25
   Simple solution to give Claude ability to check current time via MCP

2414. **[kernel-mcp-server](https://github.com/kernel/kernel-mcp-server)** - ⭐ 25
   Open-source MCP server for secure, low-latency cloud-browser automation on Kernel.

2415. **[Amazing-Marvin-MCP](https://github.com/bgheneti/Amazing-Marvin-MCP)** - ⭐ 25
   Model Context Provider for Amazing Marvin productivity app - Access your tasks, projects, and categories in AI assistants

2416. **[FerrumMCP](https://github.com/Eth3rnit3/FerrumMCP)** - ⭐ 25
...
2417. **[chatbot_Shopify](https://github.com/Mobeen-Dev/chatbot_Shopify)** - ⭐ 25
   Agentic Shopify Chatbot with MCP integration, embedded directly into Shopify via a Theme Extension

2418. **[kaggle-mcp](https://github.com/54yyyu/kaggle-mcp)** - ⭐ 25
...
2419. **[yahoo-finance-server](https://github.com/AgentX-ai/yahoo-finance-server)** - ⭐ 25
...
2420. **[semrush-mcp](https://github.com/mrkooblu/semrush-mcp)** - ⭐ 24
   A Model Context Protocol (MCP) server implementation that provides tools for accessing Semrush API data.

2421. **[Unlock-your-agents-potential-with-Model-Context-Protocol-PostgreSQL-Workshop](https://github.com/gloveboxes/Unlock-your-agents-potential-with-Model-Context-Protocol-PostgreSQL-Workshop)** - ⭐ 24

2422. **[ccmcp](https://github.com/gsong/ccmcp)** - ⭐ 24
   A CLI tool that intelligently discovers, validates, and selects MCP (Model Context Protocol) server configurations for Claude Code.

2423. **[agent-hub-mcp](https://github.com/gilbarbara/agent-hub-mcp)** - ⭐ 24
   A Model Context Protocol (MCP) server that enables communication and coordination between multiple AI agents

2424. **[opnsense-mcp-server](https://github.com/floriangrousset/opnsense-mcp-server)** - ⭐ 24
...
2425. **[n8n-AI-agent-DVM-MCP-client](https://github.com/r0d8lsh0p/n8n-AI-agent-DVM-MCP-client)** - ⭐ 24
...
2426. **[puppeteer-mcp-claude](https://github.com/jaenster/puppeteer-mcp-claude)** - ⭐ 24
...
2427. **[mcp-server-semgrep](https://github.com/Szowesgad/mcp-server-semgrep)** - ⭐ 24
   MCP Server Semgrep is a [Model Context Protocol](https://modelcontextprotocol.io) compliant server that integrates the powerful Semgrep static analysis tool with AI assistants like Anthropic Claude. It enables advanced code analysis, security vulnerability detection, and code quality improvements directly through a conversational interface.

2428. **[nebulagraph-mcp-server](https://github.com/nebula-contrib/nebulagraph-mcp-server)** - ⭐ 24
   Model Context Protocol Server for NebulaGraph 3.x

2429. **[python-sequential-thinking-mcp](https://github.com/XD3an/python-sequential-thinking-mcp)** - ⭐ 24
...
2430. **[clay-mcp](https://github.com/clay-inc/clay-mcp)** - ⭐ 24
   A simple Model Context Protocol (MCP) server for Clay.

2431. **[MCP](https://github.com/EduBase/MCP)** - ⭐ 24
   The EduBase MCP server enables Claude and other LLMs to interact with EduBase's comprehensive e-learning platform through the Model Context Protocol (MCP).

2432. **[google-search-console-mcp-server](https://github.com/Shin-sibainu/google-search-console-mcp-server)** - ⭐ 24
   Model Context Protocol server for Google Search Console API - integrate with Claude Code and Claude Desktop

2433. **[mcp-task-manager-server](https://github.com/bsmi021/mcp-task-manager-server)** - ⭐ 24
   A local Model Context Protocol (MCP) server providing backend tools for client-driven project and task management using a SQLite database.

2434. **[brlaw_mcp_server](https://github.com/pdmtt/brlaw_mcp_server)** - ⭐ 24
   A MCP (Model Context Protocol) server for agent-driven research on Brazilian law using official sources

2435. **[DeepResearchMCP](https://github.com/ameeralns/DeepResearchMCP)** - ⭐ 24
...
2436. **[aistudio-mcp-server](https://github.com/eternnoir/aistudio-mcp-server)** - ⭐ 24
...
2437. **[MCPSecBench](https://github.com/AIS2Lab/MCPSecBench)** - ⭐ 24
   MCPSecBench: A Systematic Security Benchmark and Playground for Testing Model Context Protocols

2438. **[mcp-template-dotnet](https://github.com/NikiforovAll/mcp-template-dotnet)** - ⭐ 24
   This repository contains a template for creating a Model Context Protocol (MCP) applications in .NET.

2439. **[mcp-playground](https://github.com/zanetworker/mcp-playground)** - ⭐ 24
   Simple MCP Client for remote MCP Servers 🌐

2440. **[awesome-mcp-lists](https://github.com/collabnix/awesome-mcp-lists)** - ⭐ 24
   A Curated List of MCP Servers, Clients and Toolkits

2441. **[mcp_streamable_http](https://github.com/theailanguage/mcp_streamable_http)** - ⭐ 24
   Educational repo for MCP streamable HTTP servers and clients

2442. **[Awesome-MCP](https://github.com/Albertchamberlain/Awesome-MCP)** - ⭐ 24
   Awesome-MCP Servers & Clients & Funny things

2443. **[openai-copilot](https://github.com/feiskyer/openai-copilot)** - ⭐ 24
   Your life Copilot powered by LLM models (CLI interface for LLM models with MCP tools).

2444. **[bgg-mcp](https://github.com/kkjdaniel/bgg-mcp)** - ⭐ 24
   BGG MCP provides access to BoardGameGeek and a variety of board game related data through the Model Context Protocol. Enabling retrieval and filtering of board game data, user collections, and profiles.

2445. **[meeting-mcp](https://github.com/Meeting-BaaS/meeting-mcp)** - ⭐ 24
   Model Context Protocol server for AI assistants to create meeting bots, search transcripts, and manage meeting recordings.

2446. **[calendar-mcp](https://github.com/deciduus/calendar-mcp)** - ⭐ 24
...
2447. **[crawl4ai-mcp-server](https://github.com/sadiuysal/crawl4ai-mcp-server)** - ⭐ 24
...
2448. **[readwise-vector-db](https://github.com/leonardsellem/readwise-vector-db)** - ⭐ 24
...
2449. **[mcp-server](https://github.com/blockscout/mcp-server)** - ⭐ 24
   Wraps Blockscout APIs and exposes blockchain data by Model Context Protocol

2450. **[nestjs-mcp](https://github.com/bamada/nestjs-mcp)** - ⭐ 24
   NestJS module for seamless Model Context Protocol (MCP) server integration using decorators.

2451. **[forgejo-mcp](https://github.com/goern/forgejo-mcp)** - ⭐ 24
...
2452. **[svgmaker-mcp](https://github.com/GenWaveLLC/svgmaker-mcp)** - ⭐ 24
...
2453. **[cfbd-mcp-server](https://github.com/lenwood/cfbd-mcp-server)** - ⭐ 24
   An MCP server enabling CFBD API queries within Claude Desktop.

2454. **[mcp-server-amazon-bedrock](https://github.com/zxkane/mcp-server-amazon-bedrock)** - ⭐ 24
   Model Context Procotol(MCP) server for using Amazon Bedrock Nova Canvas to generate images

2455. **[minimax_search](https://github.com/MiniMax-AI/minimax_search)** - ⭐ 24
   MiniMax Search is an MCP (Model Context Protocol) server that provides web search and browsing capabilities.

2456. **[fal-mcp-server](https://github.com/raveenb/fal-mcp-server)** - ⭐ 24
   MCP server for Fal.ai - Generate images, videos, music and audio with Claude

2457. **[Model-Context-Protocol](https://github.com/Coding-Crashkurse/Model-Context-Protocol)** - ⭐ 23

2458. **[greptimedb-mcp-server](https://github.com/GreptimeTeam/greptimedb-mcp-server)** - ⭐ 23
   A Model Context Protocol (MCP) server for GreptimeDB

2459. **[jigsawstack-mcp-server](https://github.com/JigsawStack/jigsawstack-mcp-server)** - ⭐ 23
   Model Context Protocol Server that allows AI models to interact with JigsawStack models!

2460. **[metabase-mcp-server](https://github.com/hyeongjun-dev/metabase-mcp-server)** - ⭐ 23
   A Model Context Protocol server that integrates AI assistants with Metabase analytics platform

2461. **[cortex](https://github.com/FreePeak/cortex)** - ⭐ 23
...
2462. **[paraview_mcp](https://github.com/LLNL/paraview_mcp)** - ⭐ 23
   ParaView-MCP integrates multimodal LLMs with ParaView via Model Context Protocol, enabling natural language control of scientific visualizations. The agent observes the viewport for visual feedback, making complex visualization tool accessible to all users while providing intelligent automation for experts.

2463. **[lineshopping-api-mcp](https://github.com/woraphol-j/lineshopping-api-mcp)** - ⭐ 23
...
2464. **[mcp_rss](https://github.com/buhe/mcp_rss)** - ⭐ 23
   MCP RSS is a Model Context Protocol (MCP) server for interacting with RSS feeds.

2465. **[home-assistant-mcp](https://github.com/hpohlmann/home-assistant-mcp)** - ⭐ 23
...
2466. **[mcp-twitter-server](https://github.com/crazyrabbitLTC/mcp-twitter-server)** - ⭐ 23
   Model Context Protocol Server for Accessing twitter

2467. **[fastify-mcp](https://github.com/haroldadmin/fastify-mcp)** - ⭐ 23
   A Fastify plugin to run Model Context Protocol (MCP) servers

2468. **[batchdata-mcp-real-estate](https://github.com/zellerhaus/batchdata-mcp-real-estate)** - ⭐ 23
...
2469. **[lua-resty-mcp](https://github.com/ufownl/lua-resty-mcp)** - ⭐ 23
   Model Context Protocol SDK implemented in Lua for OpenResty

2470. **[mcp-server-starter-ts](https://github.com/alexanderop/mcp-server-starter-ts)** - ⭐ 23
   A minimal TypeScript starter template for building Model Context Protocol (MCP) servers.

2471. **[strava-mcp](https://github.com/kw510/strava-mcp)** - ⭐ 23
...
2472. **[mcp-slicer](https://github.com/zhaoyouj/mcp-slicer)** - ⭐ 23
   A Model Context Protocol server for 3D Slicer integration

2473. **[identity-spec](https://github.com/agntcy/identity-spec)** - ⭐ 23
   AGNTCY Identity allows to onboard, create and verify identities for Agents, Model Context Protocol (MCP) Servers and Multi-Agent Systems (MASs).

2474. **[enhanced-mcp-memory](https://github.com/cbunting99/enhanced-mcp-memory)** - ⭐ 23
   An enhanced MCP (Model Context Protocol) server for intelligent memory and task management, designed for AI assistants and development workflows. Features semantic search, automatic task extraction, knowledge graphs, and comprehensive project management.

2475. **[mcp-ffmpeg-helper](https://github.com/sworddut/mcp-ffmpeg-helper)** - ⭐ 23
   一个基于 Model Context Protocol (MCP) 的 FFmpeg 辅助工具，提供视频处理功能。

2476. **[mcp-client-agent](https://github.com/shane-kercheval/mcp-client-agent)** - ⭐ 23
   CLI that uses DSPy to interact with MCP servers.

2477. **[mcp-community](https://github.com/Mirascope/mcp-community)** - ⭐ 23
   Easily run, deploy, and connect to MCP servers

2478. **[MiAO-MCP-for-Unity](https://github.com/MiAO-AI-Lab/MiAO-MCP-for-Unity)** - ⭐ 23
...
2479. **[jsonv-ts](https://github.com/dswbx/jsonv-ts)** - ⭐ 23
   JSON Schema builder and validator for TypeScript with static type inference, Hono middleware for OpenAPI generation and validation, and MCP server/client implementation. Lightweight, dependency-free, and built on Web Standards.

2480. **[solana-mcp](https://github.com/tony-42069/solana-mcp)** - ⭐ 23
...
2481. **[aisdk-mcp-bridge](https://github.com/vrknetha/aisdk-mcp-bridge)** - ⭐ 23
...
2482. **[RevitMCP](https://github.com/oakplank/RevitMCP)** - ⭐ 23
   model context protocol for Autodesk Revit

2483. **[nlweb-net](https://github.com/nlweb-ai/nlweb-net)** - ⭐ 23
...
2484. **[mcp-pa-ai-agent](https://github.com/zhangzhongnan928/mcp-pa-ai-agent)** - ⭐ 23
   A personal assistant AI agent built with the Model Context Protocol (MCP)

2485. **[openproject-mcp-server](https://github.com/AndyEverything/openproject-mcp-server)** - ⭐ 23
   A Model Context Protocol (MCP) server that provides seamless integration with OpenProject API v3.

2486. **[ddg_search](https://github.com/OEvortex/ddg_search)** - ⭐ 23
   A powerful Model Context Protocol (MCP) server for web search and URL content extraction using DuckDuckGo.

2487. **[github-repo-mcp](https://github.com/Ryan0204/github-repo-mcp)** - ⭐ 23
   Model Context Protocol server for Github Repo // Reading Github Repo

2488. **[prometheus-mcp](https://github.com/idanfishman/prometheus-mcp)** - ⭐ 23
   A Model Context Protocol (MCP) server implementation that provides AI agents with programmatic access to Prometheus metrics via a unified interface.

2489. **[bzm-mcp](https://github.com/Blazemeter/bzm-mcp)** - ⭐ 23
   MCP Server for AI-driven BlazeMeter performance testing

2490. **[browser-use-rs](https://github.com/BB-fat/browser-use-rs)** - ⭐ 23
...
2491. **[roo-logger](https://github.com/annenpolka/roo-logger)** - ⭐ 23
   An MCP server for logging activity in Roo Code/Cline.

2492. **[codemesh](https://github.com/kiliman/codemesh)** - ⭐ 23
   The Self-Improving MCP Server - Agents write code to orchestrate multiple MCP servers with intelligent TypeScript execution and auto-augmentation

2493. **[microsoft_fabric_mcp](https://github.com/Augustab/microsoft_fabric_mcp)** - ⭐ 23
   MCP server wrapping around the Fabric Rest API

2494. **[mcp-annotated-java-sdk](https://github.com/thought2code/mcp-annotated-java-sdk)** - ⭐ 23
   Annotation-driven MCP dev 🚀 No Spring, Zero Boilerplate, Pure Java

2495. **[touchdesigner-mcp-server](https://github.com/bottobot/touchdesigner-mcp-server)** - ⭐ 23
...
2496. **[metals-standalone-client](https://github.com/jpablo/metals-standalone-client)** - ⭐ 23
   Minimal Metals stand alone client that allows running the metals mcp server

2497. **[AskUserQuestionPlus](https://github.com/JoJoJotarou/AskUserQuestionPlus)** - ⭐ 23
...
2510. **[p5js-ai-editor](https://github.com/adilmoujahid/p5js-ai-editor)** - ⭐ 22
...
2511. **[cursor-db-mcp](https://github.com/jbdamask/cursor-db-mcp)** - ⭐ 22
   Model Context Protocol server for querying Cursor chat history

2512. **[mcp-caiyun-weather](https://github.com/caiyunapp/mcp-caiyun-weather)** - ⭐ 22
   A Model Context Protocol (MCP) server for Caiyun (ColorfulClouds) Weather.

2513. **[printify-mcp](https://github.com/TSavo/printify-mcp)** - ⭐ 22
   A Model Context Protocol (MCP) server for integrating AI assistants with Printify's print-on-demand platform

2514. **[silverbullet-mcp](https://github.com/Ahmad-A0/silverbullet-mcp)** - ⭐ 22
   A Model Context Protocol (MCP) server to interact with your SilverBullet notes and data.

2515. **[mcp-claude-spotify](https://github.com/imprvhub/mcp-claude-spotify)** - ⭐ 22
   An integration that allows Claude Desktop to interact with Spotify using the Model Context Protocol (MCP).

2516. **[cf-mcp-client](https://github.com/cpage-pivotal/cf-mcp-client)** - ⭐ 22
   Tanzu Platform Chat

2517. **[supabase-mcp-client](https://github.com/tambo-ai/supabase-mcp-client)** - ⭐ 22
   Supabase MCP client react app with Tambo

2518. **[biznagafest-mcp](https://github.com/0GiS0/biznagafest-mcp)** - ⭐ 22
   MCP Servers en Málaga con salero

2519. **[langchain-mcp-tools-ts](https://github.com/hideya/langchain-mcp-tools-ts)** - ⭐ 22
   MCP to LangChain Tools Conversion Utility / TypeScript

2520. **[pulse-editor](https://github.com/ClayPulse/pulse-editor)** - ⭐ 22
...
2521. **[codesys-mcp-toolkit](https://github.com/johannesPettersson80/codesys-mcp-toolkit)** - ⭐ 22
   Model Context Protocol server for CODESYS automation platform

2522. **[dbt-docs-mcp](https://github.com/mattijsdp/dbt-docs-mcp)** - ⭐ 22
   MCP (model context protocol) server for interacting with dbt Docs

2523. **[MCP_A2A](https://github.com/regismesquita/MCP_A2A)** - ⭐ 22
...
2524. **[grumpydev-mcp](https://github.com/sinedied/grumpydev-mcp)** - ⭐ 22
   Let the grumpy senior dev review your code with this MCP server

2525. **[apifox-mcp](https://github.com/iwen-conf/apifox-mcp)** - ⭐ 22
   Apifox MCP 服务器 - 让 Claude 等 AI 助手通过自然语言管理你的 Apifox 项目，轻松创建、更新和审计 API 接口

2526. **[Claude-Code-MCP-Manager](https://github.com/qdhenry/Claude-Code-MCP-Manager)** - ⭐ 22
    A comprehensive tool to manage Model Context Protocol (MCP) configurations for Claude code

2527. **[slack-mcp-client](https://github.com/csonigo/slack-mcp-client)** - ⭐ 22
   An MCP client for slack in Typescript

2528. **[skill-mcp](https://github.com/fkesheh/skill-mcp)** - ⭐ 22
...
2529. **[bear-notes-mcp](https://github.com/bejaminjones/bear-notes-mcp)** - ⭐ 22
   MCP server for Bear app - Full Read + Write AI-powered note management with Claude Desktop

2530. **[Excel-MCP-Server-Master](https://github.com/guillehr2/Excel-MCP-Server-Master)** - ⭐ 22
...
2531. **[bridge-mcp](https://github.com/codingjam/bridge-mcp)** - ⭐ 21
...
2532. **[cml-mcp](https://github.com/xorrkaz/cml-mcp)** - ⭐ 21
   A Model Context Protocol (MCP) Server for Cisco Modeling Labs (CML)

2533. **[mcpsharepoint](https://github.com/BrianCusack/mcpsharepoint)** - ⭐ 21
   Model Context Protocol server that provides access to Organisational SharePoint.

2534. **[command-executor-mcp-server](https://github.com/Sunwood-ai-labs/command-executor-mcp-server)** - ⭐ 21
   Model Context Protocol Server for Safely Executing Pre-approved Commands

2535. **[emqx-mcp-server](https://github.com/Benniu/emqx-mcp-server)** - ⭐ 21
   A Model Context Protocol (MCP) server implementation that provides EMQX MQTT broker interaction.

2536. **[mcp-sentry](https://github.com/MCP-100/mcp-sentry)** - ⭐ 21
   A Model Context Protocol server for retrieving and analyzing issues from Sentry.io

2537. **[fastify-mcp-server](https://github.com/flaviodelgrosso/fastify-mcp-server)** - ⭐ 21
   Fastify plugin to easily spin up Model Context Protocol (MCP) HTTP servers

2538. **[mcp-korean-spell](https://github.com/winterjung/mcp-korean-spell)** - ⭐ 21
   MCP(Model Context Protocol) server designed for Korean spell checking

2539. **[DocsRay](https://github.com/MIMICLab/DocsRay)** - ⭐ 21
   Lightweight PDF Q&A tool powered by RAG (Retrieval-Augmented Generation) with MCP (Model Context Protocol) Support.

2540. **[MCPRules](https://github.com/bartwisch/MCPRules)** - ⭐ 21
...
2541. **[code-context-mcp](https://github.com/fkesheh/code-context-mcp)** - ⭐ 21
   A Model Context Protocol (MCP) server for providing code context from git repositories

2542. **[mcp-knowledge-base](https://github.com/hjlee94/mcp-knowledge-base)** - ⭐ 21
   MCP agent/client/server implementation for private knowledge base

2543. **[google-search-console-mcp](https://github.com/surendranb/google-search-console-mcp)** - ⭐ 21
   Google Search Console MCP Server for Claude, Cursor, Windsurf and other MCP Clients

2544. **[awesome-mcp](https://github.com/MCPHubCloud/awesome-mcp)** - ⭐ 21
   A collection of mcp servers/client/sdks

2545. **[aj-mcp](https://github.com/lightweight-component/aj-mcp)** - ⭐ 21
   Simple MCP SDK in Java

2546. **[mcp-cmd](https://github.com/developit/mcp-cmd)** - ⭐ 21
   CLI for calling successive MCP Server tools

2547. **[d365fo-client](https://github.com/mafzaal/d365fo-client)** - ⭐ 21
...
2548. **[congressMCP](https://github.com/amurshak/congressMCP)** - ⭐ 21
   An MCP server allowing AI agents and MCP clients to interface with the Congress.gov API

2549. **[server-sharepoint](https://github.com/Zerg00s/server-sharepoint)** - ⭐ 21
...
2556. **[nix-mcp-servers](https://github.com/ismail-kattakath/nix-mcp-servers)** - ⭐ 21
   A nix flake for configuring Model Context Protocol (MCP) servers across supported AI assistant clients

2557. **[ib-mcp-cache-server](https://github.com/ibproduct/ib-mcp-cache-server)** - ⭐ 20
   Memory Cache Server for use with supported MCP API Clients.

2558. **[hs-mcp](https://github.com/buecking/hs-mcp)** - ⭐ 20
   Haskell server/client for MCP (Model Context Protocol)

2559. **[zotero-mcp-server](https://github.com/swairshah/zotero-mcp-server)** - ⭐ 20
   MCP server to expose local zotero repository to MCP clients 

2560. **[mcp-server-runner](https://github.com/yonaka15/mcp-server-runner)** - ⭐ 20
...
2561. **[mcp-ai-agent](https://github.com/fkesheh/mcp-ai-agent)** - ⭐ 20
...
2562. **[mcp-observer-server](https://github.com/hesreallyhim/mcp-observer-server)** - ⭐ 20
   An MCP server that provides server-to-client notifications for file changes that the client subscribes to

2563. **[easymcp](https://github.com/promptmesh/easymcp)** - ⭐ 20
   A high performance MCP client sdk for python

2564. **[room-mcp](https://github.com/agree-able/room-mcp)** - ⭐ 20
   Allow MCP clients like claude-desktop to use rooms to coordinate with other agents

2565. **[mcp-framework](https://github.com/koki7o/mcp-framework)** - ⭐ 20
   Rust MCP framework for building AI agents

2566. **[mcp-deepseek-demo](https://github.com/Ulanxx/mcp-deepseek-demo)** - ⭐ 20
   deepseek 结合 mcp 场景，最小用例，包括 client and server

2567. **[balldontlie-mcp](https://github.com/mikechao/balldontlie-mcp)** - ⭐ 20
   An MCP Server implementation that integrates the Balldontlie API, to provide information about players, teams and games for the NBA, NFL and MLB

2568. **[mcp-server-memos-py](https://github.com/RyoJerryYu/mcp-server-memos-py)** - ⭐ 20
   A Python package enabling LLM models to interact with the Memos server via the MCP interface for searching, creating, retrieving, and managing memos.

2569. **[mcp-wireshark](https://github.com/khuynh22/mcp-wireshark)** - ⭐ 20
...
2570. **[opnsense-mcp-server](https://github.com/Pixelworlds/opnsense-mcp-server)** - ⭐ 20
   Modular MCP server for OPNsense firewall management - 88 tools providing access to 2000+ methods through AI assistants

2571. **[mcp-server-excel](https://github.com/sbroenne/mcp-server-excel)** - ⭐ 20
   Excel MCP Server & CLI - 21 tools, 182 operations for AI-powered Excel automation via COM API

2572. **[PDB-MCP-Server](https://github.com/Augmented-Nature/PDB-MCP-Server)** - ⭐ 20
...
2573. **[desktop](https://github.com/agentify-sh/desktop)** - ⭐ 20
...
2574. **[NiFiMCP](https://github.com/ms82119/NiFiMCP)** - ⭐ 19
   An MCP Server and client for communicating with Nifi (v1.28)

2575. **[gemini-mcp-client](https://github.com/angrysky56/gemini-mcp-client)** - ⭐ 19
...
2576. **[starbase](https://github.com/metorial/starbase)** - ⭐ 19
   Connect, explore, and test any MCP server with AI models 🤖 ⚡

2577. **[guidance-for-scalable-model-inference-and-agentic-ai-on-amazon-eks](https://github.com/aws-solutions-library-samples/guidance-for-scalable-model-inference-and-agentic-ai-on-amazon-eks)** - ⭐ 19
...
2578. **[flutter-ai-labs](https://github.com/theshivamlko/flutter-ai-labs)** - ⭐ 19
   A curated collection of LLM-powered Flutter apps built using RAG, AI Agents, Multi-Agent Systems, MCP, and Voice Agents.

2579. **[lotus-wisdom-mcp](https://github.com/linxule/lotus-wisdom-mcp)** - ⭐ 19
...
2580. **[deep-research](https://github.com/ssdeanx/deep-research)** - ⭐ 19
...
2581. **[google-drive-mcp](https://github.com/piotr-agier/google-drive-mcp)** - ⭐ 19
...
2582. **[mcp-prompt-optimizer](https://github.com/Bubobot-Team/mcp-prompt-optimizer)** - ⭐ 19
   Advanced MCP server providing cutting-edge prompt optimization tools with research-backed strategies

2583. **[mcp-diagnostics-extension](https://github.com/newbpydev/mcp-diagnostics-extension)** - ⭐ 19
   VS Code extension that exposes diagnostic problems via Model Context Protocol (MCP) for AI agents and tools

2584. **[knowledgebase-mcp](https://github.com/biocontext-ai/knowledgebase-mcp)** - ⭐ 19
   BioContextAI Knowledgebase MCP server for biomedical agentic AI 

2585. **[mcp](https://github.com/EmilLindfors/mcp)** - ⭐ 19
    A crate for making MCP (Model Context Protocol) compatible programs with rust

2586. **[perplexity-mcp-server](https://github.com/cyanheads/perplexity-mcp-server)** - ⭐ 19
...
2587. **[mcp-frontend](https://github.com/shaharia-lab/mcp-frontend)** - ⭐ 19
   Frontend for MCP (Model Context Protocol) Kit for Go - A Complete MCP solutions for ready to use

2588. **[minime-mcp](https://github.com/manujbawa/minime-mcp)** - ⭐ 19
...
2589. **[registry](https://github.com/biocontext-ai/registry)** - ⭐ 19
   The BioContextAI Registry for biomedical MCP servers

2590. **[mcp-server-mariadb](https://github.com/abel9851/mcp-server-mariadb)** - ⭐ 19
   An mcp server that provides read-only access to MariaDB.

2591. **[gno](https://github.com/gmickel/gno)** - ⭐ 19
...
2592. **[agent-twitter-client-mcp](https://github.com/ryanmac/agent-twitter-client-mcp)** - ⭐ 18
...
2593. **[mcp-server-client-demo](https://github.com/S1LV3RJ1NX/mcp-server-client-demo)** - ⭐ 18
   Streamable HTTP based MCP server and Client demo with auto registry, Dockerfile setup and env. 

2594. **[linux-command-mcp](https://github.com/xkiranj/linux-command-mcp)** - ⭐ 18
   MCP server and client for running Linux commands

2595. **[eleven.shopping](https://github.com/elevenlabs/eleven.shopping)** - ⭐ 18
   ElevenLabs Agent with Storefront MCP UI Server & MCP UI client

2596. **[typescript-mcp-client](https://github.com/CodelyTV/typescript-mcp-client)** - ⭐ 18

2597. **[openpyxl-mcp-server](https://github.com/jonemo/openpyxl-mcp-server)** - ⭐ 18
...
2608. **[mcp-link](https://github.com/AuraFriday/mcp-link)** - ⭐ 18
...
2609. **[gpt2099.nu](https://github.com/cablehead/gpt2099.nu)** - ⭐ 18
   a Nushell cross.stream extension to interact with LLMs and MCP servers

2610. **[Devmind-MCP](https://github.com/JochenYang/Devmind-MCP)** - ⭐ 18
...
2611. **[seedream-image-mcp](https://github.com/wearzdk/seedream-image-mcp)** - ⭐ 18
   🚀 PixelMCP | 为你的 Cursor、Claude Code 等集成AI绘画能力，让AI生成的页面不再单调！

2612. **[mcp-chat-studio](https://github.com/JoeCastrom/mcp-chat-studio)** - ⭐ 18
...
2613. **[mcpc](https://github.com/micl2e2/mcpc)** - ⭐ 18
   Cross-platform C SDK for Model Context Protocol (MCP), in modern🚀 C23.

2614. **[mcp-agent](https://github.com/joshuaalpuerto/mcp-agent)** - ⭐ 18
...
2615. **[kirby-mcp](https://github.com/bnomei/kirby-mcp)** - ⭐ 18
...
2616. **[Zammad-MCP](https://github.com/basher83/Zammad-MCP)** - ⭐ 18
...
2617. **[holoviz-mcp](https://github.com/MarcSkovMadsen/holoviz-mcp)** - ⭐ 18
   ✨A MCP server that provides intelligent access to the HoloViz ecosystem for humans and AIs.

2618. **[fast-mcp-telegram](https://github.com/leshchenko1979/fast-mcp-telegram)** - ⭐ 18
   Telegram MCP Server and HTTP-MTProto bridge | Multi-user auth, intelligent search, file sending, web setup | Docker & PyPI ready

2619. **[smartlead-mcp-server](https://github.com/jonathan-politzki/smartlead-mcp-server)** - ⭐ 17
   Local version of Smartlead MCP for quick download and deployment to MCP compatible clients or n8n.

2620. **[mcp-http-client-example](https://github.com/slavashvets/mcp-http-client-example)** - ⭐ 17
   Simple example client demonstrating how to connect to MCP servers over HTTP (SSE)

2621. **[rollbar-mcp-server](https://github.com/rollbar/rollbar-mcp-server)** - ⭐ 17
   Pre-release - Model Context Protocol server for Rollbar

2622. **[jiki](https://github.com/teilomillet/jiki)** - ⭐ 17

2623. **[mcpx](https://github.com/AIGC-Hackers/mcpx)** - ⭐ 17
...
2624. **[MCP-Development-with-Rust](https://github.com/RustSandbox/MCP-Development-with-Rust)** - ⭐ 17
...
2625. **[askit](https://github.com/johnrobinsn/askit)** - ⭐ 17
   LLM Function Calling Library and CLI with Support for MCP Servers

2626. **[mssqlclient-mcp-server](https://github.com/aadversteeg/mssqlclient-mcp-server)** - ⭐ 17
...
2627. **[ai-cli](https://github.com/manusa/ai-cli)** - ⭐ 17
   ai-cli lets you go from zero to AI-powered in seconds in a safe, automated and tailored way.

2628. **[toolkit-mcp-server](https://github.com/cyanheads/toolkit-mcp-server)** - ⭐ 17
   A Model Context Protocol server providing LLM Agents with system utilities and tools, including IP geolocation, network diagnostics, system monitoring, cryptographic operations, and QR code generation.

2629. **[youtube-mcp-server](https://github.com/0GiS0/youtube-mcp-server)** - ⭐ 17
   Cómo crear MCP Servers y usarlos con GitHub Copilot Chat 🚀💻🤖

2630. **[help-scout-mcp-server](https://github.com/drewburchfield/help-scout-mcp-server)** - ⭐ 17
   MCP server for Help Scout - search conversations, threads, and inboxes with AI agents

2631. **[local_faiss_mcp](https://github.com/nonatofabio/local_faiss_mcp)** - ⭐ 17
   Local FAISS vector store as an MCP server – drop-in local RAG for Claude / Copilot / Agents.

2632. **[peta-core](https://github.com/dunialabs/peta-core)** - ⭐ 17
   Peta core: The Control Plane for MCP — secure vault, managed runtime, audit trail, and policy-based approvals.

2633. **[cmcp](https://github.com/RussellLuo/cmcp)** - ⭐ 17
   A command-line utility for interacting with MCP servers.

2634. **[short-url](https://github.com/fengzhongsen/short-url)** - ⭐ 17
   简单易用的短链接生成工具，完全开源、免费、无需登录，可私有化部署，链接永久有效！

2635. **[mcp-server-microsoft-paint](https://github.com/ghuntley/mcp-server-microsoft-paint)** - ⭐ 17

2636. **[html-to-markdown-mcp](https://github.com/levz0r/html-to-markdown-mcp)** - ⭐ 17
...
2637. **[datawrapper-mcp](https://github.com/palewire/datawrapper-mcp)** - ⭐ 17
   A Model Context Protocol (MCP) server for creating Datawrapper charts using AI assistants.

2638. **[it-tools-mcp](https://github.com/wrenchpilot/it-tools-mcp)** - ⭐ 17
...
2639. **[kratos-mcp](https://github.com/ceorkm/kratos-mcp)** - ⭐ 17
...
2640. **[muxi](https://github.com/ranaroussi/muxi)** - ⭐ 16
   An extensible AI agents framework

2641. **[mcp-email-client](https://github.com/gamalan/mcp-email-client)** - ⭐ 16
   Email Client as MCP Server. Feature: multiple configuration, more than just gmail

2642. **[mcp-oauth-proxy](https://github.com/obot-platform/mcp-oauth-proxy)** - ⭐ 16
   Oauth 2.1 proxy server that can autheticate client and proxy requests to mcp server

2643. **[oneshot](https://github.com/Destiner/oneshot)** - ⭐ 16
   Anthropic MCP client for macOS

2644. **[unity-mcp](https://github.com/wondeks/unity-mcp)** - ⭐ 16
   A Unity MCP server that allows MCP clients like Claude Desktop or Cursor to perform Unity Editor actions.

2645. **[CereBro](https://github.com/rob1997/CereBro)** - ⭐ 16
   A model-agnostic MCP Client-Server for .Net and Unity

2646. **[lite-mcp-client](https://github.com/sligter/lite-mcp-client)** - ⭐ 16
   Lite-MCP-Client是一个基于命令行的轻量级MCP客户端工具

2647. **[EasyMCP](https://github.com/mshojaei77/EasyMCP)** - ⭐ 16
...
2648. **[context-lens](https://github.com/cornelcroi/context-lens)** - ⭐ 16
...
2649. **[google-scholar-mcp](https://github.com/mochow13/google-scholar-mcp)** - ⭐ 16
   An MCP server for Google Scholar written in TypeScript with Streamable HTTP

2650. **[mcp-installer](https://github.com/joobisb/mcp-installer)** - ⭐ 16
   Simplifies the installation and management of MCP (Model Context Protocol) servers across different AI clients.

2651. **[appvector-mcp](https://github.com/Multivariate-AI-Inc/appvector-mcp)** - ⭐ 16
...
2654. **[ACP-MCP-Server](https://github.com/GongRzhe/ACP-MCP-Server)** - ⭐ 16
...
2655. **[mcp_client](https://github.com/app-appplayer/mcp_client)** - ⭐ 16

2656. **[protocols-io-mcp-server](https://github.com/hqn21/protocols-io-mcp-server)** - ⭐ 16
   An MCP server that enables MCP clients like Claude Desktop to interact with data from protocols.io.

2657. **[mcp-progressive-agentskill](https://github.com/cablate/mcp-progressive-agentskill)** - ⭐ 16
...
2658. **[Wwise-MCP](https://github.com/BilkentAudio/Wwise-MCP)** - ⭐ 16
...
2659. **[Agentic-MCP-Skill](https://github.com/cablate/Agentic-MCP-Skill)** - ⭐ 16
   Agentic-MCP, Progressive MCP client with three-layer lazy loading. Validates AgentSkills.io pattern for efficient token usage. Use MCP without pre-install & wasting full-loading

2660. **[mcp-chatbot](https://github.com/mctrinh/mcp-chatbot)** - ⭐ 16
...
2661. **[codeprism](https://github.com/rustic-ai/codeprism)** - ⭐ 16
...
2662. **[eraser-io-mcp-server](https://github.com/buck-0x/eraser-io-mcp-server)** - ⭐ 16
   A Python MCP (Model Context Protocol) server and CLI tool to render diagrams using the Eraser API.

2663. **[create-mcp](https://github.com/fefergrgrgrg/create-mcp)** - ⭐ 16
   CLI to set up and deploy MCP Servers to Cloudflare Workers in seconds. Just write TypeScript functions to make Cursor MCP tools.

2664. **[Augmented-Nature-UniProt-MCP-Server](https://github.com/Augmented-Nature/Augmented-Nature-UniProt-MCP-Server)** - ⭐ 16
   A comprehensive Model Context Protocol (MCP) server providing advanced access to the UniProt protein database. 

2665. **[mcp-chain-of-draft-prompt-tool](https://github.com/brendancopley/mcp-chain-of-draft-prompt-tool)** - ⭐ 16
   MCP prompt tool applying Chain-of-Draft (CoD) reasoning - BYOLLM

2666. **[pophive-mcp-server](https://github.com/Cicatriiz/pophive-mcp-server)** - ⭐ 16
...
2667. **[MCP-Analyzer](https://github.com/klara-research/MCP-Analyzer)** - ⭐ 15
   An MCP server to read MCP logs to debug directly inside the client

2668. **[mistr-agent](https://github.com/itisaevalex/mistr-agent)** - ⭐ 15
...
2669. **[mcp-server](https://github.com/HarperFast/mcp-server)** - ⭐ 15
   An MCP server providing an interface for MCP clients to access data within Harper.

2670. **[sveltekit-mcp-starter](https://github.com/axel-rock/sveltekit-mcp-starter)** - ⭐ 15

2671. **[MCP-Agent](https://github.com/CursorTouch/MCP-Agent)** - ⭐ 15
   Connect to any MCP servers using agents

2672. **[mcp-this](https://github.com/shane-kercheval/mcp-this)** - ⭐ 15
...
2673. **[github-repos-manager-mcp](https://github.com/kurdin/github-repos-manager-mcp)** - ⭐ 15
...
2674. **[substack-mcp](https://github.com/marcomoauro/substack-mcp)** - ⭐ 15
...
2675. **[QCX](https://github.com/QueueLab/QCX)** - ⭐ 15
   Language to Maps

2676. **[django-firebase-mcp](https://github.com/raghavdasila/django-firebase-mcp)** - ⭐ 15
...
2677. **[jenkins-mcp-enterprise](https://github.com/Jordan-Jarvis/jenkins-mcp-enterprise)** - ⭐ 15
...
2678. **[claude-server](https://github.com/davidteren/claude-server)** - ⭐ 15
...
2679. **[pinmeto-location-mcp](https://github.com/PinMeTo/pinmeto-location-mcp)** - ⭐ 15
   PinMeTo MCP server that enables users with authorized credentials to unlock their data 

2680. **[grok-faf-mcp](https://github.com/Wolfe-Jam/grok-faf-mcp)** - ⭐ 15
   First MCP server for Grok | FAST⚡️AF • URL-based AI context • Vercel-deployed

2681. **[mcp-server-amazon](https://github.com/rigwild/mcp-server-amazon)** - ⭐ 15
   🛍📦 Unofficial Amazon Model Context Protocol Server (MCP) - Search products and purchase directly from Claude AI! ✨

2682. **[awesome-dxt-mcp](https://github.com/MCPStar/awesome-dxt-mcp)** - ⭐ 15
...
2683. **[npm-search-mcp-server](https://github.com/btwiuse/npm-search-mcp-server)** - ⭐ 15
   MCP server for searching npm packages

2684. **[systemprompt-mcp-core](https://github.com/Ejb503/systemprompt-mcp-core)** - ⭐ 14
   The core MCP extension for Systemprompt MCP multimodal client

2685. **[Open-MCP-Client](https://github.com/GongRzhe/Open-MCP-Client)** - ⭐ 14
...
2686. **[signal-mcp-client](https://github.com/piebro/signal-mcp-client)** - ⭐ 14
   An MCP client that uses signal for sending and receiving messages.

2687. **[unity-editor-mcp](https://github.com/ozankasikci/unity-editor-mcp)** - ⭐ 14
   An MCP server and client for LLMs to interact with Unity Projects

2688. **[vite-plugin-mcp-client-tools](https://github.com/atesgoral/vite-plugin-mcp-client-tools)** - ⭐ 14
   Pluggable Vite MCP plugin that brings client-side tools to your existing Vite setup

2689. **[llm-sse-mcp-demo-2025](https://github.com/nlinhvu/llm-sse-mcp-demo-2025)** - ⭐ 14
...
2690. **[mcp-bundler](https://github.com/wrtnlabs/mcp-bundler)** - ⭐ 14
   Is the MCP configuration too complicated? You can easily share your own simplified setup!

2691. **[mcp-tui](https://github.com/msabramo/mcp-tui)** - ⭐ 14
   MCP host app w/ textual user interface, in Python

2692. **[mcp-client-and-proxy](https://github.com/appsecco/mcp-client-and-proxy)** - ⭐ 14
   A universal MCP client with proxying feature to interact with MCP Servers which support STDIO transport.

2693. **[mcp-turso-cloud](https://github.com/spences10/mcp-turso-cloud)** - ⭐ 14
...
2694. **[ntfy-mcp-server](https://github.com/cyanheads/ntfy-mcp-server)** - ⭐ 14
   An MCP (Model Context Protocol) server designed to interact with the ntfy push notification service. It enables LLMs and AI agents to send notifications to your devices with extensive customization options.

2695. **[hasmcp-ce](https://github.com/hasmcp/hasmcp-ce)** - ⭐ 14
   HasMCP Community Edition

2696. **[Unity-AI-Animation](https://github.com/IvanMurzak/Unity-AI-Animation)** - ⭐ 14
...
2697. **[Air-Quality-Trends-Analysis-Project](https://github.com/dyneth02/Air-Quality-Trends-Analysis-Project)** - ⭐ 14
...
2698. **[gh-mcp](https://github.com/shuymn/gh-mcp)** - ⭐ 14
...
2699. **[the-academy](https://github.com/im-knots/the-academy)** - ⭐ 14
   A Socratic dialogue engine for AI agents. 

2700. **[mcpterm](https://github.com/dwrtz/mcpterm)** - ⭐ 14
   An MCP tool server that provides stateful, TUI-compatible terminal sessions.

2701. **[mcp-koii](https://github.com/benjaminr/mcp-koii)** - ⭐ 14
   MCP Server for Teenage Engineering EP-133 KO-II

2702. **[work-memory-mcp](https://github.com/moontmsai/work-memory-mcp)** - ⭐ 14
   Never lose context again - persistent memory management system for AI-powered workflows across multiple tools

2703. **[mcp-server-python-template](https://github.com/sontallive/mcp-server-python-template)** - ⭐ 14
   This template provides a streamlined foundation for building Model Context Protocol (MCP) servers in Python. It's designed to make AI-assisted development of MCP tools easier and more efficient.

2704. **[mcpls](https://github.com/bug-ops/mcpls)** - ⭐ 14
   Universal MCP to LSP bridge - expose Language Server Protocol capabilities as MCP tools for AI agents

2705. **[mcp-graphql-forge](https://github.com/toolprint/mcp-graphql-forge)** - ⭐ 14
   MCP that can proxy any GraphQL API and expose graphql operations as mcp tools.

2706. **[spring-ai-mcp-deepseek](https://github.com/firefly0512/spring-ai-mcp-deepseek)** - ⭐ 13
   使用 Spring AI 整合 MCP 服务，包括 MCP server 和 deepseek client

2707. **[llamacppMCPClientDemo](https://github.com/brucepro/llamacppMCPClientDemo)** - ⭐ 13
   standalone react MCP client using SSE

2708. **[sample-multi-tenant-saas-mcp-server](https://github.com/aws-samples/sample-multi-tenant-saas-mcp-server)** - ⭐ 13
   Multi-Tenant remote MCP server with Amazon Cognito and remote client with Amazon Bedrock hosted on AWS

2709. **[mcp-chat-client](https://github.com/Ceeon/mcp-chat-client)** - ⭐ 13
   基于高德地图MCP服务的聊天客户端

2710. **[mcp-client-compatibility](https://github.com/tadata-org/mcp-client-compatibility)** - ⭐ 13

2711. **[mcp-client-laravel](https://github.com/RedberryProducts/mcp-client-laravel)** - ⭐ 13
...
2712. **[mcp-web-client](https://github.com/hemanth/mcp-web-client)** - ⭐ 13
   A web-based client for connecting to MCP servers with OAuth support

2713. **[mcp-client-for-weather-example](https://github.com/a-persimmons/mcp-client-for-weather-example)** - ⭐ 13
   一个MCP客户端实践：实现LLM调用天气MCP服务端查询天气的快速示例

2714. **[mcp-perplexity-server](https://github.com/PoliTwit1984/mcp-perplexity-server)** - ⭐ 13
...
2715. **[mcp-more](https://github.com/toosean/mcp-more)** - ⭐ 13
   A modern desktop application for managing Model Context Protocol (MCP) servers.

2716. **[MCP-Manager-GUI](https://github.com/gabrielbacha/MCP-Manager-GUI)** - ⭐ 13
   MCP Toggle is a simple GUI tool to help you manage MCP servers across clients seamlessly.

2717. **[easy-mcp-use](https://github.com/dforel/easy-mcp-use)** - ⭐ 13
...
2718. **[mcphawk](https://github.com/tech4242/mcphawk)** - ⭐ 13
...
2719. **[mcp-server-templates](https://github.com/Data-Everything/mcp-server-templates)** - ⭐ 13
   A flexible platform that provides Docker & Kubernetes backends, a lightweight CLI (mcpt), and client utilities for seamless MCP integration. Spin up servers from templates, route requests through a single endpoint with load balancing, and support both deployed (HTTP) and local (stdio) transports — all with sensible defaults and YAML-based configs.

2720. **[hoot](https://github.com/Portkey-AI/hoot)** - ⭐ 13
   MCP Testing Tool — Like Postman, but for the Model Context Protocol.

2721. **[mcp-test-client](https://github.com/crazyrabbitLTC/mcp-test-client)** - ⭐ 13
   MCP Test Client is a TypeScript testing utility for Model Context Protocol (MCP) servers.

2722. **[deep-research](https://github.com/troyhantech/deep-research)** - ⭐ 13
   A minimalist deep research framework for any OpenAI API compatible LLMs. 

2723. **[Frontapp-MCP](https://github.com/zqushair/Frontapp-MCP)** - ⭐ 13
   MCP server and client for Frontapp

2724. **[fusion-mcp-server](https://github.com/Joe-Spencer/fusion-mcp-server)** - ⭐ 13
...
2725. **[llama-nexus](https://github.com/LlamaEdge/llama-nexus)** - ⭐ 12
   A gateway service designed to manage and orchestrate OpenAI-compatible API servers with MCP support.

2726. **[mcp-client-langchain-ts](https://github.com/hideya/mcp-client-langchain-ts)** - ⭐ 12
   Simple MCP Client CLI Implementation Using LangChain ReAct Agent / TypeScript

2727. **[st_rag_mcp](https://github.com/digital-duck/st_rag_mcp)** - ⭐ 12
   MCP streamlit client with RAG support for tool search

2728. **[n8n-coolify-mcp-tools](https://github.com/wrediam/n8n-coolify-mcp-tools)** - ⭐ 12
...
2729. **[mcp-server-manager](https://github.com/infinitimeless/mcp-server-manager)** - ⭐ 12
   A tool to create, build, and manage MCP servers for use with Claude and other MCP clients

2730. **[MCP-Client-Server-for-agents](https://github.com/qmatteoq/MCP-Client-Server-for-agents)** - ⭐ 12
   This project demonstrates a Model Context Protocol (MCP) server and client implementation in .NET

2731. **[capture-mcp-server](https://github.com/blencorp/capture-mcp-server)** - ⭐ 12
...
2732. **[mcp-safe-run](https://github.com/ithena-one/mcp-safe-run)** - ⭐ 12
...
2736. **[SchemaPin](https://github.com/ThirdKeyAI/SchemaPin)** - ⭐ 12
   The SchemaPin protocol for cryptographically signing and verifying AI agent tool schemas to prevent supply-chain attacks.

2737. **[Tinvo](https://github.com/imxcstar/Tinvo)** - ⭐ 12
   LLM AI Client based on Blazor. (openai, chatgpt, llama, ollama, onnx, deepseekr1...)

2738. **[signoz-mcp-server](https://github.com/DrDroidLab/signoz-mcp-server)** - ⭐ 12
   Connect your Signoz Instance with Cursor, Claude Desktop or any other MCP Compatible Client

2739. **[gemma-mcp](https://github.com/monatis/gemma-mcp)** - ⭐ 12
   MCP Client for Gemma-3

2740. **[context-kit](https://github.com/eyalzh/context-kit)** - ⭐ 12
   A CLI tool and MCP client, used to create spec files for AI coding agents with context baked in

2741. **[MCP-Platform](https://github.com/Data-Everything/MCP-Platform)** - ⭐ 12
   A flexible platform that provides Docker & Kubernetes backends, a lightweight CLI (mcpt), and client utilities for seamless MCP integration. Spin up servers from templates, route requests through a single endpoint with load balancing, and support both deployed (HTTP) and local (stdio) transports — all with sensible defaults and YAML-based configs

2742. **[codepilot](https://github.com/rohittcodes/codepilot)** - ⭐ 12
   A multi-agent CLI tool powered by Swarms-rs and Composio

2743. **[mlb-mcp](https://github.com/etweisberg/mlb-mcp)** - ⭐ 12
   MCP server for advanced baseball analytics (statcast, fangraphs, baseball reference, mlb stats API) with client demo 

2744. **[mcp_client_rust](https://github.com/darinkishore/mcp_client_rust)** - ⭐ 11

2745. **[mcp-client](https://github.com/EuclideanAI/mcp-client)** - ⭐ 11
...
2746. **[MCP_Client](https://github.com/andrewdeng318/MCP_Client)** - ⭐ 11

2747. **[mcp-spotify-player](https://github.com/vsaez/mcp-spotify-player)** - ⭐ 11
   MCP server to manage Spotify from MCP clients

2748. **[ckan-mcp-server](https://github.com/ondics/ckan-mcp-server)** - ⭐ 11
...
2749. **[trebuchet](https://github.com/fuzzball-muck/trebuchet)** - ⭐ 11
   A MUD/MUCK/MUSH chat client with MCP/GUI support.

2750. **[mcp-wikipedia](https://github.com/algonacci/mcp-wikipedia)** - ⭐ 11
   MCP server to give client the ability to access Wikipedia pages

2751. **[systemprompt-mcp-gmail](https://github.com/Ejb503/systemprompt-mcp-gmail)** - ⭐ 11
...
2752. **[mcp-client-app](https://github.com/RegiByte/mcp-client-app)** - ⭐ 11
   A mcp client chat application built for learning purposes

2753. **[mcp-browser-automation](https://github.com/hrmeetsingh/mcp-browser-automation)** - ⭐ 11
   Model Context Protocol based AI Agent that runs a browser from Claude desktop

2754. **[simple-nodejs-mcp-client](https://github.com/sawa-zen/simple-nodejs-mcp-client)** - ⭐ 11
...
2755. **[ggMCP4VSCode](https://github.com/n2ns/ggMCP4VSCode)** - ⭐ 11
   Google Gemini Model Context Protocol (MCP) Client for VS Code. Connect AI assistants to local context & tools.

2756. **[goldrush-mcp-server](https://github.com/covalenthq/goldrush-mcp-server)** - ⭐ 11
...
2757. **[langchain-mcp-tools-ts-usage](https://github.com/hideya/langchain-mcp-tools-ts-usage)** - ⭐ 11
   MCP Tools Usage From LangChain ReAct Agent / Example in TypeScript

2758. **[mcp-chat-widget](https://github.com/aimdoc-ai/mcp-chat-widget)** - ⭐ 11
...
2759. **[muster](https://github.com/giantswarm/muster)** - ⭐ 11
   MCP tool management and workflow proxy

2760. **[claude_autoapprove](https://github.com/PyneSys/claude_autoapprove)** - ⭐ 11
   Autoapprove support for claude

2761. **[oauth-callback](https://github.com/kriasoft/oauth-callback)** - ⭐ 11
   Lightweight OAuth 2.0 authorization code capture for CLI tools & desktop   apps. Works with Node.js, Deno, Bun. MCP SDK ready.

2762. **[create-mcp-server-kit](https://github.com/Epi-1120/create-mcp-server-kit)** - ⭐ 11
   Scaffold a production-ready Model Context Protocol (MCP) server in seconds.

2763. **[mcp-server-gemini-pro](https://github.com/gurveeer/mcp-server-gemini-pro)** - ⭐ 11
...
2764. **[langchain-mcp-client](https://github.com/datalayer/langchain-mcp-client)** - ⭐ 10
   🦜🔗 LangChain Model Context Protocol (MCP) Client

2765. **[mcp-client-langchain-py](https://github.com/hideya/mcp-client-langchain-py)** - ⭐ 10
   Simple MCP Client CLI Implementation Using LangChain ReAct Agent / Python

2766. **[openalgo-mcp](https://github.com/marketcalls/openalgo-mcp)** - ⭐ 10
   Documentation

2767. **[mcp_client_openai](https://github.com/liangpn/mcp_client_openai)** - ⭐ 10
   适配Openai SDK构建MCP Client

2768. **[mcp-serverman](https://github.com/benhaotang/mcp-serverman)** - ⭐ 10
   a cli/mcp server tool for managing mcp server json config file with version control, profiles and multi-client support

2769. **[py-mcp-sse](https://github.com/jayliangdl/py-mcp-sse)** - ⭐ 10
   MCP Client 与 MCP Server基于SSE方式的样例实现（Python版本）

2770. **[mcpkit](https://github.com/cybertheory/mcpkit)** - ⭐ 10
   Easy to use Official MCP Registry Client UI. npx @cybertheory/mcpkit

2771. **[AIFoundry-MCPConnector-FabricGraphQL](https://github.com/LazaUK/AIFoundry-MCPConnector-FabricGraphQL)** - ⭐ 10
...
2772. **[server](https://github.com/mcpfinder/server)** - ⭐ 10
...
2773. **[kanboard-mcp](https://github.com/ChristianJStarr/kanboard-mcp)** - ⭐ 10
...
2774. **[emotion_ai](https://github.com/angrysky56/emotion_ai)** - ⭐ 10
...
2775. **[mcp-express-adapter](https://github.com/Moe03/mcp-express-adapter)** - ⭐ 10
   Run multiple MCP clients on a NodeJS Express server (adapter/middleware)

2776. **[mcp-trace](https://github.com/zabirauf/mcp-trace)** - ⭐ 10
   A TUI to probe the calls between MCP client and server

2777. **[semantictool](https://github.com/promptmesh/semantictool)** - ⭐ 10
   tool management service for performing vector tool calling at scale.

2778. **[mcp-server-blog](https://github.com/portal-labs-infrastructure/mcp-server-blog)** - ⭐ 10
   Example of a MCP implementation using TypeScript and OAuth.

2779. **[unity-mcp-template](https://github.com/dunward/unity-mcp-template)** - ⭐ 10
   Simple template project for controlling Unity via MCP

2780. **[davinci-mcp-professional](https://github.com/Positronikal/davinci-mcp-professional)** - ⭐ 10
...
2781. **[awesome-mcp-hardware](https://github.com/beriberikix/awesome-mcp-hardware)** - ⭐ 10
   Awesome list of MCP servers for interacting with hardware and the physical world.

2782. **[polaris](https://github.com/octu0/polaris)** - ⭐ 10
   Distributed AI Agent Framework

2783. **[mcp-agent-proxy](https://github.com/mashh-lab/mcp-agent-proxy)** - ⭐ 10
   An MCP server that exposes local and remote agents across different servers as MCP tools.

2784. **[amazon-seller-mcp](https://github.com/enginterzi/amazon-seller-mcp)** - ⭐ 10
...
2785. **[auto-mcp-client](https://github.com/down-to-earth1994/auto-mcp-client)** - ⭐ 10
...
2786. **[programmatic-tool-calling-ai-sdk](https://github.com/cameronking4/programmatic-tool-calling-ai-sdk)** - ⭐ 10
...
1. **[chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat)** - ⭐ 40,650
   基于大模型搭建的聊天机器人，同时支持 微信公众号、企业微信应用、飞书、钉钉 等接入，可选择ChatGPT/Claude/DeepSeek/文心一言/讯飞星火/通义千问/ Gemini/GLM-4/Kimi/LinkAI，能处理文本、语音和图片，访问操作系统和互联网，支持基于自有知识库进行定制企业智能客服。

2. **[agentscope](https://github.com/agentscope-ai/agentscope)** - ⭐ 15,559
   AgentScope: Agent-Oriented Programming for Building LLM Applications

3. **[bytebot](https://github.com/bytebot-ai/bytebot)** - ⭐ 10,236
   Bytebot is a self-hosted AI desktop agent that automates computer tasks through natural language commands, operating within a containerized Linux desktop environment.

4. **[valuecell](https://github.com/ValueCell-ai/valuecell)** - ⭐ 8,212
   ValueCell is a community-driven, multi-agent platform for financial applications.

5. **[deepchat](https://github.com/ThinkInAIXYZ/deepchat)** - ⭐ 5,361
   🐬DeepChat - A smart assistant that connects powerful AI to your personal world

6. **[ruoyi-ai](https://github.com/ageerle/ruoyi-ai)** - ⭐ 4,670
   RuoYi AI 是一个全栈式 AI 开发平台，旨在帮助开发者快速构建和部署个性化的 AI 应用。

7. **[koog](https://github.com/JetBrains/koog)** - ⭐ 3,632
...
19. **[self-dify](https://github.com/datawhalechina/self-dify)** - ⭐ 290
...
26. **[airbyte-agent-connectors](https://github.com/airbytehq/airbyte-agent-connectors)** - ⭐ 94
...
1. **[n8n](https://github.com/n8n-io/n8n)** - ⭐ 169,660
   Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.

2. **[kong](https://github.com/Kong/kong)** - ⭐ 42,553
   🦍 The Cloud-Native Gateway for APIs & AI

3. **[LocalAI](https://github.com/mudler/LocalAI)** - ⭐ 42,123
   :robot: The free, Open Source alternative to OpenAI, Claude and others. Self-hosted and local-first. Drop-in replacement for OpenAI,  running on consumer-grade hardware. No GPU required. Runs gguf, transformers, diffusers and many more. Features: Generate Text, MCP, Audio, Video, Images, Voice Cloning, Distributed, P2P and decentralized inference

4. **[FastGPT](https://github.com/labring/FastGPT)** - ⭐ 26,903
   FastGPT is a knowledge-based platform built on the LLMs, offers a comprehensive suite of out-of-the-box capabilities such as data processing, RAG retrieval, and visual AI workflow orchestration, letting you easily develop and deploy complex question-answering systems without the need for extensive setup or configuration.

5. **[kratos](https://github.com/go-kratos/kratos)** - ⭐ 25,351
   Your ultimate Go microservices framework for the cloud-native era.

6. **[excelize](https://github.com/qax-os/excelize)** - ⭐ 20,198
   Go language library for reading and writing Microsoft Excel™ (XLAM / XLSM / XLSX / XLTM / XLTX) spreadsheets

7. **[plate](https://github.com/udecode/plate)** - ⭐ 15,777
   Rich-text editor with AI, MCP, and shadcn/ui

8. **[AstrBot](https://github.com/AstrBotDevs/AstrBot)** - ⭐ 15,045
...
11. **[ui](https://github.com/creativetimofficial/ui)** - ⭐ 11,456
   Open-source components, blocks, and AI agents designed to speed up your workflow. Import them seamlessly into your favorite tools through Registry and MCPs.

12. **[note-gen](https://github.com/codexu/note-gen)** - ⭐ 10,539
   A cross-platform Markdown AI note-taking software.

13. **[langchain4j](https://github.com/langchain4j/langchain4j)** - ⭐ 10,419
   LangChain4j is an open-source Java library that simplifies the integration of LLMs into Java applications through a unified API, providing access to popular LLMs and vector databases. It makes implementing RAG, tool calling (including support for MCP), and agents easy. LangChain4j integrates seamlessly with various enterprise Java frameworks.

14. **[astron-agent](https://github.com/iflytek/astron-agent)** - ⭐ 8,648
   Enterprise-grade, commercial-friendly agentic workflow platform for building next-generation SuperAgents.

15. **[OpenMetadata](https://github.com/open-metadata/OpenMetadata)** - ⭐ 8,444
   OpenMetadata is a unified metadata platform for data discovery, data observability, and data governance powered by a central metadata repository, in-depth column level lineage, and seamless team collaboration.

16. **[Upsonic](https://github.com/Upsonic/Upsonic)** - ⭐ 7,744
   Agent Framework For Fintech and Banks

17. **[lamda](https://github.com/firerpa/lamda)** - ⭐ 7,551
    The most powerful Android RPA agent framework, next generation of mobile automation robots.

18. **[53AIHub](https://github.com/53AI/53AIHub)** - ⭐ 7,407
...
19. **[adk-go](https://github.com/google/adk-go)** - ⭐ 6,670
   An open-source, code-first Go toolkit for building, evaluating, and deploying sophisticated AI agents with flexibility and control.

20. **[Viper](https://github.com/FunnyWolf/Viper)** - ⭐ 4,850
...
23. **[nexent](https://github.com/ModelEngine-Group/nexent)** - ⭐ 4,119
...
24. **[ag2](https://github.com/ag2ai/ag2)** - ⭐ 4,056
   AG2 (formerly AutoGen): The Open-Source AgentOS. Join us at: https://discord.gg/sNGSwQME3x

25. **[kubefwd](https://github.com/txn2/kubefwd)** - ⭐ 4,010
   Bulk port forwarding Kubernetes services for local development.

26. **[Yuxi-Know](https://github.com/xerrors/Yuxi-Know)** - ⭐ 3,926
...
27. **[Continuous-Claude-v3](https://github.com/parcadei/Continuous-Claude-v3)** - ⭐ 3,279
   Context management for Claude Code. Hooks maintain state via ledgers and handoffs. MCP execution without context pollution. Agent orchestration with isolated context windows.

28. **[manifest](https://github.com/mnfst/manifest)** - ⭐ 3,272
   A shadcn/ui library for building ChatGPT Apps

29. **[semantic-router](https://github.com/vllm-project/semantic-router)** - ⭐ 2,862
...
31. **[ultracite](https://github.com/haydenbleasel/ultracite)** - ⭐ 2,565
   A highly opinionated, zero-configuration linter and formatter.

32. **[harbor](https://github.com/av/harbor)** - ⭐ 2,305
   Effortlessly run LLM backends, APIs, frontends, and services with one command.

33. **[amazon-q-developer-cli](https://github.com/aws/amazon-q-developer-cli)** - ⭐ 1,878
   ✨ Agentic chat experience in your terminal. Build applications using natural language.

34. **[generative-ai](https://github.com/genieincodebottle/generative-ai)** - ⭐ 1,740
   Comprehensive resources on Generative AI, including a detailed roadmap, projects, use cases, interview preparation, and coding preparation.

35. **[MinecraftDev](https://github.com/minecraft-dev/MinecraftDev)** - ⭐ 1,698
   Plugin for IntelliJ IDEA that gives special support for Minecraft modding projects.

36. **[easy-vibe](https://github.com/datawhalechina/easy-vibe)** - ⭐ 1,697
...
38. **[mcpelauncher-manifest](https://github.com/minecraft-linux/mcpelauncher-manifest)** - ⭐ 1,420
   The main repository for the Linux and Mac OS Bedrock edition Minecraft launcher.

39. **[d2mcpp](https://github.com/mcpp-community/d2mcpp)** - ⭐ 1,401
...
41. **[NagaAgent](https://github.com/Xxiii8322766509/NagaAgent)** - ⭐ 1,312
   A simple yet powerful agent framework for personal assistants, designed to enable intelligent interaction, multi-agent collaboration, and seamless tool integration.

42. **[paperdebugger](https://github.com/PaperDebugger/paperdebugger)** - ⭐ 1,280
   A Plugin-Based Multi-Agent System for In-Editor Academic Writing, Review, and Editing

43. **[awesome-hacking-lists](https://github.com/taielab/awesome-hacking-lists)** - ⭐ 1,267
   A curated collection of top-tier penetration testing tools and productivity utilities across multiple domains. Join us to explore, contribute, and enhance your hacking toolkit!

44. **[BuildingAI](https://github.com/BidingCC/BuildingAI)** - ⭐ 1,194
...
45. **[langchain4j-aideepin](https://github.com/moyangzhan/langchain4j-aideepin)** - ⭐ 1,114
...
48. **[AIPex](https://github.com/AIPexStudio/AIPex)** - ⭐ 1,012
...
49. **[zen](https://github.com/sheshbabu/zen)** - ⭐ 1,008
...
51. **[open-trading-api](https://github.com/koreainvestment/open-trading-api)** - ⭐ 974
...
57. **[JiwuChat](https://github.com/KiWi233333/JiwuChat)** - ⭐ 692
...
59. **[infio-copilot](https://github.com/infiolab/infio-copilot)** - ⭐ 623
   A Cursor-inspired AI assistant for Obsidian that offers smart autocomplete and interactive chat with your selected notes

60. **[cloudsword](https://github.com/wgpsec/cloudsword)** - ⭐ 582
   一款帮助云租户发现和测试云上风险、增强云上防护能力的综合性开源工具

61. **[chunkhound](https://github.com/chunkhound/chunkhound)** - ⭐ 573
   Local first codebase intelligence

62. **[WHartTest](https://github.com/MGdaasLab/WHartTest)** - ⭐ 551
...
63. **[marmot](https://github.com/marmotdata/marmot)** - ⭐ 491
...
64. **[AIWriteX](https://github.com/iniwap/AIWriteX)** - ⭐ 459
   AIWriteX是基于CrewAI、AIForge的新一代智能内容创作平台，从微信公众号自动化工具起步，正在重新定义AI辅助内容创作的边界，融合"AI+创意+搜索+借鉴"四重能力，多种超绝玩法，内容创作充满无限可能。

65. **[IDA-NO-MCP](https://github.com/P4nda0s/IDA-NO-MCP)** - ⭐ 455
   Say goodbye to the complex, verbose, and laggy interaction mode of IDA Pro MCP

66. **[LightAgent](https://github.com/wanxingai/LightAgent)** - ⭐ 453
...
67. **[ai-code-helper](https://github.com/liyupi/ai-code-helper)** - ⭐ 431
...
68. **[LightAgent](https://github.com/wxai-space/LightAgent)** - ⭐ 430
   LightAgent: Lightweight AI agent framework with memory, tools & tree-of-thought. Supports multi-agent collaboration, self-learning, and major LLMs (OpenAI/DeepSeek/Qwen). Open-source with MCP/SSE protocol integration.

69. **[browser-operator-core](https://github.com/BrowserOperator/browser-operator-core)** - ⭐ 417
   Browser Operator - The AI browser with built in Multi-Agent platform! Open source alternative to ChatGPT Atlas, Perplexity Comet, Dia and Microsoft CoPilot Edge Browser

70. **[amical](https://github.com/amicalhq/amical)** - ⭐ 405
...
72. **[mcp-cn-a-stock](https://github.com/elsejj/mcp-cn-a-stock)** - ⭐ 387
   这是一个为大模型提供 A 股数据的的 MCP(Model Content Protocol) 服务。

73. **[mcpi](https://github.com/martinohanlon/mcpi)** - ⭐ 384
   Minecraft: Pi Edition API Python Library

74. **[volcano-sdk](https://github.com/Kong/volcano-sdk)** - ⭐ 383
   🌋 Build AI agents that seamlessly combine LLM reasoning with real-world actions via MCP tools — in just a few lines of TypeScript.

75. **[chatlog_alpha](https://github.com/teest114514/chatlog_alpha)** - ⭐ 382
...
78. **[bridle](https://github.com/neiii/bridle)** - ⭐ 352
   TUI / CLI config manager for agentic harnesses (Amp, Claude Code, Opencode, Goose, Copilot CLI)

79. **[graphrag-toolkit](https://github.com/awslabs/graphrag-toolkit)** - ⭐ 346
...
82. **[UE5-MCP](https://github.com/VedantRGosavi/UE5-MCP)** - ⭐ 332
...
85. **[ios-simulator-skill](https://github.com/conorluddy/ios-simulator-skill)** - ⭐ 321
...
90. **[building-an-agentic-system](https://github.com/gerred/building-an-agentic-system)** - ⭐ 273
...
96. **[oreilly-ai-agents](https://github.com/sinanuozdemir/oreilly-ai-agents)** - ⭐ 240
   An introduction to the world of AI Agents

97. **[MCPConfig](https://github.com/MinecraftForge/MCPConfig)** - ⭐ 239
...
101. **[mcpfp](https://github.com/MauritsWilke/mcpfp)** - ⭐ 221
   A website to generate Minecraft profile pictures

102. **[tool-ui](https://github.com/assistant-ui/tool-ui)** - ⭐ 218
...
104. **[McPicker-iOS](https://github.com/kmcgill88/McPicker-iOS)** - ⭐ 215
   McPicker is a customizable, closure driven UIPickerView drop-in solution with animations that is rotation ready.

105. **[mcpat](https://github.com/HewlettPackard/mcpat)** - ⭐ 209
...
109. **[pydantic-deepagents](https://github.com/vstorm-co/pydantic-deepagents)** - ⭐ 191
...
110. **[MCP-919](https://github.com/Marcelektro/MCP-919)** - ⭐ 190
   Fully working & decompiled MCP for Minecraft 1.8.9 

111. **[MCPScan](https://github.com/antgroup/MCPScan)** - ⭐ 189
...
114. **[cupcake](https://github.com/eqtylab/cupcake)** - ⭐ 162
   A native policy enforcement layer for AI coding agents. Built on OPA/Rego.

115. **[codecompanion-history.nvim](https://github.com/ravitemer/codecompanion-history.nvim)** - ⭐ 159
...
117. **[agentic-ai-systems](https://github.com/ThibautMelen/agentic-ai-systems)** - ⭐ 137
   🐔 Agentic systems explained with chickens. Workflows, agents & orchestration made simple. Mermaid diagrams included

118. **[ZenOps](https://github.com/opsre/ZenOps)** - ⭐ 136
   🧘 通过钉钉、飞书、企微智能机器人用自然语言查询运维资源的工具。

119. **[toon-java](https://github.com/toon-format/toon-java)** - ⭐ 133
...
128. **[5-Day-AI-Agents-Intensive-Course-with-Google](https://github.com/sdivyanshu90/5-Day-AI-Agents-Intensive-Course-with-Google)** - ⭐ 107
   5-Day Gen AI Intensive Course with Google

129. **[x-mcp](https://github.com/xpzouying/x-mcp)** - ⭐ 107
   x for mcp
...
132. **[5-Day-AI-Agents-Intensive-Course-with-Google](https://github.com/anxiong2025/5-Day-AI-Agents-Intensive-Course-with-Google)** - ⭐ 93
   谷歌5天AI Agents强化课程
...
148. **[awesome-mcp-list](https://github.com/notedit/awesome-mcp-list)** - ⭐ 28
   Awesome Model Context Protocol Service List

149. **[adk-mcp-gemma3](https://github.com/arjunprabhulal/adk-mcp-gemma3)** - ⭐ 26
   Build AI Agent using Google ADK , MCP and Gemma 3 model

150. **[Wireshark_mcp](https://github.com/jayimu/Wireshark_mcp)** - ⭐ 26
...
151. **[codai](https://github.com/codai-agent/codai)** - ⭐ 24
...
152. **[hands-on-ai-building-ai-agents-with-model-context-protocol-mcp-and-agent2agent-a2a-6055298](https://github.com/LinkedInLearning/hands-on-ai-building-ai-agents-with-model-context-protocol-mcp-and-agent2agent-a2a-6055298)** - ⭐ 24
...
153. **[cursor-like-pro](https://github.com/gifflet/cursor-like-pro)** - ⭐ 17
   Cursor IDE like Pro

154. **[MCPStack](https://github.com/MCP-Pipeline/MCPStack)** - ⭐ 16
   Stack & Orchestrate MCP Tools — The Scikit-Learn-Pipeline Way , For LLMs

155. **[n8n-operator](https://github.com/jakub-k-slys/n8n-operator)** - ⭐ 15
   Kubernetes Operator for N8n, a fair-code workflow automation platform with native AI capabilities.

156. **[ai-tools](https://github.com/elsejj/ai-tools)** - ⭐ 13
   ai-tools  call your llm based tools through shortcut (ctrl-q) in any application

157. **[feather_wand_agent](https://github.com/QAInsights/feather_wand_agent)** - ⭐ 13
...
1. **[modelcontextprotocol](https://github.com/modelcontextprotocol/modelcontextprotocol)** - ⭐ 6,923
   Specification and documentation for the Model Context Protocol

2. **[ai-guide](https://github.com/liyupi/ai-guide)** - ⭐ 3,676
...
4. **[LLM-Agents-Ecosystem-Handbook](https://github.com/oxbshw/LLM-Agents-Ecosystem-Handbook)** - ⭐ 360
