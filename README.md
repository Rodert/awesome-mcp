...
1. **[dify](https://github.com/langgenius/dify)** - ⭐ 124,676
   Production-ready platform for agentic workflow development.

2. **[open-webui](https://github.com/open-webui/open-webui)** - ⭐ 119,692
   User-friendly AI Interface (Supports Ollama, OpenAI API, ...)

3. **[gemini-cli](https://github.com/google-gemini/gemini-cli)** - ⭐ 89,674
   An open-source AI agent that brings the power of Gemini directly into your terminal.

4. **[awesome-mcp-servers](https://github.com/punkpeye/awesome-mcp-servers)** - ⭐ 78,109
   A collection of MCP servers.

5. **[netdata](https://github.com/netdata/netdata)** - ⭐ 77,236
   The fastest path to AI-powered full stack observability, even for lean teams.

6. **[servers](https://github.com/modelcontextprotocol/servers)** - ⭐ 75,505
   Model Context Protocol Servers

7. **[ragflow](https://github.com/infiniflow/ragflow)** - ⭐ 70,874
   RAGFlow is a leading open-source Retrieval-Augmented Generation (RAG) engine that fuses cutting-edge RAG with Agent capabilities to create a superior context layer for LLMs

8. **[lobe-chat](https://github.com/lobehub/lobe-chat)** - ⭐ 69,780
...
9. **[anything-llm](https://github.com/Mintplex-Labs/anything-llm)** - ⭐ 52,901
   The all-in-one Desktop & Docker AI application with built-in RAG, AI agents, No-code agent builder, MCP compatibility,  and more.

10. **[JeecgBoot](https://github.com/jeecgboot/JeecgBoot)** - ⭐ 44,910
...
11. **[TrendRadar](https://github.com/sansan0/TrendRadar)** - ⭐ 42,230
...
12. **[context7](https://github.com/upstash/context7)** - ⭐ 40,865
   Context7 MCP Server -- Up-to-date code documentation for LLMs and AI code editors

13. **[mindsdb](https://github.com/mindsdb/mindsdb)** - ⭐ 38,167
   Query Engine for AI - The only MCP Server you'll ever need

14. **[cherry-studio](https://github.com/CherryHQ/cherry-studio)** - ⭐ 37,257
   🍒 Cherry Studio is a desktop client that supports for multiple LLM providers.

15. **[LibreChat](https://github.com/danny-avila/LibreChat)** - ⭐ 32,837
   Enhanced ChatGPT Clone: Features Agents, MCP, DeepSeek, Anthropic, AWS, OpenAI, Responses API, Azure, Groq, o1, GPT-5, Mistral, OpenRouter, Vertex AI, Gemini, Artifacts, AI model switching, message search, Code Interpreter, langchain, DALL-E-3, OpenAPI Actions, Functions, Secure Multi-User Auth, Presets, open-source for self-hosting. Active.

16. **[1Panel](https://github.com/1Panel-dev/1Panel)** - ⭐ 32,706
   🔥 1Panel provides an intuitive web interface and MCP Server to manage websites, files, containers, databases, and LLMs on a Linux server.

17. **[nacos](https://github.com/alibaba/nacos)** - ⭐ 32,483
   an easy-to-use dynamic service discovery, configuration and service management platform for building AI cloud native applications.

18. **[PDFMathTranslate](https://github.com/PDFMathTranslate/PDFMathTranslate)** - ⭐ 31,030
   [EMNLP 2025 Demo] PDF scientific paper translation with preserved formats - 基于 AI 完整保留排版的 PDF 文档全文双语翻译，支持 Google/DeepL/Ollama/OpenAI 等服务，提供 CLI/GUI/MCP/Docker/Zotero

19. **[composio](https://github.com/ComposioHQ/composio)** - ⭐ 26,263
   Composio equips your AI agents & LLMs with 100+ high-quality integrations via function calling

20. **[github-mcp-server](https://github.com/github/github-mcp-server)** - ⭐ 25,629
   GitHub's official MCP Server

21. **[goose](https://github.com/block/goose)** - ⭐ 25,447
   an open source, extensible AI agent that goes beyond code suggestions - install, execute, edit, and test with any LLM

22. **[playwright-mcp](https://github.com/microsoft/playwright-mcp)** - ⭐ 25,075
   Playwright MCP server

23. **[gpt-researcher](https://github.com/assafelovic/gpt-researcher)** - ⭐ 24,713
   An LLM agent that conducts deep research (local and web) on any given topic and generates a long report with citations.

24. **[ai-engineering-hub](https://github.com/patchy631/ai-engineering-hub)** - ⭐ 24,598
   In-depth tutorials on LLMs, RAGs and real-world AI agent applications.

25. **[xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)** - ⭐ 22,887
   An MCP-based chatbot | 一个基于MCP的聊天机器人

26. **[fastmcp](https://github.com/jlowin/fastmcp)** - ⭐ 21,684
   🚀 The fast, Pythonic way to build MCP servers and clients

27. **[repomix](https://github.com/yamadashy/repomix)** - ⭐ 20,967
   📦 Repomix is a powerful tool that packs your entire repository into a single, AI-friendly file. Perfect for when you need to feed your codebase to Large Language Models (LLMs) or other AI tools like Claude, ChatGPT, DeepSeek, Perplexity, Gemini, Gemma, Llama, Grok, and more.

28. **[python-sdk](https://github.com/modelcontextprotocol/python-sdk)** - ⭐ 20,949
   The official Python SDK for Model Context Protocol servers and clients

29. **[UI-TARS-desktop](https://github.com/bytedance/UI-TARS-desktop)** - ⭐ 20,390
   The Open-Source Multimodal AI Agent Stack: Connecting Cutting-Edge AI Models and Agent Infra

30. **[activepieces](https://github.com/activepieces/activepieces)** - ⭐ 20,213
   AI Agents & MCPs & AI Workflow Automation • (~400 MCP servers for AI agents) • AI Automation / AI Agent with MCPs • AI Workflows & AI Agents • MCPs for AI Agents

31. **[MaxKB](https://github.com/1Panel-dev/MaxKB)** - ⭐ 19,712
   🔥 MaxKB is an open-source platform for building enterprise-grade agents.  强大易用的开源企业级智能体平台。

32. **[mastra](https://github.com/mastra-ai/mastra)** - ⭐ 19,115
   From the team behind Gatsby, Mastra is a framework for building AI-powered applications and agents with a modern TypeScript stack.

33. **[chrome-devtools-mcp](https://github.com/ChromeDevTools/chrome-devtools-mcp)** - ⭐ 18,590
   Chrome DevTools for coding agents

34. **[agentic](https://github.com/transitive-bullshit/agentic)** - ⭐ 18,079
   Your API ⇒ Paid MCP. Instantly.

35. **[serena](https://github.com/oraios/serena)** - ⭐ 18,071
   A powerful coding agent toolkit providing semantic retrieval and editing capabilities (MCP server & other integrations)

36. **[blender-mcp](https://github.com/ahujasid/blender-mcp)** - ⭐ 14,774

37. **[mcp-for-beginners](https://github.com/microsoft/mcp-for-beginners)** - ⭐ 13,946
   This open-source curriculum introduces the fundamentals of Model Context Protocol (MCP) through real-world, cross-language examples in .NET, Java, TypeScript, JavaScript, Rust and Python. Designed for developers, it focuses on practical techniques for building modular, scalable, and secure AI workflows from session setup to service orchestration.

38. **[filestash](https://github.com/mickael-kerjean/filestash)** - ⭐ 13,340
   :file_folder: What Dropbox should have been if it was based on SFTP, S3, FTP, WebDAV, Git, and more

39. **[trigger.dev](https://github.com/triggerdotdev/trigger.dev)** - ⭐ 13,203
   Trigger.dev – build and deploy fully‑managed AI agents and workflows

40. **[Qwen-Agent](https://github.com/QwenLM/Qwen-Agent)** - ⭐ 12,840
   Agent framework and applications built upon Qwen>=3.0, featuring Function Calling, MCP, Code Interpreter, RAG, Chrome extension, etc.

41. **[Figma-Context-MCP](https://github.com/GLips/Figma-Context-MCP)** - ⭐ 12,398
   MCP server to provide Figma layout information to AI coding agents like Cursor

42. **[genai-toolbox](https://github.com/googleapis/genai-toolbox)** - ⭐ 12,169
   MCP Toolbox for Databases is an open source MCP server for databases.

43. **[fastapi_mcp](https://github.com/tadata-org/fastapi_mcp)** - ⭐ 11,337
   Expose your FastAPI endpoints as Model Context Protocol (MCP) tools, with Auth!

44. **[n8n-mcp](https://github.com/czlonkowski/n8n-mcp)** - ⭐ 11,316
   A MCP for Claude Desktop / Claude Code / Windsurf / Cursor to build n8n workflows for you 

45. **[typescript-sdk](https://github.com/modelcontextprotocol/typescript-sdk)** - ⭐ 11,198
   The official TypeScript SDK for Model Context Protocol servers and clients

46. **[claude-flow](https://github.com/ruvnet/claude-flow)** - ⭐ 11,111
...
47. **[pal-mcp-server](https://github.com/BeehiveInnovations/pal-mcp-server)** - ⭐ 10,740
   The power of Claude Code / GeminiCLI / CodexCLI + [Gemini / OpenAI / OpenRouter / Azure / Grok / Ollama / Custom Model / All Of The Above] working as one.

48. **[nginx-ui](https://github.com/0xJacky/nginx-ui)** - ⭐ 10,319
   Yet another WebUI for Nginx

49. **[gateway](https://github.com/Portkey-AI/gateway)** - ⭐ 10,197
   A blazing fast AI Gateway with integrated guardrails. Route to 200+ LLMs, 50+ AI Guardrails with 1 fast & friendly API.

50. **[zen-mcp-server](https://github.com/BeehiveInnovations/zen-mcp-server)** - ⭐ 9,890
   The power of Claude Code / GeminiCLI / CodexCLI + [Gemini / OpenAI / OpenRouter / Azure / Grok / Ollama / Custom Model / All Of The Above] working as one.

51. **[mcp-chrome](https://github.com/hangwin/mcp-chrome)** - ⭐ 9,770
   Chrome MCP Server is a Chrome extension-based Model Context Protocol (MCP) server that exposes your Chrome browser functionality to AI assistants like Claude, enabling complex browser automation, content analysis, and semantic search.

52. **[XHS-Downloader](https://github.com/JoeanAmier/XHS-Downloader)** - ⭐ 9,626
   小红书（XiaoHongShu、RedNote）链接提取/作品采集工具：提取账号发布、收藏、点赞、专辑作品链接；提取搜索结果作品、用户链接；采集小红书作品信息；提取小红书作品下载地址；下载小红书无水印作品文件

53. **[cc-switch](https://github.com/farion1231/cc-switch)** - ⭐ 9,128
   A cross-platform desktop All-in-One assistant tool for Claude Code, Codex & Gemini CLI.

54. **[mcp-use](https://github.com/mcp-use/mcp-use)** - ⭐ 8,815
   mcp-use is the easiest way to interact with mcp servers with custom agents

55. **[Scrapling](https://github.com/D4Vinci/Scrapling)** - ⭐ 8,403
   🕷️ An undetectable, powerful, flexible, high-performance Python library to make Web Scraping Easy and Effortless as it should be!

56. **[awesome-ai-apps](https://github.com/Arindam200/awesome-ai-apps)** - ⭐ 8,178
   A collection of projects showcasing RAG, agents, workflows, and other AI use cases

57. **[inspector](https://github.com/modelcontextprotocol/inspector)** - ⭐ 8,156
   Visual testing tool for MCP servers

58. **[xiaozhi-esp32-server](https://github.com/xinnan-tech/xiaozhi-esp32-server)** - ⭐ 8,126
   本项目为xiaozhi-esp32提供后端服务，帮助您快速搭建ESP32设备控制服务器。Backend service for xiaozhi-esp32, helps you quickly build an ESP32 device control server.

59. **[mcp-go](https://github.com/mark3labs/mcp-go)** - ⭐ 7,919
   A Go implementation of the Model Context Protocol (MCP), enabling seamless integration between LLM applications and external data sources and tools.

60. **[mcp-agent](https://github.com/lastmile-ai/mcp-agent)** - ⭐ 7,904
   Build effective agents using Model Context Protocol and simple workflow patterns

61. **[xiaohongshu-mcp](https://github.com/xpzouying/xiaohongshu-mcp)** - ⭐ 7,833
   MCP for xiaohongshu.com

62. **[mcp](https://github.com/awslabs/mcp)** - ⭐ 7,787
   AWS MCP Servers — helping you get the most out of AWS, wherever you use MCP.

63. **[git-mcp](https://github.com/idosal/git-mcp)** - ⭐ 7,315
...
65. **[awesome-LLM-resources](https://github.com/WangRongsheng/awesome-LLM-resources)** - ⭐ 7,183
   🧑‍🚀 全世界最好的LLM资料总结（多模态生成、Agent、辅助编程、AI审稿、数据处理、模型训练、模型推理、o1 模型、MCP、小语言模型、视觉语言模型） | Summary of the world's best LLM resources. 

66. **[GhidraMCP](https://github.com/LaurieWired/GhidraMCP)** - ⭐ 6,989
   MCP Server for Ghidra

67. **[browser-tools-mcp](https://github.com/AgentDeskAI/browser-tools-mcp)** - ⭐ 6,958
   Monitor browser logs directly from Cursor and other MCP compatible IDEs.

68. **[registry](https://github.com/modelcontextprotocol/registry)** - ⭐ 6,207
   A community driven registry service for Model Context Protocol (MCP) servers.

69. **[awesome-mcp-clients](https://github.com/punkpeye/awesome-mcp-clients)** - ⭐ 6,150
   A collection of MCP clients.

70. **[Skill_Seekers](https://github.com/yusufkaraaslan/Skill_Seekers)** - ⭐ 6,042
   Convert documentation websites, GitHub repositories, and PDFs into Claude AI skills with automatic conflict detection

71. **[cursor-talk-to-figma-mcp](https://github.com/grab/cursor-talk-to-figma-mcp)** - ⭐ 5,848
...
72. **[hexstrike-ai](https://github.com/0x4m4/hexstrike-ai)** - ⭐ 5,592
   HexStrike AI MCP Agents is an advanced MCP server that lets AI agents (Claude, GPT, Copilot, etc.) autonomously run 150+ cybersecurity tools for automated pentesting, vulnerability discovery, bug bounty automation, and security research. Seamlessly bridge LLMs with real-world offensive security capabilities.

73. **[klavis](https://github.com/Klavis-AI/klavis)** - ⭐ 5,580
   Klavis AI (YC X25):  MCP integration platforms that let AI agents use tools reliably at any scale

74. **[astron-rpa](https://github.com/iflytek/astron-rpa)** - ⭐ 5,553
   Agent-ready RPA suite with out-of-the-box automation tools. Built for individuals and enterprises.

75. **[Awesome-MCP-ZH](https://github.com/yzfly/Awesome-MCP-ZH)** - ⭐ 5,480
   MCP 资源精选， MCP指南，Claude MCP，MCP Servers, MCP Clients

76. **[mcp](https://github.com/BrowserMCP/mcp)** - ⭐ 5,344
   Browser MCP is a Model Context Provider (MCP) server that allows AI applications to control your browser

77. **[firecrawl-mcp-server](https://github.com/firecrawl/firecrawl-mcp-server)** - ⭐ 5,194
   🔥 Official Firecrawl MCP Server - Adds powerful web scraping and search to Cursor, Claude and any other LLM clients.

78. **[whatsapp-mcp](https://github.com/lharries/whatsapp-mcp)** - ⭐ 5,183
   WhatsApp MCP server

79. **[DesktopCommanderMCP](https://github.com/wonderwhy-er/DesktopCommanderMCP)** - ⭐ 5,178
   This is MCP server for Claude that gives it terminal control, file system search and diff file editing capabilities

80. **[mcp-playwright](https://github.com/executeautomation/mcp-playwright)** - ⭐ 5,109
   Playwright Model Context Protocol Server - Tool to automate Browsers and APIs in Claude Desktop, Cline, Cursor IDE and More 🔌

81. **[awesome-mcp-servers](https://github.com/appcypher/awesome-mcp-servers)** - ⭐ 5,040
   Awesome MCP Servers - A curated list of Model Context Protocol servers

82. **[gaianet-node](https://github.com/GaiaNet-AI/gaianet-node)** - ⭐ 5,011
   Install, run and deploy your own decentralized AI agent service

83. **[claude-context](https://github.com/zilliztech/claude-context)** - ⭐ 4,930
   Code search MCP for Claude Code. Make entire codebase the context for any coding agent.

84. **[5ire](https://github.com/nanbingxyz/5ire)** - ⭐ 4,901
   5ire is a cross-platform desktop AI assistant, MCP client. It compatible with major service providers,  supports local knowledge base and  tools via model context protocol servers .

85. **[ida-pro-mcp](https://github.com/mrexodia/ida-pro-mcp)** - ⭐ 4,874
   AI-powered reverse engineering assistant that bridges IDA Pro with language models through MCP.

86. **[sdk-python](https://github.com/strands-agents/sdk-python)** - ⭐ 4,791
   A model-driven approach to building AI agents in just a few lines of code.

87. **[Everywhere](https://github.com/DearVa/Everywhere)** - ⭐ 4,765
...
89. **[voltagent](https://github.com/VoltAgent/voltagent)** - ⭐ 4,663
   Open Source TypeScript AI Agent Framework with built-in LLM Observability

90. **[unity-mcp](https://github.com/CoplayDev/unity-mcp)** - ⭐ 4,570
   An MCP server that allows MCP clients like Claude Desktop or Cursor to perform actions in the Unity Editor

91. **[Kiln](https://github.com/Kiln-AI/Kiln)** - ⭐ 4,516
   Easily build AI systems with Evals, RAG, Agents, fine-tuning, synthetic data, and more.

92. **[casibase](https://github.com/casibase/casibase)** - ⭐ 4,367
   ⚡️AI Cloud OS: Open-source enterprise-level AI knowledge base and MCP (model-context-protocol)/A2A (agent-to-agent) management platform with admin UI, user management and Single-Sign-On⚡️, supports ChatGPT, Claude, Llama, Ollama, HuggingFace, etc., chat bot demo: https://ai.casibase.com, admin UI demo: https://ai-admin.casibase.com

93. **[deep-research](https://github.com/u14app/deep-research)** - ⭐ 4,299
   Use any LLMs (Large Language Models) for Deep Research. Support SSE API and MCP server.

94. **[microsandbox](https://github.com/zerocore-ai/microsandbox)** - ⭐ 4,296
   opensource self-hosted sandboxes for ai agents

95. **[httprunner](https://github.com/httprunner/httprunner)** - ⭐ 4,236
   HttpRunner 是一款开源的 API/UI 测试框架，简单易用，功能强大，具有丰富的插件化机制和高度的可扩展能力。

96. **[magic-mcp](https://github.com/21st-dev/magic-mcp)** - ⭐ 4,076
   It's like v0 but in your Cursor/WindSurf/Cline. 21st dev Magic MCP server for working with your frontend like Magic

97. **[mcp-ui](https://github.com/MCP-UI-Org/mcp-ui)** - ⭐ 3,963
   UI over MCP. Create next-gen UI experiences with the protocol and SDK!

98. **[mcp-atlassian](https://github.com/sooperset/mcp-atlassian)** - ⭐ 3,880
   MCP server for Atlassian tools (Confluence, Jira)

99. **[directories](https://github.com/pontusab/directories)** - ⭐ 3,863
   The Cursor & Windsurf community, find rules and MCPs

100. **[Olares](https://github.com/beclab/Olares)** - ⭐ 3,856
   Olares: An Open-Source Personal Cloud to Reclaim Your Data

101. **[mcpo](https://github.com/open-webui/mcpo)** - ⭐ 3,836
   A simple, secure MCP-to-OpenAPI proxy server

102. **[learn-agentic-ai](https://github.com/panaversity/learn-agentic-ai)** - ⭐ 3,801
   Learn Agentic AI using Dapr Agentic Cloud Ascent (DACA) Design Pattern and Agent-Native Cloud Technologies: OpenAI Agents SDK, Memory, MCP, A2A, Knowledge Graphs, Dapr, Rancher Desktop, and Kubernetes.

103. **[Windows-MCP](https://github.com/CursorTouch/Windows-MCP)** - ⭐ 3,799
   MCP Server for Computer Use in Windows

104. **[csharp-sdk](https://github.com/modelcontextprotocol/csharp-sdk)** - ⭐ 3,746
   The official C# SDK for Model Context Protocol servers and clients. Maintained in collaboration with Microsoft.

105. **[telegram-search](https://github.com/groupultra/telegram-search)** - ⭐ 3,659
   🔍 导出并模糊搜索 Telegram 聊天记录 | Export and fuzzy search your Telegram chat history

106. **[notion-mcp-server](https://github.com/makenotion/notion-mcp-server)** - ⭐ 3,649
   Official Notion MCP Server

107. **[MemOS](https://github.com/MemTensor/MemOS)** - ⭐ 3,619
...
108. **[wanwu](https://github.com/UnicomAI/wanwu)** - ⭐ 3,588
   China Unicom's Yuanjing Wanwu Agent Platform is an enterprise-grade, multi-tenant AI agent development platform. It helps users build applications such as intelligent agents, workflows, and rag, and also supports model management. The platform features a developer-friendly license, and we welcome all developers to build upon the platform.

109. **[core](https://github.com/opensumi/core)** - ⭐ 3,584
   A framework helps you quickly build AI Native IDE products. MCP Client, supports Model Context Protocol (MCP) tools via MCP server.

110. **[fast-agent](https://github.com/evalstate/fast-agent)** - ⭐ 3,574
   Define, Prompt and Test MCP enabled Agents and Workflows

111. **[spec-workflow-mcp](https://github.com/Pimzino/spec-workflow-mcp)** - ⭐ 3,554
   A Model Context Protocol (MCP) server that provides structured spec-driven development workflow tools for AI-assisted software development, featuring a real-time web dashboard and VSCode extension for monitoring and managing your project's progress directly in your development environment.

112. **[go-sdk](https://github.com/modelcontextprotocol/go-sdk)** - ⭐ 3,549
   The official Go SDK for Model Context Protocol servers and clients. Maintained in collaboration with Google.

113. **[exa-mcp-server](https://github.com/exa-labs/exa-mcp-server)** - ⭐ 3,498
...
115. **[mcp-server-chart](https://github.com/antvis/mcp-server-chart)** - ⭐ 3,455
   🤖 A visualization mcp contains 25+ visual charts using @antvis. Using for chart generation and data analysis.

116. **[ciso-assistant-community](https://github.com/intuitem/ciso-assistant-community)** - ⭐ 3,447
...
117. **[cipher](https://github.com/campfirein/cipher)** - ⭐ 3,395
...
118. **[AionUi](https://github.com/iOfficeAI/AionUi)** - ⭐ 3,355
...
119. **[go-whatsapp-web-multidevice](https://github.com/aldinokemal/go-whatsapp-web-multidevice)** - ⭐ 3,324
   GOWA - WhatsApp REST API with support for UI, Multi Account, Webhooks, and MCP. Built with Golang for efficient memory use. 

120. **[XcodeBuildMCP](https://github.com/cameroncooke/XcodeBuildMCP)** - ⭐ 3,323
   A Model Context Protocol (MCP) server that provides Xcode-related tools for integration with AI assistants and other MCP clients.

121. **[PeopleInSpace](https://github.com/joreilly/PeopleInSpace)** - ⭐ 3,289
   Kotlin Multiplatform sample with SwiftUI, Jetpack Compose, Compose for Wear, Compose for Desktop, and Compose for Web clients along with Ktor backend.

122. **[kreuzberg](https://github.com/kreuzberg-dev/kreuzberg)** - ⭐ 3,279
...
123. **[mcp-server-cloudflare](https://github.com/cloudflare/mcp-server-cloudflare)** - ⭐ 3,247

124. **[langchain-mcp-adapters](https://github.com/langchain-ai/langchain-mcp-adapters)** - ⭐ 3,242
   LangChain 🔌 MCP

125. **[MCP-Chinese-Getting-Started-Guide](https://github.com/liaokongVFX/MCP-Chinese-Getting-Started-Guide)** - ⭐ 3,237
   Model Context Protocol(MCP) 编程极速入门

126. **[awesome-mcp-servers](https://github.com/wong2/awesome-mcp-servers)** - ⭐ 3,215
   A curated list of Model Context Protocol (MCP) servers

127. **[metorial](https://github.com/metorial/metorial)** - ⭐ 3,200
   Connect any AI model to 600+ integrations; powered by MCP 📡 🚀

128. **[memU](https://github.com/NevaMind-AI/memU)** - ⭐ 3,181
   Memory infrastructure for LLMs and AI agents

129. **[py-xiaozhi](https://github.com/huangjunsen0406/py-xiaozhi)** - ⭐ 3,074
   A Python-based Xiaozhi AI for users who want the full Xiaozhi experience without owning specialized hardware.

130. **[excel-mcp-server](https://github.com/haris-musa/excel-mcp-server)** - ⭐ 3,063
   A Model Context Protocol server for Excel file manipulation

131. **[learn-ai-engineering](https://github.com/ashishps1/learn-ai-engineering)** - ⭐ 3,056
   Learn AI and LLMs from scratch using free resources

132. **[mcp-context-forge](https://github.com/IBM/mcp-context-forge)** - ⭐ 3,049
   A Model Context Protocol (MCP) Gateway & Registry. Serves as a central management point for tools, resources, and prompts that can be accessed by MCP-compatible LLM applications. Converts REST API endpoints to MCP, composes virtual MCP servers with added security and observability, and converts between protocols (stdio, SSE, Streamable HTTP).

133. **[PPTAgent](https://github.com/icip-cas/PPTAgent)** - ⭐ 3,036
   An Autonomous Agentic Framework for Reflective PowerPoint Generation

134. **[java-sdk](https://github.com/modelcontextprotocol/java-sdk)** - ⭐ 3,028
   The official Java SDK for Model Context Protocol servers and clients. Maintained in collaboration with Spring AI

135. **[octelium](https://github.com/octelium/octelium)** - ⭐ 3,024
   A next-gen FOSS self-hosted unified zero trust secure access platform that can operate as a remote access VPN, a ZTNA platform, API/AI/MCP gateway, a PaaS, an ngrok-alternative and a homelab infrastructure.

136. **[boost](https://github.com/laravel/boost)** - ⭐ 3,005
   Laravel-focused MCP server for augmenting your AI powered local development experience.

137. **[mcp-server-browserbase](https://github.com/browserbase/mcp-server-browserbase)** - ⭐ 3,003
...
140. **[osaurus](https://github.com/dinoki-ai/osaurus)** - ⭐ 2,909
...
141. **[mobile-mcp](https://github.com/mobile-next/mobile-mcp)** - ⭐ 2,904
   Model Context Protocol Server for Mobile Automation and Scraping (iOS, Android, Emulators, Simulators and Real Devices)

142. **[claude-code-guide](https://github.com/zebbern/claude-code-guide)** - ⭐ 2,884
...
143. **[fastmcp](https://github.com/punkpeye/fastmcp)** - ⭐ 2,859
   A TypeScript framework for building MCP servers.

144. **[mcp](https://github.com/google/mcp)** - ⭐ 2,838
   Google 💚 MCP

145. **[rikkahub](https://github.com/rikkahub/rikkahub)** - ⭐ 2,809
   RikkaHub is an Android APP that supports for multiple LLM providers.

146. **[rust-sdk](https://github.com/modelcontextprotocol/rust-sdk)** - ⭐ 2,784
   The official Rust SDK for the Model Context Protocol

147. **[AI-Infra-Guard](https://github.com/Tencent/AI-Infra-Guard)** - ⭐ 2,723
...
148. **[mcp-obsidian](https://github.com/MarkusPfundstein/mcp-obsidian)** - ⭐ 2,641
   MCP server that interacts with Obsidian via the Obsidian rest API community plugin

149. **[shadcn-ui-mcp-server](https://github.com/Jpisnice/shadcn-ui-mcp-server)** - ⭐ 2,580
...
152. **[UltraRAG](https://github.com/OpenBMB/UltraRAG)** - ⭐ 2,402
   UltraRAG v2: A Low-Code MCP Framework for Building Complex and Innovative RAG Pipelines

153. **[mcp](https://github.com/microsoft/mcp)** - ⭐ 2,385
   Catalog of official Microsoft MCP (Model Context Protocol) server implementations for AI-powered data access and tool integration

154. **[supabase-mcp](https://github.com/supabase-community/supabase-mcp)** - ⭐ 2,362
...
157. **[basic-memory](https://github.com/basicmachines-co/basic-memory)** - ⭐ 2,303
   AI conversations that actually remember. Never re-explain your project to your AI again. Join our Discord: https://discord.gg/tyvKNccgqN

158. **[MCP-SuperAssistant](https://github.com/srbhptl39/MCP-SuperAssistant)** - ⭐ 2,183
...
160. **[mcp-proxy](https://github.com/sparfenyuk/mcp-proxy)** - ⭐ 2,129
   A bridge between Streamable HTTP and stdio MCP transports

161. **[buildwithclaude](https://github.com/davepoon/buildwithclaude)** - ⭐ 2,120
   Claude Skills, Agents, Commands, Hooks, Plugins, Marketplaces Collection for Claude Code

162. **[ableton-mcp](https://github.com/ahujasid/ableton-mcp)** - ⭐ 2,118

163. **[claude-code-subagents-collection](https://github.com/davepoon/claude-code-subagents-collection)** - ⭐ 2,098
   Claude Code Subagents & Commands Collection + CLI Tool

164. **[mcp-grafana](https://github.com/grafana/mcp-grafana)** - ⭐ 2,069
   MCP server for Grafana

165. **[ddgs](https://github.com/deedy5/ddgs)** - ⭐ 2,056
   DDGS | Dux Distributed Global Search. A metasearch library that aggregates results from diverse web search services

166. **[comfyui_LLM_party](https://github.com/heshengtao/comfyui_LLM_party)** - ⭐ 2,055
   LLM Agent Framework in ComfyUI includes MCP sever, Omost,GPT-sovits, ChatTTS,GOT-OCR2.0, and FLUX prompt nodes,access to Feishu,discord,and adapts to all llms with similar openai / aisuite interfaces, such as o1,ollama, gemini, grok, qwen, GLM, deepseek, kimi,doubao. Adapted to local llms, vlm, gguf such as llama-3.3 Janus-Pro, Linkage graphRAG

167. **[papersgpt-for-zotero](https://github.com/papersgpt/papersgpt-for-zotero)** - ⭐ 2,022
...
168. **[DevDocs](https://github.com/cyberagiinc/DevDocs)** - ⭐ 2,002
   Completely free, private, UI based Tech Documentation MCP server. Designed for coders and software developers in mind. Easily integrate into Cursor, Windsurf, Cline, Roo Code, Claude Desktop App 

169. **[kagent](https://github.com/kagent-dev/kagent)** - ⭐ 2,002
   Cloud Native Agentic AI | Discord: https://bit.ly/kagentdiscord

170. **[arxiv-mcp-server](https://github.com/blazickjp/arxiv-mcp-server)** - ⭐ 2,000
   A Model Context Protocol server for searching and analyzing arXiv papers

171. **[Unla](https://github.com/AmoyLab/Unla)** - ⭐ 1,982
   🧩 MCP Gateway - A lightweight gateway service that instantly transforms existing MCP Servers and APIs into MCP servers with zero code changes. Features Docker deployment and management UI, requiring no infrastructure modifications.

172. **[superglue](https://github.com/superglue-ai/superglue)** - ⭐ 1,966
   superglue (YC W25) builds integrations and tools from natural language. Get production-grade tools for long tail and enterprise systems.

173. **[lemonade](https://github.com/lemonade-sdk/lemonade)** - ⭐ 1,957
   Lemonade helps users discover and run local AI apps by serving optimized LLMs right from their own GPUs and NPUs. Join our discord: https://discord.gg/5xXzkMu8Zk

174. **[mcpso](https://github.com/chatmcp/mcpso)** - ⭐ 1,952
   directory for Awesome MCP Servers

175. **[mcp-shrimp-task-manager](https://github.com/cjo4m06/mcp-shrimp-task-manager)** - ⭐ 1,950
   Shrimp Task Manager is a task tool built for AI Agents, emphasizing chain-of-thought, reflection, and style consistency. It converts natural language into structured dev tasks with dependency tracking and iterative refinement, enabling agent-like developer behavior in reasoning AI systems.

176. **[mcp-crawl4ai-rag](https://github.com/coleam00/mcp-crawl4ai-rag)** - ⭐ 1,944
   Web Crawling and RAG Capabilities for AI Agents and AI Coding Assistants

177. **[sandbox](https://github.com/agent-infra/sandbox)** - ⭐ 1,879
...
180. **[metamcp](https://github.com/metatool-ai/metamcp)** - ⭐ 1,856
   MCP Aggregator, Orchestrator, Middleware, Gateway in one docker

181. **[brightdata-mcp](https://github.com/brightdata/brightdata-mcp)** - ⭐ 1,840
   A powerful Model Context Protocol (MCP) server that provides an all-in-one solution for public web access.

182. **[dbhub](https://github.com/bytebase/dbhub)** - ⭐ 1,832
   Zero-dependency, token-efficient database MCP server for Postgres, MySQL, SQL Server, MariaDB, SQLite.

183. **[witsy](https://github.com/nbonamy/witsy)** - ⭐ 1,815
   Witsy: desktop AI assistant / universal MCP client

184. **[gemini-mcp-tool](https://github.com/jamubc/gemini-mcp-tool)** - ⭐ 1,801
   MCP server that enables AI assistants to interact with Google Gemini CLI, leveraging Gemini's massive token window for large file analysis and codebase understanding

185. **[beelzebub](https://github.com/mariocandela/beelzebub)** - ⭐ 1,801
   A secure low code honeypot framework, leveraging AI for System Virtualization.

186. **[mcp-cli](https://github.com/chrishayuk/mcp-cli)** - ⭐ 1,793

187. **[sanic-web](https://github.com/apconw/sanic-web)** - ⭐ 1,788
...
188. **[agentset](https://github.com/agentset-ai/agentset)** - ⭐ 1,763
   The open-source RAG platform: built-in citations, deep research, 22+ file formats, partitions, MCP server, and more.

189. **[postgres-mcp](https://github.com/crystaldba/postgres-mcp)** - ⭐ 1,758
   Postgres MCP Pro provides configurable read/write access and performance analysis for you and your AI agents.

190. **[opendia](https://github.com/aaronjmars/opendia)** - ⭐ 1,749
   Connect your browser to AI models. Just use Dia on Chrome, Arc or Firefox.

191. **[mcphub](https://github.com/samanhappy/mcphub)** - ⭐ 1,684
...
193. **[AIaW](https://github.com/NitroRCr/AIaW)** - ⭐ 1,664
...
196. **[mcpb](https://github.com/modelcontextprotocol/mcpb)** - ⭐ 1,626
   Desktop Extensions: One-click local MCP server installation in desktop apps

197. **[zenfeed](https://github.com/glidea/zenfeed)** - ⭐ 1,612
   Make RSS 📰 great again with AI 🧠✨!!

198. **[codemcp](https://github.com/ezyang/codemcp)** - ⭐ 1,591
   Coding assistant MCP for Claude Desktop

199. **[anyquery](https://github.com/julien040/anyquery)** - ⭐ 1,576
   Query anything (GitHub, Notion, +40 more) with SQL and let LLMs (ChatGPT, Claude) connect to using MCP

200. **[inspector](https://github.com/MCPJam/inspector)** - ⭐ 1,538
   Build ChatGPT Apps and MCP servers locally.

201. **[n8n-mcp-server](https://github.com/leonardsellem/n8n-mcp-server)** - ⭐ 1,536
   MCP server that provides tools and resources for interacting with n8n API

202. **[py-gpt](https://github.com/szczyglis-dev/py-gpt)** - ⭐ 1,528
   Desktop AI Assistant powered by GPT-5, GPT-4, o1, o3, Gemini, Claude, Ollama, DeepSeek, Perplexity, Grok, Bielik, chat, vision, voice, RAG, image and video generation, agents, tools, MCP, plugins, speech synthesis and recognition, web search, memory, presets, assistants,and more. Linux, Windows, Mac

203. **[bifrost](https://github.com/maximhq/bifrost)** - ⭐ 1,523
   Fastest LLM gateway (50x faster than LiteLLM) with adaptive load balancer, cluster mode, guardrails, 1000+ models support & <100 µs overhead at 5k RPS.

204. **[agentgateway](https://github.com/agentgateway/agentgateway)** - ⭐ 1,521
...
207. **[super-agent-party](https://github.com/heshengtao/super-agent-party)** - ⭐ 1,505
...
208. **[toolhive](https://github.com/stacklok/toolhive)** - ⭐ 1,492
   ToolHive makes deploying MCP servers easy, secure and fun

209. **[mcp-installer](https://github.com/anaisbetts/mcp-installer)** - ⭐ 1,490
   An MCP server that installs other MCP servers for you

210. **[mcp-router](https://github.com/mcp-router/mcp-router)** - ⭐ 1,489
   A Unified MCP Server Management App (MCP Manager).

211. **[Continuous-Claude-v2](https://github.com/parcadei/Continuous-Claude-v2)** - ⭐ 1,447
   Context management for Claude Code. Hooks maintain state via ledgers and handoffs. MCP execution without context pollution. Agent orchestration with isolated context windows.

212. **[better-agents](https://github.com/langwatch/better-agents)** - ⭐ 1,433
...
215. **[rulego](https://github.com/rulego/rulego)** - ⭐ 1,392
   ⛓️RuleGo is a lightweight, high-performance, embedded, next-generation component orchestration rule engine framework for Go.

216. **[ios-simulator-mcp](https://github.com/joshuayoes/ios-simulator-mcp)** - ⭐ 1,387
   MCP server for interacting with the iOS simulator

217. **[mcp-scan](https://github.com/invariantlabs-ai/mcp-scan)** - ⭐ 1,379
   Constrain, log and scan your MCP connections for security vulnerabilities.

218. **[Office-PowerPoint-MCP-Server](https://github.com/GongRzhe/Office-PowerPoint-MCP-Server)** - ⭐ 1,373
   A MCP (Model Context Protocol) server for PowerPoint manipulation using python-pptx. This server provides tools for creating, editing, and manipulating PowerPoint presentations through the MCP protocol.

219. **[mcp-language-server](https://github.com/isaacphi/mcp-language-server)** - ⭐ 1,363
   mcp-language-server gives MCP enabled clients access semantic tools like get definition, references, rename, and diagnostics.

220. **[playwriter](https://github.com/remorses/playwriter)** - ⭐ 1,356
   The better playwright MCP: works as a browser extension. No context bloat. More capable.

221. **[yu-ai-agent](https://github.com/liyupi/yu-ai-agent)** - ⭐ 1,332
...
222. **[Office-Word-MCP-Server](https://github.com/GongRzhe/Office-Word-MCP-Server)** - ⭐ 1,318
   A Model Context Protocol (MCP) server for creating, reading, and manipulating Microsoft Word documents. This server enables AI assistants to work with Word documents through a standardized interface, providing rich document editing capabilities.

223. **[godot-mcp](https://github.com/Coding-Solo/godot-mcp)** - ⭐ 1,314
   MCP server for interfacing with Godot game engine. Provides tools for launching the editor, running projects, and capturing debug output.

224. **[nerve](https://github.com/evilsocket/nerve)** - ⭐ 1,313
   The Simple Agent Development Kit.

225. **[mcp_agent_mail](https://github.com/Dicklesworthstone/mcp_agent_mail)** - ⭐ 1,311
   Like gmail for your coding agents. Lets various different agents communicate and coordinate with each other.

226. **[php-sdk](https://github.com/modelcontextprotocol/php-sdk)** - ⭐ 1,292
...
230. **[Risuai](https://github.com/kwaroran/Risuai)** - ⭐ 1,255
   Make your own story. User-friendly software for LLM roleplaying

231. **[docker-mcp-tutorial](https://github.com/theNetworkChuck/docker-mcp-tutorial)** - ⭐ 1,253
   Complete tutorial materials for building MCP servers with Docker - from NetworkChuck's video

232. **[mcp](https://github.com/MicrosoftDocs/mcp)** - ⭐ 1,250
   Official Microsoft Learn MCP Server – powering LLMs and AI agents with real-time, trusted Microsoft docs & code samples.

233. **[mcp-server-kubernetes](https://github.com/Flux159/mcp-server-kubernetes)** - ⭐ 1,246
   MCP Server for kubernetes management commands

234. **[code-mode](https://github.com/universal-tool-calling-protocol/code-mode)** - ⭐ 1,244
   🔌 Plug-and-play library to enable agents to call MCP and UTCP tools via code execution. 

235. **[damn-vulnerable-MCP-server](https://github.com/harishsg993010/damn-vulnerable-MCP-server)** - ⭐ 1,237
   Damn Vulnerable MCP Server

236. **[unreal-mcp](https://github.com/chongdashu/unreal-mcp)** - ⭐ 1,232
   Enable AI assistant clients like Cursor, Windsurf and Claude Desktop to control Unreal Engine through natural language using the Model Context Protocol (MCP).

237. **[web-eval-agent](https://github.com/refreshdotdev/web-eval-agent)** - ⭐ 1,230
   An MCP server that autonomously evaluates web applications. 

238. **[web-eval-agent](https://github.com/withRefresh/web-eval-agent)** - ⭐ 1,226
   An MCP server that autonomously evaluates web applications. 

239. **[pg-aiguide](https://github.com/timescale/pg-aiguide)** - ⭐ 1,225
...
245. **[grafbase](https://github.com/grafbase/grafbase)** - ⭐ 1,197
   The Grafbase GraphQL Federation Gateway

246. **[MAI-UI](https://github.com/Tongyi-MAI/MAI-UI)** - ⭐ 1,194
   MAI-UI: Real-World Centric Foundation GUI Agents.

247. **[mcp-remote](https://github.com/geelen/mcp-remote)** - ⭐ 1,189

248. **[mcp-unity](https://github.com/CoderGamester/mcp-unity)** - ⭐ 1,189
...
249. **[ai](https://github.com/stripe/ai)** - ⭐ 1,180
   One-stop shop for building AI-powered products and businesses with Stripe.

250. **[mcp-golang](https://github.com/metoro-io/mcp-golang)** - ⭐ 1,174
   Write Model Context Protocol servers in few lines of go code. Docs at https://mcpgolang.com . Created by https://metoro.io

251. **[xmcp](https://github.com/basementstudio/xmcp)** - ⭐ 1,165
   The TypeScript MCP framework

252. **[swift-sdk](https://github.com/modelcontextprotocol/swift-sdk)** - ⭐ 1,163
   The official Swift SDK for Model Context Protocol servers and clients.

253. **[npcpy](https://github.com/NPC-Worldwide/npcpy)** - ⭐ 1,154
   The AI toolkit for the AI developer

254. **[mcp-server-qdrant](https://github.com/qdrant/mcp-server-qdrant)** - ⭐ 1,152
   An official Qdrant Model Context Protocol (MCP) server implementation

255. **[MiniMax-MCP](https://github.com/MiniMax-AI/MiniMax-MCP)** - ⭐ 1,148
   Official MiniMax Model Context Protocol (MCP) server that enables interaction with powerful Text to Speech, image generation and video generation APIs.

256. **[elevenlabs-mcp](https://github.com/elevenlabs/elevenlabs-mcp)** - ⭐ 1,129
   The official ElevenLabs MCP server

257. **[azure-devops-mcp](https://github.com/microsoft/azure-devops-mcp)** - ⭐ 1,123
   The MCP server for Azure DevOps, bringing the power of Azure DevOps directly to your agents.

258. **[cunzhi](https://github.com/imhuso/cunzhi)** - ⭐ 1,122
   告别AI提前终止烦恼，助力AI更加持久

259. **[mcp-gateway](https://github.com/docker/mcp-gateway)** - ⭐ 1,118
   docker mcp CLI plugin / MCP Gateway

260. **[terraform-mcp-server](https://github.com/hashicorp/terraform-mcp-server)** - ⭐ 1,117
   The Terraform MCP Server provides seamless integration with Terraform ecosystem, enabling advanced automation and interaction capabilities for Infrastructure as Code (IaC) development.

261. **[tuui](https://github.com/AI-QL/tuui)** - ⭐ 1,116
   A desktop MCP client designed as a tool unitary utility integration, accelerating AI adoption through the Model Context Protocol (MCP) and enabling cross-vendor LLM API orchestration.

262. **[fast-mcp](https://github.com/yjacquin/fast-mcp)** - ⭐ 1,110
   A Ruby Implementation of the Model Context Protocol

263. **[Agent-MCP](https://github.com/rinadelph/Agent-MCP)** - ⭐ 1,103
   Agent-MCP is a framework for creating multi-agent systems that enables coordinated, efficient AI collaboration through the Model Context Protocol (MCP). The system is designed for developers building AI applications that benefit from multiple specialized agents working in parallel on different aspects of a project.

264. **[solace-agent-mesh](https://github.com/SolaceLabs/solace-agent-mesh)** - ⭐ 1,089
   An event-driven framework designed to build and orchestrate multi-agent AI systems. It enables seamless integration of AI agents with real-world data sources and systems, facilitating complex, multi-step workflows.

265. **[AWorld](https://github.com/inclusionAI/AWorld)** - ⭐ 1,086
   Build, evaluate and train General Multi-Agent Assistance with ease

266. **[xiaozhi-esp32-server-java](https://github.com/joey-zhou/xiaozhi-esp32-server-java)** - ⭐ 1,062
   小智ESP32的Java企业级管理平台，提供设备监控、音色定制、角色切换和对话记录管理的前后端及服务端一体化解决方案

267. **[flock](https://github.com/Onelevenvy/flock)** - ⭐ 1,060
   Flock is a workflow-based low-code platform for rapidly building chatbots, RAG, and coordinating multi-agent teams, powered by LangGraph, Langchain, FastAPI, and NextJS.（Flock 是一个基于workflow工作流的低代码平台，用于快速构建聊天机器人、RAG、Agent和Muti-Agent应用，采用 LangGraph、Langchain、FastAPI 和 NextJS 构建。）

268. **[mcp-memory-service](https://github.com/doobidoo/mcp-memory-service)** - ⭐ 1,058
   Stop re-explaining your project to AI every session. Automatic context memory for Claude, VS Code, Cursor, and 13+ AI tools.

269. **[google_workspace_mcp](https://github.com/taylorwilsdon/google_workspace_mcp)** - ⭐ 1,058
...
270. **[cui](https://github.com/wbopan/cui)** - ⭐ 1,056
   A web UI for Claude Code agents

271. **[mysql_mcp_server](https://github.com/designcomputer/mysql_mcp_server)** - ⭐ 1,055
   A Model Context Protocol (MCP) server that enables secure interaction with MySQL databases

272. **[slack-mcp-server](https://github.com/korotovsky/slack-mcp-server)** - ⭐ 1,053
...
273. **[tavily-mcp](https://github.com/tavily-ai/tavily-mcp)** - ⭐ 1,045
   Production ready MCP server with real-time search, extract, map & crawl.

274. **[xhs-toolkit](https://github.com/aki66938/xhs-toolkit)** - ⭐ 1,042
   📕 小红书创作者MCP工具包 - 支持与AI客户端集成的内容创作和发布工具

275. **[google-analytics-mcp](https://github.com/googleanalytics/google-analytics-mcp)** - ⭐ 1,039

276. **[SearChat](https://github.com/sear-chat/SearChat)** - ⭐ 1,035
   Search + Chat = SearChat(AI Chat with Search), Support OpenAI/Anthropic/VertexAI/Gemini, DeepResearch, SearXNG, Docker.  AI对话式搜索引擎，支持DeepResearch, 支持OpenAI/Anthropic/VertexAI/Gemini接口、聚合搜索引擎SearXNG，支持Docker一键部署。

277. **[mcp-server-mysql](https://github.com/benborla/mcp-server-mysql)** - ⭐ 1,033
...
283. **[jadx-ai-mcp](https://github.com/zinja-coder/jadx-ai-mcp)** - ⭐ 1,005
   Plugin for JADX to integrate MCP server

284. **[ApeRAG](https://github.com/apecloud/ApeRAG)** - ⭐ 1,003
   ApeRAG: Production-ready GraphRAG with multi-modal indexing, AI agents, MCP support, and scalable K8s deployment

285. **[mcp-boilerplate](https://github.com/iannuttall/mcp-boilerplate)** - ⭐ 997
   A remote Cloudflare MCP server boilerplate with user authentication and Stripe for paid tools.

286. **[Peekaboo](https://github.com/steipete/Peekaboo)** - ⭐ 995
   Peekaboo is a macOS CLI & optional MCP server that enables AI agents to capture screenshots of applications, or the entire system, with optional visual question answering through local or remote AI models.

287. **[claude-code-mcp](https://github.com/steipete/claude-code-mcp)** - ⭐ 985
   Claude Code as one-shot MCP server to have an agent in your agent.

288. **[iMCP](https://github.com/mattt/iMCP)** - ⭐ 984
   A macOS app that provides an MCP server to your Messages, Contacts, Reminders and more

289. **[awesome-remote-mcp-servers](https://github.com/jaw9c/awesome-remote-mcp-servers)** - ⭐ 972
   Remote MCP Servers

290. **[better-chatbot](https://github.com/cgoinglove/better-chatbot)** - ⭐ 964
   Just a Better Chatbot. Powered by Agent & MCP & Workflows.

291. **[wenyan-mcp](https://github.com/caol64/wenyan-mcp)** - ⭐ 959
...
294. **[fetcher-mcp](https://github.com/jae-jae/fetcher-mcp)** - ⭐ 948
   MCP server for fetch web page content using Playwright headless browser.

295. **[claude-init](https://github.com/cfrs2005/claude-init)** - ⭐ 948
...
297. **[kubernetes-mcp-server](https://github.com/containers/kubernetes-mcp-server)** - ⭐ 937
   Model Context Protocol (MCP) server for Kubernetes and OpenShift

298. **[RedNote-MCP](https://github.com/iFurySt/RedNote-MCP)** - ⭐ 936
   🚀MCP server for accessing RedNote(XiaoHongShu, xhs).

299. **[quickstart-resources](https://github.com/modelcontextprotocol/quickstart-resources)** - ⭐ 932
   A repository of servers and clients from the Model Context Protocol tutorials

300. **[awesome-devops-mcp-servers](https://github.com/rohitg00/awesome-devops-mcp-servers)** - ⭐ 919
   A curated list of awesome MCP servers focused on DevOps tools and capabilities.

301. **[CloudBase-MCP](https://github.com/TencentCloudBase/CloudBase-MCP)** - ⭐ 912
...
304. **[mcpdoc](https://github.com/langchain-ai/mcpdoc)** - ⭐ 897
   Expose llms-txt to IDEs for development

305. **[ref-tools-mcp](https://github.com/ref-tools/ref-tools-mcp)** - ⭐ 893
   Helping coding agents never make mistakes working with public or private libraries without wasting the context window.

306. **[short-video-maker](https://github.com/gyoridavid/short-video-maker)** - ⭐ 893
   Creates short videos for TikTok, Instagram Reels, and YouTube Shorts using the Model Context Protocol (MCP) and a REST API.

307. **[mcp-framework](https://github.com/QuantGeekDev/mcp-framework)** - ⭐ 889
   A framework for writing MCP (Model Context Protocol) servers in Typescript

308. **[Gmail-MCP-Server](https://github.com/GongRzhe/Gmail-MCP-Server)** - ⭐ 889
   A Model Context Protocol (MCP) server for Gmail integration in Claude Desktop with auto authentication support. This server enables AI assistants to manage Gmail through natural language interactions.

309. **[trustgraph](https://github.com/trustgraph-ai/trustgraph)** - ⭐ 889
   The Context Graph Factory for AI. Build, manage, and deploy AI-optimized Context Graphs.

310. **[ai-dev-tools-zoomcamp](https://github.com/DataTalksClub/ai-dev-tools-zoomcamp)** - ⭐ 888
...
311. **[claude-code-plugins-plus-skills](https://github.com/jeremylongshore/claude-code-plugins-plus-skills)** - ⭐ 888
   Hundreds of Claude Code plugins with embedded AI skills. Learn via interactive Jupyter tutorials.

312. **[awesome-agent-skills](https://github.com/heilcheng/awesome-agent-skills)** - ⭐ 885
   A curated list of skills, tools, tutorials, and capabilities for AI coding agents (Claude, Codex, Copilot, VS Code)

313. **[MCP-Bridge](https://github.com/SecretiveShell/MCP-Bridge)** - ⭐ 884
   A middleware to provide an openAI compatible endpoint that can call MCP tools

314. **[nuxt-mcp-dev](https://github.com/antfu/nuxt-mcp-dev)** - ⭐ 884
   MCP server helping models to understand your Vite/Nuxt app better.

315. **[Pixelle-MCP](https://github.com/AIDC-AI/Pixelle-MCP)** - ⭐ 882
   An Open-Source Multimodal AIGC Solution based on ComfyUI + MCP + LLM  https://pixelle.ai

316. **[docs-mcp-server](https://github.com/arabold/docs-mcp-server)** - ⭐ 882
   Grounded Docs MCP Server: Open-Source Alternative to Context7, Nia, and Ref.Tools

317. **[mix.core](https://github.com/mixcore/mix.core)** - ⭐ 880
   🚀 A future-proof enterprise web CMS supporting both headless and decoupled approaches. Build any type of app with customizable APIs on ASP.NET Core/.NET Core. Completely open-source and designed for flexibility.

318. **[mcp-windbg](https://github.com/svnscha/mcp-windbg)** - ⭐ 877
   Model Context Protocol for WinDBG

319. **[zotero-mcp](https://github.com/54yyyu/zotero-mcp)** - ⭐ 875
   Zotero MCP: Connects your Zotero research library with Claude and other AI assistants via the Model Context Protocol to discuss papers, get summaries, analyze citations, and more.

320. **[tools](https://github.com/strands-agents/tools)** - ⭐ 874
   A set of tools that gives agents powerful capabilities.

321. **[mongodb-mcp-server](https://github.com/mongodb-js/mongodb-mcp-server)** - ⭐ 871
   A Model Context Protocol server to connect to MongoDB databases and MongoDB Atlas Clusters.

322. **[MCProtocolLib](https://github.com/GeyserMC/MCProtocolLib)** - ⭐ 868
...
327. **[mcp-neo4j](https://github.com/neo4j-contrib/mcp-neo4j)** - ⭐ 863
   Neo4j Labs Model Context Protocol servers

328. **[google-calendar-mcp](https://github.com/nspady/google-calendar-mcp)** - ⭐ 859
   MCP integration for Google Calendar to manage events.

329. **[gitlab-mcp](https://github.com/zereight/gitlab-mcp)** - ⭐ 856
   First gitlab mcp for you

330. **[chatgpt-cli](https://github.com/kardolus/chatgpt-cli)** - ⭐ 855
...
331. **[awesome-mcp-list](https://github.com/MobinX/awesome-mcp-list)** - ⭐ 855
   A concise list for mcp servers

332. **[mcpm.sh](https://github.com/pathintegral-institute/mcpm.sh)** - ⭐ 851
   CLI MCP package manager & registry for all platforms and all clients. Search & configure MCP servers. Advanced Router & Profile features.

333. **[mcp-notion-server](https://github.com/suekou/mcp-notion-server)** - ⭐ 844

334. **[jupyter-mcp-server](https://github.com/datalayer/jupyter-mcp-server)** - ⭐ 837
...
339. **[gemini-nexus](https://github.com/yeahhe365/gemini-nexus)** - ⭐ 829
...
340. **[scira-mcp-chat](https://github.com/zaidmukaddam/scira-mcp-chat)** - ⭐ 823
...
342. **[OpenDerisk](https://github.com/derisk-ai/OpenDerisk)** - ⭐ 818
...
347. **[todo-for-ai](https://github.com/todo-for-ai/todo-for-ai)** - ⭐ 806
...
348. **[wassette](https://github.com/microsoft/wassette)** - ⭐ 799
...
351. **[DeepMCPAgent](https://github.com/cryxnet/DeepMCPAgent)** - ⭐ 792
   Model-agnostic plug-n-play LangChain/LangGraph agents powered entirely by MCP tools over HTTP/SSE.

352. **[openapi-servers](https://github.com/open-webui/openapi-servers)** - ⭐ 791
   OpenAPI Tool Servers

353. **[browser-use-mcp-server](https://github.com/kontext-dev/browser-use-mcp-server)** - ⭐ 791
   Browse the web, directly from Cursor etc.

354. **[trpc-agent-go](https://github.com/trpc-group/trpc-agent-go)** - ⭐ 788
...
358. **[Awesome-MCP-Servers](https://github.com/YuzeHao2023/Awesome-MCP-Servers)** - ⭐ 765
   A curated list of Model Context Protocol (MCP) servers 

359. **[MCPJungle](https://github.com/mcpjungle/MCPJungle)** - ⭐ 764
   Self-hosted MCP Gateway and Registry for AI agents

360. **[mcp-knowledge-graph](https://github.com/shaneholloman/mcp-knowledge-graph)** - ⭐ 763
   MCP server enabling persistent memory for Claude through a local knowledge graph - fork focused on local development

361. **[excel-mcp-server](https://github.com/negokaz/excel-mcp-server)** - ⭐ 761
   A Model Context Protocol (MCP) server that reads and writes MS Excel data

362. **[acemcp](https://github.com/qy527145/acemcp)** - ⭐ 757
   一个将ACE(Augment Context Engine) 做成MCP的项目

363. **[vibetest-use](https://github.com/browser-use/vibetest-use)** - ⭐ 757
   Vibetest MCP - automated QA testing using Browser-Use agents

364. **[Context](https://github.com/indragiek/Context)** - ⭐ 757
...
366. **[agent-kit](https://github.com/inngest/agent-kit)** - ⭐ 754
   AgentKit: Build multi-agent networks in TypeScript with deterministic routing and rich tooling via MCP.

367. **[kubectl-mcp-server](https://github.com/rohitg00/kubectl-mcp-server)** - ⭐ 750
...
369. **[k8m](https://github.com/weibaohui/k8m)** - ⭐ 747
...
377. **[wordpress-mcp](https://github.com/Automattic/wordpress-mcp)** - ⭐ 712
...
379. **[Unity-MCP](https://github.com/IvanMurzak/Unity-MCP)** - ⭐ 709
   AI-powered bridge connecting LLMs and advanced AI agents to the Unity Editor via the Model Context Protocol (MCP). Chat with AI to generate code, debug errors, and automate game development tasks directly within your project.

380. **[duckduckgo-mcp-server](https://github.com/nickclyde/duckduckgo-mcp-server)** - ⭐ 708
   A Model Context Protocol (MCP) server that provides web search capabilities through DuckDuckGo, with additional features for content fetching and parsing.

381. **[coderunner](https://github.com/instavm/coderunner)** - ⭐ 703
...
383. **[apple-docs-mcp](https://github.com/kimsungwhee/apple-docs-mcp)** - ⭐ 692
   MCP server for Apple Developer Documentation - Search iOS/macOS/SwiftUI/UIKit docs, WWDC videos, Swift/Objective-C APIs & code examples in Claude, Cursor & AI assistants

384. **[nanobot](https://github.com/nanobot-ai/nanobot)** - ⭐ 690
   Build MCP Agents

385. **[llm-functions](https://github.com/sigoden/llm-functions)** - ⭐ 690
   Easily create LLM tools and agents using plain Bash/JavaScript/Python functions.

386. **[just-prompt](https://github.com/disler/just-prompt)** - ⭐ 689
...
387. **[linkedin-mcp-server](https://github.com/stickerdaniel/linkedin-mcp-server)** - ⭐ 683
...
389. **[apify-mcp-server](https://github.com/apify/apify-mcp-server)** - ⭐ 676
   The Apify MCP server enables your AI agents to extract data from social media, search engines, maps, e-commerce sites, or any other website using thousands of ready-made scrapers, crawlers, and automation tools available on the Apify Store.

390. **[mcp](https://github.com/hyperbrowserai/mcp)** - ⭐ 672
   A MCP server implementation for hyperbrowser

391. **[HowToCook-mcp](https://github.com/worryzyy/HowToCook-mcp)** - ⭐ 672
   基于Anduin2017 / HowToCook （程序员在家做饭指南）的mcp server

392. **[ruby-sdk](https://github.com/modelcontextprotocol/ruby-sdk)** - ⭐ 670
   The official Ruby SDK for the Model Context Protocol. Maintained in collaboration with Shopify.

393. **[12306-mcp](https://github.com/Joooook/12306-mcp)** - ⭐ 669
   This is a 12306 ticket search server based on the Model Context Protocol (MCP).

394. **[mcp-server-docker](https://github.com/ckreiling/mcp-server-docker)** - ⭐ 666
   MCP server for Docker

395. **[octocode-mcp](https://github.com/bgauryy/octocode-mcp)** - ⭐ 664
   MCP server for semantic code research and context generation on real-time using LLM patterns | Search naturally across public & private repos based on your permissions | Transform any accessible codebase/s into AI-optimized knowledge on simple and complex flows | Find real implementations and live docs from anywhere

396. **[fetch-mcp](https://github.com/zcaceres/fetch-mcp)** - ⭐ 663
   A flexible HTTP fetching Model Context Protocol server.

397. **[clojure-mcp](https://github.com/bhauman/clojure-mcp)** - ⭐ 662
   Clojure MCP

398. **[go-mcp](https://github.com/ThinkInAIXYZ/go-mcp)** - ⭐ 657
...
399. **[mcp-client-cli](https://github.com/adhikasp/mcp-client-cli)** - ⭐ 656
   A simple CLI to run LLM prompt and implement MCP client.

400. **[yacy_grid_mcp](https://github.com/yacy/yacy_grid_mcp)** - ⭐ 655
   The YaCy Grid Master Connect Program

401. **[code-index-mcp](https://github.com/johnhuang316/code-index-mcp)** - ⭐ 650
   A Model Context Protocol (MCP) server that helps large language models index, search, and analyze code repositories with minimal setup

402. **[mcporter](https://github.com/steipete/mcporter)** - ⭐ 648
   Call MCPs via TypeScript, masquerading as simple TypeScript API. Or package them as cli.

403. **[llm-server-docs](https://github.com/varunvasudeva1/llm-server-docs)** - ⭐ 646
   End-to-end documentation to set up your own local & fully private LLM server on Debian. Equipped with chat, web search, RAG, model management, MCP servers, image generation, and TTS.

404. **[Claude-Code-Everything-You-Need-to-Know](https://github.com/wesammustafa/Claude-Code-Everything-You-Need-to-Know)** - ⭐ 644
...
410. **[mcp-clickhouse](https://github.com/ClickHouse/mcp-clickhouse)** - ⭐ 634
   Connect ClickHouse to your AI assistants.

411. **[python-utcp](https://github.com/universal-tool-calling-protocol/python-utcp)** - ⭐ 633
...
414. **[android-mcp-server](https://github.com/minhalvp/android-mcp-server)** - ⭐ 626
...
416. **[open-ptc-agent](https://github.com/Chen-zexi/open-ptc-agent)** - ⭐ 621
   An open source implementation of code execution with MCP (Programatic Tool Calling) 

417. **[mcp](https://github.com/laravel/mcp)** - ⭐ 618
...
420. **[awesome-mcp-security](https://github.com/Puliczek/awesome-mcp-security)** - ⭐ 613
   🔥🔒 Awesome MCP (Model Context Protocol) Security 🖥️

421. **[phpMyFAQ](https://github.com/thorsten/phpMyFAQ)** - ⭐ 612
   phpMyFAQ - Open Source FAQ web application for PHP 8.3+ and MySQL, PostgreSQL and other databases

422. **[obsidian-mcp](https://github.com/StevenStavrakis/obsidian-mcp)** - ⭐ 612
...
426. **[FantasyPremierLeague](https://github.com/joreilly/FantasyPremierLeague)** - ⭐ 591
   Fantasy Premier League Kotlin/Compose Multiplatform sample 

427. **[gcloud-mcp](https://github.com/googleapis/gcloud-mcp)** - ⭐ 591
   gcloud MCP server
...
430. **[vibe](https://github.com/mondaycom/vibe)** - ⭐ 587
   🎨 Vibe Design System - Official monday.com UI resources for application development in React.js

431. **[himarket](https://github.com/higress-group/himarket)** - ⭐ 584
...
433. **[mcp-server-elasticsearch](https://github.com/elastic/mcp-server-elasticsearch)** - ⭐ 582

434. **[tome](https://github.com/runebookai/tome)** - ⭐ 581
   a magical LLM desktop client that makes it easy for *anyone* to use LLMs and MCP

435. **[mcp-google-sheets](https://github.com/xing5/mcp-google-sheets)** - ⭐ 581
   This MCP server integrates with your Google Drive and Google Sheets, to enable creating and modifying spreadsheets.

436. **[daydreams](https://github.com/daydreamsai/daydreams)** - ⭐ 580
   Daydreams is a set of tools for building agents for commerce

437. **[yargi-mcp](https://github.com/saidsurucu/yargi-mcp)** - ⭐ 580
   MCP Server For Turkish Legal Databases

438. **[dexto](https://github.com/truffle-ai/dexto)** - ⭐ 572
...
439. **[mcp-filesystem-server](https://github.com/mark3labs/mcp-filesystem-server)** - ⭐ 572
   Go server implementing Model Context Protocol (MCP) for filesystem operations.

440. **[blueprint-mcp](https://github.com/ArcadeAI/blueprint-mcp)** - ⭐ 569
...
442. **[mcp_excalidraw](https://github.com/yctimlin/mcp_excalidraw)** - ⭐ 562
...
445. **[mcp-sequentialthinking-tools](https://github.com/spences10/mcp-sequentialthinking-tools)** - ⭐ 551
   🧠 An adaptation of the MCP Sequential Thinking Server to guide tool usage. This server provides recommendations for which MCP tools would be most effective at each stage.

446. **[mem0-mcp](https://github.com/mem0ai/mem0-mcp)** - ⭐ 550

447. **[obot](https://github.com/obot-platform/obot)** - ⭐ 546
...
449. **[a-share-mcp-is-just-i-need](https://github.com/24mlight/a-share-mcp-is-just-i-need)** - ⭐ 542

450. **[mcp-shield](https://github.com/riseandignite/mcp-shield)** - ⭐ 541
   Security scanner for MCP servers

451. **[evo-ai](https://github.com/EvolutionAPI/evo-ai)** - ⭐ 534
   Evo AI is an open-source platform for creating and managing AI agents, enabling integration with different AI models and services.

452. **[MCP-Universe](https://github.com/SalesforceAIResearch/MCP-Universe)** - ⭐ 534
   MCP-Universe is a comprehensive framework designed for developing, testing, and benchmarking AI agents

453. **[pg-mcp-server](https://github.com/stuzero/pg-mcp-server)** - ⭐ 533

454. **[LLMTornado](https://github.com/lofcz/LLMTornado)** - ⭐ 533
   The .NET library to build AI agents with 25+ built-in connectors.

455. **[vite-plugin-vue-mcp](https://github.com/webfansplz/vite-plugin-vue-mcp)** - ⭐ 532
...
460. **[macos-automator-mcp](https://github.com/steipete/macos-automator-mcp)** - ⭐ 530
   An MCP server to run AppleScript and JXA (JavaScript for Automation) to macOS.

461. **[telegram-mcp](https://github.com/chigwell/telegram-mcp)** - ⭐ 529
   Telegram MCP server powered by Telethon to let MCP clients read chats, manage groups, and send/modify messages, media, contacts, and settings.

462. **[mcp-handler](https://github.com/vercel/mcp-handler)** - ⭐ 526
   Easily spin up an MCP Server on Next.js, Nuxt, Svelte, and more

463. **[google-search](https://github.com/web-agent-master/google-search)** - ⭐ 524
   A Playwright-based Node.js tool that bypasses search engine anti-scraping mechanisms to execute Google searches. Local alternative to SERP APIs with MCP server integration.

464. **[wren-engine](https://github.com/Canner/wren-engine)** - ⭐ 522
   🤖 The Semantic Engine for Model Context Protocol(MCP) Clients and AI Agents 🔥 

465. **[multimodal-agents-course](https://github.com/the-ai-merge/multimodal-agents-course)** - ⭐ 520
   An MCP Multimodal AI Agent with eyes and ears!

466. **[drawio-mcp-server](https://github.com/lgazo/drawio-mcp-server)** - ⭐ 520
   Draw.io Model Context Protocol (MCP) Server

467. **[mcp.el](https://github.com/lizqwerscott/mcp.el)** - ⭐ 519
   An Mcp client inside Emacs

468. **[mcp-server-data-exploration](https://github.com/reading-plus-ai/mcp-server-data-exploration)** - ⭐ 519

469. **[pgmcp](https://github.com/subnetmarco/pgmcp)** - ⭐ 517
   An MCP server to query any Postgres database in natural language.

470. **[mcp-for-security](https://github.com/cyproxio/mcp-for-security)** - ⭐ 517
   MCP for Security: A collection of Model Context Protocol servers for popular security tools like SQLMap, FFUF, NMAP, Masscan and more. Integrate security testing and penetration testing into AI workflows.

471. **[ethora](https://github.com/dappros/ethora)** - ⭐ 516
...
473. **[paper-search-mcp](https://github.com/openags/paper-search-mcp)** - ⭐ 513
   A MCP for searching and downloading academic papers from multiple sources like arXiv, PubMed, bioRxiv, etc.

474. **[douyin-mcp-server](https://github.com/yzfly/douyin-mcp-server)** - ⭐ 513
   提取抖音无水印视频链接，视频文案，douyin-mcp-server

475. **[homeassistant-mcp](https://github.com/tevonsb/homeassistant-mcp)** - ⭐ 508
   A MCP server for Home Assistant

476. **[multimodal-agents-course](https://github.com/multi-modal-ai/multimodal-agents-course)** - ⭐ 507
   An MCP Multimodal AI Agent with eyes and ears!

477. **[apple-health-mcp](https://github.com/neiltron/apple-health-mcp)** - ⭐ 507
   MCP server for querying Apple Health data with natural language and SQL

478. **[awesome-mcp-servers](https://github.com/TensorBlock/awesome-mcp-servers)** - ⭐ 507
   A comprehensive collection of Model Context Protocol (MCP) servers

479. **[obsidian-mcp-tools](https://github.com/jacksteamdev/obsidian-mcp-tools)** - ⭐ 507
   Add Obsidian integrations like semantic search and custom Templater prompts to Claude or any MCP client.

480. **[gateway](https://github.com/centralmind/gateway)** - ⭐ 506
   Universal MCP-Server for your Databases optimized for LLMs and AI-Agents.

481. **[echokit_server](https://github.com/second-state/echokit_server)** - ⭐ 506
   Open Source Voice Agent Platform

482. **[ida-mcp-server](https://github.com/MxIris-Reverse-Engineering/ida-mcp-server)** - ⭐ 506
   A Model Context Protocol server for IDA

483. **[line-bot-mcp-server](https://github.com/line/line-bot-mcp-server)** - ⭐ 506
   MCP server that integrates the LINE Messaging API to connect an AI Agent to the LINE Official Account.

484. **[mcpcan](https://github.com/Kymo-MCP/mcpcan)** - ⭐ 506
...
485. **[iterm-mcp](https://github.com/ferrislucas/iterm-mcp)** - ⭐ 504
   A Model Context Protocol server that executes commands in the current iTerm session - useful for REPL and CLI assistance

486. **[cloud-run-mcp](https://github.com/GoogleCloudPlatform/cloud-run-mcp)** - ⭐ 504
   MCP server to deploy apps to Cloud Run

487. **[mcp-server-weread](https://github.com/freestylefly/mcp-server-weread)** - ⭐ 502
   微信读书MCP

488. **[mcp-get](https://github.com/michaellatman/mcp-get)** - ⭐ 499
...
491. **[next-devtools-mcp](https://github.com/vercel/next-devtools-mcp)** - ⭐ 496
...
493. **[sentry-mcp](https://github.com/getsentry/sentry-mcp)** - ⭐ 493
...
495. **[reverse-engineering-assistant](https://github.com/cyberkaida/reverse-engineering-assistant)** - ⭐ 491
   MCP server for reverse engineering tasks in Ghidra 👩‍💻

496. **[web-agent-protocol](https://github.com/OTA-Tech-AI/web-agent-protocol)** - ⭐ 487
   🌐Web Agent Protocol (WAP) - Record and replay user interactions in the browser with MCP support

497. **[UnityMCP](https://github.com/Arodoid/UnityMCP)** - ⭐ 486
...
502. **[cclsp](https://github.com/ktnyt/cclsp)** - ⭐ 477
   Claude Code LSP: enhance your Claude Code experience with non-IDE dependent LSP integration.

503. **[mcp-pandoc](https://github.com/vivekVells/mcp-pandoc)** - ⭐ 475
   MCP server for document format conversion using pandoc.

504. **[brave-search-mcp-server](https://github.com/brave/brave-search-mcp-server)** - ⭐ 474

505. **[rails-mcp-server](https://github.com/maquina-app/rails-mcp-server)** - ⭐ 471
   A Ruby gem implementation of a Model Context Protocol (MCP) server for Rails projects. This server allows LLMs (Large Language Models) to interact with Rails projects through the Model Context Protocol.

506. **[aser](https://github.com/AmeNetwork/aser)** - ⭐ 470
   Aser is a lightweight, self-assembling AI Agent frame.

507. **[open-multi-agent-canvas](https://github.com/CopilotKit/open-multi-agent-canvas)** - ⭐ 469
   The open-source multi-agent chat interface that lets you manage multiple agents in one dynamic conversation and add MCP servers for deep research

508. **[mcp-gsuite](https://github.com/MarkusPfundstein/mcp-gsuite)** - ⭐ 468
   MCP Server to interact with Google Gsuite prodcuts

509. **[UnrealMCP](https://github.com/kvick-games/UnrealMCP)** - ⭐ 468
...
517. **[CyberStrikeAI](https://github.com/Ed1s0nZ/CyberStrikeAI)** - ⭐ 457
...
518. **[chroma-mcp](https://github.com/chroma-core/chroma-mcp)** - ⭐ 456
   A Model Context Protocol (MCP) server implementation that provides database capabilities for Chroma

519. **[copilot-mcp](https://github.com/VikashLoomba/copilot-mcp)** - ⭐ 454
...
520. **[mcp-client-for-ollama](https://github.com/jonigl/mcp-client-for-ollama)** - ⭐ 454
   A text-based user interface (TUI) client for interacting with MCP servers using Ollama. Features include agent mode, multi-server, model switching, streaming responses, tool management, human-in-the-loop, thinking mode, model params config, MCP prompts, custom system prompt and saved preferences. Built for developers working with local LLMs.

521. **[AnyTool](https://github.com/HKUDS/AnyTool)** - ⭐ 454
   "AnyTool: Universal Tool-Use Layer for AI Agents"

522. **[n8n-workflow-builder](https://github.com/makafeli/n8n-workflow-builder)** - ⭐ 452
   AI assistant integration for n8n workflow automation through Model Context Protocol (MCP). Connect Claude Desktop, ChatGPT, and other AI assistants to n8n for natural language workflow management.

523. **[davinci-resolve-mcp](https://github.com/samuelgursky/davinci-resolve-mcp)** - ⭐ 451
   MCP server integration for DaVinci Resolve

524. **[argo](https://github.com/xark-argo/argo)** - ⭐ 449
   ARGO is an open-source AI Agent platform that brings Local Manus to your desktop. With one-click model downloads, seamless closed LLM integration, and offline-first RAG knowledge bases, ARGO becomes a DeepResearch powerhouse for autonomous thinking, task planning, and 100% of your data stays locally. Support Win/Mac/Docker.

525. **[dbt-mcp](https://github.com/dbt-labs/dbt-mcp)** - ⭐ 449
   A MCP (Model Context Protocol) server for interacting with dbt.

526. **[nexus](https://github.com/grafbase/nexus)** - ⭐ 446
   Govern & Secure your AI

527. **[vibe-check-mcp-server](https://github.com/PV-Bhat/vibe-check-mcp-server)** - ⭐ 445
   Vibe Check is a tool that provides mentor-like feedback to AI Agents, preventing tunnel-vision, over-engineering and reasoning lock-in for complex and long-horizon agent workflows. KISS your over-eager AI Agents goodbye! Effective for: Coding, Ambiguous Tasks, High-Risk tasks

528. **[director](https://github.com/director-run/director)** - ⭐ 444
   MCP Playbooks for AI agents

529. **[haiku.rag](https://github.com/ggozad/haiku.rag)** - ⭐ 440
   Opinionated agentic RAG powered by LanceDB, Pydantic AI, and Docling

530. **[docker-mcp](https://github.com/QuantGeekDev/docker-mcp)** - ⭐ 439
...
533. **[freecad-mcp](https://github.com/neka-nat/freecad-mcp)** - ⭐ 436
   FreeCAD MCP(Model Context Protocol) server

534. **[mcpe](https://github.com/ReMinecraftPE/mcpe)** - ⭐ 435
   ReMinecraftPE - A custom experience based on Minecraft PE as of 2011.

535. **[alpaca-mcp-server](https://github.com/alpacahq/alpaca-mcp-server)** - ⭐ 434
   Alpaca’s official MCP Server lets you trade stocks, ETFs, crypto, and options, run data analysis, and build strategies in plain English directly from your favorite LLM tools and IDEs

536. **[borsa-mcp](https://github.com/saidsurucu/borsa-mcp)** - ⭐ 434
...
539. **[MCP-Kali-Server](https://github.com/Wh0am123/MCP-Kali-Server)** - ⭐ 432
   MCP configuration to connect AI agent to a Linux machine.

540. **[flux-operator](https://github.com/controlplaneio-fluxcd/flux-operator)** - ⭐ 428
   GitOps on Autopilot Mode

541. **[web-search-mcp](https://github.com/mrkrsl/web-search-mcp)** - ⭐ 426
   A simple, locally hosted Web Search MCP server for use with Local LLMs

542. **[mcp-send-email](https://github.com/resend/mcp-send-email)** - ⭐ 423
...
546. **[mcp-server-spec-driven-development](https://github.com/formulahendry/mcp-server-spec-driven-development)** - ⭐ 418
...
548. **[mcp-bench](https://github.com/Accenture/mcp-bench)** - ⭐ 417
   MCP-Bench: Benchmarking Tool-Using LLM Agents with Complex Real-World Tasks via MCP Servers

549. **[kratos-transport](https://github.com/tx7do/kratos-transport)** - ⭐ 416
...
553. **[mcpadapt](https://github.com/grll/mcpadapt)** - ⭐ 414
   Unlock 650+ MCP servers tools in your favorite agentic framework.

554. **[youtube-mcp-server](https://github.com/ZubeidHendricks/youtube-mcp-server)** - ⭐ 414
   MCP Server for YouTube API, enabling video management, Shorts creation, and advanced analytics

555. **[NetCoreKevin](https://github.com/junkai-li/NetCoreKevin)** - ⭐ 410
...
556. **[learn-low-code-agentic-ai](https://github.com/panaversity/learn-low-code-agentic-ai)** - ⭐ 409
...
557. **[pdf-reader-mcp](https://github.com/SylphxAI/pdf-reader-mcp)** - ⭐ 407
   📄 Production-ready MCP server for PDF processing - 5-10x faster with parallel processing and 94%+ test coverage

558. **[MetasploitMCP](https://github.com/GH05TCREW/MetasploitMCP)** - ⭐ 406
   MCP Server for Metasploit

559. **[mcp-hub](https://github.com/ravitemer/mcp-hub)** - ⭐ 405
   A centralized manager for Model Context Protocol (MCP) servers with dynamic server management and monitoring

560. **[mcp-adapter](https://github.com/WordPress/mcp-adapter)** - ⭐ 405
   An MCP adapter that bridges the Abilities API to the Model Context Protocol, enabling MCP clients to discover and invoke WordPress plugin, theme, and core abilities programmatically.

561. **[shinkai-local-ai-agents](https://github.com/dcSpark/shinkai-local-ai-agents)** - ⭐ 404
...
562. **[AgentX](https://github.com/lucky-aeon/AgentX)** - ⭐ 403
...
564. **[RestClient.Net](https://github.com/MelbourneDeveloper/RestClient.Net)** - ⭐ 401
   The safest way to make REST calls in C# with an MCP Generator

565. **[mcp-gateway](https://github.com/microsoft/mcp-gateway)** - ⭐ 401
   MCP Gateway is a reverse proxy and management layer for MCP servers, enabling scalable, session-aware stateful routing and lifecycle management of MCP servers in Kubernetes environments.

566. **[archestra](https://github.com/archestra-ai/archestra)** - ⭐ 400
...
568. **[meta-ads-mcp](https://github.com/pipeboard-co/meta-ads-mcp)** - ⭐ 396
   MCP server to manage Facebook and Instagram Ads (Meta Ads)

569. **[Software-planning-mcp](https://github.com/NightTrek/Software-planning-mcp)** - ⭐ 395
   An experiment in software planning using MCP

570. **[applescript-mcp](https://github.com/peakmojo/applescript-mcp)** - ⭐ 395
...
575. **[azure-ai-travel-agents](https://github.com/Azure-Samples/azure-ai-travel-agents)** - ⭐ 388
...
576. **[ai-trader](https://github.com/whchien/ai-trader)** - ⭐ 388
   Backtrader-powered backtesting framework for algorithmic trading, featuring 20+ strategies, multi-market support, CLI tools, and an integrated MCP server for professional traders.

577. **[mcp-registry](https://github.com/docker/mcp-registry)** - ⭐ 387
   Official Docker MCP registry 

578. **[MCP](https://github.com/jina-ai/MCP)** - ⭐ 385
   Official Jina AI Remote MCP Server

579. **[mcp-nixos](https://github.com/utensils/mcp-nixos)** - ⭐ 384
   MCP-NixOS - Model Context Protocol Server for NixOS resources

580. **[memento-mcp](https://github.com/gannonh/memento-mcp)** - ⭐ 384
   Memento MCP: A Knowledge Graph Memory System for LLMs

581. **[biomcp](https://github.com/genomoncology/biomcp)** - ⭐ 382
   BioMCP: Biomedical Model Context Protocol

582. **[mcp-alchemy](https://github.com/runekaagaard/mcp-alchemy)** - ⭐ 382
   A MCP (model context protocol) server that gives the LLM access to and knowledge about relational databases like SQLite, Postgresql, MySQL & MariaDB, Oracle, and MS-SQL.

583. **[groq-desktop-beta](https://github.com/groq/groq-desktop-beta)** - ⭐ 382
...
586. **[chatluna](https://github.com/ChatLunaLab/chatluna)** - ⭐ 380
...
587. **[ai4j](https://github.com/LnYo-Cly/ai4j)** - ⭐ 379
...
589. **[lunar](https://github.com/TheLunarCompany/lunar)** - ⭐ 377
   lunar.dev: Agent native MCP Gateway for governance and security

590. **[mcp-hfspace](https://github.com/evalstate/mcp-hfspace)** - ⭐ 376
   MCP Server to Use HuggingFace spaces, easy configuration and Claude Desktop mode. 

591. **[ms-365-mcp-server](https://github.com/Softeria/ms-365-mcp-server)** - ⭐ 376
...
593. **[mcp-searxng](https://github.com/ihor-sokoliuk/mcp-searxng)** - ⭐ 375
...
598. **[mcp-server-youtube-transcript](https://github.com/kimtaeyoon83/mcp-server-youtube-transcript)** - ⭐ 369
...
602. **[mcp-server](https://github.com/e2b-dev/mcp-server)** - ⭐ 366
   Giving Claude ability to run code with E2B via MCP (Model Context Protocol)

603. **[mnemo](https://github.com/MnemoAI/mnemo)** - ⭐ 365
...
607. **[sdk-typescript](https://github.com/strands-agents/sdk-typescript)** - ⭐ 363
   A model-driven approach to building AI agents in just a few lines of code. 

608. **[mcp-gateway-registry](https://github.com/agentic-community/mcp-gateway-registry)** - ⭐ 362
...
609. **[docfork-mcp](https://github.com/docfork/docfork-mcp)** - ⭐ 362
   Up-to-date Documentation for AI Agents.

610. **[mcp-sdk-php](https://github.com/logiscape/mcp-sdk-php)** - ⭐ 361
...
613. **[cocos-mcp-server](https://github.com/DaxianLee/cocos-mcp-server)** - ⭐ 358
...
616. **[mcpmark](https://github.com/eval-sys/mcpmark)** - ⭐ 357
   MCPMark is a comprehensive, stress-testing MCP benchmark designed to evaluate model and agent capabilities in real-world MCP use.

617. **[MCPSharp](https://github.com/afrise/MCPSharp)** - ⭐ 356
   MCPSharp is a .NET library that helps you build Model Context Protocol (MCP) servers and clients - the standardized API protocol used by AI assistants and models.

618. **[Redbook-Search-Comment-MCP2.0](https://github.com/chenningling/Redbook-Search-Comment-MCP2.0)** - ⭐ 355
...
624. **[mcp-mermaid](https://github.com/hustcc/mcp-mermaid)** - ⭐ 351
...
630. **[puppeteer-mcp-server](https://github.com/merajmehrabi/puppeteer-mcp-server)** - ⭐ 345
   This MCP server provides browser automation capabilities through Puppeteer, allowing interaction with both new browser instances and existing Chrome windows.

631. **[mcpr](https://github.com/conikeec/mcpr)** - ⭐ 344
...
637. **[mcp-graphql](https://github.com/blurrah/mcp-graphql)** - ⭐ 342
   Model Context Protocol server for GraphQL

638. **[daan](https://github.com/pluveto/daan)** - ⭐ 341
   ✨Lightweight LLM Client with MCP 🔌 & Characters 👤

639. **[codexia](https://github.com/milisp/codexia)** - ⭐ 341
   A powerfull GUI/IDE and Toolkit for Codex CLI + Claude Code. FileTree + prompt notepad + git worktree and more

640. **[Construction-Hazard-Detection](https://github.com/yihong1120/Construction-Hazard-Detection)** - ⭐ 340
   Enhances construction site safety using YOLO for object detection, identifying hazards like workers without helmets or safety vests, and proximity to machinery or vehicles. HDBSCAN clusters safety cone coordinates to create monitored zones. Post-processing algorithms improve detection accuracy.

641. **[linear-mcp-server](https://github.com/jerhadf/linear-mcp-server)** - ⭐ 340
   A server that integrates Linear's project management system with the Model Context Protocol (MCP) to allow LLMs to interact with Linear.

642. **[xcode-mcp-server](https://github.com/r-huijts/xcode-mcp-server)** - ⭐ 339
   MCP Server implementation for Xcode integration

643. **[applescript-mcp](https://github.com/joshrutkowski/applescript-mcp)** - ⭐ 339
   A macOS AppleScript MCP server

644. **[home-assistant-vibecode-agent](https://github.com/Coolver/home-assistant-vibecode-agent)** - ⭐ 338
...
645. **[notebooklm-mcp](https://github.com/PleasePrompto/notebooklm-mcp)** - ⭐ 338
   MCP server for NotebookLM - Let your AI agents (Claude Code, Codex) research documentation directly with grounded, citation-backed answers from Gemini. Persistent auth, library management, cross-client sharing. Zero hallucinations, just your knowledge base.

646. **[awesome-cursor-mpc-server](https://github.com/kleneway/awesome-cursor-mpc-server)** - ⭐ 337
   Example of an MCP server with custom tools that can be called directly from cursor

647. **[twitter-mcp](https://github.com/EnesCinr/twitter-mcp)** - ⭐ 337
   A Model Context Protocol server allows to interact with Twitter, enabling posting tweets and searching Twitter.

648. **[a2a-directory](https://github.com/sing1ee/a2a-directory)** - ⭐ 337
   Agent2Agent (A2A) – AgentCards, Servers, Clients, Docs

649. **[f2c-mcp](https://github.com/f2c-ai/f2c-mcp)** - ⭐ 337
   F2C MCP Server

650. **[devtools-debugger-mcp](https://github.com/ScriptedAlchemy/devtools-debugger-mcp)** - ⭐ 337
   An MCP server exposing full Chrome DevTools Protocol debugging: breakpoints, step/run, call stacks, eval, and source maps.

651. **[paws-on-mcp](https://github.com/hemanth/paws-on-mcp)** - ⭐ 335
   A comprehensive Model Context Protocol (MCP) server implementing the latest specification.

652. **[reddit-mcp-buddy](https://github.com/karanb192/reddit-mcp-buddy)** - ⭐ 335
   Clean, LLM-optimized Reddit MCP server. Browse posts, search content, analyze users. No fluff, just Reddit data.

653. **[sonarqube-mcp-server](https://github.com/SonarSource/sonarqube-mcp-server)** - ⭐ 335
   SonarQube MCP Server

654. **[agent](https://github.com/1mcp-app/agent)** - ⭐ 335
   A unified Model Context Protocol server implementation that aggregates multiple MCP servers into one.

655. **[WebMCP](https://github.com/jasonjmcghee/WebMCP)** - ⭐ 333
...
656. **[lanhu-mcp](https://github.com/dsphper/lanhu-mcp)** - ⭐ 333
   ⚡ 需求分析效率提升 200%！全球首个为 AI 编程时代设计的团队协作 MCP 服务器，自动分析需求自动编写前后端代码，下载切图

657. **[lark-openapi-mcp](https://github.com/larksuite/lark-openapi-mcp)** - ⭐ 333
   飞书/Lark官方 OpenAPI MCP

658. **[base-mcp](https://github.com/base/base-mcp)** - ⭐ 332
   A Model Context Protocol (MCP) server that provides onchain tools for LLMs, allowing them to interact with the Base network and Coinbase API.

659. **[devopness](https://github.com/devopness/devopness)** - ⭐ 332
   DevOps Happiness: 1-click or 1-prompt MCP. Deploy apps + infra + CI/CD on your cloud. Happy humans + reliable agents. 🚀

660. **[mineru-tianshu](https://github.com/magicyuan876/mineru-tianshu)** - ⭐ 332
   天枢 - 企业级 AI 一站式数据预处理平台 | PDF/Office转Markdown | 支持MCP协议AI助手集成 | Vue3+FastAPI全栈方案 | 文档解析 | 多模态信息提取

661. **[db-mcp-server](https://github.com/FreePeak/db-mcp-server)** - ⭐ 331
   A powerful multi-database server implementing the Model Context Protocol (MCP) to provide AI assistants with structured access to databases.

662. **[claude-codepro](https://github.com/maxritter/claude-codepro)** - ⭐ 331
...
663. **[interactive-mcp](https://github.com/ttommyth/interactive-mcp)** - ⭐ 330
   Vibe coding should have human in the loop! interactive-mcp: Local, cross-platform MCP server for interact with your AI Agent

664. **[hermes-mcp](https://github.com/cloudwalk/hermes-mcp)** - ⭐ 328
   Elixir Model Context Protocol (MCP) SDK

665. **[laravel-mcp-server](https://github.com/opgginc/laravel-mcp-server)** - ⭐ 327
...
667. **[mcp-reddit](https://github.com/adhikasp/mcp-reddit)** - ⭐ 327
   A Model Context Protocol (MCP) server that provides tools for fetching and analyzing Reddit content.

668. **[mcp-for-next.js](https://github.com/vercel-labs/mcp-for-next.js)** - ⭐ 326

669. **[nuwax](https://github.com/nuwax-ai/nuwax)** - ⭐ 326
...
670. **[MemoryMesh](https://github.com/CheMiguel23/MemoryMesh)** - ⭐ 325
...
678. **[mcp-gateway](https://github.com/lasso-security/mcp-gateway)** - ⭐ 321
   A plugin-based gateway that orchestrates other MCPs and allows developers to build upon it enterprise-grade agents.

679. **[Rube](https://github.com/ComposioHQ/Rube)** - ⭐ 321
...
685. **[Feishu-MCP](https://github.com/cso1z/Feishu-MCP)** - ⭐ 315
   为 Cursor、Windsurf、Cline 和其他 AI 驱动的编码工具提供访问、编辑和结构化处理飞书文档的能力，基于 Model Context Protocol 服务器实现。

686. **[obsidian-mcp-server](https://github.com/cyanheads/obsidian-mcp-server)** - ⭐ 315
   Obsidian Knowledge-Management MCP (Model Context Protocol) server that enables AI agents and development tools to interact with an Obsidian vault. It provides a comprehensive suite of tools for reading, writing, searching, and managing notes, tags, and frontmatter, acting as a bridge to the Obsidian Local REST API plugin.

687. **[CodeGraphContext](https://github.com/Shashankss1205/CodeGraphContext)** - ⭐ 315
   An MCP server plus a CLI tool that indexes local code into a graph database to provide context to AI assistants.

688. **[mcp-calculator](https://github.com/78/mcp-calculator)** - ⭐ 314
   Xiaozhi MCP sample program

689. **[autogenstudio-skills](https://github.com/madtank/autogenstudio-skills)** - ⭐ 313
   Repo of skills for autogen studio using model context protocol (mcp)

690. **[ClimateTraceKMP](https://github.com/joreilly/ClimateTraceKMP)** - ⭐ 313
   Kotlin/Compose Multiplatform project to show climate related emission data from https://climatetrace.org/data.

691. **[langconnect-client](https://github.com/teddynote-lab/langconnect-client)** - ⭐ 313
   A Modern GUI Interface for Vector Database Management(Supports MCP integration)

692. **[Ace-Mcp-Node](https://github.com/yeuxuan/Ace-Mcp-Node)** - ⭐ 313
...
693. **[mcp](https://github.com/IBM/mcp)** - ⭐ 312
...
695. **[abcoder](https://github.com/cloudwego/abcoder)** - ⭐ 308
   deep, reliable and confidential coding-context

696. **[vscode-mcp-server](https://github.com/juehang/vscode-mcp-server)** - ⭐ 307
   MCP server to expose VS Code editing features to an LLM for AI coding

697. **[WireMCP](https://github.com/0xKoda/WireMCP)** - ⭐ 303
   An MCP for WireShark (tshark). Empower LLM's with realtime network traffic analysis capability

698. **[mcp-sse](https://github.com/sidharthrajaram/mcp-sse)** - ⭐ 302
   A working pattern for SSE-based MCP clients and servers

699. **[skillz](https://github.com/intellectronica/skillz)** - ⭐ 302
   An MCP server for loading skills (shim for non-claude clients).

700. **[automcp](https://github.com/NapthaAI/automcp)** - ⭐ 301
   Easily convert tool, agents and orchestrators from existing agent frameworks to MCP servers

701. **[openmcp](https://github.com/getdatanaut/openmcp)** - ⭐ 301
   Turn any openapi file into an mcp server, with just the tools you need.

702. **[gptr-mcp](https://github.com/assafelovic/gptr-mcp)** - ⭐ 301
   MCP server for enabling LLM applications to perform deep research via the MCP protocol

703. **[mcprouter](https://github.com/chatmcp/mcprouter)** - ⭐ 301
   api router for MCP Servers

704. **[gemini-flow](https://github.com/clduab11/gemini-flow)** - ⭐ 301
   rUv's Claude-Flow, translated to the new Gemini CLI; transforming it into an autonomous AI development team.

705. **[code-sandbox-mcp](https://github.com/Automata-Labs-team/code-sandbox-mcp)** - ⭐ 300
...
708. **[mcp-server](https://github.com/mapbox/mcp-server)** - ⭐ 297
   Mapbox Model Context Protocol (MCP) server

709. **[investor-agent](https://github.com/ferdousbhai/investor-agent)** - ⭐ 296
   A Model Context Protocol server for building an investor agent

710. **[deep-research-mcp](https://github.com/Ozamatash/deep-research-mcp)** - ⭐ 296

711. **[agentcontrolplane](https://github.com/humanlayer/agentcontrolplane)** - ⭐ 296
...
712. **[agentscope-runtime](https://github.com/agentscope-ai/agentscope-runtime)** - ⭐ 296
   A Production-Ready Runtime Framework for Agent Deployment and Tool Sandbox

713. **[mcp-claude-code](https://github.com/SDGLBL/mcp-claude-code)** - ⭐ 295
   MCP implementation of Claude Code capabilities and more

714. **[mcp-obsidian](https://github.com/bitbonsai/mcp-obsidian)** - ⭐ 295
   A lightweight Model Context Protocol (MCP) server for safe Obsidian vault access

715. **[claude-codex-settings](https://github.com/fcakyon/claude-codex-settings)** - ⭐ 295
   My personal Claude Code and OpenAI Codex setup with battle-tested skills, commands, hooks, agents and MCP servers that I use daily.

716. **[mcp-git-ingest](https://github.com/adhikasp/mcp-git-ingest)** - ⭐ 294
   A Model Context Protocol (MCP) server that helps read GitHub repository structure and important files.

717. **[mcp-for-argocd](https://github.com/argoproj-labs/mcp-for-argocd)** - ⭐ 293
   An implementation of Model Context Protocol (MCP) server for Argo CD.

718. **[ast-grep-mcp](https://github.com/ast-grep/ast-grep-mcp)** - ⭐ 293

719. **[DeepWideResearch](https://github.com/puppyone-ai/DeepWideResearch)** - ⭐ 292
   Agentic RAG for any scenario. Customize sources, depth, and width

720. **[tradingview-mcp](https://github.com/atilaahmettaner/tradingview-mcp)** - ⭐ 292
...
721. **[mesh](https://github.com/decocms/mesh)** - ⭐ 291
   One secure endpoint for every MCP server. Deploy anywhere.

722. **[mcp-server-code-execution-mode](https://github.com/elusznik/mcp-server-code-execution-mode)** - ⭐ 289
...
725. **[awesome-claude-code-plugins](https://github.com/ccplugins/awesome-claude-code-plugins)** - ⭐ 288
   Awesome Claude Code plugins — a curated list of slash commands, subagents, MCP servers, and hooks for Claude Code

726. **[blender-mcp-vxai](https://github.com/VxASI/blender-mcp-vxai)** - ⭐ 287

727. **[deepseek-mcp-server](https://github.com/DMontgomery40/deepseek-mcp-server)** - ⭐ 287
   Model Context Protocol server for DeepSeek's advanced language models

728. **[mysql_mcp_server_pro](https://github.com/wenb1n-dev/mysql_mcp_server_pro)** - ⭐ 287
...
729. **[powerbi-modeling-mcp](https://github.com/microsoft/powerbi-modeling-mcp)** - ⭐ 287
   The Power BI Modeling MCP Server, brings Power BI semantic modeling capabilities to your AI agents.

730. **[maverick-mcp](https://github.com/wshobson/maverick-mcp)** - ⭐ 286
   MaverickMCP - Personal Stock Analysis MCP Server

731. **[o3-search-mcp](https://github.com/yoshiko-pg/o3-search-mcp)** - ⭐ 285
   MCP server for OpenAI o3 web search

732. **[ebook-mcp](https://github.com/onebirdrocks/ebook-mcp)** - ⭐ 285
...
734. **[claude-talk-to-figma-mcp](https://github.com/arinspunk/claude-talk-to-figma-mcp)** - ⭐ 284
...
735. **[meGPT](https://github.com/adrianco/meGPT)** - ⭐ 283
   Code to process many kinds of content by an author into an MCP server

736. **[hydra-mcp-solana](https://github.com/hydra-mcp/hydra-mcp-solana)** - ⭐ 283
   hydra-ai

737. **[mssql_mcp_server](https://github.com/RichardHan/mssql_mcp_server)** - ⭐ 283
...
739. **[mcp-everything-search](https://github.com/mamertofabian/mcp-everything-search)** - ⭐ 282

740. **[lets-learn-mcp-csharp](https://github.com/microsoft/lets-learn-mcp-csharp)** - ⭐ 282
...
743. **[generator](https://github.com/context-hub/generator)** - ⭐ 281
...
745. **[utcp-specification](https://github.com/universal-tool-calling-protocol/utcp-specification)** - ⭐ 280
   The specification for the Universal Tool Calling Protocol

746. **[consult7](https://github.com/szeider/consult7)** - ⭐ 279
...
768. **[AI-Kline](https://github.com/QuantML-C/AI-Kline)** - ⭐ 270
...
769. **[chrome-devtools-mcp](https://github.com/benjaminr/chrome-devtools-mcp)** - ⭐ 270
...
771. **[metorial-index](https://github.com/metorial/metorial-index)** - ⭐ 269
...
775. **[ultra-mcp](https://github.com/RealMikeChong/ultra-mcp)** - ⭐ 264
   100x Your Claude Code, Gemini CLI, Cursor and/or any coding tools with MCP client support

776. **[AetherLink](https://github.com/1600822305/AetherLink)** - ⭐ 264
...
777. **[obsidian-mcp](https://github.com/newtype-01/obsidian-mcp)** - ⭐ 264
   Obsidian MCP (Model Context Protocol) Server

778. **[model-context-protocol-resources](https://github.com/cyanheads/model-context-protocol-resources)** - ⭐ 263
   Exploring the Model Context Protocol (MCP) through practical guides, clients, and servers I've built while learning about this new protocol.

779. **[stealth-browser-mcp](https://github.com/vibheksoni/stealth-browser-mcp)** - ⭐ 263
...
783. **[MCPControl](https://github.com/claude-did-this/MCPControl)** - ⭐ 261
   MCP server for Windows OS automation

784. **[x64DbgMCPServer](https://github.com/AgentSmithers/x64DbgMCPServer)** - ⭐ 259
...
787. **[mcp-omnisearch](https://github.com/spences10/mcp-omnisearch)** - ⭐ 258
...
790. **[jadx-mcp-server](https://github.com/zinja-coder/jadx-mcp-server)** - ⭐ 256
...
794. **[kagimcp](https://github.com/kagisearch/kagimcp)** - ⭐ 253
   The Official Model Context Protocol (MCP) server for Kagi search & other tools.

795. **[deepcontext-mcp](https://github.com/Wildcard-Official/deepcontext-mcp)** - ⭐ 252
   DeepContext is an MCP server that adds symbol-aware semantic search to Claude Code, Codex CLI, and other agents for faster, smarter context on large codebases.

796. **[project-nova](https://github.com/dujonwalker/project-nova)** - ⭐ 252
...
797. **[django-mcp-server](https://github.com/gts360/django-mcp-server)** - ⭐ 250
...
799. **[claude-code-statusline](https://github.com/rz1989s/claude-code-statusline)** - ⭐ 249
...
800. **[api200](https://github.com/API-200/api200)** - ⭐ 248
   API 200 is an open source API gateway to simplify 3rd-party integrations. Import endpoints, set up caching, retries, and mocks. Access all services via one URL. Monitor logs, track errors, and get alerts on API incidents.

801. **[aci-mcp](https://github.com/aipotheosis-labs/aci-mcp)** - ⭐ 247
   MCP server(s) for Aipolabs ACI.dev

802. **[code-reasoning](https://github.com/mettamatt/code-reasoning)** - ⭐ 247
   A code reasoning MCP server, a fork of sequential-thinking

803. **[reddit-mcp](https://github.com/Arindam200/reddit-mcp)** - ⭐ 247
...
806. **[app-store-connect-mcp-server](https://github.com/JoshuaRileyDev/app-store-connect-mcp-server)** - ⭐ 246

807. **[safe-mcp](https://github.com/SAFE-MCP/safe-mcp)** - ⭐ 246
   SAFE-MCP is a comprehensive security framework for documenting and mitigating threats in the AI Agent ecosystem.

808. **[mcp-server-gemini](https://github.com/aliargun/mcp-server-gemini)** - ⭐ 244
   MCP server implementation for Google's Gemini API

809. **[MARM-Systems](https://github.com/Lyellr88/MARM-Systems)** - ⭐ 244
...
811. **[anytype-mcp](https://github.com/anyproto/anytype-mcp)** - ⭐ 243
   An MCP server enabling AI assistants to interact with Anytype - your encrypted, local and collaborative wiki - to organize objects, lists, and more through natural language.

812. **[unreal-engine-mcp](https://github.com/flopperam/unreal-engine-mcp)** - ⭐ 243
...
813. **[mcp-feedback-collector](https://github.com/sanshao85/mcp-feedback-collector)** - ⭐ 242
...
822. **[todoist-ai](https://github.com/Doist/todoist-ai)** - ⭐ 239
   A set of tools to connect to AI agents, to allow them to use Todoist on a user's behalf. Includes MCP support.

823. **[next-lens](https://github.com/1weiho/next-lens)** - ⭐ 238
   A CLI that scans Next.js routes and provides quick insights from your terminal, web UI, and MCP.

824. **[mcp](https://github.com/salesforcecli/mcp)** - ⭐ 238
   MCP Server for interacting with Salesforce instances

825. **[rust-docs-mcp-server](https://github.com/Govcraft/rust-docs-mcp-server)** - ⭐ 238
   🦀 Prevents outdated Rust code suggestions from AI assistants. This MCP server fetches current crate docs, uses embeddings/LLMs, and provides accurate context via a tool call.

826. **[mcp-youtube-transcript](https://github.com/jkawamoto/mcp-youtube-transcript)** - ⭐ 238
   MCP server retrieving transcripts of YouTube videos

827. **[video-editing-mcp](https://github.com/burningion/video-editing-mcp)** - ⭐ 237
   MCP Interface for Video Jungle

828. **[human-mcp](https://github.com/mrgoonie/human-mcp)** - ⭐ 237

829. **[Windows-MCP.Net](https://github.com/AIDotNet/Windows-MCP.Net)** - ⭐ 237
   A .NET-based Windows desktop automation MCP (Model Context Protocol) server that provides AI assistants with the ability to interact with the Windows desktop environment.

830. **[suppr-mcp](https://github.com/WildDataX/suppr-mcp)** - ⭐ 237
    超能文献|AI驱动的文档翻译与学术搜索服务。支持PDF、DOCX、PPTX等多格式文档的高质量翻译（支持11种语言），特别优化了数学公式翻译。同时提供PubMed学术文献智能搜索功能。更多访问：https://suppr.wilddata.cn

831. **[claude-code-mcpinstall](https://github.com/undeadpickle/claude-code-mcpinstall)** - ⭐ 236
   Easy guide to installing Claude Code MCPs globally on your machine.

832. **[mcp_massive](https://github.com/massive-com/mcp_massive)** - ⭐ 236
   An MCP server for Massive.com Financial Market Data

833. **[NFTIAI](https://github.com/Axarb/NFTIAI)** - ⭐ 235
...
834. **[claude_code-gemini-mcp](https://github.com/RaiAnsar/claude_code-gemini-mcp)** - ⭐ 235
   Simplified Gemini for Claude Code. 

835. **[mcp2py](https://github.com/MaximeRivest/mcp2py)** - ⭐ 234
   Turn any MCP server into a Python module

836. **[elasticsearch-mcp-server](https://github.com/cr7258/elasticsearch-mcp-server)** - ⭐ 234
   A Model Context Protocol (MCP) server implementation that provides Elasticsearch and OpenSearch interaction.

837. **[firebase-mcp](https://github.com/gannonh/firebase-mcp)** - ⭐ 234
   🔥 Model Context Protocol (MCP) server for Firebase.

838. **[weather-mcp-server](https://github.com/ezh0v/weather-mcp-server)** - ⭐ 233
   A lightweight Model Context Protocol (MCP) server that enables AI assistants like Claude to retrieve and interpret real-time weather data. Discuss on Hacker News:

839. **[mcp-on-vercel](https://github.com/vercel-labs/mcp-on-vercel)** - ⭐ 233

840. **[xiaozhi-client](https://github.com/shenjingnan/xiaozhi-client)** - ⭐ 233
   小智AI客户端，目前主要用于MCP的对接

841. **[mcp-server-code-runner](https://github.com/formulahendry/mcp-server-code-runner)** - ⭐ 233
   Code Runner MCP Server

842. **[Lambda-MCP-Server](https://github.com/mikegc-aws/Lambda-MCP-Server)** - ⭐ 232
   Creates a simple MCP tool server with "streaming" HTTP.

843. **[MCPBench](https://github.com/modelscope/MCPBench)** - ⭐ 232
   The evaluation benchmark on MCP servers

844. **[mcp-server-tree-sitter](https://github.com/wrale/mcp-server-tree-sitter)** - ⭐ 232
   MCP Server for Tree-sitter

845. **[bazi-mcp](https://github.com/cantian-ai/bazi-mcp)** - ⭐ 230
   MCP server for Bazi (八字) information

846. **[Android-MCP](https://github.com/CursorTouch/Android-MCP)** - ⭐ 230
   Lightweight MCP Server for interacting with Android Operating System.

847. **[MCP-connect](https://github.com/EvalsOne/MCP-connect)** - ⭐ 228
   Enables cloud-based AI services to access local Stdio based MCP servers via HTTP requests

848. **[mcp_flutter](https://github.com/Arenukvern/mcp_flutter)** - ⭐ 228
   MCP server and MCP Toolkit  for Flutter and Dart VM - supports dynamic tooling

849. **[dat](https://github.com/hexinfo/dat)** - ⭐ 227
   Asking yours data in a natural language way through pre-modeling (data models and semantic models).

850. **[mcp-foundry](https://github.com/azure-ai-foundry/mcp-foundry)** - ⭐ 227
   A MCP Server for Azure AI Foundry: it's now moved to cloud, check the new Foundry MCP Server

851. **[foundry-mcp-server](https://github.com/PraneshASP/foundry-mcp-server)** - ⭐ 227
   An experimental MCP Server for foundry built for Solidity devs

852. **[cobolt](https://github.com/platinum-hill/cobolt)** - ⭐ 226
...
853. **[mcp_chatbot](https://github.com/keli-wen/mcp_chatbot)** - ⭐ 226
   A chatbot implementation compatible with MCP (terminal / streamlit supported)

854. **[xiyan_mcp_server](https://github.com/XGenerationLab/xiyan_mcp_server)** - ⭐ 226
   A Model Context Protocol (MCP) server that enables natural language queries to databases

855. **[browser-control-mcp](https://github.com/eyalzh/browser-control-mcp)** - ⭐ 226
   MCP server paired with a browser extension that enables AI agents to control the user's browser.

856. **[sample-serverless-mcp-servers](https://github.com/aws-samples/sample-serverless-mcp-servers)** - ⭐ 226
   Sample implementations of AI Agents and MCP Servers running on AWS Serverless compute

857. **[mcp-telegram](https://github.com/dryeab/mcp-telegram)** - ⭐ 225
   MCP Server for Telegram

858. **[spring-ai-summary](https://github.com/java-ai-tech/spring-ai-summary)** - ⭐ 225
   SpringAI，LLM，MCP，Embedding

859. **[awesome-mcp-servers](https://github.com/PipedreamHQ/awesome-mcp-servers)** - ⭐ 224
   A collection of MCP servers

860. **[ai-agent-team](https://github.com/peterfei/ai-agent-team)** - ⭐ 224
   AI Agent Team-拥有24/7专业AI开发团队：产品经理、前端开发、后端开发、测试工程师、DevOps工程师、技术负责人。一键安装，支持中英文命令，大幅提升开发效率！

861. **[AEnvironment](https://github.com/inclusionAI/AEnvironment)** - ⭐ 224
   Standardized environment infrastructure for Agentic AI development.

862. **[claude-skills-mcp](https://github.com/K-Dense-AI/claude-skills-mcp)** - ⭐ 224
...
864. **[langgraph-whatsapp-agent](https://github.com/lgesuellip/langgraph-whatsapp-agent)** - ⭐ 221
...
865. **[private-journal-mcp](https://github.com/obra/private-journal-mcp)** - ⭐ 221
   A lightweight MCP server that provides Claude with a private journaling capability to process feelings and thoughts

866. **[mcp-ical](https://github.com/Omar-V2/mcp-ical)** - ⭐ 221
   A Model Context Protocol Server that allows you to interact with your MacOS Calendar through natural language.

867. **[agent-mcp-lab](https://github.com/WaveSpeedAI/agent-mcp-lab)** - ⭐ 220

868. **[octocode](https://github.com/Muvon/octocode)** - ⭐ 220
   Semantic code searcher and codebase utility with AI memory onboard

869. **[studio-rust-mcp-server](https://github.com/Roblox/studio-rust-mcp-server)** - ⭐ 220
...
871. **[llamacloud-mcp](https://github.com/run-llama/llamacloud-mcp)** - ⭐ 219

872. **[home-assistant-cursor-agent](https://github.com/Coolver/home-assistant-cursor-agent)** - ⭐ 219
...
873. **[mcp-server-commands](https://github.com/g0t4/mcp-server-commands)** - ⭐ 219
   Model Context Protocol server to run commands

874. **[mcp-proxy-for-aws](https://github.com/aws/mcp-proxy-for-aws)** - ⭐ 219
   AWS MCP Proxy Server

875. **[mcp-proxy](https://github.com/punkpeye/mcp-proxy)** - ⭐ 218
...
882. **[mcp-server](https://github.com/volcengine/mcp-server)** - ⭐ 215
   Volcengine MCP Servers

883. **[Alice](https://github.com/pmbstyle/Alice)** - ⭐ 214
...
884. **[human-in-the-loop](https://github.com/KOBA789/human-in-the-loop)** - ⭐ 213
   An MCP (Model Context Protocol) server that allows AI assistants to ask questions to humans via Discord.

885. **[lihil](https://github.com/raceychan/lihil)** - ⭐ 213
   2X faster ASGI web framework for python, offering high-level development, low-level performance.

886. **[CAD-MCP](https://github.com/daobataotie/CAD-MCP)** - ⭐ 213
   CAD MCP Server

887. **[ha-mcp](https://github.com/homeassistant-ai/ha-mcp)** - ⭐ 213
   The Unofficial and Awesome Home Assistant MCP Server

888. **[mcp_code_executor](https://github.com/bazinga012/mcp_code_executor)** - ⭐ 212
   The MCP Code Executor is an MCP server that allows LLMs to execute Python code within a specified Conda environment.

889. **[tentix](https://github.com/labring/tentix)** - ⭐ 212
...
890. **[learn-agentic-ai-from-low-code-to-code](https://github.com/panaversity/learn-agentic-ai-from-low-code-to-code)** - ⭐ 212
   Build production-grade agents with OpenAI AgentKit, a no-code platfrom.

891. **[Mimir](https://github.com/orneryd/Mimir)** - ⭐ 212
...
892. **[Autono](https://github.com/vortezwohl/Autono)** - ⭐ 211
   A ReAct-Based Highly Robust Autonomous Agent Framework.

893. **[vibevideo-mcp](https://github.com/hyepartners-gmail/vibevideo-mcp)** - ⭐ 211
   Agent MCP for ffmpeg

894. **[razorpay-mcp-server](https://github.com/razorpay/razorpay-mcp-server)** - ⭐ 211
   Razorpay's Official MCP Server

895. **[uber-eats-mcp-server](https://github.com/ericzakariasson/uber-eats-mcp-server)** - ⭐ 211

896. **[effect-mcp](https://github.com/tim-smart/effect-mcp)** - ⭐ 211

897. **[mac_messages_mcp](https://github.com/carterlasalle/mac_messages_mcp)** - ⭐ 211
   An MCP server that securely interfaces with your iMessage database via the Model Context Protocol (MCP), allowing LLMs to query and analyze iMessage conversations. It includes robust phone number validation, attachment processing, contact management, group chat handling, and full support for sending and receiving messages.

898. **[lean-lsp-mcp](https://github.com/oOo0oOo/lean-lsp-mcp)** - ⭐ 211
   Lean Theorem Prover MCP

899. **[Context-Engine](https://github.com/m1rl0k/Context-Engine)** - ⭐ 211
...
900. **[mermaid-mcp-server](https://github.com/peng-shawn/mermaid-mcp-server)** - ⭐ 210
   A Model Context Protocol (MCP) server that converts Mermaid diagrams to PNG images

901. **[gibber-mcp](https://github.com/antonpk1/gibber-mcp)** - ⭐ 210
   Tiny MCP server with cryptography tools, sufficient to establish end-to-end encryption between LLM agents

902. **[figma-mcp](https://github.com/MatthewDailey/figma-mcp)** - ⭐ 210
   ModelContextProtocol for Figma's REST API

903. **[mcp-openapi-server](https://github.com/ivo-toby/mcp-openapi-server)** - ⭐ 210
   MCP Server (Model Context Protocol) for turning OpenAPI specifications into a MCP Resource

904. **[playwright-mcp](https://github.com/cloudflare/playwright-mcp)** - ⭐ 210
   Playwright MCP fork that works with Cloudflare Browser Rendering

905. **[lokka](https://github.com/merill/lokka)** - ⭐ 210
   MCP (Model Context Protocol) for Microsoft 365. Includes support for Microsoft Graph and other services

906. **[omnicoreagent](https://github.com/omnirexflora-labs/omnicoreagent)** - ⭐ 210
...
907. **[KiCAD-MCP-Server](https://github.com/mixelpixx/KiCAD-MCP-Server)** - ⭐ 210
   KiCAD MCP is a Model Context Protocol (MCP) implementation that enables Large Language Models (LLMs) like Claude to directly interact with KiCAD for printed circuit board design.

908. **[mindmap-mcp-server](https://github.com/YuChenSSR/mindmap-mcp-server)** - ⭐ 209
   mindmap, mcp server, artifact

909. **[plate-playground-template](https://github.com/udecode/plate-playground-template)** - ⭐ 209
   Plate AI template with React 19, Next 16, Tailwind 4, MCP.

910. **[mcp-taskmanager](https://github.com/kazuph/mcp-taskmanager)** - ⭐ 209

911. **[strava-mcp](https://github.com/r-huijts/strava-mcp)** - ⭐ 209
   A Model Context Protocol (MCP) server that connects to Strava API, providing tools to access Strava data through LLMs

912. **[multimodal-mcp-client](https://github.com/Ejb503/multimodal-mcp-client)** - ⭐ 208
   A Multi-modal MCP client for voice powered agentic workflows

913. **[cpp-mcp](https://github.com/hkr04/cpp-mcp)** - ⭐ 208
   Lightweight C++ MCP (Model Context Protocol) SDK

914. **[mcp-server-milvus](https://github.com/zilliztech/mcp-server-milvus)** - ⭐ 207
   Model Context Protocol Servers for Milvus

915. **[ruby_llm-mcp](https://github.com/patvice/ruby_llm-mcp)** - ⭐ 207
   Full-featured MCP support for Ruby and RubyLLM—making it easy to build structured, composable LLM workflows in pure Ruby.

916. **[composer-trade-mcp](https://github.com/invest-composer/composer-trade-mcp)** - ⭐ 207
   Composer's MCP server lets MCP-enabled LLMs like Claude backtest trading ideas and automatically invest in them for you

917. **[outlook-mcp](https://github.com/ryaker/outlook-mcp)** - ⭐ 206
   MCP server for Claude to access Outlook data via Microsoft Graph API

918. **[penpot-mcp](https://github.com/montevive/penpot-mcp)** - ⭐ 206
   Penpot MCP server
...
922. **[notion_mcp](https://github.com/danhilse/notion_mcp)** - ⭐ 205
   A simple MCP integration that allows Claude to read and manage a personal Notion todo list

923. **[mcp-context-protector](https://github.com/trailofbits/mcp-context-protector)** - ⭐ 204
...
928. **[kite-mcp-server](https://github.com/zerodha/kite-mcp-server)** - ⭐ 204
   Zerodha Kite MCP server

929. **[spotify-mcp-server](https://github.com/marcelmarais/spotify-mcp-server)** - ⭐ 204
   Lightweight MCP server for Spotify

930. **[langchain-mcp](https://github.com/rectalogic/langchain-mcp)** - ⭐ 203
   Model Context Protocol tool support for LangChain

931. **[Remote-MCP](https://github.com/ssut/Remote-MCP)** - ⭐ 203
...
933. **[automagik-genie](https://github.com/namastexlabs/automagik-genie)** - ⭐ 202
   🧞 Automagik Genie – bootstrap, update, and roll back AI agent workspaces with a single CLI + MCP toolkit.

934. **[solon-ai](https://github.com/opensolon/solon-ai)** - ⭐ 201
...
935. **[mcp](https://github.com/hopx-ai/mcp)** - ⭐ 200

936. **[c2sagent](https://github.com/C2SAgent/c2sagent)** - ⭐ 200
...
937. **[mathom](https://github.com/stephenlacy/mathom)** - ⭐ 199
   Run and monitor MCP servers locally

938. **[y-cli](https://github.com/luohy15/y-cli)** - ⭐ 199
   A Tiny Terminal Chat App for AI Models with MCP Client Support

939. **[anki-mcp-server](https://github.com/nailuoGG/anki-mcp-server)** - ⭐ 199
   MCP server for Anki via AnkiConnect

940. **[mcp](https://github.com/Snowflake-Labs/mcp)** - ⭐ 198
   MCP Server for Snowflake including Cortex AI, object management, SQL orchestration, semantic view consumption, and more

941. **[jebmcp](https://github.com/dawnslab/jebmcp)** - ⭐ 198

942. **[mcp-server-deep-research](https://github.com/reading-plus-ai/mcp-server-deep-research)** - ⭐ 198

943. **[one-mcp](https://github.com/burugo/one-mcp)** - ⭐ 197
...
944. **[smart-tree](https://github.com/8b-is/smart-tree)** - ⭐ 197
...
945. **[ticktick-mcp](https://github.com/jacepark12/ticktick-mcp)** - ⭐ 197
   MCP server that interacts with TickTick (Dida 365) via the TickTick Open API

946. **[mcp-server-rag-web-browser](https://github.com/apify/mcp-server-rag-web-browser)** - ⭐ 197
   A MCP Server for the RAG Web Browser Actor

947. **[unsplash-mcp-server](https://github.com/hellokaton/unsplash-mcp-server)** - ⭐ 197
   🔎 A MCP server for Unsplash image search.

948. **[things-mcp](https://github.com/hald/things-mcp)** - ⭐ 197
   Things.app MCP Server

949. **[mastergo-magic-mcp](https://github.com/mastergo-design/mastergo-magic-mcp)** - ⭐ 196
...
950. **[ProxmoxMCP](https://github.com/canvrno/ProxmoxMCP)** - ⭐ 196
   MCP for Proxmox integration in Cline

951. **[TradingAgents-MCPmode](https://github.com/guangxiangdebizi/TradingAgents-MCPmode)** - ⭐ 196
   TradingAgents-MCPmode 是一个创新的多智能体交易分析系统，集成了 Model Context Protocol (MCP) 工具，实现了智能化的股票分析和交易决策流程。系统通过多个专业化智能体的协作，提供全面的市场分析、投资建议和风险管理。

952. **[mcp-portal-transparencia](https://github.com/dutradotdev/mcp-portal-transparencia)** - ⭐ 195
   MCP para orquestração automatizada de chamadas à API do Portal da Transparência do Governo Federal brasileiro

953. **[cognition-wheel](https://github.com/Hormold/cognition-wheel)** - ⭐ 195
   A Model Context Protocol (MCP) server that implements a "wisdom of crowds" approach to AI reasoning by consulting multiple state-of-the-art language models in parallel and synthesizing their responses.

954. **[ht-mcp](https://github.com/memextech/ht-mcp)** - ⭐ 195
   Pure Rust implementation of MCP server for headless terminal 

955. **[mongodb-lens](https://github.com/furey/mongodb-lens)** - ⭐ 195
   🍃🔎 MongoDB Lens: Full Featured MCP Server for MongoDB Databases

956. **[BifrostMCP](https://github.com/biegehydra/BifrostMCP)** - ⭐ 195
   VSCode Extension with an MCP server that exposes semantic tools like Find Usages and Rename to LLMs

957. **[Google-Search-MCP-Server](https://github.com/mixelpixx/Google-Search-MCP-Server)** - ⭐ 195
...
958. **[opik-mcp](https://github.com/comet-ml/opik-mcp)** - ⭐ 194
   Model Context Protocol (MCP) implementation for Opik enabling seamless IDE integration and unified access to prompts, projects, traces, and metrics. 

959. **[jetski](https://github.com/hyprmcp/jetski)** - ⭐ 194
...
960. **[rmcp](https://github.com/finite-sample/rmcp)** - ⭐ 194
   R MCP Server

961. **[mcp-trends-hub](https://github.com/baranwang/mcp-trends-hub)** - ⭐ 194
   基于 Model Context Protocol (MCP) 协议的全网热点趋势一站式聚合服务

962. **[phone-mcp](https://github.com/hao-cyber/phone-mcp)** - ⭐ 193
   A phone control plugin for MCP that allows you to control your Android phone through ADB commands to connect any human

963. **[mcp-proxy-server](https://github.com/adamwattis/mcp-proxy-server)** - ⭐ 193
   An MCP proxy server that aggregates and serves multiple MCP resource servers through a single interface

964. **[zotero-mcp](https://github.com/cookjohn/zotero-mcp)** - ⭐ 193
...
965. **[metorial-platform](https://github.com/metorial/metorial-platform)** - ⭐ 192
   The engine powering hundreds of thousands of MCP connections 🤖 🔥

966. **[ssh-mcp](https://github.com/tufantunc/ssh-mcp)** - ⭐ 192
   MCP server exposing SSH control for Linux servers via Model Context Protocol.

967. **[google-docs-mcp](https://github.com/a-bonus/google-docs-mcp)** - ⭐ 192
...
968. **[easy-mcp](https://github.com/zcaceres/easy-mcp)** - ⭐ 191
   Absurdly easy Model Context Protocol Servers in Typescript

969. **[nano-agent](https://github.com/disler/nano-agent)** - ⭐ 191
   A MCP Server for a small scale engineering agents with multi-provider LLM support.

970. **[mcp-server-trello](https://github.com/delorenj/mcp-server-trello)** - ⭐ 191
   A Model Context Protocol (MCP) server that provides tools for interacting with Trello boards.

971. **[ha-mcp-for-xiaozhi](https://github.com/c1pher-cn/ha-mcp-for-xiaozhi)** - ⭐ 191
   Homeassistant MCP server for 小智AI

972. **[waldzell-mcp](https://github.com/waldzellai/waldzell-mcp)** - ⭐ 191
   Waldzell AI's monorepo of MCP servers. Use in Claude Desktop, Cline, Roo Code, and more!

973. **[mcp-n8n-workflow-builder](https://github.com/salacoste/mcp-n8n-workflow-builder)** - ⭐ 191
   AI-powered n8n workflow automation through natural language. MCP server enabling Claude AI & Cursor IDE to create, manage, and monitor workflows via Model Context Protocol. Multi-instance support, 17 tools, comprehensive docs. Build workflows conversationally without manual JSON editing.

974. **[seo-mcp](https://github.com/cnych/seo-mcp)** - ⭐ 190
...
975. **[mcp-guardian](https://github.com/eqtylab/mcp-guardian)** - ⭐ 190
   Manage / Proxy / Secure your MCP Servers

976. **[sec-edgar-mcp](https://github.com/stefanoamorelli/sec-edgar-mcp)** - ⭐ 190
   A SEC EDGAR MCP (Model Context Protocol) Server

977. **[Google-Scholar-MCP-Server](https://github.com/JackKuo666/Google-Scholar-MCP-Server)** - ⭐ 190
...
978. **[MCP-server-client-computer-use-ai-sdk](https://github.com/mediar-ai/MCP-server-client-computer-use-ai-sdk)** - ⭐ 189
...
990. **[yahoo-finance-mcp](https://github.com/Alex2Yang97/yahoo-finance-mcp)** - ⭐ 185
   This is a Model Context Protocol (MCP) server that provides comprehensive financial data from Yahoo Finance. It allows you to retrieve detailed information about stocks, including historical prices, company information, financial statements, options data, and market news.

991. **[obsidian-mcp-plugin](https://github.com/aaronsb/obsidian-mcp-plugin)** - ⭐ 185
   High-performance Model Context Protocol (MCP) server for Obsidian that provides AI tools with direct vault access through semantic operations and HTTP transport.

992. **[a2a_mcp-example](https://github.com/ishanExtreme/a2a_mcp-example)** - ⭐ 184
   An example showing how A2A and MCP can be used together

993. **[ai-infrastructure-agent](https://github.com/VersusControl/ai-infrastructure-agent)** - ⭐ 184
...
994. **[supabase-mcp](https://github.com/coleam00/supabase-mcp)** - ⭐ 184
   Supabase MCP server created in Python.

995. **[mcp-linkedin](https://github.com/adhikasp/mcp-linkedin)** - ⭐ 184
...
998. **[gram](https://github.com/speakeasy-api/gram)** - ⭐ 183
   Platform to create, curate and host MCP servers ⚒️ Build production quality tools for your agents.

999. **[yt-dlp-mcp](https://github.com/kevinwatt/yt-dlp-mcp)** - ⭐ 183
   A Model Context Protocol (MCP) server that bridges Video & Audio content with Large Language Models using yt-dlp.

1000. **[thinkchain](https://github.com/martinbowling/thinkchain)** - ⭐ 182
...
1001. **[mcp-openai-gemini-llama-example](https://github.com/philschmid/mcp-openai-gemini-llama-example)** - ⭐ 182

1002. **[MiroRL](https://github.com/MiroMindAI/MiroRL)** - ⭐ 182
   MiroRL is  an MCP-first reinforcement learning framework for deep research agent.

1003. **[litemcp](https://github.com/wong2/litemcp)** - ⭐ 182
   A TypeScript framework for building MCP servers elegantly

1004. **[tmux-mcp](https://github.com/nickgnd/tmux-mcp)** - ⭐ 182
   A MCP server for our beloved terminal multiplexer tmux.

1005. **[AgentChat](https://github.com/Shy2593666979/AgentChat)** - ⭐ 182
...
1006. **[figma-flutter-mcp](https://github.com/mhmzdev/figma-flutter-mcp)** - ⭐ 181
   An MCP server that provides the coding agents Figma's design token to write Flutter code.

1007. **[mcp-echarts](https://github.com/hustcc/mcp-echarts)** - ⭐ 181
...
1011. **[dify-plugin-tools-mcp_sse](https://github.com/junjiem/dify-plugin-tools-mcp_sse)** - ⭐ 179
...
1019. **[anki-mcp-server](https://github.com/scorzeth/anki-mcp-server)** - ⭐ 177
   An MCP server for Anki

1020. **[tripo-mcp](https://github.com/VAST-AI-Research/tripo-mcp)** - ⭐ 177
   Official MCP server for Tripo

1021. **[servicenow-mcp](https://github.com/echelon-ai-labs/servicenow-mcp)** - ⭐ 177
   MCP Server for ServiceNow

1022. **[hf-mcp-server](https://github.com/huggingface/hf-mcp-server)** - ⭐ 176
   Hugging Face MCP Server

1023. **[mcp-servers-nix](https://github.com/natsukium/mcp-servers-nix)** - ⭐ 175
   A Nix-based configuration framework for Model Control Protocol (MCP) servers with ready-to-use packages.

1024. **[mongo-mcp](https://github.com/QuantGeekDev/mongo-mcp)** - ⭐ 174
...
1026. **[mcp-gsc](https://github.com/AminForou/mcp-gsc)** - ⭐ 174
...
1046. **[mcp-use-ts](https://github.com/mcp-use/mcp-use-ts)** - ⭐ 165
   mcp-use is the framework for MCP with the best DX - Build AI agents, create MCP   servers with UI widgets, and debug with built-in inspector. Includes client SDK, server SDK, React hooks, and powerful dev tools.

1047. **[openapi-mcp](https://github.com/ckanthony/openapi-mcp)** - ⭐ 165
...
1053. **[MakeMoneyWithAI](https://github.com/garylab/MakeMoneyWithAI)** - ⭐ 164
   A list of open-source AI projects you can use to generate income easily.

1054. **[mcp-logseq](https://github.com/ergut/mcp-logseq)** - ⭐ 163
   MCP server to interact with LogSeq via its Local HTTP API - enabling AI assistants like Claude to seamlessly read, write, and manage your LogSeq graph.

1055. **[touchdesigner-mcp](https://github.com/8beeeaaat/touchdesigner-mcp)** - ⭐ 163
   MCP server for TouchDesigner

1056. **[keyboard-local](https://github.com/keyboard-dev/keyboard-local)** - ⭐ 162
   One MCP Server, All Your Apps, Privacy First

1057. **[wikipedia-mcp](https://github.com/Rudra-ravi/wikipedia-mcp)** - ⭐ 162
...
1068. **[tableau-mcp](https://github.com/tableau/tableau-mcp)** - ⭐ 159
...
1069. **[cli-mcp-server](https://github.com/MladenSU/cli-mcp-server)** - ⭐ 158
   Command line interface for MCP clients with secure execution and customizable security policies

1070. **[mcp-agent-langchainjs](https://github.com/Azure-Samples/mcp-agent-langchainjs)** - ⭐ 158
...
1071. **[remote-mcp-server](https://github.com/gleanwork/remote-mcp-server)** - ⭐ 158
   Remote MCP Server that securely connects Enterprise context with your LLM, IDE, or agent platform of choice.

1072. **[comfyui-mcp-server](https://github.com/joenorton/comfyui-mcp-server)** - ⭐ 158
   lightweight Python-based MCP (Model Context Protocol) server for local ComfyUI

1073. **[gemini-cli-desktop](https://github.com/Piebald-AI/gemini-cli-desktop)** - ⭐ 158
   Web/desktop UI for Gemini CLI/Qwen Code.  Manage projects, switch between tools, search across past conversations, and manage MCP servers, all from one multilingual interface, locally or remotely.

1074. **[spotinfo](https://github.com/alexei-led/spotinfo)** - ⭐ 157
   CLI for exploring AWS EC2 Spot inventory. Inspect AWS Spot instance types, saving, price, and interruption frequency.

1075. **[jmap-mcp](https://github.com/wyattjoh/jmap-mcp)** - ⭐ 157
   A Model Context Protocol (MCP) server that provides tools for interacting with JMAP (JSON Meta Application Protocol) email servers. Built with Deno and using the jmap-jam client library.

1076. **[Quickchart-MCP-Server](https://github.com/GongRzhe/Quickchart-MCP-Server)** - ⭐ 157
...
1077. **[dbt-llm-agent](https://github.com/pragunbhutani/dbt-llm-agent)** - ⭐ 157
   LLM based AI Agent to automate Data Analysis for dbt projects with remote MCP server

1078. **[UnityNaturalMCP](https://github.com/notargs/UnityNaturalMCP)** - ⭐ 157
   UnityNaturalMCP is an MCP server implementation for Unity that aims for a "natural" user experience.

1079. **[after-effects-mcp](https://github.com/Dakkshin/after-effects-mcp)** - ⭐ 157
   MCP Server for Adobe After Effects. Enables remote control (compositions, text, shapes, solids, properties) via the Model Context Protocol using ExtendScript.

1080. **[binary_ninja_mcp](https://github.com/fosdickio/binary_ninja_mcp)** - ⭐ 157
   A Binary Ninja plugin containing an MCP server that enables seamless integration with your favorite LLM/MCP client.

1081. **[claudepro-directory](https://github.com/JSONbored/claudepro-directory)** - ⭐ 157
...
1082. **[mcp-shell-server](https://github.com/tumf/mcp-shell-server)** - ⭐ 156

1083. **[mcp-server-wazuh](https://github.com/gbrigandi/mcp-server-wazuh)** - ⭐ 156
   MCP Server for Wazuh SIEM

1084. **[toolsdk-mcp-registry](https://github.com/toolsdk-ai/toolsdk-mcp-registry)** - ⭐ 156
...
1085. **[sketchup-mcp](https://github.com/mhyrr/sketchup-mcp)** - ⭐ 155
...
1092. **[install-mcp](https://github.com/supermemoryai/install-mcp)** - ⭐ 154
   A simple CLI to install MCP servers into any client - auth included!

1093. **[photoshop-python-api-mcp-server](https://github.com/loonghao/photoshop-python-api-mcp-server)** - ⭐ 152
   A Model Context Protocol (MCP) server that interfaces with Adobe Photoshop's Python API. Enables LLMs to execute image editing operations, automate workflows, and manage Photoshop tasks through structured commands and context-aware interactions.

1094. **[flights-mcp](https://github.com/ravinahp/flights-mcp)** - ⭐ 152
   An MCP server to search for flights.

1095. **[smart-coding-mcp](https://github.com/omar-haris/smart-coding-mcp)** - ⭐ 152
...
1096. **[python-mcp-server-client](https://github.com/GobinFan/python-mcp-server-client)** - ⭐ 151
   支持查询主流agent框架技术文档的MCP server（支持stdio和sse两种传输协议）, 支持 langchain、llama-index、autogen、agno、openai-agents-sdk、mcp-doc、camel-ai 和 crew-ai

1097. **[XPack-MCP-Marketplace](https://github.com/xpack-ai/XPack-MCP-Marketplace)** - ⭐ 151
...
1109. **[pg-mcp-server](https://github.com/ericzakariasson/pg-mcp-server)** - ⭐ 148
   MCP Server for Postgres

1110. **[opentelemetry-mcp-server](https://github.com/traceloop/opentelemetry-mcp-server)** - ⭐ 148
   Unified MCP server for querying OpenTelemetry traces across multiple backends (Jaeger, Tempo, Traceloop, etc.), enabling AI agents to analyze distributed traces for automated debugging and observability.

1111. **[awesome-claude-dxt](https://github.com/milisp/awesome-claude-dxt)** - ⭐ 148
   Awesome Claude Desktop Extensions (dxt) (not only Claude) mcpb

1112. **[make-mcp-server](https://github.com/integromat/make-mcp-server)** - ⭐ 147
   Make MCP Server

1113. **[mcp-simple-pubmed](https://github.com/andybrandt/mcp-simple-pubmed)** - ⭐ 147
...
1116. **[any-chat-completions-mcp](https://github.com/pyroprompts/any-chat-completions-mcp)** - ⭐ 146
   MCP Server for using any LLM as a Tool

1117. **[mcp-server-example](https://github.com/alejandro-ao/mcp-server-example)** - ⭐ 146
   A simple MCP server to search for documentation (tutorial)

1118. **[instagram_dm_mcp](https://github.com/trypeggy/instagram_dm_mcp)** - ⭐ 146
   Instagram Direct messages MCP

1119. **[tmcp](https://github.com/paoloricciuti/tmcp)** - ⭐ 146
...
1121. **[mcp-solver](https://github.com/szeider/mcp-solver)** - ⭐ 145
   Model Context Protocol (MCP) server for constraint optimization and solving"

1122. **[relay](https://github.com/prism-php/relay)** - ⭐ 145
   An MCP client tool for Prism

1123. **[discord-mcp](https://github.com/SaseQ/discord-mcp)** - ⭐ 145
   A MCP server for the Discord integration. Enable your AI assistants to seamlessly interact with Discord. Enhance your Discord experience with powerful automation capabilities.

1124. **[website-downloader](https://github.com/pskill9/website-downloader)** - ⭐ 144
   MCP server to download entire websites

1125. **[OpenDataMCP](https://github.com/OpenDataMCP/OpenDataMCP)** - ⭐ 144
   Connect any Open Data to any LLM with Model Context Protocol.

1126. **[figma-mcp-server](https://github.com/TimHolden/figma-mcp-server)** - ⭐ 144
   Model Context Protocol server implementation for Figma API

1127. **[goku](https://github.com/jcaromiq/goku)** - ⭐ 144
   Goku is an HTTP load testing application written in Rust 

1128. **[postman-mcp-server](https://github.com/delano/postman-mcp-server)** - ⭐ 144
   An MCP server that provides access to Postman.

1129. **[mcp-server-weread](https://github.com/ChenyqThu/mcp-server-weread)** - ⭐ 144

1130. **[mcp-1panel](https://github.com/1Panel-dev/mcp-1panel)** - ⭐ 143
   mcp-1panel is an implementation of the Model Context Protocol (MCP) server for 1Panel.

1131. **[Log-Analyzer-with-MCP](https://github.com/awslabs/Log-Analyzer-with-MCP)** - ⭐ 143
   A Model Context Protocol (MCP) server that provides AI assistants access to AWS CloudWatch Logs for analysis, searching, and correlation

1132. **[cursor-notebook-mcp](https://github.com/jbeno/cursor-notebook-mcp)** - ⭐ 143
   Model Context Protocol (MCP) server designed to allow AI agents within Cursor to interact with Jupyter Notebook (.ipynb) files

1133. **[superset-mcp](https://github.com/aptro/superset-mcp)** - ⭐ 143
   connect to 50+ data stores via superset mcp server. Can use with open ai agent sdk, Claude app, cursor, windsurf

1134. **[DrissionPageMCP](https://github.com/wxhzhwxhzh/DrissionPageMCP)** - ⭐ 143
   基于DrissionPage和FastMCP的浏览器自动化MCP服务器，提供丰富的浏览器操作API供AI调用

1135. **[pubmearch](https://github.com/Darkroaster/pubmearch)** - ⭐ 142
   A PubMed MCP server.

1136. **[ReActMCP](https://github.com/mshojaei77/ReActMCP)** - ⭐ 142
   ReActMCP is a reactive MCP client that empowers AI assistants to instantly respond with real-time, Markdown-formatted web search insights powered by the Exa API.

1137. **[aitour26-WRK540-unlock-your-agents-potential-with-model-context-protocol](https://github.com/microsoft/aitour26-WRK540-unlock-your-agents-potential-with-model-context-protocol)** - ⭐ 142

1138. **[mcp-servers](https://github.com/cursor/mcp-servers)** - ⭐ 142
   A list of MCP (Model Context Protocol) servers for developer tools and services

1139. **[mcp-shark](https://github.com/mcp-shark/mcp-shark)** - ⭐ 142
...
1147. **[mcp](https://github.com/neo4j/mcp)** - ⭐ 140
   Neo4j official MCP Server

1148. **[mcp-montano-server](https://github.com/lucasmontano/mcp-montano-server)** - ⭐ 139
   Simple MCP Server Implementation

1149. **[mcp-dotnet-samples](https://github.com/microsoft/mcp-dotnet-samples)** - ⭐ 139
   A comprehensive set of samples of creating and using MCP servers and clients with .NET

1150. **[mcp-mysql-server](https://github.com/f4ww4z/mcp-mysql-server)** - ⭐ 139
   A Model Context Protocol server for MySQL database operations

1151. **[datagov-mcp](https://github.com/aviveldan/datagov-mcp)** - ⭐ 138
   MCP server for Israel Government Data

1152. **[mcp-server-calculator](https://github.com/githejie/mcp-server-calculator)** - ⭐ 138
   A Model Context Protocol server for calculating.

1153. **[powerpoint](https://github.com/supercurses/powerpoint)** - ⭐ 138
   A MCP Server for creating Powerpoint Presentations

1154. **[mcp-interviewer](https://github.com/microsoft/mcp-interviewer)** - ⭐ 138
   Catch MCP server issues before your agents do.

1155. **[agentql-mcp](https://github.com/tinyfish-io/agentql-mcp)** - ⭐ 138
...
1158. **[agentor](https://github.com/CelestoAI/agentor)** - ⭐ 138
...
1160. **[eion](https://github.com/eiondb/eion)** - ⭐ 137
   Shared Memory Storage for Multi-Agent Systems

1161. **[postman-mcp-server](https://github.com/postmanlabs/postman-mcp-server)** - ⭐ 137
   Connect your AI to your APIs on Postman

1162. **[cheatengine-mcp-bridge](https://github.com/miscusi-peek/cheatengine-mcp-bridge)** - ⭐ 137
...
1163. **[mcp-discord](https://github.com/hanweg/mcp-discord)** - ⭐ 136
   MCP server for discord bot

1164. **[mcp-server-starrocks](https://github.com/StarRocks/mcp-server-starrocks)** - ⭐ 136
   StarRocks MCP (Model Context Protocol) Server

1165. **[google-slides-mcp](https://github.com/matteoantoci/google-slides-mcp)** - ⭐ 136
   MCP Server for Google Slides

1166. **[In-Memoria](https://github.com/pi22by7/In-Memoria)** - ⭐ 136
   Persistent Intelligence Infrastructure for AI Agents

1167. **[doc-ops-mcp](https://github.com/Tele-AI/doc-ops-mcp)** - ⭐ 135
   MCP server for seamless document format conversion and processing

1168. **[guidance-for-deploying-model-context-protocol-servers-on-aws](https://github.com/aws-solutions-library-samples/guidance-for-deploying-model-context-protocol-servers-on-aws)** - ⭐ 135
...
1169. **[mcp-3D-printer-server](https://github.com/DMontgomery40/mcp-3D-printer-server)** - ⭐ 135
   Connects MCP to major 3D printer APIs (Orca, Bambu, OctoPrint, Klipper, Duet, Repetier, Prusa, Creality). Control prints, monitor status, and perform advanced STL operations like scaling, rotation, sectional editing, and base extension. Includes slicing and visualization.

1170. **[systemprompt-code-orchestrator](https://github.com/systempromptio/systemprompt-code-orchestrator)** - ⭐ 135
     MCP server for orchestrating AI coding agents (Claude Code CLI & Gemini CLI). Features task management, process execution, Git integration, and dynamic resource discovery. Full TypeScript implementation with Docker support and Cloudflare Tunnel integration. 

1171. **[task-orchestrator](https://github.com/jpicklyk/task-orchestrator)** - ⭐ 135
...
1172. **[hypertool-mcp](https://github.com/toolprint/hypertool-mcp)** - ⭐ 135
   Dynamically expose tools from proxied servers based on an Agent Persona

1173. **[mkinf](https://github.com/mkinf-io/mkinf)** - ⭐ 134
   mkinf SDK to interact with mkinf hub MCP servers

1174. **[mcp-think-tool](https://github.com/DannyMac180/mcp-think-tool)** - ⭐ 134
   An MCP server implementing the think tool for Claude

1175. **[mssql-mcp](https://github.com/Aaronontheweb/mssql-mcp)** - ⭐ 133
   MSSQL Server MCP implementation written in C#

1176. **[Multi-Source-Media-MCP-Server](https://github.com/Decade-qiu/Multi-Source-Media-MCP-Server)** - ⭐ 133
   An MCP Tool Implementation for Multi-Source Image Access & Generation

1177. **[bilibili-mcp-js](https://github.com/34892002/bilibili-mcp-js)** - ⭐ 133
   Bilibili video search MCP (Model Context Protocol) service - 哔哩哔哩视频搜索MCP服务

1178. **[mcp-server-serper](https://github.com/marcopesani/mcp-server-serper)** - ⭐ 133
   Serper MCP Server supporting search and webpage scraping

1179. **[agent-toolkit](https://github.com/datacommonsorg/agent-toolkit)** - ⭐ 133
   Tools and agents for interacting with the Data Commons Knowledge Graph using the Model Context Protocol (MCP).

1180. **[SecureMCP](https://github.com/makalin/SecureMCP)** - ⭐ 133
...
1181. **[scrapeless-mcp-server](https://github.com/scrapeless-ai/scrapeless-mcp-server)** - ⭐ 133
   Scrapeless Mcp Server

1182. **[autocad-mcp](https://github.com/puran-water/autocad-mcp)** - ⭐ 132
...
1183. **[hayhooks](https://github.com/deepset-ai/hayhooks)** - ⭐ 132
   Easily deploy Haystack pipelines as REST APIs and MCP Tools.

1184. **[zettelkasten-mcp](https://github.com/entanglr/zettelkasten-mcp)** - ⭐ 132
   A Model Context Protocol (MCP) server that implements the Zettelkasten knowledge management methodology, allowing you to create, link, explore and synthesize atomic notes through Claude and other MCP-compatible clients.

1185. **[wa_llm](https://github.com/ilanbenb/wa_llm)** - ⭐ 132
...
1195. **[k8s-mcp-server](https://github.com/reza-gholizade/k8s-mcp-server)** - ⭐ 130
   Manage Your Kubernetes Cluster with k8s mcp-server

1196. **[MCP-PostgreSQL-Ops](https://github.com/call518/MCP-PostgreSQL-Ops)** - ⭐ 130
...
1197. **[frontmcp](https://github.com/agentfront/frontmcp)** - ⭐ 130
   FrontMCP Framework

1198. **[mcp-server-typescript](https://github.com/dataforseo/mcp-server-typescript)** - ⭐ 130
   DataForSEO API modelcontextprotocol server 

1199. **[mcp-server-reddit](https://github.com/Hawstein/mcp-server-reddit)** - ⭐ 130
   A Model Context Protocol (MCP) server that provides tools for fetching Reddit content, including frontpage posts, subreddit information and hot posts, post details, and comments.

1200. **[plane-mcp-server](https://github.com/makeplane/plane-mcp-server)** - ⭐ 130
   Plane's Official Model Context Protocol Server 🔌 ⌨️ 🔥

1201. **[logfire-mcp](https://github.com/pydantic/logfire-mcp)** - ⭐ 130
   The Logfire MCP Server is here! :tada:

1202. **[rust-mcp-sdk](https://github.com/rust-mcp-stack/rust-mcp-sdk)** - ⭐ 130
   A high-performance, asynchronous toolkit for building MCP servers and clients in Rust.

1203. **[ultimate_mcp_server](https://github.com/Dicklesworthstone/ultimate_mcp_server)** - ⭐ 129
   The Ultimate Model Context Protocol (MCP) Server, providing unified access to a wide variety of useful and powerful tools.

1204. **[mcp-gateway](https://github.com/acehoss/mcp-gateway)** - ⭐ 129
...
1205. **[backlog-mcp-server](https://github.com/nulab/backlog-mcp-server)** - ⭐ 129

1206. **[mcp-chat](https://github.com/Flux159/mcp-chat)** - ⭐ 129
   Open Source Generic MCP Client for testing & evaluating mcp servers and agents

1207. **[N8N2MCP](https://github.com/Super-Chain/N8N2MCP)** - ⭐ 128
   Convert N8N agent / workflow into MCP servers, you can use it in Claude / Cursor / Super Chain 

1208. **[xhs-mcp-server](https://github.com/aicu-icu/xhs-mcp-server)** - ⭐ 128
   小红书MCP服务器 | 基于Electron+小红书Web API。一键安装运行、极速抓取笔记、评论、用户等数据并让AI智能分析、整理与导出

1209. **[aws-cost-explorer-mcp-server](https://github.com/aarora79/aws-cost-explorer-mcp-server)** - ⭐ 128
   MCP server for understanding AWS spend

1210. **[awesome-crypto-mcp-servers](https://github.com/badkk/awesome-crypto-mcp-servers)** - ⭐ 128
   A collection of crypto MCP servers.

1211. **[obsidian-claude-code-mcp](https://github.com/iansinnott/obsidian-claude-code-mcp)** - ⭐ 128
   Connect Claude Code and other AI tools to your Obsidian notes using Model Context Protocol (MCP)

1212. **[mcp-server-aws](https://github.com/rishikavikondala/mcp-server-aws)** - ⭐ 127
   A Model Context Protocol server implementation for operations on AWS resources

1213. **[freecad_mcp](https://github.com/bonninr/freecad_mcp)** - ⭐ 127
...
1214. **[AgentCrew](https://github.com/saigontechnology/AgentCrew)** - ⭐ 127
   Chat application with multi-agents system supports multi-models and MCP

1215. **[think-mcp-server](https://github.com/PhillipRt/think-mcp-server)** - ⭐ 127

1216. **[Frappe_Assistant_Core](https://github.com/buildswithpaul/Frappe_Assistant_Core)** - ⭐ 126
   Infrastructure that connects LLMs to ERPNext. Frappe Assistant Core works with the Model Context Protocol (MCP) to expose ERPNext functionality to any compatible Language Model

1217. **[mcp-server-plugin](https://github.com/JetBrains/mcp-server-plugin)** - ⭐ 126
   JetBrains MCP Server Plugin

1218. **[A2A-MCP-Server](https://github.com/GongRzhe/A2A-MCP-Server)** - ⭐ 126
...
1219. **[mcp-email-server](https://github.com/ai-zerolab/mcp-email-server)** - ⭐ 126
   IMAP and SMTP via MCP Server

1220. **[crawl4ai-mcp-server](https://github.com/weidwonder/crawl4ai-mcp-server)** - ⭐ 126
   用于提供给本地开发者的 LLM的高效互联网搜索&内容获取的MCP Server， 节省你的token

1221. **[ghost-mcp](https://github.com/MFYDev/ghost-mcp)** - ⭐ 126
   A Model Context Protocol (MCP) server for interacting with Ghost CMS through LLM interfaces like Claude. Allow you to control your Ghost blog by simply asking Claude etc.

1222. **[CreatorBox](https://github.com/xiesx123/CreatorBox)** - ⭐ 126
   🚀🎬 Flexible, efficient, and scalable toolbox for editing and dubbing, unleashing creative potential

1223. **[play-store-mcp](https://github.com/antoniolg/play-store-mcp)** - ⭐ 126
   An MCP server that connects to Play Store Console and release new App versions from an MCP Client

1224. **[code-assistant](https://github.com/stippi/code-assistant)** - ⭐ 126
   An LLM-powered, autonomous coding assistant. Also offers an MCP and ACP mode.

1225. **[play-store-mcp](https://github.com/devexpert-io/play-store-mcp)** - ⭐ 125
   An MCP server that connects to Play Store Console and release new App versions from an MCP Client

1226. **[zotero-mcp](https://github.com/kujenga/zotero-mcp)** - ⭐ 125
   Model Context Protocol (MCP) server for the Zotero API, in Python

1227. **[mcp-server-odoo](https://github.com/ivnvxd/mcp-server-odoo)** - ⭐ 125
   A Model Context Protocol (MCP) server that enables AI assistants to securely interact with Odoo ERP systems through standardized resources and tools for data retrieval and manipulation.

1228. **[dart-mcp-server](https://github.com/its-dart/dart-mcp-server)** - ⭐ 125
   Dart AI Model Context Protocol (MCP) server

1229. **[mcp-server-manifest](https://github.com/Zomato/mcp-server-manifest)** - ⭐ 125

1230. **[codeql-mcp](https://github.com/JordyZomer/codeql-mcp)** - ⭐ 124
...
1231. **[mcp-server-macos-use](https://github.com/mediar-ai/mcp-server-macos-use)** - ⭐ 124
   AI agent that controls computer with OS-level tools, MCP compatible, works with any model

1232. **[mcp-client-server](https://github.com/willccbb/mcp-client-server)** - ⭐ 124
   An MCP Server that's also an MCP Client. Useful for letting Claude develop and test MCPs without needing to reset the application.

1233. **[zabbix-mcp-server](https://github.com/mpeirone/zabbix-mcp-server)** - ⭐ 124
...
1234. **[mcp-server-ccxt](https://github.com/doggybee/mcp-server-ccxt)** - ⭐ 124
   High-performance CCXT MCP server for cryptocurrency exchange integration

1235. **[mcp-evals](https://github.com/mclenhard/mcp-evals)** - ⭐ 124
   A Node.js package and GitHub Action for evaluating MCP (Model Context Protocol) tool implementations using LLM-based scoring. This helps ensure your MCP server's tools are working correctly and performing well.

1236. **[intervals-mcp-server](https://github.com/mvilanova/intervals-mcp-server)** - ⭐ 124
   Model Context Protocol (MCP) server for connecting Claude and ChatGPT with the Intervals.icu API.

1237. **[magg](https://github.com/sitbon/magg)** - ⭐ 124
   Magg: The MCP Aggregator

1238. **[buttplug-mcp](https://github.com/ConAcademy/buttplug-mcp)** - ⭐ 123
   Buttplug.io Model Context Protocol (MCP) Server

1239. **[laravel-loop](https://github.com/kirschbaum-development/laravel-loop)** - ⭐ 123
   Laravel Loop is a powerful Model Context Protocol (MCP) server designed specifically for Laravel applications. It connects your Laravel application with AI assistants using the MCP protocol.

1240. **[ZotLink](https://github.com/TonybotNi/ZotLink)** - ⭐ 123
...
1241. **[dify-plugin-agent-mcp_sse](https://github.com/junjiem/dify-plugin-agent-mcp_sse)** - ⭐ 123
   Dify 1.0 Plugin Support MCP Tools Agent strategies

1242. **[mcp-server-apache-airflow](https://github.com/yangkyeongmo/mcp-server-apache-airflow)** - ⭐ 123

1243. **[strudel-mcp-server](https://github.com/williamzujkowski/strudel-mcp-server)** - ⭐ 123
   A Model Context Protocol (MCP) server that gives Claude direct control over Strudel.cc for AI-assisted music generation and live coding.

1244. **[specs-workflow-mcp](https://github.com/kingkongshot/specs-workflow-mcp)** - ⭐ 122
   Intelligent spec workflow management MCP server

1245. **[mcp-svelte-docs](https://github.com/spences10/mcp-svelte-docs)** - ⭐ 122
   🔍 MCP server that lets you search and access Svelte documentation with built-in caching

1246. **[mcp-read-website-fast](https://github.com/just-every/mcp-read-website-fast)** - ⭐ 122
...
1252. **[mcp](https://github.com/pronskiy/mcp)** - ⭐ 121
   🐉 The fast, PHP way to build MCP servers

1253. **[claude-prompts-mcp](https://github.com/minipuft/claude-prompts-mcp)** - ⭐ 121
   MCP prompt template server: hot-reload, thinking frameworks, quality gates

1254. **[esp-mcp](https://github.com/horw/esp-mcp)** - ⭐ 121
   Centralize ESP32 related commands and simplify getting started with seamless, LLM-driven interaction and help.

1255. **[Human-In-the-Loop-MCP-Server](https://github.com/GongRzhe/Human-In-the-Loop-MCP-Server)** - ⭐ 121
...
1256. **[OmniFocus-MCP](https://github.com/themotionmachine/OmniFocus-MCP)** - ⭐ 121
   Let LLMs interface with your tasks and projects through the Model Context Protocol. Add, organize, and query your OmniFocus database with natural language commands.

1257. **[mcp_server_exe](https://github.com/shadowcz007/mcp_server_exe)** - ⭐ 121
   小智 & Cursor 的 MCP 启动器 - MCP For Cursor&xiaozhi。打包成可执行文件。Turn MCP server into an executable file

1258. **[mcp-server-guide](https://github.com/figma/mcp-server-guide)** - ⭐ 121
   A guide on how to use the Figma MCP server

1259. **[mcp-server-bigquery](https://github.com/LucasHild/mcp-server-bigquery)** - ⭐ 120
   A Model Context Protocol server that provides access to BigQuery

1260. **[UnityMCP](https://github.com/isuzu-shiranui/UnityMCP)** - ⭐ 120
   Unity Editor integration with Model Context Protocol (MCP) enabling AI assistants like Claude to interact with Unity projects. Features a TypeScript MCP server and C# Unity plugin with extensible command handler architecture, TCP/IP communication, and dynamic plugin discovery.

1261. **[muppet](https://github.com/muppet-dev/muppet)** - ⭐ 120
   MCP Servers SDK for TypeScript

1262. **[unreal-analyzer-mcp](https://github.com/ayeletstudioindia/unreal-analyzer-mcp)** - ⭐ 120
...
1269. **[beyond-mcp](https://github.com/disler/beyond-mcp)** - ⭐ 119
   It's time to push beyond MCP Servers... Right?

1270. **[aicode-toolkit](https://github.com/AgiFlow/aicode-toolkit)** - ⭐ 119
   Toolkit for Coding Agents to work reliably with repo of any size.

1271. **[mcp-apache-spark-history-server](https://github.com/kubeflow/mcp-apache-spark-history-server)** - ⭐ 118
   MCP Server for Apache Spark History Server. The bridge between Agentic AI and Apache Spark.

1272. **[radare2-mcp](https://github.com/radareorg/radare2-mcp)** - ⭐ 118
   MCP stdio server for radare2

1273. **[mcp-streamable-http](https://github.com/invariantlabs-ai/mcp-streamable-http)** - ⭐ 118
   Example implementation of MCP Streamable HTTP client/server in Python and TypeScript.

1274. **[mcp-endpoint-server](https://github.com/xinnan-tech/mcp-endpoint-server)** - ⭐ 118
   xiaozhi mcp接入点服务器，用于自定义mcp服务注册，方便拓展小智服务端工具调用

1275. **[mevzuat-mcp](https://github.com/saidsurucu/mevzuat-mcp)** - ⭐ 118
   MCP Server for Searching Turkish Legislation

1276. **[claudex](https://github.com/Mng-dev-ai/claudex)** - ⭐ 117
...
1280. **[mcp-server-salesforce](https://github.com/tsmztech/mcp-server-salesforce)** - ⭐ 115
   Salesforce MCP Server

1281. **[elevenlabs-mcp-server](https://github.com/mamertofabian/elevenlabs-mcp-server)** - ⭐ 115

1282. **[mcp-server-datadog](https://github.com/winor30/mcp-server-datadog)** - ⭐ 115
...
1284. **[mcp-server](https://github.com/browserstack/mcp-server)** - ⭐ 114
   BrowserStack's Official MCP Server

1285. **[penpot-mcp](https://github.com/penpot/penpot-mcp)** - ⭐ 114
...
1289. **[AgentDNS-Node](https://github.com/jsjfai/AgentDNS-Node)** - ⭐ 113
...
1290. **[mcp-server](https://github.com/InterviewReady/mcp-server)** - ⭐ 113
   An MCP server for InterviewReady

1291. **[MCppServer](https://github.com/Noeli14/MCppServer)** - ⭐ 113
   Fast and super efficient Minecraft Server written in C++

1292. **[MakerAi](https://github.com/gustavoeenriquez/MakerAi)** - ⭐ 113
...
1293. **[shopify-mcp](https://github.com/GeLi2001/shopify-mcp)** - ⭐ 113
   MCP server for Shopify api, usable on mcp hosts such as Claude and Cursor

1294. **[mcp_proxy_rust](https://github.com/tidewave-ai/mcp_proxy_rust)** - ⭐ 113
   A proxy to use HTTP/SSE MCPs from STDIO clients

1295. **[cli](https://github.com/mcpgod/cli)** - ⭐ 112
   Fine-grained control over model context protocol (MCP) clients, servers, and tools. Context is God.

1296. **[MCP2Lambda](https://github.com/danilop/MCP2Lambda)** - ⭐ 112
   Run any AWS Lambda function as a Large Language Model (LLM) tool without code changes using Anthropic's Model Context Protocol (MCP).

1297. **[mcp-hubspot](https://github.com/peakmojo/mcp-hubspot)** - ⭐ 112
...
1302. **[notion-mcp](https://github.com/ccabanillas/notion-mcp)** - ⭐ 111
   A Model Context Protocol (MCP) server implementation for Notion integration, providing a standardized interface for interacting with Notion's API.

1303. **[punkpeye_awesome-mcp-servers](https://github.com/MCP-Mirror/punkpeye_awesome-mcp-servers)** - ⭐ 111
   Mirror of https://github.com/punkpeye/awesome-mcp-servers

1304. **[Deepseek-Thinking-Claude-3.5-Sonnet-CLINE-MCP](https://github.com/newideas99/Deepseek-Thinking-Claude-3.5-Sonnet-CLINE-MCP)** - ⭐ 111
...
1305. **[SmartDB_MCP](https://github.com/wenb1n-dev/SmartDB_MCP)** - ⭐ 111
...
1309. **[mcp-jfrog](https://github.com/jfrog/mcp-jfrog)** - ⭐ 110
   Model Context Protocol (MCP) Server for the JFrog Platform API, enabling repository management, build tracking, release lifecycle management, and more.

1310. **[teslamate-mcp](https://github.com/cobanov/teslamate-mcp)** - ⭐ 110
   A Model Context Protocol (MCP) server that provides access to your TeslaMate database, allowing AI assistants to query Tesla vehicle data and analytics.

1311. **[google-workspace-mcp](https://github.com/aaronsb/google-workspace-mcp)** - ⭐ 110
   A Model Context Protocol (MCP) server that provides authenticated access to Google Workspace APIs, offering integrated Authentication, Gmail, Calendar, and Drive functionality

1312. **[mcp](https://github.com/MariaDB/mcp)** - ⭐ 110
   MariaDB MCP (Model Context Protocol) server implementation

1313. **[paperless-mcp](https://github.com/nloui/paperless-mcp)** - ⭐ 110
   An MCP (Model Context Protocol) server for interacting with a Paperless-NGX API server. This server provides tools for managing documents, tags, correspondents, and document types in your Paperless-NGX instance.

1314. **[google-sheets-mcp](https://github.com/mkummer225/google-sheets-mcp)** - ⭐ 110
...
1326. **[modex](https://github.com/theronic/modex)** - ⭐ 108
   Modex is a Clojure MCP Library to augment your AI models with Tools, Resources & Prompts using Clojure (Model Context Protocol). Implements MCP Server & Client.

1327. **[vscode-as-mcp-server](https://github.com/acomagu/vscode-as-mcp-server)** - ⭐ 108
...
1328. **[share-best-mcp](https://github.com/shareAI-lab/share-best-mcp)** - ⭐ 108
   世界上最好的MCP Servers的列表,The best mcp servers in the world.

1329. **[minesweeper-mcp-server](https://github.com/tonypan2/minesweeper-mcp-server)** - ⭐ 108
   An MCP server for playing Minesweeper

1330. **[MCP-searxng](https://github.com/SecretiveShell/MCP-searxng)** - ⭐ 108
   MCP server for connecting agentic systems to search systems via searXNG

1331. **[ffmpeg-mcp](https://github.com/video-creator/ffmpeg-mcp)** - ⭐ 108
...
1332. **[mcp-ts-template](https://github.com/cyanheads/mcp-ts-template)** - ⭐ 108
...
1333. **[turbo-flow-claude](https://github.com/marcuspat/turbo-flow-claude)** - ⭐ 108
...
1334. **[DINO-X-MCP](https://github.com/IDEA-Research/DINO-X-MCP)** - ⭐ 107
   Official DINO-X Model Context Protocol (MCP) server that empowers LLMs with real-world visual perception through image object detection, localization, and captioning APIs.

1335. **[xcodeproj-mcp-server](https://github.com/giginet/xcodeproj-mcp-server)** - ⭐ 107
   A Model Context Protocol Server to manipulate *.xcodeproj

1336. **[mcp-victoriametrics](https://github.com/VictoriaMetrics-Community/mcp-victoriametrics)** - ⭐ 107
   The implementation of Model Context Protocol (MCP) server for VictoriaMetrics

1337. **[apple-rag-mcp](https://github.com/BingoWon/apple-rag-mcp)** - ⭐ 107
    MCP server providing AI agents with instant access to Apple developer documentation via RAG technology

1338. **[hub-mcp](https://github.com/docker/hub-mcp)** - ⭐ 107
   Docker Hub MCP Server

1339. **[netbox-mcp-server](https://github.com/netboxlabs/netbox-mcp-server)** - ⭐ 107
   Model Context Protocol (MCP) server for read-only interaction with NetBox data in LLMs

1340. **[OpenSCAD-MCP-Server](https://github.com/jhacksman/OpenSCAD-MCP-Server)** - ⭐ 107
   Devin's attempt at creating an OpenSCAD MCP Server that takes a user prompt and generates a preview image and 3d file.

1341. **[mcp-memory](https://github.com/Puliczek/mcp-memory)** - ⭐ 107
...
1342. **[slack-mcp-server](https://github.com/ubie-oss/slack-mcp-server)** - ⭐ 106
   A Slack MCP server

1343. **[mcp-server](https://github.com/bitwarden/mcp-server)** - ⭐ 106
...
1345. **[mcpproxy-go](https://github.com/smart-mcp-proxy/mcpproxy-go)** - ⭐ 106
   Supercharge AI Agents, Safely

1346. **[mcp-tool-kit](https://github.com/getfounded/mcp-tool-kit)** - ⭐ 106
   Agentic abstraction layer for building high precision vertical AI agents written in python for Model Context Protocol.

1347. **[Easy-MCP-AutoCad](https://github.com/zh19980811/Easy-MCP-AutoCad)** - ⭐ 106
   这个项目是一个基于Model Context Protocol (MCP)的AutoCAD集成服务器，它允许通过自然语言与AutoCAD进行交互。通过这个服务器，用户可以使用Claude等大型语言模型来创建、修改和分析AutoCAD图纸，同时还可以存储和查询CAD元素的相关数据。目前制作参考学习，仅实现端到端之间的通信，具体工具函数尚未晚上

1348. **[matlab-mcp-core-server](https://github.com/matlab/matlab-mcp-core-server)** - ⭐ 106
   Run MATLAB® using AI applications with the official MATLAB MCP Server from MathWorks®. This MCP server for MATLAB supports a wide range of coding agents like Claude Code® and Visual Studio® Code.

1349. **[life-sciences](https://github.com/anthropics/life-sciences)** - ⭐ 106
...
1353. **[gRPC-zig](https://github.com/ziglana/gRPC-zig)** - ⭐ 105
   blazigly fast gRPC/MCP client & server implementation in zig

1354. **[pentest-mcp](https://github.com/DMontgomery40/pentest-mcp)** - ⭐ 105
   NOT for educational purposes: An MCP server for professional penetration testers including STDIO/HTTP/SSE support, nmap, go/dirbuster, nikto, JtR, hashcat, wordlist building, and more.

1355. **[mcp_client](https://github.com/theailanguage/mcp_client)** - ⭐ 105
   MCP Client Implementation using Python, LangGraph and Gemini

1356. **[sudocode](https://github.com/sudocode-ai/sudocode)** - ⭐ 105
   Lightweight agent orchestration dev tool that lives in your repo

1357. **[smileyCoin](https://github.com/fefergrgrgrg/smileyCoin)** - ⭐ 104
   simple web ui to manage mcp (model context protocol) servers in the claude app

1358. **[gemini-desktop](https://github.com/kkrishnan90/gemini-desktop)** - ⭐ 104
...
1359. **[mcp-checkpoint](https://github.com/aira-security/mcp-checkpoint)** - ⭐ 104
...
1360. **[selfhosted-supabase-mcp](https://github.com/HenkDz/selfhosted-supabase-mcp)** - ⭐ 104
   An MCP Server for your Self Hosted Supabase

1361. **[gemini-cli-mcp-server](https://github.com/centminmod/gemini-cli-mcp-server)** - ⭐ 104

1362. **[ai-command](https://github.com/mcp-wp/ai-command)** - ⭐ 104
   Control WordPress using WP-CLI, AI, and MCP.

1363. **[memory-bank-MCP](https://github.com/tuncer-byte/memory-bank-MCP)** - ⭐ 104
...
1364. **[mcp-client](https://github.com/punkpeye/mcp-client)** - ⭐ 104
   An MCP client for Node.js.

1365. **[aks-mcp](https://github.com/Azure/aks-mcp)** - ⭐ 104
   A Model Context Protocol (MCP) server that enables AI assistants to interact with AKS clusters. It serves as a bridge between AI tools (like Claude, Cursor, and GitHub Copilot) and AKS.

1366. **[easy-code-reader](https://github.com/FangYuan33/easy-code-reader)** - ⭐ 104
   A powerful MCP (Model Context Protocol) server for intelligently reading Java source code.

1367. **[Fabric-Analytics-MCP](https://github.com/santhoshravindran7/Fabric-Analytics-MCP)** - ⭐ 103
...
1371. **[neurolink](https://github.com/juspay/neurolink)** - ⭐ 103
   Universal AI Development Platform with MCP server integration, multi-provider support, and professional CLI. Build, test, and deploy AI applications with multiple ai providers.

1372. **[memory-mcp-server](https://github.com/okooo5km/memory-mcp-server)** - ⭐ 102
   A Model Context Protocol server that provides knowledge graph management capabilities. 

1373. **[a2a-mcp-tutorial](https://github.com/Tsadoq/a2a-mcp-tutorial)** - ⭐ 102
   A tutorial on how to use Model Context Protocol by Anthropic and Agent2Agent Protocol by Google

1374. **[game-asset-mcp](https://github.com/MubarakHAlketbi/game-asset-mcp)** - ⭐ 102
...
1377. **[mcp.science](https://github.com/pathintegral-institute/mcp.science)** - ⭐ 102
   Open Source MCP Servers for Scientific Research

1378. **[linux-mcp-server](https://github.com/rhel-lightspeed/linux-mcp-server)** - ⭐ 102
...
1391. **[erickwendel-contributions-mcp](https://github.com/ErickWendel/erickwendel-contributions-mcp)** - ⭐ 100
   A Model Context Protocol (MCP) server that provides tools to query Erick Wendel's contributions across different platforms

1392. **[server-google-news](https://github.com/ChanMeng666/server-google-news)** - ⭐ 100
   【Star-crossed coders unite!⭐️】Model Context Protocol (MCP) server implementation providing Google News search capabilities via SerpAPI, with automatic news categorization and multi-language support.

1393. **[oracle-mcp-server](https://github.com/danielmeppiel/oracle-mcp-server)** - ⭐ 100
   MCP Server for working with large Oracle databases

1394. **[mcp-hono-stateless](https://github.com/mhart/mcp-hono-stateless)** - ⭐ 100
   An example Hono MCP server using Streamable HTTP

1395. **[claude-code-mcp-enhanced](https://github.com/grahama1970/claude-code-mcp-enhanced)** - ⭐ 100
...
1396. **[NornicDB](https://github.com/orneryd/NornicDB)** - ⭐ 100
...
1399. **[sample-agentic-ai-demos](https://github.com/aws-samples/sample-agentic-ai-demos)** - ⭐ 99
   Collection of examples of how to use Model Context Protocol with AWS.

1400. **[next-mcp-server](https://github.com/vertile-ai/next-mcp-server)** - ⭐ 99
   Help LLMs to understand your Next apps better

1401. **[aseprite-mcp](https://github.com/diivi/aseprite-mcp)** - ⭐ 99
   MCP server for interacting with the Aseprite API

1402. **[complete-intro-to-mcp](https://github.com/btholt/complete-intro-to-mcp)** - ⭐ 99
   The Complete Intro to MCP Servers, as taught for Frontend Masters by Brian Holt

1403. **[turbular](https://github.com/raeudigerRaeffi/turbular)** - ⭐ 99
   A MCP server allowing LLM agents to easily connect and retrieve data from any database

1404. **[pywss](https://github.com/czasg/pywss)** - ⭐ 99
   一个轻量级的 Python Web 框架，一站式集成 MCP SSE、StreamHTTP 和 MCPO 协议，助你轻松构建MCP Server🔥

1405. **[mighty-security](https://github.com/NineSunsInc/mighty-security)** - ⭐ 99
   Don't Simply Trust MCP Server Code, Validate and Scan

1406. **[mcp-bsl-platform-context](https://github.com/alkoleft/mcp-bsl-platform-context)** - ⭐ 99
   MCP сервер для AI-ассистентов (справка по синтаксису и объектной модели 1С:Предприятие)

1407. **[ableton-mcp-extended](https://github.com/uisato/ableton-mcp-extended)** - ⭐ 99
   Ableton Live MCP (Model Context Protocol) server that allows control directly through AI assistants.

1408. **[btp-sap-odata-to-mcp-server](https://github.com/lemaiwo/btp-sap-odata-to-mcp-server)** - ⭐ 99
...
1410. **[mcp-typescript-sdk](https://github.com/emqx/mcp-typescript-sdk)** - ⭐ 98
   A TypeScript SDK for implementing Model Context Protocol (MCP) over MQTT, supporting both browser and Node.js environments.

1411. **[mcp-kit](https://github.com/my-mcp-hub/mcp-kit)** - ⭐ 98
   A CLI tool to create MCP (Model Context Protocol) applications with ease.

1412. **[mcp-sse-demo](https://github.com/cnych/mcp-sse-demo)** - ⭐ 98
   claude mcp sse demo with server and client(cli、web)

1413. **[mcp-windows-desktop-automation](https://github.com/mario-andreschak/mcp-windows-desktop-automation)** - ⭐ 98
   A Model Context Protocol (MCP) server for Windows desktop automation using AutoIt.

1414. **[dash-mcp-server](https://github.com/Kapeli/dash-mcp-server)** - ⭐ 98
   MCP server for Dash, the macOS documentation browser

1415. **[mcp_on_ruby](https://github.com/rubyonai/mcp_on_ruby)** - ⭐ 98
   💎 A Ruby implementation of the Model Context Protocol

1416. **[AgentBoard](https://github.com/igrigorik/AgentBoard)** - ⭐ 98
...
1418. **[mcp-client-nodejs](https://github.com/ConardLi/mcp-client-nodejs)** - ⭐ 97
   Node.js Client Implementation for Model Context Protocol (MCP)

1419. **[sqlite-explorer-fastmcp-mcp-server](https://github.com/hannesrudolph/sqlite-explorer-fastmcp-mcp-server)** - ⭐ 97
   An MCP server that provides safe, read-only access to SQLite databases through Model Context Protocol (MCP). This server is built with the FastMCP framework, which enables LLMs to explore and query SQLite databases with built-in safety features and query validation.

1420. **[gtasks-mcp](https://github.com/zcaceres/gtasks-mcp)** - ⭐ 97
   A Google Tasks Model Context Protocol Server for Claude

1421. **[railway-mcp-server](https://github.com/railwayapp/railway-mcp-server)** - ⭐ 97
   Official Railway MCP Server for interacting with your Railway account

1422. **[finance-trading-ai-agents-mcp](https://github.com/aitrados/finance-trading-ai-agents-mcp)** - ⭐ 97
...
1423. **[mcp-virustotal](https://github.com/BurtTheCoder/mcp-virustotal)** - ⭐ 97
   A Model Context Protocol (MCP) server for querying the VirusTotal API.

1424. **[mcp-shodan](https://github.com/BurtTheCoder/mcp-shodan)** - ⭐ 97
   MCP server for querying the Shodan API

1425. **[all-in-one-model-context-protocol](https://github.com/nguyenvanduocit/all-in-one-model-context-protocol)** - ⭐ 96
   🚀 All-in-one MCP server with AI search, RAG, and multi-service integrations (GitLab/Jira/Confluence/YouTube) for AI-enhanced development workflows

1426. **[MiniMax-MCP-JS](https://github.com/MiniMax-AI/MiniMax-MCP-JS)** - ⭐ 96
   Official MiniMax Model Context Protocol (MCP) JavaScript implementation that provides seamless integration with MiniMax's powerful AI capabilities including image generation, video generation, text-to-speech, and voice cloning APIs.

1427. **[searxng-mul-mcp](https://github.com/jae-jae/searxng-mul-mcp)** - ⭐ 96
   A Model Context Protocol (MCP) server for SearXNG search engine with multi-query parallel search support

1428. **[mcp-local-rag](https://github.com/nkapila6/mcp-local-rag)** - ⭐ 95
   "primitive" RAG-like web search model context protocol (MCP) server that runs locally. ✨ no APIs ✨

1429. **[awesome-mcp-enterprise](https://github.com/bh-rat/awesome-mcp-enterprise)** - ⭐ 95
   A curated list of awesome MCP (Model Context Protocol) tools, platforms, and services for enterprises.

1430. **[IntelliConnect](https://github.com/ruanrongman/IntelliConnect)** - ⭐ 95
   本项目为xiaozhi-esp32提供后端服务  |  A Powerful AI agent IoT platform core.

1431. **[systemprompt-mcp-server](https://github.com/systempromptio/systemprompt-mcp-server)** - ⭐ 94
...
1432. **[mcp-server](https://github.com/webflow/mcp-server)** - ⭐ 94
   Model Context Protocol (MCP) server for the Webflow Data API.

1433. **[ruby-mcp-client](https://github.com/simonx1/ruby-mcp-client)** - ⭐ 94
   This is a Ruby implementation of MCP (Model Context Protocol) client

1434. **[gemini-mcp-desktop-client](https://github.com/duke7able/gemini-mcp-desktop-client)** - ⭐ 94
   first gemini based desktop client for MCP

1435. **[infobus-mcp](https://github.com/simovilab/infobus-mcp)** - ⭐ 93
   Model Context Protocol server enabling AI assistants to access transit information through standardized interfaces

1436. **[typst-mcp](https://github.com/johannesbrandenburger/typst-mcp)** - ⭐ 93
   Typst MCP Server is an MCP (Model Context Protocol) implementation that helps AI models interact with Typst, a markup-based typesetting system. The server provides tools for converting between LaTeX and Typst, validating Typst syntax, and generating images from Typst code.

1437. **[terminal-controller-mcp](https://github.com/GongRzhe/terminal-controller-mcp)** - ⭐ 93
   A Model Context Protocol (MCP) server that enables secure terminal command execution, directory navigation, and file system operations through a standardized interface.

1438. **[JavaSinkTracer_MCP](https://github.com/Zacarx/JavaSinkTracer_MCP)** - ⭐ 93
   基于函数级污点分析的 Java 源代码漏洞审计工具JavaSinkTracer，通过 Model Context Protocol (MCP) 为 AI 助手提供安全分析能力。

1439. **[MasterMCP](https://github.com/slowmist/MasterMCP)** - ⭐ 92
...
1440. **[mcp-replicate](https://github.com/deepfates/mcp-replicate)** - ⭐ 92
   Model Context Protocol server for Replicate's API

1441. **[mcp-server-gsc](https://github.com/ahonn/mcp-server-gsc)** - ⭐ 92
   A Model Context Protocol (MCP) server providing access to Google Search Console

1442. **[github-stars](https://github.com/miantiao-me/github-stars)** - ⭐ 91
   A Cloudflare-powered MCP (Model Context Protocol) Server that allows you to search and query your GitHub starred repositories using natural language.

1443. **[square-mcp-server](https://github.com/square/square-mcp-server)** - ⭐ 90
   A Model Context Protocol (MCP) server for square

1444. **[sandbox-mcp](https://github.com/pottekkat/sandbox-mcp)** - ⭐ 90
   A Model Context Protocol (MCP) server that enables LLMs to run ANY code safely in isolated Docker containers.

1445. **[mcp-server-idapro](https://github.com/fdrechsler/mcp-server-idapro)** - ⭐ 90
   A Model Context Protocol (MCP) server that enables AI assistants to interact with IDA Pro for reverse engineering and binary analysis tasks.

1446. **[gis-mcp](https://github.com/mahdin75/gis-mcp)** - ⭐ 89
   A Model Context Protocol (MCP) server implementation that connects Large Language Models (LLMs) to GIS operations using GIS libraries, enabling AI assistants to perform geospatial operations and transformations.

1447. **[Financial-Modeling-Prep-MCP-Server](https://github.com/imbenrabi/Financial-Modeling-Prep-MCP-Server)** - ⭐ 89
   A Model Context Protocol (MCP) implementation for Financial Modeling Prep, enabling AI assistants to access and analyze financial data, stock information, company fundamentals, and market insights.

1448. **[pluggedin-app](https://github.com/VeriTeknik/pluggedin-app)** - ⭐ 89
   The Crossroads for AI Data Exchanges. A unified, self-hostable web interface for discovering, configuring, and managing Model Context Protocol (MCP) servers—bringing together AI tools, workspaces, prompts, and logs from multiple MCP sources (Claude, Cursor, etc.) under one roof.

1449. **[a2ajava](https://github.com/vishalmysore/a2ajava)** - ⭐ 89
...
1450. **[mcp-python-interpreter](https://github.com/yzfly/mcp-python-interpreter)** - ⭐ 89
   MCP Python Interpreter: run python code. Python-mcp-server, mcp-python-server, Code Executor

1451. **[octagon-mcp-server](https://github.com/OctagonAI/octagon-mcp-server)** - ⭐ 88
...
1452. **[mcp-web-ui](https://github.com/MegaGrindStone/mcp-web-ui)** - ⭐ 87
   MCP Web UI is a web-based user interface that serves as a Host within the Model Context Protocol (MCP) architecture. It provides a powerful and user-friendly interface for interacting with Large Language Models (LLMs) while managing context aggregation and coordination between clients and servers.

1453. **[mcp-trino](https://github.com/tuannvm/mcp-trino)** - ⭐ 87
   A high-performance Model Context Protocol (MCP) server for Trino implemented in Go.

1454. **[opencv-mcp-server](https://github.com/GongRzhe/opencv-mcp-server)** - ⭐ 87
...
1455. **[mcp-ui](https://github.com/machaojin1917939763/mcp-ui)** - ⭐ 86
   基于MCP(Model Context Protocol)的智能聊天应用，支持Web和桌面环境。集成OpenAI/Anthropic API，提供MCP服务器的所有工具能力。简洁现代的UI设计，支持跨平台部署。

1456. **[molecule-mcp](https://github.com/ChatMol/molecule-mcp)** - ⭐ 86
   A model-context-protocol server for molecules.

1457. **[model-context-protocol-mcp-hands-on-with-agentic-ai-2034200](https://github.com/LinkedInLearning/model-context-protocol-mcp-hands-on-with-agentic-ai-2034200)** - ⭐ 86
...
1458. **[mcp-server-and-gw](https://github.com/boilingdata/mcp-server-and-gw)** - ⭐ 86
   An MCP stdio to HTTP SSE transport gateway with example server and MCP client

1459. **[mcp-graphiti](https://github.com/rawr-ai/mcp-graphiti)** - ⭐ 86
   Graphiti Model Context Protocol (MCP) Server - An MCP server for knowledge graph management via Graphiti

1460. **[github-stars](https://github.com/ccbikai/github-stars)** - ⭐ 85
   A Cloudflare-powered MCP (Model Context Protocol) Server that allows you to search and query your GitHub starred repositories using natural language.

1461. **[ToolsForMCPServer](https://github.com/tanaikech/ToolsForMCPServer)** - ⭐ 85
   The Gemini CLI confirmed that the MCP server built with Google Apps Script (GAS), a low-code platform, offers immense possibilities. If you've created snippets for GAS, these could be revitalized and/or leveraged in new ways by using them as the MCP server. The Gemini CLI and other MCP clients will be useful in achieving this.

1462. **[spring-ai-playground](https://github.com/spring-ai-community/spring-ai-playground)** - ⭐ 85
...
1463. **[furi](https://github.com/ashwwwin/furi)** - ⭐ 85
   CLI & API for MCP management

1464. **[ragie-mcp-server](https://github.com/ragieai/ragie-mcp-server)** - ⭐ 84
   Ragie Model Context Protocol Server

1465. **[openai-gpt-image-mcp](https://github.com/SureScaleAI/openai-gpt-image-mcp)** - ⭐ 84
   A Model Context Protocol (MCP) tool server for OpenAI's GPT-4o/gpt-image-1 image generation and editing APIs.

1466. **[action_mcp](https://github.com/seuros/action_mcp)** - ⭐ 84
   Rails Engine with MCP compliant Spec.

1467. **[memory-mcp-server-go](https://github.com/okooo5km/memory-mcp-server-go)** - ⭐ 83
   A Model Context Protocol server that provides knowledge graph management capabilities.

1468. **[Awesome-Claude-MCP-Servers](https://github.com/win4r/Awesome-Claude-MCP-Servers)** - ⭐ 83
   A curated list of Model Context Protocol (MCP) servers optimized for Claude AI assistants.

1469. **[splunk-mcp](https://github.com/livehybrid/splunk-mcp)** - ⭐ 83
   A Model Context Protocol (MCP) implementation for Splunk Enterprise and Cloud integration with Cursor IDE or Claude

1470. **[node-candidate-mcp-server](https://github.com/jhgaylor/node-candidate-mcp-server)** - ⭐ 81
   A Model Context Protocol (MCP) server library that gives LLMs access to information about a candidate.

1471. **[mcp-rs-template](https://github.com/linux-china/mcp-rs-template)** - ⭐ 81
   Model Context Protocol (MCP) CLI server template for Rust

1472. **[sh-disney-mcp](https://github.com/syyuan14/sh-disney-mcp)** - ⭐ 81
   sh-disney-mcp 是一个基于 Model Context Protocol (MCP) 的mcp server，旨在通过标准化的接口，帮助大模型快速获取上海迪士尼乐园的门票价格和售卖状态信息

1473. **[mcphub](https://github.com/Cognitive-Stack/mcphub)** - ⭐ 81
...
1474. **[deepl-mcp-server](https://github.com/DeepLcom/deepl-mcp-server)** - ⭐ 81
   A Model Context Protocol (MCP) server that provides translation capabilities using the DeepL API.

1475. **[spiceflow](https://github.com/remorses/spiceflow)** - ⭐ 81
   Super Simple API framework, type safe, automatic OpenAPI, MCP support, client RPC, streaming with SSE

1476. **[mcp-server](https://github.com/keboola/mcp-server)** - ⭐ 80
   Model Context Protocol (MCP) Server for the Keboola Platform

1477. **[office-editor-mcp](https://github.com/theWDY/office-editor-mcp)** - ⭐ 80
   基于MCP(Model Context Protocol)的Office文档处理助手，支持在MCP Client中创建和编辑Word、Excel、Powerpoint文档。

1478. **[pinescript-mcp-server](https://github.com/cklose2000/pinescript-mcp-server)** - ⭐ 80
   A Model Context Protocol (MCP) server for working with TradingView PineScript

1479. **[mcp-server-stability-ai](https://github.com/tadasant/mcp-server-stability-ai)** - ⭐ 80
...
1480. **[anki-mcp-server](https://github.com/CamdenClark/anki-mcp-server)** - ⭐ 79
   A model context protocol server that connects to Anki through AnkiConnect

1481. **[legion-mcp](https://github.com/TheRaLabs/legion-mcp)** - ⭐ 79
   A server that helps people access and query data in databases using the Legion Query Runner with Model Context Protocol (MCP) in Python.

1482. **[identity](https://github.com/agntcy/identity)** - ⭐ 79
...
1483. **[Delphi-MCP-Server](https://github.com/GDKsoftware/Delphi-MCP-Server)** - ⭐ 79
   Native Delphi Server implementation of the Model Context Protocol (MCP)

1484. **[mcp-excel-server](https://github.com/yzfly/mcp-excel-server)** - ⭐ 79
...
1485. **[mcp-gateway](https://github.com/hyprmcp/mcp-gateway)** - ⭐ 79
...
1486. **[NASA-MCP-server](https://github.com/ProgramComputer/NASA-MCP-server)** - ⭐ 79
   A Model Context Protocol (MCP) server for NASA APIs, providing a standardized interface for AI models to interact with NASA's vast array of data sources.

1487. **[Polymcp](https://github.com/poly-mcp/Polymcp)** - ⭐ 79
   Polymcp provides a simple and efficient way to interact with MCP servers using custom agents

1488. **[aws-security-mcp](https://github.com/groovyBugify/aws-security-mcp)** - ⭐ 78
   A Model Context Protocol server that connects AI assistants like Claude to AWS security services, allowing them to autonomously query, inspect, and analyze AWS infrastructure for security issues and misconfigurations.

1489. **[mcp-memory-libsql](https://github.com/spences10/mcp-memory-libsql)** - ⭐ 78
   🧠 High-performance persistent memory system for Model Context Protocol (MCP) powered by libSQL. Features vector search, semantic knowledge storage, and efficient relationship management - perfect for AI agents and knowledge graph applications.

1490. **[github-chat-mcp](https://github.com/AsyncFuncAI/github-chat-mcp)** - ⭐ 78
   A Model Context Protocol (MCP) for analyzing and querying GitHub repositories using the GitHub Chat API.

1491. **[mcp-azure-devops](https://github.com/Vortiago/mcp-azure-devops)** - ⭐ 78
   A Model Context Protocol (MCP) server enabling AI assistants to interact with Azure DevOps services via Python SDK.

1492. **[IB_MCP](https://github.com/rcontesti/IB_MCP)** - ⭐ 78
   This project provides an Interactive Brokers (IB) API interface using the Model Context Protocol (MCP).

1493. **[dicom-mcp](https://github.com/ChristianHinge/dicom-mcp)** - ⭐ 77
   Model Context Protocol (MCP) for interacting with dicom servers (PACS etc.)

1494. **[toolhive-studio](https://github.com/stacklok/toolhive-studio)** - ⭐ 77
   ToolHive is an application that allows you to install, manage and run MCP servers and connect them to AI agents

1495. **[cve-search_mcp](https://github.com/roadwy/cve-search_mcp)** - ⭐ 77
   A Model Context Protocol (MCP) server for querying the CVE-Search API

1496. **[mcp-monitor](https://github.com/seekrays/mcp-monitor)** - ⭐ 76
   A system monitoring tool that exposes system metrics via the Model Context Protocol (MCP). This tool allows LLMs to retrieve real-time system information through an MCP-compatible interface.

1497. **[mcp-discovery](https://github.com/rust-mcp-stack/mcp-discovery)** - ⭐ 76
   A command-line tool written in Rust for discovering and documenting MCP Server capabilities.

1498. **[sample-agents-with-nova-act-and-mcp](https://github.com/aws-samples/sample-agents-with-nova-act-and-mcp)** - ⭐ 75
...
1499. **[jvm-mcp-server](https://github.com/xzq-xu/jvm-mcp-server)** - ⭐ 75
   This is an implementation project of a JVM-based MCP (Model Context Protocol) server. The project aims to provide a standardized MCP server implementation for the JVM platform, enabling AI models to better interact with the Java ecosystem.

1500. **[tester-mcp-client](https://github.com/apify/tester-mcp-client)** - ⭐ 75
   Model Context Protocol (MCP) Client for Apify's Actors

1501. **[mcp-server-circleci](https://github.com/CircleCI-Public/mcp-server-circleci)** - ⭐ 75
   A specialized server implementation for the Model Context Protocol (MCP) designed to integrate with CircleCI's development workflow. This project serves as a bridge between CircleCI's infrastructure and the Model Context Protocol, enabling enhanced AI-powered development experiences.

1502. **[mcp-sqlite](https://github.com/jparkerweb/mcp-sqlite)** - ⭐ 75
   🐇 Model Context Protocol (MCP) server that provides comprehensive SQLite database interaction capabilities

1503. **[codeglide-mcpgen](https://github.com/CodeGlide/codeglide-mcpgen)** - ⭐ 75
   Generation of Secure MCP (Model Context Protocol) Servers from API source code at Scale

1504. **[mcp-kafka](https://github.com/kanapuli/mcp-kafka)** - ⭐ 74
   A Model Context Protocol Server to perform Kafka client operations

1505. **[woocommerce-mcp-server](https://github.com/techspawn/woocommerce-mcp-server)** - ⭐ 74
   A WooCommerce (MCP) Model Context Protocol server

1506. **[google-cloud-mcp](https://github.com/krzko/google-cloud-mcp)** - ⭐ 74
   🤖 A Model Context Protocol (MCP) server for Google Cloud (GCP)

1507. **[youtrack-mcp](https://github.com/tonyzorin/youtrack-mcp)** - ⭐ 73
...
1508. **[rust-mcp-schema](https://github.com/rust-mcp-stack/rust-mcp-schema)** - ⭐ 72
   A type-safe implementation of the official Model Context Protocol (MCP) schema in Rust.

1509. **[imessage-query-fastmcp-mcp-server](https://github.com/hannesrudolph/imessage-query-fastmcp-mcp-server)** - ⭐ 72
   An MCP server that provides safe access to your iMessage database through Model Context Protocol (MCP). This server is built with the FastMCP framework and the imessagedb library, enabling LLMs to query and analyze iMessage conversations with proper phone number validation and attachment handling.

1510. **[ChEMBL-MCP-Server](https://github.com/Augmented-Nature/ChEMBL-MCP-Server)** - ⭐ 72
   A comprehensive Model Context Protocol (MCP) server providing advanced access to the ChEMBL chemical database.

1511. **[healthcare-mcp-public](https://github.com/Cicatriiz/healthcare-mcp-public)** - ⭐ 72
   A Model Context Protocol (MCP) server providing AI assistants with access to healthcare data and medical information tools, including FDA drug info, PubMed, medRxiv, NCBI Bookshelf, clinical trials, ICD-10, DICOM metadata, and a medical calculator.

1512. **[actual-mcp](https://github.com/s-stefanov/actual-mcp)** - ⭐ 72
   Model Context Protocol for Actual Budget API

1513. **[mcp-metatrader5-server](https://github.com/Qoyyuum/mcp-metatrader5-server)** - ⭐ 71
...
1514. **[mcp-outline](https://github.com/Vortiago/mcp-outline)** - ⭐ 71
   A Model Context Protocol (MCP) server enabling AI assistants to interact with Outline documentation services.

1515. **[anubis-mcp](https://github.com/zoedsoupe/anubis-mcp)** - ⭐ 71
   Elixir Model Context Protocol (MCP) SDK (hermes-mcp fork)

1516. **[choturobo](https://github.com/vishalmysore/choturobo)** - ⭐ 70
...
1517. **[airtable-mcp](https://github.com/felores/airtable-mcp)** - ⭐ 70
   Search, create and update Airtable bases, tables, fields, and records using Claude Desktop and MCP (Model Context Protocol) clients

1518. **[chat.md](https://github.com/rusiaaman/chat.md)** - ⭐ 70
   An md file as a chat interface and editable history in one.

1519. **[codebase-mcp](https://github.com/DeDeveloper23/codebase-mcp)** - ⭐ 69
   Model Context Protocol implementation for retrieving codebases using RepoMix

1520. **[ccxt-mcp](https://github.com/lazy-dinosaur/ccxt-mcp)** - ⭐ 69
   CCXT MCP Server bridges the gap between AI models and cryptocurrency trading by providing a standardized interface through the Model Context Protocol. Created to empower automated trading strategies, this tool allows AI assistants like Claude and GPT to directly interact with over 100 cryptocurrency exchanges without requiring users to write comple

1521. **[wecom-bot-mcp-server](https://github.com/loonghao/wecom-bot-mcp-server)** - ⭐ 69
...
1522. **[perfetto-mcp](https://github.com/antarikshc/perfetto-mcp)** - ⭐ 69
...
1523. **[MCP-server-Deepseek_R1](https://github.com/66julienmartin/MCP-server-Deepseek_R1)** - ⭐ 68
   A Model Context Protocol (MCP) server implementation connecting Claude Desktop with DeepSeek's language models (R1/V3)

1524. **[agentic-tools-mcp](https://github.com/Pimzino/agentic-tools-mcp)** - ⭐ 68
   A comprehensive Model Context Protocol (MCP) server providing AI assistants with powerful task management and agent memories capabilities with project-specific storage.

1525. **[Mureka-mcp](https://github.com/SkyworkAI/Mureka-mcp)** - ⭐ 68
   generate lyrics, song and background music(instrumental). Model Context Protocol (MCP) server.

1526. **[HopperMCP](https://github.com/MxIris-Reverse-Engineering/HopperMCP)** - ⭐ 68
   A Model Context Protocol server for Hopper Disassembler

1527. **[MCPhoenix](https://github.com/jmanhype/MCPhoenix)** - ⭐ 67
   A simplified implementation of the Model Context Protocol (MCP) server using Elixir's Phoenix Framework.

1528. **[mcp_gradio_client](https://github.com/justjoehere/mcp_gradio_client)** - ⭐ 67
   This is a proof of concept repo on how to create a gradio UI using the Model Context Protocol Client Python SDK.

1529. **[gmail-mcp-server](https://github.com/jasonsum/gmail-mcp-server)** - ⭐ 67
   Model Context Protocol (MCP) server for Gmail

1530. **[optuna-mcp](https://github.com/optuna/optuna-mcp)** - ⭐ 67
   The Optuna MCP Server is a Model Context Protocol (MCP) server to interact with Optuna APIs.

1531. **[deepview-mcp](https://github.com/ai-1st/deepview-mcp)** - ⭐ 67
   DeepView MCP is a Model Context Protocol server that enables IDEs like Cursor and Windsurf to analyze large codebases using Gemini 2.5 Pro's extensive context window.

1532. **[mcp-server-email](https://github.com/Shy2593666979/mcp-server-email)** - ⭐ 67
...
1533. **[FNewsCrawler](https://github.com/noimank/FNewsCrawler)** - ⭐ 67
   一个专门为大模型设计的财经信息MCP（Model Context Protocol）服务，通过高效的爬虫技术从各大财经网站（同花顺、东方财富等）获取实时资讯，为AI模型提供准确、及时的财经数据支持。

1534. **[ollama-mcp-client](https://github.com/mihirrd/ollama-mcp-client)** - ⭐ 67
   MCP client for local ollama models

1535. **[SillyTavern-MCP-Client](https://github.com/bmen25124/SillyTavern-MCP-Client)** - ⭐ 67
   An extension of MCP for SillyTavern.

1536. **[agenite](https://github.com/subeshb1/agenite)** - ⭐ 67
...
1537. **[loki-mcp](https://github.com/grafana/loki-mcp)** - ⭐ 67
   An MCP ( Model Context Protocol ) Server for Grafana Loki

1538. **[OmniMCP](https://github.com/OpenAdaptAI/OmniMCP)** - ⭐ 66
   OmniMCP uses Microsoft OmniParser and Model Context Protocol (MCP) to provide AI models with rich UI context and powerful interaction capabilities.

1539. **[raindrop-io-mcp-server](https://github.com/hiromitsusasaki/raindrop-io-mcp-server)** - ⭐ 66
   An integration that allows LLMs to interact with Raindrop.io bookmarks using the Model Context Protocol (MCP).

1540. **[mcp-fal](https://github.com/am0y/mcp-fal)** - ⭐ 66
   A Model Context Protocol (MCP) server for interacting with fal.ai models and services.

1541. **[mcp-velociraptor](https://github.com/mgreen27/mcp-velociraptor)** - ⭐ 66
   VelociraptorMCP is a Model Context Protocol bridge for exposing LLMs to MCP clients.

1542. **[deepseek-thinker-mcp](https://github.com/ruixingshi/deepseek-thinker-mcp)** - ⭐ 66
...
1543. **[vibe-blocks-mcp](https://github.com/majidmanzarpour/vibe-blocks-mcp)** - ⭐ 66
...
1544. **[mcp-server-datahub](https://github.com/acryldata/mcp-server-datahub)** - ⭐ 66
   The official Model Context Protocol (MCP) server for DataHub (https://datahub.com)

1545. **[mcp-client-python](https://github.com/alejandro-ao/mcp-client-python)** - ⭐ 66

1546. **[piapi-mcp-server](https://github.com/apinetwork/piapi-mcp-server)** - ⭐ 65
   A TypeScript implementation of a Model Context Protocol (MCP) server that integrates with PiAPI's API. PiAPI makes user able to generate media content with Midjourney/Flux/Kling/LumaLabs/Udio/Chrip/Trellis directly from Claude or any other MCP-compatible apps.

1547. **[markitdown_mcp_server](https://github.com/KorigamiK/markitdown_mcp_server)** - ⭐ 65
   A Model Context Protocol (MCP) server that converts various file formats to Markdown using the MarkItDown utility.

1548. **[QuickMCP](https://github.com/gunpal5/QuickMCP)** - ⭐ 65
   Effortlessly Build Model Context Protocol Servers with OpenAPI or Swagger or Google Discovery Specifications

1549. **[boilerplate-mcp-server](https://github.com/aashari/boilerplate-mcp-server)** - ⭐ 65
   TypeScript Model Context Protocol (MCP) server boilerplate providing IP lookup tools/resources. Includes CLI support and extensible structure for connecting AI systems (LLMs) to external data sources like ip-api.com. Ideal template for creating new MCP integrations via Node.js.

1550. **[mcp](https://github.com/vuetifyjs/mcp)** - ⭐ 65
   🤖 A Model Context Protocol (MCP) library for use with Agentic chat bots

1551. **[mcp-jenkins](https://github.com/lanbaoshen/mcp-jenkins)** - ⭐ 65
   The Model Context Protocol (MCP) is an open-source implementation that bridges Jenkins with AI language models following Anthropic's MCP specification. This project enables secure, contextual AI interactions with Jenkins tools while maintaining data privacy and security.

1552. **[bitbucket-mcp](https://github.com/MatanYemini/bitbucket-mcp)** - ⭐ 65
   Bitbucket MCP - A Model Context Protocol (MCP) server for integrating with Bitbucket Cloud and Server APIs

1553. **[ViaMCP](https://github.com/ViaVersionMCP/ViaMCP)** - ⭐ 65
   Client-side Implementation of the Via* projects for MCP

1554. **[awesome-mcp-best-practices](https://github.com/lirantal/awesome-mcp-best-practices)** - ⭐ 65
   Build Awesome MCPs with Awesome Best Practices for MCP Servers and MCP Clients

1555. **[anki-mcp-server](https://github.com/ankimcp/anki-mcp-server)** - ⭐ 65
   A Model Context Protocol (MCP) server that enables AI assistants to interact with Anki, the spaced repetition flashcard application.

1556. **[uml-mcp](https://github.com/antoinebou12/uml-mcp)** - ⭐ 64
...
1557. **[lsd-mcp](https://github.com/lsd-so/lsd-mcp)** - ⭐ 64
   LSD Model Context Protocol

1558. **[svelte5-mcp](https://github.com/StudentOfJS/svelte5-mcp)** - ⭐ 64
   A specialized Model Context Protocol (MCP) server for Svelte 5 frontend development

1559. **[BurpSuite-MCP-Server](https://github.com/X3r0K/BurpSuite-MCP-Server)** - ⭐ 64
   BurpSuite MCP Server:  A powerful Model Context Protocol (MCP) server implementation for BurpSuite, providing programmatic access to Burp's core functionalities.

1560. **[m3](https://github.com/rafiattrach/m3)** - ⭐ 64
...
1561. **[ollama-mcp-client](https://github.com/anjor/ollama-mcp-client)** - ⭐ 64

1562. **[community-servers](https://github.com/mcp-get/community-servers)** - ⭐ 63
...
1563. **[mcp-tutorials](https://github.com/chenmingyong0423/mcp-tutorials)** - ⭐ 63
   Model Context Protocol(MCP) 中文教程讲解

1564. **[mcp-fhir](https://github.com/flexpa/mcp-fhir)** - ⭐ 63
   A Model Context Protocol implementation for FHIR

1565. **[usolver](https://github.com/sdiehl/usolver)** - ⭐ 62
   A model context protocol server for solving combinatorial optimization problems with logical and numerical constraints.

1566. **[mcp-sdk](https://github.com/AntigmaLabs/mcp-sdk)** - ⭐ 62
   Minimalistic Rust Implementation Of Model Context Protocol from Anthropic

1567. **[x64dbgMCP](https://github.com/Wasdubya/x64dbgMCP)** - ⭐ 62
   Model Context Protocol for x64dbg & x32dbg

1568. **[nutrient-dws-mcp-server](https://github.com/PSPDFKit/nutrient-dws-mcp-server)** - ⭐ 62
   A Model Context Protocol (MCP) server implementation that integrates with the Nutrient Document Web Service (DWS) Processor API, providing powerful PDF processing capabilities for AI assistants.

1569. **[mcp-durable-object-client](https://github.com/Dhravya/mcp-durable-object-client)** - ⭐ 62
   testing mcps

1570. **[mcp-openapi-schema-explorer](https://github.com/kadykov/mcp-openapi-schema-explorer)** - ⭐ 62
   MCP server providing token-efficient access to OpenAPI/Swagger specs via MCP Resources for client-side exploration.

1571. **[spring-ai](https://github.com/eazybytes/spring-ai)** - ⭐ 62
   From Java Dev to AI Engineer: Spring AI Fast Track

1572. **[mcp-config](https://github.com/marcusschiesser/mcp-config)** - ⭐ 62
   A CLI tool for easy installation of MCP servers and managing their configuration

1573. **[contentful-mcp](https://github.com/ivo-toby/contentful-mcp)** - ⭐ 61
   MCP (Model Context Protocol) server for the Contentful Management API

1574. **[mcpr](https://github.com/devOpifex/mcpr)** - ⭐ 61
   Model Context Protocol server and client for R

1575. **[voice-mcp-agent](https://github.com/den-vasyliev/voice-mcp-agent)** - ⭐ 61
...
1576. **[CanvasMCPClient](https://github.com/n00bvn/CanvasMCPClient)** - ⭐ 61
   Canvas MCP Client is an open-source, self-hostable dashboard application built around an infinite, zoomable, and pannable canvas. It provides a unified interface for interacting with multiple MCP (Model Context Protocol) servers through a flexible, widget-based system.

1577. **[mcp-server-okppt](https://github.com/NeekChaw/mcp-server-okppt)** - ⭐ 61
...
1578. **[mcp-cn](https://github.com/mengjian-github/mcp-cn)** - ⭐ 61
...
1579. **[kollektiv-mcp](https://github.com/alexander-zuev/kollektiv-mcp)** - ⭐ 61
...
1580. **[Nano-Banana-MCP](https://github.com/ConechoAI/Nano-Banana-MCP)** - ⭐ 61
   A Nano Banana MCP server, which you can integrate to cursor/claude code and any mcp client

1581. **[ocaml-mcp-sdk](https://github.com/bmorphism/ocaml-mcp-sdk)** - ⭐ 60
   OCaml SDK for Model Context Protocol using Jane Street's oxcaml_effect library

1582. **[ollama-mcp-db](https://github.com/robdodson/ollama-mcp-db)** - ⭐ 60
...
1583. **[airtable-mcp](https://github.com/rashidazarang/airtable-mcp)** - ⭐ 60
   Airtable integration for AI-powered applications via Anthropic's Model Context Protocol (MCP)

1584. **[mcp-client-capabilities](https://github.com/apify/mcp-client-capabilities)** - ⭐ 60
   Index of all Model Context Protocol (MCP) clients and their capabilities

1585. **[ig-mcp](https://github.com/jlbadano/ig-mcp)** - ⭐ 60
...
1586. **[math-mcp](https://github.com/EthanHenrickson/math-mcp)** - ⭐ 60
   A Model Context Protocol (MCP) server that provides basic mathematical and statistical functions to Large Language Models (LLMs). This server enables LLMs to perform accurate numerical calculations through a simple API.

1587. **[mcp-miro](https://github.com/k-jarzyna/mcp-miro)** - ⭐ 59
   Miro integration for Model Context Protocol

1588. **[daipendency-mcp](https://github.com/daipendency/daipendency-mcp)** - ⭐ 59
   Model Context Protocol server for Daipendency

1589. **[rember-mcp](https://github.com/rember/rember-mcp)** - ⭐ 59
   A Model Context Protocol (MCP) server for Rember.

1590. **[mcp_zoomeye](https://github.com/zoomeye-ai/mcp_zoomeye)** - ⭐ 59
   A Model Context Protocol server that provides network asset information based on query conditions. This server allows LLMs to obtain network asset information and supports querying network asset information by zoomeye dork etc.

1591. **[mcp-hetzner](https://github.com/dkruyt/mcp-hetzner)** - ⭐ 59
   A Model Context Protocol (MCP) server for interacting with the Hetzner Cloud API. This server allows language models to manage Hetzner Cloud resources through structured functions.

1592. **[tiny-mcp](https://github.com/wdndev/tiny-mcp)** - ⭐ 59
   Python 实现 MCP client / service

1593. **[yamcp](https://github.com/hamidra/yamcp)** - ⭐ 59
   Organize your MCP servers in local workspaces, share them as Yet-Another-MCP through a single command

1594. **[turbomcp](https://github.com/Epistates/turbomcp)** - ⭐ 59
   A full featured, enterprise grade rust MCP SDK

1595. **[ynab-mcp-server](https://github.com/calebl/ynab-mcp-server)** - ⭐ 59
   Model Context Protocol for YNAB (you need a budget)

1596. **[mcp-hub](https://github.com/lobstercare/mcp-hub)** - ⭐ 58
   A curated list of awesome Model Context Protocol (MCP) servers.

1597. **[mcp-server-axiom](https://github.com/axiomhq/mcp-server-axiom)** - ⭐ 58
   Axiom Model Context Protocol Server

1598. **[junos-mcp-server](https://github.com/Juniper/junos-mcp-server)** - ⭐ 58
...
1599. **[mcp-wolframalpha](https://github.com/akalaric/mcp-wolframalpha)** - ⭐ 58
   A Python-powered Model Context Protocol MCP server and client that uses Wolfram Alpha via API.

1600. **[smart-pet-with-mcp](https://github.com/shijianzhong/smart-pet-with-mcp)** - ⭐ 58
   一个桌宠形式的mcp client，可以对接任意mcp server,配合测试的mcp server 开源地址：https://github.com/shijianzhong/mcp-server-for-pc

1601. **[baml-agents](https://github.com/Elijas/baml-agents)** - ⭐ 58
   Building Agents with LLM structured generation (BAML), MCP Tools, and 12-Factor Agents principles

1602. **[mcp-gemini-search](https://github.com/arjunprabhulal/mcp-gemini-search)** - ⭐ 57
   Model Context Protocol (MCP) with Gemini 2.5 Pro. Convert conversational queries into flight searches using Gemini's function calling capabilities and MCP's flight search tools

1603. **[chess-mcp](https://github.com/pab1it0/chess-mcp)** - ⭐ 57
   A Model Context Protocol server for Chess.com's Published Data API.  This provides access to Chess.com player data, game records, and other public information through standardized MCP interfaces, allowing AI assistants to search and analyze chess information.

1604. **[create-mcp-app](https://github.com/boguan/create-mcp-app)** - ⭐ 57
   A CLI tool for quickly scaffolding Model Context Protocol (MCP) server applications with TypeScript support and modern development tooling

1605. **[mobile-mcp](https://github.com/runablehq/mobile-mcp)** - ⭐ 57
   A Model Context Protocol (MCP) server that provides mobile automation capabilities.

1606. **[metis-router](https://github.com/metis-mantis/metis-router)** - ⭐ 57
   MCP router and Web Based MCP client

1607. **[quick-mcp-example](https://github.com/ALucek/quick-mcp-example)** - ⭐ 57
   Short and sweet example MCP server / client implementation for Tools, Resources and Prompts.

1608. **[mcp-clojure-sdk](https://github.com/unravel-team/mcp-clojure-sdk)** - ⭐ 57
   A Clojure SDK to create MCP servers (and eventually clients)

1609. **[ipybox](https://github.com/gradion-ai/ipybox)** - ⭐ 57
   Python code sandbox with programmatic MCP tool calling for AI agents

1610. **[mcp-think-tank](https://github.com/flight505/mcp-think-tank)** - ⭐ 56
...
1611. **[AllVoiceLab-MCP](https://github.com/allvoicelab/AllVoiceLab-MCP)** - ⭐ 56
...
1612. **[nutrient-document-engine-mcp-server](https://github.com/PSPDFKit/nutrient-document-engine-mcp-server)** - ⭐ 56
   A Model Context Protocol (MCP) server implementation exposes document processing capabilities through natural language, supporting both direct human interaction and AI agent tool calling.

1613. **[mcp-servers](https://github.com/pulsemcp/mcp-servers)** - ⭐ 56
   MCP (Model Context Protocol) Servers authored and maintained by the PulseMCP team. We build reliable servers thoughtfully designed specifically for MCP Client-powered workflows.

1614. **[mcp_newsnow](https://github.com/sligter/mcp_newsnow)** - ⭐ 56
   一个基于 Model Context Protocol (MCP) 的新闻聚合服务器，通过 Newsnow API 提供多平台热点新闻和趋势话题。

1615. **[mcp-gopls](https://github.com/hloiseau/mcp-gopls)** - ⭐ 56
   Model Context Protocol (MCP) server for Go using gopls – LSP-powered analysis, tests, coverage, and tooling.

1616. **[ncp](https://github.com/portel-dev/ncp)** - ⭐ 56
...
1617. **[umbraco-mcp](https://github.com/Matthew-Wise/umbraco-mcp)** - ⭐ 55
   A model context protocol  (MCP) server for Umbraco 

1618. **[mkp](https://github.com/StacklokLabs/mkp)** - ⭐ 55
   MKP is a Model Context Protocol (MCP) server for Kubernetes

1619. **[Unreal_mcp](https://github.com/ChiR24/Unreal_mcp)** - ⭐ 55
...
1620. **[mcp-thinking](https://github.com/mattzcarey/mcp-thinking)** - ⭐ 55
   thinking tool for claude desktop/mcp clients using Deepseek reasoner

1621. **[google_ads_mcp](https://github.com/google-marketing-solutions/google_ads_mcp)** - ⭐ 55
   The Google Ads MCP Server is an implementation of the Model Context Protocol (MCP) that enables Large Language Models (LLMs), such as Gemini, to interact directly with the Google Ads API.

1622. **[ashra-mcp](https://github.com/getrupt/ashra-mcp)** - ⭐ 54
   A Model Context Protocol server for Ashra

1623. **[openai-mcp-client](https://github.com/ResoluteError/openai-mcp-client)** - ⭐ 54
   A rudimentary implementation of Anthropic's Model Context Protocol with OpenAIs Model

1624. **[mcp-headless-gmail](https://github.com/baryhuang/mcp-headless-gmail)** - ⭐ 54
   A MCP (Model Context Protocol) server that provides get, send Gmails without local credential or token setup.

1625. **[mcp-manager](https://github.com/MediaPublishing/mcp-manager)** - ⭐ 54
   A web-based GUI tool for managing Model Context Protocol (MCP) servers in Claude and Cursor

1626. **[clarity-mcp-server](https://github.com/microsoft/clarity-mcp-server)** - ⭐ 54
   A Model Context Protocol (MCP) server for Microsoft Clarity

1627. **[xiaozhi-mcp-client](https://github.com/shadowcz007/xiaozhi-mcp-client)** - ⭐ 54
   可视化的配置和管理，给xiaozhi接入mcp

1628. **[Intelli](https://github.com/intelligentnode/Intelli)** - ⭐ 54
   Build multi-model chatbots and agents from intent.

1629. **[MySQL_MCP](https://github.com/guangxiangdebizi/MySQL_MCP)** - ⭐ 54
   这是一个功能强大且易用的MySQL数据库MCP（Model Context Protocol）服务器，让你的AI助手可以安全地进行完整的数据库操作，支持多数据库连接管理、增删改查、事务管理和智能回滚功能。

1630. **[EnergyPlus-MCP](https://github.com/LBNL-ETA/EnergyPlus-MCP)** - ⭐ 54
...
1631. **[appium-mcp](https://github.com/Rahulec08/appium-mcp)** - ⭐ 53
...
1632. **[mono-mcp](https://github.com/sin4ch/mono-mcp)** - ⭐ 53
   A comprehensive Model Context Protocol (MCP) server for Nigerian banking operations using the Mono Open Banking API.

1633. **[qu3-app](https://github.com/qu3ai/qu3-app)** - ⭐ 53
   Quantum-proof MCP Server and Client Interactions

1634. **[mcp-openai](https://github.com/S1M0N38/mcp-openai)** - ⭐ 53
   🔗 MCP Client with OpenAI compatible API

1635. **[NoLLMChat](https://github.com/zrg-team/NoLLMChat)** - ⭐ 53
...
1636. **[geoserver-mcp](https://github.com/mahdin75/geoserver-mcp)** - ⭐ 52
   A Model Context Protocol (MCP) server implementation that connects LLMs to the GeoServer REST API

1637. **[mcp-server-azure-ai-agents](https://github.com/farzad528/mcp-server-azure-ai-agents)** - ⭐ 52
   Model Context Protocol Servers for Azure AI Search

1638. **[gomcp](https://github.com/llmcontext/gomcp)** - ⭐ 52
   Unofficial Golang SDK for Anthropic Model Context Protocol

1639. **[nasdaq-data-link-mcp](https://github.com/stefanoamorelli/nasdaq-data-link-mcp)** - ⭐ 52
   A Nasdaq Data Link MCP (Model Context Protocol) Server

1640. **[mssql_mcp_server](https://github.com/JexinSam/mssql_mcp_server)** - ⭐ 52
   A Model Context Protocol (MCP) server facilitating secure interactions with MSSQL databases.

1641. **[client](https://github.com/php-mcp/client)** - ⭐ 52
   Core PHP implementation for the Model Context Protocol (MCP) Client

1642. **[cap-mcp-plugin](https://github.com/gavdilabs/cap-mcp-plugin)** - ⭐ 52
   MCP (Model Context Protocol) server plugin for CAP NodeJS

1643. **[mcp-cpp](https://github.com/Neumann-Labs/mcp-cpp)** - ⭐ 52
   A C++ SDK for the Model Context Protocol (MCP). The SDK will provide a framework for creating MCP servers and clients in C++.

1644. **[purple-mcp](https://github.com/Sentinel-One/purple-mcp)** - ⭐ 52
...
1645. **[ocaml-mcp](https://github.com/tmattio/ocaml-mcp)** - ⭐ 52
   OCaml implementation of the Model Context Protocol (MCP)

1646. **[awesome-remote-mcp-servers](https://github.com/sylviangth/awesome-remote-mcp-servers)** - ⭐ 52
   A curated list of Hosted & Managed Model Context Protocol (MCP) Servers accessible via a simple URL endpoint.

1647. **[gopher-mcp](https://github.com/GopherSecurity/gopher-mcp)** - ⭐ 52
   MCP C++ SDK - Model Context Protocol implementation in CPP with enterprise-grade security, visibility and connectivity.

1648. **[mcp-app-demo](https://github.com/pomerium/mcp-app-demo)** - ⭐ 52
...
1649. **[mcp-docs-service](https://github.com/alekspetrov/mcp-docs-service)** - ⭐ 51
   MCP Documentation Management Service - A Model Context Protocol implementation for documentation management

1650. **[erpnext-mcp-server](https://github.com/rakeshgangwar/erpnext-mcp-server)** - ⭐ 51
   Connect AI assistants to your ERPNext instance via the Model Context Protocol (MCP) using the official Frappe API.

1651. **[mcp-bridge-api](https://github.com/INQUIRELAB/mcp-bridge-api)** - ⭐ 51
...
1652. **[paper-search-mcp-nodejs](https://github.com/Dianel555/paper-search-mcp-nodejs)** - ⭐ 51
...
1653. **[mxcp](https://github.com/raw-labs/mxcp)** - ⭐ 51
   Model eXecution + Context Protocol: Enterprise-Grade Data-to-AI Infrastructure

1654. **[mcp-client](https://github.com/rakesh-eltropy/mcp-client)** - ⭐ 51

1655. **[mcp](https://github.com/twelvedata/mcp)** - ⭐ 51
...
1656. **[context-optimizer-mcp-server](https://github.com/malaksedarous/context-optimizer-mcp-server)** - ⭐ 50
   A Model Context Protocol (MCP) server that provides context optimization tools for AI coding assistants including GitHub Copilot, Cursor AI, Claude Desktop, and other MCP-compatible assistants enabling them to extract targeted information rather than processing large terminal outputs and files wasting their context.

1657. **[adx-mcp-server](https://github.com/pab1it0/adx-mcp-server)** - ⭐ 50
   A Model Context Protocol (MCP) server that enables AI assistants to query and analyze Azure Data Explorer databases through standardized interfaces.

1658. **[MCP4EDA](https://github.com/NellyW8/MCP4EDA)** - ⭐ 50
...
1659. **[vrchat-mcp](https://github.com/sawa-zen/vrchat-mcp)** - ⭐ 50
   This project is a Model Context Protocol (MCP) server for interacting with the VRChat API.

1660. **[mcp](https://github.com/abap-ai/mcp)** - ⭐ 50
   ABAP MCP - Model Context Protocol - Server SDK

1661. **[adk-mcp-a2a-crash-course](https://github.com/chongdashu/adk-mcp-a2a-crash-course)** - ⭐ 50
...
1662. **[podman-mcp-server](https://github.com/manusa/podman-mcp-server)** - ⭐ 50
   Model Context Protocol (MCP) server for container runtimes (Podman and Docker)

1663. **[fastmail-mcp](https://github.com/MadLlama25/fastmail-mcp)** - ⭐ 50
...
1664. **[joplin-mcp-server](https://github.com/dweigend/joplin-mcp-server)** - ⭐ 50
   A Model Context Protocol (MCP) Server for https://joplinapp.org/ that enables note access through the https://modelcontextprotocol.io. Perfect for integration with AI assistants like Claude.

1665. **[mcp-open-library](https://github.com/8enSmith/mcp-open-library)** - ⭐ 50
   A Model Context Protocol (MCP) server for the Internet Archive's Open Library API that enables AI assistants to search for book and author information.

1666. **[ibkr-mcp-server](https://github.com/seriallazer/ibkr-mcp-server)** - ⭐ 50
   MCP Server for IBKR Client

1667. **[mcp-guard](https://github.com/General-Analysis/mcp-guard)** - ⭐ 50
   MCP Guard secures your MCP client from prompt injection attacks and more.

1668. **[windbg-ext-mcp](https://github.com/NadavLor/windbg-ext-mcp)** - ⭐ 50
...
1669. **[bc-code-intelligence-mcp](https://github.com/JeremyVyska/bc-code-intelligence-mcp)** - ⭐ 50
...
1670. **[mcp-security-audit](https://github.com/qianniuspace/mcp-security-audit)** - ⭐ 49
   A powerful MCP (Model Context Protocol) Server that audits npm package dependencies for security vulnerabilities. Built with remote npm registry integration for real-time security checks.

1671. **[gomcp](https://github.com/localrivet/gomcp)** - ⭐ 49
...
1672. **[mcpo_docker_use](https://github.com/flyfox666/mcpo_docker_use)** - ⭐ 49
...
1673. **[bloodhound_mcp](https://github.com/mwnickerson/bloodhound_mcp)** - ⭐ 49
   A Model Context Protocol (MCP) server to converse with data in Bloodhound

1674. **[go-mcp-mysql](https://github.com/Zhwt/go-mcp-mysql)** - ⭐ 49
   Zero burden, ready-to-use Model Context Protocol (MCP) server for interacting with MySQL and automation. No Node.js or Python environment needed.

1675. **[freecad-mcp](https://github.com/contextform/freecad-mcp)** - ⭐ 49
   FreeCAD MCP - Open-source Model Context Protocol server for FreeCAD automation

1676. **[create-mcp](https://github.com/zueai/create-mcp)** - ⭐ 49
...
1679. **[trpc-mcp-go](https://github.com/trpc-group/trpc-mcp-go)** - ⭐ 48
   Go implementation of the Model Context Protocol (MCP) with comprehensive Streamable HTTP, STDIO, and SSE support. 

1680. **[oatpp-mcp](https://github.com/oatpp/oatpp-mcp)** - ⭐ 48
   Anthropic’s Model Context Protocol implementation for Oat++

1681. **[anysite-mcp-server](https://github.com/anysiteio/anysite-mcp-server)** - ⭐ 48
   A Model Context Protocol (MCP) server that provides comprehensive access to LinkedIn data and functionalities using the Anysite API, enabling not only data retrieval but also robust management of user accounts.

1682. **[mcp](https://github.com/goplus/mcp)** - ⭐ 48
...
1683. **[mcp-mermaid-validator](https://github.com/rtuin/mcp-mermaid-validator)** - ⭐ 48
   A Model Context Protocol server that validates and renders Mermaid diagrams.

1684. **[stackoverflow-mcp](https://github.com/gscalzo/stackoverflow-mcp)** - ⭐ 48
   A Model Context Protocol server for querying Stack Overflow to help AI models find programming solutions

1685. **[mcp-auth-proxy](https://github.com/sigbit/mcp-auth-proxy)** - ⭐ 48
   MCP Auth Proxy is a secure OAuth 2.1 authentication proxy for Model Context Protocol (MCP) servers

1686. **[auto-MCP-client](https://github.com/Chen-speculation/auto-MCP-client)** - ⭐ 48
...
1687. **[mcp-client-demo](https://github.com/KelvinQiu802/mcp-client-demo)** - ⭐ 48

1688. **[puremd-mcp](https://github.com/puremd/puremd-mcp)** - ⭐ 48
   Unblock, scrape, and search tools for MCP clients

1689. **[ticktick-mcp-server](https://github.com/alexarevalo9/ticktick-mcp-server)** - ⭐ 48
   A Model Context Protocol (MCP) server designed to integrate with the TickTick task management platform, enabling intelligent context-aware task operations and automation.

1690. **[tripadvisor-mcp](https://github.com/pab1it0/tripadvisor-mcp)** - ⭐ 47
...
1691. **[model-context-protocol-rb](https://github.com/dickdavis/model-context-protocol-rb)** - ⭐ 47
   An implementation of the Model Context Protocol in Ruby.

1692. **[kuon](https://github.com/lissettecarlr/kuon)** - ⭐ 47
...
1693. **[scheduler-mcp](https://github.com/PhialsBasement/scheduler-mcp)** - ⭐ 47
...
1694. **[kroger-mcp](https://github.com/CupOfOwls/kroger-mcp)** - ⭐ 47
...
1695. **[1xn-vmcp](https://github.com/1xn-labs/1xn-vmcp)** - ⭐ 47
   vMCP - Virtual Model Context Protocol

1696. **[mcp-oauth-gateway](https://github.com/atrawog/mcp-oauth-gateway)** - ⭐ 47
...
1697. **[MediaWiki-MCP-Server](https://github.com/ProfessionalWiki/MediaWiki-MCP-Server)** - ⭐ 47
   Model Context Protocol (MCP) Server to connect your AI with any MediaWiki

1698. **[mcp-all-in-one](https://github.com/vtxf/mcp-all-in-one)** - ⭐ 47
...
1699. **[mcp_demo](https://github.com/Ming-jiayou/mcp_demo)** - ⭐ 47
   A simple example of building an MCP client using C#.

1700. **[rag-app-on-aws](https://github.com/genieincodebottle/rag-app-on-aws)** - ⭐ 47
...
1701. **[mcp-kubernetes](https://github.com/Azure/mcp-kubernetes)** - ⭐ 46
   A Model Context Protocol (MCP) server that enables AI assistants to interact with Kubernetes clusters. It serves as a bridge between AI tools (like Claude, Cursor, and GitHub Copilot) and Kubernetes

1702. **[mcp-server](https://github.com/inkdropapp/mcp-server)** - ⭐ 46
   Inkdrop Model Context Protocol Server

1703. **[mcp-openapi-schema](https://github.com/hannesj/mcp-openapi-schema)** - ⭐ 46
   OpenAPI Schema Model Context Protocol Server

1704. **[claude-mcp-setup](https://github.com/patruff/claude-mcp-setup)** - ⭐ 46
   Easy setup script for Anthropic Claude Model Context Protocol (MCP) servers on Windows

1705. **[langchain-mcp-client](https://github.com/guinacio/langchain-mcp-client)** - ⭐ 46
   This Streamlit application provides a user interface for connecting to MCP (Model Context Protocol) servers and interacting with them using different LLM providers (OpenAI, Anthropic, Google, Ollama).

1706. **[AI-Cursor-Scraping-Assistant](https://github.com/TheWebScrapingClub/AI-Cursor-Scraping-Assistant)** - ⭐ 46
...
1707. **[mcp-gearbox](https://github.com/rohitsoni007/mcp-gearbox)** - ⭐ 46
   A modern desktop application for managing Model Context Protocol (MCP) servers across multiple AI agents

1708. **[APIWeaver](https://github.com/GongRzhe/APIWeaver)** - ⭐ 46
...
1709. **[ns-mcp-server](https://github.com/r-huijts/ns-mcp-server)** - ⭐ 46
   A Model Context Protocol (MCP) server that provides access to NS (Dutch Railways) travel information through Claude AI. This server enables Claude to fetch real-time train travel information and disruptions using the official Dutch NS API.

1710. **[mcp-swagger-server](https://github.com/zaizaizhao/mcp-swagger-server)** - ⭐ 46
   MCP Swagger Server 将任何符合 OpenAPI/Swagger 规范的 REST API 转换为 Model Context Protocol (MCP) 格式，让 AI 助手能够理解和调用您的 API。

1711. **[DecompilerServer](https://github.com/pardeike/DecompilerServer)** - ⭐ 46
...
1712. **[FreeCAD-MCP](https://github.com/ATOI-Ming/FreeCAD-MCP)** - ⭐ 46
...
1713. **[eliza-plugin-mcp](https://github.com/fleek-platform/eliza-plugin-mcp)** - ⭐ 46
   ElizaOS plugin allowing agents to connect to MCP servers

1714. **[vchart-mcp-server](https://github.com/VisActor/vchart-mcp-server)** - ⭐ 46
   A Model Context Protocol (MCP) server for the @visactor/vchart that enables AI assistants to generate interactive charts and visualizations.

1715. **[mcp-sdk](https://github.com/symfony/mcp-sdk)** - ⭐ 45
   Model Context Protocol SDK for Client and Server applications in PHP

1716. **[Homeassistant-server-mcp](https://github.com/hekmon8/Homeassistant-server-mcp)** - ⭐ 45
   A Model Context Protocol (MCP) server for interacting with Home Assistant. This server provides tools to control and monitor your Home Assistant devices through MCP-enabled applications.

1717. **[shadowgit-mcp](https://github.com/blade47/shadowgit-mcp)** - ⭐ 45
...
1718. **[go-mcp](https://github.com/MegaGrindStone/go-mcp)** - ⭐ 45
...
1719. **[Koppla](https://github.com/ruudmens/Koppla)** - ⭐ 45
   A Model-Context-Protocol (MCP) Server for Active Directory

1720. **[hackmd-mcp](https://github.com/yuna0x0/hackmd-mcp)** - ⭐ 45
   A Model Context Protocol server for integrating HackMD's note-taking platform with AI assistants.

1721. **[mcp-gitee](https://github.com/oschina/mcp-gitee)** - ⭐ 45
   mcp-gitee is a Model Context Protocol (MCP) server implementation for Gitee. It provides a set of tools that interact with Gitee's API, allowing AI assistants to manage repository, issues, pull requests, etc.

1722. **[mcp-made-simple](https://github.com/chongdashu/mcp-made-simple)** - ⭐ 45
   Model Context Protocol (MCP) Made Simple - Code for the tutorial series - focusing on practical ways to understand and use MCP

1723. **[mcp-server-synology](https://github.com/atom2ueki/mcp-server-synology)** - ⭐ 45
...
1724. **[mcp-things3](https://github.com/drjforrest/mcp-things3)** - ⭐ 45
...
1725. **[zendesk-mcp-server](https://github.com/reminia/zendesk-mcp-server)** - ⭐ 45
   A Model Context Protocol server for Zendesk

1726. **[ollama-mcp-bridge](https://github.com/jonigl/ollama-mcp-bridge)** - ⭐ 45
   Extend the Ollama API with dynamic AI tool integration from multiple MCP (Model Context Protocol) servers. Fully compatible, transparent, and developer-friendly, ideal for building powerful local LLM applications, AI agents, and custom chatbots

1727. **[Aspire.MCP.Sample](https://github.com/elbruno/Aspire.MCP.Sample)** - ⭐ 45
   Sample MCP Server and MCP client with Aspire

1728. **[Serper-search-mcp](https://github.com/NightTrek/Serper-search-mcp)** - ⭐ 45
   Un-official Serper Google search server for Cline and other MCP clients

1729. **[mcpcat-python-sdk](https://github.com/MCPCat/mcpcat-python-sdk)** - ⭐ 45
   MCPcat is an analytics platform for MCP server owners 🐱.

1730. **[mcp-rdf-explorer](https://github.com/emekaokoye/mcp-rdf-explorer)** - ⭐ 45
...
1731. **[mcp-lite-dev](https://github.com/datawhalechina/mcp-lite-dev)** - ⭐ 45
   共学《MCP极简开发》项目代码

1732. **[mcp-youtube](https://github.com/adhikasp/mcp-youtube)** - ⭐ 44
   Model Context Protocol to fetch youtube transcript

1733. **[flightradar24-mcp-server](https://github.com/sunsetcoder/flightradar24-mcp-server)** - ⭐ 44
   Model Context Protocol server for Flight Tracking

1734. **[vue-mcp-next](https://github.com/tuskermanshu/vue-mcp-next)** - ⭐ 44
...
1735. **[OneCite](https://github.com/HzaCode/OneCite)** - ⭐ 44
...
1736. **[calculator-mcp-server](https://github.com/huhabla/calculator-mcp-server)** - ⭐ 44
   A Model Context Protocol (MCP) server that provides Claude with advanced mathematical calculation capabilities

1737. **[mcp-starter-template](https://github.com/StevenStavrakis/mcp-starter-template)** - ⭐ 44
   An opinionated starter template for making Model Context Protocol (MCP) servers

1738. **[langchaingo-mcp-adapter](https://github.com/i2y/langchaingo-mcp-adapter)** - ⭐ 44
   A Go adapter that bridges LangChain Go tools with Model Context Protocol (MCP) servers.

1739. **[dramacraft](https://github.com/whatyun/dramacraft)** - ⭐ 44
   DramaCraft 是一个专业的短剧视频编辑 MCP (Model Context Protocol) 服务，集成国产中文大模型 API，实现剪映的智能自动化编辑功能。项目已完成从视频分析到草稿生成的完整解决方案

1740. **[wechat-mcp](https://github.com/JettChenT/wechat-mcp)** - ⭐ 44
   Model Context Protocol for WeChat

1741. **[codex-mcp-go](https://github.com/w31r4/codex-mcp-go)** - ⭐ 44
...
1742. **[mcp-server-kibana](https://github.com/TocharianOU/mcp-server-kibana)** - ⭐ 44
   MCP server for Kibana, Access search and manage Kibana in MCP Client.

1743. **[generic-mcp-client-chat](https://github.com/rom1504/generic-mcp-client-chat)** - ⭐ 44
   Generic MCP Client to use any MCP tool in a chat

1744. **[spring-ai-mcp-client](https://github.com/ogulcanarbc/spring-ai-mcp-client)** - ⭐ 44
...
1745. **[pprof-analyzer-mcp](https://github.com/ZephyrDeng/pprof-analyzer-mcp)** - ⭐ 44
   This is a Model Context Protocol (MCP) server implemented in Go, providing a tool to analyze Go pprof performance profiles.

1746. **[modular-mcp](https://github.com/d-kimuson/modular-mcp)** - ⭐ 44
   A Model Context Protocol (MCP) proxy server that enables efficient management of large tool collections across multiple MCP servers by grouping them and loading tool schemas on-demand.

1747. **[marinade-finance-mcp-server](https://github.com/lorine93s/marinade-finance-mcp-server)** - ⭐ 44
   Marinade Finance MCP Server is an MCP server specifically designed for the Marinade Finance.

1748. **[MCPP.Net](https://github.com/xuzeyu91/MCPP.Net)** - ⭐ 43
   Model Context Protocol Platform，统一管理你的MCP服务

1749. **[dataproduct-mcp](https://github.com/entropy-data/dataproduct-mcp)** - ⭐ 43
...
1750. **[thingspanel-mcp](https://github.com/ThingsPanel/thingspanel-mcp)** - ⭐ 43
...
1751. **[mcp-playground](https://github.com/Elkhn/mcp-playground)** - ⭐ 43
   A Streamlit-based chat app for LLMs with plug-and-play tool support via Model Context Protocol (MCP), powered by LangChain, LangGraph, and Docker.

1752. **[meme-mcp](https://github.com/haltakov/meme-mcp)** - ⭐ 43
   A simple Model Context Protocol (MCP) server for generating memes using the ImgFlip API

1753. **[Claude-Project-Coordinator](https://github.com/M-Pineapple/Claude-Project-Coordinator)** - ⭐ 43
...
1754. **[awesome-mcp-security](https://github.com/AIM-Intelligence/awesome-mcp-security)** - ⭐ 43
   Security Threats related with MCP (Model Context Protocol), MCP Servers and more

1755. **[taskMaster-todoist-mcp](https://github.com/mingolladaniele/taskMaster-todoist-mcp)** - ⭐ 43
...
1756. **[xiaohongshu-mcp-python](https://github.com/luyike221/xiaohongshu-mcp-python)** - ⭐ 43
...
1757. **[tuisic](https://github.com/Dark-Kernel/tuisic)** - ⭐ 43
...
1758. **[LLaMa-MCP-Streamlit](https://github.com/Nikunj2003/LLaMa-MCP-Streamlit)** - ⭐ 43
   AI assistant built with Streamlit, NVIDIA NIM (LLaMa 3.3:70B) / Ollama, and Model Control Protocol (MCP).

1759. **[solana-dev-mcp](https://github.com/solana-foundation/solana-dev-mcp)** - ⭐ 42
   Solana Model Context Protocol (MCP) Demo

1760. **[salesforce-mcp-server](https://github.com/kablewy/salesforce-mcp-server)** - ⭐ 42
   Model Context Protocol server for Salesforce REST API integration

1761. **[mcp-graphql-schema](https://github.com/hannesj/mcp-graphql-schema)** - ⭐ 42
   GraphQL Schema Model Context Protocol Server

1762. **[openrpc-mcp-server](https://github.com/shanejonas/openrpc-mcp-server)** - ⭐ 42
   A Model Context Protocol (MCP) server that provides JSON-RPC functionality through OpenRPC.

1763. **[awesome-mcp-servers](https://github.com/mctrinh/awesome-mcp-servers)** - ⭐ 42
   A curated list of excellent Model Context Protocol (MCP) servers.

1764. **[mcp-agents-hub](https://github.com/mcp-agents-ai/mcp-agents-hub)** - ⭐ 42
   The open-source ecosystem for building, discovering, and deploying Model Context Protocol servers and clients.

1765. **[MCP-Airflow-API](https://github.com/call518/MCP-Airflow-API)** - ⭐ 42
...
1766. **[mcp-openmsx](https://github.com/nataliapc/mcp-openmsx)** - ⭐ 42
...
1767. **[pdf-mcp](https://github.com/saury1120/pdf-mcp)** - ⭐ 42
   一个强大的 PDF 处理 MCP（Model Context Protocol）服务，提供全面的 PDF 文档分析功能

1768. **[python-notebook-mcp](https://github.com/UsamaK98/python-notebook-mcp)** - ⭐ 42
   Lightweight Python Notebook MCP - Enable AI assistants to create, edit, and view Jupyter notebooks via Model Context Protocol

1769. **[rhinoMcpServer](https://github.com/always-tinkering/rhinoMcpServer)** - ⭐ 42
...
1770. **[vercel-ai-docs-mcp](https://github.com/IvanAmador/vercel-ai-docs-mcp)** - ⭐ 42
   A Model Context Protocol (MCP) server that provides AI-powered search and querying capabilities for the Vercel AI SDK documentation. This project enables developers to ask questions about the Vercel AI SDK and receive accurate, contextualized responses based on the official documentation.

1771. **[mcp-amadeus](https://github.com/donghyun-chae/mcp-amadeus)** - ⭐ 42
   Amadeus MCP(Model Context Protocol) Server

1772. **[world_bank_mcp_server](https://github.com/anshumax/world_bank_mcp_server)** - ⭐ 42
   An implementation of the Model Context Protocol for the World Bank open data API

1773. **[mcp-servers-kagi](https://github.com/ac3xx/mcp-servers-kagi)** - ⭐ 42
   A Model Context Protocol server implementation for Kagi's API

1774. **[mcp-container-ts](https://github.com/Azure-Samples/mcp-container-ts)** - ⭐ 42
   This is a quick start guide that provides the basic building blocks to set up a remote Model Context Protocol (MCP) server using Azure Container Apps. The MCP server is built using Node.js and TypeScript, and it can be used to run various tools and services in a serverless environment.

1775. **[mcp-auth-servers](https://github.com/Azure-Samples/mcp-auth-servers)** - ⭐ 42
   🔒 Reference MCP servers that demo how authentication works with the current Model Context Protocol spec.

1776. **[esa-mcp-server](https://github.com/esaio/esa-mcp-server)** - ⭐ 42
   esa.io の公式 MCP(Model Context Protocol)サーバー(STDIO Transport版)

1777. **[abaqus-mcp-server](https://github.com/jianzhichun/abaqus-mcp-server)** - ⭐ 42
...
1778. **[excalidraw-mcp](https://github.com/i-tozer/excalidraw-mcp)** - ⭐ 42
   Model Context Protocol (MCP) server for Excalidraw - Work in Progress

1779. **[scaled-mcp](https://github.com/Traego/scaled-mcp)** - ⭐ 42
   ScaledMCP is a horizontally scalabled MCP and A2A Server. You know, for AI.

1780. **[mcp-server](https://github.com/profullstack/mcp-server)** - ⭐ 41
   A generic, modular server for implementing the Model Context Protocol (MCP). 

1781. **[MCPApp](https://github.com/tanaikech/MCPApp)** - ⭐ 41
   This text introduces the Model Context Protocol (MCP) for AI interaction, exploring Google Apps Script (GAS) as a server option. It shows feasibility with a sample but notes the lack of a GAS SDK, aiming to encourage understanding and development.

1782. **[mcp-server-js](https://github.com/yepcode/mcp-server-js)** - ⭐ 41
...
1788. **[mcp-ai-memory](https://github.com/scanadi/mcp-ai-memory)** - ⭐ 41
   A production-ready Model Context Protocol (MCP) server for semantic memory management

1789. **[mcp_server_filesystem](https://github.com/MarcusJellinghaus/mcp_server_filesystem)** - ⭐ 41
   MCP File System Server: A secure Model Context Protocol server that provides file operations for AI assistants. Enables Claude and other assistants to safely read, write, and list files in a designated project directory with robust path validation and security controls.

1790. **[devcontext](https://github.com/aiurda/devcontext)** - ⭐ 41
   DevContext is a cutting-edge Model Context Protocol (MCP) server designed to provide developers with continuous, project-centric context awareness. Unlike traditional context systems, DevContext continuously learns from and adapts to your development patterns and delivers highly relevant context providing a deeper understanding of your codebase.

1791. **[dify-mcp-server](https://github.com/AI-FE/dify-mcp-server)** - ⭐ 40
   A Model Context Protocol server for Dify

1792. **[mcp](https://github.com/Azure-Samples/mcp)** - ⭐ 40
...
1793. **[MCPollinations](https://github.com/pinkpixel-dev/MCPollinations)** - ⭐ 40
   A Model Context Protocol (MCP) server that enables AI assistants to generate images, text, and audio through the Pollinations APIs. Supports customizable parameters, image saving, and multiple model options.

1794. **[mcp_rails_template](https://github.com/seuros/mcp_rails_template)** - ⭐ 40
   A minimal Rails API template for creating MCP (Model Context Protocol) servers with robust tool execution capabilities and examples.

1795. **[agentic-mcp-client](https://github.com/peakmojo/agentic-mcp-client)** - ⭐ 40
   A standalone agent runner that executes tasks using MCP (Model Context Protocol) tools via Anthropic Claude, AWS BedRock and OpenAI APIs. It enables AI agents to run autonomously in cloud environments and interact with various systems securely.

1796. **[any2markdown](https://github.com/WW-AI-Lab/any2markdown)** - ⭐ 40
...
1797. **[gradle-mcp-server](https://github.com/IlyaGulya/gradle-mcp-server)** - ⭐ 40
   A Model Context Protocol (MCP) server to enable AI tools to interact with Gradle projects programmatically.

1798. **[nmap-mcp-server](https://github.com/PhialsBasement/nmap-mcp-server)** - ⭐ 40
   A Model Context Protocol (MCP) server that enables AI assistants to perform network scanning operations using NMAP

1799. **[contentful-mcp-server](https://github.com/contentful/contentful-mcp-server)** - ⭐ 40
   MCP (Model Context Protocol) server for the Contentful Management API

1800. **[caldav-mcp](https://github.com/dominik1001/caldav-mcp)** - ⭐ 40
   A CalDAV client using Model Context Protocol (MCP) to expose calendar operations as tools for AI assistants.

1801. **[mcp](https://github.com/getAlby/mcp)** - ⭐ 40
   Connect a bitcoin lightning wallet to your LLM using Nostr Wallet Connect and Model Context Protocol

1802. **[pagerduty-mcp-server](https://github.com/PagerDuty/pagerduty-mcp-server)** - ⭐ 40
   PagerDuty's official local MCP (Model Context Protocol) server which provides tools to interact with your PagerDuty account directly from your MCP-enabled client.

1803. **[mcp-victorialogs](https://github.com/VictoriaMetrics-Community/mcp-victorialogs)** - ⭐ 40
   The implementation of Model Context Protocol (MCP) server for VictoriaLogs.

1804. **[zig-mcp-server](https://github.com/openSVM/zig-mcp-server)** - ⭐ 40
   A Model Context Protocol (MCP) server that provides Zig language tooling, code analysis, and documentation access. This server enhances AI capabilities with Zig-specific functionality including code optimization, compute unit estimation, code generation, and best practices recommendations.

1805. **[bookstack-mcp-server](https://github.com/pnocera/bookstack-mcp-server)** - ⭐ 40
   A Model Context Protocol (MCP) server providing full access to BookStack's knowledge management capabilities

1806. **[kafka-mcp-server](https://github.com/tuannvm/kafka-mcp-server)** - ⭐ 40
   A Model Context Protocol (MCP) server for Apache Kafka implemented in Go, leveraging franz-go and mcp-go.

1807. **[repl-mcp](https://github.com/simm-is/repl-mcp)** - ⭐ 40
   Model Context Protocol Clojure support including REPL integration with development tools.

1808. **[mcp-filter](https://github.com/pro-vi/mcp-filter)** - ⭐ 40
   A proxy MCP (Model Context Protocol) server that filters the upstream tool surface to just the tools you need.

1809. **[instagram-engagement-mcp](https://github.com/Bob-lance/instagram-engagement-mcp)** - ⭐ 40
...
1810. **[semanticscholar-MCP-Server](https://github.com/JackKuo666/semanticscholar-MCP-Server)** - ⭐ 40
   🔍 This project implements a Model Context Protocol (MCP) server for interacting with the Semantic Scholar API. It provides tools for searching papers, retrieving paper and author details, and fetching citations and references.

1811. **[dotcom.chat](https://github.com/kamath/dotcom.chat)** - ⭐ 40
   A simple NextJS MCP client with sensible keybindings

1812. **[dynamic-shell-server](https://github.com/codelion/dynamic-shell-server)** - ⭐ 40
   Dynamic Shell Command MCP Server

1813. **[sharepoint-mcp](https://github.com/DEmodoriGatsuO/sharepoint-mcp)** - ⭐ 39
...
1814. **[mcp_code_analyzer](https://github.com/emiryasar/mcp_code_analyzer)** - ⭐ 39
   A Model Context Protocol (MCP) server implementation for comprehensive code analysis. This tool integrates with Claude Desktop to provide code analysis capabilities through natural language interactions.

1815. **[mcp-crypto-price](https://github.com/truss44/mcp-crypto-price)** - ⭐ 39
   A Model Context Protocol (MCP) server that provides real-time cryptocurrency analysis via CoinCap's API. Enables Claude and other MCP clients to fetch crypto prices, analyze market trends, and track historical data.

1816. **[osm-mcp](https://github.com/wiseman/osm-mcp)** - ⭐ 39
   Model Context Protocol server for OpenStreetMap data

1817. **[mailgun-mcp-server](https://github.com/mailgun/mailgun-mcp-server)** - ⭐ 39
   Implementation of Model Context Protocol server for Mailgun APIs

1818. **[mcp-shell](https://github.com/hdresearch/mcp-shell)** - ⭐ 39
   Execute a secure shell in Claude Desktop using the Model Context Protocol.

1819. **[autoteam](https://github.com/diazoxide/autoteam)** - ⭐ 39
   Orchestrate AI agents with YAML-driven workflows via universal Model Context Protocol (MCP)

1820. **[beanquery-mcp](https://github.com/vanto/beanquery-mcp)** - ⭐ 39
...
1821. **[mmcp](https://github.com/koki-develop/mmcp)** - ⭐ 39
   🛠️ Manage your MCP (Model Context Protocol) server definitions in one place and apply them to supported agents.

1822. **[canvas-mcp](https://github.com/vishalsachdev/canvas-mcp)** - ⭐ 39
   A Model Context Protocol server to run locally and connect to a Canvas LMS 

1823. **[youtrack-mcp](https://github.com/devstroop/youtrack-mcp)** - ⭐ 39
   An MCP (Model Context Protocol) server that provides YouTrack REST API access to AI agents

1824. **[beemcp](https://github.com/OkGoDoIt/beemcp)** - ⭐ 39
   BeeMCP: an unofficial Model Context Protocol (MCP) server that connects your Bee wearable lifelogger to AI via the Model Context Protocol

1825. **[rust-analyzer-mcp](https://github.com/zeenix/rust-analyzer-mcp)** - ⭐ 39
   A Model Context Protocol (MCP) server that provides integration with rust-analyzer

1826. **[vikunja-mcp](https://github.com/democratize-technology/vikunja-mcp)** - ⭐ 39
   Model Context Protocol server for Vikunja task management. Enables AI assistants to interact with Vikunja instances via MCP.

1827. **[quickbooks-online-mcp-server](https://github.com/intuit/quickbooks-online-mcp-server)** - ⭐ 39
...
1828. **[ai-humanizer-mcp-server](https://github.com/Text2Go/ai-humanizer-mcp-server)** - ⭐ 39
   A powerful Model Context Protocol (MCP) server that helps refine AI-generated content to sound more natural and human-like. Built with advanced AI detection and text enhancement capabilities.

1829. **[clinicaltrialsgov-mcp-server](https://github.com/cyanheads/clinicaltrialsgov-mcp-server)** - ⭐ 39
...
1830. **[mcp-codestyle-server](https://github.com/itxaiohanglover/mcp-codestyle-server)** - ⭐ 39
...
1831. **[mcp-desktop](https://github.com/http4k/mcp-desktop)** - ⭐ 39
   http4k MCP Desktop Client

1832. **[browser-use-mcp-client](https://github.com/Linzo99/browser-use-mcp-client)** - ⭐ 39
   A MCP client for browser-use

1833. **[mcp-zenml](https://github.com/zenml-io/mcp-zenml)** - ⭐ 39
   MCP server to connect an MCP client (Cursor, Claude Desktop etc) with your ZenML MLOps and LLMOps pipelines

1834. **[mcp-client-server-host-demo](https://github.com/danwritecode/mcp-client-server-host-demo)** - ⭐ 39
   A quick pokemon demo to showcase MCP server, client, and host

1835. **[vulnerable-mcp-servers-lab](https://github.com/appsecco/vulnerable-mcp-servers-lab)** - ⭐ 39
   A collection of servers which are deliberately vulnerable to learn Pentesting MCP Servers.

1836. **[algorand-mcp](https://github.com/GoPlausible/algorand-mcp)** - ⭐ 38
   Algorand Model Context Protocol (Server & Client)

1837. **[mcp](https://github.com/kyopark2014/mcp)** - ⭐ 38
   It shows how to use model-context-protocol. 

1838. **[middy-mcp](https://github.com/fredericbarthelet/middy-mcp)** - ⭐ 38
   Middy middleware for Model Context Protocol server hosting on AWS Lambda

1839. **[dev-to-mcp](https://github.com/nickytonline/dev-to-mcp)** - ⭐ 38
   A remote Model Context Protocol (MCP) server for interacting with the dev.to public API without requiring authentication.

1840. **[mcp-konnect](https://github.com/Kong/mcp-konnect)** - ⭐ 38
   A Model Context Protocol (MCP) server for interacting with Kong Konnect APIs, allowing AI assistants to query and analyze Kong Gateway configurations, traffic, and analytics.

1841. **[offeryn](https://github.com/avahowell/offeryn)** - ⭐ 38
   Build tools for LLMs in Rust using Model Context Protocol

1842. **[How-To-Create-MCP-Server](https://github.com/nisalgunawardhana/How-To-Create-MCP-Server)** - ⭐ 38
   This guide will help you set up a basic MCP (Model Context Protocol) server in .NET, configure it in VS Code, and interact with it using Copilot Chat.

1843. **[mcp-ssh](https://github.com/AiondaDotCom/mcp-ssh)** - ⭐ 38
   A Model Context Protocol (MCP) server for managing and controlling SSH connections.

1844. **[shotgrid-mcp-server](https://github.com/loonghao/shotgrid-mcp-server)** - ⭐ 38
   A Model Context Protocol (MCP) server for Autodesk ShotGrid/Flow Production Tracking (FPT) with comprehensive CRUD operations and data management capabilities.

1845. **[activitywatch-mcp-server](https://github.com/8bitgentleman/activitywatch-mcp-server)** - ⭐ 38
   Model Context Protocol server for ActivityWatch time tracking data

1846. **[mcp-logic](https://github.com/angrysky56/mcp-logic)** - ⭐ 38
...
1847. **[mcp-center](https://github.com/nautilus-ops/mcp-center)** - ⭐ 38
   A centralized platform for managing and connecting MCP servers. MCP Center provides a high-performance proxy service that enables seamless communication between MCP clients and multiple MCP servers.

1848. **[anki-mcp](https://github.com/nietus/anki-mcp)** - ⭐ 38
   MCP server for anki

1849. **[mcp-client-example](https://github.com/artemnovichkov/mcp-client-example)** - ⭐ 38
   Learn how to implement MCP client with SwiftUI and Anthropic API

1850. **[mcp-toolbox-sdk-go](https://github.com/googleapis/mcp-toolbox-sdk-go)** - ⭐ 38
   Go SDK for interacting with the MCP Toolbox for Databases.

1851. **[davinci-resolve-mcp](https://github.com/apvlv/davinci-resolve-mcp)** - ⭐ 37
   A Model Context Protocol (MCP) server for interacting with DaVinci Resolve and Fusion

1852. **[MCPToolBenchPP](https://github.com/mcp-tool-bench/MCPToolBenchPP)** - ⭐ 37
   MCPToolBench++ MCP Model Context Protocol Tool Use Benchmark on AI Agent and Model Tool Use Ability

1853. **[youtrack-mcp](https://github.com/itsalfredakku/youtrack-mcp)** - ⭐ 37
   An MCP (Model Context Protocol) server that provides YouTrack REST API access to AI agents

1854. **[ContextPods](https://github.com/conorluddy/ContextPods)** - ⭐ 37
   Model Context Protocol management suite/factory. An MCP that can generate and manage other local MCPs in multiple languages. Uses the official SDKs for code gen.

1855. **[mcp-server-leetcode](https://github.com/doggybee/mcp-server-leetcode)** - ⭐ 37
...
1856. **[okta-mcp-server](https://github.com/fctr-id/okta-mcp-server)** - ⭐ 37
   The Okta MCP Server is a groundbreaking tool built by the team at Fctr that enables AI models to interact directly with your Okta environment using the Model Context Protocol (MCP). Built specifically for IAM engineers, security teams, and Okta administrators, it implements the MCP specification to help work with Okta enitities

1857. **[attio-mcp-server](https://github.com/kesslerio/attio-mcp-server)** - ⭐ 37
   Attio Model Context Protocol (MCP) server implementation

1858. **[Claude-Deep-Research](https://github.com/mcherukara/Claude-Deep-Research)** - ⭐ 37
   An MCP (Model Context Protocol) server that enables comprehensive research capabilities for Claude

1859. **[mcp-sitecore-server](https://github.com/Antonytm/mcp-sitecore-server)** - ⭐ 37
   Model Context Protocol server for Sitecore

1860. **[McpDotNet.Extensions.SemanticKernel](https://github.com/StefH/McpDotNet.Extensions.SemanticKernel)** - ⭐ 37
   Microsoft SemanticKernel integration for the Model Context Protocol (MCP). Enables seamless use of MCP tools as AI functions.

1861. **[shodan-mcp-server](https://github.com/Cyreslab-AI/shodan-mcp-server)** - ⭐ 37
   A Model Context Protocol server that provides access to Shodan API functionality

1862. **[mealie-mcp-server](https://github.com/rldiao/mealie-mcp-server)** - ⭐ 37
   MCP server that exposes Mealie APIs to MCP clients such as Claude Desktop

1863. **[solscan-mcp](https://github.com/wowinter13/solscan-mcp)** - ⭐ 37
   An MCP server for querying Solana transactions using natural language with Solscan API

1864. **[openrouter-deep-research-mcp](https://github.com/wheattoast11/openrouter-deep-research-mcp)** - ⭐ 37
...
1865. **[DeepCo](https://github.com/succlz123/DeepCo)** - ⭐ 37
   A Chat Client for LLMs, written in Compose Multiplatform.

1866. **[openai-mcp](https://github.com/arthurcolle/openai-mcp)** - ⭐ 36
   OpenAI Code Assistant Model Context Protocol (MCP) Server

1867. **[mcp-flight-search](https://github.com/arjunprabhulal/mcp-flight-search)** - ⭐ 36
   MCP Server implementation for the Model Context Protocol (MCP) enabling AI tool usage - Realtime Flight Search 

1868. **[mcp-go](https://github.com/riza-io/mcp-go)** - ⭐ 36
   Build Model Context Protocol (MCP) servers in Go

1869. **[Mcp.Net](https://github.com/SamFold/Mcp.Net)** - ⭐ 36
   A fully featured C# implementation of Anthropic's Model Context Protocol (MCP)

1870. **[baseline-mcp-server](https://github.com/yamanoku/baseline-mcp-server)** - ⭐ 36
   特定のWeb APIに関するBaselineの状況を提供するModel Context Protocolサーバー

1871. **[example-mcp-server](https://github.com/kirill-markin/example-mcp-server)** - ⭐ 36
   A ready-to-use MCP (Model Context Protocol) server template for extending Cursor IDE with custom tools. Deploy your own server to Heroku with one click, create custom commands, and enhance your Cursor IDE experience. Perfect for developers who want to add their own tools and commands to Cursor IDE without complex setup.

1872. **[mcp-governance-sdk](https://github.com/ithena-one/mcp-governance-sdk)** - ⭐ 36
   Enterprise Governance Layer (Identity, RBAC, Credentials, Auditing, Logging, Tracing) for the Model Context Protocol SDK

1873. **[mcpmc](https://github.com/gerred/mcpmc)** - ⭐ 36
   Model Context Protocol Minecraft Server

1874. **[open-ghl-mcp](https://github.com/basicmachines-co/open-ghl-mcp)** - ⭐ 36
   An open source Model Context Protocol server for GoHighLevel API v2 with OAuth

1875. **[mcp-design-system-extractor](https://github.com/freema/mcp-design-system-extractor)** - ⭐ 36
   MCP (Model Context Protocol) server that enables AI assistants to interact with Storybook design systems. Extract component HTML, analyze styles, and help with design system adoption and refactoring.

1876. **[OmniMind](https://github.com/Techiral/OmniMind)** - ⭐ 36
...
1877. **[mcp-android-server-python](https://github.com/nim444/mcp-android-server-python)** - ⭐ 36
   MCP Android agent - This project provides an *MCP (Model Context Protocol)* server for automating Android devices using uiautomator2. It's designed to be easily plugged into AI agents like GitHub Copilot Chat, Claude, or Open Interpreter to control Android devices through natural language.

1878. **[mcp_weather_server](https://github.com/isdaniel/mcp_weather_server)** - ⭐ 36
   A Model Context Protocol (MCP) server that provides weather information using the Open-Meteo API.

1879. **[fast-filesystem-mcp](https://github.com/efforthye/fast-filesystem-mcp)** - ⭐ 36
   A high-performance Model Context Protocol (MCP) server that provides secure filesystem access for Claude and other AI assistants.

1880. **[webscraping-ai-mcp-server](https://github.com/webscraping-ai/webscraping-ai-mcp-server)** - ⭐ 36
    A Model Context Protocol (MCP) server implementation that integrates with WebScraping.AI for web data extraction capabilities.

1881. **[binance-mcp-server](https://github.com/AnalyticAce/binance-mcp-server)** - ⭐ 36
...
1882. **[bsky-mcp-server](https://github.com/brianellin/bsky-mcp-server)** - ⭐ 36
   Bluesky MCP (Model Context Protocol) Server

1883. **[nuclei-mcp](https://github.com/addcontent/nuclei-mcp)** - ⭐ 36
...
1884. **[flutter-mcp-ai-chat](https://github.com/leehack/flutter-mcp-ai-chat)** - ⭐ 36
   Demonstrate how to implement MCP Client in Flutter application with AI.

1885. **[mlb-api-mcp](https://github.com/guillochon/mlb-api-mcp)** - ⭐ 35
...
1886. **[mcp-server-ios-simulator](https://github.com/atom2ueki/mcp-server-ios-simulator)** - ⭐ 35
   Model Context Protocol (MCP) implementation for iOS simulators

1887. **[esa-mcp-server](https://github.com/d-kimuson/esa-mcp-server)** - ⭐ 35
   esa の Model Context Protocol サーバー実装

1888. **[matlab-mcp](https://github.com/Tsuchijo/matlab-mcp)** - ⭐ 35
   Model Context Protocol server to let LLMs write and execute matlab scripts 

1889. **[mcp-langchain-ts-client](https://github.com/isaacwasserman/mcp-langchain-ts-client)** - ⭐ 35
   LangChain.js client for Model Context Protocol.

1890. **[mcp-anywhere](https://github.com/locomotive-agency/mcp-anywhere)** - ⭐ 35
...
1891. **[mcp-local-rag](https://github.com/shinpr/mcp-local-rag)** - ⭐ 35
   Privacy-first local RAG server for Cursor, Claude Code, and more — powered by the Model Context Protocol.

1892. **[FastDomainCheck-MCP-Server](https://github.com/bingal/FastDomainCheck-MCP-Server)** - ⭐ 35
   A Model Context Protocol for checking domain name registration status in bulk.

1893. **[grafana-mcp-analyzer](https://github.com/SailingCoder/grafana-mcp-analyzer)** - ⭐ 35
   让AI助手直接分析你的Grafana监控数据 - A Model Context Protocol server for Grafana data analysis

1894. **[HAL](https://github.com/DeanWard/HAL)** - ⭐ 35
   HAL (HTTP API Layer) is a Model Context Protocol (MCP) server that provides HTTP API capabilities to Large Language Models.

1895. **[mcp-mistral-ocr](https://github.com/everaldo/mcp-mistral-ocr)** - ⭐ 35
   Model Context Protocol (MCP) Server for Mistral OCR API

1896. **[linkedin-mcp-server](https://github.com/Dishant27/linkedin-mcp-server)** - ⭐ 35
   Model Context Protocol (MCP) server for LinkedIn API integration

1897. **[mcp-pyautogui-server](https://github.com/hetaoBackend/mcp-pyautogui-server)** - ⭐ 35
   A MCP (Model Context Protocol) server that provides automated GUI testing and control capabilities through PyAutoGUI.

1898. **[mcp-gateway](https://github.com/theognis1002/mcp-gateway)** - ⭐ 35
...
1899. **[mcp-toolkit](https://github.com/metosin/mcp-toolkit)** - ⭐ 35
   a lib to build MCP clients and MCP servers in Clojure(script)

1900. **[RedBook-Search-Comment-MCP](https://github.com/chenningling/RedBook-Search-Comment-MCP)** - ⭐ 35
   这是一款基于 Playwright 开发的小红书自动搜索和评论工具，作为 MCP Server，可通过特定配置接入 MCP Client，帮助用户自动完成登录小红书、搜索关键词、获取笔记内容及发布智能评论等操作。

1901. **[keycloak-model-context-protocol](https://github.com/ChristophEnglisch/keycloak-model-context-protocol)** - ⭐ 34
...
1902. **[tomtom-mcp](https://github.com/tomtom-international/tomtom-mcp)** - ⭐ 34
   A Model Context Protocol (MCP) server providing TomTom's location services, search, routing, and traffic data to AI agents.

1903. **[mcp-file-context-server](https://github.com/bsmi021/mcp-file-context-server)** - ⭐ 34
   A Model Context Protocol (MCP) server that provides file system context to Large Language Models (LLMs). This server enables LLMs to read, search, and analyze code files with advanced caching and real-time file watching capabilities.

1904. **[code-mcp](https://github.com/54yyyu/code-mcp)** - ⭐ 34
...
1905. **[mcp-security-inspector](https://github.com/purpleroc/mcp-security-inspector)** - ⭐ 34
   一个用于检测Model Context Protocol (MCP)安全性的Chrome扩展工具。

1906. **[codebase-mcp](https://github.com/danyQe/codebase-mcp)** - ⭐ 34
...
1907. **[mcp-client-auth](https://github.com/dzhng/mcp-client-auth)** - ⭐ 34
...
1908. **[salesforce-mcp-server](https://github.com/jaworjar95/salesforce-mcp-server)** - ⭐ 34
   A comprehensive Model Context Protocol (MCP) server that provides seamless Salesforce integration for AI development tools like Claude Desktop, Cline, and other MCP-compatible clients.

1909. **[coin_api_mcp](https://github.com/longmans/coin_api_mcp)** - ⭐ 34
   A Model Context Protocol server that provides access to CoinMarketCap's cryptocurrency data. This server enables AI-powered applications to retrieve cryptocurrency listings, quotes, and detailed information about various coins.

1910. **[mcp-gemini-server](https://github.com/bsmi021/mcp-gemini-server)** - ⭐ 34
   This project provides a dedicated MCP (Model Context Protocol) server that wraps the @google/genai SDK. It exposes Google's Gemini model capabilities as standard MCP tools, allowing other LLMs (like Cline) or MCP-compatible systems to leverage Gemini's features as a backend workhorse.

1911. **[mcp-accessibility-scanner](https://github.com/JustasMonkev/mcp-accessibility-scanner)** - ⭐ 34
   An MCP (Model Context Protocol) server for performing accessibility audits on webpages using axe-core.

1912. **[codebadger](https://github.com/Lekssays/codebadger)** - ⭐ 34
...
1913. **[Readwise-Reader-MCP](https://github.com/edricgsh/Readwise-Reader-MCP)** - ⭐ 34
   A Model Context Protocol (MCP) server for the Readwise Reader API, built with TypeScript and the official Claude SDK.

1914. **[adk-python-mcp-client](https://github.com/arjunprabhulal/adk-python-mcp-client)** - ⭐ 34
   Demo of ADK (Agent Development Kit) as an MCP (Model Context Protocol) client for flight search capabilities.

1915. **[godot-mcp](https://github.com/bradypp/godot-mcp)** - ⭐ 34
   A Model Context Protocol (MCP) server for interacting with the Godot game engine.

1916. **[ai-vision-mcp](https://github.com/tan-yong-sheng/ai-vision-mcp)** - ⭐ 34
   A Model Context Protocol (MCP) server that provides vision capabilities to analyze image and video

1917. **[MCPSwiftWrapper](https://github.com/jamesrochabrun/MCPSwiftWrapper)** - ⭐ 34
   A light wrapper around mcp-swift-sdk for easy usage of MCP clients in Swift

1918. **[smythos-studio](https://github.com/SmythOS/smythos-studio)** - ⭐ 34
...
1919. **[mcp-scala](https://github.com/windymelt/mcp-scala)** - ⭐ 33
   Model Context Protocol server written in Scala

1920. **[mcp-server-opendal](https://github.com/Xuanwo/mcp-server-opendal)** - ⭐ 33
   Model Context Protocol Server for Apache OpenDAL™

1921. **[prometheus_mcp_server](https://github.com/CaesarYangs/prometheus_mcp_server)** - ⭐ 33
...
1922. **[mcp-google-calendar](https://github.com/markelaugust74/mcp-google-calendar)** - ⭐ 33
...
1923. **[aio-mcp](https://github.com/athapong/aio-mcp)** - ⭐ 33
...
1924. **[postman-mcp](https://github.com/SalehKhatri/postman-mcp)** - ⭐ 33
...
1925. **[mcp-prompt-server-go](https://github.com/smallnest/mcp-prompt-server-go)** - ⭐ 33
...
1926. **[jina-mcp-tools](https://github.com/PsychArch/jina-mcp-tools)** - ⭐ 33
   A Model Context Protocol (MCP) server that integrates with Jina AI Search Foundation APIs.

1927. **[imap-mcp](https://github.com/non-dirty/imap-mcp)** - ⭐ 33
   IMAP Model Context Protocol server for interactive email processing

1928. **[a11y-mcp](https://github.com/priyankark/a11y-mcp)** - ⭐ 33
   An MCP (Model Context Protocol) server for performing accessibility audits on webpages using axe-core. Use the results in an agentic loop with your favorite AI assistants (Amp/Cline/Cursor/GH Copilot) and let them fix a11y issues for you!

1929. **[mcp-registry](https://github.com/ARadRareness/mcp-registry)** - ⭐ 33
   A central registry and HTTP interface for coordinating Model Context Protocol (MCP) servers.

1930. **[mcp-front](https://github.com/stainless-api/mcp-front)** - ⭐ 33
   Auth proxy for Model Context Protocol servers - adds authentication to MCP tools for Claude.ai, Claude Code, Cursor, Gemini

1931. **[Scientific-Papers-MCP](https://github.com/benedict2310/Scientific-Papers-MCP)** - ⭐ 33
...
1932. **[linkedin-mcpserver](https://github.com/felipfr/linkedin-mcpserver)** - ⭐ 33
   A powerful Model Context Protocol server for LinkedIn API integration

1933. **[metabase-mcp](https://github.com/jerichosequitin/metabase-mcp)** - ⭐ 33
...
1934. **[llm-tools-mcp](https://github.com/VirtusLab/llm-tools-mcp)** - ⭐ 33
   Connect to MCP servers right from your shell. Plugin for simonw/llm.

1935. **[MCP-Server-Creator](https://github.com/GongRzhe/MCP-Server-Creator)** - ⭐ 32
...
1936. **[mcp-nats](https://github.com/sinadarbouy/mcp-nats)** - ⭐ 32
   A Model Context Protocol (MCP) server for NATS messaging system integration

1937. **[MayaMCP](https://github.com/PatrickPalmer/MayaMCP)** - ⭐ 32
   Model Context Protocol (MCP) server implementation for Autodesk Maya

1938. **[zilliz-mcp-server](https://github.com/zilliztech/zilliz-mcp-server)** - ⭐ 32
...
1939. **[azure-functions-mcp-extension](https://github.com/Azure/azure-functions-mcp-extension)** - ⭐ 32
   Model Context Protocol extension for Azure Functions.

1940. **[Outlook_Calendar_MCP](https://github.com/merajmehrabi/Outlook_Calendar_MCP)** - ⭐ 32
   A Model Context Protocol (MCP) server that allows Claude to access and manage your local Microsfot Outlook calendar (Windows only).

1941. **[altium-mcp](https://github.com/coffeenmusic/altium-mcp)** - ⭐ 32
   Altium Model Context Protocol server and Altium API script

1942. **[McpToolkit](https://github.com/nuskey8/McpToolkit)** - ⭐ 32
   Lightweight, fast, NativeAOT compatible MCP (Model Context Protocol) framework for .NET

1943. **[mentor-mcp-server](https://github.com/cyanheads/mentor-mcp-server)** - ⭐ 32
...
1944. **[langfuse-mcp](https://github.com/avivsinai/langfuse-mcp)** - ⭐ 32
   A Model Context Protocol (MCP) server for Langfuse, enabling AI agents to query Langfuse trace data for enhanced debugging and observability

1945. **[mcp-bundle](https://github.com/symfony/mcp-bundle)** - ⭐ 32
   Symfony integration bundle for Model Context Protocol (via official mcp/sdk)

1946. **[mcp-api-gateway](https://github.com/rflpazini/mcp-api-gateway)** - ⭐ 32
   A universal MCP (Model Context Protocol) server to integrate any API with Claude Desktop using only Docker configurations.

1947. **[lunchmoney-mcp](https://github.com/akutishevsky/lunchmoney-mcp)** - ⭐ 32
...
1948. **[chat-nextjs-mcp-client](https://github.com/shricodev/chat-nextjs-mcp-client)** - ⭐ 32
   ⚡ Chat MCP Client for Remote hosted MCP Servers (with Composio) and locally hosted MCP servers. 📡

1949. **[laravel-mcp-client](https://github.com/scriptoshi/laravel-mcp-client)** - ⭐ 32

1950. **[meta-prompt-mcp-server](https://github.com/tisu19021997/meta-prompt-mcp-server)** - ⭐ 32
   Turn any MCP Client into a "multi-agent" system (via prompting)

1951. **[RiMCP_hybrid](https://github.com/h7lu/RiMCP_hybrid)** - ⭐ 32
   Rimworld Coding RAG MCP server

1952. **[PixVerse-MCP](https://github.com/PixVerseAI/PixVerse-MCP)** - ⭐ 31
   Official PixVerse Model Context Protocol (MCP) server that enables interaction with powerful AI video generation APIs.

1953. **[mcp-aoai-web-browsing](https://github.com/kimtth/mcp-aoai-web-browsing)** - ⭐ 31
   A minimal Model Context Protocol 🖥️ server/client🧑‍💻with Azure OpenAI and 🌐 web browser control via Playwright.

1954. **[mcp-server-weibo](https://github.com/Selenium39/mcp-server-weibo)** - ⭐ 31
   Model Context Protocol服务器，用于抓取微博用户信息、动态和搜索功能

1955. **[MCPDocSearch](https://github.com/alizdavoodi/MCPDocSearch)** - ⭐ 31
...
1956. **[crawl-mcp](https://github.com/wutongci/crawl-mcp)** - ⭐ 31
   完整的微信文章抓取MCP服务器 - 基于Model Context Protocol (MCP)的智能网页抓取工具，专为Cursor IDE和AI工具设计。

1957. **[simple-psql-mcp](https://github.com/NetanelBollag/simple-psql-mcp)** - ⭐ 31
...
1958. **[storyblok-mcp-server](https://github.com/Kiran1689/storyblok-mcp-server)** - ⭐ 31
...
1959. **[sunnysideFigma-Context-MCP](https://github.com/tercumantanumut/sunnysideFigma-Context-MCP)** - ⭐ 31
...
1960. **[PubChem-MCP-Server](https://github.com/Augmented-Nature/PubChem-MCP-Server)** - ⭐ 31
   A comprehensive Model Context Protocol (MCP) server for accessing the PubChem chemical database. This server provides access to over 110 million chemical compounds with extensive molecular properties, bioassay data, and chemical informatics tools.

1961. **[mcp-wikidata](https://github.com/zzaebok/mcp-wikidata)** - ⭐ 31
   A server implementation for Wikidata API using the Model Context Protocol (MCP).

1962. **[wezterm-mcp](https://github.com/hiraishikentaro/wezterm-mcp)** - ⭐ 31
   About A Model Context Protocol server that executes commands in the current WezTerm session

1963. **[MCPCorpus](https://github.com/Snakinya/MCPCorpus)** - ⭐ 31
...
1964. **[mcp-domain-availability](https://github.com/imprvhub/mcp-domain-availability)** - ⭐ 31
   A Model Context Protocol (MCP) server that enables Claude Desktop to check domain availability across 50+ TLDs. Features DNS/WHOIS verification, bulk checking, and smart suggestions. Zero-clone installation via uvx.

1965. **[mcp-databricks-server](https://github.com/RafaelCartenet/mcp-databricks-server)** - ⭐ 31
...
1966. **[claude-mcp](https://github.com/cnych/claude-mcp)** - ⭐ 31
   Claude Unified Model Context Interaction Protocol

1967. **[seatunnel-mcp](https://github.com/ocean-zhc/seatunnel-mcp)** - ⭐ 31
...
1968. **[mcp_server](https://github.com/peppemas/mcp_server)** - ⭐ 31
   A C++ implementation of a Model Context Protocol Server with a pluggable module architecture.

1969. **[agent-mcp-gateway](https://github.com/roddutra/agent-mcp-gateway)** - ⭐ 31
...
1970. **[tinyagent](https://github.com/askbudi/tinyagent)** - ⭐ 31
   Tiny Agent: Production-Ready LLM Agent SDK for Every Developer

1971. **[nostr-mcp-server](https://github.com/AustinKelsay/nostr-mcp-server)** - ⭐ 30
   A Model Context Protocol (MCP) server that provides Nostr capabilities to AI agents

1972. **[pan-mcp-relay](https://github.com/PaloAltoNetworks/pan-mcp-relay)** - ⭐ 30
   Palo Alto Networks AI Runtime Security Model Context Protocol (MCP) Relay Server

1973. **[chatwork-mcp-server](https://github.com/chatwork/chatwork-mcp-server)** - ⭐ 30
   ChatworkをAIから操作するためのMCP(Model Context Protocol)サーバー

1974. **[dev-kit](https://github.com/nguyenvanduocit/dev-kit)** - ⭐ 30
   [Model Context Protocol] Dev Kit - anything a developer need for him day to day works

1975. **[mcp-wasm](https://github.com/beekmarks/mcp-wasm)** - ⭐ 30
   A proof-of-concept implementation of a Model Context Protocol (MCP) server that runs in WebAssembly (WASM) within a web browser. This project demonstrates the integration of MCP tools and resources in a browser environment.

1976. **[mcp-weather](https://github.com/TimLukaHorstmann/mcp-weather)** - ⭐ 30
   A Model Context Protocol (MCP) server that provides hourly and daily weather forecasts using the AccuWeather API.

1977. **[mcp-hacker-news](https://github.com/paabloLC/mcp-hacker-news)** - ⭐ 30
...
1978. **[openbim-mcp](https://github.com/helenkwok/openbim-mcp)** - ⭐ 30
   Model Context Protocol (MCP) server for openBIM

1979. **[authenticator_mcp](https://github.com/firstorderai/authenticator_mcp)** - ⭐ 30
   A secure MCP (Model Context Protocol) server that enables AI agents to interact with the Authenticator App.

1980. **[mcpc](https://github.com/OlaHulleberg/mcpc)** - ⭐ 30
...
1981. **[Smart-Thinking](https://github.com/Leghis/Smart-Thinking)** - ⭐ 30
   Smart-Thinking is a Model Context Protocol (MCP) server that delivers graph-based, multi-step reasoning without relying on external AI APIs. Everything happens locally: similarity search, heuristic-based scoring, verification tracking, memory, and visualization all run in a deterministic pipeline designed for transparency and reproducibility.

1982. **[midi-mcp-server](https://github.com/tubone24/midi-mcp-server)** - ⭐ 30
...
1983. **[EU_AI_ACT_MCP](https://github.com/SonnyLabs/EU_AI_ACT_MCP)** - ⭐ 30
   EU AI Act MCP (Model Context Protocol) that connects to your AI agents, helping you to comply with the EU AI Act.

1984. **[mcp-server-lib.el](https://github.com/laurynas-biveinis/mcp-server-lib.el)** - ⭐ 30
   Emacs Lisp implementation of the Model Context Protocol

1985. **[AlphaFold-MCP-Server](https://github.com/Augmented-Nature/AlphaFold-MCP-Server)** - ⭐ 30
   A comprehensive Model Context Protocol (MCP) server that provides access to the AlphaFold Protein Structure Database through a rich set of tools and resources for protein structure prediction analysis.

1986. **[mcp-google-cse](https://github.com/Richard-Weiss/mcp-google-cse)** - ⭐ 30
   A Model Context Protocol server that provides search capabilities using a Google CSE (custom search engine).

1987. **[hana-mcp-server](https://github.com/HatriGt/hana-mcp-server)** - ⭐ 30
   Model Context Server Protocol for your HANA DB

1988. **[macOS-Notification-MCP](https://github.com/devizor/macOS-Notification-MCP)** - ⭐ 30
...
1989. **[clap-mcp](https://github.com/gakonst/clap-mcp)** - ⭐ 30
   A Rust framework that bridges clap command-line applications with the Model Context Protocol (MCP)

1990. **[org-mcp](https://github.com/laurynas-biveinis/org-mcp)** - ⭐ 30
   Emacs Org-mode integration with Model Context Protocol (MCP) for AI-assisted task management

1991. **[mcp-browser-agent](https://github.com/imprvhub/mcp-browser-agent)** - ⭐ 30
   A Model Context Protocol (MCP) integration that provides Claude Desktop with autonomous browser automation capabilities. This agent enables Claude to interact with web content, manipulate DOM elements, execute JavaScript, and perform API requests.

1992. **[PRD-MCP-Server](https://github.com/Saml1211/PRD-MCP-Server)** - ⭐ 30
   Flagship Model Context Protocol server for generating Product Requirement Documents (PRDs) from codebase context.

1993. **[discourse-mcp](https://github.com/discourse/discourse-mcp)** - ⭐ 30
   MCP client for Discourse sites

1994. **[demo-mcp-server-client-implementation](https://github.com/mschwarzmueller/demo-mcp-server-client-implementation)** - ⭐ 30
   A demo implementation of a MCP server (consuming a dummy API) and basic client.

1995. **[awesome-devops-mcp](https://github.com/agenticdevops/awesome-devops-mcp)** - ⭐ 30
   List of Awesome MCP Servers and Clients for building Agentic Devops 

1996. **[zerodha-mcp](https://github.com/mtwn105/zerodha-mcp)** - ⭐ 30
   Zerodha MCP Server & Client - AI Agent (w/Agno & w/Google ADK)

1997. **[mcp-ollama](https://github.com/emgeee/mcp-ollama)** - ⭐ 30
   Query model running with Ollama from within Claude Desktop or other MCP clients

1998. **[lets-learn-mcp-java](https://github.com/microsoft/lets-learn-mcp-java)** - ⭐ 30
   Learn how to build Java-based MCP Servers and Clients with LangChain4J and Quarkus

1999. **[mcp-client](https://github.com/edanyal/mcp-client)** - ⭐ 30
   Typescript mcp client library.

2000. **[azure-container-apps-ai-mcp](https://github.com/Azure-Samples/azure-container-apps-ai-mcp)** - ⭐ 30
...
2001. **[postmancer](https://github.com/hijaz/postmancer)** - ⭐ 30
   An experimental MCP server Rest Client intended to be a replacement of tools postman & insomnia

2002. **[MCP-Server-Starter](https://github.com/TheSethRose/MCP-Server-Starter)** - ⭐ 29
   A Model Context Protocol server starter template

2003. **[mcp-server-dumplingai](https://github.com/DumplingAI/mcp-server-dumplingai)** - ⭐ 29
   MCP (Model Context Protocol) server for Dumpling AI

2004. **[mcp-cyclops](https://github.com/cyclops-ui/mcp-cyclops)** - ⭐ 29
   Model Context Protocol server for Cyclops

2005. **[mcp-badges](https://github.com/mcpx-dev/mcp-badges)** - ⭐ 29
   Get your projects MCP (Model Context Protocol)  badges

2006. **[apisix-mcp](https://github.com/api7/apisix-mcp)** - ⭐ 29
   APISIX Model Context Protocol (MCP) server is used to bridge large language models (LLMs) with the APISIX Admin API.

2007. **[mcp-appium-gestures](https://github.com/AppiumTestDistribution/mcp-appium-gestures)** - ⭐ 29
   This is a Model Context Protocol (MCP) server providing resources and tools for Appium mobile gestures using Actions API..

2008. **[mcp-attr](https://github.com/frozenlib/mcp-attr)** - ⭐ 29
   A library for declaratively building Model Context Protocol servers.

2009. **[awesome-blockchain-mcps](https://github.com/royyannick/awesome-blockchain-mcps)** - ⭐ 29
...
2010. **[rails-pg-extras-mcp](https://github.com/pawurb/rails-pg-extras-mcp)** - ⭐ 29
   MCP (Model Context Protocol) LLM interface for rails-pg-extras gem

2011. **[maven-mcp-server](https://github.com/Bigsy/maven-mcp-server)** - ⭐ 29
   An MCP (Model Context Protocol) server that provides tools for checking Maven dependency versions.

2012. **[dap_mcp](https://github.com/KashunCheng/dap_mcp)** - ⭐ 29
   Model Context Protocol (MCP) server that interacts with a Debugger

2013. **[browserai-mcp](https://github.com/brightdata/browserai-mcp)** - ⭐ 29
   A powerful Model Context Protocol (MCP) server that provides an access to serverless browser for AI agents and apps

2014. **[mcp-googletasks](https://github.com/arpitbatra123/mcp-googletasks)** - ⭐ 29
...
2015. **[mcp-tool-filter](https://github.com/Portkey-AI/mcp-tool-filter)** - ⭐ 29
...
2016. **[mcp-sync](https://github.com/ztripez/mcp-sync)** - ⭐ 29
   Sync MCP (Model Context Protocol) configurations across AI tools

2017. **[nvim-mcp](https://github.com/linw1995/nvim-mcp)** - ⭐ 29
...
2018. **[reaper-reapy-mcp](https://github.com/wegitor/reaper-reapy-mcp)** - ⭐ 29
...
2019. **[reaper-mcp](https://github.com/itsuzef/reaper-mcp)** - ⭐ 29
   A comprehensive Model Context Protocol (MCP) server that enables AI agents to create fully mixed and mastered tracks in REAPER with both MIDI and audio capabilities.

2020. **[luke-desktop](https://github.com/DrJonBrock/luke-desktop)** - ⭐ 29
   A modern desktop client for Claude AI with MCP server support, built with Tauri, React, and TypeScript.

2021. **[mcp-inception](https://github.com/tanevanwifferen/mcp-inception)** - ⭐ 29
   Call another MCP client from your MCP client. Offload context windows, delegate tasks, split between models

2022. **[sketchfab-mcp-server](https://github.com/gregkop/sketchfab-mcp-server)** - ⭐ 28
   This is an MCP (Model Context Protocol) Server for discovering and downloading 3D models 

2023. **[mcp-testing-framework](https://github.com/L-Qun/mcp-testing-framework)** - ⭐ 28
   Testing framework for Model Context Protocol (MCP)

2024. **[laravel-mcp-sdk](https://github.com/mohamedahmed01/laravel-mcp-sdk)** - ⭐ 28
   Laravel Based Implementation for Model Context Protocol

2025. **[mcp-websocket](https://github.com/virajsharma2000/mcp-websocket)** - ⭐ 28
   This server implements an MCP (Model Context Protocol) server with WebSocket enhancements for real-time data updates.

2026. **[MCP-Scanner](https://github.com/knostic/MCP-Scanner)** - ⭐ 28
...
2027. **[mcp-server-weibo](https://github.com/qinyuanpei/mcp-server-weibo)** - ⭐ 28
   基于 Model Context Protocol 的微博数据接口服务器 - 实时获取微博用户信息、动态内容、热搜榜单、粉丝关注数据。支持用户搜索、内容搜索、话题分析，为 AI 应用提供完整的微博数据接入方案。

2028. **[mcp_autogen_sse_stdio](https://github.com/SaM-92/mcp_autogen_sse_stdio)** - ⭐ 28
   This repository demonstrates how to use AutoGen to integrate local and remote MCP (Model Context Protocol) servers. It showcases a local math tool (math_server.py) using Stdio and a remote Apify tool (RAG Web Browser Actor) via SSE for tasks like arithmetic and web browsing.

2029. **[mattermost-mcp-host](https://github.com/jagan-shanmugam/mattermost-mcp-host)** - ⭐ 28
   A Mattermost integration that connects to Model Context Protocol (MCP) servers, leveraging a LangGraph-based Agent.

2030. **[mcp](https://github.com/fastly/mcp)** - ⭐ 28
   Model Context Protocol (MCP) server for AI-powered Fastly CDN management.

2031. **[nchan-mcp-transport](https://github.com/ConechoAI/nchan-mcp-transport)** - ⭐ 28
...
2032. **[TAM-MCP-Server](https://github.com/gvaibhav/TAM-MCP-Server)** - ⭐ 28
...
2033. **[mcp-etherscan-server](https://github.com/crazyrabbitLTC/mcp-etherscan-server)** - ⭐ 28
   An MCP (Model Context Protocol) server that provides Ethereum blockchain data tools via Etherscan's API. Features include checking ETH balances, viewing transaction history, tracking ERC20 transfers, fetching contract ABIs, monitoring gas prices, and resolving ENS names.

2034. **[mcp-for-security-python](https://github.com/f1tz/mcp-for-security-python)** - ⭐ 28
...
2035. **[n8n-mcp](https://github.com/vredrick/n8n-mcp)** - ⭐ 28
   n8n MCP Server - Documentation and tools for n8n nodes via Model Context Protocol with SSE support

2036. **[supermcp](https://github.com/dhanababum/supermcp)** - ⭐ 28
...
2037. **[rod-mcp](https://github.com/go-rod/rod-mcp)** - ⭐ 28
   Model Context Protocol Server of Rod

2038. **[filesystem-mcp-server](https://github.com/cyanheads/filesystem-mcp-server)** - ⭐ 28
   A Model Context Protocol (MCP) server for platform-agnostic file capabilities, including advanced search/replace and directory tree traversal

2039. **[univer-mcp](https://github.com/dream-num/univer-mcp)** - ⭐ 28
   AI-powered spreadsheet automation through Model Context Protocol (MCP) server for Univer

2040. **[p4mcp-server](https://github.com/perforce/p4mcp-server)** - ⭐ 28
...
2041. **[NetContextServer](https://github.com/willibrandon/NetContextServer)** - ⭐ 28
   A .NET implementation of the Model Context Protocol enabling AI assistants to explore and understand .NET codebases.

2042. **[Volatility-MCP-Server](https://github.com/bornpresident/Volatility-MCP-Server)** - ⭐ 28
   A Model Context Protocol (MCP) server that integrates Volatility 3 memory forensics framework with Claude

2043. **[openai-mcp-agent-dotnet](https://github.com/Azure-Samples/openai-mcp-agent-dotnet)** - ⭐ 28
   Sample to create an AI Agent using OpenAI models with any MCP server running on Azure Container Apps

2044. **[phonepi-mcp](https://github.com/priyankark/phonepi-mcp)** - ⭐ 28
...
2045. **[YFinance-Trader-MCP-ClaudeDesktop](https://github.com/SaintDoresh/YFinance-Trader-MCP-ClaudeDesktop)** - ⭐ 27
   An MCP (Model Context Protocol) tool that provides stock market data and trading capabilities using the yfinance library, specifically adapted for Claude Desktop.

2046. **[vsc-mcp](https://github.com/thomasgazzoni/vsc-mcp)** - ⭐ 27
   This project provides tools that expose Language Server Protocol (LSP) functionality as MCP (Model Context Protocol) tools

2047. **[directus-mcp-server](https://github.com/rijkvanzanten/directus-mcp-server)** - ⭐ 27
   Model Context Protocol server for Directus

2048. **[asterisk-mcp-server](https://github.com/winfunc/asterisk-mcp-server)** - ⭐ 27
   Asterisk Model Context Protocol (MCP) server.

2049. **[biothings-mcp](https://github.com/longevity-genie/biothings-mcp)** - ⭐ 27
   MCP (Model Context Protocol) server for biothings

2050. **[Memgpt-MCP-Server](https://github.com/Vic563/Memgpt-MCP-Server)** - ⭐ 27
   A Model Context Protocol (MCP) server that provides persistent memory and multi-model LLM support.

2051. **[searxng-mcp](https://github.com/tisDDM/searxng-mcp)** - ⭐ 27
...
2052. **[excel-reader-mcp](https://github.com/ArchimedesCrypto/excel-reader-mcp)** - ⭐ 27
...
2053. **[notion-mcp](https://github.com/Badhansen/notion-mcp)** - ⭐ 27
   A simple Model Context Protocol (MCP) server that integrates with Notion's API to manage my personal todo list.

2054. **[keynote-mcp](https://github.com/easychen/keynote-mcp)** - ⭐ 27
   A Model Context Protocol (MCP) server that enables AI assistants to control Keynote presentations through AppleScript automation.

2055. **[aws-mcp](https://github.com/lokeswaran-aj/aws-mcp)** - ⭐ 27
   An MCP(Model Context Protocol) Server for AWS services

2056. **[mcp-ollama-agent](https://github.com/ausboss/mcp-ollama-agent)** - ⭐ 27
...
2057. **[claude-code-mcp](https://github.com/zebbern/claude-code-mcp)** - ⭐ 27
...
2058. **[actor-critic-thinking-mcp](https://github.com/aquarius-wing/actor-critic-thinking-mcp)** - ⭐ 27
   A dual-perspective thinking analysis server based on Model Context Protocol (MCP), providing comprehensive performance evaluation through Actor-Critic methodology.

2059. **[email-mcp](https://github.com/TimeCyber/email-mcp)** - ⭐ 27
   一个让AI轻松接管邮箱的MCP服务，基于 Model Context Protocol (MCP) 构建，支持在 MCP-X,Claude Desktop 等 MCP 客户端中使用。

2060. **[xmind-generator-mcp](https://github.com/BangyiZhang/xmind-generator-mcp)** - ⭐ 27
   An MCP (Model Context Protocol) server for generating Xmind mind maps. This server allows LLMs to create structured mind maps through the MCP protocol.

2061. **[adb-mcp](https://github.com/srmorete/adb-mcp)** - ⭐ 27
   An MCP (Model Context Protocol) server for interacting with Android devices through ADB in TypeScript.

2062. **[polymarket-mcp](https://github.com/ozgureyilmaz/polymarket-mcp)** - ⭐ 27
...
2063. **[framer-plugin-mcp](https://github.com/Sheshiyer/framer-plugin-mcp)** - ⭐ 27
   A Model Context Protocol (MCP) server for creating and managing Framer plugins with web3 capabilities

2064. **[mcpc](https://github.com/apify/mcpc)** - ⭐ 27
   Universal command-line client for the Model Context Protocol (MCP)

2065. **[mcp-tools](https://github.com/clerk/mcp-tools)** - ⭐ 27
   Tools for building modern & secure MCP integrations across the client and server side

2066. **[pentestMCP](https://github.com/ramkansal/pentestMCP)** - ⭐ 27
   pentestMCP: AI-Powered Penetration Testing via MCP, an MCP designed for penetration testers.

2067. **[mcp-proxy](https://github.com/stephenlacy/mcp-proxy)** - ⭐ 27
   Fast rust MCP proxy between stdio and SSE

2068. **[do-remote-mcp-server-template](https://github.com/do-community/do-remote-mcp-server-template)** - ⭐ 26
   A Model Context Protocol (MCP) server that checks domain name availability using WHOIS lookups and DNS resolution

2069. **[mcp-frontend-testing](https://github.com/StudentOfJS/mcp-frontend-testing)** - ⭐ 26
   Frontend testing tools for Model Context Protocol

2070. **[google-workspace-mcp-server](https://github.com/epaproditus/google-workspace-mcp-server)** - ⭐ 26
   A Model Context Protocol server for Google Workspace integration (Gmail and Calendar)

2071. **[pptx-xlsx-mcp](https://github.com/jenstangen1/pptx-xlsx-mcp)** - ⭐ 26
   Antrophics Model context protocol to edit powerpoint files

2072. **[mcp-web-browser](https://github.com/random-robbie/mcp-web-browser)** - ⭐ 26
   An advanced web browsing server for the Model Context Protocol (MCP) powered by Playwright, enabling headless browser interactions through a flexible, secure API.

2073. **[VercelGenUI_MCP](https://github.com/JamesSloan/VercelGenUI_MCP)** - ⭐ 26
   Proof of concept chat AI combining the Model Context Protocol (MCP) with Vercel's AI SDK UI

2074. **[minds-mcp](https://github.com/mindsdb/minds-mcp)** - ⭐ 26
...
2075. **[workflows-mcp-server](https://github.com/cyanheads/workflows-mcp-server)** - ⭐ 26
...
2076. **[openapi-mcp-generator](https://github.com/abutbul/openapi-mcp-generator)** - ⭐ 26
...
2077. **[mcp-server-giphy](https://github.com/magarcia/mcp-server-giphy)** - ⭐ 26
   An implementation of Giphy integration with Model Context Protocol

2078. **[nettune](https://github.com/jtsang4/nettune)** - ⭐ 26
...
2079. **[mcp-advisor](https://github.com/olaservo/mcp-advisor)** - ⭐ 26
   MCP Server to assist LLMs and humans on Model Context Protocol spec compliance and understanding

2080. **[mcp-bash](https://github.com/patrickomatik/mcp-bash)** - ⭐ 26
...
2081. **[postgres-mcp-server](https://github.com/ahmedmustahid/postgres-mcp-server)** - ⭐ 26
   MCP (Model Context Protocol) Server for postgres Database

2082. **[mcp-zero](https://github.com/zeromicro/mcp-zero)** - ⭐ 26
   Model Context Protocol (MCP) server for go-zero framework - Generate APIs, RPC services, and models with AI assistance.

2083. **[paraview_mcp](https://github.com/llnl/paraview_mcp)** - ⭐ 26
...
2084. **[Learn-Model-Context-Protocol-with-Python](https://github.com/PacktPublishing/Learn-Model-Context-Protocol-with-Python)** - ⭐ 26
   Learn Model Context Protocol with Python, published by Packt

2085. **[mcp-zap-server](https://github.com/dtkmn/mcp-zap-server)** - ⭐ 26
   A Spring Boot application exposing OWASP ZAP as an MCP (Model Context Protocol) server. It lets any MCP‑compatible AI agent (e.g., Claude Desktop, Cursor) orchestrate ZAP actions—spider, active scan, import OpenAPI specs, and generate reports.

2086. **[php-mcp](https://github.com/dtyq/php-mcp)** - ⭐ 26
...
2087. **[MCP-BOE](https://github.com/ComputingVictor/MCP-BOE)** - ⭐ 25
...
2088. **[alpaca-mcp-server](https://github.com/tedlikeskix/alpaca-mcp-server)** - ⭐ 25
   Model Context Protocol (MCP) server for Alpaca trading API

2089. **[gyazo-mcp-server](https://github.com/nota/gyazo-mcp-server)** - ⭐ 25
   Official Model Context Protocol server for Gyazo

2090. **[Healthcare-MCP](https://github.com/innovaccer/Healthcare-MCP)** - ⭐ 25
...
2091. **[semrush-mcp](https://github.com/mrkooblu/semrush-mcp)** - ⭐ 25
   A Model Context Protocol (MCP) server implementation that provides tools for accessing Semrush API data.

2092. **[mcp-php](https://github.com/garyblankenship/mcp-php)** - ⭐ 25
   model context protocol or mcp for php laravel

2093. **[mcp-writer-substack](https://github.com/jonathan-politzki/mcp-writer-substack)** - ⭐ 25
   Model Context Protocol to bridge in Substack writings to Claude.

2094. **[mcp-media-processor](https://github.com/maoxiaoke/mcp-media-processor)** - ⭐ 25
   A Node.js server implementing Model Context Protocol (MCP) for media processing operations, providing powerful video and image manipulation capabilities.

2095. **[systemprompt-mcp-notion](https://github.com/Ejb503/systemprompt-mcp-notion)** - ⭐ 25
...
2096. **[mcp-webdriveragent](https://github.com/AppiumTestDistribution/mcp-webdriveragent)** - ⭐ 25
   This is a Model Context Protocol (MCP) server that provides tools for building and signing WebDriverAgent for iOS.

2097. **[seo-insights-mcp-server](https://github.com/mrgoonie/seo-insights-mcp-server)** - ⭐ 25
...
2098. **[turn-based-game-mcp](https://github.com/github-samples/turn-based-game-mcp)** - ⭐ 25
...
2099. **[taiwan-holiday-mcp](https://github.com/lis186/taiwan-holiday-mcp)** - ⭐ 25
   一個基於 Model Context Protocol (MCP) 的台灣假期查詢伺服器，為 AI 工具提供準確的台灣國定假日資訊。

2100. **[alibabacloud-dataworks-mcp-server](https://github.com/aliyun/alibabacloud-dataworks-mcp-server)** - ⭐ 25
   A Model Context Protocol (MCP) server that provides tools for AI, allowing it to interact with the DataWorks Open API through a standardized interface. This implementation is based on the Aliyun Open API and enables AI agents to perform cloud resources operations seamlessly.

2101. **[mcp-manager](https://github.com/nstebbins/mcp-manager)** - ⭐ 25
   CLI tool for managing Model Context Protocol (MCP) servers in one place & using them across them different clients

2102. **[php-mcp-sdk](https://github.com/dalehurley/php-mcp-sdk)** - ⭐ 25
...
2103. **[taskflow-mcp](https://github.com/pinkpixel-dev/taskflow-mcp)** - ⭐ 25
   A task management Model Context Protocol (MCP) server that helps AI assistants break down user requests into manageable tasks with subtasks, dependencies, and notes. Enforces a structured workflow with user approval steps.

2104. **[symfony-mcp-server](https://github.com/klapaudius/symfony-mcp-server)** - ⭐ 25
   A Symfony package designed for building secure servers based on the Model Context Protocol, utilizing Server-Sent Events (SSE) and/or StreamableHTTP for real-time communication. It offers a scalable tool system tailored for enterprise-grade applications.

2105. **[Python-Runtime-Interpreter-MCP-Server](https://github.com/hileamlakB/Python-Runtime-Interpreter-MCP-Server)** - ⭐ 25
   PRIMS is a lightweight, open-source Model Context Protocol (MCP) server that lets LLM agents safely execute arbitrary Python code in a secure, throw-away sandbox.

2106. **[whistle-mcp](https://github.com/7gugu/whistle-mcp)** - ⭐ 25
...
2107. **[FalkorDB-MCPServer](https://github.com/FalkorDB/FalkorDB-MCPServer)** - ⭐ 25
   FalkorDB-MCPServer is an MCP (Model Context Protocol) server that connects LLMs to FalkorDB

2108. **[modao-proto-mcp](https://github.com/modao-dev/modao-proto-mcp)** - ⭐ 25
...
2109. **[dynamic-fastmcp](https://github.com/ragieai/dynamic-fastmcp)** - ⭐ 25
...
2110. **[datagouv-mcp](https://github.com/datagouv/datagouv-mcp)** - ⭐ 25
...
2111. **[ton-blockchain-mcp](https://github.com/devonmojito/ton-blockchain-mcp)** - ⭐ 25
   A Model Context Protocol (MCP) server written in Python for natural language interaction with the TON blockchain 💎

2112. **[ida-headless-mcp](https://github.com/zboralski/ida-headless-mcp)** - ⭐ 25
   Headless IDA Pro binary analysis via Model Context Protocol

2113. **[elysia-mcp](https://github.com/kerlos/elysia-mcp)** - ⭐ 25
   ElysiaJS plugin for Model Context Protocol with HTTP transport

2114. **[mcp-server-semgrep](https://github.com/VetCoders/mcp-server-semgrep)** - ⭐ 25
   MCP Server Semgrep is a [Model Context Protocol](https://modelcontextprotocol.io) compliant server that integrates the powerful Semgrep static analysis tool with AI assistants like Anthropic Claude. It enables advanced code analysis, security vulnerability detection, and code quality improvements directly through a conversational interface.

2115. **[mcp-structured-thinking](https://github.com/Promptly-Technologies-LLC/mcp-structured-thinking)** - ⭐ 25
...
2116. **[deep-research-mcp](https://github.com/pinkpixel-dev/deep-research-mcp)** - ⭐ 25
   A Model Context Protocol (MCP) compliant server designed for comprehensive web research. It uses Tavily's Search and Crawl APIs to gather detailed information on a given topic, then structures this data in a format perfect for LLMs to create high-quality markdown documents.

2117. **[WebSearch-MCP](https://github.com/mnhlt/WebSearch-MCP)** - ⭐ 25
...
2118. **[Unlock-your-agents-potential-with-Model-Context-Protocol-PostgreSQL-Workshop](https://github.com/gloveboxes/Unlock-your-agents-potential-with-Model-Context-Protocol-PostgreSQL-Workshop)** - ⭐ 24

2119. **[slack-mcp-server](https://github.com/AVIMBU/slack-mcp-server)** - ⭐ 24
   A Model Context Protocol Server for Interacting with Slack

2120. **[ccmcp](https://github.com/gsong/ccmcp)** - ⭐ 24
   A CLI tool that intelligently discovers, validates, and selects MCP (Model Context Protocol) server configurations for Claude Code.

2121. **[agent-hub-mcp](https://github.com/gilbarbara/agent-hub-mcp)** - ⭐ 24
   A Model Context Protocol (MCP) server that enables communication and coordination between multiple AI agents

2122. **[opnsense-mcp-server](https://github.com/floriangrousset/opnsense-mcp-server)** - ⭐ 24
...
2123. **[n8n-AI-agent-DVM-MCP-client](https://github.com/r0d8lsh0p/n8n-AI-agent-DVM-MCP-client)** - ⭐ 24
...
2124. **[puppeteer-mcp-claude](https://github.com/jaenster/puppeteer-mcp-claude)** - ⭐ 24
...
2125. **[mcp-server-semgrep](https://github.com/Szowesgad/mcp-server-semgrep)** - ⭐ 24
   MCP Server Semgrep is a [Model Context Protocol](https://modelcontextprotocol.io) compliant server that integrates the powerful Semgrep static analysis tool with AI assistants like Anthropic Claude. It enables advanced code analysis, security vulnerability detection, and code quality improvements directly through a conversational interface.

2126. **[nebulagraph-mcp-server](https://github.com/nebula-contrib/nebulagraph-mcp-server)** - ⭐ 24
   Model Context Protocol Server for NebulaGraph 3.x

2127. **[python-sequential-thinking-mcp](https://github.com/XD3an/python-sequential-thinking-mcp)** - ⭐ 24
...
2128. **[clay-mcp](https://github.com/clay-inc/clay-mcp)** - ⭐ 24
   A simple Model Context Protocol (MCP) server for Clay.

2129. **[MCP](https://github.com/EduBase/MCP)** - ⭐ 24
   The EduBase MCP server enables Claude and other LLMs to interact with EduBase's comprehensive e-learning platform through the Model Context Protocol (MCP).

2130. **[kaggle-mcp](https://github.com/54yyyu/kaggle-mcp)** - ⭐ 24
...
2131. **[google-search-console-mcp-server](https://github.com/Shin-sibainu/google-search-console-mcp-server)** - ⭐ 24
   Model Context Protocol server for Google Search Console API - integrate with Claude Code and Claude Desktop

2132. **[vision-one-mcp-server](https://github.com/trendmicro/vision-one-mcp-server)** - ⭐ 24
...
2133. **[omop_mcp](https://github.com/OHNLP/omop_mcp)** - ⭐ 24
...
2134. **[mcp-task-manager-server](https://github.com/bsmi021/mcp-task-manager-server)** - ⭐ 24
   A local Model Context Protocol (MCP) server providing backend tools for client-driven project and task management using a SQLite database.

2135. **[brlaw_mcp_server](https://github.com/pdmtt/brlaw_mcp_server)** - ⭐ 24
   A MCP (Model Context Protocol) server for agent-driven research on Brazilian law using official sources

2136. **[DeepResearchMCP](https://github.com/ameeralns/DeepResearchMCP)** - ⭐ 24
...
2137. **[aistudio-mcp-server](https://github.com/eternnoir/aistudio-mcp-server)** - ⭐ 24
...
2138. **[MCPSecBench](https://github.com/AIS2Lab/MCPSecBench)** - ⭐ 24
   MCPSecBench: A Systematic Security Benchmark and Playground for Testing Model Context Protocols

2139. **[mcp-template-dotnet](https://github.com/NikiforovAll/mcp-template-dotnet)** - ⭐ 24
   This repository contains a template for creating a Model Context Protocol (MCP) applications in .NET.

2140. **[MCP-Developer-SubAgent](https://github.com/gensecaihq/MCP-Developer-SubAgent)** - ⭐ 24
...
2141. **[SUMO-MCP-Server](https://github.com/XRDS76354/SUMO-MCP-Server)** - ⭐ 24
...
2142. **[xhs-mcp](https://github.com/Algovate/xhs-mcp)** - ⭐ 24
   用于小红书（xiaohongshu.com）的 Model Context Protocol（MCP）服务器与 CLI 工具，支持登录、发布、搜索、推荐等自动化能力

2143. **[React-Native-MCP](https://github.com/MrNitro360/React-Native-MCP)** - ⭐ 24
...
2144. **[Model-Context-Protocol](https://github.com/Coding-Crashkurse/Model-Context-Protocol)** - ⭐ 23

2145. **[greptimedb-mcp-server](https://github.com/GreptimeTeam/greptimedb-mcp-server)** - ⭐ 23
   A Model Context Protocol (MCP) server for GreptimeDB

2146. **[mcp-server](https://github.com/blockscout/mcp-server)** - ⭐ 23
   Wraps Blockscout APIs and exposes blockchain data by Model Context Protocol

2147. **[jigsawstack-mcp-server](https://github.com/JigsawStack/jigsawstack-mcp-server)** - ⭐ 23
   Model Context Protocol Server that allows AI models to interact with JigsawStack models!

2148. **[freepik-mcp](https://github.com/freepik-company/freepik-mcp)** - ⭐ 23
   The Freepik enables popular agent Model Context Protocol (MCP) to integrate with Freepik APIs through function calling.

2149. **[metabase-mcp-server](https://github.com/hyeongjun-dev/metabase-mcp-server)** - ⭐ 23
   A Model Context Protocol server that integrates AI assistants with Metabase analytics platform

2150. **[calendar-mcp](https://github.com/deciduus/calendar-mcp)** - ⭐ 23
...
2151. **[cortex](https://github.com/FreePeak/cortex)** - ⭐ 23
...
2152. **[paraview_mcp](https://github.com/LLNL/paraview_mcp)** - ⭐ 23
   ParaView-MCP integrates multimodal LLMs with ParaView via Model Context Protocol, enabling natural language control of scientific visualizations. The agent observes the viewport for visual feedback, making complex visualization tool accessible to all users while providing intelligent automation for experts.

2153. **[bgg-mcp](https://github.com/kkjdaniel/bgg-mcp)** - ⭐ 23
   BGG MCP provides access to BoardGameGeek and a variety of board game related data through the Model Context Protocol. Enabling retrieval and filtering of board game data, user collections, and profiles.

2154. **[lineshopping-api-mcp](https://github.com/woraphol-j/lineshopping-api-mcp)** - ⭐ 23
...
2155. **[mcp_rss](https://github.com/buhe/mcp_rss)** - ⭐ 23
   MCP RSS is a Model Context Protocol (MCP) server for interacting with RSS feeds.

2156. **[home-assistant-mcp](https://github.com/hpohlmann/home-assistant-mcp)** - ⭐ 23
...
2157. **[mcp-twitter-server](https://github.com/crazyrabbitLTC/mcp-twitter-server)** - ⭐ 23
   Model Context Protocol Server for Accessing twitter

2158. **[fastify-mcp](https://github.com/haroldadmin/fastify-mcp)** - ⭐ 23
   A Fastify plugin to run Model Context Protocol (MCP) servers

2159. **[batchdata-mcp-real-estate](https://github.com/zellerhaus/batchdata-mcp-real-estate)** - ⭐ 23
...
2160. **[lua-resty-mcp](https://github.com/ufownl/lua-resty-mcp)** - ⭐ 23
   Model Context Protocol SDK implemented in Lua for OpenResty

2161. **[mcp-server-starter-ts](https://github.com/alexanderop/mcp-server-starter-ts)** - ⭐ 23
   A minimal TypeScript starter template for building Model Context Protocol (MCP) servers.

2162. **[strava-mcp](https://github.com/kw510/strava-mcp)** - ⭐ 23
...
2163. **[mcp-slicer](https://github.com/zhaoyouj/mcp-slicer)** - ⭐ 23
   A Model Context Protocol server for 3D Slicer integration

2164. **[powerplatform-mcp](https://github.com/michsob/powerplatform-mcp)** - ⭐ 23
   PowerPlatform Model Context Protocol server

2165. **[forgejo-mcp](https://github.com/goern/forgejo-mcp)** - ⭐ 23
...
2166. **[identity-spec](https://github.com/agntcy/identity-spec)** - ⭐ 23
   AGNTCY Identity allows to onboard, create and verify identities for Agents, Model Context Protocol (MCP) Servers and Multi-Agent Systems (MASs).

2167. **[embedded-debugger-mcp](https://github.com/Adancurusul/embedded-debugger-mcp)** - ⭐ 23
   A Model Context Protocol server for embedded debugging with probe-rs - supports ARM Cortex-M, RISC-V debugging via J-Link, ST-Link, and more

2168. **[enhanced-mcp-memory](https://github.com/cbunting99/enhanced-mcp-memory)** - ⭐ 23
   An enhanced MCP (Model Context Protocol) server for intelligent memory and task management, designed for AI assistants and development workflows. Features semantic search, automatic task extraction, knowledge graphs, and comprehensive project management.

2169. **[twenty-crm-mcp-server](https://github.com/mhenry3164/twenty-crm-mcp-server)** - ⭐ 23
...
2170. **[firefox-devtools-mcp](https://github.com/freema/firefox-devtools-mcp)** - ⭐ 23
   Model Context Protocol server for Firefox DevTools - enables AI assistants to inspect and control Firefox browser through the Remote Debugging Protocol

2171. **[nobitex-mcp-server](https://github.com/xmannii/nobitex-mcp-server)** - ⭐ 22
   a Model Context Protocol (MCP) server that provides access to cryptocurrency market data from the Nobitex API.

2172. **[mcp-ffmpeg-helper](https://github.com/sworddut/mcp-ffmpeg-helper)** - ⭐ 22
   一个基于 Model Context Protocol (MCP) 的 FFmpeg 辅助工具，提供视频处理功能。

2173. **[mcp-server-oracle](https://github.com/hdcola/mcp-server-oracle)** - ⭐ 22
   Model Context Protocol server to access oracle database

2174. **[lightdash-mcp-server](https://github.com/syucream/lightdash-mcp-server)** - ⭐ 22
   A MCP(Model Context Protocol) server that accesses to Lightdash

2175. **[mcp-pa-ai-agent](https://github.com/zhangzhongnan928/mcp-pa-ai-agent)** - ⭐ 22
   A personal assistant AI agent built with the Model Context Protocol (MCP)

2176. **[higress-ops-mcp-server](https://github.com/higress-group/higress-ops-mcp-server)** - ⭐ 22
   A Model Context Protocol (MCP) server implementation that enables comprehensive configuration and management of Higress.

2177. **[Elysia-mcp](https://github.com/keithagroves/Elysia-mcp)** - ⭐ 22
   Model Context Protocol (MCP) Server for Bun and Elysia

2178. **[mcp-flux-studio](https://github.com/jmanhype/mcp-flux-studio)** - ⭐ 22
   A Model Context Protocol server for Flux image generation, providing tools for image generation, manipulation, and control

2179. **[DANP-Engine](https://github.com/DANP-LABS/DANP-Engine)** - ⭐ 22
   A trusted AI Model Context Protocol (MCP) runtime for secure, decentralized AI tools and services.

2180. **[mcp-sse-authenticated-cloud-run](https://github.com/the-freetech-company/mcp-sse-authenticated-cloud-run)** - ⭐ 22
   Host an Model Context Protocol SSE deployment on Cloud Run, Authenticating with IAM.

2181. **[prometheus-mcp](https://github.com/idanfishman/prometheus-mcp)** - ⭐ 22
   A Model Context Protocol (MCP) server implementation that provides AI agents with programmatic access to Prometheus metrics via a unified interface.

2182. **[MobSF-MCP](https://github.com/il-il1/MobSF-MCP)** - ⭐ 22
   a Node.js-based Model Context Protocol implementation for MobSF

2183. **[async-mcp](https://github.com/v3g42/async-mcp)** - ⭐ 22
   A minimalistic async Rust implementation of the Model Context Protocol (MCP).

2184. **[mcpagentai](https://github.com/mcpagents-ai/mcpagentai)** - ⭐ 22
...
2185. **[aisdk-mcp-bridge](https://github.com/vrknetha/aisdk-mcp-bridge)** - ⭐ 22
...
2186. **[bzm-mcp](https://github.com/Blazemeter/bzm-mcp)** - ⭐ 22
...
2187. **[p5js-ai-editor](https://github.com/adilmoujahid/p5js-ai-editor)** - ⭐ 22
...
2188. **[meeting-mcp](https://github.com/Meeting-BaaS/meeting-mcp)** - ⭐ 22
   Model Context Protocol server for AI assistants to create meeting bots, search transcripts, and manage meeting recordings.

2189. **[cursor-db-mcp](https://github.com/jbdamask/cursor-db-mcp)** - ⭐ 22
   Model Context Protocol server for querying Cursor chat history

2190. **[RevitMCP](https://github.com/oakplank/RevitMCP)** - ⭐ 22
   model context protocol for Autodesk Revit

2191. **[github-repo-mcp](https://github.com/Ryan0204/github-repo-mcp)** - ⭐ 22
   Model Context Protocol server for Github Repo // Reading Github Repo

2192. **[mcp-caiyun-weather](https://github.com/caiyunapp/mcp-caiyun-weather)** - ⭐ 22
   A Model Context Protocol (MCP) server for Caiyun (ColorfulClouds) Weather.

2193. **[nestjs-mcp](https://github.com/bamada/nestjs-mcp)** - ⭐ 22
   NestJS module for seamless Model Context Protocol (MCP) server integration using decorators.

2194. **[openproject-mcp-server](https://github.com/AndyEverything/openproject-mcp-server)** - ⭐ 22
   A Model Context Protocol (MCP) server that provides seamless integration with OpenProject API v3.

2195. **[printify-mcp](https://github.com/TSavo/printify-mcp)** - ⭐ 22
   A Model Context Protocol (MCP) server for integrating AI assistants with Printify's print-on-demand platform

2196. **[silverbullet-mcp](https://github.com/Ahmad-A0/silverbullet-mcp)** - ⭐ 22
   A Model Context Protocol (MCP) server to interact with your SilverBullet notes and data.

2197. **[svgmaker-mcp](https://github.com/GenWaveLLC/svgmaker-mcp)** - ⭐ 22
...
2198. **[zillow-mcp-server](https://github.com/sap156/zillow-mcp-server)** - ⭐ 22
   Zillow MCP Server for real estate data access via the Model Context Protocol

2199. **[solana-mcp](https://github.com/tony-42069/solana-mcp)** - ⭐ 22
...
2203. **[cml-mcp](https://github.com/xorrkaz/cml-mcp)** - ⭐ 21
   A Model Context Protocol (MCP) Server for Cisco Modeling Labs (CML)

2204. **[mcpsharepoint](https://github.com/BrianCusack/mcpsharepoint)** - ⭐ 21
   Model Context Protocol server that provides access to Organisational SharePoint.

2205. **[dbt-docs-mcp](https://github.com/mattijsdp/dbt-docs-mcp)** - ⭐ 21
   MCP (model context protocol) server for interacting with dbt Docs

2206. **[command-executor-mcp-server](https://github.com/Sunwood-ai-labs/command-executor-mcp-server)** - ⭐ 21
   Model Context Protocol Server for Safely Executing Pre-approved Commands

2207. **[emqx-mcp-server](https://github.com/Benniu/emqx-mcp-server)** - ⭐ 21
   A Model Context Protocol (MCP) server implementation that provides EMQX MQTT broker interaction.

2208. **[mcp-claude-spotify](https://github.com/imprvhub/mcp-claude-spotify)** - ⭐ 21
   An integration that allows Claude Desktop to interact with Spotify using the Model Context Protocol (MCP).

2209. **[mcp-sentry](https://github.com/MCP-100/mcp-sentry)** - ⭐ 21
   A Model Context Protocol server for retrieving and analyzing issues from Sentry.io

2210. **[fastify-mcp-server](https://github.com/flaviodelgrosso/fastify-mcp-server)** - ⭐ 21
   Fastify plugin to easily spin up Model Context Protocol (MCP) HTTP servers

2211. **[mcp-korean-spell](https://github.com/winterjung/mcp-korean-spell)** - ⭐ 21
   MCP(Model Context Protocol) server designed for Korean spell checking

2212. **[DocsRay](https://github.com/MIMICLab/DocsRay)** - ⭐ 21
   Lightweight PDF Q&A tool powered by RAG (Retrieval-Augmented Generation) with MCP (Model Context Protocol) Support.

2213. **[MCPRules](https://github.com/bartwisch/MCPRules)** - ⭐ 21
...
2214. **[code-context-mcp](https://github.com/fkesheh/code-context-mcp)** - ⭐ 21
...
1. **[chatgpt-on-wechat](https://github.com/zhayujie/chatgpt-on-wechat)** - ⭐ 40,434
   基于大模型搭建的聊天机器人，同时支持 微信公众号、企业微信应用、飞书、钉钉 等接入，可选择ChatGPT/Claude/DeepSeek/文心一言/讯飞星火/通义千问/ Gemini/GLM-4/Kimi/LinkAI，能处理文本、语音和图片，访问操作系统和互联网，支持基于自有知识库进行定制企业智能客服。

2. **[agentscope](https://github.com/agentscope-ai/agentscope)** - ⭐ 15,151
   AgentScope: Agent-Oriented Programming for Building LLM Applications

3. **[bytebot](https://github.com/bytebot-ai/bytebot)** - ⭐ 10,131
   Bytebot is a self-hosted AI desktop agent that automates computer tasks through natural language commands, operating within a containerized Linux desktop environment.

4. **[valuecell](https://github.com/ValueCell-ai/valuecell)** - ⭐ 7,903
   ValueCell is a community-driven, multi-agent platform for financial applications.

5. **[deepchat](https://github.com/ThinkInAIXYZ/deepchat)** - ⭐ 5,285
   🐬DeepChat - A smart assistant that connects powerful AI to your personal world

6. **[ruoyi-ai](https://github.com/ageerle/ruoyi-ai)** - ⭐ 4,613
   RuoYi AI 是一个全栈式 AI 开发平台，旨在帮助开发者快速构建和部署个性化的 AI 应用。

7. **[koog](https://github.com/JetBrains/koog)** - ⭐ 3,589
...
10. **[supermemory-mcp](https://github.com/supermemoryai/supermemory-mcp)** - ⭐ 1,582
...
15. **[flow-like](https://github.com/TM9657/flow-like)** - ⭐ 552
   Flow-Like: Strongly Typed Enterprise Scale Workflows. Built for scalability, speed, seamless AI integration and rich customization.

16. **[voicemode](https://github.com/mbailey/voicemode)** - ⭐ 534
...
18. **[a2a-x402](https://github.com/google-agentic-commerce/a2a-x402)** - ⭐ 393
   The A2A x402 Extension brings cryptocurrency payments to the Agent-to-Agent (A2A) protocol, enabling agents to monetize their services through on-chain payments. This extension revives the spirit of HTTP 402 "Payment Required" for the decentralized agent ecosystem.

19. **[RetroMCP-Java](https://github.com/MCPHackers/RetroMCP-Java)** - ⭐ 329
   A rewrite of MCP to provide support for many versions of Minecraft which were never supported by original MCP

20. **[self-dify](https://github.com/datawhalechina/self-dify)** - ⭐ 261
...
31. **[awesome-netsuite-ai](https://github.com/michoelchaikin/awesome-netsuite-ai)** - ⭐ 22
...
1. **[n8n](https://github.com/n8n-io/n8n)** - ⭐ 166,534
   Fair-code workflow automation platform with native AI capabilities. Combine visual building with custom code, self-host or cloud, 400+ integrations.

2. **[kong](https://github.com/Kong/kong)** - ⭐ 42,474
   🦍 The Cloud-Native Gateway for APIs & AI

3. **[LocalAI](https://github.com/mudler/LocalAI)** - ⭐ 41,033
   :robot: The free, Open Source alternative to OpenAI, Claude and others. Self-hosted and local-first. Drop-in replacement for OpenAI,  running on consumer-grade hardware. No GPU required. Runs gguf, transformers, diffusers and many more. Features: Generate Text, MCP, Audio, Video, Images, Voice Cloning, Distributed, P2P and decentralized inference

4. **[FastGPT](https://github.com/labring/FastGPT)** - ⭐ 26,768
   FastGPT is a knowledge-based platform built on the LLMs, offers a comprehensive suite of out-of-the-box capabilities such as data processing, RAG retrieval, and visual AI workflow orchestration, letting you easily develop and deploy complex question-answering systems without the need for extensive setup or configuration.

5. **[kratos](https://github.com/go-kratos/kratos)** - ⭐ 25,298
   Your ultimate Go microservices framework for the cloud-native era.

6. **[excelize](https://github.com/qax-os/excelize)** - ⭐ 20,147
   Go language library for reading and writing Microsoft Excel™ (XLAM / XLSM / XLSX / XLTM / XLTX) spreadsheets

7. **[plate](https://github.com/udecode/plate)** - ⭐ 15,708
   Rich-text editor with AI, MCP, and shadcn/ui

8. **[AstrBot](https://github.com/AstrBotDevs/AstrBot)** - ⭐ 14,731
...
12. **[note-gen](https://github.com/codexu/note-gen)** - ⭐ 10,420
   A cross-platform Markdown AI note-taking software.

13. **[langchain4j](https://github.com/langchain4j/langchain4j)** - ⭐ 10,230
   LangChain4j is an open-source Java library that simplifies the integration of LLMs into Java applications through a unified API, providing access to popular LLMs and vector databases. It makes implementing RAG, tool calling (including support for MCP), and agents easy. LangChain4j integrates seamlessly with various enterprise Java frameworks.

14. **[astron-agent](https://github.com/iflytek/astron-agent)** - ⭐ 8,453
   Enterprise-grade, commercial-friendly agentic workflow platform for building next-generation SuperAgents.

15. **[OpenMetadata](https://github.com/open-metadata/OpenMetadata)** - ⭐ 8,335
   OpenMetadata is a unified metadata platform for data discovery, data observability, and data governance powered by a central metadata repository, in-depth column level lineage, and seamless team collaboration.

16. **[Upsonic](https://github.com/Upsonic/Upsonic)** - ⭐ 7,736
   Agent Framework For Fintech and Banks

17. **[lamda](https://github.com/firerpa/lamda)** - ⭐ 7,515
    The most powerful Android RPA agent framework, next generation of mobile automation robots.

18. **[53AIHub](https://github.com/53AI/53AIHub)** - ⭐ 6,707
...
19. **[adk-go](https://github.com/google/adk-go)** - ⭐ 6,552
   An open-source, code-first Go toolkit for building, evaluating, and deploying sophisticated AI agents with flexibility and control.

20. **[Viper](https://github.com/FunnyWolf/Viper)** - ⭐ 4,634
   Adversary simulation and Red teaming platform with AI

21. **[magic](https://github.com/dtyq/magic)** - ⭐ 4,428
   Super Magic. The first open-source all-in-one AI productivity platform (Generalist AI Agent + Workflow Engine + IM + Online collaborative office system)

22. **[ENScan_GO](https://github.com/wgpsec/ENScan_GO)** - ⭐ 4,145
...
24. **[ag2](https://github.com/ag2ai/ag2)** - ⭐ 4,013
   AG2 (formerly AutoGen): The Open-Source AgentOS. Join us at: https://discord.gg/sNGSwQME3x

25. **[Yuxi-Know](https://github.com/xerrors/Yuxi-Know)** - ⭐ 3,739
...
26. **[manifest](https://github.com/mnfst/manifest)** - ⭐ 3,251
...
28. **[semantic-router](https://github.com/vllm-project/semantic-router)** - ⭐ 2,629
   System Level Intelligent Router for Mixture-of-Models

29. **[ultracite](https://github.com/haydenbleasel/ultracite)** - ⭐ 2,501
   A highly opinionated, zero-configuration linter and formatter.

30. **[harbor](https://github.com/av/harbor)** - ⭐ 2,234
   Effortlessly run LLM backends, APIs, frontends, and services with one command.

31. **[amazon-q-developer-cli](https://github.com/aws/amazon-q-developer-cli)** - ⭐ 1,864
   ✨ Agentic chat experience in your terminal. Build applications using natural language.

32. **[generative-ai](https://github.com/genieincodebottle/generative-ai)** - ⭐ 1,716
   Comprehensive resources on Generative AI, including a detailed roadmap, projects, use cases, interview preparation, and coding preparation.

33. **[MinecraftDev](https://github.com/minecraft-dev/MinecraftDev)** - ⭐ 1,694
   Plugin for IntelliJ IDEA that gives special support for Minecraft modding projects.

34. **[MultiAgentPPT](https://github.com/johnson7788/MultiAgentPPT)** - ⭐ 1,455
...
36. **[d2mcpp](https://github.com/mcpp-community/d2mcpp)** - ⭐ 1,384
...
38. **[NagaAgent](https://github.com/Xxiii8322766509/NagaAgent)** - ⭐ 1,284
   A simple yet powerful agent framework for personal assistants, designed to enable intelligent interaction, multi-agent collaboration, and seamless tool integration.

39. **[awesome-hacking-lists](https://github.com/taielab/awesome-hacking-lists)** - ⭐ 1,259
   A curated collection of top-tier penetration testing tools and productivity utilities across multiple domains. Join us to explore, contribute, and enhance your hacking toolkit!

40. **[paperdebugger](https://github.com/PaperDebugger/paperdebugger)** - ⭐ 1,235
   A Plugin-Based Multi-Agent System for In-Editor Academic Writing, Review, and Editing

41. **[BuildingAI](https://github.com/BidingCC/BuildingAI)** - ⭐ 1,099
...
45. **[zen](https://github.com/sheshbabu/zen)** - ⭐ 998
   Selfhosted notes app. Single golang binary, notes stored as markdown within SQLite, full-text search, very low resource usage

46. **[AIPex](https://github.com/AIPexStudio/AIPex)** - ⭐ 981
...
48. **[open-trading-api](https://github.com/koreainvestment/open-trading-api)** - ⭐ 955
...
55. **[Sentient](https://github.com/existence-master/Sentient)** - ⭐ 651
...
57. **[cloudsword](https://github.com/wgpsec/cloudsword)** - ⭐ 580
   一款帮助云租户发现和测试云上风险、增强云上防护能力的综合性开源工具

58. **[WHartTest](https://github.com/MGdaasLab/WHartTest)** - ⭐ 514
...
60. **[AIWriteX](https://github.com/iniwap/AIWriteX)** - ⭐ 438
...
62. **[ai-code-helper](https://github.com/liyupi/ai-code-helper)** - ⭐ 409
...
63. **[IDA-NO-MCP](https://github.com/P4nda0s/IDA-NO-MCP)** - ⭐ 391
...
66. **[browser-operator-core](https://github.com/BrowserOperator/browser-operator-core)** - ⭐ 381
   Browser Operator - The AI browser with built in Multi-Agent platform! Open source alternative to ChatGPT Atlas, Perplexity Comet, Dia and Microsoft CoPilot Edge Browser

67. **[mcp-cn-a-stock](https://github.com/elsejj/mcp-cn-a-stock)** - ⭐ 380
   这是一个为大模型提供 A 股数据的的 MCP(Model Content Protocol) 服务。

68. **[azan-mcp](https://github.com/ahmedeltaher/azan-mcp)** - ⭐ 379
...
69. **[Adafruit-MCP23017-Arduino-Library](https://github.com/adafruit/Adafruit-MCP23017-Arduino-Library)** - ⭐ 376
...
74. **[UE5-MCP](https://github.com/VedantRGosavi/UE5-MCP)** - ⭐ 330
...
77. **[eechat](https://github.com/Lucassssss/eechat)** - ⭐ 318
...
80. **[amical](https://github.com/amicalhq/amical)** - ⭐ 296
   🎙️ AI Dictation App - Open Source and Local-first ⚡ Type 3x faster, no keyboard needed. 🆓 Powered by open source models, works offline, fast and accurate.

81. **[napi](https://github.com/nanoapi-io/napi)** - ⭐ 292
   Software architecture tooling for the AI age

82. **[bridle](https://github.com/neiii/bridle)** - ⭐ 272
   TUI / CLI config manager for agentic harnesses (Amp, Claude Code, Opencode, Goose)

83. **[building-an-agentic-system](https://github.com/gerred/building-an-agentic-system)** - ⭐ 269
   An in-depth book and reference on building agentic systems like Claude Code

84. **[edumcp](https://github.com/aieducations/edumcp)** - ⭐ 265
   EDUMCP is a protocol that integrates the Model Context Protocol (MCP) with applications in the education field, dedicated to achieving seamless interconnection and interoperability among different AI models, educational applications, smart hardware, and teaching AGENTs.

85. **[MCPDict](https://github.com/MaigoAkisame/MCPDict)** - ⭐ 259
   Android App: 漢字古今中外讀音查詢

86. **[ios-simulator-skill](https://github.com/conorluddy/ios-simulator-skill)** - ⭐ 253
...
87. **[MCPMappingViewer](https://github.com/bspkrs/MCPMappingViewer)** - ⭐ 243
   A small GUI for viewing the mappings from Minecraft obfuscated code names to MCP code names.

88. **[MCP-Defender](https://github.com/MCP-Defender/MCP-Defender)** - ⭐ 243
   Desktop app that automatically scans and blocks malicious MCP traffic in AI apps like Cursor, Claude, VS Code and Windsurf.

89. **[ai4eh](https://github.com/ethiack/ai4eh)** - ⭐ 242
   AI for Ethical Hacking - Workshop

90. **[chatlog_alpha](https://github.com/teest114514/chatlog_alpha)** - ⭐ 239
   原 [chatlog]项目（一个微信数据库读取及提供mcp服务开源软件）的二次开发，会尽可能同步最新开源解密源码

91. **[MCPConfig](https://github.com/MinecraftForge/MCPConfig)** - ⭐ 238
   Public facing repo for MCP SRG mappings.

92. **[Minecraft-Deobfuscator3000](https://github.com/SimplyProgrammer/Minecraft-Deobfuscator3000)** - ⭐ 233
   Powerful and universal deobfuscator for Minecraft mods and java decompiler!

93. **[MCPU](https://github.com/cpldcpu/MCPU)** - ⭐ 230
   MCPU - A Minimal 8Bit CPU in a 32 Macrocell CPLD

94. **[oreilly-ai-agents](https://github.com/sinanuozdemir/oreilly-ai-agents)** - ⭐ 227
   An introduction to the world of AI Agents

95. **[stock-scanner-mcp](https://github.com/wbsu2003/stock-scanner-mcp)** - ⭐ 226
...
98. **[AuditLuma](https://github.com/Vistaminc/AuditLuma)** - ⭐ 212
   AuditLuma是一个AI+智能体代码审计系统，它利用多个AI代理和先进的技术，包括多代理合作协议（MCP）和Self-RAG（检索增强生成），为代码库提供全面的安全分析，目前已经支持ollama部署的本地大模型

99. **[TuriX-CUA](https://github.com/TurixAI/TuriX-CUA)** - ⭐ 210
   This is the official website for TuriX Computer-use-Agent

100. **[mcpat](https://github.com/HewlettPackard/mcpat)** - ⭐ 208
   An integrated power, area, and timing modeling framework for multicore and manycore architectures

101. **[BaseLayer](https://github.com/zwgnr/BaseLayer)** - ⭐ 201
   Re-usable multi part components built on React Aria and TailwindCSS. 

102. **[MCP-919](https://github.com/Marcelektro/MCP-919)** - ⭐ 190
   Fully working & decompiled MCP for Minecraft 1.8.9 

103. **[MCPScan](https://github.com/antgroup/MCPScan)** - ⭐ 189

104. **[Toucan](https://github.com/TheAgentArk/Toucan)** - ⭐ 185
   Official repo of Toucan: Synthesizing 1.5M Tool-Agentic Data from Real-World MCP Environments

105. **[mangaba_ai](https://github.com/Mangaba-ai/mangaba_ai)** - ⭐ 183
...
106. **[rocketship](https://github.com/rocketship-ai/rocketship)** - ⭐ 140
   A QA testing framework for your coding agent.

107. **[claude-ipc-mcp](https://github.com/jdez427/claude-ipc-mcp)** - ⭐ 118
   AI-to-AI communication protocol for Claude, Gemini, and other AI assistants

108. **[STAMP](https://github.com/KatherLab/STAMP)** - ⭐ 104
   Solid Tumor Associative Modeling in Pathology

109. **[mcp-in-action](https://github.com/huangjia2019/mcp-in-action)** - ⭐ 98
   极客时间MCP新课已经上线！超2000同学一起开启MCP学习之旅！

110. **[TensorBlock-Studio](https://github.com/TensorBlock/TensorBlock-Studio)** - ⭐ 71
   A lightweight, open, and extensible multi-LLM interaction studio.

111. **[lycoris](https://github.com/solaoi/lycoris)** - ⭐ 68
...
112. **[tiktok-mcp](https://github.com/yap-audio/tiktok-mcp)** - ⭐ 63
   A Model Context Protocol service for TikTok video discovery and metadata extraction.

113. **[seekchat](https://github.com/seekrays/seekchat)** - ⭐ 61
   ✨ A Sleek and Powerful AI Desktop Assistant that supports MCP integration✨

114. **[houdini-mcp](https://github.com/capoom/houdini-mcp)** - ⭐ 48
   Houdini integration through the Model Context Protocol

115. **[mcp-java8-sdk](https://github.com/krrr/mcp-java8-sdk)** - ⭐ 46
   Backported Model Context Protocol SDK for Java 8

116. **[zentrun](https://github.com/andrewsky-labs/zentrun)** - ⭐ 30
   Prompt-driven automation platform - Transform natural language into executable workflows

117. **[awesome-mcp-list](https://github.com/notedit/awesome-mcp-list)** - ⭐ 28
   Awesome Model Context Protocol Service List

118. **[Wireshark_mcp](https://github.com/jayimu/Wireshark_mcp)** - ⭐ 25
...
119. **[hands-on-ai-building-ai-agents-with-model-context-protocol-mcp-and-agent2agent-a2a-6055298](https://github.com/LinkedInLearning/hands-on-ai-building-ai-agents-with-model-context-protocol-mcp-and-agent2agent-a2a-6055298)** - ⭐ 23
...
1. **[modelcontextprotocol](https://github.com/modelcontextprotocol/modelcontextprotocol)** - ⭐ 6,814
   Specification and documentation for the Model Context Protocol

2. **[jar-analyzer](https://github.com/jar-analyzer/jar-analyzer)** - ⭐ 1,853
...
3. **[ai-guide](https://github.com/liyupi/ai-guide)** - ⭐ 923
